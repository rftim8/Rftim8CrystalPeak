...
namespace Rftim8LeetCode.Problems
{
    public class _01430_CheckIfAStringIsAValidSequenceFromRootToLeavesPathInABinaryTree : I_01430_CheckIfAStringIsAValidSequenceFromRootToLeavesPathInABinaryTree
    {
        ...
        {
            //Input = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01430_CheckIfAStringIsAValidSequenceFromRootToLeavesPathInABinaryTree));
            Input = [.. RftResource._01430_CheckIfAStringIsAValidSequenceFromRootToLeavesPathInABinaryTree_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
        }
        ...
        public _01430_CheckIfAStringIsAValidSequenceFromRootToLeavesPathInABinaryTree(IHost host)
        {
            ...
            Input = RftLeetCodeHostData.Input_Test(problemName: nameof(_01430_CheckIfAStringIsAValidSequenceFromRootToLeavesPathInABinaryTree));
            DataCollector();
        }
