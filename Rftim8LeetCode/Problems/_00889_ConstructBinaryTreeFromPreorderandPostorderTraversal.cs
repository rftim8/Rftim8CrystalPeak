...
namespace Rftim8LeetCode.Problems
{
    public class _00889_ConstructBinaryTreeFromPreorderandPostorderTraversal : I_00889_ConstructBinaryTreeFromPreorderandPostorderTraversal
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_00889_ConstructBinaryTreeFromPreorderandPostorderTraversal));
        }
        ...
        public _00889_ConstructBinaryTreeFromPreorderandPostorderTraversal(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_00889_ConstructBinaryTreeFromPreorderandPostorderTraversal));
        }
