...
namespace Rftim8LeetCode.Problems
{
    public class _02598_SmallestMissingNonNegativeIntegerAfterOperations : I_02598_SmallestMissingNonNegativeIntegerAfterOperations
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_02598_SmallestMissingNonNegativeIntegerAfterOperations));
        }
        ...
        public _02598_SmallestMissingNonNegativeIntegerAfterOperations(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_02598_SmallestMissingNonNegativeIntegerAfterOperations));
        }
