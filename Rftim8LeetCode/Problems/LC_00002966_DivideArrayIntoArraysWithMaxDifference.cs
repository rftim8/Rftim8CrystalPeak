...
namespace Rftim8LeetCode.Problems
{
    public class LC_00002966_DivideArrayIntoArraysWithMaxDifference : ILC_00002966_DivideArrayIntoArraysWithMaxDifference
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(LC_00002966_DivideArrayIntoArraysWithMaxDifference));
        }
        ...
        public LC_00002966_DivideArrayIntoArraysWithMaxDifference(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(LC_00002966_DivideArrayIntoArraysWithMaxDifference));
        }
