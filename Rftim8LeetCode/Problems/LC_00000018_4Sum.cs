...
namespace Rftim8LeetCode.Problems
{
    public class LC_00000018_4Sum : ILC_00000018_4Sum
    {
        ...
        {
            //Input = RftLeetCodeStaticData.Input_Test(testType: true, problemName: nameof(LC_00000018_4Sum));
            Input = [.. RftLCResources.LC_00000018_4Sum_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        /// </summary>
        [Benchmark]
        public int Solution_0() => LC_00000018_4Sum_0(Input!);

        private static int LC_00000018_4Sum_0(List<string> input)
        {
            return 0;
        }
        ...
        /// </summary>        
        [Benchmark]
        public int Solution_1() => LC_00000018_4Sum_1(Input!);

        private static int LC_00000018_4Sum_1(List<string> input)
        {
            return 0;
        }
        #endregion
        ...
        #region UnitTest
        public static int Solution_0_Test(List<string> data) => LC_00000018_4Sum_0(data);

        public static int Solution_1_Test(List<string> data) => LC_00000018_4Sum_1(data);
        #endregion
