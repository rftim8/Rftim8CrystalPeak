...
{
    public class _01411_NumberOfWaysToPaintN3Grid : I_01411_NumberOfWaysToPaintN3Grid
    {
        #region Static
        ...
        public _01411_NumberOfWaysToPaintN3Grid(IHost host)
        {
            RftLeetCodeHostData = host.Services.GetRequiredService<IRftLeetCodeHostData>();
            Input = RftLeetCodeHostData.Input_Test(problemName: nameof(_01411_NumberOfWaysToPaintN3Grid));
            DataCollector();
        }
