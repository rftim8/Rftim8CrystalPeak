...
namespace Rftim8LeetCode.Problems
{
    public class _01562_FindLatestGroupOfSizeM : I_01562_FindLatestGroupOfSizeM
    {
        ...
        {
            //Input = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01562_FindLatestGroupOfSizeM));
            Input = [.. RftResource._01562_FindLatestGroupOfSizeM_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
        }
        ...
        public _01562_FindLatestGroupOfSizeM(IHost host)
        {
            ...
            Input = RftLeetCodeHostData.Input_Test(problemName: nameof(_01562_FindLatestGroupOfSizeM));
            DataCollector();
        }
