...
namespace Rftim8LeetCode.Problems
{
    public class _02493_DivideNodesIntotheMaximumNumberOfGroups : I_02493_DivideNodesIntotheMaximumNumberOfGroups
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_02493_DivideNodesIntotheMaximumNumberOfGroups));
        }
        ...
        public _02493_DivideNodesIntotheMaximumNumberOfGroups(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_02493_DivideNodesIntotheMaximumNumberOfGroups));
        }
