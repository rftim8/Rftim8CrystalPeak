...
namespace Rftim8LeetCode.Problems
{
    public class _01576_ReplaceAllsToAvoidConsecutiveRepeatingCharacters : I_01576_ReplaceAllsToAvoidConsecutiveRepeatingCharacters
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01576_ReplaceAllsToAvoidConsecutiveRepeatingCharacters));
        }
        ...
        public _01576_ReplaceAllsToAvoidConsecutiveRepeatingCharacters(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_01576_ReplaceAllsToAvoidConsecutiveRepeatingCharacters));
        }
