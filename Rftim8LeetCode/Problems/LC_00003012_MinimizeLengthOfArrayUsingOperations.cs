...
namespace Rftim8LeetCode.Problems
{
    public class LC_00003012_MinimizeLengthOfArrayUsingOperations : ILC_00003012_MinimizeLengthOfArrayUsingOperations
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(LC_00003012_MinimizeLengthOfArrayUsingOperations));
        }
        ...
        public LC_00003012_MinimizeLengthOfArrayUsingOperations(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(LC_00003012_MinimizeLengthOfArrayUsingOperations));
        }
