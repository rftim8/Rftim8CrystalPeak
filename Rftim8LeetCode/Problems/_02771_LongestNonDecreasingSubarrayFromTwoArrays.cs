...
namespace Rftim8LeetCode.Problems
{
    public class _02771_LongestNonDecreasingSubarrayFromTwoArrays : I_02771_LongestNonDecreasingSubarrayFromTwoArrays
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_02771_LongestNonDecreasingSubarrayFromTwoArrays));
        }
        ...
        public _02771_LongestNonDecreasingSubarrayFromTwoArrays(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_02771_LongestNonDecreasingSubarrayFromTwoArrays));
        }
