...
namespace Rftim8LeetCode.Problems
{
    public class _01628_DesignanExpressionTreeWithEvaluateFunction : I_01628_DesignanExpressionTreeWithEvaluateFunction
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01628_DesignanExpressionTreeWithEvaluateFunction));
        }
        ...
        public _01628_DesignanExpressionTreeWithEvaluateFunction(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_01628_DesignanExpressionTreeWithEvaluateFunction));
        }
