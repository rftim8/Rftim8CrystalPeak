...
namespace Rftim8LeetCode.Problems
{
    public class _02702_MinimumOperationsToMakeNumbersNonPositive : I_02702_MinimumOperationsToMakeNumbersNonPositive
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_02702_MinimumOperationsToMakeNumbersNonPositive));
        }
        ...
        public _02702_MinimumOperationsToMakeNumbersNonPositive(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_02702_MinimumOperationsToMakeNumbersNonPositive));
        }
