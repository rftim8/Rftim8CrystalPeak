...
namespace Rftim8LeetCode.Problems
{
    public class _01404_NumberOfStepsToReduceANumberInBinaryRepresentationToOne : I_01404_NumberOfStepsToReduceANumberInBinaryRepresentationToOne
    {
        ...
        {
            //Input = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01404_NumberOfStepsToReduceANumberInBinaryRepresentationToOne));
            Input = [.. RftResource._01404_NumberOfStepsToReduceANumberInBinaryRepresentationToOne_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
        }
        ...
        public _01404_NumberOfStepsToReduceANumberInBinaryRepresentationToOne(IHost host)
        {
            ...
            Input = RftLeetCodeHostData.Input_Test(problemName: nameof(_01404_NumberOfStepsToReduceANumberInBinaryRepresentationToOne));
            DataCollector();
        }
