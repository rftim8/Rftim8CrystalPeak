...
namespace Rftim8LeetCode.Problems
{
    public class _01521_FindAValueOfAMysteriousFunctionClosestToTarget : I_01521_FindAValueOfAMysteriousFunctionClosestToTarget
    {
        ...
        {
            //Input = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01521_FindAValueOfAMysteriousFunctionClosestToTarget));
            Input = [.. RftResource._01521_FindAValueOfAMysteriousFunctionClosestToTarget_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
        }
        ...
        public _01521_FindAValueOfAMysteriousFunctionClosestToTarget(IHost host)
        {
            ...
            Input = RftLeetCodeHostData.Input_Test(problemName: nameof(_01521_FindAValueOfAMysteriousFunctionClosestToTarget));
            DataCollector();
        }
