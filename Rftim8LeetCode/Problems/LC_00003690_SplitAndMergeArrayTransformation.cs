...
namespace Rftim8LeetCode.Problems
{
    public class LC_00003690_SplitAndMergeArrayTransformation : ILC_00003690_SplitAndMergeArrayTransformation
    {
        ...
        /// </summary>
        [Benchmark]
        public int Solution_0() => LC_00003690_SplitAndMergeArrayTransformation_0(Input!);

        private static int LC_00003690_SplitAndMergeArrayTransformation_0(List<string> input)
        {
            return 0;
        }
        ...
        /// </summary>        
        [Benchmark]
        public int Solution_1() => LC_00003690_SplitAndMergeArrayTransformation_1(Input!);

        private static int LC_00003690_SplitAndMergeArrayTransformation_1(List<string> input)
        {
            return 0;
        }
        #endregion
        ...
        #region UnitTest
        public static int Solution_0_Test(List<string> data) => LC_00003690_SplitAndMergeArrayTransformation_0(data);

        public static int Solution_1_Test(List<string> data) => LC_00003690_SplitAndMergeArrayTransformation_1(data);
        #endregion
        ...
        public void PrintSolution()
        {
            ...
            {
                int actual = LC_00003690_SplitAndMergeArrayTransformation_0([]);
                Console.WriteLine($"Solution 0: Testcase {i + 1}: Expected = {results![i]} => Actual: {actual}");
                actual = LC_00003690_SplitAndMergeArrayTransformation_1([]);
