...
namespace Rftim8LeetCode.Problems
{
    public class _01593_SplitaStringIntoTheMaxNumberOfUniqueSubstrings : I_01593_SplitaStringIntoTheMaxNumberOfUniqueSubstrings
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01593_SplitaStringIntoTheMaxNumberOfUniqueSubstrings));
        }
        ...
        public _01593_SplitaStringIntoTheMaxNumberOfUniqueSubstrings(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_01593_SplitaStringIntoTheMaxNumberOfUniqueSubstrings));
        }
