...
namespace Rftim8LeetCode.Problems
{
    public class _02472_MaximumNumberOfNonOverlappingPalindromeSubstrings : I_02472_MaximumNumberOfNonOverlappingPalindromeSubstrings
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_02472_MaximumNumberOfNonOverlappingPalindromeSubstrings));
        }
        ...
        public _02472_MaximumNumberOfNonOverlappingPalindromeSubstrings(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_02472_MaximumNumberOfNonOverlappingPalindromeSubstrings));
        }
