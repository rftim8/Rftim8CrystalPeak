...
namespace Rftim8LeetCode.Problems
{
    public class LC_00002800_ShortestStringThatContainsThreeStrings : ILC_00002800_ShortestStringThatContainsThreeStrings
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(LC_00002800_ShortestStringThatContainsThreeStrings));
        }
        ...
        public LC_00002800_ShortestStringThatContainsThreeStrings(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(LC_00002800_ShortestStringThatContainsThreeStrings));
        }
