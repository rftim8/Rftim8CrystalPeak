...
namespace Rftim8LeetCode.Problems
{
    public class _02894_DivisibleAndNonDivisibleSumsDifference : I_02894_DivisibleAndNonDivisibleSumsDifference
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_02894_DivisibleAndNonDivisibleSumsDifference));
        }
        ...
        public _02894_DivisibleAndNonDivisibleSumsDifference(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_02894_DivisibleAndNonDivisibleSumsDifference));
        }
