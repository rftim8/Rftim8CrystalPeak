...
namespace Rftim8LeetCode.Problems
{
    public class LC_00000036_ValidSudoku : ILC_00000036_ValidSudoku
    {
        ...
        /// </summary>
        [Benchmark]
        public int Solution_0() => LC_00000036_ValidSudoku_0(Input!);

        private static int LC_00000036_ValidSudoku_0(List<string> input)
        {
            return 0;
        }
        ...
        /// </summary>        
        [Benchmark]
        public int Solution_1() => LC_00000036_ValidSudoku_1(Input!);

        private static int LC_00000036_ValidSudoku_1(List<string> input)
        {
            return 0;
        }
        #endregion
        ...
        #region UnitTest
        public static int Solution_0_Test(List<string> data) => LC_00000036_ValidSudoku_0(data);

        public static int Solution_1_Test(List<string> data) => LC_00000036_ValidSudoku_1(data);
        #endregion
