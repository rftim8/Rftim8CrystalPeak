...
namespace Rftim8LeetCode.Problems
{
    public class _00865_SmallestSubtreeWithAlltheDeepestNodes : I_00865_SmallestSubtreeWithAlltheDeepestNodes
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_00865_SmallestSubtreeWithAlltheDeepestNodes));
        }
        ...
        public _00865_SmallestSubtreeWithAlltheDeepestNodes(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_00865_SmallestSubtreeWithAlltheDeepestNodes));
        }
