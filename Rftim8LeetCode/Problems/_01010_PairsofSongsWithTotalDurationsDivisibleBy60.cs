...
namespace Rftim8LeetCode.Problems
{
    public class _01010_PairsofSongsWithTotalDurationsDivisibleBy60 : I_01010_PairsofSongsWithTotalDurationsDivisibleBy60
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01010_PairsofSongsWithTotalDurationsDivisibleBy60));
        }
        ...
        public _01010_PairsofSongsWithTotalDurationsDivisibleBy60(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_01010_PairsofSongsWithTotalDurationsDivisibleBy60));
        }
