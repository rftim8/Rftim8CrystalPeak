...
namespace Rftim8LeetCode.Problems
{
    public class _02400_NumberOfWaysToReachAPositionAfterExactlykSteps : I_02400_NumberOfWaysToReachAPositionAfterExactlykSteps
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_02400_NumberOfWaysToReachAPositionAfterExactlykSteps));
        }
        ...
        public _02400_NumberOfWaysToReachAPositionAfterExactlykSteps(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_02400_NumberOfWaysToReachAPositionAfterExactlykSteps));
        }
