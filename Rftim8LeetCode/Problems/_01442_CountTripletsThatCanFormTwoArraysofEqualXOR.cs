...
namespace Rftim8LeetCode.Problems
{
    public class _01442_CountTripletsThatCanFormTwoArraysofEqualXOR : I_01442_CountTripletsThatCanFormTwoArraysofEqualXOR
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01442_CountTripletsThatCanFormTwoArraysofEqualXOR));
        }
        ...
        public _01442_CountTripletsThatCanFormTwoArraysofEqualXOR(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_01442_CountTripletsThatCanFormTwoArraysofEqualXOR));
        }
