...
namespace Rftim8LeetCode.Problems
{
    public class _01997_FirstDayWhereYouHaveBeenInAlltheRooms : I_01997_FirstDayWhereYouHaveBeenInAlltheRooms
    {
        ...
        {
            data = RftLeetCodeStaticData.Input_Test(testType: false, problemName: nameof(_01997_FirstDayWhereYouHaveBeenInAlltheRooms));
        }
        ...
        public _01997_FirstDayWhereYouHaveBeenInAlltheRooms(IHost host)
        {
            ...
            data = RftLeetCodeHostData.Input_Test(problemName: nameof(_01997_FirstDayWhereYouHaveBeenInAlltheRooms));
        }
