...
{
    public class _02042_CheckIfNumbersAreAscendingInASentence
    {
        /// <summary>
        ...
        {
            Console.WriteLine(AreNumbersAscending("1 box has 3 blue 4 red 6 green and 12 yellow marbles"));
            Console.WriteLine(AreNumbersAscending("hello world 5 x 5"));
