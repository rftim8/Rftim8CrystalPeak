...
{
    [TestClass]
    public sealed class PE_00000125_PalindromicSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000125_PalindromicSums));
        ...
        {
            int result = PE_00000125_PalindromicSums.Solution_0_Test(input);
