...
{
    [TestClass]
    public sealed class PE_00000850_FractionsOfPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000850_FractionsOfPowers));
        ...
        {
            int result = PE_00000850_FractionsOfPowers.Solution_0_Test(input);
