...
{
    [TestClass]
    public sealed class PE_00000598_SplitDivisibilities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000598_SplitDivisibilities));
        ...
        {
            int result = PE_00000598_SplitDivisibilities.Solution_0_Test(input);
