...
{
    [TestClass]
    public sealed class PE_00000262_MountainRange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000262_MountainRange));
        ...
        {
            int result = PE_00000262_MountainRange.Solution_0_Test(input);
