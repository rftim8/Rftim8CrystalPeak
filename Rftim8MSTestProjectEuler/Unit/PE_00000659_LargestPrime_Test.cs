...
{
    [TestClass]
    public sealed class PE_00000659_LargestPrime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000659_LargestPrime));
        ...
        {
            int result = PE_00000659_LargestPrime.Solution_0_Test(input);
