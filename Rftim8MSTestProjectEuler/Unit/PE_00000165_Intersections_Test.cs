...
{
    [TestClass]
    public sealed class PE_00000165_Intersections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000165_Intersections));
        ...
        {
            int result = PE_00000165_Intersections.Solution_0_Test(input);
