...
{
    [TestClass]
    public sealed class PE_00000250_250250_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000250_250250));
        ...
        {
            int result = PE_00000250_250250.Solution_0_Test(input);
