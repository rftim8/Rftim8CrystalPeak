...
{
    [TestClass]
    public sealed class PE_00000606_GozintaChainsII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000606_GozintaChainsII));
        ...
        {
            int result = PE_00000606_GozintaChainsII.Solution_0_Test(input);
