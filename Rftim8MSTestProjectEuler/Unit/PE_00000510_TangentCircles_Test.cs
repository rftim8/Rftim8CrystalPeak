...
{
    [TestClass]
    public sealed class PE_00000510_TangentCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000510_TangentCircles));
        ...
        {
            int result = PE_00000510_TangentCircles.Solution_0_Test(input);
