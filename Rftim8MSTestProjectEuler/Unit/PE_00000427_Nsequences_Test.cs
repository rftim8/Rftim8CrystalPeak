...
{
    [TestClass]
    public sealed class PE_00000427_Nsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000427_Nsequences));
        ...
        {
            int result = PE_00000427_Nsequences.Solution_0_Test(input);
