...
{
    [TestClass]
    public sealed class PE_00000928_Cribbage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000928_Cribbage));
        ...
        {
            int result = PE_00000928_Cribbage.Solution_0_Test(input);
