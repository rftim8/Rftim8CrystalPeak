...
{
    [TestClass]
    public sealed class PE_00000042_CodedTriangleNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000042_CodedTriangleNumbers));
        ...
        {
            int result = PE_00000042_CodedTriangleNumbers.Solution_0_Test(input);
