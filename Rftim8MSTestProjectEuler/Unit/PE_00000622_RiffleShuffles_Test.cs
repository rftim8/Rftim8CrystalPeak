...
{
    [TestClass]
    public sealed class PE_00000622_RiffleShuffles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000622_RiffleShuffles));
        ...
        {
            int result = PE_00000622_RiffleShuffles.Solution_0_Test(input);
