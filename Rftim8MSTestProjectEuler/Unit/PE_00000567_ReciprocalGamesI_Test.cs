...
{
    [TestClass]
    public sealed class PE_00000567_ReciprocalGamesI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000567_ReciprocalGamesI));
        ...
        {
            int result = PE_00000567_ReciprocalGamesI.Solution_0_Test(input);
