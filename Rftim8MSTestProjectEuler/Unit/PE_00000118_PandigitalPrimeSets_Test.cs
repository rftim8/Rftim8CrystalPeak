...
{
    [TestClass]
    public sealed class PE_00000118_PandigitalPrimeSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000118_PandigitalPrimeSets));
        ...
        {
            int result = PE_00000118_PandigitalPrimeSets.Solution_0_Test(input);
