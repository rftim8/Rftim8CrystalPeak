...
{
    [TestClass]
    public sealed class PE_00000566_CakeIcingPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000566_CakeIcingPuzzle));
        ...
        {
            int result = PE_00000566_CakeIcingPuzzle.Solution_0_Test(input);
