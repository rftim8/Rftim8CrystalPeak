...
{
    [TestClass]
    public sealed class PE_00000638_WeightedLatticePaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000638_WeightedLatticePaths));
        ...
        {
            int result = PE_00000638_WeightedLatticePaths.Solution_0_Test(input);
