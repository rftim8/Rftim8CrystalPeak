...
{
    [TestClass]
    public sealed class PE_00000315_DigitalRootClocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000315_DigitalRootClocks));
        ...
        {
            int result = PE_00000315_DigitalRootClocks.Solution_0_Test(input);
