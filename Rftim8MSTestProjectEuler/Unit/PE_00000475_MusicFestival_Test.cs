...
{
    [TestClass]
    public sealed class PE_00000475_MusicFestival_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000475_MusicFestival));
        ...
        {
            int result = PE_00000475_MusicFestival.Solution_0_Test(input);
