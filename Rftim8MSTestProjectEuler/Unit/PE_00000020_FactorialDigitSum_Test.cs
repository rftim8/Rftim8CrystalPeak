...
{
    [TestClass]
    public sealed class PE_00000020_FactorialDigitSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000020_FactorialDigitSum));
        ...
        {
            int result = PE_00000020_FactorialDigitSum.Solution_0_Test(input);
