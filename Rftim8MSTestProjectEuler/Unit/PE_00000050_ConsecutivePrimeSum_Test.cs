...
{
    [TestClass]
    public sealed class PE_00000050_ConsecutivePrimeSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000050_ConsecutivePrimeSum));
        ...
        {
            int result = PE_00000050_ConsecutivePrimeSum.Solution_0_Test(input);
