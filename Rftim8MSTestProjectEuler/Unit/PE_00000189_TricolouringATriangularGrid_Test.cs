...
{
    [TestClass]
    public sealed class PE_00000189_TricolouringATriangularGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000189_TricolouringATriangularGrid));
        ...
        {
            int result = PE_00000189_TricolouringATriangularGrid.Solution_0_Test(input);
