...
{
    [TestClass]
    public sealed class PE_00000528_ConstrainedSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000528_ConstrainedSums));
        ...
        {
            int result = PE_00000528_ConstrainedSums.Solution_0_Test(input);
