...
{
    [TestClass]
    public sealed class PE_00000935_RollingSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000935_RollingSquare));
        ...
        {
            int result = PE_00000935_RollingSquare.Solution_0_Test(input);
