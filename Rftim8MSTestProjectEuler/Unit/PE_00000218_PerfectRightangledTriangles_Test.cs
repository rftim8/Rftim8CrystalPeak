...
{
    [TestClass]
    public sealed class PE_00000218_PerfectRightangledTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000218_PerfectRightangledTriangles));
        ...
        {
            int result = PE_00000218_PerfectRightangledTriangles.Solution_0_Test(input);
