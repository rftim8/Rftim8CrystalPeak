...
{
    [TestClass]
    public sealed class PE_00000808_ReversiblePrimeSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000808_ReversiblePrimeSquares));
        ...
        {
            int result = PE_00000808_ReversiblePrimeSquares.Solution_0_Test(input);
