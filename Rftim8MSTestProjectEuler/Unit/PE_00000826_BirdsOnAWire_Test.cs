...
{
    [TestClass]
    public sealed class PE_00000826_BirdsOnAWire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000826_BirdsOnAWire));
        ...
        {
            int result = PE_00000826_BirdsOnAWire.Solution_0_Test(input);
