...
{
    [TestClass]
    public sealed class PE_00000794_SeventeenPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000794_SeventeenPoints));
        ...
        {
            int result = PE_00000794_SeventeenPoints.Solution_0_Test(input);
