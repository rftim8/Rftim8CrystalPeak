...
{
    [TestClass]
    public sealed class PE_00000780_Toriangulations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000780_Toriangulations));
        ...
        {
            int result = PE_00000780_Toriangulations.Solution_0_Test(input);
