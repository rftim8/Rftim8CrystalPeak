...
{
    [TestClass]
    public sealed class PE_00000234_SemidivisibleNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000234_SemidivisibleNumbers));
        ...
        {
            int result = PE_00000234_SemidivisibleNumbers.Solution_0_Test(input);
