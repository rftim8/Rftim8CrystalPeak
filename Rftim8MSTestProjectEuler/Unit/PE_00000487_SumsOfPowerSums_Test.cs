...
{
    [TestClass]
    public sealed class PE_00000487_SumsOfPowerSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000487_SumsOfPowerSums));
        ...
        {
            int result = PE_00000487_SumsOfPowerSums.Solution_0_Test(input);
