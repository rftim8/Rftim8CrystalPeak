...
{
    [TestClass]
    public sealed class PE_00000382_GeneratingPolygons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000382_GeneratingPolygons));
        ...
        {
            int result = PE_00000382_GeneratingPolygons.Solution_0_Test(input);
