...
{
    [TestClass]
    public sealed class PE_00000345_MatrixSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000345_MatrixSum));
        ...
        {
            int result = PE_00000345_MatrixSum.Solution_0_Test(input);
