...
{
    [TestClass]
    public sealed class PE_00000046_GoldbachsOtherConjecture_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000046_GoldbachsOtherConjecture));
        ...
        {
            int result = PE_00000046_GoldbachsOtherConjecture.Solution_0_Test(input);
