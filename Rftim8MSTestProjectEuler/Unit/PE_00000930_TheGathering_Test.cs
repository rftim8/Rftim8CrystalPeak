...
{
    [TestClass]
    public sealed class PE_00000930_TheGathering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000930_TheGathering));
        ...
        {
            int result = PE_00000930_TheGathering.Solution_0_Test(input);
