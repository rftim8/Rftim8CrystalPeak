...
{
    [TestClass]
    public sealed class PE_00000903_TotalPermutationPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000903_TotalPermutationPowers));
        ...
        {
            int result = PE_00000903_TotalPermutationPowers.Solution_0_Test(input);
