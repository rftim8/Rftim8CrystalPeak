...
{
    [TestClass]
    public sealed class PE_00000306_PaperstripGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000306_PaperstripGame));
        ...
        {
            int result = PE_00000306_PaperstripGame.Solution_0_Test(input);
