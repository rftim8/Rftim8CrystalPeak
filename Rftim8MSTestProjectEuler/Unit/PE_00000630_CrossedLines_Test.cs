...
{
    [TestClass]
    public sealed class PE_00000630_CrossedLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000630_CrossedLines));
        ...
        {
            int result = PE_00000630_CrossedLines.Solution_0_Test(input);
