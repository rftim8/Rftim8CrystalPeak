...
{
    [TestClass]
    public sealed class PE_00000286_ScoringProbabilities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000286_ScoringProbabilities));
        ...
        {
            int result = PE_00000286_ScoringProbabilities.Solution_0_Test(input);
