...
{
    [TestClass]
    public sealed class PE_00000514_GeoboardShapes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000514_GeoboardShapes));
        ...
        {
            int result = PE_00000514_GeoboardShapes.Solution_0_Test(input);
