...
{
    [TestClass]
    public sealed class PE_00000304_Primonacci_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000304_Primonacci));
        ...
        {
            int result = PE_00000304_Primonacci.Solution_0_Test(input);
