...
{
    [TestClass]
    public sealed class PE_00000759_ASquaredRecurrenceRelation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000759_ASquaredRecurrenceRelation));
        ...
        {
            int result = PE_00000759_ASquaredRecurrenceRelation.Solution_0_Test(input);
