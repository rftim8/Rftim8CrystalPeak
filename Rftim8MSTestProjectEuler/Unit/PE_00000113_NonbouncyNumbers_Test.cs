...
{
    [TestClass]
    public sealed class PE_00000113_NonbouncyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000113_NonbouncyNumbers));
        ...
        {
            int result = PE_00000113_NonbouncyNumbers.Solution_0_Test(input);
