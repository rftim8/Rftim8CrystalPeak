...
{
    [TestClass]
    public sealed class PE_00000716_GridGraphs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000716_GridGraphs));
        ...
        {
            int result = PE_00000716_GridGraphs.Solution_0_Test(input);
