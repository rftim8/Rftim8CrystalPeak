...
{
    [TestClass]
    public sealed class PE_00000187_Semiprimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000187_Semiprimes));
        ...
        {
            int result = PE_00000187_Semiprimes.Solution_0_Test(input);
