...
{
    [TestClass]
    public sealed class PE_00000531_ChineseLeftovers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000531_ChineseLeftovers));
        ...
        {
            int result = PE_00000531_ChineseLeftovers.Solution_0_Test(input);
