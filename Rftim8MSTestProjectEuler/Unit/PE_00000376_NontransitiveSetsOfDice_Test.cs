...
{
    [TestClass]
    public sealed class PE_00000376_NontransitiveSetsOfDice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000376_NontransitiveSetsOfDice));
        ...
        {
            int result = PE_00000376_NontransitiveSetsOfDice.Solution_0_Test(input);
