...
{
    [TestClass]
    public sealed class PE_00000530_GCDOfDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000530_GCDOfDivisors));
        ...
        {
            int result = PE_00000530_GCDOfDivisors.Solution_0_Test(input);
