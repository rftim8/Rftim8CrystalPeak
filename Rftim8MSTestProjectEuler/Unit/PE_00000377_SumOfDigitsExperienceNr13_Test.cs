...
{
    [TestClass]
    public sealed class PE_00000377_SumOfDigitsExperienceNr13_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000377_SumOfDigitsExperienceNr13));
        ...
        {
            int result = PE_00000377_SumOfDigitsExperienceNr13.Solution_0_Test(input);
