...
{
    [TestClass]
    public sealed class PE_00000321_SwappingCounters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000321_SwappingCounters));
        ...
        {
            int result = PE_00000321_SwappingCounters.Solution_0_Test(input);
