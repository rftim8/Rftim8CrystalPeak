...
{
    [TestClass]
    public sealed class PE_00000791_AverageAndVariance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000791_AverageAndVariance));
        ...
        {
            int result = PE_00000791_AverageAndVariance.Solution_0_Test(input);
