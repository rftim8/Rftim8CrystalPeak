...
{
    [TestClass]
    public sealed class PE_00000879_TouchscreenPassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000879_TouchscreenPassword));
        ...
        {
            int result = PE_00000879_TouchscreenPassword.Solution_0_Test(input);
