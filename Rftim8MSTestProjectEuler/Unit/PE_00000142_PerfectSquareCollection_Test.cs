...
{
    [TestClass]
    public sealed class PE_00000142_PerfectSquareCollection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000142_PerfectSquareCollection));
        ...
        {
            int result = PE_00000142_PerfectSquareCollection.Solution_0_Test(input);
