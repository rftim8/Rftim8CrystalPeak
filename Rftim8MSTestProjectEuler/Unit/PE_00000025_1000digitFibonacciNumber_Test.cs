...
{
    [TestClass]
    public sealed class PE_00000025_1000digitFibonacciNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000025_1000digitFibonacciNumber));
        ...
        {
            int result = PE_00000025_1000digitFibonacciNumber.Solution_0_Test(input);
