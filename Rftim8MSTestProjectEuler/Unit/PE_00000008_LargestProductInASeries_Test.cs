...
{
    [TestClass]
    public sealed class PE_00000008_LargestProductInASeries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000008_LargestProductInASeries));
        ...
        {
            int result = PE_00000008_LargestProductInASeries.Solution_0_Test(input);
