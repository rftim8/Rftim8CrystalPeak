...
{
    [TestClass]
    public sealed class PE_00000842_IrregularStarPolygons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000842_IrregularStarPolygons));
        ...
        {
            int result = PE_00000842_IrregularStarPolygons.Solution_0_Test(input);
