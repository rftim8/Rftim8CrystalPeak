...
{
    [TestClass]
    public sealed class PE_00000506_ClockSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000506_ClockSequence));
        ...
        {
            int result = PE_00000506_ClockSequence.Solution_0_Test(input);
