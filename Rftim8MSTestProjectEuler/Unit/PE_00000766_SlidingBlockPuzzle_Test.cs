...
{
    [TestClass]
    public sealed class PE_00000766_SlidingBlockPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000766_SlidingBlockPuzzle));
        ...
        {
            int result = PE_00000766_SlidingBlockPuzzle.Solution_0_Test(input);
