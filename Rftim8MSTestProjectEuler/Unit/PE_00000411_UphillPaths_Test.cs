...
{
    [TestClass]
    public sealed class PE_00000411_UphillPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000411_UphillPaths));
        ...
        {
            int result = PE_00000411_UphillPaths.Solution_0_Test(input);
