...
{
    [TestClass]
    public sealed class PE_00000909_LexpressionsI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000909_LexpressionsI));
        ...
        {
            int result = PE_00000909_LexpressionsI.Solution_0_Test(input);
