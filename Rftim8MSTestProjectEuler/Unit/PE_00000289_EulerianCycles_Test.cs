...
{
    [TestClass]
    public sealed class PE_00000289_EulerianCycles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000289_EulerianCycles));
        ...
        {
            int result = PE_00000289_EulerianCycles.Solution_0_Test(input);
