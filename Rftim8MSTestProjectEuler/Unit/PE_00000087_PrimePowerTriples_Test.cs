...
{
    [TestClass]
    public sealed class PE_00000087_PrimePowerTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000087_PrimePowerTriples));
        ...
        {
            int result = PE_00000087_PrimePowerTriples.Solution_0_Test(input);
