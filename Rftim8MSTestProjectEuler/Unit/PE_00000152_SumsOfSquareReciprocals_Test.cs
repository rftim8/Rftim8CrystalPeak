...
{
    [TestClass]
    public sealed class PE_00000152_SumsOfSquareReciprocals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000152_SumsOfSquareReciprocals));
        ...
        {
            int result = PE_00000152_SumsOfSquareReciprocals.Solution_0_Test(input);
