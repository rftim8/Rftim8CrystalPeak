...
{
    [TestClass]
    public sealed class PE_00000110_DiophantineReciprocalsII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000110_DiophantineReciprocalsII));
        ...
        {
            int result = PE_00000110_DiophantineReciprocalsII.Solution_0_Test(input);
