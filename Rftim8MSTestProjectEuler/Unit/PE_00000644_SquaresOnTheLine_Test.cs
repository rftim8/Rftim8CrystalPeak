...
{
    [TestClass]
    public sealed class PE_00000644_SquaresOnTheLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000644_SquaresOnTheLine));
        ...
        {
            int result = PE_00000644_SquaresOnTheLine.Solution_0_Test(input);
