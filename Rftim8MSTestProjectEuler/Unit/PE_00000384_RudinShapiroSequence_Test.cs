...
{
    [TestClass]
    public sealed class PE_00000384_RudinShapiroSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000384_RudinShapiroSequence));
        ...
        {
            int result = PE_00000384_RudinShapiroSequence.Solution_0_Test(input);
