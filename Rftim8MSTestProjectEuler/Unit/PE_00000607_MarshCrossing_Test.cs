...
{
    [TestClass]
    public sealed class PE_00000607_MarshCrossing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000607_MarshCrossing));
        ...
        {
            int result = PE_00000607_MarshCrossing.Solution_0_Test(input);
