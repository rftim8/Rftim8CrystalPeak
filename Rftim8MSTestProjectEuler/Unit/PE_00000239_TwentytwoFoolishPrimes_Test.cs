...
{
    [TestClass]
    public sealed class PE_00000239_TwentytwoFoolishPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000239_TwentytwoFoolishPrimes));
        ...
        {
            int result = PE_00000239_TwentytwoFoolishPrimes.Solution_0_Test(input);
