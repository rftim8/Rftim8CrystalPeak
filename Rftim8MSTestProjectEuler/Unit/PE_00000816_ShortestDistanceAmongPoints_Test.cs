...
{
    [TestClass]
    public sealed class PE_00000816_ShortestDistanceAmongPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000816_ShortestDistanceAmongPoints));
        ...
        {
            int result = PE_00000816_ShortestDistanceAmongPoints.Solution_0_Test(input);
