...
{
    [TestClass]
    public sealed class PE_00000750_OptimalCardStacking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000750_OptimalCardStacking));
        ...
        {
            int result = PE_00000750_OptimalCardStacking.Solution_0_Test(input);
