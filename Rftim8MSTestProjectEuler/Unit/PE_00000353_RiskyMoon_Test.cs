...
{
    [TestClass]
    public sealed class PE_00000353_RiskyMoon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000353_RiskyMoon));
        ...
        {
            int result = PE_00000353_RiskyMoon.Solution_0_Test(input);
