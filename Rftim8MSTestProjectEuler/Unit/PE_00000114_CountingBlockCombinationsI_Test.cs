...
{
    [TestClass]
    public sealed class PE_00000114_CountingBlockCombinationsI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000114_CountingBlockCombinationsI));
        ...
        {
            int result = PE_00000114_CountingBlockCombinationsI.Solution_0_Test(input);
