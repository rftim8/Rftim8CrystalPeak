...
{
    [TestClass]
    public sealed class PE_00000815_GroupByValue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000815_GroupByValue));
        ...
        {
            int result = PE_00000815_GroupByValue.Solution_0_Test(input);
