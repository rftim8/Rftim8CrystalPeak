...
{
    [TestClass]
    public sealed class PE_00000049_PrimePermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000049_PrimePermutations));
        ...
        {
            int result = PE_00000049_PrimePermutations.Solution_0_Test(input);
