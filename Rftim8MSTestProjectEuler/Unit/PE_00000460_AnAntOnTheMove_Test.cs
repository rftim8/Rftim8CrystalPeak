...
{
    [TestClass]
    public sealed class PE_00000460_AnAntOnTheMove_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000460_AnAntOnTheMove));
        ...
        {
            int result = PE_00000460_AnAntOnTheMove.Solution_0_Test(input);
