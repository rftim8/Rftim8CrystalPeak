...
{
    [TestClass]
    public sealed class PE_00000294_SumOfDigitsExperienceNr23_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000294_SumOfDigitsExperienceNr23));
        ...
        {
            int result = PE_00000294_SumOfDigitsExperienceNr23.Solution_0_Test(input);
