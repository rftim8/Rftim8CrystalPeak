...
{
    [TestClass]
    public sealed class PE_00000204_GeneralisedHammingNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000204_GeneralisedHammingNumbers));
        ...
        {
            int result = PE_00000204_GeneralisedHammingNumbers.Solution_0_Test(input);
