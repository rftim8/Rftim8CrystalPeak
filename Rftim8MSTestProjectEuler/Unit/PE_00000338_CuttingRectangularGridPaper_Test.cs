...
{
    [TestClass]
    public sealed class PE_00000338_CuttingRectangularGridPaper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000338_CuttingRectangularGridPaper));
        ...
        {
            int result = PE_00000338_CuttingRectangularGridPaper.Solution_0_Test(input);
