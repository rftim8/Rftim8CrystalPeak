...
{
    [TestClass]
    public sealed class PE_00000896_DivisibleRanges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000896_DivisibleRanges));
        ...
        {
            int result = PE_00000896_DivisibleRanges.Solution_0_Test(input);
