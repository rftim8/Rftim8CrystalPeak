...
{
    [TestClass]
    public sealed class PE_00000612_FriendNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000612_FriendNumbers));
        ...
        {
            int result = PE_00000612_FriendNumbers.Solution_0_Test(input);
