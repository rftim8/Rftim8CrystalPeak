...
{
    [TestClass]
    public sealed class PE_00000166_CrissCross_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000166_CrissCross));
        ...
        {
            int result = PE_00000166_CrissCross.Solution_0_Test(input);
