...
{
    [TestClass]
    public sealed class PE_00000370_GeometricTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000370_GeometricTriangles));
        ...
        {
            int result = PE_00000370_GeometricTriangles.Solution_0_Test(input);
