...
{
    [TestClass]
    public sealed class PE_00000941_DeBruijnsCombinationLock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000941_DeBruijnsCombinationLock));
        ...
        {
            int result = PE_00000941_DeBruijnsCombinationLock.Solution_0_Test(input);
