...
{
    [TestClass]
    public sealed class PE_00000167_InvestigatingUlamSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000167_InvestigatingUlamSequences));
        ...
        {
            int result = PE_00000167_InvestigatingUlamSequences.Solution_0_Test(input);
