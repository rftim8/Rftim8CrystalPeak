...
{
    [TestClass]
    public sealed class PE_00000763_AmoebasInA3DGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000763_AmoebasInA3DGrid));
        ...
        {
            int result = PE_00000763_AmoebasInA3DGrid.Solution_0_Test(input);
