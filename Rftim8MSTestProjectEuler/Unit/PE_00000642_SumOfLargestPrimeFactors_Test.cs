...
{
    [TestClass]
    public sealed class PE_00000642_SumOfLargestPrimeFactors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000642_SumOfLargestPrimeFactors));
        ...
        {
            int result = PE_00000642_SumOfLargestPrimeFactors.Solution_0_Test(input);
