...
{
    [TestClass]
    public sealed class PE_00000515_DissonantNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000515_DissonantNumbers));
        ...
        {
            int result = PE_00000515_DissonantNumbers.Solution_0_Test(input);
