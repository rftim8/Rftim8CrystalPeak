...
{
    [TestClass]
    public sealed class PE_00000924_LargerDigitPermutationII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000924_LargerDigitPermutationII));
        ...
        {
            int result = PE_00000924_LargerDigitPermutationII.Solution_0_Test(input);
