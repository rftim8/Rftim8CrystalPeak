...
{
    [TestClass]
    public sealed class PE_00000648_SkippingSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000648_SkippingSquares));
        ...
        {
            int result = PE_00000648_SkippingSquares.Solution_0_Test(input);
