...
{
    [TestClass]
    public sealed class PE_00000154_ExploringPascalsPyramid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000154_ExploringPascalsPyramid));
        ...
        {
            int result = PE_00000154_ExploringPascalsPyramid.Solution_0_Test(input);
