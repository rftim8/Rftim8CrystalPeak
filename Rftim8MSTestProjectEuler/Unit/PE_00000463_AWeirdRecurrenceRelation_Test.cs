...
{
    [TestClass]
    public sealed class PE_00000463_AWeirdRecurrenceRelation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000463_AWeirdRecurrenceRelation));
        ...
        {
            int result = PE_00000463_AWeirdRecurrenceRelation.Solution_0_Test(input);
