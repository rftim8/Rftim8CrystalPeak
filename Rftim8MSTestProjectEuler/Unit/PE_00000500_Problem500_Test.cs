...
{
    [TestClass]
    public sealed class PE_00000500_Problem500_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000500_Problem500));
        ...
        {
            int result = PE_00000500_Problem500.Solution_0_Test(input);
