...
{
    [TestClass]
    public sealed class PE_00000921_GoldenRecurrence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000921_GoldenRecurrence));
        ...
        {
            int result = PE_00000921_GoldenRecurrence.Solution_0_Test(input);
