...
{
    [TestClass]
    public sealed class PE_00000490_JumpingFrog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000490_JumpingFrog));
        ...
        {
            int result = PE_00000490_JumpingFrog.Solution_0_Test(input);
