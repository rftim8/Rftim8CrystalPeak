...
{
    [TestClass]
    public sealed class PE_00000806_NimOnTowersOfHanoi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000806_NimOnTowersOfHanoi));
        ...
        {
            int result = PE_00000806_NimOnTowersOfHanoi.Solution_0_Test(input);
