...
{
    [TestClass]
    public sealed class PE_00000115_CountingBlockCombinationsII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000115_CountingBlockCombinationsII));
        ...
        {
            int result = PE_00000115_CountingBlockCombinationsII.Solution_0_Test(input);
