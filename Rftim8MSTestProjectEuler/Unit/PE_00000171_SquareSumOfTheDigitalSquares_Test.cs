...
{
    [TestClass]
    public sealed class PE_00000171_SquareSumOfTheDigitalSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000171_SquareSumOfTheDigitalSquares));
        ...
        {
            int result = PE_00000171_SquareSumOfTheDigitalSquares.Solution_0_Test(input);
