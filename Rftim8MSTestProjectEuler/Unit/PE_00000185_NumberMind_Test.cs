...
{
    [TestClass]
    public sealed class PE_00000185_NumberMind_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000185_NumberMind));
        ...
        {
            int result = PE_00000185_NumberMind.Solution_0_Test(input);
