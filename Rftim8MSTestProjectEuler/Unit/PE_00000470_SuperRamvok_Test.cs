...
{
    [TestClass]
    public sealed class PE_00000470_SuperRamvok_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000470_SuperRamvok));
        ...
        {
            int result = PE_00000470_SuperRamvok.Solution_0_Test(input);
