...
{
    [TestClass]
    public sealed class PE_00000839_BeansInBowls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000839_BeansInBowls));
        ...
        {
            int result = PE_00000839_BeansInBowls.Solution_0_Test(input);
