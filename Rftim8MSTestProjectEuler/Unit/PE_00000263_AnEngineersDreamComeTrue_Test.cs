...
{
    [TestClass]
    public sealed class PE_00000263_AnEngineersDreamComeTrue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000263_AnEngineersDreamComeTrue));
        ...
        {
            int result = PE_00000263_AnEngineersDreamComeTrue.Solution_0_Test(input);
