...
{
    [TestClass]
    public sealed class PE_00000290_DigitalSignature_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000290_DigitalSignature));
        ...
        {
            int result = PE_00000290_DigitalSignature.Solution_0_Test(input);
