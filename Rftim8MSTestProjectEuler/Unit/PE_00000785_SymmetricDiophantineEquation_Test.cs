...
{
    [TestClass]
    public sealed class PE_00000785_SymmetricDiophantineEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000785_SymmetricDiophantineEquation));
        ...
        {
            int result = PE_00000785_SymmetricDiophantineEquation.Solution_0_Test(input);
