...
{
    [TestClass]
    public sealed class PE_00000913_RowmajorVsColumnmajor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000913_RowmajorVsColumnmajor));
        ...
        {
            int result = PE_00000913_RowmajorVsColumnmajor.Solution_0_Test(input);
