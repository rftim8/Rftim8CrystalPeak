...
{
    [TestClass]
    public sealed class PE_00000662_FibonacciPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000662_FibonacciPaths));
        ...
        {
            int result = PE_00000662_FibonacciPaths.Solution_0_Test(input);
