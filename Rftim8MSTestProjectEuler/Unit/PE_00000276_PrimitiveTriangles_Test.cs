...
{
    [TestClass]
    public sealed class PE_00000276_PrimitiveTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000276_PrimitiveTriangles));
        ...
        {
            int result = PE_00000276_PrimitiveTriangles.Solution_0_Test(input);
