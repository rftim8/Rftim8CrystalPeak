...
{
    [TestClass]
    public sealed class PE_00000558_IrrationalBase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000558_IrrationalBase));
        ...
        {
            int result = PE_00000558_IrrationalBase.Solution_0_Test(input);
