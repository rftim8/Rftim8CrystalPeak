...
{
    [TestClass]
    public sealed class PE_00000265_BinaryCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000265_BinaryCircles));
        ...
        {
            int result = PE_00000265_BinaryCircles.Solution_0_Test(input);
