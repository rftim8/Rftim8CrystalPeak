...
{
    [TestClass]
    public sealed class PE_00000245_Coresilience_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000245_Coresilience));
        ...
        {
            int result = PE_00000245_Coresilience.Solution_0_Test(input);
