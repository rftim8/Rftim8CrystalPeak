...
{
    [TestClass]
    public sealed class PE_00000707_LightsOut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000707_LightsOut));
        ...
        {
            int result = PE_00000707_LightsOut.Solution_0_Test(input);
