...
{
    [TestClass]
    public sealed class PE_00000509_DivisorNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000509_DivisorNim));
        ...
        {
            int result = PE_00000509_DivisorNim.Solution_0_Test(input);
