...
{
    [TestClass]
    public sealed class PE_00000559_PermutedMatrices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000559_PermutedMatrices));
        ...
        {
            int result = PE_00000559_PermutedMatrices.Solution_0_Test(input);
