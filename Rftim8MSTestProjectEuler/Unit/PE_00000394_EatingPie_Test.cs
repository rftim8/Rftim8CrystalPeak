...
{
    [TestClass]
    public sealed class PE_00000394_EatingPie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000394_EatingPie));
        ...
        {
            int result = PE_00000394_EatingPie.Solution_0_Test(input);
