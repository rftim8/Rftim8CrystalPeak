...
{
    [TestClass]
    public sealed class PE_00000880_NestedRadicals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000880_NestedRadicals));
        ...
        {
            int result = PE_00000880_NestedRadicals.Solution_0_Test(input);
