...
{
    [TestClass]
    public sealed class PE_00000671_ColouringALoop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000671_ColouringALoop));
        ...
        {
            int result = PE_00000671_ColouringALoop.Solution_0_Test(input);
