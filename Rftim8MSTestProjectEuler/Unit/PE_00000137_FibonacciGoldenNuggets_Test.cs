...
{
    [TestClass]
    public sealed class PE_00000137_FibonacciGoldenNuggets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000137_FibonacciGoldenNuggets));
        ...
        {
            int result = PE_00000137_FibonacciGoldenNuggets.Solution_0_Test(input);
