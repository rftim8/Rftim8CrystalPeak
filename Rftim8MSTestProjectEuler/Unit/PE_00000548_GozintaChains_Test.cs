...
{
    [TestClass]
    public sealed class PE_00000548_GozintaChains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000548_GozintaChains));
        ...
        {
            int result = PE_00000548_GozintaChains.Solution_0_Test(input);
