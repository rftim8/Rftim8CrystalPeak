...
{
    [TestClass]
    public sealed class PE_00000482_TheIncenterOfATriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000482_TheIncenterOfATriangle));
        ...
        {
            int result = PE_00000482_TheIncenterOfATriangle.Solution_0_Test(input);
