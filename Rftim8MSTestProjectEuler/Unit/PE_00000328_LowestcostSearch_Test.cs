...
{
    [TestClass]
    public sealed class PE_00000328_LowestcostSearch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000328_LowestcostSearch));
        ...
        {
            int result = PE_00000328_LowestcostSearch.Solution_0_Test(input);
