...
{
    [TestClass]
    public sealed class PE_00000752_PowersOf1PlusSqrt7_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000752_PowersOf1PlusSqrt7));
        ...
        {
            int result = PE_00000752_PowersOf1PlusSqrt7.Solution_0_Test(input);
