...
{
    [TestClass]
    public sealed class PE_00000380_AmazingMazes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000380_AmazingMazes));
        ...
        {
            int result = PE_00000380_AmazingMazes.Solution_0_Test(input);
