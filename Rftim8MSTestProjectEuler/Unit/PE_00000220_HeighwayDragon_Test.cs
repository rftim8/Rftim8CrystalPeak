...
{
    [TestClass]
    public sealed class PE_00000220_HeighwayDragon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000220_HeighwayDragon));
        ...
        {
            int result = PE_00000220_HeighwayDragon.Solution_0_Test(input);
