...
{
    [TestClass]
    public sealed class PE_00000011_LargestProductInAGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000011_LargestProductInAGrid));
        ...
        {
            int result = PE_00000011_LargestProductInAGrid.Solution_0_Test(input);
