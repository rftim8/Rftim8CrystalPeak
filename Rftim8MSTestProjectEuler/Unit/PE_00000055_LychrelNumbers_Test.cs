...
{
    [TestClass]
    public sealed class PE_00000055_LychrelNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000055_LychrelNumbers));
        ...
        {
            int result = PE_00000055_LychrelNumbers.Solution_0_Test(input);
