...
{
    [TestClass]
    public sealed class PE_00000310_NimSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000310_NimSquare));
        ...
        {
            int result = PE_00000310_NimSquare.Solution_0_Test(input);
