...
{
    [TestClass]
    public sealed class PE_00000623_LambdaCount_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000623_LambdaCount));
        ...
        {
            int result = PE_00000623_LambdaCount.Solution_0_Test(input);
