...
{
    [TestClass]
    public sealed class PE_00000292_PythagoreanPolygons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000292_PythagoreanPolygons));
        ...
        {
            int result = PE_00000292_PythagoreanPolygons.Solution_0_Test(input);
