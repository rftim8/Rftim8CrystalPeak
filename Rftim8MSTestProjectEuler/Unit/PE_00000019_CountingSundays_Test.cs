...
{
    [TestClass]
    public sealed class PE_00000019_CountingSundays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000019_CountingSundays));
        ...
        {
            int result = PE_00000019_CountingSundays.Solution_0_Test(input);
