...
{
    [TestClass]
    public sealed class PE_00000450_HypocycloidAndLatticePoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000450_HypocycloidAndLatticePoints));
        ...
        {
            int result = PE_00000450_HypocycloidAndLatticePoints.Solution_0_Test(input);
