...
{
    [TestClass]
    public sealed class PE_00000067_MaximumPathSumII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000067_MaximumPathSumII));
        ...
        {
            int result = PE_00000067_MaximumPathSumII.Solution_0_Test(input);
