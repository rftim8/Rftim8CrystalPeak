...
{
    [TestClass]
    public sealed class PE_00000444_TheRoundtableLottery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000444_TheRoundtableLottery));
        ...
        {
            int result = PE_00000444_TheRoundtableLottery.Solution_0_Test(input);
