...
{
    [TestClass]
    public sealed class PE_00000594_RhombusTilings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000594_RhombusTilings));
        ...
        {
            int result = PE_00000594_RhombusTilings.Solution_0_Test(input);
