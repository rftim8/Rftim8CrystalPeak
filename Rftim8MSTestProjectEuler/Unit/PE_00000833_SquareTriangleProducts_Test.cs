...
{
    [TestClass]
    public sealed class PE_00000833_SquareTriangleProducts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000833_SquareTriangleProducts));
        ...
        {
            int result = PE_00000833_SquareTriangleProducts.Solution_0_Test(input);
