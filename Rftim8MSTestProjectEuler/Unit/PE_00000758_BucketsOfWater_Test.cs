...
{
    [TestClass]
    public sealed class PE_00000758_BucketsOfWater_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000758_BucketsOfWater));
        ...
        {
            int result = PE_00000758_BucketsOfWater.Solution_0_Test(input);
