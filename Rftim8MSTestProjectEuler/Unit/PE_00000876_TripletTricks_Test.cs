...
{
    [TestClass]
    public sealed class PE_00000876_TripletTricks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000876_TripletTricks));
        ...
        {
            int result = PE_00000876_TripletTricks.Solution_0_Test(input);
