...
{
    [TestClass]
    public sealed class PE_00000681_MaximalArea_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000681_MaximalArea));
        ...
        {
            int result = PE_00000681_MaximalArea.Solution_0_Test(input);
