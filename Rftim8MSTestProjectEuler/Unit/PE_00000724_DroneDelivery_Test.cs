...
{
    [TestClass]
    public sealed class PE_00000724_DroneDelivery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000724_DroneDelivery));
        ...
        {
            int result = PE_00000724_DroneDelivery.Solution_0_Test(input);
