...
{
    [TestClass]
    public sealed class PE_00000336_MaximixArrangements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000336_MaximixArrangements));
        ...
        {
            int result = PE_00000336_MaximixArrangements.Solution_0_Test(input);
