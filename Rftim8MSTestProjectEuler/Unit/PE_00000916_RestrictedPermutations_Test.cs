...
{
    [TestClass]
    public sealed class PE_00000916_RestrictedPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000916_RestrictedPermutations));
        ...
        {
            int result = PE_00000916_RestrictedPermutations.Solution_0_Test(input);
