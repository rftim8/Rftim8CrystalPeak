...
{
    [TestClass]
    public sealed class PE_00000029_DistinctPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000029_DistinctPowers));
        ...
        {
            int result = PE_00000029_DistinctPowers.Solution_0_Test(input);
