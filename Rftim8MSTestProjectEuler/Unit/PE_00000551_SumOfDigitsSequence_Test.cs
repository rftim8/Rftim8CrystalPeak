...
{
    [TestClass]
    public sealed class PE_00000551_SumOfDigitsSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000551_SumOfDigitsSequence));
        ...
        {
            int result = PE_00000551_SumOfDigitsSequence.Solution_0_Test(input);
