...
{
    [TestClass]
    public sealed class PE_00000917_MinimalPathUsingAdditiveCost_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000917_MinimalPathUsingAdditiveCost));
        ...
        {
            int result = PE_00000917_MinimalPathUsingAdditiveCost.Solution_0_Test(input);
