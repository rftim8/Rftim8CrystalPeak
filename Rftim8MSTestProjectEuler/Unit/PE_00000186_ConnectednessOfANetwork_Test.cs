...
{
    [TestClass]
    public sealed class PE_00000186_ConnectednessOfANetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000186_ConnectednessOfANetwork));
        ...
        {
            int result = PE_00000186_ConnectednessOfANetwork.Solution_0_Test(input);
