...
{
    [TestClass]
    public sealed class PE_00000918_RecursiveSequenceSummation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000918_RecursiveSequenceSummation));
        ...
        {
            int result = PE_00000918_RecursiveSequenceSummation.Solution_0_Test(input);
