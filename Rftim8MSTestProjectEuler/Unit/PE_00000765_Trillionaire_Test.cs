...
{
    [TestClass]
    public sealed class PE_00000765_Trillionaire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000765_Trillionaire));
        ...
        {
            int result = PE_00000765_Trillionaire.Solution_0_Test(input);
