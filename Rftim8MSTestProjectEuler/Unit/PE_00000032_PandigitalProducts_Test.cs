...
{
    [TestClass]
    public sealed class PE_00000032_PandigitalProducts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000032_PandigitalProducts));
        ...
        {
            int result = PE_00000032_PandigitalProducts.Solution_0_Test(input);
