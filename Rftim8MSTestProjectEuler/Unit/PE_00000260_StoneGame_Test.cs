...
{
    [TestClass]
    public sealed class PE_00000260_StoneGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000260_StoneGame));
        ...
        {
            int result = PE_00000260_StoneGame.Solution_0_Test(input);
