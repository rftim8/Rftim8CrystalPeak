...
{
    [TestClass]
    public sealed class PE_00000077_PrimeSummations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000077_PrimeSummations));
        ...
        {
            int result = PE_00000077_PrimeSummations.Solution_0_Test(input);
