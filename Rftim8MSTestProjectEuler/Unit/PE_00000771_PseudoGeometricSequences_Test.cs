...
{
    [TestClass]
    public sealed class PE_00000771_PseudoGeometricSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000771_PseudoGeometricSequences));
        ...
        {
            int result = PE_00000771_PseudoGeometricSequences.Solution_0_Test(input);
