...
{
    [TestClass]
    public sealed class PE_00000726_FallingBottles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000726_FallingBottles));
        ...
        {
            int result = PE_00000726_FallingBottles.Solution_0_Test(input);
