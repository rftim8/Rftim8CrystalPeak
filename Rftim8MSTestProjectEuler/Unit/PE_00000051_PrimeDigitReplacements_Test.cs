...
{
    [TestClass]
    public sealed class PE_00000051_PrimeDigitReplacements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000051_PrimeDigitReplacements));
        ...
        {
            int result = PE_00000051_PrimeDigitReplacements.Solution_0_Test(input);
