...
{
    [TestClass]
    public sealed class PE_00000563_RobotWelders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000563_RobotWelders));
        ...
        {
            int result = PE_00000563_RobotWelders.Solution_0_Test(input);
