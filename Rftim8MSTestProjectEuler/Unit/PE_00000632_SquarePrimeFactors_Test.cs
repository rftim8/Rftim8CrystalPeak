...
{
    [TestClass]
    public sealed class PE_00000632_SquarePrimeFactors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000632_SquarePrimeFactors));
        ...
        {
            int result = PE_00000632_SquarePrimeFactors.Solution_0_Test(input);
