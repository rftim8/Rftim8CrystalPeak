...
{
    [TestClass]
    public sealed class PE_00000089_RomanNumerals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000089_RomanNumerals));
        ...
        {
            int result = PE_00000089_RomanNumerals.Solution_0_Test(input);
