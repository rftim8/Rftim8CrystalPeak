...
{
    [TestClass]
    public sealed class PE_00000254_SumsOfDigitFactorials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000254_SumsOfDigitFactorials));
        ...
        {
            int result = PE_00000254_SumsOfDigitFactorials.Solution_0_Test(input);
