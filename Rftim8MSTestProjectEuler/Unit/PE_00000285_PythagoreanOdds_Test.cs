...
{
    [TestClass]
    public sealed class PE_00000285_PythagoreanOdds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000285_PythagoreanOdds));
        ...
        {
            int result = PE_00000285_PythagoreanOdds.Solution_0_Test(input);
