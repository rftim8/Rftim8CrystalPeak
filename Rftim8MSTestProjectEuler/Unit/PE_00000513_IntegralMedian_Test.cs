...
{
    [TestClass]
    public sealed class PE_00000513_IntegralMedian_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000513_IntegralMedian));
        ...
        {
            int result = PE_00000513_IntegralMedian.Solution_0_Test(input);
