...
{
    [TestClass]
    public sealed class PE_00000014_LongestCollatzSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000014_LongestCollatzSequence));
        ...
        {
            int result = PE_00000014_LongestCollatzSequence.Solution_0_Test(input);
