...
{
    [TestClass]
    public sealed class PE_00000665_ProportionateNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000665_ProportionateNim));
        ...
        {
            int result = PE_00000665_ProportionateNim.Solution_0_Test(input);
