...
{
    [TestClass]
    public sealed class PE_00000097_LargeNonMersennePrime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000097_LargeNonMersennePrime));
        ...
        {
            int result = PE_00000097_LargeNonMersennePrime.Solution_0_Test(input);
