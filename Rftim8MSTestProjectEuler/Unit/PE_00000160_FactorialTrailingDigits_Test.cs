...
{
    [TestClass]
    public sealed class PE_00000160_FactorialTrailingDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000160_FactorialTrailingDigits));
        ...
        {
            int result = PE_00000160_FactorialTrailingDigits.Solution_0_Test(input);
