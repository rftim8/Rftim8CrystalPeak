...
{
    [TestClass]
    public sealed class PE_00000783_Urns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000783_Urns));
        ...
        {
            int result = PE_00000783_Urns.Solution_0_Test(input);
