...
{
    [TestClass]
    public sealed class PE_00000503_CompromiseOrPersist_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000503_CompromiseOrPersist));
        ...
        {
            int result = PE_00000503_CompromiseOrPersist.Solution_0_Test(input);
