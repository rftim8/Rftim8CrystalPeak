...
{
    [TestClass]
    public sealed class PE_00000017_NumberLetterCounts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000017_NumberLetterCounts));
        ...
        {
            int result = PE_00000017_NumberLetterCounts.Solution_0_Test(input);
