...
{
    [TestClass]
    public sealed class PE_00000683_TheChaseII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000683_TheChaseII));
        ...
        {
            int result = PE_00000683_TheChaseII.Solution_0_Test(input);
