...
{
    [TestClass]
    public sealed class PE_00000149_MaximumsumSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000149_MaximumsumSubsequence));
        ...
        {
            int result = PE_00000149_MaximumsumSubsequence.Solution_0_Test(input);
