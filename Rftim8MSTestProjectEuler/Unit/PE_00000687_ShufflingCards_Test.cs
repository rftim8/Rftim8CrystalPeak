...
{
    [TestClass]
    public sealed class PE_00000687_ShufflingCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000687_ShufflingCards));
        ...
        {
            int result = PE_00000687_ShufflingCards.Solution_0_Test(input);
