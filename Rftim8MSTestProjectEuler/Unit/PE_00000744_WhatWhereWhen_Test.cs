...
{
    [TestClass]
    public sealed class PE_00000744_WhatWhereWhen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000744_WhatWhereWhen));
        ...
        {
            int result = PE_00000744_WhatWhereWhen.Solution_0_Test(input);
