...
{
    [TestClass]
    public sealed class PE_00000611_HallwayOfSquareSteps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000611_HallwayOfSquareSteps));
        ...
        {
            int result = PE_00000611_HallwayOfSquareSteps.Solution_0_Test(input);
