...
{
    [TestClass]
    public sealed class PE_00000437_FibonacciPrimitiveRoots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000437_FibonacciPrimitiveRoots));
        ...
        {
            int result = PE_00000437_FibonacciPrimitiveRoots.Solution_0_Test(input);
