...
{
    [TestClass]
    public sealed class PE_00000039_IntegerRightTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000039_IntegerRightTriangles));
        ...
        {
            int result = PE_00000039_IntegerRightTriangles.Solution_0_Test(input);
