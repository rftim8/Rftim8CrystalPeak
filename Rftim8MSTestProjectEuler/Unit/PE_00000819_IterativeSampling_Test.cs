...
{
    [TestClass]
    public sealed class PE_00000819_IterativeSampling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000819_IterativeSampling));
        ...
        {
            int result = PE_00000819_IterativeSampling.Solution_0_Test(input);
