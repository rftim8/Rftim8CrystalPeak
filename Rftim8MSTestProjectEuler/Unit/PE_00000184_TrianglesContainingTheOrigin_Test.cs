...
{
    [TestClass]
    public sealed class PE_00000184_TrianglesContainingTheOrigin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000184_TrianglesContainingTheOrigin));
        ...
        {
            int result = PE_00000184_TrianglesContainingTheOrigin.Solution_0_Test(input);
