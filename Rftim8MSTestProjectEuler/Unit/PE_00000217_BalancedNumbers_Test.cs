...
{
    [TestClass]
    public sealed class PE_00000217_BalancedNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000217_BalancedNumbers));
        ...
        {
            int result = PE_00000217_BalancedNumbers.Solution_0_Test(input);
