...
{
    [TestClass]
    public sealed class PE_00000409_NimExtreme_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000409_NimExtreme));
        ...
        {
            int result = PE_00000409_NimExtreme.Solution_0_Test(input);
