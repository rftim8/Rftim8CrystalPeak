...
{
    [TestClass]
    public sealed class PE_00000589_PoohsticksMarathon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000589_PoohsticksMarathon));
        ...
        {
            int result = PE_00000589_PoohsticksMarathon.Solution_0_Test(input);
