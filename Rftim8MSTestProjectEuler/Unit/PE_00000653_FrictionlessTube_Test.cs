...
{
    [TestClass]
    public sealed class PE_00000653_FrictionlessTube_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000653_FrictionlessTube));
        ...
        {
            int result = PE_00000653_FrictionlessTube.Solution_0_Test(input);
