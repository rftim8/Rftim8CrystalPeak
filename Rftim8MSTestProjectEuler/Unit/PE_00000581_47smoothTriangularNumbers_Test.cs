...
{
    [TestClass]
    public sealed class PE_00000581_47smoothTriangularNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000581_47smoothTriangularNumbers));
        ...
        {
            int result = PE_00000581_47smoothTriangularNumbers.Solution_0_Test(input);
