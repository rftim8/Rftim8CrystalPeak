...
{
    [TestClass]
    public sealed class PE_00000805_ShiftedMultiples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000805_ShiftedMultiples));
        ...
        {
            int result = PE_00000805_ShiftedMultiples.Solution_0_Test(input);
