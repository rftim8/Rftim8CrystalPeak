...
{
    [TestClass]
    public sealed class PE_00000172_FewRepeatedDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000172_FewRepeatedDigits));
        ...
        {
            int result = PE_00000172_FewRepeatedDigits.Solution_0_Test(input);
