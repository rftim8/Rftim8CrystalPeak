...
{
    [TestClass]
    public sealed class PE_00000432_TotientSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000432_TotientSum));
        ...
        {
            int result = PE_00000432_TotientSum.Solution_0_Test(input);
