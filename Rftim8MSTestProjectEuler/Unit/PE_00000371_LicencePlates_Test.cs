...
{
    [TestClass]
    public sealed class PE_00000371_LicencePlates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000371_LicencePlates));
        ...
        {
            int result = PE_00000371_LicencePlates.Solution_0_Test(input);
