...
{
    [TestClass]
    public sealed class PE_00000561_DivisorPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000561_DivisorPairs));
        ...
        {
            int result = PE_00000561_DivisorPairs.Solution_0_Test(input);
