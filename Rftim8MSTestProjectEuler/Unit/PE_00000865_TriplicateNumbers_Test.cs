...
{
    [TestClass]
    public sealed class PE_00000865_TriplicateNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000865_TriplicateNumbers));
        ...
        {
            int result = PE_00000865_TriplicateNumbers.Solution_0_Test(input);
