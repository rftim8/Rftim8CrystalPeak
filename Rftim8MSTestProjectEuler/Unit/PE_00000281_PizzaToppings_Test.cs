...
{
    [TestClass]
    public sealed class PE_00000281_PizzaToppings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000281_PizzaToppings));
        ...
        {
            int result = PE_00000281_PizzaToppings.Solution_0_Test(input);
