...
{
    [TestClass]
    public sealed class PE_00000473_PhigitalNumberBase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000473_PhigitalNumberBase));
        ...
        {
            int result = PE_00000473_PhigitalNumberBase.Solution_0_Test(input);
