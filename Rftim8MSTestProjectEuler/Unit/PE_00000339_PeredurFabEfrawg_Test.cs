...
{
    [TestClass]
    public sealed class PE_00000339_PeredurFabEfrawg_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000339_PeredurFabEfrawg));
        ...
        {
            int result = PE_00000339_PeredurFabEfrawg.Solution_0_Test(input);
