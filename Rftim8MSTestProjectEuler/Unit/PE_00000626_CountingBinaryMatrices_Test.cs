...
{
    [TestClass]
    public sealed class PE_00000626_CountingBinaryMatrices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000626_CountingBinaryMatrices));
        ...
        {
            int result = PE_00000626_CountingBinaryMatrices.Solution_0_Test(input);
