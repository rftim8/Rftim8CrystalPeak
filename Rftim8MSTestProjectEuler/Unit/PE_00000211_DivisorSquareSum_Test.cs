...
{
    [TestClass]
    public sealed class PE_00000211_DivisorSquareSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000211_DivisorSquareSum));
        ...
        {
            int result = PE_00000211_DivisorSquareSum.Solution_0_Test(input);
