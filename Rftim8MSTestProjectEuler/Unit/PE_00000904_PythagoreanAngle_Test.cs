...
{
    [TestClass]
    public sealed class PE_00000904_PythagoreanAngle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000904_PythagoreanAngle));
        ...
        {
            int result = PE_00000904_PythagoreanAngle.Solution_0_Test(input);
