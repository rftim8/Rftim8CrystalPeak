...
{
    [TestClass]
    public sealed class PE_00000788_DominatingNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000788_DominatingNumbers));
        ...
        {
            int result = PE_00000788_DominatingNumbers.Solution_0_Test(input);
