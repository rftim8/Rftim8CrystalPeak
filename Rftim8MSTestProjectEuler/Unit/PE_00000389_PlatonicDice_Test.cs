...
{
    [TestClass]
    public sealed class PE_00000389_PlatonicDice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000389_PlatonicDice));
        ...
        {
            int result = PE_00000389_PlatonicDice.Solution_0_Test(input);
