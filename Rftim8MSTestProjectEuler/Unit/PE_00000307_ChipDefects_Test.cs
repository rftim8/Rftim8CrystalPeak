...
{
    [TestClass]
    public sealed class PE_00000307_ChipDefects_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000307_ChipDefects));
        ...
        {
            int result = PE_00000307_ChipDefects.Solution_0_Test(input);
