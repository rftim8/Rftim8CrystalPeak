...
{
    [TestClass]
    public sealed class PE_00000803_PseudorandomSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000803_PseudorandomSequence));
        ...
        {
            int result = PE_00000803_PseudorandomSequence.Solution_0_Test(input);
