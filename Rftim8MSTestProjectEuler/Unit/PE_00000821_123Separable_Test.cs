...
{
    [TestClass]
    public sealed class PE_00000821_123Separable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000821_123Separable));
        ...
        {
            int result = PE_00000821_123Separable.Solution_0_Test(input);
