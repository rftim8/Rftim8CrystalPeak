...
{
    [TestClass]
    public sealed class PE_00000886_CoprimePermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000886_CoprimePermutations));
        ...
        {
            int result = PE_00000886_CoprimePermutations.Solution_0_Test(input);
