...
{
    [TestClass]
    public sealed class PE_00000760_SumOverBitwiseOperators_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000760_SumOverBitwiseOperators));
        ...
        {
            int result = PE_00000760_SumOverBitwiseOperators.Solution_0_Test(input);
