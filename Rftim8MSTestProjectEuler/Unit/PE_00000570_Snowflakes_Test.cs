...
{
    [TestClass]
    public sealed class PE_00000570_Snowflakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000570_Snowflakes));
        ...
        {
            int result = PE_00000570_Snowflakes.Solution_0_Test(input);
