...
{
    [TestClass]
    public sealed class PE_00000398_CuttingRope_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000398_CuttingRope));
        ...
        {
            int result = PE_00000398_CuttingRope.Solution_0_Test(input);
