...
{
    [TestClass]
    public sealed class PE_00000870_StoneGameIV_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000870_StoneGameIV));
        ...
        {
            int result = PE_00000870_StoneGameIV.Solution_0_Test(input);
