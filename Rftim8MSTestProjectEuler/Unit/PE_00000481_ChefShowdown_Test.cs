...
{
    [TestClass]
    public sealed class PE_00000481_ChefShowdown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000481_ChefShowdown));
        ...
        {
            int result = PE_00000481_ChefShowdown.Solution_0_Test(input);
