...
{
    [TestClass]
    public sealed class PE_00000144_LaserBeamReflections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000144_LaserBeamReflections));
        ...
        {
            int result = PE_00000144_LaserBeamReflections.Solution_0_Test(input);
