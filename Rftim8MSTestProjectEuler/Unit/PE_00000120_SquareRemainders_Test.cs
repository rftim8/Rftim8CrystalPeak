...
{
    [TestClass]
    public sealed class PE_00000120_SquareRemainders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000120_SquareRemainders));
        ...
        {
            int result = PE_00000120_SquareRemainders.Solution_0_Test(input);
