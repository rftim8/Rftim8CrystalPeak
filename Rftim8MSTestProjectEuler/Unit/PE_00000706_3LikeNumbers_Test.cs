...
{
    [TestClass]
    public sealed class PE_00000706_3LikeNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000706_3LikeNumbers));
        ...
        {
            int result = PE_00000706_3LikeNumbers.Solution_0_Test(input);
