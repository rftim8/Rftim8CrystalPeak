...
{
    [TestClass]
    public sealed class PE_00000124_OrderedRadicals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000124_OrderedRadicals));
        ...
        {
            int result = PE_00000124_OrderedRadicals.Solution_0_Test(input);
