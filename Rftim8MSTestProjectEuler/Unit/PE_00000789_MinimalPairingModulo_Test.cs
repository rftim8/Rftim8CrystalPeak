...
{
    [TestClass]
    public sealed class PE_00000789_MinimalPairingModulo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000789_MinimalPairingModulo));
        ...
        {
            int result = PE_00000789_MinimalPairingModulo.Solution_0_Test(input);
