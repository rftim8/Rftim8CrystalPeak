...
{
    [TestClass]
    public sealed class PE_00000428_NecklaceOfCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000428_NecklaceOfCircles));
        ...
        {
            int result = PE_00000428_NecklaceOfCircles.Solution_0_Test(input);
