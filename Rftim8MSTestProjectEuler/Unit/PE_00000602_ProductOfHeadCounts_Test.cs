...
{
    [TestClass]
    public sealed class PE_00000602_ProductOfHeadCounts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000602_ProductOfHeadCounts));
        ...
        {
            int result = PE_00000602_ProductOfHeadCounts.Solution_0_Test(input);
