...
{
    [TestClass]
    public sealed class PE_00000395_PythagoreanTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000395_PythagoreanTree));
        ...
        {
            int result = PE_00000395_PythagoreanTree.Solution_0_Test(input);
