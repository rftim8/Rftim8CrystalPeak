...
{
    [TestClass]
    public sealed class PE_00000729_RangeOfPeriodicSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000729_RangeOfPeriodicSequence));
        ...
        {
            int result = PE_00000729_RangeOfPeriodicSequence.Solution_0_Test(input);
