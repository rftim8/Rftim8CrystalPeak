...
{
    [TestClass]
    public sealed class PE_00000223_AlmostRightangledTrianglesI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000223_AlmostRightangledTrianglesI));
        ...
        {
            int result = PE_00000223_AlmostRightangledTrianglesI.Solution_0_Test(input);
