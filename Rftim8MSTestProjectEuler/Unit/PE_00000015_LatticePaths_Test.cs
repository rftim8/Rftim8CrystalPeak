...
{
    [TestClass]
    public sealed class PE_00000015_LatticePaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000015_LatticePaths));
        ...
        {
            int result = PE_00000015_LatticePaths.Solution_0_Test(input);
