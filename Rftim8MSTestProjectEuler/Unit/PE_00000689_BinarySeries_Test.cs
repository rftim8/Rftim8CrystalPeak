...
{
    [TestClass]
    public sealed class PE_00000689_BinarySeries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000689_BinarySeries));
        ...
        {
            int result = PE_00000689_BinarySeries.Solution_0_Test(input);
