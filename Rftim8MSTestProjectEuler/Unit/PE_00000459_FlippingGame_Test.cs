...
{
    [TestClass]
    public sealed class PE_00000459_FlippingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000459_FlippingGame));
        ...
        {
            int result = PE_00000459_FlippingGame.Solution_0_Test(input);
