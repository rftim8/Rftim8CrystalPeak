...
{
    [TestClass]
    public sealed class PE_00000303_MultiplesWithSmallDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000303_MultiplesWithSmallDigits));
        ...
        {
            int result = PE_00000303_MultiplesWithSmallDigits.Solution_0_Test(input);
