...
{
    [TestClass]
    public sealed class PE_00000556_SquarefreeGaussianIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000556_SquarefreeGaussianIntegers));
        ...
        {
            int result = PE_00000556_SquarefreeGaussianIntegers.Solution_0_Test(input);
