...
{
    [TestClass]
    public sealed class PE_00000351_HexagonalOrchards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000351_HexagonalOrchards));
        ...
        {
            int result = PE_00000351_HexagonalOrchards.Solution_0_Test(input);
