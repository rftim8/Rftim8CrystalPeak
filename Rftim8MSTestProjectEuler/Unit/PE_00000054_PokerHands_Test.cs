...
{
    [TestClass]
    public sealed class PE_00000054_PokerHands_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000054_PokerHands));
        ...
        {
            int result = PE_00000054_PokerHands.Solution_0_Test(input);
