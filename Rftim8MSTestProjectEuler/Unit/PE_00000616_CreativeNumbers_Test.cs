...
{
    [TestClass]
    public sealed class PE_00000616_CreativeNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000616_CreativeNumbers));
        ...
        {
            int result = PE_00000616_CreativeNumbers.Solution_0_Test(input);
