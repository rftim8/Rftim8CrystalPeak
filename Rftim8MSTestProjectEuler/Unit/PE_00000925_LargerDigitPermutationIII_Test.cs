...
{
    [TestClass]
    public sealed class PE_00000925_LargerDigitPermutationIII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000925_LargerDigitPermutationIII));
        ...
        {
            int result = PE_00000925_LargerDigitPermutationIII.Solution_0_Test(input);
