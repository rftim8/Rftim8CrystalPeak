...
{
    [TestClass]
    public sealed class PE_00000858_LCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000858_LCM));
        ...
        {
            int result = PE_00000858_LCM.Solution_0_Test(input);
