...
{
    [TestClass]
    public sealed class PE_00000434_RigidGraphs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000434_RigidGraphs));
        ...
        {
            int result = PE_00000434_RigidGraphs.Solution_0_Test(input);
