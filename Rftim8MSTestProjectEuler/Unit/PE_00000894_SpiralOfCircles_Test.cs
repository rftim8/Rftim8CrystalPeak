...
{
    [TestClass]
    public sealed class PE_00000894_SpiralOfCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000894_SpiralOfCircles));
        ...
        {
            int result = PE_00000894_SpiralOfCircles.Solution_0_Test(input);
