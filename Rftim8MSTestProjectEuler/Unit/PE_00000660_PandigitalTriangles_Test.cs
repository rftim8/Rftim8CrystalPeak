...
{
    [TestClass]
    public sealed class PE_00000660_PandigitalTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000660_PandigitalTriangles));
        ...
        {
            int result = PE_00000660_PandigitalTriangles.Solution_0_Test(input);
