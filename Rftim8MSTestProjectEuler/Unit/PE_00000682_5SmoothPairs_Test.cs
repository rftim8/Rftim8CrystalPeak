...
{
    [TestClass]
    public sealed class PE_00000682_5SmoothPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000682_5SmoothPairs));
        ...
        {
            int result = PE_00000682_5SmoothPairs.Solution_0_Test(input);
