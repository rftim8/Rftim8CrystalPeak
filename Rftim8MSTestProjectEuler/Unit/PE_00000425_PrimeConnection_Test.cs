...
{
    [TestClass]
    public sealed class PE_00000425_PrimeConnection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000425_PrimeConnection));
        ...
        {
            int result = PE_00000425_PrimeConnection.Solution_0_Test(input);
