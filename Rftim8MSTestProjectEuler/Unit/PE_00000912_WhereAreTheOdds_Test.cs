...
{
    [TestClass]
    public sealed class PE_00000912_WhereAreTheOdds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000912_WhereAreTheOdds));
        ...
        {
            int result = PE_00000912_WhereAreTheOdds.Solution_0_Test(input);
