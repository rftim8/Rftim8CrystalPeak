...
{
    [TestClass]
    public sealed class PE_00000809_RationalRecurrenceRelation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000809_RationalRecurrenceRelation));
        ...
        {
            int result = PE_00000809_RationalRecurrenceRelation.Solution_0_Test(input);
