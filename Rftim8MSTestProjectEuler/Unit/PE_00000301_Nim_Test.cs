...
{
    [TestClass]
    public sealed class PE_00000301_Nim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000301_Nim));
        ...
        {
            int result = PE_00000301_Nim.Solution_0_Test(input);
