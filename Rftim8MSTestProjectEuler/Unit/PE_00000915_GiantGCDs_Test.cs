...
{
    [TestClass]
    public sealed class PE_00000915_GiantGCDs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000915_GiantGCDs));
        ...
        {
            int result = PE_00000915_GiantGCDs.Solution_0_Test(input);
