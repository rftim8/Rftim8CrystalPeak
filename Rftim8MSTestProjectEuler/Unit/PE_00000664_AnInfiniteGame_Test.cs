...
{
    [TestClass]
    public sealed class PE_00000664_AnInfiniteGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000664_AnInfiniteGame));
        ...
        {
            int result = PE_00000664_AnInfiniteGame.Solution_0_Test(input);
