...
{
    [TestClass]
    public sealed class PE_00000504_SquareOnTheInside_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000504_SquareOnTheInside));
        ...
        {
            int result = PE_00000504_SquareOnTheInside.Solution_0_Test(input);
