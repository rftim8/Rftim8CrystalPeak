...
{
    [TestClass]
    public sealed class PE_00000418_FactorisationTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000418_FactorisationTriples));
        ...
        {
            int result = PE_00000418_FactorisationTriples.Solution_0_Test(input);
