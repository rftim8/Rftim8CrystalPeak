...
{
    [TestClass]
    public sealed class PE_00000330_EulersNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000330_EulersNumber));
        ...
        {
            int result = PE_00000330_EulersNumber.Solution_0_Test(input);
