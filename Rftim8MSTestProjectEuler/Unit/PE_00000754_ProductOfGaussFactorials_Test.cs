...
{
    [TestClass]
    public sealed class PE_00000754_ProductOfGaussFactorials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000754_ProductOfGaussFactorials));
        ...
        {
            int result = PE_00000754_ProductOfGaussFactorials.Solution_0_Test(input);
