...
{
    [TestClass]
    public sealed class PE_00000399_SquarefreeFibonacciNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000399_SquarefreeFibonacciNumbers));
        ...
        {
            int result = PE_00000399_SquarefreeFibonacciNumbers.Solution_0_Test(input);
