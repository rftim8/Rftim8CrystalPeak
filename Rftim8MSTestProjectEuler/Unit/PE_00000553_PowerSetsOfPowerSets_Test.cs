...
{
    [TestClass]
    public sealed class PE_00000553_PowerSetsOfPowerSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000553_PowerSetsOfPowerSets));
        ...
        {
            int result = PE_00000553_PowerSetsOfPowerSets.Solution_0_Test(input);
