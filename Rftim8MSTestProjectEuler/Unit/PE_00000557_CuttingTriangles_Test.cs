...
{
    [TestClass]
    public sealed class PE_00000557_CuttingTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000557_CuttingTriangles));
        ...
        {
            int result = PE_00000557_CuttingTriangles.Solution_0_Test(input);
