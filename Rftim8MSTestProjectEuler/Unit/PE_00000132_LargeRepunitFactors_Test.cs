...
{
    [TestClass]
    public sealed class PE_00000132_LargeRepunitFactors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000132_LargeRepunitFactors));
        ...
        {
            int result = PE_00000132_LargeRepunitFactors.Solution_0_Test(input);
