...
{
    [TestClass]
    public sealed class PE_00000675_2PowOmegaxN_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000675_2PowOmegaxN));
        ...
        {
            int result = PE_00000675_2PowOmegaxN.Solution_0_Test(input);
