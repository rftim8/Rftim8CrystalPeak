...
{
    [TestClass]
    public sealed class PE_00000762_AmoebasInA2DGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000762_AmoebasInA2DGrid));
        ...
        {
            int result = PE_00000762_AmoebasInA2DGrid.Solution_0_Test(input);
