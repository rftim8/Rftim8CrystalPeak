...
{
    [TestClass]
    public sealed class PE_00000810_XORPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000810_XORPrimes));
        ...
        {
            int result = PE_00000810_XORPrimes.Solution_0_Test(input);
