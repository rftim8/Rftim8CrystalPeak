...
{
    [TestClass]
    public sealed class PE_00000340_CrazyFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000340_CrazyFunction));
        ...
        {
            int result = PE_00000340_CrazyFunction.Solution_0_Test(input);
