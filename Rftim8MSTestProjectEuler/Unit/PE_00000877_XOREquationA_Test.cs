...
{
    [TestClass]
    public sealed class PE_00000877_XOREquationA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000877_XOREquationA));
        ...
        {
            int result = PE_00000877_XOREquationA.Solution_0_Test(input);
