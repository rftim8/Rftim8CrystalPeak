...
{
    [TestClass]
    public sealed class PE_00000143_TorricelliTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000143_TorricelliTriangles));
        ...
        {
            int result = PE_00000143_TorricelliTriangles.Solution_0_Test(input);
