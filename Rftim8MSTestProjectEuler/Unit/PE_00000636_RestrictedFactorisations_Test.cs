...
{
    [TestClass]
    public sealed class PE_00000636_RestrictedFactorisations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000636_RestrictedFactorisations));
        ...
        {
            int result = PE_00000636_RestrictedFactorisations.Solution_0_Test(input);
