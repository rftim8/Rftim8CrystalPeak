...
{
    [TestClass]
    public sealed class PE_00000439_SumOfSumOfDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000439_SumOfSumOfDivisors));
        ...
        {
            int result = PE_00000439_SumOfSumOfDivisors.Solution_0_Test(input);
