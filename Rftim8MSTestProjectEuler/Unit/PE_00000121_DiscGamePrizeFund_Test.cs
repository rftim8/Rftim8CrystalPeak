...
{
    [TestClass]
    public sealed class PE_00000121_DiscGamePrizeFund_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000121_DiscGamePrizeFund));
        ...
        {
            int result = PE_00000121_DiscGamePrizeFund.Solution_0_Test(input);
