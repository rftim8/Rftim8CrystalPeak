...
{
    [TestClass]
    public sealed class PE_00000840_SumOfProducts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000840_SumOfProducts));
        ...
        {
            int result = PE_00000840_SumOfProducts.Solution_0_Test(input);
