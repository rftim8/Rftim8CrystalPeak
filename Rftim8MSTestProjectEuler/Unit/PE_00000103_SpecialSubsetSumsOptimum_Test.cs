...
{
    [TestClass]
    public sealed class PE_00000103_SpecialSubsetSumsOptimum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000103_SpecialSubsetSumsOptimum));
        ...
        {
            int result = PE_00000103_SpecialSubsetSumsOptimum.Solution_0_Test(input);
