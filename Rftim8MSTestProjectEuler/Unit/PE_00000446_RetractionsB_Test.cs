...
{
    [TestClass]
    public sealed class PE_00000446_RetractionsB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000446_RetractionsB));
        ...
        {
            int result = PE_00000446_RetractionsB.Solution_0_Test(input);
