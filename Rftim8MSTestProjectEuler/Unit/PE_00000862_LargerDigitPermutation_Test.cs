...
{
    [TestClass]
    public sealed class PE_00000862_LargerDigitPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000862_LargerDigitPermutation));
        ...
        {
            int result = PE_00000862_LargerDigitPermutation.Solution_0_Test(input);
