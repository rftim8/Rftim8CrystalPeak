...
{
    [TestClass]
    public sealed class PE_00000728_CircleOfCoins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000728_CircleOfCoins));
        ...
        {
            int result = PE_00000728_CircleOfCoins.Solution_0_Test(input);
