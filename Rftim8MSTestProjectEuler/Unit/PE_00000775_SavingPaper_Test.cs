...
{
    [TestClass]
    public sealed class PE_00000775_SavingPaper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000775_SavingPaper));
        ...
        {
            int result = PE_00000775_SavingPaper.Solution_0_Test(input);
