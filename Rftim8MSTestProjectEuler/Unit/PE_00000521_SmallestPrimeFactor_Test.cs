...
{
    [TestClass]
    public sealed class PE_00000521_SmallestPrimeFactor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000521_SmallestPrimeFactor));
        ...
        {
            int result = PE_00000521_SmallestPrimeFactor.Solution_0_Test(input);
