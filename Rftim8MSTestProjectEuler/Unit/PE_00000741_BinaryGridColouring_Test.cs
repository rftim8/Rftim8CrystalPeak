...
{
    [TestClass]
    public sealed class PE_00000741_BinaryGridColouring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000741_BinaryGridColouring));
        ...
        {
            int result = PE_00000741_BinaryGridColouring.Solution_0_Test(input);
