...
{
    [TestClass]
    public sealed class PE_00000719_NumberSplitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000719_NumberSplitting));
        ...
        {
            int result = PE_00000719_NumberSplitting.Solution_0_Test(input);
