...
{
    [TestClass]
    public sealed class PE_00000430_RangeFlips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000430_RangeFlips));
        ...
        {
            int result = PE_00000430_RangeFlips.Solution_0_Test(input);
