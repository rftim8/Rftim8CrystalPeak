...
{
    [TestClass]
    public sealed class PE_00000277_AModifiedCollatzSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000277_AModifiedCollatzSequence));
        ...
        {
            int result = PE_00000277_AModifiedCollatzSequence.Solution_0_Test(input);
