...
{
    [TestClass]
    public sealed class PE_00000191_PrizeStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000191_PrizeStrings));
        ...
        {
            int result = PE_00000191_PrizeStrings.Solution_0_Test(input);
