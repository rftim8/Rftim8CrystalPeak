...
{
    [TestClass]
    public sealed class PE_00000523_FirstSortI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000523_FirstSortI));
        ...
        {
            int result = PE_00000523_FirstSortI.Solution_0_Test(input);
