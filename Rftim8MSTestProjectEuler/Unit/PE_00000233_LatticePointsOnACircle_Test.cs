...
{
    [TestClass]
    public sealed class PE_00000233_LatticePointsOnACircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000233_LatticePointsOnACircle));
        ...
        {
            int result = PE_00000233_LatticePointsOnACircle.Solution_0_Test(input);
