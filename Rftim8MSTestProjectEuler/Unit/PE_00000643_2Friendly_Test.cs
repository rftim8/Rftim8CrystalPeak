...
{
    [TestClass]
    public sealed class PE_00000643_2Friendly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000643_2Friendly));
        ...
        {
            int result = PE_00000643_2Friendly.Solution_0_Test(input);
