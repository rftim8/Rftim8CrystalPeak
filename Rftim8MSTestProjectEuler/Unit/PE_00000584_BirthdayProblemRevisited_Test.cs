...
{
    [TestClass]
    public sealed class PE_00000584_BirthdayProblemRevisited_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000584_BirthdayProblemRevisited));
        ...
        {
            int result = PE_00000584_BirthdayProblemRevisited.Solution_0_Test(input);
