...
{
    [TestClass]
    public sealed class PE_00000867_TilingDodecagon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000867_TilingDodecagon));
        ...
        {
            int result = PE_00000867_TilingDodecagon.Solution_0_Test(input);
