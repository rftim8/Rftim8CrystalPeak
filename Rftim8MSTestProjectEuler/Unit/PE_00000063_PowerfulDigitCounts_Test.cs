...
{
    [TestClass]
    public sealed class PE_00000063_PowerfulDigitCounts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000063_PowerfulDigitCounts));
        ...
        {
            int result = PE_00000063_PowerfulDigitCounts.Solution_0_Test(input);
