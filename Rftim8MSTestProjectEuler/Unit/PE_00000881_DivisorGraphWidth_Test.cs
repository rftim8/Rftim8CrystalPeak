...
{
    [TestClass]
    public sealed class PE_00000881_DivisorGraphWidth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000881_DivisorGraphWidth));
        ...
        {
            int result = PE_00000881_DivisorGraphWidth.Solution_0_Test(input);
