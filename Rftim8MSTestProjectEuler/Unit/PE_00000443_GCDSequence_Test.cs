...
{
    [TestClass]
    public sealed class PE_00000443_GCDSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000443_GCDSequence));
        ...
        {
            int result = PE_00000443_GCDSequence.Solution_0_Test(input);
