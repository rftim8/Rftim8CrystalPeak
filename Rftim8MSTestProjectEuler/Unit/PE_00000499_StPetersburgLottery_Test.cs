...
{
    [TestClass]
    public sealed class PE_00000499_StPetersburgLottery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000499_StPetersburgLottery));
        ...
        {
            int result = PE_00000499_StPetersburgLottery.Solution_0_Test(input);
