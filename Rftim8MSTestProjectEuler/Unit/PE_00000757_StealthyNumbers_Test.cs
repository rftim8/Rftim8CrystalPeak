...
{
    [TestClass]
    public sealed class PE_00000757_StealthyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000757_StealthyNumbers));
        ...
        {
            int result = PE_00000757_StealthyNumbers.Solution_0_Test(input);
