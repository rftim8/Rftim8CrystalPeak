...
{
    [TestClass]
    public sealed class PE_00000539_OddElimination_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000539_OddElimination));
        ...
        {
            int result = PE_00000539_OddElimination.Solution_0_Test(input);
