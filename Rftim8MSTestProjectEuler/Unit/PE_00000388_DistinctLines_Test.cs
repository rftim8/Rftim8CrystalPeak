...
{
    [TestClass]
    public sealed class PE_00000388_DistinctLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000388_DistinctLines));
        ...
        {
            int result = PE_00000388_DistinctLines.Solution_0_Test(input);
