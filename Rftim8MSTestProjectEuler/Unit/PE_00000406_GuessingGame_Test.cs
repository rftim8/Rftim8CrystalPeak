...
{
    [TestClass]
    public sealed class PE_00000406_GuessingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000406_GuessingGame));
        ...
        {
            int result = PE_00000406_GuessingGame.Solution_0_Test(input);
