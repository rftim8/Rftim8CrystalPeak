...
{
    [TestClass]
    public sealed class PE_00000458_PermutationsOfProject_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000458_PermutationsOfProject));
        ...
        {
            int result = PE_00000458_PermutationsOfProject.Solution_0_Test(input);
