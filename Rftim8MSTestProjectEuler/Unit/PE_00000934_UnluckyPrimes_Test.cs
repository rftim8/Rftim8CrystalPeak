...
{
    [TestClass]
    public sealed class PE_00000934_UnluckyPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000934_UnluckyPrimes));
        ...
        {
            int result = PE_00000934_UnluckyPrimes.Solution_0_Test(input);
