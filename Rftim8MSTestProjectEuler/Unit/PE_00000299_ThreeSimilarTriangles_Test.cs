...
{
    [TestClass]
    public sealed class PE_00000299_ThreeSimilarTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000299_ThreeSimilarTriangles));
        ...
        {
            int result = PE_00000299_ThreeSimilarTriangles.Solution_0_Test(input);
