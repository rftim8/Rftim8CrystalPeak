...
{
    [TestClass]
    public sealed class PE_00000061_CyclicalFigurateNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000061_CyclicalFigurateNumbers));
        ...
        {
            int result = PE_00000061_CyclicalFigurateNumbers.Solution_0_Test(input);
