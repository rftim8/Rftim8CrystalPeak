...
{
    [TestClass]
    public sealed class PE_00000036_DoublebasePalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000036_DoublebasePalindromes));
        ...
        {
            int result = PE_00000036_DoublebasePalindromes.Solution_0_Test(input);
