...
{
    [TestClass]
    public sealed class PE_00000090_CubeDigitPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000090_CubeDigitPairs));
        ...
        {
            int result = PE_00000090_CubeDigitPairs.Solution_0_Test(input);
