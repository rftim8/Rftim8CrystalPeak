...
{
    [TestClass]
    public sealed class PE_00000348_SumOfASquareAndACube_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000348_SumOfASquareAndACube));
        ...
        {
            int result = PE_00000348_SumOfASquareAndACube.Solution_0_Test(input);
