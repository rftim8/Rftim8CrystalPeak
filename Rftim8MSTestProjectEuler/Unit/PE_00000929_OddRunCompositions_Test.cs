...
{
    [TestClass]
    public sealed class PE_00000929_OddRunCompositions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000929_OddRunCompositions));
        ...
        {
            int result = PE_00000929_OddRunCompositions.Solution_0_Test(input);
