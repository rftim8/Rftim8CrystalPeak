...
{
    [TestClass]
    public sealed class PE_00000086_CuboidRoute_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000086_CuboidRoute));
        ...
        {
            int result = PE_00000086_CuboidRoute.Solution_0_Test(input);
