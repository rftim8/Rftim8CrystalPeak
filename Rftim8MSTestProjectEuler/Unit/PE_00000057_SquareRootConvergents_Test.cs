...
{
    [TestClass]
    public sealed class PE_00000057_SquareRootConvergents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000057_SquareRootConvergents));
        ...
        {
            int result = PE_00000057_SquareRootConvergents.Solution_0_Test(input);
