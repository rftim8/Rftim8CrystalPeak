...
{
    [TestClass]
    public sealed class PE_00000252_ConvexHoles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000252_ConvexHoles));
        ...
        {
            int result = PE_00000252_ConvexHoles.Solution_0_Test(input);
