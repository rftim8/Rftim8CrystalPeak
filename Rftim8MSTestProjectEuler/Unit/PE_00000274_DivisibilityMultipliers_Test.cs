...
{
    [TestClass]
    public sealed class PE_00000274_DivisibilityMultipliers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000274_DivisibilityMultipliers));
        ...
        {
            int result = PE_00000274_DivisibilityMultipliers.Solution_0_Test(input);
