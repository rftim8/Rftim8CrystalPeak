...
{
    [TestClass]
    public sealed class PE_00000588_QuintinomialCoefficients_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000588_QuintinomialCoefficients));
        ...
        {
            int result = PE_00000588_QuintinomialCoefficients.Solution_0_Test(input);
