...
{
    [TestClass]
    public sealed class PE_00000538_MaximumQuadrilaterals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000538_MaximumQuadrilaterals));
        ...
        {
            int result = PE_00000538_MaximumQuadrilaterals.Solution_0_Test(input);
