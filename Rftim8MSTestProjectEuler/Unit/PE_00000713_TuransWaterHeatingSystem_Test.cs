...
{
    [TestClass]
    public sealed class PE_00000713_TuransWaterHeatingSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000713_TuransWaterHeatingSystem));
        ...
        {
            int result = PE_00000713_TuransWaterHeatingSystem.Solution_0_Test(input);
