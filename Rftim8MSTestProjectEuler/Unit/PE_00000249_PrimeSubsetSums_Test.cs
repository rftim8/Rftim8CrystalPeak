...
{
    [TestClass]
    public sealed class PE_00000249_PrimeSubsetSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000249_PrimeSubsetSums));
        ...
        {
            int result = PE_00000249_PrimeSubsetSums.Solution_0_Test(input);
