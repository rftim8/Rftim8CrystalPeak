...
{
    [TestClass]
    public sealed class PE_00000651_PatternedCylinders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000651_PatternedCylinders));
        ...
        {
            int result = PE_00000651_PatternedCylinders.Solution_0_Test(input);
