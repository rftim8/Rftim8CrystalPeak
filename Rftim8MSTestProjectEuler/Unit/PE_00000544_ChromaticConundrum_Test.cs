...
{
    [TestClass]
    public sealed class PE_00000544_ChromaticConundrum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000544_ChromaticConundrum));
        ...
        {
            int result = PE_00000544_ChromaticConundrum.Solution_0_Test(input);
