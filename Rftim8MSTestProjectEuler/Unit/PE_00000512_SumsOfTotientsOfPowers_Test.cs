...
{
    [TestClass]
    public sealed class PE_00000512_SumsOfTotientsOfPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000512_SumsOfTotientsOfPowers));
        ...
        {
            int result = PE_00000512_SumsOfTotientsOfPowers.Solution_0_Test(input);
