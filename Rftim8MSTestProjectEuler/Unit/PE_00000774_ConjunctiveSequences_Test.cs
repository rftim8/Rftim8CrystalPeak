...
{
    [TestClass]
    public sealed class PE_00000774_ConjunctiveSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000774_ConjunctiveSequences));
        ...
        {
            int result = PE_00000774_ConjunctiveSequences.Solution_0_Test(input);
