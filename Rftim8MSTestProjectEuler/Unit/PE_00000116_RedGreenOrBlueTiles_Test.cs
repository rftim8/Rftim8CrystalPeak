...
{
    [TestClass]
    public sealed class PE_00000116_RedGreenOrBlueTiles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000116_RedGreenOrBlueTiles));
        ...
        {
            int result = PE_00000116_RedGreenOrBlueTiles.Solution_0_Test(input);
