...
{
    [TestClass]
    public sealed class PE_00000258_ALaggedFibonacciSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000258_ALaggedFibonacciSequence));
        ...
        {
            int result = PE_00000258_ALaggedFibonacciSequence.Solution_0_Test(input);
