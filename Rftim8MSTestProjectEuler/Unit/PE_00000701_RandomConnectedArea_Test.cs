...
{
    [TestClass]
    public sealed class PE_00000701_RandomConnectedArea_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000701_RandomConnectedArea));
        ...
        {
            int result = PE_00000701_RandomConnectedArea.Solution_0_Test(input);
