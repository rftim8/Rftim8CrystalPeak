...
{
    [TestClass]
    public sealed class PE_00000078_CoinPartitions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000078_CoinPartitions));
        ...
        {
            int result = PE_00000078_CoinPartitions.Solution_0_Test(input);
