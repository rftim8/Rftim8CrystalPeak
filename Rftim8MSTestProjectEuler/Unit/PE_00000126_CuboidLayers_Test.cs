...
{
    [TestClass]
    public sealed class PE_00000126_CuboidLayers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000126_CuboidLayers));
        ...
        {
            int result = PE_00000126_CuboidLayers.Solution_0_Test(input);
