...
{
    [TestClass]
    public sealed class PE_00000273_SumOfSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000273_SumOfSquares));
        ...
        {
            int result = PE_00000273_SumOfSquares.Solution_0_Test(input);
