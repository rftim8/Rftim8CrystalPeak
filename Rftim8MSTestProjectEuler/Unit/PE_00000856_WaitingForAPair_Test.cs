...
{
    [TestClass]
    public sealed class PE_00000856_WaitingForAPair_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000856_WaitingForAPair));
        ...
        {
            int result = PE_00000856_WaitingForAPair.Solution_0_Test(input);
