...
{
    [TestClass]
    public sealed class PE_00000222_SpherePacking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000222_SpherePacking));
        ...
        {
            int result = PE_00000222_SpherePacking.Solution_0_Test(input);
