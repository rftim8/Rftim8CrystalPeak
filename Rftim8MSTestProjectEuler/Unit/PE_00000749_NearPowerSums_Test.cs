...
{
    [TestClass]
    public sealed class PE_00000749_NearPowerSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000749_NearPowerSums));
        ...
        {
            int result = PE_00000749_NearPowerSums.Solution_0_Test(input);
