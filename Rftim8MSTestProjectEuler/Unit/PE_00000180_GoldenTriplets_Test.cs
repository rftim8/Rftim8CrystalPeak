...
{
    [TestClass]
    public sealed class PE_00000180_GoldenTriplets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000180_GoldenTriplets));
        ...
        {
            int result = PE_00000180_GoldenTriplets.Solution_0_Test(input);
