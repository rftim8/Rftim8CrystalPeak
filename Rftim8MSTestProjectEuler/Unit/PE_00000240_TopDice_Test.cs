...
{
    [TestClass]
    public sealed class PE_00000240_TopDice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000240_TopDice));
        ...
        {
            int result = PE_00000240_TopDice.Solution_0_Test(input);
