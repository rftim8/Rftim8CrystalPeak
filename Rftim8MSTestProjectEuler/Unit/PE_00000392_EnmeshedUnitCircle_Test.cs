...
{
    [TestClass]
    public sealed class PE_00000392_EnmeshedUnitCircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000392_EnmeshedUnitCircle));
        ...
        {
            int result = PE_00000392_EnmeshedUnitCircle.Solution_0_Test(input);
