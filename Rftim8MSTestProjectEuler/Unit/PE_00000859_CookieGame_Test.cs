...
{
    [TestClass]
    public sealed class PE_00000859_CookieGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000859_CookieGame));
        ...
        {
            int result = PE_00000859_CookieGame.Solution_0_Test(input);
