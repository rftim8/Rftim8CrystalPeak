...
{
    [TestClass]
    public sealed class PE_00000259_ReachableNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000259_ReachableNumbers));
        ...
        {
            int result = PE_00000259_ReachableNumbers.Solution_0_Test(input);
