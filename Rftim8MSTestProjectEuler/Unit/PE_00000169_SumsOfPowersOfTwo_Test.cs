...
{
    [TestClass]
    public sealed class PE_00000169_SumsOfPowersOfTwo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000169_SumsOfPowersOfTwo));
        ...
        {
            int result = PE_00000169_SumsOfPowersOfTwo.Solution_0_Test(input);
