...
{
    [TestClass]
    public sealed class PE_00000030_DigitFifthPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000030_DigitFifthPowers));
        ...
        {
            int result = PE_00000030_DigitFifthPowers.Solution_0_Test(input);
