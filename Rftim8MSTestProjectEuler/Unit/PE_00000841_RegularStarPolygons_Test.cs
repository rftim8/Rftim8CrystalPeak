...
{
    [TestClass]
    public sealed class PE_00000841_RegularStarPolygons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000841_RegularStarPolygons));
        ...
        {
            int result = PE_00000841_RegularStarPolygons.Solution_0_Test(input);
