...
{
    [TestClass]
    public sealed class PE_00000641_ALongRowOfDice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000641_ALongRowOfDice));
        ...
        {
            int result = PE_00000641_ALongRowOfDice.Solution_0_Test(input);
