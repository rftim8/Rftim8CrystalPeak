...
{
    [TestClass]
    public sealed class PE_00000373_CircumscribedCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000373_CircumscribedCircles));
        ...
        {
            int result = PE_00000373_CircumscribedCircles.Solution_0_Test(input);
