...
{
    [TestClass]
    public sealed class PE_00000601_DivisibilityStreaks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000601_DivisibilityStreaks));
        ...
        {
            int result = PE_00000601_DivisibilityStreaks.Solution_0_Test(input);
