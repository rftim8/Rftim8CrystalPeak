...
{
    [TestClass]
    public sealed class PE_00000367_BozoSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000367_BozoSort));
        ...
        {
            int result = PE_00000367_BozoSort.Solution_0_Test(input);
