...
{
    [TestClass]
    public sealed class PE_00000453_LatticeQuadrilaterals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000453_LatticeQuadrilaterals));
        ...
        {
            int result = PE_00000453_LatticeQuadrilaterals.Solution_0_Test(input);
