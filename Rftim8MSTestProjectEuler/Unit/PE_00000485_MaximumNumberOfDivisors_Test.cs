...
{
    [TestClass]
    public sealed class PE_00000485_MaximumNumberOfDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000485_MaximumNumberOfDivisors));
        ...
        {
            int result = PE_00000485_MaximumNumberOfDivisors.Solution_0_Test(input);
