...
{
    [TestClass]
    public sealed class PE_00000861_ProductsOfBiUnitaryDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000861_ProductsOfBiUnitaryDivisors));
        ...
        {
            int result = PE_00000861_ProductsOfBiUnitaryDivisors.Solution_0_Test(input);
