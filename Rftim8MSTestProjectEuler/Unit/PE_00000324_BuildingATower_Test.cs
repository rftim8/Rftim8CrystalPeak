...
{
    [TestClass]
    public sealed class PE_00000324_BuildingATower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000324_BuildingATower));
        ...
        {
            int result = PE_00000324_BuildingATower.Solution_0_Test(input);
