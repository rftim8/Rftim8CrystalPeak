...
{
    [TestClass]
    public sealed class PE_00000199_IterativeCirclePacking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000199_IterativeCirclePacking));
        ...
        {
            int result = PE_00000199_IterativeCirclePacking.Solution_0_Test(input);
