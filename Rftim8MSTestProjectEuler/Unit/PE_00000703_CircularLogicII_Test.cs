...
{
    [TestClass]
    public sealed class PE_00000703_CircularLogicII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000703_CircularLogicII));
        ...
        {
            int result = PE_00000703_CircularLogicII.Solution_0_Test(input);
