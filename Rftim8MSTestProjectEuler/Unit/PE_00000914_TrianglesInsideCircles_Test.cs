...
{
    [TestClass]
    public sealed class PE_00000914_TrianglesInsideCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000914_TrianglesInsideCircles));
        ...
        {
            int result = PE_00000914_TrianglesInsideCircles.Solution_0_Test(input);
