...
{
    [TestClass]
    public sealed class PE_00000236_LuxuryHampers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000236_LuxuryHampers));
        ...
        {
            int result = PE_00000236_LuxuryHampers.Solution_0_Test(input);
