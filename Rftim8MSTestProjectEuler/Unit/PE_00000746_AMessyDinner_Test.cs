...
{
    [TestClass]
    public sealed class PE_00000746_AMessyDinner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000746_AMessyDinner));
        ...
        {
            int result = PE_00000746_AMessyDinner.Solution_0_Test(input);
