...
{
    [TestClass]
    public sealed class PE_00000332_SphericalTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000332_SphericalTriangles));
        ...
        {
            int result = PE_00000332_SphericalTriangles.Solution_0_Test(input);
