...
{
    [TestClass]
    public sealed class PE_00000844_KMarkovNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000844_KMarkovNumbers));
        ...
        {
            int result = PE_00000844_KMarkovNumbers.Solution_0_Test(input);
