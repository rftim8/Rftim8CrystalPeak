...
{
    [TestClass]
    public sealed class PE_00000627_CountingProducts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000627_CountingProducts));
        ...
        {
            int result = PE_00000627_CountingProducts.Solution_0_Test(input);
