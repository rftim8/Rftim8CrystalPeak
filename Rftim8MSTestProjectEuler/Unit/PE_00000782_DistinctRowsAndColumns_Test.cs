...
{
    [TestClass]
    public sealed class PE_00000782_DistinctRowsAndColumns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000782_DistinctRowsAndColumns));
        ...
        {
            int result = PE_00000782_DistinctRowsAndColumns.Solution_0_Test(input);
