...
{
    [TestClass]
    public sealed class PE_00000397_TriangleOnParabola_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000397_TriangleOnParabola));
        ...
        {
            int result = PE_00000397_TriangleOnParabola.Solution_0_Test(input);
