...
{
    [TestClass]
    public sealed class PE_00000098_AnagramicSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000098_AnagramicSquares));
        ...
        {
            int result = PE_00000098_AnagramicSquares.Solution_0_Test(input);
