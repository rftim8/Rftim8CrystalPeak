...
{
    [TestClass]
    public sealed class PE_00000198_AmbiguousNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000198_AmbiguousNumbers));
        ...
        {
            int result = PE_00000198_AmbiguousNumbers.Solution_0_Test(input);
