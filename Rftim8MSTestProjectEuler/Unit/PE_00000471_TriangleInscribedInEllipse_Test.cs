...
{
    [TestClass]
    public sealed class PE_00000471_TriangleInscribedInEllipse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000471_TriangleInscribedInEllipse));
        ...
        {
            int result = PE_00000471_TriangleInscribedInEllipse.Solution_0_Test(input);
