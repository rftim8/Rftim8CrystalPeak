...
{
    [TestClass]
    public sealed class PE_00000717_SummationOfAModularFormula_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000717_SummationOfAModularFormula));
        ...
        {
            int result = PE_00000717_SummationOfAModularFormula.Solution_0_Test(input);
