...
{
    [TestClass]
    public sealed class PE_00000554_CentaursOnAChessBoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000554_CentaursOnAChessBoard));
        ...
        {
            int result = PE_00000554_CentaursOnAChessBoard.Solution_0_Test(input);
