...
{
    [TestClass]
    public sealed class PE_00000483_RepeatedPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000483_RepeatedPermutation));
        ...
        {
            int result = PE_00000483_RepeatedPermutation.Solution_0_Test(input);
