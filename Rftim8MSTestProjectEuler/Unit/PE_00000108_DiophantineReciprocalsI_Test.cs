...
{
    [TestClass]
    public sealed class PE_00000108_DiophantineReciprocalsI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000108_DiophantineReciprocalsI));
        ...
        {
            int result = PE_00000108_DiophantineReciprocalsI.Solution_0_Test(input);
