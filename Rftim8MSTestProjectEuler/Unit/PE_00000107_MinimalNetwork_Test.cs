...
{
    [TestClass]
    public sealed class PE_00000107_MinimalNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000107_MinimalNetwork));
        ...
        {
            int result = PE_00000107_MinimalNetwork.Solution_0_Test(input);
