...
{
    [TestClass]
    public sealed class PE_00000035_CircularPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000035_CircularPrimes));
        ...
        {
            int result = PE_00000035_CircularPrimes.Solution_0_Test(input);
