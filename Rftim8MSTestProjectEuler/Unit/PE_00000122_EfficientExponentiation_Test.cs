...
{
    [TestClass]
    public sealed class PE_00000122_EfficientExponentiation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000122_EfficientExponentiation));
        ...
        {
            int result = PE_00000122_EfficientExponentiation.Solution_0_Test(input);
