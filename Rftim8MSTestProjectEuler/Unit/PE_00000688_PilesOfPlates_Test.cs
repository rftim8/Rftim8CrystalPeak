...
{
    [TestClass]
    public sealed class PE_00000688_PilesOfPlates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000688_PilesOfPlates));
        ...
        {
            int result = PE_00000688_PilesOfPlates.Solution_0_Test(input);
