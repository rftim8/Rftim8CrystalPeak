...
{
    [TestClass]
    public sealed class PE_00000016_PowerDigitSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000016_PowerDigitSum));
        ...
        {
            int result = PE_00000016_PowerDigitSum.Solution_0_Test(input);
