...
{
    [TestClass]
    public sealed class PE_00000814_Mezzoforte_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000814_Mezzoforte));
        ...
        {
            int result = PE_00000814_Mezzoforte.Solution_0_Test(input);
