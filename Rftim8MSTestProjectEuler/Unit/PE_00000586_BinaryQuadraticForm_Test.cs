...
{
    [TestClass]
    public sealed class PE_00000586_BinaryQuadraticForm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000586_BinaryQuadraticForm));
        ...
        {
            int result = PE_00000586_BinaryQuadraticForm.Solution_0_Test(input);
