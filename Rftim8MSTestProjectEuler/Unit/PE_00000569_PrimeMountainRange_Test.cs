...
{
    [TestClass]
    public sealed class PE_00000569_PrimeMountainRange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000569_PrimeMountainRange));
        ...
        {
            int result = PE_00000569_PrimeMountainRange.Solution_0_Test(input);
