...
{
    [TestClass]
    public sealed class PE_00000900_DistribuNimII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000900_DistribuNimII));
        ...
        {
            int result = PE_00000900_DistribuNimII.Solution_0_Test(input);
