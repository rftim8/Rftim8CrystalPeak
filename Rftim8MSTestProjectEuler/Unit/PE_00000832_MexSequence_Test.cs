...
{
    [TestClass]
    public sealed class PE_00000832_MexSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000832_MexSequence));
        ...
        {
            int result = PE_00000832_MexSequence.Solution_0_Test(input);
