...
{
    [TestClass]
    public sealed class PE_00000769_BinaryQuadraticFormII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000769_BinaryQuadraticFormII));
        ...
        {
            int result = PE_00000769_BinaryQuadraticFormII.Solution_0_Test(input);
