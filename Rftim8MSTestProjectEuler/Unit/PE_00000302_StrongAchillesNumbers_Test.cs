...
{
    [TestClass]
    public sealed class PE_00000302_StrongAchillesNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000302_StrongAchillesNumbers));
        ...
        {
            int result = PE_00000302_StrongAchillesNumbers.Solution_0_Test(input);
