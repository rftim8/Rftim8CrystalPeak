...
{
    [TestClass]
    public sealed class PE_00000325_StoneGameII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000325_StoneGameII));
        ...
        {
            int result = PE_00000325_StoneGameII.Solution_0_Test(input);
