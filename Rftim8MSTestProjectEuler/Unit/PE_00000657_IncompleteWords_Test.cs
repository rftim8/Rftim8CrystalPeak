...
{
    [TestClass]
    public sealed class PE_00000657_IncompleteWords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000657_IncompleteWords));
        ...
        {
            int result = PE_00000657_IncompleteWords.Solution_0_Test(input);
