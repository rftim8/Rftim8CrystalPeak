...
{
    [TestClass]
    public sealed class PE_00000527_RandomizedBinarySearch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000527_RandomizedBinarySearch));
        ...
        {
            int result = PE_00000527_RandomizedBinarySearch.Solution_0_Test(input);
