...
{
    [TestClass]
    public sealed class PE_00000151_APreferenceForA5_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000151_APreferenceForA5));
        ...
        {
            int result = PE_00000151_APreferenceForA5.Solution_0_Test(input);
