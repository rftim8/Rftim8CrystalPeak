...
{
    [TestClass]
    public sealed class PE_00000863_DifferentDice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000863_DifferentDice));
        ...
        {
            int result = PE_00000863_DifferentDice.Solution_0_Test(input);
