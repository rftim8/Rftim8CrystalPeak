...
{
    [TestClass]
    public sealed class PE_00000740_SecretSanta_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000740_SecretSanta));
        ...
        {
            int result = PE_00000740_SecretSanta.Solution_0_Test(input);
