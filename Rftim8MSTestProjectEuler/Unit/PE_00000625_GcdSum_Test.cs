...
{
    [TestClass]
    public sealed class PE_00000625_GcdSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000625_GcdSum));
        ...
        {
            int result = PE_00000625_GcdSum.Solution_0_Test(input);
