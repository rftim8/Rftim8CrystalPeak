...
{
    [TestClass]
    public sealed class PE_00000888_1249Nim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000888_1249Nim));
        ...
        {
            int result = PE_00000888_1249Nim.Solution_0_Test(input);
