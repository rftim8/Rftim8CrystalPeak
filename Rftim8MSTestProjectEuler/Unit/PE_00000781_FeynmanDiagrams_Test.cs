...
{
    [TestClass]
    public sealed class PE_00000781_FeynmanDiagrams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000781_FeynmanDiagrams));
        ...
        {
            int result = PE_00000781_FeynmanDiagrams.Solution_0_Test(input);
