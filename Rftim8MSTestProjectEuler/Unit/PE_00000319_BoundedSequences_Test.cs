...
{
    [TestClass]
    public sealed class PE_00000319_BoundedSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000319_BoundedSequences));
        ...
        {
            int result = PE_00000319_BoundedSequences.Solution_0_Test(input);
