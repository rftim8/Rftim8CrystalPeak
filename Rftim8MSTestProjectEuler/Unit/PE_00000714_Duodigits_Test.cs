...
{
    [TestClass]
    public sealed class PE_00000714_Duodigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000714_Duodigits));
        ...
        {
            int result = PE_00000714_Duodigits.Solution_0_Test(input);
