...
{
    [TestClass]
    public sealed class PE_00000887_BoundedBinarySearch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000887_BoundedBinarySearch));
        ...
        {
            int result = PE_00000887_BoundedBinarySearch.Solution_0_Test(input);
