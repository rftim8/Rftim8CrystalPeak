...
{
    [TestClass]
    public sealed class PE_00000213_FleaCircus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000213_FleaCircus));
        ...
        {
            int result = PE_00000213_FleaCircus.Solution_0_Test(input);
