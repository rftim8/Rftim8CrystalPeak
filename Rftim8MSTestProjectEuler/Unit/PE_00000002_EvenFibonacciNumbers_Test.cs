...
{
    [TestClass]
    public sealed class PE_00000002_EvenFibonacciNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000002_EvenFibonacciNumbers));
        ...
        {
            int result = PE_00000002_EvenFibonacciNumbers.Solution_0_Test(input);
