...
{
    [TestClass]
    public sealed class PE_00000225_TribonacciNondivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000225_TribonacciNondivisors));
        ...
        {
            int result = PE_00000225_TribonacciNondivisors.Solution_0_Test(input);
