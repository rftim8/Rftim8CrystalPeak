...
{
    [TestClass]
    public sealed class PE_00000022_NamesScores_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000022_NamesScores));
        ...
        {
            int result = PE_00000022_NamesScores.Solution_0_Test(input);
