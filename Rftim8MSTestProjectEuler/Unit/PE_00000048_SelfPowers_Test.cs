...
{
    [TestClass]
    public sealed class PE_00000048_SelfPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000048_SelfPowers));
        ...
        {
            int result = PE_00000048_SelfPowers.Solution_0_Test(input);
