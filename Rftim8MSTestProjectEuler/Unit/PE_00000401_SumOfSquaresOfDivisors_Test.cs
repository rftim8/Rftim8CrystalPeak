...
{
    [TestClass]
    public sealed class PE_00000401_SumOfSquaresOfDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000401_SumOfSquaresOfDivisors));
        ...
        {
            int result = PE_00000401_SumOfSquaresOfDivisors.Solution_0_Test(input);
