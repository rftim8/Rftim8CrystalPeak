...
{
    [TestClass]
    public sealed class PE_00000355_MaximalCoprimeSubset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000355_MaximalCoprimeSubset));
        ...
        {
            int result = PE_00000355_MaximalCoprimeSubset.Solution_0_Test(input);
