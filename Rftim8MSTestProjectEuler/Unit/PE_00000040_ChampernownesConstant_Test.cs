...
{
    [TestClass]
    public sealed class PE_00000040_ChampernownesConstant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000040_ChampernownesConstant));
        ...
        {
            int result = PE_00000040_ChampernownesConstant.Solution_0_Test(input);
