...
{
    [TestClass]
    public sealed class PE_00000305_ReflexivePosition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000305_ReflexivePosition));
        ...
        {
            int result = PE_00000305_ReflexivePosition.Solution_0_Test(input);
