...
{
    [TestClass]
    public sealed class PE_00000932_2025_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000932_2025));
        ...
        {
            int result = PE_00000932_2025.Solution_0_Test(input);
