...
{
    [TestClass]
    public sealed class PE_00000445_RetractionsA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000445_RetractionsA));
        ...
        {
            int result = PE_00000445_RetractionsA.Solution_0_Test(input);
