...
{
    [TestClass]
    public sealed class PE_00000360_ScarySphere_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000360_ScarySphere));
        ...
        {
            int result = PE_00000360_ScarySphere.Solution_0_Test(input);
