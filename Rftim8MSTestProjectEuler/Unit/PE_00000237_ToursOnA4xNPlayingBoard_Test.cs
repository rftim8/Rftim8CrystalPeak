...
{
    [TestClass]
    public sealed class PE_00000237_ToursOnA4xNPlayingBoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000237_ToursOnA4xNPlayingBoard));
        ...
        {
            int result = PE_00000237_ToursOnA4xNPlayingBoard.Solution_0_Test(input);
