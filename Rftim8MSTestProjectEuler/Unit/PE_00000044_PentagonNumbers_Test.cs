...
{
    [TestClass]
    public sealed class PE_00000044_PentagonNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000044_PentagonNumbers));
        ...
        {
            int result = PE_00000044_PentagonNumbers.Solution_0_Test(input);
