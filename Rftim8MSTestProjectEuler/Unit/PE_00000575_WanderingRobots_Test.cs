...
{
    [TestClass]
    public sealed class PE_00000575_WanderingRobots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000575_WanderingRobots));
        ...
        {
            int result = PE_00000575_WanderingRobots.Solution_0_Test(input);
