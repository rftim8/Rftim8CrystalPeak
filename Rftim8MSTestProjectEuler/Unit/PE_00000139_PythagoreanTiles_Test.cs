...
{
    [TestClass]
    public sealed class PE_00000139_PythagoreanTiles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000139_PythagoreanTiles));
        ...
        {
            int result = PE_00000139_PythagoreanTiles.Solution_0_Test(input);
