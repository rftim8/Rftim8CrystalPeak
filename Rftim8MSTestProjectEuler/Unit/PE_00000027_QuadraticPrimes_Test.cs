...
{
    [TestClass]
    public sealed class PE_00000027_QuadraticPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000027_QuadraticPrimes));
        ...
        {
            int result = PE_00000027_QuadraticPrimes.Solution_0_Test(input);
