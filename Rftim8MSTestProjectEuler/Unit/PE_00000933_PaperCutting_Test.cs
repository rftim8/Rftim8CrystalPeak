...
{
    [TestClass]
    public sealed class PE_00000933_PaperCutting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000933_PaperCutting));
        ...
        {
            int result = PE_00000933_PaperCutting.Solution_0_Test(input);
