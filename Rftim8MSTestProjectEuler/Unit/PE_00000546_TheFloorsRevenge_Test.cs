...
{
    [TestClass]
    public sealed class PE_00000546_TheFloorsRevenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000546_TheFloorsRevenge));
        ...
        {
            int result = PE_00000546_TheFloorsRevenge.Solution_0_Test(input);
