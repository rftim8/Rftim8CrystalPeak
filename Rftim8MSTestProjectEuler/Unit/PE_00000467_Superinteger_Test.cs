...
{
    [TestClass]
    public sealed class PE_00000467_Superinteger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000467_Superinteger));
        ...
        {
            int result = PE_00000467_Superinteger.Solution_0_Test(input);
