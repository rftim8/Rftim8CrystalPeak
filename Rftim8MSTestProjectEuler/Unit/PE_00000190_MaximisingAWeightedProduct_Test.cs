...
{
    [TestClass]
    public sealed class PE_00000190_MaximisingAWeightedProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000190_MaximisingAWeightedProduct));
        ...
        {
            int result = PE_00000190_MaximisingAWeightedProduct.Solution_0_Test(input);
