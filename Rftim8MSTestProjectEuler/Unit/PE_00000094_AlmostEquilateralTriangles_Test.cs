...
{
    [TestClass]
    public sealed class PE_00000094_AlmostEquilateralTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000094_AlmostEquilateralTriangles));
        ...
        {
            int result = PE_00000094_AlmostEquilateralTriangles.Solution_0_Test(input);
