...
{
    [TestClass]
    public sealed class PE_00000396_WeakGoodsteinSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000396_WeakGoodsteinSequence));
        ...
        {
            int result = PE_00000396_WeakGoodsteinSequence.Solution_0_Test(input);
