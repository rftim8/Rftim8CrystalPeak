...
{
    [TestClass]
    public sealed class PE_00000101_OptimumPolynomial_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000101_OptimumPolynomial));
        ...
        {
            int result = PE_00000101_OptimumPolynomial.Solution_0_Test(input);
