...
{
    [TestClass]
    public sealed class PE_00000410_CircleAndTangentLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000410_CircleAndTangentLine));
        ...
        {
            int result = PE_00000410_CircleAndTangentLine.Solution_0_Test(input);
