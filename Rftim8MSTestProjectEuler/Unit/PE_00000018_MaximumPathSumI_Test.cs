...
{
    [TestClass]
    public sealed class PE_00000018_MaximumPathSumI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000018_MaximumPathSumI));
        ...
        {
            int result = PE_00000018_MaximumPathSumI.Solution_0_Test(input);
