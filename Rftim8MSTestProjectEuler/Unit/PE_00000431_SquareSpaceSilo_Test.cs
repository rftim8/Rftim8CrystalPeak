...
{
    [TestClass]
    public sealed class PE_00000431_SquareSpaceSilo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000431_SquareSpaceSilo));
        ...
        {
            int result = PE_00000431_SquareSpaceSilo.Solution_0_Test(input);
