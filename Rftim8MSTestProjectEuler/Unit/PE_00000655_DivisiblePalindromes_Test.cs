...
{
    [TestClass]
    public sealed class PE_00000655_DivisiblePalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000655_DivisiblePalindromes));
        ...
        {
            int result = PE_00000655_DivisiblePalindromes.Solution_0_Test(input);
