...
{
    [TestClass]
    public sealed class PE_00000021_AmicableNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000021_AmicableNumbers));
        ...
        {
            int result = PE_00000021_AmicableNumbers.Solution_0_Test(input);
