...
{
    [TestClass]
    public sealed class PE_00000743_WindowIntoAMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000743_WindowIntoAMatrix));
        ...
        {
            int result = PE_00000743_WindowIntoAMatrix.Solution_0_Test(input);
