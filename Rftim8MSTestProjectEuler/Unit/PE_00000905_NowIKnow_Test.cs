...
{
    [TestClass]
    public sealed class PE_00000905_NowIKnow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000905_NowIKnow));
        ...
        {
            int result = PE_00000905_NowIKnow.Solution_0_Test(input);
