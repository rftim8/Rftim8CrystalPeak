...
{
    [TestClass]
    public sealed class PE_00000674_SolvingLequations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000674_SolvingLequations));
        ...
        {
            int result = PE_00000674_SolvingLequations.Solution_0_Test(input);
