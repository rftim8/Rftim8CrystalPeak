...
{
    [TestClass]
    public sealed class PE_00000327_RoomsOfDoom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000327_RoomsOfDoom));
        ...
        {
            int result = PE_00000327_RoomsOfDoom.Solution_0_Test(input);
