...
{
    [TestClass]
    public sealed class PE_00000919_FortunateTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000919_FortunateTriangles));
        ...
        {
            int result = PE_00000919_FortunateTriangles.Solution_0_Test(input);
