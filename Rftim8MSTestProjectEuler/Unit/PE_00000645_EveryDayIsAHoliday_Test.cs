...
{
    [TestClass]
    public sealed class PE_00000645_EveryDayIsAHoliday_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000645_EveryDayIsAHoliday));
        ...
        {
            int result = PE_00000645_EveryDayIsAHoliday.Solution_0_Test(input);
