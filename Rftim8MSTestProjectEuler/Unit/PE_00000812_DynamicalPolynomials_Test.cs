...
{
    [TestClass]
    public sealed class PE_00000812_DynamicalPolynomials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000812_DynamicalPolynomials));
        ...
        {
            int result = PE_00000812_DynamicalPolynomials.Solution_0_Test(input);
