...
{
    [TestClass]
    public sealed class PE_00000182_RSAEncryption_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000182_RSAEncryption));
        ...
        {
            int result = PE_00000182_RSAEncryption.Solution_0_Test(input);
