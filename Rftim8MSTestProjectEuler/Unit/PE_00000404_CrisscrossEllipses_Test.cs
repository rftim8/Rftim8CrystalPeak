...
{
    [TestClass]
    public sealed class PE_00000404_CrisscrossEllipses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000404_CrisscrossEllipses));
        ...
        {
            int result = PE_00000404_CrisscrossEllipses.Solution_0_Test(input);
