...
{
    [TestClass]
    public sealed class PE_00000508_IntegersInBaseIMinus1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000508_IntegersInBaseIMinus1));
        ...
        {
            int result = PE_00000508_IntegersInBaseIMinus1.Solution_0_Test(input);
