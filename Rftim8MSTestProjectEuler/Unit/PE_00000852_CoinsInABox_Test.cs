...
{
    [TestClass]
    public sealed class PE_00000852_CoinsInABox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000852_CoinsInABox));
        ...
        {
            int result = PE_00000852_CoinsInABox.Solution_0_Test(input);
