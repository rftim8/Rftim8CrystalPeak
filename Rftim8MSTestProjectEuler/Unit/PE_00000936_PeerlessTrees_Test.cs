...
{
    [TestClass]
    public sealed class PE_00000936_PeerlessTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000936_PeerlessTrees));
        ...
        {
            int result = PE_00000936_PeerlessTrees.Solution_0_Test(input);
