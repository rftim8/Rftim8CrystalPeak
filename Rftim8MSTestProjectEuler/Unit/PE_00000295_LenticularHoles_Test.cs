...
{
    [TestClass]
    public sealed class PE_00000295_LenticularHoles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000295_LenticularHoles));
        ...
        {
            int result = PE_00000295_LenticularHoles.Solution_0_Test(input);
