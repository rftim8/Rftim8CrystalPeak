...
{
    [TestClass]
    public sealed class PE_00000550_DivisorGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000550_DivisorGame));
        ...
        {
            int result = PE_00000550_DivisorGame.Solution_0_Test(input);
