...
{
    [TestClass]
    public sealed class PE_00000784_ReciprocalPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000784_ReciprocalPairs));
        ...
        {
            int result = PE_00000784_ReciprocalPairs.Solution_0_Test(input);
