...
{
    [TestClass]
    public sealed class PE_00000246_TangentsToAnEllipse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000246_TangentsToAnEllipse));
        ...
        {
            int result = PE_00000246_TangentsToAnEllipse.Solution_0_Test(input);
