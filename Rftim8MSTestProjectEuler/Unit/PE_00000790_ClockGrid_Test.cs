...
{
    [TestClass]
    public sealed class PE_00000790_ClockGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000790_ClockGrid));
        ...
        {
            int result = PE_00000790_ClockGrid.Solution_0_Test(input);
