...
{
    [TestClass]
    public sealed class PE_00000685_InverseDigitSumII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000685_InverseDigitSumII));
        ...
        {
            int result = PE_00000685_InverseDigitSumII.Solution_0_Test(input);
