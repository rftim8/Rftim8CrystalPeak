...
{
    [TestClass]
    public sealed class PE_00000837_Amidakuji_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000837_Amidakuji));
        ...
        {
            int result = PE_00000837_Amidakuji.Solution_0_Test(input);
