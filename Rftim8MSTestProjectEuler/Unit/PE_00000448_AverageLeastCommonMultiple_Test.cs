...
{
    [TestClass]
    public sealed class PE_00000448_AverageLeastCommonMultiple_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000448_AverageLeastCommonMultiple));
        ...
        {
            int result = PE_00000448_AverageLeastCommonMultiple.Solution_0_Test(input);
