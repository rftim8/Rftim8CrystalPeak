...
{
    [TestClass]
    public sealed class PE_00000532_NanobotsOnGeodesics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000532_NanobotsOnGeodesics));
        ...
        {
            int result = PE_00000532_NanobotsOnGeodesics.Solution_0_Test(input);
