...
{
    [TestClass]
    public sealed class PE_00000697_RandomlyDecayingSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000697_RandomlyDecayingSequence));
        ...
        {
            int result = PE_00000697_RandomlyDecayingSequence.Solution_0_Test(input);
