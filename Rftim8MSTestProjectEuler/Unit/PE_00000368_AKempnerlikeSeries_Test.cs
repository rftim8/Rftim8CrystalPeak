...
{
    [TestClass]
    public sealed class PE_00000368_AKempnerlikeSeries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000368_AKempnerlikeSeries));
        ...
        {
            int result = PE_00000368_AKempnerlikeSeries.Solution_0_Test(input);
