...
{
    [TestClass]
    public sealed class PE_00000472_ComfortableDistanceII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000472_ComfortableDistanceII));
        ...
        {
            int result = PE_00000472_ComfortableDistanceII.Solution_0_Test(input);
