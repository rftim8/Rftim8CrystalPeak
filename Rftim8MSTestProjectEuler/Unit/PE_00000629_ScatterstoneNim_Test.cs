...
{
    [TestClass]
    public sealed class PE_00000629_ScatterstoneNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000629_ScatterstoneNim));
        ...
        {
            int result = PE_00000629_ScatterstoneNim.Solution_0_Test(input);
