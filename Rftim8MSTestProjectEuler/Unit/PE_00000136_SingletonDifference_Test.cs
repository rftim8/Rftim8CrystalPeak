...
{
    [TestClass]
    public sealed class PE_00000136_SingletonDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000136_SingletonDifference));
        ...
        {
            int result = PE_00000136_SingletonDifference.Solution_0_Test(input);
