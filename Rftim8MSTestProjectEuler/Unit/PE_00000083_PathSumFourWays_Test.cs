...
{
    [TestClass]
    public sealed class PE_00000083_PathSumFourWays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000083_PathSumFourWays));
        ...
        {
            int result = PE_00000083_PathSumFourWays.Solution_0_Test(input);
