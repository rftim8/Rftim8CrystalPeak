...
{
    [TestClass]
    public sealed class PE_00000052_PermutedMultiples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000052_PermutedMultiples));
        ...
        {
            int result = PE_00000052_PermutedMultiples.Solution_0_Test(input);
