...
{
    [TestClass]
    public sealed class PE_00000192_BestApproximations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000192_BestApproximations));
        ...
        {
            int result = PE_00000192_BestApproximations.Solution_0_Test(input);
