...
{
    [TestClass]
    public sealed class PE_00000829_IntegralFusion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000829_IntegralFusion));
        ...
        {
            int result = PE_00000829_IntegralFusion.Solution_0_Test(input);
