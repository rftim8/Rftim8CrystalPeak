...
{
    [TestClass]
    public sealed class PE_00000497_DrunkenTowerOfHanoi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000497_DrunkenTowerOfHanoi));
        ...
        {
            int result = PE_00000497_DrunkenTowerOfHanoi.Solution_0_Test(input);
