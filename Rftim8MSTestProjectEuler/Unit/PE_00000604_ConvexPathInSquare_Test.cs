...
{
    [TestClass]
    public sealed class PE_00000604_ConvexPathInSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000604_ConvexPathInSquare));
        ...
        {
            int result = PE_00000604_ConvexPathInSquare.Solution_0_Test(input);
