...
{
    [TestClass]
    public sealed class PE_00000516_5smoothTotients_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000516_5smoothTotients));
        ...
        {
            int result = PE_00000516_5smoothTotients.Solution_0_Test(input);
