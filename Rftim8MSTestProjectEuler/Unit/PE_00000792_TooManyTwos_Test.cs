...
{
    [TestClass]
    public sealed class PE_00000792_TooManyTwos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000792_TooManyTwos));
        ...
        {
            int result = PE_00000792_TooManyTwos.Solution_0_Test(input);
