...
{
    [TestClass]
    public sealed class PE_00000412_GnomonNumbering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000412_GnomonNumbering));
        ...
        {
            int result = PE_00000412_GnomonNumbering.Solution_0_Test(input);
