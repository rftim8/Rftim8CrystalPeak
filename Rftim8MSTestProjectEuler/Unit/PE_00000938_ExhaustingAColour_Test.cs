...
{
    [TestClass]
    public sealed class PE_00000938_ExhaustingAColour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000938_ExhaustingAColour));
        ...
        {
            int result = PE_00000938_ExhaustingAColour.Solution_0_Test(input);
