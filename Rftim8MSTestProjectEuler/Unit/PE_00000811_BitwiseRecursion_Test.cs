...
{
    [TestClass]
    public sealed class PE_00000811_BitwiseRecursion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000811_BitwiseRecursion));
        ...
        {
            int result = PE_00000811_BitwiseRecursion.Solution_0_Test(input);
