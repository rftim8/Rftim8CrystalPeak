...
{
    [TestClass]
    public sealed class PE_00000415_TitanicSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000415_TitanicSets));
        ...
        {
            int result = PE_00000415_TitanicSets.Solution_0_Test(input);
