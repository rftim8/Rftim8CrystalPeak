...
{
    [TestClass]
    public sealed class PE_00000695_RandomRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000695_RandomRectangles));
        ...
        {
            int result = PE_00000695_RandomRectangles.Solution_0_Test(input);
