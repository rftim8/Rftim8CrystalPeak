...
{
    [TestClass]
    public sealed class PE_00000795_AlternatingGCDSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000795_AlternatingGCDSum));
        ...
        {
            int result = PE_00000795_AlternatingGCDSum.Solution_0_Test(input);
