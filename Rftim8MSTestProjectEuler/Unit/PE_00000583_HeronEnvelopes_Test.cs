...
{
    [TestClass]
    public sealed class PE_00000583_HeronEnvelopes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000583_HeronEnvelopes));
        ...
        {
            int result = PE_00000583_HeronEnvelopes.Solution_0_Test(input);
