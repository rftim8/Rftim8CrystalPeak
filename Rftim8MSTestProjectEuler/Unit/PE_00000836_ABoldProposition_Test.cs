...
{
    [TestClass]
    public sealed class PE_00000836_ABoldProposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000836_ABoldProposition));
        ...
        {
            int result = PE_00000836_ABoldProposition.Solution_0_Test(input);
