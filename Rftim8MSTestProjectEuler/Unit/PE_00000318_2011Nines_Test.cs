...
{
    [TestClass]
    public sealed class PE_00000318_2011Nines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000318_2011Nines));
        ...
        {
            int result = PE_00000318_2011Nines.Solution_0_Test(input);
