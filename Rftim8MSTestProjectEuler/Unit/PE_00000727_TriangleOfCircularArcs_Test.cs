...
{
    [TestClass]
    public sealed class PE_00000727_TriangleOfCircularArcs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000727_TriangleOfCircularArcs));
        ...
        {
            int result = PE_00000727_TriangleOfCircularArcs.Solution_0_Test(input);
