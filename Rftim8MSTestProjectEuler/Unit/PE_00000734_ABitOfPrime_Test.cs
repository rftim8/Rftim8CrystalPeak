...
{
    [TestClass]
    public sealed class PE_00000734_ABitOfPrime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000734_ABitOfPrime));
        ...
        {
            int result = PE_00000734_ABitOfPrime.Solution_0_Test(input);
