...
{
    [TestClass]
    public sealed class PE_00000517_ARealRecursion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000517_ARealRecursion));
        ...
        {
            int result = PE_00000517_ARealRecursion.Solution_0_Test(input);
