...
{
    [TestClass]
    public sealed class PE_00000855_DelphiPaper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000855_DelphiPaper));
        ...
        {
            int result = PE_00000855_DelphiPaper.Solution_0_Test(input);
