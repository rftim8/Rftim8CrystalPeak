...
{
    [TestClass]
    public sealed class PE_00000906_ACollectiveDecision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000906_ACollectiveDecision));
        ...
        {
            int result = PE_00000906_ACollectiveDecision.Solution_0_Test(input);
