...
{
    [TestClass]
    public sealed class PE_00000624_TwoHeadsAreBetterThanOne_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000624_TwoHeadsAreBetterThanOne));
        ...
        {
            int result = PE_00000624_TwoHeadsAreBetterThanOne.Solution_0_Test(input);
