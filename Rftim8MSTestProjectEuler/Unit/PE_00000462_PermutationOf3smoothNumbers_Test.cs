...
{
    [TestClass]
    public sealed class PE_00000462_PermutationOf3smoothNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000462_PermutationOf3smoothNumbers));
        ...
        {
            int result = PE_00000462_PermutationOf3smoothNumbers.Solution_0_Test(input);
