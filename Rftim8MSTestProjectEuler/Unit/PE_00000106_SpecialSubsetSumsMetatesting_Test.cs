...
{
    [TestClass]
    public sealed class PE_00000106_SpecialSubsetSumsMetatesting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000106_SpecialSubsetSumsMetatesting));
        ...
        {
            int result = PE_00000106_SpecialSubsetSumsMetatesting.Solution_0_Test(input);
