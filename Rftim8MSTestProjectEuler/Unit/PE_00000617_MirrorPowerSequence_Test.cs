...
{
    [TestClass]
    public sealed class PE_00000617_MirrorPowerSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000617_MirrorPowerSequence));
        ...
        {
            int result = PE_00000617_MirrorPowerSequence.Solution_0_Test(input);
