...
{
    [TestClass]
    public sealed class PE_00000076_CountingSummations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000076_CountingSummations));
        ...
        {
            int result = PE_00000076_CountingSummations.Solution_0_Test(input);
