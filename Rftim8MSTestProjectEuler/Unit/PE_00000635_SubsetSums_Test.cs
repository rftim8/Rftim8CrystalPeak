...
{
    [TestClass]
    public sealed class PE_00000635_SubsetSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000635_SubsetSums));
        ...
        {
            int result = PE_00000635_SubsetSums.Solution_0_Test(input);
