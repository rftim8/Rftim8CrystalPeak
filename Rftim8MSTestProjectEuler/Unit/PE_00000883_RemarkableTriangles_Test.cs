...
{
    [TestClass]
    public sealed class PE_00000883_RemarkableTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000883_RemarkableTriangles));
        ...
        {
            int result = PE_00000883_RemarkableTriangles.Solution_0_Test(input);
