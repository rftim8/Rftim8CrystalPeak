...
{
    [TestClass]
    public sealed class PE_00000693_FiniteSequenceGenerator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000693_FiniteSequenceGenerator));
        ...
        {
            int result = PE_00000693_FiniteSequenceGenerator.Solution_0_Test(input);
