...
{
    [TestClass]
    public sealed class PE_00000768_Chandelier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000768_Chandelier));
        ...
        {
            int result = PE_00000768_Chandelier.Solution_0_Test(input);
