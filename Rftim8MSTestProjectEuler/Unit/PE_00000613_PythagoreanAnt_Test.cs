...
{
    [TestClass]
    public sealed class PE_00000613_PythagoreanAnt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000613_PythagoreanAnt));
        ...
        {
            int result = PE_00000613_PythagoreanAnt.Solution_0_Test(input);
