...
{
    [TestClass]
    public sealed class PE_00000256_TatamiFreeRooms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000256_TatamiFreeRooms));
        ...
        {
            int result = PE_00000256_TatamiFreeRooms.Solution_0_Test(input);
