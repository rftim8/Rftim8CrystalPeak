...
{
    [TestClass]
    public sealed class PE_00000188_Hyperexponentiation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000188_Hyperexponentiation));
        ...
        {
            int result = PE_00000188_Hyperexponentiation.Solution_0_Test(input);
