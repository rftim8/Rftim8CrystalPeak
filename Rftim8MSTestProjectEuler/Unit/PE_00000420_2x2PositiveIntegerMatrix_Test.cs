...
{
    [TestClass]
    public sealed class PE_00000420_2x2PositiveIntegerMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000420_2x2PositiveIntegerMatrix));
        ...
        {
            int result = PE_00000420_2x2PositiveIntegerMatrix.Solution_0_Test(input);
