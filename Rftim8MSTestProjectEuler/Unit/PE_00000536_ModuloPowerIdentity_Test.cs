...
{
    [TestClass]
    public sealed class PE_00000536_ModuloPowerIdentity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000536_ModuloPowerIdentity));
        ...
        {
            int result = PE_00000536_ModuloPowerIdentity.Solution_0_Test(input);
