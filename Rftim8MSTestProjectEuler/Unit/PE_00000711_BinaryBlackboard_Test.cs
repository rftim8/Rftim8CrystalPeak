...
{
    [TestClass]
    public sealed class PE_00000711_BinaryBlackboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000711_BinaryBlackboard));
        ...
        {
            int result = PE_00000711_BinaryBlackboard.Solution_0_Test(input);
