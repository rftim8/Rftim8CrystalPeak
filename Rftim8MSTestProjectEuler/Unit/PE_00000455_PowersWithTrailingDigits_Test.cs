...
{
    [TestClass]
    public sealed class PE_00000455_PowersWithTrailingDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000455_PowersWithTrailingDigits));
        ...
        {
            int result = PE_00000455_PowersWithTrailingDigits.Solution_0_Test(input);
