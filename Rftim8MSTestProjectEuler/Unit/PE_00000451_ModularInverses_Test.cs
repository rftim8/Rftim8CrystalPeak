...
{
    [TestClass]
    public sealed class PE_00000451_ModularInverses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000451_ModularInverses));
        ...
        {
            int result = PE_00000451_ModularInverses.Solution_0_Test(input);
