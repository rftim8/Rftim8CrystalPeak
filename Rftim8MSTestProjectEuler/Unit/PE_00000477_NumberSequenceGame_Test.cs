...
{
    [TestClass]
    public sealed class PE_00000477_NumberSequenceGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000477_NumberSequenceGame));
        ...
        {
            int result = PE_00000477_NumberSequenceGame.Solution_0_Test(input);
