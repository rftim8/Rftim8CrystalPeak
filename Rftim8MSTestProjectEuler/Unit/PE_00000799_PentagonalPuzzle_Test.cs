...
{
    [TestClass]
    public sealed class PE_00000799_PentagonalPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000799_PentagonalPuzzle));
        ...
        {
            int result = PE_00000799_PentagonalPuzzle.Solution_0_Test(input);
