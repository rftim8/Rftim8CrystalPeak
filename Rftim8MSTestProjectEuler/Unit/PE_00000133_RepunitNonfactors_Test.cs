...
{
    [TestClass]
    public sealed class PE_00000133_RepunitNonfactors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000133_RepunitNonfactors));
        ...
        {
            int result = PE_00000133_RepunitNonfactors.Solution_0_Test(input);
