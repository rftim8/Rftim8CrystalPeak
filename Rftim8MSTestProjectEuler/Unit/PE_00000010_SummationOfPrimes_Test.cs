...
{
    [TestClass]
    public sealed class PE_00000010_SummationOfPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000010_SummationOfPrimes));
        ...
        {
            int result = PE_00000010_SummationOfPrimes.Solution_0_Test(input);
