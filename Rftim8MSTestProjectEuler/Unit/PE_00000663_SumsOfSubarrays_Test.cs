...
{
    [TestClass]
    public sealed class PE_00000663_SumsOfSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000663_SumsOfSubarrays));
        ...
        {
            int result = PE_00000663_SumsOfSubarrays.Solution_0_Test(input);
