...
{
    [TestClass]
    public sealed class PE_00000476_CirclePackingII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000476_CirclePackingII));
        ...
        {
            int result = PE_00000476_CirclePackingII.Solution_0_Test(input);
