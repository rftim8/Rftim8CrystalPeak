...
{
    [TestClass]
    public sealed class PE_00000074_DigitFactorialChains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000074_DigitFactorialChains));
        ...
        {
            int result = PE_00000074_DigitFactorialChains.Solution_0_Test(input);
