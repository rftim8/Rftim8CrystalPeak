...
{
    [TestClass]
    public sealed class PE_00000408_AdmissiblePathsThroughAGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000408_AdmissiblePathsThroughAGrid));
        ...
        {
            int result = PE_00000408_AdmissiblePathsThroughAGrid.Solution_0_Test(input);
