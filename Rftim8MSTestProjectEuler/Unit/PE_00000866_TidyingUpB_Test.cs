...
{
    [TestClass]
    public sealed class PE_00000866_TidyingUpB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000866_TidyingUpB));
        ...
        {
            int result = PE_00000866_TidyingUpB.Solution_0_Test(input);
