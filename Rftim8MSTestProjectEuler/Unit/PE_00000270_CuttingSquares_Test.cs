...
{
    [TestClass]
    public sealed class PE_00000270_CuttingSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000270_CuttingSquares));
        ...
        {
            int result = PE_00000270_CuttingSquares.Solution_0_Test(input);
