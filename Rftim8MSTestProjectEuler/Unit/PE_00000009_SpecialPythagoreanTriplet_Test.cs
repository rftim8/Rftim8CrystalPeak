...
{
    [TestClass]
    public sealed class PE_00000009_SpecialPythagoreanTriplet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000009_SpecialPythagoreanTriplet));
        ...
        {
            int result = PE_00000009_SpecialPythagoreanTriplet.Solution_0_Test(input);
