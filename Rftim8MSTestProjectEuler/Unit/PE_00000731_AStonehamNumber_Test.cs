...
{
    [TestClass]
    public sealed class PE_00000731_AStonehamNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000731_AStonehamNumber));
        ...
        {
            int result = PE_00000731_AStonehamNumber.Solution_0_Test(input);
