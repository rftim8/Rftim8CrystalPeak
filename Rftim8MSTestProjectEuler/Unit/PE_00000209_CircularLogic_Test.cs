...
{
    [TestClass]
    public sealed class PE_00000209_CircularLogic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000209_CircularLogic));
        ...
        {
            int result = PE_00000209_CircularLogic.Solution_0_Test(input);
