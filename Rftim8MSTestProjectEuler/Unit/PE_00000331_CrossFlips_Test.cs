...
{
    [TestClass]
    public sealed class PE_00000331_CrossFlips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000331_CrossFlips));
        ...
        {
            int result = PE_00000331_CrossFlips.Solution_0_Test(input);
