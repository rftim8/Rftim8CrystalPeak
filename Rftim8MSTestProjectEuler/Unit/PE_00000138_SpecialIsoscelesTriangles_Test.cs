...
{
    [TestClass]
    public sealed class PE_00000138_SpecialIsoscelesTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000138_SpecialIsoscelesTriangles));
        ...
        {
            int result = PE_00000138_SpecialIsoscelesTriangles.Solution_0_Test(input);
