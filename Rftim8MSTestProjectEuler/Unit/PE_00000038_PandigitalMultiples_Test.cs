...
{
    [TestClass]
    public sealed class PE_00000038_PandigitalMultiples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000038_PandigitalMultiples));
        ...
        {
            int result = PE_00000038_PandigitalMultiples.Solution_0_Test(input);
