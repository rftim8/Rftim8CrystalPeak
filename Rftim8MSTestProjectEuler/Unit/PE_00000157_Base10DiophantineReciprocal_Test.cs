...
{
    [TestClass]
    public sealed class PE_00000157_Base10DiophantineReciprocal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000157_Base10DiophantineReciprocal));
        ...
        {
            int result = PE_00000157_Base10DiophantineReciprocal.Solution_0_Test(input);
