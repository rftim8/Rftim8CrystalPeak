...
{
    [TestClass]
    public sealed class PE_00000150_SubtriangleSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000150_SubtriangleSums));
        ...
        {
            int result = PE_00000150_SubtriangleSums.Solution_0_Test(input);
