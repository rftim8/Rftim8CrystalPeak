...
{
    [TestClass]
    public sealed class PE_00000549_DivisibilityOfFactorials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000549_DivisibilityOfFactorials));
        ...
        {
            int result = PE_00000549_DivisibilityOfFactorials.Solution_0_Test(input);
