...
{
    [TestClass]
    public sealed class PE_00000692_SiegbertAndJo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000692_SiegbertAndJo));
        ...
        {
            int result = PE_00000692_SiegbertAndJo.Solution_0_Test(input);
