...
{
    [TestClass]
    public sealed class PE_00000854_PisanoPeriods2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000854_PisanoPeriods2));
        ...
        {
            int result = PE_00000854_PisanoPeriods2.Solution_0_Test(input);
