...
{
    [TestClass]
    public sealed class PE_00000654_NeighbourlyConstraints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000654_NeighbourlyConstraints));
        ...
        {
            int result = PE_00000654_NeighbourlyConstraints.Solution_0_Test(input);
