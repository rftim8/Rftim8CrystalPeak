...
{
    [TestClass]
    public sealed class PE_00000175_FractionsAndSumOfPowersOfTwo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000175_FractionsAndSumOfPowersOfTwo));
        ...
        {
            int result = PE_00000175_FractionsAndSumOfPowersOfTwo.Solution_0_Test(input);
