...
{
    [TestClass]
    public sealed class PE_00000454_DiophantineReciprocalsIII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000454_DiophantineReciprocalsIII));
        ...
        {
            int result = PE_00000454_DiophantineReciprocalsIII.Solution_0_Test(input);
