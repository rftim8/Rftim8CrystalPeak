...
{
    [TestClass]
    public sealed class PE_00000381_PrimeMinusKFactorial_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000381_PrimeMinusKFactorial));
        ...
        {
            int result = PE_00000381_PrimeMinusKFactorial.Solution_0_Test(input);
