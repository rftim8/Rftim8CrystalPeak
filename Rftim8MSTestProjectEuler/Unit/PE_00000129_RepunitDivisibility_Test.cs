...
{
    [TestClass]
    public sealed class PE_00000129_RepunitDivisibility_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000129_RepunitDivisibility));
        ...
        {
            int result = PE_00000129_RepunitDivisibility.Solution_0_Test(input);
