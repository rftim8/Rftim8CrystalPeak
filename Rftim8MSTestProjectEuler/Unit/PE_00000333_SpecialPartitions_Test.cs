...
{
    [TestClass]
    public sealed class PE_00000333_SpecialPartitions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000333_SpecialPartitions));
        ...
        {
            int result = PE_00000333_SpecialPartitions.Solution_0_Test(input);
