...
{
    [TestClass]
    public sealed class PE_00000088_ProductsumNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000088_ProductsumNumbers));
        ...
        {
            int result = PE_00000088_ProductsumNumbers.Solution_0_Test(input);
