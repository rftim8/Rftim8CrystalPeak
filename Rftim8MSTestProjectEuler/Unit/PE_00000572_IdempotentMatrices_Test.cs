...
{
    [TestClass]
    public sealed class PE_00000572_IdempotentMatrices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000572_IdempotentMatrices));
        ...
        {
            int result = PE_00000572_IdempotentMatrices.Solution_0_Test(input);
