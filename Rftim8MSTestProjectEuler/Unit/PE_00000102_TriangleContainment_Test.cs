...
{
    [TestClass]
    public sealed class PE_00000102_TriangleContainment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000102_TriangleContainment));
        ...
        {
            int result = PE_00000102_TriangleContainment.Solution_0_Test(input);
