...
{
    [TestClass]
    public sealed class PE_00000282_TheAckermannFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000282_TheAckermannFunction));
        ...
        {
            int result = PE_00000282_TheAckermannFunction.Solution_0_Test(input);
