...
{
    [TestClass]
    public sealed class PE_00000857_BeautifulGraphs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000857_BeautifulGraphs));
        ...
        {
            int result = PE_00000857_BeautifulGraphs.Solution_0_Test(input);
