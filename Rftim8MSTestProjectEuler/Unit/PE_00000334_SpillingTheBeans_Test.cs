...
{
    [TestClass]
    public sealed class PE_00000334_SpillingTheBeans_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000334_SpillingTheBeans));
        ...
        {
            int result = PE_00000334_SpillingTheBeans.Solution_0_Test(input);
