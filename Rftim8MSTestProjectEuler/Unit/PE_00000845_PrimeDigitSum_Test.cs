...
{
    [TestClass]
    public sealed class PE_00000845_PrimeDigitSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000845_PrimeDigitSum));
        ...
        {
            int result = PE_00000845_PrimeDigitSum.Solution_0_Test(input);
