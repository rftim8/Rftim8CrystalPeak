...
{
    [TestClass]
    public sealed class PE_00000739_SummationOfSummations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000739_SummationOfSummations));
        ...
        {
            int result = PE_00000739_SummationOfSummations.Solution_0_Test(input);
