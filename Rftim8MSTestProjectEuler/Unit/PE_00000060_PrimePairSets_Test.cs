...
{
    [TestClass]
    public sealed class PE_00000060_PrimePairSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000060_PrimePairSets));
        ...
        {
            int result = PE_00000060_PrimePairSets.Solution_0_Test(input);
