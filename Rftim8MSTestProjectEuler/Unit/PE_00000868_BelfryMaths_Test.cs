...
{
    [TestClass]
    public sealed class PE_00000868_BelfryMaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000868_BelfryMaths));
        ...
        {
            int result = PE_00000868_BelfryMaths.Solution_0_Test(input);
