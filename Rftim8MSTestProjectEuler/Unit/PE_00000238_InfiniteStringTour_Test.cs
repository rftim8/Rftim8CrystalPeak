...
{
    [TestClass]
    public sealed class PE_00000238_InfiniteStringTour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000238_InfiniteStringTour));
        ...
        {
            int result = PE_00000238_InfiniteStringTour.Solution_0_Test(input);
