...
{
    [TestClass]
    public sealed class PE_00000555_McCarthy91Function_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000555_McCarthy91Function));
        ...
        {
            int result = PE_00000555_McCarthy91Function.Solution_0_Test(input);
