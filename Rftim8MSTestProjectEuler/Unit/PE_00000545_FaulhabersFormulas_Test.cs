...
{
    [TestClass]
    public sealed class PE_00000545_FaulhabersFormulas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000545_FaulhabersFormulas));
        ...
        {
            int result = PE_00000545_FaulhabersFormulas.Solution_0_Test(input);
