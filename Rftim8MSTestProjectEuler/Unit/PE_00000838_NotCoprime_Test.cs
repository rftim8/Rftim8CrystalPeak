...
{
    [TestClass]
    public sealed class PE_00000838_NotCoprime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000838_NotCoprime));
        ...
        {
            int result = PE_00000838_NotCoprime.Solution_0_Test(input);
