...
{
    [TestClass]
    public sealed class PE_00000378_TriangleTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000378_TriangleTriples));
        ...
        {
            int result = PE_00000378_TriangleTriples.Solution_0_Test(input);
