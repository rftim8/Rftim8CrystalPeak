...
{
    [TestClass]
    public sealed class PE_00000827_PythagoreanTripleOccurrence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000827_PythagoreanTripleOccurrence));
        ...
        {
            int result = PE_00000827_PythagoreanTripleOccurrence.Solution_0_Test(input);
