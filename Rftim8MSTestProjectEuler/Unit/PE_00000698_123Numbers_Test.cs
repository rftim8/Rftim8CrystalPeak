...
{
    [TestClass]
    public sealed class PE_00000698_123Numbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000698_123Numbers));
        ...
        {
            int result = PE_00000698_123Numbers.Solution_0_Test(input);
