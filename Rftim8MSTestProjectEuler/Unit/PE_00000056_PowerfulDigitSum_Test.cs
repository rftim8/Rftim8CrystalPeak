...
{
    [TestClass]
    public sealed class PE_00000056_PowerfulDigitSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000056_PowerfulDigitSum));
        ...
        {
            int result = PE_00000056_PowerfulDigitSum.Solution_0_Test(input);
