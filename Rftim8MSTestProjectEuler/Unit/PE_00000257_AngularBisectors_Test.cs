...
{
    [TestClass]
    public sealed class PE_00000257_AngularBisectors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000257_AngularBisectors));
        ...
        {
            int result = PE_00000257_AngularBisectors.Solution_0_Test(input);
