...
{
    [TestClass]
    public sealed class PE_00000910_LexpressionsII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000910_LexpressionsII));
        ...
        {
            int result = PE_00000910_LexpressionsII.Solution_0_Test(input);
