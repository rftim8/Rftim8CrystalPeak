...
{
    [TestClass]
    public sealed class PE_00000111_PrimesWithRuns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000111_PrimesWithRuns));
        ...
        {
            int result = PE_00000111_PrimesWithRuns.Solution_0_Test(input);
