...
{
    [TestClass]
    public sealed class PE_00000202_Laserbeam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000202_Laserbeam));
        ...
        {
            int result = PE_00000202_Laserbeam.Solution_0_Test(input);
