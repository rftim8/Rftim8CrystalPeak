...
{
    [TestClass]
    public sealed class PE_00000777_LissajousCurves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000777_LissajousCurves));
        ...
        {
            int result = PE_00000777_LissajousCurves.Solution_0_Test(input);
