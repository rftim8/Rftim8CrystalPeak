...
{
    [TestClass]
    public sealed class PE_00000354_DistancesInABeesHoneycomb_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000354_DistancesInABeesHoneycomb));
        ...
        {
            int result = PE_00000354_DistancesInABeesHoneycomb.Solution_0_Test(input);
