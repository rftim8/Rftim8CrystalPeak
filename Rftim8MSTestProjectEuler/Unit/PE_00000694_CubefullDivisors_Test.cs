...
{
    [TestClass]
    public sealed class PE_00000694_CubefullDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000694_CubefullDivisors));
        ...
        {
            int result = PE_00000694_CubefullDivisors.Solution_0_Test(input);
