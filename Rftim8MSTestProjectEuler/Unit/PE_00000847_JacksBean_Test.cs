...
{
    [TestClass]
    public sealed class PE_00000847_JacksBean_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000847_JacksBean));
        ...
        {
            int result = PE_00000847_JacksBean.Solution_0_Test(input);
