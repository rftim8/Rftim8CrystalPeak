...
{
    [TestClass]
    public sealed class PE_00000145_ReversibleNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000145_ReversibleNumbers));
        ...
        {
            int result = PE_00000145_ReversibleNumbers.Solution_0_Test(input);
