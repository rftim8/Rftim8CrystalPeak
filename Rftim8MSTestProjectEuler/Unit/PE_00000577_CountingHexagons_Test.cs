...
{
    [TestClass]
    public sealed class PE_00000577_CountingHexagons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000577_CountingHexagons));
        ...
        {
            int result = PE_00000577_CountingHexagons.Solution_0_Test(input);
