...
{
    [TestClass]
    public sealed class PE_00000059_XORDecryption_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000059_XORDecryption));
        ...
        {
            int result = PE_00000059_XORDecryption.Solution_0_Test(input);
