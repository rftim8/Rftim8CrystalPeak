...
{
    [TestClass]
    public sealed class PE_00000656_PalindromicSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000656_PalindromicSequences));
        ...
        {
            int result = PE_00000656_PalindromicSequences.Solution_0_Test(input);
