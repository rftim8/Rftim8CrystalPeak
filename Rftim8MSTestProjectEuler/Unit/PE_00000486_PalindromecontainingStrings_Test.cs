...
{
    [TestClass]
    public sealed class PE_00000486_PalindromecontainingStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000486_PalindromecontainingStrings));
        ...
        {
            int result = PE_00000486_PalindromecontainingStrings.Solution_0_Test(input);
