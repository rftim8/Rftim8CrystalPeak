...
{
    [TestClass]
    public sealed class PE_00000923_YoungsGameB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000923_YoungsGameB));
        ...
        {
            int result = PE_00000923_YoungsGameB.Solution_0_Test(input);
