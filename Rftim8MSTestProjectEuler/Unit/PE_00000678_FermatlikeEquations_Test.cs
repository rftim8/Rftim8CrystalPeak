...
{
    [TestClass]
    public sealed class PE_00000678_FermatlikeEquations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000678_FermatlikeEquations));
        ...
        {
            int result = PE_00000678_FermatlikeEquations.Solution_0_Test(input);
