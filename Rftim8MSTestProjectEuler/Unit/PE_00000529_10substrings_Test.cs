...
{
    [TestClass]
    public sealed class PE_00000529_10substrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000529_10substrings));
        ...
        {
            int result = PE_00000529_10substrings.Solution_0_Test(input);
