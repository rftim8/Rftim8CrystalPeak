...
{
    [TestClass]
    public sealed class PE_00000163_CrosshatchedTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000163_CrosshatchedTriangles));
        ...
        {
            int result = PE_00000163_CrosshatchedTriangles.Solution_0_Test(input);
