...
{
    [TestClass]
    public sealed class PE_00000369_Badugi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000369_Badugi));
        ...
        {
            int result = PE_00000369_Badugi.Solution_0_Test(input);
