...
{
    [TestClass]
    public sealed class PE_00000560_CoprimeNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000560_CoprimeNim));
        ...
        {
            int result = PE_00000560_CoprimeNim.Solution_0_Test(input);
