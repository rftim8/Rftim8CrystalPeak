...
{
    [TestClass]
    public sealed class PE_00000379_LeastCommonMultipleCount_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000379_LeastCommonMultipleCount));
        ...
        {
            int result = PE_00000379_LeastCommonMultipleCount.Solution_0_Test(input);
