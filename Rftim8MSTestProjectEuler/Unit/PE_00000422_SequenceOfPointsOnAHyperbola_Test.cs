...
{
    [TestClass]
    public sealed class PE_00000422_SequenceOfPointsOnAHyperbola_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000422_SequenceOfPointsOnAHyperbola));
        ...
        {
            int result = PE_00000422_SequenceOfPointsOnAHyperbola.Solution_0_Test(input);
