...
{
    [TestClass]
    public sealed class PE_00000293_PseudoFortunateNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000293_PseudoFortunateNumbers));
        ...
        {
            int result = PE_00000293_PseudoFortunateNumbers.Solution_0_Test(input);
