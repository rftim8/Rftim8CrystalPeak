...
{
    [TestClass]
    public sealed class PE_00000178_StepNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000178_StepNumbers));
        ...
        {
            int result = PE_00000178_StepNumbers.Solution_0_Test(input);
