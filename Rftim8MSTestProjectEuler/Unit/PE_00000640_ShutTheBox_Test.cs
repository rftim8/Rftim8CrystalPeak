...
{
    [TestClass]
    public sealed class PE_00000640_ShutTheBox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000640_ShutTheBox));
        ...
        {
            int result = PE_00000640_ShutTheBox.Solution_0_Test(input);
