...
{
    [TestClass]
    public sealed class PE_00000747_TriangularPizza_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000747_TriangularPizza));
        ...
        {
            int result = PE_00000747_TriangularPizza.Solution_0_Test(input);
