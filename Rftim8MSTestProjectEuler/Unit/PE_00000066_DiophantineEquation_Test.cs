...
{
    [TestClass]
    public sealed class PE_00000066_DiophantineEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000066_DiophantineEquation));
        ...
        {
            int result = PE_00000066_DiophantineEquation.Solution_0_Test(input);
