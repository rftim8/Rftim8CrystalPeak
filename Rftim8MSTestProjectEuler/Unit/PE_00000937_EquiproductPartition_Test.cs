...
{
    [TestClass]
    public sealed class PE_00000937_EquiproductPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000937_EquiproductPartition));
        ...
        {
            int result = PE_00000937_EquiproductPartition.Solution_0_Test(input);
