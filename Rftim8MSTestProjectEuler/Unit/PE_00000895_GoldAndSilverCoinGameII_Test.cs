...
{
    [TestClass]
    public sealed class PE_00000895_GoldAndSilverCoinGameII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000895_GoldAndSilverCoinGameII));
        ...
        {
            int result = PE_00000895_GoldAndSilverCoinGameII.Solution_0_Test(input);
