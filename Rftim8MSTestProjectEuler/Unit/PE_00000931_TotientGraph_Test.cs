...
{
    [TestClass]
    public sealed class PE_00000931_TotientGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000931_TotientGraph));
        ...
        {
            int result = PE_00000931_TotientGraph.Solution_0_Test(input);
