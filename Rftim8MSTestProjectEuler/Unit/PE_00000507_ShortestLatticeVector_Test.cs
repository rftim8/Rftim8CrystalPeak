...
{
    [TestClass]
    public sealed class PE_00000507_ShortestLatticeVector_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000507_ShortestLatticeVector));
        ...
        {
            int result = PE_00000507_ShortestLatticeVector.Solution_0_Test(input);
