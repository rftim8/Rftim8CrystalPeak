...
{
    [TestClass]
    public sealed class PE_00000670_ColouringAStrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000670_ColouringAStrip));
        ...
        {
            int result = PE_00000670_ColouringAStrip.Solution_0_Test(input);
