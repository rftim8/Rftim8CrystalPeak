...
{
    [TestClass]
    public sealed class PE_00000519_TricolouredCoinFountains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000519_TricolouredCoinFountains));
        ...
        {
            int result = PE_00000519_TricolouredCoinFountains.Solution_0_Test(input);
