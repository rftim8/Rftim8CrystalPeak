...
{
    [TestClass]
    public sealed class PE_00000197_ARecursivelyDefinedSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000197_ARecursivelyDefinedSequence));
        ...
        {
            int result = PE_00000197_ARecursivelyDefinedSequence.Solution_0_Test(input);
