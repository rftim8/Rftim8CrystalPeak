...
{
    [TestClass]
    public sealed class PE_00000718_UnreachableNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000718_UnreachableNumbers));
        ...
        {
            int result = PE_00000718_UnreachableNumbers.Solution_0_Test(input);
