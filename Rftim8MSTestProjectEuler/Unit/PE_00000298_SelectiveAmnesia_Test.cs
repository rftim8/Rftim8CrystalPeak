...
{
    [TestClass]
    public sealed class PE_00000298_SelectiveAmnesia_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000298_SelectiveAmnesia));
        ...
        {
            int result = PE_00000298_SelectiveAmnesia.Solution_0_Test(input);
