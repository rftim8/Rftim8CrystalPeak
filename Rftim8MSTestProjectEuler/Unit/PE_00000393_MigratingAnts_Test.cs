...
{
    [TestClass]
    public sealed class PE_00000393_MigratingAnts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000393_MigratingAnts));
        ...
        {
            int result = PE_00000393_MigratingAnts.Solution_0_Test(input);
