...
{
    [TestClass]
    public sealed class PE_00000034_DigitFactorials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000034_DigitFactorials));
        ...
        {
            int result = PE_00000034_DigitFactorials.Solution_0_Test(input);
