...
{
    [TestClass]
    public sealed class PE_00000440_GCDAndTiling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000440_GCDAndTiling));
        ...
        {
            int result = PE_00000440_GCDAndTiling.Solution_0_Test(input);
