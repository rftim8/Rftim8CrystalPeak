...
{
    [TestClass]
    public sealed class PE_00000179_ConsecutivePositiveDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000179_ConsecutivePositiveDivisors));
        ...
        {
            int result = PE_00000179_ConsecutivePositiveDivisors.Solution_0_Test(input);
