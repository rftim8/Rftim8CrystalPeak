...
{
    [TestClass]
    public sealed class PE_00000908_ClockSequenceII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000908_ClockSequenceII));
        ...
        {
            int result = PE_00000908_ClockSequenceII.Solution_0_Test(input);
