...
{
    [TestClass]
    public sealed class PE_00000183_MaximumProductOfParts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000183_MaximumProductOfParts));
        ...
        {
            int result = PE_00000183_MaximumProductOfParts.Solution_0_Test(input);
