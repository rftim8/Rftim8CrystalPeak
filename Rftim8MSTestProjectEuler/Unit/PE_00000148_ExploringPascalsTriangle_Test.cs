...
{
    [TestClass]
    public sealed class PE_00000148_ExploringPascalsTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000148_ExploringPascalsTriangle));
        ...
        {
            int result = PE_00000148_ExploringPascalsTriangle.Solution_0_Test(input);
