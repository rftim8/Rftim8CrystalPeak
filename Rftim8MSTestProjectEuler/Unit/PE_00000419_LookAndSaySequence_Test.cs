...
{
    [TestClass]
    public sealed class PE_00000419_LookAndSaySequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000419_LookAndSaySequence));
        ...
        {
            int result = PE_00000419_LookAndSaySequence.Solution_0_Test(input);
