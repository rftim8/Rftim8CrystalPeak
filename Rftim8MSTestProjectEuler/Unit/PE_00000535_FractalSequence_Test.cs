...
{
    [TestClass]
    public sealed class PE_00000535_FractalSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000535_FractalSequence));
        ...
        {
            int result = PE_00000535_FractalSequence.Solution_0_Test(input);
