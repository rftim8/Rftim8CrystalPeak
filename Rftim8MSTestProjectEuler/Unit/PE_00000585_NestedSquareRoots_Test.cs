...
{
    [TestClass]
    public sealed class PE_00000585_NestedSquareRoots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000585_NestedSquareRoots));
        ...
        {
            int result = PE_00000585_NestedSquareRoots.Solution_0_Test(input);
