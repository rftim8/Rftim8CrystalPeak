...
{
    [TestClass]
    public sealed class PE_00000846_MagicBracelets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000846_MagicBracelets));
        ...
        {
            int result = PE_00000846_MagicBracelets.Solution_0_Test(input);
