...
{
    [TestClass]
    public sealed class PE_00000494_CollatzPrefixFamilies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000494_CollatzPrefixFamilies));
        ...
        {
            int result = PE_00000494_CollatzPrefixFamilies.Solution_0_Test(input);
