...
{
    [TestClass]
    public sealed class PE_00000266_PseudoSquareRoot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000266_PseudoSquareRoot));
        ...
        {
            int result = PE_00000266_PseudoSquareRoot.Solution_0_Test(input);
