...
{
    [TestClass]
    public sealed class PE_00000778_FreshmansProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000778_FreshmansProduct));
        ...
        {
            int result = PE_00000778_FreshmansProduct.Solution_0_Test(input);
