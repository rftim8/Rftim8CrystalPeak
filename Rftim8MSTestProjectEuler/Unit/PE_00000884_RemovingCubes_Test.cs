...
{
    [TestClass]
    public sealed class PE_00000884_RemovingCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000884_RemovingCubes));
        ...
        {
            int result = PE_00000884_RemovingCubes.Solution_0_Test(input);
