...
{
    [TestClass]
    public sealed class PE_00000314_TheMouseOnTheMoon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000314_TheMouseOnTheMoon));
        ...
        {
            int result = PE_00000314_TheMouseOnTheMoon.Solution_0_Test(input);
