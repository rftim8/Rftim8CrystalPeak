...
{
    [TestClass]
    public sealed class PE_00000033_DigitCancellingFractions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000033_DigitCancellingFractions));
        ...
        {
            int result = PE_00000033_DigitCancellingFractions.Solution_0_Test(input);
