...
{
    [TestClass]
    public sealed class PE_00000661_ALongChessMatch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000661_ALongChessMatch));
        ...
        {
            int result = PE_00000661_ALongChessMatch.Solution_0_Test(input);
