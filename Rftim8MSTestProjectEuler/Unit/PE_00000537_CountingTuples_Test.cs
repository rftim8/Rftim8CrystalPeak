...
{
    [TestClass]
    public sealed class PE_00000537_CountingTuples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000537_CountingTuples));
        ...
        {
            int result = PE_00000537_CountingTuples.Solution_0_Test(input);
