...
{
    [TestClass]
    public sealed class PE_00000177_IntegerAngledQuadrilaterals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000177_IntegerAngledQuadrilaterals));
        ...
        {
            int result = PE_00000177_IntegerAngledQuadrilaterals.Solution_0_Test(input);
