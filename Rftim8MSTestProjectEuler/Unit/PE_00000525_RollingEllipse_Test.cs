...
{
    [TestClass]
    public sealed class PE_00000525_RollingEllipse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000525_RollingEllipse));
        ...
        {
            int result = PE_00000525_RollingEllipse.Solution_0_Test(input);
