...
{
    [TestClass]
    public sealed class PE_00000708_TwosAreAllYouNeed_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000708_TwosAreAllYouNeed));
        ...
        {
            int result = PE_00000708_TwosAreAllYouNeed.Solution_0_Test(input);
