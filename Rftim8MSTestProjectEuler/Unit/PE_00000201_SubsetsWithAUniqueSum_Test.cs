...
{
    [TestClass]
    public sealed class PE_00000201_SubsetsWithAUniqueSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000201_SubsetsWithAUniqueSum));
        ...
        {
            int result = PE_00000201_SubsetsWithAUniqueSum.Solution_0_Test(input);
