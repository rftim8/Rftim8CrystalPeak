...
{
    [TestClass]
    public sealed class PE_00000082_PathSumThreeWays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000082_PathSumThreeWays));
        ...
        {
            int result = PE_00000082_PathSumThreeWays.Solution_0_Test(input);
