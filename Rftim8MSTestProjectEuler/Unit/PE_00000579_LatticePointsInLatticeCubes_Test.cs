...
{
    [TestClass]
    public sealed class PE_00000579_LatticePointsInLatticeCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000579_LatticePointsInLatticeCubes));
        ...
        {
            int result = PE_00000579_LatticePointsInLatticeCubes.Solution_0_Test(input);
