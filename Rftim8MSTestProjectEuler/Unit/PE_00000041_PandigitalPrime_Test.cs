...
{
    [TestClass]
    public sealed class PE_00000041_PandigitalPrime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000041_PandigitalPrime));
        ...
        {
            int result = PE_00000041_PandigitalPrime.Solution_0_Test(input);
