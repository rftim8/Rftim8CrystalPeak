...
{
    [TestClass]
    public sealed class PE_00000065_ConvergentsOfE_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000065_ConvergentsOfE));
        ...
        {
            int result = PE_00000065_ConvergentsOfE.Solution_0_Test(input);
