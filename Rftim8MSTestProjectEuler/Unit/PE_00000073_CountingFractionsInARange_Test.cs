...
{
    [TestClass]
    public sealed class PE_00000073_CountingFractionsInARange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000073_CountingFractionsInARange));
        ...
        {
            int result = PE_00000073_CountingFractionsInARange.Solution_0_Test(input);
