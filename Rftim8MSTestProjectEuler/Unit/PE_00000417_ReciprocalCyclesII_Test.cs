...
{
    [TestClass]
    public sealed class PE_00000417_ReciprocalCyclesII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000417_ReciprocalCyclesII));
        ...
        {
            int result = PE_00000417_ReciprocalCyclesII.Solution_0_Test(input);
