...
{
    [TestClass]
    public sealed class PE_00000228_MinkowskiSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000228_MinkowskiSums));
        ...
        {
            int result = PE_00000228_MinkowskiSums.Solution_0_Test(input);
