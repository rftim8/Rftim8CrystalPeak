...
{
    [TestClass]
    public sealed class PE_00000053_CombinatoricSelections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000053_CombinatoricSelections));
        ...
        {
            int result = PE_00000053_CombinatoricSelections.Solution_0_Test(input);
