...
{
    [TestClass]
    public sealed class PE_00000722_SlowlyConvergingSeries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000722_SlowlyConvergingSeries));
        ...
        {
            int result = PE_00000722_SlowlyConvergingSeries.Solution_0_Test(input);
