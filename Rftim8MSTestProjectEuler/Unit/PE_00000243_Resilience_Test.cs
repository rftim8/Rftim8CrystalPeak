...
{
    [TestClass]
    public sealed class PE_00000243_Resilience_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000243_Resilience));
        ...
        {
            int result = PE_00000243_Resilience.Solution_0_Test(input);
