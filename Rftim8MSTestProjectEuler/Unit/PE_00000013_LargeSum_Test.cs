...
{
    [TestClass]
    public sealed class PE_00000013_LargeSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000013_LargeSum));
        ...
        {
            int result = PE_00000013_LargeSum.Solution_0_Test(input);
