...
{
    [TestClass]
    public sealed class PE_00000349_LangtonsAnt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000349_LangtonsAnt));
        ...
        {
            int result = PE_00000349_LangtonsAnt.Solution_0_Test(input);
