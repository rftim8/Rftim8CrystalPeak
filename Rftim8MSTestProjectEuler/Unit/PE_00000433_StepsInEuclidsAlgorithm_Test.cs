...
{
    [TestClass]
    public sealed class PE_00000433_StepsInEuclidsAlgorithm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000433_StepsInEuclidsAlgorithm));
        ...
        {
            int result = PE_00000433_StepsInEuclidsAlgorithm.Solution_0_Test(input);
