...
{
    [TestClass]
    public sealed class PE_00000155_CountingCapacitorCircuits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000155_CountingCapacitorCircuits));
        ...
        {
            int result = PE_00000155_CountingCapacitorCircuits.Solution_0_Test(input);
