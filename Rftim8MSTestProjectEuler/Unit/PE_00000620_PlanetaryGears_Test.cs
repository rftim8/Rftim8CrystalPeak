...
{
    [TestClass]
    public sealed class PE_00000620_PlanetaryGears_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000620_PlanetaryGears));
        ...
        {
            int result = PE_00000620_PlanetaryGears.Solution_0_Test(input);
