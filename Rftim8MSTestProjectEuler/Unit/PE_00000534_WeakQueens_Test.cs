...
{
    [TestClass]
    public sealed class PE_00000534_WeakQueens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000534_WeakQueens));
        ...
        {
            int result = PE_00000534_WeakQueens.Solution_0_Test(input);
