...
{
    [TestClass]
    public sealed class PE_00000649_LowPrimeChessboardNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000649_LowPrimeChessboardNim));
        ...
        {
            int result = PE_00000649_LowPrimeChessboardNim.Solution_0_Test(input);
