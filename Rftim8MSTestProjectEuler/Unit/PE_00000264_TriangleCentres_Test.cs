...
{
    [TestClass]
    public sealed class PE_00000264_TriangleCentres_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000264_TriangleCentres));
        ...
        {
            int result = PE_00000264_TriangleCentres.Solution_0_Test(input);
