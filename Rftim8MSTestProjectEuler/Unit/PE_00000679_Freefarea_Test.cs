...
{
    [TestClass]
    public sealed class PE_00000679_Freefarea_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000679_Freefarea));
        ...
        {
            int result = PE_00000679_Freefarea.Solution_0_Test(input);
