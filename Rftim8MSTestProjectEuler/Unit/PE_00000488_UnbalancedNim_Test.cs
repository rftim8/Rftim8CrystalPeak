...
{
    [TestClass]
    public sealed class PE_00000488_UnbalancedNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000488_UnbalancedNim));
        ...
        {
            int result = PE_00000488_UnbalancedNim.Solution_0_Test(input);
