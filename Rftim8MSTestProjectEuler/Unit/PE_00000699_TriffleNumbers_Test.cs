...
{
    [TestClass]
    public sealed class PE_00000699_TriffleNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000699_TriffleNumbers));
        ...
        {
            int result = PE_00000699_TriffleNumbers.Solution_0_Test(input);
