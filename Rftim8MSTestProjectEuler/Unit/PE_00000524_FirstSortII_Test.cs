...
{
    [TestClass]
    public sealed class PE_00000524_FirstSortII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000524_FirstSortII));
        ...
        {
            int result = PE_00000524_FirstSortII.Solution_0_Test(input);
