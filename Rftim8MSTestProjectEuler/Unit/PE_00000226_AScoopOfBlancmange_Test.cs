...
{
    [TestClass]
    public sealed class PE_00000226_AScoopOfBlancmange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000226_AScoopOfBlancmange));
        ...
        {
            int result = PE_00000226_AScoopOfBlancmange.Solution_0_Test(input);
