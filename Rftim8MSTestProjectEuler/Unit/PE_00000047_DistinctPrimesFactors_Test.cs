...
{
    [TestClass]
    public sealed class PE_00000047_DistinctPrimesFactors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000047_DistinctPrimesFactors));
        ...
        {
            int result = PE_00000047_DistinctPrimesFactors.Solution_0_Test(input);
