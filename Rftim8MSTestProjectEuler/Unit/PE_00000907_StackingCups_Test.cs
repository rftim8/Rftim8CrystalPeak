...
{
    [TestClass]
    public sealed class PE_00000907_StackingCups_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000907_StackingCups));
        ...
        {
            int result = PE_00000907_StackingCups.Solution_0_Test(input);
