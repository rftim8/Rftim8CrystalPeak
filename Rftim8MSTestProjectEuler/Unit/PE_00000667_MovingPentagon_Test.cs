...
{
    [TestClass]
    public sealed class PE_00000667_MovingPentagon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000667_MovingPentagon));
        ...
        {
            int result = PE_00000667_MovingPentagon.Solution_0_Test(input);
