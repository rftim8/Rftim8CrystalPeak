...
{
    [TestClass]
    public sealed class PE_00000797_CyclogenicPolynomials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000797_CyclogenicPolynomials));
        ...
        {
            int result = PE_00000797_CyclogenicPolynomials.Solution_0_Test(input);
