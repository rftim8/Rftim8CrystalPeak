...
{
    [TestClass]
    public sealed class PE_00000834_AddAndDivide_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000834_AddAndDivide));
        ...
        {
            int result = PE_00000834_AddAndDivide.Solution_0_Test(input);
