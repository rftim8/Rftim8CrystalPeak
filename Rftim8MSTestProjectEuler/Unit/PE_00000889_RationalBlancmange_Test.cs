...
{
    [TestClass]
    public sealed class PE_00000889_RationalBlancmange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000889_RationalBlancmange));
        ...
        {
            int result = PE_00000889_RationalBlancmange.Solution_0_Test(input);
