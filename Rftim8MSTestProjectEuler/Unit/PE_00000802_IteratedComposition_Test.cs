...
{
    [TestClass]
    public sealed class PE_00000802_IteratedComposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000802_IteratedComposition));
        ...
        {
            int result = PE_00000802_IteratedComposition.Solution_0_Test(input);
