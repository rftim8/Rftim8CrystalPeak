...
{
    [TestClass]
    public sealed class PE_00000064_OddPeriodSquareRoots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000064_OddPeriodSquareRoots));
        ...
        {
            int result = PE_00000064_OddPeriodSquareRoots.Solution_0_Test(input);
