...
{
    [TestClass]
    public sealed class PE_00000878_XOREquationB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000878_XOREquationB));
        ...
        {
            int result = PE_00000878_XOREquationB.Solution_0_Test(input);
