...
{
    [TestClass]
    public sealed class PE_00000874_MaximalPrimeScore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000874_MaximalPrimeScore));
        ...
        {
            int result = PE_00000874_MaximalPrimeScore.Solution_0_Test(input);
