...
{
    [TestClass]
    public sealed class PE_00000092_SquareDigitChains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000092_SquareDigitChains));
        ...
        {
            int result = PE_00000092_SquareDigitChains.Solution_0_Test(input);
