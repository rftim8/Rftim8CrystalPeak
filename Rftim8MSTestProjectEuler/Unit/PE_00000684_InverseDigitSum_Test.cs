...
{
    [TestClass]
    public sealed class PE_00000684_InverseDigitSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000684_InverseDigitSum));
        ...
        {
            int result = PE_00000684_InverseDigitSum.Solution_0_Test(input);
