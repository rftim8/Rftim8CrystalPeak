...
{
    [TestClass]
    public sealed class PE_00000573_UnfairRace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000573_UnfairRace));
        ...
        {
            int result = PE_00000573_UnfairRace.Solution_0_Test(input);
