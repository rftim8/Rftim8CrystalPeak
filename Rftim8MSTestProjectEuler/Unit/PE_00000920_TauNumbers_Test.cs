...
{
    [TestClass]
    public sealed class PE_00000920_TauNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000920_TauNumbers));
        ...
        {
            int result = PE_00000920_TauNumbers.Solution_0_Test(input);
