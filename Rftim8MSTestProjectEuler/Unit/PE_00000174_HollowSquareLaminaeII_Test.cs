...
{
    [TestClass]
    public sealed class PE_00000174_HollowSquareLaminaeII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000174_HollowSquareLaminaeII));
        ...
        {
            int result = PE_00000174_HollowSquareLaminaeII.Solution_0_Test(input);
