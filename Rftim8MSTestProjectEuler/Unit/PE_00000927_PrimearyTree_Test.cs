...
{
    [TestClass]
    public sealed class PE_00000927_PrimearyTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000927_PrimearyTree));
        ...
        {
            int result = PE_00000927_PrimearyTree.Solution_0_Test(input);
