...
{
    [TestClass]
    public sealed class PE_00000478_Mixtures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000478_Mixtures));
        ...
        {
            int result = PE_00000478_Mixtures.Solution_0_Test(input);
