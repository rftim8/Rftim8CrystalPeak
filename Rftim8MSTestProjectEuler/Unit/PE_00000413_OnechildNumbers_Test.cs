...
{
    [TestClass]
    public sealed class PE_00000413_OnechildNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000413_OnechildNumbers));
        ...
        {
            int result = PE_00000413_OnechildNumbers.Solution_0_Test(input);
