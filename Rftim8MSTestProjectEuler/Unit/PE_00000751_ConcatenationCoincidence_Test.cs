...
{
    [TestClass]
    public sealed class PE_00000751_ConcatenationCoincidence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000751_ConcatenationCoincidence));
        ...
        {
            int result = PE_00000751_ConcatenationCoincidence.Solution_0_Test(input);
