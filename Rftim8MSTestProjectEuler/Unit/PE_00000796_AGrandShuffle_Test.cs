...
{
    [TestClass]
    public sealed class PE_00000796_AGrandShuffle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000796_AGrandShuffle));
        ...
        {
            int result = PE_00000796_AGrandShuffle.Solution_0_Test(input);
