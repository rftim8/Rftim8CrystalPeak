...
{
    [TestClass]
    public sealed class PE_00000696_Mahjong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000696_Mahjong));
        ...
        {
            int result = PE_00000696_Mahjong.Solution_0_Test(input);
