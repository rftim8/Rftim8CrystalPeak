...
{
    [TestClass]
    public sealed class PE_00000522_HilbertsBlackout_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000522_HilbertsBlackout));
        ...
        {
            int result = PE_00000522_HilbertsBlackout.Solution_0_Test(input);
