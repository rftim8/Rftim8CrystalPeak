...
{
    [TestClass]
    public sealed class PE_00000072_CountingFractions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000072_CountingFractions));
        ...
        {
            int result = PE_00000072_CountingFractions.Solution_0_Test(input);
