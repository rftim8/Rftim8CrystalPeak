...
{
    [TestClass]
    public sealed class PE_00000668_SquareRootSmoothNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000668_SquareRootSmoothNumbers));
        ...
        {
            int result = PE_00000668_SquareRootSmoothNumbers.Solution_0_Test(input);
