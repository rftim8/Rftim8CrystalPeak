...
{
    [TestClass]
    public sealed class PE_00000897_MaximalNgonInARegion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000897_MaximalNgonInARegion));
        ...
        {
            int result = PE_00000897_MaximalNgonInARegion.Solution_0_Test(input);
