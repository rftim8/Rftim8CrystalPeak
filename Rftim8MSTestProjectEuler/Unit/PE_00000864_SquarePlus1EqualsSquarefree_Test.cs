...
{
    [TestClass]
    public sealed class PE_00000864_SquarePlus1EqualsSquarefree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000864_SquarePlus1EqualsSquarefree));
        ...
        {
            int result = PE_00000864_SquarePlus1EqualsSquarefree.Solution_0_Test(input);
