...
{
    [TestClass]
    public sealed class PE_00000387_HarshadNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000387_HarshadNumbers));
        ...
        {
            int result = PE_00000387_HarshadNumbers.Solution_0_Test(input);
