...
{
    [TestClass]
    public sealed class PE_00000502_CountingCastles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000502_CountingCastles));
        ...
        {
            int result = PE_00000502_CountingCastles.Solution_0_Test(input);
