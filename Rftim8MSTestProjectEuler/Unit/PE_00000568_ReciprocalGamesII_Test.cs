...
{
    [TestClass]
    public sealed class PE_00000568_ReciprocalGamesII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000568_ReciprocalGamesII));
        ...
        {
            int result = PE_00000568_ReciprocalGamesII.Solution_0_Test(input);
