...
{
    [TestClass]
    public sealed class PE_00000725_DigitSumNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000725_DigitSumNumbers));
        ...
        {
            int result = PE_00000725_DigitSumNumbers.Solution_0_Test(input);
