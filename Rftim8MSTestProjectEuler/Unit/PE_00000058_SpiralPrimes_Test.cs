...
{
    [TestClass]
    public sealed class PE_00000058_SpiralPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000058_SpiralPrimes));
        ...
        {
            int result = PE_00000058_SpiralPrimes.Solution_0_Test(input);
