...
{
    [TestClass]
    public sealed class PE_00000135_SameDifferences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000135_SameDifferences));
        ...
        {
            int result = PE_00000135_SameDifferences.Solution_0_Test(input);
