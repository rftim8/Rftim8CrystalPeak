...
{
    [TestClass]
    public sealed class PE_00000317_Firecracker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000317_Firecracker));
        ...
        {
            int result = PE_00000317_Firecracker.Solution_0_Test(input);
