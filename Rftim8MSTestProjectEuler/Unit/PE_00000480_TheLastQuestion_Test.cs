...
{
    [TestClass]
    public sealed class PE_00000480_TheLastQuestion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000480_TheLastQuestion));
        ...
        {
            int result = PE_00000480_TheLastQuestion.Solution_0_Test(input);
