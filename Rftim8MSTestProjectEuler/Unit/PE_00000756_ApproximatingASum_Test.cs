...
{
    [TestClass]
    public sealed class PE_00000756_ApproximatingASum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000756_ApproximatingASum));
        ...
        {
            int result = PE_00000756_ApproximatingASum.Solution_0_Test(input);
