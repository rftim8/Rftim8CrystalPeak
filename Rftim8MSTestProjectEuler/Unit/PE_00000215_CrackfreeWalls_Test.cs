...
{
    [TestClass]
    public sealed class PE_00000215_CrackfreeWalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000215_CrackfreeWalls));
        ...
        {
            int result = PE_00000215_CrackfreeWalls.Solution_0_Test(input);
