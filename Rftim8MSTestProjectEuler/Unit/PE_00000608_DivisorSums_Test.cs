...
{
    [TestClass]
    public sealed class PE_00000608_DivisorSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000608_DivisorSums));
        ...
        {
            int result = PE_00000608_DivisorSums.Solution_0_Test(input);
