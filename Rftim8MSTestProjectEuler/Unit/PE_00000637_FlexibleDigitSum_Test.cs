...
{
    [TestClass]
    public sealed class PE_00000637_FlexibleDigitSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000637_FlexibleDigitSum));
        ...
        {
            int result = PE_00000637_FlexibleDigitSum.Solution_0_Test(input);
