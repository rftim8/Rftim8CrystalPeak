...
{
    [TestClass]
    public sealed class PE_00000484_ArithmeticDerivative_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000484_ArithmeticDerivative));
        ...
        {
            int result = PE_00000484_ArithmeticDerivative.Solution_0_Test(input);
