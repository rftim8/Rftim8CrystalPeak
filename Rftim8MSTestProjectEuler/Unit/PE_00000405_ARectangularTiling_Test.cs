...
{
    [TestClass]
    public sealed class PE_00000405_ARectangularTiling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000405_ARectangularTiling));
        ...
        {
            int result = PE_00000405_ARectangularTiling.Solution_0_Test(input);
