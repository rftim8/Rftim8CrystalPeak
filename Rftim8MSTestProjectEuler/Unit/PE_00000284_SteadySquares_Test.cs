...
{
    [TestClass]
    public sealed class PE_00000284_SteadySquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000284_SteadySquares));
        ...
        {
            int result = PE_00000284_SteadySquares.Solution_0_Test(input);
