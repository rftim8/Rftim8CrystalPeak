...
{
    [TestClass]
    public sealed class PE_00000288_AnEnormousFactorial_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000288_AnEnormousFactorial));
        ...
        {
            int result = PE_00000288_AnEnormousFactorial.Solution_0_Test(input);
