...
{
    [TestClass]
    public sealed class PE_00000297_ZeckendorfRepresentation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000297_ZeckendorfRepresentation));
        ...
        {
            int result = PE_00000297_ZeckendorfRepresentation.Solution_0_Test(input);
