...
{
    [TestClass]
    public sealed class PE_00000402_IntegervaluedPolynomials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000402_IntegervaluedPolynomials));
        ...
        {
            int result = PE_00000402_IntegervaluedPolynomials.Solution_0_Test(input);
