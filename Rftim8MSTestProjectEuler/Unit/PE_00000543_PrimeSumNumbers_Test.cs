...
{
    [TestClass]
    public sealed class PE_00000543_PrimeSumNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000543_PrimeSumNumbers));
        ...
        {
            int result = PE_00000543_PrimeSumNumbers.Solution_0_Test(input);
