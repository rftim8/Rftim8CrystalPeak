...
{
    [TestClass]
    public sealed class PE_00000232_TheRace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000232_TheRace));
        ...
        {
            int result = PE_00000232_TheRace.Solution_0_Test(input);
