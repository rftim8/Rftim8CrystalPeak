...
{
    [TestClass]
    public sealed class PE_00000465_PolarPolygons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000465_PolarPolygons));
        ...
        {
            int result = PE_00000465_PolarPolygons.Solution_0_Test(input);
