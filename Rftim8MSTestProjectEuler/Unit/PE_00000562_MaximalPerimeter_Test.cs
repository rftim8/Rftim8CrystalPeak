...
{
    [TestClass]
    public sealed class PE_00000562_MaximalPerimeter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000562_MaximalPerimeter));
        ...
        {
            int result = PE_00000562_MaximalPerimeter.Solution_0_Test(input);
