...
{
    [TestClass]
    public sealed class PE_00000571_SuperPandigitalNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000571_SuperPandigitalNumbers));
        ...
        {
            int result = PE_00000571_SuperPandigitalNumbers.Solution_0_Test(input);
