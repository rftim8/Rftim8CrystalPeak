...
{
    [TestClass]
    public sealed class PE_00000261_PivotalSquareSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000261_PivotalSquareSums));
        ...
        {
            int result = PE_00000261_PivotalSquareSums.Solution_0_Test(input);
