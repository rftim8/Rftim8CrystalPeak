...
{
    [TestClass]
    public sealed class PE_00000423_ConsecutiveDieThrows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000423_ConsecutiveDieThrows));
        ...
        {
            int result = PE_00000423_ConsecutiveDieThrows.Solution_0_Test(input);
