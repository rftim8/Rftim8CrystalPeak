...
{
    [TestClass]
    public sealed class PE_00000391_HoppingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000391_HoppingGame));
        ...
        {
            int result = PE_00000391_HoppingGame.Solution_0_Test(input);
