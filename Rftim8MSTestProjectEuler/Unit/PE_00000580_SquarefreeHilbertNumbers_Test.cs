...
{
    [TestClass]
    public sealed class PE_00000580_SquarefreeHilbertNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000580_SquarefreeHilbertNumbers));
        ...
        {
            int result = PE_00000580_SquarefreeHilbertNumbers.Solution_0_Test(input);
