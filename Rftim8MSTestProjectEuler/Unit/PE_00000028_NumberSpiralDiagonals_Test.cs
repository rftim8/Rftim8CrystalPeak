...
{
    [TestClass]
    public sealed class PE_00000028_NumberSpiralDiagonals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000028_NumberSpiralDiagonals));
        ...
        {
            int result = PE_00000028_NumberSpiralDiagonals.Solution_0_Test(input);
