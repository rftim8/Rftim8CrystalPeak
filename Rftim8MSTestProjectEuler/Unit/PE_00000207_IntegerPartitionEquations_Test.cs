...
{
    [TestClass]
    public sealed class PE_00000207_IntegerPartitionEquations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000207_IntegerPartitionEquations));
        ...
        {
            int result = PE_00000207_IntegerPartitionEquations.Solution_0_Test(input);
