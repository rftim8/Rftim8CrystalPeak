...
{
    [TestClass]
    public sealed class PE_00000005_SmallestMultiple_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000005_SmallestMultiple));
        ...
        {
            int result = PE_00000005_SmallestMultiple.Solution_0_Test(input);
