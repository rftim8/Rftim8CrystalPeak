...
{
    [TestClass]
    public sealed class PE_00000352_BloodTests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000352_BloodTests));
        ...
        {
            int result = PE_00000352_BloodTests.Solution_0_Test(input);
