...
{
    [TestClass]
    public sealed class PE_00000326_ModuloSummations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000326_ModuloSummations));
        ...
        {
            int result = PE_00000326_ModuloSummations.Solution_0_Test(input);
