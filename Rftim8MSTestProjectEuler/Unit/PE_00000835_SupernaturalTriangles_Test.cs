...
{
    [TestClass]
    public sealed class PE_00000835_SupernaturalTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000835_SupernaturalTriangles));
        ...
        {
            int result = PE_00000835_SupernaturalTriangles.Solution_0_Test(input);
