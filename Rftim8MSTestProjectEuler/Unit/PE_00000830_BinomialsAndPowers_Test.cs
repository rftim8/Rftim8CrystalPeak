...
{
    [TestClass]
    public sealed class PE_00000830_BinomialsAndPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000830_BinomialsAndPowers));
        ...
        {
            int result = PE_00000830_BinomialsAndPowers.Solution_0_Test(input);
