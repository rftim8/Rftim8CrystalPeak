...
{
    [TestClass]
    public sealed class PE_00000006_SumSquareDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000006_SumSquareDifference));
        ...
        {
            int result = PE_00000006_SumSquareDifference.Solution_0_Test(input);
