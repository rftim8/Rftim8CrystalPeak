...
{
    [TestClass]
    public sealed class PE_00000767_WindowIntoAMatrixII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000767_WindowIntoAMatrixII));
        ...
        {
            int result = PE_00000767_WindowIntoAMatrixII.Solution_0_Test(input);
