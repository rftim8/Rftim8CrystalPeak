...
{
    [TestClass]
    public sealed class PE_00000745_SumOfSquaresII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000745_SumOfSquaresII));
        ...
        {
            int result = PE_00000745_SumOfSquaresII.Solution_0_Test(input);
