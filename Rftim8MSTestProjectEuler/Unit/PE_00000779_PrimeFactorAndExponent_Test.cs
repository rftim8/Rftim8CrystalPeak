...
{
    [TestClass]
    public sealed class PE_00000779_PrimeFactorAndExponent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000779_PrimeFactorAndExponent));
        ...
        {
            int result = PE_00000779_PrimeFactorAndExponent.Solution_0_Test(input);
