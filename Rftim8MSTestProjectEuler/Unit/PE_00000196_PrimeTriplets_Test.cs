...
{
    [TestClass]
    public sealed class PE_00000196_PrimeTriplets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000196_PrimeTriplets));
        ...
        {
            int result = PE_00000196_PrimeTriplets.Solution_0_Test(input);
