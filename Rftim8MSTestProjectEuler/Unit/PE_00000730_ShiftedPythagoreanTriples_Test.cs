...
{
    [TestClass]
    public sealed class PE_00000730_ShiftedPythagoreanTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000730_ShiftedPythagoreanTriples));
        ...
        {
            int result = PE_00000730_ShiftedPythagoreanTriples.Solution_0_Test(input);
