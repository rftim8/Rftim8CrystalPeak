...
{
    [TestClass]
    public sealed class PE_00000723_PythagoreanQuadrilaterals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000723_PythagoreanQuadrilaterals));
        ...
        {
            int result = PE_00000723_PythagoreanQuadrilaterals.Solution_0_Test(input);
