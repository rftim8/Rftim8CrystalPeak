...
{
    [TestClass]
    public sealed class PE_00000416_AFrogsTrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000416_AFrogsTrip));
        ...
        {
            int result = PE_00000416_AFrogsTrip.Solution_0_Test(input);
