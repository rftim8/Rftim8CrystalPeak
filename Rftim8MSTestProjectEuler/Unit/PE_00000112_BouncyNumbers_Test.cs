...
{
    [TestClass]
    public sealed class PE_00000112_BouncyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000112_BouncyNumbers));
        ...
        {
            int result = PE_00000112_BouncyNumbers.Solution_0_Test(input);
