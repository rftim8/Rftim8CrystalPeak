...
{
    [TestClass]
    public sealed class PE_00000219_SkewcostCoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000219_SkewcostCoding));
        ...
        {
            int result = PE_00000219_SkewcostCoding.Solution_0_Test(input);
