...
{
    [TestClass]
    public sealed class PE_00000085_CountingRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000085_CountingRectangles));
        ...
        {
            int result = PE_00000085_CountingRectangles.Solution_0_Test(input);
