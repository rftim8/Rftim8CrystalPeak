...
{
    [TestClass]
    public sealed class PE_00000690_TomAndJerry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000690_TomAndJerry));
        ...
        {
            int result = PE_00000690_TomAndJerry.Solution_0_Test(input);
