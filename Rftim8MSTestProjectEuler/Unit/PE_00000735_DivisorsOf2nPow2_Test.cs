...
{
    [TestClass]
    public sealed class PE_00000735_DivisorsOf2nPow2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000735_DivisorsOf2nPow2));
        ...
        {
            int result = PE_00000735_DivisorsOf2nPow2.Solution_0_Test(input);
