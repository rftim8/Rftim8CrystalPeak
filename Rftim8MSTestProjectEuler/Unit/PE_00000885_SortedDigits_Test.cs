...
{
    [TestClass]
    public sealed class PE_00000885_SortedDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000885_SortedDigits));
        ...
        {
            int result = PE_00000885_SortedDigits.Solution_0_Test(input);
