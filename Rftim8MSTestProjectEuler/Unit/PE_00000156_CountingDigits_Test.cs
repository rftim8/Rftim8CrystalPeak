...
{
    [TestClass]
    public sealed class PE_00000156_CountingDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000156_CountingDigits));
        ...
        {
            int result = PE_00000156_CountingDigits.Solution_0_Test(input);
