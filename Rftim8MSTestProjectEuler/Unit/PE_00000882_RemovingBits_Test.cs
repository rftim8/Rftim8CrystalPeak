...
{
    [TestClass]
    public sealed class PE_00000882_RemovingBits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000882_RemovingBits));
        ...
        {
            int result = PE_00000882_RemovingBits.Solution_0_Test(input);
