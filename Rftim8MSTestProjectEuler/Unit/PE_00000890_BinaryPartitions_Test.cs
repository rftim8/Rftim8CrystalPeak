...
{
    [TestClass]
    public sealed class PE_00000890_BinaryPartitions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000890_BinaryPartitions));
        ...
        {
            int result = PE_00000890_BinaryPartitions.Solution_0_Test(input);
