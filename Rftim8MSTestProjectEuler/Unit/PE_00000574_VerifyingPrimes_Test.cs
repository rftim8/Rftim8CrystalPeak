...
{
    [TestClass]
    public sealed class PE_00000574_VerifyingPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000574_VerifyingPrimes));
        ...
        {
            int result = PE_00000574_VerifyingPrimes.Solution_0_Test(input);
