...
{
    [TestClass]
    public sealed class PE_00000787_BezoutsGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000787_BezoutsGame));
        ...
        {
            int result = PE_00000787_BezoutsGame.Solution_0_Test(input);
