...
{
    [TestClass]
    public sealed class PE_00000680_YarraGnisrever_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000680_YarraGnisrever));
        ...
        {
            int result = PE_00000680_YarraGnisrever.Solution_0_Test(input);
