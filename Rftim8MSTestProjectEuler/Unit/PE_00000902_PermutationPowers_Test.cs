...
{
    [TestClass]
    public sealed class PE_00000902_PermutationPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000902_PermutationPowers));
        ...
        {
            int result = PE_00000902_PermutationPowers.Solution_0_Test(input);
