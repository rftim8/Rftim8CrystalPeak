...
{
    [TestClass]
    public sealed class PE_00000609_PiSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000609_PiSequences));
        ...
        {
            int result = PE_00000609_PiSequences.Solution_0_Test(input);
