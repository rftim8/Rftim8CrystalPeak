...
{
    [TestClass]
    public sealed class PE_00000357_PrimeGeneratingIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000357_PrimeGeneratingIntegers));
        ...
        {
            int result = PE_00000357_PrimeGeneratingIntegers.Solution_0_Test(input);
