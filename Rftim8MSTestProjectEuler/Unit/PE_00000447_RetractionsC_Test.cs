...
{
    [TestClass]
    public sealed class PE_00000447_RetractionsC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000447_RetractionsC));
        ...
        {
            int result = PE_00000447_RetractionsC.Solution_0_Test(input);
