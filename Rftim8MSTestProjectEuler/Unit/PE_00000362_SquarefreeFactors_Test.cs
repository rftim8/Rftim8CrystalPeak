...
{
    [TestClass]
    public sealed class PE_00000362_SquarefreeFactors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000362_SquarefreeFactors));
        ...
        {
            int result = PE_00000362_SquarefreeFactors.Solution_0_Test(input);
