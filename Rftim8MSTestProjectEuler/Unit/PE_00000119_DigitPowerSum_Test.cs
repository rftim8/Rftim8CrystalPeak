...
{
    [TestClass]
    public sealed class PE_00000119_DigitPowerSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000119_DigitPowerSum));
        ...
        {
            int result = PE_00000119_DigitPowerSum.Solution_0_Test(input);
