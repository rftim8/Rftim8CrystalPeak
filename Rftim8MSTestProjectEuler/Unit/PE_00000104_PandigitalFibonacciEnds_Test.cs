...
{
    [TestClass]
    public sealed class PE_00000104_PandigitalFibonacciEnds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000104_PandigitalFibonacciEnds));
        ...
        {
            int result = PE_00000104_PandigitalFibonacciEnds.Solution_0_Test(input);
