...
{
    [TestClass]
    public sealed class PE_00000614_SpecialPartitions2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000614_SpecialPartitions2));
        ...
        {
            int result = PE_00000614_SpecialPartitions2.Solution_0_Test(input);
