...
{
    [TestClass]
    public sealed class PE_00000712_ExponentDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000712_ExponentDifference));
        ...
        {
            int result = PE_00000712_ExponentDifference.Solution_0_Test(input);
