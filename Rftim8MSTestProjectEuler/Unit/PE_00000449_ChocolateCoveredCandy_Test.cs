...
{
    [TestClass]
    public sealed class PE_00000449_ChocolateCoveredCandy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000449_ChocolateCoveredCandy));
        ...
        {
            int result = PE_00000449_ChocolateCoveredCandy.Solution_0_Test(input);
