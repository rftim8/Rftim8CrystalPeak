...
{
    [TestClass]
    public sealed class PE_00000363_BezierCurves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000363_BezierCurves));
        ...
        {
            int result = PE_00000363_BezierCurves.Solution_0_Test(input);
