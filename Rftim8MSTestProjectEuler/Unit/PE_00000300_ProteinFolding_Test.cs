...
{
    [TestClass]
    public sealed class PE_00000300_ProteinFolding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000300_ProteinFolding));
        ...
        {
            int result = PE_00000300_ProteinFolding.Solution_0_Test(input);
