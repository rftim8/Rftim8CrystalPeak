...
{
    [TestClass]
    public sealed class PE_00000100_ArrangedProbability_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000100_ArrangedProbability));
        ...
        {
            int result = PE_00000100_ArrangedProbability.Solution_0_Test(input);
