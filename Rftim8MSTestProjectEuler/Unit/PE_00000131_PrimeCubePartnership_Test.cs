...
{
    [TestClass]
    public sealed class PE_00000131_PrimeCubePartnership_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000131_PrimeCubePartnership));
        ...
        {
            int result = PE_00000131_PrimeCubePartnership.Solution_0_Test(input);
