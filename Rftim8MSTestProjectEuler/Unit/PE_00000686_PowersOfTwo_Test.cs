...
{
    [TestClass]
    public sealed class PE_00000686_PowersOfTwo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000686_PowersOfTwo));
        ...
        {
            int result = PE_00000686_PowersOfTwo.Solution_0_Test(input);
