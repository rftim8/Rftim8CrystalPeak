...
{
    [TestClass]
    public sealed class PE_00000773_RuffNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000773_RuffNumbers));
        ...
        {
            int result = PE_00000773_RuffNumbers.Solution_0_Test(input);
