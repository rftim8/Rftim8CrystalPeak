...
{
    [TestClass]
    public sealed class PE_00000873_WordsWithGaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000873_WordsWithGaps));
        ...
        {
            int result = PE_00000873_WordsWithGaps.Solution_0_Test(input);
