...
{
    [TestClass]
    public sealed class PE_00000843_PeriodicCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000843_PeriodicCircles));
        ...
        {
            int result = PE_00000843_PeriodicCircles.Solution_0_Test(input);
