...
{
    [TestClass]
    public sealed class PE_00000474_LastDigitsOfDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000474_LastDigitsOfDivisors));
        ...
        {
            int result = PE_00000474_LastDigitsOfDivisors.Solution_0_Test(input);
