...
{
    [TestClass]
    public sealed class PE_00000720_UnpredictablePermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000720_UnpredictablePermutations));
        ...
        {
            int result = PE_00000720_UnpredictablePermutations.Solution_0_Test(input);
