...
{
    [TestClass]
    public sealed class PE_00000134_PrimePairConnection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000134_PrimePairConnection));
        ...
        {
            int result = PE_00000134_PrimePairConnection.Solution_0_Test(input);
