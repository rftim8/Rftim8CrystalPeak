...
{
    [TestClass]
    public sealed class PE_00000127_Abchits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000127_Abchits));
        ...
        {
            int result = PE_00000127_Abchits.Solution_0_Test(input);
