...
{
    [TestClass]
    public sealed class PE_00000576_IrrationalJumps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000576_IrrationalJumps));
        ...
        {
            int result = PE_00000576_IrrationalJumps.Solution_0_Test(input);
