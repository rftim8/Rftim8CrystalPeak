...
{
    [TestClass]
    public sealed class PE_00000650_DivisorsOfBinomialProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000650_DivisorsOfBinomialProduct));
        ...
        {
            int result = PE_00000650_DivisorsOfBinomialProduct.Solution_0_Test(input);
