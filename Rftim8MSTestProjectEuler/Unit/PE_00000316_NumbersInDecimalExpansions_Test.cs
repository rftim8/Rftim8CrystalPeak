...
{
    [TestClass]
    public sealed class PE_00000316_NumbersInDecimalExpansions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000316_NumbersInDecimalExpansions));
        ...
        {
            int result = PE_00000316_NumbersInDecimalExpansions.Solution_0_Test(input);
