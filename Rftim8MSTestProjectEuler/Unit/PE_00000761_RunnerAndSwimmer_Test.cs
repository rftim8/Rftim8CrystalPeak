...
{
    [TestClass]
    public sealed class PE_00000761_RunnerAndSwimmer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000761_RunnerAndSwimmer));
        ...
        {
            int result = PE_00000761_RunnerAndSwimmer.Solution_0_Test(input);
