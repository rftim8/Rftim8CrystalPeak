...
{
    [TestClass]
    public sealed class PE_00000848_GuessingWithSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000848_GuessingWithSets));
        ...
        {
            int result = PE_00000848_GuessingWithSets.Solution_0_Test(input);
