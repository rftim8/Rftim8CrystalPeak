...
{
    [TestClass]
    public sealed class PE_00000633_SquarePrimeFactorsII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000633_SquarePrimeFactorsII));
        ...
        {
            int result = PE_00000633_SquarePrimeFactorsII.Solution_0_Test(input);
