...
{
    [TestClass]
    public sealed class PE_00000364_ComfortableDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000364_ComfortableDistance));
        ...
        {
            int result = PE_00000364_ComfortableDistance.Solution_0_Test(input);
