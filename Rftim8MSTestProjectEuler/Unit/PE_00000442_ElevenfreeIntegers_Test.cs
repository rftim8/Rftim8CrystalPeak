...
{
    [TestClass]
    public sealed class PE_00000442_ElevenfreeIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000442_ElevenfreeIntegers));
        ...
        {
            int result = PE_00000442_ElevenfreeIntegers.Solution_0_Test(input);
