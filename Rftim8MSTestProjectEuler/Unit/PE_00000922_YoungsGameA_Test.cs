...
{
    [TestClass]
    public sealed class PE_00000922_YoungsGameA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000922_YoungsGameA));
        ...
        {
            int result = PE_00000922_YoungsGameA.Solution_0_Test(input);
