...
{
    [TestClass]
    public sealed class PE_00000253_TidyingUpA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000253_TidyingUpA));
        ...
        {
            int result = PE_00000253_TidyingUpA.Solution_0_Test(input);
