...
{
    [TestClass]
    public sealed class PE_00000755_NotZeckendorf_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000755_NotZeckendorf));
        ...
        {
            int result = PE_00000755_NotZeckendorf.Solution_0_Test(input);
