...
{
    [TestClass]
    public sealed class PE_00000552_ChineseLeftoversII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000552_ChineseLeftoversII));
        ...
        {
            int result = PE_00000552_ChineseLeftoversII.Solution_0_Test(input);
