...
{
    [TestClass]
    public sealed class PE_00000892_ZebraCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000892_ZebraCircles));
        ...
        {
            int result = PE_00000892_ZebraCircles.Solution_0_Test(input);
