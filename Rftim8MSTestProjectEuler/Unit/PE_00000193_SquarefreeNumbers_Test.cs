...
{
    [TestClass]
    public sealed class PE_00000193_SquarefreeNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000193_SquarefreeNumbers));
        ...
        {
            int result = PE_00000193_SquarefreeNumbers.Solution_0_Test(input);
