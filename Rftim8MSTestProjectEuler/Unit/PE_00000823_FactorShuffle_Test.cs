...
{
    [TestClass]
    public sealed class PE_00000823_FactorShuffle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000823_FactorShuffle));
        ...
        {
            int result = PE_00000823_FactorShuffle.Solution_0_Test(input);
