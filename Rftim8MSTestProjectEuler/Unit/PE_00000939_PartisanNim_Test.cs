...
{
    [TestClass]
    public sealed class PE_00000939_PartisanNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000939_PartisanNim));
        ...
        {
            int result = PE_00000939_PartisanNim.Solution_0_Test(input);
