...
{
    [TestClass]
    public sealed class PE_00000200_PrimeproofSqubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000200_PrimeproofSqubes));
        ...
        {
            int result = PE_00000200_PrimeproofSqubes.Solution_0_Test(input);
