...
{
    [TestClass]
    public sealed class PE_00000158_LexicographicalNeighbours_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000158_LexicographicalNeighbours));
        ...
        {
            int result = PE_00000158_LexicographicalNeighbours.Solution_0_Test(input);
