...
{
    [TestClass]
    public sealed class PE_00000587_ConcaveTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000587_ConcaveTriangle));
        ...
        {
            int result = PE_00000587_ConcaveTriangle.Solution_0_Test(input);
