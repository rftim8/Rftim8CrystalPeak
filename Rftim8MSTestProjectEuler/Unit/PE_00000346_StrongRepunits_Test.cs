...
{
    [TestClass]
    public sealed class PE_00000346_StrongRepunits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000346_StrongRepunits));
        ...
        {
            int result = PE_00000346_StrongRepunits.Solution_0_Test(input);
