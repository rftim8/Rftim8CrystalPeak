...
{
    [TestClass]
    public sealed class PE_00000520_Simbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000520_Simbers));
        ...
        {
            int result = PE_00000520_Simbers.Solution_0_Test(input);
