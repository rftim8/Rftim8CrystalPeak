...
{
    [TestClass]
    public sealed class PE_00000407_Idempotents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000407_Idempotents));
        ...
        {
            int result = PE_00000407_Idempotents.Solution_0_Test(input);
