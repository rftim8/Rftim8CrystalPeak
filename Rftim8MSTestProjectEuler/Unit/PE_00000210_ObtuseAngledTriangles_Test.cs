...
{
    [TestClass]
    public sealed class PE_00000210_ObtuseAngledTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000210_ObtuseAngledTriangles));
        ...
        {
            int result = PE_00000210_ObtuseAngledTriangles.Solution_0_Test(input);
