...
{
    [TestClass]
    public sealed class PE_00000079_PasscodeDerivation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000079_PasscodeDerivation));
        ...
        {
            int result = PE_00000079_PasscodeDerivation.Solution_0_Test(input);
