...
{
    [TestClass]
    public sealed class PE_00000452_LongProducts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000452_LongProducts));
        ...
        {
            int result = PE_00000452_LongProducts.Solution_0_Test(input);
