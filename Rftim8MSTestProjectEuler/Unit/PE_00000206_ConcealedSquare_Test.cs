...
{
    [TestClass]
    public sealed class PE_00000206_ConcealedSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000206_ConcealedSquare));
        ...
        {
            int result = PE_00000206_ConcealedSquare.Solution_0_Test(input);
