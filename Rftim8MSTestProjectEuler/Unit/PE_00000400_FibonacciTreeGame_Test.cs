...
{
    [TestClass]
    public sealed class PE_00000400_FibonacciTreeGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000400_FibonacciTreeGame));
        ...
        {
            int result = PE_00000400_FibonacciTreeGame.Solution_0_Test(input);
