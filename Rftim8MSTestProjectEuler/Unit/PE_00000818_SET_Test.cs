...
{
    [TestClass]
    public sealed class PE_00000818_SET_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000818_SET));
        ...
        {
            int result = PE_00000818_SET.Solution_0_Test(input);
