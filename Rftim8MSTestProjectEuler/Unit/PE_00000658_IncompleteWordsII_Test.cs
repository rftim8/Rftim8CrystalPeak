...
{
    [TestClass]
    public sealed class PE_00000658_IncompleteWordsII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000658_IncompleteWordsII));
        ...
        {
            int result = PE_00000658_IncompleteWordsII.Solution_0_Test(input);
