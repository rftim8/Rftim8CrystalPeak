...
{
    [TestClass]
    public sealed class PE_00000146_InvestigatingAPrimePattern_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000146_InvestigatingAPrimePattern));
        ...
        {
            int result = PE_00000146_InvestigatingAPrimePattern.Solution_0_Test(input);
