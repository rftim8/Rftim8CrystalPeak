...
{
    [TestClass]
    public sealed class PE_00000105_SpecialSubsetSumsTesting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000105_SpecialSubsetSumsTesting));
        ...
        {
            int result = PE_00000105_SpecialSubsetSumsTesting.Solution_0_Test(input);
