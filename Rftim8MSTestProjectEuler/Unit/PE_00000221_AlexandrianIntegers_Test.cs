...
{
    [TestClass]
    public sealed class PE_00000221_AlexandrianIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000221_AlexandrianIntegers));
        ...
        {
            int result = PE_00000221_AlexandrianIntegers.Solution_0_Test(input);
