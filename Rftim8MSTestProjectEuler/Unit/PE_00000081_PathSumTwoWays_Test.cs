...
{
    [TestClass]
    public sealed class PE_00000081_PathSumTwoWays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000081_PathSumTwoWays));
        ...
        {
            int result = PE_00000081_PathSumTwoWays.Solution_0_Test(input);
