...
{
    [TestClass]
    public sealed class PE_00000464_MobiusFunctionAndIntervals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000464_MobiusFunctionAndIntervals));
        ...
        {
            int result = PE_00000464_MobiusFunctionAndIntervals.Solution_0_Test(input);
