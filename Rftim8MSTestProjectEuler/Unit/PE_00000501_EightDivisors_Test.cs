...
{
    [TestClass]
    public sealed class PE_00000501_EightDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000501_EightDivisors));
        ...
        {
            int result = PE_00000501_EightDivisors.Solution_0_Test(input);
