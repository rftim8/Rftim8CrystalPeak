...
{
    [TestClass]
    public sealed class PE_00000342_TheTotientOfASquareIsACube_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000342_TheTotientOfASquareIsACube));
        ...
        {
            int result = PE_00000342_TheTotientOfASquareIsACube.Solution_0_Test(input);
