...
{
    [TestClass]
    public sealed class PE_00000031_CoinSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000031_CoinSums));
        ...
        {
            int result = PE_00000031_CoinSums.Solution_0_Test(input);
