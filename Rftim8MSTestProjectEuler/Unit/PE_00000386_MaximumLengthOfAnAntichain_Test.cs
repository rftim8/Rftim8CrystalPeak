...
{
    [TestClass]
    public sealed class PE_00000386_MaximumLengthOfAnAntichain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000386_MaximumLengthOfAnAntichain));
        ...
        {
            int result = PE_00000386_MaximumLengthOfAnAntichain.Solution_0_Test(input);
