...
{
    [TestClass]
    public sealed class PE_00000251_CardanoTriplets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000251_CardanoTriplets));
        ...
        {
            int result = PE_00000251_CardanoTriplets.Solution_0_Test(input);
