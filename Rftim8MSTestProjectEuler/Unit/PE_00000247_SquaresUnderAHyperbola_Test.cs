...
{
    [TestClass]
    public sealed class PE_00000247_SquaresUnderAHyperbola_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000247_SquaresUnderAHyperbola));
        ...
        {
            int result = PE_00000247_SquaresUnderAHyperbola.Solution_0_Test(input);
