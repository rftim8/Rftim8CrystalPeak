...
{
    [TestClass]
    public sealed class PE_00000710_OneMillionMembers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000710_OneMillionMembers));
        ...
        {
            int result = PE_00000710_OneMillionMembers.Solution_0_Test(input);
