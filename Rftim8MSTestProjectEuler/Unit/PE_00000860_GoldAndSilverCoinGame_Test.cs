...
{
    [TestClass]
    public sealed class PE_00000860_GoldAndSilverCoinGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000860_GoldAndSilverCoinGame));
        ...
        {
            int result = PE_00000860_GoldAndSilverCoinGame.Solution_0_Test(input);
