...
{
    [TestClass]
    public sealed class PE_00000095_AmicableChains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000095_AmicableChains));
        ...
        {
            int result = PE_00000095_AmicableChains.Solution_0_Test(input);
