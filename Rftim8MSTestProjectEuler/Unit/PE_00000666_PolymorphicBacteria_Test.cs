...
{
    [TestClass]
    public sealed class PE_00000666_PolymorphicBacteria_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000666_PolymorphicBacteria));
        ...
        {
            int result = PE_00000666_PolymorphicBacteria.Solution_0_Test(input);
