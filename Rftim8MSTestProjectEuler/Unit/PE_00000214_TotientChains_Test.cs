...
{
    [TestClass]
    public sealed class PE_00000214_TotientChains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000214_TotientChains));
        ...
        {
            int result = PE_00000214_TotientChains.Solution_0_Test(input);
