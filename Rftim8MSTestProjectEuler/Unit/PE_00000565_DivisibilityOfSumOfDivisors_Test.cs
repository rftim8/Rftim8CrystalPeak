...
{
    [TestClass]
    public sealed class PE_00000565_DivisibilityOfSumOfDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000565_DivisibilityOfSumOfDivisors));
        ...
        {
            int result = PE_00000565_DivisibilityOfSumOfDivisors.Solution_0_Test(input);
