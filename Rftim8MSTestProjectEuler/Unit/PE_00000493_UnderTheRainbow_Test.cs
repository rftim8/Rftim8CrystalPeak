...
{
    [TestClass]
    public sealed class PE_00000493_UnderTheRainbow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000493_UnderTheRainbow));
        ...
        {
            int result = PE_00000493_UnderTheRainbow.Solution_0_Test(input);
