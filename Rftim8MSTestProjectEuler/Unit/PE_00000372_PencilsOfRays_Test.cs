...
{
    [TestClass]
    public sealed class PE_00000372_PencilsOfRays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000372_PencilsOfRays));
        ...
        {
            int result = PE_00000372_PencilsOfRays.Solution_0_Test(input);
