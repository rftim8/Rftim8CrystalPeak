...
{
    [TestClass]
    public sealed class PE_00000631_ConstrainedPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000631_ConstrainedPermutations));
        ...
        {
            int result = PE_00000631_ConstrainedPermutations.Solution_0_Test(input);
