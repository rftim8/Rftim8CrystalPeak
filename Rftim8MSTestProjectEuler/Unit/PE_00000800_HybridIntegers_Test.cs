...
{
    [TestClass]
    public sealed class PE_00000800_HybridIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000800_HybridIntegers));
        ...
        {
            int result = PE_00000800_HybridIntegers.Solution_0_Test(input);
