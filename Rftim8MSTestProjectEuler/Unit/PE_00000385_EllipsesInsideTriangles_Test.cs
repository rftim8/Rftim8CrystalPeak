...
{
    [TestClass]
    public sealed class PE_00000385_EllipsesInsideTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000385_EllipsesInsideTriangles));
        ...
        {
            int result = PE_00000385_EllipsesInsideTriangles.Solution_0_Test(input);
