...
{
    [TestClass]
    public sealed class PE_00000677_ColouredGraphs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000677_ColouredGraphs));
        ...
        {
            int result = PE_00000677_ColouredGraphs.Solution_0_Test(input);
