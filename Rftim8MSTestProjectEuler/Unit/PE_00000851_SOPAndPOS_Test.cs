...
{
    [TestClass]
    public sealed class PE_00000851_SOPAndPOS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000851_SOPAndPOS));
        ...
        {
            int result = PE_00000851_SOPAndPOS.Solution_0_Test(input);
