...
{
    [TestClass]
    public sealed class PE_00000733_AscendingSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000733_AscendingSubsequences));
        ...
        {
            int result = PE_00000733_AscendingSubsequences.Solution_0_Test(input);
