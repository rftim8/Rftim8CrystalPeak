...
{
    [TestClass]
    public sealed class PE_00000893_Matchsticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000893_Matchsticks));
        ...
        {
            int result = PE_00000893_Matchsticks.Solution_0_Test(input);
