...
{
    [TestClass]
    public sealed class PE_00000173_HollowSquareLaminaeI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000173_HollowSquareLaminaeI));
        ...
        {
            int result = PE_00000173_HollowSquareLaminaeI.Solution_0_Test(input);
