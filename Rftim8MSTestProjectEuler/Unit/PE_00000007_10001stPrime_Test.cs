...
{
    [TestClass]
    public sealed class PE_00000007_10001stPrime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000007_10001stPrime));
        ...
        {
            int result = PE_00000007_10001stPrime.Solution_0_Test(input);
