...
{
    [TestClass]
    public sealed class PE_00000365_AHugeBinomialCoefficient_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000365_AHugeBinomialCoefficient));
        ...
        {
            int result = PE_00000365_AHugeBinomialCoefficient.Solution_0_Test(input);
