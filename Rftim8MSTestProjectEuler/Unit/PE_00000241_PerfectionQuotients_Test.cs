...
{
    [TestClass]
    public sealed class PE_00000241_PerfectionQuotients_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000241_PerfectionQuotients));
        ...
        {
            int result = PE_00000241_PerfectionQuotients.Solution_0_Test(input);
