...
{
    [TestClass]
    public sealed class PE_00000871_DriftingSubsets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000871_DriftingSubsets));
        ...
        {
            int result = PE_00000871_DriftingSubsets.Solution_0_Test(input);
