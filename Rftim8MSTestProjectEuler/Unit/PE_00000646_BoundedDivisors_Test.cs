...
{
    [TestClass]
    public sealed class PE_00000646_BoundedDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000646_BoundedDivisors));
        ...
        {
            int result = PE_00000646_BoundedDivisors.Solution_0_Test(input);
