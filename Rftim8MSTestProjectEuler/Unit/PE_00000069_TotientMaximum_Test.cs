...
{
    [TestClass]
    public sealed class PE_00000069_TotientMaximum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000069_TotientMaximum));
        ...
        {
            int result = PE_00000069_TotientMaximum.Solution_0_Test(input);
