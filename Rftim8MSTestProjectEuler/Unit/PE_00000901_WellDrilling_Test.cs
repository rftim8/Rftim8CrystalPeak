...
{
    [TestClass]
    public sealed class PE_00000901_WellDrilling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000901_WellDrilling));
        ...
        {
            int result = PE_00000901_WellDrilling.Solution_0_Test(input);
