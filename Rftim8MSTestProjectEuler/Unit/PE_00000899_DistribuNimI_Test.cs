...
{
    [TestClass]
    public sealed class PE_00000899_DistribuNimI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000899_DistribuNimI));
        ...
        {
            int result = PE_00000899_DistribuNimI.Solution_0_Test(input);
