...
{
    [TestClass]
    public sealed class PE_00000242_OddTriplets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000242_OddTriplets));
        ...
        {
            int result = PE_00000242_OddTriplets.Solution_0_Test(input);
