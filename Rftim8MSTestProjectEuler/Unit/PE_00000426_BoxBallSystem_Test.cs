...
{
    [TestClass]
    public sealed class PE_00000426_BoxBallSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000426_BoxBallSystem));
        ...
        {
            int result = PE_00000426_BoxBallSystem.Solution_0_Test(input);
