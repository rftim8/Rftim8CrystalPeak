...
{
    [TestClass]
    public sealed class PE_00000224_AlmostRightangledTrianglesII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000224_AlmostRightangledTrianglesII));
        ...
        {
            int result = PE_00000224_AlmostRightangledTrianglesII.Solution_0_Test(input);
