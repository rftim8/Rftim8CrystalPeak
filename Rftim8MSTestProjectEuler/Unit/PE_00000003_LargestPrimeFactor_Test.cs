...
{
    [TestClass]
    public sealed class PE_00000003_LargestPrimeFactor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000003_LargestPrimeFactor));
        ...
        {
            int result = PE_00000003_LargestPrimeFactor.Solution_0_Test(input);
