...
{
    [TestClass]
    public sealed class PE_00000926_TotalRoundness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000926_TotalRoundness));
        ...
        {
            int result = PE_00000926_TotalRoundness.Solution_0_Test(input);
