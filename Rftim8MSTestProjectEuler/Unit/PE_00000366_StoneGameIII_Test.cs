...
{
    [TestClass]
    public sealed class PE_00000366_StoneGameIII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000366_StoneGameIII));
        ...
        {
            int result = PE_00000366_StoneGameIII.Solution_0_Test(input);
