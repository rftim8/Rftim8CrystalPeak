...
{
    [TestClass]
    public sealed class PE_00000820_NthDigitOfReciprocals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000820_NthDigitOfReciprocals));
        ...
        {
            int result = PE_00000820_NthDigitOfReciprocals.Solution_0_Test(input);
