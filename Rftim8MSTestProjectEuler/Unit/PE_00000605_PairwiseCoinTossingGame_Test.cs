...
{
    [TestClass]
    public sealed class PE_00000605_PairwiseCoinTossingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000605_PairwiseCoinTossingGame));
        ...
        {
            int result = PE_00000605_PairwiseCoinTossingGame.Solution_0_Test(input);
