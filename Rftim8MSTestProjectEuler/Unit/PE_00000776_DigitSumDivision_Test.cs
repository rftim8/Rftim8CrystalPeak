...
{
    [TestClass]
    public sealed class PE_00000776_DigitSumDivision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000776_DigitSumDivision));
        ...
        {
            int result = PE_00000776_DigitSumDivision.Solution_0_Test(input);
