...
{
    [TestClass]
    public sealed class PE_00000461_AlmostPi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000461_AlmostPi));
        ...
        {
            int result = PE_00000461_AlmostPi.Solution_0_Test(input);
