...
{
    [TestClass]
    public sealed class PE_00000162_HexadecimalNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000162_HexadecimalNumbers));
        ...
        {
            int result = PE_00000162_HexadecimalNumbers.Solution_0_Test(input);
