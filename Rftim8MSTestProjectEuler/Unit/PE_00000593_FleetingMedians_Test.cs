...
{
    [TestClass]
    public sealed class PE_00000593_FleetingMedians_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000593_FleetingMedians));
        ...
        {
            int result = PE_00000593_FleetingMedians.Solution_0_Test(input);
