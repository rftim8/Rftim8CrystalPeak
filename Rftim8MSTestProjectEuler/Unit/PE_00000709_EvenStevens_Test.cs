...
{
    [TestClass]
    public sealed class PE_00000709_EvenStevens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000709_EvenStevens));
        ...
        {
            int result = PE_00000709_EvenStevens.Solution_0_Test(input);
