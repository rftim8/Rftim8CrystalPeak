...
{
    [TestClass]
    public sealed class PE_00000026_ReciprocalCycles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000026_ReciprocalCycles));
        ...
        {
            int result = PE_00000026_ReciprocalCycles.Solution_0_Test(input);
