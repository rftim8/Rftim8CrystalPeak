...
{
    [TestClass]
    public sealed class PE_00000673_BedsAndDesks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000673_BedsAndDesks));
        ...
        {
            int result = PE_00000673_BedsAndDesks.Solution_0_Test(input);
