...
{
    [TestClass]
    public sealed class PE_00000335_GatheringTheBeans_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000335_GatheringTheBeans));
        ...
        {
            int result = PE_00000335_GatheringTheBeans.Solution_0_Test(input);
