...
{
    [TestClass]
    public sealed class PE_00000753_FermatEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000753_FermatEquation));
        ...
        {
            int result = PE_00000753_FermatEquation.Solution_0_Test(input);
