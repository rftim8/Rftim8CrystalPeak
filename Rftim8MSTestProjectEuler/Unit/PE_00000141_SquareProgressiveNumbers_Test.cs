...
{
    [TestClass]
    public sealed class PE_00000141_SquareProgressiveNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000141_SquareProgressiveNumbers));
        ...
        {
            int result = PE_00000141_SquareProgressiveNumbers.Solution_0_Test(input);
