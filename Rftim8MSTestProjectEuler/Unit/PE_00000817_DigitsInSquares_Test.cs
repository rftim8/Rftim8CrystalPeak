...
{
    [TestClass]
    public sealed class PE_00000817_DigitsInSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000817_DigitsInSquares));
        ...
        {
            int result = PE_00000817_DigitsInSquares.Solution_0_Test(input);
