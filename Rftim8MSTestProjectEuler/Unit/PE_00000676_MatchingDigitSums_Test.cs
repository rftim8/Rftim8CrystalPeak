...
{
    [TestClass]
    public sealed class PE_00000676_MatchingDigitSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000676_MatchingDigitSums));
        ...
        {
            int result = PE_00000676_MatchingDigitSums.Solution_0_Test(input);
