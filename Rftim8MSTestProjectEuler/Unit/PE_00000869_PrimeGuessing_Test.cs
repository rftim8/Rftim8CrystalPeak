...
{
    [TestClass]
    public sealed class PE_00000869_PrimeGuessing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000869_PrimeGuessing));
        ...
        {
            int result = PE_00000869_PrimeGuessing.Solution_0_Test(input);
