...
{
    [TestClass]
    public sealed class PE_00000619_SquareSubsets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000619_SquareSubsets));
        ...
        {
            int result = PE_00000619_SquareSubsets.Solution_0_Test(input);
