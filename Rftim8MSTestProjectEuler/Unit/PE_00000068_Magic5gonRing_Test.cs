...
{
    [TestClass]
    public sealed class PE_00000068_Magic5gonRing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000068_Magic5gonRing));
        ...
        {
            int result = PE_00000068_Magic5gonRing.Solution_0_Test(input);
