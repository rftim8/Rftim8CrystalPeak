...
{
    [TestClass]
    public sealed class PE_00000813_XORPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000813_XORPowers));
        ...
        {
            int result = PE_00000813_XORPowers.Solution_0_Test(input);
