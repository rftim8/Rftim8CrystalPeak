...
{
    [TestClass]
    public sealed class PE_00000343_FractionalSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000343_FractionalSequences));
        ...
        {
            int result = PE_00000343_FractionalSequences.Solution_0_Test(input);
