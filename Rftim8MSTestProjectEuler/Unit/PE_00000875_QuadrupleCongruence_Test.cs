...
{
    [TestClass]
    public sealed class PE_00000875_QuadrupleCongruence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000875_QuadrupleCongruence));
        ...
        {
            int result = PE_00000875_QuadrupleCongruence.Solution_0_Test(input);
