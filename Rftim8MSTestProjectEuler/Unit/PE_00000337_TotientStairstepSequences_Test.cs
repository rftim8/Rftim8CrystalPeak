...
{
    [TestClass]
    public sealed class PE_00000337_TotientStairstepSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000337_TotientStairstepSequences));
        ...
        {
            int result = PE_00000337_TotientStairstepSequences.Solution_0_Test(input);
