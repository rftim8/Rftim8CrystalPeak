...
{
    [TestClass]
    public sealed class PE_00000291_PanaitopolPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000291_PanaitopolPrimes));
        ...
        {
            int result = PE_00000291_PanaitopolPrimes.Solution_0_Test(input);
