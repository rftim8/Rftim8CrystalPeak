...
{
    [TestClass]
    public sealed class PE_00000469_EmptyChairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000469_EmptyChairs));
        ...
        {
            int result = PE_00000469_EmptyChairs.Solution_0_Test(input);
