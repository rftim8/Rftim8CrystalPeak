...
{
    [TestClass]
    public sealed class PE_00000128_HexagonalTileDifferences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000128_HexagonalTileDifferences));
        ...
        {
            int result = PE_00000128_HexagonalTileDifferences.Solution_0_Test(input);
