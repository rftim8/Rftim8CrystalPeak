...
{
    [TestClass]
    public sealed class PE_00000492_ExplodingSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftProjectEulerStaticData.Input_Test(testType: true, problemName: nameof(PE_00000492_ExplodingSequence));
        ...
        {
            int result = PE_00000492_ExplodingSequence.Solution_0_Test(input);
