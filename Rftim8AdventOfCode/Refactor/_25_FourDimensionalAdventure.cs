...
{
    public class _25_FourDimensionalAdventure : I_25_FourDimensionalAdventure
    {
        #region Static
        private readonly List<string>? data;

        public _25_FourDimensionalAdventure()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_25_FourDimensionalAdventure));
        }
        ...
        /// Let me check your timeline for a source.... Got one. There's actually a powerful source of magical energy about 1000 years forward from you, 
        /// and at roughly your position, too! It looks like... hot chocolate? Anyway, you should be able to travel there to pick some up; 
        ...
        /// each a manhattan distance no more than 3 from the last, between the two of them. (That is, if a point is close enough to a constellation, 
        /// it "joins" that constellation.) For example:
        /// 
        ///  0, 0, 0, 0
        ///  3, 0, 0, 0
        ///  0, 3, 0, 0
        ...
        /// So, in the above list, the number of constellations is 2. (If a point at 6, 0, 0, 0 were present, it would connect 3, 0, 0, 0 and 9, 0, 0, 0, 
        ...
        public _25_FourDimensionalAdventure(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_25_FourDimensionalAdventure));
        }
