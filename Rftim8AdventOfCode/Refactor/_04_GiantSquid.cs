...
{
    public class _04_GiantSquid : I_04_GiantSquid
    {
        #region Static
        ...
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_04_GiantSquid));
        }
        ...
        private static int PartOne0(List<string> input)
        {
            ...
            for (int i = 2; i < n; i += 6)
            {
                ...
                [
                    ...
                    [.. input[i + 1].Split(' ', StringSplitOptions.RemoveEmptyEntries)],
                    [.. input[i + 2].Split(' ', StringSplitOptions.RemoveEmptyEntries)],
                    [.. input[i + 3].Split(' ', StringSplitOptions.RemoveEmptyEntries)],
                    [.. input[i + 4].Split(' ', StringSplitOptions.RemoveEmptyEntries)],
                ];
            ...
            {
                foreach (string[][] item1 in boards)
                {
                    for (int i = 0; i < 5; i++)
                    {
                        for (int j = 0; j < 5; j++)
                                ...
                                for (int k = 0; k < 5; k++)
                                {
                                    ...
                                    if (h == 5 || v == 5)
                                    {
                                        ...
                                        for (int m = 0; m < 5; m++)
                                        {
                                            for (int o = 0; o < 5; o++)
                                            {
                                                if (item1[m][o] != "X") y += int.Parse(item1[m][o]);
                                            }
                                        }
                                        return y * int.Parse(item);
                                    }
                                }
                            }
                        }
        ...
        private static int PartTwo0(List<string> input)
        {
            ...
            Dictionary<int, (int, int, int)> kvp = [];
            int nr = 0;
            foreach (string item in x)
            {
                for (int a = 0; a < boards.Count; a++)
                {
                    for (int i = 0; i < 5; i++)
                    {
                        for (int j = 0; j < 5; j++)
                        {
                            if (boards[a][i][j] == item)
                            {
                                boards[a][i][j] = "X";
                                ...
                                for (int k = 0; k < 5; k++)
                                {
                                    ...
                                    if (h == 5 || v == 5)
                                    {
                                        ...
                                        for (int m = 0; m < 5; m++)
                                        {
                                            for (int o = 0; o < 5; o++)
                                            {
                                                if (boards[a][m][o] != "X") y += int.Parse(boards[a][m][o]);
                                            }
                                        }

                                        if (!kvp.ContainsKey(a))
                                        {
                                            kvp[a] = (y, int.Parse(item), nr);
                                            nr++;
                                        }
                                    }
                                }
            ...
            return kvp.MaxBy(o => o.Value.Item3).Value.Item1 * kvp.MaxBy(o => o.Value.Item3).Value.Item2;
        }
        #endregion
        ...
        public _04_GiantSquid(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_04_GiantSquid));
        }
