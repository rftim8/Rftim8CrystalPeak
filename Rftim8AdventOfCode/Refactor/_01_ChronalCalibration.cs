...
{
    public class _01_ChronalCalibration : I_01_ChronalCalibration
    {
        #region Static
        private readonly List<string>? data;

        public _01_ChronalCalibration()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_01_ChronalCalibration));
        }
        ...
        private static int PartOne0(List<string> input)
        {
            ...
            {
                if (item[0] == '-') r -= int.Parse(item[1..]);
                else r += int.Parse(item[1..]);
            }
        ...
        public _01_ChronalCalibration(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_01_ChronalCalibration));
        }
