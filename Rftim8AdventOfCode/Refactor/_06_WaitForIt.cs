...
{
    public class _06_WaitForIt : I_06_WaitForIt
    {
        #region Static
        private readonly List<string>? data;

        public _06_WaitForIt()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_06_WaitForIt));
        }
        ...
        /// The boat can't move until you let you of the button.Please make sure you let go of the button so the boat gets to move. 0 millimeters.
        ...
        private static int PartOne0(List<string> input)
        {
            ...
            List<int> time = input[0].Split(":")[1].Split(" ", StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToList();
            List<int> dist = input[1].Split(":")[1].Split(" ", StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToList();
        ...
        private static long PartTwo0(List<string> input)
        {
            ...
            long dist = long.Parse(input[1].Split(":")[1].Replace(" ", ""));
        ...
        public _06_WaitForIt(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_06_WaitForIt));
        }
