...
{
    public class _19_NotEnoughMinerals : I_19_NotEnoughMinerals
    {
        #region Static
        private readonly List<string>? data;

        public _19_NotEnoughMinerals()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_19_NotEnoughMinerals));
        }
        ...
        /// As you do, you notice a collection of geodes around the pond.Perhaps you could use the obsidian to create some geode-cracking robots and break them open?
        /// 
        ...
        /// in 24 minutes using that blueprint. In this example, the first blueprint has ID 1 and can open 9 geodes, so its quality level is 9. 
        ...
        public _19_NotEnoughMinerals(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_19_NotEnoughMinerals));
        }
