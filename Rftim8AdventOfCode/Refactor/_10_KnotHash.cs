...
{
    public class _10_KnotHash : I_10_KnotHash
    {
        #region Static
        ...
        public _10_KnotHash()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_10_KnotHash));
        }
        ...
        /// and gives the span a half-twist to reverse the order of the marks within it.After doing this many times, the order of the marks is used to build the resulting hash.
        /// 
        ///   4--5   pinch   4  5           4   1
        ///  /    \  5,0,1  / \/ \  twist  / \ / \
        /// 3      0  -->  3      0  -->  3   X   0
        ...
        /// the operation reverses using as many extra elements as it needs from the front of the list.If the current position moves past the end of the list,
        ...
        /// 
        /// Once you have determined the sequence of lengths to use, add the following lengths to the end of the sequence: 17, 31, 73, 47, 23. For example, 
        /// if you are given 1,2,3, your final sequence of lengths should be 49,44,50,44,51,17,31,73,47,23 
        ...
        private static string PartTwo0(List<string> input)
        {
            ...
            IEnumerable<int> denseHash = sparseHash
        ...
        public _10_KnotHash(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_10_KnotHash));
        }
    ...
    static class Extensions
    {
        public static IEnumerable<byte[]> ToSparseHashSequence(this IEnumerable<byte> lengths, int repeat)
        {
            ...
            int position = 0;
            int skip = 0;
            byte[] state = Enumerable.Range(0, size).Select(i => (byte)i).ToArray();
