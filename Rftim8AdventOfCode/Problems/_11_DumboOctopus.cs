...
{
    public class _11_DumboOctopus : I_11_DumboOctopus
    {
        #region Static
        private readonly List<string>? data;

        public _11_DumboOctopus()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_11_DumboOctopus));
        }

        /// <summary>
        /// You enter a large cavern full of rare bioluminescent dumbo octopuses! They seem to not like the Christmas lights on your submarine, so you turn them off for now.
        /// 
        /// There are 100 octopuses arranged neatly in a 10 by 10 grid.Each octopus slowly gains energy over time and flashes brightly 
        /// for a moment when its energy is full.Although your lights are off, maybe you could navigate through the cave without disturbing 
        /// the octopuses if you could predict when the flashes of light will happen.
        /// 
        ...
        public _11_DumboOctopus(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_11_DumboOctopus));
        }
