...
{
    public class AOC_00000001_Y16_NoTimeForATaxicab : IAOC_00000001_Y16_NoTimeForATaxicab
    {
        #region Static
        ...
        [Benchmark]
        public bool Solution_0() => AOC_00000001_Y16_NoTimeForATaxicab_0(Board!);

        private static bool AOC_00000001_Y16_NoTimeForATaxicab_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => AOC_00000001_Y16_NoTimeForATaxicab_0(board);
        ...
        public AOC_00000001_Y16_NoTimeForATaxicab(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            Input = RftAdventOfCodeHostData.Input_Test(problemName: nameof(AOC_00000001_Y16_NoTimeForATaxicab));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = AOC_00000001_Y16_NoTimeForATaxicab_0(boards[i]);
