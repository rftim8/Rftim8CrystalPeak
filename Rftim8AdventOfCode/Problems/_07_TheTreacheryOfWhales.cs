...
{
    public class _07_TheTreacheryOfWhales : I_07_TheTreacheryOfWhales
    {
        #region Static
        private readonly List<string>? data;

        public _07_TheTreacheryOfWhales()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_07_TheTreacheryOfWhales));
        }
        ...
        {
            List<int> nums = input[0].Split(',').Select(int.Parse).ToList();
            int min = nums.Min();
            int max = nums.Max();
        ...
        public _07_TheTreacheryOfWhales(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_07_TheTreacheryOfWhales));
        }
