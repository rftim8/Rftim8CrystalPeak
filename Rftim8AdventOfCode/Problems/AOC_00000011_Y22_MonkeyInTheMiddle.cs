...
{
    public class AOC_00000011_Y22_MonkeyInTheMiddle : IAOC_00000011_Y22_MonkeyInTheMiddle
    {
        #region Static
        ...
        [Benchmark]
        public bool Solution_0() => AOC_00000011_Y22_MonkeyInTheMiddle_0(Board!);

        private static bool AOC_00000011_Y22_MonkeyInTheMiddle_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => AOC_00000011_Y22_MonkeyInTheMiddle_0(board);
        ...
        public AOC_00000011_Y22_MonkeyInTheMiddle(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            Input = RftAdventOfCodeHostData.Input_Test(problemName: nameof(AOC_00000011_Y22_MonkeyInTheMiddle));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = AOC_00000011_Y22_MonkeyInTheMiddle_0(boards[i]);
