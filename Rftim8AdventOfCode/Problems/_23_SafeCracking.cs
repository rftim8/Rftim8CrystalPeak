...
{
    public class _23_SafeCracking : I_23_SafeCracking
    {
        #region Static
        private readonly List<string>? data;

        public _23_SafeCracking()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_23_SafeCracking));
        }

        /// <summary>
        /// This is one of the top floors of the nicest tower in EBHQ. 
        /// The Easter Bunny's private office is here, complete with a safe hidden behind a painting, and who wouldn't hide a star in a safe behind a painting?
        /// 
        ...
        /// apparently having been smashed.Behind it is some kind of socket - one that matches a connector in your prototype computer! 
        ...
        /// and whether the lack of any instruction more powerful than "add one" has anything to do with it. Don't bunnies usually multiply?
        /// 
        ...
        public _23_SafeCracking(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_23_SafeCracking));
        }
