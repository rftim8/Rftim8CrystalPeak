...
{
    public class _20_JurassicJigsaw : I_20_JurassicJigsaw
    {
        #region Static
        private readonly List<string>? data;

        public _20_JurassicJigsaw()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_20_JurassicJigsaw));
        }
        ...
        /// The camera array consists of many cameras; rather than produce a single square image, they produce many smaller square image tiles that need 
        ...
        public _20_JurassicJigsaw(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_20_JurassicJigsaw));
        }
