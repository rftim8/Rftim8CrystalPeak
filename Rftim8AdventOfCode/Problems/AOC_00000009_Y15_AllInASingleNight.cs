...
{
    public class AOC_00000009_Y15_AllInASingleNight : IAOC_00000009_Y15_AllInASingleNight
    {
        #region Static
        ...
        [Benchmark]
        public bool Solution_0() => AOC_00000009_Y15_AllInASingleNight_0(Board!);

        private static bool AOC_00000009_Y15_AllInASingleNight_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => AOC_00000009_Y15_AllInASingleNight_0(board);
        ...
        public AOC_00000009_Y15_AllInASingleNight(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            Input = RftAdventOfCodeHostData.Input_Test(problemName: nameof(AOC_00000009_Y15_AllInASingleNight));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = AOC_00000009_Y15_AllInASingleNight_0(boards[i]);
