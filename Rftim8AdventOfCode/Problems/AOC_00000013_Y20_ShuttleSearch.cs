...
{
    public class AOC_00000013_Y20_ShuttleSearch : IAOC_00000013_Y20_ShuttleSearch
    {
        #region Static
        ...
        [Benchmark]
        public bool Solution_0() => AOC_00000013_Y20_ShuttleSearch_0(Board!);

        private static bool AOC_00000013_Y20_ShuttleSearch_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => AOC_00000013_Y20_ShuttleSearch_0(board);
        ...
        public AOC_00000013_Y20_ShuttleSearch(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            Input = RftAdventOfCodeHostData.Input_Test(problemName: nameof(AOC_00000013_Y20_ShuttleSearch));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = AOC_00000013_Y20_ShuttleSearch_0(boards[i]);
