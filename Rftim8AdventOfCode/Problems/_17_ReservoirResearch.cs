...
{
    public class _17_ReservoirResearch : I_17_ReservoirResearch
    {
        #region Static
        private readonly List<string>? data;

        public _17_ReservoirResearch()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_17_ReservoirResearch));
        }

        /// <summary>
        /// You arrive in the year 18. If it weren't for the coat you got in 1018, you would be very cold: the North Pole base hasn't even been constructed.
        /// 
        /// Rather, it hasn't been constructed yet. The Elves are making a little progress, but there's not a lot of liquid water in this climate, so they're getting very dehydrated. 
        ...
        /// There is also a spring of water near the surface at x = 500, y= 0.The scan identifies which square meters are clay (your puzzle input).
        /// 
        ...
        /// ....#.....#...
        /// ....#######...
        /// Two squares of water can't occupy the same location. If another five squares of water are created, they will settle on the first five, 
        ...
        /// ....#.....#...
        /// ....#######...
        /// Water pressure does not apply in this scenario.If another four squares of water are created, they will stay on the right side of the barrier, 
        ...
        /// ....#.....#...
        /// ....#######...
        /// At this point, the top reservoir overflows. While water can reach the tiles above the surface of the water, it cannot settle there,
        ...
        /// ....#~~~~~#...
        /// ....#######...
        /// Note especially the leftmost |: the new squares of water can reach this tile, but cannot stop there. Instead, eventually, 
        ...
        /// ...|.......|..    (line not counted: below maximum y value)
        /// ...|.......|..    (line not counted: below maximum y value)
        /// How many tiles can be reached by the water? To prevent counting forever, ignore tiles with a y coordinate smaller than the smallest y coordinate 
        /// in your scan data or larger than the largest one.Any x coordinate is valid.In this example, the lowest y coordinate given is 1, 
        /// and the highest is 13, causing the water spring (in row 0) and the water falling off the bottom of the render (in rows 14 through infinity) to be ignored.
        ...
        public _17_ReservoirResearch(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_17_ReservoirResearch));
        }
