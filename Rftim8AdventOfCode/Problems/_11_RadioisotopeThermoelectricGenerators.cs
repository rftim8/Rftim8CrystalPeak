...
{
    public class _11_RadioisotopeThermoelectricGenerators : I_11_RadioisotopeThermoelectricGenerators
    {
        #region Static
        private readonly List<string>? data;

        public _11_RadioisotopeThermoelectricGenerators()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_11_RadioisotopeThermoelectricGenerators));
        }
        ...
        /// The fourth floor of the facility has an assembling machine which can make a self-contained, shielded computer for you to take with you - that is, 
        ...
        /// F2.  .  .  .  .
        /// F1.  .  .  .  .
        /// Leave the Lithium-compatible microchip on the fourth floor, but bring the Hydrogen-compatible one so you can still use the elevator; 
        /// this is safe because although the Lithium Generator is on the destination floor, you can connect Hydrogen-compatible microchip to the Hydrogen Generator there:
        /// 
        /// F4.  .  .  .LM
        /// F3 E HG HM LG.
        /// F2.  .  .  .  .
        ...
        public _11_RadioisotopeThermoelectricGenerators(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_11_RadioisotopeThermoelectricGenerators));
        }
