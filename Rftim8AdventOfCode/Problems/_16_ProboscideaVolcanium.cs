...
{
    public class _16_ProboscideaVolcanium : I_16_ProboscideaVolcanium
    {
        #region Static
        private readonly List<string>? data;

        public _16_ProboscideaVolcanium()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_16_ProboscideaVolcanium));
        }
        ...
        public _16_ProboscideaVolcanium(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_16_ProboscideaVolcanium));
        }
