...
{
    public class _07_AmplificationCircuit : I_07_AmplificationCircuit
    {
        #region Static
        private readonly List<string>? data;

        public _07_AmplificationCircuit()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_07_AmplificationCircuit));
        }
        ...
        /// They are connected such that the first amplifier's output leads to the second amplifier's input, the second amplifier's output leads to the third amplifier's input, 
        /// and so on.The first amplifier's input value is 0, and the last amplifier's output leads to your ship's thrusters.
        /// 
        /// 
        ///     O-------O O-------O O-------O O-------O O-------O
        ...
        public _07_AmplificationCircuit(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_07_AmplificationCircuit));
        }
