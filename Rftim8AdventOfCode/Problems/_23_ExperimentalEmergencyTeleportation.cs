...
{
    public class _23_ExperimentalEmergencyTeleportation : I_23_ExperimentalEmergencyTeleportation
    {
        #region Static
        private readonly List<string>? data;

        public _23_ExperimentalEmergencyTeleportation()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_23_ExperimentalEmergencyTeleportation));
        }
        ...
        public _23_ExperimentalEmergencyTeleportation(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_23_ExperimentalEmergencyTeleportation));
        }
