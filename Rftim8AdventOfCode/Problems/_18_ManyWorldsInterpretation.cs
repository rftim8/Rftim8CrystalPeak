...
{
    public class _18_ManyWorldsInterpretation : I_18_ManyWorldsInterpretation
    {
        #region Static
        private readonly List<string>? data;

        public _18_ManyWorldsInterpretation()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_18_ManyWorldsInterpretation));
        }
        ...
        public _18_ManyWorldsInterpretation(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_18_ManyWorldsInterpretation));
        }
