...
{
    public class _09_StreamProcessing : I_09_StreamProcessing
    {
        #region Static
        private readonly List<string>? data;
        
        public _09_StreamProcessing()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_09_StreamProcessing));
        }
        ...
        public _09_StreamProcessing(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_09_StreamProcessing));
        }
