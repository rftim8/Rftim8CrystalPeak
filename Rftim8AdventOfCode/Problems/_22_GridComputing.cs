...
{
    public class _22_GridComputing : I_22_GridComputing
    {
        #region Static
        private readonly List<string>? data;

        public _22_GridComputing()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_22_GridComputing));
        }
        ...
        public _22_GridComputing(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_22_GridComputing));
        }
