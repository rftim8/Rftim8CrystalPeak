...
{
    public class _25_TheHaltingProblem : I_25_TheHaltingProblem
    {
        #region Static
        private readonly List<string>? data;

        public _25_TheHaltingProblem()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_25_TheHaltingProblem));
        }
        ...
        /// You try to explain that Turing machines are merely models of computation, but he cuts you off. "No, see, that's just what they want you to think. 
        /// Ultimately, inside every CPU, there's a Turing machine driving the whole thing! Too bad this one's broken. We're doomed!"
        /// 
        /// You ask how you can help. "Well, unfortunately, the only way to get the computer running again would be to create a whole new Turing machine from scratch,
        /// but there's no way you can-" He notices the look on your face, gives you a curious glance, shrugs, and goes back to sweeping the floor.
        ///
        ...
        /// Based on whether the cursor is pointing at a 0 or a 1, the current state says what value to write at the current position of the cursor,
        ...
        public _25_TheHaltingProblem(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_25_TheHaltingProblem));
        }
