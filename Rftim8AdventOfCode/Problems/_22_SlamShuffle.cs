...
{
    public class _22_SlamShuffle : I_22_SlamShuffle
    {
        #region Static
        private readonly List<string>? data;

        public _22_SlamShuffle()
        {
            data = RftAdventOfCodeStaticData.Input_Test(testType: false, problemName: nameof(_22_SlamShuffle));
        }
        ...
        /// You've also been getting pretty good at a version of this technique where N is negative! In that case, cut (the absolute value of) N cards 
        ...
        /// 
        /// Finally, collect the cards on the table so that the leftmost card ends up at the top of your deck, the card to its right ends up just below the top card, 
        ...
        public _22_SlamShuffle(IHost host)
        {
            RftAdventOfCodeHostData = host.Services.GetRequiredService<IRftAdventOfCodeHostData>();
            data = RftAdventOfCodeHostData.Input_Test(problemName: nameof(_22_SlamShuffle));
        }
