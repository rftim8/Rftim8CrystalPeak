...
{
    public class CF_00001013A_PilesWithStones : ICF_00001013A_PilesWithStones
    {
        #region Static
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001013A_PilesWithStones_0(Board!);

        private static bool CF_00001013A_PilesWithStones_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001013A_PilesWithStones_0(board);
        ...
        public CF_00001013A_PilesWithStones(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001013A_PilesWithStones));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001013A_PilesWithStones_0(boards[i]);
