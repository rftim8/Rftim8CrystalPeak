...
{
    public class CF_00000257D_Sum : ICF_00000257D_Sum
    {
        #region Static
        ...
        public CF_00000257D_Sum()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000257D_Sum));
            //Input = [.. CF_Resources.CF_00000257D_Sum_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000257D_Sum_0(Board!);

        private static bool CF_00000257D_Sum_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000257D_Sum_0(board);
        ...
        public CF_00000257D_Sum(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000257D_Sum));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000257D_Sum_0(boards[i]);
