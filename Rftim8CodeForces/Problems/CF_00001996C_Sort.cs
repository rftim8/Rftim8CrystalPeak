...
{
    public class CF_00001996C_Sort : ICF_00001996C_Sort
    {
        #region Static
        ...
        public CF_00001996C_Sort()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001996C_Sort));
            //Input = [.. CF_Resources.CF_00001996C_Sort_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001996C_Sort_0(Board!);

        private static bool CF_00001996C_Sort_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001996C_Sort_0(board);
        ...
        public CF_00001996C_Sort(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001996C_Sort));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001996C_Sort_0(boards[i]);
