...
{
    public class CF_00001057B_DDoS : ICF_00001057B_DDoS
    {
        #region Static
        ...
        public CF_00001057B_DDoS()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001057B_DDoS));
            //Input = [.. CF_Resources.CF_00001057B_DDoS_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001057B_DDoS_0(Board!);

        private static bool CF_00001057B_DDoS_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001057B_DDoS_0(board);
        ...
        public CF_00001057B_DDoS(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001057B_DDoS));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001057B_DDoS_0(boards[i]);
