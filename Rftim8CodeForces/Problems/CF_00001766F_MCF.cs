...
{
    public class CF_00001766F_MCF : ICF_00001766F_MCF
    {
        #region Static
        ...
        public CF_00001766F_MCF()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001766F_MCF));
            //Input = [.. CF_Resources.CF_00001766F_MCF_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001766F_MCF_0(Board!);

        private static bool CF_00001766F_MCF_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001766F_MCF_0(board);
        ...
        public CF_00001766F_MCF(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001766F_MCF));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001766F_MCF_0(boards[i]);
