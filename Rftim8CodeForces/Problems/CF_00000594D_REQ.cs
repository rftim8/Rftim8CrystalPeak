...
{
    public class CF_00000594D_REQ : ICF_00000594D_REQ
    {
        #region Static
        ...
        public CF_00000594D_REQ()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000594D_REQ));
            //Input = [.. CF_Resources.CF_00000594D_REQ_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000594D_REQ_0(Board!);

        private static bool CF_00000594D_REQ_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000594D_REQ_0(board);
        ...
        public CF_00000594D_REQ(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000594D_REQ));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000594D_REQ_0(boards[i]);
