...
{
    public class CF_00000687E_TOF : ICF_00000687E_TOF
    {
        #region Static
        ...
        public CF_00000687E_TOF()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000687E_TOF));
            //Input = [.. CF_Resources.CF_00000687E_TOF_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000687E_TOF_0(Board!);

        private static bool CF_00000687E_TOF_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000687E_TOF_0(board);
        ...
        public CF_00000687E_TOF(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000687E_TOF));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000687E_TOF_0(boards[i]);
