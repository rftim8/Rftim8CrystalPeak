...
{
    public class CF_00002041C_Cube : ICF_00002041C_Cube
    {
        #region Static
        ...
        public CF_00002041C_Cube()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002041C_Cube));
            //Input = [.. CF_Resources.CF_00002041C_Cube_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00002041C_Cube_0(Board!);

        private static bool CF_00002041C_Cube_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00002041C_Cube_0(board);
        ...
        public CF_00002041C_Cube(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00002041C_Cube));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00002041C_Cube_0(boards[i]);
