...
{
    public class CF_00000376B_IOU : ICF_00000376B_IOU
    {
        #region Static
        ...
        public CF_00000376B_IOU()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000376B_IOU));
            //Input = [.. CF_Resources.CF_00000376B_IOU_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000376B_IOU_0(Board!);

        private static bool CF_00000376B_IOU_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000376B_IOU_0(board);
        ...
        public CF_00000376B_IOU(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000376B_IOU));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000376B_IOU_0(boards[i]);
