...
{
    public class CF_00000364D_Ghd : ICF_00000364D_Ghd
    {
        #region Static
        ...
        public CF_00000364D_Ghd()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000364D_Ghd));
            //Input = [.. CF_Resources.CF_00000364D_Ghd_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000364D_Ghd_0(Board!);

        private static bool CF_00000364D_Ghd_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000364D_Ghd_0(board);
        ...
        public CF_00000364D_Ghd(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000364D_Ghd));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000364D_Ghd_0(boards[i]);
