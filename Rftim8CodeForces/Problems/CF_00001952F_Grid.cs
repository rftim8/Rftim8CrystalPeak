...
{
    public class CF_00001952F_Grid : ICF_00001952F_Grid
    {
        #region Static
        ...
        public CF_00001952F_Grid()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001952F_Grid));
            //Input = [.. CF_Resources.CF_00001952F_Grid_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001952F_Grid_0(Board!);

        private static bool CF_00001952F_Grid_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001952F_Grid_0(board);
        ...
        public CF_00001952F_Grid(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001952F_Grid));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001952F_Grid_0(boards[i]);
