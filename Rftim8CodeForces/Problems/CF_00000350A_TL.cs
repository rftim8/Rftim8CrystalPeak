...
{
    public class CF_00000350A_TL : ICF_00000350A_TL
    {
        #region Static
        ...
        public CF_00000350A_TL()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000350A_TL));
            //Input = [.. CF_Resources.CF_00000350A_TL_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000350A_TL_0(Board!);

        private static bool CF_00000350A_TL_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000350A_TL_0(board);
        ...
        public CF_00000350A_TL(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000350A_TL));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000350A_TL_0(boards[i]);
