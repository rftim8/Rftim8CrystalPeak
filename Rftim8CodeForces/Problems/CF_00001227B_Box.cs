...
{
    public class CF_00001227B_Box : ICF_00001227B_Box
    {
        #region Static
        ...
        public CF_00001227B_Box()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001227B_Box));
            //Input = [.. CF_Resources.CF_00001227B_Box_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001227B_Box_0(Board!);

        private static bool CF_00001227B_Box_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001227B_Box_0(board);
        ...
        public CF_00001227B_Box(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001227B_Box));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001227B_Box_0(boards[i]);
