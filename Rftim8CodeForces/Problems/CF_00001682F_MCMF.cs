...
{
    public class CF_00001682F_MCMF : ICF_00001682F_MCMF
    {
        #region Static
        ...
        public CF_00001682F_MCMF()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001682F_MCMF));
            //Input = [.. CF_Resources.CF_00001682F_MCMF_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001682F_MCMF_0(Board!);

        private static bool CF_00001682F_MCMF_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001682F_MCMF_0(board);
        ...
        public CF_00001682F_MCMF(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001682F_MCMF));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001682F_MCMF_0(boards[i]);
