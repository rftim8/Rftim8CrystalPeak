...
{
    public class CF_00001868F_LIS : ICF_00001868F_LIS
    {
        #region Static
        ...
        public CF_00001868F_LIS()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001868F_LIS));
            //Input = [.. CF_Resources.CF_00001868F_LIS_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001868F_LIS_0(Board!);

        private static bool CF_00001868F_LIS_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001868F_LIS_0(board);
        ...
        public CF_00001868F_LIS(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001868F_LIS));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001868F_LIS_0(boards[i]);
