...
{
    public class CF_00000043E_Race : ICF_00000043E_Race
    {
        #region Static
        ...
        public CF_00000043E_Race()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000043E_Race));
            //Input = [.. CF_Resources.CF_00000043E_Race_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000043E_Race_0(Board!);

        private static bool CF_00000043E_Race_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000043E_Race_0(board);
        ...
        public CF_00000043E_Race(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000043E_Race));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000043E_Race_0(boards[i]);
