...
{
    public class CF_00001604A_Era : ICF_00001604A_Era
    {
        #region Static
        ...
        public CF_00001604A_Era()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001604A_Era));
            //Input = [.. CF_Resources.CF_00001604A_Era_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001604A_Era_0(Board!);

        private static bool CF_00001604A_Era_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001604A_Era_0(board);
        ...
        public CF_00001604A_Era(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001604A_Era));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001604A_Era_0(boards[i]);
