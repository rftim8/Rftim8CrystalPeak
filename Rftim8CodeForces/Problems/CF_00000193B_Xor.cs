...
{
    public class CF_00000193B_Xor : ICF_00000193B_Xor
    {
        #region Static
        ...
        public CF_00000193B_Xor()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000193B_Xor));
            //Input = [.. CF_Resources.CF_00000193B_Xor_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000193B_Xor_0(Board!);

        private static bool CF_00000193B_Xor_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000193B_Xor_0(board);
        ...
        public CF_00000193B_Xor(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000193B_Xor));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000193B_Xor_0(boards[i]);
