...
{
    public class CF_00002038C_DIY : ICF_00002038C_DIY
    {
        #region Static
        ...
        public CF_00002038C_DIY()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002038C_DIY));
            //Input = [.. CF_Resources.CF_00002038C_DIY_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00002038C_DIY_0(Board!);

        private static bool CF_00002038C_DIY_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00002038C_DIY_0(board);
        ...
        public CF_00002038C_DIY(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00002038C_DIY));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00002038C_DIY_0(boards[i]);
