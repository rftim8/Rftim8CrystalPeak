...
{
    public class CF_00001635E_Cars : ICF_00001635E_Cars
    {
        #region Static
        ...
        public CF_00001635E_Cars()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001635E_Cars));
            //Input = [.. CF_Resources.CF_00001635E_Cars_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001635E_Cars_0(Board!);

        private static bool CF_00001635E_Cars_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001635E_Cars_0(board);
        ...
        public CF_00001635E_Cars(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001635E_Cars));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001635E_Cars_0(boards[i]);
