...
{
    public class CF_00001938D_Cake : ICF_00001938D_Cake
    {
        #region Static
        ...
        public CF_00001938D_Cake()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001938D_Cake));
            //Input = [.. CF_Resources.CF_00001938D_Cake_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001938D_Cake_0(Board!);

        private static bool CF_00001938D_Cake_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001938D_Cake_0(board);
        ...
        public CF_00001938D_Cake(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001938D_Cake));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001938D_Cake_0(boards[i]);
