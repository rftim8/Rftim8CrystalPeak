...
{
    public class CF_00001996F_Bomb : ICF_00001996F_Bomb
    {
        #region Static
        ...
        public CF_00001996F_Bomb()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001996F_Bomb));
            //Input = [.. CF_Resources.CF_00001996F_Bomb_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001996F_Bomb_0(Board!);

        private static bool CF_00001996F_Bomb_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001996F_Bomb_0(board);
        ...
        public CF_00001996F_Bomb(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001996F_Bomb));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001996F_Bomb_0(boards[i]);
