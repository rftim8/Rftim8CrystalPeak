...
{
    public class CF_00000044B_Cola : ICF_00000044B_Cola
    {
        #region Static
        ...
        public CF_00000044B_Cola()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000044B_Cola));
            //Input = [.. CF_Resources.CF_00000044B_Cola_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000044B_Cola_0(Board!);

        private static bool CF_00000044B_Cola_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000044B_Cola_0(board);
        ...
        public CF_00000044B_Cola(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000044B_Cola));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000044B_Cola_0(boards[i]);
