...
namespace Rftim8CodeForces.Problems
{
    public class CF_00000002A_Winner : ICF_00000002A_Winner
    {
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000002A_Winner_0(Board!);

        private static bool CF_00000002A_Winner_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000002A_Winner_0(board);
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000002A_Winner_0(boards[i]);
