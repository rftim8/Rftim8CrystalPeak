...
{
    public class CF_00001905E_OneX : ICF_00001905E_OneX
    {
        #region Static
        ...
        public CF_00001905E_OneX()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001905E_OneX));
            //Input = [.. CF_Resources.CF_00001905E_OneX_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001905E_OneX_0(Board!);

        private static bool CF_00001905E_OneX_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001905E_OneX_0(board);
        ...
        public CF_00001905E_OneX(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001905E_OneX));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001905E_OneX_0(boards[i]);
