...
{
    public class CF_00001468A_LaIS : ICF_00001468A_LaIS
    {
        #region Static
        ...
        public CF_00001468A_LaIS()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468A_LaIS));
            //Input = [.. CF_Resources.CF_00001468A_LaIS_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001468A_LaIS_0(Board!);

        private static bool CF_00001468A_LaIS_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001468A_LaIS_0(board);
        ...
        public CF_00001468A_LaIS(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001468A_LaIS));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001468A_LaIS_0(boards[i]);
