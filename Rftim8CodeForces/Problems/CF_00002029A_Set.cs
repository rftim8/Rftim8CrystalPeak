...
{
    public class CF_00002029A_Set : ICF_00002029A_Set
    {
        #region Static
        ...
        public CF_00002029A_Set()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002029A_Set));
            //Input = [.. CF_Resources.CF_00002029A_Set_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00002029A_Set_0(Board!);

        private static bool CF_00002029A_Set_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00002029A_Set_0(board);
        ...
        public CF_00002029A_Set(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00002029A_Set));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00002029A_Set_0(boards[i]);
