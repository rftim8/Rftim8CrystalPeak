...
{
    public class CF_00001223A_CME : ICF_00001223A_CME
    {
        #region Static
        ...
        public CF_00001223A_CME()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001223A_CME));
            //Input = [.. CF_Resources.CF_00001223A_CME_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001223A_CME_0(Board!);

        private static bool CF_00001223A_CME_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001223A_CME_0(board);
        ...
        public CF_00001223A_CME(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001223A_CME));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001223A_CME_0(boards[i]);
