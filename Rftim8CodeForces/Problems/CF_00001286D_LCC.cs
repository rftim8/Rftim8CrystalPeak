...
{
    public class CF_00001286D_LCC : ICF_00001286D_LCC
    {
        #region Static
        ...
        public CF_00001286D_LCC()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001286D_LCC));
            //Input = [.. CF_Resources.CF_00001286D_LCC_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001286D_LCC_0(Board!);

        private static bool CF_00001286D_LCC_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001286D_LCC_0(board);
        ...
        public CF_00001286D_LCC(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001286D_LCC));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001286D_LCC_0(boards[i]);
