...
{
    public class CF_00001632A_ABC : ICF_00001632A_ABC
    {
        #region Static
        ...
        public CF_00001632A_ABC()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001632A_ABC));
            //Input = [.. CF_Resources.CF_00001632A_ABC_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001632A_ABC_0(Board!);

        private static bool CF_00001632A_ABC_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001632A_ABC_0(board);
        ...
        public CF_00001632A_ABC(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001632A_ABC));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001632A_ABC_0(boards[i]);
