...
{
    public class CF_00000484A_Bits : ICF_00000484A_Bits
    {
        #region Static
        ...
        public CF_00000484A_Bits()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000484A_Bits));
            //Input = [.. CF_Resources.CF_00000484A_Bits_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00000484A_Bits_0(Board!);

        private static bool CF_00000484A_Bits_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00000484A_Bits_0(board);
        ...
        public CF_00000484A_Bits(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00000484A_Bits));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00000484A_Bits_0(boards[i]);
