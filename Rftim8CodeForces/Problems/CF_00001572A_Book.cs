...
{
    public class CF_00001572A_Book : ICF_00001572A_Book
    {
        #region Static
        ...
        public CF_00001572A_Book()
        {
            Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001572A_Book));
            //Input = [.. CF_Resources.CF_00001572A_Book_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CF_00001572A_Book_0(Board!);

        private static bool CF_00001572A_Book_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CF_00001572A_Book_0(board);
        ...
        public CF_00001572A_Book(IHost host)
        {
            RftCodeForcesHostData = host.Services.GetRequiredService<IRftCodeForcesHostData>();
            Input = RftCodeForcesHostData.Input_Test(problemName: nameof(CF_00001572A_Book));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CF_00001572A_Book_0(boards[i]);
