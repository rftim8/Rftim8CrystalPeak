...
{
    public class CG_00000183_DAWG : ICG_00000183_DAWG
    {
        #region Static
        ...
        public CG_00000183_DAWG()
        {
            Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000183_DAWG));
            //Input = [.. CF_Resources.CG_00000183_DAWG_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CG_00000183_DAWG_0(Board!);

        private static bool CG_00000183_DAWG_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CG_00000183_DAWG_0(board);
        ...
        public CG_00000183_DAWG(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            Input = RftCodinGameHostData.Input_Test(problemName: nameof(CG_00000183_DAWG));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CG_00000183_DAWG_0(boards[i]);
