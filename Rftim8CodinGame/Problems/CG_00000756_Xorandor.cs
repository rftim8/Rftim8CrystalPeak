...
{
    public class CG_00000756_Xorandor : ICG_00000756_Xorandor
    {
        #region Static
        ...
        public CG_00000756_Xorandor()
        {
            Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000756_Xorandor));
            //Input = [.. CF_Resources.CG_00000756_Xorandor_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CG_00000756_Xorandor_0(Board!);

        private static bool CG_00000756_Xorandor_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CG_00000756_Xorandor_0(board);
        ...
        public CG_00000756_Xorandor(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            Input = RftCodinGameHostData.Input_Test(problemName: nameof(CG_00000756_Xorandor));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CG_00000756_Xorandor_0(boards[i]);
