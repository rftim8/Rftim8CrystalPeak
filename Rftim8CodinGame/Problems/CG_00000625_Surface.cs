...
{
    public class CG_00000625_Surface : ICG_00000625_Surface
    {
        #region Static
        ...
        public CG_00000625_Surface()
        {
            Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000625_Surface));
            //Input = [.. CF_Resources.CG_00000625_Surface_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CG_00000625_Surface_0(Board!);

        private static bool CG_00000625_Surface_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CG_00000625_Surface_0(board);
        ...
        public CG_00000625_Surface(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            Input = RftCodinGameHostData.Input_Test(problemName: nameof(CG_00000625_Surface));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CG_00000625_Surface_0(boards[i]);
