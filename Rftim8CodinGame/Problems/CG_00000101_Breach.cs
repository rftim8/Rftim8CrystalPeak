...
{
    public class CG_00000101_Breach : ICG_00000101_Breach
    {
        #region Static
        ...
        public CG_00000101_Breach()
        {
            Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000101_Breach));
            //Input = [.. CF_Resources.CG_00000101_Breach_Input.Split(["\n"], StringSplitOptions.RemoveEmptyEntries)]; // Benchmarking
            DataCollector();
            PrintSolution();
        }
        ...
        [Benchmark]
        public bool Solution_0() => CG_00000101_Breach_0(Board!);

        private static bool CG_00000101_Breach_0(char[][] board)
        {
            return true;
        }
        #endregion
        ...
        #region UnitTest
        public static bool Solution_0_Test(char[][] board) => CG_00000101_Breach_0(board);
        ...
        public CG_00000101_Breach(IHost host)
        {
            RftCodinGameHostData = host.Services.GetRequiredService<IRftCodinGameHostData>();
            Input = RftCodinGameHostData.Input_Test(problemName: nameof(CG_00000101_Breach));
            DataCollector();
        }
        ...
        public void PrintSolution()
        {
            ...
            {
                bool actual = CG_00000101_Breach_0(boards[i]);
