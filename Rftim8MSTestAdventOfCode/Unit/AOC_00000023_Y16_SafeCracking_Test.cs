...
{
    [TestClass]
    public sealed class AOC_00000023_Y16_SafeCracking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftAdventOfCodeStaticData.Input_Test(testType: true, problemName: nameof(AOC_00000023_Y16_SafeCracking));
        ...
        public void Solution_0(List<char[][]> boards, List<bool> results)
        {
            ...
            {
                bool result = AOC_00000023_Y16_SafeCracking.Solution_0_Test(boards[i]);
