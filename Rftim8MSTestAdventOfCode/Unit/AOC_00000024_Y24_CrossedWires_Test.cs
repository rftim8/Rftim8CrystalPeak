...
{
    [TestClass]
    public sealed class AOC_00000024_Y24_CrossedWires_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftAdventOfCodeStaticData.Input_Test(testType: true, problemName: nameof(AOC_00000024_Y24_CrossedWires));
        ...
        public void Solution_0(List<char[][]> boards, List<bool> results)
        {
            ...
            {
                bool result = AOC_00000024_Y24_CrossedWires.Solution_0_Test(boards[i]);
