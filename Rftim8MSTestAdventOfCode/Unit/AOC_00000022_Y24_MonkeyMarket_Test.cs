...
{
    [TestClass]
    public sealed class AOC_00000022_Y24_MonkeyMarket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftAdventOfCodeStaticData.Input_Test(testType: true, problemName: nameof(AOC_00000022_Y24_MonkeyMarket));
        ...
        public void Solution_0(List<char[][]> boards, List<bool> results)
        {
            ...
            {
                bool result = AOC_00000022_Y24_MonkeyMarket.Solution_0_Test(boards[i]);
