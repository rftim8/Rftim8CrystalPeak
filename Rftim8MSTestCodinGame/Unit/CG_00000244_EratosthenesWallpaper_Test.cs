...
{
    [TestClass]
    public sealed class CG_00000244_EratosthenesWallpaper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000244_EratosthenesWallpaper));
        ...
        {
            bool result = CG_00000244_EratosthenesWallpaper.Solution_0_Test(input);
