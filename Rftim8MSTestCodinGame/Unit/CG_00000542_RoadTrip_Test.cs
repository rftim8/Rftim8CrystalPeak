...
{
    [TestClass]
    public sealed class CG_00000542_RoadTrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000542_RoadTrip));
        ...
        {
            bool result = CG_00000542_RoadTrip.Solution_0_Test(input);
