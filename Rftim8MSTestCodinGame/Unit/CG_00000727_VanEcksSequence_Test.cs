...
{
    [TestClass]
    public sealed class CG_00000727_VanEcksSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000727_VanEcksSequence));
        ...
        {
            bool result = CG_00000727_VanEcksSequence.Solution_0_Test(input);
