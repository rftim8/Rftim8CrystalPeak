...
{
    [TestClass]
    public sealed class CG_00000400_MagicStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000400_MagicStones));
        ...
        {
            bool result = CG_00000400_MagicStones.Solution_0_Test(input);
