...
{
    [TestClass]
    public sealed class CG_00000554_RooksMovements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000554_RooksMovements));
        ...
        {
            bool result = CG_00000554_RooksMovements.Solution_0_Test(input);
