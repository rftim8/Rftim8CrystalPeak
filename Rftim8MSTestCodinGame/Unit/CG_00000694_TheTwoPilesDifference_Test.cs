...
{
    [TestClass]
    public sealed class CG_00000694_TheTwoPilesDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000694_TheTwoPilesDifference));
        ...
        {
            bool result = CG_00000694_TheTwoPilesDifference.Solution_0_Test(input);
