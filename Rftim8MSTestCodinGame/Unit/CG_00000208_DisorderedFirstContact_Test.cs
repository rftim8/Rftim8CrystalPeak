...
{
    [TestClass]
    public sealed class CG_00000208_DisorderedFirstContact_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000208_DisorderedFirstContact));
        ...
        {
            bool result = CG_00000208_DisorderedFirstContact.Solution_0_Test(input);
