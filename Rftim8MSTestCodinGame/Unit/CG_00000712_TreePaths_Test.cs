...
{
    [TestClass]
    public sealed class CG_00000712_TreePaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000712_TreePaths));
        ...
        {
            bool result = CG_00000712_TreePaths.Solution_0_Test(input);
