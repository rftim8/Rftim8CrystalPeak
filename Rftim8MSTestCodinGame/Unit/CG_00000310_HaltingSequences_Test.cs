...
{
    [TestClass]
    public sealed class CG_00000310_HaltingSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000310_HaltingSequences));
        ...
        {
            bool result = CG_00000310_HaltingSequences.Solution_0_Test(input);
