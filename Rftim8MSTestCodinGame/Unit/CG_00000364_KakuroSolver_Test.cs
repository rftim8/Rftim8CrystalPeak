...
{
    [TestClass]
    public sealed class CG_00000364_KakuroSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000364_KakuroSolver));
        ...
        {
            bool result = CG_00000364_KakuroSolver.Solution_0_Test(input);
