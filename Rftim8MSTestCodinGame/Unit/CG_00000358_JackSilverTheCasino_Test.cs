...
{
    [TestClass]
    public sealed class CG_00000358_JackSilverTheCasino_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000358_JackSilverTheCasino));
        ...
        {
            bool result = CG_00000358_JackSilverTheCasino.Solution_0_Test(input);
