...
{
    [TestClass]
    public sealed class CG_00000558_RunningUpThatHill_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000558_RunningUpThatHill));
        ...
        {
            bool result = CG_00000558_RunningUpThatHill.Solution_0_Test(input);
