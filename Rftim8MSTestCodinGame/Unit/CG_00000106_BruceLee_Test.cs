...
{
    [TestClass]
    public sealed class CG_00000106_BruceLee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000106_BruceLee));
        ...
        {
            bool result = CG_00000106_BruceLee.Solution_0_Test(input);
