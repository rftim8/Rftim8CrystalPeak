...
{
    [TestClass]
    public sealed class CG_00000149_ComplicatedInterpreter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000149_ComplicatedInterpreter));
        ...
        {
            bool result = CG_00000149_ComplicatedInterpreter.Solution_0_Test(input);
