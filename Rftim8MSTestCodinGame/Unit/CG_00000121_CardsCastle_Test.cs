...
{
    [TestClass]
    public sealed class CG_00000121_CardsCastle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000121_CardsCastle));
        ...
        {
            bool result = CG_00000121_CardsCastle.Solution_0_Test(input);
