...
{
    [TestClass]
    public sealed class CG_00000702_TicketToRideEurope_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000702_TicketToRideEurope));
        ...
        {
            bool result = CG_00000702_TicketToRideEurope.Solution_0_Test(input);
