...
{
    [TestClass]
    public sealed class CG_00000307_GuessingDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000307_GuessingDigits));
        ...
        {
            bool result = CG_00000307_GuessingDigits.Solution_0_Test(input);
