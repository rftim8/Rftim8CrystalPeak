...
{
    [TestClass]
    public sealed class CG_00000361_JumpingFrogs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000361_JumpingFrogs));
        ...
        {
            bool result = CG_00000361_JumpingFrogs.Solution_0_Test(input);
