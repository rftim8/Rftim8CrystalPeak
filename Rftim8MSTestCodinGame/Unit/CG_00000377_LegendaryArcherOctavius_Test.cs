...
{
    [TestClass]
    public sealed class CG_00000377_LegendaryArcherOctavius_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000377_LegendaryArcherOctavius));
        ...
        {
            bool result = CG_00000377_LegendaryArcherOctavius.Solution_0_Test(input);
