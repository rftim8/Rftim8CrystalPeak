...
{
    [TestClass]
    public sealed class CG_00000675_TheLostFiles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000675_TheLostFiles));
        ...
        {
            bool result = CG_00000675_TheLostFiles.Solution_0_Test(input);
