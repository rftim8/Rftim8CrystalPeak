...
{
    [TestClass]
    public sealed class CG_00000636_TelephoneNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000636_TelephoneNumbers));
        ...
        {
            bool result = CG_00000636_TelephoneNumbers.Solution_0_Test(input);
