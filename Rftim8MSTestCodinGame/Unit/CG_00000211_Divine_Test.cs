...
{
    [TestClass]
    public sealed class CG_00000211_Divine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000211_Divine));
        ...
        {
            bool result = CG_00000211_Divine.Solution_0_Test(input);
