...
{
    [TestClass]
    public sealed class CG_00000291_GeneticsAndComputers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000291_GeneticsAndComputers));
        ...
        {
            bool result = CG_00000291_GeneticsAndComputers.Solution_0_Test(input);
