...
{
    [TestClass]
    public sealed class CG_00000067_BattleTower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000067_BattleTower));
        ...
        {
            bool result = CG_00000067_BattleTower.Solution_0_Test(input);
