...
{
    [TestClass]
    public sealed class CG_00000413_MathematicsForBigEars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000413_MathematicsForBigEars));
        ...
        {
            bool result = CG_00000413_MathematicsForBigEars.Solution_0_Test(input);
