...
{
    [TestClass]
    public sealed class CG_00000089_BLUNDEREPISODE3_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000089_BLUNDEREPISODE3));
        ...
        {
            bool result = CG_00000089_BLUNDEREPISODE3.Solution_0_Test(input);
