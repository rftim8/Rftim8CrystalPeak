...
{
    [TestClass]
    public sealed class CG_00000215_DominoesSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000215_DominoesSolver));
        ...
        {
            bool result = CG_00000215_DominoesSolver.Solution_0_Test(input);
