...
{
    [TestClass]
    public sealed class CG_00000532_RemoveInsertStatements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000532_RemoveInsertStatements));
        ...
        {
            bool result = CG_00000532_RemoveInsertStatements.Solution_0_Test(input);
