...
{
    [TestClass]
    public sealed class CG_00000515_ProbabilityForDummies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000515_ProbabilityForDummies));
        ...
        {
            bool result = CG_00000515_ProbabilityForDummies.Solution_0_Test(input);
