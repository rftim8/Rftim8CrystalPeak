...
{
    [TestClass]
    public sealed class CG_00000481_OneWayCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000481_OneWayCity));
        ...
        {
            bool result = CG_00000481_OneWayCity.Solution_0_Test(input);
