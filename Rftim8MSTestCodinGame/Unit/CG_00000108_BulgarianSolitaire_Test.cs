...
{
    [TestClass]
    public sealed class CG_00000108_BulgarianSolitaire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000108_BulgarianSolitaire));
        ...
        {
            bool result = CG_00000108_BulgarianSolitaire.Solution_0_Test(input);
