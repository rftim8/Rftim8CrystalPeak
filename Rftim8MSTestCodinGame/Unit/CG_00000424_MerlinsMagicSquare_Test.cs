...
{
    [TestClass]
    public sealed class CG_00000424_MerlinsMagicSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000424_MerlinsMagicSquare));
        ...
        {
            bool result = CG_00000424_MerlinsMagicSquare.Solution_0_Test(input);
