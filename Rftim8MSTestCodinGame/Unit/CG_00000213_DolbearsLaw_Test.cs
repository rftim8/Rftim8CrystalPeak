...
{
    [TestClass]
    public sealed class CG_00000213_DolbearsLaw_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000213_DolbearsLaw));
        ...
        {
            bool result = CG_00000213_DolbearsLaw.Solution_0_Test(input);
