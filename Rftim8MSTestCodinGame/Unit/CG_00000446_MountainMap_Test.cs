...
{
    [TestClass]
    public sealed class CG_00000446_MountainMap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000446_MountainMap));
        ...
        {
            bool result = CG_00000446_MountainMap.Solution_0_Test(input);
