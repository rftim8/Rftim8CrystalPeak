...
{
    [TestClass]
    public sealed class CG_00000487_PanelCount_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000487_PanelCount));
        ...
        {
            bool result = CG_00000487_PanelCount.Solution_0_Test(input);
