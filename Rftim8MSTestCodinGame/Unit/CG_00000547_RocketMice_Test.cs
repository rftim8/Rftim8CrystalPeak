...
{
    [TestClass]
    public sealed class CG_00000547_RocketMice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000547_RocketMice));
        ...
        {
            bool result = CG_00000547_RocketMice.Solution_0_Test(input);
