...
{
    [TestClass]
    public sealed class CG_00000272_FloodFillExample_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000272_FloodFillExample));
        ...
        {
            bool result = CG_00000272_FloodFillExample.Solution_0_Test(input);
