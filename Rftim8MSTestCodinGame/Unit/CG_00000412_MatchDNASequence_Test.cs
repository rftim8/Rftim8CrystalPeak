...
{
    [TestClass]
    public sealed class CG_00000412_MatchDNASequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000412_MatchDNASequence));
        ...
        {
            bool result = CG_00000412_MatchDNASequence.Solution_0_Test(input);
