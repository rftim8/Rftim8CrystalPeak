...
{
    [TestClass]
    public sealed class CG_00000375_LargestNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000375_LargestNumber));
        ...
        {
            bool result = CG_00000375_LargestNumber.Solution_0_Test(input);
