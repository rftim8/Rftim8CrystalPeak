...
{
    [TestClass]
    public sealed class CG_00000123_CastleSiege_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000123_CastleSiege));
        ...
        {
            bool result = CG_00000123_CastleSiege.Solution_0_Test(input);
