...
{
    [TestClass]
    public sealed class CG_00000543_RobberyOptimisation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000543_RobberyOptimisation));
        ...
        {
            bool result = CG_00000543_RobberyOptimisation.Solution_0_Test(input);
