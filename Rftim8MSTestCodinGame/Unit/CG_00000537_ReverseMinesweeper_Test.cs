...
{
    [TestClass]
    public sealed class CG_00000537_ReverseMinesweeper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000537_ReverseMinesweeper));
        ...
        {
            bool result = CG_00000537_ReverseMinesweeper.Solution_0_Test(input);
