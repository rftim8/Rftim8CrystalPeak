...
{
    [TestClass]
    public sealed class CG_00000722_UnfoldingPaper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000722_UnfoldingPaper));
        ...
        {
            bool result = CG_00000722_UnfoldingPaper.Solution_0_Test(input);
