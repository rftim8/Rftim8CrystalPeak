...
{
    [TestClass]
    public sealed class CG_00000324_HighriseBuildings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000324_HighriseBuildings));
        ...
        {
            bool result = CG_00000324_HighriseBuildings.Solution_0_Test(input);
