...
{
    [TestClass]
    public sealed class CG_00000416_MaximumSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000416_MaximumSubsequence));
        ...
        {
            bool result = CG_00000416_MaximumSubsequence.Solution_0_Test(input);
