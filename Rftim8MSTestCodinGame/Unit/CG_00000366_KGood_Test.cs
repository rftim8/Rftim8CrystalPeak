...
{
    [TestClass]
    public sealed class CG_00000366_KGood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000366_KGood));
        ...
        {
            bool result = CG_00000366_KGood.Solution_0_Test(input);
