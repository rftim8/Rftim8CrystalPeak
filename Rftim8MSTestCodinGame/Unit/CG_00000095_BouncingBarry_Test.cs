...
{
    [TestClass]
    public sealed class CG_00000095_BouncingBarry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000095_BouncingBarry));
        ...
        {
            bool result = CG_00000095_BouncingBarry.Solution_0_Test(input);
