...
{
    [TestClass]
    public sealed class CG_00000603_SPORECityPlanner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000603_SPORECityPlanner));
        ...
        {
            bool result = CG_00000603_SPORECityPlanner.Solution_0_Test(input);
