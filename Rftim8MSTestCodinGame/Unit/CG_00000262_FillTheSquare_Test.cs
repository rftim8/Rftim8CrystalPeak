...
{
    [TestClass]
    public sealed class CG_00000262_FillTheSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000262_FillTheSquare));
        ...
        {
            bool result = CG_00000262_FillTheSquare.Solution_0_Test(input);
