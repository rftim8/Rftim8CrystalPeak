...
{
    [TestClass]
    public sealed class CG_00000111_BustSpeedingVehicles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000111_BustSpeedingVehicles));
        ...
        {
            bool result = CG_00000111_BustSpeedingVehicles.Solution_0_Test(input);
