...
{
    [TestClass]
    public sealed class CG_00000084_Blockout_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000084_Blockout));
        ...
        {
            bool result = CG_00000084_Blockout.Solution_0_Test(input);
