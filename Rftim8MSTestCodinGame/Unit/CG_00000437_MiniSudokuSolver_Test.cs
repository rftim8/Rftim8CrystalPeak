...
{
    [TestClass]
    public sealed class CG_00000437_MiniSudokuSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000437_MiniSudokuSolver));
        ...
        {
            bool result = CG_00000437_MiniSudokuSolver.Solution_0_Test(input);
