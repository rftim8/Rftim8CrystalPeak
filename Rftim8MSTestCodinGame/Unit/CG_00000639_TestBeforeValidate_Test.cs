...
{
    [TestClass]
    public sealed class CG_00000639_TestBeforeValidate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000639_TestBeforeValidate));
        ...
        {
            bool result = CG_00000639_TestBeforeValidate.Solution_0_Test(input);
