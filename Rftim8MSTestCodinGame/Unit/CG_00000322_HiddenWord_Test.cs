...
{
    [TestClass]
    public sealed class CG_00000322_HiddenWord_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000322_HiddenWord));
        ...
        {
            bool result = CG_00000322_HiddenWord.Solution_0_Test(input);
