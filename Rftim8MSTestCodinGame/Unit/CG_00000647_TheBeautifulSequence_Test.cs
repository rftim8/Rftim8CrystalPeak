...
{
    [TestClass]
    public sealed class CG_00000647_TheBeautifulSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000647_TheBeautifulSequence));
        ...
        {
            bool result = CG_00000647_TheBeautifulSequence.Solution_0_Test(input);
