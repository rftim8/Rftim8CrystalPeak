...
{
    [TestClass]
    public sealed class CG_00000263_FindTheLiars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000263_FindTheLiars));
        ...
        {
            bool result = CG_00000263_FindTheLiars.Solution_0_Test(input);
