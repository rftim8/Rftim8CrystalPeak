...
{
    [TestClass]
    public sealed class CG_00000396_LunarLockout_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000396_LunarLockout));
        ...
        {
            bool result = CG_00000396_LunarLockout.Solution_0_Test(input);
