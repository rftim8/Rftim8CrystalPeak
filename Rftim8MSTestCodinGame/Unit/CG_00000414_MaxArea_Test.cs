...
{
    [TestClass]
    public sealed class CG_00000414_MaxArea_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000414_MaxArea));
        ...
        {
            bool result = CG_00000414_MaxArea.Solution_0_Test(input);
