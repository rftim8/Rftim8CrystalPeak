...
{
    [TestClass]
    public sealed class CG_00000634_TeamBuilding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000634_TeamBuilding));
        ...
        {
            bool result = CG_00000634_TeamBuilding.Solution_0_Test(input);
