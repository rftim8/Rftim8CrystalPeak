...
{
    [TestClass]
    public sealed class CG_00000277_ForestFire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000277_ForestFire));
        ...
        {
            bool result = CG_00000277_ForestFire.Solution_0_Test(input);
