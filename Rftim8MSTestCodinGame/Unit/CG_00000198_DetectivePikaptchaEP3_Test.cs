...
{
    [TestClass]
    public sealed class CG_00000198_DetectivePikaptchaEP3_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000198_DetectivePikaptchaEP3));
        ...
        {
            bool result = CG_00000198_DetectivePikaptchaEP3.Solution_0_Test(input);
