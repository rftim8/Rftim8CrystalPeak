...
{
    [TestClass]
    public sealed class CG_00000703_TicTacToe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000703_TicTacToe));
        ...
        {
            bool result = CG_00000703_TicTacToe.Solution_0_Test(input);
