...
{
    [TestClass]
    public sealed class CG_00000336_HowHighUpDoesTheBeerGo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000336_HowHighUpDoesTheBeerGo));
        ...
        {
            bool result = CG_00000336_HowHighUpDoesTheBeerGo.Solution_0_Test(input);
