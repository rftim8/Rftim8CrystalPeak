...
{
    [TestClass]
    public sealed class CG_00000159_CookingPassion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000159_CookingPassion));
        ...
        {
            bool result = CG_00000159_CookingPassion.Solution_0_Test(input);
