...
{
    [TestClass]
    public sealed class CG_00000526_RectangularBlockSpinner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000526_RectangularBlockSpinner));
        ...
        {
            bool result = CG_00000526_RectangularBlockSpinner.Solution_0_Test(input);
