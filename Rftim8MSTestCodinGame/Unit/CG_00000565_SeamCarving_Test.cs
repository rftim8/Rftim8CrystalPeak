...
{
    [TestClass]
    public sealed class CG_00000565_SeamCarving_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000565_SeamCarving));
        ...
        {
            bool result = CG_00000565_SeamCarving.Solution_0_Test(input);
