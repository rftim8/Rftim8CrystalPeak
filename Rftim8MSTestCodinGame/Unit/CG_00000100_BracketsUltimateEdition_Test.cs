...
{
    [TestClass]
    public sealed class CG_00000100_BracketsUltimateEdition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000100_BracketsUltimateEdition));
        ...
        {
            bool result = CG_00000100_BracketsUltimateEdition.Solution_0_Test(input);
