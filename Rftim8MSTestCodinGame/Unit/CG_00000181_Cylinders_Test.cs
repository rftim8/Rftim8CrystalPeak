...
{
    [TestClass]
    public sealed class CG_00000181_Cylinders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000181_Cylinders));
        ...
        {
            bool result = CG_00000181_Cylinders.Solution_0_Test(input);
