...
{
    [TestClass]
    public sealed class CG_00000371_KnightsJam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000371_KnightsJam));
        ...
        {
            bool result = CG_00000371_KnightsJam.Solution_0_Test(input);
