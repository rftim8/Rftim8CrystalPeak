...
{
    [TestClass]
    public sealed class CG_00000258_FaxMachine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000258_FaxMachine));
        ...
        {
            bool result = CG_00000258_FaxMachine.Solution_0_Test(input);
