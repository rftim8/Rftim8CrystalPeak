...
{
    [TestClass]
    public sealed class CG_00000349_InStereo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000349_InStereo));
        ...
        {
            bool result = CG_00000349_InStereo.Solution_0_Test(input);
