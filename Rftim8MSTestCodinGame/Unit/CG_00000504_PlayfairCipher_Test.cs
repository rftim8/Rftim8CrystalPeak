...
{
    [TestClass]
    public sealed class CG_00000504_PlayfairCipher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000504_PlayfairCipher));
        ...
        {
            bool result = CG_00000504_PlayfairCipher.Solution_0_Test(input);
