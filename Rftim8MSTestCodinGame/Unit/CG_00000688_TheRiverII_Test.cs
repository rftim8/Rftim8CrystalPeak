...
{
    [TestClass]
    public sealed class CG_00000688_TheRiverII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000688_TheRiverII));
        ...
        {
            bool result = CG_00000688_TheRiverII.Solution_0_Test(input);
