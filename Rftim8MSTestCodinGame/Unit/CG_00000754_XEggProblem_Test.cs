...
{
    [TestClass]
    public sealed class CG_00000754_XEggProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000754_XEggProblem));
        ...
        {
            bool result = CG_00000754_XEggProblem.Solution_0_Test(input);
