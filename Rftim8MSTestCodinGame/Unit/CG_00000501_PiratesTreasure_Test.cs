...
{
    [TestClass]
    public sealed class CG_00000501_PiratesTreasure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000501_PiratesTreasure));
        ...
        {
            bool result = CG_00000501_PiratesTreasure.Solution_0_Test(input);
