...
{
    [TestClass]
    public sealed class CG_00000745_WhatTheBrainfuck_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000745_WhatTheBrainfuck));
        ...
        {
            bool result = CG_00000745_WhatTheBrainfuck.Solution_0_Test(input);
