...
{
    [TestClass]
    public sealed class CG_00000388_LongestCoast_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000388_LongestCoast));
        ...
        {
            bool result = CG_00000388_LongestCoast.Solution_0_Test(input);
