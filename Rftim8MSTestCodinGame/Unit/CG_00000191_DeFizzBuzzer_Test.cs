...
{
    [TestClass]
    public sealed class CG_00000191_DeFizzBuzzer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000191_DeFizzBuzzer));
        ...
        {
            bool result = CG_00000191_DeFizzBuzzer.Solution_0_Test(input);
