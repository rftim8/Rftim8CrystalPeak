...
{
    [TestClass]
    public sealed class CG_00000609_StallTilt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000609_StallTilt));
        ...
        {
            bool result = CG_00000609_StallTilt.Solution_0_Test(input);
