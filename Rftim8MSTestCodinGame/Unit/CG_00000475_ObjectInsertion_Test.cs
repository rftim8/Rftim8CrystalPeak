...
{
    [TestClass]
    public sealed class CG_00000475_ObjectInsertion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000475_ObjectInsertion));
        ...
        {
            bool result = CG_00000475_ObjectInsertion.Solution_0_Test(input);
