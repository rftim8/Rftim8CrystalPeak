...
{
    [TestClass]
    public sealed class CG_00000452_MysterySums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000452_MysterySums));
        ...
        {
            bool result = CG_00000452_MysterySums.Solution_0_Test(input);
