...
{
    [TestClass]
    public sealed class CG_00000600_SomeonesActingSus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000600_SomeonesActingSus));
        ...
        {
            bool result = CG_00000600_SomeonesActingSus.Solution_0_Test(input);
