...
{
    [TestClass]
    public sealed class CG_00000576_SimpleAIDuels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000576_SimpleAIDuels));
        ...
        {
            bool result = CG_00000576_SimpleAIDuels.Solution_0_Test(input);
