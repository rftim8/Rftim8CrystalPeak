...
{
    [TestClass]
    public sealed class CG_00000717_TXT2HTML_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000717_TXT2HTML));
        ...
        {
            bool result = CG_00000717_TXT2HTML.Solution_0_Test(input);
