...
{
    [TestClass]
    public sealed class CG_00000520_RailwayStationClock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000520_RailwayStationClock));
        ...
        {
            bool result = CG_00000520_RailwayStationClock.Solution_0_Test(input);
