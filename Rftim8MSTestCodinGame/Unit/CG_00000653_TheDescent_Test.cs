...
{
    [TestClass]
    public sealed class CG_00000653_TheDescent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000653_TheDescent));
        ...
        {
            bool result = CG_00000653_TheDescent.Solution_0_Test(input);
