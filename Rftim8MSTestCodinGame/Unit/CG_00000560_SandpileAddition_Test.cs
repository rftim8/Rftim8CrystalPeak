...
{
    [TestClass]
    public sealed class CG_00000560_SandpileAddition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000560_SandpileAddition));
        ...
        {
            bool result = CG_00000560_SandpileAddition.Solution_0_Test(input);
