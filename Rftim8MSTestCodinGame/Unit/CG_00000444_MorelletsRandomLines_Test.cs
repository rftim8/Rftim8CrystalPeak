...
{
    [TestClass]
    public sealed class CG_00000444_MorelletsRandomLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000444_MorelletsRandomLines));
        ...
        {
            bool result = CG_00000444_MorelletsRandomLines.Solution_0_Test(input);
