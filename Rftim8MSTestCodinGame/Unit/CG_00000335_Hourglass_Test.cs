...
{
    [TestClass]
    public sealed class CG_00000335_Hourglass_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000335_Hourglass));
        ...
        {
            bool result = CG_00000335_Hourglass.Solution_0_Test(input);
