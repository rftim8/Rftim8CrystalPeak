...
{
    [TestClass]
    public sealed class CG_00000438_Mirrors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000438_Mirrors));
        ...
        {
            bool result = CG_00000438_Mirrors.Solution_0_Test(input);
