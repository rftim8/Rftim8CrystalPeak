...
{
    [TestClass]
    public sealed class CG_00000418_MayanCalculation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000418_MayanCalculation));
        ...
        {
            bool result = CG_00000418_MayanCalculation.Solution_0_Test(input);
