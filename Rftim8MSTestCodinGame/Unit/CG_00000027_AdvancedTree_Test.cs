...
{
    [TestClass]
    public sealed class CG_00000027_AdvancedTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000027_AdvancedTree));
        ...
        {
            bool result = CG_00000027_AdvancedTree.Solution_0_Test(input);
