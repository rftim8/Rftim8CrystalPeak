...
{
    [TestClass]
    public sealed class CG_00000491_ParseSQLQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000491_ParseSQLQueries));
        ...
        {
            bool result = CG_00000491_ParseSQLQueries.Solution_0_Test(input);
