...
{
    [TestClass]
    public sealed class CG_00000221_DrugInteractions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000221_DrugInteractions));
        ...
        {
            bool result = CG_00000221_DrugInteractions.Solution_0_Test(input);
