...
{
    [TestClass]
    public sealed class CG_00000303_GravityCentrifugeTuning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000303_GravityCentrifugeTuning));
        ...
        {
            bool result = CG_00000303_GravityCentrifugeTuning.Solution_0_Test(input);
