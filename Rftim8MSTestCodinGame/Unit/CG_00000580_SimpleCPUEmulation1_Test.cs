...
{
    [TestClass]
    public sealed class CG_00000580_SimpleCPUEmulation1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000580_SimpleCPUEmulation1));
        ...
        {
            bool result = CG_00000580_SimpleCPUEmulation1.Solution_0_Test(input);
