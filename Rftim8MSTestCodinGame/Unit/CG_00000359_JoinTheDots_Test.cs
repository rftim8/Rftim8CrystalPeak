...
{
    [TestClass]
    public sealed class CG_00000359_JoinTheDots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000359_JoinTheDots));
        ...
        {
            bool result = CG_00000359_JoinTheDots.Solution_0_Test(input);
