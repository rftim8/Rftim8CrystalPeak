...
{
    [TestClass]
    public sealed class CG_00000597_Sokoban_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000597_Sokoban));
        ...
        {
            bool result = CG_00000597_Sokoban.Solution_0_Test(input);
