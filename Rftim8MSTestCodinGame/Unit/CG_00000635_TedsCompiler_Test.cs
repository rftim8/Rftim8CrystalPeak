...
{
    [TestClass]
    public sealed class CG_00000635_TedsCompiler_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000635_TedsCompiler));
        ...
        {
            bool result = CG_00000635_TedsCompiler.Solution_0_Test(input);
