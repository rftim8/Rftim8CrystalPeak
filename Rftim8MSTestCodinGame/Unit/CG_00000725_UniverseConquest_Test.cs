...
{
    [TestClass]
    public sealed class CG_00000725_UniverseConquest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000725_UniverseConquest));
        ...
        {
            bool result = CG_00000725_UniverseConquest.Solution_0_Test(input);
