...
{
    [TestClass]
    public sealed class CG_00000058_BagOfBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000058_BagOfBalls));
        ...
        {
            bool result = CG_00000058_BagOfBalls.Solution_0_Test(input);
