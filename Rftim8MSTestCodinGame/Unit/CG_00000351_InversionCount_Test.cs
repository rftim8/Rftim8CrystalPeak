...
{
    [TestClass]
    public sealed class CG_00000351_InversionCount_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000351_InversionCount));
        ...
        {
            bool result = CG_00000351_InversionCount.Solution_0_Test(input);
