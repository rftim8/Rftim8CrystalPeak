...
{
    [TestClass]
    public sealed class CG_00000055_Asteroids_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000055_Asteroids));
        ...
        {
            bool result = CG_00000055_Asteroids.Solution_0_Test(input);
