...
{
    [TestClass]
    public sealed class CG_00000301_Gravity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000301_Gravity));
        ...
        {
            bool result = CG_00000301_Gravity.Solution_0_Test(input);
