...
{
    [TestClass]
    public sealed class CG_00000052_AsciiGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000052_AsciiGraph));
        ...
        {
            bool result = CG_00000052_AsciiGraph.Solution_0_Test(input);
