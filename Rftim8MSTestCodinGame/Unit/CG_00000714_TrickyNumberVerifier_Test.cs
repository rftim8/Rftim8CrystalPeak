...
{
    [TestClass]
    public sealed class CG_00000714_TrickyNumberVerifier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000714_TrickyNumberVerifier));
        ...
        {
            bool result = CG_00000714_TrickyNumberVerifier.Solution_0_Test(input);
