...
{
    [TestClass]
    public sealed class CG_00000316_HeartOfTheCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000316_HeartOfTheCity));
        ...
        {
            bool result = CG_00000316_HeartOfTheCity.Solution_0_Test(input);
