...
{
    [TestClass]
    public sealed class CG_00000482_OrderOfOopserations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000482_OrderOfOopserations));
        ...
        {
            bool result = CG_00000482_OrderOfOopserations.Solution_0_Test(input);
