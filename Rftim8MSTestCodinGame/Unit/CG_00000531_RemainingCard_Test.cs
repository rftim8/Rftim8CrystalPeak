...
{
    [TestClass]
    public sealed class CG_00000531_RemainingCard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000531_RemainingCard));
        ...
        {
            bool result = CG_00000531_RemainingCard.Solution_0_Test(input);
