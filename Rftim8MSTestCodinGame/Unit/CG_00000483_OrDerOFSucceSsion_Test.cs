...
{
    [TestClass]
    public sealed class CG_00000483_OrDerOFSucceSsion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000483_OrDerOFSucceSsion));
        ...
        {
            bool result = CG_00000483_OrDerOFSucceSsion.Solution_0_Test(input);
