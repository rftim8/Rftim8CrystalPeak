...
{
    [TestClass]
    public sealed class CG_00000145_CodeBreakerPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000145_CodeBreakerPuzzle));
        ...
        {
            bool result = CG_00000145_CodeBreakerPuzzle.Solution_0_Test(input);
