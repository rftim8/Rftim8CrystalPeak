...
{
    [TestClass]
    public sealed class CG_00000296_GoldbachsConjecture_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000296_GoldbachsConjecture));
        ...
        {
            bool result = CG_00000296_GoldbachsConjecture.Solution_0_Test(input);
