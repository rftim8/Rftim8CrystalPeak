...
{
    [TestClass]
    public sealed class CG_00000468_NumberDerivation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000468_NumberDerivation));
        ...
        {
            bool result = CG_00000468_NumberDerivation.Solution_0_Test(input);
