...
{
    [TestClass]
    public sealed class CG_00000275_FoldingANote_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000275_FoldingANote));
        ...
        {
            bool result = CG_00000275_FoldingANote.Solution_0_Test(input);
