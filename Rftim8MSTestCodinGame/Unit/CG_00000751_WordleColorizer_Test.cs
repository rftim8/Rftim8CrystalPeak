...
{
    [TestClass]
    public sealed class CG_00000751_WordleColorizer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000751_WordleColorizer));
        ...
        {
            bool result = CG_00000751_WordleColorizer.Solution_0_Test(input);
