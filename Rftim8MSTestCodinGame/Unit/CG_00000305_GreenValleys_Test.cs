...
{
    [TestClass]
    public sealed class CG_00000305_GreenValleys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000305_GreenValleys));
        ...
        {
            bool result = CG_00000305_GreenValleys.Solution_0_Test(input);
