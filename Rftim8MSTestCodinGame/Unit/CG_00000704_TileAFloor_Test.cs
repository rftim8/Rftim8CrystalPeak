...
{
    [TestClass]
    public sealed class CG_00000704_TileAFloor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000704_TileAFloor));
        ...
        {
            bool result = CG_00000704_TileAFloor.Solution_0_Test(input);
