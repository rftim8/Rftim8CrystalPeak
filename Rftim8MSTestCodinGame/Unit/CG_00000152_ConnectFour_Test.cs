...
{
    [TestClass]
    public sealed class CG_00000152_ConnectFour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000152_ConnectFour));
        ...
        {
            bool result = CG_00000152_ConnectFour.Solution_0_Test(input);
