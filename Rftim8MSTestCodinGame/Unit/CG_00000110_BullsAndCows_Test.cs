...
{
    [TestClass]
    public sealed class CG_00000110_BullsAndCows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000110_BullsAndCows));
        ...
        {
            bool result = CG_00000110_BullsAndCows.Solution_0_Test(input);
