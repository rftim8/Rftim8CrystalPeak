...
{
    [TestClass]
    public sealed class CG_00000706_TilingBySquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000706_TilingBySquares));
        ...
        {
            bool result = CG_00000706_TilingBySquares.Solution_0_Test(input);
