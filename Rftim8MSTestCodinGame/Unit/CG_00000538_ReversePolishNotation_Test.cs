...
{
    [TestClass]
    public sealed class CG_00000538_ReversePolishNotation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000538_ReversePolishNotation));
        ...
        {
            bool result = CG_00000538_ReversePolishNotation.Solution_0_Test(input);
