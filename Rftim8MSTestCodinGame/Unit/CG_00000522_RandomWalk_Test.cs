...
{
    [TestClass]
    public sealed class CG_00000522_RandomWalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000522_RandomWalk));
        ...
        {
            bool result = CG_00000522_RandomWalk.Solution_0_Test(input);
