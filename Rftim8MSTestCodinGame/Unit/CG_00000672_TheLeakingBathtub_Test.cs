...
{
    [TestClass]
    public sealed class CG_00000672_TheLeakingBathtub_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000672_TheLeakingBathtub));
        ...
        {
            bool result = CG_00000672_TheLeakingBathtub.Solution_0_Test(input);
