...
{
    [TestClass]
    public sealed class CG_00000313_HappyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000313_HappyNumbers));
        ...
        {
            bool result = CG_00000313_HappyNumbers.Solution_0_Test(input);
