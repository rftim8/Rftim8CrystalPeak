...
{
    [TestClass]
    public sealed class CG_00000637_Temperatures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000637_Temperatures));
        ...
        {
            bool result = CG_00000637_Temperatures.Solution_0_Test(input);
