...
{
    [TestClass]
    public sealed class CG_00000588_SlidingMazePuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000588_SlidingMazePuzzle));
        ...
        {
            bool result = CG_00000588_SlidingMazePuzzle.Solution_0_Test(input);
