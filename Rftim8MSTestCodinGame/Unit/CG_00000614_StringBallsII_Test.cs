...
{
    [TestClass]
    public sealed class CG_00000614_StringBallsII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000614_StringBallsII));
        ...
        {
            bool result = CG_00000614_StringBallsII.Solution_0_Test(input);
