...
{
    [TestClass]
    public sealed class CG_00000363_JumpPointSearchRuntime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000363_JumpPointSearchRuntime));
        ...
        {
            bool result = CG_00000363_JumpPointSearchRuntime.Solution_0_Test(input);
