...
{
    [TestClass]
    public sealed class CG_00000533_RetainingWater_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000533_RetainingWater));
        ...
        {
            bool result = CG_00000533_RetainingWater.Solution_0_Test(input);
