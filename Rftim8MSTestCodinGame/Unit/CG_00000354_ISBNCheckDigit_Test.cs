...
{
    [TestClass]
    public sealed class CG_00000354_ISBNCheckDigit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000354_ISBNCheckDigit));
        ...
        {
            bool result = CG_00000354_ISBNCheckDigit.Solution_0_Test(input);
