...
{
    [TestClass]
    public sealed class CG_00000546_RocketEngines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000546_RocketEngines));
        ...
        {
            bool result = CG_00000546_RocketEngines.Solution_0_Test(input);
