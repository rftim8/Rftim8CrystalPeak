...
{
    [TestClass]
    public sealed class CG_00000469_NumberFormatting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000469_NumberFormatting));
        ...
        {
            bool result = CG_00000469_NumberFormatting.Solution_0_Test(input);
