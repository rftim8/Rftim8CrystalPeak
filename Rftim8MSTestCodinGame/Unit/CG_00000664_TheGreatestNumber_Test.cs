...
{
    [TestClass]
    public sealed class CG_00000664_TheGreatestNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000664_TheGreatestNumber));
        ...
        {
            bool result = CG_00000664_TheGreatestNumber.Solution_0_Test(input);
