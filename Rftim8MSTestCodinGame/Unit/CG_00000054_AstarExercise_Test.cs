...
{
    [TestClass]
    public sealed class CG_00000054_AstarExercise_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000054_AstarExercise));
        ...
        {
            bool result = CG_00000054_AstarExercise.Solution_0_Test(input);
