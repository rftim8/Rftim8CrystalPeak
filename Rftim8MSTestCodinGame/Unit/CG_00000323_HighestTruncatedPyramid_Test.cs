...
{
    [TestClass]
    public sealed class CG_00000323_HighestTruncatedPyramid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000323_HighestTruncatedPyramid));
        ...
        {
            bool result = CG_00000323_HighestTruncatedPyramid.Solution_0_Test(input);
