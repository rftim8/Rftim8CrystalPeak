...
{
    [TestClass]
    public sealed class CG_00000552_RollerCoaster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000552_RollerCoaster));
        ...
        {
            bool result = CG_00000552_RollerCoaster.Solution_0_Test(input);
