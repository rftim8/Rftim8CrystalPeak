...
{
    [TestClass]
    public sealed class CG_00000405_MarkovAnts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000405_MarkovAnts));
        ...
        {
            bool result = CG_00000405_MarkovAnts.Solution_0_Test(input);
