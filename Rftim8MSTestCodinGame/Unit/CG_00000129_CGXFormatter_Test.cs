...
{
    [TestClass]
    public sealed class CG_00000129_CGXFormatter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000129_CGXFormatter));
        ...
        {
            bool result = CG_00000129_CGXFormatter.Solution_0_Test(input);
