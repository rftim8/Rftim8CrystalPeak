...
{
    [TestClass]
    public sealed class CG_00000102_BreakingApart_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000102_BreakingApart));
        ...
        {
            bool result = CG_00000102_BreakingApart.Solution_0_Test(input);
