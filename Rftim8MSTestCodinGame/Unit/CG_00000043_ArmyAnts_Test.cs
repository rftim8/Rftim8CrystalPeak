...
{
    [TestClass]
    public sealed class CG_00000043_ArmyAnts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000043_ArmyAnts));
        ...
        {
            bool result = CG_00000043_ArmyAnts.Solution_0_Test(input);
