...
{
    [TestClass]
    public sealed class CG_00000334_Hotel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000334_Hotel));
        ...
        {
            bool result = CG_00000334_Hotel.Solution_0_Test(input);
