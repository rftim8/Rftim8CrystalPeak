...
{
    [TestClass]
    public sealed class CG_00000139_ChessMovesOnFENPosition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000139_ChessMovesOnFENPosition));
        ...
        {
            bool result = CG_00000139_ChessMovesOnFENPosition.Solution_0_Test(input);
