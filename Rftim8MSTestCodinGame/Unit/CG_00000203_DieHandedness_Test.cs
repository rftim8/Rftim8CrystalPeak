...
{
    [TestClass]
    public sealed class CG_00000203_DieHandedness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000203_DieHandedness));
        ...
        {
            bool result = CG_00000203_DieHandedness.Solution_0_Test(input);
