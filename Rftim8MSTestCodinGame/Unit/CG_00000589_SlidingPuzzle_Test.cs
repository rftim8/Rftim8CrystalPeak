...
{
    [TestClass]
    public sealed class CG_00000589_SlidingPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000589_SlidingPuzzle));
        ...
        {
            bool result = CG_00000589_SlidingPuzzle.Solution_0_Test(input);
