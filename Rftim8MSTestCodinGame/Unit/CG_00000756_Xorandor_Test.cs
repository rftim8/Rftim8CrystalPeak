...
{
    [TestClass]
    public sealed class CG_00000756_Xorandor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000756_Xorandor));
        ...
        {
            bool result = CG_00000756_Xorandor.Solution_0_Test(input);
