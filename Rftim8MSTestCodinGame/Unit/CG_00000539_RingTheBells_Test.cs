...
{
    [TestClass]
    public sealed class CG_00000539_RingTheBells_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000539_RingTheBells));
        ...
        {
            bool result = CG_00000539_RingTheBells.Solution_0_Test(input);
