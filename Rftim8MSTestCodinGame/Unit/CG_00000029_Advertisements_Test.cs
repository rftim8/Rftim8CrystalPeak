...
{
    [TestClass]
    public sealed class CG_00000029_Advertisements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000029_Advertisements));
        ...
        {
            bool result = CG_00000029_Advertisements.Solution_0_Test(input);
