...
{
    [TestClass]
    public sealed class CG_00000072_BinaryImage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000072_BinaryImage));
        ...
        {
            bool result = CG_00000072_BinaryImage.Solution_0_Test(input);
