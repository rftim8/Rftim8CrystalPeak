...
{
    [TestClass]
    public sealed class CG_00000057_AutoPickup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000057_AutoPickup));
        ...
        {
            bool result = CG_00000057_AutoPickup.Solution_0_Test(input);
