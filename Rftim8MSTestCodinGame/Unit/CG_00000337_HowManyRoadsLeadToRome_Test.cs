...
{
    [TestClass]
    public sealed class CG_00000337_HowManyRoadsLeadToRome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000337_HowManyRoadsLeadToRome));
        ...
        {
            bool result = CG_00000337_HowManyRoadsLeadToRome.Solution_0_Test(input);
