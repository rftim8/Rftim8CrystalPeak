...
{
    [TestClass]
    public sealed class CG_00000668_TheHolyGrail_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000668_TheHolyGrail));
        ...
        {
            bool result = CG_00000668_TheHolyGrail.Solution_0_Test(input);
