...
{
    [TestClass]
    public sealed class CG_00000586_Skylines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000586_Skylines));
        ...
        {
            bool result = CG_00000586_Skylines.Solution_0_Test(input);
