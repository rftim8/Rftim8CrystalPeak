...
{
    [TestClass]
    public sealed class CG_00000184_DDCGMapper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000184_DDCGMapper));
        ...
        {
            bool result = CG_00000184_DDCGMapper.Solution_0_Test(input);
