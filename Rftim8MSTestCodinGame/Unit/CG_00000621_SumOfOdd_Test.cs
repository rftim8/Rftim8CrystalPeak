...
{
    [TestClass]
    public sealed class CG_00000621_SumOfOdd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000621_SumOfOdd));
        ...
        {
            bool result = CG_00000621_SumOfOdd.Solution_0_Test(input);
