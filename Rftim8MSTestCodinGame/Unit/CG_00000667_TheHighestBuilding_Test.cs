...
{
    [TestClass]
    public sealed class CG_00000667_TheHighestBuilding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000667_TheHighestBuilding));
        ...
        {
            bool result = CG_00000667_TheHighestBuilding.Solution_0_Test(input);
