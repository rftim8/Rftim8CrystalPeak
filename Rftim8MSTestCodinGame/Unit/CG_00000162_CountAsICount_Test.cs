...
{
    [TestClass]
    public sealed class CG_00000162_CountAsICount_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000162_CountAsICount));
        ...
        {
            bool result = CG_00000162_CountAsICount.Solution_0_Test(input);
