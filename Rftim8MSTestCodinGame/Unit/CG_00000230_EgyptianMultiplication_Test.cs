...
{
    [TestClass]
    public sealed class CG_00000230_EgyptianMultiplication_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000230_EgyptianMultiplication));
        ...
        {
            bool result = CG_00000230_EgyptianMultiplication.Solution_0_Test(input);
