...
{
    [TestClass]
    public sealed class CG_00000633_TargetFiring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000633_TargetFiring));
        ...
        {
            bool result = CG_00000633_TargetFiring.Solution_0_Test(input);
