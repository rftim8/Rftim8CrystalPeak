...
{
    [TestClass]
    public sealed class CG_00000011_24Game_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000011_24Game));
        ...
        {
            bool result = CG_00000011_24Game.Solution_0_Test(input);
