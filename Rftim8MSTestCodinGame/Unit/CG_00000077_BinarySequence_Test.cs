...
{
    [TestClass]
    public sealed class CG_00000077_BinarySequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000077_BinarySequence));
        ...
        {
            bool result = CG_00000077_BinarySequence.Solution_0_Test(input);
