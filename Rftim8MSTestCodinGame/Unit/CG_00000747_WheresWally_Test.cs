...
{
    [TestClass]
    public sealed class CG_00000747_WheresWally_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000747_WheresWally));
        ...
        {
            bool result = CG_00000747_WheresWally.Solution_0_Test(input);
