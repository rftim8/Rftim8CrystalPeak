...
{
    [TestClass]
    public sealed class CG_00000441_MondayTuesdayHappyDays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000441_MondayTuesdayHappyDays));
        ...
        {
            bool result = CG_00000441_MondayTuesdayHappyDays.Solution_0_Test(input);
