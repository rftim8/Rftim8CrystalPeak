...
{
    [TestClass]
    public sealed class CG_00000226_DungeonsAndMaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000226_DungeonsAndMaps));
        ...
        {
            bool result = CG_00000226_DungeonsAndMaps.Solution_0_Test(input);
