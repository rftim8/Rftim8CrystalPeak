...
{
    [TestClass]
    public sealed class CG_00000521_RandomTimeTravel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000521_RandomTimeTravel));
        ...
        {
            bool result = CG_00000521_RandomTimeTravel.Solution_0_Test(input);
