...
{
    [TestClass]
    public sealed class CG_00000090_BoardingPassesReady_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000090_BoardingPassesReady));
        ...
        {
            bool result = CG_00000090_BoardingPassesReady.Solution_0_Test(input);
