...
{
    [TestClass]
    public sealed class CG_00000733_Vortex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000733_Vortex));
        ...
        {
            bool result = CG_00000733_Vortex.Solution_0_Test(input);
