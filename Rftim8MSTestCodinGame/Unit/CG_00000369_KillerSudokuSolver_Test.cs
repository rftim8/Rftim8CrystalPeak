...
{
    [TestClass]
    public sealed class CG_00000369_KillerSudokuSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000369_KillerSudokuSolver));
        ...
        {
            bool result = CG_00000369_KillerSudokuSolver.Solution_0_Test(input);
