...
{
    [TestClass]
    public sealed class CG_00000128_CGsNextTopModel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000128_CGsNextTopModel));
        ...
        {
            bool result = CG_00000128_CGsNextTopModel.Solution_0_Test(input);
