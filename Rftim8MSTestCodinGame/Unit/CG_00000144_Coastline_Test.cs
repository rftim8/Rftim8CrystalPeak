...
{
    [TestClass]
    public sealed class CG_00000144_Coastline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000144_Coastline));
        ...
        {
            bool result = CG_00000144_Coastline.Solution_0_Test(input);
