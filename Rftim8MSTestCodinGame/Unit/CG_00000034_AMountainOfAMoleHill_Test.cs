...
{
    [TestClass]
    public sealed class CG_00000034_AMountainOfAMoleHill_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000034_AMountainOfAMoleHill));
        ...
        {
            bool result = CG_00000034_AMountainOfAMoleHill.Solution_0_Test(input);
