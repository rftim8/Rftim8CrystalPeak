...
{
    [TestClass]
    public sealed class CG_00000039_Annihilation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000039_Annihilation));
        ...
        {
            bool result = CG_00000039_Annihilation.Solution_0_Test(input);
