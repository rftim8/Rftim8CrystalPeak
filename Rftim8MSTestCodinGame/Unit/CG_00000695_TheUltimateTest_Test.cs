...
{
    [TestClass]
    public sealed class CG_00000695_TheUltimateTest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000695_TheUltimateTest));
        ...
        {
            bool result = CG_00000695_TheUltimateTest.Solution_0_Test(input);
