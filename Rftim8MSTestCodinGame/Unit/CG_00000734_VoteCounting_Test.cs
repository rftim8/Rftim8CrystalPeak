...
{
    [TestClass]
    public sealed class CG_00000734_VoteCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000734_VoteCounting));
        ...
        {
            bool result = CG_00000734_VoteCounting.Solution_0_Test(input);
