...
{
    [TestClass]
    public sealed class CG_00000330_HornSATSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000330_HornSATSolver));
        ...
        {
            bool result = CG_00000330_HornSATSolver.Solution_0_Test(input);
