...
{
    [TestClass]
    public sealed class CG_00000135_ChebyshevOrbiting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000135_ChebyshevOrbiting));
        ...
        {
            bool result = CG_00000135_ChebyshevOrbiting.Solution_0_Test(input);
