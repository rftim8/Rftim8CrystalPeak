...
{
    [TestClass]
    public sealed class CG_00000529_RegularPolygons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000529_RegularPolygons));
        ...
        {
            bool result = CG_00000529_RegularPolygons.Solution_0_Test(input);
