...
{
    [TestClass]
    public sealed class CG_00000572_ShikakuSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000572_ShikakuSolver));
        ...
        {
            bool result = CG_00000572_ShikakuSolver.Solution_0_Test(input);
