...
{
    [TestClass]
    public sealed class CG_00000726_ValidBracketsInCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000726_ValidBracketsInCode));
        ...
        {
            bool result = CG_00000726_ValidBracketsInCode.Solution_0_Test(input);
