...
{
    [TestClass]
    public sealed class CG_00000567_SelfdrivingCarTesting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000567_SelfdrivingCarTesting));
        ...
        {
            bool result = CG_00000567_SelfdrivingCarTesting.Solution_0_Test(input);
