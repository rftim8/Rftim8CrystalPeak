...
{
    [TestClass]
    public sealed class CG_00000553_RomanSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000553_RomanSorting));
        ...
        {
            bool result = CG_00000553_RomanSorting.Solution_0_Test(input);
