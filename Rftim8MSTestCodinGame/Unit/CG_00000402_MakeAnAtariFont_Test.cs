...
{
    [TestClass]
    public sealed class CG_00000402_MakeAnAtariFont_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000402_MakeAnAtariFont));
        ...
        {
            bool result = CG_00000402_MakeAnAtariFont.Solution_0_Test(input);
