...
{
    [TestClass]
    public sealed class CG_00000031_AllOperationsAreEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000031_AllOperationsAreEqual));
        ...
        {
            bool result = CG_00000031_AllOperationsAreEqual.Solution_0_Test(input);
