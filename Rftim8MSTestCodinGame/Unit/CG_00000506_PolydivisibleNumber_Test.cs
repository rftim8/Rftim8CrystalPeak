...
{
    [TestClass]
    public sealed class CG_00000506_PolydivisibleNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000506_PolydivisibleNumber));
        ...
        {
            bool result = CG_00000506_PolydivisibleNumber.Solution_0_Test(input);
