...
{
    [TestClass]
    public sealed class CG_00000192_DepotOrganization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000192_DepotOrganization));
        ...
        {
            bool result = CG_00000192_DepotOrganization.Solution_0_Test(input);
