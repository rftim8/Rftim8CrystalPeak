...
{
    [TestClass]
    public sealed class CG_00000105_BrickInTheWall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000105_BrickInTheWall));
        ...
        {
            bool result = CG_00000105_BrickInTheWall.Solution_0_Test(input);
