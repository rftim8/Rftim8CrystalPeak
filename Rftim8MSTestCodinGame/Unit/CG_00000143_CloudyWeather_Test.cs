...
{
    [TestClass]
    public sealed class CG_00000143_CloudyWeather_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000143_CloudyWeather));
        ...
        {
            bool result = CG_00000143_CloudyWeather.Solution_0_Test(input);
