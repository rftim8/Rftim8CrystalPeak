...
{
    [TestClass]
    public sealed class CG_00000071_BinaryExtension_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000071_BinaryExtension));
        ...
        {
            bool result = CG_00000071_BinaryExtension.Solution_0_Test(input);
