...
{
    [TestClass]
    public sealed class CG_00000671_TheLabyrinth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000671_TheLabyrinth));
        ...
        {
            bool result = CG_00000671_TheLabyrinth.Solution_0_Test(input);
