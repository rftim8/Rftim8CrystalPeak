...
{
    [TestClass]
    public sealed class CG_00000387_LogicGates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000387_LogicGates));
        ...
        {
            bool result = CG_00000387_LogicGates.Solution_0_Test(input);
