...
{
    [TestClass]
    public sealed class CG_00000606_SquaresOrder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000606_SquaresOrder));
        ...
        {
            bool result = CG_00000606_SquaresOrder.Solution_0_Test(input);
