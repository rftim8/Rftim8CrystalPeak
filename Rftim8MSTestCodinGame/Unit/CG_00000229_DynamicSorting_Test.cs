...
{
    [TestClass]
    public sealed class CG_00000229_DynamicSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000229_DynamicSorting));
        ...
        {
            bool result = CG_00000229_DynamicSorting.Solution_0_Test(input);
