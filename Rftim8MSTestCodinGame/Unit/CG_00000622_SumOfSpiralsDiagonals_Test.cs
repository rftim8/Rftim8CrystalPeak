...
{
    [TestClass]
    public sealed class CG_00000622_SumOfSpiralsDiagonals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000622_SumOfSpiralsDiagonals));
        ...
        {
            bool result = CG_00000622_SumOfSpiralsDiagonals.Solution_0_Test(input);
