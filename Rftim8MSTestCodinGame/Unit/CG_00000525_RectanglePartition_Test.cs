...
{
    [TestClass]
    public sealed class CG_00000525_RectanglePartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000525_RectanglePartition));
        ...
        {
            bool result = CG_00000525_RectanglePartition.Solution_0_Test(input);
