...
{
    [TestClass]
    public sealed class CG_00000374_LargestBinaryRectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000374_LargestBinaryRectangle));
        ...
        {
            bool result = CG_00000374_LargestBinaryRectangle.Solution_0_Test(input);
