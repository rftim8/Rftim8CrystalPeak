...
{
    [TestClass]
    public sealed class CG_00000289_GameOfLife_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000289_GameOfLife));
        ...
        {
            bool result = CG_00000289_GameOfLife.Solution_0_Test(input);
