...
{
    [TestClass]
    public sealed class CG_00000160_CooperativeMateWithRook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000160_CooperativeMateWithRook));
        ...
        {
            bool result = CG_00000160_CooperativeMateWithRook.Solution_0_Test(input);
