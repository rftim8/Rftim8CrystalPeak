...
{
    [TestClass]
    public sealed class CG_00000017_3DPrinter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000017_3DPrinter));
        ...
        {
            bool result = CG_00000017_3DPrinter.Solution_0_Test(input);
