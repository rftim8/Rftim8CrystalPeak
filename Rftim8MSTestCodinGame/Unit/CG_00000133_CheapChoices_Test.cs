...
{
    [TestClass]
    public sealed class CG_00000133_CheapChoices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000133_CheapChoices));
        ...
        {
            bool result = CG_00000133_CheapChoices.Solution_0_Test(input);
