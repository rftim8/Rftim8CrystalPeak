...
{
    [TestClass]
    public sealed class CG_00000551_RodCuttingProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000551_RodCuttingProblem));
        ...
        {
            bool result = CG_00000551_RodCuttingProblem.Solution_0_Test(input);
