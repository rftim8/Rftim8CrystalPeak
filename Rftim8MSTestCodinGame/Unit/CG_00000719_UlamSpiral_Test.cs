...
{
    [TestClass]
    public sealed class CG_00000719_UlamSpiral_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000719_UlamSpiral));
        ...
        {
            bool result = CG_00000719_UlamSpiral.Solution_0_Test(input);
