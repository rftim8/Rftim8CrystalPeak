...
{
    [TestClass]
    public sealed class CG_00000205_DigitSumSuccessor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000205_DigitSumSuccessor));
        ...
        {
            bool result = CG_00000205_DigitSumSuccessor.Solution_0_Test(input);
