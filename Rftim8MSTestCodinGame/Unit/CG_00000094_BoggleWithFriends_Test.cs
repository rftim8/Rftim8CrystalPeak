...
{
    [TestClass]
    public sealed class CG_00000094_BoggleWithFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000094_BoggleWithFriends));
        ...
        {
            bool result = CG_00000094_BoggleWithFriends.Solution_0_Test(input);
