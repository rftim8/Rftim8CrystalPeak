...
{
    [TestClass]
    public sealed class CG_00000643_TextFormatting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000643_TextFormatting));
        ...
        {
            bool result = CG_00000643_TextFormatting.Solution_0_Test(input);
