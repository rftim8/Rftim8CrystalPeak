...
{
    [TestClass]
    public sealed class CG_00000480_OneForHisNobs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000480_OneForHisNobs));
        ...
        {
            bool result = CG_00000480_OneForHisNobs.Solution_0_Test(input);
