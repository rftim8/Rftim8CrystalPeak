...
{
    [TestClass]
    public sealed class CG_00000457_NeighborSumGrids_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000457_NeighborSumGrids));
        ...
        {
            bool result = CG_00000457_NeighborSumGrids.Solution_0_Test(input);
