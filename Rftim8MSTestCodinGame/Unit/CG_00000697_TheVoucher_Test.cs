...
{
    [TestClass]
    public sealed class CG_00000697_TheVoucher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000697_TheVoucher));
        ...
        {
            bool result = CG_00000697_TheVoucher.Solution_0_Test(input);
