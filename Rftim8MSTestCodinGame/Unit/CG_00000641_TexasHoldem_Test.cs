...
{
    [TestClass]
    public sealed class CG_00000641_TexasHoldem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000641_TexasHoldem));
        ...
        {
            bool result = CG_00000641_TexasHoldem.Solution_0_Test(input);
