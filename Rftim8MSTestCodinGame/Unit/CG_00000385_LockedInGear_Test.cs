...
{
    [TestClass]
    public sealed class CG_00000385_LockedInGear_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000385_LockedInGear));
        ...
        {
            bool result = CG_00000385_LockedInGear.Solution_0_Test(input);
