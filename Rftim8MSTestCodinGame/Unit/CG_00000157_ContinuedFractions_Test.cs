...
{
    [TestClass]
    public sealed class CG_00000157_ContinuedFractions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000157_ContinuedFractions));
        ...
        {
            bool result = CG_00000157_ContinuedFractions.Solution_0_Test(input);
