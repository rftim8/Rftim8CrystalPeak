...
{
    [TestClass]
    public sealed class CG_00000078_BinaryTreeVisual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000078_BinaryTreeVisual));
        ...
        {
            bool result = CG_00000078_BinaryTreeVisual.Solution_0_Test(input);
