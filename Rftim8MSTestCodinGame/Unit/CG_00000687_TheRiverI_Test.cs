...
{
    [TestClass]
    public sealed class CG_00000687_TheRiverI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000687_TheRiverI));
        ...
        {
            bool result = CG_00000687_TheRiverI.Solution_0_Test(input);
