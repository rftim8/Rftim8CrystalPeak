...
{
    [TestClass]
    public sealed class CG_00000003_10PinBowlingScores_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000003_10PinBowlingScores));
        ...
        {
            bool result = CG_00000003_10PinBowlingScores.Solution_0_Test(input);
