...
{
    [TestClass]
    public sealed class CG_00000465_NPearlsNecklace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000465_NPearlsNecklace));
        ...
        {
            bool result = CG_00000465_NPearlsNecklace.Solution_0_Test(input);
