...
{
    [TestClass]
    public sealed class CG_00000155_ConstrainedLatinSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000155_ConstrainedLatinSquares));
        ...
        {
            bool result = CG_00000155_ConstrainedLatinSquares.Solution_0_Test(input);
