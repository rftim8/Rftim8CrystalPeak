...
{
    [TestClass]
    public sealed class CG_00000254_FactorialVsExponential_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000254_FactorialVsExponential));
        ...
        {
            bool result = CG_00000254_FactorialVsExponential.Solution_0_Test(input);
