...
{
    [TestClass]
    public sealed class CG_00000662_TheGrandFestivalI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000662_TheGrandFestivalI));
        ...
        {
            bool result = CG_00000662_TheGrandFestivalI.Solution_0_Test(input);
