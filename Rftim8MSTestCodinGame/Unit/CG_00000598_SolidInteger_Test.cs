...
{
    [TestClass]
    public sealed class CG_00000598_SolidInteger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000598_SolidInteger));
        ...
        {
            bool result = CG_00000598_SolidInteger.Solution_0_Test(input);
