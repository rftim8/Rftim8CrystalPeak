...
{
    [TestClass]
    public sealed class CG_00000390_LongestPalindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000390_LongestPalindrome));
        ...
        {
            bool result = CG_00000390_LongestPalindrome.Solution_0_Test(input);
