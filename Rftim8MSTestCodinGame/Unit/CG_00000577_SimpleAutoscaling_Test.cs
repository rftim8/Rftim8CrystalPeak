...
{
    [TestClass]
    public sealed class CG_00000577_SimpleAutoscaling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000577_SimpleAutoscaling));
        ...
        {
            bool result = CG_00000577_SimpleAutoscaling.Solution_0_Test(input);
