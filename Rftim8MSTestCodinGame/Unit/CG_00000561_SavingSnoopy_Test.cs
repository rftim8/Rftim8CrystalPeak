...
{
    [TestClass]
    public sealed class CG_00000561_SavingSnoopy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000561_SavingSnoopy));
        ...
        {
            bool result = CG_00000561_SavingSnoopy.Solution_0_Test(input);
