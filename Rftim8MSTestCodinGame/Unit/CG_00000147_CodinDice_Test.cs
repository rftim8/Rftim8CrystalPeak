...
{
    [TestClass]
    public sealed class CG_00000147_CodinDice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000147_CodinDice));
        ...
        {
            bool result = CG_00000147_CodinDice.Solution_0_Test(input);
