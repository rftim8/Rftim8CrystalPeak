...
{
    [TestClass]
    public sealed class CG_00000046_ASCIIARTGlassStacking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000046_ASCIIARTGlassStacking));
        ...
        {
            bool result = CG_00000046_ASCIIARTGlassStacking.Solution_0_Test(input);
