...
{
    [TestClass]
    public sealed class CG_00000237_EncounterSurface_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000237_EncounterSurface));
        ...
        {
            bool result = CG_00000237_EncounterSurface.Solution_0_Test(input);
