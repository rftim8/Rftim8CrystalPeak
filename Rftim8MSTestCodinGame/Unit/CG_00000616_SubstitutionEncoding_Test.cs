...
{
    [TestClass]
    public sealed class CG_00000616_SubstitutionEncoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000616_SubstitutionEncoding));
        ...
        {
            bool result = CG_00000616_SubstitutionEncoding.Solution_0_Test(input);
