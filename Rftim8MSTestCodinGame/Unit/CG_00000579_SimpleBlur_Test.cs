...
{
    [TestClass]
    public sealed class CG_00000579_SimpleBlur_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000579_SimpleBlur));
        ...
        {
            bool result = CG_00000579_SimpleBlur.Solution_0_Test(input);
