...
{
    [TestClass]
    public sealed class CG_00000137_ChessBoardAnalyzer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000137_ChessBoardAnalyzer));
        ...
        {
            bool result = CG_00000137_ChessBoardAnalyzer.Solution_0_Test(input);
