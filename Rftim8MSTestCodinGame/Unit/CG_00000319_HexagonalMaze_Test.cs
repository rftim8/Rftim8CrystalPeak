...
{
    [TestClass]
    public sealed class CG_00000319_HexagonalMaze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000319_HexagonalMaze));
        ...
        {
            bool result = CG_00000319_HexagonalMaze.Solution_0_Test(input);
