...
{
    [TestClass]
    public sealed class CG_00000064_BasicDecisionTree1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000064_BasicDecisionTree1));
        ...
        {
            bool result = CG_00000064_BasicDecisionTree1.Solution_0_Test(input);
