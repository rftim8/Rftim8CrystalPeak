...
{
    [TestClass]
    public sealed class CG_00000617_SudokuSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000617_SudokuSolver));
        ...
        {
            bool result = CG_00000617_SudokuSolver.Solution_0_Test(input);
