...
{
    [TestClass]
    public sealed class CG_00000350_Interstellar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000350_Interstellar));
        ...
        {
            bool result = CG_00000350_Interstellar.Solution_0_Test(input);
