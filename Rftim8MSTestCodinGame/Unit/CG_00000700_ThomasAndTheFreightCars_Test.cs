...
{
    [TestClass]
    public sealed class CG_00000700_ThomasAndTheFreightCars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000700_ThomasAndTheFreightCars));
        ...
        {
            bool result = CG_00000700_ThomasAndTheFreightCars.Solution_0_Test(input);
