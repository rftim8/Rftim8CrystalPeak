...
{
    [TestClass]
    public sealed class CG_00000678_TheMichelangeloCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000678_TheMichelangeloCode));
        ...
        {
            bool result = CG_00000678_TheMichelangeloCode.Solution_0_Test(input);
