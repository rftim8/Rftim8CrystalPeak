...
{
    [TestClass]
    public sealed class CG_00000592_SmoothFactory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000592_SmoothFactory));
        ...
        {
            bool result = CG_00000592_SmoothFactory.Solution_0_Test(input);
