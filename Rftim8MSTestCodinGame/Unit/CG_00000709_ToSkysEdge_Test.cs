...
{
    [TestClass]
    public sealed class CG_00000709_ToSkysEdge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000709_ToSkysEdge));
        ...
        {
            bool result = CG_00000709_ToSkysEdge.Solution_0_Test(input);
