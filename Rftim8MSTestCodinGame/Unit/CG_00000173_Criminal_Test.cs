...
{
    [TestClass]
    public sealed class CG_00000173_Criminal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000173_Criminal));
        ...
        {
            bool result = CG_00000173_Criminal.Solution_0_Test(input);
