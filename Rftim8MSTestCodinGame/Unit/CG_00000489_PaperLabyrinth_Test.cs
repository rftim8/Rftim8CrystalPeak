...
{
    [TestClass]
    public sealed class CG_00000489_PaperLabyrinth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000489_PaperLabyrinth));
        ...
        {
            bool result = CG_00000489_PaperLabyrinth.Solution_0_Test(input);
