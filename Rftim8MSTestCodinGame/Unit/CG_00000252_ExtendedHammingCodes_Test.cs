...
{
    [TestClass]
    public sealed class CG_00000252_ExtendedHammingCodes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000252_ExtendedHammingCodes));
        ...
        {
            bool result = CG_00000252_ExtendedHammingCodes.Solution_0_Test(input);
