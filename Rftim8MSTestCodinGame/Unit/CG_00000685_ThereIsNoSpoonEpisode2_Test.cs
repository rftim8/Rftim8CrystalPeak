...
{
    [TestClass]
    public sealed class CG_00000685_ThereIsNoSpoonEpisode2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000685_ThereIsNoSpoonEpisode2));
        ...
        {
            bool result = CG_00000685_ThereIsNoSpoonEpisode2.Solution_0_Test(input);
