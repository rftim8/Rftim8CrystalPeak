...
{
    [TestClass]
    public sealed class CG_00000269_FishingWithAStick_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000269_FishingWithAStick));
        ...
        {
            bool result = CG_00000269_FishingWithAStick.Solution_0_Test(input);
