...
{
    [TestClass]
    public sealed class CG_00000341_HuffmanCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000341_HuffmanCode));
        ...
        {
            bool result = CG_00000341_HuffmanCode.Solution_0_Test(input);
