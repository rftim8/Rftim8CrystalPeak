...
{
    [TestClass]
    public sealed class CG_00000314_HarmlessRooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000314_HarmlessRooks));
        ...
        {
            bool result = CG_00000314_HarmlessRooks.Solution_0_Test(input);
