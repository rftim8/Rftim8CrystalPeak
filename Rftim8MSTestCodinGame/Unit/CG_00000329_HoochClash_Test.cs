...
{
    [TestClass]
    public sealed class CG_00000329_HoochClash_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000329_HoochClash));
        ...
        {
            bool result = CG_00000329_HoochClash.Solution_0_Test(input);
