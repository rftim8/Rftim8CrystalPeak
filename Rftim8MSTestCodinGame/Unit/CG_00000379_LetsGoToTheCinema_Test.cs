...
{
    [TestClass]
    public sealed class CG_00000379_LetsGoToTheCinema_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000379_LetsGoToTheCinema));
        ...
        {
            bool result = CG_00000379_LetsGoToTheCinema.Solution_0_Test(input);
