...
{
    [TestClass]
    public sealed class CG_00000180_CustomGameOfLife_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000180_CustomGameOfLife));
        ...
        {
            bool result = CG_00000180_CustomGameOfLife.Solution_0_Test(input);
