...
{
    [TestClass]
    public sealed class CG_00000590_SmileFriezeCheese_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000590_SmileFriezeCheese));
        ...
        {
            bool result = CG_00000590_SmileFriezeCheese.Solution_0_Test(input);
