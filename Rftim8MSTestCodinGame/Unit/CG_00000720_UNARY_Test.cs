...
{
    [TestClass]
    public sealed class CG_00000720_UNARY_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000720_UNARY));
        ...
        {
            bool result = CG_00000720_UNARY.Solution_0_Test(input);
