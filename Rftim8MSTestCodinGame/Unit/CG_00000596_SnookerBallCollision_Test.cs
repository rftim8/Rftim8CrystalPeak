...
{
    [TestClass]
    public sealed class CG_00000596_SnookerBallCollision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000596_SnookerBallCollision));
        ...
        {
            bool result = CG_00000596_SnookerBallCollision.Solution_0_Test(input);
