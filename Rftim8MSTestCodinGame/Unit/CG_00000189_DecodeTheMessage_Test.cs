...
{
    [TestClass]
    public sealed class CG_00000189_DecodeTheMessage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000189_DecodeTheMessage));
        ...
        {
            bool result = CG_00000189_DecodeTheMessage.Solution_0_Test(input);
