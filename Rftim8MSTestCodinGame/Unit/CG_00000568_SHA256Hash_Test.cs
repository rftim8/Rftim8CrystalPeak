...
{
    [TestClass]
    public sealed class CG_00000568_SHA256Hash_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000568_SHA256Hash));
        ...
        {
            bool result = CG_00000568_SHA256Hash.Solution_0_Test(input);
