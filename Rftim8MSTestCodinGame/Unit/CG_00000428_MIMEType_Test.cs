...
{
    [TestClass]
    public sealed class CG_00000428_MIMEType_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000428_MIMEType));
        ...
        {
            bool result = CG_00000428_MIMEType.Solution_0_Test(input);
