...
{
    [TestClass]
    public sealed class CG_00000708_TinyForest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000708_TinyForest));
        ...
        {
            bool result = CG_00000708_TinyForest.Solution_0_Test(input);
