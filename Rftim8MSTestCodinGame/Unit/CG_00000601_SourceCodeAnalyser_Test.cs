...
{
    [TestClass]
    public sealed class CG_00000601_SourceCodeAnalyser_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000601_SourceCodeAnalyser));
        ...
        {
            bool result = CG_00000601_SourceCodeAnalyser.Solution_0_Test(input);
