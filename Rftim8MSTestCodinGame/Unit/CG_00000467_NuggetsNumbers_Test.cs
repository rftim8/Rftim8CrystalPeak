...
{
    [TestClass]
    public sealed class CG_00000467_NuggetsNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000467_NuggetsNumbers));
        ...
        {
            bool result = CG_00000467_NuggetsNumbers.Solution_0_Test(input);
