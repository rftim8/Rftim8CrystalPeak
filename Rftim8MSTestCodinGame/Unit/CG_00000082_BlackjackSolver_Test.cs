...
{
    [TestClass]
    public sealed class CG_00000082_BlackjackSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000082_BlackjackSolver));
        ...
        {
            bool result = CG_00000082_BlackjackSolver.Solution_0_Test(input);
