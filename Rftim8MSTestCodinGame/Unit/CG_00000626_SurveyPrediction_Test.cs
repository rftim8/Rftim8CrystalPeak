...
{
    [TestClass]
    public sealed class CG_00000626_SurveyPrediction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000626_SurveyPrediction));
        ...
        {
            bool result = CG_00000626_SurveyPrediction.Solution_0_Test(input);
