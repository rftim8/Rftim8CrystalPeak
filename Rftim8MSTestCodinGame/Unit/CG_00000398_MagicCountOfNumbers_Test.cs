...
{
    [TestClass]
    public sealed class CG_00000398_MagicCountOfNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000398_MagicCountOfNumbers));
        ...
        {
            bool result = CG_00000398_MagicCountOfNumbers.Solution_0_Test(input);
