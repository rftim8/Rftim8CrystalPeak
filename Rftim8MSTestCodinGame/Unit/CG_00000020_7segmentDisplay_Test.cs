...
{
    [TestClass]
    public sealed class CG_00000020_7segmentDisplay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000020_7segmentDisplay));
        ...
        {
            bool result = CG_00000020_7segmentDisplay.Solution_0_Test(input);
