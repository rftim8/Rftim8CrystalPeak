...
{
    [TestClass]
    public sealed class CG_00000585_SimplifySelectionRanges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000585_SimplifySelectionRanges));
        ...
        {
            bool result = CG_00000585_SimplifySelectionRanges.Solution_0_Test(input);
