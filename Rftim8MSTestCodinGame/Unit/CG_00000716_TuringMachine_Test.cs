...
{
    [TestClass]
    public sealed class CG_00000716_TuringMachine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000716_TuringMachine));
        ...
        {
            bool result = CG_00000716_TuringMachine.Solution_0_Test(input);
