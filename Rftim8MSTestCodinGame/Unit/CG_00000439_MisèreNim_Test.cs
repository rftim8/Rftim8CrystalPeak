...
{
    [TestClass]
    public sealed class CG_00000439_MisèreNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000439_MisèreNim));
        ...
        {
            bool result = CG_00000439_MisèreNim.Solution_0_Test(input);
