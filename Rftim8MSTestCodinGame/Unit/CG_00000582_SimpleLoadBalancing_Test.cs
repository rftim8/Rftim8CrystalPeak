...
{
    [TestClass]
    public sealed class CG_00000582_SimpleLoadBalancing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000582_SimpleLoadBalancing));
        ...
        {
            bool result = CG_00000582_SimpleLoadBalancing.Solution_0_Test(input);
