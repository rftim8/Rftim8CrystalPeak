...
{
    [TestClass]
    public sealed class CG_00000255_FairNumbering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000255_FairNumbering));
        ...
        {
            bool result = CG_00000255_FairNumbering.Solution_0_Test(input);
