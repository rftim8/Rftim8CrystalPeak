...
{
    [TestClass]
    public sealed class CG_00000618_SudokuValidator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000618_SudokuValidator));
        ...
        {
            bool result = CG_00000618_SudokuValidator.Solution_0_Test(input);
