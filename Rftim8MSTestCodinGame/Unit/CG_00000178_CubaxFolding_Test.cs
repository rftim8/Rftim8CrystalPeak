...
{
    [TestClass]
    public sealed class CG_00000178_CubaxFolding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000178_CubaxFolding));
        ...
        {
            bool result = CG_00000178_CubaxFolding.Solution_0_Test(input);
