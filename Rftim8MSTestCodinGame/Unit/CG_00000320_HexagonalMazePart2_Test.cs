...
{
    [TestClass]
    public sealed class CG_00000320_HexagonalMazePart2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000320_HexagonalMazePart2));
        ...
        {
            bool result = CG_00000320_HexagonalMazePart2.Solution_0_Test(input);
