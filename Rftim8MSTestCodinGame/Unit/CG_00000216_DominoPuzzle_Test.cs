...
{
    [TestClass]
    public sealed class CG_00000216_DominoPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000216_DominoPuzzle));
        ...
        {
            bool result = CG_00000216_DominoPuzzle.Solution_0_Test(input);
