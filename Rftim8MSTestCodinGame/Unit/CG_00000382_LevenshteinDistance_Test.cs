...
{
    [TestClass]
    public sealed class CG_00000382_LevenshteinDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000382_LevenshteinDistance));
        ...
        {
            bool result = CG_00000382_LevenshteinDistance.Solution_0_Test(input);
