...
{
    [TestClass]
    public sealed class CG_00000673_TheLogoBeyondCAndC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000673_TheLogoBeyondCAndC));
        ...
        {
            bool result = CG_00000673_TheLogoBeyondCAndC.Solution_0_Test(input);
