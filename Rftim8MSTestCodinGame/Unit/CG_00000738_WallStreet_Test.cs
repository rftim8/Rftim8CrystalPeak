...
{
    [TestClass]
    public sealed class CG_00000738_WallStreet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000738_WallStreet));
        ...
        {
            bool result = CG_00000738_WallStreet.Solution_0_Test(input);
