...
{
    [TestClass]
    public sealed class CG_00000415_MaximisingIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000415_MaximisingIntegers));
        ...
        {
            bool result = CG_00000415_MaximisingIntegers.Solution_0_Test(input);
