...
{
    [TestClass]
    public sealed class CG_00000214_DominoesPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000214_DominoesPath));
        ...
        {
            bool result = CG_00000214_DominoesPath.Solution_0_Test(input);
