...
{
    [TestClass]
    public sealed class CG_00000037_AnagramToBreakTheCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000037_AnagramToBreakTheCode));
        ...
        {
            bool result = CG_00000037_AnagramToBreakTheCode.Solution_0_Test(input);
