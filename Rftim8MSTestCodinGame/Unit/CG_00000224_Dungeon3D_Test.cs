...
{
    [TestClass]
    public sealed class CG_00000224_Dungeon3D_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000224_Dungeon3D));
        ...
        {
            bool result = CG_00000224_Dungeon3D.Solution_0_Test(input);
