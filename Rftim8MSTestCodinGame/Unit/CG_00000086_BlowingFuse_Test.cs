...
{
    [TestClass]
    public sealed class CG_00000086_BlowingFuse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000086_BlowingFuse));
        ...
        {
            bool result = CG_00000086_BlowingFuse.Solution_0_Test(input);
