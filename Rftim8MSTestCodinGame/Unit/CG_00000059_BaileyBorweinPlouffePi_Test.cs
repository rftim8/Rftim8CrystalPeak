...
{
    [TestClass]
    public sealed class CG_00000059_BaileyBorweinPlouffePi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000059_BaileyBorweinPlouffePi));
        ...
        {
            bool result = CG_00000059_BaileyBorweinPlouffePi.Solution_0_Test(input);
