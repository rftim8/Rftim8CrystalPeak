...
{
    [TestClass]
    public sealed class CG_00000591_Smooth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000591_Smooth));
        ...
        {
            bool result = CG_00000591_Smooth.Solution_0_Test(input);
