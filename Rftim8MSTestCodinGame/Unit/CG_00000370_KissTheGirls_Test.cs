...
{
    [TestClass]
    public sealed class CG_00000370_KissTheGirls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000370_KissTheGirls));
        ...
        {
            bool result = CG_00000370_KissTheGirls.Solution_0_Test(input);
