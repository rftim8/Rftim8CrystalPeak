...
{
    [TestClass]
    public sealed class CG_00000332_HorseracingDuals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000332_HorseracingDuals));
        ...
        {
            bool result = CG_00000332_HorseracingDuals.Solution_0_Test(input);
