...
{
    [TestClass]
    public sealed class CG_00000265_FindTheReplacement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000265_FindTheReplacement));
        ...
        {
            bool result = CG_00000265_FindTheReplacement.Solution_0_Test(input);
