...
{
    [TestClass]
    public sealed class CG_00000460_NextGrowingNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000460_NextGrowingNumber));
        ...
        {
            bool result = CG_00000460_NextGrowingNumber.Solution_0_Test(input);
