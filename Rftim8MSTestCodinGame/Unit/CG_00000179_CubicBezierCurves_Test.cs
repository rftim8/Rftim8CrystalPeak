...
{
    [TestClass]
    public sealed class CG_00000179_CubicBezierCurves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000179_CubicBezierCurves));
        ...
        {
            bool result = CG_00000179_CubicBezierCurves.Solution_0_Test(input);
