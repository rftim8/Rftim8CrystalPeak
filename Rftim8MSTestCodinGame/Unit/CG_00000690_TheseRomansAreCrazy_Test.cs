...
{
    [TestClass]
    public sealed class CG_00000690_TheseRomansAreCrazy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000690_TheseRomansAreCrazy));
        ...
        {
            bool result = CG_00000690_TheseRomansAreCrazy.Solution_0_Test(input);
