...
{
    [TestClass]
    public sealed class CG_00000530_RemainderFantasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000530_RemainderFantasy));
        ...
        {
            bool result = CG_00000530_RemainderFantasy.Solution_0_Test(input);
