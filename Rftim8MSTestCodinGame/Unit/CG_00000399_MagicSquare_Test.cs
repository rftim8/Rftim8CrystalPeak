...
{
    [TestClass]
    public sealed class CG_00000399_MagicSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000399_MagicSquare));
        ...
        {
            bool result = CG_00000399_MagicSquare.Solution_0_Test(input);
