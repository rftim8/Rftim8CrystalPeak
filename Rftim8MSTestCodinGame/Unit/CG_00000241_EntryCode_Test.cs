...
{
    [TestClass]
    public sealed class CG_00000241_EntryCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000241_EntryCode));
        ...
        {
            bool result = CG_00000241_EntryCode.Solution_0_Test(input);
