...
{
    [TestClass]
    public sealed class CG_00000755_XMLMDF2016_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000755_XMLMDF2016));
        ...
        {
            bool result = CG_00000755_XMLMDF2016.Solution_0_Test(input);
