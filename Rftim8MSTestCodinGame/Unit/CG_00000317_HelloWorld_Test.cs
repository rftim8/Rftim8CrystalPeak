...
{
    [TestClass]
    public sealed class CG_00000317_HelloWorld_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000317_HelloWorld));
        ...
        {
            bool result = CG_00000317_HelloWorld.Solution_0_Test(input);
