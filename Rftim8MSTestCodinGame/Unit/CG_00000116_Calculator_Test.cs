...
{
    [TestClass]
    public sealed class CG_00000116_Calculator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000116_Calculator));
        ...
        {
            bool result = CG_00000116_Calculator.Solution_0_Test(input);
