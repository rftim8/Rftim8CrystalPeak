...
{
    [TestClass]
    public sealed class CG_00000376_LaserAndMirrors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000376_LaserAndMirrors));
        ...
        {
            bool result = CG_00000376_LaserAndMirrors.Solution_0_Test(input);
