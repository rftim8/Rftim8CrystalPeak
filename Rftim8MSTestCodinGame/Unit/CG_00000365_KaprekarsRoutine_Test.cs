...
{
    [TestClass]
    public sealed class CG_00000365_KaprekarsRoutine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000365_KaprekarsRoutine));
        ...
        {
            bool result = CG_00000365_KaprekarsRoutine.Solution_0_Test(input);
