...
{
    [TestClass]
    public sealed class CG_00000718_UkuleleGuitarConverter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000718_UkuleleGuitarConverter));
        ...
        {
            bool result = CG_00000718_UkuleleGuitarConverter.Solution_0_Test(input);
