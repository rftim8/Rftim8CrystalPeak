...
{
    [TestClass]
    public sealed class CG_00000484_OrganicCompounds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000484_OrganicCompounds));
        ...
        {
            bool result = CG_00000484_OrganicCompounds.Solution_0_Test(input);
