...
{
    [TestClass]
    public sealed class CG_00000328_HoleyTimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000328_HoleyTimes));
        ...
        {
            bool result = CG_00000328_HoleyTimes.Solution_0_Test(input);
