...
{
    [TestClass]
    public sealed class CG_00000686_TheResistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000686_TheResistance));
        ...
        {
            bool result = CG_00000686_TheResistance.Solution_0_Test(input);
