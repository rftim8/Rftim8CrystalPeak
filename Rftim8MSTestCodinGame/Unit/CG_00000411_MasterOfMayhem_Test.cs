...
{
    [TestClass]
    public sealed class CG_00000411_MasterOfMayhem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000411_MasterOfMayhem));
        ...
        {
            bool result = CG_00000411_MasterOfMayhem.Solution_0_Test(input);
