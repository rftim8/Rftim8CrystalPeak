...
{
    [TestClass]
    public sealed class CG_00000299_GoroWantChocolate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000299_GoroWantChocolate));
        ...
        {
            bool result = CG_00000299_GoroWantChocolate.Solution_0_Test(input);
