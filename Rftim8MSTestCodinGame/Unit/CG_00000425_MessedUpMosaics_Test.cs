...
{
    [TestClass]
    public sealed class CG_00000425_MessedUpMosaics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000425_MessedUpMosaics));
        ...
        {
            bool result = CG_00000425_MessedUpMosaics.Solution_0_Test(input);
