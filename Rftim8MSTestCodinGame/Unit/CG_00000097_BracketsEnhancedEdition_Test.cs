...
{
    [TestClass]
    public sealed class CG_00000097_BracketsEnhancedEdition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000097_BracketsEnhancedEdition));
        ...
        {
            bool result = CG_00000097_BracketsEnhancedEdition.Solution_0_Test(input);
