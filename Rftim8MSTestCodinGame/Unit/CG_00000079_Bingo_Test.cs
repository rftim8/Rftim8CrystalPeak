...
{
    [TestClass]
    public sealed class CG_00000079_Bingo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000079_Bingo));
        ...
        {
            bool result = CG_00000079_Bingo.Solution_0_Test(input);
