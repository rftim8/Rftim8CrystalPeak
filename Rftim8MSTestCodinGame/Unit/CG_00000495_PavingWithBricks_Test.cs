...
{
    [TestClass]
    public sealed class CG_00000495_PavingWithBricks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000495_PavingWithBricks));
        ...
        {
            bool result = CG_00000495_PavingWithBricks.Solution_0_Test(input);
