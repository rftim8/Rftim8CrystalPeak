...
{
    [TestClass]
    public sealed class CG_00000724_UnitFractions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000724_UnitFractions));
        ...
        {
            bool result = CG_00000724_UnitFractions.Solution_0_Test(input);
