...
{
    [TestClass]
    public sealed class CG_00000060_BalancedLevers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000060_BalancedLevers));
        ...
        {
            bool result = CG_00000060_BalancedLevers.Solution_0_Test(input);
