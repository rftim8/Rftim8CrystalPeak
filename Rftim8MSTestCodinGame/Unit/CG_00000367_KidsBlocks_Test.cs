...
{
    [TestClass]
    public sealed class CG_00000367_KidsBlocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000367_KidsBlocks));
        ...
        {
            bool result = CG_00000367_KidsBlocks.Solution_0_Test(input);
