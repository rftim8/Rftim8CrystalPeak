...
{
    [TestClass]
    public sealed class CG_00000559_RUSHHOUR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000559_RUSHHOUR));
        ...
        {
            bool result = CG_00000559_RUSHHOUR.Solution_0_Test(input);
