...
{
    [TestClass]
    public sealed class CG_00000563_ScoreABridgeDeal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000563_ScoreABridgeDeal));
        ...
        {
            bool result = CG_00000563_ScoreABridgeDeal.Solution_0_Test(input);
