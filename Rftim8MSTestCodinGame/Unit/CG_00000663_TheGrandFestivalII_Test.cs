...
{
    [TestClass]
    public sealed class CG_00000663_TheGrandFestivalII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000663_TheGrandFestivalII));
        ...
        {
            bool result = CG_00000663_TheGrandFestivalII.Solution_0_Test(input);
