...
{
    [TestClass]
    public sealed class CG_00000209_DistributingCandy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000209_DistributingCandy));
        ...
        {
            bool result = CG_00000209_DistributingCandy.Solution_0_Test(input);
