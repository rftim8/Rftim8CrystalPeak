...
{
    [TestClass]
    public sealed class CG_00000010_222RubiksCubeMovements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000010_222RubiksCubeMovements));
        ...
        {
            bool result = CG_00000010_222RubiksCubeMovements.Solution_0_Test(input);
