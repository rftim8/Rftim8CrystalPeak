...
{
    [TestClass]
    public sealed class CG_00000644_TheAlienBusinessOfCows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000644_TheAlienBusinessOfCows));
        ...
        {
            bool result = CG_00000644_TheAlienBusinessOfCows.Solution_0_Test(input);
