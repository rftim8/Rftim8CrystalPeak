...
{
    [TestClass]
    public sealed class CG_00000477_OddQuadOut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000477_OddQuadOut));
        ...
        {
            bool result = CG_00000477_OddQuadOut.Solution_0_Test(input);
