...
{
    [TestClass]
    public sealed class CG_00000103_BreakingBifid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000103_BreakingBifid));
        ...
        {
            bool result = CG_00000103_BreakingBifid.Solution_0_Test(input);
