...
{
    [TestClass]
    public sealed class CG_00000286_FunWithSetTheory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000286_FunWithSetTheory));
        ...
        {
            bool result = CG_00000286_FunWithSetTheory.Solution_0_Test(input);
