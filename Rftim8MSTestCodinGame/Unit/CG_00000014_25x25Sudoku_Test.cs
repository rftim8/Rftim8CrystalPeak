...
{
    [TestClass]
    public sealed class CG_00000014_25x25Sudoku_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000014_25x25Sudoku));
        ...
        {
            bool result = CG_00000014_25x25Sudoku.Solution_0_Test(input);
