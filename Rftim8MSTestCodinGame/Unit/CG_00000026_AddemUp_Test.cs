...
{
    [TestClass]
    public sealed class CG_00000026_AddemUp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000026_AddemUp));
        ...
        {
            bool result = CG_00000026_AddemUp.Solution_0_Test(input);
