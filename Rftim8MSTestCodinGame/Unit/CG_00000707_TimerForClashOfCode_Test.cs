...
{
    [TestClass]
    public sealed class CG_00000707_TimerForClashOfCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000707_TimerForClashOfCode));
        ...
        {
            bool result = CG_00000707_TimerForClashOfCode.Solution_0_Test(input);
