...
{
    [TestClass]
    public sealed class CG_00000013_25DMaze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000013_25DMaze));
        ...
        {
            bool result = CG_00000013_25DMaze.Solution_0_Test(input);
