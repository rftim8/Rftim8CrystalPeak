...
{
    [TestClass]
    public sealed class CG_00000550_RocksPapersScissorses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000550_RocksPapersScissorses));
        ...
        {
            bool result = CG_00000550_RocksPapersScissorses.Solution_0_Test(input);
