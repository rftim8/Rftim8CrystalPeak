...
{
    [TestClass]
    public sealed class CG_00000541_RiverCrossing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000541_RiverCrossing));
        ...
        {
            bool result = CG_00000541_RiverCrossing.Solution_0_Test(input);
