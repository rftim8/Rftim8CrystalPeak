...
{
    [TestClass]
    public sealed class CG_00000497_PeriodicTableSpelling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000497_PeriodicTableSpelling));
        ...
        {
            bool result = CG_00000497_PeriodicTableSpelling.Solution_0_Test(input);
