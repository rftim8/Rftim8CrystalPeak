...
{
    [TestClass]
    public sealed class CG_00000219_DoublySolvedRubiksCube_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000219_DoublySolvedRubiksCube));
        ...
        {
            bool result = CG_00000219_DoublySolvedRubiksCube.Solution_0_Test(input);
