...
{
    [TestClass]
    public sealed class CG_00000293_Gerrymandering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000293_Gerrymandering));
        ...
        {
            bool result = CG_00000293_Gerrymandering.Solution_0_Test(input);
