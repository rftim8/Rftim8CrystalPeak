...
{
    [TestClass]
    public sealed class CG_00000348_InsertToString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000348_InsertToString));
        ...
        {
            bool result = CG_00000348_InsertToString.Solution_0_Test(input);
