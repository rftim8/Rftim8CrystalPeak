...
{
    [TestClass]
    public sealed class CG_00000759_ZhiweiSunSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000759_ZhiweiSunSquares));
        ...
        {
            bool result = CG_00000759_ZhiweiSunSquares.Solution_0_Test(input);
