...
{
    [TestClass]
    public sealed class CG_00000623_SuperComputer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000623_SuperComputer));
        ...
        {
            bool result = CG_00000623_SuperComputer.Solution_0_Test(input);
