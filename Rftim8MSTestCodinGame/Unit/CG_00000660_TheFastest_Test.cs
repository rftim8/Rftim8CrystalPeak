...
{
    [TestClass]
    public sealed class CG_00000660_TheFastest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000660_TheFastest));
        ...
        {
            bool result = CG_00000660_TheFastest.Solution_0_Test(input);
