...
{
    [TestClass]
    public sealed class CG_00000009_2048Scores_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000009_2048Scores));
        ...
        {
            bool result = CG_00000009_2048Scores.Solution_0_Test(input);
