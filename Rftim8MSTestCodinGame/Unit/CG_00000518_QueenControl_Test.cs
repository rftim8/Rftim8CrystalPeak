...
{
    [TestClass]
    public sealed class CG_00000518_QueenControl_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000518_QueenControl));
        ...
        {
            bool result = CG_00000518_QueenControl.Solution_0_Test(input);
