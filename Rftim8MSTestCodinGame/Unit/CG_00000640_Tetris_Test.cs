...
{
    [TestClass]
    public sealed class CG_00000640_Tetris_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000640_Tetris));
        ...
        {
            bool result = CG_00000640_Tetris.Solution_0_Test(input);
