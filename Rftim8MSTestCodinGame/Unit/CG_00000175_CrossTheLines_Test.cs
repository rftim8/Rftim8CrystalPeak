...
{
    [TestClass]
    public sealed class CG_00000175_CrossTheLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000175_CrossTheLines));
        ...
        {
            bool result = CG_00000175_CrossTheLines.Solution_0_Test(input);
