...
{
    [TestClass]
    public sealed class CG_00000051_ASCIICube_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000051_ASCIICube));
        ...
        {
            bool result = CG_00000051_ASCIICube.Solution_0_Test(input);
