...
{
    [TestClass]
    public sealed class CG_00000401_MagicString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000401_MagicString));
        ...
        {
            bool result = CG_00000401_MagicString.Solution_0_Test(input);
