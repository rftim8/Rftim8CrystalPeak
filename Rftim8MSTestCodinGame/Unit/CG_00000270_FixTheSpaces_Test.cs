...
{
    [TestClass]
    public sealed class CG_00000270_FixTheSpaces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000270_FixTheSpaces));
        ...
        {
            bool result = CG_00000270_FixTheSpaces.Solution_0_Test(input);
