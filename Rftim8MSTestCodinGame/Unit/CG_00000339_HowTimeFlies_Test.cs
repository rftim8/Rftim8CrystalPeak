...
{
    [TestClass]
    public sealed class CG_00000339_HowTimeFlies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000339_HowTimeFlies));
        ...
        {
            bool result = CG_00000339_HowTimeFlies.Solution_0_Test(input);
