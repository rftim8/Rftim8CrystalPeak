...
{
    [TestClass]
    public sealed class CG_00000624_Surakarta_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000624_Surakarta));
        ...
        {
            bool result = CG_00000624_Surakarta.Solution_0_Test(input);
