...
{
    [TestClass]
    public sealed class CG_00000041_AppleTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000041_AppleTree));
        ...
        {
            bool result = CG_00000041_AppleTree.Solution_0_Test(input);
