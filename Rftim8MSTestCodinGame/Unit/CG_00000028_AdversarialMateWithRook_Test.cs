...
{
    [TestClass]
    public sealed class CG_00000028_AdversarialMateWithRook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000028_AdversarialMateWithRook));
        ...
        {
            bool result = CG_00000028_AdversarialMateWithRook.Solution_0_Test(input);
