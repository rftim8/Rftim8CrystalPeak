...
{
    [TestClass]
    public sealed class CG_00000485_Othello_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000485_Othello));
        ...
        {
            bool result = CG_00000485_Othello.Solution_0_Test(input);
