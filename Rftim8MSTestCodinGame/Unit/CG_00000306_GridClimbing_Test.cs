...
{
    [TestClass]
    public sealed class CG_00000306_GridClimbing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000306_GridClimbing));
        ...
        {
            bool result = CG_00000306_GridClimbing.Solution_0_Test(input);
