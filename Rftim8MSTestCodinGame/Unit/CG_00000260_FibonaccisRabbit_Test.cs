...
{
    [TestClass]
    public sealed class CG_00000260_FibonaccisRabbit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000260_FibonaccisRabbit));
        ...
        {
            bool result = CG_00000260_FibonaccisRabbit.Solution_0_Test(input);
