...
{
    [TestClass]
    public sealed class CG_00000019_5DChests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000019_5DChests));
        ...
        {
            bool result = CG_00000019_5DChests.Solution_0_Test(input);
