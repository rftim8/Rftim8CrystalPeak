...
{
    [TestClass]
    public sealed class CG_00000451_MusicScores_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000451_MusicScores));
        ...
        {
            bool result = CG_00000451_MusicScores.Solution_0_Test(input);
