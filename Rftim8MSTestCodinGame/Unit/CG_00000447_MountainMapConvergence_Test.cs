...
{
    [TestClass]
    public sealed class CG_00000447_MountainMapConvergence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000447_MountainMapConvergence));
        ...
        {
            bool result = CG_00000447_MountainMapConvergence.Solution_0_Test(input);
