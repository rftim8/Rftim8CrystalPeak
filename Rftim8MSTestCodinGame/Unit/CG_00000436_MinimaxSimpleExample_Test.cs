...
{
    [TestClass]
    public sealed class CG_00000436_MinimaxSimpleExample_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000436_MinimaxSimpleExample));
        ...
        {
            bool result = CG_00000436_MinimaxSimpleExample.Solution_0_Test(input);
