...
{
    [TestClass]
    public sealed class CG_00000642_TextAlignment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000642_TextAlignment));
        ...
        {
            bool result = CG_00000642_TextAlignment.Solution_0_Test(input);
