...
{
    [TestClass]
    public sealed class CG_00000564_Scrabble_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000564_Scrabble));
        ...
        {
            bool result = CG_00000564_Scrabble.Solution_0_Test(input);
