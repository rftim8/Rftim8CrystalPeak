...
{
    [TestClass]
    public sealed class CG_00000109_BulkEmailGenerator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000109_BulkEmailGenerator));
        ...
        {
            bool result = CG_00000109_BulkEmailGenerator.Solution_0_Test(input);
