...
{
    [TestClass]
    public sealed class CG_00000555_RotatingArrows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000555_RotatingArrows));
        ...
        {
            bool result = CG_00000555_RotatingArrows.Solution_0_Test(input);
