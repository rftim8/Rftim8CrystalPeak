...
{
    [TestClass]
    public sealed class CG_00000721_UnfloodTheWorld_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000721_UnfloodTheWorld));
        ...
        {
            bool result = CG_00000721_UnfloodTheWorld.Solution_0_Test(input);
