...
{
    [TestClass]
    public sealed class CG_00000210_DivideTheFactorial_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000210_DivideTheFactorial));
        ...
        {
            bool result = CG_00000210_DivideTheFactorial.Solution_0_Test(input);
