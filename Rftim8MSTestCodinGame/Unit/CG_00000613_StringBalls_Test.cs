...
{
    [TestClass]
    public sealed class CG_00000613_StringBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000613_StringBalls));
        ...
        {
            bool result = CG_00000613_StringBalls.Solution_0_Test(input);
