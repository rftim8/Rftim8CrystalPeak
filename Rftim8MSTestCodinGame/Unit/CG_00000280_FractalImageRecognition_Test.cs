...
{
    [TestClass]
    public sealed class CG_00000280_FractalImageRecognition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000280_FractalImageRecognition));
        ...
        {
            bool result = CG_00000280_FractalImageRecognition.Solution_0_Test(input);
