...
{
    [TestClass]
    public sealed class CG_00000234_Elevator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000234_Elevator));
        ...
        {
            bool result = CG_00000234_Elevator.Solution_0_Test(input);
