...
{
    [TestClass]
    public sealed class CG_00000223_DumbbellsSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000223_DumbbellsSolver));
        ...
        {
            bool result = CG_00000223_DumbbellsSolver.Solution_0_Test(input);
