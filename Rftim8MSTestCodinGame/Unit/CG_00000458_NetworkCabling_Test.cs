...
{
    [TestClass]
    public sealed class CG_00000458_NetworkCabling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000458_NetworkCabling));
        ...
        {
            bool result = CG_00000458_NetworkCabling.Solution_0_Test(input);
