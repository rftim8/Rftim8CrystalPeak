...
{
    [TestClass]
    public sealed class CG_00000083_BlendingColors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000083_BlendingColors));
        ...
        {
            bool result = CG_00000083_BlendingColors.Solution_0_Test(input);
