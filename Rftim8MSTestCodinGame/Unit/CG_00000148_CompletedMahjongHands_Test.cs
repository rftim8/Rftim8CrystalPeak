...
{
    [TestClass]
    public sealed class CG_00000148_CompletedMahjongHands_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000148_CompletedMahjongHands));
        ...
        {
            bool result = CG_00000148_CompletedMahjongHands.Solution_0_Test(input);
