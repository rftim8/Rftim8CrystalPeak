...
{
    [TestClass]
    public sealed class CG_00000419_MayTheTriforceBeWithYou_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000419_MayTheTriforceBeWithYou));
        ...
        {
            bool result = CG_00000419_MayTheTriforceBeWithYou.Solution_0_Test(input);
