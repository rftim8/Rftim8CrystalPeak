...
{
    [TestClass]
    public sealed class CG_00000472_NumberPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000472_NumberPartition));
        ...
        {
            bool result = CG_00000472_NumberPartition.Solution_0_Test(input);
