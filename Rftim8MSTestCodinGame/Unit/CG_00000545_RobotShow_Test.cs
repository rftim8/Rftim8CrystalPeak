...
{
    [TestClass]
    public sealed class CG_00000545_RobotShow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000545_RobotShow));
        ...
        {
            bool result = CG_00000545_RobotShow.Solution_0_Test(input);
