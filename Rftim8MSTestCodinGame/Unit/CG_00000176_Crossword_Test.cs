...
{
    [TestClass]
    public sealed class CG_00000176_Crossword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000176_Crossword));
        ...
        {
            bool result = CG_00000176_Crossword.Solution_0_Test(input);
