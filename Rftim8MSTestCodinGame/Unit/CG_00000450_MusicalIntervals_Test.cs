...
{
    [TestClass]
    public sealed class CG_00000450_MusicalIntervals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000450_MusicalIntervals));
        ...
        {
            bool result = CG_00000450_MusicalIntervals.Solution_0_Test(input);
