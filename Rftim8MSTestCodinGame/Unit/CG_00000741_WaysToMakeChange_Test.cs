...
{
    [TestClass]
    public sealed class CG_00000741_WaysToMakeChange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000741_WaysToMakeChange));
        ...
        {
            bool result = CG_00000741_WaysToMakeChange.Solution_0_Test(input);
