...
{
    [TestClass]
    public sealed class CG_00000008_1NGRBasicRadar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000008_1NGRBasicRadar));
        ...
        {
            bool result = CG_00000008_1NGRBasicRadar.Solution_0_Test(input);
