...
{
    [TestClass]
    public sealed class CG_00000115_CaesarIsTheChief_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000115_CaesarIsTheChief));
        ...
        {
            bool result = CG_00000115_CaesarIsTheChief.Solution_0_Test(input);
