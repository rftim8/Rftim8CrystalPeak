...
{
    [TestClass]
    public sealed class CG_00000267_FireControl_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000267_FireControl));
        ...
        {
            bool result = CG_00000267_FireControl.Solution_0_Test(input);
