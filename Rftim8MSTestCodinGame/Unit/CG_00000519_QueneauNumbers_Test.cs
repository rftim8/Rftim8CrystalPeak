...
{
    [TestClass]
    public sealed class CG_00000519_QueneauNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000519_QueneauNumbers));
        ...
        {
            bool result = CG_00000519_QueneauNumbers.Solution_0_Test(input);
