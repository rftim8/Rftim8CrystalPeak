...
{
    [TestClass]
    public sealed class CG_00000101_Breach_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000101_Breach));
        ...
        {
            bool result = CG_00000101_Breach.Solution_0_Test(input);
