...
{
    [TestClass]
    public sealed class CG_00000333_HorseracingHyperduals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000333_HorseracingHyperduals));
        ...
        {
            bool result = CG_00000333_HorseracingHyperduals.Solution_0_Test(input);
