...
{
    [TestClass]
    public sealed class CG_00000242_EqualizingArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000242_EqualizingArrays));
        ...
        {
            bool result = CG_00000242_EqualizingArrays.Solution_0_Test(input);
