...
{
    [TestClass]
    public sealed class CG_00000183_DAWG_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000183_DAWG));
        ...
        {
            bool result = CG_00000183_DAWG.Solution_0_Test(input);
