...
{
    [TestClass]
    public sealed class CG_00000164_CounterAttack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000164_CounterAttack));
        ...
        {
            bool result = CG_00000164_CounterAttack.Solution_0_Test(input);
