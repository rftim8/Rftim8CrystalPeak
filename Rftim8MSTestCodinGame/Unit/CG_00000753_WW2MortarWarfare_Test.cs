...
{
    [TestClass]
    public sealed class CG_00000753_WW2MortarWarfare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000753_WW2MortarWarfare));
        ...
        {
            bool result = CG_00000753_WW2MortarWarfare.Solution_0_Test(input);
