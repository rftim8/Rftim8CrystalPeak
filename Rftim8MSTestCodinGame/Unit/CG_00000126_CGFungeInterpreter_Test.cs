...
{
    [TestClass]
    public sealed class CG_00000126_CGFungeInterpreter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000126_CGFungeInterpreter));
        ...
        {
            bool result = CG_00000126_CGFungeInterpreter.Solution_0_Test(input);
