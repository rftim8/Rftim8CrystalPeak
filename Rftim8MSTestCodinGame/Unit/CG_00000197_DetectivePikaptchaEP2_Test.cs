...
{
    [TestClass]
    public sealed class CG_00000197_DetectivePikaptchaEP2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000197_DetectivePikaptchaEP2));
        ...
        {
            bool result = CG_00000197_DetectivePikaptchaEP2.Solution_0_Test(input);
