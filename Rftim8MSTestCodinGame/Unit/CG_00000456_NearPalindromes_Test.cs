...
{
    [TestClass]
    public sealed class CG_00000456_NearPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000456_NearPalindromes));
        ...
        {
            bool result = CG_00000456_NearPalindromes.Solution_0_Test(input);
