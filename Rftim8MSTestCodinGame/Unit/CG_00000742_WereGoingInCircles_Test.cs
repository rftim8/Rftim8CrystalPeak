...
{
    [TestClass]
    public sealed class CG_00000742_WereGoingInCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000742_WereGoingInCircles));
        ...
        {
            bool result = CG_00000742_WereGoingInCircles.Solution_0_Test(input);
