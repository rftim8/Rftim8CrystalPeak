...
{
    [TestClass]
    public sealed class CG_00000032_AlternativeVote_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000032_AlternativeVote));
        ...
        {
            bool result = CG_00000032_AlternativeVote.Solution_0_Test(input);
