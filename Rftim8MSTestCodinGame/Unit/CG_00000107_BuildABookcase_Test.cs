...
{
    [TestClass]
    public sealed class CG_00000107_BuildABookcase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000107_BuildABookcase));
        ...
        {
            bool result = CG_00000107_BuildABookcase.Solution_0_Test(input);
