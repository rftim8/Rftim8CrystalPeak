...
{
    [TestClass]
    public sealed class CG_00000593_SnailRun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000593_SnailRun));
        ...
        {
            bool result = CG_00000593_SnailRun.Solution_0_Test(input);
