...
{
    [TestClass]
    public sealed class CG_00000430_Minesweeper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000430_Minesweeper));
        ...
        {
            bool result = CG_00000430_Minesweeper.Solution_0_Test(input);
