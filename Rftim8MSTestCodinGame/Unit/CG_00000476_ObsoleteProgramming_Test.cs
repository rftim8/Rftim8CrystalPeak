...
{
    [TestClass]
    public sealed class CG_00000476_ObsoleteProgramming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000476_ObsoleteProgramming));
        ...
        {
            bool result = CG_00000476_ObsoleteProgramming.Solution_0_Test(input);
