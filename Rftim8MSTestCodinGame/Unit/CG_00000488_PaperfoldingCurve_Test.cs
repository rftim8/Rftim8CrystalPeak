...
{
    [TestClass]
    public sealed class CG_00000488_PaperfoldingCurve_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000488_PaperfoldingCurve));
        ...
        {
            bool result = CG_00000488_PaperfoldingCurve.Solution_0_Test(input);
