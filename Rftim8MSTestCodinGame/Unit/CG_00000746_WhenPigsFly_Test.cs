...
{
    [TestClass]
    public sealed class CG_00000746_WhenPigsFly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000746_WhenPigsFly));
        ...
        {
            bool result = CG_00000746_WhenPigsFly.Solution_0_Test(input);
