...
{
    [TestClass]
    public sealed class CG_00000701_ThreeLittlePiggies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000701_ThreeLittlePiggies));
        ...
        {
            bool result = CG_00000701_ThreeLittlePiggies.Solution_0_Test(input);
