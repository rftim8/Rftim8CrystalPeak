...
{
    [TestClass]
    public sealed class CG_00000056_AStoryToGoInCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000056_AStoryToGoInCircles));
        ...
        {
            bool result = CG_00000056_AStoryToGoInCircles.Solution_0_Test(input);
