...
{
    [TestClass]
    public sealed class CG_00000158_ConwaySequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000158_ConwaySequence));
        ...
        {
            bool result = CG_00000158_ConwaySequence.Solution_0_Test(input);
