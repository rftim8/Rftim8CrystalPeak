...
{
    [TestClass]
    public sealed class CG_00000012_24TheLongGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000012_24TheLongGame));
        ...
        {
            bool result = CG_00000012_24TheLongGame.Solution_0_Test(input);
