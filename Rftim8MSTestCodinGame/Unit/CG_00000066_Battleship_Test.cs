...
{
    [TestClass]
    public sealed class CG_00000066_Battleship_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000066_Battleship));
        ...
        {
            bool result = CG_00000066_Battleship.Solution_0_Test(input);
