...
{
    [TestClass]
    public sealed class CG_00000395_Lumen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000395_Lumen));
        ...
        {
            bool result = CG_00000395_Lumen.Solution_0_Test(input);
