...
{
    [TestClass]
    public sealed class CG_00000503_PlagueJr_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000503_PlagueJr));
        ...
        {
            bool result = CG_00000503_PlagueJr.Solution_0_Test(input);
