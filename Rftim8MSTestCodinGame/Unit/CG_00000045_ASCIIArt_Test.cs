...
{
    [TestClass]
    public sealed class CG_00000045_ASCIIArt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000045_ASCIIArt));
        ...
        {
            bool result = CG_00000045_ASCIIArt.Solution_0_Test(input);
