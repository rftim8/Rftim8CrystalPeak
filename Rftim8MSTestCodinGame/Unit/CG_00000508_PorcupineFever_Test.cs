...
{
    [TestClass]
    public sealed class CG_00000508_PorcupineFever_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000508_PorcupineFever));
        ...
        {
            bool result = CG_00000508_PorcupineFever.Solution_0_Test(input);
