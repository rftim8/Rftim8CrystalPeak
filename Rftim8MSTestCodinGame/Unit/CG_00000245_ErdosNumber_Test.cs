...
{
    [TestClass]
    public sealed class CG_00000245_ErdosNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000245_ErdosNumber));
        ...
        {
            bool result = CG_00000245_ErdosNumber.Solution_0_Test(input);
