...
{
    [TestClass]
    public sealed class CG_00000342_Hunger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000342_Hunger));
        ...
        {
            bool result = CG_00000342_Hunger.Solution_0_Test(input);
