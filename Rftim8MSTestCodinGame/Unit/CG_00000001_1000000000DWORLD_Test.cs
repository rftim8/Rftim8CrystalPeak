...
{
    [TestClass]
    public sealed class CG_00000001_1000000000DWORLD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000001_1000000000DWORLD));
        ...
        {
            bool result = CG_00000001_1000000000DWORLD.Solution_0_Test(input);
