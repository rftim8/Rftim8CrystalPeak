...
{
    [TestClass]
    public sealed class CG_00000666_TheHiddenFortress_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000666_TheHiddenFortress));
        ...
        {
            bool result = CG_00000666_TheHiddenFortress.Solution_0_Test(input);
