...
{
    [TestClass]
    public sealed class CG_00000063_BarcodeScanner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000063_BarcodeScanner));
        ...
        {
            bool result = CG_00000063_BarcodeScanner.Solution_0_Test(input);
