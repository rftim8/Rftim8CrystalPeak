...
{
    [TestClass]
    public sealed class CG_00000731_VideoComments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000731_VideoComments));
        ...
        {
            bool result = CG_00000731_VideoComments.Solution_0_Test(input);
