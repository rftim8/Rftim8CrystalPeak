...
{
    [TestClass]
    public sealed class CG_00000557_RugbyScore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000557_RugbyScore));
        ...
        {
            bool result = CG_00000557_RugbyScore.Solution_0_Test(input);
