...
{
    [TestClass]
    public sealed class CG_00000018_3NTiling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000018_3NTiling));
        ...
        {
            bool result = CG_00000018_3NTiling.Solution_0_Test(input);
