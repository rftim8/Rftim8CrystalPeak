...
{
    [TestClass]
    public sealed class CG_00000080_BinPacking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000080_BinPacking));
        ...
        {
            bool result = CG_00000080_BinPacking.Solution_0_Test(input);
