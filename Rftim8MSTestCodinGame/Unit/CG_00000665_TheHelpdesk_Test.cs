...
{
    [TestClass]
    public sealed class CG_00000665_TheHelpdesk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000665_TheHelpdesk));
        ...
        {
            bool result = CG_00000665_TheHelpdesk.Solution_0_Test(input);
