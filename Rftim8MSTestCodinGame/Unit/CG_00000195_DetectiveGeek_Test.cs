...
{
    [TestClass]
    public sealed class CG_00000195_DetectiveGeek_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000195_DetectiveGeek));
        ...
        {
            bool result = CG_00000195_DetectiveGeek.Solution_0_Test(input);
