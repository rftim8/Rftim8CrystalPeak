...
{
    [TestClass]
    public sealed class CG_00000285_FunWithCGXExpressions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000285_FunWithCGXExpressions));
        ...
        {
            bool result = CG_00000285_FunWithCGXExpressions.Solution_0_Test(input);
