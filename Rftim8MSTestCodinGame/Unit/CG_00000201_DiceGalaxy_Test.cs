...
{
    [TestClass]
    public sealed class CG_00000201_DiceGalaxy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000201_DiceGalaxy));
        ...
        {
            bool result = CG_00000201_DiceGalaxy.Solution_0_Test(input);
