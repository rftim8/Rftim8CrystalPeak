...
{
    [TestClass]
    public sealed class CG_00000297_GoldPacking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000297_GoldPacking));
        ...
        {
            bool result = CG_00000297_GoldPacking.Solution_0_Test(input);
