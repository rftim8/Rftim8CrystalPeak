...
{
    [TestClass]
    public sealed class CG_00000038_AncestorsDescendants_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000038_AncestorsDescendants));
        ...
        {
            bool result = CG_00000038_AncestorsDescendants.Solution_0_Test(input);
