...
{
    [TestClass]
    public sealed class CG_00000404_MapColorations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000404_MapColorations));
        ...
        {
            bool result = CG_00000404_MapColorations.Solution_0_Test(input);
