...
{
    [TestClass]
    public sealed class CG_00000648_TheBridge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000648_TheBridge));
        ...
        {
            bool result = CG_00000648_TheBridge.Solution_0_Test(input);
