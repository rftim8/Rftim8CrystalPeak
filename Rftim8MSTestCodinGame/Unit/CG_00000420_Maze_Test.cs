...
{
    [TestClass]
    public sealed class CG_00000420_Maze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000420_Maze));
        ...
        {
            bool result = CG_00000420_Maze.Solution_0_Test(input);
