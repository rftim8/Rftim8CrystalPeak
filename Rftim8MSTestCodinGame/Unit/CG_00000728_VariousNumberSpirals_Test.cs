...
{
    [TestClass]
    public sealed class CG_00000728_VariousNumberSpirals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000728_VariousNumberSpirals));
        ...
        {
            bool result = CG_00000728_VariousNumberSpirals.Solution_0_Test(input);
