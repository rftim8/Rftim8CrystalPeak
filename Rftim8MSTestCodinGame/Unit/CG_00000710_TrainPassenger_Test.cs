...
{
    [TestClass]
    public sealed class CG_00000710_TrainPassenger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000710_TrainPassenger));
        ...
        {
            bool result = CG_00000710_TrainPassenger.Solution_0_Test(input);
