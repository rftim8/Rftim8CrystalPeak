...
{
    [TestClass]
    public sealed class CG_00000433_MinimalNumberOfSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000433_MinimalNumberOfSwaps));
        ...
        {
            bool result = CG_00000433_MinimalNumberOfSwaps.Solution_0_Test(input);
