...
{
    [TestClass]
    public sealed class CG_00000004_111RubiksCubeMovements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000004_111RubiksCubeMovements));
        ...
        {
            bool result = CG_00000004_111RubiksCubeMovements.Solution_0_Test(input);
