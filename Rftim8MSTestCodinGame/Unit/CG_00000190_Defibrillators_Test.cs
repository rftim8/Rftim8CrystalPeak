...
{
    [TestClass]
    public sealed class CG_00000190_Defibrillators_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000190_Defibrillators));
        ...
        {
            bool result = CG_00000190_Defibrillators.Solution_0_Test(input);
