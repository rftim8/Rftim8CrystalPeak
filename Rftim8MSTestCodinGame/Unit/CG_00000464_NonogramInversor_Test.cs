...
{
    [TestClass]
    public sealed class CG_00000464_NonogramInversor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000464_NonogramInversor));
        ...
        {
            bool result = CG_00000464_NonogramInversor.Solution_0_Test(input);
