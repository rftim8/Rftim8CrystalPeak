...
{
    [TestClass]
    public sealed class CG_00000556_Rubik_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000556_Rubik));
        ...
        {
            bool result = CG_00000556_Rubik.Solution_0_Test(input);
