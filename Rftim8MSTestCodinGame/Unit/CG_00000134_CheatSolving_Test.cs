...
{
    [TestClass]
    public sealed class CG_00000134_CheatSolving_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000134_CheatSolving));
        ...
        {
            bool result = CG_00000134_CheatSolving.Solution_0_Test(input);
