...
{
    [TestClass]
    public sealed class CG_00000500_PicturePuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000500_PicturePuzzle));
        ...
        {
            bool result = CG_00000500_PicturePuzzle.Solution_0_Test(input);
