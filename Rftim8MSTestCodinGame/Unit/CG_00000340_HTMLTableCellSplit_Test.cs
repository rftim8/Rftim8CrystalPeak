...
{
    [TestClass]
    public sealed class CG_00000340_HTMLTableCellSplit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000340_HTMLTableCellSplit));
        ...
        {
            bool result = CG_00000340_HTMLTableCellSplit.Solution_0_Test(input);
