...
{
    [TestClass]
    public sealed class CG_00000153_ConnectTheHyperDots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000153_ConnectTheHyperDots));
        ...
        {
            bool result = CG_00000153_ConnectTheHyperDots.Solution_0_Test(input);
