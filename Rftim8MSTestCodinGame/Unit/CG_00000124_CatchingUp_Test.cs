...
{
    [TestClass]
    public sealed class CG_00000124_CatchingUp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000124_CatchingUp));
        ...
        {
            bool result = CG_00000124_CatchingUp.Solution_0_Test(input);
