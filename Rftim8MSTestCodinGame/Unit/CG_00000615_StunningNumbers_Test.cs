...
{
    [TestClass]
    public sealed class CG_00000615_StunningNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000615_StunningNumbers));
        ...
        {
            bool result = CG_00000615_StunningNumbers.Solution_0_Test(input);
