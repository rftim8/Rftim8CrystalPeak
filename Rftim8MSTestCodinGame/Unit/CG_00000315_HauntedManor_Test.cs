...
{
    [TestClass]
    public sealed class CG_00000315_HauntedManor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000315_HauntedManor));
        ...
        {
            bool result = CG_00000315_HauntedManor.Solution_0_Test(input);
