...
{
    [TestClass]
    public sealed class CG_00000739_War_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000739_War));
        ...
        {
            bool result = CG_00000739_War.Solution_0_Test(input);
