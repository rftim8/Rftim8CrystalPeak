...
{
    [TestClass]
    public sealed class CG_00000130_ChainedMatrixProducts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000130_ChainedMatrixProducts));
        ...
        {
            bool result = CG_00000130_ChainedMatrixProducts.Solution_0_Test(input);
