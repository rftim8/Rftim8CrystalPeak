...
{
    [TestClass]
    public sealed class CG_00000287_FurlongsPerFortnight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000287_FurlongsPerFortnight));
        ...
        {
            bool result = CG_00000287_FurlongsPerFortnight.Solution_0_Test(input);
