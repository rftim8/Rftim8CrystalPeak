...
{
    [TestClass]
    public sealed class CG_00000113_BytePairEncoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000113_BytePairEncoding));
        ...
        {
            bool result = CG_00000113_BytePairEncoding.Solution_0_Test(input);
