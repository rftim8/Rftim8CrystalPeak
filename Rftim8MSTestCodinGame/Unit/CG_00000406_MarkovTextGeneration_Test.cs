...
{
    [TestClass]
    public sealed class CG_00000406_MarkovTextGeneration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000406_MarkovTextGeneration));
        ...
        {
            bool result = CG_00000406_MarkovTextGeneration.Solution_0_Test(input);
