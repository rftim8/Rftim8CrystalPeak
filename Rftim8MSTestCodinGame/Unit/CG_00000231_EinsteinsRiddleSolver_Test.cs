...
{
    [TestClass]
    public sealed class CG_00000231_EinsteinsRiddleSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000231_EinsteinsRiddleSolver));
        ...
        {
            bool result = CG_00000231_EinsteinsRiddleSolver.Solution_0_Test(input);
