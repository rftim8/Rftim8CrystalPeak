...
{
    [TestClass]
    public sealed class CG_00000394_Ltriominoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000394_Ltriominoes));
        ...
        {
            bool result = CG_00000394_Ltriominoes.Solution_0_Test(input);
