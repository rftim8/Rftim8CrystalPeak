...
{
    [TestClass]
    public sealed class CG_00000053_AssignmentsAreBoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000053_AssignmentsAreBoring));
        ...
        {
            bool result = CG_00000053_AssignmentsAreBoring.Solution_0_Test(input);
