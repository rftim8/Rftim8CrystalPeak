...
{
    [TestClass]
    public sealed class CG_00000677_TheMaxSurfaceBox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000677_TheMaxSurfaceBox));
        ...
        {
            bool result = CG_00000677_TheMaxSurfaceBox.Solution_0_Test(input);
