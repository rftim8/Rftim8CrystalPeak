...
{
    [TestClass]
    public sealed class CG_00000308_GuessingNCheating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000308_GuessingNCheating));
        ...
        {
            bool result = CG_00000308_GuessingNCheating.Solution_0_Test(input);
