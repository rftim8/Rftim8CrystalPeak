...
{
    [TestClass]
    public sealed class CG_00000630_TabloidCoupleNames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000630_TabloidCoupleNames));
        ...
        {
            bool result = CG_00000630_TabloidCoupleNames.Solution_0_Test(input);
