...
{
    [TestClass]
    public sealed class CG_00000294_GhostLegs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000294_GhostLegs));
        ...
        {
            bool result = CG_00000294_GhostLegs.Solution_0_Test(input);
