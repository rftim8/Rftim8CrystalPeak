...
{
    [TestClass]
    public sealed class CG_00000566_SelfCheckoutMachine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000566_SelfCheckoutMachine));
        ...
        {
            bool result = CG_00000566_SelfCheckoutMachine.Solution_0_Test(input);
