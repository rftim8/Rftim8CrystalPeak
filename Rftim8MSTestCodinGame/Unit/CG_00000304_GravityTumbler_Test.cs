...
{
    [TestClass]
    public sealed class CG_00000304_GravityTumbler_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000304_GravityTumbler));
        ...
        {
            bool result = CG_00000304_GravityTumbler.Solution_0_Test(input);
