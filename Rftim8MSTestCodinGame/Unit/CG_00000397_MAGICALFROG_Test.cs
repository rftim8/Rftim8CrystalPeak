...
{
    [TestClass]
    public sealed class CG_00000397_MAGICALFROG_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000397_MAGICALFROG));
        ...
        {
            bool result = CG_00000397_MAGICALFROG.Solution_0_Test(input);
