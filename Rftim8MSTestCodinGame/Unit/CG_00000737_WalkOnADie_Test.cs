...
{
    [TestClass]
    public sealed class CG_00000737_WalkOnADie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000737_WalkOnADie));
        ...
        {
            bool result = CG_00000737_WalkOnADie.Solution_0_Test(input);
