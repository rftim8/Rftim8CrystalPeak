...
{
    [TestClass]
    public sealed class CG_00000309_HackingAtRobberCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000309_HackingAtRobberCity));
        ...
        {
            bool result = CG_00000309_HackingAtRobberCity.Solution_0_Test(input);
