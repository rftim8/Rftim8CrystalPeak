...
{
    [TestClass]
    public sealed class CG_00000429_MindCracker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000429_MindCracker));
        ...
        {
            bool result = CG_00000429_MindCracker.Solution_0_Test(input);
