...
{
    [TestClass]
    public sealed class CG_00000625_Surface_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000625_Surface));
        ...
        {
            bool result = CG_00000625_Surface.Solution_0_Test(input);
