...
{
    [TestClass]
    public sealed class CG_00000200_DeusHexMachina_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000200_DeusHexMachina));
        ...
        {
            bool result = CG_00000200_DeusHexMachina.Solution_0_Test(input);
