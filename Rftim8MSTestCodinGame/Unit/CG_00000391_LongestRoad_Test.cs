...
{
    [TestClass]
    public sealed class CG_00000391_LongestRoad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000391_LongestRoad));
        ...
        {
            bool result = CG_00000391_LongestRoad.Solution_0_Test(input);
