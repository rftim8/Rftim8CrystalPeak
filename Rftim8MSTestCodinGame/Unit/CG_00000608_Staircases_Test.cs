...
{
    [TestClass]
    public sealed class CG_00000608_Staircases_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000608_Staircases));
        ...
        {
            bool result = CG_00000608_Staircases.Solution_0_Test(input);
