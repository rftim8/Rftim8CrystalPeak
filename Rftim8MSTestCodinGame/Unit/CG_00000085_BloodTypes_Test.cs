...
{
    [TestClass]
    public sealed class CG_00000085_BloodTypes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000085_BloodTypes));
        ...
        {
            bool result = CG_00000085_BloodTypes.Solution_0_Test(input);
