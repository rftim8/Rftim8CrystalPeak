...
{
    [TestClass]
    public sealed class CG_00000681_TheOtherSide_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000681_TheOtherSide));
        ...
        {
            bool result = CG_00000681_TheOtherSide.Solution_0_Test(input);
