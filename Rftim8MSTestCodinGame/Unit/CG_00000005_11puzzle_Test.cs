...
{
    [TestClass]
    public sealed class CG_00000005_11puzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000005_11puzzle));
        ...
        {
            bool result = CG_00000005_11puzzle.Solution_0_Test(input);
