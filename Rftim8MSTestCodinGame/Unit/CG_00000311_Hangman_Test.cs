...
{
    [TestClass]
    public sealed class CG_00000311_Hangman_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000311_Hangman));
        ...
        {
            bool result = CG_00000311_Hangman.Solution_0_Test(input);
