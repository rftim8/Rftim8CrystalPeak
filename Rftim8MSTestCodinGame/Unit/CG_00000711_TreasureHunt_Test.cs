...
{
    [TestClass]
    public sealed class CG_00000711_TreasureHunt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000711_TreasureHunt));
        ...
        {
            bool result = CG_00000711_TreasureHunt.Solution_0_Test(input);
