...
{
    [TestClass]
    public sealed class CG_00000261_Fibonomials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000261_Fibonomials));
        ...
        {
            bool result = CG_00000261_Fibonomials.Solution_0_Test(input);
