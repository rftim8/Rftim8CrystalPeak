...
{
    [TestClass]
    public sealed class CG_00000473_NumeralSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000473_NumeralSystem));
        ...
        {
            bool result = CG_00000473_NumeralSystem.Solution_0_Test(input);
