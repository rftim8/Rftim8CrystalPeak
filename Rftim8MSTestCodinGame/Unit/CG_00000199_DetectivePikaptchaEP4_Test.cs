...
{
    [TestClass]
    public sealed class CG_00000199_DetectivePikaptchaEP4_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000199_DetectivePikaptchaEP4));
        ...
        {
            bool result = CG_00000199_DetectivePikaptchaEP4.Solution_0_Test(input);
