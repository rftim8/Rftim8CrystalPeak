...
{
    [TestClass]
    public sealed class CG_00000360_JumpingFrog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000360_JumpingFrog));
        ...
        {
            bool result = CG_00000360_JumpingFrog.Solution_0_Test(input);
