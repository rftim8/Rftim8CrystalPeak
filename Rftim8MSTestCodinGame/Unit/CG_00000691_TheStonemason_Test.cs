...
{
    [TestClass]
    public sealed class CG_00000691_TheStonemason_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000691_TheStonemason));
        ...
        {
            bool result = CG_00000691_TheStonemason.Solution_0_Test(input);
