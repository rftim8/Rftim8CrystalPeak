...
{
    [TestClass]
    public sealed class CG_00000749_WindmillProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000749_WindmillProblem));
        ...
        {
            bool result = CG_00000749_WindmillProblem.Solution_0_Test(input);
