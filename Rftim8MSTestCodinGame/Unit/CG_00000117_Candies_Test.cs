...
{
    [TestClass]
    public sealed class CG_00000117_Candies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000117_Candies));
        ...
        {
            bool result = CG_00000117_Candies.Solution_0_Test(input);
