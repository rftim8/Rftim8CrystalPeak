...
{
    [TestClass]
    public sealed class CG_00000490_PARKPILOT_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000490_PARKPILOT));
        ...
        {
            bool result = CG_00000490_PARKPILOT.Solution_0_Test(input);
