...
{
    [TestClass]
    public sealed class CG_00000114_ByTrainOrByCar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000114_ByTrainOrByCar));
        ...
        {
            bool result = CG_00000114_ByTrainOrByCar.Solution_0_Test(input);
