...
{
    [TestClass]
    public sealed class CG_00000033_AManWithAPlan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000033_AManWithAPlan));
        ...
        {
            bool result = CG_00000033_AManWithAPlan.Solution_0_Test(input);
