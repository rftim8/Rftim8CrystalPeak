...
{
    [TestClass]
    public sealed class CG_00000355_IsThatAPossibleWord_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000355_IsThatAPossibleWord));
        ...
        {
            bool result = CG_00000355_IsThatAPossibleWord.Solution_0_Test(input);
