...
{
    [TestClass]
    public sealed class CG_00000122_CarmichaelNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000122_CarmichaelNumbers));
        ...
        {
            bool result = CG_00000122_CarmichaelNumbers.Solution_0_Test(input);
