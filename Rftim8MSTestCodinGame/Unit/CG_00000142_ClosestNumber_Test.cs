...
{
    [TestClass]
    public sealed class CG_00000142_ClosestNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000142_ClosestNumber));
        ...
        {
            bool result = CG_00000142_ClosestNumber.Solution_0_Test(input);
