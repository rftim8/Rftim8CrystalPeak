...
{
    [TestClass]
    public sealed class CG_00000177_Cryptarithm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000177_Cryptarithm));
        ...
        {
            bool result = CG_00000177_Cryptarithm.Solution_0_Test(input);
