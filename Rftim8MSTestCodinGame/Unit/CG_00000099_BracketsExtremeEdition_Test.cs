...
{
    [TestClass]
    public sealed class CG_00000099_BracketsExtremeEdition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000099_BracketsExtremeEdition));
        ...
        {
            bool result = CG_00000099_BracketsExtremeEdition.Solution_0_Test(input);
