...
{
    [TestClass]
    public sealed class CG_00000276_FoldingPaper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000276_FoldingPaper));
        ...
        {
            bool result = CG_00000276_FoldingPaper.Solution_0_Test(input);
