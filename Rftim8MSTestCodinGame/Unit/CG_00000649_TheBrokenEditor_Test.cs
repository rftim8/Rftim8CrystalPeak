...
{
    [TestClass]
    public sealed class CG_00000649_TheBrokenEditor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000649_TheBrokenEditor));
        ...
        {
            bool result = CG_00000649_TheBrokenEditor.Solution_0_Test(input);
