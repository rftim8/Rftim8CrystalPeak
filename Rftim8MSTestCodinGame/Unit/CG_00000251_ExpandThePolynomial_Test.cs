...
{
    [TestClass]
    public sealed class CG_00000251_ExpandThePolynomial_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000251_ExpandThePolynomial));
        ...
        {
            bool result = CG_00000251_ExpandThePolynomial.Solution_0_Test(input);
