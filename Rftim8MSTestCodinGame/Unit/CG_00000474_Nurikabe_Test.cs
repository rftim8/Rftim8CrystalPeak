...
{
    [TestClass]
    public sealed class CG_00000474_Nurikabe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000474_Nurikabe));
        ...
        {
            bool result = CG_00000474_Nurikabe.Solution_0_Test(input);
