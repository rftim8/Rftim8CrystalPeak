...
{
    [TestClass]
    public sealed class CG_00000174_CropCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000174_CropCircles));
        ...
        {
            bool result = CG_00000174_CropCircles.Solution_0_Test(input);
