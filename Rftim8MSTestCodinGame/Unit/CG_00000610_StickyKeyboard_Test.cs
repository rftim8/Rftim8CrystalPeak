...
{
    [TestClass]
    public sealed class CG_00000610_StickyKeyboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000610_StickyKeyboard));
        ...
        {
            bool result = CG_00000610_StickyKeyboard.Solution_0_Test(input);
