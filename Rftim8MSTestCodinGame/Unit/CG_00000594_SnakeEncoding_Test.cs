...
{
    [TestClass]
    public sealed class CG_00000594_SnakeEncoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000594_SnakeEncoding));
        ...
        {
            bool result = CG_00000594_SnakeEncoding.Solution_0_Test(input);
