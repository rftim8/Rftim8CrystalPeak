...
{
    [TestClass]
    public sealed class CG_00000279_FractalCarpet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000279_FractalCarpet));
        ...
        {
            bool result = CG_00000279_FractalCarpet.Solution_0_Test(input);
