...
{
    [TestClass]
    public sealed class CG_00000502_PlaceTheParenthesis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000502_PlaceTheParenthesis));
        ...
        {
            bool result = CG_00000502_PlaceTheParenthesis.Solution_0_Test(input);
