...
{
    [TestClass]
    public sealed class CG_00000225_DungeonDesigner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000225_DungeonDesigner));
        ...
        {
            bool result = CG_00000225_DungeonDesigner.Solution_0_Test(input);
