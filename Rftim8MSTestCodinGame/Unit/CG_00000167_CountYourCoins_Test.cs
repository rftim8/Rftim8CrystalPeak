...
{
    [TestClass]
    public sealed class CG_00000167_CountYourCoins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000167_CountYourCoins));
        ...
        {
            bool result = CG_00000167_CountYourCoins.Solution_0_Test(input);
