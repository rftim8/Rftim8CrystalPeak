...
{
    [TestClass]
    public sealed class CG_00000627_SweetSpot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000627_SweetSpot));
        ...
        {
            bool result = CG_00000627_SweetSpot.Solution_0_Test(input);
