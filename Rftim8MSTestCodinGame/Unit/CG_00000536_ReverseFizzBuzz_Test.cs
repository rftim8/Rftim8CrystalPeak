...
{
    [TestClass]
    public sealed class CG_00000536_ReverseFizzBuzz_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000536_ReverseFizzBuzz));
        ...
        {
            bool result = CG_00000536_ReverseFizzBuzz.Solution_0_Test(input);
