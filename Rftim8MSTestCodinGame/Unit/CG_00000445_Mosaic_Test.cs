...
{
    [TestClass]
    public sealed class CG_00000445_Mosaic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000445_Mosaic));
        ...
        {
            bool result = CG_00000445_Mosaic.Solution_0_Test(input);
