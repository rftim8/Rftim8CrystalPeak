...
{
    [TestClass]
    public sealed class CG_00000353_IPv6Shortener_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000353_IPv6Shortener));
        ...
        {
            bool result = CG_00000353_IPv6Shortener.Solution_0_Test(input);
