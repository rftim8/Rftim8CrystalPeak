...
{
    [TestClass]
    public sealed class CG_00000549_RockPaperScissorsWar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000549_RockPaperScissorsWar));
        ...
        {
            bool result = CG_00000549_RockPaperScissorsWar.Solution_0_Test(input);
