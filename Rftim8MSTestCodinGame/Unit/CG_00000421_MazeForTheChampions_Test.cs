...
{
    [TestClass]
    public sealed class CG_00000421_MazeForTheChampions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000421_MazeForTheChampions));
        ...
        {
            bool result = CG_00000421_MazeForTheChampions.Solution_0_Test(input);
