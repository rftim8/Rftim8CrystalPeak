...
{
    [TestClass]
    public sealed class CG_00000383_LibraryDependencies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000383_LibraryDependencies));
        ...
        {
            bool result = CG_00000383_LibraryDependencies.Solution_0_Test(input);
