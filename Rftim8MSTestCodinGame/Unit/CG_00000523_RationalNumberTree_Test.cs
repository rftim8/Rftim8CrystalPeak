...
{
    [TestClass]
    public sealed class CG_00000523_RationalNumberTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000523_RationalNumberTree));
        ...
        {
            bool result = CG_00000523_RationalNumberTree.Solution_0_Test(input);
