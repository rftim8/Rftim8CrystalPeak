...
{
    [TestClass]
    public sealed class CG_00000448_MovesInMaze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000448_MovesInMaze));
        ...
        {
            bool result = CG_00000448_MovesInMaze.Solution_0_Test(input);
