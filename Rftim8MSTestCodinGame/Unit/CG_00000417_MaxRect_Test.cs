...
{
    [TestClass]
    public sealed class CG_00000417_MaxRect_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000417_MaxRect));
        ...
        {
            bool result = CG_00000417_MaxRect.Solution_0_Test(input);
