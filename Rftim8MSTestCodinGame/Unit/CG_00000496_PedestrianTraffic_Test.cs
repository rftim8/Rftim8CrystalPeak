...
{
    [TestClass]
    public sealed class CG_00000496_PedestrianTraffic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000496_PedestrianTraffic));
        ...
        {
            bool result = CG_00000496_PedestrianTraffic.Solution_0_Test(input);
