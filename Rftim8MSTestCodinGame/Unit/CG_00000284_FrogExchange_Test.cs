...
{
    [TestClass]
    public sealed class CG_00000284_FrogExchange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000284_FrogExchange));
        ...
        {
            bool result = CG_00000284_FrogExchange.Solution_0_Test(input);
