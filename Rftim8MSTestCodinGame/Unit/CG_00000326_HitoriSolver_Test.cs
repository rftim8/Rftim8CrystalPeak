...
{
    [TestClass]
    public sealed class CG_00000326_HitoriSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000326_HitoriSolver));
        ...
        {
            bool result = CG_00000326_HitoriSolver.Solution_0_Test(input);
