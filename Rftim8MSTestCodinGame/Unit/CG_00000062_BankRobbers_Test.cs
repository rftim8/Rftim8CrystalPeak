...
{
    [TestClass]
    public sealed class CG_00000062_BankRobbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000062_BankRobbers));
        ...
        {
            bool result = CG_00000062_BankRobbers.Solution_0_Test(input);
