...
{
    [TestClass]
    public sealed class CG_00000427_MicroAssembly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000427_MicroAssembly));
        ...
        {
            bool result = CG_00000427_MicroAssembly.Solution_0_Test(input);
