...
{
    [TestClass]
    public sealed class CG_00000169_CrazyList_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000169_CrazyList));
        ...
        {
            bool result = CG_00000169_CrazyList.Solution_0_Test(input);
