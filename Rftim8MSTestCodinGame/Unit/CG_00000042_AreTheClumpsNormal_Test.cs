...
{
    [TestClass]
    public sealed class CG_00000042_AreTheClumpsNormal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000042_AreTheClumpsNormal));
        ...
        {
            bool result = CG_00000042_AreTheClumpsNormal.Solution_0_Test(input);
