...
{
    [TestClass]
    public sealed class CG_00000511_PrefixCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000511_PrefixCode));
        ...
        {
            bool result = CG_00000511_PrefixCode.Solution_0_Test(input);
