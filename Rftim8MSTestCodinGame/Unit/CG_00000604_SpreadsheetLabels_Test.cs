...
{
    [TestClass]
    public sealed class CG_00000604_SpreadsheetLabels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000604_SpreadsheetLabels));
        ...
        {
            bool result = CG_00000604_SpreadsheetLabels.Solution_0_Test(input);
