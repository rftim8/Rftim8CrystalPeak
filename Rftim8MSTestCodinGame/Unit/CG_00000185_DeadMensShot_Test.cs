...
{
    [TestClass]
    public sealed class CG_00000185_DeadMensShot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000185_DeadMensShot));
        ...
        {
            bool result = CG_00000185_DeadMensShot.Solution_0_Test(input);
