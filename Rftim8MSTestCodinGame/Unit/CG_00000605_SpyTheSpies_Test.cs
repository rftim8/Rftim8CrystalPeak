...
{
    [TestClass]
    public sealed class CG_00000605_SpyTheSpies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000605_SpyTheSpies));
        ...
        {
            bool result = CG_00000605_SpyTheSpies.Solution_0_Test(input);
