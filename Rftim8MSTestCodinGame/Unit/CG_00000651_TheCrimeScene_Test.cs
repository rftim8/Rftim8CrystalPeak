...
{
    [TestClass]
    public sealed class CG_00000651_TheCrimeScene_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000651_TheCrimeScene));
        ...
        {
            bool result = CG_00000651_TheCrimeScene.Solution_0_Test(input);
