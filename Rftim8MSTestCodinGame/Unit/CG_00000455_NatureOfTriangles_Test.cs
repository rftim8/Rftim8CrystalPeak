...
{
    [TestClass]
    public sealed class CG_00000455_NatureOfTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000455_NatureOfTriangles));
        ...
        {
            bool result = CG_00000455_NatureOfTriangles.Solution_0_Test(input);
