...
{
    [TestClass]
    public sealed class CG_00000247_EuclidsAlgorithm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000247_EuclidsAlgorithm));
        ...
        {
            bool result = CG_00000247_EuclidsAlgorithm.Solution_0_Test(input);
