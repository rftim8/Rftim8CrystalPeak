...
{
    [TestClass]
    public sealed class CG_00000535_ReversedLookandsay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000535_ReversedLookandsay));
        ...
        {
            bool result = CG_00000535_ReversedLookandsay.Solution_0_Test(input);
