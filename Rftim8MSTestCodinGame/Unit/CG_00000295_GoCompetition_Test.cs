...
{
    [TestClass]
    public sealed class CG_00000295_GoCompetition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000295_GoCompetition));
        ...
        {
            bool result = CG_00000295_GoCompetition.Solution_0_Test(input);
