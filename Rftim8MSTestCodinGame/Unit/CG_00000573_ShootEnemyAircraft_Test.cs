...
{
    [TestClass]
    public sealed class CG_00000573_ShootEnemyAircraft_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000573_ShootEnemyAircraft));
        ...
        {
            bool result = CG_00000573_ShootEnemyAircraft.Solution_0_Test(input);
