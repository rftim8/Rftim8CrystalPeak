...
{
    [TestClass]
    public sealed class CG_00000047_ASCIIArtQRCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000047_ASCIIArtQRCode));
        ...
        {
            bool result = CG_00000047_ASCIIArtQRCode.Solution_0_Test(input);
