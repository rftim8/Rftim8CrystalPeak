...
{
    [TestClass]
    public sealed class CG_00000302_GravityCentrifuge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000302_GravityCentrifuge));
        ...
        {
            bool result = CG_00000302_GravityCentrifuge.Solution_0_Test(input);
