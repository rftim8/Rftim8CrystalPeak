...
{
    [TestClass]
    public sealed class CG_00000611_StockExchangeLosses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000611_StockExchangeLosses));
        ...
        {
            bool result = CG_00000611_StockExchangeLosses.Solution_0_Test(input);
