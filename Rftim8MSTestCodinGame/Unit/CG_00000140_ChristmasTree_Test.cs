...
{
    [TestClass]
    public sealed class CG_00000140_ChristmasTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000140_ChristmasTree));
        ...
        {
            bool result = CG_00000140_ChristmasTree.Solution_0_Test(input);
