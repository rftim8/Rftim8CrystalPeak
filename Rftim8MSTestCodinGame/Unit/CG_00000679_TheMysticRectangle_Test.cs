...
{
    [TestClass]
    public sealed class CG_00000679_TheMysticRectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000679_TheMysticRectangle));
        ...
        {
            bool result = CG_00000679_TheMysticRectangle.Solution_0_Test(input);
