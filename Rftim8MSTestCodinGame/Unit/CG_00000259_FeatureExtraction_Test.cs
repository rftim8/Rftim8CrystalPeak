...
{
    [TestClass]
    public sealed class CG_00000259_FeatureExtraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000259_FeatureExtraction));
        ...
        {
            bool result = CG_00000259_FeatureExtraction.Solution_0_Test(input);
