...
{
    [TestClass]
    public sealed class CG_00000281_FrameThePicture_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000281_FrameThePicture));
        ...
        {
            bool result = CG_00000281_FrameThePicture.Solution_0_Test(input);
