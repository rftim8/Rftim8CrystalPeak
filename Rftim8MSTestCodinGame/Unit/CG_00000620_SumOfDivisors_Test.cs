...
{
    [TestClass]
    public sealed class CG_00000620_SumOfDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000620_SumOfDivisors));
        ...
        {
            bool result = CG_00000620_SumOfDivisors.Solution_0_Test(input);
