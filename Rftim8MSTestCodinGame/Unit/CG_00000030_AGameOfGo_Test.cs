...
{
    [TestClass]
    public sealed class CG_00000030_AGameOfGo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000030_AGameOfGo));
        ...
        {
            bool result = CG_00000030_AGameOfGo.Solution_0_Test(input);
