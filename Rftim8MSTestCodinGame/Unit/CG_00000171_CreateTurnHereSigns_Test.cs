...
{
    [TestClass]
    public sealed class CG_00000171_CreateTurnHereSigns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000171_CreateTurnHereSigns));
        ...
        {
            bool result = CG_00000171_CreateTurnHereSigns.Solution_0_Test(input);
