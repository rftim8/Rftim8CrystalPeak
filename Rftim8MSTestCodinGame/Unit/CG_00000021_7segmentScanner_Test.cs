...
{
    [TestClass]
    public sealed class CG_00000021_7segmentScanner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000021_7segmentScanner));
        ...
        {
            bool result = CG_00000021_7segmentScanner.Solution_0_Test(input);
