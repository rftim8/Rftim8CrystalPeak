...
{
    [TestClass]
    public sealed class CG_00000407_MarsColonization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000407_MarsColonization));
        ...
        {
            bool result = CG_00000407_MarsColonization.Solution_0_Test(input);
