...
{
    [TestClass]
    public sealed class CG_00000372_KolakoskiSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000372_KolakoskiSequence));
        ...
        {
            bool result = CG_00000372_KolakoskiSequence.Solution_0_Test(input);
