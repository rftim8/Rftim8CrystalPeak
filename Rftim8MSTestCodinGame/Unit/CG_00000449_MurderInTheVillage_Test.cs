...
{
    [TestClass]
    public sealed class CG_00000449_MurderInTheVillage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000449_MurderInTheVillage));
        ...
        {
            bool result = CG_00000449_MurderInTheVillage.Solution_0_Test(input);
