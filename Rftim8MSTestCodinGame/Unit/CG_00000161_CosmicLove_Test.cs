...
{
    [TestClass]
    public sealed class CG_00000161_CosmicLove_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000161_CosmicLove));
        ...
        {
            bool result = CG_00000161_CosmicLove.Solution_0_Test(input);
