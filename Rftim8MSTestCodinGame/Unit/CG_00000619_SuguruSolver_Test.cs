...
{
    [TestClass]
    public sealed class CG_00000619_SuguruSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000619_SuguruSolver));
        ...
        {
            bool result = CG_00000619_SuguruSolver.Solution_0_Test(input);
