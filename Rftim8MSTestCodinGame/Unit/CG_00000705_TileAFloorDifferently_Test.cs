...
{
    [TestClass]
    public sealed class CG_00000705_TileAFloorDifferently_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000705_TileAFloorDifferently));
        ...
        {
            bool result = CG_00000705_TileAFloorDifferently.Solution_0_Test(input);
