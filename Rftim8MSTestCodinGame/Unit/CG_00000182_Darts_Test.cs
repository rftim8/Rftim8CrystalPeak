...
{
    [TestClass]
    public sealed class CG_00000182_Darts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000182_Darts));
        ...
        {
            bool result = CG_00000182_Darts.Solution_0_Test(input);
