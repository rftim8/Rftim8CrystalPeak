...
{
    [TestClass]
    public sealed class CG_00000131_ChainReaction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000131_ChainReaction));
        ...
        {
            bool result = CG_00000131_ChainReaction.Solution_0_Test(input);
