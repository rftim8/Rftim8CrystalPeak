...
{
    [TestClass]
    public sealed class CG_00000096_BoxOfCigars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000096_BoxOfCigars));
        ...
        {
            bool result = CG_00000096_BoxOfCigars.Solution_0_Test(input);
