...
{
    [TestClass]
    public sealed class CG_00000098_BracketsExtendedEdition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000098_BracketsExtendedEdition));
        ...
        {
            bool result = CG_00000098_BracketsExtendedEdition.Solution_0_Test(input);
