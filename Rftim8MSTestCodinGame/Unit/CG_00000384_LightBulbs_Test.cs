...
{
    [TestClass]
    public sealed class CG_00000384_LightBulbs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000384_LightBulbs));
        ...
        {
            bool result = CG_00000384_LightBulbs.Solution_0_Test(input);
