...
{
    [TestClass]
    public sealed class CG_00000327_HitTheRoad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000327_HitTheRoad));
        ...
        {
            bool result = CG_00000327_HitTheRoad.Solution_0_Test(input);
