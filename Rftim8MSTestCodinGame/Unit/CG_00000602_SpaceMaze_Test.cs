...
{
    [TestClass]
    public sealed class CG_00000602_SpaceMaze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000602_SpaceMaze));
        ...
        {
            bool result = CG_00000602_SpaceMaze.Solution_0_Test(input);
