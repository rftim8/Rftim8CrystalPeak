...
{
    [TestClass]
    public sealed class CG_00000093_Boggle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000093_Boggle));
        ...
        {
            bool result = CG_00000093_Boggle.Solution_0_Test(input);
