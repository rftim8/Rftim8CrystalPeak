...
{
    [TestClass]
    public sealed class CG_00000321_HiddenMessagesInImages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000321_HiddenMessagesInImages));
        ...
        {
            bool result = CG_00000321_HiddenMessagesInImages.Solution_0_Test(input);
