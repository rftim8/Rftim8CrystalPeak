...
{
    [TestClass]
    public sealed class CG_00000278_FormatStringValidation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000278_FormatStringValidation));
        ...
        {
            bool result = CG_00000278_FormatStringValidation.Solution_0_Test(input);
