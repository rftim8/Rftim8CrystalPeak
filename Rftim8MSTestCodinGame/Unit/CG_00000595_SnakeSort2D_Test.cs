...
{
    [TestClass]
    public sealed class CG_00000595_SnakeSort2D_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000595_SnakeSort2D));
        ...
        {
            bool result = CG_00000595_SnakeSort2D.Solution_0_Test(input);
