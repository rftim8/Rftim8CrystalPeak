...
{
    [TestClass]
    public sealed class CG_00000138_ChessCavalry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000138_ChessCavalry));
        ...
        {
            bool result = CG_00000138_ChessCavalry.Solution_0_Test(input);
