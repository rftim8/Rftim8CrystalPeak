...
{
    [TestClass]
    public sealed class CG_00000352_IPMaskCalculating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000352_IPMaskCalculating));
        ...
        {
            bool result = CG_00000352_IPMaskCalculating.Solution_0_Test(input);
