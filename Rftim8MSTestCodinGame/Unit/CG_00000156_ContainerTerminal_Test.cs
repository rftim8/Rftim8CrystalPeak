...
{
    [TestClass]
    public sealed class CG_00000156_ContainerTerminal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000156_ContainerTerminal));
        ...
        {
            bool result = CG_00000156_ContainerTerminal.Solution_0_Test(input);
