...
{
    [TestClass]
    public sealed class CG_00000002_10101_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000002_10101));
        ...
        {
            bool result = CG_00000002_10101.Solution_0_Test(input);
