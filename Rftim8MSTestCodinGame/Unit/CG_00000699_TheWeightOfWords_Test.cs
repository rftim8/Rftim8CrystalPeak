...
{
    [TestClass]
    public sealed class CG_00000699_TheWeightOfWords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000699_TheWeightOfWords));
        ...
        {
            bool result = CG_00000699_TheWeightOfWords.Solution_0_Test(input);
