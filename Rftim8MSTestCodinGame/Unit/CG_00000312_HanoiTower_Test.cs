...
{
    [TestClass]
    public sealed class CG_00000312_HanoiTower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000312_HanoiTower));
        ...
        {
            bool result = CG_00000312_HanoiTower.Solution_0_Test(input);
