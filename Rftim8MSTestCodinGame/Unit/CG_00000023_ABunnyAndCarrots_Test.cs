...
{
    [TestClass]
    public sealed class CG_00000023_ABunnyAndCarrots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000023_ABunnyAndCarrots));
        ...
        {
            bool result = CG_00000023_ABunnyAndCarrots.Solution_0_Test(input);
