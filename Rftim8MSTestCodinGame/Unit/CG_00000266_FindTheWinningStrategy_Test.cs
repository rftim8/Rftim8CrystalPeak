...
{
    [TestClass]
    public sealed class CG_00000266_FindTheWinningStrategy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000266_FindTheWinningStrategy));
        ...
        {
            bool result = CG_00000266_FindTheWinningStrategy.Solution_0_Test(input);
