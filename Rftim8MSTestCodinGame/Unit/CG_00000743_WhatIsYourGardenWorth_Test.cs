...
{
    [TestClass]
    public sealed class CG_00000743_WhatIsYourGardenWorth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000743_WhatIsYourGardenWorth));
        ...
        {
            bool result = CG_00000743_WhatIsYourGardenWorth.Solution_0_Test(input);
