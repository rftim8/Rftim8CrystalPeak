...
{
    [TestClass]
    public sealed class CG_00000494_PascalTrapezoid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000494_PascalTrapezoid));
        ...
        {
            bool result = CG_00000494_PascalTrapezoid.Solution_0_Test(input);
