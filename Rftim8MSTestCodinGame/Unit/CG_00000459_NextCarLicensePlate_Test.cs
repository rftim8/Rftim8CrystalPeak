...
{
    [TestClass]
    public sealed class CG_00000459_NextCarLicensePlate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000459_NextCarLicensePlate));
        ...
        {
            bool result = CG_00000459_NextCarLicensePlate.Solution_0_Test(input);
