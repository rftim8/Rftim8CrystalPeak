...
{
    [TestClass]
    public sealed class CG_00000300_GraffitiOnTheFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000300_GraffitiOnTheFence));
        ...
        {
            bool result = CG_00000300_GraffitiOnTheFence.Solution_0_Test(input);
