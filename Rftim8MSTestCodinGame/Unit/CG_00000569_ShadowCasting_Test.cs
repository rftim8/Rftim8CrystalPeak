...
{
    [TestClass]
    public sealed class CG_00000569_ShadowCasting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000569_ShadowCasting));
        ...
        {
            bool result = CG_00000569_ShadowCasting.Solution_0_Test(input);
