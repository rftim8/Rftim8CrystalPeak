...
{
    [TestClass]
    public sealed class CG_00000070_BijectiveNumeration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000070_BijectiveNumeration));
        ...
        {
            bool result = CG_00000070_BijectiveNumeration.Solution_0_Test(input);
