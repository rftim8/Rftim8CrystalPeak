...
{
    [TestClass]
    public sealed class CG_00000204_DigitalScoreboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000204_DigitalScoreboard));
        ...
        {
            bool result = CG_00000204_DigitalScoreboard.Solution_0_Test(input);
