...
{
    [TestClass]
    public sealed class CG_00000347_InertiaRide_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000347_InertiaRide));
        ...
        {
            bool result = CG_00000347_InertiaRide.Solution_0_Test(input);
