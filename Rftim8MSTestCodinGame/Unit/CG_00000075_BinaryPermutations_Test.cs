...
{
    [TestClass]
    public sealed class CG_00000075_BinaryPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000075_BinaryPermutations));
        ...
        {
            bool result = CG_00000075_BinaryPermutations.Solution_0_Test(input);
