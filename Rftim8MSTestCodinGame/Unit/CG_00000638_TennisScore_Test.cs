...
{
    [TestClass]
    public sealed class CG_00000638_TennisScore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000638_TennisScore));
        ...
        {
            bool result = CG_00000638_TennisScore.Solution_0_Test(input);
