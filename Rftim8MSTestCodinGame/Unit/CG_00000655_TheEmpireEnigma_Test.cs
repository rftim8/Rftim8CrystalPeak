...
{
    [TestClass]
    public sealed class CG_00000655_TheEmpireEnigma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000655_TheEmpireEnigma));
        ...
        {
            bool result = CG_00000655_TheEmpireEnigma.Solution_0_Test(input);
