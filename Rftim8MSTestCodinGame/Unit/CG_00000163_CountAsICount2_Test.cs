...
{
    [TestClass]
    public sealed class CG_00000163_CountAsICount2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000163_CountAsICount2));
        ...
        {
            bool result = CG_00000163_CountAsICount2.Solution_0_Test(input);
