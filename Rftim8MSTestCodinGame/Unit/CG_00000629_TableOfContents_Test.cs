...
{
    [TestClass]
    public sealed class CG_00000629_TableOfContents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000629_TableOfContents));
        ...
        {
            bool result = CG_00000629_TableOfContents.Solution_0_Test(input);
