...
{
    [TestClass]
    public sealed class CG_00000392_LostAstronaut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000392_LostAstronaut));
        ...
        {
            bool result = CG_00000392_LostAstronaut.Solution_0_Test(input);
