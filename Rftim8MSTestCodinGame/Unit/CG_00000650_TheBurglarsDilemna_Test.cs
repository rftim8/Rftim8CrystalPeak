...
{
    [TestClass]
    public sealed class CG_00000650_TheBurglarsDilemna_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000650_TheBurglarsDilemna));
        ...
        {
            bool result = CG_00000650_TheBurglarsDilemna.Solution_0_Test(input);
