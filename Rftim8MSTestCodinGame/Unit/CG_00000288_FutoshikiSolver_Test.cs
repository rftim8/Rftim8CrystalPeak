...
{
    [TestClass]
    public sealed class CG_00000288_FutoshikiSolver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000288_FutoshikiSolver));
        ...
        {
            bool result = CG_00000288_FutoshikiSolver.Solution_0_Test(input);
