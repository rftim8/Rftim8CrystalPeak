...
{
    [TestClass]
    public sealed class CG_00000193_DerivativeTimePart1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000193_DerivativeTimePart1));
        ...
        {
            bool result = CG_00000193_DerivativeTimePart1.Solution_0_Test(input);
