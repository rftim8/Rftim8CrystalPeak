...
{
    [TestClass]
    public sealed class CG_00000373_LangtonsAnt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000373_LangtonsAnt));
        ...
        {
            bool result = CG_00000373_LangtonsAnt.Solution_0_Test(input);
