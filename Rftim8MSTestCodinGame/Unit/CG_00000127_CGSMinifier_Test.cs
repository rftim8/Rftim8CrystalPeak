...
{
    [TestClass]
    public sealed class CG_00000127_CGSMinifier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000127_CGSMinifier));
        ...
        {
            bool result = CG_00000127_CGSMinifier.Solution_0_Test(input);
