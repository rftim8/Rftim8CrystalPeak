...
{
    [TestClass]
    public sealed class CG_00000478_OffsetArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000478_OffsetArrays));
        ...
        {
            bool result = CG_00000478_OffsetArrays.Solution_0_Test(input);
