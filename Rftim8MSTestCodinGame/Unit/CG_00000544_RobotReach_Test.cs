...
{
    [TestClass]
    public sealed class CG_00000544_RobotReach_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000544_RobotReach));
        ...
        {
            bool result = CG_00000544_RobotReach.Solution_0_Test(input);
