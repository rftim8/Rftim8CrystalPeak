...
{
    [TestClass]
    public sealed class CG_00000236_EmbeddedChessboards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000236_EmbeddedChessboards));
        ...
        {
            bool result = CG_00000236_EmbeddedChessboards.Solution_0_Test(input);
