...
{
    [TestClass]
    public sealed class CG_00000273_FloodTheWorld_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000273_FloodTheWorld));
        ...
        {
            bool result = CG_00000273_FloodTheWorld.Solution_0_Test(input);
