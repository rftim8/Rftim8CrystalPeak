...
{
    [TestClass]
    public sealed class CG_00000036_Anagrams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000036_Anagrams));
        ...
        {
            bool result = CG_00000036_Anagrams.Solution_0_Test(input);
