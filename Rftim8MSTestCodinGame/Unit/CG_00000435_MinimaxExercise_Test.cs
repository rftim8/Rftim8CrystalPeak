...
{
    [TestClass]
    public sealed class CG_00000435_MinimaxExercise_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000435_MinimaxExercise));
        ...
        {
            bool result = CG_00000435_MinimaxExercise.Solution_0_Test(input);
