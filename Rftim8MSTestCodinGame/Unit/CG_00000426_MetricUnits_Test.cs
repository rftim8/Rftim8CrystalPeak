...
{
    [TestClass]
    public sealed class CG_00000426_MetricUnits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000426_MetricUnits));
        ...
        {
            bool result = CG_00000426_MetricUnits.Solution_0_Test(input);
