...
{
    [TestClass]
    public sealed class CG_00000575_ShouldBakersBeFrugal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000575_ShouldBakersBeFrugal));
        ...
        {
            bool result = CG_00000575_ShouldBakersBeFrugal.Solution_0_Test(input);
