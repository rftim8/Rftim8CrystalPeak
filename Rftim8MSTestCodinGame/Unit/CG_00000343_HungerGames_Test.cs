...
{
    [TestClass]
    public sealed class CG_00000343_HungerGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000343_HungerGames));
        ...
        {
            bool result = CG_00000343_HungerGames.Solution_0_Test(input);
