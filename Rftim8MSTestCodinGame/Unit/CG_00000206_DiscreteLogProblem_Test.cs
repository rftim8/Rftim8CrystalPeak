...
{
    [TestClass]
    public sealed class CG_00000206_DiscreteLogProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000206_DiscreteLogProblem));
        ...
        {
            bool result = CG_00000206_DiscreteLogProblem.Solution_0_Test(input);
