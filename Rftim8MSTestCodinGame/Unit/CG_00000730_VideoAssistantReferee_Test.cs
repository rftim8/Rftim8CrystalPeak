...
{
    [TestClass]
    public sealed class CG_00000730_VideoAssistantReferee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000730_VideoAssistantReferee));
        ...
        {
            bool result = CG_00000730_VideoAssistantReferee.Solution_0_Test(input);
