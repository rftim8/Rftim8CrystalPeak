...
{
    [TestClass]
    public sealed class CG_00000250_ExecutionCircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000250_ExecutionCircle));
        ...
        {
            bool result = CG_00000250_ExecutionCircle.Solution_0_Test(input);
