...
{
    [TestClass]
    public sealed class CG_00000271_FlipTheSign_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000271_FlipTheSign));
        ...
        {
            bool result = CG_00000271_FlipTheSign.Solution_0_Test(input);
