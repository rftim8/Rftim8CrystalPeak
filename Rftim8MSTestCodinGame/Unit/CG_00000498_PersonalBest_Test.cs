...
{
    [TestClass]
    public sealed class CG_00000498_PersonalBest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000498_PersonalBest));
        ...
        {
            bool result = CG_00000498_PersonalBest.Solution_0_Test(input);
