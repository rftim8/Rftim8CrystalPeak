...
{
    [TestClass]
    public sealed class CG_00000112_Buzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000112_Buzzle));
        ...
        {
            bool result = CG_00000112_Buzzle.Solution_0_Test(input);
