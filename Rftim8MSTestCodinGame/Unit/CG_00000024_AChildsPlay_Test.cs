...
{
    [TestClass]
    public sealed class CG_00000024_AChildsPlay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000024_AChildsPlay));
        ...
        {
            bool result = CG_00000024_AChildsPlay.Solution_0_Test(input);
