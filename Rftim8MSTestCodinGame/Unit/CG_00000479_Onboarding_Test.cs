...
{
    [TestClass]
    public sealed class CG_00000479_Onboarding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000479_Onboarding));
        ...
        {
            bool result = CG_00000479_Onboarding.Solution_0_Test(input);
