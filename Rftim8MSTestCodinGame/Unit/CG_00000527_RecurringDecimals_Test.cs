...
{
    [TestClass]
    public sealed class CG_00000527_RecurringDecimals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000527_RecurringDecimals));
        ...
        {
            bool result = CG_00000527_RecurringDecimals.Solution_0_Test(input);
