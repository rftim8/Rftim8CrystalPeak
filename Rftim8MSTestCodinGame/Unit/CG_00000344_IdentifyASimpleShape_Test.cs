...
{
    [TestClass]
    public sealed class CG_00000344_IdentifyASimpleShape_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000344_IdentifyASimpleShape));
        ...
        {
            bool result = CG_00000344_IdentifyASimpleShape.Solution_0_Test(input);
