...
{
    [TestClass]
    public sealed class CG_00000661_TheGift_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000661_TheGift));
        ...
        {
            bool result = CG_00000661_TheGift.Solution_0_Test(input);
