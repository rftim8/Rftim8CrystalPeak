...
{
    [TestClass]
    public sealed class CG_00000632_TANNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000632_TANNetwork));
        ...
        {
            bool result = CG_00000632_TANNetwork.Solution_0_Test(input);
