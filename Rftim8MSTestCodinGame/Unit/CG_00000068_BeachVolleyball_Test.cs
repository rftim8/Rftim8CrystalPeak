...
{
    [TestClass]
    public sealed class CG_00000068_BeachVolleyball_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000068_BeachVolleyball));
        ...
        {
            bool result = CG_00000068_BeachVolleyball.Solution_0_Test(input);
