...
{
    [TestClass]
    public sealed class CG_00000440_MitosisMayhem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000440_MitosisMayhem));
        ...
        {
            bool result = CG_00000440_MitosisMayhem.Solution_0_Test(input);
