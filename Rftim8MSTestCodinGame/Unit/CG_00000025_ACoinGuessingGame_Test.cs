...
{
    [TestClass]
    public sealed class CG_00000025_ACoinGuessingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000025_ACoinGuessingGame));
        ...
        {
            bool result = CG_00000025_ACoinGuessingGame.Solution_0_Test(input);
