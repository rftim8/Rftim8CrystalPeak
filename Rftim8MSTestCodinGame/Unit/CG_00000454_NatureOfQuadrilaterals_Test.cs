...
{
    [TestClass]
    public sealed class CG_00000454_NatureOfQuadrilaterals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000454_NatureOfQuadrilaterals));
        ...
        {
            bool result = CG_00000454_NatureOfQuadrilaterals.Solution_0_Test(input);
