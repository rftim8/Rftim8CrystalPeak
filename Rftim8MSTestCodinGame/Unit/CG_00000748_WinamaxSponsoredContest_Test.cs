...
{
    [TestClass]
    public sealed class CG_00000748_WinamaxSponsoredContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000748_WinamaxSponsoredContest));
        ...
        {
            bool result = CG_00000748_WinamaxSponsoredContest.Solution_0_Test(input);
