...
{
    [TestClass]
    public sealed class CG_00000165_CountingSquaresOnPegs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000165_CountingSquaresOnPegs));
        ...
        {
            bool result = CG_00000165_CountingSquaresOnPegs.Solution_0_Test(input);
