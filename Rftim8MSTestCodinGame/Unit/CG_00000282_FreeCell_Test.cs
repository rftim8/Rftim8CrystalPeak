...
{
    [TestClass]
    public sealed class CG_00000282_FreeCell_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000282_FreeCell));
        ...
        {
            bool result = CG_00000282_FreeCell.Solution_0_Test(input);
