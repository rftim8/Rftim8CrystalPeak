...
{
    [TestClass]
    public sealed class CG_00000151_ConditionOvershadowing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000151_ConditionOvershadowing));
        ...
        {
            bool result = CG_00000151_ConditionOvershadowing.Solution_0_Test(input);
