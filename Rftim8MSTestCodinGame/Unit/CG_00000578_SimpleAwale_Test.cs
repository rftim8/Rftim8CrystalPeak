...
{
    [TestClass]
    public sealed class CG_00000578_SimpleAwale_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000578_SimpleAwale));
        ...
        {
            bool result = CG_00000578_SimpleAwale.Solution_0_Test(input);
