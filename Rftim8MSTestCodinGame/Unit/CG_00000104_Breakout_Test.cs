...
{
    [TestClass]
    public sealed class CG_00000104_Breakout_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000104_Breakout));
        ...
        {
            bool result = CG_00000104_Breakout.Solution_0_Test(input);
