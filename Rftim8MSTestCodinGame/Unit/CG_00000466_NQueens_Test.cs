...
{
    [TestClass]
    public sealed class CG_00000466_NQueens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodinGameStaticData.Input_Test(testType: true, problemName: nameof(CG_00000466_NQueens));
        ...
        {
            bool result = CG_00000466_NQueens.Solution_0_Test(input);
