...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002900_LongestUnequalAdjacentGroupsSubsequenceI_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002900_LongestUnequalAdjacentGroupsSubsequenceI.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002900_LongestUnequalAdjacentGroupsSubsequenceI.Solution_1_Test([.. a0]);
