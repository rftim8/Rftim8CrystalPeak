...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002472_MaximumNumberOfNonOverlappingPalindromeSubstrings_Test(ITestOutputHelper testOutputHelper)
    {
        ...
        public static TheoryData<List<string>, int> LC_00002472_MaximumNumberOfNonOverlappingPalindromeSubstringsPartOne_Input =>
            new()
            {
                { Input, Expected }
            };

        public static TheoryData<List<string>, int> LC_00002472_MaximumNumberOfNonOverlappingPalindromeSubstringsPartTwo_Input =>
            new()
            {
                { Input, Expected }
            };
