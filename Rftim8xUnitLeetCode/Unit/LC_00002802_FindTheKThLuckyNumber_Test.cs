...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002802_FindTheKthLuckyNumber_Test(ITestOutputHelper testOutputHelper)
    {
        ...
        public static TheoryData<List<string>, int> LC_00002802_FindTheKthLuckyNumberPartOne_Input =>
            new()
            {
                { Input, Expected }
            };

        public static TheoryData<List<string>, int> LC_00002802_FindTheKthLuckyNumberPartTwo_Input =>
            new()
            {
                { Input, Expected }
            };
