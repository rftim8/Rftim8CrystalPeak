...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002945_FindMaximumNondecreasingArrayLength_Test(ITestOutputHelper testOutputHelper)
    {
        ...
        public static TheoryData<List<string>, int> LC_00002945_FindMaximumNonDecreasingArrayLengthPartOne_Input =>
            new()
            {
                { Input, Expected }
            };

        public static TheoryData<List<string>, int> LC_00002945_FindMaximumNonDecreasingArrayLengthPartTwo_Input =>
            new()
            {
                { Input, Expected }
            };
