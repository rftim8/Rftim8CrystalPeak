...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002911_MinimumChangesToMakeKSemiPalindromes_Test(ITestOutputHelper testOutputHelper)
    {
        ...
        public static TheoryData<List<string>, int> LC_00002911_MinimumChangesToMakeKSemiPalindromesPartOne_Input =>
            new()
            {
                { Input, Expected }
            };

        public static TheoryData<List<string>, int> LC_00002911_MinimumChangesToMakeKSemiPalindromesPartTwo_Input =>
            new()
            {
                { Input, Expected }
            };
