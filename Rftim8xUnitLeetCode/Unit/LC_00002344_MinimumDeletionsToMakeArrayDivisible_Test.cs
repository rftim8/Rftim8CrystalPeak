...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002344_MinimumDeletionsToMakeArrayDivisible_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002344_MinimumDeletionsToMakeArrayDivisible.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002344_MinimumDeletionsToMakeArrayDivisible.Solution_1_Test([.. a0]);
