...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002892_MinimizingArrayAfterReplacingPairsWithTheirProduct_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002892_MinimizingArrayAfterReplacingPairsWithTheirProduct.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002892_MinimizingArrayAfterReplacingPairsWithTheirProduct.Solution_1_Test([.. a0]);
