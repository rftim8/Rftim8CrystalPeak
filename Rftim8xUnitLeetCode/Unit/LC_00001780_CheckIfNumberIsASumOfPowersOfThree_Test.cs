...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00001780_CheckIfNumberIsASumOfPowersOfThree_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00001780_CheckIfNumberIsASumOfPowersOfThree.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00001780_CheckIfNumberIsASumOfPowersOfThree.Solution_1_Test([.. a0]);
