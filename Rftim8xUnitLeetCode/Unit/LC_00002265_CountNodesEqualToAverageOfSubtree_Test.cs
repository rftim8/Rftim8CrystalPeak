...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002265_CountNodesEqualToAverageOfSubtree_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002265_CountNodesEqualToAverageOfSubtree.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002265_CountNodesEqualToAverageOfSubtree.Solution_1_Test([.. a0]);
