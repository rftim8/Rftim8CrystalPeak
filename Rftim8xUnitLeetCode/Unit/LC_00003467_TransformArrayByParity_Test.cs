...
{
    public class LC_00003467_TransformArrayByParity_Test
    {
        // Arrange
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00003467_TransformArrayByParity.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00003467_TransformArrayByParity.Solution_1_Test([.. a0]);
