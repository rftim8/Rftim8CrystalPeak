...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00001039_MinimumScoreTriangulationOfPolygon_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00001039_MinimumScoreTriangulationOfPolygon.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00001039_MinimumScoreTriangulationOfPolygon.Solution_1_Test([.. a0]);
