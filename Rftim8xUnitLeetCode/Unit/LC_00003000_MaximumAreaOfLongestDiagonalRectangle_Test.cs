...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00003000_MaximumAreaOfLongestDiagonalRectangle_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00003000_MaximumAreaOfLongestDiagonalRectangle.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00003000_MaximumAreaOfLongestDiagonalRectangle.Solution_1_Test([.. a0]);
