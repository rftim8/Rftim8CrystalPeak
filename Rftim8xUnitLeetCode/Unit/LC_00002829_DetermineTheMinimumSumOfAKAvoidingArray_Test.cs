...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002829_DetermineTheMinimumSumOfAKavoidingArray_Test(ITestOutputHelper testOutputHelper)
    {
        ...
        public static TheoryData<List<string>> LC_00002829_DetermineTheMinimumSumOfAKavoidingArrayPartOne_Input =>
            new()
            {
                { Input }
            };

        public static TheoryData<List<string>> LC_00002829_DetermineTheMinimumSumOfAKavoidingArrayPartTwo_Input =>
            new()
            {
