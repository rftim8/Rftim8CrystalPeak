...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002495_NumberOfSubarraysHavingEvenProduct_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002495_NumberOfSubarraysHavingEvenProduct.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002495_NumberOfSubarraysHavingEvenProduct.Solution_1_Test([.. a0]);
