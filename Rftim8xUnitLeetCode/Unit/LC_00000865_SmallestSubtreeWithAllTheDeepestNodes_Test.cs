...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00000865_SmallestSubtreeWithAllTheDeepestNodes_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00000865_SmallestSubtreeWithAllTheDeepestNodes.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00000865_SmallestSubtreeWithAllTheDeepestNodes.Solution_1_Test([.. a0]);
