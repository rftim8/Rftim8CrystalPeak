...
namespace Rftim8xUnitLeetCode.Unit
{
    public class LC_00002832_MaximalRangeThatEachElementIsMaximumInIt_Test
    {
        ...
        public void Solution_0(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002832_MaximalRangeThatEachElementIsMaximumInIt.Solution_0_Test([.. a0]);
        ...
        public void Solution_1(string[] a0)
        {
            // Act
            int expected = 0;
            int actual = LC_00002832_MaximalRangeThatEachElementIsMaximumInIt.Solution_1_Test([.. a0]);
