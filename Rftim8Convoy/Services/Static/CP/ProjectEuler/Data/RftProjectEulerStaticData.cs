namespace Rftim8Convoy.Services.Static.CP.ProjectEuler.Data
{
    public class RftProjectEulerStaticData : IRftProjectEulerStaticData<List<string>, List<string>>
    {
        ...
        private static List<string> GetFileContentToList(bool testType, bool direction, string problemName)
        {
            ...
            string path = direction ?
                $"{dataDir}CP\\ProjectEuler\\IO\\{problemName}_Input.txt" :
                $"{dataDir}CP\\ProjectEuler\\IO\\{problemName}_Output.txt";
