...
{
    [TestClass]
    public sealed class CF_00001970E2_TrailsMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970E2_TrailsMedium));
        ...
        {
            bool result = CF_00001970E2_TrailsMedium.Solution_0_Test(input);
