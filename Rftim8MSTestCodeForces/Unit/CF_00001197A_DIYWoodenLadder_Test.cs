...
{
    [TestClass]
    public sealed class CF_00001197A_DIYWoodenLadder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001197A_DIYWoodenLadder));
        ...
        {
            bool result = CF_00001197A_DIYWoodenLadder.Solution_0_Test(input);
