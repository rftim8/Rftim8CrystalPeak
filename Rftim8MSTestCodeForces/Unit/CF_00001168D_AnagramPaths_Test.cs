...
{
    [TestClass]
    public sealed class CF_00001168D_AnagramPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001168D_AnagramPaths));
        ...
        {
            bool result = CF_00001168D_AnagramPaths.Solution_0_Test(input);
