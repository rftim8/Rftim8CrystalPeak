...
{
    [TestClass]
    public sealed class CF_00000717H_PokermonLeagueChallenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000717H_PokermonLeagueChallenge));
        ...
        {
            bool result = CF_00000717H_PokermonLeagueChallenge.Solution_0_Test(input);
