...
{
    [TestClass]
    public sealed class CF_00000515E_DrazilAndPark_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000515E_DrazilAndPark));
        ...
        {
            bool result = CF_00000515E_DrazilAndPark.Solution_0_Test(input);
