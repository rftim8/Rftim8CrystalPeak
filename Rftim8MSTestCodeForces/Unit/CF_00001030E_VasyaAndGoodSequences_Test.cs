...
{
    [TestClass]
    public sealed class CF_00001030E_VasyaAndGoodSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001030E_VasyaAndGoodSequences));
        ...
        {
            bool result = CF_00001030E_VasyaAndGoodSequences.Solution_0_Test(input);
