...
{
    [TestClass]
    public sealed class CF_00001861D_SortingByMultiplication_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001861D_SortingByMultiplication));
        ...
        {
            bool result = CF_00001861D_SortingByMultiplication.Solution_0_Test(input);
