...
{
    [TestClass]
    public sealed class CF_00001475F_UnusualMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001475F_UnusualMatrix));
        ...
        {
            bool result = CF_00001475F_UnusualMatrix.Solution_0_Test(input);
