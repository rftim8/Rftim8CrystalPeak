...
{
    [TestClass]
    public sealed class CF_00000498D_TrafficJamsInTheLand_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000498D_TrafficJamsInTheLand));
        ...
        {
            bool result = CF_00000498D_TrafficJamsInTheLand.Solution_0_Test(input);
