...
{
    [TestClass]
    public sealed class CF_00000050E_SquareEquationRoots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000050E_SquareEquationRoots));
        ...
        {
            bool result = CF_00000050E_SquareEquationRoots.Solution_0_Test(input);
