...
{
    [TestClass]
    public sealed class CF_00000901D_WeightingATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000901D_WeightingATree));
        ...
        {
            bool result = CF_00000901D_WeightingATree.Solution_0_Test(input);
