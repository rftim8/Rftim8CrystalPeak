...
{
    [TestClass]
    public sealed class CF_00000319E_PingPong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000319E_PingPong));
        ...
        {
            bool result = CF_00000319E_PingPong.Solution_0_Test(input);
