...
{
    [TestClass]
    public sealed class CF_00001519C_BerlandRegional_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001519C_BerlandRegional));
        ...
        {
            bool result = CF_00001519C_BerlandRegional.Solution_0_Test(input);
