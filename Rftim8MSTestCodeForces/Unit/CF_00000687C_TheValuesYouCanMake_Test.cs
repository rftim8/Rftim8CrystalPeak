...
{
    [TestClass]
    public sealed class CF_00000687C_TheValuesYouCanMake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000687C_TheValuesYouCanMake));
        ...
        {
            bool result = CF_00000687C_TheValuesYouCanMake.Solution_0_Test(input);
