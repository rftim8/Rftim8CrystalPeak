...
{
    [TestClass]
    public sealed class CF_00001765I_InfiniteChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001765I_InfiniteChess));
        ...
        {
            bool result = CF_00001765I_InfiniteChess.Solution_0_Test(input);
