...
{
    [TestClass]
    public sealed class CF_00001609B_WilliamTheVigilant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001609B_WilliamTheVigilant));
        ...
        {
            bool result = CF_00001609B_WilliamTheVigilant.Solution_0_Test(input);
