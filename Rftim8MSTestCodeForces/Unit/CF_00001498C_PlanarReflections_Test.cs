...
{
    [TestClass]
    public sealed class CF_00001498C_PlanarReflections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001498C_PlanarReflections));
        ...
        {
            bool result = CF_00001498C_PlanarReflections.Solution_0_Test(input);
