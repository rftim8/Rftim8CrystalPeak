...
{
    [TestClass]
    public sealed class CF_00000166D_ShoeStore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000166D_ShoeStore));
        ...
        {
            bool result = CF_00000166D_ShoeStore.Solution_0_Test(input);
