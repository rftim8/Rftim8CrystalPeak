...
{
    [TestClass]
    public sealed class CF_00001572A_Book_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001572A_Book));
        ...
        {
            bool result = CF_00001572A_Book.Solution_0_Test(input);
