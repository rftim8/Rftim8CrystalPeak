...
{
    [TestClass]
    public sealed class CF_00001811C_RestoreTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001811C_RestoreTheArray));
        ...
        {
            bool result = CF_00001811C_RestoreTheArray.Solution_0_Test(input);
