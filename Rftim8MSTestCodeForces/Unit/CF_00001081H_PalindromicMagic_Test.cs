...
{
    [TestClass]
    public sealed class CF_00001081H_PalindromicMagic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001081H_PalindromicMagic));
        ...
        {
            bool result = CF_00001081H_PalindromicMagic.Solution_0_Test(input);
