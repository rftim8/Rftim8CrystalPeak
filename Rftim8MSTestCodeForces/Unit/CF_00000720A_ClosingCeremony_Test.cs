...
{
    [TestClass]
    public sealed class CF_00000720A_ClosingCeremony_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000720A_ClosingCeremony));
        ...
        {
            bool result = CF_00000720A_ClosingCeremony.Solution_0_Test(input);
