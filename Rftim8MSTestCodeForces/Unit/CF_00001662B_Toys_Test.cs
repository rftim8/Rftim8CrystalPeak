...
{
    [TestClass]
    public sealed class CF_00001662B_Toys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662B_Toys));
        ...
        {
            bool result = CF_00001662B_Toys.Solution_0_Test(input);
