...
{
    [TestClass]
    public sealed class CF_00000005B_CenterAlignment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000005B_CenterAlignment));
        ...
        {
            bool result = CF_00000005B_CenterAlignment.Solution_0_Test(input);
