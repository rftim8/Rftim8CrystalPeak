...
{
    [TestClass]
    public sealed class CF_00000850A_FiveDimensionalPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000850A_FiveDimensionalPoints));
        ...
        {
            bool result = CF_00000850A_FiveDimensionalPoints.Solution_0_Test(input);
