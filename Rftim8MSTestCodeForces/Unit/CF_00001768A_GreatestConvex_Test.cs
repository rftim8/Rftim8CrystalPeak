...
{
    [TestClass]
    public sealed class CF_00001768A_GreatestConvex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001768A_GreatestConvex));
        ...
        {
            bool result = CF_00001768A_GreatestConvex.Solution_0_Test(input);
