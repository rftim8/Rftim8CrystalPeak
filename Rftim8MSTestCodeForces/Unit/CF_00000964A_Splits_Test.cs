...
{
    [TestClass]
    public sealed class CF_00000964A_Splits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000964A_Splits));
        ...
        {
            bool result = CF_00000964A_Splits.Solution_0_Test(input);
