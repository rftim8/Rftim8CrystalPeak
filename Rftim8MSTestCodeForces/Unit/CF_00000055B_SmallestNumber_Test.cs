...
{
    [TestClass]
    public sealed class CF_00000055B_SmallestNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000055B_SmallestNumber));
        ...
        {
            bool result = CF_00000055B_SmallestNumber.Solution_0_Test(input);
