...
{
    [TestClass]
    public sealed class CF_00001918E_Ace5AndTaskOrder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001918E_Ace5AndTaskOrder));
        ...
        {
            bool result = CF_00001918E_Ace5AndTaskOrder.Solution_0_Test(input);
