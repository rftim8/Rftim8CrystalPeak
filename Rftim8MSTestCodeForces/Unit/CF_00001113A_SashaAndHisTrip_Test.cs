...
{
    [TestClass]
    public sealed class CF_00001113A_SashaAndHisTrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001113A_SashaAndHisTrip));
        ...
        {
            bool result = CF_00001113A_SashaAndHisTrip.Solution_0_Test(input);
