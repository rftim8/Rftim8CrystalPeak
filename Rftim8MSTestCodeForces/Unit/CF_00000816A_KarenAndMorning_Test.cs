...
{
    [TestClass]
    public sealed class CF_00000816A_KarenAndMorning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000816A_KarenAndMorning));
        ...
        {
            bool result = CF_00000816A_KarenAndMorning.Solution_0_Test(input);
