...
{
    [TestClass]
    public sealed class CF_00000147B_SmileHouse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000147B_SmileHouse));
        ...
        {
            bool result = CF_00000147B_SmileHouse.Solution_0_Test(input);
