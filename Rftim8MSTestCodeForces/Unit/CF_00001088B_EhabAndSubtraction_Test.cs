...
{
    [TestClass]
    public sealed class CF_00001088B_EhabAndSubtraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001088B_EhabAndSubtraction));
        ...
        {
            bool result = CF_00001088B_EhabAndSubtraction.Solution_0_Test(input);
