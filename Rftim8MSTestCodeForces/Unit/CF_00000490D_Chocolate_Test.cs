...
{
    [TestClass]
    public sealed class CF_00000490D_Chocolate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000490D_Chocolate));
        ...
        {
            bool result = CF_00000490D_Chocolate.Solution_0_Test(input);
