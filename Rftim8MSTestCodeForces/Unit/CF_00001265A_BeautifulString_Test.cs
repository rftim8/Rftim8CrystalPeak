...
{
    [TestClass]
    public sealed class CF_00001265A_BeautifulString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001265A_BeautifulString));
        ...
        {
            bool result = CF_00001265A_BeautifulString.Solution_0_Test(input);
