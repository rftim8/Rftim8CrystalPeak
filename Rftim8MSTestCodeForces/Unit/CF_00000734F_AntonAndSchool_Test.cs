...
{
    [TestClass]
    public sealed class CF_00000734F_AntonAndSchool_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000734F_AntonAndSchool));
        ...
        {
            bool result = CF_00000734F_AntonAndSchool.Solution_0_Test(input);
