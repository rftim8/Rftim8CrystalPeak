...
{
    [TestClass]
    public sealed class CF_00001848F_VikaAndWiki_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001848F_VikaAndWiki));
        ...
        {
            bool result = CF_00001848F_VikaAndWiki.Solution_0_Test(input);
