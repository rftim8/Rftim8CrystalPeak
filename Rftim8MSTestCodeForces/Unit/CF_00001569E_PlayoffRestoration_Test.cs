...
{
    [TestClass]
    public sealed class CF_00001569E_PlayoffRestoration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001569E_PlayoffRestoration));
        ...
        {
            bool result = CF_00001569E_PlayoffRestoration.Solution_0_Test(input);
