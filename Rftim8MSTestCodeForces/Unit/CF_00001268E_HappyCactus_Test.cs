...
{
    [TestClass]
    public sealed class CF_00001268E_HappyCactus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001268E_HappyCactus));
        ...
        {
            bool result = CF_00001268E_HappyCactus.Solution_0_Test(input);
