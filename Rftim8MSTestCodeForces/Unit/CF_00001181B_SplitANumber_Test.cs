...
{
    [TestClass]
    public sealed class CF_00001181B_SplitANumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001181B_SplitANumber));
        ...
        {
            bool result = CF_00001181B_SplitANumber.Solution_0_Test(input);
