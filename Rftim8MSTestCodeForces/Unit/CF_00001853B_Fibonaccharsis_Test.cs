...
{
    [TestClass]
    public sealed class CF_00001853B_Fibonaccharsis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001853B_Fibonaccharsis));
        ...
        {
            bool result = CF_00001853B_Fibonaccharsis.Solution_0_Test(input);
