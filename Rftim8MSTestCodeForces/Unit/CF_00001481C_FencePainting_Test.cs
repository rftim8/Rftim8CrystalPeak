...
{
    [TestClass]
    public sealed class CF_00001481C_FencePainting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001481C_FencePainting));
        ...
        {
            bool result = CF_00001481C_FencePainting.Solution_0_Test(input);
