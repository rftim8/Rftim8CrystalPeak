...
{
    [TestClass]
    public sealed class CF_00001812A_AreYouARobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001812A_AreYouARobot));
        ...
        {
            bool result = CF_00001812A_AreYouARobot.Solution_0_Test(input);
