...
{
    [TestClass]
    public sealed class CF_00001580E_RailwayConstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001580E_RailwayConstruction));
        ...
        {
            bool result = CF_00001580E_RailwayConstruction.Solution_0_Test(input);
