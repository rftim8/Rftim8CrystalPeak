...
{
    [TestClass]
    public sealed class CF_00000981B_BusinessmenProblems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000981B_BusinessmenProblems));
        ...
        {
            bool result = CF_00000981B_BusinessmenProblems.Solution_0_Test(input);
