...
{
    [TestClass]
    public sealed class CF_00000042A_GuiltyToTheKitchen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000042A_GuiltyToTheKitchen));
        ...
        {
            bool result = CF_00000042A_GuiltyToTheKitchen.Solution_0_Test(input);
