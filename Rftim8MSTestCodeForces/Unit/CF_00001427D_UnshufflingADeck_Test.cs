...
{
    [TestClass]
    public sealed class CF_00001427D_UnshufflingADeck_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001427D_UnshufflingADeck));
        ...
        {
            bool result = CF_00001427D_UnshufflingADeck.Solution_0_Test(input);
