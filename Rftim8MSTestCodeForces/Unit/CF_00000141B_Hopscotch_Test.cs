...
{
    [TestClass]
    public sealed class CF_00000141B_Hopscotch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000141B_Hopscotch));
        ...
        {
            bool result = CF_00000141B_Hopscotch.Solution_0_Test(input);
