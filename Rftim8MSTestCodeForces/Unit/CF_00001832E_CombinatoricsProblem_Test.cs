...
{
    [TestClass]
    public sealed class CF_00001832E_CombinatoricsProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001832E_CombinatoricsProblem));
        ...
        {
            bool result = CF_00001832E_CombinatoricsProblem.Solution_0_Test(input);
