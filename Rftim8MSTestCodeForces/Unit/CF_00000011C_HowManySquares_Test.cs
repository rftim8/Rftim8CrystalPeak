...
{
    [TestClass]
    public sealed class CF_00000011C_HowManySquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000011C_HowManySquares));
        ...
        {
            bool result = CF_00000011C_HowManySquares.Solution_0_Test(input);
