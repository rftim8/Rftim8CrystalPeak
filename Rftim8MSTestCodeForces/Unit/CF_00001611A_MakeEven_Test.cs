...
{
    [TestClass]
    public sealed class CF_00001611A_MakeEven_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001611A_MakeEven));
        ...
        {
            bool result = CF_00001611A_MakeEven.Solution_0_Test(input);
