...
{
    [TestClass]
    public sealed class CF_00001941D_RudolfAndTheBallGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001941D_RudolfAndTheBallGame));
        ...
        {
            bool result = CF_00001941D_RudolfAndTheBallGame.Solution_0_Test(input);
