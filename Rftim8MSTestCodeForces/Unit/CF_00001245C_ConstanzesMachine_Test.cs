...
{
    [TestClass]
    public sealed class CF_00001245C_ConstanzesMachine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001245C_ConstanzesMachine));
        ...
        {
            bool result = CF_00001245C_ConstanzesMachine.Solution_0_Test(input);
