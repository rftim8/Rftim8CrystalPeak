...
{
    [TestClass]
    public sealed class CF_00001454A_SpecialPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001454A_SpecialPermutation));
        ...
        {
            bool result = CF_00001454A_SpecialPermutation.Solution_0_Test(input);
