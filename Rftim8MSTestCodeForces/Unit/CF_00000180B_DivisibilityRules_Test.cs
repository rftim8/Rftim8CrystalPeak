...
{
    [TestClass]
    public sealed class CF_00000180B_DivisibilityRules_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000180B_DivisibilityRules));
        ...
        {
            bool result = CF_00000180B_DivisibilityRules.Solution_0_Test(input);
