...
{
    [TestClass]
    public sealed class CF_00001009A_GameShopping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001009A_GameShopping));
        ...
        {
            bool result = CF_00001009A_GameShopping.Solution_0_Test(input);
