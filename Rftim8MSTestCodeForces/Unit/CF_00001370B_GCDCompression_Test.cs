...
{
    [TestClass]
    public sealed class CF_00001370B_GCDCompression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001370B_GCDCompression));
        ...
        {
            bool result = CF_00001370B_GCDCompression.Solution_0_Test(input);
