...
{
    [TestClass]
    public sealed class CF_00001191B_TokitsukazeAndMahjong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001191B_TokitsukazeAndMahjong));
        ...
        {
            bool result = CF_00001191B_TokitsukazeAndMahjong.Solution_0_Test(input);
