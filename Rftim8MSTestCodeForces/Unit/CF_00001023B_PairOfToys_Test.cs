...
{
    [TestClass]
    public sealed class CF_00001023B_PairOfToys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001023B_PairOfToys));
        ...
        {
            bool result = CF_00001023B_PairOfToys.Solution_0_Test(input);
