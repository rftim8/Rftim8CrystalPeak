...
{
    [TestClass]
    public sealed class CF_00000375A_DivisibleBySeven_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000375A_DivisibleBySeven));
        ...
        {
            bool result = CF_00000375A_DivisibleBySeven.Solution_0_Test(input);
