...
{
    [TestClass]
    public sealed class CF_00001847F_TheBosssIdentity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001847F_TheBosssIdentity));
        ...
        {
            bool result = CF_00001847F_TheBosssIdentity.Solution_0_Test(input);
