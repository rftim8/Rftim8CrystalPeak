...
{
    [TestClass]
    public sealed class CF_00001297F_MovieFan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001297F_MovieFan));
        ...
        {
            bool result = CF_00001297F_MovieFan.Solution_0_Test(input);
