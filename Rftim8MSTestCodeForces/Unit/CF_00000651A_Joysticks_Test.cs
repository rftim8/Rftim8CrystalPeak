...
{
    [TestClass]
    public sealed class CF_00000651A_Joysticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000651A_Joysticks));
        ...
        {
            bool result = CF_00000651A_Joysticks.Solution_0_Test(input);
