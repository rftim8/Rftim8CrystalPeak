...
{
    [TestClass]
    public sealed class CF_00001070C_CloudComputing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001070C_CloudComputing));
        ...
        {
            bool result = CF_00001070C_CloudComputing.Solution_0_Test(input);
