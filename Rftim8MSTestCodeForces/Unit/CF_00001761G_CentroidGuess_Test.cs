...
{
    [TestClass]
    public sealed class CF_00001761G_CentroidGuess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001761G_CentroidGuess));
        ...
        {
            bool result = CF_00001761G_CentroidGuess.Solution_0_Test(input);
