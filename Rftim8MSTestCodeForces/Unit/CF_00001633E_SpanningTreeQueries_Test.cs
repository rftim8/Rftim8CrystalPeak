...
{
    [TestClass]
    public sealed class CF_00001633E_SpanningTreeQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001633E_SpanningTreeQueries));
        ...
        {
            bool result = CF_00001633E_SpanningTreeQueries.Solution_0_Test(input);
