...
{
    [TestClass]
    public sealed class CF_00001359C_MixingWater_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001359C_MixingWater));
        ...
        {
            bool result = CF_00001359C_MixingWater.Solution_0_Test(input);
