...
{
    [TestClass]
    public sealed class CF_00001663A_WhoTested_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001663A_WhoTested));
        ...
        {
            bool result = CF_00001663A_WhoTested.Solution_0_Test(input);
