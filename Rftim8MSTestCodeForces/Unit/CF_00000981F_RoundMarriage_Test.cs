...
{
    [TestClass]
    public sealed class CF_00000981F_RoundMarriage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000981F_RoundMarriage));
        ...
        {
            bool result = CF_00000981F_RoundMarriage.Solution_0_Test(input);
