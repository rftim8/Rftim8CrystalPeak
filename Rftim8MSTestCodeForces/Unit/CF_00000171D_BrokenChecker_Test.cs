...
{
    [TestClass]
    public sealed class CF_00000171D_BrokenChecker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000171D_BrokenChecker));
        ...
        {
            bool result = CF_00000171D_BrokenChecker.Solution_0_Test(input);
