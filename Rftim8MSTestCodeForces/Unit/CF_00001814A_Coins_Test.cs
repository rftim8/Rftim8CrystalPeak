...
{
    [TestClass]
    public sealed class CF_00001814A_Coins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001814A_Coins));
        ...
        {
            bool result = CF_00001814A_Coins.Solution_0_Test(input);
