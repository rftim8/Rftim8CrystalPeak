...
{
    [TestClass]
    public sealed class CF_00000071D_Solitaire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000071D_Solitaire));
        ...
        {
            bool result = CF_00000071D_Solitaire.Solution_0_Test(input);
