...
{
    [TestClass]
    public sealed class CF_00001562A_TheMiracleAndTheSleeper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001562A_TheMiracleAndTheSleeper));
        ...
        {
            bool result = CF_00001562A_TheMiracleAndTheSleeper.Solution_0_Test(input);
