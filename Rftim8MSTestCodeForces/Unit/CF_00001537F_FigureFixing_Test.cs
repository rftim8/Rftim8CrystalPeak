...
{
    [TestClass]
    public sealed class CF_00001537F_FigureFixing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001537F_FigureFixing));
        ...
        {
            bool result = CF_00001537F_FigureFixing.Solution_0_Test(input);
