...
{
    [TestClass]
    public sealed class CF_00001151C_ProblemForNazar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001151C_ProblemForNazar));
        ...
        {
            bool result = CF_00001151C_ProblemForNazar.Solution_0_Test(input);
