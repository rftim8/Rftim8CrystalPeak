...
{
    [TestClass]
    public sealed class CF_00000895C_SquareSubsets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000895C_SquareSubsets));
        ...
        {
            bool result = CF_00000895C_SquareSubsets.Solution_0_Test(input);
