...
{
    [TestClass]
    public sealed class CF_00001469C_BuildingAFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001469C_BuildingAFence));
        ...
        {
            bool result = CF_00001469C_BuildingAFence.Solution_0_Test(input);
