...
{
    [TestClass]
    public sealed class CF_00000178E3_TheBeaversProblem2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000178E3_TheBeaversProblem2));
        ...
        {
            bool result = CF_00000178E3_TheBeaversProblem2.Solution_0_Test(input);
