...
{
    [TestClass]
    public sealed class CF_00001430F_RealisticGameplay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001430F_RealisticGameplay));
        ...
        {
            bool result = CF_00001430F_RealisticGameplay.Solution_0_Test(input);
