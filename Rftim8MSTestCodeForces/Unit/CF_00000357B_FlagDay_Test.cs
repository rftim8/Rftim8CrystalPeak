...
{
    [TestClass]
    public sealed class CF_00000357B_FlagDay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000357B_FlagDay));
        ...
        {
            bool result = CF_00000357B_FlagDay.Solution_0_Test(input);
