...
{
    [TestClass]
    public sealed class CF_00000114A_Cifera_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000114A_Cifera));
        ...
        {
            bool result = CF_00000114A_Cifera.Solution_0_Test(input);
