...
{
    [TestClass]
    public sealed class CF_00001987C_BasilsGarden_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001987C_BasilsGarden));
        ...
        {
            bool result = CF_00001987C_BasilsGarden.Solution_0_Test(input);
