...
{
    [TestClass]
    public sealed class CF_00001111A_SuperheroTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001111A_SuperheroTransformation));
        ...
        {
            bool result = CF_00001111A_SuperheroTransformation.Solution_0_Test(input);
