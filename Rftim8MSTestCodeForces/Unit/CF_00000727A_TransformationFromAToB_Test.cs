...
{
    [TestClass]
    public sealed class CF_00000727A_TransformationFromAToB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000727A_TransformationFromAToB));
        ...
        {
            bool result = CF_00000727A_TransformationFromAToB.Solution_0_Test(input);
