...
{
    [TestClass]
    public sealed class CF_00000100D_WorldOfMouth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000100D_WorldOfMouth));
        ...
        {
            bool result = CF_00000100D_WorldOfMouth.Solution_0_Test(input);
