...
{
    [TestClass]
    public sealed class CF_00000303D_RotatableNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000303D_RotatableNumber));
        ...
        {
            bool result = CF_00000303D_RotatableNumber.Solution_0_Test(input);
