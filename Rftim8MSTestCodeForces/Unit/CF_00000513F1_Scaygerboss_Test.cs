...
{
    [TestClass]
    public sealed class CF_00000513F1_Scaygerboss_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000513F1_Scaygerboss));
        ...
        {
            bool result = CF_00000513F1_Scaygerboss.Solution_0_Test(input);
