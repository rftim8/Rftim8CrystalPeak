...
{
    [TestClass]
    public sealed class CF_00000696D_Legen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000696D_Legen));
        ...
        {
            bool result = CF_00000696D_Legen.Solution_0_Test(input);
