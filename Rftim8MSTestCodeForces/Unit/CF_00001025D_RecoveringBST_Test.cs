...
{
    [TestClass]
    public sealed class CF_00001025D_RecoveringBST_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001025D_RecoveringBST));
        ...
        {
            bool result = CF_00001025D_RecoveringBST.Solution_0_Test(input);
