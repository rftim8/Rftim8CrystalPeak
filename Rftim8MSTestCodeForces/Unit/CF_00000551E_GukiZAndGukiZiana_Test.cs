...
{
    [TestClass]
    public sealed class CF_00000551E_GukiZAndGukiZiana_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000551E_GukiZAndGukiZiana));
        ...
        {
            bool result = CF_00000551E_GukiZAndGukiZiana.Solution_0_Test(input);
