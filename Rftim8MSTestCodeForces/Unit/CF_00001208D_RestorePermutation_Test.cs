...
{
    [TestClass]
    public sealed class CF_00001208D_RestorePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001208D_RestorePermutation));
        ...
        {
            bool result = CF_00001208D_RestorePermutation.Solution_0_Test(input);
