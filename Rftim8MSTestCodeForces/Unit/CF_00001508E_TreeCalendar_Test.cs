...
{
    [TestClass]
    public sealed class CF_00001508E_TreeCalendar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001508E_TreeCalendar));
        ...
        {
            bool result = CF_00001508E_TreeCalendar.Solution_0_Test(input);
