...
{
    [TestClass]
    public sealed class CF_00000493D_VasyaAndChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000493D_VasyaAndChess));
        ...
        {
            bool result = CF_00000493D_VasyaAndChess.Solution_0_Test(input);
