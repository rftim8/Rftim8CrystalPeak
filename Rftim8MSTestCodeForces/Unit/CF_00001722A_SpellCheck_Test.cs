...
{
    [TestClass]
    public sealed class CF_00001722A_SpellCheck_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001722A_SpellCheck));
        ...
        {
            bool result = CF_00001722A_SpellCheck.Solution_0_Test(input);
