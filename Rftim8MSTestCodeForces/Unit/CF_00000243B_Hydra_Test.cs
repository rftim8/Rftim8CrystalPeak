...
{
    [TestClass]
    public sealed class CF_00000243B_Hydra_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000243B_Hydra));
        ...
        {
            bool result = CF_00000243B_Hydra.Solution_0_Test(input);
