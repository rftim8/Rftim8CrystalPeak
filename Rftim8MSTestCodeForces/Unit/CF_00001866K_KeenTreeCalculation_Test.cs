...
{
    [TestClass]
    public sealed class CF_00001866K_KeenTreeCalculation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001866K_KeenTreeCalculation));
        ...
        {
            bool result = CF_00001866K_KeenTreeCalculation.Solution_0_Test(input);
