...
{
    [TestClass]
    public sealed class CF_00001705A_MarkThePhotographer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001705A_MarkThePhotographer));
        ...
        {
            bool result = CF_00001705A_MarkThePhotographer.Solution_0_Test(input);
