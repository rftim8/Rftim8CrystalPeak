...
{
    [TestClass]
    public sealed class CF_00001098B_NiceTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001098B_NiceTable));
        ...
        {
            bool result = CF_00001098B_NiceTable.Solution_0_Test(input);
