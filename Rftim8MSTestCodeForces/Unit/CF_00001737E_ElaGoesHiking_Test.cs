...
{
    [TestClass]
    public sealed class CF_00001737E_ElaGoesHiking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001737E_ElaGoesHiking));
        ...
        {
            bool result = CF_00001737E_ElaGoesHiking.Solution_0_Test(input);
