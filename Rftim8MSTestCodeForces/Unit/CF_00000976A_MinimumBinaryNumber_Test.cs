...
{
    [TestClass]
    public sealed class CF_00000976A_MinimumBinaryNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000976A_MinimumBinaryNumber));
        ...
        {
            bool result = CF_00000976A_MinimumBinaryNumber.Solution_0_Test(input);
