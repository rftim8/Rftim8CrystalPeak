...
{
    [TestClass]
    public sealed class CF_00001776G_AnotherWineTastingEvent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001776G_AnotherWineTastingEvent));
        ...
        {
            bool result = CF_00001776G_AnotherWineTastingEvent.Solution_0_Test(input);
