...
{
    [TestClass]
    public sealed class CF_00000877C_SlavaAndTanks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000877C_SlavaAndTanks));
        ...
        {
            bool result = CF_00000877C_SlavaAndTanks.Solution_0_Test(input);
