...
{
    [TestClass]
    public sealed class CF_00000226E_NobleKnightsPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000226E_NobleKnightsPath));
        ...
        {
            bool result = CF_00000226E_NobleKnightsPath.Solution_0_Test(input);
