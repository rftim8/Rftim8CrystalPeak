...
{
    [TestClass]
    public sealed class CF_00000785C_AntonAndFairyTale_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000785C_AntonAndFairyTale));
        ...
        {
            bool result = CF_00000785C_AntonAndFairyTale.Solution_0_Test(input);
