...
{
    [TestClass]
    public sealed class CF_00001939A_DrawPolygonLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001939A_DrawPolygonLines));
        ...
        {
            bool result = CF_00001939A_DrawPolygonLines.Solution_0_Test(input);
