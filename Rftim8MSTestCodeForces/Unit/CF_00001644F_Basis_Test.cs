...
{
    [TestClass]
    public sealed class CF_00001644F_Basis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001644F_Basis));
        ...
        {
            bool result = CF_00001644F_Basis.Solution_0_Test(input);
