...
{
    [TestClass]
    public sealed class CF_00002004G_SubstringCompression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002004G_SubstringCompression));
        ...
        {
            bool result = CF_00002004G_SubstringCompression.Solution_0_Test(input);
