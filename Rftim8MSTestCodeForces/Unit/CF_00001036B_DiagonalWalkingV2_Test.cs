...
{
    [TestClass]
    public sealed class CF_00001036B_DiagonalWalkingV2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001036B_DiagonalWalkingV2));
        ...
        {
            bool result = CF_00001036B_DiagonalWalkingV2.Solution_0_Test(input);
