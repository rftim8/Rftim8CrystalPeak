...
{
    [TestClass]
    public sealed class CF_00001148C_CrazyDiamond_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001148C_CrazyDiamond));
        ...
        {
            bool result = CF_00001148C_CrazyDiamond.Solution_0_Test(input);
