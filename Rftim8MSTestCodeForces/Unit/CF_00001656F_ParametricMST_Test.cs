...
{
    [TestClass]
    public sealed class CF_00001656F_ParametricMST_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001656F_ParametricMST));
        ...
        {
            bool result = CF_00001656F_ParametricMST.Solution_0_Test(input);
