...
{
    [TestClass]
    public sealed class CF_00001940A_ParallelUniverses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001940A_ParallelUniverses));
        ...
        {
            bool result = CF_00001940A_ParallelUniverses.Solution_0_Test(input);
