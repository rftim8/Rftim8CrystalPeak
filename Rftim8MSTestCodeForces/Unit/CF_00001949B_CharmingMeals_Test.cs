...
{
    [TestClass]
    public sealed class CF_00001949B_CharmingMeals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001949B_CharmingMeals));
        ...
        {
            bool result = CF_00001949B_CharmingMeals.Solution_0_Test(input);
