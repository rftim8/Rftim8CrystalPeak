...
{
    [TestClass]
    public sealed class CF_00000056C_CorporationMail_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000056C_CorporationMail));
        ...
        {
            bool result = CF_00000056C_CorporationMail.Solution_0_Test(input);
