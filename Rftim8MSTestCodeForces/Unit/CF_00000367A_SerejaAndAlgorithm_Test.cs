...
{
    [TestClass]
    public sealed class CF_00000367A_SerejaAndAlgorithm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000367A_SerejaAndAlgorithm));
        ...
        {
            bool result = CF_00000367A_SerejaAndAlgorithm.Solution_0_Test(input);
