...
{
    [TestClass]
    public sealed class CF_00000007D_PalindromeDegree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000007D_PalindromeDegree));
        ...
        {
            bool result = CF_00000007D_PalindromeDegree.Solution_0_Test(input);
