...
{
    [TestClass]
    public sealed class CF_00001861A_PrimeDeletion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001861A_PrimeDeletion));
        ...
        {
            bool result = CF_00001861A_PrimeDeletion.Solution_0_Test(input);
