...
{
    [TestClass]
    public sealed class CF_00000085B_EmbassyQueue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000085B_EmbassyQueue));
        ...
        {
            bool result = CF_00000085B_EmbassyQueue.Solution_0_Test(input);
