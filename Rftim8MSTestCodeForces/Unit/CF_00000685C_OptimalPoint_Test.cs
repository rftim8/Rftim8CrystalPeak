...
{
    [TestClass]
    public sealed class CF_00000685C_OptimalPoint_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000685C_OptimalPoint));
        ...
        {
            bool result = CF_00000685C_OptimalPoint.Solution_0_Test(input);
