...
{
    [TestClass]
    public sealed class CF_00001641C_AnonymityIsImportant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001641C_AnonymityIsImportant));
        ...
        {
            bool result = CF_00001641C_AnonymityIsImportant.Solution_0_Test(input);
