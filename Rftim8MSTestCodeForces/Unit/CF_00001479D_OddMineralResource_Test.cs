...
{
    [TestClass]
    public sealed class CF_00001479D_OddMineralResource_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001479D_OddMineralResource));
        ...
        {
            bool result = CF_00001479D_OddMineralResource.Solution_0_Test(input);
