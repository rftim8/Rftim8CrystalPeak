...
{
    [TestClass]
    public sealed class CF_00000183E_CandyShop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000183E_CandyShop));
        ...
        {
            bool result = CF_00000183E_CandyShop.Solution_0_Test(input);
