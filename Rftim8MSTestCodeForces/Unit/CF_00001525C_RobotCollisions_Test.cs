...
{
    [TestClass]
    public sealed class CF_00001525C_RobotCollisions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001525C_RobotCollisions));
        ...
        {
            bool result = CF_00001525C_RobotCollisions.Solution_0_Test(input);
