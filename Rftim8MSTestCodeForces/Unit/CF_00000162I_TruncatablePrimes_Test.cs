...
{
    [TestClass]
    public sealed class CF_00000162I_TruncatablePrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000162I_TruncatablePrimes));
        ...
        {
            bool result = CF_00000162I_TruncatablePrimes.Solution_0_Test(input);
