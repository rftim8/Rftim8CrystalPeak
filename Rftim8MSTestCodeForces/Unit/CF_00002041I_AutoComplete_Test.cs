...
{
    [TestClass]
    public sealed class CF_00002041I_AutoComplete_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002041I_AutoComplete));
        ...
        {
            bool result = CF_00002041I_AutoComplete.Solution_0_Test(input);
