...
{
    [TestClass]
    public sealed class CF_00000449C_JzzhuAndApples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000449C_JzzhuAndApples));
        ...
        {
            bool result = CF_00000449C_JzzhuAndApples.Solution_0_Test(input);
