...
{
    [TestClass]
    public sealed class CF_00001842C_TenzingAndBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001842C_TenzingAndBalls));
        ...
        {
            bool result = CF_00001842C_TenzingAndBalls.Solution_0_Test(input);
