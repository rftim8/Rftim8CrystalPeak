...
{
    [TestClass]
    public sealed class CF_00000100A_CarpetingTheRoom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000100A_CarpetingTheRoom));
        ...
        {
            bool result = CF_00000100A_CarpetingTheRoom.Solution_0_Test(input);
