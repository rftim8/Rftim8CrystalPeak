...
{
    [TestClass]
    public sealed class CF_00000845C_TwoTVs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000845C_TwoTVs));
        ...
        {
            bool result = CF_00000845C_TwoTVs.Solution_0_Test(input);
