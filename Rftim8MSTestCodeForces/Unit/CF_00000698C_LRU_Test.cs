...
{
    [TestClass]
    public sealed class CF_00000698C_LRU_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000698C_LRU));
        ...
        {
            bool result = CF_00000698C_LRU.Solution_0_Test(input);
