...
{
    [TestClass]
    public sealed class CF_00001170I_GoodSubsets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001170I_GoodSubsets));
        ...
        {
            bool result = CF_00001170I_GoodSubsets.Solution_0_Test(input);
