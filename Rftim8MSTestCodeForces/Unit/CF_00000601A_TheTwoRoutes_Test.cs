...
{
    [TestClass]
    public sealed class CF_00000601A_TheTwoRoutes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000601A_TheTwoRoutes));
        ...
        {
            bool result = CF_00000601A_TheTwoRoutes.Solution_0_Test(input);
