...
{
    [TestClass]
    public sealed class CF_00001856E1_PermuTreeEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001856E1_PermuTreeEasyVersion));
        ...
        {
            bool result = CF_00001856E1_PermuTreeEasyVersion.Solution_0_Test(input);
