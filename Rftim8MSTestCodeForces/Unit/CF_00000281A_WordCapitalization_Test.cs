...
{
    [TestClass]
    public sealed class CF_00000281A_WordCapitalization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000281A_WordCapitalization));
        ...
        {
            bool result = CF_00000281A_WordCapitalization.Solution_0_Test(input);
