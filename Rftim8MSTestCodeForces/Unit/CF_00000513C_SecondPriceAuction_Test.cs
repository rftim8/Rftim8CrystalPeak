...
{
    [TestClass]
    public sealed class CF_00000513C_SecondPriceAuction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000513C_SecondPriceAuction));
        ...
        {
            bool result = CF_00000513C_SecondPriceAuction.Solution_0_Test(input);
