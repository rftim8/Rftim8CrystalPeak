...
{
    [TestClass]
    public sealed class CF_00001934D2_XORBreakGameVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001934D2_XORBreakGameVersion));
        ...
        {
            bool result = CF_00001934D2_XORBreakGameVersion.Solution_0_Test(input);
