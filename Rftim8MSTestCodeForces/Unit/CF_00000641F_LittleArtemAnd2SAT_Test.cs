...
{
    [TestClass]
    public sealed class CF_00000641F_LittleArtemAnd2SAT_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000641F_LittleArtemAnd2SAT));
        ...
        {
            bool result = CF_00000641F_LittleArtemAnd2SAT.Solution_0_Test(input);
