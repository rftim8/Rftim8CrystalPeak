...
{
    [TestClass]
    public sealed class CF_00002043G_ProblemWithQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002043G_ProblemWithQueries));
        ...
        {
            bool result = CF_00002043G_ProblemWithQueries.Solution_0_Test(input);
