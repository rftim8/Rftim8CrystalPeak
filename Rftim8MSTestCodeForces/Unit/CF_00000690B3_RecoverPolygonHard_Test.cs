...
{
    [TestClass]
    public sealed class CF_00000690B3_RecoverPolygonHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690B3_RecoverPolygonHard));
        ...
        {
            bool result = CF_00000690B3_RecoverPolygonHard.Solution_0_Test(input);
