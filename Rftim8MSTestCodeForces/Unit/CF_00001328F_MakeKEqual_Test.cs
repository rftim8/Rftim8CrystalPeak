...
{
    [TestClass]
    public sealed class CF_00001328F_MakeKEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001328F_MakeKEqual));
        ...
        {
            bool result = CF_00001328F_MakeKEqual.Solution_0_Test(input);
