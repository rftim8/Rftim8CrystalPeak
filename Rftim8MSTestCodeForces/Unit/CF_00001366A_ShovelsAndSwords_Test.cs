...
{
    [TestClass]
    public sealed class CF_00001366A_ShovelsAndSwords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001366A_ShovelsAndSwords));
        ...
        {
            bool result = CF_00001366A_ShovelsAndSwords.Solution_0_Test(input);
