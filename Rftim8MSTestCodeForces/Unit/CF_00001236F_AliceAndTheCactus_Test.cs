...
{
    [TestClass]
    public sealed class CF_00001236F_AliceAndTheCactus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001236F_AliceAndTheCactus));
        ...
        {
            bool result = CF_00001236F_AliceAndTheCactus.Solution_0_Test(input);
