...
{
    [TestClass]
    public sealed class CF_00001767E_AlgebraFlash_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001767E_AlgebraFlash));
        ...
        {
            bool result = CF_00001767E_AlgebraFlash.Solution_0_Test(input);
