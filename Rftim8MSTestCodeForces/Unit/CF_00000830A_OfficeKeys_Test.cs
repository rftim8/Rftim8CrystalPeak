...
{
    [TestClass]
    public sealed class CF_00000830A_OfficeKeys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000830A_OfficeKeys));
        ...
        {
            bool result = CF_00000830A_OfficeKeys.Solution_0_Test(input);
