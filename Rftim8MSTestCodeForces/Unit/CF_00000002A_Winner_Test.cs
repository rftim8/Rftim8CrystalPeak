...
{
    [TestClass]
    public sealed class CF_00000002A_Winner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000002A_Winner));
        ...
        {
            string result = CF_00000002A_Winner.Solution_0_Test(input);
