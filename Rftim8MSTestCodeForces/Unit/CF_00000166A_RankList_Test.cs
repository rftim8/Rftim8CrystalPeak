...
{
    [TestClass]
    public sealed class CF_00000166A_RankList_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000166A_RankList));
        ...
        {
            bool result = CF_00000166A_RankList.Solution_0_Test(input);
