...
{
    [TestClass]
    public sealed class CF_00001503E_2Coloring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001503E_2Coloring));
        ...
        {
            bool result = CF_00001503E_2Coloring.Solution_0_Test(input);
