...
{
    [TestClass]
    public sealed class CF_00000093B_EndOfExams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000093B_EndOfExams));
        ...
        {
            bool result = CF_00000093B_EndOfExams.Solution_0_Test(input);
