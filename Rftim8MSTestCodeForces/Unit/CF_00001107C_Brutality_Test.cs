...
{
    [TestClass]
    public sealed class CF_00001107C_Brutality_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001107C_Brutality));
        ...
        {
            bool result = CF_00001107C_Brutality.Solution_0_Test(input);
