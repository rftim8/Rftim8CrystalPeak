...
{
    [TestClass]
    public sealed class CF_00002038E_Barrels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002038E_Barrels));
        ...
        {
            bool result = CF_00002038E_Barrels.Solution_0_Test(input);
