...
{
    [TestClass]
    public sealed class CF_00001828B_PermutationSwap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001828B_PermutationSwap));
        ...
        {
            bool result = CF_00001828B_PermutationSwap.Solution_0_Test(input);
