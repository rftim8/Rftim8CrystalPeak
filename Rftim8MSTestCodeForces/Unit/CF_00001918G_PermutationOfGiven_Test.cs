...
{
    [TestClass]
    public sealed class CF_00001918G_PermutationOfGiven_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001918G_PermutationOfGiven));
        ...
        {
            bool result = CF_00001918G_PermutationOfGiven.Solution_0_Test(input);
