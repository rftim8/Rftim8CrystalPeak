...
{
    [TestClass]
    public sealed class CF_00000460D_LittleVictorAndSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000460D_LittleVictorAndSet));
        ...
        {
            bool result = CF_00000460D_LittleVictorAndSet.Solution_0_Test(input);
