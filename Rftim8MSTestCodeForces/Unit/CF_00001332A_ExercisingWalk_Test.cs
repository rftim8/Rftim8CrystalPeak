...
{
    [TestClass]
    public sealed class CF_00001332A_ExercisingWalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001332A_ExercisingWalk));
        ...
        {
            bool result = CF_00001332A_ExercisingWalk.Solution_0_Test(input);
