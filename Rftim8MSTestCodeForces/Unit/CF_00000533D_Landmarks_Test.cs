...
{
    [TestClass]
    public sealed class CF_00000533D_Landmarks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000533D_Landmarks));
        ...
        {
            bool result = CF_00000533D_Landmarks.Solution_0_Test(input);
