...
{
    [TestClass]
    public sealed class CF_00001512G_ShortTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001512G_ShortTask));
        ...
        {
            bool result = CF_00001512G_ShortTask.Solution_0_Test(input);
