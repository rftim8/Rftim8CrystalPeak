...
{
    [TestClass]
    public sealed class CF_00001478B_NezzarAndLuckyNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001478B_NezzarAndLuckyNumber));
        ...
        {
            bool result = CF_00001478B_NezzarAndLuckyNumber.Solution_0_Test(input);
