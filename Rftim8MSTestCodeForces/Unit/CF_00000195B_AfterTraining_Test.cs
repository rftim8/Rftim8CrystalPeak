...
{
    [TestClass]
    public sealed class CF_00000195B_AfterTraining_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000195B_AfterTraining));
        ...
        {
            bool result = CF_00000195B_AfterTraining.Solution_0_Test(input);
