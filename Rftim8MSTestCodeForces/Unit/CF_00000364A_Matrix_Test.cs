...
{
    [TestClass]
    public sealed class CF_00000364A_Matrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000364A_Matrix));
        ...
        {
            bool result = CF_00000364A_Matrix.Solution_0_Test(input);
