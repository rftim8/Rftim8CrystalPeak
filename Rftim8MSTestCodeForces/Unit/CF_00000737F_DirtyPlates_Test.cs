...
{
    [TestClass]
    public sealed class CF_00000737F_DirtyPlates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000737F_DirtyPlates));
        ...
        {
            bool result = CF_00000737F_DirtyPlates.Solution_0_Test(input);
