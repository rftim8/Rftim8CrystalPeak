...
{
    [TestClass]
    public sealed class CF_00000869E_TheUntendedAntiquity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000869E_TheUntendedAntiquity));
        ...
        {
            bool result = CF_00000869E_TheUntendedAntiquity.Solution_0_Test(input);
