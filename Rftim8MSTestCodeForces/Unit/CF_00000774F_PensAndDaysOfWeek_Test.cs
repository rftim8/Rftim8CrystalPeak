...
{
    [TestClass]
    public sealed class CF_00000774F_PensAndDaysOfWeek_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774F_PensAndDaysOfWeek));
        ...
        {
            bool result = CF_00000774F_PensAndDaysOfWeek.Solution_0_Test(input);
