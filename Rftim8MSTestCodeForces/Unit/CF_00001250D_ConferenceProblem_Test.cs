...
{
    [TestClass]
    public sealed class CF_00001250D_ConferenceProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250D_ConferenceProblem));
        ...
        {
            bool result = CF_00001250D_ConferenceProblem.Solution_0_Test(input);
