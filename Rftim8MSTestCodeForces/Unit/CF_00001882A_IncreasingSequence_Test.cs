...
{
    [TestClass]
    public sealed class CF_00001882A_IncreasingSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001882A_IncreasingSequence));
        ...
        {
            bool result = CF_00001882A_IncreasingSequence.Solution_0_Test(input);
