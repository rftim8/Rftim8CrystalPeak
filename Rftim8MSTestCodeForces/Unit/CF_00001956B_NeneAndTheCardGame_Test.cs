...
{
    [TestClass]
    public sealed class CF_00001956B_NeneAndTheCardGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001956B_NeneAndTheCardGame));
        ...
        {
            bool result = CF_00001956B_NeneAndTheCardGame.Solution_0_Test(input);
