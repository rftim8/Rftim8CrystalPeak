...
{
    [TestClass]
    public sealed class CF_00001426C_IncreaseAndCopy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001426C_IncreaseAndCopy));
        ...
        {
            bool result = CF_00001426C_IncreaseAndCopy.Solution_0_Test(input);
