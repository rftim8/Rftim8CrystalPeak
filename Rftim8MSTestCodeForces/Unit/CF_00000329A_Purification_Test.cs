...
{
    [TestClass]
    public sealed class CF_00000329A_Purification_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000329A_Purification));
        ...
        {
            bool result = CF_00000329A_Purification.Solution_0_Test(input);
