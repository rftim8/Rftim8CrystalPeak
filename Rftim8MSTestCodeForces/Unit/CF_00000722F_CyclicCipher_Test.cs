...
{
    [TestClass]
    public sealed class CF_00000722F_CyclicCipher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000722F_CyclicCipher));
        ...
        {
            bool result = CF_00000722F_CyclicCipher.Solution_0_Test(input);
