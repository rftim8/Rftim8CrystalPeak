...
{
    [TestClass]
    public sealed class CF_00000773F_TestDataGeneration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000773F_TestDataGeneration));
        ...
        {
            bool result = CF_00000773F_TestDataGeneration.Solution_0_Test(input);
