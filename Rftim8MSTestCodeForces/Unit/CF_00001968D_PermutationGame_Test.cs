...
{
    [TestClass]
    public sealed class CF_00001968D_PermutationGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001968D_PermutationGame));
        ...
        {
            bool result = CF_00001968D_PermutationGame.Solution_0_Test(input);
