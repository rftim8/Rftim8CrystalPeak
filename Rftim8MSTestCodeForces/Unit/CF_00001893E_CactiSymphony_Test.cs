...
{
    [TestClass]
    public sealed class CF_00001893E_CactiSymphony_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001893E_CactiSymphony));
        ...
        {
            bool result = CF_00001893E_CactiSymphony.Solution_0_Test(input);
