...
{
    [TestClass]
    public sealed class CF_00001525B_PermutationSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001525B_PermutationSort));
        ...
        {
            bool result = CF_00001525B_PermutationSort.Solution_0_Test(input);
