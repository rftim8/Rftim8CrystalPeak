...
{
    [TestClass]
    public sealed class CF_00001695D2_TreeQueriesHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001695D2_TreeQueriesHardVersion));
        ...
        {
            bool result = CF_00001695D2_TreeQueriesHardVersion.Solution_0_Test(input);
