...
{
    [TestClass]
    public sealed class CF_00000331E1_DejaVu_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000331E1_DejaVu));
        ...
        {
            bool result = CF_00000331E1_DejaVu.Solution_0_Test(input);
