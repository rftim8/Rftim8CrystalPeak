...
{
    [TestClass]
    public sealed class CF_00000125A_MeasuringLengthsInBaden_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000125A_MeasuringLengthsInBaden));
        ...
        {
            bool result = CF_00000125A_MeasuringLengthsInBaden.Solution_0_Test(input);
