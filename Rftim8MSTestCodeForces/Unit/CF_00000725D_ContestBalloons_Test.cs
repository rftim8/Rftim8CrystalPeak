...
{
    [TestClass]
    public sealed class CF_00000725D_ContestBalloons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000725D_ContestBalloons));
        ...
        {
            bool result = CF_00000725D_ContestBalloons.Solution_0_Test(input);
