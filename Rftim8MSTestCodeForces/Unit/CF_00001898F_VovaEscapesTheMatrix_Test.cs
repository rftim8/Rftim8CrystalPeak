...
{
    [TestClass]
    public sealed class CF_00001898F_VovaEscapesTheMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001898F_VovaEscapesTheMatrix));
        ...
        {
            bool result = CF_00001898F_VovaEscapesTheMatrix.Solution_0_Test(input);
