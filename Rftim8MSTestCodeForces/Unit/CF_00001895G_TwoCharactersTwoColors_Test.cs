...
{
    [TestClass]
    public sealed class CF_00001895G_TwoCharactersTwoColors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001895G_TwoCharactersTwoColors));
        ...
        {
            bool result = CF_00001895G_TwoCharactersTwoColors.Solution_0_Test(input);
