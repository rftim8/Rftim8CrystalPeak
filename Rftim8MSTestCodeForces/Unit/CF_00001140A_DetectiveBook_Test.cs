...
{
    [TestClass]
    public sealed class CF_00001140A_DetectiveBook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001140A_DetectiveBook));
        ...
        {
            bool result = CF_00001140A_DetectiveBook.Solution_0_Test(input);
