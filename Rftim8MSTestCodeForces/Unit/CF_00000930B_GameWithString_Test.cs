...
{
    [TestClass]
    public sealed class CF_00000930B_GameWithString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000930B_GameWithString));
        ...
        {
            bool result = CF_00000930B_GameWithString.Solution_0_Test(input);
