...
{
    [TestClass]
    public sealed class CF_00001505D_XenolithHippodrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001505D_XenolithHippodrome));
        ...
        {
            bool result = CF_00001505D_XenolithHippodrome.Solution_0_Test(input);
