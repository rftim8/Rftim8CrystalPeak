...
{
    [TestClass]
    public sealed class CF_00001415C_BouncingBall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001415C_BouncingBall));
        ...
        {
            bool result = CF_00001415C_BouncingBall.Solution_0_Test(input);
