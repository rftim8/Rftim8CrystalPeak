...
{
    [TestClass]
    public sealed class CF_00000670F_RestoreANumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000670F_RestoreANumber));
        ...
        {
            bool result = CF_00000670F_RestoreANumber.Solution_0_Test(input);
