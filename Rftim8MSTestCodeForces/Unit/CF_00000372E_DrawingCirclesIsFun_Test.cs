...
{
    [TestClass]
    public sealed class CF_00000372E_DrawingCirclesIsFun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000372E_DrawingCirclesIsFun));
        ...
        {
            bool result = CF_00000372E_DrawingCirclesIsFun.Solution_0_Test(input);
