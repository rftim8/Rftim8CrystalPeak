...
{
    [TestClass]
    public sealed class CF_00000794F_LehaAndSecuritySystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000794F_LehaAndSecuritySystem));
        ...
        {
            bool result = CF_00000794F_LehaAndSecuritySystem.Solution_0_Test(input);
