...
{
    [TestClass]
    public sealed class CF_00000911F_TreeDestruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000911F_TreeDestruction));
        ...
        {
            bool result = CF_00000911F_TreeDestruction.Solution_0_Test(input);
