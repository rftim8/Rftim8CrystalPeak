...
{
    [TestClass]
    public sealed class CF_00001041C_CoffeeBreak_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001041C_CoffeeBreak));
        ...
        {
            bool result = CF_00001041C_CoffeeBreak.Solution_0_Test(input);
