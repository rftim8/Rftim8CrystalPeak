...
{
    [TestClass]
    public sealed class CF_00000391F1_StockTrading_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000391F1_StockTrading));
        ...
        {
            bool result = CF_00000391F1_StockTrading.Solution_0_Test(input);
