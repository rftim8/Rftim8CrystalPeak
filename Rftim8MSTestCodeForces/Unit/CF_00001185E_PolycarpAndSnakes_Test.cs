...
{
    [TestClass]
    public sealed class CF_00001185E_PolycarpAndSnakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001185E_PolycarpAndSnakes));
        ...
        {
            bool result = CF_00001185E_PolycarpAndSnakes.Solution_0_Test(input);
