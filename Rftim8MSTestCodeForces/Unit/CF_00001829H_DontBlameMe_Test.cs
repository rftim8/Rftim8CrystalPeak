...
{
    [TestClass]
    public sealed class CF_00001829H_DontBlameMe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001829H_DontBlameMe));
        ...
        {
            bool result = CF_00001829H_DontBlameMe.Solution_0_Test(input);
