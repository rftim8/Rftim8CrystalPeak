...
{
    [TestClass]
    public sealed class CF_00000834A_TheUselessToy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000834A_TheUselessToy));
        ...
        {
            bool result = CF_00000834A_TheUselessToy.Solution_0_Test(input);
