...
{
    [TestClass]
    public sealed class CF_00000072G_FibonacciArmy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000072G_FibonacciArmy));
        ...
        {
            bool result = CF_00000072G_FibonacciArmy.Solution_0_Test(input);
