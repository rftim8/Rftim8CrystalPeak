...
{
    [TestClass]
    public sealed class CF_00000136B_TernaryLogic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000136B_TernaryLogic));
        ...
        {
            bool result = CF_00000136B_TernaryLogic.Solution_0_Test(input);
