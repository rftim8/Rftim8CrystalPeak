...
{
    [TestClass]
    public sealed class CF_00001726G_ACertainMagicalParty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001726G_ACertainMagicalParty));
        ...
        {
            bool result = CF_00001726G_ACertainMagicalParty.Solution_0_Test(input);
