...
{
    [TestClass]
    public sealed class CF_00001646F_PlayingAroundTheTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001646F_PlayingAroundTheTable));
        ...
        {
            bool result = CF_00001646F_PlayingAroundTheTable.Solution_0_Test(input);
