...
{
    [TestClass]
    public sealed class CF_00000370E_SummerReading_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000370E_SummerReading));
        ...
        {
            bool result = CF_00000370E_SummerReading.Solution_0_Test(input);
