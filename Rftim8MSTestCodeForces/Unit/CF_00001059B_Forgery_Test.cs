...
{
    [TestClass]
    public sealed class CF_00001059B_Forgery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001059B_Forgery));
        ...
        {
            bool result = CF_00001059B_Forgery.Solution_0_Test(input);
