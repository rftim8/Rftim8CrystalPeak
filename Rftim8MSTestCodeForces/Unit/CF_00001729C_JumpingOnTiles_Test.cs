...
{
    [TestClass]
    public sealed class CF_00001729C_JumpingOnTiles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001729C_JumpingOnTiles));
        ...
        {
            bool result = CF_00001729C_JumpingOnTiles.Solution_0_Test(input);
