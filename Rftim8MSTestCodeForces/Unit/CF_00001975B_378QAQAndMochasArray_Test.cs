...
{
    [TestClass]
    public sealed class CF_00001975B_378QAQAndMochasArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001975B_378QAQAndMochasArray));
        ...
        {
            bool result = CF_00001975B_378QAQAndMochasArray.Solution_0_Test(input);
