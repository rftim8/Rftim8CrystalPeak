...
{
    [TestClass]
    public sealed class CF_00000470E_Chessboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000470E_Chessboard));
        ...
        {
            bool result = CF_00000470E_Chessboard.Solution_0_Test(input);
