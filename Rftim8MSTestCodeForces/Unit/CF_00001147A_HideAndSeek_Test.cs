...
{
    [TestClass]
    public sealed class CF_00001147A_HideAndSeek_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001147A_HideAndSeek));
        ...
        {
            bool result = CF_00001147A_HideAndSeek.Solution_0_Test(input);
