...
{
    [TestClass]
    public sealed class CF_00001280D_MissPunyverse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001280D_MissPunyverse));
        ...
        {
            bool result = CF_00001280D_MissPunyverse.Solution_0_Test(input);
