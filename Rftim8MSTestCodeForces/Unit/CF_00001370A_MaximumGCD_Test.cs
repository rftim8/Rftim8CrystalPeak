...
{
    [TestClass]
    public sealed class CF_00001370A_MaximumGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001370A_MaximumGCD));
        ...
        {
            bool result = CF_00001370A_MaximumGCD.Solution_0_Test(input);
