...
{
    [TestClass]
    public sealed class CF_00000687D_DividingKingdomII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000687D_DividingKingdomII));
        ...
        {
            bool result = CF_00000687D_DividingKingdomII.Solution_0_Test(input);
