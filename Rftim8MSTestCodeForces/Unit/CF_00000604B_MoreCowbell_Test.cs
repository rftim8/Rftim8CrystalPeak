...
{
    [TestClass]
    public sealed class CF_00000604B_MoreCowbell_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000604B_MoreCowbell));
        ...
        {
            bool result = CF_00000604B_MoreCowbell.Solution_0_Test(input);
