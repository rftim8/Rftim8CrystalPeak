...
{
    [TestClass]
    public sealed class CF_00000196C_PaintTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000196C_PaintTree));
        ...
        {
            bool result = CF_00000196C_PaintTree.Solution_0_Test(input);
