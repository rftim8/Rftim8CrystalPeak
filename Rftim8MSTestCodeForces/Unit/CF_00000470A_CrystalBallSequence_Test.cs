...
{
    [TestClass]
    public sealed class CF_00000470A_CrystalBallSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000470A_CrystalBallSequence));
        ...
        {
            bool result = CF_00000470A_CrystalBallSequence.Solution_0_Test(input);
