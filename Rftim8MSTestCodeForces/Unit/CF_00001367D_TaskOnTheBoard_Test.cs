...
{
    [TestClass]
    public sealed class CF_00001367D_TaskOnTheBoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001367D_TaskOnTheBoard));
        ...
        {
            bool result = CF_00001367D_TaskOnTheBoard.Solution_0_Test(input);
