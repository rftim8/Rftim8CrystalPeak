...
{
    [TestClass]
    public sealed class CF_00000154E_MartianColony_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000154E_MartianColony));
        ...
        {
            bool result = CF_00000154E_MartianColony.Solution_0_Test(input);
