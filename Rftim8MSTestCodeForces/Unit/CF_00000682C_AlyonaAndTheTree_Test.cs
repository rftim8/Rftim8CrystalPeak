...
{
    [TestClass]
    public sealed class CF_00000682C_AlyonaAndTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000682C_AlyonaAndTheTree));
        ...
        {
            bool result = CF_00000682C_AlyonaAndTheTree.Solution_0_Test(input);
