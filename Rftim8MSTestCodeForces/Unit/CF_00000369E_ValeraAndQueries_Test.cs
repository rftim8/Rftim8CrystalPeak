...
{
    [TestClass]
    public sealed class CF_00000369E_ValeraAndQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000369E_ValeraAndQueries));
        ...
        {
            bool result = CF_00000369E_ValeraAndQueries.Solution_0_Test(input);
