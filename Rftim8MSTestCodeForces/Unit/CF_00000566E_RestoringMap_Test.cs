...
{
    [TestClass]
    public sealed class CF_00000566E_RestoringMap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000566E_RestoringMap));
        ...
        {
            bool result = CF_00000566E_RestoringMap.Solution_0_Test(input);
