...
{
    [TestClass]
    public sealed class CF_00000743A_VladikAndFlights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000743A_VladikAndFlights));
        ...
        {
            bool result = CF_00000743A_VladikAndFlights.Solution_0_Test(input);
