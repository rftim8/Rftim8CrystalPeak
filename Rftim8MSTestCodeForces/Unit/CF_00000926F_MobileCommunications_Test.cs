...
{
    [TestClass]
    public sealed class CF_00000926F_MobileCommunications_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000926F_MobileCommunications));
        ...
        {
            bool result = CF_00000926F_MobileCommunications.Solution_0_Test(input);
