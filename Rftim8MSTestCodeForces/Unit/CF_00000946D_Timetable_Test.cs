...
{
    [TestClass]
    public sealed class CF_00000946D_Timetable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000946D_Timetable));
        ...
        {
            bool result = CF_00000946D_Timetable.Solution_0_Test(input);
