...
{
    [TestClass]
    public sealed class CF_00000470G_HammingDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000470G_HammingDistance));
        ...
        {
            bool result = CF_00000470G_HammingDistance.Solution_0_Test(input);
