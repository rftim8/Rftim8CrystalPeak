...
{
    [TestClass]
    public sealed class CF_00001984C1_MagnitudeEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001984C1_MagnitudeEasyVersion));
        ...
        {
            bool result = CF_00001984C1_MagnitudeEasyVersion.Solution_0_Test(input);
