...
{
    [TestClass]
    public sealed class CF_00001455G_ForbiddenValue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001455G_ForbiddenValue));
        ...
        {
            bool result = CF_00001455G_ForbiddenValue.Solution_0_Test(input);
