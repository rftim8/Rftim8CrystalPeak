...
{
    [TestClass]
    public sealed class CF_00000256D_LiarsAndSerge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000256D_LiarsAndSerge));
        ...
        {
            bool result = CF_00000256D_LiarsAndSerge.Solution_0_Test(input);
