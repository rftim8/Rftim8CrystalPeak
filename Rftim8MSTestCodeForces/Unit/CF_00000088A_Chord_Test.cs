...
{
    [TestClass]
    public sealed class CF_00000088A_Chord_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000088A_Chord));
        ...
        {
            bool result = CF_00000088A_Chord.Solution_0_Test(input);
