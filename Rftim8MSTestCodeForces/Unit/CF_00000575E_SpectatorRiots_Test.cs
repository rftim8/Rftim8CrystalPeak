...
{
    [TestClass]
    public sealed class CF_00000575E_SpectatorRiots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000575E_SpectatorRiots));
        ...
        {
            bool result = CF_00000575E_SpectatorRiots.Solution_0_Test(input);
