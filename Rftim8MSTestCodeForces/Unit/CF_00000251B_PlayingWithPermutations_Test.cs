...
{
    [TestClass]
    public sealed class CF_00000251B_PlayingWithPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000251B_PlayingWithPermutations));
        ...
        {
            bool result = CF_00000251B_PlayingWithPermutations.Solution_0_Test(input);
