...
{
    [TestClass]
    public sealed class CF_00000361B_LevkoAndPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000361B_LevkoAndPermutation));
        ...
        {
            bool result = CF_00000361B_LevkoAndPermutation.Solution_0_Test(input);
