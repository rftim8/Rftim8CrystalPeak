...
{
    [TestClass]
    public sealed class CF_00000039D_CubicalPlanet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000039D_CubicalPlanet));
        ...
        {
            bool result = CF_00000039D_CubicalPlanet.Solution_0_Test(input);
