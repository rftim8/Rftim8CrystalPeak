...
{
    [TestClass]
    public sealed class CF_00000141C_Queue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000141C_Queue));
        ...
        {
            bool result = CF_00000141C_Queue.Solution_0_Test(input);
