...
{
    [TestClass]
    public sealed class CF_00001956F_NeneAndThePassingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001956F_NeneAndThePassingGame));
        ...
        {
            bool result = CF_00001956F_NeneAndThePassingGame.Solution_0_Test(input);
