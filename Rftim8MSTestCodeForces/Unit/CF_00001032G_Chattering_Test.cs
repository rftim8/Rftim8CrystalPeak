...
{
    [TestClass]
    public sealed class CF_00001032G_Chattering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001032G_Chattering));
        ...
        {
            bool result = CF_00001032G_Chattering.Solution_0_Test(input);
