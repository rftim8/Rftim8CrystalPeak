...
{
    [TestClass]
    public sealed class CF_00001266D_DecreasingDebts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001266D_DecreasingDebts));
        ...
        {
            bool result = CF_00001266D_DecreasingDebts.Solution_0_Test(input);
