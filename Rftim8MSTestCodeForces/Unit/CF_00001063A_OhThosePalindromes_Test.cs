...
{
    [TestClass]
    public sealed class CF_00001063A_OhThosePalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001063A_OhThosePalindromes));
        ...
        {
            bool result = CF_00001063A_OhThosePalindromes.Solution_0_Test(input);
