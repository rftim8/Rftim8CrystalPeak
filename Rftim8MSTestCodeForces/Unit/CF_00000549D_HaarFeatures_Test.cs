...
{
    [TestClass]
    public sealed class CF_00000549D_HaarFeatures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000549D_HaarFeatures));
        ...
        {
            bool result = CF_00000549D_HaarFeatures.Solution_0_Test(input);
