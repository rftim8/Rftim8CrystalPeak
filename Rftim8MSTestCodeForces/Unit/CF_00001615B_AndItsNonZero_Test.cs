...
{
    [TestClass]
    public sealed class CF_00001615B_AndItsNonZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001615B_AndItsNonZero));
        ...
        {
            bool result = CF_00001615B_AndItsNonZero.Solution_0_Test(input);
