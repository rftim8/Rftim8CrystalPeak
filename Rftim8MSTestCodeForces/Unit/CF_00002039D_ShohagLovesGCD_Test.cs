...
{
    [TestClass]
    public sealed class CF_00002039D_ShohagLovesGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002039D_ShohagLovesGCD));
        ...
        {
            bool result = CF_00002039D_ShohagLovesGCD.Solution_0_Test(input);
