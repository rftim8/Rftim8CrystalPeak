...
{
    [TestClass]
    public sealed class CF_00001840E_CharacterBlocking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001840E_CharacterBlocking));
        ...
        {
            bool result = CF_00001840E_CharacterBlocking.Solution_0_Test(input);
