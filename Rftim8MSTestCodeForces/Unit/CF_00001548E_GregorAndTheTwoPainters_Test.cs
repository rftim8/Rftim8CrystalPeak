...
{
    [TestClass]
    public sealed class CF_00001548E_GregorAndTheTwoPainters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001548E_GregorAndTheTwoPainters));
        ...
        {
            bool result = CF_00001548E_GregorAndTheTwoPainters.Solution_0_Test(input);
