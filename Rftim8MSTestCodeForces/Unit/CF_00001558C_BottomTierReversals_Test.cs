...
{
    [TestClass]
    public sealed class CF_00001558C_BottomTierReversals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001558C_BottomTierReversals));
        ...
        {
            bool result = CF_00001558C_BottomTierReversals.Solution_0_Test(input);
