...
{
    [TestClass]
    public sealed class CF_00001320E_TreelandAndViruses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001320E_TreelandAndViruses));
        ...
        {
            bool result = CF_00001320E_TreelandAndViruses.Solution_0_Test(input);
