...
{
    [TestClass]
    public sealed class CF_00001896A_JaggedSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001896A_JaggedSwaps));
        ...
        {
            bool result = CF_00001896A_JaggedSwaps.Solution_0_Test(input);
