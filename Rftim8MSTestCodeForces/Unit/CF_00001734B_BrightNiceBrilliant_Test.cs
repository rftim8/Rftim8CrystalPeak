...
{
    [TestClass]
    public sealed class CF_00001734B_BrightNiceBrilliant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001734B_BrightNiceBrilliant));
        ...
        {
            bool result = CF_00001734B_BrightNiceBrilliant.Solution_0_Test(input);
