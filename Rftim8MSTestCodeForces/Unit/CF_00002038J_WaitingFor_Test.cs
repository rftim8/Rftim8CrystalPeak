...
{
    [TestClass]
    public sealed class CF_00002038J_WaitingFor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002038J_WaitingFor));
        ...
        {
            bool result = CF_00002038J_WaitingFor.Solution_0_Test(input);
