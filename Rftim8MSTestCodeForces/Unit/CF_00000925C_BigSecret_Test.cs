...
{
    [TestClass]
    public sealed class CF_00000925C_BigSecret_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000925C_BigSecret));
        ...
        {
            bool result = CF_00000925C_BigSecret.Solution_0_Test(input);
