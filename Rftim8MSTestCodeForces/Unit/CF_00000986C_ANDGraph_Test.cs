...
{
    [TestClass]
    public sealed class CF_00000986C_ANDGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000986C_ANDGraph));
        ...
        {
            bool result = CF_00000986C_ANDGraph.Solution_0_Test(input);
