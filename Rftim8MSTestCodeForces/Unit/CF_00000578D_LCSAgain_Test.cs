...
{
    [TestClass]
    public sealed class CF_00000578D_LCSAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000578D_LCSAgain));
        ...
        {
            bool result = CF_00000578D_LCSAgain.Solution_0_Test(input);
