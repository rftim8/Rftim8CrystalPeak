...
{
    [TestClass]
    public sealed class CF_00000086A_Reflection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000086A_Reflection));
        ...
        {
            bool result = CF_00000086A_Reflection.Solution_0_Test(input);
