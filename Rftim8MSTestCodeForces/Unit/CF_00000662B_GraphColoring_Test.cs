...
{
    [TestClass]
    public sealed class CF_00000662B_GraphColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000662B_GraphColoring));
        ...
        {
            bool result = CF_00000662B_GraphColoring.Solution_0_Test(input);
