...
{
    [TestClass]
    public sealed class CF_00001838C_NoPrimeDifferences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001838C_NoPrimeDifferences));
        ...
        {
            bool result = CF_00001838C_NoPrimeDifferences.Solution_0_Test(input);
