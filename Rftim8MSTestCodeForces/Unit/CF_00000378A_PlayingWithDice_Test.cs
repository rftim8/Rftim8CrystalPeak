...
{
    [TestClass]
    public sealed class CF_00000378A_PlayingWithDice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000378A_PlayingWithDice));
        ...
        {
            bool result = CF_00000378A_PlayingWithDice.Solution_0_Test(input);
