...
{
    [TestClass]
    public sealed class CF_00000938D_BuyATicket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000938D_BuyATicket));
        ...
        {
            bool result = CF_00000938D_BuyATicket.Solution_0_Test(input);
