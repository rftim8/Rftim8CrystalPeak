...
{
    [TestClass]
    public sealed class CF_00002007B_IndexAndMaximumValue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002007B_IndexAndMaximumValue));
        ...
        {
            bool result = CF_00002007B_IndexAndMaximumValue.Solution_0_Test(input);
