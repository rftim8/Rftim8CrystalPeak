...
{
    [TestClass]
    public sealed class CF_00000377B_PreparingForTheContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000377B_PreparingForTheContest));
        ...
        {
            bool result = CF_00000377B_PreparingForTheContest.Solution_0_Test(input);
