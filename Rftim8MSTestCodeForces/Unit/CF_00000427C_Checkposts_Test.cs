...
{
    [TestClass]
    public sealed class CF_00000427C_Checkposts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000427C_Checkposts));
        ...
        {
            bool result = CF_00000427C_Checkposts.Solution_0_Test(input);
