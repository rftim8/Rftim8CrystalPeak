...
{
    [TestClass]
    public sealed class CF_00001092A_UniformString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001092A_UniformString));
        ...
        {
            bool result = CF_00001092A_UniformString.Solution_0_Test(input);
