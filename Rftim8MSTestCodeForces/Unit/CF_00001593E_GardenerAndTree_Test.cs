...
{
    [TestClass]
    public sealed class CF_00001593E_GardenerAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001593E_GardenerAndTree));
        ...
        {
            bool result = CF_00001593E_GardenerAndTree.Solution_0_Test(input);
