...
{
    [TestClass]
    public sealed class CF_00001200A_Hotelier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001200A_Hotelier));
        ...
        {
            bool result = CF_00001200A_Hotelier.Solution_0_Test(input);
