...
{
    [TestClass]
    public sealed class CF_00000448A_Rewards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000448A_Rewards));
        ...
        {
            bool result = CF_00000448A_Rewards.Solution_0_Test(input);
