...
{
    [TestClass]
    public sealed class CF_00001121B_MikeAndChildren_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001121B_MikeAndChildren));
        ...
        {
            bool result = CF_00001121B_MikeAndChildren.Solution_0_Test(input);
