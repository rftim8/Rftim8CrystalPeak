...
{
    [TestClass]
    public sealed class CF_00001002A4_GenerateWState_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001002A4_GenerateWState));
        ...
        {
            bool result = CF_00001002A4_GenerateWState.Solution_0_Test(input);
