...
{
    [TestClass]
    public sealed class CF_00000683H_ExchangeOfBooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000683H_ExchangeOfBooks));
        ...
        {
            bool result = CF_00000683H_ExchangeOfBooks.Solution_0_Test(input);
