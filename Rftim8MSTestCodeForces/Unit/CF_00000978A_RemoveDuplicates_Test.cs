...
{
    [TestClass]
    public sealed class CF_00000978A_RemoveDuplicates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000978A_RemoveDuplicates));
        ...
        {
            bool result = CF_00000978A_RemoveDuplicates.Solution_0_Test(input);
