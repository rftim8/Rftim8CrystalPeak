...
{
    [TestClass]
    public sealed class CF_00001778B_TheForbiddenPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001778B_TheForbiddenPermutation));
        ...
        {
            bool result = CF_00001778B_TheForbiddenPermutation.Solution_0_Test(input);
