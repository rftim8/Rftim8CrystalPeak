...
{
    [TestClass]
    public sealed class CF_00000616F_ExpensiveStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000616F_ExpensiveStrings));
        ...
        {
            bool result = CF_00000616F_ExpensiveStrings.Solution_0_Test(input);
