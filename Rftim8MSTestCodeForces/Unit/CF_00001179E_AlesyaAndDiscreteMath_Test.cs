...
{
    [TestClass]
    public sealed class CF_00001179E_AlesyaAndDiscreteMath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001179E_AlesyaAndDiscreteMath));
        ...
        {
            bool result = CF_00001179E_AlesyaAndDiscreteMath.Solution_0_Test(input);
