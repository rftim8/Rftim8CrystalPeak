...
{
    [TestClass]
    public sealed class CF_00000958F1_LightsabersEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958F1_LightsabersEasy));
        ...
        {
            bool result = CF_00000958F1_LightsabersEasy.Solution_0_Test(input);
