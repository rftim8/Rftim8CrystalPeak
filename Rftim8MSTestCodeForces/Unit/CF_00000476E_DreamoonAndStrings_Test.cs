...
{
    [TestClass]
    public sealed class CF_00000476E_DreamoonAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000476E_DreamoonAndStrings));
        ...
        {
            bool result = CF_00000476E_DreamoonAndStrings.Solution_0_Test(input);
