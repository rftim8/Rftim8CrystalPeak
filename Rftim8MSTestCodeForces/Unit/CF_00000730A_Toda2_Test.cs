...
{
    [TestClass]
    public sealed class CF_00000730A_Toda2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730A_Toda2));
        ...
        {
            bool result = CF_00000730A_Toda2.Solution_0_Test(input);
