...
{
    [TestClass]
    public sealed class CF_00000744D_HongcowDrawsACircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000744D_HongcowDrawsACircle));
        ...
        {
            bool result = CF_00000744D_HongcowDrawsACircle.Solution_0_Test(input);
