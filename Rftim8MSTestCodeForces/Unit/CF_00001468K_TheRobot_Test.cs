...
{
    [TestClass]
    public sealed class CF_00001468K_TheRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468K_TheRobot));
        ...
        {
            bool result = CF_00001468K_TheRobot.Solution_0_Test(input);
