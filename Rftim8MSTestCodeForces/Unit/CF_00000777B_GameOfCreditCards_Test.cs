...
{
    [TestClass]
    public sealed class CF_00000777B_GameOfCreditCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000777B_GameOfCreditCards));
        ...
        {
            bool result = CF_00000777B_GameOfCreditCards.Solution_0_Test(input);
