...
{
    [TestClass]
    public sealed class CF_00001874C_JellyfishAndEVA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001874C_JellyfishAndEVA));
        ...
        {
            bool result = CF_00001874C_JellyfishAndEVA.Solution_0_Test(input);
