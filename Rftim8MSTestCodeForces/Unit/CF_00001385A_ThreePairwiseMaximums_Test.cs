...
{
    [TestClass]
    public sealed class CF_00001385A_ThreePairwiseMaximums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001385A_ThreePairwiseMaximums));
        ...
        {
            bool result = CF_00001385A_ThreePairwiseMaximums.Solution_0_Test(input);
