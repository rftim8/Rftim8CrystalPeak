...
{
    [TestClass]
    public sealed class CF_00001790B_TaisiaAndDice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001790B_TaisiaAndDice));
        ...
        {
            bool result = CF_00001790B_TaisiaAndDice.Solution_0_Test(input);
