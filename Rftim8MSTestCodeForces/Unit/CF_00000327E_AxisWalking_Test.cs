...
{
    [TestClass]
    public sealed class CF_00000327E_AxisWalking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000327E_AxisWalking));
        ...
        {
            bool result = CF_00000327E_AxisWalking.Solution_0_Test(input);
