...
{
    [TestClass]
    public sealed class CF_00001612D_XMagicPair_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001612D_XMagicPair));
        ...
        {
            bool result = CF_00001612D_XMagicPair.Solution_0_Test(input);
