...
{
    [TestClass]
    public sealed class CF_00001213G_PathQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001213G_PathQueries));
        ...
        {
            bool result = CF_00001213G_PathQueries.Solution_0_Test(input);
