...
{
    [TestClass]
    public sealed class CF_00001531E3_MergeSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001531E3_MergeSort));
        ...
        {
            bool result = CF_00001531E3_MergeSort.Solution_0_Test(input);
