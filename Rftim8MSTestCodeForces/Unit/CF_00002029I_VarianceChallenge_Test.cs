...
{
    [TestClass]
    public sealed class CF_00002029I_VarianceChallenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002029I_VarianceChallenge));
        ...
        {
            bool result = CF_00002029I_VarianceChallenge.Solution_0_Test(input);
