...
{
    [TestClass]
    public sealed class CF_00000095E_LuckyCountry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000095E_LuckyCountry));
        ...
        {
            bool result = CF_00000095E_LuckyCountry.Solution_0_Test(input);
