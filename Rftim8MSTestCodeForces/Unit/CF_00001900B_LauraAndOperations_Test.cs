...
{
    [TestClass]
    public sealed class CF_00001900B_LauraAndOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001900B_LauraAndOperations));
        ...
        {
            bool result = CF_00001900B_LauraAndOperations.Solution_0_Test(input);
