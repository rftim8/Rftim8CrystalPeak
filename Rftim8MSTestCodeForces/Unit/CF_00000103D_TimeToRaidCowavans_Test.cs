...
{
    [TestClass]
    public sealed class CF_00000103D_TimeToRaidCowavans_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000103D_TimeToRaidCowavans));
        ...
        {
            bool result = CF_00000103D_TimeToRaidCowavans.Solution_0_Test(input);
