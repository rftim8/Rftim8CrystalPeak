...
{
    [TestClass]
    public sealed class CF_00001183B_EqualizePrices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001183B_EqualizePrices));
        ...
        {
            bool result = CF_00001183B_EqualizePrices.Solution_0_Test(input);
