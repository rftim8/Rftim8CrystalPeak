...
{
    [TestClass]
    public sealed class CF_00001280B_Beingawesomeism_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001280B_Beingawesomeism));
        ...
        {
            bool result = CF_00001280B_Beingawesomeism.Solution_0_Test(input);
