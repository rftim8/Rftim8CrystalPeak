...
{
    [TestClass]
    public sealed class CF_00001217D_ColoringEdges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001217D_ColoringEdges));
        ...
        {
            bool result = CF_00001217D_ColoringEdges.Solution_0_Test(input);
