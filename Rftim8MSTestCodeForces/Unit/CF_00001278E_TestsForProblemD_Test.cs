...
{
    [TestClass]
    public sealed class CF_00001278E_TestsForProblemD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001278E_TestsForProblemD));
        ...
        {
            bool result = CF_00001278E_TestsForProblemD.Solution_0_Test(input);
