...
{
    [TestClass]
    public sealed class CF_00001804A_LameKing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001804A_LameKing));
        ...
        {
            bool result = CF_00001804A_LameKing.Solution_0_Test(input);
