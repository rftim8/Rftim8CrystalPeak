...
{
    [TestClass]
    public sealed class CF_00001060B_MaximumSumOfDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001060B_MaximumSumOfDigits));
        ...
        {
            bool result = CF_00001060B_MaximumSumOfDigits.Solution_0_Test(input);
