...
{
    [TestClass]
    public sealed class CF_00001244D_PaintTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001244D_PaintTheTree));
        ...
        {
            bool result = CF_00001244D_PaintTheTree.Solution_0_Test(input);
