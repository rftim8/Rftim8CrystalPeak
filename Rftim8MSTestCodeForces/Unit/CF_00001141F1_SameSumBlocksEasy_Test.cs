...
{
    [TestClass]
    public sealed class CF_00001141F1_SameSumBlocksEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001141F1_SameSumBlocksEasy));
        ...
        {
            bool result = CF_00001141F1_SameSumBlocksEasy.Solution_0_Test(input);
