...
{
    [TestClass]
    public sealed class CF_00001747B_BANBAN_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001747B_BANBAN));
        ...
        {
            bool result = CF_00001747B_BANBAN.Solution_0_Test(input);
