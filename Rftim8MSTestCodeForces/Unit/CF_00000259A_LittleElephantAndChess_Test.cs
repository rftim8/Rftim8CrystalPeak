...
{
    [TestClass]
    public sealed class CF_00000259A_LittleElephantAndChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000259A_LittleElephantAndChess));
        ...
        {
            bool result = CF_00000259A_LittleElephantAndChess.Solution_0_Test(input);
