...
{
    [TestClass]
    public sealed class CF_00000612D_TheUnionOfKSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000612D_TheUnionOfKSegments));
        ...
        {
            bool result = CF_00000612D_TheUnionOfKSegments.Solution_0_Test(input);
