...
{
    [TestClass]
    public sealed class CF_00001661A_ArrayBalancing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001661A_ArrayBalancing));
        ...
        {
            bool result = CF_00001661A_ArrayBalancing.Solution_0_Test(input);
