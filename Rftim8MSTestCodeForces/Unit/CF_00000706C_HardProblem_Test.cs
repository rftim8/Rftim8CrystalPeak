...
{
    [TestClass]
    public sealed class CF_00000706C_HardProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000706C_HardProblem));
        ...
        {
            bool result = CF_00000706C_HardProblem.Solution_0_Test(input);
