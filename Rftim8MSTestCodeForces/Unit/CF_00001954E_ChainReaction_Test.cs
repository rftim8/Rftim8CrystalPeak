...
{
    [TestClass]
    public sealed class CF_00001954E_ChainReaction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001954E_ChainReaction));
        ...
        {
            bool result = CF_00001954E_ChainReaction.Solution_0_Test(input);
