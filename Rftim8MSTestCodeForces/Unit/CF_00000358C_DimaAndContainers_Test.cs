...
{
    [TestClass]
    public sealed class CF_00000358C_DimaAndContainers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000358C_DimaAndContainers));
        ...
        {
            bool result = CF_00000358C_DimaAndContainers.Solution_0_Test(input);
