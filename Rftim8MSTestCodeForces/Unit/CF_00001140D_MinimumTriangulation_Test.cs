...
{
    [TestClass]
    public sealed class CF_00001140D_MinimumTriangulation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001140D_MinimumTriangulation));
        ...
        {
            bool result = CF_00001140D_MinimumTriangulation.Solution_0_Test(input);
