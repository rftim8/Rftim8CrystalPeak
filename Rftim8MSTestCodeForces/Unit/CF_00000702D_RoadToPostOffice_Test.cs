...
{
    [TestClass]
    public sealed class CF_00000702D_RoadToPostOffice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000702D_RoadToPostOffice));
        ...
        {
            bool result = CF_00000702D_RoadToPostOffice.Solution_0_Test(input);
