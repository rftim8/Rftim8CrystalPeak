...
{
    [TestClass]
    public sealed class CF_00000702F_TShirts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000702F_TShirts));
        ...
        {
            bool result = CF_00000702F_TShirts.Solution_0_Test(input);
