...
{
    [TestClass]
    public sealed class CF_00000665F_FourDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000665F_FourDivisors));
        ...
        {
            bool result = CF_00000665F_FourDivisors.Solution_0_Test(input);
