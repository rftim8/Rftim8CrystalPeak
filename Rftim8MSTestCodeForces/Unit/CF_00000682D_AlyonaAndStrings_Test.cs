...
{
    [TestClass]
    public sealed class CF_00000682D_AlyonaAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000682D_AlyonaAndStrings));
        ...
        {
            bool result = CF_00000682D_AlyonaAndStrings.Solution_0_Test(input);
