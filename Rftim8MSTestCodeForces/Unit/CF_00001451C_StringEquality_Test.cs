...
{
    [TestClass]
    public sealed class CF_00001451C_StringEquality_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001451C_StringEquality));
        ...
        {
            bool result = CF_00001451C_StringEquality.Solution_0_Test(input);
