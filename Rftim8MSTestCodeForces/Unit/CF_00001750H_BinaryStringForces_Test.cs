...
{
    [TestClass]
    public sealed class CF_00001750H_BinaryStringForces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001750H_BinaryStringForces));
        ...
        {
            bool result = CF_00001750H_BinaryStringForces.Solution_0_Test(input);
