...
{
    [TestClass]
    public sealed class CF_00000670D1_MagicPowder1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000670D1_MagicPowder1));
        ...
        {
            bool result = CF_00000670D1_MagicPowder1.Solution_0_Test(input);
