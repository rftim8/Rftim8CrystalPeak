...
{
    [TestClass]
    public sealed class CF_00001167G_LowBudgetInception_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001167G_LowBudgetInception));
        ...
        {
            bool result = CF_00001167G_LowBudgetInception.Solution_0_Test(input);
