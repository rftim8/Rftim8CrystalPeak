...
{
    [TestClass]
    public sealed class CF_00000171H_APolyline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000171H_APolyline));
        ...
        {
            bool result = CF_00000171H_APolyline.Solution_0_Test(input);
