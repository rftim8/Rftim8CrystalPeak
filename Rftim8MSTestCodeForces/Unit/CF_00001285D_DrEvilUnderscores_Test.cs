...
{
    [TestClass]
    public sealed class CF_00001285D_DrEvilUnderscores_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001285D_DrEvilUnderscores));
        ...
        {
            bool result = CF_00001285D_DrEvilUnderscores.Solution_0_Test(input);
