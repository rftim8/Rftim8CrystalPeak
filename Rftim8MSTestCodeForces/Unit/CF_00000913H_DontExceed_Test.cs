...
{
    [TestClass]
    public sealed class CF_00000913H_DontExceed_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000913H_DontExceed));
        ...
        {
            bool result = CF_00000913H_DontExceed.Solution_0_Test(input);
