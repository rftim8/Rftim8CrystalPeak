...
{
    [TestClass]
    public sealed class CF_00000466B_WonderRoom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000466B_WonderRoom));
        ...
        {
            bool result = CF_00000466B_WonderRoom.Solution_0_Test(input);
