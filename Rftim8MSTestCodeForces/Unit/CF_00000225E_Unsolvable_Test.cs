...
{
    [TestClass]
    public sealed class CF_00000225E_Unsolvable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000225E_Unsolvable));
        ...
        {
            bool result = CF_00000225E_Unsolvable.Solution_0_Test(input);
