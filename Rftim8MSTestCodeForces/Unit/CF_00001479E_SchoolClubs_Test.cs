...
{
    [TestClass]
    public sealed class CF_00001479E_SchoolClubs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001479E_SchoolClubs));
        ...
        {
            bool result = CF_00001479E_SchoolClubs.Solution_0_Test(input);
