...
{
    [TestClass]
    public sealed class CF_00000919D_Substring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000919D_Substring));
        ...
        {
            bool result = CF_00000919D_Substring.Solution_0_Test(input);
