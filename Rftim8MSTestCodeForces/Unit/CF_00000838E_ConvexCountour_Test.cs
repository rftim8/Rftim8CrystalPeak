...
{
    [TestClass]
    public sealed class CF_00000838E_ConvexCountour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000838E_ConvexCountour));
        ...
        {
            bool result = CF_00000838E_ConvexCountour.Solution_0_Test(input);
