...
{
    [TestClass]
    public sealed class CF_00001307B_CowAndFriend_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001307B_CowAndFriend));
        ...
        {
            bool result = CF_00001307B_CowAndFriend.Solution_0_Test(input);
