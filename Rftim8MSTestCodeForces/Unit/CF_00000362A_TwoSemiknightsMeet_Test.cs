...
{
    [TestClass]
    public sealed class CF_00000362A_TwoSemiknightsMeet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000362A_TwoSemiknightsMeet));
        ...
        {
            bool result = CF_00000362A_TwoSemiknightsMeet.Solution_0_Test(input);
