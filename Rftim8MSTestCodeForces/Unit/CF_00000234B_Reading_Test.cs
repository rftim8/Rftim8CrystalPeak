...
{
    [TestClass]
    public sealed class CF_00000234B_Reading_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000234B_Reading));
        ...
        {
            bool result = CF_00000234B_Reading.Solution_0_Test(input);
