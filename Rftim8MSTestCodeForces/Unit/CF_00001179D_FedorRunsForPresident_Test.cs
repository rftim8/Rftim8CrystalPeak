...
{
    [TestClass]
    public sealed class CF_00001179D_FedorRunsForPresident_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001179D_FedorRunsForPresident));
        ...
        {
            bool result = CF_00001179D_FedorRunsForPresident.Solution_0_Test(input);
