...
{
    [TestClass]
    public sealed class CF_00001909I_ShortPermutationProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001909I_ShortPermutationProblem));
        ...
        {
            bool result = CF_00001909I_ShortPermutationProblem.Solution_0_Test(input);
