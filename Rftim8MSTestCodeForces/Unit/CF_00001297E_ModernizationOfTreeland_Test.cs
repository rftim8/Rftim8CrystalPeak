...
{
    [TestClass]
    public sealed class CF_00001297E_ModernizationOfTreeland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001297E_ModernizationOfTreeland));
        ...
        {
            bool result = CF_00001297E_ModernizationOfTreeland.Solution_0_Test(input);
