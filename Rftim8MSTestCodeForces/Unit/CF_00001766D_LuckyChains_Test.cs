...
{
    [TestClass]
    public sealed class CF_00001766D_LuckyChains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001766D_LuckyChains));
        ...
        {
            bool result = CF_00001766D_LuckyChains.Solution_0_Test(input);
