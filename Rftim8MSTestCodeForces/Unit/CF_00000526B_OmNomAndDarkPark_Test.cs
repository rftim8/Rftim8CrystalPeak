...
{
    [TestClass]
    public sealed class CF_00000526B_OmNomAndDarkPark_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000526B_OmNomAndDarkPark));
        ...
        {
            bool result = CF_00000526B_OmNomAndDarkPark.Solution_0_Test(input);
