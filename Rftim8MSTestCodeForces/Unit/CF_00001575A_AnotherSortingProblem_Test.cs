...
{
    [TestClass]
    public sealed class CF_00001575A_AnotherSortingProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575A_AnotherSortingProblem));
        ...
        {
            bool result = CF_00001575A_AnotherSortingProblem.Solution_0_Test(input);
