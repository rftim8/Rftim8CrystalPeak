...
{
    [TestClass]
    public sealed class CF_00001170H_LongestSaw_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001170H_LongestSaw));
        ...
        {
            bool result = CF_00001170H_LongestSaw.Solution_0_Test(input);
