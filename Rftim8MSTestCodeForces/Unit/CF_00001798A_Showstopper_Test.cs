...
{
    [TestClass]
    public sealed class CF_00001798A_Showstopper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001798A_Showstopper));
        ...
        {
            bool result = CF_00001798A_Showstopper.Solution_0_Test(input);
