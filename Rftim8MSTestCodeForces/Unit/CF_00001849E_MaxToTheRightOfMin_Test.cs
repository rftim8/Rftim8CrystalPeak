...
{
    [TestClass]
    public sealed class CF_00001849E_MaxToTheRightOfMin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001849E_MaxToTheRightOfMin));
        ...
        {
            bool result = CF_00001849E_MaxToTheRightOfMin.Solution_0_Test(input);
