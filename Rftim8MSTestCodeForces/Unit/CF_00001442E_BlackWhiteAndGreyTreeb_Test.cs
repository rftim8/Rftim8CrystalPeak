...
{
    [TestClass]
    public sealed class CF_00001442E_BlackWhiteAndGreyTreeb_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001442E_BlackWhiteAndGreyTreeb));
        ...
        {
            bool result = CF_00001442E_BlackWhiteAndGreyTreeb.Solution_0_Test(input);
