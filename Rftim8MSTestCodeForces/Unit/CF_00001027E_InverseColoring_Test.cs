...
{
    [TestClass]
    public sealed class CF_00001027E_InverseColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001027E_InverseColoring));
        ...
        {
            bool result = CF_00001027E_InverseColoring.Solution_0_Test(input);
