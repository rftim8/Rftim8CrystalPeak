...
{
    [TestClass]
    public sealed class CF_00000852B_NeuralNetworkCountry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000852B_NeuralNetworkCountry));
        ...
        {
            bool result = CF_00000852B_NeuralNetworkCountry.Solution_0_Test(input);
