...
{
    [TestClass]
    public sealed class CF_00000334B_EightPointSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000334B_EightPointSets));
        ...
        {
            bool result = CF_00000334B_EightPointSets.Solution_0_Test(input);
