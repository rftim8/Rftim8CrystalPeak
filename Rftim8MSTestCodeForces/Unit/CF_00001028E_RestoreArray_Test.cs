...
{
    [TestClass]
    public sealed class CF_00001028E_RestoreArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001028E_RestoreArray));
        ...
        {
            bool result = CF_00001028E_RestoreArray.Solution_0_Test(input);
