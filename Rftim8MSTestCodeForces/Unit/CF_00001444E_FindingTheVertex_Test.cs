...
{
    [TestClass]
    public sealed class CF_00001444E_FindingTheVertex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001444E_FindingTheVertex));
        ...
        {
            bool result = CF_00001444E_FindingTheVertex.Solution_0_Test(input);
