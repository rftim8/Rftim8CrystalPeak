...
{
    [TestClass]
    public sealed class CF_00001774G_SegmentCovering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001774G_SegmentCovering));
        ...
        {
            bool result = CF_00001774G_SegmentCovering.Solution_0_Test(input);
