...
{
    [TestClass]
    public sealed class CF_00001606B_UpdateFiles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001606B_UpdateFiles));
        ...
        {
            bool result = CF_00001606B_UpdateFiles.Solution_0_Test(input);
