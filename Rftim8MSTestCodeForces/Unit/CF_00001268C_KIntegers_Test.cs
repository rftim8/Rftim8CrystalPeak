...
{
    [TestClass]
    public sealed class CF_00001268C_KIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001268C_KIntegers));
        ...
        {
            bool result = CF_00001268C_KIntegers.Solution_0_Test(input);
