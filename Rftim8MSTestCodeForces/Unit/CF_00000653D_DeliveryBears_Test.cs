...
{
    [TestClass]
    public sealed class CF_00000653D_DeliveryBears_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000653D_DeliveryBears));
        ...
        {
            bool result = CF_00000653D_DeliveryBears.Solution_0_Test(input);
