...
{
    [TestClass]
    public sealed class CF_00001861F_FourSuits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001861F_FourSuits));
        ...
        {
            bool result = CF_00001861F_FourSuits.Solution_0_Test(input);
