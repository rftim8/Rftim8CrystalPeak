...
{
    [TestClass]
    public sealed class CF_00000849B_TellYourWorld_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000849B_TellYourWorld));
        ...
        {
            bool result = CF_00000849B_TellYourWorld.Solution_0_Test(input);
