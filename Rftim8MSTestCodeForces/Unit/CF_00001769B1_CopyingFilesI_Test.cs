...
{
    [TestClass]
    public sealed class CF_00001769B1_CopyingFilesI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001769B1_CopyingFilesI));
        ...
        {
            bool result = CF_00001769B1_CopyingFilesI.Solution_0_Test(input);
