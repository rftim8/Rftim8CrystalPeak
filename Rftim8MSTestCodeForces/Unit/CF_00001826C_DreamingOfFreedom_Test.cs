...
{
    [TestClass]
    public sealed class CF_00001826C_DreamingOfFreedom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001826C_DreamingOfFreedom));
        ...
        {
            bool result = CF_00001826C_DreamingOfFreedom.Solution_0_Test(input);
