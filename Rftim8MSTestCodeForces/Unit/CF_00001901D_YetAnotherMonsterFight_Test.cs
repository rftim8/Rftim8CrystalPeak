...
{
    [TestClass]
    public sealed class CF_00001901D_YetAnotherMonsterFight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001901D_YetAnotherMonsterFight));
        ...
        {
            bool result = CF_00001901D_YetAnotherMonsterFight.Solution_0_Test(input);
