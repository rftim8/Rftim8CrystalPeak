...
{
    [TestClass]
    public sealed class CF_00000263A_BeautifulMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000263A_BeautifulMatrix));
        ...
        {
            bool result = CF_00000263A_BeautifulMatrix.Solution_0_Test(input);
