...
{
    [TestClass]
    public sealed class CF_00001869B_2DTraveling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001869B_2DTraveling));
        ...
        {
            bool result = CF_00001869B_2DTraveling.Solution_0_Test(input);
