...
{
    [TestClass]
    public sealed class CF_00001714C_MinimumVariedNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001714C_MinimumVariedNumber));
        ...
        {
            bool result = CF_00001714C_MinimumVariedNumber.Solution_0_Test(input);
