...
{
    [TestClass]
    public sealed class CF_00000746D_GreenAndBlackTea_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000746D_GreenAndBlackTea));
        ...
        {
            bool result = CF_00000746D_GreenAndBlackTea.Solution_0_Test(input);
