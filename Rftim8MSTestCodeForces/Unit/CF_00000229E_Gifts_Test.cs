...
{
    [TestClass]
    public sealed class CF_00000229E_Gifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000229E_Gifts));
        ...
        {
            bool result = CF_00000229E_Gifts.Solution_0_Test(input);
