...
{
    [TestClass]
    public sealed class CF_00000258A_LittleElephantAndBits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000258A_LittleElephantAndBits));
        ...
        {
            bool result = CF_00000258A_LittleElephantAndBits.Solution_0_Test(input);
