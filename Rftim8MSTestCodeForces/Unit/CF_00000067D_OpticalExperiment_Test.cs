...
{
    [TestClass]
    public sealed class CF_00000067D_OpticalExperiment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000067D_OpticalExperiment));
        ...
        {
            bool result = CF_00000067D_OpticalExperiment.Solution_0_Test(input);
