...
{
    [TestClass]
    public sealed class CF_00000847I_NoiseLevel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847I_NoiseLevel));
        ...
        {
            bool result = CF_00000847I_NoiseLevel.Solution_0_Test(input);
