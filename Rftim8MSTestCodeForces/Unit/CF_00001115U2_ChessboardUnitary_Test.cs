...
{
    [TestClass]
    public sealed class CF_00001115U2_ChessboardUnitary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001115U2_ChessboardUnitary));
        ...
        {
            bool result = CF_00001115U2_ChessboardUnitary.Solution_0_Test(input);
