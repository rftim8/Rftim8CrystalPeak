...
{
    [TestClass]
    public sealed class CF_00001560D_MakeAPowerOfTwo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001560D_MakeAPowerOfTwo));
        ...
        {
            bool result = CF_00001560D_MakeAPowerOfTwo.Solution_0_Test(input);
