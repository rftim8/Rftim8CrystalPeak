...
{
    [TestClass]
    public sealed class CF_00001350A_OracAndFactors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001350A_OracAndFactors));
        ...
        {
            bool result = CF_00001350A_OracAndFactors.Solution_0_Test(input);
