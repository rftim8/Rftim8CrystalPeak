...
{
    [TestClass]
    public sealed class CF_00000837F_PrefixSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000837F_PrefixSums));
        ...
        {
            bool result = CF_00000837F_PrefixSums.Solution_0_Test(input);
