...
{
    [TestClass]
    public sealed class CF_00002020B_BrightnessBegins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002020B_BrightnessBegins));
        ...
        {
            bool result = CF_00002020B_BrightnessBegins.Solution_0_Test(input);
