...
{
    [TestClass]
    public sealed class CF_00000822C_HackerPackYourBags_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000822C_HackerPackYourBags));
        ...
        {
            bool result = CF_00000822C_HackerPackYourBags.Solution_0_Test(input);
