...
{
    [TestClass]
    public sealed class CF_00001907G_Lights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001907G_Lights));
        ...
        {
            bool result = CF_00001907G_Lights.Solution_0_Test(input);
