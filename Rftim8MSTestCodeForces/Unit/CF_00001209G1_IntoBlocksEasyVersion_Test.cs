...
{
    [TestClass]
    public sealed class CF_00001209G1_IntoBlocksEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001209G1_IntoBlocksEasyVersion));
        ...
        {
            bool result = CF_00001209G1_IntoBlocksEasyVersion.Solution_0_Test(input);
