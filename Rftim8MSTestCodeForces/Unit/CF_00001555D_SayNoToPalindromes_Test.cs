...
{
    [TestClass]
    public sealed class CF_00001555D_SayNoToPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001555D_SayNoToPalindromes));
        ...
        {
            bool result = CF_00001555D_SayNoToPalindromes.Solution_0_Test(input);
