...
{
    [TestClass]
    public sealed class CF_00000952F_2Plus2NotEqual4_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000952F_2Plus2NotEqual4));
        ...
        {
            bool result = CF_00000952F_2Plus2NotEqual4.Solution_0_Test(input);
