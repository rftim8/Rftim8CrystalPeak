...
{
    [TestClass]
    public sealed class CF_00002028A_AlicesAdventuresInChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002028A_AlicesAdventuresInChess));
        ...
        {
            bool result = CF_00002028A_AlicesAdventuresInChess.Solution_0_Test(input);
