...
{
    [TestClass]
    public sealed class CF_00000599A_PatrickAndShopping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000599A_PatrickAndShopping));
        ...
        {
            bool result = CF_00000599A_PatrickAndShopping.Solution_0_Test(input);
