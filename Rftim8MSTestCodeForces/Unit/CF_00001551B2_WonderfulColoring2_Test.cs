...
{
    [TestClass]
    public sealed class CF_00001551B2_WonderfulColoring2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001551B2_WonderfulColoring2));
        ...
        {
            bool result = CF_00001551B2_WonderfulColoring2.Solution_0_Test(input);
