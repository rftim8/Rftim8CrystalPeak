...
{
    [TestClass]
    public sealed class CF_00000485A_Factory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000485A_Factory));
        ...
        {
            bool result = CF_00000485A_Factory.Solution_0_Test(input);
