...
{
    [TestClass]
    public sealed class CF_00000019A_WorldFootballCup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000019A_WorldFootballCup));
        ...
        {
            bool result = CF_00000019A_WorldFootballCup.Solution_0_Test(input);
