...
{
    [TestClass]
    public sealed class CF_00000372B_CountingRectanglesIsFun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000372B_CountingRectanglesIsFun));
        ...
        {
            bool result = CF_00000372B_CountingRectanglesIsFun.Solution_0_Test(input);
