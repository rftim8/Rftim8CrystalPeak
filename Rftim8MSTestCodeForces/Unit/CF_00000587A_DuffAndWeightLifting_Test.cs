...
{
    [TestClass]
    public sealed class CF_00000587A_DuffAndWeightLifting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000587A_DuffAndWeightLifting));
        ...
        {
            bool result = CF_00000587A_DuffAndWeightLifting.Solution_0_Test(input);
