...
{
    [TestClass]
    public sealed class CF_00000637B_ChatOrder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000637B_ChatOrder));
        ...
        {
            bool result = CF_00000637B_ChatOrder.Solution_0_Test(input);
