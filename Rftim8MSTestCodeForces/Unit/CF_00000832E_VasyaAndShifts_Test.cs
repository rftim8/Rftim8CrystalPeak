...
{
    [TestClass]
    public sealed class CF_00000832E_VasyaAndShifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000832E_VasyaAndShifts));
        ...
        {
            bool result = CF_00000832E_VasyaAndShifts.Solution_0_Test(input);
