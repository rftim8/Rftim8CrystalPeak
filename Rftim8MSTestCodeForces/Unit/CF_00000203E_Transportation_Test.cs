...
{
    [TestClass]
    public sealed class CF_00000203E_Transportation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000203E_Transportation));
        ...
        {
            bool result = CF_00000203E_Transportation.Solution_0_Test(input);
