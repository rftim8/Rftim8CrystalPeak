...
{
    [TestClass]
    public sealed class CF_00001700F_Puzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001700F_Puzzle));
        ...
        {
            bool result = CF_00001700F_Puzzle.Solution_0_Test(input);
