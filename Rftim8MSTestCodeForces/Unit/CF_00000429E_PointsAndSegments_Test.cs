...
{
    [TestClass]
    public sealed class CF_00000429E_PointsAndSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000429E_PointsAndSegments));
        ...
        {
            bool result = CF_00000429E_PointsAndSegments.Solution_0_Test(input);
