...
{
    [TestClass]
    public sealed class CF_00001208F_BitsAndPieces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001208F_BitsAndPieces));
        ...
        {
            bool result = CF_00001208F_BitsAndPieces.Solution_0_Test(input);
