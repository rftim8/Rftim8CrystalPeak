...
{
    [TestClass]
    public sealed class CF_00001420B_RockAndLever_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001420B_RockAndLever));
        ...
        {
            bool result = CF_00001420B_RockAndLever.Solution_0_Test(input);
