...
{
    [TestClass]
    public sealed class CF_00001906B_ButtonPressing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001906B_ButtonPressing));
        ...
        {
            bool result = CF_00001906B_ButtonPressing.Solution_0_Test(input);
