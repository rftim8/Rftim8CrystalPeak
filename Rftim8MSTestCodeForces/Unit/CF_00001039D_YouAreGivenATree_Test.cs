...
{
    [TestClass]
    public sealed class CF_00001039D_YouAreGivenATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001039D_YouAreGivenATree));
        ...
        {
            bool result = CF_00001039D_YouAreGivenATree.Solution_0_Test(input);
