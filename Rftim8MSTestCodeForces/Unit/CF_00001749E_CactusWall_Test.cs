...
{
    [TestClass]
    public sealed class CF_00001749E_CactusWall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001749E_CactusWall));
        ...
        {
            bool result = CF_00001749E_CactusWall.Solution_0_Test(input);
