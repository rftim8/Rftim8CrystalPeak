...
{
    [TestClass]
    public sealed class CF_00001428H_RotaryLaserLock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001428H_RotaryLaserLock));
        ...
        {
            bool result = CF_00001428H_RotaryLaserLock.Solution_0_Test(input);
