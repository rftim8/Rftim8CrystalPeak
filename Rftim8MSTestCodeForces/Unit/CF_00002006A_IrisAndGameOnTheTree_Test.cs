...
{
    [TestClass]
    public sealed class CF_00002006A_IrisAndGameOnTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002006A_IrisAndGameOnTheTree));
        ...
        {
            bool result = CF_00002006A_IrisAndGameOnTheTree.Solution_0_Test(input);
