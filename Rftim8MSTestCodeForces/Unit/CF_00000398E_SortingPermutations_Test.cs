...
{
    [TestClass]
    public sealed class CF_00000398E_SortingPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000398E_SortingPermutations));
        ...
        {
            bool result = CF_00000398E_SortingPermutations.Solution_0_Test(input);
