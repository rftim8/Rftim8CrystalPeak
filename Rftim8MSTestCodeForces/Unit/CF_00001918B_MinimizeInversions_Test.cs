...
{
    [TestClass]
    public sealed class CF_00001918B_MinimizeInversions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001918B_MinimizeInversions));
        ...
        {
            bool result = CF_00001918B_MinimizeInversions.Solution_0_Test(input);
