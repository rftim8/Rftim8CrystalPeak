...
{
    [TestClass]
    public sealed class CF_00000366E_DimaAndMagicGuitar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000366E_DimaAndMagicGuitar));
        ...
        {
            bool result = CF_00000366E_DimaAndMagicGuitar.Solution_0_Test(input);
