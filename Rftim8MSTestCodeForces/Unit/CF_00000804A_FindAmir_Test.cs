...
{
    [TestClass]
    public sealed class CF_00000804A_FindAmir_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000804A_FindAmir));
        ...
        {
            bool result = CF_00000804A_FindAmir.Solution_0_Test(input);
