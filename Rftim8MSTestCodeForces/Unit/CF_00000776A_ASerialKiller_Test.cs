...
{
    [TestClass]
    public sealed class CF_00000776A_ASerialKiller_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000776A_ASerialKiller));
        ...
        {
            bool result = CF_00000776A_ASerialKiller.Solution_0_Test(input);
