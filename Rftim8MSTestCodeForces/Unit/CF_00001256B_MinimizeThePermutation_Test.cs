...
{
    [TestClass]
    public sealed class CF_00001256B_MinimizeThePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001256B_MinimizeThePermutation));
        ...
        {
            bool result = CF_00001256B_MinimizeThePermutation.Solution_0_Test(input);
