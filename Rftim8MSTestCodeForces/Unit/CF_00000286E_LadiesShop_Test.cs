...
{
    [TestClass]
    public sealed class CF_00000286E_LadiesShop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000286E_LadiesShop));
        ...
        {
            bool result = CF_00000286E_LadiesShop.Solution_0_Test(input);
