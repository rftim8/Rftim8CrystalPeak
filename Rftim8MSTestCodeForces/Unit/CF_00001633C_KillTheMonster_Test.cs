...
{
    [TestClass]
    public sealed class CF_00001633C_KillTheMonster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001633C_KillTheMonster));
        ...
        {
            bool result = CF_00001633C_KillTheMonster.Solution_0_Test(input);
