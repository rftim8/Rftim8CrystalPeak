...
{
    [TestClass]
    public sealed class CF_00001277A_HappyBirthdayPolycarp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001277A_HappyBirthdayPolycarp));
        ...
        {
            bool result = CF_00001277A_HappyBirthdayPolycarp.Solution_0_Test(input);
