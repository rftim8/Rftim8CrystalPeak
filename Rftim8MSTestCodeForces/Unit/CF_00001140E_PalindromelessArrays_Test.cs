...
{
    [TestClass]
    public sealed class CF_00001140E_PalindromelessArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001140E_PalindromelessArrays));
        ...
        {
            bool result = CF_00001140E_PalindromelessArrays.Solution_0_Test(input);
