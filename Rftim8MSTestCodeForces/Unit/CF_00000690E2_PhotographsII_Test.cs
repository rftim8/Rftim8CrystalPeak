...
{
    [TestClass]
    public sealed class CF_00000690E2_PhotographsII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690E2_PhotographsII));
        ...
        {
            bool result = CF_00000690E2_PhotographsII.Solution_0_Test(input);
