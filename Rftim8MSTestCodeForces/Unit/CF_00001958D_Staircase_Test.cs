...
{
    [TestClass]
    public sealed class CF_00001958D_Staircase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001958D_Staircase));
        ...
        {
            bool result = CF_00001958D_Staircase.Solution_0_Test(input);
