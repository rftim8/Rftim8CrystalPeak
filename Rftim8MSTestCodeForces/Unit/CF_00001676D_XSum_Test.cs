...
{
    [TestClass]
    public sealed class CF_00001676D_XSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001676D_XSum));
        ...
        {
            bool result = CF_00001676D_XSum.Solution_0_Test(input);
