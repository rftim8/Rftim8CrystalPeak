...
{
    [TestClass]
    public sealed class CF_00001630F_MakingItBipartite_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001630F_MakingItBipartite));
        ...
        {
            bool result = CF_00001630F_MakingItBipartite.Solution_0_Test(input);
