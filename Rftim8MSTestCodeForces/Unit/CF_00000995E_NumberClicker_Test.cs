...
{
    [TestClass]
    public sealed class CF_00000995E_NumberClicker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000995E_NumberClicker));
        ...
        {
            bool result = CF_00000995E_NumberClicker.Solution_0_Test(input);
