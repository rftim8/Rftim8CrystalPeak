...
{
    [TestClass]
    public sealed class CF_00000576C_PointsOnPlane_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000576C_PointsOnPlane));
        ...
        {
            bool result = CF_00000576C_PointsOnPlane.Solution_0_Test(input);
