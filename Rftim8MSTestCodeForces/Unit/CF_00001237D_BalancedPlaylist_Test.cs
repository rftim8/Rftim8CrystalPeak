...
{
    [TestClass]
    public sealed class CF_00001237D_BalancedPlaylist_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001237D_BalancedPlaylist));
        ...
        {
            bool result = CF_00001237D_BalancedPlaylist.Solution_0_Test(input);
