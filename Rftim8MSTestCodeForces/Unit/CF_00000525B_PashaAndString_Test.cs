...
{
    [TestClass]
    public sealed class CF_00000525B_PashaAndString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000525B_PashaAndString));
        ...
        {
            bool result = CF_00000525B_PashaAndString.Solution_0_Test(input);
