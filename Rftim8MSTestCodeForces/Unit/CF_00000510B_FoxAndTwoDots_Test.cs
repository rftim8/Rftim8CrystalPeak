...
{
    [TestClass]
    public sealed class CF_00000510B_FoxAndTwoDots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000510B_FoxAndTwoDots));
        ...
        {
            bool result = CF_00000510B_FoxAndTwoDots.Solution_0_Test(input);
