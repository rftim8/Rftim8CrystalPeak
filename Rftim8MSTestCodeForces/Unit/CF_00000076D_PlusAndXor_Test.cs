...
{
    [TestClass]
    public sealed class CF_00000076D_PlusAndXor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000076D_PlusAndXor));
        ...
        {
            bool result = CF_00000076D_PlusAndXor.Solution_0_Test(input);
