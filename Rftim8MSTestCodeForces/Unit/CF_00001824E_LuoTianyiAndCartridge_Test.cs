...
{
    [TestClass]
    public sealed class CF_00001824E_LuoTianyiAndCartridge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001824E_LuoTianyiAndCartridge));
        ...
        {
            bool result = CF_00001824E_LuoTianyiAndCartridge.Solution_0_Test(input);
