...
{
    [TestClass]
    public sealed class CF_00000411B_MulticoreProcessor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000411B_MulticoreProcessor));
        ...
        {
            bool result = CF_00000411B_MulticoreProcessor.Solution_0_Test(input);
