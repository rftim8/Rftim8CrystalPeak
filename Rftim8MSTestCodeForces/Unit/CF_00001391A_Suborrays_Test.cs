...
{
    [TestClass]
    public sealed class CF_00001391A_Suborrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001391A_Suborrays));
        ...
        {
            bool result = CF_00001391A_Suborrays.Solution_0_Test(input);
