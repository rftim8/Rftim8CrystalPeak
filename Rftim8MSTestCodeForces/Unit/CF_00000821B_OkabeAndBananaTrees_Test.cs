...
{
    [TestClass]
    public sealed class CF_00000821B_OkabeAndBananaTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000821B_OkabeAndBananaTrees));
        ...
        {
            bool result = CF_00000821B_OkabeAndBananaTrees.Solution_0_Test(input);
