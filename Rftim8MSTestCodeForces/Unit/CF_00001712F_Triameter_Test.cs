...
{
    [TestClass]
    public sealed class CF_00001712F_Triameter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001712F_Triameter));
        ...
        {
            bool result = CF_00001712F_Triameter.Solution_0_Test(input);
