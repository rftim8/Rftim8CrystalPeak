...
{
    [TestClass]
    public sealed class CF_00000276A_LunchRush_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000276A_LunchRush));
        ...
        {
            bool result = CF_00000276A_LunchRush.Solution_0_Test(input);
