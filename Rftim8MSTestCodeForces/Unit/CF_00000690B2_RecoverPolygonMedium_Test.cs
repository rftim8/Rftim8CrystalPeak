...
{
    [TestClass]
    public sealed class CF_00000690B2_RecoverPolygonMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690B2_RecoverPolygonMedium));
        ...
        {
            bool result = CF_00000690B2_RecoverPolygonMedium.Solution_0_Test(input);
