...
{
    [TestClass]
    public sealed class CF_00000833B_TheBakery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000833B_TheBakery));
        ...
        {
            bool result = CF_00000833B_TheBakery.Solution_0_Test(input);
