...
{
    [TestClass]
    public sealed class CF_00001130B_TwoCakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001130B_TwoCakes));
        ...
        {
            bool result = CF_00001130B_TwoCakes.Solution_0_Test(input);
