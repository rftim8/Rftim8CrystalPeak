...
{
    [TestClass]
    public sealed class CF_00000897B_ChthollysRequest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000897B_ChthollysRequest));
        ...
        {
            bool result = CF_00000897B_ChthollysRequest.Solution_0_Test(input);
