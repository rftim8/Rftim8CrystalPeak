...
{
    [TestClass]
    public sealed class CF_00000084C_Biathlon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000084C_Biathlon));
        ...
        {
            bool result = CF_00000084C_Biathlon.Solution_0_Test(input);
