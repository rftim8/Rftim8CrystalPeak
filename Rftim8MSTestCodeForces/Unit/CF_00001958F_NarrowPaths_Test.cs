...
{
    [TestClass]
    public sealed class CF_00001958F_NarrowPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001958F_NarrowPaths));
        ...
        {
            bool result = CF_00001958F_NarrowPaths.Solution_0_Test(input);
