...
{
    [TestClass]
    public sealed class CF_00000518E_ArthurAndQuestions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000518E_ArthurAndQuestions));
        ...
        {
            bool result = CF_00000518E_ArthurAndQuestions.Solution_0_Test(input);
