...
{
    [TestClass]
    public sealed class CF_00000223D_Spider_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000223D_Spider));
        ...
        {
            bool result = CF_00000223D_Spider.Solution_0_Test(input);
