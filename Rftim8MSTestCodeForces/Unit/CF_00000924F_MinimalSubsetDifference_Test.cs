...
{
    [TestClass]
    public sealed class CF_00000924F_MinimalSubsetDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000924F_MinimalSubsetDifference));
        ...
        {
            bool result = CF_00000924F_MinimalSubsetDifference.Solution_0_Test(input);
