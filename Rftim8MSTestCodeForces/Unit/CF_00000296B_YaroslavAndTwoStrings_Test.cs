...
{
    [TestClass]
    public sealed class CF_00000296B_YaroslavAndTwoStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000296B_YaroslavAndTwoStrings));
        ...
        {
            bool result = CF_00000296B_YaroslavAndTwoStrings.Solution_0_Test(input);
