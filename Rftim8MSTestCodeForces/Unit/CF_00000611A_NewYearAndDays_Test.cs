...
{
    [TestClass]
    public sealed class CF_00000611A_NewYearAndDays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000611A_NewYearAndDays));
        ...
        {
            bool result = CF_00000611A_NewYearAndDays.Solution_0_Test(input);
