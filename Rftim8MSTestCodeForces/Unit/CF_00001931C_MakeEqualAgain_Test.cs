...
{
    [TestClass]
    public sealed class CF_00001931C_MakeEqualAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001931C_MakeEqualAgain));
        ...
        {
            bool result = CF_00001931C_MakeEqualAgain.Solution_0_Test(input);
