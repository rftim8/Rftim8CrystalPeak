...
{
    [TestClass]
    public sealed class CF_00000145A_LuckyConversion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000145A_LuckyConversion));
        ...
        {
            bool result = CF_00000145A_LuckyConversion.Solution_0_Test(input);
