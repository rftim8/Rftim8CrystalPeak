...
{
    [TestClass]
    public sealed class CF_00001192A_BuildingSkyscrapers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001192A_BuildingSkyscrapers));
        ...
        {
            bool result = CF_00001192A_BuildingSkyscrapers.Solution_0_Test(input);
