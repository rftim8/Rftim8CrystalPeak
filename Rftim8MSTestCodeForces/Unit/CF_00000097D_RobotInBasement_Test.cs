...
{
    [TestClass]
    public sealed class CF_00000097D_RobotInBasement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000097D_RobotInBasement));
        ...
        {
            bool result = CF_00000097D_RobotInBasement.Solution_0_Test(input);
