...
{
    [TestClass]
    public sealed class CF_00000852D_ExplorationPlan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000852D_ExplorationPlan));
        ...
        {
            bool result = CF_00000852D_ExplorationPlan.Solution_0_Test(input);
