...
{
    [TestClass]
    public sealed class CF_00001994A_DiverseGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001994A_DiverseGame));
        ...
        {
            bool result = CF_00001994A_DiverseGame.Solution_0_Test(input);
