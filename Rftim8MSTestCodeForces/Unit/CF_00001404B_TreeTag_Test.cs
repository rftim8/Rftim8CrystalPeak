...
{
    [TestClass]
    public sealed class CF_00001404B_TreeTag_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001404B_TreeTag));
        ...
        {
            bool result = CF_00001404B_TreeTag.Solution_0_Test(input);
