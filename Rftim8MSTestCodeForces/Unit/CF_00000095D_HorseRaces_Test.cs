...
{
    [TestClass]
    public sealed class CF_00000095D_HorseRaces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000095D_HorseRaces));
        ...
        {
            bool result = CF_00000095D_HorseRaces.Solution_0_Test(input);
