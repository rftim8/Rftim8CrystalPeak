...
{
    [TestClass]
    public sealed class CF_00001234E_SpecialPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001234E_SpecialPermutations));
        ...
        {
            bool result = CF_00001234E_SpecialPermutations.Solution_0_Test(input);
