...
{
    [TestClass]
    public sealed class CF_00001750E_BracketCost_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001750E_BracketCost));
        ...
        {
            bool result = CF_00001750E_BracketCost.Solution_0_Test(input);
