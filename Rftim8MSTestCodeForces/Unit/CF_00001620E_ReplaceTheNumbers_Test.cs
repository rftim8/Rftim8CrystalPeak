...
{
    [TestClass]
    public sealed class CF_00001620E_ReplaceTheNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001620E_ReplaceTheNumbers));
        ...
        {
            bool result = CF_00001620E_ReplaceTheNumbers.Solution_0_Test(input);
