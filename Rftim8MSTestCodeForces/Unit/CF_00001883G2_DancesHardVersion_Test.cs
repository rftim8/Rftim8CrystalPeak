...
{
    [TestClass]
    public sealed class CF_00001883G2_DancesHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001883G2_DancesHardVersion));
        ...
        {
            bool result = CF_00001883G2_DancesHardVersion.Solution_0_Test(input);
