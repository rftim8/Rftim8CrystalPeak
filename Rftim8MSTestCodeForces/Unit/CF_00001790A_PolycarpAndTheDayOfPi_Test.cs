...
{
    [TestClass]
    public sealed class CF_00001790A_PolycarpAndTheDayOfPi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001790A_PolycarpAndTheDayOfPi));
        ...
        {
            bool result = CF_00001790A_PolycarpAndTheDayOfPi.Solution_0_Test(input);
