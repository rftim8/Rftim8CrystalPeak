...
{
    [TestClass]
    public sealed class CF_00001810A_BeautifulSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001810A_BeautifulSequence));
        ...
        {
            bool result = CF_00001810A_BeautifulSequence.Solution_0_Test(input);
