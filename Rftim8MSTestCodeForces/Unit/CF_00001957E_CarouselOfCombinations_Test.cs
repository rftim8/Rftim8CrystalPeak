...
{
    [TestClass]
    public sealed class CF_00001957E_CarouselOfCombinations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001957E_CarouselOfCombinations));
        ...
        {
            bool result = CF_00001957E_CarouselOfCombinations.Solution_0_Test(input);
