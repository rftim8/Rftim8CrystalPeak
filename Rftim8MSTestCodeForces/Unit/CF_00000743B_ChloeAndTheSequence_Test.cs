...
{
    [TestClass]
    public sealed class CF_00000743B_ChloeAndTheSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000743B_ChloeAndTheSequence));
        ...
        {
            bool result = CF_00000743B_ChloeAndTheSequence.Solution_0_Test(input);
