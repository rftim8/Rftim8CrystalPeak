...
{
    [TestClass]
    public sealed class CF_00001202F_YouAreGivenSomeLetters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001202F_YouAreGivenSomeLetters));
        ...
        {
            bool result = CF_00001202F_YouAreGivenSomeLetters.Solution_0_Test(input);
