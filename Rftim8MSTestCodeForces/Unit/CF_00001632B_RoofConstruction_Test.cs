...
{
    [TestClass]
    public sealed class CF_00001632B_RoofConstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001632B_RoofConstruction));
        ...
        {
            bool result = CF_00001632B_RoofConstruction.Solution_0_Test(input);
