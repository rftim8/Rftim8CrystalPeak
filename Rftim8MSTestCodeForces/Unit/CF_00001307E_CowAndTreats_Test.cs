...
{
    [TestClass]
    public sealed class CF_00001307E_CowAndTreats_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001307E_CowAndTreats));
        ...
        {
            bool result = CF_00001307E_CowAndTreats.Solution_0_Test(input);
