...
{
    [TestClass]
    public sealed class CF_00001863I_RedundantRoutes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001863I_RedundantRoutes));
        ...
        {
            bool result = CF_00001863I_RedundantRoutes.Solution_0_Test(input);
