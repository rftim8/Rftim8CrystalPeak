...
{
    [TestClass]
    public sealed class CF_00000047D_Safe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000047D_Safe));
        ...
        {
            bool result = CF_00000047D_Safe.Solution_0_Test(input);
