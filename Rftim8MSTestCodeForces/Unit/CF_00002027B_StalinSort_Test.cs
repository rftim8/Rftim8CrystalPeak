...
{
    [TestClass]
    public sealed class CF_00002027B_StalinSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002027B_StalinSort));
        ...
        {
            bool result = CF_00002027B_StalinSort.Solution_0_Test(input);
