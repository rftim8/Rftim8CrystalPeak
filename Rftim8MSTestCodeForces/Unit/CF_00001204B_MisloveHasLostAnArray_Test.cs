...
{
    [TestClass]
    public sealed class CF_00001204B_MisloveHasLostAnArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001204B_MisloveHasLostAnArray));
        ...
        {
            bool result = CF_00001204B_MisloveHasLostAnArray.Solution_0_Test(input);
