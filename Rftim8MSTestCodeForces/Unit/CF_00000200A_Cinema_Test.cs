...
{
    [TestClass]
    public sealed class CF_00000200A_Cinema_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000200A_Cinema));
        ...
        {
            bool result = CF_00000200A_Cinema.Solution_0_Test(input);
