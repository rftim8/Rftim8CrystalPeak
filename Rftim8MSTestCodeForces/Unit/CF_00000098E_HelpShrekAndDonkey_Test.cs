...
{
    [TestClass]
    public sealed class CF_00000098E_HelpShrekAndDonkey_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000098E_HelpShrekAndDonkey));
        ...
        {
            bool result = CF_00000098E_HelpShrekAndDonkey.Solution_0_Test(input);
