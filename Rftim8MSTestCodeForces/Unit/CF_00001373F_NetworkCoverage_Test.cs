...
{
    [TestClass]
    public sealed class CF_00001373F_NetworkCoverage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001373F_NetworkCoverage));
        ...
        {
            bool result = CF_00001373F_NetworkCoverage.Solution_0_Test(input);
