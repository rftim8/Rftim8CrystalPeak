...
{
    [TestClass]
    public sealed class CF_00000226B_NaughtyStonePiles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000226B_NaughtyStonePiles));
        ...
        {
            bool result = CF_00000226B_NaughtyStonePiles.Solution_0_Test(input);
