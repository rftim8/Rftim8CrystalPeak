...
{
    [TestClass]
    public sealed class CF_00001219C_PeriodicIntegerNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001219C_PeriodicIntegerNumber));
        ...
        {
            bool result = CF_00001219C_PeriodicIntegerNumber.Solution_0_Test(input);
