...
{
    [TestClass]
    public sealed class CF_00000855B_MarvoloGauntsRing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000855B_MarvoloGauntsRing));
        ...
        {
            bool result = CF_00000855B_MarvoloGauntsRing.Solution_0_Test(input);
