...
{
    [TestClass]
    public sealed class CF_00001268B_DominoForYoung_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001268B_DominoForYoung));
        ...
        {
            bool result = CF_00001268B_DominoForYoung.Solution_0_Test(input);
