...
{
    [TestClass]
    public sealed class CF_00000573D_BearAndCavalry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000573D_BearAndCavalry));
        ...
        {
            bool result = CF_00000573D_BearAndCavalry.Solution_0_Test(input);
