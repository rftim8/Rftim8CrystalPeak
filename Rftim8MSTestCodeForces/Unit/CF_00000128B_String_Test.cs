...
{
    [TestClass]
    public sealed class CF_00000128B_String_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000128B_String));
        ...
        {
            bool result = CF_00000128B_String.Solution_0_Test(input);
