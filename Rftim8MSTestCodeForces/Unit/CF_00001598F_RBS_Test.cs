...
{
    [TestClass]
    public sealed class CF_00001598F_RBS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001598F_RBS));
        ...
        {
            bool result = CF_00001598F_RBS.Solution_0_Test(input);
