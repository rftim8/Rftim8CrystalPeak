...
{
    [TestClass]
    public sealed class CF_00001716C_RobotInAHallway_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001716C_RobotInAHallway));
        ...
        {
            bool result = CF_00001716C_RobotInAHallway.Solution_0_Test(input);
