...
{
    [TestClass]
    public sealed class CF_00001691C_SumOfSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001691C_SumOfSubstrings));
        ...
        {
            bool result = CF_00001691C_SumOfSubstrings.Solution_0_Test(input);
