...
{
    [TestClass]
    public sealed class CF_00000340E_IahubAndPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000340E_IahubAndPermutations));
        ...
        {
            bool result = CF_00000340E_IahubAndPermutations.Solution_0_Test(input);
