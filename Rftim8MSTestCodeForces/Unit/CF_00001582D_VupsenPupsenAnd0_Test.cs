...
{
    [TestClass]
    public sealed class CF_00001582D_VupsenPupsenAnd0_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001582D_VupsenPupsenAnd0));
        ...
        {
            bool result = CF_00001582D_VupsenPupsenAnd0.Solution_0_Test(input);
