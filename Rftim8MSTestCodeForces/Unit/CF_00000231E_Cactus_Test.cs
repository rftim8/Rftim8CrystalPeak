...
{
    [TestClass]
    public sealed class CF_00000231E_Cactus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000231E_Cactus));
        ...
        {
            bool result = CF_00000231E_Cactus.Solution_0_Test(input);
