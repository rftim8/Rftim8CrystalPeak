...
{
    [TestClass]
    public sealed class CF_00001837E_PlayoffFixing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001837E_PlayoffFixing));
        ...
        {
            bool result = CF_00001837E_PlayoffFixing.Solution_0_Test(input);
