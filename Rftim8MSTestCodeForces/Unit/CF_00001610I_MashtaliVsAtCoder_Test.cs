...
{
    [TestClass]
    public sealed class CF_00001610I_MashtaliVsAtCoder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001610I_MashtaliVsAtCoder));
        ...
        {
            bool result = CF_00001610I_MashtaliVsAtCoder.Solution_0_Test(input);
