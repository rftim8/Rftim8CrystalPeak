...
{
    [TestClass]
    public sealed class CF_00001810H_LastNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001810H_LastNumber));
        ...
        {
            bool result = CF_00001810H_LastNumber.Solution_0_Test(input);
