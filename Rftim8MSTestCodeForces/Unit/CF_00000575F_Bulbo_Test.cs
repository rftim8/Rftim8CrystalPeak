...
{
    [TestClass]
    public sealed class CF_00000575F_Bulbo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000575F_Bulbo));
        ...
        {
            bool result = CF_00000575F_Bulbo.Solution_0_Test(input);
