...
{
    [TestClass]
    public sealed class CF_00001798C_CandyStore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001798C_CandyStore));
        ...
        {
            bool result = CF_00001798C_CandyStore.Solution_0_Test(input);
