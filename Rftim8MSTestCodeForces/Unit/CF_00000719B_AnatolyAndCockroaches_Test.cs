...
{
    [TestClass]
    public sealed class CF_00000719B_AnatolyAndCockroaches_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000719B_AnatolyAndCockroaches));
        ...
        {
            bool result = CF_00000719B_AnatolyAndCockroaches.Solution_0_Test(input);
