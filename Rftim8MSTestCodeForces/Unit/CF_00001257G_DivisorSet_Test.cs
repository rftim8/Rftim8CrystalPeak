...
{
    [TestClass]
    public sealed class CF_00001257G_DivisorSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001257G_DivisorSet));
        ...
        {
            bool result = CF_00001257G_DivisorSet.Solution_0_Test(input);
