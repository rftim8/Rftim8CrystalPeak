...
{
    [TestClass]
    public sealed class CF_00001713C_BuildPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001713C_BuildPermutation));
        ...
        {
            bool result = CF_00001713C_BuildPermutation.Solution_0_Test(input);
