...
{
    [TestClass]
    public sealed class CF_00001037A_Packets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001037A_Packets));
        ...
        {
            bool result = CF_00001037A_Packets.Solution_0_Test(input);
