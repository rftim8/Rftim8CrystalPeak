...
{
    [TestClass]
    public sealed class CF_00001077E_ThematicContests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001077E_ThematicContests));
        ...
        {
            bool result = CF_00001077E_ThematicContests.Solution_0_Test(input);
