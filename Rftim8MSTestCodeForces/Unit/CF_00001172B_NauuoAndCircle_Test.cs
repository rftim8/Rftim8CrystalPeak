...
{
    [TestClass]
    public sealed class CF_00001172B_NauuoAndCircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001172B_NauuoAndCircle));
        ...
        {
            bool result = CF_00001172B_NauuoAndCircle.Solution_0_Test(input);
