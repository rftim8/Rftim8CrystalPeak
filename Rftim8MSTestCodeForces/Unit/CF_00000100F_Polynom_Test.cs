...
{
    [TestClass]
    public sealed class CF_00000100F_Polynom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000100F_Polynom));
        ...
        {
            bool result = CF_00000100F_Polynom.Solution_0_Test(input);
