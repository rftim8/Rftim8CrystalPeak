...
{
    [TestClass]
    public sealed class CF_00001580C_TrainMaintenance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001580C_TrainMaintenance));
        ...
        {
            bool result = CF_00001580C_TrainMaintenance.Solution_0_Test(input);
