...
{
    [TestClass]
    public sealed class CF_00001361B_JohnnyAndGrandmaster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001361B_JohnnyAndGrandmaster));
        ...
        {
            bool result = CF_00001361B_JohnnyAndGrandmaster.Solution_0_Test(input);
