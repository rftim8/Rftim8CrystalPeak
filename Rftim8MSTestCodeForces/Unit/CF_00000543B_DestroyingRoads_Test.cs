...
{
    [TestClass]
    public sealed class CF_00000543B_DestroyingRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000543B_DestroyingRoads));
        ...
        {
            bool result = CF_00000543B_DestroyingRoads.Solution_0_Test(input);
