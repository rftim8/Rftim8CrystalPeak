...
{
    [TestClass]
    public sealed class CF_00001346F_DuneIIBattleForArrakis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001346F_DuneIIBattleForArrakis));
        ...
        {
            bool result = CF_00001346F_DuneIIBattleForArrakis.Solution_0_Test(input);
