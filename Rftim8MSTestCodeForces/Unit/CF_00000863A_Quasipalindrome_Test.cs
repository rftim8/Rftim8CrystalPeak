...
{
    [TestClass]
    public sealed class CF_00000863A_Quasipalindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000863A_Quasipalindrome));
        ...
        {
            bool result = CF_00000863A_Quasipalindrome.Solution_0_Test(input);
