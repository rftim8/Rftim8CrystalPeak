...
{
    [TestClass]
    public sealed class CF_00001251E1_VotingEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001251E1_VotingEasyVersion));
        ...
        {
            bool result = CF_00001251E1_VotingEasyVersion.Solution_0_Test(input);
