...
{
    [TestClass]
    public sealed class CF_00001316F_BattalionStrength_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001316F_BattalionStrength));
        ...
        {
            bool result = CF_00001316F_BattalionStrength.Solution_0_Test(input);
