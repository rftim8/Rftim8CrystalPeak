...
{
    [TestClass]
    public sealed class CF_00001684A_DigitMinimization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001684A_DigitMinimization));
        ...
        {
            bool result = CF_00001684A_DigitMinimization.Solution_0_Test(input);
