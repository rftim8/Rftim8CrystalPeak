...
{
    [TestClass]
    public sealed class CF_00001085A_RightLeftCipher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001085A_RightLeftCipher));
        ...
        {
            bool result = CF_00001085A_RightLeftCipher.Solution_0_Test(input);
