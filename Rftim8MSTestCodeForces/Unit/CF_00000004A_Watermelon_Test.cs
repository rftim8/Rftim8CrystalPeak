...
{
    [TestClass]
    public sealed class CF_00000004A_Watermelon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000004A_Watermelon));
        ...
        {
            bool result = CF_00000004A_Watermelon.Solution_0_Test(input);
