...
{
    [TestClass]
    public sealed class CF_00001144D_EqualizeThemAll_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001144D_EqualizeThemAll));
        ...
        {
            bool result = CF_00001144D_EqualizeThemAll.Solution_0_Test(input);
