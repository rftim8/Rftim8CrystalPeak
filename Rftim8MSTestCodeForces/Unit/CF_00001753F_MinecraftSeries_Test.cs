...
{
    [TestClass]
    public sealed class CF_00001753F_MinecraftSeries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001753F_MinecraftSeries));
        ...
        {
            bool result = CF_00001753F_MinecraftSeries.Solution_0_Test(input);
