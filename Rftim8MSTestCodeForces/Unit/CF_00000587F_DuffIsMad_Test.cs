...
{
    [TestClass]
    public sealed class CF_00000587F_DuffIsMad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000587F_DuffIsMad));
        ...
        {
            bool result = CF_00000587F_DuffIsMad.Solution_0_Test(input);
