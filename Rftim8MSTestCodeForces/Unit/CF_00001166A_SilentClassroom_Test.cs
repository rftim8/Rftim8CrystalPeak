...
{
    [TestClass]
    public sealed class CF_00001166A_SilentClassroom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001166A_SilentClassroom));
        ...
        {
            bool result = CF_00001166A_SilentClassroom.Solution_0_Test(input);
