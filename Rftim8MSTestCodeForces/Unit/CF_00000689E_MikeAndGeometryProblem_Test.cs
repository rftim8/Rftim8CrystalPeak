...
{
    [TestClass]
    public sealed class CF_00000689E_MikeAndGeometryProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000689E_MikeAndGeometryProblem));
        ...
        {
            bool result = CF_00000689E_MikeAndGeometryProblem.Solution_0_Test(input);
