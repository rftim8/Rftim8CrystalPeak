...
{
    [TestClass]
    public sealed class CF_00000038E_LetsGoRolling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000038E_LetsGoRolling));
        ...
        {
            bool result = CF_00000038E_LetsGoRolling.Solution_0_Test(input);
