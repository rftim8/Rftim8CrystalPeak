...
{
    [TestClass]
    public sealed class CF_00001690B_ArrayDecrements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001690B_ArrayDecrements));
        ...
        {
            bool result = CF_00001690B_ArrayDecrements.Solution_0_Test(input);
