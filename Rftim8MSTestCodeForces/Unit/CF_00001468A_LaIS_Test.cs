...
{
    [TestClass]
    public sealed class CF_00001468A_LaIS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468A_LaIS));
        ...
        {
            bool result = CF_00001468A_LaIS.Solution_0_Test(input);
