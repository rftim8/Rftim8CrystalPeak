...
{
    [TestClass]
    public sealed class CF_00000677A_VanyaAndFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000677A_VanyaAndFence));
        ...
        {
            bool result = CF_00000677A_VanyaAndFence.Solution_0_Test(input);
