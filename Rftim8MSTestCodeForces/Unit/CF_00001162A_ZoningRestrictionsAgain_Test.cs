...
{
    [TestClass]
    public sealed class CF_00001162A_ZoningRestrictionsAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001162A_ZoningRestrictionsAgain));
        ...
        {
            bool result = CF_00001162A_ZoningRestrictionsAgain.Solution_0_Test(input);
