...
{
    [TestClass]
    public sealed class CF_00001119A_IlyaAndAColorfulWalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001119A_IlyaAndAColorfulWalk));
        ...
        {
            bool result = CF_00001119A_IlyaAndAColorfulWalk.Solution_0_Test(input);
