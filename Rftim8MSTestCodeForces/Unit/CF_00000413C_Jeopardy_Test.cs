...
{
    [TestClass]
    public sealed class CF_00000413C_Jeopardy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000413C_Jeopardy));
        ...
        {
            bool result = CF_00000413C_Jeopardy.Solution_0_Test(input);
