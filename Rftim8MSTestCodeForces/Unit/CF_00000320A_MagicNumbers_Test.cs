...
{
    [TestClass]
    public sealed class CF_00000320A_MagicNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000320A_MagicNumbers));
        ...
        {
            bool result = CF_00000320A_MagicNumbers.Solution_0_Test(input);
