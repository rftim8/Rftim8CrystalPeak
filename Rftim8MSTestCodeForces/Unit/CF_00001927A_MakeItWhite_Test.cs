...
{
    [TestClass]
    public sealed class CF_00001927A_MakeItWhite_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001927A_MakeItWhite));
        ...
        {
            bool result = CF_00001927A_MakeItWhite.Solution_0_Test(input);
