...
{
    [TestClass]
    public sealed class CF_00001455D_SequenceAndSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001455D_SequenceAndSwaps));
        ...
        {
            bool result = CF_00001455D_SequenceAndSwaps.Solution_0_Test(input);
