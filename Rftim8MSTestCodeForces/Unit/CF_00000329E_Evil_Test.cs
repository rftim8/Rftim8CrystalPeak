...
{
    [TestClass]
    public sealed class CF_00000329E_Evil_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000329E_Evil));
        ...
        {
            bool result = CF_00000329E_Evil.Solution_0_Test(input);
