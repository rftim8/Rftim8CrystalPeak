...
{
    [TestClass]
    public sealed class CF_00002037A_Twice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002037A_Twice));
        ...
        {
            bool result = CF_00002037A_Twice.Solution_0_Test(input);
