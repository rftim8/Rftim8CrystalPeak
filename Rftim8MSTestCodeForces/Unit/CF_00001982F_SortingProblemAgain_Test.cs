...
{
    [TestClass]
    public sealed class CF_00001982F_SortingProblemAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001982F_SortingProblemAgain));
        ...
        {
            bool result = CF_00001982F_SortingProblemAgain.Solution_0_Test(input);
