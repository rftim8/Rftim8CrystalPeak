...
{
    [TestClass]
    public sealed class CF_00002043E_MatrixTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002043E_MatrixTransformation));
        ...
        {
            bool result = CF_00002043E_MatrixTransformation.Solution_0_Test(input);
