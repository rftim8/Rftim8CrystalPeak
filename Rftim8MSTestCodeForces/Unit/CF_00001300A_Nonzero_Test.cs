...
{
    [TestClass]
    public sealed class CF_00001300A_Nonzero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001300A_Nonzero));
        ...
        {
            bool result = CF_00001300A_Nonzero.Solution_0_Test(input);
