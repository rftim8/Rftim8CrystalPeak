...
{
    [TestClass]
    public sealed class CF_00000158B_Taxi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000158B_Taxi));
        ...
        {
            bool result = CF_00000158B_Taxi.Solution_0_Test(input);
