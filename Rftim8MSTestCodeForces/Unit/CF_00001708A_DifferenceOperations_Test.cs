...
{
    [TestClass]
    public sealed class CF_00001708A_DifferenceOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001708A_DifferenceOperations));
        ...
        {
            bool result = CF_00001708A_DifferenceOperations.Solution_0_Test(input);
