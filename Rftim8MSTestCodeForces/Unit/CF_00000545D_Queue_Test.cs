...
{
    [TestClass]
    public sealed class CF_00000545D_Queue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000545D_Queue));
        ...
        {
            bool result = CF_00000545D_Queue.Solution_0_Test(input);
