...
{
    [TestClass]
    public sealed class CF_00001090E_HorsebackRiding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090E_HorsebackRiding));
        ...
        {
            bool result = CF_00001090E_HorsebackRiding.Solution_0_Test(input);
