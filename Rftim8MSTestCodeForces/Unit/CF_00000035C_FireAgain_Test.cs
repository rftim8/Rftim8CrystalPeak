...
{
    [TestClass]
    public sealed class CF_00000035C_FireAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000035C_FireAgain));
        ...
        {
            bool result = CF_00000035C_FireAgain.Solution_0_Test(input);
