...
{
    [TestClass]
    public sealed class CF_00000671A_RecyclingBottles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000671A_RecyclingBottles));
        ...
        {
            bool result = CF_00000671A_RecyclingBottles.Solution_0_Test(input);
