...
{
    [TestClass]
    public sealed class CF_00001452E_TwoEditorials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001452E_TwoEditorials));
        ...
        {
            bool result = CF_00001452E_TwoEditorials.Solution_0_Test(input);
