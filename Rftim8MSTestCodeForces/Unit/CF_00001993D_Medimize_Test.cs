...
{
    [TestClass]
    public sealed class CF_00001993D_Medimize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001993D_Medimize));
        ...
        {
            bool result = CF_00001993D_Medimize.Solution_0_Test(input);
