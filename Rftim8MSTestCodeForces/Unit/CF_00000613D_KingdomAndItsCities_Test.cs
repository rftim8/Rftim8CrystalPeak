...
{
    [TestClass]
    public sealed class CF_00000613D_KingdomAndItsCities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000613D_KingdomAndItsCities));
        ...
        {
            bool result = CF_00000613D_KingdomAndItsCities.Solution_0_Test(input);
