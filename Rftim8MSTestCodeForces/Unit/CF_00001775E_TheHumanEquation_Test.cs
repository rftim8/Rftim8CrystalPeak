...
{
    [TestClass]
    public sealed class CF_00001775E_TheHumanEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001775E_TheHumanEquation));
        ...
        {
            bool result = CF_00001775E_TheHumanEquation.Solution_0_Test(input);
