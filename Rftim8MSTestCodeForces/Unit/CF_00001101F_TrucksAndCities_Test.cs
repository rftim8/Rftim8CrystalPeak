...
{
    [TestClass]
    public sealed class CF_00001101F_TrucksAndCities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001101F_TrucksAndCities));
        ...
        {
            bool result = CF_00001101F_TrucksAndCities.Solution_0_Test(input);
