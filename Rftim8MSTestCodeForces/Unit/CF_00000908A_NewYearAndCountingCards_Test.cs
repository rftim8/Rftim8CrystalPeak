...
{
    [TestClass]
    public sealed class CF_00000908A_NewYearAndCountingCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000908A_NewYearAndCountingCards));
        ...
        {
            bool result = CF_00000908A_NewYearAndCountingCards.Solution_0_Test(input);
