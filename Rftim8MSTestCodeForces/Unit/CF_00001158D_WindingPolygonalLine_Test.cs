...
{
    [TestClass]
    public sealed class CF_00001158D_WindingPolygonalLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001158D_WindingPolygonalLine));
        ...
        {
            bool result = CF_00001158D_WindingPolygonalLine.Solution_0_Test(input);
