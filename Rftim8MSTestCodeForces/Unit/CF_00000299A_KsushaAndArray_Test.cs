...
{
    [TestClass]
    public sealed class CF_00000299A_KsushaAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000299A_KsushaAndArray));
        ...
        {
            bool result = CF_00000299A_KsushaAndArray.Solution_0_Test(input);
