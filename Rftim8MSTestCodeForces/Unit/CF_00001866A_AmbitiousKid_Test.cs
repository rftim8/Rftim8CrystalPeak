...
{
    [TestClass]
    public sealed class CF_00001866A_AmbitiousKid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001866A_AmbitiousKid));
        ...
        {
            bool result = CF_00001866A_AmbitiousKid.Solution_0_Test(input);
