...
{
    [TestClass]
    public sealed class CF_00001520G_ToGoOrNotToGo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001520G_ToGoOrNotToGo));
        ...
        {
            bool result = CF_00001520G_ToGoOrNotToGo.Solution_0_Test(input);
