...
{
    [TestClass]
    public sealed class CF_00001380C_CreateTheTeams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001380C_CreateTheTeams));
        ...
        {
            bool result = CF_00001380C_CreateTheTeams.Solution_0_Test(input);
