...
{
    [TestClass]
    public sealed class CF_00001806E_TreeMaster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001806E_TreeMaster));
        ...
        {
            bool result = CF_00001806E_TreeMaster.Solution_0_Test(input);
