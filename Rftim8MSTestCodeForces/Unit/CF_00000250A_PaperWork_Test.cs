...
{
    [TestClass]
    public sealed class CF_00000250A_PaperWork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000250A_PaperWork));
        ...
        {
            bool result = CF_00000250A_PaperWork.Solution_0_Test(input);
