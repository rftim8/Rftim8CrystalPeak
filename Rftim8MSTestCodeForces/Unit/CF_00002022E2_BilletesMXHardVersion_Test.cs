...
{
    [TestClass]
    public sealed class CF_00002022E2_BilletesMXHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002022E2_BilletesMXHardVersion));
        ...
        {
            bool result = CF_00002022E2_BilletesMXHardVersion.Solution_0_Test(input);
