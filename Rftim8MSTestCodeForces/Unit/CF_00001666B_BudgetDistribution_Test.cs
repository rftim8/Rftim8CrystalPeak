...
{
    [TestClass]
    public sealed class CF_00001666B_BudgetDistribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001666B_BudgetDistribution));
        ...
        {
            bool result = CF_00001666B_BudgetDistribution.Solution_0_Test(input);
