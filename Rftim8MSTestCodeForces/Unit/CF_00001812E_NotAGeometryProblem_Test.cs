...
{
    [TestClass]
    public sealed class CF_00001812E_NotAGeometryProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001812E_NotAGeometryProblem));
        ...
        {
            bool result = CF_00001812E_NotAGeometryProblem.Solution_0_Test(input);
