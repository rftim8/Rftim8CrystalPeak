...
{
    [TestClass]
    public sealed class CF_00001188A1_AddOnATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001188A1_AddOnATree));
        ...
        {
            bool result = CF_00001188A1_AddOnATree.Solution_0_Test(input);
