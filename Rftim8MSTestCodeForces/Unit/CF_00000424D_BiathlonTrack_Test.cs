...
{
    [TestClass]
    public sealed class CF_00000424D_BiathlonTrack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000424D_BiathlonTrack));
        ...
        {
            bool result = CF_00000424D_BiathlonTrack.Solution_0_Test(input);
