...
{
    [TestClass]
    public sealed class CF_00001500A_GoingHome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001500A_GoingHome));
        ...
        {
            bool result = CF_00001500A_GoingHome.Solution_0_Test(input);
