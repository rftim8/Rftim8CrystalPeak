...
{
    [TestClass]
    public sealed class CF_00001017H_TheFilms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001017H_TheFilms));
        ...
        {
            bool result = CF_00001017H_TheFilms.Solution_0_Test(input);
