...
{
    [TestClass]
    public sealed class CF_00000913G_PowerSubstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000913G_PowerSubstring));
        ...
        {
            bool result = CF_00000913G_PowerSubstring.Solution_0_Test(input);
