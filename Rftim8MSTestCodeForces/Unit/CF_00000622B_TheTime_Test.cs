...
{
    [TestClass]
    public sealed class CF_00000622B_TheTime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000622B_TheTime));
        ...
        {
            bool result = CF_00000622B_TheTime.Solution_0_Test(input);
