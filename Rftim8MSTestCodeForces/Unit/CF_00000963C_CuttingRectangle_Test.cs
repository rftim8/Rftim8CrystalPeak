...
{
    [TestClass]
    public sealed class CF_00000963C_CuttingRectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000963C_CuttingRectangle));
        ...
        {
            bool result = CF_00000963C_CuttingRectangle.Solution_0_Test(input);
