...
{
    [TestClass]
    public sealed class CF_00001731B_KillDemodogs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001731B_KillDemodogs));
        ...
        {
            bool result = CF_00001731B_KillDemodogs.Solution_0_Test(input);
