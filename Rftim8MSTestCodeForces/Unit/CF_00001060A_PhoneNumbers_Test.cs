...
{
    [TestClass]
    public sealed class CF_00001060A_PhoneNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001060A_PhoneNumbers));
        ...
        {
            bool result = CF_00001060A_PhoneNumbers.Solution_0_Test(input);
