...
{
    [TestClass]
    public sealed class CF_00000334A_CandyBags_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000334A_CandyBags));
        ...
        {
            bool result = CF_00000334A_CandyBags.Solution_0_Test(input);
