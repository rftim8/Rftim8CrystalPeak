...
{
    [TestClass]
    public sealed class CF_00000467C_GeorgeAndJob_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000467C_GeorgeAndJob));
        ...
        {
            bool result = CF_00000467C_GeorgeAndJob.Solution_0_Test(input);
