...
{
    [TestClass]
    public sealed class CF_00000059B_FortuneTelling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000059B_FortuneTelling));
        ...
        {
            bool result = CF_00000059B_FortuneTelling.Solution_0_Test(input);
