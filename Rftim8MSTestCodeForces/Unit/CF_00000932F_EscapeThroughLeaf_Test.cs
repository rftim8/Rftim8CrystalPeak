...
{
    [TestClass]
    public sealed class CF_00000932F_EscapeThroughLeaf_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000932F_EscapeThroughLeaf));
        ...
        {
            bool result = CF_00000932F_EscapeThroughLeaf.Solution_0_Test(input);
