...
{
    [TestClass]
    public sealed class CF_00001148E_EarthWindAndFire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001148E_EarthWindAndFire));
        ...
        {
            bool result = CF_00001148E_EarthWindAndFire.Solution_0_Test(input);
