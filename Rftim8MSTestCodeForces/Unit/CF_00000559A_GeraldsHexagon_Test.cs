...
{
    [TestClass]
    public sealed class CF_00000559A_GeraldsHexagon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000559A_GeraldsHexagon));
        ...
        {
            bool result = CF_00000559A_GeraldsHexagon.Solution_0_Test(input);
