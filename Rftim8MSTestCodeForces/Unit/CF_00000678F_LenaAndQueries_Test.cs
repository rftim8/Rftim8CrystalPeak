...
{
    [TestClass]
    public sealed class CF_00000678F_LenaAndQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000678F_LenaAndQueries));
        ...
        {
            bool result = CF_00000678F_LenaAndQueries.Solution_0_Test(input);
