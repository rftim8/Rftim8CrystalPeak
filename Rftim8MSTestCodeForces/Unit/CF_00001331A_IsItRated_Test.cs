...
{
    [TestClass]
    public sealed class CF_00001331A_IsItRated_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001331A_IsItRated));
        ...
        {
            bool result = CF_00001331A_IsItRated.Solution_0_Test(input);
