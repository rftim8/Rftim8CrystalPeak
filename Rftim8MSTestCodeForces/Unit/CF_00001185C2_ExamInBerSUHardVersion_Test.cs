...
{
    [TestClass]
    public sealed class CF_00001185C2_ExamInBerSUHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001185C2_ExamInBerSUHardVersion));
        ...
        {
            bool result = CF_00001185C2_ExamInBerSUHardVersion.Solution_0_Test(input);
