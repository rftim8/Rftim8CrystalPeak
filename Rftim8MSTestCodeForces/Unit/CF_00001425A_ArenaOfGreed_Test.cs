...
{
    [TestClass]
    public sealed class CF_00001425A_ArenaOfGreed_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001425A_ArenaOfGreed));
        ...
        {
            bool result = CF_00001425A_ArenaOfGreed.Solution_0_Test(input);
