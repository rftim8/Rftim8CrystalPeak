...
{
    [TestClass]
    public sealed class CF_00001923E_CountPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001923E_CountPaths));
        ...
        {
            bool result = CF_00001923E_CountPaths.Solution_0_Test(input);
