...
{
    [TestClass]
    public sealed class CF_00000282D_YetAnotherNumberGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000282D_YetAnotherNumberGame));
        ...
        {
            bool result = CF_00000282D_YetAnotherNumberGame.Solution_0_Test(input);
