...
{
    [TestClass]
    public sealed class CF_00000235E_NumberChallenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000235E_NumberChallenge));
        ...
        {
            bool result = CF_00000235E_NumberChallenge.Solution_0_Test(input);
