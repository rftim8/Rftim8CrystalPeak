...
{
    [TestClass]
    public sealed class CF_00000425E_SerejaAndSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000425E_SerejaAndSets));
        ...
        {
            bool result = CF_00000425E_SerejaAndSets.Solution_0_Test(input);
