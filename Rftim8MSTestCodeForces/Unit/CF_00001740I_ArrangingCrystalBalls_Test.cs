...
{
    [TestClass]
    public sealed class CF_00001740I_ArrangingCrystalBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001740I_ArrangingCrystalBalls));
        ...
        {
            bool result = CF_00001740I_ArrangingCrystalBalls.Solution_0_Test(input);
