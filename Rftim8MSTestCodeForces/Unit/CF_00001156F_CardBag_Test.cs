...
{
    [TestClass]
    public sealed class CF_00001156F_CardBag_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001156F_CardBag));
        ...
        {
            bool result = CF_00001156F_CardBag.Solution_0_Test(input);
