...
{
    [TestClass]
    public sealed class CF_00000578F_MirrorBox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000578F_MirrorBox));
        ...
        {
            bool result = CF_00000578F_MirrorBox.Solution_0_Test(input);
