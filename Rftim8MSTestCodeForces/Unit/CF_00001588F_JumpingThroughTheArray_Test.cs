...
{
    [TestClass]
    public sealed class CF_00001588F_JumpingThroughTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001588F_JumpingThroughTheArray));
        ...
        {
            bool result = CF_00001588F_JumpingThroughTheArray.Solution_0_Test(input);
