...
{
    [TestClass]
    public sealed class CF_00001096B_SubstringRemoval_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001096B_SubstringRemoval));
        ...
        {
            bool result = CF_00001096B_SubstringRemoval.Solution_0_Test(input);
