...
{
    [TestClass]
    public sealed class CF_00001916G_OptimizationsFromChelsu_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001916G_OptimizationsFromChelsu));
        ...
        {
            bool result = CF_00001916G_OptimizationsFromChelsu.Solution_0_Test(input);
