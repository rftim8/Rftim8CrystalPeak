...
{
    [TestClass]
    public sealed class CF_00000364D_Ghd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000364D_Ghd));
        ...
        {
            bool result = CF_00000364D_Ghd.Solution_0_Test(input);
