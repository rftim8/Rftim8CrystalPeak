...
{
    [TestClass]
    public sealed class CF_00000213A_Game_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000213A_Game));
        ...
        {
            bool result = CF_00000213A_Game.Solution_0_Test(input);
