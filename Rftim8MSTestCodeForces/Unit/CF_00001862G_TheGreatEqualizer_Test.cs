...
{
    [TestClass]
    public sealed class CF_00001862G_TheGreatEqualizer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001862G_TheGreatEqualizer));
        ...
        {
            bool result = CF_00001862G_TheGreatEqualizer.Solution_0_Test(input);
