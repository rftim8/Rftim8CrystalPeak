...
{
    [TestClass]
    public sealed class CF_00001902C_InsertAndEqualize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001902C_InsertAndEqualize));
        ...
        {
            bool result = CF_00001902C_InsertAndEqualize.Solution_0_Test(input);
