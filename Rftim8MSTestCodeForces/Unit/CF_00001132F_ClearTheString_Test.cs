...
{
    [TestClass]
    public sealed class CF_00001132F_ClearTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001132F_ClearTheString));
        ...
        {
            bool result = CF_00001132F_ClearTheString.Solution_0_Test(input);
