...
{
    [TestClass]
    public sealed class CF_00000483B_FriendsAndPresents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000483B_FriendsAndPresents));
        ...
        {
            bool result = CF_00000483B_FriendsAndPresents.Solution_0_Test(input);
