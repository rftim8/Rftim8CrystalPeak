...
{
    [TestClass]
    public sealed class CF_00000622C_NotEqualOnASegment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000622C_NotEqualOnASegment));
        ...
        {
            bool result = CF_00000622C_NotEqualOnASegment.Solution_0_Test(input);
