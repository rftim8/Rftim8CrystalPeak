...
{
    [TestClass]
    public sealed class CF_00000335D_RectanglesAndSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000335D_RectanglesAndSquare));
        ...
        {
            bool result = CF_00000335D_RectanglesAndSquare.Solution_0_Test(input);
