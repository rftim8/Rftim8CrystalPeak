...
{
    [TestClass]
    public sealed class CF_00001796E_ColoredSubgraphs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001796E_ColoredSubgraphs));
        ...
        {
            bool result = CF_00001796E_ColoredSubgraphs.Solution_0_Test(input);
