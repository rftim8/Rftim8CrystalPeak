...
{
    [TestClass]
    public sealed class CF_00001902F_TreesAndXORQueriesAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001902F_TreesAndXORQueriesAgain));
        ...
        {
            bool result = CF_00001902F_TreesAndXORQueriesAgain.Solution_0_Test(input);
