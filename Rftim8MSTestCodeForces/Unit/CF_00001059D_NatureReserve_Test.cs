...
{
    [TestClass]
    public sealed class CF_00001059D_NatureReserve_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001059D_NatureReserve));
        ...
        {
            bool result = CF_00001059D_NatureReserve.Solution_0_Test(input);
