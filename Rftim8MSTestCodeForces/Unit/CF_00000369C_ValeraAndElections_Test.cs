...
{
    [TestClass]
    public sealed class CF_00000369C_ValeraAndElections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000369C_ValeraAndElections));
        ...
        {
            bool result = CF_00000369C_ValeraAndElections.Solution_0_Test(input);
