...
{
    [TestClass]
    public sealed class CF_00001512D_CorruptedArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001512D_CorruptedArray));
        ...
        {
            bool result = CF_00001512D_CorruptedArray.Solution_0_Test(input);
