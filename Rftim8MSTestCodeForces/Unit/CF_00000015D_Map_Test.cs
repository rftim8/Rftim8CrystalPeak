...
{
    [TestClass]
    public sealed class CF_00000015D_Map_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000015D_Map));
        ...
        {
            bool result = CF_00000015D_Map.Solution_0_Test(input);
