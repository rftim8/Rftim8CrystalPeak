...
{
    [TestClass]
    public sealed class CF_00001523H_HoppingAroundTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001523H_HoppingAroundTheArray));
        ...
        {
            bool result = CF_00001523H_HoppingAroundTheArray.Solution_0_Test(input);
