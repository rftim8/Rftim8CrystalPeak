...
{
    [TestClass]
    public sealed class CF_00000245D_RestoringTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000245D_RestoringTable));
        ...
        {
            bool result = CF_00000245D_RestoringTable.Solution_0_Test(input);
