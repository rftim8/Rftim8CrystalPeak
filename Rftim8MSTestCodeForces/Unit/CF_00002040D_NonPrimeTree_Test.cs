...
{
    [TestClass]
    public sealed class CF_00002040D_NonPrimeTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002040D_NonPrimeTree));
        ...
        {
            bool result = CF_00002040D_NonPrimeTree.Solution_0_Test(input);
