...
{
    [TestClass]
    public sealed class CF_00000046B_TshirtsFromSponsor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000046B_TshirtsFromSponsor));
        ...
        {
            bool result = CF_00000046B_TshirtsFromSponsor.Solution_0_Test(input);
