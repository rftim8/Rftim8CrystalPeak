...
{
    [TestClass]
    public sealed class CF_00002009C_TheLegendOfFreyaTheFrog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002009C_TheLegendOfFreyaTheFrog));
        ...
        {
            bool result = CF_00002009C_TheLegendOfFreyaTheFrog.Solution_0_Test(input);
