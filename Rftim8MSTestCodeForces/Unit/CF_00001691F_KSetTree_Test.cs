...
{
    [TestClass]
    public sealed class CF_00001691F_KSetTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001691F_KSetTree));
        ...
        {
            bool result = CF_00001691F_KSetTree.Solution_0_Test(input);
