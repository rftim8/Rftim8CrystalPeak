...
{
    [TestClass]
    public sealed class CF_00001862F_MagicWillSaveTheWorld_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001862F_MagicWillSaveTheWorld));
        ...
        {
            bool result = CF_00001862F_MagicWillSaveTheWorld.Solution_0_Test(input);
