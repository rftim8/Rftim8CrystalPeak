...
{
    [TestClass]
    public sealed class CF_00001749B_DeathsBlessing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001749B_DeathsBlessing));
        ...
        {
            bool result = CF_00001749B_DeathsBlessing.Solution_0_Test(input);
