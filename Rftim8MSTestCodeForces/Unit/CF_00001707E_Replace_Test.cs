...
{
    [TestClass]
    public sealed class CF_00001707E_Replace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001707E_Replace));
        ...
        {
            bool result = CF_00001707E_Replace.Solution_0_Test(input);
