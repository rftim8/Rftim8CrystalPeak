...
{
    [TestClass]
    public sealed class CF_00001827A_CountingOrders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001827A_CountingOrders));
        ...
        {
            bool result = CF_00001827A_CountingOrders.Solution_0_Test(input);
