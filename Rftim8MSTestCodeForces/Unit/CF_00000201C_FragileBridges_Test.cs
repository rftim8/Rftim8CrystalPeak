...
{
    [TestClass]
    public sealed class CF_00000201C_FragileBridges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000201C_FragileBridges));
        ...
        {
            bool result = CF_00000201C_FragileBridges.Solution_0_Test(input);
