...
{
    [TestClass]
    public sealed class CF_00000843D_DynamicShortestPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000843D_DynamicShortestPath));
        ...
        {
            bool result = CF_00000843D_DynamicShortestPath.Solution_0_Test(input);
