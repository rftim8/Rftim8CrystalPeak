...
{
    [TestClass]
    public sealed class CF_00000424C_MagicFormulas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000424C_MagicFormulas));
        ...
        {
            bool result = CF_00000424C_MagicFormulas.Solution_0_Test(input);
