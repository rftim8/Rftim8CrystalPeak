...
{
    [TestClass]
    public sealed class CF_00001183F_TopforcesStrikesBack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001183F_TopforcesStrikesBack));
        ...
        {
            bool result = CF_00001183F_TopforcesStrikesBack.Solution_0_Test(input);
