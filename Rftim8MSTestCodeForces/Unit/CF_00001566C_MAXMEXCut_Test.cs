...
{
    [TestClass]
    public sealed class CF_00001566C_MAXMEXCut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001566C_MAXMEXCut));
        ...
        {
            bool result = CF_00001566C_MAXMEXCut.Solution_0_Test(input);
