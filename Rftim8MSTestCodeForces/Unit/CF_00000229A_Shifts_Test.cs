...
{
    [TestClass]
    public sealed class CF_00000229A_Shifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000229A_Shifts));
        ...
        {
            bool result = CF_00000229A_Shifts.Solution_0_Test(input);
