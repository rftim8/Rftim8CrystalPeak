...
{
    [TestClass]
    public sealed class CF_00002022D2_AsesinoHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002022D2_AsesinoHardVersion));
        ...
        {
            bool result = CF_00002022D2_AsesinoHardVersion.Solution_0_Test(input);
