...
{
    [TestClass]
    public sealed class CF_00000735A_OstapAndGrasshopper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000735A_OstapAndGrasshopper));
        ...
        {
            bool result = CF_00000735A_OstapAndGrasshopper.Solution_0_Test(input);
