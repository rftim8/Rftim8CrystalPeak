...
{
    [TestClass]
    public sealed class CF_00000887F_RowOfModels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000887F_RowOfModels));
        ...
        {
            bool result = CF_00000887F_RowOfModels.Solution_0_Test(input);
