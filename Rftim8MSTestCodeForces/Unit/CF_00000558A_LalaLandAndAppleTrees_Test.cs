...
{
    [TestClass]
    public sealed class CF_00000558A_LalaLandAndAppleTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000558A_LalaLandAndAppleTrees));
        ...
        {
            bool result = CF_00000558A_LalaLandAndAppleTrees.Solution_0_Test(input);
