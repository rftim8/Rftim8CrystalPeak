...
{
    [TestClass]
    public sealed class CF_00000878E_NumbersOnTheBlackboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000878E_NumbersOnTheBlackboard));
        ...
        {
            bool result = CF_00000878E_NumbersOnTheBlackboard.Solution_0_Test(input);
