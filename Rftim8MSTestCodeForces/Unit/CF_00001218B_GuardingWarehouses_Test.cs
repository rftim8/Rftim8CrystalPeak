...
{
    [TestClass]
    public sealed class CF_00001218B_GuardingWarehouses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001218B_GuardingWarehouses));
        ...
        {
            bool result = CF_00001218B_GuardingWarehouses.Solution_0_Test(input);
