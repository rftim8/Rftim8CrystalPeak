...
{
    [TestClass]
    public sealed class CF_00000762A_KthDivisor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000762A_KthDivisor));
        ...
        {
            bool result = CF_00000762A_KthDivisor.Solution_0_Test(input);
