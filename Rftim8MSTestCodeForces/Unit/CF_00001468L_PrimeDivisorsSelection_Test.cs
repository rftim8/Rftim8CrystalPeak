...
{
    [TestClass]
    public sealed class CF_00001468L_PrimeDivisorsSelection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468L_PrimeDivisorsSelection));
        ...
        {
            bool result = CF_00001468L_PrimeDivisorsSelection.Solution_0_Test(input);
