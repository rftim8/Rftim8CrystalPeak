...
{
    [TestClass]
    public sealed class CF_00002042E_VertexPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002042E_VertexPairs));
        ...
        {
            bool result = CF_00002042E_VertexPairs.Solution_0_Test(input);
