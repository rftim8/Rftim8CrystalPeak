...
{
    [TestClass]
    public sealed class CF_00001228B_FillingTheGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001228B_FillingTheGrid));
        ...
        {
            bool result = CF_00001228B_FillingTheGrid.Solution_0_Test(input);
