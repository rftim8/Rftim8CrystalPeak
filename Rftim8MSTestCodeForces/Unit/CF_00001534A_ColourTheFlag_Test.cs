...
{
    [TestClass]
    public sealed class CF_00001534A_ColourTheFlag_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001534A_ColourTheFlag));
        ...
        {
            bool result = CF_00001534A_ColourTheFlag.Solution_0_Test(input);
