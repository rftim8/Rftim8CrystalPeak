...
{
    [TestClass]
    public sealed class CF_00001744D_DivisibilityBy2ToPowern_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001744D_DivisibilityBy2ToPowern));
        ...
        {
            bool result = CF_00001744D_DivisibilityBy2ToPowern.Solution_0_Test(input);
