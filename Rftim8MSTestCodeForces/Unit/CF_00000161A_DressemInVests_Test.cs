...
{
    [TestClass]
    public sealed class CF_00000161A_DressemInVests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000161A_DressemInVests));
        ...
        {
            bool result = CF_00000161A_DressemInVests.Solution_0_Test(input);
