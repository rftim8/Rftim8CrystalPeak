...
{
    [TestClass]
    public sealed class CF_00001360F_Spystring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001360F_Spystring));
        ...
        {
            bool result = CF_00001360F_Spystring.Solution_0_Test(input);
