...
{
    [TestClass]
    public sealed class CF_00000081A_Plugin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000081A_Plugin));
        ...
        {
            bool result = CF_00000081A_Plugin.Solution_0_Test(input);
