...
{
    [TestClass]
    public sealed class CF_00000344B_SimpleMolecules_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000344B_SimpleMolecules));
        ...
        {
            bool result = CF_00000344B_SimpleMolecules.Solution_0_Test(input);
