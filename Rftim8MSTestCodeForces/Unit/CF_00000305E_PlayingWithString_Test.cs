...
{
    [TestClass]
    public sealed class CF_00000305E_PlayingWithString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000305E_PlayingWithString));
        ...
        {
            bool result = CF_00000305E_PlayingWithString.Solution_0_Test(input);
