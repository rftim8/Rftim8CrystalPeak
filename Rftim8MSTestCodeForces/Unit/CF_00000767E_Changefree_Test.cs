...
{
    [TestClass]
    public sealed class CF_00000767E_Changefree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000767E_Changefree));
        ...
        {
            bool result = CF_00000767E_Changefree.Solution_0_Test(input);
