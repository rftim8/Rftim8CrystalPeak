...
{
    [TestClass]
    public sealed class CF_00000599E_SandyAndNuts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000599E_SandyAndNuts));
        ...
        {
            bool result = CF_00000599E_SandyAndNuts.Solution_0_Test(input);
