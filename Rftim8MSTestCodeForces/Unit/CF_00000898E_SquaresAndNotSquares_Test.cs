...
{
    [TestClass]
    public sealed class CF_00000898E_SquaresAndNotSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000898E_SquaresAndNotSquares));
        ...
        {
            bool result = CF_00000898E_SquaresAndNotSquares.Solution_0_Test(input);
