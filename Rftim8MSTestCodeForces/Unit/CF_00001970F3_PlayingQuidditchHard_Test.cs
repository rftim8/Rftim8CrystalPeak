...
{
    [TestClass]
    public sealed class CF_00001970F3_PlayingQuidditchHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970F3_PlayingQuidditchHard));
        ...
        {
            bool result = CF_00001970F3_PlayingQuidditchHard.Solution_0_Test(input);
