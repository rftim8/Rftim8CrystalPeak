...
{
    [TestClass]
    public sealed class CF_00000276C_LittleGirlAndMaximumSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000276C_LittleGirlAndMaximumSum));
        ...
        {
            bool result = CF_00000276C_LittleGirlAndMaximumSum.Solution_0_Test(input);
