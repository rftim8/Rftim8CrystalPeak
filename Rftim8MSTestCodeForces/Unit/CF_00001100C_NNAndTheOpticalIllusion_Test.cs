...
{
    [TestClass]
    public sealed class CF_00001100C_NNAndTheOpticalIllusion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001100C_NNAndTheOpticalIllusion));
        ...
        {
            bool result = CF_00001100C_NNAndTheOpticalIllusion.Solution_0_Test(input);
