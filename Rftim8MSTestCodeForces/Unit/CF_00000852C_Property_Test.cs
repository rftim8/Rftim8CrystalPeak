...
{
    [TestClass]
    public sealed class CF_00000852C_Property_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000852C_Property));
        ...
        {
            bool result = CF_00000852C_Property.Solution_0_Test(input);
