...
{
    [TestClass]
    public sealed class CF_00000946E_LargestBeautifulNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000946E_LargestBeautifulNumber));
        ...
        {
            bool result = CF_00000946E_LargestBeautifulNumber.Solution_0_Test(input);
