...
{
    [TestClass]
    public sealed class CF_00000617D_Polyline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000617D_Polyline));
        ...
        {
            bool result = CF_00000617D_Polyline.Solution_0_Test(input);
