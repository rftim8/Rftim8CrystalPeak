...
{
    [TestClass]
    public sealed class CF_00001450D_RatingCompression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001450D_RatingCompression));
        ...
        {
            bool result = CF_00001450D_RatingCompression.Solution_0_Test(input);
