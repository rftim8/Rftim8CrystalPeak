...
{
    [TestClass]
    public sealed class CF_00000545C_Woodcutters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000545C_Woodcutters));
        ...
        {
            bool result = CF_00000545C_Woodcutters.Solution_0_Test(input);
