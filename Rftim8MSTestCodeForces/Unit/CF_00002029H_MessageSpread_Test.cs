...
{
    [TestClass]
    public sealed class CF_00002029H_MessageSpread_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002029H_MessageSpread));
        ...
        {
            bool result = CF_00002029H_MessageSpread.Solution_0_Test(input);
