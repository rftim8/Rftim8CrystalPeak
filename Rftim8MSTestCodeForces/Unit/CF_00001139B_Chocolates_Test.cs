...
{
    [TestClass]
    public sealed class CF_00001139B_Chocolates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001139B_Chocolates));
        ...
        {
            bool result = CF_00001139B_Chocolates.Solution_0_Test(input);
