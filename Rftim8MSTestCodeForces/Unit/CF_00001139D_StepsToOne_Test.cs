...
{
    [TestClass]
    public sealed class CF_00001139D_StepsToOne_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001139D_StepsToOne));
        ...
        {
            bool result = CF_00001139D_StepsToOne.Solution_0_Test(input);
