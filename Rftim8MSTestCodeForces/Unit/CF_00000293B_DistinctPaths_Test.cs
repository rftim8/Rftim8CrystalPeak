...
{
    [TestClass]
    public sealed class CF_00000293B_DistinctPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000293B_DistinctPaths));
        ...
        {
            bool result = CF_00000293B_DistinctPaths.Solution_0_Test(input);
