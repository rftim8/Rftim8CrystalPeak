...
{
    [TestClass]
    public sealed class CF_00001967B2_ReverseCardHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001967B2_ReverseCardHardVersion));
        ...
        {
            bool result = CF_00001967B2_ReverseCardHardVersion.Solution_0_Test(input);
