...
{
    [TestClass]
    public sealed class CF_00001326E_Bombs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001326E_Bombs));
        ...
        {
            bool result = CF_00001326E_Bombs.Solution_0_Test(input);
