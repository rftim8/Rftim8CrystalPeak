...
{
    [TestClass]
    public sealed class CF_00001221E_GameWithString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001221E_GameWithString));
        ...
        {
            bool result = CF_00001221E_GameWithString.Solution_0_Test(input);
