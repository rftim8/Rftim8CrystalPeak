...
{
    [TestClass]
    public sealed class CF_00000731E_FunnyGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000731E_FunnyGame));
        ...
        {
            bool result = CF_00000731E_FunnyGame.Solution_0_Test(input);
