...
{
    [TestClass]
    public sealed class CF_00001796A_TypicalInterviewProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001796A_TypicalInterviewProblem));
        ...
        {
            bool result = CF_00001796A_TypicalInterviewProblem.Solution_0_Test(input);
