...
{
    [TestClass]
    public sealed class CF_00001187E_TreePainting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001187E_TreePainting));
        ...
        {
            bool result = CF_00001187E_TreePainting.Solution_0_Test(input);
