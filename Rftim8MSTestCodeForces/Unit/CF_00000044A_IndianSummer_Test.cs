...
{
    [TestClass]
    public sealed class CF_00000044A_IndianSummer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000044A_IndianSummer));
        ...
        {
            bool result = CF_00000044A_IndianSummer.Solution_0_Test(input);
