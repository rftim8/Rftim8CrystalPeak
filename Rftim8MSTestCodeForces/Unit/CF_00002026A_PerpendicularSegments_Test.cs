...
{
    [TestClass]
    public sealed class CF_00002026A_PerpendicularSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002026A_PerpendicularSegments));
        ...
        {
            bool result = CF_00002026A_PerpendicularSegments.Solution_0_Test(input);
