...
{
    [TestClass]
    public sealed class CF_00001948A_SpecialCharacters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001948A_SpecialCharacters));
        ...
        {
            bool result = CF_00001948A_SpecialCharacters.Solution_0_Test(input);
