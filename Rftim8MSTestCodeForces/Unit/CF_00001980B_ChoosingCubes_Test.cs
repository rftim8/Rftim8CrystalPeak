...
{
    [TestClass]
    public sealed class CF_00001980B_ChoosingCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001980B_ChoosingCubes));
        ...
        {
            bool result = CF_00001980B_ChoosingCubes.Solution_0_Test(input);
