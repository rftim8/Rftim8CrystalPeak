...
{
    [TestClass]
    public sealed class CF_00000164C_MachineProgramming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000164C_MachineProgramming));
        ...
        {
            bool result = CF_00000164C_MachineProgramming.Solution_0_Test(input);
