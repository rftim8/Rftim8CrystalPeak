...
{
    [TestClass]
    public sealed class CF_00000373B_MakingSequencesIsFun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000373B_MakingSequencesIsFun));
        ...
        {
            bool result = CF_00000373B_MakingSequencesIsFun.Solution_0_Test(input);
