...
{
    [TestClass]
    public sealed class CF_00000370B_BerlandBingo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000370B_BerlandBingo));
        ...
        {
            bool result = CF_00000370B_BerlandBingo.Solution_0_Test(input);
