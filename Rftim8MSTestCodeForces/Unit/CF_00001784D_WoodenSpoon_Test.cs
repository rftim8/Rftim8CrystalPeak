...
{
    [TestClass]
    public sealed class CF_00001784D_WoodenSpoon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001784D_WoodenSpoon));
        ...
        {
            bool result = CF_00001784D_WoodenSpoon.Solution_0_Test(input);
