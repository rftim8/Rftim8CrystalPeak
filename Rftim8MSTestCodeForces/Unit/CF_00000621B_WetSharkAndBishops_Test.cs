...
{
    [TestClass]
    public sealed class CF_00000621B_WetSharkAndBishops_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000621B_WetSharkAndBishops));
        ...
        {
            bool result = CF_00000621B_WetSharkAndBishops.Solution_0_Test(input);
