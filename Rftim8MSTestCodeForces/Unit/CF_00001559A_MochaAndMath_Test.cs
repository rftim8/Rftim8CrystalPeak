...
{
    [TestClass]
    public sealed class CF_00001559A_MochaAndMath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001559A_MochaAndMath));
        ...
        {
            bool result = CF_00001559A_MochaAndMath.Solution_0_Test(input);
