...
{
    [TestClass]
    public sealed class CF_00000883F_LostInTransliteration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883F_LostInTransliteration));
        ...
        {
            bool result = CF_00000883F_LostInTransliteration.Solution_0_Test(input);
