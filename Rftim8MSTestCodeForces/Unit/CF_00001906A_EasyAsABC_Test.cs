...
{
    [TestClass]
    public sealed class CF_00001906A_EasyAsABC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001906A_EasyAsABC));
        ...
        {
            bool result = CF_00001906A_EasyAsABC.Solution_0_Test(input);
