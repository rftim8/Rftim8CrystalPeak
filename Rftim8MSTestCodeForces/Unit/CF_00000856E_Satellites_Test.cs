...
{
    [TestClass]
    public sealed class CF_00000856E_Satellites_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000856E_Satellites));
        ...
        {
            bool result = CF_00000856E_Satellites.Solution_0_Test(input);
