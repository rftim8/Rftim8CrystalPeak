...
{
    [TestClass]
    public sealed class CF_00001574D_TheStrongestBuild_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001574D_TheStrongestBuild));
        ...
        {
            bool result = CF_00001574D_TheStrongestBuild.Solution_0_Test(input);
