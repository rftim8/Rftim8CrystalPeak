...
{
    [TestClass]
    public sealed class CF_00000231C_ToAddOrNotToAdd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000231C_ToAddOrNotToAdd));
        ...
        {
            bool result = CF_00000231C_ToAddOrNotToAdd.Solution_0_Test(input);
