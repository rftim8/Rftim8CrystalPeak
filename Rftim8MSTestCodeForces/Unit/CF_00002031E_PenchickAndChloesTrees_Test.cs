...
{
    [TestClass]
    public sealed class CF_00002031E_PenchickAndChloesTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002031E_PenchickAndChloesTrees));
        ...
        {
            bool result = CF_00002031E_PenchickAndChloesTrees.Solution_0_Test(input);
