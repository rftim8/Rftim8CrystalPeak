...
{
    [TestClass]
    public sealed class CF_00000283D_CowsAndCoolSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000283D_CowsAndCoolSequences));
        ...
        {
            bool result = CF_00000283D_CowsAndCoolSequences.Solution_0_Test(input);
