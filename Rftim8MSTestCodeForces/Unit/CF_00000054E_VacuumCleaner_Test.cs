...
{
    [TestClass]
    public sealed class CF_00000054E_VacuumCleaner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000054E_VacuumCleaner));
        ...
        {
            bool result = CF_00000054E_VacuumCleaner.Solution_0_Test(input);
