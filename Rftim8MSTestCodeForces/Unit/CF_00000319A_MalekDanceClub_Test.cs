...
{
    [TestClass]
    public sealed class CF_00000319A_MalekDanceClub_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000319A_MalekDanceClub));
        ...
        {
            bool result = CF_00000319A_MalekDanceClub.Solution_0_Test(input);
