...
{
    [TestClass]
    public sealed class CF_00001821F_Timber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001821F_Timber));
        ...
        {
            bool result = CF_00001821F_Timber.Solution_0_Test(input);
