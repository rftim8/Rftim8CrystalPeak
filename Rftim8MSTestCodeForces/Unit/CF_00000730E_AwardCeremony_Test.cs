...
{
    [TestClass]
    public sealed class CF_00000730E_AwardCeremony_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730E_AwardCeremony));
        ...
        {
            bool result = CF_00000730E_AwardCeremony.Solution_0_Test(input);
