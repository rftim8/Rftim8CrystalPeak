...
{
    [TestClass]
    public sealed class CF_00001672A_LogChopping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001672A_LogChopping));
        ...
        {
            bool result = CF_00001672A_LogChopping.Solution_0_Test(input);
