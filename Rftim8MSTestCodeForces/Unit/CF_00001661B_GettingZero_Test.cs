...
{
    [TestClass]
    public sealed class CF_00001661B_GettingZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001661B_GettingZero));
        ...
        {
            bool result = CF_00001661B_GettingZero.Solution_0_Test(input);
