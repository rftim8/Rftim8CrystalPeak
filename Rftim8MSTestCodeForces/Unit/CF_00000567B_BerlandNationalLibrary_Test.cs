...
{
    [TestClass]
    public sealed class CF_00000567B_BerlandNationalLibrary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000567B_BerlandNationalLibrary));
        ...
        {
            bool result = CF_00000567B_BerlandNationalLibrary.Solution_0_Test(input);
