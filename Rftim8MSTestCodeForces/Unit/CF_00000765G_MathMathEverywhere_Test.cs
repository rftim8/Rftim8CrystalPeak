...
{
    [TestClass]
    public sealed class CF_00000765G_MathMathEverywhere_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000765G_MathMathEverywhere));
        ...
        {
            bool result = CF_00000765G_MathMathEverywhere.Solution_0_Test(input);
