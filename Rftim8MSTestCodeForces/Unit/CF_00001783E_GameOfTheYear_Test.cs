...
{
    [TestClass]
    public sealed class CF_00001783E_GameOfTheYear_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001783E_GameOfTheYear));
        ...
        {
            bool result = CF_00001783E_GameOfTheYear.Solution_0_Test(input);
