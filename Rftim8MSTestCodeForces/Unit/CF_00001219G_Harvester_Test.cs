...
{
    [TestClass]
    public sealed class CF_00001219G_Harvester_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001219G_Harvester));
        ...
        {
            bool result = CF_00001219G_Harvester.Solution_0_Test(input);
