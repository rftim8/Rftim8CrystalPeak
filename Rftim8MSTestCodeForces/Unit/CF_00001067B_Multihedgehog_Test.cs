...
{
    [TestClass]
    public sealed class CF_00001067B_Multihedgehog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001067B_Multihedgehog));
        ...
        {
            bool result = CF_00001067B_Multihedgehog.Solution_0_Test(input);
