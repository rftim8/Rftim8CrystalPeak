...
{
    [TestClass]
    public sealed class CF_00001466E_ApolloVersusPan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001466E_ApolloVersusPan));
        ...
        {
            bool result = CF_00001466E_ApolloVersusPan.Solution_0_Test(input);
