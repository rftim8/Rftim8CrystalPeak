...
{
    [TestClass]
    public sealed class CF_00001974D_Ingenuity2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001974D_Ingenuity2));
        ...
        {
            bool result = CF_00001974D_Ingenuity2.Solution_0_Test(input);
