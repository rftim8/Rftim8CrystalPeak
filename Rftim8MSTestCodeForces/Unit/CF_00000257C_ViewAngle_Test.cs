...
{
    [TestClass]
    public sealed class CF_00000257C_ViewAngle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000257C_ViewAngle));
        ...
        {
            bool result = CF_00000257C_ViewAngle.Solution_0_Test(input);
