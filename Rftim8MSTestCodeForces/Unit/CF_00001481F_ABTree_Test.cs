...
{
    [TestClass]
    public sealed class CF_00001481F_ABTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001481F_ABTree));
        ...
        {
            bool result = CF_00001481F_ABTree.Solution_0_Test(input);
