...
{
    [TestClass]
    public sealed class CF_00001299B_Aerodynamic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001299B_Aerodynamic));
        ...
        {
            bool result = CF_00001299B_Aerodynamic.Solution_0_Test(input);
