...
{
    [TestClass]
    public sealed class CF_00000778E_SellingNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000778E_SellingNumbers));
        ...
        {
            bool result = CF_00000778E_SellingNumbers.Solution_0_Test(input);
