...
{
    [TestClass]
    public sealed class CF_00000658A_BearAndReverseRadewoosh_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000658A_BearAndReverseRadewoosh));
        ...
        {
            bool result = CF_00000658A_BearAndReverseRadewoosh.Solution_0_Test(input);
