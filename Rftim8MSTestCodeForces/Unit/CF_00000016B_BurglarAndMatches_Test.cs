...
{
    [TestClass]
    public sealed class CF_00000016B_BurglarAndMatches_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000016B_BurglarAndMatches));
        ...
        {
            bool result = CF_00000016B_BurglarAndMatches.Solution_0_Test(input);
