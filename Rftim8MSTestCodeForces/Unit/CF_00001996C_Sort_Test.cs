...
{
    [TestClass]
    public sealed class CF_00001996C_Sort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001996C_Sort));
        ...
        {
            bool result = CF_00001996C_Sort.Solution_0_Test(input);
