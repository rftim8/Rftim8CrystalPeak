...
{
    [TestClass]
    public sealed class CF_00001116C1_AlternatingBitsOracle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001116C1_AlternatingBitsOracle));
        ...
        {
            bool result = CF_00001116C1_AlternatingBitsOracle.Solution_0_Test(input);
