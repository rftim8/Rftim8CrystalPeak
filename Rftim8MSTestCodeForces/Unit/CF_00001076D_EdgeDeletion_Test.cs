...
{
    [TestClass]
    public sealed class CF_00001076D_EdgeDeletion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001076D_EdgeDeletion));
        ...
        {
            bool result = CF_00001076D_EdgeDeletion.Solution_0_Test(input);
