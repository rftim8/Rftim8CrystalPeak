...
{
    [TestClass]
    public sealed class CF_00000546B_SoldierAndBadges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000546B_SoldierAndBadges));
        ...
        {
            bool result = CF_00000546B_SoldierAndBadges.Solution_0_Test(input);
