...
{
    [TestClass]
    public sealed class CF_00001286D_LCC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001286D_LCC));
        ...
        {
            bool result = CF_00001286D_LCC.Solution_0_Test(input);
