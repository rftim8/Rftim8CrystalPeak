...
{
    [TestClass]
    public sealed class CF_00001334C_CircleOfMonsters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001334C_CircleOfMonsters));
        ...
        {
            bool result = CF_00001334C_CircleOfMonsters.Solution_0_Test(input);
