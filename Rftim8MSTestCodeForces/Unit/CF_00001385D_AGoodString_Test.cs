...
{
    [TestClass]
    public sealed class CF_00001385D_AGoodString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001385D_AGoodString));
        ...
        {
            bool result = CF_00001385D_AGoodString.Solution_0_Test(input);
