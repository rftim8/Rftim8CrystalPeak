...
{
    [TestClass]
    public sealed class CF_00001650G_CountingShortcuts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001650G_CountingShortcuts));
        ...
        {
            bool result = CF_00001650G_CountingShortcuts.Solution_0_Test(input);
