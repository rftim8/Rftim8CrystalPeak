...
{
    [TestClass]
    public sealed class CF_00001709C_RecoverAnRBS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001709C_RecoverAnRBS));
        ...
        {
            bool result = CF_00001709C_RecoverAnRBS.Solution_0_Test(input);
