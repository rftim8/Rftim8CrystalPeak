...
{
    [TestClass]
    public sealed class CF_00002001B_GeneratePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002001B_GeneratePermutation));
        ...
        {
            bool result = CF_00002001B_GeneratePermutation.Solution_0_Test(input);
