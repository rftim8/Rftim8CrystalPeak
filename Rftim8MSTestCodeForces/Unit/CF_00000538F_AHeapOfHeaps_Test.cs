...
{
    [TestClass]
    public sealed class CF_00000538F_AHeapOfHeaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000538F_AHeapOfHeaps));
        ...
        {
            bool result = CF_00000538F_AHeapOfHeaps.Solution_0_Test(input);
