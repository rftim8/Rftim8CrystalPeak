...
{
    [TestClass]
    public sealed class CF_00000358A_DimaAndContinuousLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000358A_DimaAndContinuousLine));
        ...
        {
            bool result = CF_00000358A_DimaAndContinuousLine.Solution_0_Test(input);
