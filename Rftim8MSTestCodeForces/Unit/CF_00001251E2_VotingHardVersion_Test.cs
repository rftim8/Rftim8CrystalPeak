...
{
    [TestClass]
    public sealed class CF_00001251E2_VotingHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001251E2_VotingHardVersion));
        ...
        {
            bool result = CF_00001251E2_VotingHardVersion.Solution_0_Test(input);
