...
{
    [TestClass]
    public sealed class CF_00001485E_MoveAndSwap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001485E_MoveAndSwap));
        ...
        {
            bool result = CF_00001485E_MoveAndSwap.Solution_0_Test(input);
