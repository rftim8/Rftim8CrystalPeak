...
{
    [TestClass]
    public sealed class CF_00001812J_UnmysteriousLanguage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001812J_UnmysteriousLanguage));
        ...
        {
            bool result = CF_00001812J_UnmysteriousLanguage.Solution_0_Test(input);
