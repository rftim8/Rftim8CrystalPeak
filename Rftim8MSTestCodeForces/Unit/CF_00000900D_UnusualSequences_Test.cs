...
{
    [TestClass]
    public sealed class CF_00000900D_UnusualSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000900D_UnusualSequences));
        ...
        {
            bool result = CF_00000900D_UnusualSequences.Solution_0_Test(input);
