...
{
    [TestClass]
    public sealed class CF_00000397A_OnSegmentsOwnPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000397A_OnSegmentsOwnPoints));
        ...
        {
            bool result = CF_00000397A_OnSegmentsOwnPoints.Solution_0_Test(input);
