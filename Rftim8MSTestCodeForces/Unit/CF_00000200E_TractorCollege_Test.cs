...
{
    [TestClass]
    public sealed class CF_00000200E_TractorCollege_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000200E_TractorCollege));
        ...
        {
            bool result = CF_00000200E_TractorCollege.Solution_0_Test(input);
