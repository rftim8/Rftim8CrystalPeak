...
{
    [TestClass]
    public sealed class CF_00001291A_EvenButNotEven_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001291A_EvenButNotEven));
        ...
        {
            bool result = CF_00001291A_EvenButNotEven.Solution_0_Test(input);
