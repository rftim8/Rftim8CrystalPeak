...
{
    [TestClass]
    public sealed class CF_00000687A_NPHardProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000687A_NPHardProblem));
        ...
        {
            bool result = CF_00000687A_NPHardProblem.Solution_0_Test(input);
