...
{
    [TestClass]
    public sealed class CF_00001346E_MagicTricks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001346E_MagicTricks));
        ...
        {
            bool result = CF_00001346E_MagicTricks.Solution_0_Test(input);
