...
{
    [TestClass]
    public sealed class CF_00001995A_Diagonals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001995A_Diagonals));
        ...
        {
            bool result = CF_00001995A_Diagonals.Solution_0_Test(input);
