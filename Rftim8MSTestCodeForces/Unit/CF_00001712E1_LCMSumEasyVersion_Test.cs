...
{
    [TestClass]
    public sealed class CF_00001712E1_LCMSumEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001712E1_LCMSumEasyVersion));
        ...
        {
            bool result = CF_00001712E1_LCMSumEasyVersion.Solution_0_Test(input);
