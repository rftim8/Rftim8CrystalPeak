...
{
    [TestClass]
    public sealed class CF_00001556A_AVarietyOfOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001556A_AVarietyOfOperations));
        ...
        {
            bool result = CF_00001556A_AVarietyOfOperations.Solution_0_Test(input);
