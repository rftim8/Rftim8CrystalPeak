...
{
    [TestClass]
    public sealed class CF_00001571J_TwoRailroads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001571J_TwoRailroads));
        ...
        {
            bool result = CF_00001571J_TwoRailroads.Solution_0_Test(input);
