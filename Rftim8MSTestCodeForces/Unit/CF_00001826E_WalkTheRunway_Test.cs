...
{
    [TestClass]
    public sealed class CF_00001826E_WalkTheRunway_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001826E_WalkTheRunway));
        ...
        {
            bool result = CF_00001826E_WalkTheRunway.Solution_0_Test(input);
