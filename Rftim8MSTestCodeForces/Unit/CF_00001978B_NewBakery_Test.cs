...
{
    [TestClass]
    public sealed class CF_00001978B_NewBakery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001978B_NewBakery));
        ...
        {
            bool result = CF_00001978B_NewBakery.Solution_0_Test(input);
