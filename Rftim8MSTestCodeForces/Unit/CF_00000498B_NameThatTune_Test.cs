...
{
    [TestClass]
    public sealed class CF_00000498B_NameThatTune_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000498B_NameThatTune));
        ...
        {
            bool result = CF_00000498B_NameThatTune.Solution_0_Test(input);
