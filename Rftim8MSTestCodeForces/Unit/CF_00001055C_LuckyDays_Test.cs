...
{
    [TestClass]
    public sealed class CF_00001055C_LuckyDays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001055C_LuckyDays));
        ...
        {
            bool result = CF_00001055C_LuckyDays.Solution_0_Test(input);
