...
{
    [TestClass]
    public sealed class CF_00001032B_PersonalizedCup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001032B_PersonalizedCup));
        ...
        {
            bool result = CF_00001032B_PersonalizedCup.Solution_0_Test(input);
