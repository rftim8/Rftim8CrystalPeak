...
{
    [TestClass]
    public sealed class CF_00001455F_StringAndOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001455F_StringAndOperations));
        ...
        {
            bool result = CF_00001455F_StringAndOperations.Solution_0_Test(input);
