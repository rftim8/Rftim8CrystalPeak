...
{
    [TestClass]
    public sealed class CF_00001628A_MeximumArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001628A_MeximumArray));
        ...
        {
            bool result = CF_00001628A_MeximumArray.Solution_0_Test(input);
