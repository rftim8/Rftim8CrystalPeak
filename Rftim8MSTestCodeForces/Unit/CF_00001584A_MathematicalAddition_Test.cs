...
{
    [TestClass]
    public sealed class CF_00001584A_MathematicalAddition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001584A_MathematicalAddition));
        ...
        {
            bool result = CF_00001584A_MathematicalAddition.Solution_0_Test(input);
