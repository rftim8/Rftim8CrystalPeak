...
{
    [TestClass]
    public sealed class CF_00000916A_JamieAndAlarmSnooze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000916A_JamieAndAlarmSnooze));
        ...
        {
            bool result = CF_00000916A_JamieAndAlarmSnooze.Solution_0_Test(input);
