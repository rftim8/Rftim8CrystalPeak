...
{
    [TestClass]
    public sealed class CF_00001809E_TwoTanks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001809E_TwoTanks));
        ...
        {
            bool result = CF_00001809E_TwoTanks.Solution_0_Test(input);
