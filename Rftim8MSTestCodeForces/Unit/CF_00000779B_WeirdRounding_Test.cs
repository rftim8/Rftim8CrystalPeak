...
{
    [TestClass]
    public sealed class CF_00000779B_WeirdRounding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000779B_WeirdRounding));
        ...
        {
            bool result = CF_00000779B_WeirdRounding.Solution_0_Test(input);
