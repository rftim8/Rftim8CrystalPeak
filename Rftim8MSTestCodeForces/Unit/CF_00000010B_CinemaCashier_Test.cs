...
{
    [TestClass]
    public sealed class CF_00000010B_CinemaCashier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000010B_CinemaCashier));
        ...
        {
            bool result = CF_00000010B_CinemaCashier.Solution_0_Test(input);
