...
{
    [TestClass]
    public sealed class CF_00001051F_TheShortestStatement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001051F_TheShortestStatement));
        ...
        {
            bool result = CF_00001051F_TheShortestStatement.Solution_0_Test(input);
