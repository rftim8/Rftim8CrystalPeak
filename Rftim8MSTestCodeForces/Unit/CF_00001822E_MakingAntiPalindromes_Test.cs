...
{
    [TestClass]
    public sealed class CF_00001822E_MakingAntiPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001822E_MakingAntiPalindromes));
        ...
        {
            bool result = CF_00001822E_MakingAntiPalindromes.Solution_0_Test(input);
