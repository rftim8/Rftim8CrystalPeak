...
{
    [TestClass]
    public sealed class CF_00001983E_ILoveBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001983E_ILoveBalls));
        ...
        {
            bool result = CF_00001983E_ILoveBalls.Solution_0_Test(input);
