...
{
    [TestClass]
    public sealed class CF_00000710B_OptimalPointOnALine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000710B_OptimalPointOnALine));
        ...
        {
            bool result = CF_00000710B_OptimalPointOnALine.Solution_0_Test(input);
