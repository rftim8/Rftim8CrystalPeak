...
{
    [TestClass]
    public sealed class CF_00000409B_MysteriousLanguage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000409B_MysteriousLanguage));
        ...
        {
            bool result = CF_00000409B_MysteriousLanguage.Solution_0_Test(input);
