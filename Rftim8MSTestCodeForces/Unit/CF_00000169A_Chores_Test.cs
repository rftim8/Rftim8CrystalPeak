...
{
    [TestClass]
    public sealed class CF_00000169A_Chores_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000169A_Chores));
        ...
        {
            bool result = CF_00000169A_Chores.Solution_0_Test(input);
