...
{
    [TestClass]
    public sealed class CF_00000437D_TheChildAndZoo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000437D_TheChildAndZoo));
        ...
        {
            bool result = CF_00000437D_TheChildAndZoo.Solution_0_Test(input);
