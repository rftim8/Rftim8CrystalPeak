...
{
    [TestClass]
    public sealed class CF_00000053A_Autocomplete_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000053A_Autocomplete));
        ...
        {
            bool result = CF_00000053A_Autocomplete.Solution_0_Test(input);
