...
{
    [TestClass]
    public sealed class CF_00001712B_WoefulPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001712B_WoefulPermutation));
        ...
        {
            bool result = CF_00001712B_WoefulPermutation.Solution_0_Test(input);
