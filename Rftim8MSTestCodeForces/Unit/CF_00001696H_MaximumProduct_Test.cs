...
{
    [TestClass]
    public sealed class CF_00001696H_MaximumProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001696H_MaximumProduct));
        ...
        {
            bool result = CF_00001696H_MaximumProduct.Solution_0_Test(input);
