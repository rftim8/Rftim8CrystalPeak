...
{
    [TestClass]
    public sealed class CF_00000507B_AmrAndPins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000507B_AmrAndPins));
        ...
        {
            bool result = CF_00000507B_AmrAndPins.Solution_0_Test(input);
