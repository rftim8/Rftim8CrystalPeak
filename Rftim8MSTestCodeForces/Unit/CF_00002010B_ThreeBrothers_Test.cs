...
{
    [TestClass]
    public sealed class CF_00002010B_ThreeBrothers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002010B_ThreeBrothers));
        ...
        {
            bool result = CF_00002010B_ThreeBrothers.Solution_0_Test(input);
