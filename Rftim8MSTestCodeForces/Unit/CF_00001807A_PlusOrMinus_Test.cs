...
{
    [TestClass]
    public sealed class CF_00001807A_PlusOrMinus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001807A_PlusOrMinus));
        ...
        {
            bool result = CF_00001807A_PlusOrMinus.Solution_0_Test(input);
