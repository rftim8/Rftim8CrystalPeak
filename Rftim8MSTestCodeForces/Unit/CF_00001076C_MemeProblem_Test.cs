...
{
    [TestClass]
    public sealed class CF_00001076C_MemeProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001076C_MemeProblem));
        ...
        {
            bool result = CF_00001076C_MemeProblem.Solution_0_Test(input);
