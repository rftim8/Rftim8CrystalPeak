...
{
    [TestClass]
    public sealed class CF_00001617B_GCDProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001617B_GCDProblem));
        ...
        {
            bool result = CF_00001617B_GCDProblem.Solution_0_Test(input);
