...
{
    [TestClass]
    public sealed class CF_00000713D_AnimalsAndPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000713D_AnimalsAndPuzzle));
        ...
        {
            bool result = CF_00000713D_AnimalsAndPuzzle.Solution_0_Test(input);
