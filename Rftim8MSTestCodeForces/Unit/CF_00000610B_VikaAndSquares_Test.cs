...
{
    [TestClass]
    public sealed class CF_00000610B_VikaAndSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000610B_VikaAndSquares));
        ...
        {
            bool result = CF_00000610B_VikaAndSquares.Solution_0_Test(input);
