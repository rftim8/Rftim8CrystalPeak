...
{
    [TestClass]
    public sealed class CF_00000077C_Beavermuncher0xFF_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000077C_Beavermuncher0xFF));
        ...
        {
            bool result = CF_00000077C_Beavermuncher0xFF.Solution_0_Test(input);
