...
{
    [TestClass]
    public sealed class CF_00001572B_XorOf3_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001572B_XorOf3));
        ...
        {
            bool result = CF_00001572B_XorOf3.Solution_0_Test(input);
