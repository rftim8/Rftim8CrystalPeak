...
{
    [TestClass]
    public sealed class CF_00001583C_OmkarAndDetermination_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001583C_OmkarAndDetermination));
        ...
        {
            bool result = CF_00001583C_OmkarAndDetermination.Solution_0_Test(input);
