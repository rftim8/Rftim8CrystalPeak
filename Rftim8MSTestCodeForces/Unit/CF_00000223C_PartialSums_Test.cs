...
{
    [TestClass]
    public sealed class CF_00000223C_PartialSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000223C_PartialSums));
        ...
        {
            bool result = CF_00000223C_PartialSums.Solution_0_Test(input);
