...
{
    [TestClass]
    public sealed class CF_00000343B_AlternatingCurrent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000343B_AlternatingCurrent));
        ...
        {
            bool result = CF_00000343B_AlternatingCurrent.Solution_0_Test(input);
