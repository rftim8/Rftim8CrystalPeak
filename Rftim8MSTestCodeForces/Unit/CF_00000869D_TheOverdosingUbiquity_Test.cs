...
{
    [TestClass]
    public sealed class CF_00000869D_TheOverdosingUbiquity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000869D_TheOverdosingUbiquity));
        ...
        {
            bool result = CF_00000869D_TheOverdosingUbiquity.Solution_0_Test(input);
