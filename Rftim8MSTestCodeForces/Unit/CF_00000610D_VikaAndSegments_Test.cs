...
{
    [TestClass]
    public sealed class CF_00000610D_VikaAndSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000610D_VikaAndSegments));
        ...
        {
            bool result = CF_00000610D_VikaAndSegments.Solution_0_Test(input);
