...
{
    [TestClass]
    public sealed class CF_00000131A_CAPSLOCK_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000131A_CAPSLOCK));
        ...
        {
            bool result = CF_00000131A_CAPSLOCK.Solution_0_Test(input);
