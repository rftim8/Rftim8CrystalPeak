...
{
    [TestClass]
    public sealed class CF_00000012E_StartOfTheSession_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000012E_StartOfTheSession));
        ...
        {
            bool result = CF_00000012E_StartOfTheSession.Solution_0_Test(input);
