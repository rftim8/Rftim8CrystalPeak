...
{
    [TestClass]
    public sealed class CF_00000580A_KefaAndFirstSteps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000580A_KefaAndFirstSteps));
        ...
        {
            bool result = CF_00000580A_KefaAndFirstSteps.Solution_0_Test(input);
