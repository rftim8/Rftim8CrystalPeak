...
{
    [TestClass]
    public sealed class CF_00001105C_AyoubAndLostArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001105C_AyoubAndLostArray));
        ...
        {
            bool result = CF_00001105C_AyoubAndLostArray.Solution_0_Test(input);
