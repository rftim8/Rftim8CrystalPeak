...
{
    [TestClass]
    public sealed class CF_00001540E_TastyDishes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001540E_TastyDishes));
        ...
        {
            bool result = CF_00001540E_TastyDishes.Solution_0_Test(input);
