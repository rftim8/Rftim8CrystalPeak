...
{
    [TestClass]
    public sealed class CF_00000993C_CarefulManeuvering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000993C_CarefulManeuvering));
        ...
        {
            bool result = CF_00000993C_CarefulManeuvering.Solution_0_Test(input);
