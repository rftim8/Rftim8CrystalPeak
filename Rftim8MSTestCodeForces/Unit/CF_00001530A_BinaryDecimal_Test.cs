...
{
    [TestClass]
    public sealed class CF_00001530A_BinaryDecimal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001530A_BinaryDecimal));
        ...
        {
            bool result = CF_00001530A_BinaryDecimal.Solution_0_Test(input);
