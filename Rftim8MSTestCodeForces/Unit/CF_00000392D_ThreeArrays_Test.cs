...
{
    [TestClass]
    public sealed class CF_00000392D_ThreeArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000392D_ThreeArrays));
        ...
        {
            bool result = CF_00000392D_ThreeArrays.Solution_0_Test(input);
