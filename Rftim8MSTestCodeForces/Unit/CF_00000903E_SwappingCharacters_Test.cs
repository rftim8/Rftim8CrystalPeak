...
{
    [TestClass]
    public sealed class CF_00000903E_SwappingCharacters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000903E_SwappingCharacters));
        ...
        {
            bool result = CF_00000903E_SwappingCharacters.Solution_0_Test(input);
