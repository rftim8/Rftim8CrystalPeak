...
{
    [TestClass]
    public sealed class CF_00000064E_PrimeSegment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000064E_PrimeSegment));
        ...
        {
            bool result = CF_00000064E_PrimeSegment.Solution_0_Test(input);
