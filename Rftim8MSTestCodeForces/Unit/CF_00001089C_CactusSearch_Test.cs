...
{
    [TestClass]
    public sealed class CF_00001089C_CactusSearch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001089C_CactusSearch));
        ...
        {
            bool result = CF_00001089C_CactusSearch.Solution_0_Test(input);
