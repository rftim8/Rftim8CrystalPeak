...
{
    [TestClass]
    public sealed class CF_00001573B_Swaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001573B_Swaps));
        ...
        {
            bool result = CF_00001573B_Swaps.Solution_0_Test(input);
