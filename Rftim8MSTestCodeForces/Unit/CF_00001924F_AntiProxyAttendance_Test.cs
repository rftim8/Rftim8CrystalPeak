...
{
    [TestClass]
    public sealed class CF_00001924F_AntiProxyAttendance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001924F_AntiProxyAttendance));
        ...
        {
            bool result = CF_00001924F_AntiProxyAttendance.Solution_0_Test(input);
