...
{
    [TestClass]
    public sealed class CF_00000575A_Fibonotci_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000575A_Fibonotci));
        ...
        {
            bool result = CF_00000575A_Fibonotci.Solution_0_Test(input);
