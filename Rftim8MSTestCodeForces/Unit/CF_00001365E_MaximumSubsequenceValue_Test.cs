...
{
    [TestClass]
    public sealed class CF_00001365E_MaximumSubsequenceValue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001365E_MaximumSubsequenceValue));
        ...
        {
            bool result = CF_00001365E_MaximumSubsequenceValue.Solution_0_Test(input);
