...
{
    [TestClass]
    public sealed class CF_00000442B_AndreyAndProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000442B_AndreyAndProblem));
        ...
        {
            bool result = CF_00000442B_AndreyAndProblem.Solution_0_Test(input);
