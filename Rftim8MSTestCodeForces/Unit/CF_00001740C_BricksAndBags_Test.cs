...
{
    [TestClass]
    public sealed class CF_00001740C_BricksAndBags_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001740C_BricksAndBags));
        ...
        {
            bool result = CF_00001740C_BricksAndBags.Solution_0_Test(input);
