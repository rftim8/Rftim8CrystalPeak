...
{
    [TestClass]
    public sealed class CF_00001709F_MultisetOfStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001709F_MultisetOfStrings));
        ...
        {
            bool result = CF_00001709F_MultisetOfStrings.Solution_0_Test(input);
