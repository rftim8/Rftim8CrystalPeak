...
{
    [TestClass]
    public sealed class CF_00001497A_Meximization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001497A_Meximization));
        ...
        {
            bool result = CF_00001497A_Meximization.Solution_0_Test(input);
