...
{
    [TestClass]
    public sealed class CF_00001037G_AGameOnStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001037G_AGameOnStrings));
        ...
        {
            bool result = CF_00001037G_AGameOnStrings.Solution_0_Test(input);
