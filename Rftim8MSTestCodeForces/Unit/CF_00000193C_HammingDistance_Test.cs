...
{
    [TestClass]
    public sealed class CF_00000193C_HammingDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000193C_HammingDistance));
        ...
        {
            bool result = CF_00000193C_HammingDistance.Solution_0_Test(input);
