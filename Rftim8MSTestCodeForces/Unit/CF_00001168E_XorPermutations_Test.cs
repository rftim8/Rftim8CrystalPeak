...
{
    [TestClass]
    public sealed class CF_00001168E_XorPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001168E_XorPermutations));
        ...
        {
            bool result = CF_00001168E_XorPermutations.Solution_0_Test(input);
