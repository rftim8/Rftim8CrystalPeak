...
{
    [TestClass]
    public sealed class CF_00001436D_BanditInACity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001436D_BanditInACity));
        ...
        {
            bool result = CF_00001436D_BanditInACity.Solution_0_Test(input);
