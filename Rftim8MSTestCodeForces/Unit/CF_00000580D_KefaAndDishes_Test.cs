...
{
    [TestClass]
    public sealed class CF_00000580D_KefaAndDishes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000580D_KefaAndDishes));
        ...
        {
            bool result = CF_00000580D_KefaAndDishes.Solution_0_Test(input);
