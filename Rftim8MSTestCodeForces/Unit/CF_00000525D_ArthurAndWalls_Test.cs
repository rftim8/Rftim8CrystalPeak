...
{
    [TestClass]
    public sealed class CF_00000525D_ArthurAndWalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000525D_ArthurAndWalls));
        ...
        {
            bool result = CF_00000525D_ArthurAndWalls.Solution_0_Test(input);
