...
{
    [TestClass]
    public sealed class CF_00002019B_AllPairsSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002019B_AllPairsSegments));
        ...
        {
            bool result = CF_00002019B_AllPairsSegments.Solution_0_Test(input);
