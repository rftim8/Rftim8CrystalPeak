...
{
    [TestClass]
    public sealed class CF_00001252D_FindStringInAGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001252D_FindStringInAGrid));
        ...
        {
            bool result = CF_00001252D_FindStringInAGrid.Solution_0_Test(input);
