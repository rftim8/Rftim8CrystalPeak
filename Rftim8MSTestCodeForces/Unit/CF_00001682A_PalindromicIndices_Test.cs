...
{
    [TestClass]
    public sealed class CF_00001682A_PalindromicIndices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001682A_PalindromicIndices));
        ...
        {
            bool result = CF_00001682A_PalindromicIndices.Solution_0_Test(input);
