...
{
    [TestClass]
    public sealed class CF_00001044A_TheTowerIsGoingHome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001044A_TheTowerIsGoingHome));
        ...
        {
            bool result = CF_00001044A_TheTowerIsGoingHome.Solution_0_Test(input);
