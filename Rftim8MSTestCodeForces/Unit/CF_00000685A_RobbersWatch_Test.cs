...
{
    [TestClass]
    public sealed class CF_00000685A_RobbersWatch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000685A_RobbersWatch));
        ...
        {
            bool result = CF_00000685A_RobbersWatch.Solution_0_Test(input);
