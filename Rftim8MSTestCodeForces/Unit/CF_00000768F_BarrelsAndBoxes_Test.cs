...
{
    [TestClass]
    public sealed class CF_00000768F_BarrelsAndBoxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000768F_BarrelsAndBoxes));
        ...
        {
            bool result = CF_00000768F_BarrelsAndBoxes.Solution_0_Test(input);
