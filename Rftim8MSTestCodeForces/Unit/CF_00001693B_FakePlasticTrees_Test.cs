...
{
    [TestClass]
    public sealed class CF_00001693B_FakePlasticTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001693B_FakePlasticTrees));
        ...
        {
            bool result = CF_00001693B_FakePlasticTrees.Solution_0_Test(input);
