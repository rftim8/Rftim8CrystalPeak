...
{
    [TestClass]
    public sealed class CF_00001532D_TeamsForming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001532D_TeamsForming));
        ...
        {
            bool result = CF_00001532D_TeamsForming.Solution_0_Test(input);
