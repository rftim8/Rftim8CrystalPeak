...
{
    [TestClass]
    public sealed class CF_00000117B_VeryInterestingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000117B_VeryInterestingGame));
        ...
        {
            bool result = CF_00000117B_VeryInterestingGame.Solution_0_Test(input);
