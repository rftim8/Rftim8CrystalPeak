...
{
    [TestClass]
    public sealed class CF_00001117F_CrispString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001117F_CrispString));
        ...
        {
            bool result = CF_00001117F_CrispString.Solution_0_Test(input);
