...
{
    [TestClass]
    public sealed class CF_00001200C_RoundCorridor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001200C_RoundCorridor));
        ...
        {
            bool result = CF_00001200C_RoundCorridor.Solution_0_Test(input);
