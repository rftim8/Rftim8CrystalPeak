...
{
    [TestClass]
    public sealed class CF_00001534E_LostArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001534E_LostArray));
        ...
        {
            bool result = CF_00001534E_LostArray.Solution_0_Test(input);
