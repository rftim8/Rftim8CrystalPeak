...
{
    [TestClass]
    public sealed class CF_00001610G_AmShZWinsABet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001610G_AmShZWinsABet));
        ...
        {
            bool result = CF_00001610G_AmShZWinsABet.Solution_0_Test(input);
