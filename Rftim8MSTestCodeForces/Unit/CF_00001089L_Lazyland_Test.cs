...
{
    [TestClass]
    public sealed class CF_00001089L_Lazyland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001089L_Lazyland));
        ...
        {
            bool result = CF_00001089L_Lazyland.Solution_0_Test(input);
