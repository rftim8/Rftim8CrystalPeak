...
{
    [TestClass]
    public sealed class CF_00001085E_VasyaAndTemplates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001085E_VasyaAndTemplates));
        ...
        {
            bool result = CF_00001085E_VasyaAndTemplates.Solution_0_Test(input);
