...
{
    [TestClass]
    public sealed class CF_00002025G_VariableDamage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002025G_VariableDamage));
        ...
        {
            bool result = CF_00002025G_VariableDamage.Solution_0_Test(input);
