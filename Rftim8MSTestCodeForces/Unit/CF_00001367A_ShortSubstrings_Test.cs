...
{
    [TestClass]
    public sealed class CF_00001367A_ShortSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001367A_ShortSubstrings));
        ...
        {
            bool result = CF_00001367A_ShortSubstrings.Solution_0_Test(input);
