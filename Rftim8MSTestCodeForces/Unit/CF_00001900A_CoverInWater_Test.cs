...
{
    [TestClass]
    public sealed class CF_00001900A_CoverInWater_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001900A_CoverInWater));
        ...
        {
            bool result = CF_00001900A_CoverInWater.Solution_0_Test(input);
