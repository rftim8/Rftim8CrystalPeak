...
{
    [TestClass]
    public sealed class CF_00001601D_DifficultMountain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001601D_DifficultMountain));
        ...
        {
            bool result = CF_00001601D_DifficultMountain.Solution_0_Test(input);
