...
{
    [TestClass]
    public sealed class CF_00001073E_SegmentSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001073E_SegmentSum));
        ...
        {
            bool result = CF_00001073E_SegmentSum.Solution_0_Test(input);
