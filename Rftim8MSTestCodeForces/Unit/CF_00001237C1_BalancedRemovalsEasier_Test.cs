...
{
    [TestClass]
    public sealed class CF_00001237C1_BalancedRemovalsEasier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001237C1_BalancedRemovalsEasier));
        ...
        {
            bool result = CF_00001237C1_BalancedRemovalsEasier.Solution_0_Test(input);
