...
{
    [TestClass]
    public sealed class CF_00001712A_WonderfulPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001712A_WonderfulPermutation));
        ...
        {
            bool result = CF_00001712A_WonderfulPermutation.Solution_0_Test(input);
