...
{
    [TestClass]
    public sealed class CF_00001452D_RadioTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001452D_RadioTowers));
        ...
        {
            bool result = CF_00001452D_RadioTowers.Solution_0_Test(input);
