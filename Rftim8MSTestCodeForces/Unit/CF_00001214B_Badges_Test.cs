...
{
    [TestClass]
    public sealed class CF_00001214B_Badges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001214B_Badges));
        ...
        {
            bool result = CF_00001214B_Badges.Solution_0_Test(input);
