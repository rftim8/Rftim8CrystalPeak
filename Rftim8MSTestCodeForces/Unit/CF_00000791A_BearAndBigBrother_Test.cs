...
{
    [TestClass]
    public sealed class CF_00000791A_BearAndBigBrother_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000791A_BearAndBigBrother));
        ...
        {
            bool result = CF_00000791A_BearAndBigBrother.Solution_0_Test(input);
