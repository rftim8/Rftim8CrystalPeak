...
{
    [TestClass]
    public sealed class CF_00001583A_WindblumeOde_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001583A_WindblumeOde));
        ...
        {
            bool result = CF_00001583A_WindblumeOde.Solution_0_Test(input);
