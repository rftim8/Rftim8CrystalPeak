...
{
    [TestClass]
    public sealed class CF_00001910A_Username_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001910A_Username));
        ...
        {
            bool result = CF_00001910A_Username.Solution_0_Test(input);
