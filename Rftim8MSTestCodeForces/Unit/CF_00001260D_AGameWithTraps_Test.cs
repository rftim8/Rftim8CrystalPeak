...
{
    [TestClass]
    public sealed class CF_00001260D_AGameWithTraps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001260D_AGameWithTraps));
        ...
        {
            bool result = CF_00001260D_AGameWithTraps.Solution_0_Test(input);
