...
{
    [TestClass]
    public sealed class CF_00001491B_MinimalCost_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001491B_MinimalCost));
        ...
        {
            bool result = CF_00001491B_MinimalCost.Solution_0_Test(input);
