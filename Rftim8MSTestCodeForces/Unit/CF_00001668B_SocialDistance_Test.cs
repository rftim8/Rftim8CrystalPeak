...
{
    [TestClass]
    public sealed class CF_00001668B_SocialDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001668B_SocialDistance));
        ...
        {
            bool result = CF_00001668B_SocialDistance.Solution_0_Test(input);
