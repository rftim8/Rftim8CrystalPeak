...
{
    [TestClass]
    public sealed class CF_00001194E_CountTheRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001194E_CountTheRectangles));
        ...
        {
            bool result = CF_00001194E_CountTheRectangles.Solution_0_Test(input);
