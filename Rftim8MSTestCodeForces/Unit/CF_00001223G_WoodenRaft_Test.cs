...
{
    [TestClass]
    public sealed class CF_00001223G_WoodenRaft_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001223G_WoodenRaft));
        ...
        {
            bool result = CF_00001223G_WoodenRaft.Solution_0_Test(input);
