...
{
    [TestClass]
    public sealed class CF_00001398E_TwoTypesOfSpells_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001398E_TwoTypesOfSpells));
        ...
        {
            bool result = CF_00001398E_TwoTypesOfSpells.Solution_0_Test(input);
