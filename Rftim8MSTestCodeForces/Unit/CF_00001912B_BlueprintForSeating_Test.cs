...
{
    [TestClass]
    public sealed class CF_00001912B_BlueprintForSeating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001912B_BlueprintForSeating));
        ...
        {
            bool result = CF_00001912B_BlueprintForSeating.Solution_0_Test(input);
