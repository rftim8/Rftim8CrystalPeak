...
{
    [TestClass]
    public sealed class CF_00000274A_KMultipleFreeSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000274A_KMultipleFreeSet));
        ...
        {
            bool result = CF_00000274A_KMultipleFreeSet.Solution_0_Test(input);
