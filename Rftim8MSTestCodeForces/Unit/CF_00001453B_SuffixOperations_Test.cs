...
{
    [TestClass]
    public sealed class CF_00001453B_SuffixOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001453B_SuffixOperations));
        ...
        {
            bool result = CF_00001453B_SuffixOperations.Solution_0_Test(input);
