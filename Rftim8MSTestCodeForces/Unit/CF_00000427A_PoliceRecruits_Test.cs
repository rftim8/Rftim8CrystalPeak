...
{
    [TestClass]
    public sealed class CF_00000427A_PoliceRecruits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000427A_PoliceRecruits));
        ...
        {
            bool result = CF_00000427A_PoliceRecruits.Solution_0_Test(input);
