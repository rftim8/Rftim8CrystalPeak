...
{
    [TestClass]
    public sealed class CF_00001396C_MonsterInvaders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001396C_MonsterInvaders));
        ...
        {
            bool result = CF_00001396C_MonsterInvaders.Solution_0_Test(input);
