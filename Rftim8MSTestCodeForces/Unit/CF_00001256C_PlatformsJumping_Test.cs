...
{
    [TestClass]
    public sealed class CF_00001256C_PlatformsJumping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001256C_PlatformsJumping));
        ...
        {
            bool result = CF_00001256C_PlatformsJumping.Solution_0_Test(input);
