...
{
    [TestClass]
    public sealed class CF_00000785D_AntonAndSchool2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000785D_AntonAndSchool2));
        ...
        {
            bool result = CF_00000785D_AntonAndSchool2.Solution_0_Test(input);
