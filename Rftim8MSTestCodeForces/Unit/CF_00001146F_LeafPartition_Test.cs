...
{
    [TestClass]
    public sealed class CF_00001146F_LeafPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001146F_LeafPartition));
        ...
        {
            bool result = CF_00001146F_LeafPartition.Solution_0_Test(input);
