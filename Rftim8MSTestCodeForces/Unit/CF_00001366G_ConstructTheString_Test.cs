...
{
    [TestClass]
    public sealed class CF_00001366G_ConstructTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001366G_ConstructTheString));
        ...
        {
            bool result = CF_00001366G_ConstructTheString.Solution_0_Test(input);
