...
{
    [TestClass]
    public sealed class CF_00001503B_3Coloring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001503B_3Coloring));
        ...
        {
            bool result = CF_00001503B_3Coloring.Solution_0_Test(input);
