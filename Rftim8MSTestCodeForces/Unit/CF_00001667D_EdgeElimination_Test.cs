...
{
    [TestClass]
    public sealed class CF_00001667D_EdgeElimination_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001667D_EdgeElimination));
        ...
        {
            bool result = CF_00001667D_EdgeElimination.Solution_0_Test(input);
