...
{
    [TestClass]
    public sealed class CF_00000540A_CombinationLock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000540A_CombinationLock));
        ...
        {
            bool result = CF_00000540A_CombinationLock.Solution_0_Test(input);
