...
{
    [TestClass]
    public sealed class CF_00000218B_Airport_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000218B_Airport));
        ...
        {
            bool result = CF_00000218B_Airport.Solution_0_Test(input);
