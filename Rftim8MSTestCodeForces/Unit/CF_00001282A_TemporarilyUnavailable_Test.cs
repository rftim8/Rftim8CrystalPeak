...
{
    [TestClass]
    public sealed class CF_00001282A_TemporarilyUnavailable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001282A_TemporarilyUnavailable));
        ...
        {
            bool result = CF_00001282A_TemporarilyUnavailable.Solution_0_Test(input);
