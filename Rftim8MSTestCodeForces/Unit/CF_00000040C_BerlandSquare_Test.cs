...
{
    [TestClass]
    public sealed class CF_00000040C_BerlandSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000040C_BerlandSquare));
        ...
        {
            bool result = CF_00000040C_BerlandSquare.Solution_0_Test(input);
