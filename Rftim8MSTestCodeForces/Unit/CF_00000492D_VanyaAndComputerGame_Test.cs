...
{
    [TestClass]
    public sealed class CF_00000492D_VanyaAndComputerGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000492D_VanyaAndComputerGame));
        ...
        {
            bool result = CF_00000492D_VanyaAndComputerGame.Solution_0_Test(input);
