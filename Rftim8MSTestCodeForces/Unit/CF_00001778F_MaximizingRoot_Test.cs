...
{
    [TestClass]
    public sealed class CF_00001778F_MaximizingRoot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001778F_MaximizingRoot));
        ...
        {
            bool result = CF_00001778F_MaximizingRoot.Solution_0_Test(input);
