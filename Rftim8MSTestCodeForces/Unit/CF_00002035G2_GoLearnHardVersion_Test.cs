...
{
    [TestClass]
    public sealed class CF_00002035G2_GoLearnHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002035G2_GoLearnHardVersion));
        ...
        {
            bool result = CF_00002035G2_GoLearnHardVersion.Solution_0_Test(input);
