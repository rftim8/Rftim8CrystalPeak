...
{
    [TestClass]
    public sealed class CF_00001333C_EugeneAndAnArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001333C_EugeneAndAnArray));
        ...
        {
            bool result = CF_00001333C_EugeneAndAnArray.Solution_0_Test(input);
