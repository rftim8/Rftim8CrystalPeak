...
{
    [TestClass]
    public sealed class CF_00001866L_LihmufBalling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001866L_LihmufBalling));
        ...
        {
            bool result = CF_00001866L_LihmufBalling.Solution_0_Test(input);
