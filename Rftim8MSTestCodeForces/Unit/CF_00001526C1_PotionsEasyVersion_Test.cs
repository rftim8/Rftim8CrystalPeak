...
{
    [TestClass]
    public sealed class CF_00001526C1_PotionsEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001526C1_PotionsEasyVersion));
        ...
        {
            bool result = CF_00001526C1_PotionsEasyVersion.Solution_0_Test(input);
