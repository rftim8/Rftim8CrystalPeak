...
{
    [TestClass]
    public sealed class CF_00000615A_Bulbs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000615A_Bulbs));
        ...
        {
            bool result = CF_00000615A_Bulbs.Solution_0_Test(input);
