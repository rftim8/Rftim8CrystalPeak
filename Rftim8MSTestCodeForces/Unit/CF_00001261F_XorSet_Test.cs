...
{
    [TestClass]
    public sealed class CF_00001261F_XorSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001261F_XorSet));
        ...
        {
            bool result = CF_00001261F_XorSet.Solution_0_Test(input);
