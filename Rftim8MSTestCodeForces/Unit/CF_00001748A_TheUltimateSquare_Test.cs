...
{
    [TestClass]
    public sealed class CF_00001748A_TheUltimateSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001748A_TheUltimateSquare));
        ...
        {
            bool result = CF_00001748A_TheUltimateSquare.Solution_0_Test(input);
