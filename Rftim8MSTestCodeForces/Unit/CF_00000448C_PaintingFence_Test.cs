...
{
    [TestClass]
    public sealed class CF_00000448C_PaintingFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000448C_PaintingFence));
        ...
        {
            bool result = CF_00000448C_PaintingFence.Solution_0_Test(input);
