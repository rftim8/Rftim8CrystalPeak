...
{
    [TestClass]
    public sealed class CF_00001363C_GameOnLeaves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001363C_GameOnLeaves));
        ...
        {
            bool result = CF_00001363C_GameOnLeaves.Solution_0_Test(input);
