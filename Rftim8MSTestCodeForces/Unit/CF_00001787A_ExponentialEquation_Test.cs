...
{
    [TestClass]
    public sealed class CF_00001787A_ExponentialEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001787A_ExponentialEquation));
        ...
        {
            bool result = CF_00001787A_ExponentialEquation.Solution_0_Test(input);
