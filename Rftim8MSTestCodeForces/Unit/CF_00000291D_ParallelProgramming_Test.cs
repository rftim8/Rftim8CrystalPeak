...
{
    [TestClass]
    public sealed class CF_00000291D_ParallelProgramming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000291D_ParallelProgramming));
        ...
        {
            bool result = CF_00000291D_ParallelProgramming.Solution_0_Test(input);
