...
{
    [TestClass]
    public sealed class CF_00000610A_PashaAndStick_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000610A_PashaAndStick));
        ...
        {
            bool result = CF_00000610A_PashaAndStick.Solution_0_Test(input);
