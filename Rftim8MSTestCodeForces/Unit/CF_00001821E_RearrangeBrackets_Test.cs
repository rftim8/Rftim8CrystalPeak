...
{
    [TestClass]
    public sealed class CF_00001821E_RearrangeBrackets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001821E_RearrangeBrackets));
        ...
        {
            bool result = CF_00001821E_RearrangeBrackets.Solution_0_Test(input);
