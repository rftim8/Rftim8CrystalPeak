...
{
    [TestClass]
    public sealed class CF_00000613B_Skills_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000613B_Skills));
        ...
        {
            bool result = CF_00000613B_Skills.Solution_0_Test(input);
