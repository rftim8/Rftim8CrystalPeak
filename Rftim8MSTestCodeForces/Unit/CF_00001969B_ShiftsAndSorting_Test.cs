...
{
    [TestClass]
    public sealed class CF_00001969B_ShiftsAndSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001969B_ShiftsAndSorting));
        ...
        {
            bool result = CF_00001969B_ShiftsAndSorting.Solution_0_Test(input);
