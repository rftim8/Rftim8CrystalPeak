...
{
    [TestClass]
    public sealed class CF_00000440B_Balancer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000440B_Balancer));
        ...
        {
            bool result = CF_00000440B_Balancer.Solution_0_Test(input);
