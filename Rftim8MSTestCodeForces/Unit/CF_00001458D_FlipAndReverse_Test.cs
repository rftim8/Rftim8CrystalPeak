...
{
    [TestClass]
    public sealed class CF_00001458D_FlipAndReverse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001458D_FlipAndReverse));
        ...
        {
            bool result = CF_00001458D_FlipAndReverse.Solution_0_Test(input);
