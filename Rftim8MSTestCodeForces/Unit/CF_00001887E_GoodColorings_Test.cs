...
{
    [TestClass]
    public sealed class CF_00001887E_GoodColorings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001887E_GoodColorings));
        ...
        {
            bool result = CF_00001887E_GoodColorings.Solution_0_Test(input);
