...
{
    [TestClass]
    public sealed class CF_00001213E_TwoSmallStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001213E_TwoSmallStrings));
        ...
        {
            bool result = CF_00001213E_TwoSmallStrings.Solution_0_Test(input);
