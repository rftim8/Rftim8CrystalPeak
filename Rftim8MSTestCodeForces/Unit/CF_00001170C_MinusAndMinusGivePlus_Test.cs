...
{
    [TestClass]
    public sealed class CF_00001170C_MinusAndMinusGivePlus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001170C_MinusAndMinusGivePlus));
        ...
        {
            bool result = CF_00001170C_MinusAndMinusGivePlus.Solution_0_Test(input);
