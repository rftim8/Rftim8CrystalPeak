...
{
    [TestClass]
    public sealed class CF_00000837C_TwoSeals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000837C_TwoSeals));
        ...
        {
            bool result = CF_00000837C_TwoSeals.Solution_0_Test(input);
