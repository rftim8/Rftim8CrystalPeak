...
{
    [TestClass]
    public sealed class CF_00000052A_123sequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000052A_123sequence));
        ...
        {
            bool result = CF_00000052A_123sequence.Solution_0_Test(input);
