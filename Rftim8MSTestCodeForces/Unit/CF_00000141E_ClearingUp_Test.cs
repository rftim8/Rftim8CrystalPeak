...
{
    [TestClass]
    public sealed class CF_00000141E_ClearingUp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000141E_ClearingUp));
        ...
        {
            bool result = CF_00000141E_ClearingUp.Solution_0_Test(input);
