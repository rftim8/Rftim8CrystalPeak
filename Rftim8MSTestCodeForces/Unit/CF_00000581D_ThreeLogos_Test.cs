...
{
    [TestClass]
    public sealed class CF_00000581D_ThreeLogos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000581D_ThreeLogos));
        ...
        {
            bool result = CF_00000581D_ThreeLogos.Solution_0_Test(input);
