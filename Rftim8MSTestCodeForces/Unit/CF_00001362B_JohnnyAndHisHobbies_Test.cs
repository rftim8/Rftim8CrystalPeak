...
{
    [TestClass]
    public sealed class CF_00001362B_JohnnyAndHisHobbies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001362B_JohnnyAndHisHobbies));
        ...
        {
            bool result = CF_00001362B_JohnnyAndHisHobbies.Solution_0_Test(input);
