...
{
    [TestClass]
    public sealed class CF_00001554B_Cobb_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001554B_Cobb));
        ...
        {
            bool result = CF_00001554B_Cobb.Solution_0_Test(input);
