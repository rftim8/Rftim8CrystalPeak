...
{
    [TestClass]
    public sealed class CF_00000995F_CowmpanyCowmpensation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000995F_CowmpanyCowmpensation));
        ...
        {
            bool result = CF_00000995F_CowmpanyCowmpensation.Solution_0_Test(input);
