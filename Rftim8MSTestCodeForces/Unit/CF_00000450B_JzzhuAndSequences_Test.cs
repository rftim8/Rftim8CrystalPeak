...
{
    [TestClass]
    public sealed class CF_00000450B_JzzhuAndSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000450B_JzzhuAndSequences));
        ...
        {
            bool result = CF_00000450B_JzzhuAndSequences.Solution_0_Test(input);
