...
{
    [TestClass]
    public sealed class CF_00001733B_RuleOfLeague_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001733B_RuleOfLeague));
        ...
        {
            bool result = CF_00001733B_RuleOfLeague.Solution_0_Test(input);
