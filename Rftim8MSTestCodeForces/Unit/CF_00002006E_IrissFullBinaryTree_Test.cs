...
{
    [TestClass]
    public sealed class CF_00002006E_IrissFullBinaryTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002006E_IrissFullBinaryTree));
        ...
        {
            bool result = CF_00002006E_IrissFullBinaryTree.Solution_0_Test(input);
