...
{
    [TestClass]
    public sealed class CF_00001714E_AddModulo10_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001714E_AddModulo10));
        ...
        {
            bool result = CF_00001714E_AddModulo10.Solution_0_Test(input);
