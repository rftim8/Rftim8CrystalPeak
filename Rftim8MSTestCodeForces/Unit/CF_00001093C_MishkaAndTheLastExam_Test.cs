...
{
    [TestClass]
    public sealed class CF_00001093C_MishkaAndTheLastExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001093C_MishkaAndTheLastExam));
        ...
        {
            bool result = CF_00001093C_MishkaAndTheLastExam.Solution_0_Test(input);
