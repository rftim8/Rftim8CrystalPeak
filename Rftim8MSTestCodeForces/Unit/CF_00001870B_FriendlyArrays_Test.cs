...
{
    [TestClass]
    public sealed class CF_00001870B_FriendlyArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001870B_FriendlyArrays));
        ...
        {
            bool result = CF_00001870B_FriendlyArrays.Solution_0_Test(input);
