...
{
    [TestClass]
    public sealed class CF_00001623B_GameOnRanges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001623B_GameOnRanges));
        ...
        {
            bool result = CF_00001623B_GameOnRanges.Solution_0_Test(input);
