...
{
    [TestClass]
    public sealed class CF_00000441E_ValeraAndNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000441E_ValeraAndNumber));
        ...
        {
            bool result = CF_00000441E_ValeraAndNumber.Solution_0_Test(input);
