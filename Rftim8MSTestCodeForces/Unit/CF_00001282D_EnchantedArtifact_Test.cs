...
{
    [TestClass]
    public sealed class CF_00001282D_EnchantedArtifact_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001282D_EnchantedArtifact));
        ...
        {
            bool result = CF_00001282D_EnchantedArtifact.Solution_0_Test(input);
