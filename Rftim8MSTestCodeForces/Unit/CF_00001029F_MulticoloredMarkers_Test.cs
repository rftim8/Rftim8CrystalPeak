...
{
    [TestClass]
    public sealed class CF_00001029F_MulticoloredMarkers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001029F_MulticoloredMarkers));
        ...
        {
            bool result = CF_00001029F_MulticoloredMarkers.Solution_0_Test(input);
