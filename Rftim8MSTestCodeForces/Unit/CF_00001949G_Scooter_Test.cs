...
{
    [TestClass]
    public sealed class CF_00001949G_Scooter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001949G_Scooter));
        ...
        {
            bool result = CF_00001949G_Scooter.Solution_0_Test(input);
