...
{
    [TestClass]
    public sealed class CF_00000827F_DirtyArkadysKitchen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000827F_DirtyArkadysKitchen));
        ...
        {
            bool result = CF_00000827F_DirtyArkadysKitchen.Solution_0_Test(input);
