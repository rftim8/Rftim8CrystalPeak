...
{
    [TestClass]
    public sealed class CF_00001156G_Optimizer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001156G_Optimizer));
        ...
        {
            bool result = CF_00001156G_Optimizer.Solution_0_Test(input);
