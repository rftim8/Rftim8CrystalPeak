...
{
    [TestClass]
    public sealed class CF_00000260E_DividingKingdom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000260E_DividingKingdom));
        ...
        {
            bool result = CF_00000260E_DividingKingdom.Solution_0_Test(input);
