...
{
    [TestClass]
    public sealed class CF_00001613C_PoisonedDagger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001613C_PoisonedDagger));
        ...
        {
            bool result = CF_00001613C_PoisonedDagger.Solution_0_Test(input);
