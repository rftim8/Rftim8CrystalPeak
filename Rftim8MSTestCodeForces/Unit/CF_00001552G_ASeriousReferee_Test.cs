...
{
    [TestClass]
    public sealed class CF_00001552G_ASeriousReferee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001552G_ASeriousReferee));
        ...
        {
            bool result = CF_00001552G_ASeriousReferee.Solution_0_Test(input);
