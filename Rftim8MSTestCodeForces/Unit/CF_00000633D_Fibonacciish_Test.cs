...
{
    [TestClass]
    public sealed class CF_00000633D_Fibonacciish_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000633D_Fibonacciish));
        ...
        {
            bool result = CF_00000633D_Fibonacciish.Solution_0_Test(input);
