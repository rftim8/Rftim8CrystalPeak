...
{
    [TestClass]
    public sealed class CF_00000174A_ProblemAboutEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000174A_ProblemAboutEquation));
        ...
        {
            bool result = CF_00000174A_ProblemAboutEquation.Solution_0_Test(input);
