...
{
    [TestClass]
    public sealed class CF_00001926A_VladAndTheBestOfFive_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001926A_VladAndTheBestOfFive));
        ...
        {
            bool result = CF_00001926A_VladAndTheBestOfFive.Solution_0_Test(input);
