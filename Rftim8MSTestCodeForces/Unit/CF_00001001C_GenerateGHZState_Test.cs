...
{
    [TestClass]
    public sealed class CF_00001001C_GenerateGHZState_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001001C_GenerateGHZState));
        ...
        {
            bool result = CF_00001001C_GenerateGHZState.Solution_0_Test(input);
