...
{
    [TestClass]
    public sealed class CF_00000568A_PrimesOrPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000568A_PrimesOrPalindromes));
        ...
        {
            bool result = CF_00000568A_PrimesOrPalindromes.Solution_0_Test(input);
