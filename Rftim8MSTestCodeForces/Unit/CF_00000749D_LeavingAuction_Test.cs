...
{
    [TestClass]
    public sealed class CF_00000749D_LeavingAuction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000749D_LeavingAuction));
        ...
        {
            bool result = CF_00000749D_LeavingAuction.Solution_0_Test(input);
