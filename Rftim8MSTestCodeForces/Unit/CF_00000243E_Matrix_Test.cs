...
{
    [TestClass]
    public sealed class CF_00000243E_Matrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000243E_Matrix));
        ...
        {
            bool result = CF_00000243E_Matrix.Solution_0_Test(input);
