...
{
    [TestClass]
    public sealed class CF_00001302E_AmazingBitset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001302E_AmazingBitset));
        ...
        {
            bool result = CF_00001302E_AmazingBitset.Solution_0_Test(input);
