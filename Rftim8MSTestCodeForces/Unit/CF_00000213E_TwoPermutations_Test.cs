...
{
    [TestClass]
    public sealed class CF_00000213E_TwoPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000213E_TwoPermutations));
        ...
        {
            bool result = CF_00000213E_TwoPermutations.Solution_0_Test(input);
