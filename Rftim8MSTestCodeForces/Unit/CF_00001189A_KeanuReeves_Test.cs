...
{
    [TestClass]
    public sealed class CF_00001189A_KeanuReeves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001189A_KeanuReeves));
        ...
        {
            bool result = CF_00001189A_KeanuReeves.Solution_0_Test(input);
