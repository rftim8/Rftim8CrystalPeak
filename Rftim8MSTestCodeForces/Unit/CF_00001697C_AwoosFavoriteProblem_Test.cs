...
{
    [TestClass]
    public sealed class CF_00001697C_AwoosFavoriteProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001697C_AwoosFavoriteProblem));
        ...
        {
            bool result = CF_00001697C_AwoosFavoriteProblem.Solution_0_Test(input);
