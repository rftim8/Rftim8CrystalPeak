...
{
    [TestClass]
    public sealed class CF_00001016D_VasyaAndTheMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001016D_VasyaAndTheMatrix));
        ...
        {
            bool result = CF_00001016D_VasyaAndTheMatrix.Solution_0_Test(input);
