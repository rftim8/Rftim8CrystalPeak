...
{
    [TestClass]
    public sealed class CF_00000803D_MagazineAd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000803D_MagazineAd));
        ...
        {
            bool result = CF_00000803D_MagazineAd.Solution_0_Test(input);
