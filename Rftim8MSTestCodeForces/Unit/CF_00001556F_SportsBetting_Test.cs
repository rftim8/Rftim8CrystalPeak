...
{
    [TestClass]
    public sealed class CF_00001556F_SportsBetting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001556F_SportsBetting));
        ...
        {
            bool result = CF_00001556F_SportsBetting.Solution_0_Test(input);
