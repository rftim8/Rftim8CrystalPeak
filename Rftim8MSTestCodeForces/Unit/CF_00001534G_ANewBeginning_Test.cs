...
{
    [TestClass]
    public sealed class CF_00001534G_ANewBeginning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001534G_ANewBeginning));
        ...
        {
            bool result = CF_00001534G_ANewBeginning.Solution_0_Test(input);
