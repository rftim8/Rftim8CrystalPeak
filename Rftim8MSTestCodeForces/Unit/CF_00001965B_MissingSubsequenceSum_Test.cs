...
{
    [TestClass]
    public sealed class CF_00001965B_MissingSubsequenceSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001965B_MissingSubsequenceSum));
        ...
        {
            bool result = CF_00001965B_MissingSubsequenceSum.Solution_0_Test(input);
