...
{
    [TestClass]
    public sealed class CF_00001462D_AddToNeighbourAndRemove_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001462D_AddToNeighbourAndRemove));
        ...
        {
            bool result = CF_00001462D_AddToNeighbourAndRemove.Solution_0_Test(input);
