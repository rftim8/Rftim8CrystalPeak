...
{
    [TestClass]
    public sealed class CF_00001200B_BlockAdventure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001200B_BlockAdventure));
        ...
        {
            bool result = CF_00001200B_BlockAdventure.Solution_0_Test(input);
