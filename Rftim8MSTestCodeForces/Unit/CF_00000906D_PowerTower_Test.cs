...
{
    [TestClass]
    public sealed class CF_00000906D_PowerTower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000906D_PowerTower));
        ...
        {
            bool result = CF_00000906D_PowerTower.Solution_0_Test(input);
