...
{
    [TestClass]
    public sealed class CF_00000153D_DateChange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000153D_DateChange));
        ...
        {
            bool result = CF_00000153D_DateChange.Solution_0_Test(input);
