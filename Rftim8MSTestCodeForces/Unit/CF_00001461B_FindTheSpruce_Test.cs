...
{
    [TestClass]
    public sealed class CF_00001461B_FindTheSpruce_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001461B_FindTheSpruce));
        ...
        {
            bool result = CF_00001461B_FindTheSpruce.Solution_0_Test(input);
