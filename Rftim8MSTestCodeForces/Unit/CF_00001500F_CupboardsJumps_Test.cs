...
{
    [TestClass]
    public sealed class CF_00001500F_CupboardsJumps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001500F_CupboardsJumps));
        ...
        {
            bool result = CF_00001500F_CupboardsJumps.Solution_0_Test(input);
