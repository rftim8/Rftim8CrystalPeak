...
{
    [TestClass]
    public sealed class CF_00001907D_JumpingThroughSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001907D_JumpingThroughSegments));
        ...
        {
            bool result = CF_00001907D_JumpingThroughSegments.Solution_0_Test(input);
