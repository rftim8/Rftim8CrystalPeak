...
{
    [TestClass]
    public sealed class CF_00001899D_YarikAndMusicalNotes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001899D_YarikAndMusicalNotes));
        ...
        {
            bool result = CF_00001899D_YarikAndMusicalNotes.Solution_0_Test(input);
