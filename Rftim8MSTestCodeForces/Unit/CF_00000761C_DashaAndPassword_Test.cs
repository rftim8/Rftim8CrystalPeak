...
{
    [TestClass]
    public sealed class CF_00000761C_DashaAndPassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000761C_DashaAndPassword));
        ...
        {
            bool result = CF_00000761C_DashaAndPassword.Solution_0_Test(input);
