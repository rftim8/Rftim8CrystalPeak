...
{
    [TestClass]
    public sealed class CF_00001852A_NtarsisSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001852A_NtarsisSet));
        ...
        {
            bool result = CF_00001852A_NtarsisSet.Solution_0_Test(input);
