...
{
    [TestClass]
    public sealed class CF_00001295F_GoodContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001295F_GoodContest));
        ...
        {
            bool result = CF_00001295F_GoodContest.Solution_0_Test(input);
