...
{
    [TestClass]
    public sealed class CF_00001759B_LostPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001759B_LostPermutation));
        ...
        {
            bool result = CF_00001759B_LostPermutation.Solution_0_Test(input);
