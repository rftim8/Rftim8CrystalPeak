...
{
    [TestClass]
    public sealed class CF_00001129A2_ToyTrain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001129A2_ToyTrain));
        ...
        {
            bool result = CF_00001129A2_ToyTrain.Solution_0_Test(input);
