...
{
    [TestClass]
    public sealed class CF_00001037D_ValidBFS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001037D_ValidBFS));
        ...
        {
            bool result = CF_00001037D_ValidBFS.Solution_0_Test(input);
