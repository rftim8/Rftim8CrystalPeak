...
{
    [TestClass]
    public sealed class CF_00001989B_SubstringAndSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001989B_SubstringAndSubsequence));
        ...
        {
            bool result = CF_00001989B_SubstringAndSubsequence.Solution_0_Test(input);
