...
{
    [TestClass]
    public sealed class CF_00000012D_Ball_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000012D_Ball));
        ...
        {
            bool result = CF_00000012D_Ball.Solution_0_Test(input);
