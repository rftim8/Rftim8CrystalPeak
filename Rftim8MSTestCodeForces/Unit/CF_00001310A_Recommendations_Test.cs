...
{
    [TestClass]
    public sealed class CF_00001310A_Recommendations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001310A_Recommendations));
        ...
        {
            bool result = CF_00001310A_Recommendations.Solution_0_Test(input);
