...
{
    [TestClass]
    public sealed class CF_00001744B_EvenOddIncrements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001744B_EvenOddIncrements));
        ...
        {
            bool result = CF_00001744B_EvenOddIncrements.Solution_0_Test(input);
