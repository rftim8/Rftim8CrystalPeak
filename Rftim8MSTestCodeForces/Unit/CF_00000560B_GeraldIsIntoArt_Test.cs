...
{
    [TestClass]
    public sealed class CF_00000560B_GeraldIsIntoArt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000560B_GeraldIsIntoArt));
        ...
        {
            bool result = CF_00000560B_GeraldIsIntoArt.Solution_0_Test(input);
