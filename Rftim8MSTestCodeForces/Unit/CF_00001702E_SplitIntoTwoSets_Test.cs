...
{
    [TestClass]
    public sealed class CF_00001702E_SplitIntoTwoSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001702E_SplitIntoTwoSets));
        ...
        {
            bool result = CF_00001702E_SplitIntoTwoSets.Solution_0_Test(input);
