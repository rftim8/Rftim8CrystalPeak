...
{
    [TestClass]
    public sealed class CF_00001852B_ImbalancedArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001852B_ImbalancedArrays));
        ...
        {
            bool result = CF_00001852B_ImbalancedArrays.Solution_0_Test(input);
