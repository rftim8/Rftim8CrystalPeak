...
{
    [TestClass]
    public sealed class CF_00001437C_ChefMonocarp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001437C_ChefMonocarp));
        ...
        {
            bool result = CF_00001437C_ChefMonocarp.Solution_0_Test(input);
