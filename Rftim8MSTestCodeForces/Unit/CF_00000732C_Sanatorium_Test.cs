...
{
    [TestClass]
    public sealed class CF_00000732C_Sanatorium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000732C_Sanatorium));
        ...
        {
            bool result = CF_00000732C_Sanatorium.Solution_0_Test(input);
