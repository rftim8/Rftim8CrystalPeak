...
{
    [TestClass]
    public sealed class CF_00002000B_SeatingInABus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002000B_SeatingInABus));
        ...
        {
            bool result = CF_00002000B_SeatingInABus.Solution_0_Test(input);
