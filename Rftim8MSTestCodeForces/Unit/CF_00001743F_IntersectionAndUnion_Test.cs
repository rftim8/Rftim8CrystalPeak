...
{
    [TestClass]
    public sealed class CF_00001743F_IntersectionAndUnion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001743F_IntersectionAndUnion));
        ...
        {
            bool result = CF_00001743F_IntersectionAndUnion.Solution_0_Test(input);
