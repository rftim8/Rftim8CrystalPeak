...
{
    [TestClass]
    public sealed class CF_00001459A_RedBlueShuffle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001459A_RedBlueShuffle));
        ...
        {
            bool result = CF_00001459A_RedBlueShuffle.Solution_0_Test(input);
