...
{
    [TestClass]
    public sealed class CF_00001426B_SymmetricMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001426B_SymmetricMatrix));
        ...
        {
            bool result = CF_00001426B_SymmetricMatrix.Solution_0_Test(input);
