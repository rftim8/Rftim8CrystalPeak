...
{
    [TestClass]
    public sealed class CF_00001333A_LittleArtem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001333A_LittleArtem));
        ...
        {
            bool result = CF_00001333A_LittleArtem.Solution_0_Test(input);
