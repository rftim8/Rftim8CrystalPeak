...
{
    [TestClass]
    public sealed class CF_00001740E_HangingHearts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001740E_HangingHearts));
        ...
        {
            bool result = CF_00001740E_HangingHearts.Solution_0_Test(input);
