...
{
    [TestClass]
    public sealed class CF_00001800D_RemoveTwoLetters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001800D_RemoveTwoLetters));
        ...
        {
            bool result = CF_00001800D_RemoveTwoLetters.Solution_0_Test(input);
