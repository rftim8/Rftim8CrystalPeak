...
{
    [TestClass]
    public sealed class CF_00000696C_PLEASE_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000696C_PLEASE));
        ...
        {
            bool result = CF_00000696C_PLEASE.Solution_0_Test(input);
