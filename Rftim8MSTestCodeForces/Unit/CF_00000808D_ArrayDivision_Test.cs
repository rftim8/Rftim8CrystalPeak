...
{
    [TestClass]
    public sealed class CF_00000808D_ArrayDivision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000808D_ArrayDivision));
        ...
        {
            bool result = CF_00000808D_ArrayDivision.Solution_0_Test(input);
