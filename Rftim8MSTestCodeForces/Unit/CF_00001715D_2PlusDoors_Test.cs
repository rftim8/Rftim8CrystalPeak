...
{
    [TestClass]
    public sealed class CF_00001715D_2PlusDoors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001715D_2PlusDoors));
        ...
        {
            bool result = CF_00001715D_2PlusDoors.Solution_0_Test(input);
