...
{
    [TestClass]
    public sealed class CF_00000198A_AboutBacteria_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000198A_AboutBacteria));
        ...
        {
            bool result = CF_00000198A_AboutBacteria.Solution_0_Test(input);
