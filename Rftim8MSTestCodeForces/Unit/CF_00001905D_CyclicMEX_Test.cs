...
{
    [TestClass]
    public sealed class CF_00001905D_CyclicMEX_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001905D_CyclicMEX));
        ...
        {
            bool result = CF_00001905D_CyclicMEX.Solution_0_Test(input);
