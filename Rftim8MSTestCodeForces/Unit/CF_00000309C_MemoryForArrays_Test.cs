...
{
    [TestClass]
    public sealed class CF_00000309C_MemoryForArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000309C_MemoryForArrays));
        ...
        {
            bool result = CF_00000309C_MemoryForArrays.Solution_0_Test(input);
