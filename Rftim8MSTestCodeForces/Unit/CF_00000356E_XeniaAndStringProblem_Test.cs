...
{
    [TestClass]
    public sealed class CF_00000356E_XeniaAndStringProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000356E_XeniaAndStringProblem));
        ...
        {
            bool result = CF_00000356E_XeniaAndStringProblem.Solution_0_Test(input);
