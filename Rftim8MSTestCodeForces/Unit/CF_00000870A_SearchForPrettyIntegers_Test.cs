...
{
    [TestClass]
    public sealed class CF_00000870A_SearchForPrettyIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000870A_SearchForPrettyIntegers));
        ...
        {
            bool result = CF_00000870A_SearchForPrettyIntegers.Solution_0_Test(input);
