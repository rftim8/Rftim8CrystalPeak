...
{
    [TestClass]
    public sealed class CF_00001572C_Paint_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001572C_Paint));
        ...
        {
            bool result = CF_00001572C_Paint.Solution_0_Test(input);
