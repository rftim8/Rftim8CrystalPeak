...
{
    [TestClass]
    public sealed class CF_00000135E_WeakSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000135E_WeakSubsequence));
        ...
        {
            bool result = CF_00000135E_WeakSubsequence.Solution_0_Test(input);
