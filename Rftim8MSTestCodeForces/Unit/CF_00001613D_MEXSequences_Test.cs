...
{
    [TestClass]
    public sealed class CF_00001613D_MEXSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001613D_MEXSequences));
        ...
        {
            bool result = CF_00001613D_MEXSequences.Solution_0_Test(input);
