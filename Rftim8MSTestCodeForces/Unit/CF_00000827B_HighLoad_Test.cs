...
{
    [TestClass]
    public sealed class CF_00000827B_HighLoad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000827B_HighLoad));
        ...
        {
            bool result = CF_00000827B_HighLoad.Solution_0_Test(input);
