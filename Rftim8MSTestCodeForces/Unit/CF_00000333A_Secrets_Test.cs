...
{
    [TestClass]
    public sealed class CF_00000333A_Secrets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000333A_Secrets));
        ...
        {
            bool result = CF_00000333A_Secrets.Solution_0_Test(input);
