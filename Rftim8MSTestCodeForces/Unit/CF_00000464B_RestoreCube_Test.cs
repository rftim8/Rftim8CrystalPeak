...
{
    [TestClass]
    public sealed class CF_00000464B_RestoreCube_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000464B_RestoreCube));
        ...
        {
            bool result = CF_00000464B_RestoreCube.Solution_0_Test(input);
