...
{
    [TestClass]
    public sealed class CF_00000129B_StudentsAndShoelaces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000129B_StudentsAndShoelaces));
        ...
        {
            bool result = CF_00000129B_StudentsAndShoelaces.Solution_0_Test(input);
