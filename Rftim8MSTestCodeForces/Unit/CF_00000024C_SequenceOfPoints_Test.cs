...
{
    [TestClass]
    public sealed class CF_00000024C_SequenceOfPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000024C_SequenceOfPoints));
        ...
        {
            bool result = CF_00000024C_SequenceOfPoints.Solution_0_Test(input);
