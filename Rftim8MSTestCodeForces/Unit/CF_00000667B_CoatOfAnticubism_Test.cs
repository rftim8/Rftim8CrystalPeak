...
{
    [TestClass]
    public sealed class CF_00000667B_CoatOfAnticubism_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000667B_CoatOfAnticubism));
        ...
        {
            bool result = CF_00000667B_CoatOfAnticubism.Solution_0_Test(input);
