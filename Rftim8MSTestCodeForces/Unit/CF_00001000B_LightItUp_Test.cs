...
{
    [TestClass]
    public sealed class CF_00001000B_LightItUp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001000B_LightItUp));
        ...
        {
            bool result = CF_00001000B_LightItUp.Solution_0_Test(input);
