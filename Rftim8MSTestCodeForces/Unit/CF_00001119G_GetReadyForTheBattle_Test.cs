...
{
    [TestClass]
    public sealed class CF_00001119G_GetReadyForTheBattle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001119G_GetReadyForTheBattle));
        ...
        {
            bool result = CF_00001119G_GetReadyForTheBattle.Solution_0_Test(input);
