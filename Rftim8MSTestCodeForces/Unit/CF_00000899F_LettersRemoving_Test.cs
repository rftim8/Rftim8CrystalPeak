...
{
    [TestClass]
    public sealed class CF_00000899F_LettersRemoving_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000899F_LettersRemoving));
        ...
        {
            bool result = CF_00000899F_LettersRemoving.Solution_0_Test(input);
