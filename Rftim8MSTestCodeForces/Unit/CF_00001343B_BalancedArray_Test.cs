...
{
    [TestClass]
    public sealed class CF_00001343B_BalancedArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001343B_BalancedArray));
        ...
        {
            bool result = CF_00001343B_BalancedArray.Solution_0_Test(input);
