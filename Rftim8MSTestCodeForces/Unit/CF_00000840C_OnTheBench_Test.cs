...
{
    [TestClass]
    public sealed class CF_00000840C_OnTheBench_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000840C_OnTheBench));
        ...
        {
            bool result = CF_00000840C_OnTheBench.Solution_0_Test(input);
