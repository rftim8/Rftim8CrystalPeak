...
{
    [TestClass]
    public sealed class CF_00000231B_MagicWizardryAndWonders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000231B_MagicWizardryAndWonders));
        ...
        {
            bool result = CF_00000231B_MagicWizardryAndWonders.Solution_0_Test(input);
