...
{
    [TestClass]
    public sealed class CF_00001667C_HalfQueenCover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001667C_HalfQueenCover));
        ...
        {
            bool result = CF_00001667C_HalfQueenCover.Solution_0_Test(input);
