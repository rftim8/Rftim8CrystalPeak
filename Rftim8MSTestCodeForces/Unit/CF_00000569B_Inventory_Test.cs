...
{
    [TestClass]
    public sealed class CF_00000569B_Inventory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000569B_Inventory));
        ...
        {
            bool result = CF_00000569B_Inventory.Solution_0_Test(input);
