...
{
    [TestClass]
    public sealed class CF_00000048C_TheRace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000048C_TheRace));
        ...
        {
            bool result = CF_00000048C_TheRace.Solution_0_Test(input);
