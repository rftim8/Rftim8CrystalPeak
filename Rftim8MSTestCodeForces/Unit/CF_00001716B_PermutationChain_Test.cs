...
{
    [TestClass]
    public sealed class CF_00001716B_PermutationChain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001716B_PermutationChain));
        ...
        {
            bool result = CF_00001716B_PermutationChain.Solution_0_Test(input);
