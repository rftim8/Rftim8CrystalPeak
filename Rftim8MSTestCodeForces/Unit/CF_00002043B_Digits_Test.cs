...
{
    [TestClass]
    public sealed class CF_00002043B_Digits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002043B_Digits));
        ...
        {
            bool result = CF_00002043B_Digits.Solution_0_Test(input);
