...
{
    [TestClass]
    public sealed class CF_00000840D_Destiny_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000840D_Destiny));
        ...
        {
            bool result = CF_00000840D_Destiny.Solution_0_Test(input);
