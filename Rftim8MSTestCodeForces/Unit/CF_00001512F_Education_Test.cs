...
{
    [TestClass]
    public sealed class CF_00001512F_Education_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001512F_Education));
        ...
        {
            bool result = CF_00001512F_Education.Solution_0_Test(input);
