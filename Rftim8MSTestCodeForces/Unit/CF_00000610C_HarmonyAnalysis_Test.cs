...
{
    [TestClass]
    public sealed class CF_00000610C_HarmonyAnalysis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000610C_HarmonyAnalysis));
        ...
        {
            bool result = CF_00000610C_HarmonyAnalysis.Solution_0_Test(input);
