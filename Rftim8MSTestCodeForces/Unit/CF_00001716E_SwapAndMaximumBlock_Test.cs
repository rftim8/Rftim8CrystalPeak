...
{
    [TestClass]
    public sealed class CF_00001716E_SwapAndMaximumBlock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001716E_SwapAndMaximumBlock));
        ...
        {
            bool result = CF_00001716E_SwapAndMaximumBlock.Solution_0_Test(input);
