...
{
    [TestClass]
    public sealed class CF_00001230B_AniaAndMinimizing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001230B_AniaAndMinimizing));
        ...
        {
            bool result = CF_00001230B_AniaAndMinimizing.Solution_0_Test(input);
