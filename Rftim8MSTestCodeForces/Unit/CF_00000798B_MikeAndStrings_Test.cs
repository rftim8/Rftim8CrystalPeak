...
{
    [TestClass]
    public sealed class CF_00000798B_MikeAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000798B_MikeAndStrings));
        ...
        {
            bool result = CF_00000798B_MikeAndStrings.Solution_0_Test(input);
