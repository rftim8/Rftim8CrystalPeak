...
{
    [TestClass]
    public sealed class CF_00000689B_MikeAndShortcuts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000689B_MikeAndShortcuts));
        ...
        {
            bool result = CF_00000689B_MikeAndShortcuts.Solution_0_Test(input);
