...
{
    [TestClass]
    public sealed class CF_00000345E_BlackCatRush_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000345E_BlackCatRush));
        ...
        {
            bool result = CF_00000345E_BlackCatRush.Solution_0_Test(input);
