...
{
    [TestClass]
    public sealed class CF_00001764D_DoremysPeggingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001764D_DoremysPeggingGame));
        ...
        {
            bool result = CF_00001764D_DoremysPeggingGame.Solution_0_Test(input);
