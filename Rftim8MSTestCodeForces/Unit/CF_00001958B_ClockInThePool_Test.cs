...
{
    [TestClass]
    public sealed class CF_00001958B_ClockInThePool_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001958B_ClockInThePool));
        ...
        {
            bool result = CF_00001958B_ClockInThePool.Solution_0_Test(input);
