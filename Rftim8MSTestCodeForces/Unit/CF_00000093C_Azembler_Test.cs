...
{
    [TestClass]
    public sealed class CF_00000093C_Azembler_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000093C_Azembler));
        ...
        {
            bool result = CF_00000093C_Azembler.Solution_0_Test(input);
