...
{
    [TestClass]
    public sealed class CF_00001196A_ThreePilesOfCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001196A_ThreePilesOfCandies));
        ...
        {
            bool result = CF_00001196A_ThreePilesOfCandies.Solution_0_Test(input);
