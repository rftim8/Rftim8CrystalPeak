...
{
    [TestClass]
    public sealed class CF_00001617A_ForbiddenSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001617A_ForbiddenSubsequence));
        ...
        {
            bool result = CF_00001617A_ForbiddenSubsequence.Solution_0_Test(input);
