...
{
    [TestClass]
    public sealed class CF_00001572F_Stations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001572F_Stations));
        ...
        {
            bool result = CF_00001572F_Stations.Solution_0_Test(input);
