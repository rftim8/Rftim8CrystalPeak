...
{
    [TestClass]
    public sealed class CF_00001490E_AccidentalVictory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001490E_AccidentalVictory));
        ...
        {
            bool result = CF_00001490E_AccidentalVictory.Solution_0_Test(input);
