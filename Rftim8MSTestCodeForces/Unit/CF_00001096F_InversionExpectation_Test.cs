...
{
    [TestClass]
    public sealed class CF_00001096F_InversionExpectation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001096F_InversionExpectation));
        ...
        {
            bool result = CF_00001096F_InversionExpectation.Solution_0_Test(input);
