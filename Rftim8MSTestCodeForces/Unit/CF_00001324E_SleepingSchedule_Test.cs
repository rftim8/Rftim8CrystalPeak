...
{
    [TestClass]
    public sealed class CF_00001324E_SleepingSchedule_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001324E_SleepingSchedule));
        ...
        {
            bool result = CF_00001324E_SleepingSchedule.Solution_0_Test(input);
