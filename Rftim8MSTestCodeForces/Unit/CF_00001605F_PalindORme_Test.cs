...
{
    [TestClass]
    public sealed class CF_00001605F_PalindORme_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001605F_PalindORme));
        ...
        {
            bool result = CF_00001605F_PalindORme.Solution_0_Test(input);
