...
{
    [TestClass]
    public sealed class CF_00001831B_ArrayMerging_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001831B_ArrayMerging));
        ...
        {
            bool result = CF_00001831B_ArrayMerging.Solution_0_Test(input);
