...
{
    [TestClass]
    public sealed class CF_00001672F1_ArrayShuffling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001672F1_ArrayShuffling));
        ...
        {
            bool result = CF_00001672F1_ArrayShuffling.Solution_0_Test(input);
