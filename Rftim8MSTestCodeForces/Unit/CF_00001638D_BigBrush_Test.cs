...
{
    [TestClass]
    public sealed class CF_00001638D_BigBrush_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001638D_BigBrush));
        ...
        {
            bool result = CF_00001638D_BigBrush.Solution_0_Test(input);
