...
{
    [TestClass]
    public sealed class CF_00000417D_CunningGena_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000417D_CunningGena));
        ...
        {
            bool result = CF_00000417D_CunningGena.Solution_0_Test(input);
