...
{
    [TestClass]
    public sealed class CF_00000064I_SortTheTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000064I_SortTheTable));
        ...
        {
            bool result = CF_00000064I_SortTheTable.Solution_0_Test(input);
