...
{
    [TestClass]
    public sealed class CF_00001676A_Lucky_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001676A_Lucky));
        ...
        {
            bool result = CF_00001676A_Lucky.Solution_0_Test(input);
