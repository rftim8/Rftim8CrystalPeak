...
{
    [TestClass]
    public sealed class CF_00001505H_LBREAKIntoProgram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001505H_LBREAKIntoProgram));
        ...
        {
            bool result = CF_00001505H_LBREAKIntoProgram.Solution_0_Test(input);
