...
{
    [TestClass]
    public sealed class CF_00000985B_SwitchesAndLamps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000985B_SwitchesAndLamps));
        ...
        {
            bool result = CF_00000985B_SwitchesAndLamps.Solution_0_Test(input);
