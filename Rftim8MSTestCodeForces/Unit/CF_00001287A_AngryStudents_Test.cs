...
{
    [TestClass]
    public sealed class CF_00001287A_AngryStudents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001287A_AngryStudents));
        ...
        {
            bool result = CF_00001287A_AngryStudents.Solution_0_Test(input);
