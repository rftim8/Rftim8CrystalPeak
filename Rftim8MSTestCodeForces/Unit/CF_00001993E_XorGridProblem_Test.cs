...
{
    [TestClass]
    public sealed class CF_00001993E_XorGridProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001993E_XorGridProblem));
        ...
        {
            bool result = CF_00001993E_XorGridProblem.Solution_0_Test(input);
