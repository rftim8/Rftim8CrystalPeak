...
{
    [TestClass]
    public sealed class CF_00001114C_TrailingLovesOrLoeufs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001114C_TrailingLovesOrLoeufs));
        ...
        {
            bool result = CF_00001114C_TrailingLovesOrLoeufs.Solution_0_Test(input);
