...
{
    [TestClass]
    public sealed class CF_00001056B_DivideCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001056B_DivideCandies));
        ...
        {
            bool result = CF_00001056B_DivideCandies.Solution_0_Test(input);
