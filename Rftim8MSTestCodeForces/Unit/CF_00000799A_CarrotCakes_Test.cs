...
{
    [TestClass]
    public sealed class CF_00000799A_CarrotCakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000799A_CarrotCakes));
        ...
        {
            bool result = CF_00000799A_CarrotCakes.Solution_0_Test(input);
