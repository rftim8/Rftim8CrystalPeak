...
{
    [TestClass]
    public sealed class CF_00000519C_AAndBAndTeamTraining_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000519C_AAndBAndTeamTraining));
        ...
        {
            bool result = CF_00000519C_AAndBAndTeamTraining.Solution_0_Test(input);
