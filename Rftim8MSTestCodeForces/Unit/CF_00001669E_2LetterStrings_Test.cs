...
{
    [TestClass]
    public sealed class CF_00001669E_2LetterStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001669E_2LetterStrings));
        ...
        {
            bool result = CF_00001669E_2LetterStrings.Solution_0_Test(input);
