...
{
    [TestClass]
    public sealed class CF_00000296A_YaroslavAndPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000296A_YaroslavAndPermutations));
        ...
        {
            bool result = CF_00000296A_YaroslavAndPermutations.Solution_0_Test(input);
