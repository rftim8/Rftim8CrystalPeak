...
{
    [TestClass]
    public sealed class CF_00001915E_RomanticGlasses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001915E_RomanticGlasses));
        ...
        {
            bool result = CF_00001915E_RomanticGlasses.Solution_0_Test(input);
