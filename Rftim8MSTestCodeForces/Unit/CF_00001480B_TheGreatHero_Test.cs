...
{
    [TestClass]
    public sealed class CF_00001480B_TheGreatHero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001480B_TheGreatHero));
        ...
        {
            bool result = CF_00001480B_TheGreatHero.Solution_0_Test(input);
