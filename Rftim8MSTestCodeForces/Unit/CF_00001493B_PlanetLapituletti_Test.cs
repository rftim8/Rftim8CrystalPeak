...
{
    [TestClass]
    public sealed class CF_00001493B_PlanetLapituletti_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001493B_PlanetLapituletti));
        ...
        {
            bool result = CF_00001493B_PlanetLapituletti.Solution_0_Test(input);
