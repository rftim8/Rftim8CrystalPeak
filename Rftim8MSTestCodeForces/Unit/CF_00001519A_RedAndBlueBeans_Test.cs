...
{
    [TestClass]
    public sealed class CF_00001519A_RedAndBlueBeans_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001519A_RedAndBlueBeans));
        ...
        {
            bool result = CF_00001519A_RedAndBlueBeans.Solution_0_Test(input);
