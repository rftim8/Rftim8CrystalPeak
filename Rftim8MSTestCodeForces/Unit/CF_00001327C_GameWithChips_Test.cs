...
{
    [TestClass]
    public sealed class CF_00001327C_GameWithChips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001327C_GameWithChips));
        ...
        {
            bool result = CF_00001327C_GameWithChips.Solution_0_Test(input);
