...
{
    [TestClass]
    public sealed class CF_00001904B_CollectingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001904B_CollectingGame));
        ...
        {
            bool result = CF_00001904B_CollectingGame.Solution_0_Test(input);
