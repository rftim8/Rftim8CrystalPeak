...
{
    [TestClass]
    public sealed class CF_00001183H_SubsequencesHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001183H_SubsequencesHardVersion));
        ...
        {
            bool result = CF_00001183H_SubsequencesHardVersion.Solution_0_Test(input);
