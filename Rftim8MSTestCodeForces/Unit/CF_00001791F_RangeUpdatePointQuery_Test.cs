...
{
    [TestClass]
    public sealed class CF_00001791F_RangeUpdatePointQuery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001791F_RangeUpdatePointQuery));
        ...
        {
            bool result = CF_00001791F_RangeUpdatePointQuery.Solution_0_Test(input);
