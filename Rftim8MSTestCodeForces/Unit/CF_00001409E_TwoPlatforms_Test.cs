...
{
    [TestClass]
    public sealed class CF_00001409E_TwoPlatforms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001409E_TwoPlatforms));
        ...
        {
            bool result = CF_00001409E_TwoPlatforms.Solution_0_Test(input);
