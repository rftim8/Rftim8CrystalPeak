...
{
    [TestClass]
    public sealed class CF_00001616C_RepresentativeEdges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001616C_RepresentativeEdges));
        ...
        {
            bool result = CF_00001616C_RepresentativeEdges.Solution_0_Test(input);
