...
{
    [TestClass]
    public sealed class CF_00000909F_ANDpermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000909F_ANDpermutations));
        ...
        {
            bool result = CF_00000909F_ANDpermutations.Solution_0_Test(input);
