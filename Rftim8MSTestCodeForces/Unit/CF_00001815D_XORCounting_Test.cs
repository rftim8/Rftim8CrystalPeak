...
{
    [TestClass]
    public sealed class CF_00001815D_XORCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001815D_XORCounting));
        ...
        {
            bool result = CF_00001815D_XORCounting.Solution_0_Test(input);
