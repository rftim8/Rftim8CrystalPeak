...
{
    [TestClass]
    public sealed class CF_00000509B_PaintingPebbles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000509B_PaintingPebbles));
        ...
        {
            bool result = CF_00000509B_PaintingPebbles.Solution_0_Test(input);
