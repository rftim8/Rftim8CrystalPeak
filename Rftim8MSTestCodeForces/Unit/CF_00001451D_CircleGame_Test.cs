...
{
    [TestClass]
    public sealed class CF_00001451D_CircleGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001451D_CircleGame));
        ...
        {
            bool result = CF_00001451D_CircleGame.Solution_0_Test(input);
