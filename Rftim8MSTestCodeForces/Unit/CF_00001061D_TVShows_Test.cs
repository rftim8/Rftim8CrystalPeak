...
{
    [TestClass]
    public sealed class CF_00001061D_TVShows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001061D_TVShows));
        ...
        {
            bool result = CF_00001061D_TVShows.Solution_0_Test(input);
