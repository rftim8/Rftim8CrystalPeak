...
{
    [TestClass]
    public sealed class CF_00000435A_QueueOnBusStop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000435A_QueueOnBusStop));
        ...
        {
            bool result = CF_00000435A_QueueOnBusStop.Solution_0_Test(input);
