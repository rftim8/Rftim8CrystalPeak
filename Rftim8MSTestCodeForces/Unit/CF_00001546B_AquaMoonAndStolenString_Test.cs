...
{
    [TestClass]
    public sealed class CF_00001546B_AquaMoonAndStolenString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001546B_AquaMoonAndStolenString));
        ...
        {
            bool result = CF_00001546B_AquaMoonAndStolenString.Solution_0_Test(input);
