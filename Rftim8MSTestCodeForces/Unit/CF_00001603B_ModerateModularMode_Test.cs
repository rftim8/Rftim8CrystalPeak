...
{
    [TestClass]
    public sealed class CF_00001603B_ModerateModularMode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001603B_ModerateModularMode));
        ...
        {
            bool result = CF_00001603B_ModerateModularMode.Solution_0_Test(input);
