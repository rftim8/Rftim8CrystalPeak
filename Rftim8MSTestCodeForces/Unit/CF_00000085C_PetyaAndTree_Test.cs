...
{
    [TestClass]
    public sealed class CF_00000085C_PetyaAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000085C_PetyaAndTree));
        ...
        {
            bool result = CF_00000085C_PetyaAndTree.Solution_0_Test(input);
