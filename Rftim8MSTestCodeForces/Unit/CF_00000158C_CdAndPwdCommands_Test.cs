...
{
    [TestClass]
    public sealed class CF_00000158C_CdAndPwdCommands_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000158C_CdAndPwdCommands));
        ...
        {
            bool result = CF_00000158C_CdAndPwdCommands.Solution_0_Test(input);
