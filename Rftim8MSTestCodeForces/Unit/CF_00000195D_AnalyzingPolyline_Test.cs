...
{
    [TestClass]
    public sealed class CF_00000195D_AnalyzingPolyline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000195D_AnalyzingPolyline));
        ...
        {
            bool result = CF_00000195D_AnalyzingPolyline.Solution_0_Test(input);
