...
{
    [TestClass]
    public sealed class CF_00000354A_VasyaAndRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000354A_VasyaAndRobot));
        ...
        {
            bool result = CF_00000354A_VasyaAndRobot.Solution_0_Test(input);
