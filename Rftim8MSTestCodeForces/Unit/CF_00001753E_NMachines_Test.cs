...
{
    [TestClass]
    public sealed class CF_00001753E_NMachines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001753E_NMachines));
        ...
        {
            bool result = CF_00001753E_NMachines.Solution_0_Test(input);
