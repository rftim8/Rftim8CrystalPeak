...
{
    [TestClass]
    public sealed class CF_00000294D_ShaassAndPainterRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000294D_ShaassAndPainterRobot));
        ...
        {
            bool result = CF_00000294D_ShaassAndPainterRobot.Solution_0_Test(input);
