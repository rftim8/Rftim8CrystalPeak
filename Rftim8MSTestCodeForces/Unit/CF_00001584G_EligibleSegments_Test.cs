...
{
    [TestClass]
    public sealed class CF_00001584G_EligibleSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001584G_EligibleSegments));
        ...
        {
            bool result = CF_00001584G_EligibleSegments.Solution_0_Test(input);
