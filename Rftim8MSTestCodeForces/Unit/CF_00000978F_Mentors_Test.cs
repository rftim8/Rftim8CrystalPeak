...
{
    [TestClass]
    public sealed class CF_00000978F_Mentors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000978F_Mentors));
        ...
        {
            bool result = CF_00000978F_Mentors.Solution_0_Test(input);
