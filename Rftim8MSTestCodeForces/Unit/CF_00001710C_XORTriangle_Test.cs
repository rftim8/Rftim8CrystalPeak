...
{
    [TestClass]
    public sealed class CF_00001710C_XORTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001710C_XORTriangle));
        ...
        {
            bool result = CF_00001710C_XORTriangle.Solution_0_Test(input);
