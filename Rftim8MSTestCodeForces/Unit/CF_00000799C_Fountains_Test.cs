...
{
    [TestClass]
    public sealed class CF_00000799C_Fountains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000799C_Fountains));
        ...
        {
            bool result = CF_00000799C_Fountains.Solution_0_Test(input);
