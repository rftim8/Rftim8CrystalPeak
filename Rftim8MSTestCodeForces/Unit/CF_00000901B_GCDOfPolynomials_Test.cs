...
{
    [TestClass]
    public sealed class CF_00000901B_GCDOfPolynomials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000901B_GCDOfPolynomials));
        ...
        {
            bool result = CF_00000901B_GCDOfPolynomials.Solution_0_Test(input);
