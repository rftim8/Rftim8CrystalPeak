...
{
    [TestClass]
    public sealed class CF_00001252K_AdditionRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001252K_AdditionRobot));
        ...
        {
            bool result = CF_00001252K_AdditionRobot.Solution_0_Test(input);
