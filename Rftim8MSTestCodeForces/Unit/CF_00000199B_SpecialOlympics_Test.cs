...
{
    [TestClass]
    public sealed class CF_00000199B_SpecialOlympics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000199B_SpecialOlympics));
        ...
        {
            bool result = CF_00000199B_SpecialOlympics.Solution_0_Test(input);
