...
{
    [TestClass]
    public sealed class CF_00001939D_BigPersimmon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001939D_BigPersimmon));
        ...
        {
            bool result = CF_00001939D_BigPersimmon.Solution_0_Test(input);
