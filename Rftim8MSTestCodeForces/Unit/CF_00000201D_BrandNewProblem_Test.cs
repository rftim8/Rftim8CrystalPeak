...
{
    [TestClass]
    public sealed class CF_00000201D_BrandNewProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000201D_BrandNewProblem));
        ...
        {
            bool result = CF_00000201D_BrandNewProblem.Solution_0_Test(input);
