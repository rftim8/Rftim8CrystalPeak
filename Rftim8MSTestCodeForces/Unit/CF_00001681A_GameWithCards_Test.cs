...
{
    [TestClass]
    public sealed class CF_00001681A_GameWithCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001681A_GameWithCards));
        ...
        {
            bool result = CF_00001681A_GameWithCards.Solution_0_Test(input);
