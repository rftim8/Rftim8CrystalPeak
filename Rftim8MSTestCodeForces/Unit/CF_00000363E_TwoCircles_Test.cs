...
{
    [TestClass]
    public sealed class CF_00000363E_TwoCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000363E_TwoCircles));
        ...
        {
            bool result = CF_00000363E_TwoCircles.Solution_0_Test(input);
