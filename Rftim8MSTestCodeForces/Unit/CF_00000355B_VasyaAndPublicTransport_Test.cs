...
{
    [TestClass]
    public sealed class CF_00000355B_VasyaAndPublicTransport_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000355B_VasyaAndPublicTransport));
        ...
        {
            bool result = CF_00000355B_VasyaAndPublicTransport.Solution_0_Test(input);
