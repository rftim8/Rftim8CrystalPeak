...
{
    [TestClass]
    public sealed class CF_00000077A_Heroes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000077A_Heroes));
        ...
        {
            bool result = CF_00000077A_Heroes.Solution_0_Test(input);
