...
{
    [TestClass]
    public sealed class CF_00000870F_Paths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000870F_Paths));
        ...
        {
            bool result = CF_00000870F_Paths.Solution_0_Test(input);
