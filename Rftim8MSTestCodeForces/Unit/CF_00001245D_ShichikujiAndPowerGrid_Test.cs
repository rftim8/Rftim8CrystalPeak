...
{
    [TestClass]
    public sealed class CF_00001245D_ShichikujiAndPowerGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001245D_ShichikujiAndPowerGrid));
        ...
        {
            bool result = CF_00001245D_ShichikujiAndPowerGrid.Solution_0_Test(input);
