...
{
    [TestClass]
    public sealed class CF_00001075B_TaxiDriversAndLyft_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001075B_TaxiDriversAndLyft));
        ...
        {
            bool result = CF_00001075B_TaxiDriversAndLyft.Solution_0_Test(input);
