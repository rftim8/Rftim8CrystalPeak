...
{
    [TestClass]
    public sealed class CF_00001651F_TowerDefense_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001651F_TowerDefense));
        ...
        {
            bool result = CF_00001651F_TowerDefense.Solution_0_Test(input);
