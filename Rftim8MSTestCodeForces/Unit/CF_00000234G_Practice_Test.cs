...
{
    [TestClass]
    public sealed class CF_00000234G_Practice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000234G_Practice));
        ...
        {
            bool result = CF_00000234G_Practice.Solution_0_Test(input);
