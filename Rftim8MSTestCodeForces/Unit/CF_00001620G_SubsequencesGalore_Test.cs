...
{
    [TestClass]
    public sealed class CF_00001620G_SubsequencesGalore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001620G_SubsequencesGalore));
        ...
        {
            bool result = CF_00001620G_SubsequencesGalore.Solution_0_Test(input);
