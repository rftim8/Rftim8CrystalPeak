...
{
    [TestClass]
    public sealed class CF_00000029E_Quarrel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000029E_Quarrel));
        ...
        {
            bool result = CF_00000029E_Quarrel.Solution_0_Test(input);
