...
{
    [TestClass]
    public sealed class CF_00000917B_MADMAX_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000917B_MADMAX));
        ...
        {
            bool result = CF_00000917B_MADMAX.Solution_0_Test(input);
