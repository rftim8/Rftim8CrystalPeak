...
{
    [TestClass]
    public sealed class CF_00000244B_UndoubtedlyLuckyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000244B_UndoubtedlyLuckyNumbers));
        ...
        {
            bool result = CF_00000244B_UndoubtedlyLuckyNumbers.Solution_0_Test(input);
