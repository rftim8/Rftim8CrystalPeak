...
{
    [TestClass]
    public sealed class CF_00000144E_Competition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000144E_Competition));
        ...
        {
            bool result = CF_00000144E_Competition.Solution_0_Test(input);
