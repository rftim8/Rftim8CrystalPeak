...
{
    [TestClass]
    public sealed class CF_00000416A_GuessANumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000416A_GuessANumber));
        ...
        {
            bool result = CF_00000416A_GuessANumber.Solution_0_Test(input);
