...
{
    [TestClass]
    public sealed class CF_00001263E_Editor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001263E_Editor));
        ...
        {
            bool result = CF_00001263E_Editor.Solution_0_Test(input);
