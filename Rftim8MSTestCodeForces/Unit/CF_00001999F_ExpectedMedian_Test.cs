...
{
    [TestClass]
    public sealed class CF_00001999F_ExpectedMedian_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001999F_ExpectedMedian));
        ...
        {
            bool result = CF_00001999F_ExpectedMedian.Solution_0_Test(input);
