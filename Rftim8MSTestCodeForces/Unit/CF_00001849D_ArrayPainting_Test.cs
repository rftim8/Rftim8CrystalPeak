...
{
    [TestClass]
    public sealed class CF_00001849D_ArrayPainting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001849D_ArrayPainting));
        ...
        {
            bool result = CF_00001849D_ArrayPainting.Solution_0_Test(input);
