...
{
    [TestClass]
    public sealed class CF_00001989A_CatchTheCoin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001989A_CatchTheCoin));
        ...
        {
            bool result = CF_00001989A_CatchTheCoin.Solution_0_Test(input);
