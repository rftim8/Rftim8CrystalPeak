...
{
    [TestClass]
    public sealed class CF_00000808A_LuckyYear_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000808A_LuckyYear));
        ...
        {
            bool result = CF_00000808A_LuckyYear.Solution_0_Test(input);
