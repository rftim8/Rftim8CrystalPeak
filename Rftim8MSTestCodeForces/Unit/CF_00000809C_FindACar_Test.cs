...
{
    [TestClass]
    public sealed class CF_00000809C_FindACar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000809C_FindACar));
        ...
        {
            bool result = CF_00000809C_FindACar.Solution_0_Test(input);
