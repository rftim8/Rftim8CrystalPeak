...
{
    [TestClass]
    public sealed class CF_00000301C_YaroslavAndAlgorithm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000301C_YaroslavAndAlgorithm));
        ...
        {
            bool result = CF_00000301C_YaroslavAndAlgorithm.Solution_0_Test(input);
