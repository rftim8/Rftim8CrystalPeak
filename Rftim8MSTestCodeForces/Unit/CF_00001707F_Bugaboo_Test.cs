...
{
    [TestClass]
    public sealed class CF_00001707F_Bugaboo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001707F_Bugaboo));
        ...
        {
            bool result = CF_00001707F_Bugaboo.Solution_0_Test(input);
