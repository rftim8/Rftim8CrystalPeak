...
{
    [TestClass]
    public sealed class CF_00001028C_Rectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001028C_Rectangles));
        ...
        {
            bool result = CF_00001028C_Rectangles.Solution_0_Test(input);
