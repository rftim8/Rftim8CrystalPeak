...
{
    [TestClass]
    public sealed class CF_00000852G_BathroomTerm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000852G_BathroomTerm));
        ...
        {
            bool result = CF_00000852G_BathroomTerm.Solution_0_Test(input);
