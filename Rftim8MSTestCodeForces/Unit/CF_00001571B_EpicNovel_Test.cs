...
{
    [TestClass]
    public sealed class CF_00001571B_EpicNovel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001571B_EpicNovel));
        ...
        {
            bool result = CF_00001571B_EpicNovel.Solution_0_Test(input);
