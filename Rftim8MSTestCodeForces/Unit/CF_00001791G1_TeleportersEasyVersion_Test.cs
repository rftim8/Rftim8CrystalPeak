...
{
    [TestClass]
    public sealed class CF_00001791G1_TeleportersEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001791G1_TeleportersEasyVersion));
        ...
        {
            bool result = CF_00001791G1_TeleportersEasyVersion.Solution_0_Test(input);
