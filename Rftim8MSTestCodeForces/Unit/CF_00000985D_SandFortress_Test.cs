...
{
    [TestClass]
    public sealed class CF_00000985D_SandFortress_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000985D_SandFortress));
        ...
        {
            bool result = CF_00000985D_SandFortress.Solution_0_Test(input);
