...
{
    [TestClass]
    public sealed class CF_00002042B_GameWithColoredMarbles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002042B_GameWithColoredMarbles));
        ...
        {
            bool result = CF_00002042B_GameWithColoredMarbles.Solution_0_Test(input);
