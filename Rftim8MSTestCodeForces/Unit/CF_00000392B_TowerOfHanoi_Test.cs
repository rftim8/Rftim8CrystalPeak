...
{
    [TestClass]
    public sealed class CF_00000392B_TowerOfHanoi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000392B_TowerOfHanoi));
        ...
        {
            bool result = CF_00000392B_TowerOfHanoi.Solution_0_Test(input);
