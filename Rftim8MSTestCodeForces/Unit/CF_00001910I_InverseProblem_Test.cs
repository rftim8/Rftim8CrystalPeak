...
{
    [TestClass]
    public sealed class CF_00001910I_InverseProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001910I_InverseProblem));
        ...
        {
            bool result = CF_00001910I_InverseProblem.Solution_0_Test(input);
