...
{
    [TestClass]
    public sealed class CF_00001928B_Equalize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001928B_Equalize));
        ...
        {
            bool result = CF_00001928B_Equalize.Solution_0_Test(input);
