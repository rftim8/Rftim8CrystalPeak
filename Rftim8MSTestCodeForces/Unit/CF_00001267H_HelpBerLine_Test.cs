...
{
    [TestClass]
    public sealed class CF_00001267H_HelpBerLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001267H_HelpBerLine));
        ...
        {
            bool result = CF_00001267H_HelpBerLine.Solution_0_Test(input);
