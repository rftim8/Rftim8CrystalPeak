...
{
    [TestClass]
    public sealed class CF_00000729B_Spotlights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000729B_Spotlights));
        ...
        {
            bool result = CF_00000729B_Spotlights.Solution_0_Test(input);
