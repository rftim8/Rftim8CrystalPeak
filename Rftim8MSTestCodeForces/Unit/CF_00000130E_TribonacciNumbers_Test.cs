...
{
    [TestClass]
    public sealed class CF_00000130E_TribonacciNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000130E_TribonacciNumbers));
        ...
        {
            bool result = CF_00000130E_TribonacciNumbers.Solution_0_Test(input);
