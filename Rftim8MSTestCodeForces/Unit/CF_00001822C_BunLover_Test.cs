...
{
    [TestClass]
    public sealed class CF_00001822C_BunLover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001822C_BunLover));
        ...
        {
            bool result = CF_00001822C_BunLover.Solution_0_Test(input);
