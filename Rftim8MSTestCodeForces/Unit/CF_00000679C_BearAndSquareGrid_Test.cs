...
{
    [TestClass]
    public sealed class CF_00000679C_BearAndSquareGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000679C_BearAndSquareGrid));
        ...
        {
            bool result = CF_00000679C_BearAndSquareGrid.Solution_0_Test(input);
