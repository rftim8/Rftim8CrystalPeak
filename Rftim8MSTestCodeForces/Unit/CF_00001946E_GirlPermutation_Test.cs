...
{
    [TestClass]
    public sealed class CF_00001946E_GirlPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001946E_GirlPermutation));
        ...
        {
            bool result = CF_00001946E_GirlPermutation.Solution_0_Test(input);
