...
{
    [TestClass]
    public sealed class CF_00001875D_JellyfishAndMex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001875D_JellyfishAndMex));
        ...
        {
            bool result = CF_00001875D_JellyfishAndMex.Solution_0_Test(input);
