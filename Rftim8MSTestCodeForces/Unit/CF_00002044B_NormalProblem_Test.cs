...
{
    [TestClass]
    public sealed class CF_00002044B_NormalProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002044B_NormalProblem));
        ...
        {
            bool result = CF_00002044B_NormalProblem.Solution_0_Test(input);
