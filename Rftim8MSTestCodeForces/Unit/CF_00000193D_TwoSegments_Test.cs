...
{
    [TestClass]
    public sealed class CF_00000193D_TwoSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000193D_TwoSegments));
        ...
        {
            bool result = CF_00000193D_TwoSegments.Solution_0_Test(input);
