...
{
    [TestClass]
    public sealed class CF_00001613B_AbsentRemainder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001613B_AbsentRemainder));
        ...
        {
            bool result = CF_00001613B_AbsentRemainder.Solution_0_Test(input);
