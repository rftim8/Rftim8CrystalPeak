...
{
    [TestClass]
    public sealed class CF_00001267L_Lexicography_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001267L_Lexicography));
        ...
        {
            bool result = CF_00001267L_Lexicography.Solution_0_Test(input);
