...
{
    [TestClass]
    public sealed class CF_00001284A_NewYearAndNaming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001284A_NewYearAndNaming));
        ...
        {
            bool result = CF_00001284A_NewYearAndNaming.Solution_0_Test(input);
