...
{
    [TestClass]
    public sealed class CF_00000514B_HanSoloAndLazerGun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000514B_HanSoloAndLazerGun));
        ...
        {
            bool result = CF_00000514B_HanSoloAndLazerGun.Solution_0_Test(input);
