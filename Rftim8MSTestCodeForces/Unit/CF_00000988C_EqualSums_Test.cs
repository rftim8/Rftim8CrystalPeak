...
{
    [TestClass]
    public sealed class CF_00000988C_EqualSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000988C_EqualSums));
        ...
        {
            bool result = CF_00000988C_EqualSums.Solution_0_Test(input);
