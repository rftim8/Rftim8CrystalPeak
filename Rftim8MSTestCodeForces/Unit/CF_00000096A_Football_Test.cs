...
{
    [TestClass]
    public sealed class CF_00000096A_Football_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000096A_Football));
        ...
        {
            bool result = CF_00000096A_Football.Solution_0_Test(input);
