...
{
    [TestClass]
    public sealed class CF_00000086D_PowerfulArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000086D_PowerfulArray));
        ...
        {
            bool result = CF_00000086D_PowerfulArray.Solution_0_Test(input);
