...
{
    [TestClass]
    public sealed class CF_00001425B_BlueAndRedOfOurFaculty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001425B_BlueAndRedOfOurFaculty));
        ...
        {
            bool result = CF_00001425B_BlueAndRedOfOurFaculty.Solution_0_Test(input);
