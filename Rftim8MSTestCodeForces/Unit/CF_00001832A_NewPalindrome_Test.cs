...
{
    [TestClass]
    public sealed class CF_00001832A_NewPalindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001832A_NewPalindrome));
        ...
        {
            bool result = CF_00001832A_NewPalindrome.Solution_0_Test(input);
