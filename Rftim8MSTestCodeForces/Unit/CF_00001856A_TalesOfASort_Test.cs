...
{
    [TestClass]
    public sealed class CF_00001856A_TalesOfASort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001856A_TalesOfASort));
        ...
        {
            bool result = CF_00001856A_TalesOfASort.Solution_0_Test(input);
