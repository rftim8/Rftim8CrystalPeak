...
{
    [TestClass]
    public sealed class CF_00001271D_Portals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001271D_Portals));
        ...
        {
            bool result = CF_00001271D_Portals.Solution_0_Test(input);
