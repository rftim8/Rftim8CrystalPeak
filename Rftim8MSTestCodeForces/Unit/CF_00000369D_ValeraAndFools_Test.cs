...
{
    [TestClass]
    public sealed class CF_00000369D_ValeraAndFools_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000369D_ValeraAndFools));
        ...
        {
            bool result = CF_00000369D_ValeraAndFools.Solution_0_Test(input);
