...
{
    [TestClass]
    public sealed class CF_00001611F_ATMAndStudents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001611F_ATMAndStudents));
        ...
        {
            bool result = CF_00001611F_ATMAndStudents.Solution_0_Test(input);
