...
{
    [TestClass]
    public sealed class CF_00000601E_AMuseumRobbery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000601E_AMuseumRobbery));
        ...
        {
            bool result = CF_00000601E_AMuseumRobbery.Solution_0_Test(input);
