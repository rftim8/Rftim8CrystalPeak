...
{
    [TestClass]
    public sealed class CF_00001138B_Circus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001138B_Circus));
        ...
        {
            bool result = CF_00001138B_Circus.Solution_0_Test(input);
