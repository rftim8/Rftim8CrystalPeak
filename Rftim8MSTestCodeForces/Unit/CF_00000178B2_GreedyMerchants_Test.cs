...
{
    [TestClass]
    public sealed class CF_00000178B2_GreedyMerchants_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000178B2_GreedyMerchants));
        ...
        {
            bool result = CF_00000178B2_GreedyMerchants.Solution_0_Test(input);
