...
{
    [TestClass]
    public sealed class CF_00001949E_DamagePerSecond_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001949E_DamagePerSecond));
        ...
        {
            bool result = CF_00001949E_DamagePerSecond.Solution_0_Test(input);
