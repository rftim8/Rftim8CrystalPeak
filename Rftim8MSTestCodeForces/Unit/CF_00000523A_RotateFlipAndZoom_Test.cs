...
{
    [TestClass]
    public sealed class CF_00000523A_RotateFlipAndZoom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000523A_RotateFlipAndZoom));
        ...
        {
            bool result = CF_00000523A_RotateFlipAndZoom.Solution_0_Test(input);
