...
{
    [TestClass]
    public sealed class CF_00001769D2_GameOfNineII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001769D2_GameOfNineII));
        ...
        {
            bool result = CF_00001769D2_GameOfNineII.Solution_0_Test(input);
