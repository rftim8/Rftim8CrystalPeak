...
{
    [TestClass]
    public sealed class CF_00001930A_MaximiseTheScore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001930A_MaximiseTheScore));
        ...
        {
            bool result = CF_00001930A_MaximiseTheScore.Solution_0_Test(input);
