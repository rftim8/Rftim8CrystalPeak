...
{
    [TestClass]
    public sealed class CF_00001486A_ShiftingStacks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001486A_ShiftingStacks));
        ...
        {
            bool result = CF_00001486A_ShiftingStacks.Solution_0_Test(input);
