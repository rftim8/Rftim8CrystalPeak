...
{
    [TestClass]
    public sealed class CF_00001519F_ChestsAndKeys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001519F_ChestsAndKeys));
        ...
        {
            bool result = CF_00001519F_ChestsAndKeys.Solution_0_Test(input);
