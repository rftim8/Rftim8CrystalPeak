...
{
    [TestClass]
    public sealed class CF_00000336B_VasilyTheBearAndFly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000336B_VasilyTheBearAndFly));
        ...
        {
            bool result = CF_00000336B_VasilyTheBearAndFly.Solution_0_Test(input);
