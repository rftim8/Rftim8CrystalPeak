...
{
    [TestClass]
    public sealed class CF_00000494B_ObsessiveString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000494B_ObsessiveString));
        ...
        {
            bool result = CF_00000494B_ObsessiveString.Solution_0_Test(input);
