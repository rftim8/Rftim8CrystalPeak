...
{
    [TestClass]
    public sealed class CF_00001689D_LenaAndMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001689D_LenaAndMatrix));
        ...
        {
            bool result = CF_00001689D_LenaAndMatrix.Solution_0_Test(input);
