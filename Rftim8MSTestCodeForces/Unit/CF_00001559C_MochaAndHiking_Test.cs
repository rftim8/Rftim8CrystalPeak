...
{
    [TestClass]
    public sealed class CF_00001559C_MochaAndHiking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001559C_MochaAndHiking));
        ...
        {
            bool result = CF_00001559C_MochaAndHiking.Solution_0_Test(input);
