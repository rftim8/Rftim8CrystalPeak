...
{
    [TestClass]
    public sealed class CF_00000196E_OpeningPortals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000196E_OpeningPortals));
        ...
        {
            bool result = CF_00000196E_OpeningPortals.Solution_0_Test(input);
