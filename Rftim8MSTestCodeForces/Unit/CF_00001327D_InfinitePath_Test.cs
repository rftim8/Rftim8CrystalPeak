...
{
    [TestClass]
    public sealed class CF_00001327D_InfinitePath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001327D_InfinitePath));
        ...
        {
            bool result = CF_00001327D_InfinitePath.Solution_0_Test(input);
