...
{
    [TestClass]
    public sealed class CF_00001585B_ArrayEversion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001585B_ArrayEversion));
        ...
        {
            bool result = CF_00001585B_ArrayEversion.Solution_0_Test(input);
