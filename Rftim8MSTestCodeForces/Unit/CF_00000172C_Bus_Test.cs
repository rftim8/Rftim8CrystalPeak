...
{
    [TestClass]
    public sealed class CF_00000172C_Bus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000172C_Bus));
        ...
        {
            bool result = CF_00000172C_Bus.Solution_0_Test(input);
