...
{
    [TestClass]
    public sealed class CF_00000274B_ZeroTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000274B_ZeroTree));
        ...
        {
            bool result = CF_00000274B_ZeroTree.Solution_0_Test(input);
