...
{
    [TestClass]
    public sealed class CF_00000190A_VasyaAndTheBus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000190A_VasyaAndTheBus));
        ...
        {
            bool result = CF_00000190A_VasyaAndTheBus.Solution_0_Test(input);
