...
{
    [TestClass]
    public sealed class CF_00001423K_LonelyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001423K_LonelyNumbers));
        ...
        {
            bool result = CF_00001423K_LonelyNumbers.Solution_0_Test(input);
