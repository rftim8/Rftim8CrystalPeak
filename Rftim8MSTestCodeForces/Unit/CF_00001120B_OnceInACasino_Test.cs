...
{
    [TestClass]
    public sealed class CF_00001120B_OnceInACasino_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001120B_OnceInACasino));
        ...
        {
            bool result = CF_00001120B_OnceInACasino.Solution_0_Test(input);
