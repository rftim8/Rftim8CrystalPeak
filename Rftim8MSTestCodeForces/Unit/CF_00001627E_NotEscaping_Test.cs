...
{
    [TestClass]
    public sealed class CF_00001627E_NotEscaping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001627E_NotEscaping));
        ...
        {
            bool result = CF_00001627E_NotEscaping.Solution_0_Test(input);
