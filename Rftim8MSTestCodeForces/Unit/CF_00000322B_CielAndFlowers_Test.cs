...
{
    [TestClass]
    public sealed class CF_00000322B_CielAndFlowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000322B_CielAndFlowers));
        ...
        {
            bool result = CF_00000322B_CielAndFlowers.Solution_0_Test(input);
