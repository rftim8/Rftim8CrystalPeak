...
{
    [TestClass]
    public sealed class CF_00000358B_DimaAndTextMessages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000358B_DimaAndTextMessages));
        ...
        {
            bool result = CF_00000358B_DimaAndTextMessages.Solution_0_Test(input);
