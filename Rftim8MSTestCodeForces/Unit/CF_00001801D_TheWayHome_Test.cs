...
{
    [TestClass]
    public sealed class CF_00001801D_TheWayHome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001801D_TheWayHome));
        ...
        {
            bool result = CF_00001801D_TheWayHome.Solution_0_Test(input);
