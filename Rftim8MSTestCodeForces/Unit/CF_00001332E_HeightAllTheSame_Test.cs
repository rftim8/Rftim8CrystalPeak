...
{
    [TestClass]
    public sealed class CF_00001332E_HeightAllTheSame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001332E_HeightAllTheSame));
        ...
        {
            bool result = CF_00001332E_HeightAllTheSame.Solution_0_Test(input);
