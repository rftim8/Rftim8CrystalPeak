...
{
    [TestClass]
    public sealed class CF_00001708B_DifferenceOfGCDs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001708B_DifferenceOfGCDs));
        ...
        {
            bool result = CF_00001708B_DifferenceOfGCDs.Solution_0_Test(input);
