...
{
    [TestClass]
    public sealed class CF_00001168A_IncreasingByModulo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001168A_IncreasingByModulo));
        ...
        {
            bool result = CF_00001168A_IncreasingByModulo.Solution_0_Test(input);
