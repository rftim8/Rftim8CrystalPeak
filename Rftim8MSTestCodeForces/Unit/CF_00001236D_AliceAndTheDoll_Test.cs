...
{
    [TestClass]
    public sealed class CF_00001236D_AliceAndTheDoll_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001236D_AliceAndTheDoll));
        ...
        {
            bool result = CF_00001236D_AliceAndTheDoll.Solution_0_Test(input);
