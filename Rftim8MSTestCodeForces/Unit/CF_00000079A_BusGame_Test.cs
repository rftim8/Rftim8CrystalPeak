...
{
    [TestClass]
    public sealed class CF_00000079A_BusGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000079A_BusGame));
        ...
        {
            bool result = CF_00000079A_BusGame.Solution_0_Test(input);
