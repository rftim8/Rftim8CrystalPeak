...
{
    [TestClass]
    public sealed class CF_00002021B_MaximizeMex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002021B_MaximizeMex));
        ...
        {
            bool result = CF_00002021B_MaximizeMex.Solution_0_Test(input);
