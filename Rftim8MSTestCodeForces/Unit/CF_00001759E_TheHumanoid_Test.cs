...
{
    [TestClass]
    public sealed class CF_00001759E_TheHumanoid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001759E_TheHumanoid));
        ...
        {
            bool result = CF_00001759E_TheHumanoid.Solution_0_Test(input);
