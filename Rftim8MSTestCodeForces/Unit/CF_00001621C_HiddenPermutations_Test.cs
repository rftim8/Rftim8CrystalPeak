...
{
    [TestClass]
    public sealed class CF_00001621C_HiddenPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001621C_HiddenPermutations));
        ...
        {
            bool result = CF_00001621C_HiddenPermutations.Solution_0_Test(input);
