...
{
    [TestClass]
    public sealed class CF_00000181B_NumberOfTriplets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000181B_NumberOfTriplets));
        ...
        {
            bool result = CF_00000181B_NumberOfTriplets.Solution_0_Test(input);
