...
{
    [TestClass]
    public sealed class CF_00000409E_Dome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000409E_Dome));
        ...
        {
            bool result = CF_00000409E_Dome.Solution_0_Test(input);
