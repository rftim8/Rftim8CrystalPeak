...
{
    [TestClass]
    public sealed class CF_00000923D_PickingStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000923D_PickingStrings));
        ...
        {
            bool result = CF_00000923D_PickingStrings.Solution_0_Test(input);
