...
{
    [TestClass]
    public sealed class CF_00001369C_RationalLee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001369C_RationalLee));
        ...
        {
            bool result = CF_00001369C_RationalLee.Solution_0_Test(input);
