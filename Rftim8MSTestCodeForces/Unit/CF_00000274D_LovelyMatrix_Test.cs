...
{
    [TestClass]
    public sealed class CF_00000274D_LovelyMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000274D_LovelyMatrix));
        ...
        {
            bool result = CF_00000274D_LovelyMatrix.Solution_0_Test(input);
