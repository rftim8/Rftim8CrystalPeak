...
{
    [TestClass]
    public sealed class CF_00001547B_AlphabeticalStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001547B_AlphabeticalStrings));
        ...
        {
            bool result = CF_00001547B_AlphabeticalStrings.Solution_0_Test(input);
