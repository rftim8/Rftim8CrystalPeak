...
{
    [TestClass]
    public sealed class CF_00000022A_SecondOrderStatistics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000022A_SecondOrderStatistics));
        ...
        {
            bool result = CF_00000022A_SecondOrderStatistics.Solution_0_Test(input);
