...
{
    [TestClass]
    public sealed class CF_00001062B_Math_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001062B_Math));
        ...
        {
            bool result = CF_00001062B_Math.Solution_0_Test(input);
