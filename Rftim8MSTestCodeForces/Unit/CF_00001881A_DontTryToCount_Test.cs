...
{
    [TestClass]
    public sealed class CF_00001881A_DontTryToCount_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001881A_DontTryToCount));
        ...
        {
            bool result = CF_00001881A_DontTryToCount.Solution_0_Test(input);
