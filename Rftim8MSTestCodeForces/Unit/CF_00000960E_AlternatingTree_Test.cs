...
{
    [TestClass]
    public sealed class CF_00000960E_AlternatingTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000960E_AlternatingTree));
        ...
        {
            bool result = CF_00000960E_AlternatingTree.Solution_0_Test(input);
