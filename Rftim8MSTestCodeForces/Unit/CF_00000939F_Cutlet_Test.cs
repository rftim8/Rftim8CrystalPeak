...
{
    [TestClass]
    public sealed class CF_00000939F_Cutlet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000939F_Cutlet));
        ...
        {
            bool result = CF_00000939F_Cutlet.Solution_0_Test(input);
