...
{
    [TestClass]
    public sealed class CF_00001463D_Pairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001463D_Pairs));
        ...
        {
            bool result = CF_00001463D_Pairs.Solution_0_Test(input);
