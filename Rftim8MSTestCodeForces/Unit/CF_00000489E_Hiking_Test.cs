...
{
    [TestClass]
    public sealed class CF_00000489E_Hiking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000489E_Hiking));
        ...
        {
            bool result = CF_00000489E_Hiking.Solution_0_Test(input);
