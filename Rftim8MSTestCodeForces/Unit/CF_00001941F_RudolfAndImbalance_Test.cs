...
{
    [TestClass]
    public sealed class CF_00001941F_RudolfAndImbalance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001941F_RudolfAndImbalance));
        ...
        {
            bool result = CF_00001941F_RudolfAndImbalance.Solution_0_Test(input);
