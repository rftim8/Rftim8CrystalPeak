...
{
    [TestClass]
    public sealed class CF_00001204A_BowWowAndTheTimetable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001204A_BowWowAndTheTimetable));
        ...
        {
            bool result = CF_00001204A_BowWowAndTheTimetable.Solution_0_Test(input);
