...
{
    [TestClass]
    public sealed class CF_00001238C_StandardFree2play_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001238C_StandardFree2play));
        ...
        {
            bool result = CF_00001238C_StandardFree2play.Solution_0_Test(input);
