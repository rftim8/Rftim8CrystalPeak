...
{
    [TestClass]
    public sealed class CF_00000855A_TomRiddlesDiary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000855A_TomRiddlesDiary));
        ...
        {
            bool result = CF_00000855A_TomRiddlesDiary.Solution_0_Test(input);
