...
{
    [TestClass]
    public sealed class CF_00000386D_GameWithPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000386D_GameWithPoints));
        ...
        {
            bool result = CF_00000386D_GameWithPoints.Solution_0_Test(input);
