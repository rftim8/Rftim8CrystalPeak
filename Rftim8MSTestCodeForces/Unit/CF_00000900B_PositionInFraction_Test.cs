...
{
    [TestClass]
    public sealed class CF_00000900B_PositionInFraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000900B_PositionInFraction));
        ...
        {
            bool result = CF_00000900B_PositionInFraction.Solution_0_Test(input);
