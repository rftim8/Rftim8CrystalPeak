...
{
    [TestClass]
    public sealed class CF_00000266C_BelowTheDiagonal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000266C_BelowTheDiagonal));
        ...
        {
            bool result = CF_00000266C_BelowTheDiagonal.Solution_0_Test(input);
