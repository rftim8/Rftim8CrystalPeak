...
{
    [TestClass]
    public sealed class CF_00000135D_Cycle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000135D_Cycle));
        ...
        {
            bool result = CF_00000135D_Cycle.Solution_0_Test(input);
