...
{
    [TestClass]
    public sealed class CF_00000834B_TheFestiveEvening_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000834B_TheFestiveEvening));
        ...
        {
            bool result = CF_00000834B_TheFestiveEvening.Solution_0_Test(input);
