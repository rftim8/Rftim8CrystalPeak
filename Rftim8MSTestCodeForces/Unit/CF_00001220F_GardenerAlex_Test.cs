...
{
    [TestClass]
    public sealed class CF_00001220F_GardenerAlex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001220F_GardenerAlex));
        ...
        {
            bool result = CF_00001220F_GardenerAlex.Solution_0_Test(input);
