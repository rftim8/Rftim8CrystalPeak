...
{
    [TestClass]
    public sealed class CF_00001543C_NeedForPinkSlips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001543C_NeedForPinkSlips));
        ...
        {
            bool result = CF_00001543C_NeedForPinkSlips.Solution_0_Test(input);
