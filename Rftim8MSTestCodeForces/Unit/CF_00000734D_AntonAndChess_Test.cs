...
{
    [TestClass]
    public sealed class CF_00000734D_AntonAndChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000734D_AntonAndChess));
        ...
        {
            bool result = CF_00000734D_AntonAndChess.Solution_0_Test(input);
