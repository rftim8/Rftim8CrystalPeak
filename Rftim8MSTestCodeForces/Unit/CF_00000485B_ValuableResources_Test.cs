...
{
    [TestClass]
    public sealed class CF_00000485B_ValuableResources_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000485B_ValuableResources));
        ...
        {
            bool result = CF_00000485B_ValuableResources.Solution_0_Test(input);
