...
{
    [TestClass]
    public sealed class CF_00001485F_CopyOrPrefixSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001485F_CopyOrPrefixSum));
        ...
        {
            bool result = CF_00001485F_CopyOrPrefixSum.Solution_0_Test(input);
