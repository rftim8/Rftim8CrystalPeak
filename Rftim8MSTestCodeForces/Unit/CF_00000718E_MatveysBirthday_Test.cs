...
{
    [TestClass]
    public sealed class CF_00000718E_MatveysBirthday_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000718E_MatveysBirthday));
        ...
        {
            bool result = CF_00000718E_MatveysBirthday.Solution_0_Test(input);
