...
{
    [TestClass]
    public sealed class CF_00000833C_EverHungryKrakozyabra_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000833C_EverHungryKrakozyabra));
        ...
        {
            bool result = CF_00000833C_EverHungryKrakozyabra.Solution_0_Test(input);
