...
{
    [TestClass]
    public sealed class CF_00001987D_WorldIsMine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001987D_WorldIsMine));
        ...
        {
            bool result = CF_00001987D_WorldIsMine.Solution_0_Test(input);
