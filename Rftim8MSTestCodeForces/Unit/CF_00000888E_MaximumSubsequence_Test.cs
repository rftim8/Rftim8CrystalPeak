...
{
    [TestClass]
    public sealed class CF_00000888E_MaximumSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000888E_MaximumSubsequence));
        ...
        {
            bool result = CF_00000888E_MaximumSubsequence.Solution_0_Test(input);
