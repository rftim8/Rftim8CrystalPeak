...
{
    [TestClass]
    public sealed class CF_00000786E_ALT_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000786E_ALT));
        ...
        {
            bool result = CF_00000786E_ALT.Solution_0_Test(input);
