...
{
    [TestClass]
    public sealed class CF_00001338B_EdgeWeightAssignment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001338B_EdgeWeightAssignment));
        ...
        {
            bool result = CF_00001338B_EdgeWeightAssignment.Solution_0_Test(input);
