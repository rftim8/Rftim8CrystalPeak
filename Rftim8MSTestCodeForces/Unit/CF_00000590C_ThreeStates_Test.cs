...
{
    [TestClass]
    public sealed class CF_00000590C_ThreeStates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000590C_ThreeStates));
        ...
        {
            bool result = CF_00000590C_ThreeStates.Solution_0_Test(input);
