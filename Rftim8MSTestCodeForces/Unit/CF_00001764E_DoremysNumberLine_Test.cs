...
{
    [TestClass]
    public sealed class CF_00001764E_DoremysNumberLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001764E_DoremysNumberLine));
        ...
        {
            bool result = CF_00001764E_DoremysNumberLine.Solution_0_Test(input);
