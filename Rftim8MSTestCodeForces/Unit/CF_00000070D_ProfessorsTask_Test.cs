...
{
    [TestClass]
    public sealed class CF_00000070D_ProfessorsTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000070D_ProfessorsTask));
        ...
        {
            bool result = CF_00000070D_ProfessorsTask.Solution_0_Test(input);
