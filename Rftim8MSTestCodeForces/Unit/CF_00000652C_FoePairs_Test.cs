...
{
    [TestClass]
    public sealed class CF_00000652C_FoePairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000652C_FoePairs));
        ...
        {
            bool result = CF_00000652C_FoePairs.Solution_0_Test(input);
