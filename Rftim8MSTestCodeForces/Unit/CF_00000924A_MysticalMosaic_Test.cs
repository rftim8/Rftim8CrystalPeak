...
{
    [TestClass]
    public sealed class CF_00000924A_MysticalMosaic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000924A_MysticalMosaic));
        ...
        {
            bool result = CF_00000924A_MysticalMosaic.Solution_0_Test(input);
