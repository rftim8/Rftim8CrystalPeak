...
{
    [TestClass]
    public sealed class CF_00001242A_TilePainting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001242A_TilePainting));
        ...
        {
            bool result = CF_00001242A_TilePainting.Solution_0_Test(input);
