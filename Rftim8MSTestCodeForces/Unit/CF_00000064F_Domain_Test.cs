...
{
    [TestClass]
    public sealed class CF_00000064F_Domain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000064F_Domain));
        ...
        {
            bool result = CF_00000064F_Domain.Solution_0_Test(input);
