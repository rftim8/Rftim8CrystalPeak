...
{
    [TestClass]
    public sealed class CF_00001263D_SecretPasswords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001263D_SecretPasswords));
        ...
        {
            bool result = CF_00001263D_SecretPasswords.Solution_0_Test(input);
