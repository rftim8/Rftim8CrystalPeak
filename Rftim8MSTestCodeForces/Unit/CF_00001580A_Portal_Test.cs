...
{
    [TestClass]
    public sealed class CF_00001580A_Portal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001580A_Portal));
        ...
        {
            bool result = CF_00001580A_Portal.Solution_0_Test(input);
