...
{
    [TestClass]
    public sealed class CF_00001699E_ThreeDaysGrace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001699E_ThreeDaysGrace));
        ...
        {
            bool result = CF_00001699E_ThreeDaysGrace.Solution_0_Test(input);
