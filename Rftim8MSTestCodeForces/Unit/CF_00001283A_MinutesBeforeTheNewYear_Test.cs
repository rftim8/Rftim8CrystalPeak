...
{
    [TestClass]
    public sealed class CF_00001283A_MinutesBeforeTheNewYear_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001283A_MinutesBeforeTheNewYear));
        ...
        {
            bool result = CF_00001283A_MinutesBeforeTheNewYear.Solution_0_Test(input);
