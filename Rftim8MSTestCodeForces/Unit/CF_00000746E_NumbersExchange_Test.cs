...
{
    [TestClass]
    public sealed class CF_00000746E_NumbersExchange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000746E_NumbersExchange));
        ...
        {
            bool result = CF_00000746E_NumbersExchange.Solution_0_Test(input);
