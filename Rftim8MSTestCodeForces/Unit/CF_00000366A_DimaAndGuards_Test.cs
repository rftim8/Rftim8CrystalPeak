...
{
    [TestClass]
    public sealed class CF_00000366A_DimaAndGuards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000366A_DimaAndGuards));
        ...
        {
            bool result = CF_00000366A_DimaAndGuards.Solution_0_Test(input);
