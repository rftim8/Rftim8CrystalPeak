...
{
    [TestClass]
    public sealed class CF_00001510G_Guide_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001510G_Guide));
        ...
        {
            bool result = CF_00001510G_Guide.Solution_0_Test(input);
