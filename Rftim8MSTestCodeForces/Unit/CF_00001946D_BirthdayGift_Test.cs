...
{
    [TestClass]
    public sealed class CF_00001946D_BirthdayGift_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001946D_BirthdayGift));
        ...
        {
            bool result = CF_00001946D_BirthdayGift.Solution_0_Test(input);
