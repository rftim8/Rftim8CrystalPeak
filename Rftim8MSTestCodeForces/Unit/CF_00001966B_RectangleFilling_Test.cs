...
{
    [TestClass]
    public sealed class CF_00001966B_RectangleFilling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001966B_RectangleFilling));
        ...
        {
            bool result = CF_00001966B_RectangleFilling.Solution_0_Test(input);
