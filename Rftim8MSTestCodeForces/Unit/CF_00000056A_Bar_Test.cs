...
{
    [TestClass]
    public sealed class CF_00000056A_Bar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000056A_Bar));
        ...
        {
            bool result = CF_00000056A_Bar.Solution_0_Test(input);
