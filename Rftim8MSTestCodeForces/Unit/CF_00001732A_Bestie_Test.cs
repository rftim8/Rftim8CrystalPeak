...
{
    [TestClass]
    public sealed class CF_00001732A_Bestie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001732A_Bestie));
        ...
        {
            bool result = CF_00001732A_Bestie.Solution_0_Test(input);
