...
{
    [TestClass]
    public sealed class CF_00000066C_PetyaAndFileSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000066C_PetyaAndFileSystem));
        ...
        {
            bool result = CF_00000066C_PetyaAndFileSystem.Solution_0_Test(input);
