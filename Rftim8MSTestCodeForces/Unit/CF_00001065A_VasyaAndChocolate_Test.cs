...
{
    [TestClass]
    public sealed class CF_00001065A_VasyaAndChocolate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001065A_VasyaAndChocolate));
        ...
        {
            bool result = CF_00001065A_VasyaAndChocolate.Solution_0_Test(input);
