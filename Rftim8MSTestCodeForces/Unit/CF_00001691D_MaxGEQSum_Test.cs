...
{
    [TestClass]
    public sealed class CF_00001691D_MaxGEQSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001691D_MaxGEQSum));
        ...
        {
            bool result = CF_00001691D_MaxGEQSum.Solution_0_Test(input);
