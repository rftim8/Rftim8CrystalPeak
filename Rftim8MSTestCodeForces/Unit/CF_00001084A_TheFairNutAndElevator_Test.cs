...
{
    [TestClass]
    public sealed class CF_00001084A_TheFairNutAndElevator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001084A_TheFairNutAndElevator));
        ...
        {
            bool result = CF_00001084A_TheFairNutAndElevator.Solution_0_Test(input);
