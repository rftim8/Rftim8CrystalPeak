...
{
    [TestClass]
    public sealed class CF_00001493A_Antiknapsack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001493A_Antiknapsack));
        ...
        {
            bool result = CF_00001493A_Antiknapsack.Solution_0_Test(input);
