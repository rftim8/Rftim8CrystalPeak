...
{
    [TestClass]
    public sealed class CF_00001525F_GoblinsAndGnomes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001525F_GoblinsAndGnomes));
        ...
        {
            bool result = CF_00001525F_GoblinsAndGnomes.Solution_0_Test(input);
