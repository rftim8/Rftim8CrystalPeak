...
{
    [TestClass]
    public sealed class CF_00001870C_ColorfulTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001870C_ColorfulTable));
        ...
        {
            bool result = CF_00001870C_ColorfulTable.Solution_0_Test(input);
