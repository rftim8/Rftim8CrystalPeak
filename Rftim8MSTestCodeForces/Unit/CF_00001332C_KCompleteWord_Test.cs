...
{
    [TestClass]
    public sealed class CF_00001332C_KCompleteWord_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001332C_KCompleteWord));
        ...
        {
            bool result = CF_00001332C_KCompleteWord.Solution_0_Test(input);
