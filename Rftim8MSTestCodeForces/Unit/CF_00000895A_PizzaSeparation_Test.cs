...
{
    [TestClass]
    public sealed class CF_00000895A_PizzaSeparation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000895A_PizzaSeparation));
        ...
        {
            bool result = CF_00000895A_PizzaSeparation.Solution_0_Test(input);
