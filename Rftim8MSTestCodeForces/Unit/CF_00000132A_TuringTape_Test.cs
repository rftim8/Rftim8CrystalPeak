...
{
    [TestClass]
    public sealed class CF_00000132A_TuringTape_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000132A_TuringTape));
        ...
        {
            bool result = CF_00000132A_TuringTape.Solution_0_Test(input);
