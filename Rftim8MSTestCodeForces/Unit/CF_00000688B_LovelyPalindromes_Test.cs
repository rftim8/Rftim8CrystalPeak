...
{
    [TestClass]
    public sealed class CF_00000688B_LovelyPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000688B_LovelyPalindromes));
        ...
        {
            bool result = CF_00000688B_LovelyPalindromes.Solution_0_Test(input);
