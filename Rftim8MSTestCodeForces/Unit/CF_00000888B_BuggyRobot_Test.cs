...
{
    [TestClass]
    public sealed class CF_00000888B_BuggyRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000888B_BuggyRobot));
        ...
        {
            bool result = CF_00000888B_BuggyRobot.Solution_0_Test(input);
