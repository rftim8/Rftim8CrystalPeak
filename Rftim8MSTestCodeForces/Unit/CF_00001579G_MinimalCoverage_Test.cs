...
{
    [TestClass]
    public sealed class CF_00001579G_MinimalCoverage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001579G_MinimalCoverage));
        ...
        {
            bool result = CF_00001579G_MinimalCoverage.Solution_0_Test(input);
