...
{
    [TestClass]
    public sealed class CF_00002011C_SplitTheExpression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002011C_SplitTheExpression));
        ...
        {
            bool result = CF_00002011C_SplitTheExpression.Solution_0_Test(input);
