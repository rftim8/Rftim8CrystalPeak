...
{
    [TestClass]
    public sealed class CF_00002036B_Startup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002036B_Startup));
        ...
        {
            bool result = CF_00002036B_Startup.Solution_0_Test(input);
