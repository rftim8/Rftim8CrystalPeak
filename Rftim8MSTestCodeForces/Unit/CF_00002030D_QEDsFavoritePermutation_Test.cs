...
{
    [TestClass]
    public sealed class CF_00002030D_QEDsFavoritePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002030D_QEDsFavoritePermutation));
        ...
        {
            bool result = CF_00002030D_QEDsFavoritePermutation.Solution_0_Test(input);
