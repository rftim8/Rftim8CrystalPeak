...
{
    [TestClass]
    public sealed class CF_00000264D_ColorfulStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000264D_ColorfulStones));
        ...
        {
            bool result = CF_00000264D_ColorfulStones.Solution_0_Test(input);
