...
{
    [TestClass]
    public sealed class CF_00001437B_ReverseBinaryStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001437B_ReverseBinaryStrings));
        ...
        {
            bool result = CF_00001437B_ReverseBinaryStrings.Solution_0_Test(input);
