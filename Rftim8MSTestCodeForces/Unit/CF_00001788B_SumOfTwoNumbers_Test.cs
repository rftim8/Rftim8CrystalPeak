...
{
    [TestClass]
    public sealed class CF_00001788B_SumOfTwoNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001788B_SumOfTwoNumbers));
        ...
        {
            bool result = CF_00001788B_SumOfTwoNumbers.Solution_0_Test(input);
