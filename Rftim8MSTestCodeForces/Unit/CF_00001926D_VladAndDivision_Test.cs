...
{
    [TestClass]
    public sealed class CF_00001926D_VladAndDivision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001926D_VladAndDivision));
        ...
        {
            bool result = CF_00001926D_VladAndDivision.Solution_0_Test(input);
