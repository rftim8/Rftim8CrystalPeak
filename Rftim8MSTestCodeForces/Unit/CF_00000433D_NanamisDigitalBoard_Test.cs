...
{
    [TestClass]
    public sealed class CF_00000433D_NanamisDigitalBoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000433D_NanamisDigitalBoard));
        ...
        {
            bool result = CF_00000433D_NanamisDigitalBoard.Solution_0_Test(input);
