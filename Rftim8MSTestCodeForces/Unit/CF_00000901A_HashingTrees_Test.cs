...
{
    [TestClass]
    public sealed class CF_00000901A_HashingTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000901A_HashingTrees));
        ...
        {
            bool result = CF_00000901A_HashingTrees.Solution_0_Test(input);
