...
{
    [TestClass]
    public sealed class CF_00001413A_FindingSasuke_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001413A_FindingSasuke));
        ...
        {
            bool result = CF_00001413A_FindingSasuke.Solution_0_Test(input);
