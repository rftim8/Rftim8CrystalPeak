...
{
    [TestClass]
    public sealed class CF_00001675G_SortingPancakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001675G_SortingPancakes));
        ...
        {
            bool result = CF_00001675G_SortingPancakes.Solution_0_Test(input);
