...
{
    [TestClass]
    public sealed class CF_00001716D_ChipMove_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001716D_ChipMove));
        ...
        {
            bool result = CF_00001716D_ChipMove.Solution_0_Test(input);
