...
{
    [TestClass]
    public sealed class CF_00002037F_ArdentFlames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002037F_ArdentFlames));
        ...
        {
            bool result = CF_00002037F_ArdentFlames.Solution_0_Test(input);
