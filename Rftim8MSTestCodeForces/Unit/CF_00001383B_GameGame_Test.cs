...
{
    [TestClass]
    public sealed class CF_00001383B_GameGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001383B_GameGame));
        ...
        {
            bool result = CF_00001383B_GameGame.Solution_0_Test(input);
