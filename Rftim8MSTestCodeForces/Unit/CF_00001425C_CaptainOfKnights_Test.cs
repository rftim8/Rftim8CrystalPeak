...
{
    [TestClass]
    public sealed class CF_00001425C_CaptainOfKnights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001425C_CaptainOfKnights));
        ...
        {
            bool result = CF_00001425C_CaptainOfKnights.Solution_0_Test(input);
