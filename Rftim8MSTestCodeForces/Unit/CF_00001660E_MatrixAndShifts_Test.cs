...
{
    [TestClass]
    public sealed class CF_00001660E_MatrixAndShifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001660E_MatrixAndShifts));
        ...
        {
            bool result = CF_00001660E_MatrixAndShifts.Solution_0_Test(input);
