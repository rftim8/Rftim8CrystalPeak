...
{
    [TestClass]
    public sealed class CF_00001618G_TraderProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001618G_TraderProblem));
        ...
        {
            bool result = CF_00001618G_TraderProblem.Solution_0_Test(input);
