...
{
    [TestClass]
    public sealed class CF_00001409B_MinimumProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001409B_MinimumProduct));
        ...
        {
            bool result = CF_00001409B_MinimumProduct.Solution_0_Test(input);
