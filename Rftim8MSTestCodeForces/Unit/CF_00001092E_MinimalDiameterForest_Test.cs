...
{
    [TestClass]
    public sealed class CF_00001092E_MinimalDiameterForest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001092E_MinimalDiameterForest));
        ...
        {
            bool result = CF_00001092E_MinimalDiameterForest.Solution_0_Test(input);
