...
{
    [TestClass]
    public sealed class CF_00000045I_TCMCFPlusPlusPlus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000045I_TCMCFPlusPlusPlus));
        ...
        {
            bool result = CF_00000045I_TCMCFPlusPlusPlus.Solution_0_Test(input);
