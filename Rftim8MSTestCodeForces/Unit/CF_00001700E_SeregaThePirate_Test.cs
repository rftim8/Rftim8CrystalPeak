...
{
    [TestClass]
    public sealed class CF_00001700E_SeregaThePirate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001700E_SeregaThePirate));
        ...
        {
            bool result = CF_00001700E_SeregaThePirate.Solution_0_Test(input);
