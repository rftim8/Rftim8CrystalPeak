...
{
    [TestClass]
    public sealed class CF_00001486F_PairsOfPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001486F_PairsOfPaths));
        ...
        {
            bool result = CF_00001486F_PairsOfPaths.Solution_0_Test(input);
