...
{
    [TestClass]
    public sealed class CF_00001662E_RoundTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662E_RoundTable));
        ...
        {
            bool result = CF_00001662E_RoundTable.Solution_0_Test(input);
