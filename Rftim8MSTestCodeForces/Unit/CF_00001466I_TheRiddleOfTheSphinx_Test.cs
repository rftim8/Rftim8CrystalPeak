...
{
    [TestClass]
    public sealed class CF_00001466I_TheRiddleOfTheSphinx_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001466I_TheRiddleOfTheSphinx));
        ...
        {
            bool result = CF_00001466I_TheRiddleOfTheSphinx.Solution_0_Test(input);
