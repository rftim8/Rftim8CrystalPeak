...
{
    [TestClass]
    public sealed class CF_00001475E_AdvertisingAgency_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001475E_AdvertisingAgency));
        ...
        {
            bool result = CF_00001475E_AdvertisingAgency.Solution_0_Test(input);
