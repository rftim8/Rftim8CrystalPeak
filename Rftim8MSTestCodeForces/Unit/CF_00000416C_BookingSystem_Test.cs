...
{
    [TestClass]
    public sealed class CF_00000416C_BookingSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000416C_BookingSystem));
        ...
        {
            bool result = CF_00000416C_BookingSystem.Solution_0_Test(input);
