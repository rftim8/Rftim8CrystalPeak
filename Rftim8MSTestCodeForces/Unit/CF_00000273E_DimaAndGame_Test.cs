...
{
    [TestClass]
    public sealed class CF_00000273E_DimaAndGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000273E_DimaAndGame));
        ...
        {
            bool result = CF_00000273E_DimaAndGame.Solution_0_Test(input);
