...
{
    [TestClass]
    public sealed class CF_00000369A_ValeraAndPlates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000369A_ValeraAndPlates));
        ...
        {
            bool result = CF_00000369A_ValeraAndPlates.Solution_0_Test(input);
