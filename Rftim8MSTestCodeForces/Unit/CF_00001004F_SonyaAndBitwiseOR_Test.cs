...
{
    [TestClass]
    public sealed class CF_00001004F_SonyaAndBitwiseOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001004F_SonyaAndBitwiseOR));
        ...
        {
            bool result = CF_00001004F_SonyaAndBitwiseOR.Solution_0_Test(input);
