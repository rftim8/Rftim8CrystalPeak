...
{
    [TestClass]
    public sealed class CF_00000413E_Maze2D_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000413E_Maze2D));
        ...
        {
            bool result = CF_00000413E_Maze2D.Solution_0_Test(input);
