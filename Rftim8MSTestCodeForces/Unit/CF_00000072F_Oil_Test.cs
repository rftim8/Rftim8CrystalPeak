...
{
    [TestClass]
    public sealed class CF_00000072F_Oil_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000072F_Oil));
        ...
        {
            bool result = CF_00000072F_Oil.Solution_0_Test(input);
