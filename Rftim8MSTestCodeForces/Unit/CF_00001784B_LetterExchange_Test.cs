...
{
    [TestClass]
    public sealed class CF_00001784B_LetterExchange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001784B_LetterExchange));
        ...
        {
            bool result = CF_00001784B_LetterExchange.Solution_0_Test(input);
