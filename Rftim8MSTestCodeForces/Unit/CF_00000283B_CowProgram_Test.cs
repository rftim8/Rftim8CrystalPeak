...
{
    [TestClass]
    public sealed class CF_00000283B_CowProgram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000283B_CowProgram));
        ...
        {
            bool result = CF_00000283B_CowProgram.Solution_0_Test(input);
