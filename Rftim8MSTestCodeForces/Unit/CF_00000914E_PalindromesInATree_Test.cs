...
{
    [TestClass]
    public sealed class CF_00000914E_PalindromesInATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000914E_PalindromesInATree));
        ...
        {
            bool result = CF_00000914E_PalindromesInATree.Solution_0_Test(input);
