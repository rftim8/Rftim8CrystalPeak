...
{
    [TestClass]
    public sealed class CF_00000671E_OrganizingARace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000671E_OrganizingARace));
        ...
        {
            bool result = CF_00000671E_OrganizingARace.Solution_0_Test(input);
