...
{
    [TestClass]
    public sealed class CF_00001571G_ABattleAgainstADragon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001571G_ABattleAgainstADragon));
        ...
        {
            bool result = CF_00001571G_ABattleAgainstADragon.Solution_0_Test(input);
