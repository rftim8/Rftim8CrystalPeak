...
{
    [TestClass]
    public sealed class CF_00000677C_VanyaAndLabel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000677C_VanyaAndLabel));
        ...
        {
            bool result = CF_00000677C_VanyaAndLabel.Solution_0_Test(input);
