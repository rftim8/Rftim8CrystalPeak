...
{
    [TestClass]
    public sealed class CF_00001372B_OmkarAndLastClassOfMath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001372B_OmkarAndLastClassOfMath));
        ...
        {
            bool result = CF_00001372B_OmkarAndLastClassOfMath.Solution_0_Test(input);
