...
{
    [TestClass]
    public sealed class CF_00000788D_FindingLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000788D_FindingLines));
        ...
        {
            bool result = CF_00000788D_FindingLines.Solution_0_Test(input);
