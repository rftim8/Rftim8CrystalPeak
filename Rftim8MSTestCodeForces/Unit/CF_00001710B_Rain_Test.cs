...
{
    [TestClass]
    public sealed class CF_00001710B_Rain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001710B_Rain));
        ...
        {
            bool result = CF_00001710B_Rain.Solution_0_Test(input);
