...
{
    [TestClass]
    public sealed class CF_00001491G_SwitchAndFlip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001491G_SwitchAndFlip));
        ...
        {
            bool result = CF_00001491G_SwitchAndFlip.Solution_0_Test(input);
