...
{
    [TestClass]
    public sealed class CF_00000482D_RandomFunctionAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000482D_RandomFunctionAndTree));
        ...
        {
            bool result = CF_00000482D_RandomFunctionAndTree.Solution_0_Test(input);
