...
{
    [TestClass]
    public sealed class CF_00001324A_YetAnotherTetrisProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001324A_YetAnotherTetrisProblem));
        ...
        {
            bool result = CF_00001324A_YetAnotherTetrisProblem.Solution_0_Test(input);
