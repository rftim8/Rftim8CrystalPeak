...
{
    [TestClass]
    public sealed class CF_00001280C_JeremyBearimy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001280C_JeremyBearimy));
        ...
        {
            bool result = CF_00001280C_JeremyBearimy.Solution_0_Test(input);
