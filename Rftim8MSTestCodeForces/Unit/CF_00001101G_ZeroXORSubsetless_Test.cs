...
{
    [TestClass]
    public sealed class CF_00001101G_ZeroXORSubsetless_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001101G_ZeroXORSubsetless));
        ...
        {
            bool result = CF_00001101G_ZeroXORSubsetless.Solution_0_Test(input);
