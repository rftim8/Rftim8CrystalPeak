...
{
    [TestClass]
    public sealed class CF_00001025F_DisjointTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001025F_DisjointTriangles));
        ...
        {
            bool result = CF_00001025F_DisjointTriangles.Solution_0_Test(input);
