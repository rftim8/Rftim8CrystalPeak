...
{
    [TestClass]
    public sealed class CF_00000673B_ProblemsForRound_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000673B_ProblemsForRound));
        ...
        {
            bool result = CF_00000673B_ProblemsForRound.Solution_0_Test(input);
