...
{
    [TestClass]
    public sealed class CF_00001503D_FlipTheCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001503D_FlipTheCards));
        ...
        {
            bool result = CF_00001503D_FlipTheCards.Solution_0_Test(input);
