...
{
    [TestClass]
    public sealed class CF_00000335A_Banana_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000335A_Banana));
        ...
        {
            bool result = CF_00000335A_Banana.Solution_0_Test(input);
