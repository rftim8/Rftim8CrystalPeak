...
{
    [TestClass]
    public sealed class CF_00000085A_Domino_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000085A_Domino));
        ...
        {
            bool result = CF_00000085A_Domino.Solution_0_Test(input);
