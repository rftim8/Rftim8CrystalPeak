...
{
    [TestClass]
    public sealed class CF_00001108D_DiverseGarland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001108D_DiverseGarland));
        ...
        {
            bool result = CF_00001108D_DiverseGarland.Solution_0_Test(input);
