...
{
    [TestClass]
    public sealed class CF_00000732D_Exams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000732D_Exams));
        ...
        {
            bool result = CF_00000732D_Exams.Solution_0_Test(input);
