...
{
    [TestClass]
    public sealed class CF_00001986E_BeautifulArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001986E_BeautifulArray));
        ...
        {
            bool result = CF_00001986E_BeautifulArray.Solution_0_Test(input);
