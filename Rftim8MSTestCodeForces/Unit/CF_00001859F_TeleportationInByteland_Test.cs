...
{
    [TestClass]
    public sealed class CF_00001859F_TeleportationInByteland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001859F_TeleportationInByteland));
        ...
        {
            bool result = CF_00001859F_TeleportationInByteland.Solution_0_Test(input);
