...
{
    [TestClass]
    public sealed class CF_00001213F_UnstableStringSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001213F_UnstableStringSort));
        ...
        {
            bool result = CF_00001213F_UnstableStringSort.Solution_0_Test(input);
