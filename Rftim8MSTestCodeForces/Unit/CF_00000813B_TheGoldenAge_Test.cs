...
{
    [TestClass]
    public sealed class CF_00000813B_TheGoldenAge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000813B_TheGoldenAge));
        ...
        {
            bool result = CF_00000813B_TheGoldenAge.Solution_0_Test(input);
