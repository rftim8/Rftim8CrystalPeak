...
{
    [TestClass]
    public sealed class CF_00001010E_Store_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001010E_Store));
        ...
        {
            bool result = CF_00001010E_Store.Solution_0_Test(input);
