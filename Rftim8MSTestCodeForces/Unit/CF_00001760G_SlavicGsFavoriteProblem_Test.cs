...
{
    [TestClass]
    public sealed class CF_00001760G_SlavicGsFavoriteProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001760G_SlavicGsFavoriteProblem));
        ...
        {
            bool result = CF_00001760G_SlavicGsFavoriteProblem.Solution_0_Test(input);
