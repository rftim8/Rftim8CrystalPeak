...
{
    [TestClass]
    public sealed class CF_00000215A_BicycleChain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000215A_BicycleChain));
        ...
        {
            bool result = CF_00000215A_BicycleChain.Solution_0_Test(input);
