...
{
    [TestClass]
    public sealed class CF_00001456E_XORranges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001456E_XORranges));
        ...
        {
            bool result = CF_00001456E_XORranges.Solution_0_Test(input);
