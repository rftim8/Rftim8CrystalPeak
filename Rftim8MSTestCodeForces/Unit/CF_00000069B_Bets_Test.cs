...
{
    [TestClass]
    public sealed class CF_00000069B_Bets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000069B_Bets));
        ...
        {
            bool result = CF_00000069B_Bets.Solution_0_Test(input);
