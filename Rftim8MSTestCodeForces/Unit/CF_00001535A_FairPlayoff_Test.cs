...
{
    [TestClass]
    public sealed class CF_00001535A_FairPlayoff_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001535A_FairPlayoff));
        ...
        {
            bool result = CF_00001535A_FairPlayoff.Solution_0_Test(input);
