...
{
    [TestClass]
    public sealed class CF_00000436A_FeedWithCandy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000436A_FeedWithCandy));
        ...
        {
            bool result = CF_00000436A_FeedWithCandy.Solution_0_Test(input);
