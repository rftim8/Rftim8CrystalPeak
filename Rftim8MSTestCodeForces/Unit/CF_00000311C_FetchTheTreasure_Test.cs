...
{
    [TestClass]
    public sealed class CF_00000311C_FetchTheTreasure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000311C_FetchTheTreasure));
        ...
        {
            bool result = CF_00000311C_FetchTheTreasure.Solution_0_Test(input);
