...
{
    [TestClass]
    public sealed class CF_00000163D_LargeRefrigerator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000163D_LargeRefrigerator));
        ...
        {
            bool result = CF_00000163D_LargeRefrigerator.Solution_0_Test(input);
