...
{
    [TestClass]
    public sealed class CF_00000989C_AMistOfFlorescence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000989C_AMistOfFlorescence));
        ...
        {
            bool result = CF_00000989C_AMistOfFlorescence.Solution_0_Test(input);
