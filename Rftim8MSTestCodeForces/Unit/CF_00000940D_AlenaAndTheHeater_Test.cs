...
{
    [TestClass]
    public sealed class CF_00000940D_AlenaAndTheHeater_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000940D_AlenaAndTheHeater));
        ...
        {
            bool result = CF_00000940D_AlenaAndTheHeater.Solution_0_Test(input);
