...
{
    [TestClass]
    public sealed class CF_00001270F_AwesomeSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001270F_AwesomeSubstrings));
        ...
        {
            bool result = CF_00001270F_AwesomeSubstrings.Solution_0_Test(input);
