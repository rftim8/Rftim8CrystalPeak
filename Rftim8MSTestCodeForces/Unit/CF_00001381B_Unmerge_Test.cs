...
{
    [TestClass]
    public sealed class CF_00001381B_Unmerge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001381B_Unmerge));
        ...
        {
            bool result = CF_00001381B_Unmerge.Solution_0_Test(input);
