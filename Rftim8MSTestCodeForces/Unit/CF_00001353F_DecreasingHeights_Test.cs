...
{
    [TestClass]
    public sealed class CF_00001353F_DecreasingHeights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001353F_DecreasingHeights));
        ...
        {
            bool result = CF_00001353F_DecreasingHeights.Solution_0_Test(input);
