...
{
    [TestClass]
    public sealed class CF_00000036D_NewGameWithAChessPiece_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000036D_NewGameWithAChessPiece));
        ...
        {
            bool result = CF_00000036D_NewGameWithAChessPiece.Solution_0_Test(input);
