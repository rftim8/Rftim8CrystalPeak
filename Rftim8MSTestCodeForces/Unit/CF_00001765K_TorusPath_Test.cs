...
{
    [TestClass]
    public sealed class CF_00001765K_TorusPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001765K_TorusPath));
        ...
        {
            bool result = CF_00001765K_TorusPath.Solution_0_Test(input);
