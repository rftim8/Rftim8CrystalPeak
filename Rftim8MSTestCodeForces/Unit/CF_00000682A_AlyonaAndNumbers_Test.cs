...
{
    [TestClass]
    public sealed class CF_00000682A_AlyonaAndNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000682A_AlyonaAndNumbers));
        ...
        {
            bool result = CF_00000682A_AlyonaAndNumbers.Solution_0_Test(input);
