...
{
    [TestClass]
    public sealed class CF_00000859A_DeclinedFinalists_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000859A_DeclinedFinalists));
        ...
        {
            bool result = CF_00000859A_DeclinedFinalists.Solution_0_Test(input);
