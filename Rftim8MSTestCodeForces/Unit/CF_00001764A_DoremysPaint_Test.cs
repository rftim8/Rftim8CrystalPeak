...
{
    [TestClass]
    public sealed class CF_00001764A_DoremysPaint_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001764A_DoremysPaint));
        ...
        {
            bool result = CF_00001764A_DoremysPaint.Solution_0_Test(input);
