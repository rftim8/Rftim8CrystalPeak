...
{
    [TestClass]
    public sealed class CF_00000047A_TriangularNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000047A_TriangularNumbers));
        ...
        {
            bool result = CF_00000047A_TriangularNumbers.Solution_0_Test(input);
