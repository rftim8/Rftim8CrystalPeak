...
{
    [TestClass]
    public sealed class CF_00001635C_DifferentialSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001635C_DifferentialSorting));
        ...
        {
            bool result = CF_00001635C_DifferentialSorting.Solution_0_Test(input);
