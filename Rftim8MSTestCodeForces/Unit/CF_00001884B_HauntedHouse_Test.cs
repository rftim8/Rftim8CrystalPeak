...
{
    [TestClass]
    public sealed class CF_00001884B_HauntedHouse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001884B_HauntedHouse));
        ...
        {
            bool result = CF_00001884B_HauntedHouse.Solution_0_Test(input);
