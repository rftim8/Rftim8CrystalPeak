...
{
    [TestClass]
    public sealed class CF_00000268C_BeautifulSetsOfPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000268C_BeautifulSetsOfPoints));
        ...
        {
            bool result = CF_00000268C_BeautifulSetsOfPoints.Solution_0_Test(input);
