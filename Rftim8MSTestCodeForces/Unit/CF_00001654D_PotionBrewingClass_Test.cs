...
{
    [TestClass]
    public sealed class CF_00001654D_PotionBrewingClass_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001654D_PotionBrewingClass));
        ...
        {
            bool result = CF_00001654D_PotionBrewingClass.Solution_0_Test(input);
