...
{
    [TestClass]
    public sealed class CF_00001679F_FormalismForFormalism_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001679F_FormalismForFormalism));
        ...
        {
            bool result = CF_00001679F_FormalismForFormalism.Solution_0_Test(input);
