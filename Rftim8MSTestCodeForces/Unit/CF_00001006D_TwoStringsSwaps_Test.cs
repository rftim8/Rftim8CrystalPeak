...
{
    [TestClass]
    public sealed class CF_00001006D_TwoStringsSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001006D_TwoStringsSwaps));
        ...
        {
            bool result = CF_00001006D_TwoStringsSwaps.Solution_0_Test(input);
