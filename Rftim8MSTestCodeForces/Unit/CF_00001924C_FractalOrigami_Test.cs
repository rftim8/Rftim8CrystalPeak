...
{
    [TestClass]
    public sealed class CF_00001924C_FractalOrigami_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001924C_FractalOrigami));
        ...
        {
            bool result = CF_00001924C_FractalOrigami.Solution_0_Test(input);
