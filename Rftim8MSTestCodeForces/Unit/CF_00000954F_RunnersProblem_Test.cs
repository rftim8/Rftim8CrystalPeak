...
{
    [TestClass]
    public sealed class CF_00000954F_RunnersProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000954F_RunnersProblem));
        ...
        {
            bool result = CF_00000954F_RunnersProblem.Solution_0_Test(input);
