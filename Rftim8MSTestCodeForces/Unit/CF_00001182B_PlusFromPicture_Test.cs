...
{
    [TestClass]
    public sealed class CF_00001182B_PlusFromPicture_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001182B_PlusFromPicture));
        ...
        {
            bool result = CF_00001182B_PlusFromPicture.Solution_0_Test(input);
