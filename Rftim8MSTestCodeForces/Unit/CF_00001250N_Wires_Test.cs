...
{
    [TestClass]
    public sealed class CF_00001250N_Wires_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250N_Wires));
        ...
        {
            bool result = CF_00001250N_Wires.Solution_0_Test(input);
