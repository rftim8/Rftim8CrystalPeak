...
{
    [TestClass]
    public sealed class CF_00000924B_ThreelevelLaser_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000924B_ThreelevelLaser));
        ...
        {
            bool result = CF_00000924B_ThreelevelLaser.Solution_0_Test(input);
