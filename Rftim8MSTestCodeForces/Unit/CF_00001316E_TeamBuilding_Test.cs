...
{
    [TestClass]
    public sealed class CF_00001316E_TeamBuilding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001316E_TeamBuilding));
        ...
        {
            bool result = CF_00001316E_TeamBuilding.Solution_0_Test(input);
