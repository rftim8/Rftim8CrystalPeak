...
{
    [TestClass]
    public sealed class CF_00000711D_DirectedRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000711D_DirectedRoads));
        ...
        {
            bool result = CF_00000711D_DirectedRoads.Solution_0_Test(input);
