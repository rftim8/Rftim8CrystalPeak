...
{
    [TestClass]
    public sealed class CF_00001145E_FourierDoodles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001145E_FourierDoodles));
        ...
        {
            bool result = CF_00001145E_FourierDoodles.Solution_0_Test(input);
