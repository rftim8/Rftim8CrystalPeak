...
{
    [TestClass]
    public sealed class CF_00001680D_DogWalking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001680D_DogWalking));
        ...
        {
            bool result = CF_00001680D_DogWalking.Solution_0_Test(input);
