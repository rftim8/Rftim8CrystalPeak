...
{
    [TestClass]
    public sealed class CF_00000471C_MUHAndHouseOfCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000471C_MUHAndHouseOfCards));
        ...
        {
            bool result = CF_00000471C_MUHAndHouseOfCards.Solution_0_Test(input);
