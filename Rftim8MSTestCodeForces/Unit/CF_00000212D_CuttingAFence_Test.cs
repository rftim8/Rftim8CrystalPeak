...
{
    [TestClass]
    public sealed class CF_00000212D_CuttingAFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000212D_CuttingAFence));
        ...
        {
            bool result = CF_00000212D_CuttingAFence.Solution_0_Test(input);
