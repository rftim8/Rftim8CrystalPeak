...
{
    [TestClass]
    public sealed class CF_00001845B_ComeTogether_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001845B_ComeTogether));
        ...
        {
            bool result = CF_00001845B_ComeTogether.Solution_0_Test(input);
