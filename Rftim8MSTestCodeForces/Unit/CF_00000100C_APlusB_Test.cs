...
{
    [TestClass]
    public sealed class CF_00000100C_APlusB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000100C_APlusB));
        ...
        {
            bool result = CF_00000100C_APlusB.Solution_0_Test(input);
