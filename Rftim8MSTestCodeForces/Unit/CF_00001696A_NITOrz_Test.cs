...
{
    [TestClass]
    public sealed class CF_00001696A_NITOrz_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001696A_NITOrz));
        ...
        {
            bool result = CF_00001696A_NITOrz.Solution_0_Test(input);
