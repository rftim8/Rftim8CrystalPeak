...
{
    [TestClass]
    public sealed class CF_00001873F_MoneyTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001873F_MoneyTrees));
        ...
        {
            bool result = CF_00001873F_MoneyTrees.Solution_0_Test(input);
