...
{
    [TestClass]
    public sealed class CF_00001006E_MilitaryProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001006E_MilitaryProblem));
        ...
        {
            bool result = CF_00001006E_MilitaryProblem.Solution_0_Test(input);
