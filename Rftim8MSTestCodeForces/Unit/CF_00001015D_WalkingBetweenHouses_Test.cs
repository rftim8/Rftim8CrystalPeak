...
{
    [TestClass]
    public sealed class CF_00001015D_WalkingBetweenHouses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001015D_WalkingBetweenHouses));
        ...
        {
            bool result = CF_00001015D_WalkingBetweenHouses.Solution_0_Test(input);
