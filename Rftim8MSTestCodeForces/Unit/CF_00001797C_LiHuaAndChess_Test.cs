...
{
    [TestClass]
    public sealed class CF_00001797C_LiHuaAndChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001797C_LiHuaAndChess));
        ...
        {
            bool result = CF_00001797C_LiHuaAndChess.Solution_0_Test(input);
