...
{
    [TestClass]
    public sealed class CF_00000870C_MaximumSplitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000870C_MaximumSplitting));
        ...
        {
            bool result = CF_00000870C_MaximumSplitting.Solution_0_Test(input);
