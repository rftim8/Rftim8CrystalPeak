...
{
    [TestClass]
    public sealed class CF_00000049E_CommonAncestor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000049E_CommonAncestor));
        ...
        {
            bool result = CF_00000049E_CommonAncestor.Solution_0_Test(input);
