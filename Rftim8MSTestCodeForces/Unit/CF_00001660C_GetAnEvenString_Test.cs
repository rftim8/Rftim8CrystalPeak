...
{
    [TestClass]
    public sealed class CF_00001660C_GetAnEvenString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001660C_GetAnEvenString));
        ...
        {
            bool result = CF_00001660C_GetAnEvenString.Solution_0_Test(input);
