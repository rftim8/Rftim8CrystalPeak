...
{
    [TestClass]
    public sealed class CF_00001642B_PowerWalking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001642B_PowerWalking));
        ...
        {
            bool result = CF_00001642B_PowerWalking.Solution_0_Test(input);
