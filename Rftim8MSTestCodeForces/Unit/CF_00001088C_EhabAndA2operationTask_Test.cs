...
{
    [TestClass]
    public sealed class CF_00001088C_EhabAndA2operationTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001088C_EhabAndA2operationTask));
        ...
        {
            bool result = CF_00001088C_EhabAndA2operationTask.Solution_0_Test(input);
