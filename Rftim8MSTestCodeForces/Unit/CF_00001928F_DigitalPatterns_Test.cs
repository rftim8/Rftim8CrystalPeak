...
{
    [TestClass]
    public sealed class CF_00001928F_DigitalPatterns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001928F_DigitalPatterns));
        ...
        {
            bool result = CF_00001928F_DigitalPatterns.Solution_0_Test(input);
