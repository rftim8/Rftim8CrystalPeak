...
{
    [TestClass]
    public sealed class CF_00001062A_APrank_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001062A_APrank));
        ...
        {
            bool result = CF_00001062A_APrank.Solution_0_Test(input);
