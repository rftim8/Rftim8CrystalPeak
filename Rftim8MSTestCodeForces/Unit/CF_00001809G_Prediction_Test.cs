...
{
    [TestClass]
    public sealed class CF_00001809G_Prediction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001809G_Prediction));
        ...
        {
            bool result = CF_00001809G_Prediction.Solution_0_Test(input);
