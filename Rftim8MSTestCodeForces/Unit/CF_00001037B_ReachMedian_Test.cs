...
{
    [TestClass]
    public sealed class CF_00001037B_ReachMedian_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001037B_ReachMedian));
        ...
        {
            bool result = CF_00001037B_ReachMedian.Solution_0_Test(input);
