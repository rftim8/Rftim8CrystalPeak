...
{
    [TestClass]
    public sealed class CF_00000542A_PlaceYourAdHere_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000542A_PlaceYourAdHere));
        ...
        {
            bool result = CF_00000542A_PlaceYourAdHere.Solution_0_Test(input);
