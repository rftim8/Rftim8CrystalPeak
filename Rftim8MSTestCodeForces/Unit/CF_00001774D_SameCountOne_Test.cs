...
{
    [TestClass]
    public sealed class CF_00001774D_SameCountOne_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001774D_SameCountOne));
        ...
        {
            bool result = CF_00001774D_SameCountOne.Solution_0_Test(input);
