...
{
    [TestClass]
    public sealed class CF_00001833A_MusicalPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001833A_MusicalPuzzle));
        ...
        {
            bool result = CF_00001833A_MusicalPuzzle.Solution_0_Test(input);
