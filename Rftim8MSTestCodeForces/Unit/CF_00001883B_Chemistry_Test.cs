...
{
    [TestClass]
    public sealed class CF_00001883B_Chemistry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001883B_Chemistry));
        ...
        {
            bool result = CF_00001883B_Chemistry.Solution_0_Test(input);
