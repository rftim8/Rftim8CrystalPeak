...
{
    [TestClass]
    public sealed class CF_00001421B_PuttingBricksInTheWall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001421B_PuttingBricksInTheWall));
        ...
        {
            bool result = CF_00001421B_PuttingBricksInTheWall.Solution_0_Test(input);
