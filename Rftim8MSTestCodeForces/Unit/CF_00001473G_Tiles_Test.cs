...
{
    [TestClass]
    public sealed class CF_00001473G_Tiles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001473G_Tiles));
        ...
        {
            bool result = CF_00001473G_Tiles.Solution_0_Test(input);
