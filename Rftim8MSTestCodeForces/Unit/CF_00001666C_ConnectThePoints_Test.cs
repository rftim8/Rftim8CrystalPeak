...
{
    [TestClass]
    public sealed class CF_00001666C_ConnectThePoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001666C_ConnectThePoints));
        ...
        {
            bool result = CF_00001666C_ConnectThePoints.Solution_0_Test(input);
