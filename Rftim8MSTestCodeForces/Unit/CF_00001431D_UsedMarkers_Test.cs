...
{
    [TestClass]
    public sealed class CF_00001431D_UsedMarkers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001431D_UsedMarkers));
        ...
        {
            bool result = CF_00001431D_UsedMarkers.Solution_0_Test(input);
