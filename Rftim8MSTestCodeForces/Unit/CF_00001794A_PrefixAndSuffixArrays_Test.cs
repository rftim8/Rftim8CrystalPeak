...
{
    [TestClass]
    public sealed class CF_00001794A_PrefixAndSuffixArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001794A_PrefixAndSuffixArrays));
        ...
        {
            bool result = CF_00001794A_PrefixAndSuffixArrays.Solution_0_Test(input);
