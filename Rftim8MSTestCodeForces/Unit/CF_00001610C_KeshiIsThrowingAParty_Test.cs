...
{
    [TestClass]
    public sealed class CF_00001610C_KeshiIsThrowingAParty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001610C_KeshiIsThrowingAParty));
        ...
        {
            bool result = CF_00001610C_KeshiIsThrowingAParty.Solution_0_Test(input);
