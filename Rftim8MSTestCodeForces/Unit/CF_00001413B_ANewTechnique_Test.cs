...
{
    [TestClass]
    public sealed class CF_00001413B_ANewTechnique_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001413B_ANewTechnique));
        ...
        {
            bool result = CF_00001413B_ANewTechnique.Solution_0_Test(input);
