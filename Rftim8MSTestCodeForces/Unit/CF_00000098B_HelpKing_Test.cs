...
{
    [TestClass]
    public sealed class CF_00000098B_HelpKing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000098B_HelpKing));
        ...
        {
            bool result = CF_00000098B_HelpKing.Solution_0_Test(input);
