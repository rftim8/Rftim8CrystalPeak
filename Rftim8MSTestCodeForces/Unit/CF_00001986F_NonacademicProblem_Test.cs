...
{
    [TestClass]
    public sealed class CF_00001986F_NonacademicProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001986F_NonacademicProblem));
        ...
        {
            bool result = CF_00001986F_NonacademicProblem.Solution_0_Test(input);
