...
{
    [TestClass]
    public sealed class CF_00001311C_PerformTheCombo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001311C_PerformTheCombo));
        ...
        {
            bool result = CF_00001311C_PerformTheCombo.Solution_0_Test(input);
