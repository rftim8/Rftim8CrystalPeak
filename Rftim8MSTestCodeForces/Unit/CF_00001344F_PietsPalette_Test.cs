...
{
    [TestClass]
    public sealed class CF_00001344F_PietsPalette_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001344F_PietsPalette));
        ...
        {
            bool result = CF_00001344F_PietsPalette.Solution_0_Test(input);
