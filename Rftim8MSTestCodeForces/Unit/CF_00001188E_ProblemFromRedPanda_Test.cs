...
{
    [TestClass]
    public sealed class CF_00001188E_ProblemFromRedPanda_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001188E_ProblemFromRedPanda));
        ...
        {
            bool result = CF_00001188E_ProblemFromRedPanda.Solution_0_Test(input);
