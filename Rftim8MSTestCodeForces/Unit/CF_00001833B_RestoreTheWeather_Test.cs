...
{
    [TestClass]
    public sealed class CF_00001833B_RestoreTheWeather_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001833B_RestoreTheWeather));
        ...
        {
            bool result = CF_00001833B_RestoreTheWeather.Solution_0_Test(input);
