...
{
    [TestClass]
    public sealed class CF_00001922B_FormingTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001922B_FormingTriangles));
        ...
        {
            bool result = CF_00001922B_FormingTriangles.Solution_0_Test(input);
