...
{
    [TestClass]
    public sealed class CF_00001253F_CheapRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001253F_CheapRobot));
        ...
        {
            bool result = CF_00001253F_CheapRobot.Solution_0_Test(input);
