...
{
    [TestClass]
    public sealed class CF_00000614A_LinkCutTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000614A_LinkCutTree));
        ...
        {
            bool result = CF_00000614A_LinkCutTree.Solution_0_Test(input);
