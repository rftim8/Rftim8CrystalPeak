...
{
    [TestClass]
    public sealed class CF_00001945H_GCDIsGreater_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001945H_GCDIsGreater));
        ...
        {
            bool result = CF_00001945H_GCDIsGreater.Solution_0_Test(input);
