...
{
    [TestClass]
    public sealed class CF_00001768F_WonderfulJump_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001768F_WonderfulJump));
        ...
        {
            bool result = CF_00001768F_WonderfulJump.Solution_0_Test(input);
