...
{
    [TestClass]
    public sealed class CF_00001806B_MexMaster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001806B_MexMaster));
        ...
        {
            bool result = CF_00001806B_MexMaster.Solution_0_Test(input);
