...
{
    [TestClass]
    public sealed class CF_00001741A_CompareTShirtSizes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001741A_CompareTShirtSizes));
        ...
        {
            bool result = CF_00001741A_CompareTShirtSizes.Solution_0_Test(input);
