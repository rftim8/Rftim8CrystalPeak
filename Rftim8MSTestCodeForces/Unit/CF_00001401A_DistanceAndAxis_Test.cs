...
{
    [TestClass]
    public sealed class CF_00001401A_DistanceAndAxis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001401A_DistanceAndAxis));
        ...
        {
            bool result = CF_00001401A_DistanceAndAxis.Solution_0_Test(input);
