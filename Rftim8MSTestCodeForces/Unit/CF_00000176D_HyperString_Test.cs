...
{
    [TestClass]
    public sealed class CF_00000176D_HyperString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000176D_HyperString));
        ...
        {
            bool result = CF_00000176D_HyperString.Solution_0_Test(input);
