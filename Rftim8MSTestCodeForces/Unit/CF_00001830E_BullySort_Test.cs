...
{
    [TestClass]
    public sealed class CF_00001830E_BullySort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001830E_BullySort));
        ...
        {
            bool result = CF_00001830E_BullySort.Solution_0_Test(input);
