...
{
    [TestClass]
    public sealed class CF_00000630F_SelectionOfPersonnel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630F_SelectionOfPersonnel));
        ...
        {
            bool result = CF_00000630F_SelectionOfPersonnel.Solution_0_Test(input);
