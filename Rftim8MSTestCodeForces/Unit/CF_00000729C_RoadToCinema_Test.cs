...
{
    [TestClass]
    public sealed class CF_00000729C_RoadToCinema_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000729C_RoadToCinema));
        ...
        {
            bool result = CF_00000729C_RoadToCinema.Solution_0_Test(input);
