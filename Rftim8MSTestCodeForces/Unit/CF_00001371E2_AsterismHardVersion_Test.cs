...
{
    [TestClass]
    public sealed class CF_00001371E2_AsterismHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001371E2_AsterismHardVersion));
        ...
        {
            bool result = CF_00001371E2_AsterismHardVersion.Solution_0_Test(input);
