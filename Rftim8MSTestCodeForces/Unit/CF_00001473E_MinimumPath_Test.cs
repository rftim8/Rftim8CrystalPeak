...
{
    [TestClass]
    public sealed class CF_00001473E_MinimumPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001473E_MinimumPath));
        ...
        {
            bool result = CF_00001473E_MinimumPath.Solution_0_Test(input);
