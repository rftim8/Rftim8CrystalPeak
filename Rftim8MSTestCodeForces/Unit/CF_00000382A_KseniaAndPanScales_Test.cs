...
{
    [TestClass]
    public sealed class CF_00000382A_KseniaAndPanScales_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000382A_KseniaAndPanScales));
        ...
        {
            bool result = CF_00000382A_KseniaAndPanScales.Solution_0_Test(input);
