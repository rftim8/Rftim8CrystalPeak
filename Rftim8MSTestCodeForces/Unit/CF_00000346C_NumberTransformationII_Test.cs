...
{
    [TestClass]
    public sealed class CF_00000346C_NumberTransformationII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000346C_NumberTransformationII));
        ...
        {
            bool result = CF_00000346C_NumberTransformationII.Solution_0_Test(input);
