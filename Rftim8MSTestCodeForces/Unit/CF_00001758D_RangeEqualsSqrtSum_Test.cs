...
{
    [TestClass]
    public sealed class CF_00001758D_RangeEqualsSqrtSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001758D_RangeEqualsSqrtSum));
        ...
        {
            bool result = CF_00001758D_RangeEqualsSqrtSum.Solution_0_Test(input);
