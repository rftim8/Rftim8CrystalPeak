...
{
    [TestClass]
    public sealed class CF_00000295A_GregAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000295A_GregAndArray));
        ...
        {
            bool result = CF_00000295A_GregAndArray.Solution_0_Test(input);
