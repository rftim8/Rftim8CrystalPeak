...
{
    [TestClass]
    public sealed class CF_00001042E_VasyaAndMagicMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001042E_VasyaAndMagicMatrix));
        ...
        {
            bool result = CF_00001042E_VasyaAndMagicMatrix.Solution_0_Test(input);
