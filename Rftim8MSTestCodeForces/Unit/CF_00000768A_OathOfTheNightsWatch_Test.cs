...
{
    [TestClass]
    public sealed class CF_00000768A_OathOfTheNightsWatch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000768A_OathOfTheNightsWatch));
        ...
        {
            bool result = CF_00000768A_OathOfTheNightsWatch.Solution_0_Test(input);
