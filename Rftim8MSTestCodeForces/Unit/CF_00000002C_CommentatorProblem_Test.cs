...
{
    [TestClass]
    public sealed class CF_00000002C_CommentatorProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000002C_CommentatorProblem));
        ...
        {
            bool result = CF_00000002C_CommentatorProblem.Solution_0_Test(input);
