...
{
    [TestClass]
    public sealed class CF_00001470F_StrangeCovering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001470F_StrangeCovering));
        ...
        {
            bool result = CF_00001470F_StrangeCovering.Solution_0_Test(input);
