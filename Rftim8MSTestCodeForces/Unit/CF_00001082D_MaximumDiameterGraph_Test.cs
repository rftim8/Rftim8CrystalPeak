...
{
    [TestClass]
    public sealed class CF_00001082D_MaximumDiameterGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001082D_MaximumDiameterGraph));
        ...
        {
            bool result = CF_00001082D_MaximumDiameterGraph.Solution_0_Test(input);
