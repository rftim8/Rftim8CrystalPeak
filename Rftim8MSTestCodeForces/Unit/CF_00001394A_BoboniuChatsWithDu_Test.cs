...
{
    [TestClass]
    public sealed class CF_00001394A_BoboniuChatsWithDu_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001394A_BoboniuChatsWithDu));
        ...
        {
            bool result = CF_00001394A_BoboniuChatsWithDu.Solution_0_Test(input);
