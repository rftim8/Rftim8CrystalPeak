...
{
    [TestClass]
    public sealed class CF_00001835C_TwinClusters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001835C_TwinClusters));
        ...
        {
            bool result = CF_00001835C_TwinClusters.Solution_0_Test(input);
