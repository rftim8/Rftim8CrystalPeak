...
{
    [TestClass]
    public sealed class CF_00000818E_CardGameAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000818E_CardGameAgain));
        ...
        {
            bool result = CF_00000818E_CardGameAgain.Solution_0_Test(input);
