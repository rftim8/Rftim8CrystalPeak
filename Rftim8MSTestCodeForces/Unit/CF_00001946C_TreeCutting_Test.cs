...
{
    [TestClass]
    public sealed class CF_00001946C_TreeCutting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001946C_TreeCutting));
        ...
        {
            bool result = CF_00001946C_TreeCutting.Solution_0_Test(input);
