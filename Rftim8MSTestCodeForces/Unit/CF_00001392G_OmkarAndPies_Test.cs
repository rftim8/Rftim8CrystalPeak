...
{
    [TestClass]
    public sealed class CF_00001392G_OmkarAndPies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001392G_OmkarAndPies));
        ...
        {
            bool result = CF_00001392G_OmkarAndPies.Solution_0_Test(input);
