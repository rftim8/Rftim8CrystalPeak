...
{
    [TestClass]
    public sealed class CF_00000379D_NewYearLetter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000379D_NewYearLetter));
        ...
        {
            bool result = CF_00000379D_NewYearLetter.Solution_0_Test(input);
