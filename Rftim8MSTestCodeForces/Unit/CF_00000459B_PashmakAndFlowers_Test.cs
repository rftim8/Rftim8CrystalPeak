...
{
    [TestClass]
    public sealed class CF_00000459B_PashmakAndFlowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000459B_PashmakAndFlowers));
        ...
        {
            bool result = CF_00000459B_PashmakAndFlowers.Solution_0_Test(input);
