...
{
    [TestClass]
    public sealed class CF_00000708A_LettersCyclicShift_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000708A_LettersCyclicShift));
        ...
        {
            bool result = CF_00000708A_LettersCyclicShift.Solution_0_Test(input);
