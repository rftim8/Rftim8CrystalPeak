...
{
    [TestClass]
    public sealed class CF_00001217E_SumQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001217E_SumQueries));
        ...
        {
            bool result = CF_00001217E_SumQueries.Solution_0_Test(input);
