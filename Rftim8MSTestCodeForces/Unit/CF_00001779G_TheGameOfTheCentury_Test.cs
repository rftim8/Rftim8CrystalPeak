...
{
    [TestClass]
    public sealed class CF_00001779G_TheGameOfTheCentury_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001779G_TheGameOfTheCentury));
        ...
        {
            bool result = CF_00001779G_TheGameOfTheCentury.Solution_0_Test(input);
