...
{
    [TestClass]
    public sealed class CF_00001799D2_HotStartUpHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001799D2_HotStartUpHardVersion));
        ...
        {
            bool result = CF_00001799D2_HotStartUpHardVersion.Solution_0_Test(input);
