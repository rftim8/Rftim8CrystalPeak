...
{
    [TestClass]
    public sealed class CF_00000492B_VanyaAndLanterns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000492B_VanyaAndLanterns));
        ...
        {
            bool result = CF_00000492B_VanyaAndLanterns.Solution_0_Test(input);
