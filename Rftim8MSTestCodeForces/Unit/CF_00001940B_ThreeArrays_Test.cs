...
{
    [TestClass]
    public sealed class CF_00001940B_ThreeArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001940B_ThreeArrays));
        ...
        {
            bool result = CF_00001940B_ThreeArrays.Solution_0_Test(input);
