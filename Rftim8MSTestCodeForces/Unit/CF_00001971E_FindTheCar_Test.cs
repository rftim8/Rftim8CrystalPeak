...
{
    [TestClass]
    public sealed class CF_00001971E_FindTheCar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001971E_FindTheCar));
        ...
        {
            bool result = CF_00001971E_FindTheCar.Solution_0_Test(input);
