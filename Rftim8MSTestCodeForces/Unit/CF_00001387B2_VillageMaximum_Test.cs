...
{
    [TestClass]
    public sealed class CF_00001387B2_VillageMaximum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001387B2_VillageMaximum));
        ...
        {
            bool result = CF_00001387B2_VillageMaximum.Solution_0_Test(input);
