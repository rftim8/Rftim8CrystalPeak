...
{
    [TestClass]
    public sealed class CF_00001926G_VladAndTroubleAtMIT_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001926G_VladAndTroubleAtMIT));
        ...
        {
            bool result = CF_00001926G_VladAndTroubleAtMIT.Solution_0_Test(input);
