...
{
    [TestClass]
    public sealed class CF_00001794D_CountingFactorizations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001794D_CountingFactorizations));
        ...
        {
            bool result = CF_00001794D_CountingFactorizations.Solution_0_Test(input);
