...
{
    [TestClass]
    public sealed class CF_00001646D_WeightTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001646D_WeightTheTree));
        ...
        {
            bool result = CF_00001646D_WeightTheTree.Solution_0_Test(input);
