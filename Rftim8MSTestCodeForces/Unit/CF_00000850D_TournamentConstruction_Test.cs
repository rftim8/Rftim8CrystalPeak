...
{
    [TestClass]
    public sealed class CF_00000850D_TournamentConstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000850D_TournamentConstruction));
        ...
        {
            bool result = CF_00000850D_TournamentConstruction.Solution_0_Test(input);
