...
{
    [TestClass]
    public sealed class CF_00001539C_StableGroups_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001539C_StableGroups));
        ...
        {
            bool result = CF_00001539C_StableGroups.Solution_0_Test(input);
