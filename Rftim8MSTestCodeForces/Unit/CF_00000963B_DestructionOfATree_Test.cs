...
{
    [TestClass]
    public sealed class CF_00000963B_DestructionOfATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000963B_DestructionOfATree));
        ...
        {
            bool result = CF_00000963B_DestructionOfATree.Solution_0_Test(input);
