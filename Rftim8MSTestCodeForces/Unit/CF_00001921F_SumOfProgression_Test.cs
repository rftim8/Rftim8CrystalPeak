...
{
    [TestClass]
    public sealed class CF_00001921F_SumOfProgression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001921F_SumOfProgression));
        ...
        {
            bool result = CF_00001921F_SumOfProgression.Solution_0_Test(input);
