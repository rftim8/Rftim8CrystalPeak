...
{
    [TestClass]
    public sealed class CF_00001051C_VasyaAndMultisets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001051C_VasyaAndMultisets));
        ...
        {
            bool result = CF_00001051C_VasyaAndMultisets.Solution_0_Test(input);
