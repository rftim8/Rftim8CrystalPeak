...
{
    [TestClass]
    public sealed class CF_00000567C_GeometricProgression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000567C_GeometricProgression));
        ...
        {
            bool result = CF_00000567C_GeometricProgression.Solution_0_Test(input);
