...
{
    [TestClass]
    public sealed class CF_00000898A_Rounding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000898A_Rounding));
        ...
        {
            bool result = CF_00000898A_Rounding.Solution_0_Test(input);
