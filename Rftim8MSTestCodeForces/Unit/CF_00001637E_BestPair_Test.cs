...
{
    [TestClass]
    public sealed class CF_00001637E_BestPair_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001637E_BestPair));
        ...
        {
            bool result = CF_00001637E_BestPair.Solution_0_Test(input);
