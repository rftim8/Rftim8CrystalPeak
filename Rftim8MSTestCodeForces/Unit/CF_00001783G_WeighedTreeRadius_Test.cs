...
{
    [TestClass]
    public sealed class CF_00001783G_WeighedTreeRadius_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001783G_WeighedTreeRadius));
        ...
        {
            bool result = CF_00001783G_WeighedTreeRadius.Solution_0_Test(input);
