...
{
    [TestClass]
    public sealed class CF_00001326B_Maximums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001326B_Maximums));
        ...
        {
            bool result = CF_00001326B_Maximums.Solution_0_Test(input);
