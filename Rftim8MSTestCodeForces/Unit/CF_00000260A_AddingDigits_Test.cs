...
{
    [TestClass]
    public sealed class CF_00000260A_AddingDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000260A_AddingDigits));
        ...
        {
            bool result = CF_00000260A_AddingDigits.Solution_0_Test(input);
