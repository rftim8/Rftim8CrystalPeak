...
{
    [TestClass]
    public sealed class CF_00001080A_PetyaAndOrigami_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001080A_PetyaAndOrigami));
        ...
        {
            bool result = CF_00001080A_PetyaAndOrigami.Solution_0_Test(input);
