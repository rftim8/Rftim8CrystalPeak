...
{
    [TestClass]
    public sealed class CF_00001530F_Bingo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001530F_Bingo));
        ...
        {
            bool result = CF_00001530F_Bingo.Solution_0_Test(input);
