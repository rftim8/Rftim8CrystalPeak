...
{
    [TestClass]
    public sealed class CF_00001494A_ABCString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001494A_ABCString));
        ...
        {
            bool result = CF_00001494A_ABCString.Solution_0_Test(input);
