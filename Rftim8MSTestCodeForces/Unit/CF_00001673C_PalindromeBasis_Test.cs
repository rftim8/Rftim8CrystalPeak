...
{
    [TestClass]
    public sealed class CF_00001673C_PalindromeBasis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001673C_PalindromeBasis));
        ...
        {
            bool result = CF_00001673C_PalindromeBasis.Solution_0_Test(input);
