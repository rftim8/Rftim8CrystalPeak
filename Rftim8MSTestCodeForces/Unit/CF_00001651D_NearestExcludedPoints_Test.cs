...
{
    [TestClass]
    public sealed class CF_00001651D_NearestExcludedPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001651D_NearestExcludedPoints));
        ...
        {
            bool result = CF_00001651D_NearestExcludedPoints.Solution_0_Test(input);
