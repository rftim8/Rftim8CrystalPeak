...
{
    [TestClass]
    public sealed class CF_00001225C_Pbinary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001225C_Pbinary));
        ...
        {
            bool result = CF_00001225C_Pbinary.Solution_0_Test(input);
