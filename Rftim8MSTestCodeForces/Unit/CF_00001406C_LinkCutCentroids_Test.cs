...
{
    [TestClass]
    public sealed class CF_00001406C_LinkCutCentroids_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001406C_LinkCutCentroids));
        ...
        {
            bool result = CF_00001406C_LinkCutCentroids.Solution_0_Test(input);
