...
{
    [TestClass]
    public sealed class CF_00001605A_AMDeviation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001605A_AMDeviation));
        ...
        {
            bool result = CF_00001605A_AMDeviation.Solution_0_Test(input);
