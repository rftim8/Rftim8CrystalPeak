...
{
    [TestClass]
    public sealed class CF_00000067C_SequenceOfBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000067C_SequenceOfBalls));
        ...
        {
            bool result = CF_00000067C_SequenceOfBalls.Solution_0_Test(input);
