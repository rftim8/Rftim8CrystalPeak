...
{
    [TestClass]
    public sealed class CF_00001598G_TheSumOfGoodNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001598G_TheSumOfGoodNumbers));
        ...
        {
            bool result = CF_00001598G_TheSumOfGoodNumbers.Solution_0_Test(input);
