...
{
    [TestClass]
    public sealed class CF_00000625C_KspecialTables_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000625C_KspecialTables));
        ...
        {
            bool result = CF_00000625C_KspecialTables.Solution_0_Test(input);
