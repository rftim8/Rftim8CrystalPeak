...
{
    [TestClass]
    public sealed class CF_00001304C_AirConditioner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001304C_AirConditioner));
        ...
        {
            bool result = CF_00001304C_AirConditioner.Solution_0_Test(input);
