...
{
    [TestClass]
    public sealed class CF_00001184A1_HeidiLearnsHashingEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001184A1_HeidiLearnsHashingEasy));
        ...
        {
            bool result = CF_00001184A1_HeidiLearnsHashingEasy.Solution_0_Test(input);
