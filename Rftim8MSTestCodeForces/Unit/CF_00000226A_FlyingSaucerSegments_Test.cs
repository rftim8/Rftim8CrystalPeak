...
{
    [TestClass]
    public sealed class CF_00000226A_FlyingSaucerSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000226A_FlyingSaucerSegments));
        ...
        {
            bool result = CF_00000226A_FlyingSaucerSegments.Solution_0_Test(input);
