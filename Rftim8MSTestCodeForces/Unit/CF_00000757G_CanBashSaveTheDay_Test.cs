...
{
    [TestClass]
    public sealed class CF_00000757G_CanBashSaveTheDay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000757G_CanBashSaveTheDay));
        ...
        {
            bool result = CF_00000757G_CanBashSaveTheDay.Solution_0_Test(input);
