...
{
    [TestClass]
    public sealed class CF_00000842E_NikitaAndGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000842E_NikitaAndGame));
        ...
        {
            bool result = CF_00000842E_NikitaAndGame.Solution_0_Test(input);
