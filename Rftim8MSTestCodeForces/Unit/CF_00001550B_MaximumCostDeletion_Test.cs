...
{
    [TestClass]
    public sealed class CF_00001550B_MaximumCostDeletion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001550B_MaximumCostDeletion));
        ...
        {
            bool result = CF_00001550B_MaximumCostDeletion.Solution_0_Test(input);
