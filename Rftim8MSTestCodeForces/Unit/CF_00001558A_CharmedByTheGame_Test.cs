...
{
    [TestClass]
    public sealed class CF_00001558A_CharmedByTheGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001558A_CharmedByTheGame));
        ...
        {
            bool result = CF_00001558A_CharmedByTheGame.Solution_0_Test(input);
