...
{
    [TestClass]
    public sealed class CF_00001223D_SequenceSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001223D_SequenceSorting));
        ...
        {
            bool result = CF_00001223D_SequenceSorting.Solution_0_Test(input);
