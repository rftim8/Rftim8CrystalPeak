...
{
    [TestClass]
    public sealed class CF_00000798C_MikeAndGcdProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000798C_MikeAndGcdProblem));
        ...
        {
            bool result = CF_00000798C_MikeAndGcdProblem.Solution_0_Test(input);
