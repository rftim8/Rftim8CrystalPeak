...
{
    [TestClass]
    public sealed class CF_00001442A_ExtremeSubtraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001442A_ExtremeSubtraction));
        ...
        {
            bool result = CF_00001442A_ExtremeSubtraction.Solution_0_Test(input);
