...
{
    [TestClass]
    public sealed class CF_00002032F_Peanuts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002032F_Peanuts));
        ...
        {
            bool result = CF_00002032F_Peanuts.Solution_0_Test(input);
