...
{
    [TestClass]
    public sealed class CF_00000072E_AliGoesShopping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000072E_AliGoesShopping));
        ...
        {
            bool result = CF_00000072E_AliGoesShopping.Solution_0_Test(input);
