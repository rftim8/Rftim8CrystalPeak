...
{
    [TestClass]
    public sealed class CF_00000162A_PentagonalNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000162A_PentagonalNumbers));
        ...
        {
            bool result = CF_00000162A_PentagonalNumbers.Solution_0_Test(input);
