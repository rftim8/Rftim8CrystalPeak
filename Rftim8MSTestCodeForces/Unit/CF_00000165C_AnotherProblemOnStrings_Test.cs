...
{
    [TestClass]
    public sealed class CF_00000165C_AnotherProblemOnStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000165C_AnotherProblemOnStrings));
        ...
        {
            bool result = CF_00000165C_AnotherProblemOnStrings.Solution_0_Test(input);
