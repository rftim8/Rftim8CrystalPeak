...
{
    [TestClass]
    public sealed class CF_00000045J_PlantingTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000045J_PlantingTrees));
        ...
        {
            bool result = CF_00000045J_PlantingTrees.Solution_0_Test(input);
