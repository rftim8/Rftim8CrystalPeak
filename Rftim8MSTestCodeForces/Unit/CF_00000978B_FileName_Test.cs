...
{
    [TestClass]
    public sealed class CF_00000978B_FileName_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000978B_FileName));
        ...
        {
            bool result = CF_00000978B_FileName.Solution_0_Test(input);
