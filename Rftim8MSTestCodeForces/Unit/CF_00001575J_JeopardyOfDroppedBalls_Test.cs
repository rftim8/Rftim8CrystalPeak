...
{
    [TestClass]
    public sealed class CF_00001575J_JeopardyOfDroppedBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575J_JeopardyOfDroppedBalls));
        ...
        {
            bool result = CF_00001575J_JeopardyOfDroppedBalls.Solution_0_Test(input);
