...
{
    [TestClass]
    public sealed class CF_00001622A_ConstructARectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001622A_ConstructARectangle));
        ...
        {
            bool result = CF_00001622A_ConstructARectangle.Solution_0_Test(input);
