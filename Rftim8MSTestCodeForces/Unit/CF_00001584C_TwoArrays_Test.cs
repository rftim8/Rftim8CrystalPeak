...
{
    [TestClass]
    public sealed class CF_00001584C_TwoArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001584C_TwoArrays));
        ...
        {
            bool result = CF_00001584C_TwoArrays.Solution_0_Test(input);
