...
{
    [TestClass]
    public sealed class CF_00001141D_ColoredBoots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001141D_ColoredBoots));
        ...
        {
            bool result = CF_00001141D_ColoredBoots.Solution_0_Test(input);
