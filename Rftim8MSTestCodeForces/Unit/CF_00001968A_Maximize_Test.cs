...
{
    [TestClass]
    public sealed class CF_00001968A_Maximize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001968A_Maximize));
        ...
        {
            bool result = CF_00001968A_Maximize.Solution_0_Test(input);
