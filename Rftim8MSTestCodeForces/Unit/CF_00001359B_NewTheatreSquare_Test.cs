...
{
    [TestClass]
    public sealed class CF_00001359B_NewTheatreSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001359B_NewTheatreSquare));
        ...
        {
            bool result = CF_00001359B_NewTheatreSquare.Solution_0_Test(input);
