...
{
    [TestClass]
    public sealed class CF_00001166B_AllTheVowelsPlease_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001166B_AllTheVowelsPlease));
        ...
        {
            bool result = CF_00001166B_AllTheVowelsPlease.Solution_0_Test(input);
