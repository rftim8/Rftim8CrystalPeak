...
{
    [TestClass]
    public sealed class CF_00000128C_GamesWithRectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000128C_GamesWithRectangle));
        ...
        {
            bool result = CF_00000128C_GamesWithRectangle.Solution_0_Test(input);
