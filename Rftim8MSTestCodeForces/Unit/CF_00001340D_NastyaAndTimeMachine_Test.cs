...
{
    [TestClass]
    public sealed class CF_00001340D_NastyaAndTimeMachine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001340D_NastyaAndTimeMachine));
        ...
        {
            bool result = CF_00001340D_NastyaAndTimeMachine.Solution_0_Test(input);
