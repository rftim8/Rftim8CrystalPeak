...
{
    [TestClass]
    public sealed class CF_00001413F_RoadsAndRamen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001413F_RoadsAndRamen));
        ...
        {
            bool result = CF_00001413F_RoadsAndRamen.Solution_0_Test(input);
