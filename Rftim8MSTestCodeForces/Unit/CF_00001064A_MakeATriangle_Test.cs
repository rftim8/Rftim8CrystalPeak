...
{
    [TestClass]
    public sealed class CF_00001064A_MakeATriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001064A_MakeATriangle));
        ...
        {
            bool result = CF_00001064A_MakeATriangle.Solution_0_Test(input);
