...
{
    [TestClass]
    public sealed class CF_00000827A_StringReconstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000827A_StringReconstruction));
        ...
        {
            bool result = CF_00000827A_StringReconstruction.Solution_0_Test(input);
