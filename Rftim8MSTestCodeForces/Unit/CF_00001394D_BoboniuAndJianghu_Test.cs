...
{
    [TestClass]
    public sealed class CF_00001394D_BoboniuAndJianghu_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001394D_BoboniuAndJianghu));
        ...
        {
            bool result = CF_00001394D_BoboniuAndJianghu.Solution_0_Test(input);
