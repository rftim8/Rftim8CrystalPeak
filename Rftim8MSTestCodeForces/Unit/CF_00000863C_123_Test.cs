...
{
    [TestClass]
    public sealed class CF_00000863C_123_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000863C_123));
        ...
        {
            bool result = CF_00000863C_123.Solution_0_Test(input);
