...
{
    [TestClass]
    public sealed class CF_00000105A_Transmigration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000105A_Transmigration));
        ...
        {
            bool result = CF_00000105A_Transmigration.Solution_0_Test(input);
