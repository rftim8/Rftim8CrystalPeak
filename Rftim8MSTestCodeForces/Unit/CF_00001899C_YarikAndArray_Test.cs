...
{
    [TestClass]
    public sealed class CF_00001899C_YarikAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001899C_YarikAndArray));
        ...
        {
            bool result = CF_00001899C_YarikAndArray.Solution_0_Test(input);
