...
{
    [TestClass]
    public sealed class CF_00000730L_ExpressionQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730L_ExpressionQueries));
        ...
        {
            bool result = CF_00000730L_ExpressionQueries.Solution_0_Test(input);
