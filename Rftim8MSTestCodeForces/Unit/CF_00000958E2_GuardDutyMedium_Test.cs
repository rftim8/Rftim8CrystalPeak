...
{
    [TestClass]
    public sealed class CF_00000958E2_GuardDutyMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958E2_GuardDutyMedium));
        ...
        {
            bool result = CF_00000958E2_GuardDutyMedium.Solution_0_Test(input);
