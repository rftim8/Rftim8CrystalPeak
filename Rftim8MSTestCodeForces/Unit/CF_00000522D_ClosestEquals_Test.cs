...
{
    [TestClass]
    public sealed class CF_00000522D_ClosestEquals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000522D_ClosestEquals));
        ...
        {
            bool result = CF_00000522D_ClosestEquals.Solution_0_Test(input);
