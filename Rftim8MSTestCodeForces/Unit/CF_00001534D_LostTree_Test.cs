...
{
    [TestClass]
    public sealed class CF_00001534D_LostTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001534D_LostTree));
        ...
        {
            bool result = CF_00001534D_LostTree.Solution_0_Test(input);
