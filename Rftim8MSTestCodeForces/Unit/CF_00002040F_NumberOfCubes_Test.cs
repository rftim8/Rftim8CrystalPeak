...
{
    [TestClass]
    public sealed class CF_00002040F_NumberOfCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002040F_NumberOfCubes));
        ...
        {
            bool result = CF_00002040F_NumberOfCubes.Solution_0_Test(input);
