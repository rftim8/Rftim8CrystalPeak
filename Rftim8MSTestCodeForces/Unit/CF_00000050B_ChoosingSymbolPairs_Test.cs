...
{
    [TestClass]
    public sealed class CF_00000050B_ChoosingSymbolPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000050B_ChoosingSymbolPairs));
        ...
        {
            bool result = CF_00000050B_ChoosingSymbolPairs.Solution_0_Test(input);
