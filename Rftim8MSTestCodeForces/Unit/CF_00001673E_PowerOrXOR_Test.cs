...
{
    [TestClass]
    public sealed class CF_00001673E_PowerOrXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001673E_PowerOrXOR));
        ...
        {
            bool result = CF_00001673E_PowerOrXOR.Solution_0_Test(input);
