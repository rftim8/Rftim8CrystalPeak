...
{
    [TestClass]
    public sealed class CF_00001881E_BlockSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001881E_BlockSequence));
        ...
        {
            bool result = CF_00001881E_BlockSequence.Solution_0_Test(input);
