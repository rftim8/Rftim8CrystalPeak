...
{
    [TestClass]
    public sealed class CF_00000702B_PowersOfTwo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000702B_PowersOfTwo));
        ...
        {
            bool result = CF_00000702B_PowersOfTwo.Solution_0_Test(input);
