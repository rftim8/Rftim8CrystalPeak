...
{
    [TestClass]
    public sealed class CF_00000797B_OddSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000797B_OddSum));
        ...
        {
            bool result = CF_00000797B_OddSum.Solution_0_Test(input);
