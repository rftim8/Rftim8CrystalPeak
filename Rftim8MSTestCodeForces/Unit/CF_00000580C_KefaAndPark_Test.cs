...
{
    [TestClass]
    public sealed class CF_00000580C_KefaAndPark_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000580C_KefaAndPark));
        ...
        {
            bool result = CF_00000580C_KefaAndPark.Solution_0_Test(input);
