...
{
    [TestClass]
    public sealed class CF_00001917F_ConstructTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001917F_ConstructTree));
        ...
        {
            bool result = CF_00001917F_ConstructTree.Solution_0_Test(input);
