...
{
    [TestClass]
    public sealed class CF_00000628A_TennisTournament_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000628A_TennisTournament));
        ...
        {
            bool result = CF_00000628A_TennisTournament.Solution_0_Test(input);
