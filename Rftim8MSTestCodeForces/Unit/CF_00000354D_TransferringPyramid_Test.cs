...
{
    [TestClass]
    public sealed class CF_00000354D_TransferringPyramid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000354D_TransferringPyramid));
        ...
        {
            bool result = CF_00000354D_TransferringPyramid.Solution_0_Test(input);
