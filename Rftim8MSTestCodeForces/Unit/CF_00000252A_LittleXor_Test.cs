...
{
    [TestClass]
    public sealed class CF_00000252A_LittleXor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000252A_LittleXor));
        ...
        {
            bool result = CF_00000252A_LittleXor.Solution_0_Test(input);
