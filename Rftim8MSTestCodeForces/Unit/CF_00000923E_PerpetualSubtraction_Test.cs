...
{
    [TestClass]
    public sealed class CF_00000923E_PerpetualSubtraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000923E_PerpetualSubtraction));
        ...
        {
            bool result = CF_00000923E_PerpetualSubtraction.Solution_0_Test(input);
