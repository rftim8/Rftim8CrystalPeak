...
{
    [TestClass]
    public sealed class CF_00001666I_InteractiveTreasureHunt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001666I_InteractiveTreasureHunt));
        ...
        {
            bool result = CF_00001666I_InteractiveTreasureHunt.Solution_0_Test(input);
