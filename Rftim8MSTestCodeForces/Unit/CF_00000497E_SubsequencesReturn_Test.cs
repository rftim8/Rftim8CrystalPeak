...
{
    [TestClass]
    public sealed class CF_00000497E_SubsequencesReturn_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000497E_SubsequencesReturn));
        ...
        {
            bool result = CF_00000497E_SubsequencesReturn.Solution_0_Test(input);
