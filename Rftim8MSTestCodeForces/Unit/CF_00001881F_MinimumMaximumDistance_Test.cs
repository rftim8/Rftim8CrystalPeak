...
{
    [TestClass]
    public sealed class CF_00001881F_MinimumMaximumDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001881F_MinimumMaximumDistance));
        ...
        {
            bool result = CF_00001881F_MinimumMaximumDistance.Solution_0_Test(input);
