...
{
    [TestClass]
    public sealed class CF_00000463E_CaisaAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000463E_CaisaAndTree));
        ...
        {
            bool result = CF_00000463E_CaisaAndTree.Solution_0_Test(input);
