...
{
    [TestClass]
    public sealed class CF_00000977A_WrongSubtraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000977A_WrongSubtraction));
        ...
        {
            bool result = CF_00000977A_WrongSubtraction.Solution_0_Test(input);
