...
{
    [TestClass]
    public sealed class CF_00000847G_UniversityClasses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847G_UniversityClasses));
        ...
        {
            bool result = CF_00000847G_UniversityClasses.Solution_0_Test(input);
