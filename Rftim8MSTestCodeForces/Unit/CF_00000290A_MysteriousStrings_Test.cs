...
{
    [TestClass]
    public sealed class CF_00000290A_MysteriousStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000290A_MysteriousStrings));
        ...
        {
            bool result = CF_00000290A_MysteriousStrings.Solution_0_Test(input);
