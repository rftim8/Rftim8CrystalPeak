...
{
    [TestClass]
    public sealed class CF_00001628D2_GameOnSumHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001628D2_GameOnSumHardVersion));
        ...
        {
            bool result = CF_00001628D2_GameOnSumHardVersion.Solution_0_Test(input);
