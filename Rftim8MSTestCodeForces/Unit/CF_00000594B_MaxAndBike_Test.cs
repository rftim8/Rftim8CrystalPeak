...
{
    [TestClass]
    public sealed class CF_00000594B_MaxAndBike_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000594B_MaxAndBike));
        ...
        {
            bool result = CF_00000594B_MaxAndBike.Solution_0_Test(input);
