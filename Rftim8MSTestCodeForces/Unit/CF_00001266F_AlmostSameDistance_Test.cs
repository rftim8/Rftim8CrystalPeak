...
{
    [TestClass]
    public sealed class CF_00001266F_AlmostSameDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001266F_AlmostSameDistance));
        ...
        {
            bool result = CF_00001266F_AlmostSameDistance.Solution_0_Test(input);
