...
{
    [TestClass]
    public sealed class CF_00002035C_AlyaAndPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002035C_AlyaAndPermutation));
        ...
        {
            bool result = CF_00002035C_AlyaAndPermutation.Solution_0_Test(input);
