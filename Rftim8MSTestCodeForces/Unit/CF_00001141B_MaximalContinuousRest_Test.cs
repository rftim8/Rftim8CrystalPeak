...
{
    [TestClass]
    public sealed class CF_00001141B_MaximalContinuousRest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001141B_MaximalContinuousRest));
        ...
        {
            bool result = CF_00001141B_MaximalContinuousRest.Solution_0_Test(input);
