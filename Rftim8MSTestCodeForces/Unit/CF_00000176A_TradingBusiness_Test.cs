...
{
    [TestClass]
    public sealed class CF_00000176A_TradingBusiness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000176A_TradingBusiness));
        ...
        {
            bool result = CF_00000176A_TradingBusiness.Solution_0_Test(input);
