...
{
    [TestClass]
    public sealed class CF_00001695A_SubrectangleGuess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001695A_SubrectangleGuess));
        ...
        {
            bool result = CF_00001695A_SubrectangleGuess.Solution_0_Test(input);
