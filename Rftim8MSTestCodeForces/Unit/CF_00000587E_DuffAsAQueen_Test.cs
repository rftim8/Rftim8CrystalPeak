...
{
    [TestClass]
    public sealed class CF_00000587E_DuffAsAQueen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000587E_DuffAsAQueen));
        ...
        {
            bool result = CF_00000587E_DuffAsAQueen.Solution_0_Test(input);
