...
{
    [TestClass]
    public sealed class CF_00000306D_Polygon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000306D_Polygon));
        ...
        {
            bool result = CF_00000306D_Polygon.Solution_0_Test(input);
