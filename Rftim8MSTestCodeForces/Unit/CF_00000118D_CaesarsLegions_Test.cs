...
{
    [TestClass]
    public sealed class CF_00000118D_CaesarsLegions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000118D_CaesarsLegions));
        ...
        {
            bool result = CF_00000118D_CaesarsLegions.Solution_0_Test(input);
