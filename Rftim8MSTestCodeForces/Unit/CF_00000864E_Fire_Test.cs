...
{
    [TestClass]
    public sealed class CF_00000864E_Fire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000864E_Fire));
        ...
        {
            bool result = CF_00000864E_Fire.Solution_0_Test(input);
