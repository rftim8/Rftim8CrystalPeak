...
{
    [TestClass]
    public sealed class CF_00001348A_PhoenixAndBalance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001348A_PhoenixAndBalance));
        ...
        {
            bool result = CF_00001348A_PhoenixAndBalance.Solution_0_Test(input);
