...
{
    [TestClass]
    public sealed class CF_00002021D_BossThirsty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002021D_BossThirsty));
        ...
        {
            bool result = CF_00002021D_BossThirsty.Solution_0_Test(input);
