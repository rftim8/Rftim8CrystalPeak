...
{
    [TestClass]
    public sealed class CF_00000250D_BuildingBridge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000250D_BuildingBridge));
        ...
        {
            bool result = CF_00000250D_BuildingBridge.Solution_0_Test(input);
