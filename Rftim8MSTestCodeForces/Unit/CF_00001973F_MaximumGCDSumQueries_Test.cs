...
{
    [TestClass]
    public sealed class CF_00001973F_MaximumGCDSumQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001973F_MaximumGCDSumQueries));
        ...
        {
            bool result = CF_00001973F_MaximumGCDSumQueries.Solution_0_Test(input);
