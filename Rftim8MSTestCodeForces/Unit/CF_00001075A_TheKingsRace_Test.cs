...
{
    [TestClass]
    public sealed class CF_00001075A_TheKingsRace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001075A_TheKingsRace));
        ...
        {
            bool result = CF_00001075A_TheKingsRace.Solution_0_Test(input);
