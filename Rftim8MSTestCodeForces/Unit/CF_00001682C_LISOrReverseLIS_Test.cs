...
{
    [TestClass]
    public sealed class CF_00001682C_LISOrReverseLIS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001682C_LISOrReverseLIS));
        ...
        {
            bool result = CF_00001682C_LISOrReverseLIS.Solution_0_Test(input);
