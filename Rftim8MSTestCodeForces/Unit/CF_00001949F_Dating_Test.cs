...
{
    [TestClass]
    public sealed class CF_00001949F_Dating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001949F_Dating));
        ...
        {
            bool result = CF_00001949F_Dating.Solution_0_Test(input);
