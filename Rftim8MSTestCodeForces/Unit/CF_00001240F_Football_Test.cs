...
{
    [TestClass]
    public sealed class CF_00001240F_Football_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001240F_Football));
        ...
        {
            bool result = CF_00001240F_Football.Solution_0_Test(input);
