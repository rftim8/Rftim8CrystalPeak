...
{
    [TestClass]
    public sealed class CF_00000246E_BloodCousinsReturn_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000246E_BloodCousinsReturn));
        ...
        {
            bool result = CF_00000246E_BloodCousinsReturn.Solution_0_Test(input);
