...
{
    [TestClass]
    public sealed class CF_00000008D_TwoFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000008D_TwoFriends));
        ...
        {
            bool result = CF_00000008D_TwoFriends.Solution_0_Test(input);
