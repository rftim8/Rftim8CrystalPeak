...
{
    [TestClass]
    public sealed class CF_00001789B_ServalAndInversionMagic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001789B_ServalAndInversionMagic));
        ...
        {
            bool result = CF_00001789B_ServalAndInversionMagic.Solution_0_Test(input);
