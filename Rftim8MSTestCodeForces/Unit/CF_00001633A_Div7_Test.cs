...
{
    [TestClass]
    public sealed class CF_00001633A_Div7_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001633A_Div7));
        ...
        {
            bool result = CF_00001633A_Div7.Solution_0_Test(input);
