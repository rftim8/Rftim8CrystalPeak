...
{
    [TestClass]
    public sealed class CF_00001861C_QueriesForTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001861C_QueriesForTheArray));
        ...
        {
            bool result = CF_00001861C_QueriesForTheArray.Solution_0_Test(input);
