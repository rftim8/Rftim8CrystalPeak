...
{
    [TestClass]
    public sealed class CF_00000859D_ThirdMonthInsanity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000859D_ThirdMonthInsanity));
        ...
        {
            bool result = CF_00000859D_ThirdMonthInsanity.Solution_0_Test(input);
