...
{
    [TestClass]
    public sealed class CF_00000580B_KefaAndCompany_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000580B_KefaAndCompany));
        ...
        {
            bool result = CF_00000580B_KefaAndCompany.Solution_0_Test(input);
