...
{
    [TestClass]
    public sealed class CF_00000234H_MergingTwoDecks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000234H_MergingTwoDecks));
        ...
        {
            bool result = CF_00000234H_MergingTwoDecks.Solution_0_Test(input);
