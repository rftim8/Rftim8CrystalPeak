...
{
    [TestClass]
    public sealed class CF_00001681D_RequiredLength_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001681D_RequiredLength));
        ...
        {
            bool result = CF_00001681D_RequiredLength.Solution_0_Test(input);
