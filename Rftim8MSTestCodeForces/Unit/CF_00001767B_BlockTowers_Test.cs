...
{
    [TestClass]
    public sealed class CF_00001767B_BlockTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001767B_BlockTowers));
        ...
        {
            bool result = CF_00001767B_BlockTowers.Solution_0_Test(input);
