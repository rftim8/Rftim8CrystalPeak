...
{
    [TestClass]
    public sealed class CF_00001692F_3SUM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001692F_3SUM));
        ...
        {
            bool result = CF_00001692F_3SUM.Solution_0_Test(input);
