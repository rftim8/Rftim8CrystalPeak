...
{
    [TestClass]
    public sealed class CF_00001862E_KolyaAndMovieTheatre_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001862E_KolyaAndMovieTheatre));
        ...
        {
            bool result = CF_00001862E_KolyaAndMovieTheatre.Solution_0_Test(input);
