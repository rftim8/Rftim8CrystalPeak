...
{
    [TestClass]
    public sealed class CF_00001743D_ProblemWithRandomTests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001743D_ProblemWithRandomTests));
        ...
        {
            bool result = CF_00001743D_ProblemWithRandomTests.Solution_0_Test(input);
