...
{
    [TestClass]
    public sealed class CF_00000867A_BetweenTheOffices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000867A_BetweenTheOffices));
        ...
        {
            bool result = CF_00000867A_BetweenTheOffices.Solution_0_Test(input);
