...
{
    [TestClass]
    public sealed class CF_00000407E_Kdsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000407E_Kdsequence));
        ...
        {
            bool result = CF_00000407E_Kdsequence.Solution_0_Test(input);
