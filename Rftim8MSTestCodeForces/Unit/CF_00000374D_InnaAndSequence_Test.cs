...
{
    [TestClass]
    public sealed class CF_00000374D_InnaAndSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000374D_InnaAndSequence));
        ...
        {
            bool result = CF_00000374D_InnaAndSequence.Solution_0_Test(input);
