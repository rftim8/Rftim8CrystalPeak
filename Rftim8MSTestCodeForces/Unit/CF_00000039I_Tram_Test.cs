...
{
    [TestClass]
    public sealed class CF_00000039I_Tram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000039I_Tram));
        ...
        {
            bool result = CF_00000039I_Tram.Solution_0_Test(input);
