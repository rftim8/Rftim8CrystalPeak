...
{
    [TestClass]
    public sealed class CF_00001984H_TowerCapturing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001984H_TowerCapturing));
        ...
        {
            bool result = CF_00001984H_TowerCapturing.Solution_0_Test(input);
