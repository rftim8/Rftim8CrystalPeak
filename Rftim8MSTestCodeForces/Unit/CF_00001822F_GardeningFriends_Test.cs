...
{
    [TestClass]
    public sealed class CF_00001822F_GardeningFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001822F_GardeningFriends));
        ...
        {
            bool result = CF_00001822F_GardeningFriends.Solution_0_Test(input);
