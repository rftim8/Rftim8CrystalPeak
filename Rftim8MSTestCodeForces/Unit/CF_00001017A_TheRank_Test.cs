...
{
    [TestClass]
    public sealed class CF_00001017A_TheRank_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001017A_TheRank));
        ...
        {
            bool result = CF_00001017A_TheRank.Solution_0_Test(input);
