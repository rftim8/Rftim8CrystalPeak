...
{
    [TestClass]
    public sealed class CF_00000225C_Barcode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000225C_Barcode));
        ...
        {
            bool result = CF_00000225C_Barcode.Solution_0_Test(input);
