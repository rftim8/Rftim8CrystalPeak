...
{
    [TestClass]
    public sealed class CF_00000865D_BuyLowSellHigh_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000865D_BuyLowSellHigh));
        ...
        {
            bool result = CF_00000865D_BuyLowSellHigh.Solution_0_Test(input);
