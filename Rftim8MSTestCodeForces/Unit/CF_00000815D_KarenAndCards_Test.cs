...
{
    [TestClass]
    public sealed class CF_00000815D_KarenAndCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000815D_KarenAndCards));
        ...
        {
            bool result = CF_00000815D_KarenAndCards.Solution_0_Test(input);
