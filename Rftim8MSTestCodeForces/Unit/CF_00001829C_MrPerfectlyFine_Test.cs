...
{
    [TestClass]
    public sealed class CF_00001829C_MrPerfectlyFine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001829C_MrPerfectlyFine));
        ...
        {
            bool result = CF_00001829C_MrPerfectlyFine.Solution_0_Test(input);
