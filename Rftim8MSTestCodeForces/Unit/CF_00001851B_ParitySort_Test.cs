...
{
    [TestClass]
    public sealed class CF_00001851B_ParitySort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001851B_ParitySort));
        ...
        {
            bool result = CF_00001851B_ParitySort.Solution_0_Test(input);
