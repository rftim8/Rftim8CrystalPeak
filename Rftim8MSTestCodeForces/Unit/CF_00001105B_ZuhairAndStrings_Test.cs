...
{
    [TestClass]
    public sealed class CF_00001105B_ZuhairAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001105B_ZuhairAndStrings));
        ...
        {
            bool result = CF_00001105B_ZuhairAndStrings.Solution_0_Test(input);
