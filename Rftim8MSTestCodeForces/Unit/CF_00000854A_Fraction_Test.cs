...
{
    [TestClass]
    public sealed class CF_00000854A_Fraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000854A_Fraction));
        ...
        {
            bool result = CF_00000854A_Fraction.Solution_0_Test(input);
