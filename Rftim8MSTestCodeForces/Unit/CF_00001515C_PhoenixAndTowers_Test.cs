...
{
    [TestClass]
    public sealed class CF_00001515C_PhoenixAndTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001515C_PhoenixAndTowers));
        ...
        {
            bool result = CF_00001515C_PhoenixAndTowers.Solution_0_Test(input);
