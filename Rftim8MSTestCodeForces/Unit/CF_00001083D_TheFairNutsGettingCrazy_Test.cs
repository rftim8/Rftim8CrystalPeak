...
{
    [TestClass]
    public sealed class CF_00001083D_TheFairNutsGettingCrazy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001083D_TheFairNutsGettingCrazy));
        ...
        {
            bool result = CF_00001083D_TheFairNutsGettingCrazy.Solution_0_Test(input);
