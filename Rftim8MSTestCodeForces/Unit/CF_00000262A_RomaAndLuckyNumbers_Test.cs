...
{
    [TestClass]
    public sealed class CF_00000262A_RomaAndLuckyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000262A_RomaAndLuckyNumbers));
        ...
        {
            bool result = CF_00000262A_RomaAndLuckyNumbers.Solution_0_Test(input);
