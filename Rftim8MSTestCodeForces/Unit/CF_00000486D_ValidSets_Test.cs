...
{
    [TestClass]
    public sealed class CF_00000486D_ValidSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000486D_ValidSets));
        ...
        {
            bool result = CF_00000486D_ValidSets.Solution_0_Test(input);
