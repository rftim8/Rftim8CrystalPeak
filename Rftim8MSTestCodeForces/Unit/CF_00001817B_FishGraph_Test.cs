...
{
    [TestClass]
    public sealed class CF_00001817B_FishGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001817B_FishGraph));
        ...
        {
            bool result = CF_00001817B_FishGraph.Solution_0_Test(input);
