...
{
    [TestClass]
    public sealed class CF_00000431D_RandomTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000431D_RandomTask));
        ...
        {
            bool result = CF_00000431D_RandomTask.Solution_0_Test(input);
