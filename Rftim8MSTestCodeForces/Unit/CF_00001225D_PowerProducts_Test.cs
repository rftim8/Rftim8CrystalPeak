...
{
    [TestClass]
    public sealed class CF_00001225D_PowerProducts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001225D_PowerProducts));
        ...
        {
            bool result = CF_00001225D_PowerProducts.Solution_0_Test(input);
