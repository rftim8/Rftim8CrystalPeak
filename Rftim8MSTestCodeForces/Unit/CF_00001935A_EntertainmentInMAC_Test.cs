...
{
    [TestClass]
    public sealed class CF_00001935A_EntertainmentInMAC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001935A_EntertainmentInMAC));
        ...
        {
            bool result = CF_00001935A_EntertainmentInMAC.Solution_0_Test(input);
