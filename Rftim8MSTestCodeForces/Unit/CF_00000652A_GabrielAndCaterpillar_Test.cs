...
{
    [TestClass]
    public sealed class CF_00000652A_GabrielAndCaterpillar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000652A_GabrielAndCaterpillar));
        ...
        {
            bool result = CF_00000652A_GabrielAndCaterpillar.Solution_0_Test(input);
