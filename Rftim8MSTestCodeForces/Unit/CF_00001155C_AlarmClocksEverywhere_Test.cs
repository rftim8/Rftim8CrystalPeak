...
{
    [TestClass]
    public sealed class CF_00001155C_AlarmClocksEverywhere_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001155C_AlarmClocksEverywhere));
        ...
        {
            bool result = CF_00001155C_AlarmClocksEverywhere.Solution_0_Test(input);
