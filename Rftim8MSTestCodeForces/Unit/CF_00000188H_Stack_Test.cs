...
{
    [TestClass]
    public sealed class CF_00000188H_Stack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000188H_Stack));
        ...
        {
            bool result = CF_00000188H_Stack.Solution_0_Test(input);
