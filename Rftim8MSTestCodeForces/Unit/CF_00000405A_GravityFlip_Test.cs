...
{
    [TestClass]
    public sealed class CF_00000405A_GravityFlip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000405A_GravityFlip));
        ...
        {
            bool result = CF_00000405A_GravityFlip.Solution_0_Test(input);
