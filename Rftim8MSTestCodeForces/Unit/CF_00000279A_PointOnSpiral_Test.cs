...
{
    [TestClass]
    public sealed class CF_00000279A_PointOnSpiral_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000279A_PointOnSpiral));
        ...
        {
            bool result = CF_00000279A_PointOnSpiral.Solution_0_Test(input);
