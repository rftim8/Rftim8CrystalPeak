...
{
    [TestClass]
    public sealed class CF_00001017E_TheSupersonicRocket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001017E_TheSupersonicRocket));
        ...
        {
            bool result = CF_00001017E_TheSupersonicRocket.Solution_0_Test(input);
