...
{
    [TestClass]
    public sealed class CF_00000699B_OneBomb_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000699B_OneBomb));
        ...
        {
            bool result = CF_00000699B_OneBomb.Solution_0_Test(input);
