...
{
    [TestClass]
    public sealed class CF_00001099B_SquaresAndSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001099B_SquaresAndSegments));
        ...
        {
            bool result = CF_00001099B_SquaresAndSegments.Solution_0_Test(input);
