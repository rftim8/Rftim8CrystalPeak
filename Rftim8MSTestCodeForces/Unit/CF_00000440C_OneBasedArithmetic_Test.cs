...
{
    [TestClass]
    public sealed class CF_00000440C_OneBasedArithmetic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000440C_OneBasedArithmetic));
        ...
        {
            bool result = CF_00000440C_OneBasedArithmetic.Solution_0_Test(input);
