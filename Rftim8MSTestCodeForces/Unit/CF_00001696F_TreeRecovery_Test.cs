...
{
    [TestClass]
    public sealed class CF_00001696F_TreeRecovery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001696F_TreeRecovery));
        ...
        {
            bool result = CF_00001696F_TreeRecovery.Solution_0_Test(input);
