...
{
    [TestClass]
    public sealed class CF_00000155B_Combination_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000155B_Combination));
        ...
        {
            bool result = CF_00000155B_Combination.Solution_0_Test(input);
