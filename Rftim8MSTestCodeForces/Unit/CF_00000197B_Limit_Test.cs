...
{
    [TestClass]
    public sealed class CF_00000197B_Limit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000197B_Limit));
        ...
        {
            bool result = CF_00000197B_Limit.Solution_0_Test(input);
