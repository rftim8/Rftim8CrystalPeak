...
{
    [TestClass]
    public sealed class CF_00001250K_Projectors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250K_Projectors));
        ...
        {
            bool result = CF_00001250K_Projectors.Solution_0_Test(input);
