...
{
    [TestClass]
    public sealed class CF_00001271F_DivideTheStudents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001271F_DivideTheStudents));
        ...
        {
            bool result = CF_00001271F_DivideTheStudents.Solution_0_Test(input);
