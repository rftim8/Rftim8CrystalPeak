...
{
    [TestClass]
    public sealed class CF_00001581B_DiameterOfGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001581B_DiameterOfGraph));
        ...
        {
            bool result = CF_00001581B_DiameterOfGraph.Solution_0_Test(input);
