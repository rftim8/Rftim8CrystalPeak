...
{
    [TestClass]
    public sealed class CF_00000919B_PerfectNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000919B_PerfectNumber));
        ...
        {
            bool result = CF_00000919B_PerfectNumber.Solution_0_Test(input);
