...
{
    [TestClass]
    public sealed class CF_00000056E_DominoPrinciple_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000056E_DominoPrinciple));
        ...
        {
            bool result = CF_00000056E_DominoPrinciple.Solution_0_Test(input);
