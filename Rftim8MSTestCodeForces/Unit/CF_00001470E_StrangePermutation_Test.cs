...
{
    [TestClass]
    public sealed class CF_00001470E_StrangePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001470E_StrangePermutation));
        ...
        {
            bool result = CF_00001470E_StrangePermutation.Solution_0_Test(input);
