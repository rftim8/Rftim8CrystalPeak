...
{
    [TestClass]
    public sealed class CF_00000298A_SnowFootprints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000298A_SnowFootprints));
        ...
        {
            bool result = CF_00000298A_SnowFootprints.Solution_0_Test(input);
