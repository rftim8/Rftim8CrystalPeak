...
{
    [TestClass]
    public sealed class CF_00001857B_MaximumRounding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001857B_MaximumRounding));
        ...
        {
            bool result = CF_00001857B_MaximumRounding.Solution_0_Test(input);
