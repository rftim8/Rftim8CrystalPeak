...
{
    [TestClass]
    public sealed class CF_00001837D_BracketColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001837D_BracketColoring));
        ...
        {
            bool result = CF_00001837D_BracketColoring.Solution_0_Test(input);
