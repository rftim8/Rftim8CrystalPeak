...
{
    [TestClass]
    public sealed class CF_00000616B_DinnerWithEmma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000616B_DinnerWithEmma));
        ...
        {
            bool result = CF_00000616B_DinnerWithEmma.Solution_0_Test(input);
