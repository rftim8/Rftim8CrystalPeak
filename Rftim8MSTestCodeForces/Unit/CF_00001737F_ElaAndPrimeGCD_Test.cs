...
{
    [TestClass]
    public sealed class CF_00001737F_ElaAndPrimeGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001737F_ElaAndPrimeGCD));
        ...
        {
            bool result = CF_00001737F_ElaAndPrimeGCD.Solution_0_Test(input);
