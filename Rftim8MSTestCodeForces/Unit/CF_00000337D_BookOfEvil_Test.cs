...
{
    [TestClass]
    public sealed class CF_00000337D_BookOfEvil_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000337D_BookOfEvil));
        ...
        {
            bool result = CF_00000337D_BookOfEvil.Solution_0_Test(input);
