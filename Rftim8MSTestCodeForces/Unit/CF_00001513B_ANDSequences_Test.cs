...
{
    [TestClass]
    public sealed class CF_00001513B_ANDSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001513B_ANDSequences));
        ...
        {
            bool result = CF_00001513B_ANDSequences.Solution_0_Test(input);
