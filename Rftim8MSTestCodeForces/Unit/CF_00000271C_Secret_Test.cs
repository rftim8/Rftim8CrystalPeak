...
{
    [TestClass]
    public sealed class CF_00000271C_Secret_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000271C_Secret));
        ...
        {
            bool result = CF_00000271C_Secret.Solution_0_Test(input);
