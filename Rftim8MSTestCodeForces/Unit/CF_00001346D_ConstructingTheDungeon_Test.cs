...
{
    [TestClass]
    public sealed class CF_00001346D_ConstructingTheDungeon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001346D_ConstructingTheDungeon));
        ...
        {
            bool result = CF_00001346D_ConstructingTheDungeon.Solution_0_Test(input);
