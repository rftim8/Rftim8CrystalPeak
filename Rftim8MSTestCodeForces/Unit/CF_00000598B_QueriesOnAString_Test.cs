...
{
    [TestClass]
    public sealed class CF_00000598B_QueriesOnAString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000598B_QueriesOnAString));
        ...
        {
            bool result = CF_00000598B_QueriesOnAString.Solution_0_Test(input);
