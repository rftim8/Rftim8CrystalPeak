...
{
    [TestClass]
    public sealed class CF_00000222D_Olympiad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000222D_Olympiad));
        ...
        {
            bool result = CF_00000222D_Olympiad.Solution_0_Test(input);
