...
{
    [TestClass]
    public sealed class CF_00000413D_2048_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000413D_2048));
        ...
        {
            bool result = CF_00000413D_2048.Solution_0_Test(input);
