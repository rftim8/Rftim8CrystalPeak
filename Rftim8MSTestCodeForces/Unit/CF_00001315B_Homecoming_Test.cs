...
{
    [TestClass]
    public sealed class CF_00001315B_Homecoming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001315B_Homecoming));
        ...
        {
            bool result = CF_00001315B_Homecoming.Solution_0_Test(input);
