...
{
    [TestClass]
    public sealed class CF_00000317A_PerfectPair_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000317A_PerfectPair));
        ...
        {
            bool result = CF_00000317A_PerfectPair.Solution_0_Test(input);
