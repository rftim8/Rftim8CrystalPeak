...
{
    [TestClass]
    public sealed class CF_00000216E_MartianLuck_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000216E_MartianLuck));
        ...
        {
            bool result = CF_00000216E_MartianLuck.Solution_0_Test(input);
