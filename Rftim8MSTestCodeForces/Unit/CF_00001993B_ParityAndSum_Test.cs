...
{
    [TestClass]
    public sealed class CF_00001993B_ParityAndSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001993B_ParityAndSum));
        ...
        {
            bool result = CF_00001993B_ParityAndSum.Solution_0_Test(input);
