...
{
    [TestClass]
    public sealed class CF_00001848B_VikaAndTheBridge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001848B_VikaAndTheBridge));
        ...
        {
            bool result = CF_00001848B_VikaAndTheBridge.Solution_0_Test(input);
