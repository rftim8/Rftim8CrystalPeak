...
{
    [TestClass]
    public sealed class CF_00001252A_CopyingHomework_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001252A_CopyingHomework));
        ...
        {
            bool result = CF_00001252A_CopyingHomework.Solution_0_Test(input);
