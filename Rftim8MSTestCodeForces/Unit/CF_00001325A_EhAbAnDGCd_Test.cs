...
{
    [TestClass]
    public sealed class CF_00001325A_EhAbAnDGCd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001325A_EhAbAnDGCd));
        ...
        {
            bool result = CF_00001325A_EhAbAnDGCd.Solution_0_Test(input);
