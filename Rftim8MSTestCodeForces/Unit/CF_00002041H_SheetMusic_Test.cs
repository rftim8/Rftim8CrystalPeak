...
{
    [TestClass]
    public sealed class CF_00002041H_SheetMusic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002041H_SheetMusic));
        ...
        {
            bool result = CF_00002041H_SheetMusic.Solution_0_Test(input);
