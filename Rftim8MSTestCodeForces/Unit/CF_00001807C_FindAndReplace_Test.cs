...
{
    [TestClass]
    public sealed class CF_00001807C_FindAndReplace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001807C_FindAndReplace));
        ...
        {
            bool result = CF_00001807C_FindAndReplace.Solution_0_Test(input);
