...
{
    [TestClass]
    public sealed class CF_00001338D_NestedRubberBands_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001338D_NestedRubberBands));
        ...
        {
            bool result = CF_00001338D_NestedRubberBands.Solution_0_Test(input);
