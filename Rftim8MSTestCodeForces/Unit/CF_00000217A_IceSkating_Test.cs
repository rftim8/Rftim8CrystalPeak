...
{
    [TestClass]
    public sealed class CF_00000217A_IceSkating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000217A_IceSkating));
        ...
        {
            bool result = CF_00000217A_IceSkating.Solution_0_Test(input);
