...
{
    [TestClass]
    public sealed class CF_00000514E_DarthVaderAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000514E_DarthVaderAndTree));
        ...
        {
            bool result = CF_00000514E_DarthVaderAndTree.Solution_0_Test(input);
