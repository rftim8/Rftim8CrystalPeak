...
{
    [TestClass]
    public sealed class CF_00001949J_AmandaTheAmoeba_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001949J_AmandaTheAmoeba));
        ...
        {
            bool result = CF_00001949J_AmandaTheAmoeba.Solution_0_Test(input);
