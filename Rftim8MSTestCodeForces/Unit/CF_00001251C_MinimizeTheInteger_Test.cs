...
{
    [TestClass]
    public sealed class CF_00001251C_MinimizeTheInteger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001251C_MinimizeTheInteger));
        ...
        {
            bool result = CF_00001251C_MinimizeTheInteger.Solution_0_Test(input);
