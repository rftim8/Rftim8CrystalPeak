...
{
    [TestClass]
    public sealed class CF_00001413E_SoloMidOracle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001413E_SoloMidOracle));
        ...
        {
            bool result = CF_00001413E_SoloMidOracle.Solution_0_Test(input);
