...
{
    [TestClass]
    public sealed class CF_00001487A_Arena_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001487A_Arena));
        ...
        {
            bool result = CF_00001487A_Arena.Solution_0_Test(input);
