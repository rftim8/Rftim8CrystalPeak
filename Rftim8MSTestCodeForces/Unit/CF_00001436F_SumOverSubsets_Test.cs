...
{
    [TestClass]
    public sealed class CF_00001436F_SumOverSubsets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001436F_SumOverSubsets));
        ...
        {
            bool result = CF_00001436F_SumOverSubsets.Solution_0_Test(input);
