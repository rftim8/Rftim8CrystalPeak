...
{
    [TestClass]
    public sealed class CF_00001403B_SpringCleaning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001403B_SpringCleaning));
        ...
        {
            bool result = CF_00001403B_SpringCleaning.Solution_0_Test(input);
