...
{
    [TestClass]
    public sealed class CF_00000038F_SmartBoy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000038F_SmartBoy));
        ...
        {
            bool result = CF_00000038F_SmartBoy.Solution_0_Test(input);
