...
{
    [TestClass]
    public sealed class CF_00000498E_StairsAndLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000498E_StairsAndLines));
        ...
        {
            bool result = CF_00000498E_StairsAndLines.Solution_0_Test(input);
