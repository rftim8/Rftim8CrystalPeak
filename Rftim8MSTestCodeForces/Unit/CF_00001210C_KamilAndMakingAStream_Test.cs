...
{
    [TestClass]
    public sealed class CF_00001210C_KamilAndMakingAStream_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001210C_KamilAndMakingAStream));
        ...
        {
            bool result = CF_00001210C_KamilAndMakingAStream.Solution_0_Test(input);
