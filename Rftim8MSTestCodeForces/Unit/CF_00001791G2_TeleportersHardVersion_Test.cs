...
{
    [TestClass]
    public sealed class CF_00001791G2_TeleportersHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001791G2_TeleportersHardVersion));
        ...
        {
            bool result = CF_00001791G2_TeleportersHardVersion.Solution_0_Test(input);
