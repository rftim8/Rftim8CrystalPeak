...
{
    [TestClass]
    public sealed class CF_00001260C_InfiniteFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001260C_InfiniteFence));
        ...
        {
            bool result = CF_00001260C_InfiniteFence.Solution_0_Test(input);
