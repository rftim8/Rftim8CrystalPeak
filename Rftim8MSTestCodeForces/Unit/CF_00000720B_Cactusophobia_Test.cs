...
{
    [TestClass]
    public sealed class CF_00000720B_Cactusophobia_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000720B_Cactusophobia));
        ...
        {
            bool result = CF_00000720B_Cactusophobia.Solution_0_Test(input);
