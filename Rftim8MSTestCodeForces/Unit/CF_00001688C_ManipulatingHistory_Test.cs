...
{
    [TestClass]
    public sealed class CF_00001688C_ManipulatingHistory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001688C_ManipulatingHistory));
        ...
        {
            bool result = CF_00001688C_ManipulatingHistory.Solution_0_Test(input);
