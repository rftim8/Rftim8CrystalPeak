...
{
    [TestClass]
    public sealed class CF_00001498B_BoxFitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001498B_BoxFitting));
        ...
        {
            bool result = CF_00001498B_BoxFitting.Solution_0_Test(input);
