...
{
    [TestClass]
    public sealed class CF_00000906B_SeatingOfStudents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000906B_SeatingOfStudents));
        ...
        {
            bool result = CF_00000906B_SeatingOfStudents.Solution_0_Test(input);
