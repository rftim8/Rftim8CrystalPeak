...
{
    [TestClass]
    public sealed class CF_00001170A_ThreeIntegersAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001170A_ThreeIntegersAgain));
        ...
        {
            bool result = CF_00001170A_ThreeIntegersAgain.Solution_0_Test(input);
