...
{
    [TestClass]
    public sealed class CF_00000666B_WorldTour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000666B_WorldTour));
        ...
        {
            bool result = CF_00000666B_WorldTour.Solution_0_Test(input);
