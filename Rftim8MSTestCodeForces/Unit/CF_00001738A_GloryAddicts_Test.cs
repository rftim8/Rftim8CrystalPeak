...
{
    [TestClass]
    public sealed class CF_00001738A_GloryAddicts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001738A_GloryAddicts));
        ...
        {
            bool result = CF_00001738A_GloryAddicts.Solution_0_Test(input);
