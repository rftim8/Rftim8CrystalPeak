...
{
    [TestClass]
    public sealed class CF_00001263F_EconomicDifficulties_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001263F_EconomicDifficulties));
        ...
        {
            bool result = CF_00001263F_EconomicDifficulties.Solution_0_Test(input);
