...
{
    [TestClass]
    public sealed class CF_00001505C_FibonacciWords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001505C_FibonacciWords));
        ...
        {
            bool result = CF_00001505C_FibonacciWords.Solution_0_Test(input);
