...
{
    [TestClass]
    public sealed class CF_00000337C_Quiz_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000337C_Quiz));
        ...
        {
            bool result = CF_00000337C_Quiz.Solution_0_Test(input);
