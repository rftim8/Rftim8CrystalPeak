...
{
    [TestClass]
    public sealed class CF_00001761B_EliminationOfARing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001761B_EliminationOfARing));
        ...
        {
            bool result = CF_00001761B_EliminationOfARing.Solution_0_Test(input);
