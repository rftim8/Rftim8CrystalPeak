...
{
    [TestClass]
    public sealed class CF_00000138D_WorldOfDarkraft_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000138D_WorldOfDarkraft));
        ...
        {
            bool result = CF_00000138D_WorldOfDarkraft.Solution_0_Test(input);
