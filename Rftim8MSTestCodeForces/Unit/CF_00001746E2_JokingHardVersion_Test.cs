...
{
    [TestClass]
    public sealed class CF_00001746E2_JokingHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001746E2_JokingHardVersion));
        ...
        {
            bool result = CF_00001746E2_JokingHardVersion.Solution_0_Test(input);
