...
{
    [TestClass]
    public sealed class CF_00001692A_Marathon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001692A_Marathon));
        ...
        {
            bool result = CF_00001692A_Marathon.Solution_0_Test(input);
