...
{
    [TestClass]
    public sealed class CF_00001008A_Romaji_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001008A_Romaji));
        ...
        {
            bool result = CF_00001008A_Romaji.Solution_0_Test(input);
