...
{
    [TestClass]
    public sealed class CF_00001952I_DarkMatter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001952I_DarkMatter));
        ...
        {
            bool result = CF_00001952I_DarkMatter.Solution_0_Test(input);
