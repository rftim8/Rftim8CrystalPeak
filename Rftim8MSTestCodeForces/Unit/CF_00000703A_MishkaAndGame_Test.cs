...
{
    [TestClass]
    public sealed class CF_00000703A_MishkaAndGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000703A_MishkaAndGame));
        ...
        {
            bool result = CF_00000703A_MishkaAndGame.Solution_0_Test(input);
