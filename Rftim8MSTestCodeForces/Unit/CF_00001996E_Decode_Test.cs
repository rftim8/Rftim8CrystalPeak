...
{
    [TestClass]
    public sealed class CF_00001996E_Decode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001996E_Decode));
        ...
        {
            bool result = CF_00001996E_Decode.Solution_0_Test(input);
