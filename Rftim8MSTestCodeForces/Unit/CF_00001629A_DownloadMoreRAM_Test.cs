...
{
    [TestClass]
    public sealed class CF_00001629A_DownloadMoreRAM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001629A_DownloadMoreRAM));
        ...
        {
            bool result = CF_00001629A_DownloadMoreRAM.Solution_0_Test(input);
