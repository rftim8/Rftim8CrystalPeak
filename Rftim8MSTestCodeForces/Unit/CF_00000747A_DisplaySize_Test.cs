...
{
    [TestClass]
    public sealed class CF_00000747A_DisplaySize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000747A_DisplaySize));
        ...
        {
            bool result = CF_00000747A_DisplaySize.Solution_0_Test(input);
