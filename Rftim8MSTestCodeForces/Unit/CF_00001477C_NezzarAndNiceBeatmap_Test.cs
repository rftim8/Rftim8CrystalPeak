...
{
    [TestClass]
    public sealed class CF_00001477C_NezzarAndNiceBeatmap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001477C_NezzarAndNiceBeatmap));
        ...
        {
            bool result = CF_00001477C_NezzarAndNiceBeatmap.Solution_0_Test(input);
