...
{
    [TestClass]
    public sealed class CF_00000796A_BuyingAHouse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000796A_BuyingAHouse));
        ...
        {
            bool result = CF_00000796A_BuyingAHouse.Solution_0_Test(input);
