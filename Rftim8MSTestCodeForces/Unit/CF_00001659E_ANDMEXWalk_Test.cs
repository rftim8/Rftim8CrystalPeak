...
{
    [TestClass]
    public sealed class CF_00001659E_ANDMEXWalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001659E_ANDMEXWalk));
        ...
        {
            bool result = CF_00001659E_ANDMEXWalk.Solution_0_Test(input);
