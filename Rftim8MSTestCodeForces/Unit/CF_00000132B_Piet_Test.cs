...
{
    [TestClass]
    public sealed class CF_00000132B_Piet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000132B_Piet));
        ...
        {
            bool result = CF_00000132B_Piet.Solution_0_Test(input);
