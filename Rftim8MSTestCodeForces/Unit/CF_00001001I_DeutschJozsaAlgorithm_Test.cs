...
{
    [TestClass]
    public sealed class CF_00001001I_DeutschJozsaAlgorithm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001001I_DeutschJozsaAlgorithm));
        ...
        {
            bool result = CF_00001001I_DeutschJozsaAlgorithm.Solution_0_Test(input);
