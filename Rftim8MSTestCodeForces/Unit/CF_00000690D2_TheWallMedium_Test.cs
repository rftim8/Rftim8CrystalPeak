...
{
    [TestClass]
    public sealed class CF_00000690D2_TheWallMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690D2_TheWallMedium));
        ...
        {
            bool result = CF_00000690D2_TheWallMedium.Solution_0_Test(input);
