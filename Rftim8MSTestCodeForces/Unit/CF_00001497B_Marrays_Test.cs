...
{
    [TestClass]
    public sealed class CF_00001497B_Marrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001497B_Marrays));
        ...
        {
            bool result = CF_00001497B_Marrays.Solution_0_Test(input);
