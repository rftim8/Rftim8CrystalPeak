...
{
    [TestClass]
    public sealed class CF_00001023F_MobilePhoneNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001023F_MobilePhoneNetwork));
        ...
        {
            bool result = CF_00001023F_MobilePhoneNetwork.Solution_0_Test(input);
