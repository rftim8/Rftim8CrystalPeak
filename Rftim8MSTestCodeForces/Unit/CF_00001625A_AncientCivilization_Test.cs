...
{
    [TestClass]
    public sealed class CF_00001625A_AncientCivilization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001625A_AncientCivilization));
        ...
        {
            bool result = CF_00001625A_AncientCivilization.Solution_0_Test(input);
