...
{
    [TestClass]
    public sealed class CF_00000916E_JamieAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000916E_JamieAndTree));
        ...
        {
            bool result = CF_00000916E_JamieAndTree.Solution_0_Test(input);
