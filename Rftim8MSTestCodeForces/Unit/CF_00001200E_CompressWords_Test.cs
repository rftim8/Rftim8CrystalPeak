...
{
    [TestClass]
    public sealed class CF_00001200E_CompressWords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001200E_CompressWords));
        ...
        {
            bool result = CF_00001200E_CompressWords.Solution_0_Test(input);
