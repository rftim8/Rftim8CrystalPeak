...
{
    [TestClass]
    public sealed class CF_00000017C_Balance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000017C_Balance));
        ...
        {
            bool result = CF_00000017C_Balance.Solution_0_Test(input);
