...
{
    [TestClass]
    public sealed class CF_00001383E_StrangeOperation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001383E_StrangeOperation));
        ...
        {
            bool result = CF_00001383E_StrangeOperation.Solution_0_Test(input);
