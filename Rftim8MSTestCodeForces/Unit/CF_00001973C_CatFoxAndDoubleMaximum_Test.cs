...
{
    [TestClass]
    public sealed class CF_00001973C_CatFoxAndDoubleMaximum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001973C_CatFoxAndDoubleMaximum));
        ...
        {
            bool result = CF_00001973C_CatFoxAndDoubleMaximum.Solution_0_Test(input);
