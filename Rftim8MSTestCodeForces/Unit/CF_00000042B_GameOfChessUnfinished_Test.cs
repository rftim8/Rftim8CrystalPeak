...
{
    [TestClass]
    public sealed class CF_00000042B_GameOfChessUnfinished_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000042B_GameOfChessUnfinished));
        ...
        {
            bool result = CF_00000042B_GameOfChessUnfinished.Solution_0_Test(input);
