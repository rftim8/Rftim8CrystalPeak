...
{
    [TestClass]
    public sealed class CF_00001271A_Suits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001271A_Suits));
        ...
        {
            bool result = CF_00001271A_Suits.Solution_0_Test(input);
