...
{
    [TestClass]
    public sealed class CF_00001859A_UnitedWeStand_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001859A_UnitedWeStand));
        ...
        {
            bool result = CF_00001859A_UnitedWeStand.Solution_0_Test(input);
