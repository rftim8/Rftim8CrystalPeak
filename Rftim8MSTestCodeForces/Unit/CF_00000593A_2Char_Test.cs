...
{
    [TestClass]
    public sealed class CF_00000593A_2Char_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000593A_2Char));
        ...
        {
            bool result = CF_00000593A_2Char.Solution_0_Test(input);
