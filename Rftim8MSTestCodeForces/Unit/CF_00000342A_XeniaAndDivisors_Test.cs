...
{
    [TestClass]
    public sealed class CF_00000342A_XeniaAndDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000342A_XeniaAndDivisors));
        ...
        {
            bool result = CF_00000342A_XeniaAndDivisors.Solution_0_Test(input);
