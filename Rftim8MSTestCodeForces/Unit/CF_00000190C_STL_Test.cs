...
{
    [TestClass]
    public sealed class CF_00000190C_STL_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000190C_STL));
        ...
        {
            bool result = CF_00000190C_STL.Solution_0_Test(input);
