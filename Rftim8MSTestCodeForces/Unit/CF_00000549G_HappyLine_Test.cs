...
{
    [TestClass]
    public sealed class CF_00000549G_HappyLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000549G_HappyLine));
        ...
        {
            bool result = CF_00000549G_HappyLine.Solution_0_Test(input);
