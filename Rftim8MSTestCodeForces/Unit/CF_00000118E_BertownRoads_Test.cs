...
{
    [TestClass]
    public sealed class CF_00000118E_BertownRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000118E_BertownRoads));
        ...
        {
            bool result = CF_00000118E_BertownRoads.Solution_0_Test(input);
