...
{
    [TestClass]
    public sealed class CF_00000930C_TeodorIsNotALiar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000930C_TeodorIsNotALiar));
        ...
        {
            bool result = CF_00000930C_TeodorIsNotALiar.Solution_0_Test(input);
