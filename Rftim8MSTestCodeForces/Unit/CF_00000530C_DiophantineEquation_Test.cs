...
{
    [TestClass]
    public sealed class CF_00000530C_DiophantineEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000530C_DiophantineEquation));
        ...
        {
            bool result = CF_00000530C_DiophantineEquation.Solution_0_Test(input);
