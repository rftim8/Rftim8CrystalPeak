...
{
    [TestClass]
    public sealed class CF_00001386A_Colors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001386A_Colors));
        ...
        {
            bool result = CF_00001386A_Colors.Solution_0_Test(input);
