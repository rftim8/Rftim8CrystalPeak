...
{
    [TestClass]
    public sealed class CF_00000633A_EbonyAndIvory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000633A_EbonyAndIvory));
        ...
        {
            bool result = CF_00000633A_EbonyAndIvory.Solution_0_Test(input);
