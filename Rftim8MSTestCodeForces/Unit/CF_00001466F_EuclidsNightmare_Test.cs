...
{
    [TestClass]
    public sealed class CF_00001466F_EuclidsNightmare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001466F_EuclidsNightmare));
        ...
        {
            bool result = CF_00001466F_EuclidsNightmare.Solution_0_Test(input);
