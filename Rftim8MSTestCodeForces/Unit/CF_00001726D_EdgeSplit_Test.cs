...
{
    [TestClass]
    public sealed class CF_00001726D_EdgeSplit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001726D_EdgeSplit));
        ...
        {
            bool result = CF_00001726D_EdgeSplit.Solution_0_Test(input);
