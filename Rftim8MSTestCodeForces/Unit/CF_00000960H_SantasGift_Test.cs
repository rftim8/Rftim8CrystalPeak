...
{
    [TestClass]
    public sealed class CF_00000960H_SantasGift_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000960H_SantasGift));
        ...
        {
            bool result = CF_00000960H_SantasGift.Solution_0_Test(input);
