...
{
    [TestClass]
    public sealed class CF_00000515A_DrazilAndDate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000515A_DrazilAndDate));
        ...
        {
            bool result = CF_00000515A_DrazilAndDate.Solution_0_Test(input);
