...
{
    [TestClass]
    public sealed class CF_00000089A_Robbery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000089A_Robbery));
        ...
        {
            bool result = CF_00000089A_Robbery.Solution_0_Test(input);
