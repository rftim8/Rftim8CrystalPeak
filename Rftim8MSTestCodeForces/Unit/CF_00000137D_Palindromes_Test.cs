...
{
    [TestClass]
    public sealed class CF_00000137D_Palindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000137D_Palindromes));
        ...
        {
            bool result = CF_00000137D_Palindromes.Solution_0_Test(input);
