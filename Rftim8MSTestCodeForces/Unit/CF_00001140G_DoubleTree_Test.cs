...
{
    [TestClass]
    public sealed class CF_00001140G_DoubleTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001140G_DoubleTree));
        ...
        {
            bool result = CF_00001140G_DoubleTree.Solution_0_Test(input);
