...
{
    [TestClass]
    public sealed class CF_00001277B_MakeThemOdd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001277B_MakeThemOdd));
        ...
        {
            bool result = CF_00001277B_MakeThemOdd.Solution_0_Test(input);
