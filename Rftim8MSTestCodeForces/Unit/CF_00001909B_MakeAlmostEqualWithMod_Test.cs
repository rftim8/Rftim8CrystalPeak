...
{
    [TestClass]
    public sealed class CF_00001909B_MakeAlmostEqualWithMod_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001909B_MakeAlmostEqualWithMod));
        ...
        {
            bool result = CF_00001909B_MakeAlmostEqualWithMod.Solution_0_Test(input);
