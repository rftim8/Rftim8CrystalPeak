...
{
    [TestClass]
    public sealed class CF_00001470A_StrangeBirthdayPart_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001470A_StrangeBirthdayPart));
        ...
        {
            bool result = CF_00001470A_StrangeBirthdayPart.Solution_0_Test(input);
