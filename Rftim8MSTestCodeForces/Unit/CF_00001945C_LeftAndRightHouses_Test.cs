...
{
    [TestClass]
    public sealed class CF_00001945C_LeftAndRightHouses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001945C_LeftAndRightHouses));
        ...
        {
            bool result = CF_00001945C_LeftAndRightHouses.Solution_0_Test(input);
