...
{
    [TestClass]
    public sealed class CF_00001007A_ReorderTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001007A_ReorderTheArray));
        ...
        {
            bool result = CF_00001007A_ReorderTheArray.Solution_0_Test(input);
