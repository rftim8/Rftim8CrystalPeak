...
{
    [TestClass]
    public sealed class CF_00001684G_EuclidGuess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001684G_EuclidGuess));
        ...
        {
            bool result = CF_00001684G_EuclidGuess.Solution_0_Test(input);
