...
{
    [TestClass]
    public sealed class CF_00000471D_MUHAndCubeWalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000471D_MUHAndCubeWalls));
        ...
        {
            bool result = CF_00000471D_MUHAndCubeWalls.Solution_0_Test(input);
