...
{
    [TestClass]
    public sealed class CF_00002034B_RakhshsRevival_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002034B_RakhshsRevival));
        ...
        {
            bool result = CF_00002034B_RakhshsRevival.Solution_0_Test(input);
