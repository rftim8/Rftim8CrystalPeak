...
{
    [TestClass]
    public sealed class CF_00000388B_FoxAndMinimalPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000388B_FoxAndMinimalPath));
        ...
        {
            bool result = CF_00000388B_FoxAndMinimalPath.Solution_0_Test(input);
