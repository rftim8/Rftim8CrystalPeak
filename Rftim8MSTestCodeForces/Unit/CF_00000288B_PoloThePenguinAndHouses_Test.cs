...
{
    [TestClass]
    public sealed class CF_00000288B_PoloThePenguinAndHouses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000288B_PoloThePenguinAndHouses));
        ...
        {
            bool result = CF_00000288B_PoloThePenguinAndHouses.Solution_0_Test(input);
