...
{
    [TestClass]
    public sealed class CF_00001992D_TestOfLove_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001992D_TestOfLove));
        ...
        {
            bool result = CF_00001992D_TestOfLove.Solution_0_Test(input);
