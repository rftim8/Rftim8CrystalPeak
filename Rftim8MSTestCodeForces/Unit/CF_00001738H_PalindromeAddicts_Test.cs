...
{
    [TestClass]
    public sealed class CF_00001738H_PalindromeAddicts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001738H_PalindromeAddicts));
        ...
        {
            bool result = CF_00001738H_PalindromeAddicts.Solution_0_Test(input);
