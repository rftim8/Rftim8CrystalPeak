...
{
    [TestClass]
    public sealed class CF_00000107C_Arrangement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000107C_Arrangement));
        ...
        {
            bool result = CF_00000107C_Arrangement.Solution_0_Test(input);
