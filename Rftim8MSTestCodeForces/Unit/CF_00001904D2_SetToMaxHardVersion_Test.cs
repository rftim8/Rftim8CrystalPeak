...
{
    [TestClass]
    public sealed class CF_00001904D2_SetToMaxHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001904D2_SetToMaxHardVersion));
        ...
        {
            bool result = CF_00001904D2_SetToMaxHardVersion.Solution_0_Test(input);
