...
{
    [TestClass]
    public sealed class CF_00001444A_Division_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001444A_Division));
        ...
        {
            bool result = CF_00001444A_Division.Solution_0_Test(input);
