...
{
    [TestClass]
    public sealed class CF_00000630I_ParkingLot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630I_ParkingLot));
        ...
        {
            bool result = CF_00000630I_ParkingLot.Solution_0_Test(input);
