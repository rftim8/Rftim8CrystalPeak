...
{
    [TestClass]
    public sealed class CF_00000166E_Tetrahedron_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000166E_Tetrahedron));
        ...
        {
            bool result = CF_00000166E_Tetrahedron.Solution_0_Test(input);
