...
{
    [TestClass]
    public sealed class CF_00001774H_MaximumPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001774H_MaximumPermutation));
        ...
        {
            bool result = CF_00001774H_MaximumPermutation.Solution_0_Test(input);
