...
{
    [TestClass]
    public sealed class CF_00000245G_SuggestedFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000245G_SuggestedFriends));
        ...
        {
            bool result = CF_00000245G_SuggestedFriends.Solution_0_Test(input);
