...
{
    [TestClass]
    public sealed class CF_00001770C_KoxiaAndNumberTheory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001770C_KoxiaAndNumberTheory));
        ...
        {
            bool result = CF_00001770C_KoxiaAndNumberTheory.Solution_0_Test(input);
