...
{
    [TestClass]
    public sealed class CF_00000452B_4pointPolyline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000452B_4pointPolyline));
        ...
        {
            bool result = CF_00000452B_4pointPolyline.Solution_0_Test(input);
