...
{
    [TestClass]
    public sealed class CF_00001279B_VerseForSanta_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001279B_VerseForSanta));
        ...
        {
            bool result = CF_00001279B_VerseForSanta.Solution_0_Test(input);
