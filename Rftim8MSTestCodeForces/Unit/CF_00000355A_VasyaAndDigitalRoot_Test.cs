...
{
    [TestClass]
    public sealed class CF_00000355A_VasyaAndDigitalRoot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000355A_VasyaAndDigitalRoot));
        ...
        {
            bool result = CF_00000355A_VasyaAndDigitalRoot.Solution_0_Test(input);
