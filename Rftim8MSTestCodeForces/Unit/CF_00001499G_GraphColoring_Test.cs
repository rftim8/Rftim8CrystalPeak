...
{
    [TestClass]
    public sealed class CF_00001499G_GraphColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001499G_GraphColoring));
        ...
        {
            bool result = CF_00001499G_GraphColoring.Solution_0_Test(input);
