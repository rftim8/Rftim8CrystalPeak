...
{
    [TestClass]
    public sealed class CF_00001996G_Penacony_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001996G_Penacony));
        ...
        {
            bool result = CF_00001996G_Penacony.Solution_0_Test(input);
