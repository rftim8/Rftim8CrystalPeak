...
{
    [TestClass]
    public sealed class CF_00001458E_NimShortcuts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001458E_NimShortcuts));
        ...
        {
            bool result = CF_00001458E_NimShortcuts.Solution_0_Test(input);
