...
{
    [TestClass]
    public sealed class CF_00000878A_ShortProgram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000878A_ShortProgram));
        ...
        {
            bool result = CF_00000878A_ShortProgram.Solution_0_Test(input);
