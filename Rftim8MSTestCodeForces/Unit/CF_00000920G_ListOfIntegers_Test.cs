...
{
    [TestClass]
    public sealed class CF_00000920G_ListOfIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000920G_ListOfIntegers));
        ...
        {
            bool result = CF_00000920G_ListOfIntegers.Solution_0_Test(input);
