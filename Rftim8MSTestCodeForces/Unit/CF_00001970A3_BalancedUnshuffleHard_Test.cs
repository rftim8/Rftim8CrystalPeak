...
{
    [TestClass]
    public sealed class CF_00001970A3_BalancedUnshuffleHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970A3_BalancedUnshuffleHard));
        ...
        {
            bool result = CF_00001970A3_BalancedUnshuffleHard.Solution_0_Test(input);
