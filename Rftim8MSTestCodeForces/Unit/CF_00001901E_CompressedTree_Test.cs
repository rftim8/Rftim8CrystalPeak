...
{
    [TestClass]
    public sealed class CF_00001901E_CompressedTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001901E_CompressedTree));
        ...
        {
            bool result = CF_00001901E_CompressedTree.Solution_0_Test(input);
