...
{
    [TestClass]
    public sealed class CF_00000784B_KidsRiddle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000784B_KidsRiddle));
        ...
        {
            bool result = CF_00000784B_KidsRiddle.Solution_0_Test(input);
