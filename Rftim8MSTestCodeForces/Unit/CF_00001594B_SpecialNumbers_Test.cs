...
{
    [TestClass]
    public sealed class CF_00001594B_SpecialNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001594B_SpecialNumbers));
        ...
        {
            bool result = CF_00001594B_SpecialNumbers.Solution_0_Test(input);
