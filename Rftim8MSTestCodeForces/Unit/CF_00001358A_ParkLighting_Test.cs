...
{
    [TestClass]
    public sealed class CF_00001358A_ParkLighting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001358A_ParkLighting));
        ...
        {
            bool result = CF_00001358A_ParkLighting.Solution_0_Test(input);
