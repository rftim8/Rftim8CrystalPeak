...
{
    [TestClass]
    public sealed class CF_00000616E_SumOfRemainders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000616E_SumOfRemainders));
        ...
        {
            bool result = CF_00000616E_SumOfRemainders.Solution_0_Test(input);
