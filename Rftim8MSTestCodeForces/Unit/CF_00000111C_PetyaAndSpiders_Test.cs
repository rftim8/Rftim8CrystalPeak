...
{
    [TestClass]
    public sealed class CF_00000111C_PetyaAndSpiders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000111C_PetyaAndSpiders));
        ...
        {
            bool result = CF_00000111C_PetyaAndSpiders.Solution_0_Test(input);
