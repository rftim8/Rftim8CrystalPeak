...
{
    [TestClass]
    public sealed class CF_00001627A_NotShading_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001627A_NotShading));
        ...
        {
            bool result = CF_00001627A_NotShading.Solution_0_Test(input);
