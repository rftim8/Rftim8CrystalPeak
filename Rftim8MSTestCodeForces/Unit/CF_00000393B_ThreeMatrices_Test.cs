...
{
    [TestClass]
    public sealed class CF_00000393B_ThreeMatrices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000393B_ThreeMatrices));
        ...
        {
            bool result = CF_00000393B_ThreeMatrices.Solution_0_Test(input);
