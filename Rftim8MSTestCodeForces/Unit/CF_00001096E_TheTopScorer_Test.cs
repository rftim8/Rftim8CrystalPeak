...
{
    [TestClass]
    public sealed class CF_00001096E_TheTopScorer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001096E_TheTopScorer));
        ...
        {
            bool result = CF_00001096E_TheTopScorer.Solution_0_Test(input);
