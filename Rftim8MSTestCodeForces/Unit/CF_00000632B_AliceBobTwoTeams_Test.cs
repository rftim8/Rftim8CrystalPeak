...
{
    [TestClass]
    public sealed class CF_00000632B_AliceBobTwoTeams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000632B_AliceBobTwoTeams));
        ...
        {
            bool result = CF_00000632B_AliceBobTwoTeams.Solution_0_Test(input);
