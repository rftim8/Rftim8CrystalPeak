...
{
    [TestClass]
    public sealed class CF_00001275B_CodeReview_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001275B_CodeReview));
        ...
        {
            bool result = CF_00001275B_CodeReview.Solution_0_Test(input);
