...
{
    [TestClass]
    public sealed class CF_00001753C_WishIKnewHowToSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001753C_WishIKnewHowToSort));
        ...
        {
            bool result = CF_00001753C_WishIKnewHowToSort.Solution_0_Test(input);
