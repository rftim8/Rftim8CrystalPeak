...
{
    [TestClass]
    public sealed class CF_00000500A_NewYearTransportation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000500A_NewYearTransportation));
        ...
        {
            bool result = CF_00000500A_NewYearTransportation.Solution_0_Test(input);
