...
{
    [TestClass]
    public sealed class CF_00001537C_ChallengingCliffs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001537C_ChallengingCliffs));
        ...
        {
            bool result = CF_00001537C_ChallengingCliffs.Solution_0_Test(input);
