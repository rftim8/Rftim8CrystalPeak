...
{
    [TestClass]
    public sealed class CF_00000533A_BerlandMiners_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000533A_BerlandMiners));
        ...
        {
            bool result = CF_00000533A_BerlandMiners.Solution_0_Test(input);
