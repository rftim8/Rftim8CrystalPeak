...
{
    [TestClass]
    public sealed class CF_00000402C_SearchingForGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000402C_SearchingForGraph));
        ...
        {
            bool result = CF_00000402C_SearchingForGraph.Solution_0_Test(input);
