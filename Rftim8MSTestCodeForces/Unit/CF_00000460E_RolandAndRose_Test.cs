...
{
    [TestClass]
    public sealed class CF_00000460E_RolandAndRose_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000460E_RolandAndRose));
        ...
        {
            bool result = CF_00000460E_RolandAndRose.Solution_0_Test(input);
