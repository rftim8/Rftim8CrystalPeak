...
{
    [TestClass]
    public sealed class CF_00001421A_XORwice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001421A_XORwice));
        ...
        {
            bool result = CF_00001421A_XORwice.Solution_0_Test(input);
