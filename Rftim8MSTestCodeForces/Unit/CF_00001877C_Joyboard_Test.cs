...
{
    [TestClass]
    public sealed class CF_00001877C_Joyboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001877C_Joyboard));
        ...
        {
            bool result = CF_00001877C_Joyboard.Solution_0_Test(input);
