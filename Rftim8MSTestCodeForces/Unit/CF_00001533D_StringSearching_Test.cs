...
{
    [TestClass]
    public sealed class CF_00001533D_StringSearching_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001533D_StringSearching));
        ...
        {
            bool result = CF_00001533D_StringSearching.Solution_0_Test(input);
