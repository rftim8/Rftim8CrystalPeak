...
{
    [TestClass]
    public sealed class CF_00001510J_JapaneseGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001510J_JapaneseGame));
        ...
        {
            bool result = CF_00001510J_JapaneseGame.Solution_0_Test(input);
