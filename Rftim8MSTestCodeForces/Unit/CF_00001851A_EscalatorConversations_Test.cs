...
{
    [TestClass]
    public sealed class CF_00001851A_EscalatorConversations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001851A_EscalatorConversations));
        ...
        {
            bool result = CF_00001851A_EscalatorConversations.Solution_0_Test(input);
