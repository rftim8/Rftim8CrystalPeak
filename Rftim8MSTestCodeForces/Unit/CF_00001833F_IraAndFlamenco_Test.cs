...
{
    [TestClass]
    public sealed class CF_00001833F_IraAndFlamenco_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001833F_IraAndFlamenco));
        ...
        {
            bool result = CF_00001833F_IraAndFlamenco.Solution_0_Test(input);
