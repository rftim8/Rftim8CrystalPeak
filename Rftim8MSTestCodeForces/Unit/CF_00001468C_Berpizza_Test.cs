...
{
    [TestClass]
    public sealed class CF_00001468C_Berpizza_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468C_Berpizza));
        ...
        {
            bool result = CF_00001468C_Berpizza.Solution_0_Test(input);
