...
{
    [TestClass]
    public sealed class CF_00001251B_BinaryPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001251B_BinaryPalindromes));
        ...
        {
            bool result = CF_00001251B_BinaryPalindromes.Solution_0_Test(input);
