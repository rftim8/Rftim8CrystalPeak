...
{
    [TestClass]
    public sealed class CF_00000930A_PeculiarAppletree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000930A_PeculiarAppletree));
        ...
        {
            bool result = CF_00000930A_PeculiarAppletree.Solution_0_Test(input);
