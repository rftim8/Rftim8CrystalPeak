...
{
    [TestClass]
    public sealed class CF_00000341E_CandiesGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000341E_CandiesGame));
        ...
        {
            bool result = CF_00000341E_CandiesGame.Solution_0_Test(input);
