...
{
    [TestClass]
    public sealed class CF_00001211H_RoadRepairInTreeland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001211H_RoadRepairInTreeland));
        ...
        {
            bool result = CF_00001211H_RoadRepairInTreeland.Solution_0_Test(input);
