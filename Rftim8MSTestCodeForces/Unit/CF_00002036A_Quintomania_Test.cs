...
{
    [TestClass]
    public sealed class CF_00002036A_Quintomania_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002036A_Quintomania));
        ...
        {
            bool result = CF_00002036A_Quintomania.Solution_0_Test(input);
