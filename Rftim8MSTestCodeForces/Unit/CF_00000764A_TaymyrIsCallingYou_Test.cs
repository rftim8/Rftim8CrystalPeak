...
{
    [TestClass]
    public sealed class CF_00000764A_TaymyrIsCallingYou_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000764A_TaymyrIsCallingYou));
        ...
        {
            bool result = CF_00000764A_TaymyrIsCallingYou.Solution_0_Test(input);
