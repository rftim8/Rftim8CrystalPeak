...
{
    [TestClass]
    public sealed class CF_00001089J_JSMinification_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001089J_JSMinification));
        ...
        {
            bool result = CF_00001089J_JSMinification.Solution_0_Test(input);
