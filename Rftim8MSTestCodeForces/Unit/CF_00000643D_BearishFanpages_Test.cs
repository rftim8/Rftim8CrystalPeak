...
{
    [TestClass]
    public sealed class CF_00000643D_BearishFanpages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000643D_BearishFanpages));
        ...
        {
            bool result = CF_00000643D_BearishFanpages.Solution_0_Test(input);
