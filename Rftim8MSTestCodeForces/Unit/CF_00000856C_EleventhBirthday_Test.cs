...
{
    [TestClass]
    public sealed class CF_00000856C_EleventhBirthday_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000856C_EleventhBirthday));
        ...
        {
            bool result = CF_00000856C_EleventhBirthday.Solution_0_Test(input);
