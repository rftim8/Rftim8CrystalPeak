...
{
    [TestClass]
    public sealed class CF_00001208B_Uniqueness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001208B_Uniqueness));
        ...
        {
            bool result = CF_00001208B_Uniqueness.Solution_0_Test(input);
