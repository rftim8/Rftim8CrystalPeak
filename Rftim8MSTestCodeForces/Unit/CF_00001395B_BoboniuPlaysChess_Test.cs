...
{
    [TestClass]
    public sealed class CF_00001395B_BoboniuPlaysChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001395B_BoboniuPlaysChess));
        ...
        {
            bool result = CF_00001395B_BoboniuPlaysChess.Solution_0_Test(input);
