...
{
    [TestClass]
    public sealed class CF_00001769A_NarrowRoad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001769A_NarrowRoad));
        ...
        {
            bool result = CF_00001769A_NarrowRoad.Solution_0_Test(input);
