...
{
    [TestClass]
    public sealed class CF_00001430A_NumberOfApartments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001430A_NumberOfApartments));
        ...
        {
            bool result = CF_00001430A_NumberOfApartments.Solution_0_Test(input);
