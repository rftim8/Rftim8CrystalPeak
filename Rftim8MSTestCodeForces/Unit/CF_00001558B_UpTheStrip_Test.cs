...
{
    [TestClass]
    public sealed class CF_00001558B_UpTheStrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001558B_UpTheStrip));
        ...
        {
            bool result = CF_00001558B_UpTheStrip.Solution_0_Test(input);
