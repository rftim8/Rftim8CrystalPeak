...
{
    [TestClass]
    public sealed class CF_00000925B_ResourceDistribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000925B_ResourceDistribution));
        ...
        {
            bool result = CF_00000925B_ResourceDistribution.Solution_0_Test(input);
