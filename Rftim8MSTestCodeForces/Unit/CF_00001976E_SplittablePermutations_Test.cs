...
{
    [TestClass]
    public sealed class CF_00001976E_SplittablePermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001976E_SplittablePermutations));
        ...
        {
            bool result = CF_00001976E_SplittablePermutations.Solution_0_Test(input);
