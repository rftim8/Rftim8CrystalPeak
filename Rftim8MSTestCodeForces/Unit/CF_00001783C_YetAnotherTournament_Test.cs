...
{
    [TestClass]
    public sealed class CF_00001783C_YetAnotherTournament_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001783C_YetAnotherTournament));
        ...
        {
            bool result = CF_00001783C_YetAnotherTournament.Solution_0_Test(input);
