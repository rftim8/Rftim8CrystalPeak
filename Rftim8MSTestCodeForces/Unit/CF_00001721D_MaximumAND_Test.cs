...
{
    [TestClass]
    public sealed class CF_00001721D_MaximumAND_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001721D_MaximumAND));
        ...
        {
            bool result = CF_00001721D_MaximumAND.Solution_0_Test(input);
