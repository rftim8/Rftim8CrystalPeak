...
{
    [TestClass]
    public sealed class CF_00001768E_PartialSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001768E_PartialSorting));
        ...
        {
            bool result = CF_00001768E_PartialSorting.Solution_0_Test(input);
