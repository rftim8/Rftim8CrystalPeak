...
{
    [TestClass]
    public sealed class CF_00001742G_Orray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001742G_Orray));
        ...
        {
            bool result = CF_00001742G_Orray.Solution_0_Test(input);
