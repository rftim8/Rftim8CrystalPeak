...
{
    [TestClass]
    public sealed class CF_00001693E_OutermostMaximums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001693E_OutermostMaximums));
        ...
        {
            bool result = CF_00001693E_OutermostMaximums.Solution_0_Test(input);
