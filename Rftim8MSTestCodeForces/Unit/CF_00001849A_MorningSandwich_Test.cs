...
{
    [TestClass]
    public sealed class CF_00001849A_MorningSandwich_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001849A_MorningSandwich));
        ...
        {
            bool result = CF_00001849A_MorningSandwich.Solution_0_Test(input);
