...
{
    [TestClass]
    public sealed class CF_00000592D_SuperM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000592D_SuperM));
        ...
        {
            bool result = CF_00000592D_SuperM.Solution_0_Test(input);
