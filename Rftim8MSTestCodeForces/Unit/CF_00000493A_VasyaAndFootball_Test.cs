...
{
    [TestClass]
    public sealed class CF_00000493A_VasyaAndFootball_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000493A_VasyaAndFootball));
        ...
        {
            bool result = CF_00000493A_VasyaAndFootball.Solution_0_Test(input);
