...
{
    [TestClass]
    public sealed class CF_00000733B_Parade_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000733B_Parade));
        ...
        {
            bool result = CF_00000733B_Parade.Solution_0_Test(input);
