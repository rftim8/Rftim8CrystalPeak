...
{
    [TestClass]
    public sealed class CF_00001775D_FriendlySpiders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001775D_FriendlySpiders));
        ...
        {
            bool result = CF_00001775D_FriendlySpiders.Solution_0_Test(input);
