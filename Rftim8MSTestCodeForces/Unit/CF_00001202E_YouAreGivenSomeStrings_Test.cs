...
{
    [TestClass]
    public sealed class CF_00001202E_YouAreGivenSomeStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001202E_YouAreGivenSomeStrings));
        ...
        {
            bool result = CF_00001202E_YouAreGivenSomeStrings.Solution_0_Test(input);
