...
{
    [TestClass]
    public sealed class CF_00000599D_SpongebobAndSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000599D_SpongebobAndSquares));
        ...
        {
            bool result = CF_00000599D_SpongebobAndSquares.Solution_0_Test(input);
