...
{
    [TestClass]
    public sealed class CF_00001301A_ThreeStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001301A_ThreeStrings));
        ...
        {
            bool result = CF_00001301A_ThreeStrings.Solution_0_Test(input);
