...
{
    [TestClass]
    public sealed class CF_00000431E_ChemistryExperiment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000431E_ChemistryExperiment));
        ...
        {
            bool result = CF_00000431E_ChemistryExperiment.Solution_0_Test(input);
