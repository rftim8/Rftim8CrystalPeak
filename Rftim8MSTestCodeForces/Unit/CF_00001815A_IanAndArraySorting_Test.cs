...
{
    [TestClass]
    public sealed class CF_00001815A_IanAndArraySorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001815A_IanAndArraySorting));
        ...
        {
            bool result = CF_00001815A_IanAndArraySorting.Solution_0_Test(input);
