...
{
    [TestClass]
    public sealed class CF_00000362D_FoolsAndFoolproofRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000362D_FoolsAndFoolproofRoads));
        ...
        {
            bool result = CF_00000362D_FoolsAndFoolproofRoads.Solution_0_Test(input);
