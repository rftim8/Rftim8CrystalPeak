...
{
    [TestClass]
    public sealed class CF_00001209F_KoalaAndNotebook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001209F_KoalaAndNotebook));
        ...
        {
            bool result = CF_00001209F_KoalaAndNotebook.Solution_0_Test(input);
