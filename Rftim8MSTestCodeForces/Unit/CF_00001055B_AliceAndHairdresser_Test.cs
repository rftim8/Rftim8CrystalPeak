...
{
    [TestClass]
    public sealed class CF_00001055B_AliceAndHairdresser_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001055B_AliceAndHairdresser));
        ...
        {
            bool result = CF_00001055B_AliceAndHairdresser.Solution_0_Test(input);
