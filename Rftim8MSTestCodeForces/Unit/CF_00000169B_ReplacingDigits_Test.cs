...
{
    [TestClass]
    public sealed class CF_00000169B_ReplacingDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000169B_ReplacingDigits));
        ...
        {
            bool result = CF_00000169B_ReplacingDigits.Solution_0_Test(input);
