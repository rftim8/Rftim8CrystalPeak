...
{
    [TestClass]
    public sealed class CF_00001672I_PermutationForces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001672I_PermutationForces));
        ...
        {
            bool result = CF_00001672I_PermutationForces.Solution_0_Test(input);
