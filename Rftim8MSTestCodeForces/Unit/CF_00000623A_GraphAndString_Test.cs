...
{
    [TestClass]
    public sealed class CF_00000623A_GraphAndString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000623A_GraphAndString));
        ...
        {
            bool result = CF_00000623A_GraphAndString.Solution_0_Test(input);
