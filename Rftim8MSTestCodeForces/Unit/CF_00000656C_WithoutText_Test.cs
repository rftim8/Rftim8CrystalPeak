...
{
    [TestClass]
    public sealed class CF_00000656C_WithoutText_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000656C_WithoutText));
        ...
        {
            bool result = CF_00000656C_WithoutText.Solution_0_Test(input);
