...
{
    [TestClass]
    public sealed class CF_00001671E_Preorder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001671E_Preorder));
        ...
        {
            bool result = CF_00001671E_Preorder.Solution_0_Test(input);
