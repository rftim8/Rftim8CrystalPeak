...
{
    [TestClass]
    public sealed class CF_00000862C_MahmoudAndEhabAndTheXor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000862C_MahmoudAndEhabAndTheXor));
        ...
        {
            bool result = CF_00000862C_MahmoudAndEhabAndTheXor.Solution_0_Test(input);
