...
{
    [TestClass]
    public sealed class CF_00000911A_NearestMinimums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000911A_NearestMinimums));
        ...
        {
            bool result = CF_00000911A_NearestMinimums.Solution_0_Test(input);
