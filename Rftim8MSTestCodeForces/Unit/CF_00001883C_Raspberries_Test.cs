...
{
    [TestClass]
    public sealed class CF_00001883C_Raspberries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001883C_Raspberries));
        ...
        {
            bool result = CF_00001883C_Raspberries.Solution_0_Test(input);
