...
{
    [TestClass]
    public sealed class CF_00000051E_Pentagon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000051E_Pentagon));
        ...
        {
            bool result = CF_00000051E_Pentagon.Solution_0_Test(input);
