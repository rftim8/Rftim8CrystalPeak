...
{
    [TestClass]
    public sealed class CF_00000756F_LongNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000756F_LongNumber));
        ...
        {
            bool result = CF_00000756F_LongNumber.Solution_0_Test(input);
