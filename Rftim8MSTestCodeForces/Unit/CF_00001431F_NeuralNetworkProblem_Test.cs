...
{
    [TestClass]
    public sealed class CF_00001431F_NeuralNetworkProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001431F_NeuralNetworkProblem));
        ...
        {
            bool result = CF_00001431F_NeuralNetworkProblem.Solution_0_Test(input);
