...
{
    [TestClass]
    public sealed class CF_00001841B_KeepItBeautiful_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001841B_KeepItBeautiful));
        ...
        {
            bool result = CF_00001841B_KeepItBeautiful.Solution_0_Test(input);
