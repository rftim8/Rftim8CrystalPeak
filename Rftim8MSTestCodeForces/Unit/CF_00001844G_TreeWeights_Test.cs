...
{
    [TestClass]
    public sealed class CF_00001844G_TreeWeights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001844G_TreeWeights));
        ...
        {
            bool result = CF_00001844G_TreeWeights.Solution_0_Test(input);
