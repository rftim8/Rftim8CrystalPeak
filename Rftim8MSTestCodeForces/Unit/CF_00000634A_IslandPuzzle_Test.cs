...
{
    [TestClass]
    public sealed class CF_00000634A_IslandPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000634A_IslandPuzzle));
        ...
        {
            bool result = CF_00000634A_IslandPuzzle.Solution_0_Test(input);
