...
{
    [TestClass]
    public sealed class CF_00001196C_RobotBreakout_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001196C_RobotBreakout));
        ...
        {
            bool result = CF_00001196C_RobotBreakout.Solution_0_Test(input);
