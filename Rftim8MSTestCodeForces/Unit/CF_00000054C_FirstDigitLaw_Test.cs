...
{
    [TestClass]
    public sealed class CF_00000054C_FirstDigitLaw_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000054C_FirstDigitLaw));
        ...
        {
            bool result = CF_00000054C_FirstDigitLaw.Solution_0_Test(input);
