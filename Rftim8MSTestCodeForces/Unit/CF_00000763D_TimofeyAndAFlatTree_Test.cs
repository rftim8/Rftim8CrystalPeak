...
{
    [TestClass]
    public sealed class CF_00000763D_TimofeyAndAFlatTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000763D_TimofeyAndAFlatTree));
        ...
        {
            bool result = CF_00000763D_TimofeyAndAFlatTree.Solution_0_Test(input);
