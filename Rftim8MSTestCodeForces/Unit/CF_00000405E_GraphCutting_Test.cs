...
{
    [TestClass]
    public sealed class CF_00000405E_GraphCutting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000405E_GraphCutting));
        ...
        {
            bool result = CF_00000405E_GraphCutting.Solution_0_Test(input);
