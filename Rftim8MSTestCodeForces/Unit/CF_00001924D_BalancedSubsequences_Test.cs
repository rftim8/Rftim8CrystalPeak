...
{
    [TestClass]
    public sealed class CF_00001924D_BalancedSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001924D_BalancedSubsequences));
        ...
        {
            bool result = CF_00001924D_BalancedSubsequences.Solution_0_Test(input);
