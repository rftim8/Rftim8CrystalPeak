...
{
    [TestClass]
    public sealed class CF_00002038D_DivideORConquer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002038D_DivideORConquer));
        ...
        {
            bool result = CF_00002038D_DivideORConquer.Solution_0_Test(input);
