...
{
    [TestClass]
    public sealed class CF_00000161B_Discounts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000161B_Discounts));
        ...
        {
            bool result = CF_00000161B_Discounts.Solution_0_Test(input);
