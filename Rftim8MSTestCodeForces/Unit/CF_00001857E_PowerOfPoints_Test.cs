...
{
    [TestClass]
    public sealed class CF_00001857E_PowerOfPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001857E_PowerOfPoints));
        ...
        {
            bool result = CF_00001857E_PowerOfPoints.Solution_0_Test(input);
