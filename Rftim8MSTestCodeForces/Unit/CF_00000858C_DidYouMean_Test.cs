...
{
    [TestClass]
    public sealed class CF_00000858C_DidYouMean_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000858C_DidYouMean));
        ...
        {
            bool result = CF_00000858C_DidYouMean.Solution_0_Test(input);
