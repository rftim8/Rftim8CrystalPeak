...
{
    [TestClass]
    public sealed class CF_00001207C_GasPipeline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001207C_GasPipeline));
        ...
        {
            bool result = CF_00001207C_GasPipeline.Solution_0_Test(input);
