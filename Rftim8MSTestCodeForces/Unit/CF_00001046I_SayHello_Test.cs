...
{
    [TestClass]
    public sealed class CF_00001046I_SayHello_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001046I_SayHello));
        ...
        {
            bool result = CF_00001046I_SayHello.Solution_0_Test(input);
