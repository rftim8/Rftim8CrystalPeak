...
{
    [TestClass]
    public sealed class CF_00000064A_Factorial_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000064A_Factorial));
        ...
        {
            bool result = CF_00000064A_Factorial.Solution_0_Test(input);
