...
{
    [TestClass]
    public sealed class CF_00000746B_Decoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000746B_Decoding));
        ...
        {
            bool result = CF_00000746B_Decoding.Solution_0_Test(input);
