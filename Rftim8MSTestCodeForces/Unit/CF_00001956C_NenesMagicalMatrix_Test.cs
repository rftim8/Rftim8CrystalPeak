...
{
    [TestClass]
    public sealed class CF_00001956C_NenesMagicalMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001956C_NenesMagicalMatrix));
        ...
        {
            bool result = CF_00001956C_NenesMagicalMatrix.Solution_0_Test(input);
