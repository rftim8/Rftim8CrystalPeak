...
{
    [TestClass]
    public sealed class CF_00000382D_KseniaAndPawns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000382D_KseniaAndPawns));
        ...
        {
            bool result = CF_00000382D_KseniaAndPawns.Solution_0_Test(input);
