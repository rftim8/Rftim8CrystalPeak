...
{
    [TestClass]
    public sealed class CF_00000214A_SystemOfEquations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000214A_SystemOfEquations));
        ...
        {
            bool result = CF_00000214A_SystemOfEquations.Solution_0_Test(input);
