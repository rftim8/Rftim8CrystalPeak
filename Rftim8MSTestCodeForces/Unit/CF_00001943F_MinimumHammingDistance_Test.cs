...
{
    [TestClass]
    public sealed class CF_00001943F_MinimumHammingDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001943F_MinimumHammingDistance));
        ...
        {
            bool result = CF_00001943F_MinimumHammingDistance.Solution_0_Test(input);
