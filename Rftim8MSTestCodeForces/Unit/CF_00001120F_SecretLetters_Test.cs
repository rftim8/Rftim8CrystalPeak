...
{
    [TestClass]
    public sealed class CF_00001120F_SecretLetters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001120F_SecretLetters));
        ...
        {
            bool result = CF_00001120F_SecretLetters.Solution_0_Test(input);
