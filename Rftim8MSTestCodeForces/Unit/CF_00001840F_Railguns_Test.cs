...
{
    [TestClass]
    public sealed class CF_00001840F_Railguns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001840F_Railguns));
        ...
        {
            bool result = CF_00001840F_Railguns.Solution_0_Test(input);
