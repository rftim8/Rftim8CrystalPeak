...
{
    [TestClass]
    public sealed class CF_00000770A_NewPassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000770A_NewPassword));
        ...
        {
            bool result = CF_00000770A_NewPassword.Solution_0_Test(input);
