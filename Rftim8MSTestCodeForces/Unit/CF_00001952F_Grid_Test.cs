...
{
    [TestClass]
    public sealed class CF_00001952F_Grid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001952F_Grid));
        ...
        {
            bool result = CF_00001952F_Grid.Solution_0_Test(input);
