...
{
    [TestClass]
    public sealed class CF_00000939A_LoveTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000939A_LoveTriangle));
        ...
        {
            bool result = CF_00000939A_LoveTriangle.Solution_0_Test(input);
