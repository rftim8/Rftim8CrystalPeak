...
{
    [TestClass]
    public sealed class CF_00001562C_Rings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001562C_Rings));
        ...
        {
            bool result = CF_00001562C_Rings.Solution_0_Test(input);
