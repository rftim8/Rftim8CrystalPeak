...
{
    [TestClass]
    public sealed class CF_00000899A_SplittingInTeams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000899A_SplittingInTeams));
        ...
        {
            bool result = CF_00000899A_SplittingInTeams.Solution_0_Test(input);
