...
{
    [TestClass]
    public sealed class CF_00000385A_BearAndRaspberry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000385A_BearAndRaspberry));
        ...
        {
            bool result = CF_00000385A_BearAndRaspberry.Solution_0_Test(input);
