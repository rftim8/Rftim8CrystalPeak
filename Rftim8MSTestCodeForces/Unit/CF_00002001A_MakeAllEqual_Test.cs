...
{
    [TestClass]
    public sealed class CF_00002001A_MakeAllEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002001A_MakeAllEqual));
        ...
        {
            bool result = CF_00002001A_MakeAllEqual.Solution_0_Test(input);
