...
{
    [TestClass]
    public sealed class CF_00000475A_BayanBus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000475A_BayanBus));
        ...
        {
            bool result = CF_00000475A_BayanBus.Solution_0_Test(input);
