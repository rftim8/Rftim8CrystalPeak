...
{
    [TestClass]
    public sealed class CF_00001630E_ExpectedComponents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001630E_ExpectedComponents));
        ...
        {
            bool result = CF_00001630E_ExpectedComponents.Solution_0_Test(input);
