...
{
    [TestClass]
    public sealed class CF_00001172E_NauuoAndODT_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001172E_NauuoAndODT));
        ...
        {
            bool result = CF_00001172E_NauuoAndODT.Solution_0_Test(input);
