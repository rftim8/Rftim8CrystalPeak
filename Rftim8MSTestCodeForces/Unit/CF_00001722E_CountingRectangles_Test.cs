...
{
    [TestClass]
    public sealed class CF_00001722E_CountingRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001722E_CountingRectangles));
        ...
        {
            bool result = CF_00001722E_CountingRectangles.Solution_0_Test(input);
