...
{
    [TestClass]
    public sealed class CF_00000167E_WizardsAndBets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000167E_WizardsAndBets));
        ...
        {
            bool result = CF_00000167E_WizardsAndBets.Solution_0_Test(input);
