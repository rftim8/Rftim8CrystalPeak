...
{
    [TestClass]
    public sealed class CF_00000908G_NewYearAndOriginalOrder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000908G_NewYearAndOriginalOrder));
        ...
        {
            bool result = CF_00000908G_NewYearAndOriginalOrder.Solution_0_Test(input);
