...
{
    [TestClass]
    public sealed class CF_00000730D_RunningOverTheBridges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730D_RunningOverTheBridges));
        ...
        {
            bool result = CF_00000730D_RunningOverTheBridges.Solution_0_Test(input);
