...
{
    [TestClass]
    public sealed class CF_00000680A_BearAndFiveCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000680A_BearAndFiveCards));
        ...
        {
            bool result = CF_00000680A_BearAndFiveCards.Solution_0_Test(input);
