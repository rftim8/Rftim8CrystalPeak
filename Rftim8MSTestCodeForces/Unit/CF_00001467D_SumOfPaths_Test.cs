...
{
    [TestClass]
    public sealed class CF_00001467D_SumOfPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001467D_SumOfPaths));
        ...
        {
            bool result = CF_00001467D_SumOfPaths.Solution_0_Test(input);
