...
{
    [TestClass]
    public sealed class CF_00000934A_ACompatiblePair_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000934A_ACompatiblePair));
        ...
        {
            bool result = CF_00000934A_ACompatiblePair.Solution_0_Test(input);
