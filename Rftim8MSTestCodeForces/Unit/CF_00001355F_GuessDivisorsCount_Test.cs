...
{
    [TestClass]
    public sealed class CF_00001355F_GuessDivisorsCount_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001355F_GuessDivisorsCount));
        ...
        {
            bool result = CF_00001355F_GuessDivisorsCount.Solution_0_Test(input);
