...
{
    [TestClass]
    public sealed class CF_00000130J_DateCalculation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000130J_DateCalculation));
        ...
        {
            bool result = CF_00000130J_DateCalculation.Solution_0_Test(input);
