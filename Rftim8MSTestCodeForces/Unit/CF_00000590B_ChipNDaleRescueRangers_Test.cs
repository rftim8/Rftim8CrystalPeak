...
{
    [TestClass]
    public sealed class CF_00000590B_ChipNDaleRescueRangers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000590B_ChipNDaleRescueRangers));
        ...
        {
            bool result = CF_00000590B_ChipNDaleRescueRangers.Solution_0_Test(input);
