...
{
    [TestClass]
    public sealed class CF_00000092A_Chips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000092A_Chips));
        ...
        {
            bool result = CF_00000092A_Chips.Solution_0_Test(input);
