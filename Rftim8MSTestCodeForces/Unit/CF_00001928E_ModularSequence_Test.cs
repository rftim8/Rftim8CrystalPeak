...
{
    [TestClass]
    public sealed class CF_00001928E_ModularSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001928E_ModularSequence));
        ...
        {
            bool result = CF_00001928E_ModularSequence.Solution_0_Test(input);
