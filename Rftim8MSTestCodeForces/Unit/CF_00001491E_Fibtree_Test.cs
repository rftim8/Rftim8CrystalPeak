...
{
    [TestClass]
    public sealed class CF_00001491E_Fibtree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001491E_Fibtree));
        ...
        {
            bool result = CF_00001491E_Fibtree.Solution_0_Test(input);
