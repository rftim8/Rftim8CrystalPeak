...
{
    [TestClass]
    public sealed class CF_00001599D_BubblePopping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001599D_BubblePopping));
        ...
        {
            bool result = CF_00001599D_BubblePopping.Solution_0_Test(input);
