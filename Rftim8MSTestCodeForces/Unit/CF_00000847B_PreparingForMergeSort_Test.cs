...
{
    [TestClass]
    public sealed class CF_00000847B_PreparingForMergeSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847B_PreparingForMergeSort));
        ...
        {
            bool result = CF_00000847B_PreparingForMergeSort.Solution_0_Test(input);
