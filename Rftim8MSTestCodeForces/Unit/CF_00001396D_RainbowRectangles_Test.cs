...
{
    [TestClass]
    public sealed class CF_00001396D_RainbowRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001396D_RainbowRectangles));
        ...
        {
            bool result = CF_00001396D_RainbowRectangles.Solution_0_Test(input);
