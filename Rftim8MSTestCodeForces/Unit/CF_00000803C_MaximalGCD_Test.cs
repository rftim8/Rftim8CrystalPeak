...
{
    [TestClass]
    public sealed class CF_00000803C_MaximalGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000803C_MaximalGCD));
        ...
        {
            bool result = CF_00000803C_MaximalGCD.Solution_0_Test(input);
