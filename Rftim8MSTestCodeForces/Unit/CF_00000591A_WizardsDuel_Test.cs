...
{
    [TestClass]
    public sealed class CF_00000591A_WizardsDuel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000591A_WizardsDuel));
        ...
        {
            bool result = CF_00000591A_WizardsDuel.Solution_0_Test(input);
