...
{
    [TestClass]
    public sealed class CF_00001342D_MultipleTestcases_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001342D_MultipleTestcases));
        ...
        {
            bool result = CF_00001342D_MultipleTestcases.Solution_0_Test(input);
