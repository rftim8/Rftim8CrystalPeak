...
{
    [TestClass]
    public sealed class CF_00001221C_PerfectTeam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001221C_PerfectTeam));
        ...
        {
            bool result = CF_00001221C_PerfectTeam.Solution_0_Test(input);
