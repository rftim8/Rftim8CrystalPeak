...
{
    [TestClass]
    public sealed class CF_00001419E_Decryption_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001419E_Decryption));
        ...
        {
            bool result = CF_00001419E_Decryption.Solution_0_Test(input);
