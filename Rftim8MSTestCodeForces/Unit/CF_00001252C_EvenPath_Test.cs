...
{
    [TestClass]
    public sealed class CF_00001252C_EvenPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001252C_EvenPath));
        ...
        {
            bool result = CF_00001252C_EvenPath.Solution_0_Test(input);
