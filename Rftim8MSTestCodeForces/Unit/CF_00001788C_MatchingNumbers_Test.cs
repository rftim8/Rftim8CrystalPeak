...
{
    [TestClass]
    public sealed class CF_00001788C_MatchingNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001788C_MatchingNumbers));
        ...
        {
            bool result = CF_00001788C_MatchingNumbers.Solution_0_Test(input);
