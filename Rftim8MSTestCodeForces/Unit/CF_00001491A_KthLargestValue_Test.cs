...
{
    [TestClass]
    public sealed class CF_00001491A_KthLargestValue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001491A_KthLargestValue));
        ...
        {
            bool result = CF_00001491A_KthLargestValue.Solution_0_Test(input);
