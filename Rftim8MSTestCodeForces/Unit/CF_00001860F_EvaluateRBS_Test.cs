...
{
    [TestClass]
    public sealed class CF_00001860F_EvaluateRBS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001860F_EvaluateRBS));
        ...
        {
            bool result = CF_00001860F_EvaluateRBS.Solution_0_Test(input);
