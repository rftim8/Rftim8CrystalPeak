...
{
    [TestClass]
    public sealed class CF_00001699D_AlmostTripleDeletions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001699D_AlmostTripleDeletions));
        ...
        {
            bool result = CF_00001699D_AlmostTripleDeletions.Solution_0_Test(input);
