...
{
    [TestClass]
    public sealed class CF_00002018D_MaxPlusMinPlusSize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002018D_MaxPlusMinPlusSize));
        ...
        {
            bool result = CF_00002018D_MaxPlusMinPlusSize.Solution_0_Test(input);
