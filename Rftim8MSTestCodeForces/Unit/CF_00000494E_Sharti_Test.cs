...
{
    [TestClass]
    public sealed class CF_00000494E_Sharti_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000494E_Sharti));
        ...
        {
            bool result = CF_00000494E_Sharti.Solution_0_Test(input);
