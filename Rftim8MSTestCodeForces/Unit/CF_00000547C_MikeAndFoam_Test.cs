...
{
    [TestClass]
    public sealed class CF_00000547C_MikeAndFoam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000547C_MikeAndFoam));
        ...
        {
            bool result = CF_00000547C_MikeAndFoam.Solution_0_Test(input);
