...
{
    [TestClass]
    public sealed class CF_00002003C_TurtleAndGoodPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002003C_TurtleAndGoodPairs));
        ...
        {
            bool result = CF_00002003C_TurtleAndGoodPairs.Solution_0_Test(input);
