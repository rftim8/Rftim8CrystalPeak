...
{
    [TestClass]
    public sealed class CF_00001684C_ColumnSwapping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001684C_ColumnSwapping));
        ...
        {
            bool result = CF_00001684C_ColumnSwapping.Solution_0_Test(input);
