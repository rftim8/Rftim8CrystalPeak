...
{
    [TestClass]
    public sealed class CF_00000954E_WaterTaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000954E_WaterTaps));
        ...
        {
            bool result = CF_00000954E_WaterTaps.Solution_0_Test(input);
