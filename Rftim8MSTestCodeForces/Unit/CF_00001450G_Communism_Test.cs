...
{
    [TestClass]
    public sealed class CF_00001450G_Communism_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001450G_Communism));
        ...
        {
            bool result = CF_00001450G_Communism.Solution_0_Test(input);
