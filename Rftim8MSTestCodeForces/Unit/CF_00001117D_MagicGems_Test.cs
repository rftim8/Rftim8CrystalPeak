...
{
    [TestClass]
    public sealed class CF_00001117D_MagicGems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001117D_MagicGems));
        ...
        {
            bool result = CF_00001117D_MagicGems.Solution_0_Test(input);
