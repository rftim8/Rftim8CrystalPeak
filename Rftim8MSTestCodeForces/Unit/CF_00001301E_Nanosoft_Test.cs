...
{
    [TestClass]
    public sealed class CF_00001301E_Nanosoft_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001301E_Nanosoft));
        ...
        {
            bool result = CF_00001301E_Nanosoft.Solution_0_Test(input);
