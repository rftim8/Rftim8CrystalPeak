...
{
    [TestClass]
    public sealed class CF_00000976C_NestedSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000976C_NestedSegments));
        ...
        {
            bool result = CF_00000976C_NestedSegments.Solution_0_Test(input);
