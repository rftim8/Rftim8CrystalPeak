...
{
    [TestClass]
    public sealed class CF_00001858D_TreesAndSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001858D_TreesAndSegments));
        ...
        {
            bool result = CF_00001858D_TreesAndSegments.Solution_0_Test(input);
