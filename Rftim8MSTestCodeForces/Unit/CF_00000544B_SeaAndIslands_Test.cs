...
{
    [TestClass]
    public sealed class CF_00000544B_SeaAndIslands_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000544B_SeaAndIslands));
        ...
        {
            bool result = CF_00000544B_SeaAndIslands.Solution_0_Test(input);
