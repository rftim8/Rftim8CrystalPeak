...
{
    [TestClass]
    public sealed class CF_00001497C2_KLCMHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001497C2_KLCMHardVersion));
        ...
        {
            bool result = CF_00001497C2_KLCMHardVersion.Solution_0_Test(input);
