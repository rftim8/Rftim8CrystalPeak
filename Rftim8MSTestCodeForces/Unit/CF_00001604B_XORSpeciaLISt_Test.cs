...
{
    [TestClass]
    public sealed class CF_00001604B_XORSpeciaLISt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001604B_XORSpeciaLISt));
        ...
        {
            bool result = CF_00001604B_XORSpeciaLISt.Solution_0_Test(input);
