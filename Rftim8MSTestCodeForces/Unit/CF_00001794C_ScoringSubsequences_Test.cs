...
{
    [TestClass]
    public sealed class CF_00001794C_ScoringSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001794C_ScoringSubsequences));
        ...
        {
            bool result = CF_00001794C_ScoringSubsequences.Solution_0_Test(input);
