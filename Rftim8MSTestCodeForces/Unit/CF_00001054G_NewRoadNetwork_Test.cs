...
{
    [TestClass]
    public sealed class CF_00001054G_NewRoadNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001054G_NewRoadNetwork));
        ...
        {
            bool result = CF_00001054G_NewRoadNetwork.Solution_0_Test(input);
