...
{
    [TestClass]
    public sealed class CF_00000987C_ThreeDisplays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000987C_ThreeDisplays));
        ...
        {
            bool result = CF_00000987C_ThreeDisplays.Solution_0_Test(input);
