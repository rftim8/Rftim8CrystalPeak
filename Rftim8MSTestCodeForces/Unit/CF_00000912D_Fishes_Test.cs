...
{
    [TestClass]
    public sealed class CF_00000912D_Fishes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000912D_Fishes));
        ...
        {
            bool result = CF_00000912D_Fishes.Solution_0_Test(input);
