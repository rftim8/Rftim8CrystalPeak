...
{
    [TestClass]
    public sealed class CF_00001889B_DoremysConnectingPlan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001889B_DoremysConnectingPlan));
        ...
        {
            bool result = CF_00001889B_DoremysConnectingPlan.Solution_0_Test(input);
