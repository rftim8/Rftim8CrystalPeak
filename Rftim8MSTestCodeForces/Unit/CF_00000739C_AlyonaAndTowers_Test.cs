...
{
    [TestClass]
    public sealed class CF_00000739C_AlyonaAndTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000739C_AlyonaAndTowers));
        ...
        {
            bool result = CF_00000739C_AlyonaAndTowers.Solution_0_Test(input);
