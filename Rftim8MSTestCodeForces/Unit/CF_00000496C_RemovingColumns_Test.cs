...
{
    [TestClass]
    public sealed class CF_00000496C_RemovingColumns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000496C_RemovingColumns));
        ...
        {
            bool result = CF_00000496C_RemovingColumns.Solution_0_Test(input);
