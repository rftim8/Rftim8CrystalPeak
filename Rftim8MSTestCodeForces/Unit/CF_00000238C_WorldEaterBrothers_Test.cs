...
{
    [TestClass]
    public sealed class CF_00000238C_WorldEaterBrothers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000238C_WorldEaterBrothers));
        ...
        {
            bool result = CF_00000238C_WorldEaterBrothers.Solution_0_Test(input);
