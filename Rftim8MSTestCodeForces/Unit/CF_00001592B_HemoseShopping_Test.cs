...
{
    [TestClass]
    public sealed class CF_00001592B_HemoseShopping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001592B_HemoseShopping));
        ...
        {
            bool result = CF_00001592B_HemoseShopping.Solution_0_Test(input);
