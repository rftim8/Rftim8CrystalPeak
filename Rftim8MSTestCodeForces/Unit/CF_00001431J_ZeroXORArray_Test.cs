...
{
    [TestClass]
    public sealed class CF_00001431J_ZeroXORArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001431J_ZeroXORArray));
        ...
        {
            bool result = CF_00001431J_ZeroXORArray.Solution_0_Test(input);
