...
{
    [TestClass]
    public sealed class CF_00001949C_AnnualAntsGathering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001949C_AnnualAntsGathering));
        ...
        {
            bool result = CF_00001949C_AnnualAntsGathering.Solution_0_Test(input);
