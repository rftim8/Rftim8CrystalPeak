...
{
    [TestClass]
    public sealed class CF_00000446A_DZYLovesSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000446A_DZYLovesSequences));
        ...
        {
            bool result = CF_00000446A_DZYLovesSequences.Solution_0_Test(input);
