...
{
    [TestClass]
    public sealed class CF_00000607B_Zuma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000607B_Zuma));
        ...
        {
            bool result = CF_00000607B_Zuma.Solution_0_Test(input);
