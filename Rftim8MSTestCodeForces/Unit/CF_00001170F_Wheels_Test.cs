...
{
    [TestClass]
    public sealed class CF_00001170F_Wheels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001170F_Wheels));
        ...
        {
            bool result = CF_00001170F_Wheels.Solution_0_Test(input);
