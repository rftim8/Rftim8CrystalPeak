...
{
    [TestClass]
    public sealed class CF_00001783A_MakeItBeautiful_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001783A_MakeItBeautiful));
        ...
        {
            bool result = CF_00001783A_MakeItBeautiful.Solution_0_Test(input);
