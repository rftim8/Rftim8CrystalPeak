...
{
    [TestClass]
    public sealed class CF_00000292C_BeautifulIPAddresses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000292C_BeautifulIPAddresses));
        ...
        {
            bool result = CF_00000292C_BeautifulIPAddresses.Solution_0_Test(input);
