...
{
    [TestClass]
    public sealed class CF_00001453F_EvenHarder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001453F_EvenHarder));
        ...
        {
            bool result = CF_00001453F_EvenHarder.Solution_0_Test(input);
