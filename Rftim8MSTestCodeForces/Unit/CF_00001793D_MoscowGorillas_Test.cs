...
{
    [TestClass]
    public sealed class CF_00001793D_MoscowGorillas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001793D_MoscowGorillas));
        ...
        {
            bool result = CF_00001793D_MoscowGorillas.Solution_0_Test(input);
