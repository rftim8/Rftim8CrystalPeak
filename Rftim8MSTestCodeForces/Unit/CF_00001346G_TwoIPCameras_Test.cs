...
{
    [TestClass]
    public sealed class CF_00001346G_TwoIPCameras_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001346G_TwoIPCameras));
        ...
        {
            bool result = CF_00001346G_TwoIPCameras.Solution_0_Test(input);
