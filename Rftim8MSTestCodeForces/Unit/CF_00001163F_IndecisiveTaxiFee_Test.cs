...
{
    [TestClass]
    public sealed class CF_00001163F_IndecisiveTaxiFee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001163F_IndecisiveTaxiFee));
        ...
        {
            bool result = CF_00001163F_IndecisiveTaxiFee.Solution_0_Test(input);
