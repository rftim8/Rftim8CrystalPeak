...
{
    [TestClass]
    public sealed class CF_00000060A_WhereAreMyFlakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000060A_WhereAreMyFlakes));
        ...
        {
            bool result = CF_00000060A_WhereAreMyFlakes.Solution_0_Test(input);
