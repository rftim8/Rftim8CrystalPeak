...
{
    [TestClass]
    public sealed class CF_00001665B_ArrayCloningTechnique_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001665B_ArrayCloningTechnique));
        ...
        {
            bool result = CF_00001665B_ArrayCloningTechnique.Solution_0_Test(input);
