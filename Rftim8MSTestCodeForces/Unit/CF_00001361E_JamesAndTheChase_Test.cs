...
{
    [TestClass]
    public sealed class CF_00001361E_JamesAndTheChase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001361E_JamesAndTheChase));
        ...
        {
            bool result = CF_00001361E_JamesAndTheChase.Solution_0_Test(input);
