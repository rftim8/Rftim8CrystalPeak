...
{
    [TestClass]
    public sealed class CF_00001874D_JellyfishAndMiku_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001874D_JellyfishAndMiku));
        ...
        {
            bool result = CF_00001874D_JellyfishAndMiku.Solution_0_Test(input);
