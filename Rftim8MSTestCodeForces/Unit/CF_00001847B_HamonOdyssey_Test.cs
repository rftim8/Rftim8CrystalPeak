...
{
    [TestClass]
    public sealed class CF_00001847B_HamonOdyssey_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001847B_HamonOdyssey));
        ...
        {
            bool result = CF_00001847B_HamonOdyssey.Solution_0_Test(input);
