...
{
    [TestClass]
    public sealed class CF_00000856B_SimilarWords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000856B_SimilarWords));
        ...
        {
            bool result = CF_00000856B_SimilarWords.Solution_0_Test(input);
