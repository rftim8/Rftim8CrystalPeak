...
{
    [TestClass]
    public sealed class CF_00000209C_TrailsAndGlades_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000209C_TrailsAndGlades));
        ...
        {
            bool result = CF_00000209C_TrailsAndGlades.Solution_0_Test(input);
