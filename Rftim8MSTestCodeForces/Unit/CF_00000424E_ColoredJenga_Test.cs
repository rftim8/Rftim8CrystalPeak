...
{
    [TestClass]
    public sealed class CF_00000424E_ColoredJenga_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000424E_ColoredJenga));
        ...
        {
            bool result = CF_00000424E_ColoredJenga.Solution_0_Test(input);
