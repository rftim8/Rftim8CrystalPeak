...
{
    [TestClass]
    public sealed class CF_00000594C_EdoAndMagnets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000594C_EdoAndMagnets));
        ...
        {
            bool result = CF_00000594C_EdoAndMagnets.Solution_0_Test(input);
