...
{
    [TestClass]
    public sealed class CF_00001326F1_WiseMenEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001326F1_WiseMenEasyVersion));
        ...
        {
            bool result = CF_00001326F1_WiseMenEasyVersion.Solution_0_Test(input);
