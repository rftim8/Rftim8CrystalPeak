...
{
    [TestClass]
    public sealed class CF_00000152D_Frames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000152D_Frames));
        ...
        {
            bool result = CF_00000152D_Frames.Solution_0_Test(input);
