...
{
    [TestClass]
    public sealed class CF_00001323A_EvenSubsetSumProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001323A_EvenSubsetSumProblem));
        ...
        {
            bool result = CF_00001323A_EvenSubsetSumProblem.Solution_0_Test(input);
