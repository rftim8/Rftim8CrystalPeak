...
{
    [TestClass]
    public sealed class CF_00000379E_NewYearTreeDecorations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000379E_NewYearTreeDecorations));
        ...
        {
            bool result = CF_00000379E_NewYearTreeDecorations.Solution_0_Test(input);
