...
{
    [TestClass]
    public sealed class CF_00000316A2_SpecialTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000316A2_SpecialTask));
        ...
        {
            bool result = CF_00000316A2_SpecialTask.Solution_0_Test(input);
