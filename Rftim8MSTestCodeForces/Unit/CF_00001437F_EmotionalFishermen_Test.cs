...
{
    [TestClass]
    public sealed class CF_00001437F_EmotionalFishermen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001437F_EmotionalFishermen));
        ...
        {
            bool result = CF_00001437F_EmotionalFishermen.Solution_0_Test(input);
