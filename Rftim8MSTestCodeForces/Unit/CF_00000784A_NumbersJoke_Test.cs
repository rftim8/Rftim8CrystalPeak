...
{
    [TestClass]
    public sealed class CF_00000784A_NumbersJoke_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000784A_NumbersJoke));
        ...
        {
            bool result = CF_00000784A_NumbersJoke.Solution_0_Test(input);
