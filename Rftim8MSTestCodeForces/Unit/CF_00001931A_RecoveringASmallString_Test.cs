...
{
    [TestClass]
    public sealed class CF_00001931A_RecoveringASmallString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001931A_RecoveringASmallString));
        ...
        {
            bool result = CF_00001931A_RecoveringASmallString.Solution_0_Test(input);
