...
{
    [TestClass]
    public sealed class CF_00001948F_RareCoins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001948F_RareCoins));
        ...
        {
            bool result = CF_00001948F_RareCoins.Solution_0_Test(input);
