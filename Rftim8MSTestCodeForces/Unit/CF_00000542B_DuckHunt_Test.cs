...
{
    [TestClass]
    public sealed class CF_00000542B_DuckHunt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000542B_DuckHunt));
        ...
        {
            bool result = CF_00000542B_DuckHunt.Solution_0_Test(input);
