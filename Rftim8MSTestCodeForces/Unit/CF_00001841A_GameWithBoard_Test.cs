...
{
    [TestClass]
    public sealed class CF_00001841A_GameWithBoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001841A_GameWithBoard));
        ...
        {
            bool result = CF_00001841A_GameWithBoard.Solution_0_Test(input);
