...
{
    [TestClass]
    public sealed class CF_00000013C_Sequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000013C_Sequence));
        ...
        {
            bool result = CF_00000013C_Sequence.Solution_0_Test(input);
