...
{
    [TestClass]
    public sealed class CF_00001916A_2023_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001916A_2023));
        ...
        {
            bool result = CF_00001916A_2023.Solution_0_Test(input);
