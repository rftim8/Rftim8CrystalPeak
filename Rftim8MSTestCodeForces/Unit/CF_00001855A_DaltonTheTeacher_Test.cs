...
{
    [TestClass]
    public sealed class CF_00001855A_DaltonTheTeacher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001855A_DaltonTheTeacher));
        ...
        {
            bool result = CF_00001855A_DaltonTheTeacher.Solution_0_Test(input);
