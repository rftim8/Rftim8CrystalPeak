...
{
    [TestClass]
    public sealed class CF_00001493D_GCDOfAnArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001493D_GCDOfAnArray));
        ...
        {
            bool result = CF_00001493D_GCDOfAnArray.Solution_0_Test(input);
