...
{
    [TestClass]
    public sealed class CF_00001840D_WoodenToyFestival_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001840D_WoodenToyFestival));
        ...
        {
            bool result = CF_00001840D_WoodenToyFestival.Solution_0_Test(input);
