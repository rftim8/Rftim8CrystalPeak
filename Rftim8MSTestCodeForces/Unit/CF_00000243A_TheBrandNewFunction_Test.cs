...
{
    [TestClass]
    public sealed class CF_00000243A_TheBrandNewFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000243A_TheBrandNewFunction));
        ...
        {
            bool result = CF_00000243A_TheBrandNewFunction.Solution_0_Test(input);
