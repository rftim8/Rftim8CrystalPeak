...
{
    [TestClass]
    public sealed class CF_00000730G_CarRepairShop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730G_CarRepairShop));
        ...
        {
            bool result = CF_00000730G_CarRepairShop.Solution_0_Test(input);
