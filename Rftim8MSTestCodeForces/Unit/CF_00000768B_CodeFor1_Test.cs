...
{
    [TestClass]
    public sealed class CF_00000768B_CodeFor1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000768B_CodeFor1));
        ...
        {
            bool result = CF_00000768B_CodeFor1.Solution_0_Test(input);
