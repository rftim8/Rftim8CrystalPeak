...
{
    [TestClass]
    public sealed class CF_00000556A_CaseOfTheZerosAndOnes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000556A_CaseOfTheZerosAndOnes));
        ...
        {
            bool result = CF_00000556A_CaseOfTheZerosAndOnes.Solution_0_Test(input);
