...
{
    [TestClass]
    public sealed class CF_00000113D_Museum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000113D_Museum));
        ...
        {
            bool result = CF_00000113D_Museum.Solution_0_Test(input);
