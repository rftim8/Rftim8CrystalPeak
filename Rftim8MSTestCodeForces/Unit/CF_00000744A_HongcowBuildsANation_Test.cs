...
{
    [TestClass]
    public sealed class CF_00000744A_HongcowBuildsANation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000744A_HongcowBuildsANation));
        ...
        {
            bool result = CF_00000744A_HongcowBuildsANation.Solution_0_Test(input);
