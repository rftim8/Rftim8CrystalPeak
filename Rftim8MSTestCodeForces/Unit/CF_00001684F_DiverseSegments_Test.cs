...
{
    [TestClass]
    public sealed class CF_00001684F_DiverseSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001684F_DiverseSegments));
        ...
        {
            bool result = CF_00001684F_DiverseSegments.Solution_0_Test(input);
