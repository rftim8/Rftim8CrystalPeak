...
{
    [TestClass]
    public sealed class CF_00001060H_SophisticatedDevice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001060H_SophisticatedDevice));
        ...
        {
            bool result = CF_00001060H_SophisticatedDevice.Solution_0_Test(input);
