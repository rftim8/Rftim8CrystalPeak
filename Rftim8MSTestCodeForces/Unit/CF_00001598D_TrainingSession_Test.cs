...
{
    [TestClass]
    public sealed class CF_00001598D_TrainingSession_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001598D_TrainingSession));
        ...
        {
            bool result = CF_00001598D_TrainingSession.Solution_0_Test(input);
