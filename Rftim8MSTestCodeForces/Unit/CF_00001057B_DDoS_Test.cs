...
{
    [TestClass]
    public sealed class CF_00001057B_DDoS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001057B_DDoS));
        ...
        {
            bool result = CF_00001057B_DDoS.Solution_0_Test(input);
