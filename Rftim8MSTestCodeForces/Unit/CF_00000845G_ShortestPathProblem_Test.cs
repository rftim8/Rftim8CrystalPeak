...
{
    [TestClass]
    public sealed class CF_00000845G_ShortestPathProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000845G_ShortestPathProblem));
        ...
        {
            bool result = CF_00000845G_ShortestPathProblem.Solution_0_Test(input);
