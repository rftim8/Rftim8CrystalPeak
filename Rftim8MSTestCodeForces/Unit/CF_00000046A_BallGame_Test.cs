...
{
    [TestClass]
    public sealed class CF_00000046A_BallGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000046A_BallGame));
        ...
        {
            bool result = CF_00000046A_BallGame.Solution_0_Test(input);
