...
{
    [TestClass]
    public sealed class CF_00001245B_RestrictedRPS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001245B_RestrictedRPS));
        ...
        {
            bool result = CF_00001245B_RestrictedRPS.Solution_0_Test(input);
