...
{
    [TestClass]
    public sealed class CF_00000009C_HexadecimalsNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000009C_HexadecimalsNumbers));
        ...
        {
            bool result = CF_00000009C_HexadecimalsNumbers.Solution_0_Test(input);
