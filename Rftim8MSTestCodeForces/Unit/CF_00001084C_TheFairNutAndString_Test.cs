...
{
    [TestClass]
    public sealed class CF_00001084C_TheFairNutAndString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001084C_TheFairNutAndString));
        ...
        {
            bool result = CF_00001084C_TheFairNutAndString.Solution_0_Test(input);
