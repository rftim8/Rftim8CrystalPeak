...
{
    [TestClass]
    public sealed class CF_00000427E_PolicePatrol_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000427E_PolicePatrol));
        ...
        {
            bool result = CF_00000427E_PolicePatrol.Solution_0_Test(input);
