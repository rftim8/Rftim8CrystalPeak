...
{
    [TestClass]
    public sealed class CF_00001667B_OptimalPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001667B_OptimalPartition));
        ...
        {
            bool result = CF_00001667B_OptimalPartition.Solution_0_Test(input);
