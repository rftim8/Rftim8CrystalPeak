...
{
    [TestClass]
    public sealed class CF_00001251F_RedWhiteFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001251F_RedWhiteFence));
        ...
        {
            bool result = CF_00001251F_RedWhiteFence.Solution_0_Test(input);
