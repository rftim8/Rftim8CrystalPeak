...
{
    [TestClass]
    public sealed class CF_00000899E_SegmentsRemoval_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000899E_SegmentsRemoval));
        ...
        {
            bool result = CF_00000899E_SegmentsRemoval.Solution_0_Test(input);
