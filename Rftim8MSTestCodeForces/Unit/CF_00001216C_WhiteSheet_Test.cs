...
{
    [TestClass]
    public sealed class CF_00001216C_WhiteSheet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001216C_WhiteSheet));
        ...
        {
            bool result = CF_00001216C_WhiteSheet.Solution_0_Test(input);
