...
{
    [TestClass]
    public sealed class CF_00000774I_ComposingOfString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774I_ComposingOfString));
        ...
        {
            bool result = CF_00000774I_ComposingOfString.Solution_0_Test(input);
