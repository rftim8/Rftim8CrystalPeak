...
{
    [TestClass]
    public sealed class CF_00001830D_MexTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001830D_MexTree));
        ...
        {
            bool result = CF_00001830D_MexTree.Solution_0_Test(input);
