...
{
    [TestClass]
    public sealed class CF_00001864H_AsterismStream_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001864H_AsterismStream));
        ...
        {
            bool result = CF_00001864H_AsterismStream.Solution_0_Test(input);
