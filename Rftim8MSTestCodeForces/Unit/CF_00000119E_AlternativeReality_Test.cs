...
{
    [TestClass]
    public sealed class CF_00000119E_AlternativeReality_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000119E_AlternativeReality));
        ...
        {
            bool result = CF_00000119E_AlternativeReality.Solution_0_Test(input);
