...
{
    [TestClass]
    public sealed class CF_00001943C_TreeCompass_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001943C_TreeCompass));
        ...
        {
            bool result = CF_00001943C_TreeCompass.Solution_0_Test(input);
