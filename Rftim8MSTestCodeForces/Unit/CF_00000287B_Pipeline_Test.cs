...
{
    [TestClass]
    public sealed class CF_00000287B_Pipeline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000287B_Pipeline));
        ...
        {
            bool result = CF_00000287B_Pipeline.Solution_0_Test(input);
