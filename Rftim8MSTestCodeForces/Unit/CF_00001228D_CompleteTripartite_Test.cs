...
{
    [TestClass]
    public sealed class CF_00001228D_CompleteTripartite_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001228D_CompleteTripartite));
        ...
        {
            bool result = CF_00001228D_CompleteTripartite.Solution_0_Test(input);
