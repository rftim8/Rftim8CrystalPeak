...
{
    [TestClass]
    public sealed class CF_00001984G_MagicTrickII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001984G_MagicTrickII));
        ...
        {
            bool result = CF_00001984G_MagicTrickII.Solution_0_Test(input);
