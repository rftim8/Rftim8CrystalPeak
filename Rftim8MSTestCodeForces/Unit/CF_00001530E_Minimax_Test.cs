...
{
    [TestClass]
    public sealed class CF_00001530E_Minimax_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001530E_Minimax));
        ...
        {
            bool result = CF_00001530E_Minimax.Solution_0_Test(input);
