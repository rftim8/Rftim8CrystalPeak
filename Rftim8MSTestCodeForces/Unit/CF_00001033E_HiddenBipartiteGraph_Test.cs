...
{
    [TestClass]
    public sealed class CF_00001033E_HiddenBipartiteGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001033E_HiddenBipartiteGraph));
        ...
        {
            bool result = CF_00001033E_HiddenBipartiteGraph.Solution_0_Test(input);
