...
{
    [TestClass]
    public sealed class CF_00000491B_NewYorkHotel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000491B_NewYorkHotel));
        ...
        {
            bool result = CF_00000491B_NewYorkHotel.Solution_0_Test(input);
