...
{
    [TestClass]
    public sealed class CF_00001538A_StoneGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001538A_StoneGame));
        ...
        {
            bool result = CF_00001538A_StoneGame.Solution_0_Test(input);
