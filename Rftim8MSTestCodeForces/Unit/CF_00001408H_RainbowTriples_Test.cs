...
{
    [TestClass]
    public sealed class CF_00001408H_RainbowTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001408H_RainbowTriples));
        ...
        {
            bool result = CF_00001408H_RainbowTriples.Solution_0_Test(input);
