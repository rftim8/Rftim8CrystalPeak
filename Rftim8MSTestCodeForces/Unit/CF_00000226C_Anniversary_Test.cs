...
{
    [TestClass]
    public sealed class CF_00000226C_Anniversary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000226C_Anniversary));
        ...
        {
            bool result = CF_00000226C_Anniversary.Solution_0_Test(input);
