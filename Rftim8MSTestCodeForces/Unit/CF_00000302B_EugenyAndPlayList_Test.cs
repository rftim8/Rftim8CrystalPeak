...
{
    [TestClass]
    public sealed class CF_00000302B_EugenyAndPlayList_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000302B_EugenyAndPlayList));
        ...
        {
            bool result = CF_00000302B_EugenyAndPlayList.Solution_0_Test(input);
