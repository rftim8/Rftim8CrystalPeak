...
{
    [TestClass]
    public sealed class CF_00001305B_KuroniAndSimpleStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001305B_KuroniAndSimpleStrings));
        ...
        {
            bool result = CF_00001305B_KuroniAndSimpleStrings.Solution_0_Test(input);
