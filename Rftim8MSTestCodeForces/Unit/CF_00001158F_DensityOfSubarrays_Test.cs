...
{
    [TestClass]
    public sealed class CF_00001158F_DensityOfSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001158F_DensityOfSubarrays));
        ...
        {
            bool result = CF_00001158F_DensityOfSubarrays.Solution_0_Test(input);
