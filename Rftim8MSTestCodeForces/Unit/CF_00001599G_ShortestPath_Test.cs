...
{
    [TestClass]
    public sealed class CF_00001599G_ShortestPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001599G_ShortestPath));
        ...
        {
            bool result = CF_00001599G_ShortestPath.Solution_0_Test(input);
