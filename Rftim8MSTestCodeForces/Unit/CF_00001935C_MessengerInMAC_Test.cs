...
{
    [TestClass]
    public sealed class CF_00001935C_MessengerInMAC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001935C_MessengerInMAC));
        ...
        {
            bool result = CF_00001935C_MessengerInMAC.Solution_0_Test(input);
