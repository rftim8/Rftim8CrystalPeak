...
{
    [TestClass]
    public sealed class CF_00000772B_VolatileKite_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000772B_VolatileKite));
        ...
        {
            bool result = CF_00000772B_VolatileKite.Solution_0_Test(input);
