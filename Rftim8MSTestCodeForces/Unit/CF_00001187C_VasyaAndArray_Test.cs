...
{
    [TestClass]
    public sealed class CF_00001187C_VasyaAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001187C_VasyaAndArray));
        ...
        {
            bool result = CF_00001187C_VasyaAndArray.Solution_0_Test(input);
