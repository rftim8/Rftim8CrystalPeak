...
{
    [TestClass]
    public sealed class CF_00001389B_ArrayWalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001389B_ArrayWalk));
        ...
        {
            bool result = CF_00001389B_ArrayWalk.Solution_0_Test(input);
