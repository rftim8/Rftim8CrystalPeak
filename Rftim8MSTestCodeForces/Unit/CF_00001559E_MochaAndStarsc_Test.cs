...
{
    [TestClass]
    public sealed class CF_00001559E_MochaAndStarsc_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001559E_MochaAndStarsc));
        ...
        {
            bool result = CF_00001559E_MochaAndStarsc.Solution_0_Test(input);
