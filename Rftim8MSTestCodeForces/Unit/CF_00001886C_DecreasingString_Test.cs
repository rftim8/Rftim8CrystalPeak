...
{
    [TestClass]
    public sealed class CF_00001886C_DecreasingString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001886C_DecreasingString));
        ...
        {
            bool result = CF_00001886C_DecreasingString.Solution_0_Test(input);
