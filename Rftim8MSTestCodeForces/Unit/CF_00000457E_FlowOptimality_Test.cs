...
{
    [TestClass]
    public sealed class CF_00000457E_FlowOptimality_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000457E_FlowOptimality));
        ...
        {
            bool result = CF_00000457E_FlowOptimality.Solution_0_Test(input);
