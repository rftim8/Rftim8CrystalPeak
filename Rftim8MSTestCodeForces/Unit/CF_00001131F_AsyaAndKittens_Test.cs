...
{
    [TestClass]
    public sealed class CF_00001131F_AsyaAndKittens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001131F_AsyaAndKittens));
        ...
        {
            bool result = CF_00001131F_AsyaAndKittens.Solution_0_Test(input);
