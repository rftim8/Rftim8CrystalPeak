...
{
    [TestClass]
    public sealed class CF_00000530H_PointsInTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000530H_PointsInTriangle));
        ...
        {
            bool result = CF_00000530H_PointsInTriangle.Solution_0_Test(input);
