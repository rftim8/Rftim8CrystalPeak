...
{
    [TestClass]
    public sealed class CF_00000316E2_SummerHomework_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000316E2_SummerHomework));
        ...
        {
            bool result = CF_00000316E2_SummerHomework.Solution_0_Test(input);
