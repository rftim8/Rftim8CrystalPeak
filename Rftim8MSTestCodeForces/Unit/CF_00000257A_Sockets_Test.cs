...
{
    [TestClass]
    public sealed class CF_00000257A_Sockets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000257A_Sockets));
        ...
        {
            bool result = CF_00000257A_Sockets.Solution_0_Test(input);
