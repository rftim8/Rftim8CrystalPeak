...
{
    [TestClass]
    public sealed class CF_00000325D_Reclamation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000325D_Reclamation));
        ...
        {
            bool result = CF_00000325D_Reclamation.Solution_0_Test(input);
