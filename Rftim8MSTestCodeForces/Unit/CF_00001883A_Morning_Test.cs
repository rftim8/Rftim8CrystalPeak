...
{
    [TestClass]
    public sealed class CF_00001883A_Morning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001883A_Morning));
        ...
        {
            bool result = CF_00001883A_Morning.Solution_0_Test(input);
