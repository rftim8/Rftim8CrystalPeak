...
{
    [TestClass]
    public sealed class CF_00000381B_SerejaAndStairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000381B_SerejaAndStairs));
        ...
        {
            bool result = CF_00000381B_SerejaAndStairs.Solution_0_Test(input);
