...
{
    [TestClass]
    public sealed class CF_00000412B_NetworkConfiguration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000412B_NetworkConfiguration));
        ...
        {
            bool result = CF_00000412B_NetworkConfiguration.Solution_0_Test(input);
