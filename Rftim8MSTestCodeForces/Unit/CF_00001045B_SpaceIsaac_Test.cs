...
{
    [TestClass]
    public sealed class CF_00001045B_SpaceIsaac_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001045B_SpaceIsaac));
        ...
        {
            bool result = CF_00001045B_SpaceIsaac.Solution_0_Test(input);
