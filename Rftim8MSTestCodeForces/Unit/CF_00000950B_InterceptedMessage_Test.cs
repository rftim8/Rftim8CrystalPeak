...
{
    [TestClass]
    public sealed class CF_00000950B_InterceptedMessage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000950B_InterceptedMessage));
        ...
        {
            bool result = CF_00000950B_InterceptedMessage.Solution_0_Test(input);
