...
{
    [TestClass]
    public sealed class CF_00000101D_Castle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000101D_Castle));
        ...
        {
            bool result = CF_00000101D_Castle.Solution_0_Test(input);
