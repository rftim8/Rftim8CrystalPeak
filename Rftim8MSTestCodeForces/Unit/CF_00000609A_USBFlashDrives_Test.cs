...
{
    [TestClass]
    public sealed class CF_00000609A_USBFlashDrives_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000609A_USBFlashDrives));
        ...
        {
            bool result = CF_00000609A_USBFlashDrives.Solution_0_Test(input);
