...
{
    [TestClass]
    public sealed class CF_00000171B_Star_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000171B_Star));
        ...
        {
            bool result = CF_00000171B_Star.Solution_0_Test(input);
