...
{
    [TestClass]
    public sealed class CF_00001368E_SkiAccidents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001368E_SkiAccidents));
        ...
        {
            bool result = CF_00001368E_SkiAccidents.Solution_0_Test(input);
