...
{
    [TestClass]
    public sealed class CF_00001532E_GoodArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001532E_GoodArray));
        ...
        {
            bool result = CF_00001532E_GoodArray.Solution_0_Test(input);
