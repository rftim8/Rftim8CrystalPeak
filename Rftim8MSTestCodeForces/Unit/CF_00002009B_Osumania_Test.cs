...
{
    [TestClass]
    public sealed class CF_00002009B_Osumania_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002009B_Osumania));
        ...
        {
            bool result = CF_00002009B_Osumania.Solution_0_Test(input);
