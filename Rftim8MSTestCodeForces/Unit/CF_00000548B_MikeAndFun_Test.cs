...
{
    [TestClass]
    public sealed class CF_00000548B_MikeAndFun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000548B_MikeAndFun));
        ...
        {
            bool result = CF_00000548B_MikeAndFun.Solution_0_Test(input);
