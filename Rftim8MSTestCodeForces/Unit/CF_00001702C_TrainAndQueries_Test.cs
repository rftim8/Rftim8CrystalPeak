...
{
    [TestClass]
    public sealed class CF_00001702C_TrainAndQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001702C_TrainAndQueries));
        ...
        {
            bool result = CF_00001702C_TrainAndQueries.Solution_0_Test(input);
