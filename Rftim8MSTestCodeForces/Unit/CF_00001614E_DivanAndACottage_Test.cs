...
{
    [TestClass]
    public sealed class CF_00001614E_DivanAndACottage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001614E_DivanAndACottage));
        ...
        {
            bool result = CF_00001614E_DivanAndACottage.Solution_0_Test(input);
