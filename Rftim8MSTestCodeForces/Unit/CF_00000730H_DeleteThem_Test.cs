...
{
    [TestClass]
    public sealed class CF_00000730H_DeleteThem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730H_DeleteThem));
        ...
        {
            bool result = CF_00000730H_DeleteThem.Solution_0_Test(input);
