...
{
    [TestClass]
    public sealed class CF_00001575K_KnittingBatik_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575K_KnittingBatik));
        ...
        {
            bool result = CF_00001575K_KnittingBatik.Solution_0_Test(input);
