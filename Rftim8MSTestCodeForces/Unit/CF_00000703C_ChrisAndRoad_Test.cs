...
{
    [TestClass]
    public sealed class CF_00000703C_ChrisAndRoad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000703C_ChrisAndRoad));
        ...
        {
            bool result = CF_00000703C_ChrisAndRoad.Solution_0_Test(input);
