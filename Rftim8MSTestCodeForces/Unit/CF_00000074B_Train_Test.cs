...
{
    [TestClass]
    public sealed class CF_00000074B_Train_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000074B_Train));
        ...
        {
            bool result = CF_00000074B_Train.Solution_0_Test(input);
