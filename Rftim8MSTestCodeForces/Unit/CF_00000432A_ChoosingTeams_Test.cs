...
{
    [TestClass]
    public sealed class CF_00000432A_ChoosingTeams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000432A_ChoosingTeams));
        ...
        {
            bool result = CF_00000432A_ChoosingTeams.Solution_0_Test(input);
