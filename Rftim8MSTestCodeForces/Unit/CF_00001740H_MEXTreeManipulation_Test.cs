...
{
    [TestClass]
    public sealed class CF_00001740H_MEXTreeManipulation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001740H_MEXTreeManipulation));
        ...
        {
            bool result = CF_00001740H_MEXTreeManipulation.Solution_0_Test(input);
