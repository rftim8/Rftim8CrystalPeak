...
{
    [TestClass]
    public sealed class CF_00001879C_MakeItAlternating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001879C_MakeItAlternating));
        ...
        {
            bool result = CF_00001879C_MakeItAlternating.Solution_0_Test(input);
