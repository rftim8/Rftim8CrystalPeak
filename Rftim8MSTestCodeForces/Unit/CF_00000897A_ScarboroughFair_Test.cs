...
{
    [TestClass]
    public sealed class CF_00000897A_ScarboroughFair_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000897A_ScarboroughFair));
        ...
        {
            bool result = CF_00000897A_ScarboroughFair.Solution_0_Test(input);
