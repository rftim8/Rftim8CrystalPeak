...
{
    [TestClass]
    public sealed class CF_00001060C_MaximumSubrectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001060C_MaximumSubrectangle));
        ...
        {
            bool result = CF_00001060C_MaximumSubrectangle.Solution_0_Test(input);
