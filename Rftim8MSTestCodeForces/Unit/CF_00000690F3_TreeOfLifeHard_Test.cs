...
{
    [TestClass]
    public sealed class CF_00000690F3_TreeOfLifeHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690F3_TreeOfLifeHard));
        ...
        {
            bool result = CF_00000690F3_TreeOfLifeHard.Solution_0_Test(input);
