...
{
    [TestClass]
    public sealed class CF_00001396E_DistanceMatching_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001396E_DistanceMatching));
        ...
        {
            bool result = CF_00001396E_DistanceMatching.Solution_0_Test(input);
