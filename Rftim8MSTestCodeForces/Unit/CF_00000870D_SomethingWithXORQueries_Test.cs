...
{
    [TestClass]
    public sealed class CF_00000870D_SomethingWithXORQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000870D_SomethingWithXORQueries));
        ...
        {
            bool result = CF_00000870D_SomethingWithXORQueries.Solution_0_Test(input);
