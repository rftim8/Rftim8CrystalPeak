...
{
    [TestClass]
    public sealed class CF_00000917A_TheMonster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000917A_TheMonster));
        ...
        {
            bool result = CF_00000917A_TheMonster.Solution_0_Test(input);
