...
{
    [TestClass]
    public sealed class CF_00001824A_LuoTianyiAndTheShow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001824A_LuoTianyiAndTheShow));
        ...
        {
            bool result = CF_00001824A_LuoTianyiAndTheShow.Solution_0_Test(input);
