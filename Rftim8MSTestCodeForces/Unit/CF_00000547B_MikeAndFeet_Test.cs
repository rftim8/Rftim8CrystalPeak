...
{
    [TestClass]
    public sealed class CF_00000547B_MikeAndFeet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000547B_MikeAndFeet));
        ...
        {
            bool result = CF_00000547B_MikeAndFeet.Solution_0_Test(input);
