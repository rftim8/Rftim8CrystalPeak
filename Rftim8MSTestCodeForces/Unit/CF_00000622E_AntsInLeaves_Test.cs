...
{
    [TestClass]
    public sealed class CF_00000622E_AntsInLeaves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000622E_AntsInLeaves));
        ...
        {
            bool result = CF_00000622E_AntsInLeaves.Solution_0_Test(input);
