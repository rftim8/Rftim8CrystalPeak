...
{
    [TestClass]
    public sealed class CF_00001338A_PoweredAddition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001338A_PoweredAddition));
        ...
        {
            bool result = CF_00001338A_PoweredAddition.Solution_0_Test(input);
