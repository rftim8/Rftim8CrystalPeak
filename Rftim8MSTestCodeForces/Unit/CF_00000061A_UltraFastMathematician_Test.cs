...
{
    [TestClass]
    public sealed class CF_00000061A_UltraFastMathematician_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000061A_UltraFastMathematician));
        ...
        {
            bool result = CF_00000061A_UltraFastMathematician.Solution_0_Test(input);
