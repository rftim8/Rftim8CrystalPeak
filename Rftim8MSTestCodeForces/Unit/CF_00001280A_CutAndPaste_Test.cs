...
{
    [TestClass]
    public sealed class CF_00001280A_CutAndPaste_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001280A_CutAndPaste));
        ...
        {
            bool result = CF_00001280A_CutAndPaste.Solution_0_Test(input);
