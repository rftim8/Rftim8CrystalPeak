...
{
    [TestClass]
    public sealed class CF_00001073A_DiverseSubstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001073A_DiverseSubstring));
        ...
        {
            bool result = CF_00001073A_DiverseSubstring.Solution_0_Test(input);
