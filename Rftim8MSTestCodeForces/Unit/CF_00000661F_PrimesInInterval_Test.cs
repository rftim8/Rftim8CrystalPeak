...
{
    [TestClass]
    public sealed class CF_00000661F_PrimesInInterval_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000661F_PrimesInInterval));
        ...
        {
            bool result = CF_00000661F_PrimesInInterval.Solution_0_Test(input);
