...
{
    [TestClass]
    public sealed class CF_00001839A_TheGoodArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001839A_TheGoodArray));
        ...
        {
            bool result = CF_00001839A_TheGoodArray.Solution_0_Test(input);
