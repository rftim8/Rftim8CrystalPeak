...
{
    [TestClass]
    public sealed class CF_00001367B_EvenArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001367B_EvenArray));
        ...
        {
            bool result = CF_00001367B_EvenArray.Solution_0_Test(input);
