...
{
    [TestClass]
    public sealed class CF_00000938C_ConstructingTests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000938C_ConstructingTests));
        ...
        {
            bool result = CF_00000938C_ConstructingTests.Solution_0_Test(input);
