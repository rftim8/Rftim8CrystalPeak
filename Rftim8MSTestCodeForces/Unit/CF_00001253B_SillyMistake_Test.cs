...
{
    [TestClass]
    public sealed class CF_00001253B_SillyMistake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001253B_SillyMistake));
        ...
        {
            bool result = CF_00001253B_SillyMistake.Solution_0_Test(input);
