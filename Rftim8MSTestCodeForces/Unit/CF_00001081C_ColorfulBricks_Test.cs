...
{
    [TestClass]
    public sealed class CF_00001081C_ColorfulBricks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001081C_ColorfulBricks));
        ...
        {
            bool result = CF_00001081C_ColorfulBricks.Solution_0_Test(input);
