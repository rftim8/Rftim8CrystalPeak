...
{
    [TestClass]
    public sealed class CF_00001663G_SixCharacters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001663G_SixCharacters));
        ...
        {
            bool result = CF_00001663G_SixCharacters.Solution_0_Test(input);
