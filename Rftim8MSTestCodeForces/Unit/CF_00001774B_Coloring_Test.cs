...
{
    [TestClass]
    public sealed class CF_00001774B_Coloring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001774B_Coloring));
        ...
        {
            bool result = CF_00001774B_Coloring.Solution_0_Test(input);
