...
{
    [TestClass]
    public sealed class CF_00000333E_SummerEarnings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000333E_SummerEarnings));
        ...
        {
            bool result = CF_00000333E_SummerEarnings.Solution_0_Test(input);
