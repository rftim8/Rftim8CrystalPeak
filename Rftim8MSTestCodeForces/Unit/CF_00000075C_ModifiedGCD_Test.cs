...
{
    [TestClass]
    public sealed class CF_00000075C_ModifiedGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000075C_ModifiedGCD));
        ...
        {
            bool result = CF_00000075C_ModifiedGCD.Solution_0_Test(input);
