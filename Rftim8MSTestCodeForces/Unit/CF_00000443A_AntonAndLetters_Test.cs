...
{
    [TestClass]
    public sealed class CF_00000443A_AntonAndLetters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000443A_AntonAndLetters));
        ...
        {
            bool result = CF_00000443A_AntonAndLetters.Solution_0_Test(input);
