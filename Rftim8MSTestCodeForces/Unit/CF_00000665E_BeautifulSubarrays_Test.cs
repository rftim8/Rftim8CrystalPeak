...
{
    [TestClass]
    public sealed class CF_00000665E_BeautifulSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000665E_BeautifulSubarrays));
        ...
        {
            bool result = CF_00000665E_BeautifulSubarrays.Solution_0_Test(input);
