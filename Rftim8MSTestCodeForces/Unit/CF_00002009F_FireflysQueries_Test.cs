...
{
    [TestClass]
    public sealed class CF_00002009F_FireflysQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002009F_FireflysQueries));
        ...
        {
            bool result = CF_00002009F_FireflysQueries.Solution_0_Test(input);
