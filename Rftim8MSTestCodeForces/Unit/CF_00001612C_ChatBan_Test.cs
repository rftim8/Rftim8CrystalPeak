...
{
    [TestClass]
    public sealed class CF_00001612C_ChatBan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001612C_ChatBan));
        ...
        {
            bool result = CF_00001612C_ChatBan.Solution_0_Test(input);
