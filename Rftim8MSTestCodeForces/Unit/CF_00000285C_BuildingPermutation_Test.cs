...
{
    [TestClass]
    public sealed class CF_00000285C_BuildingPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000285C_BuildingPermutation));
        ...
        {
            bool result = CF_00000285C_BuildingPermutation.Solution_0_Test(input);
