...
{
    [TestClass]
    public sealed class CF_00001671D_InsertAProgression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001671D_InsertAProgression));
        ...
        {
            bool result = CF_00001671D_InsertAProgression.Solution_0_Test(input);
