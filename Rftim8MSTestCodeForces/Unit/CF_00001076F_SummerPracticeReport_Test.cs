...
{
    [TestClass]
    public sealed class CF_00001076F_SummerPracticeReport_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001076F_SummerPracticeReport));
        ...
        {
            bool result = CF_00001076F_SummerPracticeReport.Solution_0_Test(input);
