...
{
    [TestClass]
    public sealed class CF_00001322F_AssigningFares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001322F_AssigningFares));
        ...
        {
            bool result = CF_00001322F_AssigningFares.Solution_0_Test(input);
