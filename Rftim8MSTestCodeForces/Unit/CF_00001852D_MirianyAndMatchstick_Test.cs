...
{
    [TestClass]
    public sealed class CF_00001852D_MirianyAndMatchstick_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001852D_MirianyAndMatchstick));
        ...
        {
            bool result = CF_00001852D_MirianyAndMatchstick.Solution_0_Test(input);
