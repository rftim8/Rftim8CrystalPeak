...
{
    [TestClass]
    public sealed class CF_00000076F_Tourist_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000076F_Tourist));
        ...
        {
            bool result = CF_00000076F_Tourist.Solution_0_Test(input);
