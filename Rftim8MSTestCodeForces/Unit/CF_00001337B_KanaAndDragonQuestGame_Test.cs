...
{
    [TestClass]
    public sealed class CF_00001337B_KanaAndDragonQuestGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001337B_KanaAndDragonQuestGame));
        ...
        {
            bool result = CF_00001337B_KanaAndDragonQuestGame.Solution_0_Test(input);
