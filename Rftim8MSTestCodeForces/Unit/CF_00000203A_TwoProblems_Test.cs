...
{
    [TestClass]
    public sealed class CF_00000203A_TwoProblems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000203A_TwoProblems));
        ...
        {
            bool result = CF_00000203A_TwoProblems.Solution_0_Test(input);
