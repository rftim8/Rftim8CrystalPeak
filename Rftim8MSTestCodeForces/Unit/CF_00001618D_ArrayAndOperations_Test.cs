...
{
    [TestClass]
    public sealed class CF_00001618D_ArrayAndOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001618D_ArrayAndOperations));
        ...
        {
            bool result = CF_00001618D_ArrayAndOperations.Solution_0_Test(input);
