...
{
    [TestClass]
    public sealed class CF_00000846F_RandomQuery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000846F_RandomQuery));
        ...
        {
            bool result = CF_00000846F_RandomQuery.Solution_0_Test(input);
