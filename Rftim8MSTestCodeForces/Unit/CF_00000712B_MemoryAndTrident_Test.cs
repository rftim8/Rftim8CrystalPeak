...
{
    [TestClass]
    public sealed class CF_00000712B_MemoryAndTrident_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000712B_MemoryAndTrident));
        ...
        {
            bool result = CF_00000712B_MemoryAndTrident.Solution_0_Test(input);
