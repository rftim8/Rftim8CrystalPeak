...
{
    [TestClass]
    public sealed class CF_00000361A_LevkoAndTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000361A_LevkoAndTable));
        ...
        {
            bool result = CF_00000361A_LevkoAndTable.Solution_0_Test(input);
