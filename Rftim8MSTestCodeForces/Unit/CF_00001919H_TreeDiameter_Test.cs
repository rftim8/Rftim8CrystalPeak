...
{
    [TestClass]
    public sealed class CF_00001919H_TreeDiameter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001919H_TreeDiameter));
        ...
        {
            bool result = CF_00001919H_TreeDiameter.Solution_0_Test(input);
