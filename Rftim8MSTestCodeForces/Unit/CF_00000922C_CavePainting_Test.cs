...
{
    [TestClass]
    public sealed class CF_00000922C_CavePainting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000922C_CavePainting));
        ...
        {
            bool result = CF_00000922C_CavePainting.Solution_0_Test(input);
