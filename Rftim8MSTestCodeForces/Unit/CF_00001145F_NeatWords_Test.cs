...
{
    [TestClass]
    public sealed class CF_00001145F_NeatWords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001145F_NeatWords));
        ...
        {
            bool result = CF_00001145F_NeatWords.Solution_0_Test(input);
