...
{
    [TestClass]
    public sealed class CF_00001598B_Groups_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001598B_Groups));
        ...
        {
            bool result = CF_00001598B_Groups.Solution_0_Test(input);
