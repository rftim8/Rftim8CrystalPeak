...
{
    [TestClass]
    public sealed class CF_00000313E_IlyaAndTwoNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000313E_IlyaAndTwoNumbers));
        ...
        {
            bool result = CF_00000313E_IlyaAndTwoNumbers.Solution_0_Test(input);
