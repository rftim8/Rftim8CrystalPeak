...
{
    [TestClass]
    public sealed class CF_00000777D_CloudOfHashtags_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000777D_CloudOfHashtags));
        ...
        {
            bool result = CF_00000777D_CloudOfHashtags.Solution_0_Test(input);
