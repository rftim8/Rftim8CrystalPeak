...
{
    [TestClass]
    public sealed class CF_00001000A_CodehorsesTshirts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001000A_CodehorsesTshirts));
        ...
        {
            bool result = CF_00001000A_CodehorsesTshirts.Solution_0_Test(input);
