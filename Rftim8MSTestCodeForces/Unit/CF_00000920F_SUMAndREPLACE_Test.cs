...
{
    [TestClass]
    public sealed class CF_00000920F_SUMAndREPLACE_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000920F_SUMAndREPLACE));
        ...
        {
            bool result = CF_00000920F_SUMAndREPLACE.Solution_0_Test(input);
