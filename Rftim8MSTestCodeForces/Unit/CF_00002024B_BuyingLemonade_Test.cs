...
{
    [TestClass]
    public sealed class CF_00002024B_BuyingLemonade_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002024B_BuyingLemonade));
        ...
        {
            bool result = CF_00002024B_BuyingLemonade.Solution_0_Test(input);
