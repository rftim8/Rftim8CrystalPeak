...
{
    [TestClass]
    public sealed class CF_00001925B_ABalancedProblemset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001925B_ABalancedProblemset));
        ...
        {
            bool result = CF_00001925B_ABalancedProblemset.Solution_0_Test(input);
