...
{
    [TestClass]
    public sealed class CF_00001801A_TheVeryBeautifulBlanket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001801A_TheVeryBeautifulBlanket));
        ...
        {
            bool result = CF_00001801A_TheVeryBeautifulBlanket.Solution_0_Test(input);
