...
{
    [TestClass]
    public sealed class CF_00001242E_PlanarPerimeter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001242E_PlanarPerimeter));
        ...
        {
            bool result = CF_00001242E_PlanarPerimeter.Solution_0_Test(input);
