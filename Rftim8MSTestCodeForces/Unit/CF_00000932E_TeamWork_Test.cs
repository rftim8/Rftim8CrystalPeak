...
{
    [TestClass]
    public sealed class CF_00000932E_TeamWork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000932E_TeamWork));
        ...
        {
            bool result = CF_00000932E_TeamWork.Solution_0_Test(input);
