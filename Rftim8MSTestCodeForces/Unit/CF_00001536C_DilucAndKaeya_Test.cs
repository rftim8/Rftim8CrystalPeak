...
{
    [TestClass]
    public sealed class CF_00001536C_DilucAndKaeya_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001536C_DilucAndKaeya));
        ...
        {
            bool result = CF_00001536C_DilucAndKaeya.Solution_0_Test(input);
