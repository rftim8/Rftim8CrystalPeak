...
{
    [TestClass]
    public sealed class CF_00001205D_AlmostAll_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001205D_AlmostAll));
        ...
        {
            bool result = CF_00001205D_AlmostAll.Solution_0_Test(input);
