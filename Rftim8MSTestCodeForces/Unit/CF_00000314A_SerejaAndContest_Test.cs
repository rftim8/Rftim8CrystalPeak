...
{
    [TestClass]
    public sealed class CF_00000314A_SerejaAndContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000314A_SerejaAndContest));
        ...
        {
            bool result = CF_00000314A_SerejaAndContest.Solution_0_Test(input);
