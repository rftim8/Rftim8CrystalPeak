...
{
    [TestClass]
    public sealed class CF_00001553E_PermutationShift_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001553E_PermutationShift));
        ...
        {
            bool result = CF_00001553E_PermutationShift.Solution_0_Test(input);
