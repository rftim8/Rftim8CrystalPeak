...
{
    [TestClass]
    public sealed class CF_00001741B_FunnyPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001741B_FunnyPermutation));
        ...
        {
            bool result = CF_00001741B_FunnyPermutation.Solution_0_Test(input);
