...
{
    [TestClass]
    public sealed class CF_00000980C_Posterized_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000980C_Posterized));
        ...
        {
            bool result = CF_00000980C_Posterized.Solution_0_Test(input);
