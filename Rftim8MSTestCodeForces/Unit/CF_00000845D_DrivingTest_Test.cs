...
{
    [TestClass]
    public sealed class CF_00000845D_DrivingTest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000845D_DrivingTest));
        ...
        {
            bool result = CF_00000845D_DrivingTest.Solution_0_Test(input);
