...
{
    [TestClass]
    public sealed class CF_00000688A_Opponents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000688A_Opponents));
        ...
        {
            bool result = CF_00000688A_Opponents.Solution_0_Test(input);
