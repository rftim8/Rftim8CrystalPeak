...
{
    [TestClass]
    public sealed class CF_00001970G1_MinFundPrisonEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970G1_MinFundPrisonEasy));
        ...
        {
            bool result = CF_00001970G1_MinFundPrisonEasy.Solution_0_Test(input);
