...
{
    [TestClass]
    public sealed class CF_00000757A_GottaCatchEmAll_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000757A_GottaCatchEmAll));
        ...
        {
            bool result = CF_00000757A_GottaCatchEmAll.Solution_0_Test(input);
