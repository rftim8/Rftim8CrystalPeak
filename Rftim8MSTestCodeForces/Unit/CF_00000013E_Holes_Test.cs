...
{
    [TestClass]
    public sealed class CF_00000013E_Holes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000013E_Holes));
        ...
        {
            bool result = CF_00000013E_Holes.Solution_0_Test(input);
