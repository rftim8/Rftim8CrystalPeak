...
{
    [TestClass]
    public sealed class CF_00000056D_ChangingAString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000056D_ChangingAString));
        ...
        {
            bool result = CF_00000056D_ChangingAString.Solution_0_Test(input);
