...
{
    [TestClass]
    public sealed class CF_00001107E_VasyaAndBinaryString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001107E_VasyaAndBinaryString));
        ...
        {
            bool result = CF_00001107E_VasyaAndBinaryString.Solution_0_Test(input);
