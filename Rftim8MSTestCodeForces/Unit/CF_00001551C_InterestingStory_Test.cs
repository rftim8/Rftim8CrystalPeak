...
{
    [TestClass]
    public sealed class CF_00001551C_InterestingStory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001551C_InterestingStory));
        ...
        {
            bool result = CF_00001551C_InterestingStory.Solution_0_Test(input);
