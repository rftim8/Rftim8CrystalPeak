...
{
    [TestClass]
    public sealed class CF_00000678C_JotyAndChocolate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000678C_JotyAndChocolate));
        ...
        {
            bool result = CF_00000678C_JotyAndChocolate.Solution_0_Test(input);
