...
{
    [TestClass]
    public sealed class CF_00000436E_CardboardBox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000436E_CardboardBox));
        ...
        {
            bool result = CF_00000436E_CardboardBox.Solution_0_Test(input);
