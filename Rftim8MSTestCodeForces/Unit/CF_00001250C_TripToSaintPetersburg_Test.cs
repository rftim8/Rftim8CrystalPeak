...
{
    [TestClass]
    public sealed class CF_00001250C_TripToSaintPetersburg_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250C_TripToSaintPetersburg));
        ...
        {
            bool result = CF_00001250C_TripToSaintPetersburg.Solution_0_Test(input);
