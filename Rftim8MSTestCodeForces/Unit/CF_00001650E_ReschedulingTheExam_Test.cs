...
{
    [TestClass]
    public sealed class CF_00001650E_ReschedulingTheExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001650E_ReschedulingTheExam));
        ...
        {
            bool result = CF_00001650E_ReschedulingTheExam.Solution_0_Test(input);
