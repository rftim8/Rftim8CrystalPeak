...
{
    [TestClass]
    public sealed class CF_00000072D_Persescript_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000072D_Persescript));
        ...
        {
            bool result = CF_00000072D_Persescript.Solution_0_Test(input);
