...
{
    [TestClass]
    public sealed class CF_00001108F_MSTUnification_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001108F_MSTUnification));
        ...
        {
            bool result = CF_00001108F_MSTUnification.Solution_0_Test(input);
