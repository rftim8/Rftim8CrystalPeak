...
{
    [TestClass]
    public sealed class CF_00001989F_SimultaneousColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001989F_SimultaneousColoring));
        ...
        {
            bool result = CF_00001989F_SimultaneousColoring.Solution_0_Test(input);
