...
{
    [TestClass]
    public sealed class CF_00001914C_Quests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001914C_Quests));
        ...
        {
            bool result = CF_00001914C_Quests.Solution_0_Test(input);
