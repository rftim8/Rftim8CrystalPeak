...
{
    [TestClass]
    public sealed class CF_00000295C_GregAndFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000295C_GregAndFriends));
        ...
        {
            bool result = CF_00000295C_GregAndFriends.Solution_0_Test(input);
