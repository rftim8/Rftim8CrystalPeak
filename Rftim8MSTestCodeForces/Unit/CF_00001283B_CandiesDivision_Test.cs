...
{
    [TestClass]
    public sealed class CF_00001283B_CandiesDivision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001283B_CandiesDivision));
        ...
        {
            bool result = CF_00001283B_CandiesDivision.Solution_0_Test(input);
