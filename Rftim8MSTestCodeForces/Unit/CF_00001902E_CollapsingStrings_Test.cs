...
{
    [TestClass]
    public sealed class CF_00001902E_CollapsingStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001902E_CollapsingStrings));
        ...
        {
            bool result = CF_00001902E_CollapsingStrings.Solution_0_Test(input);
