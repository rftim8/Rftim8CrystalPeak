...
{
    [TestClass]
    public sealed class CF_00001970E3_TrailsHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970E3_TrailsHard));
        ...
        {
            bool result = CF_00001970E3_TrailsHard.Solution_0_Test(input);
