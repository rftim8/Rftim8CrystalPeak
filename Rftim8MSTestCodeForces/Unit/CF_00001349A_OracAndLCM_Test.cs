...
{
    [TestClass]
    public sealed class CF_00001349A_OracAndLCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001349A_OracAndLCM));
        ...
        {
            bool result = CF_00001349A_OracAndLCM.Solution_0_Test(input);
