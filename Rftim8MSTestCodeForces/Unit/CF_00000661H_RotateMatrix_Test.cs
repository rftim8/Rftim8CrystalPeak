...
{
    [TestClass]
    public sealed class CF_00000661H_RotateMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000661H_RotateMatrix));
        ...
        {
            bool result = CF_00000661H_RotateMatrix.Solution_0_Test(input);
