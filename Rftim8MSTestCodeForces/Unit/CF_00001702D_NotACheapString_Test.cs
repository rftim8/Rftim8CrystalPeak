...
{
    [TestClass]
    public sealed class CF_00001702D_NotACheapString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001702D_NotACheapString));
        ...
        {
            bool result = CF_00001702D_NotACheapString.Solution_0_Test(input);
