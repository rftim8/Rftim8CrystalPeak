...
{
    [TestClass]
    public sealed class CF_00000212A_Privatization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000212A_Privatization));
        ...
        {
            bool result = CF_00000212A_Privatization.Solution_0_Test(input);
