...
{
    [TestClass]
    public sealed class CF_00001970F2_PlayingQuidditchMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970F2_PlayingQuidditchMedium));
        ...
        {
            bool result = CF_00001970F2_PlayingQuidditchMedium.Solution_0_Test(input);
