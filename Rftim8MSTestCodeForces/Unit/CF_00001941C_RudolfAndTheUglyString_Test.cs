...
{
    [TestClass]
    public sealed class CF_00001941C_RudolfAndTheUglyString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001941C_RudolfAndTheUglyString));
        ...
        {
            bool result = CF_00001941C_RudolfAndTheUglyString.Solution_0_Test(input);
