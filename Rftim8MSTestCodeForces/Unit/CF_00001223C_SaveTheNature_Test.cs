...
{
    [TestClass]
    public sealed class CF_00001223C_SaveTheNature_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001223C_SaveTheNature));
        ...
        {
            bool result = CF_00001223C_SaveTheNature.Solution_0_Test(input);
