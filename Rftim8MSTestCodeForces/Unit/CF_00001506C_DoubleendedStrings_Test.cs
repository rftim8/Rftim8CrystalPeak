...
{
    [TestClass]
    public sealed class CF_00001506C_DoubleendedStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001506C_DoubleendedStrings));
        ...
        {
            bool result = CF_00001506C_DoubleendedStrings.Solution_0_Test(input);
