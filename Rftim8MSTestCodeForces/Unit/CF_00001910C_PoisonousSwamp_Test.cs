...
{
    [TestClass]
    public sealed class CF_00001910C_PoisonousSwamp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001910C_PoisonousSwamp));
        ...
        {
            bool result = CF_00001910C_PoisonousSwamp.Solution_0_Test(input);
