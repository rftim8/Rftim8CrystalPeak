...
{
    [TestClass]
    public sealed class CF_00000223A_BracketSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000223A_BracketSequence));
        ...
        {
            bool result = CF_00000223A_BracketSequence.Solution_0_Test(input);
