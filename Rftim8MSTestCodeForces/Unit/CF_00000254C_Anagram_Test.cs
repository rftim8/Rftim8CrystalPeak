...
{
    [TestClass]
    public sealed class CF_00000254C_Anagram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000254C_Anagram));
        ...
        {
            bool result = CF_00000254C_Anagram.Solution_0_Test(input);
