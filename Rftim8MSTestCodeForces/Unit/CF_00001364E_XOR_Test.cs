...
{
    [TestClass]
    public sealed class CF_00001364E_XOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001364E_XOR));
        ...
        {
            bool result = CF_00001364E_XOR.Solution_0_Test(input);
