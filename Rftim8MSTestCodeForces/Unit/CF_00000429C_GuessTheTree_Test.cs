...
{
    [TestClass]
    public sealed class CF_00000429C_GuessTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000429C_GuessTheTree));
        ...
        {
            bool result = CF_00000429C_GuessTheTree.Solution_0_Test(input);
