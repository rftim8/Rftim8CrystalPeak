...
{
    [TestClass]
    public sealed class CF_00001326F2_WiseMenHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001326F2_WiseMenHardVersion));
        ...
        {
            bool result = CF_00001326F2_WiseMenHardVersion.Solution_0_Test(input);
