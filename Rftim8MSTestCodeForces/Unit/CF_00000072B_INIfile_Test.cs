...
{
    [TestClass]
    public sealed class CF_00000072B_INIfile_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000072B_INIfile));
        ...
        {
            bool result = CF_00000072B_INIfile.Solution_0_Test(input);
