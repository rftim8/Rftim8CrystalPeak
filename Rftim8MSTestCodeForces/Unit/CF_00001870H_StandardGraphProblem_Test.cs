...
{
    [TestClass]
    public sealed class CF_00001870H_StandardGraphProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001870H_StandardGraphProblem));
        ...
        {
            bool result = CF_00001870H_StandardGraphProblem.Solution_0_Test(input);
