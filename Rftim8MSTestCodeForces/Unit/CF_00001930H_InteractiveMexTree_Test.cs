...
{
    [TestClass]
    public sealed class CF_00001930H_InteractiveMexTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001930H_InteractiveMexTree));
        ...
        {
            bool result = CF_00001930H_InteractiveMexTree.Solution_0_Test(input);
