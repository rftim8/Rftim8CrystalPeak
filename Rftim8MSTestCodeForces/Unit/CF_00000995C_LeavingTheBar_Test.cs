...
{
    [TestClass]
    public sealed class CF_00000995C_LeavingTheBar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000995C_LeavingTheBar));
        ...
        {
            bool result = CF_00000995C_LeavingTheBar.Solution_0_Test(input);
