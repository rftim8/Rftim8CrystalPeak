...
{
    [TestClass]
    public sealed class CF_00000380A_SerejaAndPrefixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000380A_SerejaAndPrefixes));
        ...
        {
            bool result = CF_00000380A_SerejaAndPrefixes.Solution_0_Test(input);
