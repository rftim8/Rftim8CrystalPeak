...
{
    [TestClass]
    public sealed class CF_00001011A_Stages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001011A_Stages));
        ...
        {
            bool result = CF_00001011A_Stages.Solution_0_Test(input);
