...
{
    [TestClass]
    public sealed class CF_00000597B_Restaurant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000597B_Restaurant));
        ...
        {
            bool result = CF_00000597B_Restaurant.Solution_0_Test(input);
