...
{
    [TestClass]
    public sealed class CF_00002039B_ShohagLovesStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002039B_ShohagLovesStrings));
        ...
        {
            bool result = CF_00002039B_ShohagLovesStrings.Solution_0_Test(input);
