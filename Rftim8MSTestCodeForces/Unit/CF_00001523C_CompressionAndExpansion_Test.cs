...
{
    [TestClass]
    public sealed class CF_00001523C_CompressionAndExpansion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001523C_CompressionAndExpansion));
        ...
        {
            bool result = CF_00001523C_CompressionAndExpansion.Solution_0_Test(input);
