...
{
    [TestClass]
    public sealed class CF_00000923F_PublicService_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000923F_PublicService));
        ...
        {
            bool result = CF_00000923F_PublicService.Solution_0_Test(input);
