...
{
    [TestClass]
    public sealed class CF_00001452G_GameOnTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001452G_GameOnTree));
        ...
        {
            bool result = CF_00001452G_GameOnTree.Solution_0_Test(input);
