...
{
    [TestClass]
    public sealed class CF_00000746G_NewRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000746G_NewRoads));
        ...
        {
            bool result = CF_00000746G_NewRoads.Solution_0_Test(input);
