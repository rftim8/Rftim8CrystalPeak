...
{
    [TestClass]
    public sealed class CF_00001519B_TheCakeIsALie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001519B_TheCakeIsALie));
        ...
        {
            bool result = CF_00001519B_TheCakeIsALie.Solution_0_Test(input);
