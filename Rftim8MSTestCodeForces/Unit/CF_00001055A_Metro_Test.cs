...
{
    [TestClass]
    public sealed class CF_00001055A_Metro_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001055A_Metro));
        ...
        {
            bool result = CF_00001055A_Metro.Solution_0_Test(input);
