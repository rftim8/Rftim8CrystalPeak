...
{
    [TestClass]
    public sealed class CF_00000414D_MashmokhAndWaterTanks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000414D_MashmokhAndWaterTanks));
        ...
        {
            bool result = CF_00000414D_MashmokhAndWaterTanks.Solution_0_Test(input);
