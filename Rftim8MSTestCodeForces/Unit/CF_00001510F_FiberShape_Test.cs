...
{
    [TestClass]
    public sealed class CF_00001510F_FiberShape_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001510F_FiberShape));
        ...
        {
            bool result = CF_00001510F_FiberShape.Solution_0_Test(input);
