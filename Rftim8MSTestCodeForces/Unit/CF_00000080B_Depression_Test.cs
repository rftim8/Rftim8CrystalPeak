...
{
    [TestClass]
    public sealed class CF_00000080B_Depression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000080B_Depression));
        ...
        {
            bool result = CF_00000080B_Depression.Solution_0_Test(input);
