...
{
    [TestClass]
    public sealed class CF_00001201D_TreasureHunting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001201D_TreasureHunting));
        ...
        {
            bool result = CF_00001201D_TreasureHunting.Solution_0_Test(input);
