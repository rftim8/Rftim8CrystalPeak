...
{
    [TestClass]
    public sealed class CF_00001133A_MiddleOfTheContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001133A_MiddleOfTheContest));
        ...
        {
            bool result = CF_00001133A_MiddleOfTheContest.Solution_0_Test(input);
