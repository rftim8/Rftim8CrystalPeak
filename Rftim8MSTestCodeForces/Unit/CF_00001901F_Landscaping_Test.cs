...
{
    [TestClass]
    public sealed class CF_00001901F_Landscaping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001901F_Landscaping));
        ...
        {
            bool result = CF_00001901F_Landscaping.Solution_0_Test(input);
