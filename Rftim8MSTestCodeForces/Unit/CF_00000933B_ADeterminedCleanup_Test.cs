...
{
    [TestClass]
    public sealed class CF_00000933B_ADeterminedCleanup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000933B_ADeterminedCleanup));
        ...
        {
            bool result = CF_00000933B_ADeterminedCleanup.Solution_0_Test(input);
