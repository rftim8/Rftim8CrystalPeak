...
{
    [TestClass]
    public sealed class CF_00001971B_DifferentString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001971B_DifferentString));
        ...
        {
            bool result = CF_00001971B_DifferentString.Solution_0_Test(input);
