...
{
    [TestClass]
    public sealed class CF_00000317D_GameWithPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000317D_GameWithPowers));
        ...
        {
            bool result = CF_00000317D_GameWithPowers.Solution_0_Test(input);
