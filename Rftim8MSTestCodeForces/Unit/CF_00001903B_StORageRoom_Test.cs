...
{
    [TestClass]
    public sealed class CF_00001903B_StORageRoom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001903B_StORageRoom));
        ...
        {
            bool result = CF_00001903B_StORageRoom.Solution_0_Test(input);
