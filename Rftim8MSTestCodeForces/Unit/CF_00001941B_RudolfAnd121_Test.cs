...
{
    [TestClass]
    public sealed class CF_00001941B_RudolfAnd121_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001941B_RudolfAnd121));
        ...
        {
            bool result = CF_00001941B_RudolfAnd121.Solution_0_Test(input);
