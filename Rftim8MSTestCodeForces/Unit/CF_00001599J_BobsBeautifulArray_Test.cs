...
{
    [TestClass]
    public sealed class CF_00001599J_BobsBeautifulArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001599J_BobsBeautifulArray));
        ...
        {
            bool result = CF_00001599J_BobsBeautifulArray.Solution_0_Test(input);
