...
{
    [TestClass]
    public sealed class CF_00000374B_InnaAndNine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000374B_InnaAndNine));
        ...
        {
            bool result = CF_00000374B_InnaAndNine.Solution_0_Test(input);
