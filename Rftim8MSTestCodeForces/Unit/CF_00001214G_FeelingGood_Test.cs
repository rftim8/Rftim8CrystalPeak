...
{
    [TestClass]
    public sealed class CF_00001214G_FeelingGood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001214G_FeelingGood));
        ...
        {
            bool result = CF_00001214G_FeelingGood.Solution_0_Test(input);
