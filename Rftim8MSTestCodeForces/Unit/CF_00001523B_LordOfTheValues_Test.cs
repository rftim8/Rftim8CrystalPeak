...
{
    [TestClass]
    public sealed class CF_00001523B_LordOfTheValues_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001523B_LordOfTheValues));
        ...
        {
            bool result = CF_00001523B_LordOfTheValues.Solution_0_Test(input);
