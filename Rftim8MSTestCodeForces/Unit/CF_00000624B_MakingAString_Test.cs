...
{
    [TestClass]
    public sealed class CF_00000624B_MakingAString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000624B_MakingAString));
        ...
        {
            bool result = CF_00000624B_MakingAString.Solution_0_Test(input);
