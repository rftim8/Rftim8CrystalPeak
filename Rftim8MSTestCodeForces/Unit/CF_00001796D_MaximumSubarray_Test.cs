...
{
    [TestClass]
    public sealed class CF_00001796D_MaximumSubarray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001796D_MaximumSubarray));
        ...
        {
            bool result = CF_00001796D_MaximumSubarray.Solution_0_Test(input);
