...
{
    [TestClass]
    public sealed class CF_00001205A_AlmostEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001205A_AlmostEqual));
        ...
        {
            bool result = CF_00001205A_AlmostEqual.Solution_0_Test(input);
