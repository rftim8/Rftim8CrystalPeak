...
{
    [TestClass]
    public sealed class CF_00000696F_Dary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000696F_Dary));
        ...
        {
            bool result = CF_00000696F_Dary.Solution_0_Test(input);
