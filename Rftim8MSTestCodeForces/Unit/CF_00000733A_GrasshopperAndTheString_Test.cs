...
{
    [TestClass]
    public sealed class CF_00000733A_GrasshopperAndTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000733A_GrasshopperAndTheString));
        ...
        {
            bool result = CF_00000733A_GrasshopperAndTheString.Solution_0_Test(input);
