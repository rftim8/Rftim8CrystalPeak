...
{
    [TestClass]
    public sealed class CF_00001657D_ForGamersByGamers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001657D_ForGamersByGamers));
        ...
        {
            bool result = CF_00001657D_ForGamersByGamers.Solution_0_Test(input);
