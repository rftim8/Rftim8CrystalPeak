...
{
    [TestClass]
    public sealed class CF_00001010D_MarsRover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001010D_MarsRover));
        ...
        {
            bool result = CF_00001010D_MarsRover.Solution_0_Test(input);
