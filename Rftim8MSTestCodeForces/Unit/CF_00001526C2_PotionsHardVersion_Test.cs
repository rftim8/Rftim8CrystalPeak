...
{
    [TestClass]
    public sealed class CF_00001526C2_PotionsHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001526C2_PotionsHardVersion));
        ...
        {
            bool result = CF_00001526C2_PotionsHardVersion.Solution_0_Test(input);
