...
{
    [TestClass]
    public sealed class CF_00001855B_LongestDivisorsInterval_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001855B_LongestDivisorsInterval));
        ...
        {
            bool result = CF_00001855B_LongestDivisorsInterval.Solution_0_Test(input);
