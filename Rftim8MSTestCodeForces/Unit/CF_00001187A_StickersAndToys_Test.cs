...
{
    [TestClass]
    public sealed class CF_00001187A_StickersAndToys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001187A_StickersAndToys));
        ...
        {
            bool result = CF_00001187A_StickersAndToys.Solution_0_Test(input);
