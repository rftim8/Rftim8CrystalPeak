...
{
    [TestClass]
    public sealed class CF_00001706B_MakingTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001706B_MakingTowers));
        ...
        {
            bool result = CF_00001706B_MakingTowers.Solution_0_Test(input);
