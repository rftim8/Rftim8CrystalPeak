...
{
    [TestClass]
    public sealed class CF_00000350E_WrongFloyd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000350E_WrongFloyd));
        ...
        {
            bool result = CF_00000350E_WrongFloyd.Solution_0_Test(input);
