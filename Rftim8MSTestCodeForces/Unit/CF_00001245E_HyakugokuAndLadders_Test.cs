...
{
    [TestClass]
    public sealed class CF_00001245E_HyakugokuAndLadders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001245E_HyakugokuAndLadders));
        ...
        {
            bool result = CF_00001245E_HyakugokuAndLadders.Solution_0_Test(input);
