...
{
    [TestClass]
    public sealed class CF_00000064C_Table_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000064C_Table));
        ...
        {
            bool result = CF_00000064C_Table.Solution_0_Test(input);
