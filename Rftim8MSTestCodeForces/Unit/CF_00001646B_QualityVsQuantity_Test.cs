...
{
    [TestClass]
    public sealed class CF_00001646B_QualityVsQuantity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001646B_QualityVsQuantity));
        ...
        {
            bool result = CF_00001646B_QualityVsQuantity.Solution_0_Test(input);
