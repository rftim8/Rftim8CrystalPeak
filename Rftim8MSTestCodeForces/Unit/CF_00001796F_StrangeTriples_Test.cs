...
{
    [TestClass]
    public sealed class CF_00001796F_StrangeTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001796F_StrangeTriples));
        ...
        {
            bool result = CF_00001796F_StrangeTriples.Solution_0_Test(input);
