...
{
    [TestClass]
    public sealed class CF_00000351B_JeffAndFurik_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000351B_JeffAndFurik));
        ...
        {
            bool result = CF_00000351B_JeffAndFurik.Solution_0_Test(input);
