...
{
    [TestClass]
    public sealed class CF_00000267C_BerlandTraffic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000267C_BerlandTraffic));
        ...
        {
            bool result = CF_00000267C_BerlandTraffic.Solution_0_Test(input);
