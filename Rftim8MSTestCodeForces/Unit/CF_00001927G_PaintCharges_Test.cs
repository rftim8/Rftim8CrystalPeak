...
{
    [TestClass]
    public sealed class CF_00001927G_PaintCharges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001927G_PaintCharges));
        ...
        {
            bool result = CF_00001927G_PaintCharges.Solution_0_Test(input);
