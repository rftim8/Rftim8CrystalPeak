...
{
    [TestClass]
    public sealed class CF_00001488J_FlowerShop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001488J_FlowerShop));
        ...
        {
            bool result = CF_00001488J_FlowerShop.Solution_0_Test(input);
