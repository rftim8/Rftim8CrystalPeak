...
{
    [TestClass]
    public sealed class CF_00000505D_MrKitayutasTechnology_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000505D_MrKitayutasTechnology));
        ...
        {
            bool result = CF_00000505D_MrKitayutasTechnology.Solution_0_Test(input);
