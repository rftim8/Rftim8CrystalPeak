...
{
    [TestClass]
    public sealed class CF_00001687B_RailwaySystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001687B_RailwaySystem));
        ...
        {
            bool result = CF_00001687B_RailwaySystem.Solution_0_Test(input);
