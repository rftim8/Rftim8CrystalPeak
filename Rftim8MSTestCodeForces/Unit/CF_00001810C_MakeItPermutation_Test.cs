...
{
    [TestClass]
    public sealed class CF_00001810C_MakeItPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001810C_MakeItPermutation));
        ...
        {
            bool result = CF_00001810C_MakeItPermutation.Solution_0_Test(input);
