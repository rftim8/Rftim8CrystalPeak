...
{
    [TestClass]
    public sealed class CF_00000127A_WastedTime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000127A_WastedTime));
        ...
        {
            bool result = CF_00000127A_WastedTime.Solution_0_Test(input);
