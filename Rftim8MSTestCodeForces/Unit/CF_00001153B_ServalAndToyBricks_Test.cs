...
{
    [TestClass]
    public sealed class CF_00001153B_ServalAndToyBricks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001153B_ServalAndToyBricks));
        ...
        {
            bool result = CF_00001153B_ServalAndToyBricks.Solution_0_Test(input);
