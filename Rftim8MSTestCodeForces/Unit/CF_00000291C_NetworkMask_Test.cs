...
{
    [TestClass]
    public sealed class CF_00000291C_NetworkMask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000291C_NetworkMask));
        ...
        {
            bool result = CF_00000291C_NetworkMask.Solution_0_Test(input);
