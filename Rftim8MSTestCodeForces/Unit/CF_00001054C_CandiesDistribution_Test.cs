...
{
    [TestClass]
    public sealed class CF_00001054C_CandiesDistribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001054C_CandiesDistribution));
        ...
        {
            bool result = CF_00001054C_CandiesDistribution.Solution_0_Test(input);
