...
{
    [TestClass]
    public sealed class CF_00000909A_GenerateLogin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000909A_GenerateLogin));
        ...
        {
            bool result = CF_00000909A_GenerateLogin.Solution_0_Test(input);
