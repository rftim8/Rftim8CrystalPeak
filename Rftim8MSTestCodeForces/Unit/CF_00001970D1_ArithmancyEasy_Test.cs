...
{
    [TestClass]
    public sealed class CF_00001970D1_ArithmancyEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970D1_ArithmancyEasy));
        ...
        {
            bool result = CF_00001970D1_ArithmancyEasy.Solution_0_Test(input);
