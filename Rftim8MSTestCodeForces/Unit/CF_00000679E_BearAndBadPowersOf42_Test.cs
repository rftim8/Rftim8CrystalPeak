...
{
    [TestClass]
    public sealed class CF_00000679E_BearAndBadPowersOf42_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000679E_BearAndBadPowersOf42));
        ...
        {
            bool result = CF_00000679E_BearAndBadPowersOf42.Solution_0_Test(input);
