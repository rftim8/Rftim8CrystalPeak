...
{
    [TestClass]
    public sealed class CF_00000808B_AverageSleepTime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000808B_AverageSleepTime));
        ...
        {
            bool result = CF_00000808B_AverageSleepTime.Solution_0_Test(input);
