...
{
    [TestClass]
    public sealed class CF_00001187D_SubarraySorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001187D_SubarraySorting));
        ...
        {
            bool result = CF_00001187D_SubarraySorting.Solution_0_Test(input);
