...
{
    [TestClass]
    public sealed class CF_00000279E_BeautifulDecomposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000279E_BeautifulDecomposition));
        ...
        {
            bool result = CF_00000279E_BeautifulDecomposition.Solution_0_Test(input);
