...
{
    [TestClass]
    public sealed class CF_00000357A_GroupOfStudents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000357A_GroupOfStudents));
        ...
        {
            bool result = CF_00000357A_GroupOfStudents.Solution_0_Test(input);
