...
{
    [TestClass]
    public sealed class CF_00001982B_CollatzConjecture_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001982B_CollatzConjecture));
        ...
        {
            bool result = CF_00001982B_CollatzConjecture.Solution_0_Test(input);
