...
{
    [TestClass]
    public sealed class CF_00000041B_MartianDollar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000041B_MartianDollar));
        ...
        {
            bool result = CF_00000041B_MartianDollar.Solution_0_Test(input);
