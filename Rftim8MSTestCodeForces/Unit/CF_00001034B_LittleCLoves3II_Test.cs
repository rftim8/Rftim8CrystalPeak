...
{
    [TestClass]
    public sealed class CF_00001034B_LittleCLoves3II_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001034B_LittleCLoves3II));
        ...
        {
            bool result = CF_00001034B_LittleCLoves3II.Solution_0_Test(input);
