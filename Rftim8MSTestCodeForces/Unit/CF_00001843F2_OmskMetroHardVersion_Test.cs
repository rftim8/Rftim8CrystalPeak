...
{
    [TestClass]
    public sealed class CF_00001843F2_OmskMetroHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001843F2_OmskMetroHardVersion));
        ...
        {
            bool result = CF_00001843F2_OmskMetroHardVersion.Solution_0_Test(input);
