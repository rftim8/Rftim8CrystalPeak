...
{
    [TestClass]
    public sealed class CF_00001186E_VusTheCossackAndAField_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001186E_VusTheCossackAndAField));
        ...
        {
            bool result = CF_00001186E_VusTheCossackAndAField.Solution_0_Test(input);
