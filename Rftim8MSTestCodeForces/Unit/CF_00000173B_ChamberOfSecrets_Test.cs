...
{
    [TestClass]
    public sealed class CF_00000173B_ChamberOfSecrets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000173B_ChamberOfSecrets));
        ...
        {
            bool result = CF_00000173B_ChamberOfSecrets.Solution_0_Test(input);
