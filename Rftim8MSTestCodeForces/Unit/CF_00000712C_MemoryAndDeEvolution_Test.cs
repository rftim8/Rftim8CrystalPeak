...
{
    [TestClass]
    public sealed class CF_00000712C_MemoryAndDeEvolution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000712C_MemoryAndDeEvolution));
        ...
        {
            bool result = CF_00000712C_MemoryAndDeEvolution.Solution_0_Test(input);
