...
{
    [TestClass]
    public sealed class CF_00000997A_ConvertToOnes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000997A_ConvertToOnes));
        ...
        {
            bool result = CF_00000997A_ConvertToOnes.Solution_0_Test(input);
