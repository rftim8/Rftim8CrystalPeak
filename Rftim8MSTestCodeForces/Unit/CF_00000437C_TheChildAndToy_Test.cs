...
{
    [TestClass]
    public sealed class CF_00000437C_TheChildAndToy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000437C_TheChildAndToy));
        ...
        {
            bool result = CF_00000437C_TheChildAndToy.Solution_0_Test(input);
