...
{
    [TestClass]
    public sealed class CF_00000391C1_TheTournament_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000391C1_TheTournament));
        ...
        {
            bool result = CF_00000391C1_TheTournament.Solution_0_Test(input);
