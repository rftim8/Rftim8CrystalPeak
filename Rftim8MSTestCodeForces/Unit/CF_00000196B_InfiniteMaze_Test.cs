...
{
    [TestClass]
    public sealed class CF_00000196B_InfiniteMaze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000196B_InfiniteMaze));
        ...
        {
            bool result = CF_00000196B_InfiniteMaze.Solution_0_Test(input);
