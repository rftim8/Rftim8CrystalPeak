...
{
    [TestClass]
    public sealed class CF_00001806F2_GCDMasterHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001806F2_GCDMasterHardVersion));
        ...
        {
            bool result = CF_00001806F2_GCDMasterHardVersion.Solution_0_Test(input);
