...
{
    [TestClass]
    public sealed class CF_00001801B_BuyingGifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001801B_BuyingGifts));
        ...
        {
            bool result = CF_00001801B_BuyingGifts.Solution_0_Test(input);
