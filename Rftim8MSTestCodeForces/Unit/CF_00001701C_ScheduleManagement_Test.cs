...
{
    [TestClass]
    public sealed class CF_00001701C_ScheduleManagement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001701C_ScheduleManagement));
        ...
        {
            bool result = CF_00001701C_ScheduleManagement.Solution_0_Test(input);
