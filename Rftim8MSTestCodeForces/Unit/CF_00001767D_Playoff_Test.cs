...
{
    [TestClass]
    public sealed class CF_00001767D_Playoff_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001767D_Playoff));
        ...
        {
            bool result = CF_00001767D_Playoff.Solution_0_Test(input);
