...
{
    [TestClass]
    public sealed class CF_00001989E_DistanceToDifferent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001989E_DistanceToDifferent));
        ...
        {
            bool result = CF_00001989E_DistanceToDifferent.Solution_0_Test(input);
