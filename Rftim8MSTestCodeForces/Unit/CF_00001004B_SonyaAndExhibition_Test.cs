...
{
    [TestClass]
    public sealed class CF_00001004B_SonyaAndExhibition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001004B_SonyaAndExhibition));
        ...
        {
            bool result = CF_00001004B_SonyaAndExhibition.Solution_0_Test(input);
