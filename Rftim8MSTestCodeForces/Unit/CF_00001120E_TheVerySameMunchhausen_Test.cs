...
{
    [TestClass]
    public sealed class CF_00001120E_TheVerySameMunchhausen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001120E_TheVerySameMunchhausen));
        ...
        {
            bool result = CF_00001120E_TheVerySameMunchhausen.Solution_0_Test(input);
