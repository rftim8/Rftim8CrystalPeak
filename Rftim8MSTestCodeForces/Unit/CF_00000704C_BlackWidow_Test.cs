...
{
    [TestClass]
    public sealed class CF_00000704C_BlackWidow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000704C_BlackWidow));
        ...
        {
            bool result = CF_00000704C_BlackWidow.Solution_0_Test(input);
