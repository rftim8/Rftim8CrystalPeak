...
{
    [TestClass]
    public sealed class CF_00001857G_CountingGraphs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001857G_CountingGraphs));
        ...
        {
            bool result = CF_00001857G_CountingGraphs.Solution_0_Test(input);
