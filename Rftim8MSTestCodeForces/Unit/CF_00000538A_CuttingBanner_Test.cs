...
{
    [TestClass]
    public sealed class CF_00000538A_CuttingBanner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000538A_CuttingBanner));
        ...
        {
            bool result = CF_00000538A_CuttingBanner.Solution_0_Test(input);
