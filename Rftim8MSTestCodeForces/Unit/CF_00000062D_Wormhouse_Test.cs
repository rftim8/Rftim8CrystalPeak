...
{
    [TestClass]
    public sealed class CF_00000062D_Wormhouse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000062D_Wormhouse));
        ...
        {
            bool result = CF_00000062D_Wormhouse.Solution_0_Test(input);
