...
{
    [TestClass]
    public sealed class CF_00001615H_ReindeerGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001615H_ReindeerGames));
        ...
        {
            bool result = CF_00001615H_ReindeerGames.Solution_0_Test(input);
