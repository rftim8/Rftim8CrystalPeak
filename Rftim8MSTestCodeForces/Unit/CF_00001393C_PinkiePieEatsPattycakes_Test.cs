...
{
    [TestClass]
    public sealed class CF_00001393C_PinkiePieEatsPattycakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001393C_PinkiePieEatsPattycakes));
        ...
        {
            bool result = CF_00001393C_PinkiePieEatsPattycakes.Solution_0_Test(input);
