...
{
    [TestClass]
    public sealed class CF_00001765N_NumberReduction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001765N_NumberReduction));
        ...
        {
            bool result = CF_00001765N_NumberReduction.Solution_0_Test(input);
