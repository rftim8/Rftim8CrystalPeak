...
{
    [TestClass]
    public sealed class CF_00001765C_CardGuessing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001765C_CardGuessing));
        ...
        {
            bool result = CF_00001765C_CardGuessing.Solution_0_Test(input);
