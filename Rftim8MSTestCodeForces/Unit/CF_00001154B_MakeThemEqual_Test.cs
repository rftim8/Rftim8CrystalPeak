...
{
    [TestClass]
    public sealed class CF_00001154B_MakeThemEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001154B_MakeThemEqual));
        ...
        {
            bool result = CF_00001154B_MakeThemEqual.Solution_0_Test(input);
