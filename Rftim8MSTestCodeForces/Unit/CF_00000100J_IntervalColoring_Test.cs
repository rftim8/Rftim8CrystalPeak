...
{
    [TestClass]
    public sealed class CF_00000100J_IntervalColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000100J_IntervalColoring));
        ...
        {
            bool result = CF_00000100J_IntervalColoring.Solution_0_Test(input);
