...
{
    [TestClass]
    public sealed class CF_00000076C_Mutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000076C_Mutation));
        ...
        {
            bool result = CF_00000076C_Mutation.Solution_0_Test(input);
