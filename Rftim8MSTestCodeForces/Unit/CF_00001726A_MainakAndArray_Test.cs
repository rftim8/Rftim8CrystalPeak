...
{
    [TestClass]
    public sealed class CF_00001726A_MainakAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001726A_MainakAndArray));
        ...
        {
            bool result = CF_00001726A_MainakAndArray.Solution_0_Test(input);
