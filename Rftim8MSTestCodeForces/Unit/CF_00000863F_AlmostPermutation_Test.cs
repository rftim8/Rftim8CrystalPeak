...
{
    [TestClass]
    public sealed class CF_00000863F_AlmostPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000863F_AlmostPermutation));
        ...
        {
            bool result = CF_00000863F_AlmostPermutation.Solution_0_Test(input);
