...
{
    [TestClass]
    public sealed class CF_00000435B_PashaMaximizes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000435B_PashaMaximizes));
        ...
        {
            bool result = CF_00000435B_PashaMaximizes.Solution_0_Test(input);
