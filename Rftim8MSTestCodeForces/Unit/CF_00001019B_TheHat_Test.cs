...
{
    [TestClass]
    public sealed class CF_00001019B_TheHat_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001019B_TheHat));
        ...
        {
            bool result = CF_00001019B_TheHat.Solution_0_Test(input);
