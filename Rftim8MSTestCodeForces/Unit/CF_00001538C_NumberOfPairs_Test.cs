...
{
    [TestClass]
    public sealed class CF_00001538C_NumberOfPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001538C_NumberOfPairs));
        ...
        {
            bool result = CF_00001538C_NumberOfPairs.Solution_0_Test(input);
