...
{
    [TestClass]
    public sealed class CF_00000581B_LuxuriousHouses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000581B_LuxuriousHouses));
        ...
        {
            bool result = CF_00000581B_LuxuriousHouses.Solution_0_Test(input);
