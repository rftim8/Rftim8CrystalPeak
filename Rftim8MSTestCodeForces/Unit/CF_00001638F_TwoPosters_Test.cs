...
{
    [TestClass]
    public sealed class CF_00001638F_TwoPosters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001638F_TwoPosters));
        ...
        {
            bool result = CF_00001638F_TwoPosters.Solution_0_Test(input);
