...
{
    [TestClass]
    public sealed class CF_00000735B_Urbanization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000735B_Urbanization));
        ...
        {
            bool result = CF_00000735B_Urbanization.Solution_0_Test(input);
