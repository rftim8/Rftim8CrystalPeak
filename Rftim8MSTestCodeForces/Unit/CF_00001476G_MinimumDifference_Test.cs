...
{
    [TestClass]
    public sealed class CF_00001476G_MinimumDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001476G_MinimumDifference));
        ...
        {
            bool result = CF_00001476G_MinimumDifference.Solution_0_Test(input);
