...
{
    [TestClass]
    public sealed class CF_00001454B_UniqueBidAuction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001454B_UniqueBidAuction));
        ...
        {
            bool result = CF_00001454B_UniqueBidAuction.Solution_0_Test(input);
