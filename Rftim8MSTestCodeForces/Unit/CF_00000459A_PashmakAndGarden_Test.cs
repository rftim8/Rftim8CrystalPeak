...
{
    [TestClass]
    public sealed class CF_00000459A_PashmakAndGarden_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000459A_PashmakAndGarden));
        ...
        {
            bool result = CF_00000459A_PashmakAndGarden.Solution_0_Test(input);
