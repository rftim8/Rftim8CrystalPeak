...
{
    [TestClass]
    public sealed class CF_00000376B_IOU_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000376B_IOU));
        ...
        {
            bool result = CF_00000376B_IOU.Solution_0_Test(input);
