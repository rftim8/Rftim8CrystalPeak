...
{
    [TestClass]
    public sealed class CF_00001311E_ConstructTheBinaryTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001311E_ConstructTheBinaryTree));
        ...
        {
            bool result = CF_00001311E_ConstructTheBinaryTree.Solution_0_Test(input);
