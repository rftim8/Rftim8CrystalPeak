...
{
    [TestClass]
    public sealed class CF_00001770A_KoxiaAndWhiteboards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001770A_KoxiaAndWhiteboards));
        ...
        {
            bool result = CF_00001770A_KoxiaAndWhiteboards.Solution_0_Test(input);
