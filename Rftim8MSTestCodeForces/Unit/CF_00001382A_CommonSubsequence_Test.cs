...
{
    [TestClass]
    public sealed class CF_00001382A_CommonSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001382A_CommonSubsequence));
        ...
        {
            bool result = CF_00001382A_CommonSubsequence.Solution_0_Test(input);
