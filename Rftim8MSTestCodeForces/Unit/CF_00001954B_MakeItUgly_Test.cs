...
{
    [TestClass]
    public sealed class CF_00001954B_MakeItUgly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001954B_MakeItUgly));
        ...
        {
            bool result = CF_00001954B_MakeItUgly.Solution_0_Test(input);
