...
{
    [TestClass]
    public sealed class CF_00000164E_PolycarpusAndTasks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000164E_PolycarpusAndTasks));
        ...
        {
            bool result = CF_00000164E_PolycarpusAndTasks.Solution_0_Test(input);
