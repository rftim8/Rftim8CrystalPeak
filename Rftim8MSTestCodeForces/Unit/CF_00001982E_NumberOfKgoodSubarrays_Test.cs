...
{
    [TestClass]
    public sealed class CF_00001982E_NumberOfKgoodSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001982E_NumberOfKgoodSubarrays));
        ...
        {
            bool result = CF_00001982E_NumberOfKgoodSubarrays.Solution_0_Test(input);
