...
{
    [TestClass]
    public sealed class CF_00001301B_MotaracksBirthday_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001301B_MotaracksBirthday));
        ...
        {
            bool result = CF_00001301B_MotaracksBirthday.Solution_0_Test(input);
