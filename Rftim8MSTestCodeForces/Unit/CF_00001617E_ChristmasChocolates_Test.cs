...
{
    [TestClass]
    public sealed class CF_00001617E_ChristmasChocolates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001617E_ChristmasChocolates));
        ...
        {
            bool result = CF_00001617E_ChristmasChocolates.Solution_0_Test(input);
