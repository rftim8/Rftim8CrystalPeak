...
{
    [TestClass]
    public sealed class CF_00000818F_LevelGeneration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000818F_LevelGeneration));
        ...
        {
            bool result = CF_00000818F_LevelGeneration.Solution_0_Test(input);
