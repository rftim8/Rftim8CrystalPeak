...
{
    [TestClass]
    public sealed class CF_00001427A_AvoidingZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001427A_AvoidingZero));
        ...
        {
            bool result = CF_00001427A_AvoidingZero.Solution_0_Test(input);
