...
{
    [TestClass]
    public sealed class CF_00001725K_KingdomOfCriticism_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725K_KingdomOfCriticism));
        ...
        {
            bool result = CF_00001725K_KingdomOfCriticism.Solution_0_Test(input);
