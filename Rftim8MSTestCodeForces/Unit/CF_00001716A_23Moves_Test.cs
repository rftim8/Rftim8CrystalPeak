...
{
    [TestClass]
    public sealed class CF_00001716A_23Moves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001716A_23Moves));
        ...
        {
            bool result = CF_00001716A_23Moves.Solution_0_Test(input);
