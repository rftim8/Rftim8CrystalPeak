...
{
    [TestClass]
    public sealed class CF_00001459B_MoveAndTurn_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001459B_MoveAndTurn));
        ...
        {
            bool result = CF_00001459B_MoveAndTurn.Solution_0_Test(input);
