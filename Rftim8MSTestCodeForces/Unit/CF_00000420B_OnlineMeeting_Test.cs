...
{
    [TestClass]
    public sealed class CF_00000420B_OnlineMeeting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000420B_OnlineMeeting));
        ...
        {
            bool result = CF_00000420B_OnlineMeeting.Solution_0_Test(input);
