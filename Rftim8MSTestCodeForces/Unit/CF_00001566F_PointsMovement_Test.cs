...
{
    [TestClass]
    public sealed class CF_00001566F_PointsMovement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001566F_PointsMovement));
        ...
        {
            bool result = CF_00001566F_PointsMovement.Solution_0_Test(input);
