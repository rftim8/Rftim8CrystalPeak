...
{
    [TestClass]
    public sealed class CF_00001090M_ThePleasantWalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090M_ThePleasantWalk));
        ...
        {
            bool result = CF_00001090M_ThePleasantWalk.Solution_0_Test(input);
