...
{
    [TestClass]
    public sealed class CF_00001893A_AnonymousInformant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001893A_AnonymousInformant));
        ...
        {
            bool result = CF_00001893A_AnonymousInformant.Solution_0_Test(input);
