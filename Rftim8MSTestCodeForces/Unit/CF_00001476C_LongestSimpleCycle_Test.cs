...
{
    [TestClass]
    public sealed class CF_00001476C_LongestSimpleCycle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001476C_LongestSimpleCycle));
        ...
        {
            bool result = CF_00001476C_LongestSimpleCycle.Solution_0_Test(input);
