...
{
    [TestClass]
    public sealed class CF_00000130C_DecimalSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000130C_DecimalSum));
        ...
        {
            bool result = CF_00000130C_DecimalSum.Solution_0_Test(input);
