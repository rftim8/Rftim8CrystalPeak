...
{
    [TestClass]
    public sealed class CF_00000061B_HardWork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000061B_HardWork));
        ...
        {
            bool result = CF_00000061B_HardWork.Solution_0_Test(input);
