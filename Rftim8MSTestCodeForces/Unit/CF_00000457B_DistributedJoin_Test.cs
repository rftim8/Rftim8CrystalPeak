...
{
    [TestClass]
    public sealed class CF_00000457B_DistributedJoin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000457B_DistributedJoin));
        ...
        {
            bool result = CF_00000457B_DistributedJoin.Solution_0_Test(input);
