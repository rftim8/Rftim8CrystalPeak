...
{
    [TestClass]
    public sealed class CF_00001292C_XenonsAttackOnTheGangs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001292C_XenonsAttackOnTheGangs));
        ...
        {
            bool result = CF_00001292C_XenonsAttackOnTheGangs.Solution_0_Test(input);
