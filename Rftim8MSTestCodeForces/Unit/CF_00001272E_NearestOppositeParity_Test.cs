...
{
    [TestClass]
    public sealed class CF_00001272E_NearestOppositeParity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001272E_NearestOppositeParity));
        ...
        {
            bool result = CF_00001272E_NearestOppositeParity.Solution_0_Test(input);
