...
{
    [TestClass]
    public sealed class CF_00000354B_GameWithStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000354B_GameWithStrings));
        ...
        {
            bool result = CF_00000354B_GameWithStrings.Solution_0_Test(input);
