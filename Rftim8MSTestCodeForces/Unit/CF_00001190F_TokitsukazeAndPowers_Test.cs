...
{
    [TestClass]
    public sealed class CF_00001190F_TokitsukazeAndPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001190F_TokitsukazeAndPowers));
        ...
        {
            bool result = CF_00001190F_TokitsukazeAndPowers.Solution_0_Test(input);
