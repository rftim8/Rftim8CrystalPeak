...
{
    [TestClass]
    public sealed class CF_00000946C_StringTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000946C_StringTransformation));
        ...
        {
            bool result = CF_00000946C_StringTransformation.Solution_0_Test(input);
