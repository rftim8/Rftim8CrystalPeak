...
{
    [TestClass]
    public sealed class CF_00001272A_ThreeFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001272A_ThreeFriends));
        ...
        {
            bool result = CF_00001272A_ThreeFriends.Solution_0_Test(input);
