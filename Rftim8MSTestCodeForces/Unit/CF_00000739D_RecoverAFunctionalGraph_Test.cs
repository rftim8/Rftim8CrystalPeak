...
{
    [TestClass]
    public sealed class CF_00000739D_RecoverAFunctionalGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000739D_RecoverAFunctionalGraph));
        ...
        {
            bool result = CF_00000739D_RecoverAFunctionalGraph.Solution_0_Test(input);
