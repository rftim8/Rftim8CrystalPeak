...
{
    [TestClass]
    public sealed class CF_00002000G_CallDuringTheJourney_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002000G_CallDuringTheJourney));
        ...
        {
            bool result = CF_00002000G_CallDuringTheJourney.Solution_0_Test(input);
