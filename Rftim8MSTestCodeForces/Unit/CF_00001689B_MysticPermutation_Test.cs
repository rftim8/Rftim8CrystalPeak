...
{
    [TestClass]
    public sealed class CF_00001689B_MysticPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001689B_MysticPermutation));
        ...
        {
            bool result = CF_00001689B_MysticPermutation.Solution_0_Test(input);
