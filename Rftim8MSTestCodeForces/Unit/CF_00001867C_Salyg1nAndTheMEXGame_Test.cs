...
{
    [TestClass]
    public sealed class CF_00001867C_Salyg1nAndTheMEXGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001867C_Salyg1nAndTheMEXGame));
        ...
        {
            bool result = CF_00001867C_Salyg1nAndTheMEXGame.Solution_0_Test(input);
