...
{
    [TestClass]
    public sealed class CF_00001118F2_TreeCuttingHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001118F2_TreeCuttingHardVersion));
        ...
        {
            bool result = CF_00001118F2_TreeCuttingHardVersion.Solution_0_Test(input);
