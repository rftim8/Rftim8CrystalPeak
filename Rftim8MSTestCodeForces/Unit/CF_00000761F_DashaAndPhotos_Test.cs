...
{
    [TestClass]
    public sealed class CF_00000761F_DashaAndPhotos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000761F_DashaAndPhotos));
        ...
        {
            bool result = CF_00000761F_DashaAndPhotos.Solution_0_Test(input);
