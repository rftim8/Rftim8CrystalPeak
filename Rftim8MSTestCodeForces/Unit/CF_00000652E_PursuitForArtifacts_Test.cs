...
{
    [TestClass]
    public sealed class CF_00000652E_PursuitForArtifacts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000652E_PursuitForArtifacts));
        ...
        {
            bool result = CF_00000652E_PursuitForArtifacts.Solution_0_Test(input);
