...
{
    [TestClass]
    public sealed class CF_00000028A_BenderProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000028A_BenderProblem));
        ...
        {
            bool result = CF_00000028A_BenderProblem.Solution_0_Test(input);
