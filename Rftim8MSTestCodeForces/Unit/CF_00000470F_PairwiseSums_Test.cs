...
{
    [TestClass]
    public sealed class CF_00000470F_PairwiseSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000470F_PairwiseSums));
        ...
        {
            bool result = CF_00000470F_PairwiseSums.Solution_0_Test(input);
