...
{
    [TestClass]
    public sealed class CF_00000270A_FancyFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000270A_FancyFence));
        ...
        {
            bool result = CF_00000270A_FancyFence.Solution_0_Test(input);
