...
{
    [TestClass]
    public sealed class CF_00001431I_CyclicShifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001431I_CyclicShifts));
        ...
        {
            bool result = CF_00001431I_CyclicShifts.Solution_0_Test(input);
