...
{
    [TestClass]
    public sealed class CF_00001032F_VasyaAndMaximumMatching_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001032F_VasyaAndMaximumMatching));
        ...
        {
            bool result = CF_00001032F_VasyaAndMaximumMatching.Solution_0_Test(input);
