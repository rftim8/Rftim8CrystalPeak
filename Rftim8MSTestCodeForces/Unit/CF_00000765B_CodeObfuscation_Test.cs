...
{
    [TestClass]
    public sealed class CF_00000765B_CodeObfuscation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000765B_CodeObfuscation));
        ...
        {
            bool result = CF_00000765B_CodeObfuscation.Solution_0_Test(input);
