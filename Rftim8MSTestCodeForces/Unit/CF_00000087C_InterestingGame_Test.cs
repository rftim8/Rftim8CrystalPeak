...
{
    [TestClass]
    public sealed class CF_00000087C_InterestingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000087C_InterestingGame));
        ...
        {
            bool result = CF_00000087C_InterestingGame.Solution_0_Test(input);
