...
{
    [TestClass]
    public sealed class CF_00001158C_PermutationRecovery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001158C_PermutationRecovery));
        ...
        {
            bool result = CF_00001158C_PermutationRecovery.Solution_0_Test(input);
