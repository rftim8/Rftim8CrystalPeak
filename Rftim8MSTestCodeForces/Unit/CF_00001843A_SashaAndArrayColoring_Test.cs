...
{
    [TestClass]
    public sealed class CF_00001843A_SashaAndArrayColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001843A_SashaAndArrayColoring));
        ...
        {
            bool result = CF_00001843A_SashaAndArrayColoring.Solution_0_Test(input);
