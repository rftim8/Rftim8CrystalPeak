...
{
    [TestClass]
    public sealed class CF_00001358E_AreYouFired_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001358E_AreYouFired));
        ...
        {
            bool result = CF_00001358E_AreYouFired.Solution_0_Test(input);
