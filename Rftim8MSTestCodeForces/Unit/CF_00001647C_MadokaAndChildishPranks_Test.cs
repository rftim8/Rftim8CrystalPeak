...
{
    [TestClass]
    public sealed class CF_00001647C_MadokaAndChildishPranks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001647C_MadokaAndChildishPranks));
        ...
        {
            bool result = CF_00001647C_MadokaAndChildishPranks.Solution_0_Test(input);
