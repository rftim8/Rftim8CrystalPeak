...
{
    [TestClass]
    public sealed class CF_00001406E_DeletingNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001406E_DeletingNumbers));
        ...
        {
            bool result = CF_00001406E_DeletingNumbers.Solution_0_Test(input);
