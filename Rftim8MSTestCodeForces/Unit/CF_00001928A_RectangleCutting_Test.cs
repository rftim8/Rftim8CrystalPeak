...
{
    [TestClass]
    public sealed class CF_00001928A_RectangleCutting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001928A_RectangleCutting));
        ...
        {
            bool result = CF_00001928A_RectangleCutting.Solution_0_Test(input);
