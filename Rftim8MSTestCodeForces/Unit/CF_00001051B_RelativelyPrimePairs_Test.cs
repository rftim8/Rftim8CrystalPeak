...
{
    [TestClass]
    public sealed class CF_00001051B_RelativelyPrimePairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001051B_RelativelyPrimePairs));
        ...
        {
            bool result = CF_00001051B_RelativelyPrimePairs.Solution_0_Test(input);
