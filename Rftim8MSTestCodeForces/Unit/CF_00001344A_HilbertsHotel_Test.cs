...
{
    [TestClass]
    public sealed class CF_00001344A_HilbertsHotel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001344A_HilbertsHotel));
        ...
        {
            bool result = CF_00001344A_HilbertsHotel.Solution_0_Test(input);
