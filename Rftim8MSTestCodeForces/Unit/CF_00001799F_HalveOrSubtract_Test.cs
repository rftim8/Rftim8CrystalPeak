...
{
    [TestClass]
    public sealed class CF_00001799F_HalveOrSubtract_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001799F_HalveOrSubtract));
        ...
        {
            bool result = CF_00001799F_HalveOrSubtract.Solution_0_Test(input);
