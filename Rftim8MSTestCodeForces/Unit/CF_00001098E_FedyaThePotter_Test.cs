...
{
    [TestClass]
    public sealed class CF_00001098E_FedyaThePotter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001098E_FedyaThePotter));
        ...
        {
            bool result = CF_00001098E_FedyaThePotter.Solution_0_Test(input);
