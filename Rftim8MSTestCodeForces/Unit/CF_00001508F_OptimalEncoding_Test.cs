...
{
    [TestClass]
    public sealed class CF_00001508F_OptimalEncoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001508F_OptimalEncoding));
        ...
        {
            bool result = CF_00001508F_OptimalEncoding.Solution_0_Test(input);
