...
{
    [TestClass]
    public sealed class CF_00001468F_FullTurn_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468F_FullTurn));
        ...
        {
            bool result = CF_00001468F_FullTurn.Solution_0_Test(input);
