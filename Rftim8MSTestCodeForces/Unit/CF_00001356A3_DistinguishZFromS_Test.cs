...
{
    [TestClass]
    public sealed class CF_00001356A3_DistinguishZFromS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001356A3_DistinguishZFromS));
        ...
        {
            bool result = CF_00001356A3_DistinguishZFromS.Solution_0_Test(input);
