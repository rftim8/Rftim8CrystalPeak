...
{
    [TestClass]
    public sealed class CF_00001371D_Grid00100_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001371D_Grid00100));
        ...
        {
            bool result = CF_00001371D_Grid00100.Solution_0_Test(input);
