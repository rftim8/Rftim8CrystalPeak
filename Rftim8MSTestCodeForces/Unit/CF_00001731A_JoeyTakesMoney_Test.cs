...
{
    [TestClass]
    public sealed class CF_00001731A_JoeyTakesMoney_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001731A_JoeyTakesMoney));
        ...
        {
            bool result = CF_00001731A_JoeyTakesMoney.Solution_0_Test(input);
