...
{
    [TestClass]
    public sealed class CF_00000643C_LevelsAndRegions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000643C_LevelsAndRegions));
        ...
        {
            bool result = CF_00000643C_LevelsAndRegions.Solution_0_Test(input);
