...
{
    [TestClass]
    public sealed class CF_00000014E_Camels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000014E_Camels));
        ...
        {
            bool result = CF_00000014E_Camels.Solution_0_Test(input);
