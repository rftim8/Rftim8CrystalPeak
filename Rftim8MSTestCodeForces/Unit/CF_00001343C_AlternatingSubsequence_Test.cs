...
{
    [TestClass]
    public sealed class CF_00001343C_AlternatingSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001343C_AlternatingSubsequence));
        ...
        {
            bool result = CF_00001343C_AlternatingSubsequence.Solution_0_Test(input);
