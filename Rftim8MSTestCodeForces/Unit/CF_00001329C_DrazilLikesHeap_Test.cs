...
{
    [TestClass]
    public sealed class CF_00001329C_DrazilLikesHeap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001329C_DrazilLikesHeap));
        ...
        {
            bool result = CF_00001329C_DrazilLikesHeap.Solution_0_Test(input);
