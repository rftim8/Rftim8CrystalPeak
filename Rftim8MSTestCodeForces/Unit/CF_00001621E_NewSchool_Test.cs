...
{
    [TestClass]
    public sealed class CF_00001621E_NewSchool_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001621E_NewSchool));
        ...
        {
            bool result = CF_00001621E_NewSchool.Solution_0_Test(input);
