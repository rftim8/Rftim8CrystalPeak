...
{
    [TestClass]
    public sealed class CF_00001133E_KBalancedTeams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001133E_KBalancedTeams));
        ...
        {
            bool result = CF_00001133E_KBalancedTeams.Solution_0_Test(input);
