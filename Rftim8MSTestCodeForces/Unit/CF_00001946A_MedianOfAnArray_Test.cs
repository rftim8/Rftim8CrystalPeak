...
{
    [TestClass]
    public sealed class CF_00001946A_MedianOfAnArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001946A_MedianOfAnArray));
        ...
        {
            bool result = CF_00001946A_MedianOfAnArray.Solution_0_Test(input);
