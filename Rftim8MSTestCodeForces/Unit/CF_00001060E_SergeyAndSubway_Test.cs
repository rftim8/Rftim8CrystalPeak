...
{
    [TestClass]
    public sealed class CF_00001060E_SergeyAndSubway_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001060E_SergeyAndSubway));
        ...
        {
            bool result = CF_00001060E_SergeyAndSubway.Solution_0_Test(input);
