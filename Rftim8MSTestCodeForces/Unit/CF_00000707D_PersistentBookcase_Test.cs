...
{
    [TestClass]
    public sealed class CF_00000707D_PersistentBookcase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000707D_PersistentBookcase));
        ...
        {
            bool result = CF_00000707D_PersistentBookcase.Solution_0_Test(input);
