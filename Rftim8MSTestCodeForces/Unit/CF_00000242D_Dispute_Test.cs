...
{
    [TestClass]
    public sealed class CF_00000242D_Dispute_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000242D_Dispute));
        ...
        {
            bool result = CF_00000242D_Dispute.Solution_0_Test(input);
