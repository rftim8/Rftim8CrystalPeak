...
{
    [TestClass]
    public sealed class CF_00001819B_TheButcher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001819B_TheButcher));
        ...
        {
            bool result = CF_00001819B_TheButcher.Solution_0_Test(input);
