...
{
    [TestClass]
    public sealed class CF_00001836A_Destroyer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001836A_Destroyer));
        ...
        {
            bool result = CF_00001836A_Destroyer.Solution_0_Test(input);
