...
{
    [TestClass]
    public sealed class CF_00001574B_CombinatoricsHomework_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001574B_CombinatoricsHomework));
        ...
        {
            bool result = CF_00001574B_CombinatoricsHomework.Solution_0_Test(input);
