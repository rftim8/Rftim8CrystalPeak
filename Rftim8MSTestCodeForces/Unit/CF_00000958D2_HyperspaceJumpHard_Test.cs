...
{
    [TestClass]
    public sealed class CF_00000958D2_HyperspaceJumpHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958D2_HyperspaceJumpHard));
        ...
        {
            bool result = CF_00000958D2_HyperspaceJumpHard.Solution_0_Test(input);
