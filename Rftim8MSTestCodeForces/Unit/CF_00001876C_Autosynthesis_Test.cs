...
{
    [TestClass]
    public sealed class CF_00001876C_Autosynthesis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001876C_Autosynthesis));
        ...
        {
            bool result = CF_00001876C_Autosynthesis.Solution_0_Test(input);
