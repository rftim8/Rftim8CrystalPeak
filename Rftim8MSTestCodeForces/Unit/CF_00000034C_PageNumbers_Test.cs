...
{
    [TestClass]
    public sealed class CF_00000034C_PageNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000034C_PageNumbers));
        ...
        {
            bool result = CF_00000034C_PageNumbers.Solution_0_Test(input);
