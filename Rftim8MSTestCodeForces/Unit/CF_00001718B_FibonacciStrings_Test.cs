...
{
    [TestClass]
    public sealed class CF_00001718B_FibonacciStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001718B_FibonacciStrings));
        ...
        {
            bool result = CF_00001718B_FibonacciStrings.Solution_0_Test(input);
