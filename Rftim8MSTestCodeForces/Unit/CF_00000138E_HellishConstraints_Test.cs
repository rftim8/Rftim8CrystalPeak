...
{
    [TestClass]
    public sealed class CF_00000138E_HellishConstraints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000138E_HellishConstraints));
        ...
        {
            bool result = CF_00000138E_HellishConstraints.Solution_0_Test(input);
