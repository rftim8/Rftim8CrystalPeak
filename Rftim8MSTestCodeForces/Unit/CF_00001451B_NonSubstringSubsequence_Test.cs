...
{
    [TestClass]
    public sealed class CF_00001451B_NonSubstringSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001451B_NonSubstringSubsequence));
        ...
        {
            bool result = CF_00001451B_NonSubstringSubsequence.Solution_0_Test(input);
