...
{
    [TestClass]
    public sealed class CF_00000758D_AbilityToConvert_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000758D_AbilityToConvert));
        ...
        {
            bool result = CF_00000758D_AbilityToConvert.Solution_0_Test(input);
