...
{
    [TestClass]
    public sealed class CF_00000030D_KingsProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000030D_KingsProblem));
        ...
        {
            bool result = CF_00000030D_KingsProblem.Solution_0_Test(input);
