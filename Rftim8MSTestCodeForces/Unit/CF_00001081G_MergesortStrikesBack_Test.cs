...
{
    [TestClass]
    public sealed class CF_00001081G_MergesortStrikesBack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001081G_MergesortStrikesBack));
        ...
        {
            bool result = CF_00001081G_MergesortStrikesBack.Solution_0_Test(input);
