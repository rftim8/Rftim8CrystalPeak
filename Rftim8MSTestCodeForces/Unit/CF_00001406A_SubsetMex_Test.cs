...
{
    [TestClass]
    public sealed class CF_00001406A_SubsetMex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001406A_SubsetMex));
        ...
        {
            bool result = CF_00001406A_SubsetMex.Solution_0_Test(input);
