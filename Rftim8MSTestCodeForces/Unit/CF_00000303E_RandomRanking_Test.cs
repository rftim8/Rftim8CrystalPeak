...
{
    [TestClass]
    public sealed class CF_00000303E_RandomRanking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000303E_RandomRanking));
        ...
        {
            bool result = CF_00000303E_RandomRanking.Solution_0_Test(input);
