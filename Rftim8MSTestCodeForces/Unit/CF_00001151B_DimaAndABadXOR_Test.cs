...
{
    [TestClass]
    public sealed class CF_00001151B_DimaAndABadXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001151B_DimaAndABadXOR));
        ...
        {
            bool result = CF_00001151B_DimaAndABadXOR.Solution_0_Test(input);
