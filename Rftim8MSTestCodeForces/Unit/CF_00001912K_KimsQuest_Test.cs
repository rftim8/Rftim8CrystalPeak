...
{
    [TestClass]
    public sealed class CF_00001912K_KimsQuest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001912K_KimsQuest));
        ...
        {
            bool result = CF_00001912K_KimsQuest.Solution_0_Test(input);
