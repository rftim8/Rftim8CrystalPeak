...
{
    [TestClass]
    public sealed class CF_00001895A_TreasureChest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001895A_TreasureChest));
        ...
        {
            bool result = CF_00001895A_TreasureChest.Solution_0_Test(input);
