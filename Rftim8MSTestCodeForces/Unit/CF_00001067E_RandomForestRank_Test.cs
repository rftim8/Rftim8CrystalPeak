...
{
    [TestClass]
    public sealed class CF_00001067E_RandomForestRank_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001067E_RandomForestRank));
        ...
        {
            bool result = CF_00001067E_RandomForestRank.Solution_0_Test(input);
