...
{
    [TestClass]
    public sealed class CF_00000404C_RestoreGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000404C_RestoreGraph));
        ...
        {
            bool result = CF_00000404C_RestoreGraph.Solution_0_Test(input);
