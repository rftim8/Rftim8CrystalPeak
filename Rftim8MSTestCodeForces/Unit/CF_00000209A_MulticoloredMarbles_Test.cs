...
{
    [TestClass]
    public sealed class CF_00000209A_MulticoloredMarbles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000209A_MulticoloredMarbles));
        ...
        {
            bool result = CF_00000209A_MulticoloredMarbles.Solution_0_Test(input);
