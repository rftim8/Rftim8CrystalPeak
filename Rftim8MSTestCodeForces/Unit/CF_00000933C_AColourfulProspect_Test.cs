...
{
    [TestClass]
    public sealed class CF_00000933C_AColourfulProspect_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000933C_AColourfulProspect));
        ...
        {
            bool result = CF_00000933C_AColourfulProspect.Solution_0_Test(input);
