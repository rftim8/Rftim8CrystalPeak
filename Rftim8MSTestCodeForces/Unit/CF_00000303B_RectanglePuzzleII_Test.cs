...
{
    [TestClass]
    public sealed class CF_00000303B_RectanglePuzzleII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000303B_RectanglePuzzleII));
        ...
        {
            bool result = CF_00000303B_RectanglePuzzleII.Solution_0_Test(input);
