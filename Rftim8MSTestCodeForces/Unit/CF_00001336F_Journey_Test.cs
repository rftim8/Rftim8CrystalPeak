...
{
    [TestClass]
    public sealed class CF_00001336F_Journey_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001336F_Journey));
        ...
        {
            bool result = CF_00001336F_Journey.Solution_0_Test(input);
