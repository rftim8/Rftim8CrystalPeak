...
{
    [TestClass]
    public sealed class CF_00001016A_DeathNote_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001016A_DeathNote));
        ...
        {
            bool result = CF_00001016A_DeathNote.Solution_0_Test(input);
