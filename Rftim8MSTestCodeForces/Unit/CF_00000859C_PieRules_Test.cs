...
{
    [TestClass]
    public sealed class CF_00000859C_PieRules_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000859C_PieRules));
        ...
        {
            bool result = CF_00000859C_PieRules.Solution_0_Test(input);
