...
{
    [TestClass]
    public sealed class CF_00001120A_DianaAndLiana_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001120A_DianaAndLiana));
        ...
        {
            bool result = CF_00001120A_DianaAndLiana.Solution_0_Test(input);
