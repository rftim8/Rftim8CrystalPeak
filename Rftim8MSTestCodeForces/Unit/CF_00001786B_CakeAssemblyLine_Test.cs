...
{
    [TestClass]
    public sealed class CF_00001786B_CakeAssemblyLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001786B_CakeAssemblyLine));
        ...
        {
            bool result = CF_00001786B_CakeAssemblyLine.Solution_0_Test(input);
