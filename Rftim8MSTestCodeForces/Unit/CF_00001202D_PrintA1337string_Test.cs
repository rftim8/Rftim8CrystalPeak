...
{
    [TestClass]
    public sealed class CF_00001202D_PrintA1337string_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001202D_PrintA1337string));
        ...
        {
            bool result = CF_00001202D_PrintA1337string.Solution_0_Test(input);
