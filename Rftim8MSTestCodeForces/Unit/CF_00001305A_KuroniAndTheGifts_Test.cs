...
{
    [TestClass]
    public sealed class CF_00001305A_KuroniAndTheGifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001305A_KuroniAndTheGifts));
        ...
        {
            bool result = CF_00001305A_KuroniAndTheGifts.Solution_0_Test(input);
