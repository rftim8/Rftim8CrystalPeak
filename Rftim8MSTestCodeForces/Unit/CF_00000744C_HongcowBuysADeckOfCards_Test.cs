...
{
    [TestClass]
    public sealed class CF_00000744C_HongcowBuysADeckOfCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000744C_HongcowBuysADeckOfCards));
        ...
        {
            bool result = CF_00000744C_HongcowBuysADeckOfCards.Solution_0_Test(input);
