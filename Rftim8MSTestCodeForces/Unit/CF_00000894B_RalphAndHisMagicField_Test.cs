...
{
    [TestClass]
    public sealed class CF_00000894B_RalphAndHisMagicField_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000894B_RalphAndHisMagicField));
        ...
        {
            bool result = CF_00000894B_RalphAndHisMagicField.Solution_0_Test(input);
