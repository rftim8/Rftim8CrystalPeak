...
{
    [TestClass]
    public sealed class CF_00001690G_CountTheTrains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001690G_CountTheTrains));
        ...
        {
            bool result = CF_00001690G_CountTheTrains.Solution_0_Test(input);
