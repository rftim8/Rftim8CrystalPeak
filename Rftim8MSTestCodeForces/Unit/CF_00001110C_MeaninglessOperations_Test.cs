...
{
    [TestClass]
    public sealed class CF_00001110C_MeaninglessOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001110C_MeaninglessOperations));
        ...
        {
            bool result = CF_00001110C_MeaninglessOperations.Solution_0_Test(input);
