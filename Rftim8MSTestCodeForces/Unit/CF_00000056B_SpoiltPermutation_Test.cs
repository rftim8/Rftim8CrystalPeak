...
{
    [TestClass]
    public sealed class CF_00000056B_SpoiltPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000056B_SpoiltPermutation));
        ...
        {
            bool result = CF_00000056B_SpoiltPermutation.Solution_0_Test(input);
