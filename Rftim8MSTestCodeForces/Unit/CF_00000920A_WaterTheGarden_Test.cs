...
{
    [TestClass]
    public sealed class CF_00000920A_WaterTheGarden_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000920A_WaterTheGarden));
        ...
        {
            bool result = CF_00000920A_WaterTheGarden.Solution_0_Test(input);
