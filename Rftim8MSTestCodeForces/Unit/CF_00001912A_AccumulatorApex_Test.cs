...
{
    [TestClass]
    public sealed class CF_00001912A_AccumulatorApex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001912A_AccumulatorApex));
        ...
        {
            bool result = CF_00001912A_AccumulatorApex.Solution_0_Test(input);
