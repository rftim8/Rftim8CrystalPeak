...
{
    [TestClass]
    public sealed class CF_00000534B_CoveredPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000534B_CoveredPath));
        ...
        {
            bool result = CF_00000534B_CoveredPath.Solution_0_Test(input);
