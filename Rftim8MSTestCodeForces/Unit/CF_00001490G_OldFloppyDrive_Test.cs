...
{
    [TestClass]
    public sealed class CF_00001490G_OldFloppyDrive_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001490G_OldFloppyDrive));
        ...
        {
            bool result = CF_00001490G_OldFloppyDrive.Solution_0_Test(input);
