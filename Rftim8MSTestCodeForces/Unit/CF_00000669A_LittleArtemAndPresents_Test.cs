...
{
    [TestClass]
    public sealed class CF_00000669A_LittleArtemAndPresents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000669A_LittleArtemAndPresents));
        ...
        {
            bool result = CF_00000669A_LittleArtemAndPresents.Solution_0_Test(input);
