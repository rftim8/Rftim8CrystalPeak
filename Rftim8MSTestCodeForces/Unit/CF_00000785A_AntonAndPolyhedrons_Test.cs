...
{
    [TestClass]
    public sealed class CF_00000785A_AntonAndPolyhedrons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000785A_AntonAndPolyhedrons));
        ...
        {
            bool result = CF_00000785A_AntonAndPolyhedrons.Solution_0_Test(input);
