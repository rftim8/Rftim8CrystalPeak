...
{
    [TestClass]
    public sealed class CF_00001043D_MysteriousCrime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001043D_MysteriousCrime));
        ...
        {
            bool result = CF_00001043D_MysteriousCrime.Solution_0_Test(input);
