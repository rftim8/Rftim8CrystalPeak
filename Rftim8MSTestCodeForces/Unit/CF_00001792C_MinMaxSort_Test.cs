...
{
    [TestClass]
    public sealed class CF_00001792C_MinMaxSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001792C_MinMaxSort));
        ...
        {
            bool result = CF_00001792C_MinMaxSort.Solution_0_Test(input);
