...
{
    [TestClass]
    public sealed class CF_00001027A_PalindromicTwist_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001027A_PalindromicTwist));
        ...
        {
            bool result = CF_00001027A_PalindromicTwist.Solution_0_Test(input);
