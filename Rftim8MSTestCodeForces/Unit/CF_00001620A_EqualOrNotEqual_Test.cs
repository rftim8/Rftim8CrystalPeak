...
{
    [TestClass]
    public sealed class CF_00001620A_EqualOrNotEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001620A_EqualOrNotEqual));
        ...
        {
            bool result = CF_00001620A_EqualOrNotEqual.Solution_0_Test(input);
