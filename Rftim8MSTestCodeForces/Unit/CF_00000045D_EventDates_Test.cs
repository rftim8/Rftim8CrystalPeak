...
{
    [TestClass]
    public sealed class CF_00000045D_EventDates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000045D_EventDates));
        ...
        {
            bool result = CF_00000045D_EventDates.Solution_0_Test(input);
