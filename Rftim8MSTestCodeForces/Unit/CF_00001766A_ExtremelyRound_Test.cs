...
{
    [TestClass]
    public sealed class CF_00001766A_ExtremelyRound_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001766A_ExtremelyRound));
        ...
        {
            bool result = CF_00001766A_ExtremelyRound.Solution_0_Test(input);
