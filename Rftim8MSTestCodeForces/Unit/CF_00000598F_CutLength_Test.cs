...
{
    [TestClass]
    public sealed class CF_00000598F_CutLength_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000598F_CutLength));
        ...
        {
            bool result = CF_00000598F_CutLength.Solution_0_Test(input);
