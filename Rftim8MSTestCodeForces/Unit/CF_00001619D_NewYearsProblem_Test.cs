...
{
    [TestClass]
    public sealed class CF_00001619D_NewYearsProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001619D_NewYearsProblem));
        ...
        {
            bool result = CF_00001619D_NewYearsProblem.Solution_0_Test(input);
