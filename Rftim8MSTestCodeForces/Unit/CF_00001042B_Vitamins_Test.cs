...
{
    [TestClass]
    public sealed class CF_00001042B_Vitamins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001042B_Vitamins));
        ...
        {
            bool result = CF_00001042B_Vitamins.Solution_0_Test(input);
