...
{
    [TestClass]
    public sealed class CF_00000149B_MartianClock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000149B_MartianClock));
        ...
        {
            bool result = CF_00000149B_MartianClock.Solution_0_Test(input);
