...
{
    [TestClass]
    public sealed class CF_00000524C_TheArtOfDealingWithATM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000524C_TheArtOfDealingWithATM));
        ...
        {
            bool result = CF_00000524C_TheArtOfDealingWithATM.Solution_0_Test(input);
