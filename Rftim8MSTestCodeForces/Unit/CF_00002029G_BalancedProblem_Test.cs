...
{
    [TestClass]
    public sealed class CF_00002029G_BalancedProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002029G_BalancedProblem));
        ...
        {
            bool result = CF_00002029G_BalancedProblem.Solution_0_Test(input);
