...
{
    [TestClass]
    public sealed class CF_00000242C_KingsPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000242C_KingsPath));
        ...
        {
            bool result = CF_00000242C_KingsPath.Solution_0_Test(input);
