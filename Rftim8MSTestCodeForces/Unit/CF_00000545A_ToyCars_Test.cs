...
{
    [TestClass]
    public sealed class CF_00000545A_ToyCars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000545A_ToyCars));
        ...
        {
            bool result = CF_00000545A_ToyCars.Solution_0_Test(input);
