...
{
    [TestClass]
    public sealed class CF_00001215C_SwapLetters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001215C_SwapLetters));
        ...
        {
            bool result = CF_00001215C_SwapLetters.Solution_0_Test(input);
