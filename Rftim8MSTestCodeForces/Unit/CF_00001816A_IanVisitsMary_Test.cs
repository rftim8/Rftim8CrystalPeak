...
{
    [TestClass]
    public sealed class CF_00001816A_IanVisitsMary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001816A_IanVisitsMary));
        ...
        {
            bool result = CF_00001816A_IanVisitsMary.Solution_0_Test(input);
