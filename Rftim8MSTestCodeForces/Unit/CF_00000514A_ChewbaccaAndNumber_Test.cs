...
{
    [TestClass]
    public sealed class CF_00000514A_ChewbaccaAndNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000514A_ChewbaccaAndNumber));
        ...
        {
            bool result = CF_00000514A_ChewbaccaAndNumber.Solution_0_Test(input);
