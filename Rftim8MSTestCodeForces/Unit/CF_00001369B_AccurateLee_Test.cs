...
{
    [TestClass]
    public sealed class CF_00001369B_AccurateLee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001369B_AccurateLee));
        ...
        {
            bool result = CF_00001369B_AccurateLee.Solution_0_Test(input);
