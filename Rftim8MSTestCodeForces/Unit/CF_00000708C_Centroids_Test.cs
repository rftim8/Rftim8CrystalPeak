...
{
    [TestClass]
    public sealed class CF_00000708C_Centroids_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000708C_Centroids));
        ...
        {
            bool result = CF_00000708C_Centroids.Solution_0_Test(input);
