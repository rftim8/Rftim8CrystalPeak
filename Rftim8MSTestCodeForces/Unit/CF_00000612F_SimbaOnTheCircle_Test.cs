...
{
    [TestClass]
    public sealed class CF_00000612F_SimbaOnTheCircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000612F_SimbaOnTheCircle));
        ...
        {
            bool result = CF_00000612F_SimbaOnTheCircle.Solution_0_Test(input);
