...
{
    [TestClass]
    public sealed class CF_00001729D_FriendsAndTheRestaurant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001729D_FriendsAndTheRestaurant));
        ...
        {
            bool result = CF_00001729D_FriendsAndTheRestaurant.Solution_0_Test(input);
