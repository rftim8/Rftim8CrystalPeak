...
{
    [TestClass]
    public sealed class CF_00000191E_ThwartingDemonstrations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000191E_ThwartingDemonstrations));
        ...
        {
            bool result = CF_00000191E_ThwartingDemonstrations.Solution_0_Test(input);
