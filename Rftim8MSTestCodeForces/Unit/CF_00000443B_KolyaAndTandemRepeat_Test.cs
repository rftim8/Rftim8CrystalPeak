...
{
    [TestClass]
    public sealed class CF_00000443B_KolyaAndTandemRepeat_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000443B_KolyaAndTandemRepeat));
        ...
        {
            bool result = CF_00000443B_KolyaAndTandemRepeat.Solution_0_Test(input);
