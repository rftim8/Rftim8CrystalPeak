...
{
    [TestClass]
    public sealed class CF_00000363B_Fence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000363B_Fence));
        ...
        {
            bool result = CF_00000363B_Fence.Solution_0_Test(input);
