...
{
    [TestClass]
    public sealed class CF_00000575D_Tablecity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000575D_Tablecity));
        ...
        {
            bool result = CF_00000575D_Tablecity.Solution_0_Test(input);
