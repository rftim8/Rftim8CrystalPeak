...
{
    [TestClass]
    public sealed class CF_00000838B_DivergingDirections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000838B_DivergingDirections));
        ...
        {
            bool result = CF_00000838B_DivergingDirections.Solution_0_Test(input);
