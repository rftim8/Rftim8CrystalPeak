...
{
    [TestClass]
    public sealed class CF_00000868B_RaceAgainstTime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000868B_RaceAgainstTime));
        ...
        {
            bool result = CF_00000868B_RaceAgainstTime.Solution_0_Test(input);
