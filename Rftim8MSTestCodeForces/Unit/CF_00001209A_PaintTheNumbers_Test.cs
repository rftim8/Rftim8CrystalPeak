...
{
    [TestClass]
    public sealed class CF_00001209A_PaintTheNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001209A_PaintTheNumbers));
        ...
        {
            bool result = CF_00001209A_PaintTheNumbers.Solution_0_Test(input);
