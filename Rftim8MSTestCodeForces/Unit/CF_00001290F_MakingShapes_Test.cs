...
{
    [TestClass]
    public sealed class CF_00001290F_MakingShapes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001290F_MakingShapes));
        ...
        {
            bool result = CF_00001290F_MakingShapes.Solution_0_Test(input);
