...
{
    [TestClass]
    public sealed class CF_00001846D_RudolphAndChristmasTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001846D_RudolphAndChristmasTree));
        ...
        {
            bool result = CF_00001846D_RudolphAndChristmasTree.Solution_0_Test(input);
