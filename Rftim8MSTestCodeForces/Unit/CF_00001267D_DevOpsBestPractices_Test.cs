...
{
    [TestClass]
    public sealed class CF_00001267D_DevOpsBestPractices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001267D_DevOpsBestPractices));
        ...
        {
            bool result = CF_00001267D_DevOpsBestPractices.Solution_0_Test(input);
