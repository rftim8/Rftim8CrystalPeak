...
{
    [TestClass]
    public sealed class CF_00000380D_SerejaAndCinema_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000380D_SerejaAndCinema));
        ...
        {
            bool result = CF_00000380D_SerejaAndCinema.Solution_0_Test(input);
