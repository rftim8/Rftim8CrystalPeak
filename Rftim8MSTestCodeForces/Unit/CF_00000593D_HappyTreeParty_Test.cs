...
{
    [TestClass]
    public sealed class CF_00000593D_HappyTreeParty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000593D_HappyTreeParty));
        ...
        {
            bool result = CF_00000593D_HappyTreeParty.Solution_0_Test(input);
