...
{
    [TestClass]
    public sealed class CF_00001613F_TreeColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001613F_TreeColoring));
        ...
        {
            bool result = CF_00001613F_TreeColoring.Solution_0_Test(input);
