...
{
    [TestClass]
    public sealed class CF_00001916B_TwoDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001916B_TwoDivisors));
        ...
        {
            bool result = CF_00001916B_TwoDivisors.Solution_0_Test(input);
