...
{
    [TestClass]
    public sealed class CF_00001481A_SpaceNavigation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001481A_SpaceNavigation));
        ...
        {
            bool result = CF_00001481A_SpaceNavigation.Solution_0_Test(input);
