...
{
    [TestClass]
    public sealed class CF_00001609F_InterestingSections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001609F_InterestingSections));
        ...
        {
            bool result = CF_00001609F_InterestingSections.Solution_0_Test(input);
