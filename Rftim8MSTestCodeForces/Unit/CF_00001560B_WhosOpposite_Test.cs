...
{
    [TestClass]
    public sealed class CF_00001560B_WhosOpposite_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001560B_WhosOpposite));
        ...
        {
            bool result = CF_00001560B_WhosOpposite.Solution_0_Test(input);
