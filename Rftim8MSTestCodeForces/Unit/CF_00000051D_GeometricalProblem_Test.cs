...
{
    [TestClass]
    public sealed class CF_00000051D_GeometricalProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000051D_GeometricalProblem));
        ...
        {
            bool result = CF_00000051D_GeometricalProblem.Solution_0_Test(input);
