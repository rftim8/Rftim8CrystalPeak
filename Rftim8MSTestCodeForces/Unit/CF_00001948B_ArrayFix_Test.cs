...
{
    [TestClass]
    public sealed class CF_00001948B_ArrayFix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001948B_ArrayFix));
        ...
        {
            bool result = CF_00001948B_ArrayFix.Solution_0_Test(input);
