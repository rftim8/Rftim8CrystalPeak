...
{
    [TestClass]
    public sealed class CF_00001873B_GoodKid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001873B_GoodKid));
        ...
        {
            bool result = CF_00001873B_GoodKid.Solution_0_Test(input);
