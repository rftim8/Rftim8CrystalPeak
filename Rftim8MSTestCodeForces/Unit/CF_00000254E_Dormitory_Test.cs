...
{
    [TestClass]
    public sealed class CF_00000254E_Dormitory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000254E_Dormitory));
        ...
        {
            bool result = CF_00000254E_Dormitory.Solution_0_Test(input);
