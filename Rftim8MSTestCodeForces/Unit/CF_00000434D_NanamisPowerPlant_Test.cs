...
{
    [TestClass]
    public sealed class CF_00000434D_NanamisPowerPlant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000434D_NanamisPowerPlant));
        ...
        {
            bool result = CF_00000434D_NanamisPowerPlant.Solution_0_Test(input);
