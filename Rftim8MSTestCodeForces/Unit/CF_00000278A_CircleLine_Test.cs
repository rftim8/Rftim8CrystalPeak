...
{
    [TestClass]
    public sealed class CF_00000278A_CircleLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000278A_CircleLine));
        ...
        {
            bool result = CF_00000278A_CircleLine.Solution_0_Test(input);
