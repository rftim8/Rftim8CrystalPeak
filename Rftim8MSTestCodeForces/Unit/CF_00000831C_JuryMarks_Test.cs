...
{
    [TestClass]
    public sealed class CF_00000831C_JuryMarks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000831C_JuryMarks));
        ...
        {
            bool result = CF_00000831C_JuryMarks.Solution_0_Test(input);
