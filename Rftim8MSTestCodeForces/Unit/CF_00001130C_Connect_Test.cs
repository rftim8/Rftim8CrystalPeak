...
{
    [TestClass]
    public sealed class CF_00001130C_Connect_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001130C_Connect));
        ...
        {
            bool result = CF_00001130C_Connect.Solution_0_Test(input);
