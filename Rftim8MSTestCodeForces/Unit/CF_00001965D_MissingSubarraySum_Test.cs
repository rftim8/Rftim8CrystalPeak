...
{
    [TestClass]
    public sealed class CF_00001965D_MissingSubarraySum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001965D_MissingSubarraySum));
        ...
        {
            bool result = CF_00001965D_MissingSubarraySum.Solution_0_Test(input);
