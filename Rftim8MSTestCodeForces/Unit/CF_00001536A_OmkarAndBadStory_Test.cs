...
{
    [TestClass]
    public sealed class CF_00001536A_OmkarAndBadStory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001536A_OmkarAndBadStory));
        ...
        {
            bool result = CF_00001536A_OmkarAndBadStory.Solution_0_Test(input);
