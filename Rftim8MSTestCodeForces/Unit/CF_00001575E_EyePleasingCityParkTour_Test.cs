...
{
    [TestClass]
    public sealed class CF_00001575E_EyePleasingCityParkTour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575E_EyePleasingCityParkTour));
        ...
        {
            bool result = CF_00001575E_EyePleasingCityParkTour.Solution_0_Test(input);
