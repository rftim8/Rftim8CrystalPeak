...
{
    [TestClass]
    public sealed class CF_00000796C_BankHacking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000796C_BankHacking));
        ...
        {
            bool result = CF_00000796C_BankHacking.Solution_0_Test(input);
