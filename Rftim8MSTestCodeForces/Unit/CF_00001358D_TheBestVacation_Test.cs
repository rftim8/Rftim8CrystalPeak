...
{
    [TestClass]
    public sealed class CF_00001358D_TheBestVacation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001358D_TheBestVacation));
        ...
        {
            bool result = CF_00001358D_TheBestVacation.Solution_0_Test(input);
