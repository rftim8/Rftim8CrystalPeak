...
{
    [TestClass]
    public sealed class CF_00001200D_WhiteLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001200D_WhiteLines));
        ...
        {
            bool result = CF_00001200D_WhiteLines.Solution_0_Test(input);
