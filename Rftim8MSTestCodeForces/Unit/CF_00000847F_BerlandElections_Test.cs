...
{
    [TestClass]
    public sealed class CF_00000847F_BerlandElections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847F_BerlandElections));
        ...
        {
            bool result = CF_00000847F_BerlandElections.Solution_0_Test(input);
