...
{
    [TestClass]
    public sealed class CF_00000051B_BHTMLTablesAnalisys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000051B_BHTMLTablesAnalisys));
        ...
        {
            bool result = CF_00000051B_BHTMLTablesAnalisys.Solution_0_Test(input);
