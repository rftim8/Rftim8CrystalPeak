...
{
    [TestClass]
    public sealed class CF_00001486B_EasternExhibition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001486B_EasternExhibition));
        ...
        {
            bool result = CF_00001486B_EasternExhibition.Solution_0_Test(input);
