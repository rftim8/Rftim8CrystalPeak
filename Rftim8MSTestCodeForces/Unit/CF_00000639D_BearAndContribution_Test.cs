...
{
    [TestClass]
    public sealed class CF_00000639D_BearAndContribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000639D_BearAndContribution));
        ...
        {
            bool result = CF_00000639D_BearAndContribution.Solution_0_Test(input);
