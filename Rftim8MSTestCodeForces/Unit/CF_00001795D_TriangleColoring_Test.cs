...
{
    [TestClass]
    public sealed class CF_00001795D_TriangleColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001795D_TriangleColoring));
        ...
        {
            bool result = CF_00001795D_TriangleColoring.Solution_0_Test(input);
