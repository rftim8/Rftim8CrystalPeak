...
{
    [TestClass]
    public sealed class CF_00002004A_ClosestPoint_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002004A_ClosestPoint));
        ...
        {
            bool result = CF_00002004A_ClosestPoint.Solution_0_Test(input);
