...
{
    [TestClass]
    public sealed class CF_00001763E_NodePairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001763E_NodePairs));
        ...
        {
            bool result = CF_00001763E_NodePairs.Solution_0_Test(input);
