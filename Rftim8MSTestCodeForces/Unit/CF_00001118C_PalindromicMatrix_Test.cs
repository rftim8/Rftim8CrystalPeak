...
{
    [TestClass]
    public sealed class CF_00001118C_PalindromicMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001118C_PalindromicMatrix));
        ...
        {
            bool result = CF_00001118C_PalindromicMatrix.Solution_0_Test(input);
