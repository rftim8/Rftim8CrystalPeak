...
{
    [TestClass]
    public sealed class CF_00000555A_CaseOfMatryoshkas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000555A_CaseOfMatryoshkas));
        ...
        {
            bool result = CF_00000555A_CaseOfMatryoshkas.Solution_0_Test(input);
