...
{
    [TestClass]
    public sealed class CF_00000620A_ProfessorGukiZsRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000620A_ProfessorGukiZsRobot));
        ...
        {
            bool result = CF_00000620A_ProfessorGukiZsRobot.Solution_0_Test(input);
