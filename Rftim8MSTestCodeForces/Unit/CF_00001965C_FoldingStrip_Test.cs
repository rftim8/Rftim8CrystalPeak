...
{
    [TestClass]
    public sealed class CF_00001965C_FoldingStrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001965C_FoldingStrip));
        ...
        {
            bool result = CF_00001965C_FoldingStrip.Solution_0_Test(input);
