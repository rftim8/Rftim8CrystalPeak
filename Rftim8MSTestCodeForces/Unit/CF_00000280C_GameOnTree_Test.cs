...
{
    [TestClass]
    public sealed class CF_00000280C_GameOnTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000280C_GameOnTree));
        ...
        {
            bool result = CF_00000280C_GameOnTree.Solution_0_Test(input);
