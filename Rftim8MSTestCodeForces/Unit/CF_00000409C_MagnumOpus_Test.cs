...
{
    [TestClass]
    public sealed class CF_00000409C_MagnumOpus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000409C_MagnumOpus));
        ...
        {
            bool result = CF_00000409C_MagnumOpus.Solution_0_Test(input);
