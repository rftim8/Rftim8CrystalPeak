...
{
    [TestClass]
    public sealed class CF_00000730B_MinimumAndMaximum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730B_MinimumAndMaximum));
        ...
        {
            bool result = CF_00000730B_MinimumAndMaximum.Solution_0_Test(input);
