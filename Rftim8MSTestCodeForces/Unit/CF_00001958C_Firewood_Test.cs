...
{
    [TestClass]
    public sealed class CF_00001958C_Firewood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001958C_Firewood));
        ...
        {
            bool result = CF_00001958C_Firewood.Solution_0_Test(input);
