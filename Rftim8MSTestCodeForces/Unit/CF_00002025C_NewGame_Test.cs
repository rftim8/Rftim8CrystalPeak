...
{
    [TestClass]
    public sealed class CF_00002025C_NewGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002025C_NewGame));
        ...
        {
            bool result = CF_00002025C_NewGame.Solution_0_Test(input);
