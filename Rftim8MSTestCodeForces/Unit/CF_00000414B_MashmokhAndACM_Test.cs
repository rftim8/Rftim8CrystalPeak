...
{
    [TestClass]
    public sealed class CF_00000414B_MashmokhAndACM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000414B_MashmokhAndACM));
        ...
        {
            bool result = CF_00000414B_MashmokhAndACM.Solution_0_Test(input);
