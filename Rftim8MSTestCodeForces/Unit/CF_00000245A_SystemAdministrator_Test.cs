...
{
    [TestClass]
    public sealed class CF_00000245A_SystemAdministrator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000245A_SystemAdministrator));
        ...
        {
            bool result = CF_00000245A_SystemAdministrator.Solution_0_Test(input);
