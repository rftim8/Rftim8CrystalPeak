...
{
    [TestClass]
    public sealed class CF_00001418G_ThreeOccurrences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001418G_ThreeOccurrences));
        ...
        {
            bool result = CF_00001418G_ThreeOccurrences.Solution_0_Test(input);
