...
{
    [TestClass]
    public sealed class CF_00000605B_LazyStudent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000605B_LazyStudent));
        ...
        {
            bool result = CF_00000605B_LazyStudent.Solution_0_Test(input);
