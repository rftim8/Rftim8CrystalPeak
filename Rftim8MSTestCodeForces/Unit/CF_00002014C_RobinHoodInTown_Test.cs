...
{
    [TestClass]
    public sealed class CF_00002014C_RobinHoodInTown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002014C_RobinHoodInTown));
        ...
        {
            bool result = CF_00002014C_RobinHoodInTown.Solution_0_Test(input);
