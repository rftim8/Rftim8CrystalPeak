...
{
    [TestClass]
    public sealed class CF_00001443C_TheDeliveryDilemma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001443C_TheDeliveryDilemma));
        ...
        {
            bool result = CF_00001443C_TheDeliveryDilemma.Solution_0_Test(input);
