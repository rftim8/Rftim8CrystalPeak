...
{
    [TestClass]
    public sealed class CF_00000378B_Semifinals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000378B_Semifinals));
        ...
        {
            bool result = CF_00000378B_Semifinals.Solution_0_Test(input);
