...
{
    [TestClass]
    public sealed class CF_00002042A_GreedyMonocarp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002042A_GreedyMonocarp));
        ...
        {
            bool result = CF_00002042A_GreedyMonocarp.Solution_0_Test(input);
