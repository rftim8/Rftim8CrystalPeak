...
{
    [TestClass]
    public sealed class CF_00000843B_InteractiveLowerBound_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000843B_InteractiveLowerBound));
        ...
        {
            bool result = CF_00000843B_InteractiveLowerBound.Solution_0_Test(input);
