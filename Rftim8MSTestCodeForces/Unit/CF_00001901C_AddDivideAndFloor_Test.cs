...
{
    [TestClass]
    public sealed class CF_00001901C_AddDivideAndFloor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001901C_AddDivideAndFloor));
        ...
        {
            bool result = CF_00001901C_AddDivideAndFloor.Solution_0_Test(input);
