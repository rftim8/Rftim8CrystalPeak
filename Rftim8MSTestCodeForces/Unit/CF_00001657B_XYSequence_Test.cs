...
{
    [TestClass]
    public sealed class CF_00001657B_XYSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001657B_XYSequence));
        ...
        {
            bool result = CF_00001657B_XYSequence.Solution_0_Test(input);
