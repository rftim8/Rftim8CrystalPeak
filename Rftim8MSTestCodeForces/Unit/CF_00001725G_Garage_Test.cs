...
{
    [TestClass]
    public sealed class CF_00001725G_Garage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725G_Garage));
        ...
        {
            bool result = CF_00001725G_Garage.Solution_0_Test(input);
