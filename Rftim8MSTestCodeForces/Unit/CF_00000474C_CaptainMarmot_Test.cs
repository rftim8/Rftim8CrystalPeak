...
{
    [TestClass]
    public sealed class CF_00000474C_CaptainMarmot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000474C_CaptainMarmot));
        ...
        {
            bool result = CF_00000474C_CaptainMarmot.Solution_0_Test(input);
