...
{
    [TestClass]
    public sealed class CF_00001997F_ChipsOnALine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001997F_ChipsOnALine));
        ...
        {
            bool result = CF_00001997F_ChipsOnALine.Solution_0_Test(input);
