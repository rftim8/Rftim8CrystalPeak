...
{
    [TestClass]
    public sealed class CF_00000875B_SortingTheCoins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000875B_SortingTheCoins));
        ...
        {
            bool result = CF_00000875B_SortingTheCoins.Solution_0_Test(input);
