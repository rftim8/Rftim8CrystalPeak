...
{
    [TestClass]
    public sealed class CF_00001730E_MaximumsAndMinimums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001730E_MaximumsAndMinimums));
        ...
        {
            bool result = CF_00001730E_MaximumsAndMinimums.Solution_0_Test(input);
