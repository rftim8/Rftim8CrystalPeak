...
{
    [TestClass]
    public sealed class CF_00000855C_HelgaHufflepuffsCup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000855C_HelgaHufflepuffsCup));
        ...
        {
            bool result = CF_00000855C_HelgaHufflepuffsCup.Solution_0_Test(input);
