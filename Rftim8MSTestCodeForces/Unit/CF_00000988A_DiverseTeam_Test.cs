...
{
    [TestClass]
    public sealed class CF_00000988A_DiverseTeam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000988A_DiverseTeam));
        ...
        {
            bool result = CF_00000988A_DiverseTeam.Solution_0_Test(input);
