...
{
    [TestClass]
    public sealed class CF_00001592E_BoredBakry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001592E_BoredBakry));
        ...
        {
            bool result = CF_00001592E_BoredBakry.Solution_0_Test(input);
