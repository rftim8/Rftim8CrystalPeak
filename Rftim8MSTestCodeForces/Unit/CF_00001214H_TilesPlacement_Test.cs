...
{
    [TestClass]
    public sealed class CF_00001214H_TilesPlacement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001214H_TilesPlacement));
        ...
        {
            bool result = CF_00001214H_TilesPlacement.Solution_0_Test(input);
