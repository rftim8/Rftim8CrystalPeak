...
{
    [TestClass]
    public sealed class CF_00000187A_Permutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000187A_Permutations));
        ...
        {
            bool result = CF_00000187A_Permutations.Solution_0_Test(input);
