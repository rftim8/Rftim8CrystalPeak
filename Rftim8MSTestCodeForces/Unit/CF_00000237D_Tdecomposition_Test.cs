...
{
    [TestClass]
    public sealed class CF_00000237D_Tdecomposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000237D_Tdecomposition));
        ...
        {
            bool result = CF_00000237D_Tdecomposition.Solution_0_Test(input);
