...
{
    [TestClass]
    public sealed class CF_00001648B_IntegralArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001648B_IntegralArray));
        ...
        {
            bool result = CF_00001648B_IntegralArray.Solution_0_Test(input);
