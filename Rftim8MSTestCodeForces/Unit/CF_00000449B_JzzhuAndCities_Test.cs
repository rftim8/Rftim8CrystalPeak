...
{
    [TestClass]
    public sealed class CF_00000449B_JzzhuAndCities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000449B_JzzhuAndCities));
        ...
        {
            bool result = CF_00000449B_JzzhuAndCities.Solution_0_Test(input);
