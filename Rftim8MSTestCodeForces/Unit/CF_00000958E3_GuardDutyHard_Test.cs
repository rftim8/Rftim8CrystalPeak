...
{
    [TestClass]
    public sealed class CF_00000958E3_GuardDutyHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958E3_GuardDutyHard));
        ...
        {
            bool result = CF_00000958E3_GuardDutyHard.Solution_0_Test(input);
