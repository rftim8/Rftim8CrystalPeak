...
{
    [TestClass]
    public sealed class CF_00001517G_StarryNightCamping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001517G_StarryNightCamping));
        ...
        {
            bool result = CF_00001517G_StarryNightCamping.Solution_0_Test(input);
