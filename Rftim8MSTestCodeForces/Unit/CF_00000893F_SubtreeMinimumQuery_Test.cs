...
{
    [TestClass]
    public sealed class CF_00000893F_SubtreeMinimumQuery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000893F_SubtreeMinimumQuery));
        ...
        {
            bool result = CF_00000893F_SubtreeMinimumQuery.Solution_0_Test(input);
