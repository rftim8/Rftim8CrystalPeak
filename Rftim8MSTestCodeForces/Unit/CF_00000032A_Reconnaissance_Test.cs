...
{
    [TestClass]
    public sealed class CF_00000032A_Reconnaissance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000032A_Reconnaissance));
        ...
        {
            bool result = CF_00000032A_Reconnaissance.Solution_0_Test(input);
