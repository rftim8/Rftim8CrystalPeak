...
{
    [TestClass]
    public sealed class CF_00001488G_PaintingNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001488G_PaintingNumbers));
        ...
        {
            bool result = CF_00001488G_PaintingNumbers.Solution_0_Test(input);
