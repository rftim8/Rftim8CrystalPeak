...
{
    [TestClass]
    public sealed class CF_00001178D_PrimeGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001178D_PrimeGraph));
        ...
        {
            bool result = CF_00001178D_PrimeGraph.Solution_0_Test(input);
