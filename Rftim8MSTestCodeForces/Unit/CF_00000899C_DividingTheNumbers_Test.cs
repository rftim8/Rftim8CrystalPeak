...
{
    [TestClass]
    public sealed class CF_00000899C_DividingTheNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000899C_DividingTheNumbers));
        ...
        {
            bool result = CF_00000899C_DividingTheNumbers.Solution_0_Test(input);
