...
{
    [TestClass]
    public sealed class CF_00001627C_NotAssigning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001627C_NotAssigning));
        ...
        {
            bool result = CF_00001627C_NotAssigning.Solution_0_Test(input);
