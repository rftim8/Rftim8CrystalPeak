...
{
    [TestClass]
    public sealed class CF_00000975B_Mancala_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000975B_Mancala));
        ...
        {
            bool result = CF_00000975B_Mancala.Solution_0_Test(input);
