...
{
    [TestClass]
    public sealed class CF_00001183D_CandyBoxEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001183D_CandyBoxEasyVersion));
        ...
        {
            bool result = CF_00001183D_CandyBoxEasyVersion.Solution_0_Test(input);
