...
{
    [TestClass]
    public sealed class CF_00001142D_Foreigner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001142D_Foreigner));
        ...
        {
            bool result = CF_00001142D_Foreigner.Solution_0_Test(input);
