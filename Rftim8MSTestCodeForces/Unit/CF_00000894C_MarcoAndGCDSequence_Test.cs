...
{
    [TestClass]
    public sealed class CF_00000894C_MarcoAndGCDSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000894C_MarcoAndGCDSequence));
        ...
        {
            bool result = CF_00000894C_MarcoAndGCDSequence.Solution_0_Test(input);
