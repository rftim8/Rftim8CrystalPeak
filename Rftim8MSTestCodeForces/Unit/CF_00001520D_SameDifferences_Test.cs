...
{
    [TestClass]
    public sealed class CF_00001520D_SameDifferences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001520D_SameDifferences));
        ...
        {
            bool result = CF_00001520D_SameDifferences.Solution_0_Test(input);
