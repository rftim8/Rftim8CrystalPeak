...
{
    [TestClass]
    public sealed class CF_00000089C_ChipPlay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000089C_ChipPlay));
        ...
        {
            bool result = CF_00000089C_ChipPlay.Solution_0_Test(input);
