...
{
    [TestClass]
    public sealed class CF_00001495D_BFSTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001495D_BFSTrees));
        ...
        {
            bool result = CF_00001495D_BFSTrees.Solution_0_Test(input);
