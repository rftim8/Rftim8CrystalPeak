...
{
    [TestClass]
    public sealed class CF_00001004E_SonyaAndIceCream_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001004E_SonyaAndIceCream));
        ...
        {
            bool result = CF_00001004E_SonyaAndIceCream.Solution_0_Test(input);
