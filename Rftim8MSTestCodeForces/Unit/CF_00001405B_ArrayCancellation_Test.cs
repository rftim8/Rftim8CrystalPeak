...
{
    [TestClass]
    public sealed class CF_00001405B_ArrayCancellation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001405B_ArrayCancellation));
        ...
        {
            bool result = CF_00001405B_ArrayCancellation.Solution_0_Test(input);
