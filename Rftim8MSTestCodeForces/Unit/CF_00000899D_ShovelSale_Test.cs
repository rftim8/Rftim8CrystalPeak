...
{
    [TestClass]
    public sealed class CF_00000899D_ShovelSale_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000899D_ShovelSale));
        ...
        {
            bool result = CF_00000899D_ShovelSale.Solution_0_Test(input);
