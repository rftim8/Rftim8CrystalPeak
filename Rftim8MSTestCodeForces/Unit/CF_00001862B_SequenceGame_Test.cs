...
{
    [TestClass]
    public sealed class CF_00001862B_SequenceGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001862B_SequenceGame));
        ...
        {
            bool result = CF_00001862B_SequenceGame.Solution_0_Test(input);
