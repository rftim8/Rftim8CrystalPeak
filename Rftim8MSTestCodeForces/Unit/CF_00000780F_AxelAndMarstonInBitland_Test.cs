...
{
    [TestClass]
    public sealed class CF_00000780F_AxelAndMarstonInBitland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000780F_AxelAndMarstonInBitland));
        ...
        {
            bool result = CF_00000780F_AxelAndMarstonInBitland.Solution_0_Test(input);
