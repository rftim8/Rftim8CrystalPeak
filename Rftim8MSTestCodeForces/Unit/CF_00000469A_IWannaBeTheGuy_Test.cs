...
{
    [TestClass]
    public sealed class CF_00000469A_IWannaBeTheGuy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000469A_IWannaBeTheGuy));
        ...
        {
            bool result = CF_00000469A_IWannaBeTheGuy.Solution_0_Test(input);
