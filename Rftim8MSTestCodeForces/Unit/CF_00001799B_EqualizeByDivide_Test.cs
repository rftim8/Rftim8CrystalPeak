...
{
    [TestClass]
    public sealed class CF_00001799B_EqualizeByDivide_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001799B_EqualizeByDivide));
        ...
        {
            bool result = CF_00001799B_EqualizeByDivide.Solution_0_Test(input);
