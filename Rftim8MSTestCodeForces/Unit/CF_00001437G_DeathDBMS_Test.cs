...
{
    [TestClass]
    public sealed class CF_00001437G_DeathDBMS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001437G_DeathDBMS));
        ...
        {
            bool result = CF_00001437G_DeathDBMS.Solution_0_Test(input);
