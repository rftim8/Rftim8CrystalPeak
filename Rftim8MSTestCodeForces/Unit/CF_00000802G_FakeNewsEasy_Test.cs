...
{
    [TestClass]
    public sealed class CF_00000802G_FakeNewsEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802G_FakeNewsEasy));
        ...
        {
            bool result = CF_00000802G_FakeNewsEasy.Solution_0_Test(input);
