...
{
    [TestClass]
    public sealed class CF_00001733A_ConsecutiveSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001733A_ConsecutiveSum));
        ...
        {
            bool result = CF_00001733A_ConsecutiveSum.Solution_0_Test(input);
