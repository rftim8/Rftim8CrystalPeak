...
{
    [TestClass]
    public sealed class CF_00001907F_ShiftAndReverse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001907F_ShiftAndReverse));
        ...
        {
            bool result = CF_00001907F_ShiftAndReverse.Solution_0_Test(input);
