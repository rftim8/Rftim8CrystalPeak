...
{
    [TestClass]
    public sealed class CF_00000676B_PyramidOfGlasses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000676B_PyramidOfGlasses));
        ...
        {
            bool result = CF_00000676B_PyramidOfGlasses.Solution_0_Test(input);
