...
{
    [TestClass]
    public sealed class CF_00000666E_ForensicExamination_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000666E_ForensicExamination));
        ...
        {
            bool result = CF_00000666E_ForensicExamination.Solution_0_Test(input);
