...
{
    [TestClass]
    public sealed class CF_00001106D_LunarNewYearAndAWander_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001106D_LunarNewYearAndAWander));
        ...
        {
            bool result = CF_00001106D_LunarNewYearAndAWander.Solution_0_Test(input);
