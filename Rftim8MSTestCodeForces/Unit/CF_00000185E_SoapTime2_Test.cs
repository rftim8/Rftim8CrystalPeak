...
{
    [TestClass]
    public sealed class CF_00000185E_SoapTime2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000185E_SoapTime2));
        ...
        {
            bool result = CF_00000185E_SoapTime2.Solution_0_Test(input);
