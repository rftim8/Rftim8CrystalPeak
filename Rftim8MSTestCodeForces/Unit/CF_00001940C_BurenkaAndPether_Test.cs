...
{
    [TestClass]
    public sealed class CF_00001940C_BurenkaAndPether_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001940C_BurenkaAndPether));
        ...
        {
            bool result = CF_00001940C_BurenkaAndPether.Solution_0_Test(input);
