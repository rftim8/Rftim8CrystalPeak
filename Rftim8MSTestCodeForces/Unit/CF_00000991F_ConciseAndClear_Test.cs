...
{
    [TestClass]
    public sealed class CF_00000991F_ConciseAndClear_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000991F_ConciseAndClear));
        ...
        {
            bool result = CF_00000991F_ConciseAndClear.Solution_0_Test(input);
