...
{
    [TestClass]
    public sealed class CF_00000595B_PashaAndPhone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000595B_PashaAndPhone));
        ...
        {
            bool result = CF_00000595B_PashaAndPhone.Solution_0_Test(input);
