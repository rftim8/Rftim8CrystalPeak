...
{
    [TestClass]
    public sealed class CF_00001491I_RulerOfTheZoo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001491I_RulerOfTheZoo));
        ...
        {
            bool result = CF_00001491I_RulerOfTheZoo.Solution_0_Test(input);
