...
{
    [TestClass]
    public sealed class CF_00000683G_TheFraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000683G_TheFraction));
        ...
        {
            bool result = CF_00000683G_TheFraction.Solution_0_Test(input);
