...
{
    [TestClass]
    public sealed class CF_00001225A_ForgettingThings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001225A_ForgettingThings));
        ...
        {
            bool result = CF_00001225A_ForgettingThings.Solution_0_Test(input);
