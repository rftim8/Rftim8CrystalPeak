...
{
    [TestClass]
    public sealed class CF_00000796B_FindTheBone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000796B_FindTheBone));
        ...
        {
            bool result = CF_00000796B_FindTheBone.Solution_0_Test(input);
