...
{
    [TestClass]
    public sealed class CF_00002037D_SharkySurfing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002037D_SharkySurfing));
        ...
        {
            bool result = CF_00002037D_SharkySurfing.Solution_0_Test(input);
