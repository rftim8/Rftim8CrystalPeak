...
{
    [TestClass]
    public sealed class CF_00001770B_KoxiaAndPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001770B_KoxiaAndPermutation));
        ...
        {
            bool result = CF_00001770B_KoxiaAndPermutation.Solution_0_Test(input);
