...
{
    [TestClass]
    public sealed class CF_00000048B_LandLot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000048B_LandLot));
        ...
        {
            bool result = CF_00000048B_LandLot.Solution_0_Test(input);
