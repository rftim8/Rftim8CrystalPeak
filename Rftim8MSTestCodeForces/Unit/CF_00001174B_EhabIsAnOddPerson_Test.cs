...
{
    [TestClass]
    public sealed class CF_00001174B_EhabIsAnOddPerson_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001174B_EhabIsAnOddPerson));
        ...
        {
            bool result = CF_00001174B_EhabIsAnOddPerson.Solution_0_Test(input);
