...
{
    [TestClass]
    public sealed class CF_00001929D_SashaAndAWalkInTheCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001929D_SashaAndAWalkInTheCity));
        ...
        {
            bool result = CF_00001929D_SashaAndAWalkInTheCity.Solution_0_Test(input);
