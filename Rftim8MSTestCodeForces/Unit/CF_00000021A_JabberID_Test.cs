...
{
    [TestClass]
    public sealed class CF_00000021A_JabberID_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000021A_JabberID));
        ...
        {
            bool result = CF_00000021A_JabberID.Solution_0_Test(input);
