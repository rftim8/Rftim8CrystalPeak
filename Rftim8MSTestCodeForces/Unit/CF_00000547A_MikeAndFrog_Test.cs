...
{
    [TestClass]
    public sealed class CF_00000547A_MikeAndFrog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000547A_MikeAndFrog));
        ...
        {
            bool result = CF_00000547A_MikeAndFrog.Solution_0_Test(input);
