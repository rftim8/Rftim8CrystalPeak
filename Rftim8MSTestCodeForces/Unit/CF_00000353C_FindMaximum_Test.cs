...
{
    [TestClass]
    public sealed class CF_00000353C_FindMaximum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000353C_FindMaximum));
        ...
        {
            bool result = CF_00000353C_FindMaximum.Solution_0_Test(input);
