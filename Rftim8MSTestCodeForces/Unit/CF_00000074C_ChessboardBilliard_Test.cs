...
{
    [TestClass]
    public sealed class CF_00000074C_ChessboardBilliard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000074C_ChessboardBilliard));
        ...
        {
            bool result = CF_00000074C_ChessboardBilliard.Solution_0_Test(input);
