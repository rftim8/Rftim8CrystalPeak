...
{
    [TestClass]
    public sealed class CF_00001779C_LeastPrefixSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001779C_LeastPrefixSum));
        ...
        {
            bool result = CF_00001779C_LeastPrefixSum.Solution_0_Test(input);
