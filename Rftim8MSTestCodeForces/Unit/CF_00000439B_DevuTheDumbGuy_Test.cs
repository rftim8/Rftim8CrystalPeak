...
{
    [TestClass]
    public sealed class CF_00000439B_DevuTheDumbGuy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000439B_DevuTheDumbGuy));
        ...
        {
            bool result = CF_00000439B_DevuTheDumbGuy.Solution_0_Test(input);
