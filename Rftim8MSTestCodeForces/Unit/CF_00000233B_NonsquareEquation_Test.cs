...
{
    [TestClass]
    public sealed class CF_00000233B_NonsquareEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000233B_NonsquareEquation));
        ...
        {
            bool result = CF_00000233B_NonsquareEquation.Solution_0_Test(input);
