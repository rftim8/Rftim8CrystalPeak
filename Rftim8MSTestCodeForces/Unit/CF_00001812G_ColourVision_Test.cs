...
{
    [TestClass]
    public sealed class CF_00001812G_ColourVision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001812G_ColourVision));
        ...
        {
            bool result = CF_00001812G_ColourVision.Solution_0_Test(input);
