...
{
    [TestClass]
    public sealed class CF_00000992A_NastyaAndAnArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000992A_NastyaAndAnArray));
        ...
        {
            bool result = CF_00000992A_NastyaAndAnArray.Solution_0_Test(input);
