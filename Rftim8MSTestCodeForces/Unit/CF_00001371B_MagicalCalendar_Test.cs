...
{
    [TestClass]
    public sealed class CF_00001371B_MagicalCalendar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001371B_MagicalCalendar));
        ...
        {
            bool result = CF_00001371B_MagicalCalendar.Solution_0_Test(input);
