...
{
    [TestClass]
    public sealed class CF_00001921B_ArrangingCats_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001921B_ArrangingCats));
        ...
        {
            bool result = CF_00001921B_ArrangingCats.Solution_0_Test(input);
