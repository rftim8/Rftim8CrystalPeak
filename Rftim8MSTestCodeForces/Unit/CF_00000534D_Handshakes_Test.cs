...
{
    [TestClass]
    public sealed class CF_00000534D_Handshakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000534D_Handshakes));
        ...
        {
            bool result = CF_00000534D_Handshakes.Solution_0_Test(input);
