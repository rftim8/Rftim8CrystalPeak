...
{
    [TestClass]
    public sealed class CF_00000178B1_GreedyMerchants_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000178B1_GreedyMerchants));
        ...
        {
            bool result = CF_00000178B1_GreedyMerchants.Solution_0_Test(input);
