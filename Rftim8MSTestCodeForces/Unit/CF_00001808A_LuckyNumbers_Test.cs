...
{
    [TestClass]
    public sealed class CF_00001808A_LuckyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001808A_LuckyNumbers));
        ...
        {
            bool result = CF_00001808A_LuckyNumbers.Solution_0_Test(input);
