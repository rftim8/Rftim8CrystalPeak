...
{
    [TestClass]
    public sealed class CF_00001969E_UniqueArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001969E_UniqueArray));
        ...
        {
            bool result = CF_00001969E_UniqueArray.Solution_0_Test(input);
