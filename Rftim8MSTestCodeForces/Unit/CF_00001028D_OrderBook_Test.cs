...
{
    [TestClass]
    public sealed class CF_00001028D_OrderBook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001028D_OrderBook));
        ...
        {
            bool result = CF_00001028D_OrderBook.Solution_0_Test(input);
