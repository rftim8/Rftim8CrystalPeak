...
{
    [TestClass]
    public sealed class CF_00000091C_SkiBase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000091C_SkiBase));
        ...
        {
            bool result = CF_00000091C_SkiBase.Solution_0_Test(input);
