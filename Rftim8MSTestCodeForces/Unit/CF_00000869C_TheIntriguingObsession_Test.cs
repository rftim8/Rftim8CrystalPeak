...
{
    [TestClass]
    public sealed class CF_00000869C_TheIntriguingObsession_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000869C_TheIntriguingObsession));
        ...
        {
            bool result = CF_00000869C_TheIntriguingObsession.Solution_0_Test(input);
