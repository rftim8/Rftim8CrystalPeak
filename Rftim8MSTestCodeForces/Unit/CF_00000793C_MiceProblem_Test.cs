...
{
    [TestClass]
    public sealed class CF_00000793C_MiceProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000793C_MiceProblem));
        ...
        {
            bool result = CF_00000793C_MiceProblem.Solution_0_Test(input);
