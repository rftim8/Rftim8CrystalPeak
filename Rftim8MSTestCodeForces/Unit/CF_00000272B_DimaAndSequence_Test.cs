...
{
    [TestClass]
    public sealed class CF_00000272B_DimaAndSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000272B_DimaAndSequence));
        ...
        {
            bool result = CF_00000272B_DimaAndSequence.Solution_0_Test(input);
