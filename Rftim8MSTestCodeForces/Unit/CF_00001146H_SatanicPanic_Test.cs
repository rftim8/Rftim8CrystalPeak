...
{
    [TestClass]
    public sealed class CF_00001146H_SatanicPanic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001146H_SatanicPanic));
        ...
        {
            bool result = CF_00001146H_SatanicPanic.Solution_0_Test(input);
