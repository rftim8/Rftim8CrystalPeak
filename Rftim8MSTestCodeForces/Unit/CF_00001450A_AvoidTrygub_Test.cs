...
{
    [TestClass]
    public sealed class CF_00001450A_AvoidTrygub_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001450A_AvoidTrygub));
        ...
        {
            bool result = CF_00001450A_AvoidTrygub.Solution_0_Test(input);
