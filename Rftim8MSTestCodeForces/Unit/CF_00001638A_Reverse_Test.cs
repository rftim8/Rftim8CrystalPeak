...
{
    [TestClass]
    public sealed class CF_00001638A_Reverse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001638A_Reverse));
        ...
        {
            bool result = CF_00001638A_Reverse.Solution_0_Test(input);
