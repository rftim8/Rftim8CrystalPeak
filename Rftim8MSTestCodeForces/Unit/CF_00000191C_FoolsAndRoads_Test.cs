...
{
    [TestClass]
    public sealed class CF_00000191C_FoolsAndRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000191C_FoolsAndRoads));
        ...
        {
            bool result = CF_00000191C_FoolsAndRoads.Solution_0_Test(input);
