...
{
    [TestClass]
    public sealed class CF_00001279C_StackOfPresents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001279C_StackOfPresents));
        ...
        {
            bool result = CF_00001279C_StackOfPresents.Solution_0_Test(input);
