...
{
    [TestClass]
    public sealed class CF_00000142D_HelpShrekAndDonkey2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000142D_HelpShrekAndDonkey2));
        ...
        {
            bool result = CF_00000142D_HelpShrekAndDonkey2.Solution_0_Test(input);
