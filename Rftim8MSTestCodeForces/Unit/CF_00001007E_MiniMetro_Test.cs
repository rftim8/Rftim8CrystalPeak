...
{
    [TestClass]
    public sealed class CF_00001007E_MiniMetro_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001007E_MiniMetro));
        ...
        {
            bool result = CF_00001007E_MiniMetro.Solution_0_Test(input);
