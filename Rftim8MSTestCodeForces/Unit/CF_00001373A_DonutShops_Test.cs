...
{
    [TestClass]
    public sealed class CF_00001373A_DonutShops_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001373A_DonutShops));
        ...
        {
            bool result = CF_00001373A_DonutShops.Solution_0_Test(input);
