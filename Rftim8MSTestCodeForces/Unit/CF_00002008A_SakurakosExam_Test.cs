...
{
    [TestClass]
    public sealed class CF_00002008A_SakurakosExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002008A_SakurakosExam));
        ...
        {
            bool result = CF_00002008A_SakurakosExam.Solution_0_Test(input);
