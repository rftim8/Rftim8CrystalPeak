...
{
    [TestClass]
    public sealed class CF_00001043C_SmallestWord_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001043C_SmallestWord));
        ...
        {
            bool result = CF_00001043C_SmallestWord.Solution_0_Test(input);
