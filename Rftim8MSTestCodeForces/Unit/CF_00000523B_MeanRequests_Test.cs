...
{
    [TestClass]
    public sealed class CF_00000523B_MeanRequests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000523B_MeanRequests));
        ...
        {
            bool result = CF_00000523B_MeanRequests.Solution_0_Test(input);
