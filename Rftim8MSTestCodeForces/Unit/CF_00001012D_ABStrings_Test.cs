...
{
    [TestClass]
    public sealed class CF_00001012D_ABStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001012D_ABStrings));
        ...
        {
            bool result = CF_00001012D_ABStrings.Solution_0_Test(input);
