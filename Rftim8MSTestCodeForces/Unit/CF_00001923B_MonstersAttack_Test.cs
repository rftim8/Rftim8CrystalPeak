...
{
    [TestClass]
    public sealed class CF_00001923B_MonstersAttack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001923B_MonstersAttack));
        ...
        {
            bool result = CF_00001923B_MonstersAttack.Solution_0_Test(input);
