...
{
    [TestClass]
    public sealed class CF_00000815C_KarenAndSupermarket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000815C_KarenAndSupermarket));
        ...
        {
            bool result = CF_00000815C_KarenAndSupermarket.Solution_0_Test(input);
