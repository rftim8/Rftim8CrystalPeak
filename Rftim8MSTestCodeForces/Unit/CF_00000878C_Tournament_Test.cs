...
{
    [TestClass]
    public sealed class CF_00000878C_Tournament_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000878C_Tournament));
        ...
        {
            bool result = CF_00000878C_Tournament.Solution_0_Test(input);
