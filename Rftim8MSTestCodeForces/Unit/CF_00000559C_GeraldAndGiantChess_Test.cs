...
{
    [TestClass]
    public sealed class CF_00000559C_GeraldAndGiantChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000559C_GeraldAndGiantChess));
        ...
        {
            bool result = CF_00000559C_GeraldAndGiantChess.Solution_0_Test(input);
