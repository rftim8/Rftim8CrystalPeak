...
{
    [TestClass]
    public sealed class CF_00000452C_MagicTrick_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000452C_MagicTrick));
        ...
        {
            bool result = CF_00000452C_MagicTrick.Solution_0_Test(input);
