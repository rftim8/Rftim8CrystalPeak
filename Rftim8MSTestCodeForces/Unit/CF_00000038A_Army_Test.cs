...
{
    [TestClass]
    public sealed class CF_00000038A_Army_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000038A_Army));
        ...
        {
            bool result = CF_00000038A_Army.Solution_0_Test(input);
