...
{
    [TestClass]
    public sealed class CF_00002036D_ILove1543_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002036D_ILove1543));
        ...
        {
            bool result = CF_00002036D_ILove1543.Solution_0_Test(input);
