...
{
    [TestClass]
    public sealed class CF_00001791E_NegativesAndPositives_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001791E_NegativesAndPositives));
        ...
        {
            bool result = CF_00001791E_NegativesAndPositives.Solution_0_Test(input);
