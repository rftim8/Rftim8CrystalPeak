...
{
    [TestClass]
    public sealed class CF_00001093G_MultidimensionalQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001093G_MultidimensionalQueries));
        ...
        {
            bool result = CF_00001093G_MultidimensionalQueries.Solution_0_Test(input);
