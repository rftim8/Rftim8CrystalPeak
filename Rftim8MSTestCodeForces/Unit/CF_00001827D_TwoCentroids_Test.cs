...
{
    [TestClass]
    public sealed class CF_00001827D_TwoCentroids_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001827D_TwoCentroids));
        ...
        {
            bool result = CF_00001827D_TwoCentroids.Solution_0_Test(input);
