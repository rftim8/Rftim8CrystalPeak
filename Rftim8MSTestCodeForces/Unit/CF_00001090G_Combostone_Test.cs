...
{
    [TestClass]
    public sealed class CF_00001090G_Combostone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090G_Combostone));
        ...
        {
            bool result = CF_00001090G_Combostone.Solution_0_Test(input);
