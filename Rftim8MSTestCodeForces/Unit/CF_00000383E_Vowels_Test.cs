...
{
    [TestClass]
    public sealed class CF_00000383E_Vowels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000383E_Vowels));
        ...
        {
            bool result = CF_00000383E_Vowels.Solution_0_Test(input);
