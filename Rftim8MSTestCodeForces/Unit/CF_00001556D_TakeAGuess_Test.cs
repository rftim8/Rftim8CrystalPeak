...
{
    [TestClass]
    public sealed class CF_00001556D_TakeAGuess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001556D_TakeAGuess));
        ...
        {
            bool result = CF_00001556D_TakeAGuess.Solution_0_Test(input);
