...
{
    [TestClass]
    public sealed class CF_00000134B_PairsOfNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000134B_PairsOfNumbers));
        ...
        {
            bool result = CF_00000134B_PairsOfNumbers.Solution_0_Test(input);
