...
{
    [TestClass]
    public sealed class CF_00000445A_DZYLovesChessboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000445A_DZYLovesChessboard));
        ...
        {
            bool result = CF_00000445A_DZYLovesChessboard.Solution_0_Test(input);
