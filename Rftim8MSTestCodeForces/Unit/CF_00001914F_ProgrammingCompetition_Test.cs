...
{
    [TestClass]
    public sealed class CF_00001914F_ProgrammingCompetition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001914F_ProgrammingCompetition));
        ...
        {
            bool result = CF_00001914F_ProgrammingCompetition.Solution_0_Test(input);
