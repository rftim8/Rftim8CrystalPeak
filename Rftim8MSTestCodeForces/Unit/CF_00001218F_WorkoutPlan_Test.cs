...
{
    [TestClass]
    public sealed class CF_00001218F_WorkoutPlan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001218F_WorkoutPlan));
        ...
        {
            bool result = CF_00001218F_WorkoutPlan.Solution_0_Test(input);
