...
{
    [TestClass]
    public sealed class CF_00000649C_PrintConditions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000649C_PrintConditions));
        ...
        {
            bool result = CF_00000649C_PrintConditions.Solution_0_Test(input);
