...
{
    [TestClass]
    public sealed class CF_00000314B_SerejaAndPeriods_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000314B_SerejaAndPeriods));
        ...
        {
            bool result = CF_00000314B_SerejaAndPeriods.Solution_0_Test(input);
