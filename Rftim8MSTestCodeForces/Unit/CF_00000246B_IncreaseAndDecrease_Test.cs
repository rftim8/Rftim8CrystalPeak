...
{
    [TestClass]
    public sealed class CF_00000246B_IncreaseAndDecrease_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000246B_IncreaseAndDecrease));
        ...
        {
            bool result = CF_00000246B_IncreaseAndDecrease.Solution_0_Test(input);
