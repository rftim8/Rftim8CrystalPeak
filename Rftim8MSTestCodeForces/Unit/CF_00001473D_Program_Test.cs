...
{
    [TestClass]
    public sealed class CF_00001473D_Program_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001473D_Program));
        ...
        {
            bool result = CF_00001473D_Program.Solution_0_Test(input);
