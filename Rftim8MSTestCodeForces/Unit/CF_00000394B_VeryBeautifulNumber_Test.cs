...
{
    [TestClass]
    public sealed class CF_00000394B_VeryBeautifulNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000394B_VeryBeautifulNumber));
        ...
        {
            bool result = CF_00000394B_VeryBeautifulNumber.Solution_0_Test(input);
