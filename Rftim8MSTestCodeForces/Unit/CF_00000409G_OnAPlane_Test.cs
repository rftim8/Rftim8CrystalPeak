...
{
    [TestClass]
    public sealed class CF_00000409G_OnAPlane_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000409G_OnAPlane));
        ...
        {
            bool result = CF_00000409G_OnAPlane.Solution_0_Test(input);
