...
{
    [TestClass]
    public sealed class CF_00001198A_MP3_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001198A_MP3));
        ...
        {
            bool result = CF_00001198A_MP3.Solution_0_Test(input);
