...
{
    [TestClass]
    public sealed class CF_00000716A_CrazyComputer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000716A_CrazyComputer));
        ...
        {
            bool result = CF_00000716A_CrazyComputer.Solution_0_Test(input);
