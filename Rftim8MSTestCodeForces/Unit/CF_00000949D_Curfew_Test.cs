...
{
    [TestClass]
    public sealed class CF_00000949D_Curfew_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000949D_Curfew));
        ...
        {
            bool result = CF_00000949D_Curfew.Solution_0_Test(input);
