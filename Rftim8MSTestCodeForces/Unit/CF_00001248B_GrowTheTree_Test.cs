...
{
    [TestClass]
    public sealed class CF_00001248B_GrowTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001248B_GrowTheTree));
        ...
        {
            bool result = CF_00001248B_GrowTheTree.Solution_0_Test(input);
