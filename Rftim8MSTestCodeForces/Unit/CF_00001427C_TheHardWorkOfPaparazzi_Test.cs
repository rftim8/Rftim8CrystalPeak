...
{
    [TestClass]
    public sealed class CF_00001427C_TheHardWorkOfPaparazzi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001427C_TheHardWorkOfPaparazzi));
        ...
        {
            bool result = CF_00001427C_TheHardWorkOfPaparazzi.Solution_0_Test(input);
