...
{
    [TestClass]
    public sealed class CF_00000808G_AnthemOfBerland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000808G_AnthemOfBerland));
        ...
        {
            bool result = CF_00000808G_AnthemOfBerland.Solution_0_Test(input);
