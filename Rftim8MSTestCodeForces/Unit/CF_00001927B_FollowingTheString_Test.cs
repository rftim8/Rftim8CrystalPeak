...
{
    [TestClass]
    public sealed class CF_00001927B_FollowingTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001927B_FollowingTheString));
        ...
        {
            bool result = CF_00001927B_FollowingTheString.Solution_0_Test(input);
