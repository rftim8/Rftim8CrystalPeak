...
{
    [TestClass]
    public sealed class CF_00002005A_SimplePalindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002005A_SimplePalindrome));
        ...
        {
            bool result = CF_00002005A_SimplePalindrome.Solution_0_Test(input);
