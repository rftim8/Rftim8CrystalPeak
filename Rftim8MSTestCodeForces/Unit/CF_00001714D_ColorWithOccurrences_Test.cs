...
{
    [TestClass]
    public sealed class CF_00001714D_ColorWithOccurrences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001714D_ColorWithOccurrences));
        ...
        {
            bool result = CF_00001714D_ColorWithOccurrences.Solution_0_Test(input);
