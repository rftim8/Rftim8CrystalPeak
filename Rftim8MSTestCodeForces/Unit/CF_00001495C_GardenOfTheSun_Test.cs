...
{
    [TestClass]
    public sealed class CF_00001495C_GardenOfTheSun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001495C_GardenOfTheSun));
        ...
        {
            bool result = CF_00001495C_GardenOfTheSun.Solution_0_Test(input);
