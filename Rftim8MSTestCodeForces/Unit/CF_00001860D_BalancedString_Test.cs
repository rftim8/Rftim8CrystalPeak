...
{
    [TestClass]
    public sealed class CF_00001860D_BalancedString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001860D_BalancedString));
        ...
        {
            bool result = CF_00001860D_BalancedString.Solution_0_Test(input);
