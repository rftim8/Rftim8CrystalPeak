...
{
    [TestClass]
    public sealed class CF_00000107B_BasketballTeam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000107B_BasketballTeam));
        ...
        {
            bool result = CF_00000107B_BasketballTeam.Solution_0_Test(input);
