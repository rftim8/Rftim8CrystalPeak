...
{
    [TestClass]
    public sealed class CF_00000158D_IceSculptures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000158D_IceSculptures));
        ...
        {
            bool result = CF_00000158D_IceSculptures.Solution_0_Test(input);
