...
{
    [TestClass]
    public sealed class CF_00001436B_PrimeSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001436B_PrimeSquare));
        ...
        {
            bool result = CF_00001436B_PrimeSquare.Solution_0_Test(input);
