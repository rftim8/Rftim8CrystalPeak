...
{
    [TestClass]
    public sealed class CF_00000248C_RoboFootballer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000248C_RoboFootballer));
        ...
        {
            bool result = CF_00000248C_RoboFootballer.Solution_0_Test(input);
