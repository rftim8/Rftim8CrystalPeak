...
{
    [TestClass]
    public sealed class CF_00000359E_Neatness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000359E_Neatness));
        ...
        {
            bool result = CF_00000359E_Neatness.Solution_0_Test(input);
