...
{
    [TestClass]
    public sealed class CF_00002033D_KousukesAssignment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002033D_KousukesAssignment));
        ...
        {
            bool result = CF_00002033D_KousukesAssignment.Solution_0_Test(input);
