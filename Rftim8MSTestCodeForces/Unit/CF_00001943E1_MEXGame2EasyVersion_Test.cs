...
{
    [TestClass]
    public sealed class CF_00001943E1_MEXGame2EasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001943E1_MEXGame2EasyVersion));
        ...
        {
            bool result = CF_00001943E1_MEXGame2EasyVersion.Solution_0_Test(input);
