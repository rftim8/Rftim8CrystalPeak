...
{
    [TestClass]
    public sealed class CF_00001231E_MiddleOut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001231E_MiddleOut));
        ...
        {
            bool result = CF_00001231E_MiddleOut.Solution_0_Test(input);
