...
{
    [TestClass]
    public sealed class CF_00000585D_LizardEraBeginning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000585D_LizardEraBeginning));
        ...
        {
            bool result = CF_00000585D_LizardEraBeginning.Solution_0_Test(input);
