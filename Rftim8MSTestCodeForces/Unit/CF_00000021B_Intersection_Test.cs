...
{
    [TestClass]
    public sealed class CF_00000021B_Intersection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000021B_Intersection));
        ...
        {
            bool result = CF_00000021B_Intersection.Solution_0_Test(input);
