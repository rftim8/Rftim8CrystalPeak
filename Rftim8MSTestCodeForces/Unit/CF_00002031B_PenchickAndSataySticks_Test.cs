...
{
    [TestClass]
    public sealed class CF_00002031B_PenchickAndSataySticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002031B_PenchickAndSataySticks));
        ...
        {
            bool result = CF_00002031B_PenchickAndSataySticks.Solution_0_Test(input);
