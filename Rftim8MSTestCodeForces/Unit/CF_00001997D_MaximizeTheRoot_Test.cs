...
{
    [TestClass]
    public sealed class CF_00001997D_MaximizeTheRoot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001997D_MaximizeTheRoot));
        ...
        {
            bool result = CF_00001997D_MaximizeTheRoot.Solution_0_Test(input);
