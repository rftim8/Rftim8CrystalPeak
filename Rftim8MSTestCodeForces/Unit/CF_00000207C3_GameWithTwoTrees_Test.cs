...
{
    [TestClass]
    public sealed class CF_00000207C3_GameWithTwoTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000207C3_GameWithTwoTrees));
        ...
        {
            bool result = CF_00000207C3_GameWithTwoTrees.Solution_0_Test(input);
