...
{
    [TestClass]
    public sealed class CF_00001612E_Messages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001612E_Messages));
        ...
        {
            bool result = CF_00001612E_Messages.Solution_0_Test(input);
