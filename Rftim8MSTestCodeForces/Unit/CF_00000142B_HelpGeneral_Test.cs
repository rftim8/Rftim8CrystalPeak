...
{
    [TestClass]
    public sealed class CF_00000142B_HelpGeneral_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000142B_HelpGeneral));
        ...
        {
            bool result = CF_00000142B_HelpGeneral.Solution_0_Test(input);
