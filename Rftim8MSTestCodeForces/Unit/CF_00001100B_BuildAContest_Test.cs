...
{
    [TestClass]
    public sealed class CF_00001100B_BuildAContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001100B_BuildAContest));
        ...
        {
            bool result = CF_00001100B_BuildAContest.Solution_0_Test(input);
