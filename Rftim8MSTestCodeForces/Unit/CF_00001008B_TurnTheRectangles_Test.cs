...
{
    [TestClass]
    public sealed class CF_00001008B_TurnTheRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001008B_TurnTheRectangles));
        ...
        {
            bool result = CF_00001008B_TurnTheRectangles.Solution_0_Test(input);
