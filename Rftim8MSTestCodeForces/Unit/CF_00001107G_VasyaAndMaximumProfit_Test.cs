...
{
    [TestClass]
    public sealed class CF_00001107G_VasyaAndMaximumProfit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001107G_VasyaAndMaximumProfit));
        ...
        {
            bool result = CF_00001107G_VasyaAndMaximumProfit.Solution_0_Test(input);
