...
{
    [TestClass]
    public sealed class CF_00001658D1_388535EasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001658D1_388535EasyVersion));
        ...
        {
            bool result = CF_00001658D1_388535EasyVersion.Solution_0_Test(input);
