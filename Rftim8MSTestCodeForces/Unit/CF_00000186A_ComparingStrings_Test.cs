...
{
    [TestClass]
    public sealed class CF_00000186A_ComparingStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000186A_ComparingStrings));
        ...
        {
            bool result = CF_00000186A_ComparingStrings.Solution_0_Test(input);
