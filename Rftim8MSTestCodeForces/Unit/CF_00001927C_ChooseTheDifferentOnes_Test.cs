...
{
    [TestClass]
    public sealed class CF_00001927C_ChooseTheDifferentOnes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001927C_ChooseTheDifferentOnes));
        ...
        {
            bool result = CF_00001927C_ChooseTheDifferentOnes.Solution_0_Test(input);
