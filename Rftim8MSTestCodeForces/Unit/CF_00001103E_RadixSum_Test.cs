...
{
    [TestClass]
    public sealed class CF_00001103E_RadixSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001103E_RadixSum));
        ...
        {
            bool result = CF_00001103E_RadixSum.Solution_0_Test(input);
