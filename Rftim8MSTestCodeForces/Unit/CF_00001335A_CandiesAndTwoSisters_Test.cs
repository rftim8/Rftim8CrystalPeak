...
{
    [TestClass]
    public sealed class CF_00001335A_CandiesAndTwoSisters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001335A_CandiesAndTwoSisters));
        ...
        {
            bool result = CF_00001335A_CandiesAndTwoSisters.Solution_0_Test(input);
