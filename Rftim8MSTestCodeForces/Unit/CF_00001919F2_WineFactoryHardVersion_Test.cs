...
{
    [TestClass]
    public sealed class CF_00001919F2_WineFactoryHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001919F2_WineFactoryHardVersion));
        ...
        {
            bool result = CF_00001919F2_WineFactoryHardVersion.Solution_0_Test(input);
