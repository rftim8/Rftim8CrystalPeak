...
{
    [TestClass]
    public sealed class CF_00000427D_MatchAndCatch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000427D_MatchAndCatch));
        ...
        {
            bool result = CF_00000427D_MatchAndCatch.Solution_0_Test(input);
