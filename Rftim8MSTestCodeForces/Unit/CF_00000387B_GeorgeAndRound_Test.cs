...
{
    [TestClass]
    public sealed class CF_00000387B_GeorgeAndRound_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000387B_GeorgeAndRound));
        ...
        {
            bool result = CF_00000387B_GeorgeAndRound.Solution_0_Test(input);
