...
{
    [TestClass]
    public sealed class CF_00000178D3_MagicSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000178D3_MagicSquares));
        ...
        {
            bool result = CF_00000178D3_MagicSquares.Solution_0_Test(input);
