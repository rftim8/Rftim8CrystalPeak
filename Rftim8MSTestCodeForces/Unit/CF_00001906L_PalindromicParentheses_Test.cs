...
{
    [TestClass]
    public sealed class CF_00001906L_PalindromicParentheses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001906L_PalindromicParentheses));
        ...
        {
            bool result = CF_00001906L_PalindromicParentheses.Solution_0_Test(input);
