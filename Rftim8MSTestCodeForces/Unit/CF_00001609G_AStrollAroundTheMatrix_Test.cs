...
{
    [TestClass]
    public sealed class CF_00001609G_AStrollAroundTheMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001609G_AStrollAroundTheMatrix));
        ...
        {
            bool result = CF_00001609G_AStrollAroundTheMatrix.Solution_0_Test(input);
