...
{
    [TestClass]
    public sealed class CF_00001495A_DiamondMiner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001495A_DiamondMiner));
        ...
        {
            bool result = CF_00001495A_DiamondMiner.Solution_0_Test(input);
