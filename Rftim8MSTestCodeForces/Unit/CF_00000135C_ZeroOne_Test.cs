...
{
    [TestClass]
    public sealed class CF_00000135C_ZeroOne_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000135C_ZeroOne));
        ...
        {
            bool result = CF_00000135C_ZeroOne.Solution_0_Test(input);
