...
{
    [TestClass]
    public sealed class CF_00000777E_HanoiFactory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000777E_HanoiFactory));
        ...
        {
            bool result = CF_00000777E_HanoiFactory.Solution_0_Test(input);
