...
{
    [TestClass]
    public sealed class CF_00001335F_RobotsOnAGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001335F_RobotsOnAGrid));
        ...
        {
            bool result = CF_00001335F_RobotsOnAGrid.Solution_0_Test(input);
