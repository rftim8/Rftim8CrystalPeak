...
{
    [TestClass]
    public sealed class CF_00000793A_OlegAndShares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000793A_OlegAndShares));
        ...
        {
            bool result = CF_00000793A_OlegAndShares.Solution_0_Test(input);
