...
{
    [TestClass]
    public sealed class CF_00001346A_ColorRevolution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001346A_ColorRevolution));
        ...
        {
            bool result = CF_00001346A_ColorRevolution.Solution_0_Test(input);
