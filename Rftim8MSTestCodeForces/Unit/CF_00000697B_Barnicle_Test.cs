...
{
    [TestClass]
    public sealed class CF_00000697B_Barnicle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000697B_Barnicle));
        ...
        {
            bool result = CF_00000697B_Barnicle.Solution_0_Test(input);
