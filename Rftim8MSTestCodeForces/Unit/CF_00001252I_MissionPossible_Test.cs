...
{
    [TestClass]
    public sealed class CF_00001252I_MissionPossible_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001252I_MissionPossible));
        ...
        {
            bool result = CF_00001252I_MissionPossible.Solution_0_Test(input);
