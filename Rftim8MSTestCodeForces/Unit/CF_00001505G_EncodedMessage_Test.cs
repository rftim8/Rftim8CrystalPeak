...
{
    [TestClass]
    public sealed class CF_00001505G_EncodedMessage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001505G_EncodedMessage));
        ...
        {
            bool result = CF_00001505G_EncodedMessage.Solution_0_Test(input);
