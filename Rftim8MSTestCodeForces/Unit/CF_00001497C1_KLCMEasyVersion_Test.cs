...
{
    [TestClass]
    public sealed class CF_00001497C1_KLCMEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001497C1_KLCMEasyVersion));
        ...
        {
            bool result = CF_00001497C1_KLCMEasyVersion.Solution_0_Test(input);
