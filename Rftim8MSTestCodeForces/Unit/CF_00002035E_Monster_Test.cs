...
{
    [TestClass]
    public sealed class CF_00002035E_Monster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002035E_Monster));
        ...
        {
            bool result = CF_00002035E_Monster.Solution_0_Test(input);
