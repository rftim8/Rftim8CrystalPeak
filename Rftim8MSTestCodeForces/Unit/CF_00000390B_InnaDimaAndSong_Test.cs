...
{
    [TestClass]
    public sealed class CF_00000390B_InnaDimaAndSong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000390B_InnaDimaAndSong));
        ...
        {
            bool result = CF_00000390B_InnaDimaAndSong.Solution_0_Test(input);
