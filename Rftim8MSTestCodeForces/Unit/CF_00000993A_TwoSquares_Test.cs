...
{
    [TestClass]
    public sealed class CF_00000993A_TwoSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000993A_TwoSquares));
        ...
        {
            bool result = CF_00000993A_TwoSquares.Solution_0_Test(input);
