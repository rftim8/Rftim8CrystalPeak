...
{
    [TestClass]
    public sealed class CF_00000139A_PetrAndBook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000139A_PetrAndBook));
        ...
        {
            bool result = CF_00000139A_PetrAndBook.Solution_0_Test(input);
