...
{
    [TestClass]
    public sealed class CF_00001763C_AnotherArrayProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001763C_AnotherArrayProblem));
        ...
        {
            bool result = CF_00001763C_AnotherArrayProblem.Solution_0_Test(input);
