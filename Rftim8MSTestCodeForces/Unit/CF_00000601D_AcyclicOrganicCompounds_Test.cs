...
{
    [TestClass]
    public sealed class CF_00000601D_AcyclicOrganicCompounds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000601D_AcyclicOrganicCompounds));
        ...
        {
            bool result = CF_00000601D_AcyclicOrganicCompounds.Solution_0_Test(input);
