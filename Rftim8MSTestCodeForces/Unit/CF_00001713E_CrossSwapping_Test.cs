...
{
    [TestClass]
    public sealed class CF_00001713E_CrossSwapping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001713E_CrossSwapping));
        ...
        {
            bool result = CF_00001713E_CrossSwapping.Solution_0_Test(input);
