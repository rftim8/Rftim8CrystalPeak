...
{
    [TestClass]
    public sealed class CF_00001040B_ShashlikCooking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001040B_ShashlikCooking));
        ...
        {
            bool result = CF_00001040B_ShashlikCooking.Solution_0_Test(input);
