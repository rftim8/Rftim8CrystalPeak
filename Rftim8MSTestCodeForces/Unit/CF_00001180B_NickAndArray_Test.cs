...
{
    [TestClass]
    public sealed class CF_00001180B_NickAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001180B_NickAndArray));
        ...
        {
            bool result = CF_00001180B_NickAndArray.Solution_0_Test(input);
