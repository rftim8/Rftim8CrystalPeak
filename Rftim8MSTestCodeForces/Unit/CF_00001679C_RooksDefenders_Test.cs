...
{
    [TestClass]
    public sealed class CF_00001679C_RooksDefenders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001679C_RooksDefenders));
        ...
        {
            bool result = CF_00001679C_RooksDefenders.Solution_0_Test(input);
