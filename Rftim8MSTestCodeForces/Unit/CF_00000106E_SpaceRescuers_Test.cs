...
{
    [TestClass]
    public sealed class CF_00000106E_SpaceRescuers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000106E_SpaceRescuers));
        ...
        {
            bool result = CF_00000106E_SpaceRescuers.Solution_0_Test(input);
