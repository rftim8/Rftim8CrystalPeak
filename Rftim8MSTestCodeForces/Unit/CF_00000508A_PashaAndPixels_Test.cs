...
{
    [TestClass]
    public sealed class CF_00000508A_PashaAndPixels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000508A_PashaAndPixels));
        ...
        {
            bool result = CF_00000508A_PashaAndPixels.Solution_0_Test(input);
