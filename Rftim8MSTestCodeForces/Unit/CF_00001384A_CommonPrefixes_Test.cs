...
{
    [TestClass]
    public sealed class CF_00001384A_CommonPrefixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001384A_CommonPrefixes));
        ...
        {
            bool result = CF_00001384A_CommonPrefixes.Solution_0_Test(input);
