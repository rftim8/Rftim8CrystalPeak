...
{
    [TestClass]
    public sealed class CF_00000988E_DivisibilityBy25_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000988E_DivisibilityBy25));
        ...
        {
            bool result = CF_00000988E_DivisibilityBy25.Solution_0_Test(input);
