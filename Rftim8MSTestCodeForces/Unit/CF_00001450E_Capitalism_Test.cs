...
{
    [TestClass]
    public sealed class CF_00001450E_Capitalism_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001450E_Capitalism));
        ...
        {
            bool result = CF_00001450E_Capitalism.Solution_0_Test(input);
