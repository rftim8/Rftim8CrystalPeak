...
{
    [TestClass]
    public sealed class CF_00001464F_MyBeautifulMadness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001464F_MyBeautifulMadness));
        ...
        {
            bool result = CF_00001464F_MyBeautifulMadness.Solution_0_Test(input);
