...
{
    [TestClass]
    public sealed class CF_00001830A_CopilCopacDrawsTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001830A_CopilCopacDrawsTrees));
        ...
        {
            bool result = CF_00001830A_CopilCopacDrawsTrees.Solution_0_Test(input);
