...
{
    [TestClass]
    public sealed class CF_00000629D_BabaeiAndBirthdayCake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000629D_BabaeiAndBirthdayCake));
        ...
        {
            bool result = CF_00000629D_BabaeiAndBirthdayCake.Solution_0_Test(input);
