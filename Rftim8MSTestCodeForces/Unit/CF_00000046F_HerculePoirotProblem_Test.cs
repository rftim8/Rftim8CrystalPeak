...
{
    [TestClass]
    public sealed class CF_00000046F_HerculePoirotProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000046F_HerculePoirotProblem));
        ...
        {
            bool result = CF_00000046F_HerculePoirotProblem.Solution_0_Test(input);
