...
{
    [TestClass]
    public sealed class CF_00001867B_XORPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001867B_XORPalindromes));
        ...
        {
            bool result = CF_00001867B_XORPalindromes.Solution_0_Test(input);
