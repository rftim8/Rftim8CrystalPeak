...
{
    [TestClass]
    public sealed class CF_00000725A_JumpingBall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000725A_JumpingBall));
        ...
        {
            bool result = CF_00000725A_JumpingBall.Solution_0_Test(input);
