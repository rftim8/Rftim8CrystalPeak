...
{
    [TestClass]
    public sealed class CF_00001071E_RainProtection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001071E_RainProtection));
        ...
        {
            bool result = CF_00001071E_RainProtection.Solution_0_Test(input);
