...
{
    [TestClass]
    public sealed class CF_00001985D_ManhattanCircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001985D_ManhattanCircle));
        ...
        {
            bool result = CF_00001985D_ManhattanCircle.Solution_0_Test(input);
