...
{
    [TestClass]
    public sealed class CF_00001027C_MinimumValueRectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001027C_MinimumValueRectangle));
        ...
        {
            bool result = CF_00001027C_MinimumValueRectangle.Solution_0_Test(input);
