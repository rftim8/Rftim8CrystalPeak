...
{
    [TestClass]
    public sealed class CF_00002035A_Sliding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002035A_Sliding));
        ...
        {
            bool result = CF_00002035A_Sliding.Solution_0_Test(input);
