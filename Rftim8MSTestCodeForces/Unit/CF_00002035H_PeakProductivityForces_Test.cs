...
{
    [TestClass]
    public sealed class CF_00002035H_PeakProductivityForces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002035H_PeakProductivityForces));
        ...
        {
            bool result = CF_00002035H_PeakProductivityForces.Solution_0_Test(input);
