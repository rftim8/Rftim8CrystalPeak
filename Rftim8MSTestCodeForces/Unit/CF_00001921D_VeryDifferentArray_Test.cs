...
{
    [TestClass]
    public sealed class CF_00001921D_VeryDifferentArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001921D_VeryDifferentArray));
        ...
        {
            bool result = CF_00001921D_VeryDifferentArray.Solution_0_Test(input);
