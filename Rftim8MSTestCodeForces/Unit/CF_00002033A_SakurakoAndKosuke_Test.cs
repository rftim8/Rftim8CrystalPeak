...
{
    [TestClass]
    public sealed class CF_00002033A_SakurakoAndKosuke_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002033A_SakurakoAndKosuke));
        ...
        {
            bool result = CF_00002033A_SakurakoAndKosuke.Solution_0_Test(input);
