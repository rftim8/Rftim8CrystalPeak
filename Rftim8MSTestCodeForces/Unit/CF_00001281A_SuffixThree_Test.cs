...
{
    [TestClass]
    public sealed class CF_00001281A_SuffixThree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001281A_SuffixThree));
        ...
        {
            bool result = CF_00001281A_SuffixThree.Solution_0_Test(input);
