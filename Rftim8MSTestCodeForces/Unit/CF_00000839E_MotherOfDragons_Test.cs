...
{
    [TestClass]
    public sealed class CF_00000839E_MotherOfDragons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000839E_MotherOfDragons));
        ...
        {
            bool result = CF_00000839E_MotherOfDragons.Solution_0_Test(input);
