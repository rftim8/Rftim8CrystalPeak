...
{
    [TestClass]
    public sealed class CF_00001237H_BalancedReversals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001237H_BalancedReversals));
        ...
        {
            bool result = CF_00001237H_BalancedReversals.Solution_0_Test(input);
