...
{
    [TestClass]
    public sealed class CF_00001907A_Rook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001907A_Rook));
        ...
        {
            bool result = CF_00001907A_Rook.Solution_0_Test(input);
