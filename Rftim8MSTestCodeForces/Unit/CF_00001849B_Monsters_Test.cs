...
{
    [TestClass]
    public sealed class CF_00001849B_Monsters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001849B_Monsters));
        ...
        {
            bool result = CF_00001849B_Monsters.Solution_0_Test(input);
