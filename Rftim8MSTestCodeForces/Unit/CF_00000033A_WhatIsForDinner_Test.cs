...
{
    [TestClass]
    public sealed class CF_00000033A_WhatIsForDinner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000033A_WhatIsForDinner));
        ...
        {
            bool result = CF_00000033A_WhatIsForDinner.Solution_0_Test(input);
