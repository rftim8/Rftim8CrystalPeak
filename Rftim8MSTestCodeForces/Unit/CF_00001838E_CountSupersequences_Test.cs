...
{
    [TestClass]
    public sealed class CF_00001838E_CountSupersequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001838E_CountSupersequences));
        ...
        {
            bool result = CF_00001838E_CountSupersequences.Solution_0_Test(input);
