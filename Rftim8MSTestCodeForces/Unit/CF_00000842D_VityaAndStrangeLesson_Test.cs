...
{
    [TestClass]
    public sealed class CF_00000842D_VityaAndStrangeLesson_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000842D_VityaAndStrangeLesson));
        ...
        {
            bool result = CF_00000842D_VityaAndStrangeLesson.Solution_0_Test(input);
