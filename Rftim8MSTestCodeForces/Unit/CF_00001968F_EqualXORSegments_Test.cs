...
{
    [TestClass]
    public sealed class CF_00001968F_EqualXORSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001968F_EqualXORSegments));
        ...
        {
            bool result = CF_00001968F_EqualXORSegments.Solution_0_Test(input);
