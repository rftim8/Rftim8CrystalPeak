...
{
    [TestClass]
    public sealed class CF_00000883A_AutomaticDoor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883A_AutomaticDoor));
        ...
        {
            bool result = CF_00000883A_AutomaticDoor.Solution_0_Test(input);
