...
{
    [TestClass]
    public sealed class CF_00001508D_SwapPass_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001508D_SwapPass));
        ...
        {
            bool result = CF_00001508D_SwapPass.Solution_0_Test(input);
