...
{
    [TestClass]
    public sealed class CF_00001538B_FriendsAndCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001538B_FriendsAndCandies));
        ...
        {
            bool result = CF_00001538B_FriendsAndCandies.Solution_0_Test(input);
