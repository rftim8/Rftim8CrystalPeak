...
{
    [TestClass]
    public sealed class CF_00000766B_MahmoudAndATriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000766B_MahmoudAndATriangle));
        ...
        {
            bool result = CF_00000766B_MahmoudAndATriangle.Solution_0_Test(input);
