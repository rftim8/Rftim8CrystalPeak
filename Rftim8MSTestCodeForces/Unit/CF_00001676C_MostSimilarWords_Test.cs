...
{
    [TestClass]
    public sealed class CF_00001676C_MostSimilarWords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001676C_MostSimilarWords));
        ...
        {
            bool result = CF_00001676C_MostSimilarWords.Solution_0_Test(input);
