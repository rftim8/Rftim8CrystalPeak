...
{
    [TestClass]
    public sealed class CF_00001552F_Telepanting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001552F_Telepanting));
        ...
        {
            bool result = CF_00001552F_Telepanting.Solution_0_Test(input);
