...
{
    [TestClass]
    public sealed class CF_00001098F_Zfunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001098F_Zfunction));
        ...
        {
            bool result = CF_00001098F_Zfunction.Solution_0_Test(input);
