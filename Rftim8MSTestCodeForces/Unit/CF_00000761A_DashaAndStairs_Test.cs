...
{
    [TestClass]
    public sealed class CF_00000761A_DashaAndStairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000761A_DashaAndStairs));
        ...
        {
            bool result = CF_00000761A_DashaAndStairs.Solution_0_Test(input);
