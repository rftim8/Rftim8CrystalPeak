...
{
    [TestClass]
    public sealed class CF_00001616F_TricolorTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001616F_TricolorTriangles));
        ...
        {
            bool result = CF_00001616F_TricolorTriangles.Solution_0_Test(input);
