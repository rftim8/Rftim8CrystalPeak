...
{
    [TestClass]
    public sealed class CF_00001680F_LenientVertexCover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001680F_LenientVertexCover));
        ...
        {
            bool result = CF_00001680F_LenientVertexCover.Solution_0_Test(input);
