...
{
    [TestClass]
    public sealed class CF_00000191A_DynastyPuzzles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000191A_DynastyPuzzles));
        ...
        {
            bool result = CF_00000191A_DynastyPuzzles.Solution_0_Test(input);
