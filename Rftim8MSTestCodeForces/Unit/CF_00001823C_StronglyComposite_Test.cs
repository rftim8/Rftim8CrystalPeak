...
{
    [TestClass]
    public sealed class CF_00001823C_StronglyComposite_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001823C_StronglyComposite));
        ...
        {
            bool result = CF_00001823C_StronglyComposite.Solution_0_Test(input);
