...
{
    [TestClass]
    public sealed class CF_00001361A_JohnnyAndContribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001361A_JohnnyAndContribution));
        ...
        {
            bool result = CF_00001361A_JohnnyAndContribution.Solution_0_Test(input);
