...
{
    [TestClass]
    public sealed class CF_00000400C_InnaAndHugeCandyMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000400C_InnaAndHugeCandyMatrix));
        ...
        {
            bool result = CF_00000400C_InnaAndHugeCandyMatrix.Solution_0_Test(input);
