...
{
    [TestClass]
    public sealed class CF_00001846F_RudolphAndMimic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001846F_RudolphAndMimic));
        ...
        {
            bool result = CF_00001846F_RudolphAndMimic.Solution_0_Test(input);
