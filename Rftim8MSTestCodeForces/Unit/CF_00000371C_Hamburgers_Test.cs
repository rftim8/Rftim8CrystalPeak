...
{
    [TestClass]
    public sealed class CF_00000371C_Hamburgers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000371C_Hamburgers));
        ...
        {
            bool result = CF_00000371C_Hamburgers.Solution_0_Test(input);
