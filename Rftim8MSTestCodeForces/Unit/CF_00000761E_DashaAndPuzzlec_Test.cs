...
{
    [TestClass]
    public sealed class CF_00000761E_DashaAndPuzzlec_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000761E_DashaAndPuzzlec));
        ...
        {
            bool result = CF_00000761E_DashaAndPuzzlec.Solution_0_Test(input);
