...
{
    [TestClass]
    public sealed class CF_00000883C_DownloadingBPlusPlus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883C_DownloadingBPlusPlus));
        ...
        {
            bool result = CF_00000883C_DownloadingBPlusPlus.Solution_0_Test(input);
