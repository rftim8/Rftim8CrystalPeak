...
{
    [TestClass]
    public sealed class CF_00001833E_RoundDance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001833E_RoundDance));
        ...
        {
            bool result = CF_00001833E_RoundDance.Solution_0_Test(input);
