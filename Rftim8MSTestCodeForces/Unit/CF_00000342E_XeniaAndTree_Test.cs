...
{
    [TestClass]
    public sealed class CF_00000342E_XeniaAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000342E_XeniaAndTree));
        ...
        {
            bool result = CF_00000342E_XeniaAndTree.Solution_0_Test(input);
