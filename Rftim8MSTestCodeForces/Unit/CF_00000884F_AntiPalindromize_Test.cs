...
{
    [TestClass]
    public sealed class CF_00000884F_AntiPalindromize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000884F_AntiPalindromize));
        ...
        {
            bool result = CF_00000884F_AntiPalindromize.Solution_0_Test(input);
