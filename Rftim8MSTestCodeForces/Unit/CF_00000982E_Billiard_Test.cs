...
{
    [TestClass]
    public sealed class CF_00000982E_Billiard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000982E_Billiard));
        ...
        {
            bool result = CF_00000982E_Billiard.Solution_0_Test(input);
