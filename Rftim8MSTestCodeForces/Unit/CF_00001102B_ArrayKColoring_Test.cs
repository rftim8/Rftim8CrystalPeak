...
{
    [TestClass]
    public sealed class CF_00001102B_ArrayKColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001102B_ArrayKColoring));
        ...
        {
            bool result = CF_00001102B_ArrayKColoring.Solution_0_Test(input);
