...
{
    [TestClass]
    public sealed class CF_00000513E2_SubarrayCuts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000513E2_SubarrayCuts));
        ...
        {
            bool result = CF_00000513E2_SubarrayCuts.Solution_0_Test(input);
