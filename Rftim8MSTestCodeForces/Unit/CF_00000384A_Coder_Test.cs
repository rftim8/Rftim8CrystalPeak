...
{
    [TestClass]
    public sealed class CF_00000384A_Coder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000384A_Coder));
        ...
        {
            bool result = CF_00000384A_Coder.Solution_0_Test(input);
