...
{
    [TestClass]
    public sealed class CF_00001374F_CyclicShiftsSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001374F_CyclicShiftsSorting));
        ...
        {
            bool result = CF_00001374F_CyclicShiftsSorting.Solution_0_Test(input);
