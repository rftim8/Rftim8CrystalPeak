...
{
    [TestClass]
    public sealed class CF_00001843B_LongLong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001843B_LongLong));
        ...
        {
            bool result = CF_00001843B_LongLong.Solution_0_Test(input);
