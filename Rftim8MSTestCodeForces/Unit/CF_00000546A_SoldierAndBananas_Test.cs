...
{
    [TestClass]
    public sealed class CF_00000546A_SoldierAndBananas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000546A_SoldierAndBananas));
        ...
        {
            bool result = CF_00000546A_SoldierAndBananas.Solution_0_Test(input);
