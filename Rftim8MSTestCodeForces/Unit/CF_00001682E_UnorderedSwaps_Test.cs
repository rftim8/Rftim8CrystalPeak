...
{
    [TestClass]
    public sealed class CF_00001682E_UnorderedSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001682E_UnorderedSwaps));
        ...
        {
            bool result = CF_00001682E_UnorderedSwaps.Solution_0_Test(input);
