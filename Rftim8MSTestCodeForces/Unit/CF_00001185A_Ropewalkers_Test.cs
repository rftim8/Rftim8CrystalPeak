...
{
    [TestClass]
    public sealed class CF_00001185A_Ropewalkers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001185A_Ropewalkers));
        ...
        {
            bool result = CF_00001185A_Ropewalkers.Solution_0_Test(input);
