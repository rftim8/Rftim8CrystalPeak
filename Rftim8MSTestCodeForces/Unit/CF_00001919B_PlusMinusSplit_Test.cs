...
{
    [TestClass]
    public sealed class CF_00001919B_PlusMinusSplit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001919B_PlusMinusSplit));
        ...
        {
            bool result = CF_00001919B_PlusMinusSplit.Solution_0_Test(input);
