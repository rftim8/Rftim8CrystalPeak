...
{
    [TestClass]
    public sealed class CF_00001178H_StockExchange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001178H_StockExchange));
        ...
        {
            bool result = CF_00001178H_StockExchange.Solution_0_Test(input);
