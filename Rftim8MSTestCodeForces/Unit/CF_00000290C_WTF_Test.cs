...
{
    [TestClass]
    public sealed class CF_00000290C_WTF_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000290C_WTF));
        ...
        {
            bool result = CF_00000290C_WTF.Solution_0_Test(input);
