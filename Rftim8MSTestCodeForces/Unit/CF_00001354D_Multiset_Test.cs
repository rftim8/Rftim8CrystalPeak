...
{
    [TestClass]
    public sealed class CF_00001354D_Multiset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001354D_Multiset));
        ...
        {
            bool result = CF_00001354D_Multiset.Solution_0_Test(input);
