...
{
    [TestClass]
    public sealed class CF_00000217D_BitonixPatrol_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000217D_BitonixPatrol));
        ...
        {
            bool result = CF_00000217D_BitonixPatrol.Solution_0_Test(input);
