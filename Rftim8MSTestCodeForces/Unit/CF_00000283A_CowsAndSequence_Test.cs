...
{
    [TestClass]
    public sealed class CF_00000283A_CowsAndSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000283A_CowsAndSequence));
        ...
        {
            bool result = CF_00000283A_CowsAndSequence.Solution_0_Test(input);
