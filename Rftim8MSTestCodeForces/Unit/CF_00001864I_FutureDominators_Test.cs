...
{
    [TestClass]
    public sealed class CF_00001864I_FutureDominators_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001864I_FutureDominators));
        ...
        {
            bool result = CF_00001864I_FutureDominators.Solution_0_Test(input);
