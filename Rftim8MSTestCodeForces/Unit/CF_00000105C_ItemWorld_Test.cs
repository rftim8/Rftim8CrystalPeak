...
{
    [TestClass]
    public sealed class CF_00000105C_ItemWorld_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000105C_ItemWorld));
        ...
        {
            bool result = CF_00000105C_ItemWorld.Solution_0_Test(input);
