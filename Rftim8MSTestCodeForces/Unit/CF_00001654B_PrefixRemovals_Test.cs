...
{
    [TestClass]
    public sealed class CF_00001654B_PrefixRemovals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001654B_PrefixRemovals));
        ...
        {
            bool result = CF_00001654B_PrefixRemovals.Solution_0_Test(input);
