...
{
    [TestClass]
    public sealed class CF_00001498F_ChristmasGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001498F_ChristmasGame));
        ...
        {
            bool result = CF_00001498F_ChristmasGame.Solution_0_Test(input);
