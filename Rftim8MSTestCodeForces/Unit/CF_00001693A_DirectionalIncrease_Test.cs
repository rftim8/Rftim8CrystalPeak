...
{
    [TestClass]
    public sealed class CF_00001693A_DirectionalIncrease_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001693A_DirectionalIncrease));
        ...
        {
            bool result = CF_00001693A_DirectionalIncrease.Solution_0_Test(input);
