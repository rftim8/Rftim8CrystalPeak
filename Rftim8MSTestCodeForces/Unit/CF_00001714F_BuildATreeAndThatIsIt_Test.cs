...
{
    [TestClass]
    public sealed class CF_00001714F_BuildATreeAndThatIsIt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001714F_BuildATreeAndThatIsIt));
        ...
        {
            bool result = CF_00001714F_BuildATreeAndThatIsIt.Solution_0_Test(input);
