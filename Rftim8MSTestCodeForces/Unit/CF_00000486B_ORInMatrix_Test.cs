...
{
    [TestClass]
    public sealed class CF_00000486B_ORInMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000486B_ORInMatrix));
        ...
        {
            bool result = CF_00000486B_ORInMatrix.Solution_0_Test(input);
