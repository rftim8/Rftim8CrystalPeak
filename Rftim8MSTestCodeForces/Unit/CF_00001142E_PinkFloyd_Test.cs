...
{
    [TestClass]
    public sealed class CF_00001142E_PinkFloyd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001142E_PinkFloyd));
        ...
        {
            bool result = CF_00001142E_PinkFloyd.Solution_0_Test(input);
