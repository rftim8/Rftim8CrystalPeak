...
{
    [TestClass]
    public sealed class CF_00001929B_SashaAndTheDrawing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001929B_SashaAndTheDrawing));
        ...
        {
            bool result = CF_00001929B_SashaAndTheDrawing.Solution_0_Test(input);
