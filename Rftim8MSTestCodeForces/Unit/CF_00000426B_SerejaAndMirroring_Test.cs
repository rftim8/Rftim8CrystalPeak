...
{
    [TestClass]
    public sealed class CF_00000426B_SerejaAndMirroring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000426B_SerejaAndMirroring));
        ...
        {
            bool result = CF_00000426B_SerejaAndMirroring.Solution_0_Test(input);
