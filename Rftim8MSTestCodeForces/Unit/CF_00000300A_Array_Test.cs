...
{
    [TestClass]
    public sealed class CF_00000300A_Array_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000300A_Array));
        ...
        {
            bool result = CF_00000300A_Array.Solution_0_Test(input);
