...
{
    [TestClass]
    public sealed class CF_00000976D_DegreeSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000976D_DegreeSet));
        ...
        {
            bool result = CF_00000976D_DegreeSet.Solution_0_Test(input);
