...
{
    [TestClass]
    public sealed class CF_00000679A_BearAndPrime100_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000679A_BearAndPrime100));
        ...
        {
            bool result = CF_00000679A_BearAndPrime100.Solution_0_Test(input);
