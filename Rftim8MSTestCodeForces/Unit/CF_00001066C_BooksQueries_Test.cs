...
{
    [TestClass]
    public sealed class CF_00001066C_BooksQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001066C_BooksQueries));
        ...
        {
            bool result = CF_00001066C_BooksQueries.Solution_0_Test(input);
