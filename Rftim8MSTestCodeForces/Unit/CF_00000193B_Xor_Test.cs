...
{
    [TestClass]
    public sealed class CF_00000193B_Xor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000193B_Xor));
        ...
        {
            bool result = CF_00000193B_Xor.Solution_0_Test(input);
