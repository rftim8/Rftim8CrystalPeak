...
{
    [TestClass]
    public sealed class CF_00001935F_AndreysTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001935F_AndreysTree));
        ...
        {
            bool result = CF_00001935F_AndreysTree.Solution_0_Test(input);
