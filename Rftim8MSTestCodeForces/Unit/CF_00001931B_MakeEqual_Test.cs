...
{
    [TestClass]
    public sealed class CF_00001931B_MakeEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001931B_MakeEqual));
        ...
        {
            bool result = CF_00001931B_MakeEqual.Solution_0_Test(input);
