...
{
    [TestClass]
    public sealed class CF_00000394A_CountingSticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000394A_CountingSticks));
        ...
        {
            bool result = CF_00000394A_CountingSticks.Solution_0_Test(input);
