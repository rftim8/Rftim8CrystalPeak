...
{
    [TestClass]
    public sealed class CF_00001167A_TelephoneNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001167A_TelephoneNumber));
        ...
        {
            bool result = CF_00001167A_TelephoneNumber.Solution_0_Test(input);
