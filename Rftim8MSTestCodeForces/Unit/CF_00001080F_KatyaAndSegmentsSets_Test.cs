...
{
    [TestClass]
    public sealed class CF_00001080F_KatyaAndSegmentsSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001080F_KatyaAndSegmentsSets));
        ...
        {
            bool result = CF_00001080F_KatyaAndSegmentsSets.Solution_0_Test(input);
