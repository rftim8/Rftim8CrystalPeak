...
{
    [TestClass]
    public sealed class CF_00000846C_FourSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000846C_FourSegments));
        ...
        {
            bool result = CF_00000846C_FourSegments.Solution_0_Test(input);
