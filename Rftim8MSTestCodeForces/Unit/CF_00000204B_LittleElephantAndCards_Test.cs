...
{
    [TestClass]
    public sealed class CF_00000204B_LittleElephantAndCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000204B_LittleElephantAndCards));
        ...
        {
            bool result = CF_00000204B_LittleElephantAndCards.Solution_0_Test(input);
