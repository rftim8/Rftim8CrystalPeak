...
{
    [TestClass]
    public sealed class CF_00000513D1_ConstrainedTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000513D1_ConstrainedTree));
        ...
        {
            bool result = CF_00000513D1_ConstrainedTree.Solution_0_Test(input);
