...
{
    [TestClass]
    public sealed class CF_00000252B_UnsortingArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000252B_UnsortingArray));
        ...
        {
            bool result = CF_00000252B_UnsortingArray.Solution_0_Test(input);
