...
{
    [TestClass]
    public sealed class CF_00000070B_TextMessaging_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000070B_TextMessaging));
        ...
        {
            bool result = CF_00000070B_TextMessaging.Solution_0_Test(input);
