...
{
    [TestClass]
    public sealed class CF_00001761F1_AntimedianEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001761F1_AntimedianEasyVersion));
        ...
        {
            bool result = CF_00001761F1_AntimedianEasyVersion.Solution_0_Test(input);
