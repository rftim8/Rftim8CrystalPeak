...
{
    [TestClass]
    public sealed class CF_00001722B_Colourblindness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001722B_Colourblindness));
        ...
        {
            bool result = CF_00001722B_Colourblindness.Solution_0_Test(input);
