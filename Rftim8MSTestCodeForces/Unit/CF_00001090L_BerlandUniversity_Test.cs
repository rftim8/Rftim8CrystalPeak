...
{
    [TestClass]
    public sealed class CF_00001090L_BerlandUniversity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090L_BerlandUniversity));
        ...
        {
            bool result = CF_00001090L_BerlandUniversity.Solution_0_Test(input);
