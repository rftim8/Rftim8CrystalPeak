...
{
    [TestClass]
    public sealed class CF_00000958F3_LightsabersHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958F3_LightsabersHard));
        ...
        {
            bool result = CF_00000958F3_LightsabersHard.Solution_0_Test(input);
