...
{
    [TestClass]
    public sealed class CF_00000615D_Multipliers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000615D_Multipliers));
        ...
        {
            bool result = CF_00000615D_Multipliers.Solution_0_Test(input);
