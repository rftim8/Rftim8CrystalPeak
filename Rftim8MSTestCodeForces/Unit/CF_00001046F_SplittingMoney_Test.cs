...
{
    [TestClass]
    public sealed class CF_00001046F_SplittingMoney_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001046F_SplittingMoney));
        ...
        {
            bool result = CF_00001046F_SplittingMoney.Solution_0_Test(input);
