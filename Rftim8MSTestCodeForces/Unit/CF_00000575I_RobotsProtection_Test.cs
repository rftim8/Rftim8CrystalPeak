...
{
    [TestClass]
    public sealed class CF_00000575I_RobotsProtection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000575I_RobotsProtection));
        ...
        {
            bool result = CF_00000575I_RobotsProtection.Solution_0_Test(input);
