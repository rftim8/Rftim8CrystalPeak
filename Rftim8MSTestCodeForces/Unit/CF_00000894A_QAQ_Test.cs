...
{
    [TestClass]
    public sealed class CF_00000894A_QAQ_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000894A_QAQ));
        ...
        {
            bool result = CF_00000894A_QAQ.Solution_0_Test(input);
