...
{
    [TestClass]
    public sealed class CF_00000832A_SashaAndSticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000832A_SashaAndSticks));
        ...
        {
            bool result = CF_00000832A_SashaAndSticks.Solution_0_Test(input);
