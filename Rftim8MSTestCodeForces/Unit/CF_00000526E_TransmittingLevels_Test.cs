...
{
    [TestClass]
    public sealed class CF_00000526E_TransmittingLevels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000526E_TransmittingLevels));
        ...
        {
            bool result = CF_00000526E_TransmittingLevels.Solution_0_Test(input);
