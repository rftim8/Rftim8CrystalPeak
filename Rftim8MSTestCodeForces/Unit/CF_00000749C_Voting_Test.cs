...
{
    [TestClass]
    public sealed class CF_00000749C_Voting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000749C_Voting));
        ...
        {
            bool result = CF_00000749C_Voting.Solution_0_Test(input);
