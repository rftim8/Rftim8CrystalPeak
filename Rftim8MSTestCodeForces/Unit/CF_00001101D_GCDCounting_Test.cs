...
{
    [TestClass]
    public sealed class CF_00001101D_GCDCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001101D_GCDCounting));
        ...
        {
            bool result = CF_00001101D_GCDCounting.Solution_0_Test(input);
