...
{
    [TestClass]
    public sealed class CF_00001144C_TwoShuffledSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001144C_TwoShuffledSequences));
        ...
        {
            bool result = CF_00001144C_TwoShuffledSequences.Solution_0_Test(input);
