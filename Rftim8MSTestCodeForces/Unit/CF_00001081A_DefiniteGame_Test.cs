...
{
    [TestClass]
    public sealed class CF_00001081A_DefiniteGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001081A_DefiniteGame));
        ...
        {
            bool result = CF_00001081A_DefiniteGame.Solution_0_Test(input);
