...
{
    [TestClass]
    public sealed class CF_00001196B_OddSumSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001196B_OddSumSegments));
        ...
        {
            bool result = CF_00001196B_OddSumSegments.Solution_0_Test(input);
