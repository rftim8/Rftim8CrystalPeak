...
{
    [TestClass]
    public sealed class CF_00000348C_SubsetSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000348C_SubsetSums));
        ...
        {
            bool result = CF_00000348C_SubsetSums.Solution_0_Test(input);
