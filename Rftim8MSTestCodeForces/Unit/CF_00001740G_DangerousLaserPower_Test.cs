...
{
    [TestClass]
    public sealed class CF_00001740G_DangerousLaserPower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001740G_DangerousLaserPower));
        ...
        {
            bool result = CF_00001740G_DangerousLaserPower.Solution_0_Test(input);
