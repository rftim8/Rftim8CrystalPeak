...
{
    [TestClass]
    public sealed class CF_00001285E_DeleteASegment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001285E_DeleteASegment));
        ...
        {
            bool result = CF_00001285E_DeleteASegment.Solution_0_Test(input);
