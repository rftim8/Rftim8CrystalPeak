...
{
    [TestClass]
    public sealed class CF_00000739B_AlyonaAndATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000739B_AlyonaAndATree));
        ...
        {
            bool result = CF_00000739B_AlyonaAndATree.Solution_0_Test(input);
