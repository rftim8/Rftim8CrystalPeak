...
{
    [TestClass]
    public sealed class CF_00001791D_DistinctSplit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001791D_DistinctSplit));
        ...
        {
            bool result = CF_00001791D_DistinctSplit.Solution_0_Test(input);
