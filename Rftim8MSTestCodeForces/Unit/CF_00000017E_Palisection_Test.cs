...
{
    [TestClass]
    public sealed class CF_00000017E_Palisection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000017E_Palisection));
        ...
        {
            bool result = CF_00000017E_Palisection.Solution_0_Test(input);
