...
{
    [TestClass]
    public sealed class CF_00002039G_ShohagLovesPebae_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002039G_ShohagLovesPebae));
        ...
        {
            bool result = CF_00002039G_ShohagLovesPebae.Solution_0_Test(input);
