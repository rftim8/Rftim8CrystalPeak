...
{
    [TestClass]
    public sealed class CF_00001526D_KillAnton_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001526D_KillAnton));
        ...
        {
            bool result = CF_00001526D_KillAnton.Solution_0_Test(input);
