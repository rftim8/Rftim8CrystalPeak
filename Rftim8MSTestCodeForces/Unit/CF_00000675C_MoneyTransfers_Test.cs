...
{
    [TestClass]
    public sealed class CF_00000675C_MoneyTransfers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000675C_MoneyTransfers));
        ...
        {
            bool result = CF_00000675C_MoneyTransfers.Solution_0_Test(input);
