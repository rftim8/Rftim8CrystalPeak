...
{
    [TestClass]
    public sealed class CF_00001681F_UniqueOccurrences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001681F_UniqueOccurrences));
        ...
        {
            bool result = CF_00001681F_UniqueOccurrences.Solution_0_Test(input);
