...
{
    [TestClass]
    public sealed class CF_00001769D3_GameOfNineIII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001769D3_GameOfNineIII));
        ...
        {
            bool result = CF_00001769D3_GameOfNineIII.Solution_0_Test(input);
