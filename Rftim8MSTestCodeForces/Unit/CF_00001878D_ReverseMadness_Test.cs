...
{
    [TestClass]
    public sealed class CF_00001878D_ReverseMadness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001878D_ReverseMadness));
        ...
        {
            bool result = CF_00001878D_ReverseMadness.Solution_0_Test(input);
