...
{
    [TestClass]
    public sealed class CF_00000939D_LoveRescue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000939D_LoveRescue));
        ...
        {
            bool result = CF_00000939D_LoveRescue.Solution_0_Test(input);
