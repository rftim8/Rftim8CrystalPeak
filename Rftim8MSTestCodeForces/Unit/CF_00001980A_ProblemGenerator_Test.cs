...
{
    [TestClass]
    public sealed class CF_00001980A_ProblemGenerator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001980A_ProblemGenerator));
        ...
        {
            bool result = CF_00001980A_ProblemGenerator.Solution_0_Test(input);
