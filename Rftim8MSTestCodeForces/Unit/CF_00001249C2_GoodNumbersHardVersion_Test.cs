...
{
    [TestClass]
    public sealed class CF_00001249C2_GoodNumbersHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001249C2_GoodNumbersHardVersion));
        ...
        {
            bool result = CF_00001249C2_GoodNumbersHardVersion.Solution_0_Test(input);
