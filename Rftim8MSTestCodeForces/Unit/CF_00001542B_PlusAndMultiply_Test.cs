...
{
    [TestClass]
    public sealed class CF_00001542B_PlusAndMultiply_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001542B_PlusAndMultiply));
        ...
        {
            bool result = CF_00001542B_PlusAndMultiply.Solution_0_Test(input);
