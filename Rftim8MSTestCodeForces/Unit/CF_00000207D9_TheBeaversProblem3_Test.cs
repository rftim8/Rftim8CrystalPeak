...
{
    [TestClass]
    public sealed class CF_00000207D9_TheBeaversProblem3_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000207D9_TheBeaversProblem3));
        ...
        {
            bool result = CF_00000207D9_TheBeaversProblem3.Solution_0_Test(input);
