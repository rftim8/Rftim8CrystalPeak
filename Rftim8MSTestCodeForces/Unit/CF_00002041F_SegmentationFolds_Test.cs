...
{
    [TestClass]
    public sealed class CF_00002041F_SegmentationFolds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002041F_SegmentationFolds));
        ...
        {
            bool result = CF_00002041F_SegmentationFolds.Solution_0_Test(input);
