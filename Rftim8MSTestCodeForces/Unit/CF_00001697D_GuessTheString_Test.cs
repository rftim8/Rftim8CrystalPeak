...
{
    [TestClass]
    public sealed class CF_00001697D_GuessTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001697D_GuessTheString));
        ...
        {
            bool result = CF_00001697D_GuessTheString.Solution_0_Test(input);
