...
{
    [TestClass]
    public sealed class CF_00001625C_RoadOptimization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001625C_RoadOptimization));
        ...
        {
            bool result = CF_00001625C_RoadOptimization.Solution_0_Test(input);
