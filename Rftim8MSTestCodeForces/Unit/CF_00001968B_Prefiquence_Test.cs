...
{
    [TestClass]
    public sealed class CF_00001968B_Prefiquence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001968B_Prefiquence));
        ...
        {
            bool result = CF_00001968B_Prefiquence.Solution_0_Test(input);
