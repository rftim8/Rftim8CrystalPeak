...
{
    [TestClass]
    public sealed class CF_00001391C_CyclicPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001391C_CyclicPermutations));
        ...
        {
            bool result = CF_00001391C_CyclicPermutations.Solution_0_Test(input);
