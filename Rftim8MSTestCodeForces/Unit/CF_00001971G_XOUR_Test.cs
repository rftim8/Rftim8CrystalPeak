...
{
    [TestClass]
    public sealed class CF_00001971G_XOUR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001971G_XOUR));
        ...
        {
            bool result = CF_00001971G_XOUR.Solution_0_Test(input);
