...
{
    [TestClass]
    public sealed class CF_00001060F_ShrinkingTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001060F_ShrinkingTree));
        ...
        {
            bool result = CF_00001060F_ShrinkingTree.Solution_0_Test(input);
