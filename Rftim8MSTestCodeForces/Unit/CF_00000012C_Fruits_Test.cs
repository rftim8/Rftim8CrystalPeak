...
{
    [TestClass]
    public sealed class CF_00000012C_Fruits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000012C_Fruits));
        ...
        {
            bool result = CF_00000012C_Fruits.Solution_0_Test(input);
