...
{
    [TestClass]
    public sealed class CF_00001891D_SuspiciousLogarithms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001891D_SuspiciousLogarithms));
        ...
        {
            bool result = CF_00001891D_SuspiciousLogarithms.Solution_0_Test(input);
