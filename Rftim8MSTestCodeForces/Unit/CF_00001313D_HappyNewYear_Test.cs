...
{
    [TestClass]
    public sealed class CF_00001313D_HappyNewYear_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001313D_HappyNewYear));
        ...
        {
            bool result = CF_00001313D_HappyNewYear.Solution_0_Test(input);
