...
{
    [TestClass]
    public sealed class CF_00000142C_HelpCaretaker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000142C_HelpCaretaker));
        ...
        {
            bool result = CF_00000142C_HelpCaretaker.Solution_0_Test(input);
