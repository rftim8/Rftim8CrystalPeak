...
{
    [TestClass]
    public sealed class CF_00000587B_DuffInBeach_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000587B_DuffInBeach));
        ...
        {
            bool result = CF_00000587B_DuffInBeach.Solution_0_Test(input);
