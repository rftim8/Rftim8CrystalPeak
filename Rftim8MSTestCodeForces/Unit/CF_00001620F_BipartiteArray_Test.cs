...
{
    [TestClass]
    public sealed class CF_00001620F_BipartiteArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001620F_BipartiteArray));
        ...
        {
            bool result = CF_00001620F_BipartiteArray.Solution_0_Test(input);
