...
{
    [TestClass]
    public sealed class CF_00001039B_SubwayPursuit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001039B_SubwayPursuit));
        ...
        {
            bool result = CF_00001039B_SubwayPursuit.Solution_0_Test(input);
