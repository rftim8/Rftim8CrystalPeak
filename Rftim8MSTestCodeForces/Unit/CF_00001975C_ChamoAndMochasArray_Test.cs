...
{
    [TestClass]
    public sealed class CF_00001975C_ChamoAndMochasArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001975C_ChamoAndMochasArray));
        ...
        {
            bool result = CF_00001975C_ChamoAndMochasArray.Solution_0_Test(input);
