...
{
    [TestClass]
    public sealed class CF_00001829E_TheLakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001829E_TheLakes));
        ...
        {
            bool result = CF_00001829E_TheLakes.Solution_0_Test(input);
