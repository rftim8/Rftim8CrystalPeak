...
{
    [TestClass]
    public sealed class CF_00000717F_HeroesOfMakingMagicIII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000717F_HeroesOfMakingMagicIII));
        ...
        {
            bool result = CF_00000717F_HeroesOfMakingMagicIII.Solution_0_Test(input);
