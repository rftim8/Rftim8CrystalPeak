...
{
    [TestClass]
    public sealed class CF_00001511D_MinCostString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001511D_MinCostString));
        ...
        {
            bool result = CF_00001511D_MinCostString.Solution_0_Test(input);
