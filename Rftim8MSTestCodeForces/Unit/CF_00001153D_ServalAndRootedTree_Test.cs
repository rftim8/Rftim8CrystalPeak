...
{
    [TestClass]
    public sealed class CF_00001153D_ServalAndRootedTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001153D_ServalAndRootedTree));
        ...
        {
            bool result = CF_00001153D_ServalAndRootedTree.Solution_0_Test(input);
