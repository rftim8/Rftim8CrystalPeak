...
{
    [TestClass]
    public sealed class CF_00001527C_SequencePairWeight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001527C_SequencePairWeight));
        ...
        {
            bool result = CF_00001527C_SequencePairWeight.Solution_0_Test(input);
