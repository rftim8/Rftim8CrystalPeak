...
{
    [TestClass]
    public sealed class CF_00001665D_GCDGuess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001665D_GCDGuess));
        ...
        {
            bool result = CF_00001665D_GCDGuess.Solution_0_Test(input);
