...
{
    [TestClass]
    public sealed class CF_00000046C_HamstersAndTigers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000046C_HamstersAndTigers));
        ...
        {
            bool result = CF_00000046C_HamstersAndTigers.Solution_0_Test(input);
