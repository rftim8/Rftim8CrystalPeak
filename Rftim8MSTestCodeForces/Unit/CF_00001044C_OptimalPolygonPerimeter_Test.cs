...
{
    [TestClass]
    public sealed class CF_00001044C_OptimalPolygonPerimeter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001044C_OptimalPolygonPerimeter));
        ...
        {
            bool result = CF_00001044C_OptimalPolygonPerimeter.Solution_0_Test(input);
