...
{
    [TestClass]
    public sealed class CF_00000978C_Letters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000978C_Letters));
        ...
        {
            bool result = CF_00000978C_Letters.Solution_0_Test(input);
