...
{
    [TestClass]
    public sealed class CF_00001433F_ZeroRemainderSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001433F_ZeroRemainderSum));
        ...
        {
            bool result = CF_00001433F_ZeroRemainderSum.Solution_0_Test(input);
