...
{
    [TestClass]
    public sealed class CF_00001999D_SlavicsExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001999D_SlavicsExam));
        ...
        {
            bool result = CF_00001999D_SlavicsExam.Solution_0_Test(input);
