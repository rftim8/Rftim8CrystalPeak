...
{
    [TestClass]
    public sealed class CF_00001512B_AlmostRectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001512B_AlmostRectangle));
        ...
        {
            bool result = CF_00001512B_AlmostRectangle.Solution_0_Test(input);
