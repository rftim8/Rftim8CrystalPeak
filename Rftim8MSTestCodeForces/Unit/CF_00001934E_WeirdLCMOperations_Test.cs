...
{
    [TestClass]
    public sealed class CF_00001934E_WeirdLCMOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001934E_WeirdLCMOperations));
        ...
        {
            bool result = CF_00001934E_WeirdLCMOperations.Solution_0_Test(input);
