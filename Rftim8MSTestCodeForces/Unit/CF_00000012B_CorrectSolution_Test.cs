...
{
    [TestClass]
    public sealed class CF_00000012B_CorrectSolution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000012B_CorrectSolution));
        ...
        {
            bool result = CF_00000012B_CorrectSolution.Solution_0_Test(input);
