...
{
    [TestClass]
    public sealed class CF_00001704H2_GameOfAIHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001704H2_GameOfAIHardVersion));
        ...
        {
            bool result = CF_00001704H2_GameOfAIHardVersion.Solution_0_Test(input);
