...
{
    [TestClass]
    public sealed class CF_00000014B_YoungPhotographer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000014B_YoungPhotographer));
        ...
        {
            bool result = CF_00000014B_YoungPhotographer.Solution_0_Test(input);
