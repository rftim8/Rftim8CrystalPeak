...
{
    [TestClass]
    public sealed class CF_00000187E_HeavenTour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000187E_HeavenTour));
        ...
        {
            bool result = CF_00000187E_HeavenTour.Solution_0_Test(input);
