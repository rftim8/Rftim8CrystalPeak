...
{
    [TestClass]
    public sealed class CF_00000127B_CanvasFrames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000127B_CanvasFrames));
        ...
        {
            bool result = CF_00000127B_CanvasFrames.Solution_0_Test(input);
