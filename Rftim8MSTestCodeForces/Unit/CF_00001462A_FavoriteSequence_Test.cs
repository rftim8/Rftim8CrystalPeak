...
{
    [TestClass]
    public sealed class CF_00001462A_FavoriteSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001462A_FavoriteSequence));
        ...
        {
            bool result = CF_00001462A_FavoriteSequence.Solution_0_Test(input);
