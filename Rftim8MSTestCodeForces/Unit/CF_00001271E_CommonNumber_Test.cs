...
{
    [TestClass]
    public sealed class CF_00001271E_CommonNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001271E_CommonNumber));
        ...
        {
            bool result = CF_00001271E_CommonNumber.Solution_0_Test(input);
