...
{
    [TestClass]
    public sealed class CF_00000135B_RectangleAndSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000135B_RectangleAndSquare));
        ...
        {
            bool result = CF_00000135B_RectangleAndSquare.Solution_0_Test(input);
