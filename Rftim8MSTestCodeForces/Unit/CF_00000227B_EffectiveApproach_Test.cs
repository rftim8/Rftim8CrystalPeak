...
{
    [TestClass]
    public sealed class CF_00000227B_EffectiveApproach_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000227B_EffectiveApproach));
        ...
        {
            bool result = CF_00000227B_EffectiveApproach.Solution_0_Test(input);
