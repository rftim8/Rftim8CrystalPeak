...
{
    [TestClass]
    public sealed class CF_00000603A_AlternativeThinking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000603A_AlternativeThinking));
        ...
        {
            bool result = CF_00000603A_AlternativeThinking.Solution_0_Test(input);
