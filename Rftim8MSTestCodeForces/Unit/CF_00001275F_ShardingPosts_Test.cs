...
{
    [TestClass]
    public sealed class CF_00001275F_ShardingPosts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001275F_ShardingPosts));
        ...
        {
            bool result = CF_00001275F_ShardingPosts.Solution_0_Test(input);
