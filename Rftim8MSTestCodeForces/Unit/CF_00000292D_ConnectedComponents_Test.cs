...
{
    [TestClass]
    public sealed class CF_00000292D_ConnectedComponents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000292D_ConnectedComponents));
        ...
        {
            bool result = CF_00000292D_ConnectedComponents.Solution_0_Test(input);
