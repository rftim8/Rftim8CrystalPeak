...
{
    [TestClass]
    public sealed class CF_00001988A_SplitTheMultiset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001988A_SplitTheMultiset));
        ...
        {
            bool result = CF_00001988A_SplitTheMultiset.Solution_0_Test(input);
