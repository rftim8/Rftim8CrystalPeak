...
{
    [TestClass]
    public sealed class CF_00001985B_MaximumMultipleSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001985B_MaximumMultipleSum));
        ...
        {
            bool result = CF_00001985B_MaximumMultipleSum.Solution_0_Test(input);
