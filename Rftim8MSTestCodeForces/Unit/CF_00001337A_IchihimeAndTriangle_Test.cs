...
{
    [TestClass]
    public sealed class CF_00001337A_IchihimeAndTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001337A_IchihimeAndTriangle));
        ...
        {
            bool result = CF_00001337A_IchihimeAndTriangle.Solution_0_Test(input);
