...
{
    [TestClass]
    public sealed class CF_00001387B1_VillageMinimum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001387B1_VillageMinimum));
        ...
        {
            bool result = CF_00001387B1_VillageMinimum.Solution_0_Test(input);
