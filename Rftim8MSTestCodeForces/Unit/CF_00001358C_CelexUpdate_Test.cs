...
{
    [TestClass]
    public sealed class CF_00001358C_CelexUpdate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001358C_CelexUpdate));
        ...
        {
            bool result = CF_00001358C_CelexUpdate.Solution_0_Test(input);
