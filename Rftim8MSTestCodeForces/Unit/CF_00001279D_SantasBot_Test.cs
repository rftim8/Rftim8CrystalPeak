...
{
    [TestClass]
    public sealed class CF_00001279D_SantasBot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001279D_SantasBot));
        ...
        {
            bool result = CF_00001279D_SantasBot.Solution_0_Test(input);
