...
{
    [TestClass]
    public sealed class CF_00001900E_TransitiveGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001900E_TransitiveGraph));
        ...
        {
            bool result = CF_00001900E_TransitiveGraph.Solution_0_Test(input);
