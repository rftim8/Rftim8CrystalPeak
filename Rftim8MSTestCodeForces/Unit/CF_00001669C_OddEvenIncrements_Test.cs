...
{
    [TestClass]
    public sealed class CF_00001669C_OddEvenIncrements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001669C_OddEvenIncrements));
        ...
        {
            bool result = CF_00001669C_OddEvenIncrements.Solution_0_Test(input);
