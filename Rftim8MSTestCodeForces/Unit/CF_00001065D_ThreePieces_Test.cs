...
{
    [TestClass]
    public sealed class CF_00001065D_ThreePieces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001065D_ThreePieces));
        ...
        {
            bool result = CF_00001065D_ThreePieces.Solution_0_Test(input);
