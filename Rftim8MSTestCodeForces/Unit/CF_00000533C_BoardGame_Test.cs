...
{
    [TestClass]
    public sealed class CF_00000533C_BoardGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000533C_BoardGame));
        ...
        {
            bool result = CF_00000533C_BoardGame.Solution_0_Test(input);
