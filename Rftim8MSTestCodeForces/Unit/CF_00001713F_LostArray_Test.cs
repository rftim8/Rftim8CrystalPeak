...
{
    [TestClass]
    public sealed class CF_00001713F_LostArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001713F_LostArray));
        ...
        {
            bool result = CF_00001713F_LostArray.Solution_0_Test(input);
