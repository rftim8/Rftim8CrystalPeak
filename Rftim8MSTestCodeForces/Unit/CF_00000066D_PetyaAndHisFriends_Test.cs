...
{
    [TestClass]
    public sealed class CF_00000066D_PetyaAndHisFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000066D_PetyaAndHisFriends));
        ...
        {
            bool result = CF_00000066D_PetyaAndHisFriends.Solution_0_Test(input);
