...
{
    [TestClass]
    public sealed class CF_00001517D_ExplorerSpace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001517D_ExplorerSpace));
        ...
        {
            bool result = CF_00001517D_ExplorerSpace.Solution_0_Test(input);
