...
{
    [TestClass]
    public sealed class CF_00001392H_ZSShufflesCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001392H_ZSShufflesCards));
        ...
        {
            bool result = CF_00001392H_ZSShufflesCards.Solution_0_Test(input);
