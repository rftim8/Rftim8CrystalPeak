...
{
    [TestClass]
    public sealed class CF_00001154G_MinimumPossibleLCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001154G_MinimumPossibleLCM));
        ...
        {
            bool result = CF_00001154G_MinimumPossibleLCM.Solution_0_Test(input);
