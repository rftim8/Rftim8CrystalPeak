...
{
    [TestClass]
    public sealed class CF_00000244A_DividingOrange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000244A_DividingOrange));
        ...
        {
            bool result = CF_00000244A_DividingOrange.Solution_0_Test(input);
