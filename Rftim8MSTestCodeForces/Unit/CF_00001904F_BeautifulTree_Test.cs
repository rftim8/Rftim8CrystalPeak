...
{
    [TestClass]
    public sealed class CF_00001904F_BeautifulTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001904F_BeautifulTree));
        ...
        {
            bool result = CF_00001904F_BeautifulTree.Solution_0_Test(input);
