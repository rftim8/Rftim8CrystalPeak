...
{
    [TestClass]
    public sealed class CF_00000253B_PhysicsPractical_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000253B_PhysicsPractical));
        ...
        {
            bool result = CF_00000253B_PhysicsPractical.Solution_0_Test(input);
