...
{
    [TestClass]
    public sealed class CF_00001534H_LostNodes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001534H_LostNodes));
        ...
        {
            bool result = CF_00001534H_LostNodes.Solution_0_Test(input);
