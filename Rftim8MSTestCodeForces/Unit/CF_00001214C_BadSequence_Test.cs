...
{
    [TestClass]
    public sealed class CF_00001214C_BadSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001214C_BadSequence));
        ...
        {
            bool result = CF_00001214C_BadSequence.Solution_0_Test(input);
