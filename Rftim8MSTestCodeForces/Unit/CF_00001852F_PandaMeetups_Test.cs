...
{
    [TestClass]
    public sealed class CF_00001852F_PandaMeetups_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001852F_PandaMeetups));
        ...
        {
            bool result = CF_00001852F_PandaMeetups.Solution_0_Test(input);
