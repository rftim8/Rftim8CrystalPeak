...
{
    [TestClass]
    public sealed class CF_00000701B_CellsNotUnderAttack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000701B_CellsNotUnderAttack));
        ...
        {
            bool result = CF_00000701B_CellsNotUnderAttack.Solution_0_Test(input);
