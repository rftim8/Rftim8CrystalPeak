...
{
    [TestClass]
    public sealed class CF_00001332B_CompositeColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001332B_CompositeColoring));
        ...
        {
            bool result = CF_00001332B_CompositeColoring.Solution_0_Test(input);
