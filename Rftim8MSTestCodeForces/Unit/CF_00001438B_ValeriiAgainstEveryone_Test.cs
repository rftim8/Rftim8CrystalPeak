...
{
    [TestClass]
    public sealed class CF_00001438B_ValeriiAgainstEveryone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001438B_ValeriiAgainstEveryone));
        ...
        {
            bool result = CF_00001438B_ValeriiAgainstEveryone.Solution_0_Test(input);
