...
{
    [TestClass]
    public sealed class CF_00001015A_PointsInSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001015A_PointsInSegments));
        ...
        {
            bool result = CF_00001015A_PointsInSegments.Solution_0_Test(input);
