...
{
    [TestClass]
    public sealed class CF_00001534F1_FallingSandEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001534F1_FallingSandEasyVersion));
        ...
        {
            bool result = CF_00001534F1_FallingSandEasyVersion.Solution_0_Test(input);
