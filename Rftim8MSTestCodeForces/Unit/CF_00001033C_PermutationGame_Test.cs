...
{
    [TestClass]
    public sealed class CF_00001033C_PermutationGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001033C_PermutationGame));
        ...
        {
            bool result = CF_00001033C_PermutationGame.Solution_0_Test(input);
