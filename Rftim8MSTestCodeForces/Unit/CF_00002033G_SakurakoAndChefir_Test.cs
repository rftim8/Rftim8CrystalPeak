...
{
    [TestClass]
    public sealed class CF_00002033G_SakurakoAndChefir_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002033G_SakurakoAndChefir));
        ...
        {
            bool result = CF_00002033G_SakurakoAndChefir.Solution_0_Test(input);
