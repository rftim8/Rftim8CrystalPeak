...
{
    [TestClass]
    public sealed class CF_00000394C_Dominoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000394C_Dominoes));
        ...
        {
            bool result = CF_00000394C_Dominoes.Solution_0_Test(input);
