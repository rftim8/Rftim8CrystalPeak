...
{
    [TestClass]
    public sealed class CF_00001401E_DivideSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001401E_DivideSquare));
        ...
        {
            bool result = CF_00001401E_DivideSquare.Solution_0_Test(input);
