...
{
    [TestClass]
    public sealed class CF_00002002C_BlackCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002002C_BlackCircles));
        ...
        {
            bool result = CF_00002002C_BlackCircles.Solution_0_Test(input);
