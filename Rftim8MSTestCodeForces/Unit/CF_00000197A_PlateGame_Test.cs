...
{
    [TestClass]
    public sealed class CF_00000197A_PlateGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000197A_PlateGame));
        ...
        {
            bool result = CF_00000197A_PlateGame.Solution_0_Test(input);
