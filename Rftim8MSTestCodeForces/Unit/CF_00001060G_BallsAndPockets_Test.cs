...
{
    [TestClass]
    public sealed class CF_00001060G_BallsAndPockets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001060G_BallsAndPockets));
        ...
        {
            bool result = CF_00001060G_BallsAndPockets.Solution_0_Test(input);
