...
{
    [TestClass]
    public sealed class CF_00001006A_AdjacentReplacements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001006A_AdjacentReplacements));
        ...
        {
            bool result = CF_00001006A_AdjacentReplacements.Solution_0_Test(input);
