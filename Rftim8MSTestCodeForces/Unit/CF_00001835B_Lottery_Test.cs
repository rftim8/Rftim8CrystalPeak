...
{
    [TestClass]
    public sealed class CF_00001835B_Lottery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001835B_Lottery));
        ...
        {
            bool result = CF_00001835B_Lottery.Solution_0_Test(input);
