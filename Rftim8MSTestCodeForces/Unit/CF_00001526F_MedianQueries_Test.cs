...
{
    [TestClass]
    public sealed class CF_00001526F_MedianQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001526F_MedianQueries));
        ...
        {
            bool result = CF_00001526F_MedianQueries.Solution_0_Test(input);
