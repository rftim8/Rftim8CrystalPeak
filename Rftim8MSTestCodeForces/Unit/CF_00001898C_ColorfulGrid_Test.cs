...
{
    [TestClass]
    public sealed class CF_00001898C_ColorfulGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001898C_ColorfulGrid));
        ...
        {
            bool result = CF_00001898C_ColorfulGrid.Solution_0_Test(input);
