...
{
    [TestClass]
    public sealed class CF_00001900D_SmallGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001900D_SmallGCD));
        ...
        {
            bool result = CF_00001900D_SmallGCD.Solution_0_Test(input);
