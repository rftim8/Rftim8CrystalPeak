...
{
    [TestClass]
    public sealed class CF_00000519E_AAndBAndLectureRooms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000519E_AAndBAndLectureRooms));
        ...
        {
            bool result = CF_00000519E_AAndBAndLectureRooms.Solution_0_Test(input);
