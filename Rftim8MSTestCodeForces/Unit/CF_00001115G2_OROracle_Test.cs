...
{
    [TestClass]
    public sealed class CF_00001115G2_OROracle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001115G2_OROracle));
        ...
        {
            bool result = CF_00001115G2_OROracle.Solution_0_Test(input);
