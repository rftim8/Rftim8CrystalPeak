...
{
    [TestClass]
    public sealed class CF_00000153A_APlusB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000153A_APlusB));
        ...
        {
            bool result = CF_00000153A_APlusB.Solution_0_Test(input);
