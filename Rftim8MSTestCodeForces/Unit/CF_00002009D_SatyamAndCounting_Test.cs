...
{
    [TestClass]
    public sealed class CF_00002009D_SatyamAndCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002009D_SatyamAndCounting));
        ...
        {
            bool result = CF_00002009D_SatyamAndCounting.Solution_0_Test(input);
