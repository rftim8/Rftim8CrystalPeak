...
{
    [TestClass]
    public sealed class CF_00000863G_GraphicSettings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000863G_GraphicSettings));
        ...
        {
            bool result = CF_00000863G_GraphicSettings.Solution_0_Test(input);
