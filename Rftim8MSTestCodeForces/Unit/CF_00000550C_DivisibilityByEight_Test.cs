...
{
    [TestClass]
    public sealed class CF_00000550C_DivisibilityByEight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000550C_DivisibilityByEight));
        ...
        {
            bool result = CF_00000550C_DivisibilityByEight.Solution_0_Test(input);
