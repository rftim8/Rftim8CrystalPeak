...
{
    [TestClass]
    public sealed class CF_00001765M_MinimumLCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001765M_MinimumLCM));
        ...
        {
            bool result = CF_00001765M_MinimumLCM.Solution_0_Test(input);
