...
{
    [TestClass]
    public sealed class CF_00001894B_TwoOutOfThree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001894B_TwoOutOfThree));
        ...
        {
            bool result = CF_00001894B_TwoOutOfThree.Solution_0_Test(input);
