...
{
    [TestClass]
    public sealed class CF_00001934B_YetAnotherCoinProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001934B_YetAnotherCoinProblem));
        ...
        {
            bool result = CF_00001934B_YetAnotherCoinProblem.Solution_0_Test(input);
