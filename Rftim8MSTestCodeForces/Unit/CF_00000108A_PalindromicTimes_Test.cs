...
{
    [TestClass]
    public sealed class CF_00000108A_PalindromicTimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000108A_PalindromicTimes));
        ...
        {
            bool result = CF_00000108A_PalindromicTimes.Solution_0_Test(input);
