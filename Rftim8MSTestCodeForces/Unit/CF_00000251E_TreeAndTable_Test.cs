...
{
    [TestClass]
    public sealed class CF_00000251E_TreeAndTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000251E_TreeAndTable));
        ...
        {
            bool result = CF_00000251E_TreeAndTable.Solution_0_Test(input);
