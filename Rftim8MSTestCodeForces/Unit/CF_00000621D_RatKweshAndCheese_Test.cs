...
{
    [TestClass]
    public sealed class CF_00000621D_RatKweshAndCheese_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000621D_RatKweshAndCheese));
        ...
        {
            bool result = CF_00000621D_RatKweshAndCheese.Solution_0_Test(input);
