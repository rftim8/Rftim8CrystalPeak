...
{
    [TestClass]
    public sealed class CF_00001341B_NastyaAndDoor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001341B_NastyaAndDoor));
        ...
        {
            bool result = CF_00001341B_NastyaAndDoor.Solution_0_Test(input);
