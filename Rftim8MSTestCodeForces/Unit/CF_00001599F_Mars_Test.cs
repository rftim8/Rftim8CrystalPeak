...
{
    [TestClass]
    public sealed class CF_00001599F_Mars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001599F_Mars));
        ...
        {
            bool result = CF_00001599F_Mars.Solution_0_Test(input);
