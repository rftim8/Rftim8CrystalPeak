...
{
    [TestClass]
    public sealed class CF_00000100I_Rotation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000100I_Rotation));
        ...
        {
            bool result = CF_00000100I_Rotation.Solution_0_Test(input);
