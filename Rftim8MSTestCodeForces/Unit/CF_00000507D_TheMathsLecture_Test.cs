...
{
    [TestClass]
    public sealed class CF_00000507D_TheMathsLecture_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000507D_TheMathsLecture));
        ...
        {
            bool result = CF_00000507D_TheMathsLecture.Solution_0_Test(input);
