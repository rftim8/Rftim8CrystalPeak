...
{
    [TestClass]
    public sealed class CF_00001781B_GoingToTheCinema_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001781B_GoingToTheCinema));
        ...
        {
            bool result = CF_00001781B_GoingToTheCinema.Solution_0_Test(input);
