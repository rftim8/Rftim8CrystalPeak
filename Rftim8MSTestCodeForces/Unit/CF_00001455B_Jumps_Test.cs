...
{
    [TestClass]
    public sealed class CF_00001455B_Jumps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001455B_Jumps));
        ...
        {
            bool result = CF_00001455B_Jumps.Solution_0_Test(input);
