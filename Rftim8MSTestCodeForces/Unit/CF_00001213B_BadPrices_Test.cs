...
{
    [TestClass]
    public sealed class CF_00001213B_BadPrices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001213B_BadPrices));
        ...
        {
            bool result = CF_00001213B_BadPrices.Solution_0_Test(input);
