...
{
    [TestClass]
    public sealed class CF_00001198B_WelfareState_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001198B_WelfareState));
        ...
        {
            bool result = CF_00001198B_WelfareState.Solution_0_Test(input);
