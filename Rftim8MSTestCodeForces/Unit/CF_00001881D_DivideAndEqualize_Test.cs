...
{
    [TestClass]
    public sealed class CF_00001881D_DivideAndEqualize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001881D_DivideAndEqualize));
        ...
        {
            bool result = CF_00001881D_DivideAndEqualize.Solution_0_Test(input);
