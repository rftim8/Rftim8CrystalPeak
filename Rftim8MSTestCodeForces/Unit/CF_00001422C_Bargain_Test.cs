...
{
    [TestClass]
    public sealed class CF_00001422C_Bargain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001422C_Bargain));
        ...
        {
            bool result = CF_00001422C_Bargain.Solution_0_Test(input);
