...
{
    [TestClass]
    public sealed class CF_00000383B_Volcanoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000383B_Volcanoes));
        ...
        {
            bool result = CF_00000383B_Volcanoes.Solution_0_Test(input);
