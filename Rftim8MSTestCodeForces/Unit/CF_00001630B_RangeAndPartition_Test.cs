...
{
    [TestClass]
    public sealed class CF_00001630B_RangeAndPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001630B_RangeAndPartition));
        ...
        {
            bool result = CF_00001630B_RangeAndPartition.Solution_0_Test(input);
