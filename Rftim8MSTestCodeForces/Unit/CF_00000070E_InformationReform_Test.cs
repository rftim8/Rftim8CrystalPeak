...
{
    [TestClass]
    public sealed class CF_00000070E_InformationReform_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000070E_InformationReform));
        ...
        {
            bool result = CF_00000070E_InformationReform.Solution_0_Test(input);
