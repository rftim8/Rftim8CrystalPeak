...
{
    [TestClass]
    public sealed class CF_00000521E_CyclingCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000521E_CyclingCity));
        ...
        {
            bool result = CF_00000521E_CyclingCity.Solution_0_Test(input);
