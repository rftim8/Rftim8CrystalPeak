...
{
    [TestClass]
    public sealed class CF_00000198D_CubeSnake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000198D_CubeSnake));
        ...
        {
            bool result = CF_00000198D_CubeSnake.Solution_0_Test(input);
