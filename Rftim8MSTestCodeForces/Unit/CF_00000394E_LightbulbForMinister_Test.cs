...
{
    [TestClass]
    public sealed class CF_00000394E_LightbulbForMinister_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000394E_LightbulbForMinister));
        ...
        {
            bool result = CF_00000394E_LightbulbForMinister.Solution_0_Test(input);
