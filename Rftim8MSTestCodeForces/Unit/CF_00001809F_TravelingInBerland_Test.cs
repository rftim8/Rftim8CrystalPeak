...
{
    [TestClass]
    public sealed class CF_00001809F_TravelingInBerland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001809F_TravelingInBerland));
        ...
        {
            bool result = CF_00001809F_TravelingInBerland.Solution_0_Test(input);
