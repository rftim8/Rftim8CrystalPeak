...
{
    [TestClass]
    public sealed class CF_00000249E_EndlessMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000249E_EndlessMatrix));
        ...
        {
            bool result = CF_00000249E_EndlessMatrix.Solution_0_Test(input);
