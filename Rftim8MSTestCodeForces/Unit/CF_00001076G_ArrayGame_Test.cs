...
{
    [TestClass]
    public sealed class CF_00001076G_ArrayGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001076G_ArrayGame));
        ...
        {
            bool result = CF_00001076G_ArrayGame.Solution_0_Test(input);
