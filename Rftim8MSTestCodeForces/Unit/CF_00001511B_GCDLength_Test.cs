...
{
    [TestClass]
    public sealed class CF_00001511B_GCDLength_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001511B_GCDLength));
        ...
        {
            bool result = CF_00001511B_GCDLength.Solution_0_Test(input);
