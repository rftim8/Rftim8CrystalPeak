...
{
    [TestClass]
    public sealed class CF_00000769B_NewsAboutCredit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000769B_NewsAboutCredit));
        ...
        {
            bool result = CF_00000769B_NewsAboutCredit.Solution_0_Test(input);
