...
{
    [TestClass]
    public sealed class CF_00001912D_DivisibilityTest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001912D_DivisibilityTest));
        ...
        {
            bool result = CF_00001912D_DivisibilityTest.Solution_0_Test(input);
