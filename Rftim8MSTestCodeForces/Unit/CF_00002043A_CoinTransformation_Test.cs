...
{
    [TestClass]
    public sealed class CF_00002043A_CoinTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002043A_CoinTransformation));
        ...
        {
            bool result = CF_00002043A_CoinTransformation.Solution_0_Test(input);
