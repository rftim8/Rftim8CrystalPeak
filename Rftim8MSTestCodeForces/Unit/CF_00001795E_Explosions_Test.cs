...
{
    [TestClass]
    public sealed class CF_00001795E_Explosions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001795E_Explosions));
        ...
        {
            bool result = CF_00001795E_Explosions.Solution_0_Test(input);
