...
{
    [TestClass]
    public sealed class CF_00001999C_Showering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001999C_Showering));
        ...
        {
            bool result = CF_00001999C_Showering.Solution_0_Test(input);
