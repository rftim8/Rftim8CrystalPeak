...
{
    [TestClass]
    public sealed class CF_00001820A_YurasNewName_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001820A_YurasNewName));
        ...
        {
            bool result = CF_00001820A_YurasNewName.Solution_0_Test(input);
