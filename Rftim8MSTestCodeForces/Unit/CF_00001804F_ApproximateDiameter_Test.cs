...
{
    [TestClass]
    public sealed class CF_00001804F_ApproximateDiameter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001804F_ApproximateDiameter));
        ...
        {
            bool result = CF_00001804F_ApproximateDiameter.Solution_0_Test(input);
