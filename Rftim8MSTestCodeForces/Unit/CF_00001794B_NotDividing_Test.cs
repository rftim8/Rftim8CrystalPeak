...
{
    [TestClass]
    public sealed class CF_00001794B_NotDividing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001794B_NotDividing));
        ...
        {
            bool result = CF_00001794B_NotDividing.Solution_0_Test(input);
