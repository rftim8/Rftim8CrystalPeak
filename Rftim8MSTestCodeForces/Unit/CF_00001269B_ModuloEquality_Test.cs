...
{
    [TestClass]
    public sealed class CF_00001269B_ModuloEquality_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001269B_ModuloEquality));
        ...
        {
            bool result = CF_00001269B_ModuloEquality.Solution_0_Test(input);
