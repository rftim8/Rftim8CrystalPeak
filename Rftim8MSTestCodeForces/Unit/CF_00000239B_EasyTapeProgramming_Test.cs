...
{
    [TestClass]
    public sealed class CF_00000239B_EasyTapeProgramming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000239B_EasyTapeProgramming));
        ...
        {
            bool result = CF_00000239B_EasyTapeProgramming.Solution_0_Test(input);
