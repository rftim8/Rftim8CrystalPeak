...
{
    [TestClass]
    public sealed class CF_00001970G3_MinFundPrisonHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970G3_MinFundPrisonHard));
        ...
        {
            bool result = CF_00001970G3_MinFundPrisonHard.Solution_0_Test(input);
