...
{
    [TestClass]
    public sealed class CF_00001909H_ParallelSwapsSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001909H_ParallelSwapsSort));
        ...
        {
            bool result = CF_00001909H_ParallelSwapsSort.Solution_0_Test(input);
