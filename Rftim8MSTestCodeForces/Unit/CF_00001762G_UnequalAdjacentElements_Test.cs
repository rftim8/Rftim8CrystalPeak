...
{
    [TestClass]
    public sealed class CF_00001762G_UnequalAdjacentElements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001762G_UnequalAdjacentElements));
        ...
        {
            bool result = CF_00001762G_UnequalAdjacentElements.Solution_0_Test(input);
