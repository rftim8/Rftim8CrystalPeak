...
{
    [TestClass]
    public sealed class CF_00001730B_MeetingOnTheLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001730B_MeetingOnTheLine));
        ...
        {
            bool result = CF_00001730B_MeetingOnTheLine.Solution_0_Test(input);
