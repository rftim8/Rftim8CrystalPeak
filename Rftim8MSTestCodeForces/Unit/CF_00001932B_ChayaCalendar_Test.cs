...
{
    [TestClass]
    public sealed class CF_00001932B_ChayaCalendar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001932B_ChayaCalendar));
        ...
        {
            bool result = CF_00001932B_ChayaCalendar.Solution_0_Test(input);
