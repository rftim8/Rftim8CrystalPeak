...
{
    [TestClass]
    public sealed class CF_00000283C_CoinTroubles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000283C_CoinTroubles));
        ...
        {
            bool result = CF_00000283C_CoinTroubles.Solution_0_Test(input);
