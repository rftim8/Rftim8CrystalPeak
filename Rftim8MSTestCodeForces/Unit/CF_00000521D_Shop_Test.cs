...
{
    [TestClass]
    public sealed class CF_00000521D_Shop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000521D_Shop));
        ...
        {
            bool result = CF_00000521D_Shop.Solution_0_Test(input);
