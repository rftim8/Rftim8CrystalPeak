...
{
    [TestClass]
    public sealed class CF_00000780A_AndryushaAndSocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000780A_AndryushaAndSocks));
        ...
        {
            bool result = CF_00000780A_AndryushaAndSocks.Solution_0_Test(input);
