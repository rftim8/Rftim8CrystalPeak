...
{
    [TestClass]
    public sealed class CF_00001499F_DiameterCuts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001499F_DiameterCuts));
        ...
        {
            bool result = CF_00001499F_DiameterCuts.Solution_0_Test(input);
