...
{
    [TestClass]
    public sealed class CF_00001129D_Isolation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001129D_Isolation));
        ...
        {
            bool result = CF_00001129D_Isolation.Solution_0_Test(input);
