...
{
    [TestClass]
    public sealed class CF_00001055F_TreeAndXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001055F_TreeAndXOR));
        ...
        {
            bool result = CF_00001055F_TreeAndXOR.Solution_0_Test(input);
