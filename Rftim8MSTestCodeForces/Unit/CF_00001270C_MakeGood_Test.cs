...
{
    [TestClass]
    public sealed class CF_00001270C_MakeGood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001270C_MakeGood));
        ...
        {
            bool result = CF_00001270C_MakeGood.Solution_0_Test(input);
