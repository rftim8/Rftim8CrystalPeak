...
{
    [TestClass]
    public sealed class CF_00001823B_SortWithStep_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001823B_SortWithStep));
        ...
        {
            bool result = CF_00001823B_SortWithStep.Solution_0_Test(input);
