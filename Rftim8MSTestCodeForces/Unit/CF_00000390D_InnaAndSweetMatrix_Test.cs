...
{
    [TestClass]
    public sealed class CF_00000390D_InnaAndSweetMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000390D_InnaAndSweetMatrix));
        ...
        {
            bool result = CF_00000390D_InnaAndSweetMatrix.Solution_0_Test(input);
