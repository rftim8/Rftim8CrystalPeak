...
{
    [TestClass]
    public sealed class CF_00000468D_Tree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000468D_Tree));
        ...
        {
            bool result = CF_00000468D_Tree.Solution_0_Test(input);
