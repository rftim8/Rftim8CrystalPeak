...
{
    [TestClass]
    public sealed class CF_00000446D_DZYLovesGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000446D_DZYLovesGames));
        ...
        {
            bool result = CF_00000446D_DZYLovesGames.Solution_0_Test(input);
