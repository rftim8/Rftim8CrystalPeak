...
{
    [TestClass]
    public sealed class CF_00001824D_LuoTianyiAndTheFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001824D_LuoTianyiAndTheFunction));
        ...
        {
            bool result = CF_00001824D_LuoTianyiAndTheFunction.Solution_0_Test(input);
