...
{
    [TestClass]
    public sealed class CF_00000648D_DogsAndBowls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000648D_DogsAndBowls));
        ...
        {
            bool result = CF_00000648D_DogsAndBowls.Solution_0_Test(input);
