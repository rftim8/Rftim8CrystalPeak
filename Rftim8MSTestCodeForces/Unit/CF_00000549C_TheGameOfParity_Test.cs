...
{
    [TestClass]
    public sealed class CF_00000549C_TheGameOfParity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000549C_TheGameOfParity));
        ...
        {
            bool result = CF_00000549C_TheGameOfParity.Solution_0_Test(input);
