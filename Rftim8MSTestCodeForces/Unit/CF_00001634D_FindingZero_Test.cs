...
{
    [TestClass]
    public sealed class CF_00001634D_FindingZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001634D_FindingZero));
        ...
        {
            bool result = CF_00001634D_FindingZero.Solution_0_Test(input);
