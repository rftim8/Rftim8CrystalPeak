...
{
    [TestClass]
    public sealed class CF_00001560A_DislikeOfThrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001560A_DislikeOfThrees));
        ...
        {
            bool result = CF_00001560A_DislikeOfThrees.Solution_0_Test(input);
