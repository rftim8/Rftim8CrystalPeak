...
{
    [TestClass]
    public sealed class CF_00001186C_VusTheCossackAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001186C_VusTheCossackAndStrings));
        ...
        {
            bool result = CF_00001186C_VusTheCossackAndStrings.Solution_0_Test(input);
