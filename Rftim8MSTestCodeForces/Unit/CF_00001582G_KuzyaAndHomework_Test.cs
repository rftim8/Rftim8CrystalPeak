...
{
    [TestClass]
    public sealed class CF_00001582G_KuzyaAndHomework_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001582G_KuzyaAndHomework));
        ...
        {
            bool result = CF_00001582G_KuzyaAndHomework.Solution_0_Test(input);
