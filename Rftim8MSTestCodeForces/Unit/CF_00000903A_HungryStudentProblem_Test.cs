...
{
    [TestClass]
    public sealed class CF_00000903A_HungryStudentProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000903A_HungryStudentProblem));
        ...
        {
            bool result = CF_00000903A_HungryStudentProblem.Solution_0_Test(input);
