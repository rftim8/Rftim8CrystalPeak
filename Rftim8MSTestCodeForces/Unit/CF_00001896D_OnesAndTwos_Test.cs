...
{
    [TestClass]
    public sealed class CF_00001896D_OnesAndTwos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001896D_OnesAndTwos));
        ...
        {
            bool result = CF_00001896D_OnesAndTwos.Solution_0_Test(input);
