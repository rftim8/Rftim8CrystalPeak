...
{
    [TestClass]
    public sealed class CF_00000821E_OkabeAndElPsyKongroo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000821E_OkabeAndElPsyKongroo));
        ...
        {
            bool result = CF_00000821E_OkabeAndElPsyKongroo.Solution_0_Test(input);
