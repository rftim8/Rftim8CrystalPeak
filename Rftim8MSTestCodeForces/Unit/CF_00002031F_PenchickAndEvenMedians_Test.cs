...
{
    [TestClass]
    public sealed class CF_00002031F_PenchickAndEvenMedians_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002031F_PenchickAndEvenMedians));
        ...
        {
            bool result = CF_00002031F_PenchickAndEvenMedians.Solution_0_Test(input);
