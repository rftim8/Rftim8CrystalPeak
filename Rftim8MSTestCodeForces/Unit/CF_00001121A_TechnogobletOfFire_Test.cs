...
{
    [TestClass]
    public sealed class CF_00001121A_TechnogobletOfFire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001121A_TechnogobletOfFire));
        ...
        {
            bool result = CF_00001121A_TechnogobletOfFire.Solution_0_Test(input);
