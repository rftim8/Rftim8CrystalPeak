...
{
    [TestClass]
    public sealed class CF_00001172F_NauuoAndBug_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001172F_NauuoAndBug));
        ...
        {
            bool result = CF_00001172F_NauuoAndBug.Solution_0_Test(input);
