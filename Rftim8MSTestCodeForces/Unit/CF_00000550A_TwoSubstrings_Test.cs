...
{
    [TestClass]
    public sealed class CF_00000550A_TwoSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000550A_TwoSubstrings));
        ...
        {
            bool result = CF_00000550A_TwoSubstrings.Solution_0_Test(input);
