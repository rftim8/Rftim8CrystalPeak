...
{
    [TestClass]
    public sealed class CF_00001380A_ThreeIndices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001380A_ThreeIndices));
        ...
        {
            bool result = CF_00001380A_ThreeIndices.Solution_0_Test(input);
