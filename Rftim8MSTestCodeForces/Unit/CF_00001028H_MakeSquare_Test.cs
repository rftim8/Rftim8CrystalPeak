...
{
    [TestClass]
    public sealed class CF_00001028H_MakeSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001028H_MakeSquare));
        ...
        {
            bool result = CF_00001028H_MakeSquare.Solution_0_Test(input);
