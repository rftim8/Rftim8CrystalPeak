...
{
    [TestClass]
    public sealed class CF_00000981A_Antipalindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000981A_Antipalindrome));
        ...
        {
            bool result = CF_00000981A_Antipalindrome.Solution_0_Test(input);
