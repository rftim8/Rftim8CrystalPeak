...
{
    [TestClass]
    public sealed class CF_00000507A_AmrAndMusic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000507A_AmrAndMusic));
        ...
        {
            bool result = CF_00000507A_AmrAndMusic.Solution_0_Test(input);
