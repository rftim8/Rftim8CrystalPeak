...
{
    [TestClass]
    public sealed class CF_00000727D_TshirtsDistribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000727D_TshirtsDistribution));
        ...
        {
            bool result = CF_00000727D_TshirtsDistribution.Solution_0_Test(input);
