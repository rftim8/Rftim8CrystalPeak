...
{
    [TestClass]
    public sealed class CF_00001729E_GuessTheCycleSize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001729E_GuessTheCycleSize));
        ...
        {
            bool result = CF_00001729E_GuessTheCycleSize.Solution_0_Test(input);
