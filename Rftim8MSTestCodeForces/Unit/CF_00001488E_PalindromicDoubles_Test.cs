...
{
    [TestClass]
    public sealed class CF_00001488E_PalindromicDoubles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001488E_PalindromicDoubles));
        ...
        {
            bool result = CF_00001488E_PalindromicDoubles.Solution_0_Test(input);
