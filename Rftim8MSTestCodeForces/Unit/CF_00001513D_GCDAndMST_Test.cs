...
{
    [TestClass]
    public sealed class CF_00001513D_GCDAndMST_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001513D_GCDAndMST));
        ...
        {
            bool result = CF_00001513D_GCDAndMST.Solution_0_Test(input);
