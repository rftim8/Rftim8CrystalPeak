...
{
    [TestClass]
    public sealed class CF_00001349C_OracAndGameOfLife_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001349C_OracAndGameOfLife));
        ...
        {
            bool result = CF_00001349C_OracAndGameOfLife.Solution_0_Test(input);
