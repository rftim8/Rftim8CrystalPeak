...
{
    [TestClass]
    public sealed class CF_00000637D_RunningWithObstacles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000637D_RunningWithObstacles));
        ...
        {
            bool result = CF_00000637D_RunningWithObstacles.Solution_0_Test(input);
