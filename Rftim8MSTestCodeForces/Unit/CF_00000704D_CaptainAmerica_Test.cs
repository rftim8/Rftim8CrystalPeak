...
{
    [TestClass]
    public sealed class CF_00000704D_CaptainAmerica_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000704D_CaptainAmerica));
        ...
        {
            bool result = CF_00000704D_CaptainAmerica.Solution_0_Test(input);
