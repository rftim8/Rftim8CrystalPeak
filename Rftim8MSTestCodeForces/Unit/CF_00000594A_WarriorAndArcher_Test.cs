...
{
    [TestClass]
    public sealed class CF_00000594A_WarriorAndArcher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000594A_WarriorAndArcher));
        ...
        {
            bool result = CF_00000594A_WarriorAndArcher.Solution_0_Test(input);
