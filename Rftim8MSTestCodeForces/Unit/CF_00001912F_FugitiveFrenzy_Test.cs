...
{
    [TestClass]
    public sealed class CF_00001912F_FugitiveFrenzy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001912F_FugitiveFrenzy));
        ...
        {
            bool result = CF_00001912F_FugitiveFrenzy.Solution_0_Test(input);
