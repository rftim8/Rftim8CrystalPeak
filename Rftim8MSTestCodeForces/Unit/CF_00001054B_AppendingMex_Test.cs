...
{
    [TestClass]
    public sealed class CF_00001054B_AppendingMex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001054B_AppendingMex));
        ...
        {
            bool result = CF_00001054B_AppendingMex.Solution_0_Test(input);
