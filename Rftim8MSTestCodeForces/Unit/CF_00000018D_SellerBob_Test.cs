...
{
    [TestClass]
    public sealed class CF_00000018D_SellerBob_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000018D_SellerBob));
        ...
        {
            bool result = CF_00000018D_SellerBob.Solution_0_Test(input);
