...
{
    [TestClass]
    public sealed class CF_00000989E_ATranceOfNightfall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000989E_ATranceOfNightfall));
        ...
        {
            bool result = CF_00000989E_ATranceOfNightfall.Solution_0_Test(input);
