...
{
    [TestClass]
    public sealed class CF_00000630C_LuckyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630C_LuckyNumbers));
        ...
        {
            bool result = CF_00000630C_LuckyNumbers.Solution_0_Test(input);
