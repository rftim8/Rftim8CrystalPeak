...
{
    [TestClass]
    public sealed class CF_00000474B_Worms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000474B_Worms));
        ...
        {
            bool result = CF_00000474B_Worms.Solution_0_Test(input);
