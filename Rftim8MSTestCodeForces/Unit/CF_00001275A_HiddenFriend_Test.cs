...
{
    [TestClass]
    public sealed class CF_00001275A_HiddenFriend_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001275A_HiddenFriend));
        ...
        {
            bool result = CF_00001275A_HiddenFriend.Solution_0_Test(input);
