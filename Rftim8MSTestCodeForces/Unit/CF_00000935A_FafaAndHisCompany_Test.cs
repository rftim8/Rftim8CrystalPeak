...
{
    [TestClass]
    public sealed class CF_00000935A_FafaAndHisCompany_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000935A_FafaAndHisCompany));
        ...
        {
            bool result = CF_00000935A_FafaAndHisCompany.Solution_0_Test(input);
