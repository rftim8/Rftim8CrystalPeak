...
{
    [TestClass]
    public sealed class CF_00001488D_ProblemsolvingMarathon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001488D_ProblemsolvingMarathon));
        ...
        {
            bool result = CF_00001488D_ProblemsolvingMarathon.Solution_0_Test(input);
