...
{
    [TestClass]
    public sealed class CF_00001608C_GameMaster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001608C_GameMaster));
        ...
        {
            bool result = CF_00001608C_GameMaster.Solution_0_Test(input);
