...
{
    [TestClass]
    public sealed class CF_00000188D_Asterisks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000188D_Asterisks));
        ...
        {
            bool result = CF_00000188D_Asterisks.Solution_0_Test(input);
