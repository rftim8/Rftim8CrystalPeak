...
{
    [TestClass]
    public sealed class CF_00000588B_DuffInLove_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000588B_DuffInLove));
        ...
        {
            bool result = CF_00000588B_DuffInLove.Solution_0_Test(input);
