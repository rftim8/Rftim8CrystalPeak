...
{
    [TestClass]
    public sealed class CF_00001180A_AlexAndARhombus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001180A_AlexAndARhombus));
        ...
        {
            bool result = CF_00001180A_AlexAndARhombus.Solution_0_Test(input);
