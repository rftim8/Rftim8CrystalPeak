...
{
    [TestClass]
    public sealed class CF_00000762E_RadioStations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000762E_RadioStations));
        ...
        {
            bool result = CF_00000762E_RadioStations.Solution_0_Test(input);
