...
{
    [TestClass]
    public sealed class CF_00001747C_SwapGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001747C_SwapGame));
        ...
        {
            bool result = CF_00001747C_SwapGame.Solution_0_Test(input);
