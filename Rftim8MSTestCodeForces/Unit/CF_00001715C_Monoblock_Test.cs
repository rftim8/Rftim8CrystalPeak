...
{
    [TestClass]
    public sealed class CF_00001715C_Monoblock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001715C_Monoblock));
        ...
        {
            bool result = CF_00001715C_Monoblock.Solution_0_Test(input);
