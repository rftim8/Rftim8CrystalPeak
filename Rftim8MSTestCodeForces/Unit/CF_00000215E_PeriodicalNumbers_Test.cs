...
{
    [TestClass]
    public sealed class CF_00000215E_PeriodicalNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000215E_PeriodicalNumbers));
        ...
        {
            bool result = CF_00000215E_PeriodicalNumbers.Solution_0_Test(input);
