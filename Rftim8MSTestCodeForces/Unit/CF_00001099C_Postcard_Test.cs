...
{
    [TestClass]
    public sealed class CF_00001099C_Postcard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001099C_Postcard));
        ...
        {
            bool result = CF_00001099C_Postcard.Solution_0_Test(input);
