...
{
    [TestClass]
    public sealed class CF_00001584B_ColoringRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001584B_ColoringRectangles));
        ...
        {
            bool result = CF_00001584B_ColoringRectangles.Solution_0_Test(input);
