...
{
    [TestClass]
    public sealed class CF_00001769C2_TwistII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001769C2_TwistII));
        ...
        {
            bool result = CF_00001769C2_TwistII.Solution_0_Test(input);
