...
{
    [TestClass]
    public sealed class CF_00001103D_ProfessionalLayer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001103D_ProfessionalLayer));
        ...
        {
            bool result = CF_00001103D_ProfessionalLayer.Solution_0_Test(input);
