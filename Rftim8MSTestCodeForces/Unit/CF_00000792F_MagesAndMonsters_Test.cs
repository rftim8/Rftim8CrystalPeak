...
{
    [TestClass]
    public sealed class CF_00000792F_MagesAndMonsters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000792F_MagesAndMonsters));
        ...
        {
            bool result = CF_00000792F_MagesAndMonsters.Solution_0_Test(input);
