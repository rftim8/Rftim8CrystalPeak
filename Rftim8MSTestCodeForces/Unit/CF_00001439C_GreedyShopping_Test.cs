...
{
    [TestClass]
    public sealed class CF_00001439C_GreedyShopping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001439C_GreedyShopping));
        ...
        {
            bool result = CF_00001439C_GreedyShopping.Solution_0_Test(input);
