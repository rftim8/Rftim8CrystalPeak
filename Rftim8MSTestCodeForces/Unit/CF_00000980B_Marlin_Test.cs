...
{
    [TestClass]
    public sealed class CF_00000980B_Marlin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000980B_Marlin));
        ...
        {
            bool result = CF_00000980B_Marlin.Solution_0_Test(input);
