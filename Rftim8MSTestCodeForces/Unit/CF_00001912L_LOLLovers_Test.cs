...
{
    [TestClass]
    public sealed class CF_00001912L_LOLLovers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001912L_LOLLovers));
        ...
        {
            bool result = CF_00001912L_LOLLovers.Solution_0_Test(input);
