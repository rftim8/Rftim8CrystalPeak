...
{
    [TestClass]
    public sealed class CF_00000405C_UnusualProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000405C_UnusualProduct));
        ...
        {
            bool result = CF_00000405C_UnusualProduct.Solution_0_Test(input);
