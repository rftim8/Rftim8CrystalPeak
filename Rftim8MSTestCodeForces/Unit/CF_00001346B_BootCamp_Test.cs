...
{
    [TestClass]
    public sealed class CF_00001346B_BootCamp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001346B_BootCamp));
        ...
        {
            bool result = CF_00001346B_BootCamp.Solution_0_Test(input);
