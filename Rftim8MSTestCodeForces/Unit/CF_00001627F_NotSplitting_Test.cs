...
{
    [TestClass]
    public sealed class CF_00001627F_NotSplitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001627F_NotSplitting));
        ...
        {
            bool result = CF_00001627F_NotSplitting.Solution_0_Test(input);
