...
{
    [TestClass]
    public sealed class CF_00000788E_NewTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000788E_NewTask));
        ...
        {
            bool result = CF_00000788E_NewTask.Solution_0_Test(input);
