...
{
    [TestClass]
    public sealed class CF_00001881B_ThreeThreadlets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001881B_ThreeThreadlets));
        ...
        {
            bool result = CF_00001881B_ThreeThreadlets.Solution_0_Test(input);
