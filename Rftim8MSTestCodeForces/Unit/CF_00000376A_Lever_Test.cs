...
{
    [TestClass]
    public sealed class CF_00000376A_Lever_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000376A_Lever));
        ...
        {
            bool result = CF_00000376A_Lever.Solution_0_Test(input);
