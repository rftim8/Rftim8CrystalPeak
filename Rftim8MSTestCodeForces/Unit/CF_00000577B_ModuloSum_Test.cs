...
{
    [TestClass]
    public sealed class CF_00000577B_ModuloSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000577B_ModuloSum));
        ...
        {
            bool result = CF_00000577B_ModuloSum.Solution_0_Test(input);
