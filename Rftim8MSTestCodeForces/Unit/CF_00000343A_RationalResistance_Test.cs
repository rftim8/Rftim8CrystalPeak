...
{
    [TestClass]
    public sealed class CF_00000343A_RationalResistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000343A_RationalResistance));
        ...
        {
            bool result = CF_00000343A_RationalResistance.Solution_0_Test(input);
