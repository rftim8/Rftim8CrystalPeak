...
{
    [TestClass]
    public sealed class CF_00001759G_RestoreThePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001759G_RestoreThePermutation));
        ...
        {
            bool result = CF_00001759G_RestoreThePermutation.Solution_0_Test(input);
