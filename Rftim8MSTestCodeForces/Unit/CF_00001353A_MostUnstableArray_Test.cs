...
{
    [TestClass]
    public sealed class CF_00001353A_MostUnstableArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001353A_MostUnstableArray));
        ...
        {
            bool result = CF_00001353A_MostUnstableArray.Solution_0_Test(input);
