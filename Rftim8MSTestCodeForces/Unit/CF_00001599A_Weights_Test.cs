...
{
    [TestClass]
    public sealed class CF_00001599A_Weights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001599A_Weights));
        ...
        {
            bool result = CF_00001599A_Weights.Solution_0_Test(input);
