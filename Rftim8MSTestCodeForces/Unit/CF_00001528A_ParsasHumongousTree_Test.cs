...
{
    [TestClass]
    public sealed class CF_00001528A_ParsasHumongousTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001528A_ParsasHumongousTree));
        ...
        {
            bool result = CF_00001528A_ParsasHumongousTree.Solution_0_Test(input);
