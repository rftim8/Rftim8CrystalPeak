...
{
    [TestClass]
    public sealed class CF_00001821A_Matching_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001821A_Matching));
        ...
        {
            bool result = CF_00001821A_Matching.Solution_0_Test(input);
