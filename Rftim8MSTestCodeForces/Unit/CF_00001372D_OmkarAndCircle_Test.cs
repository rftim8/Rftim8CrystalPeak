...
{
    [TestClass]
    public sealed class CF_00001372D_OmkarAndCircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001372D_OmkarAndCircle));
        ...
        {
            bool result = CF_00001372D_OmkarAndCircle.Solution_0_Test(input);
