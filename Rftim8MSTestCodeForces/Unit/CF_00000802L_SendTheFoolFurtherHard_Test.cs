...
{
    [TestClass]
    public sealed class CF_00000802L_SendTheFoolFurtherHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802L_SendTheFoolFurtherHard));
        ...
        {
            bool result = CF_00000802L_SendTheFoolFurtherHard.Solution_0_Test(input);
