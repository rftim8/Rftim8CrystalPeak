...
{
    [TestClass]
    public sealed class CF_00001812F_Factorization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001812F_Factorization));
        ...
        {
            bool result = CF_00001812F_Factorization.Solution_0_Test(input);
