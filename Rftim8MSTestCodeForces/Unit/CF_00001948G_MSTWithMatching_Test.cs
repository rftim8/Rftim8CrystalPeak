...
{
    [TestClass]
    public sealed class CF_00001948G_MSTWithMatching_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001948G_MSTWithMatching));
        ...
        {
            bool result = CF_00001948G_MSTWithMatching.Solution_0_Test(input);
