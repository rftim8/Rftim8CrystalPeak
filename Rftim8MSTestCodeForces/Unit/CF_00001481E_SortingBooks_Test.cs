...
{
    [TestClass]
    public sealed class CF_00001481E_SortingBooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001481E_SortingBooks));
        ...
        {
            bool result = CF_00001481E_SortingBooks.Solution_0_Test(input);
