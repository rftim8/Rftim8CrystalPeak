...
{
    [TestClass]
    public sealed class CF_00000117D_NotQuickTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000117D_NotQuickTransformation));
        ...
        {
            bool result = CF_00000117D_NotQuickTransformation.Solution_0_Test(input);
