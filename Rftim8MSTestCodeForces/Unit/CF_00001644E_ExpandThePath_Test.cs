...
{
    [TestClass]
    public sealed class CF_00001644E_ExpandThePath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001644E_ExpandThePath));
        ...
        {
            bool result = CF_00001644E_ExpandThePath.Solution_0_Test(input);
