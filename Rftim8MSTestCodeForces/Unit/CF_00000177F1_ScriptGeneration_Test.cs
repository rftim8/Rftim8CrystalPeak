...
{
    [TestClass]
    public sealed class CF_00000177F1_ScriptGeneration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000177F1_ScriptGeneration));
        ...
        {
            bool result = CF_00000177F1_ScriptGeneration.Solution_0_Test(input);
