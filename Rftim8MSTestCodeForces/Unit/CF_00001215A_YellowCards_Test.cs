...
{
    [TestClass]
    public sealed class CF_00001215A_YellowCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001215A_YellowCards));
        ...
        {
            bool result = CF_00001215A_YellowCards.Solution_0_Test(input);
