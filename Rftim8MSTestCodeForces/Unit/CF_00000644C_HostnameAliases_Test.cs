...
{
    [TestClass]
    public sealed class CF_00000644C_HostnameAliases_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000644C_HostnameAliases));
        ...
        {
            bool result = CF_00000644C_HostnameAliases.Solution_0_Test(input);
