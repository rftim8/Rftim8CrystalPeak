...
{
    [TestClass]
    public sealed class CF_00000906E_Reverses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000906E_Reverses));
        ...
        {
            bool result = CF_00000906E_Reverses.Solution_0_Test(input);
