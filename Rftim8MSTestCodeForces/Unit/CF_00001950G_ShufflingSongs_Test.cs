...
{
    [TestClass]
    public sealed class CF_00001950G_ShufflingSongs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001950G_ShufflingSongs));
        ...
        {
            bool result = CF_00001950G_ShufflingSongs.Solution_0_Test(input);
