...
{
    [TestClass]
    public sealed class CF_00000409H_APlusBStrikesBack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000409H_APlusBStrikesBack));
        ...
        {
            bool result = CF_00000409H_APlusBStrikesBack.Solution_0_Test(input);
