...
{
    [TestClass]
    public sealed class CF_00001574C_SlayTheDragon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001574C_SlayTheDragon));
        ...
        {
            bool result = CF_00001574C_SlayTheDragon.Solution_0_Test(input);
