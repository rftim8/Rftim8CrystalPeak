...
{
    [TestClass]
    public sealed class CF_00001535E_GoldTransfer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001535E_GoldTransfer));
        ...
        {
            bool result = CF_00001535E_GoldTransfer.Solution_0_Test(input);
