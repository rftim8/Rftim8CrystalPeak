...
{
    [TestClass]
    public sealed class CF_00001823F_RandomWalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001823F_RandomWalk));
        ...
        {
            bool result = CF_00001823F_RandomWalk.Solution_0_Test(input);
