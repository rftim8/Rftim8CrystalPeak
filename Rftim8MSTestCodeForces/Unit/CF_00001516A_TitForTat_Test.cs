...
{
    [TestClass]
    public sealed class CF_00001516A_TitForTat_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001516A_TitForTat));
        ...
        {
            bool result = CF_00001516A_TitForTat.Solution_0_Test(input);
