...
{
    [TestClass]
    public sealed class CF_00000660F_BearAndBowling4_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000660F_BearAndBowling4));
        ...
        {
            bool result = CF_00000660F_BearAndBowling4.Solution_0_Test(input);
