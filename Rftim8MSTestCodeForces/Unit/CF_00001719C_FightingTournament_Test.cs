...
{
    [TestClass]
    public sealed class CF_00001719C_FightingTournament_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001719C_FightingTournament));
        ...
        {
            bool result = CF_00001719C_FightingTournament.Solution_0_Test(input);
