...
{
    [TestClass]
    public sealed class CF_00001194G_AnotherMemeProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001194G_AnotherMemeProblem));
        ...
        {
            bool result = CF_00001194G_AnotherMemeProblem.Solution_0_Test(input);
