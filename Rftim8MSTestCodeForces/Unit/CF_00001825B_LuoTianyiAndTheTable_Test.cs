...
{
    [TestClass]
    public sealed class CF_00001825B_LuoTianyiAndTheTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001825B_LuoTianyiAndTheTable));
        ...
        {
            bool result = CF_00001825B_LuoTianyiAndTheTable.Solution_0_Test(input);
