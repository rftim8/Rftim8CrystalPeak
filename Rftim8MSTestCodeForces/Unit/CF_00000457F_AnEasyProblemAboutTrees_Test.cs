...
{
    [TestClass]
    public sealed class CF_00000457F_AnEasyProblemAboutTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000457F_AnEasyProblemAboutTrees));
        ...
        {
            bool result = CF_00000457F_AnEasyProblemAboutTrees.Solution_0_Test(input);
