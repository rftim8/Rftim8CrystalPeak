...
{
    [TestClass]
    public sealed class CF_00001495F_Squares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001495F_Squares));
        ...
        {
            bool result = CF_00001495F_Squares.Solution_0_Test(input);
