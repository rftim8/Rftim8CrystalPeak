...
{
    [TestClass]
    public sealed class CF_00000162C_PrimeFactorization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000162C_PrimeFactorization));
        ...
        {
            bool result = CF_00000162C_PrimeFactorization.Solution_0_Test(input);
