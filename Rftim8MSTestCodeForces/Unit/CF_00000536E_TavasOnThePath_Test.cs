...
{
    [TestClass]
    public sealed class CF_00000536E_TavasOnThePath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000536E_TavasOnThePath));
        ...
        {
            bool result = CF_00000536E_TavasOnThePath.Solution_0_Test(input);
