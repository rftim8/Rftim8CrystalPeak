...
{
    [TestClass]
    public sealed class CF_00000832C_StrangeRadiation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000832C_StrangeRadiation));
        ...
        {
            bool result = CF_00000832C_StrangeRadiation.Solution_0_Test(input);
