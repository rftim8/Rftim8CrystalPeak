...
{
    [TestClass]
    public sealed class CF_00001454C_SequenceTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001454C_SequenceTransformation));
        ...
        {
            bool result = CF_00001454C_SequenceTransformation.Solution_0_Test(input);
