...
{
    [TestClass]
    public sealed class CF_00000981C_UsefulDecomposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000981C_UsefulDecomposition));
        ...
        {
            bool result = CF_00000981C_UsefulDecomposition.Solution_0_Test(input);
