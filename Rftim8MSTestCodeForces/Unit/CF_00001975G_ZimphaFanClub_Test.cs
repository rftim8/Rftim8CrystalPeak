...
{
    [TestClass]
    public sealed class CF_00001975G_ZimphaFanClub_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001975G_ZimphaFanClub));
        ...
        {
            bool result = CF_00001975G_ZimphaFanClub.Solution_0_Test(input);
