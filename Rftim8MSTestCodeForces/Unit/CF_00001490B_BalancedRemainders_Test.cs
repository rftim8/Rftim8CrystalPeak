...
{
    [TestClass]
    public sealed class CF_00001490B_BalancedRemainders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001490B_BalancedRemainders));
        ...
        {
            bool result = CF_00001490B_BalancedRemainders.Solution_0_Test(input);
