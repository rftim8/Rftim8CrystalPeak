...
{
    [TestClass]
    public sealed class CF_00001054A_ElevatorOrStairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001054A_ElevatorOrStairs));
        ...
        {
            bool result = CF_00001054A_ElevatorOrStairs.Solution_0_Test(input);
