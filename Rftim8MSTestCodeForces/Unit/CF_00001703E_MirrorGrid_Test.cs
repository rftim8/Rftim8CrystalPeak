...
{
    [TestClass]
    public sealed class CF_00001703E_MirrorGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001703E_MirrorGrid));
        ...
        {
            bool result = CF_00001703E_MirrorGrid.Solution_0_Test(input);
