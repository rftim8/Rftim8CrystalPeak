...
{
    [TestClass]
    public sealed class CF_00001492B_CardDeck_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001492B_CardDeck));
        ...
        {
            bool result = CF_00001492B_CardDeck.Solution_0_Test(input);
