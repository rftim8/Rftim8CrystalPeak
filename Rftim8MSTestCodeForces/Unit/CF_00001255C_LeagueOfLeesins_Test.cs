...
{
    [TestClass]
    public sealed class CF_00001255C_LeagueOfLeesins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001255C_LeagueOfLeesins));
        ...
        {
            bool result = CF_00001255C_LeagueOfLeesins.Solution_0_Test(input);
