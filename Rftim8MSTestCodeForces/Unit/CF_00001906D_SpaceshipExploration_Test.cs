...
{
    [TestClass]
    public sealed class CF_00001906D_SpaceshipExploration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001906D_SpaceshipExploration));
        ...
        {
            bool result = CF_00001906D_SpaceshipExploration.Solution_0_Test(input);
