...
{
    [TestClass]
    public sealed class CF_00001139F_DishShopping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001139F_DishShopping));
        ...
        {
            bool result = CF_00001139F_DishShopping.Solution_0_Test(input);
