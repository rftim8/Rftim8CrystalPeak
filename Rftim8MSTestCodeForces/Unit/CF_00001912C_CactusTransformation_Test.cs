...
{
    [TestClass]
    public sealed class CF_00001912C_CactusTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001912C_CactusTransformation));
        ...
        {
            bool result = CF_00001912C_CactusTransformation.Solution_0_Test(input);
