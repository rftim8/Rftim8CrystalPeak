...
{
    [TestClass]
    public sealed class CF_00001348D_PhoenixAndScience_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001348D_PhoenixAndScience));
        ...
        {
            bool result = CF_00001348D_PhoenixAndScience.Solution_0_Test(input);
