...
{
    [TestClass]
    public sealed class CF_00001571A_SequenceOfComparisons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001571A_SequenceOfComparisons));
        ...
        {
            bool result = CF_00001571A_SequenceOfComparisons.Solution_0_Test(input);
