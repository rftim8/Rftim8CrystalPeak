...
{
    [TestClass]
    public sealed class CF_00000232E_QuickTortoise_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000232E_QuickTortoise));
        ...
        {
            bool result = CF_00000232E_QuickTortoise.Solution_0_Test(input);
