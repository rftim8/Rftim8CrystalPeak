...
{
    [TestClass]
    public sealed class CF_00001832C_ContrastValue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001832C_ContrastValue));
        ...
        {
            bool result = CF_00001832C_ContrastValue.Solution_0_Test(input);
