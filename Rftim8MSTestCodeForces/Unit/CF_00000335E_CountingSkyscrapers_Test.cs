...
{
    [TestClass]
    public sealed class CF_00000335E_CountingSkyscrapers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000335E_CountingSkyscrapers));
        ...
        {
            bool result = CF_00000335E_CountingSkyscrapers.Solution_0_Test(input);
