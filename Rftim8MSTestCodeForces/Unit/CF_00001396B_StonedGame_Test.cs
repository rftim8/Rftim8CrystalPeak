...
{
    [TestClass]
    public sealed class CF_00001396B_StonedGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001396B_StonedGame));
        ...
        {
            bool result = CF_00001396B_StonedGame.Solution_0_Test(input);
