...
{
    [TestClass]
    public sealed class CF_00001303B_NationalProject_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001303B_NationalProject));
        ...
        {
            bool result = CF_00001303B_NationalProject.Solution_0_Test(input);
