...
{
    [TestClass]
    public sealed class CF_00001612F_ArmorAndWeapons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001612F_ArmorAndWeapons));
        ...
        {
            bool result = CF_00001612F_ArmorAndWeapons.Solution_0_Test(input);
