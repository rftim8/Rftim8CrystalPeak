...
{
    [TestClass]
    public sealed class CF_00000257E_GreedyElevator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000257E_GreedyElevator));
        ...
        {
            bool result = CF_00000257E_GreedyElevator.Solution_0_Test(input);
