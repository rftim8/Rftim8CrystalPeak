...
{
    [TestClass]
    public sealed class CF_00000120J_MinimumSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000120J_MinimumSum));
        ...
        {
            bool result = CF_00000120J_MinimumSum.Solution_0_Test(input);
