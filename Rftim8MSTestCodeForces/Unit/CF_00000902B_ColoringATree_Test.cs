...
{
    [TestClass]
    public sealed class CF_00000902B_ColoringATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000902B_ColoringATree));
        ...
        {
            bool result = CF_00000902B_ColoringATree.Solution_0_Test(input);
