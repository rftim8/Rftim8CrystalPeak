...
{
    [TestClass]
    public sealed class CF_00000042D_StrangeTown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000042D_StrangeTown));
        ...
        {
            bool result = CF_00000042D_StrangeTown.Solution_0_Test(input);
