...
{
    [TestClass]
    public sealed class CF_00000926C_IsThisAZebra_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000926C_IsThisAZebra));
        ...
        {
            bool result = CF_00000926C_IsThisAZebra.Solution_0_Test(input);
