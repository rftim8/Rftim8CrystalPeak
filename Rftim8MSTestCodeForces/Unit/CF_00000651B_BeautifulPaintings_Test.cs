...
{
    [TestClass]
    public sealed class CF_00000651B_BeautifulPaintings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000651B_BeautifulPaintings));
        ...
        {
            bool result = CF_00000651B_BeautifulPaintings.Solution_0_Test(input);
