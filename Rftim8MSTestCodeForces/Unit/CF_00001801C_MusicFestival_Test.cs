...
{
    [TestClass]
    public sealed class CF_00001801C_MusicFestival_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001801C_MusicFestival));
        ...
        {
            bool result = CF_00001801C_MusicFestival.Solution_0_Test(input);
