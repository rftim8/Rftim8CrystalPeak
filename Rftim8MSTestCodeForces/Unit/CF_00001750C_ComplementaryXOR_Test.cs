...
{
    [TestClass]
    public sealed class CF_00001750C_ComplementaryXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001750C_ComplementaryXOR));
        ...
        {
            bool result = CF_00001750C_ComplementaryXOR.Solution_0_Test(input);
