...
{
    [TestClass]
    public sealed class CF_00000267A_Subtractions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000267A_Subtractions));
        ...
        {
            bool result = CF_00000267A_Subtractions.Solution_0_Test(input);
