...
{
    [TestClass]
    public sealed class CF_00001669F_EatingCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001669F_EatingCandies));
        ...
        {
            bool result = CF_00001669F_EatingCandies.Solution_0_Test(input);
