...
{
    [TestClass]
    public sealed class CF_00000293A_WeirdGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000293A_WeirdGame));
        ...
        {
            bool result = CF_00000293A_WeirdGame.Solution_0_Test(input);
