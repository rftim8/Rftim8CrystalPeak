...
{
    [TestClass]
    public sealed class CF_00001704G_MioAndLuckyArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001704G_MioAndLuckyArray));
        ...
        {
            bool result = CF_00001704G_MioAndLuckyArray.Solution_0_Test(input);
