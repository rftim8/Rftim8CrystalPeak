...
{
    [TestClass]
    public sealed class CF_00001139C_EdgyTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001139C_EdgyTrees));
        ...
        {
            bool result = CF_00001139C_EdgyTrees.Solution_0_Test(input);
