...
{
    [TestClass]
    public sealed class CF_00001356A5_DistinguishZFromZ_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001356A5_DistinguishZFromZ));
        ...
        {
            bool result = CF_00001356A5_DistinguishZFromZ.Solution_0_Test(input);
