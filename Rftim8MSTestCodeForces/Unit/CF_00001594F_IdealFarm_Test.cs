...
{
    [TestClass]
    public sealed class CF_00001594F_IdealFarm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001594F_IdealFarm));
        ...
        {
            bool result = CF_00001594F_IdealFarm.Solution_0_Test(input);
