...
{
    [TestClass]
    public sealed class CF_00001033D_Divisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001033D_Divisors));
        ...
        {
            bool result = CF_00001033D_Divisors.Solution_0_Test(input);
