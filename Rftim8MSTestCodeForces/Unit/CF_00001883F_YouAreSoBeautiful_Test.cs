...
{
    [TestClass]
    public sealed class CF_00001883F_YouAreSoBeautiful_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001883F_YouAreSoBeautiful));
        ...
        {
            bool result = CF_00001883F_YouAreSoBeautiful.Solution_0_Test(input);
