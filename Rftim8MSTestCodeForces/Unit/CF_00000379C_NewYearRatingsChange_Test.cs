...
{
    [TestClass]
    public sealed class CF_00000379C_NewYearRatingsChange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000379C_NewYearRatingsChange));
        ...
        {
            bool result = CF_00000379C_NewYearRatingsChange.Solution_0_Test(input);
