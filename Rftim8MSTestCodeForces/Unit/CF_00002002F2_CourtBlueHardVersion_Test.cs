...
{
    [TestClass]
    public sealed class CF_00002002F2_CourtBlueHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002002F2_CourtBlueHardVersion));
        ...
        {
            bool result = CF_00002002F2_CourtBlueHardVersion.Solution_0_Test(input);
