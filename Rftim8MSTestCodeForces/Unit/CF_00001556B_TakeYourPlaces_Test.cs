...
{
    [TestClass]
    public sealed class CF_00001556B_TakeYourPlaces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001556B_TakeYourPlaces));
        ...
        {
            bool result = CF_00001556B_TakeYourPlaces.Solution_0_Test(input);
