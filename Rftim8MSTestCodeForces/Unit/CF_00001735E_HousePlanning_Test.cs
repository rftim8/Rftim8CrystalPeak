...
{
    [TestClass]
    public sealed class CF_00001735E_HousePlanning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001735E_HousePlanning));
        ...
        {
            bool result = CF_00001735E_HousePlanning.Solution_0_Test(input);
