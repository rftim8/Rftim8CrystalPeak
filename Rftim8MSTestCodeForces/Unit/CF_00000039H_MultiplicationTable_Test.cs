...
{
    [TestClass]
    public sealed class CF_00000039H_MultiplicationTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000039H_MultiplicationTable));
        ...
        {
            bool result = CF_00000039H_MultiplicationTable.Solution_0_Test(input);
