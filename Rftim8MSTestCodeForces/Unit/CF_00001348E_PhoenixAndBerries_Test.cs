...
{
    [TestClass]
    public sealed class CF_00001348E_PhoenixAndBerries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001348E_PhoenixAndBerries));
        ...
        {
            bool result = CF_00001348E_PhoenixAndBerries.Solution_0_Test(input);
