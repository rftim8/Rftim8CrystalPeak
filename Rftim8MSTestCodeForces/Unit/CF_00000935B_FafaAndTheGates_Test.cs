...
{
    [TestClass]
    public sealed class CF_00000935B_FafaAndTheGates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000935B_FafaAndTheGates));
        ...
        {
            bool result = CF_00000935B_FafaAndTheGates.Solution_0_Test(input);
