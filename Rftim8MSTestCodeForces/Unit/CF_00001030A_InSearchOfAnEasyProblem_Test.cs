...
{
    [TestClass]
    public sealed class CF_00001030A_InSearchOfAnEasyProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001030A_InSearchOfAnEasyProblem));
        ...
        {
            bool result = CF_00001030A_InSearchOfAnEasyProblem.Solution_0_Test(input);
