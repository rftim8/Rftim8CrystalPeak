...
{
    [TestClass]
    public sealed class CF_00000737E_TanyaIs5_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000737E_TanyaIs5));
        ...
        {
            bool result = CF_00000737E_TanyaIs5.Solution_0_Test(input);
