...
{
    [TestClass]
    public sealed class CF_00000442A_BoryaAndHanabi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000442A_BoryaAndHanabi));
        ...
        {
            bool result = CF_00000442A_BoryaAndHanabi.Solution_0_Test(input);
