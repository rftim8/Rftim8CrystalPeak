...
{
    [TestClass]
    public sealed class CF_00001276F_AsteriskSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001276F_AsteriskSubstrings));
        ...
        {
            bool result = CF_00001276F_AsteriskSubstrings.Solution_0_Test(input);
