...
{
    [TestClass]
    public sealed class CF_00000929C_BeautifulTeam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000929C_BeautifulTeam));
        ...
        {
            bool result = CF_00000929C_BeautifulTeam.Solution_0_Test(input);
