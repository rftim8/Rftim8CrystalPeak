...
{
    [TestClass]
    public sealed class CF_00001367E_NecklaceAssembly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001367E_NecklaceAssembly));
        ...
        {
            bool result = CF_00001367E_NecklaceAssembly.Solution_0_Test(input);
