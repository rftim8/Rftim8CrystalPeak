...
{
    [TestClass]
    public sealed class CF_00001394B_BoboniuWalksOnGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001394B_BoboniuWalksOnGraph));
        ...
        {
            bool result = CF_00001394B_BoboniuWalksOnGraph.Solution_0_Test(input);
