...
{
    [TestClass]
    public sealed class CF_00001677B_TokitsukazeAndMeeting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001677B_TokitsukazeAndMeeting));
        ...
        {
            bool result = CF_00001677B_TokitsukazeAndMeeting.Solution_0_Test(input);
