...
{
    [TestClass]
    public sealed class CF_00001898A_MilicaAndString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001898A_MilicaAndString));
        ...
        {
            bool result = CF_00001898A_MilicaAndString.Solution_0_Test(input);
