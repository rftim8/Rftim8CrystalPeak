...
{
    [TestClass]
    public sealed class CF_00001650B_DIVPlusMOD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001650B_DIVPlusMOD));
        ...
        {
            bool result = CF_00001650B_DIVPlusMOD.Solution_0_Test(input);
