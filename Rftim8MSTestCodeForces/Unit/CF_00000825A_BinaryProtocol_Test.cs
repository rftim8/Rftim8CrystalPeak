...
{
    [TestClass]
    public sealed class CF_00000825A_BinaryProtocol_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000825A_BinaryProtocol));
        ...
        {
            bool result = CF_00000825A_BinaryProtocol.Solution_0_Test(input);
