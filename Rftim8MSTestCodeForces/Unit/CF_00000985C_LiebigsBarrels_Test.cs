...
{
    [TestClass]
    public sealed class CF_00000985C_LiebigsBarrels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000985C_LiebigsBarrels));
        ...
        {
            bool result = CF_00000985C_LiebigsBarrels.Solution_0_Test(input);
