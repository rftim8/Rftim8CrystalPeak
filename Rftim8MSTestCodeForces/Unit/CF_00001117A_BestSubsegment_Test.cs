...
{
    [TestClass]
    public sealed class CF_00001117A_BestSubsegment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001117A_BestSubsegment));
        ...
        {
            bool result = CF_00001117A_BestSubsegment.Solution_0_Test(input);
