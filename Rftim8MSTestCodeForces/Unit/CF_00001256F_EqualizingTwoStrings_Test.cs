...
{
    [TestClass]
    public sealed class CF_00001256F_EqualizingTwoStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001256F_EqualizingTwoStrings));
        ...
        {
            bool result = CF_00001256F_EqualizingTwoStrings.Solution_0_Test(input);
