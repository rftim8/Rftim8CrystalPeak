...
{
    [TestClass]
    public sealed class CF_00001624B_MakeAP_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001624B_MakeAP));
        ...
        {
            bool result = CF_00001624B_MakeAP.Solution_0_Test(input);
