...
{
    [TestClass]
    public sealed class CF_00001009B_MinimumTernaryString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001009B_MinimumTernaryString));
        ...
        {
            bool result = CF_00001009B_MinimumTernaryString.Solution_0_Test(input);
