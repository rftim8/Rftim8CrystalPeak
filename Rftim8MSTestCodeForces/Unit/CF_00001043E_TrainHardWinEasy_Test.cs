...
{
    [TestClass]
    public sealed class CF_00001043E_TrainHardWinEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001043E_TrainHardWinEasy));
        ...
        {
            bool result = CF_00001043E_TrainHardWinEasy.Solution_0_Test(input);
