...
{
    [TestClass]
    public sealed class CF_00000859B_LazySecurityGuard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000859B_LazySecurityGuard));
        ...
        {
            bool result = CF_00000859B_LazySecurityGuard.Solution_0_Test(input);
