...
{
    [TestClass]
    public sealed class CF_00000963E_CirclesOfWaiting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000963E_CirclesOfWaiting));
        ...
        {
            bool result = CF_00000963E_CirclesOfWaiting.Solution_0_Test(input);
