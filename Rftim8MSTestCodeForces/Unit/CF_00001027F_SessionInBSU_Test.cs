...
{
    [TestClass]
    public sealed class CF_00001027F_SessionInBSU_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001027F_SessionInBSU));
        ...
        {
            bool result = CF_00001027F_SessionInBSU.Solution_0_Test(input);
