...
{
    [TestClass]
    public sealed class CF_00001573A_Countdown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001573A_Countdown));
        ...
        {
            bool result = CF_00001573A_Countdown.Solution_0_Test(input);
