...
{
    [TestClass]
    public sealed class CF_00001750F_Majority_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001750F_Majority));
        ...
        {
            bool result = CF_00001750F_Majority.Solution_0_Test(input);
