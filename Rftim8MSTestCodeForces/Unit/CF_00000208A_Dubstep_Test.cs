...
{
    [TestClass]
    public sealed class CF_00000208A_Dubstep_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000208A_Dubstep));
        ...
        {
            bool result = CF_00000208A_Dubstep.Solution_0_Test(input);
