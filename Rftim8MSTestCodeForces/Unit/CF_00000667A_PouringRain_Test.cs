...
{
    [TestClass]
    public sealed class CF_00000667A_PouringRain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000667A_PouringRain));
        ...
        {
            bool result = CF_00000667A_PouringRain.Solution_0_Test(input);
