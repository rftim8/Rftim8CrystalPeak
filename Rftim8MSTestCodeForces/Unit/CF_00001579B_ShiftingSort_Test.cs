...
{
    [TestClass]
    public sealed class CF_00001579B_ShiftingSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001579B_ShiftingSort));
        ...
        {
            bool result = CF_00001579B_ShiftingSort.Solution_0_Test(input);
