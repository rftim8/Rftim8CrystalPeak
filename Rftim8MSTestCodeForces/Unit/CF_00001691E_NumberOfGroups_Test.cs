...
{
    [TestClass]
    public sealed class CF_00001691E_NumberOfGroups_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001691E_NumberOfGroups));
        ...
        {
            bool result = CF_00001691E_NumberOfGroups.Solution_0_Test(input);
