...
{
    [TestClass]
    public sealed class CF_00001157D_NProblemsDuringKDays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001157D_NProblemsDuringKDays));
        ...
        {
            bool result = CF_00001157D_NProblemsDuringKDays.Solution_0_Test(input);
