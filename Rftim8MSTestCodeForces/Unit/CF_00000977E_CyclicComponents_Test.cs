...
{
    [TestClass]
    public sealed class CF_00000977E_CyclicComponents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000977E_CyclicComponents));
        ...
        {
            bool result = CF_00000977E_CyclicComponents.Solution_0_Test(input);
