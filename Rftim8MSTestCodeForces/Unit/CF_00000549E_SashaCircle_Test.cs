...
{
    [TestClass]
    public sealed class CF_00000549E_SashaCircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000549E_SashaCircle));
        ...
        {
            bool result = CF_00000549E_SashaCircle.Solution_0_Test(input);
