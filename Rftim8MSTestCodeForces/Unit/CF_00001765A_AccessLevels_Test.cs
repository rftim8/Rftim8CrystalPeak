...
{
    [TestClass]
    public sealed class CF_00001765A_AccessLevels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001765A_AccessLevels));
        ...
        {
            bool result = CF_00001765A_AccessLevels.Solution_0_Test(input);
