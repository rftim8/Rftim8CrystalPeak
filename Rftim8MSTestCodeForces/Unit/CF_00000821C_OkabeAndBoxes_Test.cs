...
{
    [TestClass]
    public sealed class CF_00000821C_OkabeAndBoxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000821C_OkabeAndBoxes));
        ...
        {
            bool result = CF_00000821C_OkabeAndBoxes.Solution_0_Test(input);
