...
{
    [TestClass]
    public sealed class CF_00000838F_ExpectedEarnings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000838F_ExpectedEarnings));
        ...
        {
            bool result = CF_00000838F_ExpectedEarnings.Solution_0_Test(input);
