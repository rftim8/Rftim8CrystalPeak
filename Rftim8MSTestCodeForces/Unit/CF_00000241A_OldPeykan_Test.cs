...
{
    [TestClass]
    public sealed class CF_00000241A_OldPeykan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000241A_OldPeykan));
        ...
        {
            bool result = CF_00000241A_OldPeykan.Solution_0_Test(input);
