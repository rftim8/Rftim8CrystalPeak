...
{
    [TestClass]
    public sealed class CF_00000332C_StudentsRevenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000332C_StudentsRevenge));
        ...
        {
            bool result = CF_00000332C_StudentsRevenge.Solution_0_Test(input);
