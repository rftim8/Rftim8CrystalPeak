...
{
    [TestClass]
    public sealed class CF_00001450F_TheStrugglingContestant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001450F_TheStrugglingContestant));
        ...
        {
            bool result = CF_00001450F_TheStrugglingContestant.Solution_0_Test(input);
