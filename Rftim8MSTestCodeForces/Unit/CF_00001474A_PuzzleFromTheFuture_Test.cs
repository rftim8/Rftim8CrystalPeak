...
{
    [TestClass]
    public sealed class CF_00001474A_PuzzleFromTheFuture_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001474A_PuzzleFromTheFuture));
        ...
        {
            bool result = CF_00001474A_PuzzleFromTheFuture.Solution_0_Test(input);
