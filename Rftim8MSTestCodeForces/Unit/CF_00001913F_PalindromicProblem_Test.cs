...
{
    [TestClass]
    public sealed class CF_00001913F_PalindromicProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001913F_PalindromicProblem));
        ...
        {
            bool result = CF_00001913F_PalindromicProblem.Solution_0_Test(input);
