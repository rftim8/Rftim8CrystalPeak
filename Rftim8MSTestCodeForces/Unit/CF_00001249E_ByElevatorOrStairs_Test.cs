...
{
    [TestClass]
    public sealed class CF_00001249E_ByElevatorOrStairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001249E_ByElevatorOrStairs));
        ...
        {
            bool result = CF_00001249E_ByElevatorOrStairs.Solution_0_Test(input);
