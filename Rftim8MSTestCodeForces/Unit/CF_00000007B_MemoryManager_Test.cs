...
{
    [TestClass]
    public sealed class CF_00000007B_MemoryManager_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000007B_MemoryManager));
        ...
        {
            bool result = CF_00000007B_MemoryManager.Solution_0_Test(input);
