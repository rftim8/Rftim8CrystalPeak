...
{
    [TestClass]
    public sealed class CF_00000238D_TapeProgrammin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000238D_TapeProgrammin));
        ...
        {
            bool result = CF_00000238D_TapeProgrammin.Solution_0_Test(input);
