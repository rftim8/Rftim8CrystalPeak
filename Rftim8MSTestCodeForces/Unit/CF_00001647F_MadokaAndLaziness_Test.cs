...
{
    [TestClass]
    public sealed class CF_00001647F_MadokaAndLaziness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001647F_MadokaAndLaziness));
        ...
        {
            bool result = CF_00001647F_MadokaAndLaziness.Solution_0_Test(input);
