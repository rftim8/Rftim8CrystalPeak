...
{
    [TestClass]
    public sealed class CF_00002000A_PrimaryTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002000A_PrimaryTask));
        ...
        {
            bool result = CF_00002000A_PrimaryTask.Solution_0_Test(input);
