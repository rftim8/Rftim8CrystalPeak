...
{
    [TestClass]
    public sealed class CF_00000203C_Photographer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000203C_Photographer));
        ...
        {
            bool result = CF_00000203C_Photographer.Solution_0_Test(input);
