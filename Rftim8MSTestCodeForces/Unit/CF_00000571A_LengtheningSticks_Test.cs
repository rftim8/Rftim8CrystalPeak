...
{
    [TestClass]
    public sealed class CF_00000571A_LengtheningSticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000571A_LengtheningSticks));
        ...
        {
            bool result = CF_00000571A_LengtheningSticks.Solution_0_Test(input);
