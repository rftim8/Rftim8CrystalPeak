...
{
    [TestClass]
    public sealed class CF_00000089E_FireAndIce_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000089E_FireAndIce));
        ...
        {
            bool result = CF_00000089E_FireAndIce.Solution_0_Test(input);
