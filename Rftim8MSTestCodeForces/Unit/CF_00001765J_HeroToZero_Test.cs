...
{
    [TestClass]
    public sealed class CF_00001765J_HeroToZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001765J_HeroToZero));
        ...
        {
            bool result = CF_00001765J_HeroToZero.Solution_0_Test(input);
