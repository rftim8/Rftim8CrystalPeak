...
{
    [TestClass]
    public sealed class CF_00000984B_Minesweeper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000984B_Minesweeper));
        ...
        {
            bool result = CF_00000984B_Minesweeper.Solution_0_Test(input);
