...
{
    [TestClass]
    public sealed class CF_00000315A_SerejaAndBottles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000315A_SerejaAndBottles));
        ...
        {
            bool result = CF_00000315A_SerejaAndBottles.Solution_0_Test(input);
