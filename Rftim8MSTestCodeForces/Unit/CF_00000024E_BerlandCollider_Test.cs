...
{
    [TestClass]
    public sealed class CF_00000024E_BerlandCollider_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000024E_BerlandCollider));
        ...
        {
            bool result = CF_00000024E_BerlandCollider.Solution_0_Test(input);
