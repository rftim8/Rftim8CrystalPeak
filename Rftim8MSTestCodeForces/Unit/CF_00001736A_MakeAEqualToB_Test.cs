...
{
    [TestClass]
    public sealed class CF_00001736A_MakeAEqualToB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001736A_MakeAEqualToB));
        ...
        {
            bool result = CF_00001736A_MakeAEqualToB.Solution_0_Test(input);
