...
{
    [TestClass]
    public sealed class CF_00000887E_LittleBrother_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000887E_LittleBrother));
        ...
        {
            bool result = CF_00000887E_LittleBrother.Solution_0_Test(input);
