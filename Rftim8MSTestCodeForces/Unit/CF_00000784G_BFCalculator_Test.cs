...
{
    [TestClass]
    public sealed class CF_00000784G_BFCalculator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000784G_BFCalculator));
        ...
        {
            bool result = CF_00000784G_BFCalculator.Solution_0_Test(input);
