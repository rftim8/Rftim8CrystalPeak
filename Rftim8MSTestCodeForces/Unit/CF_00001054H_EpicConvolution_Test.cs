...
{
    [TestClass]
    public sealed class CF_00001054H_EpicConvolution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001054H_EpicConvolution));
        ...
        {
            bool result = CF_00001054H_EpicConvolution.Solution_0_Test(input);
