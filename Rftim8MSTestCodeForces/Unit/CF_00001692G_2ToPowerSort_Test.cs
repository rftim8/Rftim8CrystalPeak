...
{
    [TestClass]
    public sealed class CF_00001692G_2ToPowerSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001692G_2ToPowerSort));
        ...
        {
            bool result = CF_00001692G_2ToPowerSort.Solution_0_Test(input);
