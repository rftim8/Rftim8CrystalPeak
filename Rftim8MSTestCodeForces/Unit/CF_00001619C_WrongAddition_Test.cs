...
{
    [TestClass]
    public sealed class CF_00001619C_WrongAddition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001619C_WrongAddition));
        ...
        {
            bool result = CF_00001619C_WrongAddition.Solution_0_Test(input);
