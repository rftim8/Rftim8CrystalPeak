...
{
    [TestClass]
    public sealed class CF_00001152C_NekoDoesMaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001152C_NekoDoesMaths));
        ...
        {
            bool result = CF_00001152C_NekoDoesMaths.Solution_0_Test(input);
