...
{
    [TestClass]
    public sealed class CF_00000571E_GeometricProgressions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000571E_GeometricProgressions));
        ...
        {
            bool result = CF_00000571E_GeometricProgressions.Solution_0_Test(input);
