...
{
    [TestClass]
    public sealed class CF_00000661G_HungarianNotation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000661G_HungarianNotation));
        ...
        {
            bool result = CF_00000661G_HungarianNotation.Solution_0_Test(input);
