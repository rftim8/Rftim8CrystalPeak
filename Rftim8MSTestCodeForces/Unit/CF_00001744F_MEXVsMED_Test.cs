...
{
    [TestClass]
    public sealed class CF_00001744F_MEXVsMED_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001744F_MEXVsMED));
        ...
        {
            bool result = CF_00001744F_MEXVsMED.Solution_0_Test(input);
