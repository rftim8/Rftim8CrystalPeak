...
{
    [TestClass]
    public sealed class CF_00000360D_LevkoAndSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000360D_LevkoAndSets));
        ...
        {
            bool result = CF_00000360D_LevkoAndSets.Solution_0_Test(input);
