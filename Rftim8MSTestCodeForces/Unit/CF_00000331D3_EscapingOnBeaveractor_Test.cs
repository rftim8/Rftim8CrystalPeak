...
{
    [TestClass]
    public sealed class CF_00000331D3_EscapingOnBeaveractor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000331D3_EscapingOnBeaveractor));
        ...
        {
            bool result = CF_00000331D3_EscapingOnBeaveractor.Solution_0_Test(input);
