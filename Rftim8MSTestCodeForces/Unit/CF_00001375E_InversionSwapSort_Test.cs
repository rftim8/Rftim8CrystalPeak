...
{
    [TestClass]
    public sealed class CF_00001375E_InversionSwapSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001375E_InversionSwapSort));
        ...
        {
            bool result = CF_00001375E_InversionSwapSort.Solution_0_Test(input);
