...
{
    [TestClass]
    public sealed class CF_00001884A_SimpleDesign_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001884A_SimpleDesign));
        ...
        {
            bool result = CF_00001884A_SimpleDesign.Solution_0_Test(input);
