...
{
    [TestClass]
    public sealed class CF_00000918B_RadioStation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000918B_RadioStation));
        ...
        {
            bool result = CF_00000918B_RadioStation.Solution_0_Test(input);
