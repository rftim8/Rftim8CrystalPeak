...
{
    [TestClass]
    public sealed class CF_00001395C_BoboniuAndBitOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001395C_BoboniuAndBitOperations));
        ...
        {
            bool result = CF_00001395C_BoboniuAndBitOperations.Solution_0_Test(input);
