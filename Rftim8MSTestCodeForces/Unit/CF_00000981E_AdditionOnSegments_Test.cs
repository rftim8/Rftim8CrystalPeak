...
{
    [TestClass]
    public sealed class CF_00000981E_AdditionOnSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000981E_AdditionOnSegments));
        ...
        {
            bool result = CF_00000981E_AdditionOnSegments.Solution_0_Test(input);
