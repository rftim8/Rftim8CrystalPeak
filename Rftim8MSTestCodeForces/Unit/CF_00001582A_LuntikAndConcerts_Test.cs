...
{
    [TestClass]
    public sealed class CF_00001582A_LuntikAndConcerts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001582A_LuntikAndConcerts));
        ...
        {
            bool result = CF_00001582A_LuntikAndConcerts.Solution_0_Test(input);
