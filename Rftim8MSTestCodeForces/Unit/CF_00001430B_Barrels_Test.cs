...
{
    [TestClass]
    public sealed class CF_00001430B_Barrels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001430B_Barrels));
        ...
        {
            bool result = CF_00001430B_Barrels.Solution_0_Test(input);
