...
{
    [TestClass]
    public sealed class CF_00001499D_TheNumberOfPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001499D_TheNumberOfPairs));
        ...
        {
            bool result = CF_00001499D_TheNumberOfPairs.Solution_0_Test(input);
