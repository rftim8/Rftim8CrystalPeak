...
{
    [TestClass]
    public sealed class CF_00000074D_Hanger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000074D_Hanger));
        ...
        {
            bool result = CF_00000074D_Hanger.Solution_0_Test(input);
