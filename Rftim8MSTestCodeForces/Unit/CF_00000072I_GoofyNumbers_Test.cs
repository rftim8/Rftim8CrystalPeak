...
{
    [TestClass]
    public sealed class CF_00000072I_GoofyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000072I_GoofyNumbers));
        ...
        {
            bool result = CF_00000072I_GoofyNumbers.Solution_0_Test(input);
