...
{
    [TestClass]
    public sealed class CF_00000377D_DevelopingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000377D_DevelopingGame));
        ...
        {
            bool result = CF_00000377D_DevelopingGame.Solution_0_Test(input);
