...
{
    [TestClass]
    public sealed class CF_00000434E_FurukawaNagisasTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000434E_FurukawaNagisasTree));
        ...
        {
            bool result = CF_00000434E_FurukawaNagisasTree.Solution_0_Test(input);
