...
{
    [TestClass]
    public sealed class CF_00000017B_Hierarchy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000017B_Hierarchy));
        ...
        {
            bool result = CF_00000017B_Hierarchy.Solution_0_Test(input);
