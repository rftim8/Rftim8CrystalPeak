...
{
    [TestClass]
    public sealed class CF_00000710F_StringSetQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000710F_StringSetQueries));
        ...
        {
            bool result = CF_00000710F_StringSetQueries.Solution_0_Test(input);
