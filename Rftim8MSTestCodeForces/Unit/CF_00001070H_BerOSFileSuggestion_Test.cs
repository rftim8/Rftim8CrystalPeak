...
{
    [TestClass]
    public sealed class CF_00001070H_BerOSFileSuggestion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001070H_BerOSFileSuggestion));
        ...
        {
            bool result = CF_00001070H_BerOSFileSuggestion.Solution_0_Test(input);
