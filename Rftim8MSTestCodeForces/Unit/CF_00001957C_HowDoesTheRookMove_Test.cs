...
{
    [TestClass]
    public sealed class CF_00001957C_HowDoesTheRookMove_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001957C_HowDoesTheRookMove));
        ...
        {
            bool result = CF_00001957C_HowDoesTheRookMove.Solution_0_Test(input);
