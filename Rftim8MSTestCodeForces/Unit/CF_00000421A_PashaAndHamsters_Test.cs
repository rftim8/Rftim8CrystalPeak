...
{
    [TestClass]
    public sealed class CF_00000421A_PashaAndHamsters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000421A_PashaAndHamsters));
        ...
        {
            bool result = CF_00000421A_PashaAndHamsters.Solution_0_Test(input);
