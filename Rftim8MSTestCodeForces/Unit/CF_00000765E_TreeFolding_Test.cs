...
{
    [TestClass]
    public sealed class CF_00000765E_TreeFolding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000765E_TreeFolding));
        ...
        {
            bool result = CF_00000765E_TreeFolding.Solution_0_Test(input);
