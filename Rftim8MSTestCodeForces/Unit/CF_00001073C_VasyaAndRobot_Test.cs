...
{
    [TestClass]
    public sealed class CF_00001073C_VasyaAndRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001073C_VasyaAndRobot));
        ...
        {
            bool result = CF_00001073C_VasyaAndRobot.Solution_0_Test(input);
