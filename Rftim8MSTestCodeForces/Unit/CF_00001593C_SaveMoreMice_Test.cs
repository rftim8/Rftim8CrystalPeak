...
{
    [TestClass]
    public sealed class CF_00001593C_SaveMoreMice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001593C_SaveMoreMice));
        ...
        {
            bool result = CF_00001593C_SaveMoreMice.Solution_0_Test(input);
