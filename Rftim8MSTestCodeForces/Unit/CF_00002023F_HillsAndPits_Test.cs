...
{
    [TestClass]
    public sealed class CF_00002023F_HillsAndPits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002023F_HillsAndPits));
        ...
        {
            bool result = CF_00002023F_HillsAndPits.Solution_0_Test(input);
