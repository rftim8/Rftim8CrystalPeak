...
{
    [TestClass]
    public sealed class CF_00001681C_DoubleSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001681C_DoubleSort));
        ...
        {
            bool result = CF_00001681C_DoubleSort.Solution_0_Test(input);
