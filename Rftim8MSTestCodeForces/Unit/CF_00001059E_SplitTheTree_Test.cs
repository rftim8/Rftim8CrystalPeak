...
{
    [TestClass]
    public sealed class CF_00001059E_SplitTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001059E_SplitTheTree));
        ...
        {
            bool result = CF_00001059E_SplitTheTree.Solution_0_Test(input);
