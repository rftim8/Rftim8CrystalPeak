...
{
    [TestClass]
    public sealed class CF_00000962A_Equator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000962A_Equator));
        ...
        {
            bool result = CF_00000962A_Equator.Solution_0_Test(input);
