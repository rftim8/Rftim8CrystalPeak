...
{
    [TestClass]
    public sealed class CF_00000929B_SeatsOnThePlane_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000929B_SeatsOnThePlane));
        ...
        {
            bool result = CF_00000929B_SeatsOnThePlane.Solution_0_Test(input);
