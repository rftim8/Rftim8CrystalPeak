...
{
    [TestClass]
    public sealed class CF_00001215F_RadioStations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001215F_RadioStations));
        ...
        {
            bool result = CF_00001215F_RadioStations.Solution_0_Test(input);
