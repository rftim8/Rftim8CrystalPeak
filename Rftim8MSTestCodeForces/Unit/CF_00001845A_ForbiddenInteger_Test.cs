...
{
    [TestClass]
    public sealed class CF_00001845A_ForbiddenInteger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001845A_ForbiddenInteger));
        ...
        {
            bool result = CF_00001845A_ForbiddenInteger.Solution_0_Test(input);
