...
{
    [TestClass]
    public sealed class CF_00000146A_LuckyTicket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000146A_LuckyTicket));
        ...
        {
            bool result = CF_00000146A_LuckyTicket.Solution_0_Test(input);
