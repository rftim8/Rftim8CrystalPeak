...
{
    [TestClass]
    public sealed class CF_00001479B2_PaintingTheArrayII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001479B2_PaintingTheArrayII));
        ...
        {
            bool result = CF_00001479B2_PaintingTheArrayII.Solution_0_Test(input);
