...
{
    [TestClass]
    public sealed class CF_00000557A_IlyaAndDiplomas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000557A_IlyaAndDiplomas));
        ...
        {
            bool result = CF_00000557A_IlyaAndDiplomas.Solution_0_Test(input);
