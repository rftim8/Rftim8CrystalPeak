...
{
    [TestClass]
    public sealed class CF_00001004D_SonyaAndMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001004D_SonyaAndMatrix));
        ...
        {
            bool result = CF_00001004D_SonyaAndMatrix.Solution_0_Test(input);
