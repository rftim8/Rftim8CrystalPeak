...
{
    [TestClass]
    public sealed class CF_00001004A_SonyaAndHotels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001004A_SonyaAndHotels));
        ...
        {
            bool result = CF_00001004A_SonyaAndHotels.Solution_0_Test(input);
