...
{
    [TestClass]
    public sealed class CF_00000729E_Subordinates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000729E_Subordinates));
        ...
        {
            bool result = CF_00000729E_Subordinates.Solution_0_Test(input);
