...
{
    [TestClass]
    public sealed class CF_00000178F1_RepresentativeSampling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000178F1_RepresentativeSampling));
        ...
        {
            bool result = CF_00000178F1_RepresentativeSampling.Solution_0_Test(input);
