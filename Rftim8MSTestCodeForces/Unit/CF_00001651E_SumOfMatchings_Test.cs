...
{
    [TestClass]
    public sealed class CF_00001651E_SumOfMatchings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001651E_SumOfMatchings));
        ...
        {
            bool result = CF_00001651E_SumOfMatchings.Solution_0_Test(input);
