...
{
    [TestClass]
    public sealed class CF_00001272F_TwoBracketSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001272F_TwoBracketSequences));
        ...
        {
            bool result = CF_00001272F_TwoBracketSequences.Solution_0_Test(input);
