...
{
    [TestClass]
    public sealed class CF_00001873C_TargetPractice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001873C_TargetPractice));
        ...
        {
            bool result = CF_00001873C_TargetPractice.Solution_0_Test(input);
