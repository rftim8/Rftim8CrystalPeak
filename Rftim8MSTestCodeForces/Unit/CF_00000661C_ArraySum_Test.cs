...
{
    [TestClass]
    public sealed class CF_00000661C_ArraySum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000661C_ArraySum));
        ...
        {
            bool result = CF_00000661C_ArraySum.Solution_0_Test(input);
