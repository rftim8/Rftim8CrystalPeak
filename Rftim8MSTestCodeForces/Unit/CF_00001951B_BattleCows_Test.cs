...
{
    [TestClass]
    public sealed class CF_00001951B_BattleCows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001951B_BattleCows));
        ...
        {
            bool result = CF_00001951B_BattleCows.Solution_0_Test(input);
