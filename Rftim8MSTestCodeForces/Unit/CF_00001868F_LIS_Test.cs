...
{
    [TestClass]
    public sealed class CF_00001868F_LIS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001868F_LIS));
        ...
        {
            bool result = CF_00001868F_LIS.Solution_0_Test(input);
