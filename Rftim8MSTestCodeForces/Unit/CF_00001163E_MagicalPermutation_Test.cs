...
{
    [TestClass]
    public sealed class CF_00001163E_MagicalPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001163E_MagicalPermutation));
        ...
        {
            bool result = CF_00001163E_MagicalPermutation.Solution_0_Test(input);
