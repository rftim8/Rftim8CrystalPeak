...
{
    [TestClass]
    public sealed class CF_00001674E_BreakingTheWall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001674E_BreakingTheWall));
        ...
        {
            bool result = CF_00001674E_BreakingTheWall.Solution_0_Test(input);
