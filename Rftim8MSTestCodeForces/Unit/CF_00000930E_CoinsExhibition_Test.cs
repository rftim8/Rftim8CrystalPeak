...
{
    [TestClass]
    public sealed class CF_00000930E_CoinsExhibition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000930E_CoinsExhibition));
        ...
        {
            bool result = CF_00000930E_CoinsExhibition.Solution_0_Test(input);
