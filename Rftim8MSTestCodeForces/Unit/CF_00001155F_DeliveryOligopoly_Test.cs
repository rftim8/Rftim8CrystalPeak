...
{
    [TestClass]
    public sealed class CF_00001155F_DeliveryOligopoly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001155F_DeliveryOligopoly));
        ...
        {
            bool result = CF_00001155F_DeliveryOligopoly.Solution_0_Test(input);
