...
{
    [TestClass]
    public sealed class CF_00000009B_RunningStudent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000009B_RunningStudent));
        ...
        {
            bool result = CF_00000009B_RunningStudent.Solution_0_Test(input);
