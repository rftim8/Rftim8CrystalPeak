...
{
    [TestClass]
    public sealed class CF_00001056F_WriteTheContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001056F_WriteTheContest));
        ...
        {
            bool result = CF_00001056F_WriteTheContest.Solution_0_Test(input);
