...
{
    [TestClass]
    public sealed class CF_00001984A_StrangeSplitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001984A_StrangeSplitting));
        ...
        {
            bool result = CF_00001984A_StrangeSplitting.Solution_0_Test(input);
