...
{
    [TestClass]
    public sealed class CF_00000171E_MYSTERIOUSLANGUAGE_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000171E_MYSTERIOUSLANGUAGE));
        ...
        {
            bool result = CF_00000171E_MYSTERIOUSLANGUAGE.Solution_0_Test(input);
