...
{
    [TestClass]
    public sealed class CF_00000446B_DZYLovesModification_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000446B_DZYLovesModification));
        ...
        {
            bool result = CF_00000446B_DZYLovesModification.Solution_0_Test(input);
