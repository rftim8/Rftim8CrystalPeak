...
{
    [TestClass]
    public sealed class CF_00001073B_VasyaAndBooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001073B_VasyaAndBooks));
        ...
        {
            bool result = CF_00001073B_VasyaAndBooks.Solution_0_Test(input);
