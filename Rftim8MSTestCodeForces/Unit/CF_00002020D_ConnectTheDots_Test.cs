...
{
    [TestClass]
    public sealed class CF_00002020D_ConnectTheDots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002020D_ConnectTheDots));
        ...
        {
            bool result = CF_00002020D_ConnectTheDots.Solution_0_Test(input);
