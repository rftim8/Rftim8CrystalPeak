...
{
    [TestClass]
    public sealed class CF_00000483A_Counterexample_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000483A_Counterexample));
        ...
        {
            bool result = CF_00000483A_Counterexample.Solution_0_Test(input);
