...
{
    [TestClass]
    public sealed class CF_00000858F_WizardsTour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000858F_WizardsTour));
        ...
        {
            bool result = CF_00000858F_WizardsTour.Solution_0_Test(input);
