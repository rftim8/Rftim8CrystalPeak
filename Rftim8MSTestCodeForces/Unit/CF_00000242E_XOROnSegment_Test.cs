...
{
    [TestClass]
    public sealed class CF_00000242E_XOROnSegment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000242E_XOROnSegment));
        ...
        {
            bool result = CF_00000242E_XOROnSegment.Solution_0_Test(input);
