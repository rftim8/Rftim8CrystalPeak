...
{
    [TestClass]
    public sealed class CF_00001149B_ThreeReligions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001149B_ThreeReligions));
        ...
        {
            bool result = CF_00001149B_ThreeReligions.Solution_0_Test(input);
