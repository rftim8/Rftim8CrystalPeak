...
{
    [TestClass]
    public sealed class CF_00000498A_CrazyTown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000498A_CrazyTown));
        ...
        {
            bool result = CF_00000498A_CrazyTown.Solution_0_Test(input);
