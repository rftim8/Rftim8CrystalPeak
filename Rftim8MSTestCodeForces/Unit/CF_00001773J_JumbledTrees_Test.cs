...
{
    [TestClass]
    public sealed class CF_00001773J_JumbledTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001773J_JumbledTrees));
        ...
        {
            bool result = CF_00001773J_JumbledTrees.Solution_0_Test(input);
