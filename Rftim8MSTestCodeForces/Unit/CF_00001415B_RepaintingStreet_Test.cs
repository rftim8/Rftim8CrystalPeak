...
{
    [TestClass]
    public sealed class CF_00001415B_RepaintingStreet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001415B_RepaintingStreet));
        ...
        {
            bool result = CF_00001415B_RepaintingStreet.Solution_0_Test(input);
