...
{
    [TestClass]
    public sealed class CF_00001992B_AngryMonk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001992B_AngryMonk));
        ...
        {
            bool result = CF_00001992B_AngryMonk.Solution_0_Test(input);
