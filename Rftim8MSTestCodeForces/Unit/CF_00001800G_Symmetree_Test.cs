...
{
    [TestClass]
    public sealed class CF_00001800G_Symmetree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001800G_Symmetree));
        ...
        {
            bool result = CF_00001800G_Symmetree.Solution_0_Test(input);
