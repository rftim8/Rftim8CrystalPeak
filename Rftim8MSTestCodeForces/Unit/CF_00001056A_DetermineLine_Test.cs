...
{
    [TestClass]
    public sealed class CF_00001056A_DetermineLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001056A_DetermineLine));
        ...
        {
            bool result = CF_00001056A_DetermineLine.Solution_0_Test(input);
