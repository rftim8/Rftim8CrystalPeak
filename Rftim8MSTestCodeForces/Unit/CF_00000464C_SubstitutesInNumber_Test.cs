...
{
    [TestClass]
    public sealed class CF_00000464C_SubstitutesInNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000464C_SubstitutesInNumber));
        ...
        {
            bool result = CF_00000464C_SubstitutesInNumber.Solution_0_Test(input);
