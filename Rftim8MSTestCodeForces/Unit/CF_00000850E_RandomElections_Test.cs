...
{
    [TestClass]
    public sealed class CF_00000850E_RandomElections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000850E_RandomElections));
        ...
        {
            bool result = CF_00000850E_RandomElections.Solution_0_Test(input);
