...
{
    [TestClass]
    public sealed class CF_00000250E_MadJoe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000250E_MadJoe));
        ...
        {
            bool result = CF_00000250E_MadJoe.Solution_0_Test(input);
