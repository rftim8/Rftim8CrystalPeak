...
{
    [TestClass]
    public sealed class CF_00000566D_RestructuringCompany_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000566D_RestructuringCompany));
        ...
        {
            bool result = CF_00000566D_RestructuringCompany.Solution_0_Test(input);
