...
{
    [TestClass]
    public sealed class CF_00001041A_Heist_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001041A_Heist));
        ...
        {
            bool result = CF_00001041A_Heist.Solution_0_Test(input);
