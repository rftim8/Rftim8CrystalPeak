...
{
    [TestClass]
    public sealed class CF_00001249F_MaximumWeightSubset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001249F_MaximumWeightSubset));
        ...
        {
            bool result = CF_00001249F_MaximumWeightSubset.Solution_0_Test(input);
