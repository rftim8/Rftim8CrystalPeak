...
{
    [TestClass]
    public sealed class CF_00001166F_VickysDeliveryService_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001166F_VickysDeliveryService));
        ...
        {
            bool result = CF_00001166F_VickysDeliveryService.Solution_0_Test(input);
