...
{
    [TestClass]
    public sealed class CF_00001520C_NotAdjacentMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001520C_NotAdjacentMatrix));
        ...
        {
            bool result = CF_00001520C_NotAdjacentMatrix.Solution_0_Test(input);
