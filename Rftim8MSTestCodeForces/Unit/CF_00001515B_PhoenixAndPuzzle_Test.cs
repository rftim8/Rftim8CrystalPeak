...
{
    [TestClass]
    public sealed class CF_00001515B_PhoenixAndPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001515B_PhoenixAndPuzzle));
        ...
        {
            bool result = CF_00001515B_PhoenixAndPuzzle.Solution_0_Test(input);
