...
{
    [TestClass]
    public sealed class CF_00001375B_NeighborGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001375B_NeighborGrid));
        ...
        {
            bool result = CF_00001375B_NeighborGrid.Solution_0_Test(input);
