...
{
    [TestClass]
    public sealed class CF_00001551A_PolycarpAndCoins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001551A_PolycarpAndCoins));
        ...
        {
            bool result = CF_00001551A_PolycarpAndCoins.Solution_0_Test(input);
