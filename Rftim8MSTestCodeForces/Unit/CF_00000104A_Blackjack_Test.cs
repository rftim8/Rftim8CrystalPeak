...
{
    [TestClass]
    public sealed class CF_00000104A_Blackjack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000104A_Blackjack));
        ...
        {
            bool result = CF_00000104A_Blackjack.Solution_0_Test(input);
