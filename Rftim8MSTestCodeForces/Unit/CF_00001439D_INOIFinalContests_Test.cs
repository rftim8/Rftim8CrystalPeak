...
{
    [TestClass]
    public sealed class CF_00001439D_INOIFinalContests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001439D_INOIFinalContests));
        ...
        {
            bool result = CF_00001439D_INOIFinalContests.Solution_0_Test(input);
