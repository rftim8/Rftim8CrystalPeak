...
{
    [TestClass]
    public sealed class CF_00001609E_WilliamTheOblivious_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001609E_WilliamTheOblivious));
        ...
        {
            bool result = CF_00001609E_WilliamTheOblivious.Solution_0_Test(input);
