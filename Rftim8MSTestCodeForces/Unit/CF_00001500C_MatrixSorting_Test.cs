...
{
    [TestClass]
    public sealed class CF_00001500C_MatrixSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001500C_MatrixSorting));
        ...
        {
            bool result = CF_00001500C_MatrixSorting.Solution_0_Test(input);
