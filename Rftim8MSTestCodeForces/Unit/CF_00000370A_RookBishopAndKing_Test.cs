...
{
    [TestClass]
    public sealed class CF_00000370A_RookBishopAndKing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000370A_RookBishopAndKing));
        ...
        {
            bool result = CF_00000370A_RookBishopAndKing.Solution_0_Test(input);
