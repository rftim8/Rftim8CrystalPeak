...
{
    [TestClass]
    public sealed class CF_00000290B_QRCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000290B_QRCode));
        ...
        {
            bool result = CF_00000290B_QRCode.Solution_0_Test(input);
