...
{
    [TestClass]
    public sealed class CF_00001214A_OptimalCurrencyExchange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001214A_OptimalCurrencyExchange));
        ...
        {
            bool result = CF_00001214A_OptimalCurrencyExchange.Solution_0_Test(input);
