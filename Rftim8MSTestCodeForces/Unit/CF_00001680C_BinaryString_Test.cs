...
{
    [TestClass]
    public sealed class CF_00001680C_BinaryString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001680C_BinaryString));
        ...
        {
            bool result = CF_00001680C_BinaryString.Solution_0_Test(input);
