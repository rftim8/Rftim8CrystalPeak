...
{
    [TestClass]
    public sealed class CF_00001716F_BagsWithBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001716F_BagsWithBalls));
        ...
        {
            bool result = CF_00001716F_BagsWithBalls.Solution_0_Test(input);
