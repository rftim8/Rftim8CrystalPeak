...
{
    [TestClass]
    public sealed class CF_00000527B_ErrorCorrectSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000527B_ErrorCorrectSystem));
        ...
        {
            bool result = CF_00000527B_ErrorCorrectSystem.Solution_0_Test(input);
