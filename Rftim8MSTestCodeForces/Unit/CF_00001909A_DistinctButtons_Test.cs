...
{
    [TestClass]
    public sealed class CF_00001909A_DistinctButtons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001909A_DistinctButtons));
        ...
        {
            bool result = CF_00001909A_DistinctButtons.Solution_0_Test(input);
