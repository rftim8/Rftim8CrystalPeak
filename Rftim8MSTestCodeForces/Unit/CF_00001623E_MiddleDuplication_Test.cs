...
{
    [TestClass]
    public sealed class CF_00001623E_MiddleDuplication_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001623E_MiddleDuplication));
        ...
        {
            bool result = CF_00001623E_MiddleDuplication.Solution_0_Test(input);
