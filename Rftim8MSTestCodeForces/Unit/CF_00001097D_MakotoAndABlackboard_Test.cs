...
{
    [TestClass]
    public sealed class CF_00001097D_MakotoAndABlackboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001097D_MakotoAndABlackboard));
        ...
        {
            bool result = CF_00001097D_MakotoAndABlackboard.Solution_0_Test(input);
