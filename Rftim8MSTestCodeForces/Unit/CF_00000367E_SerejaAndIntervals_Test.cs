...
{
    [TestClass]
    public sealed class CF_00000367E_SerejaAndIntervals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000367E_SerejaAndIntervals));
        ...
        {
            bool result = CF_00000367E_SerejaAndIntervals.Solution_0_Test(input);
