...
{
    [TestClass]
    public sealed class CF_00001485A_AddAndDivide_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001485A_AddAndDivide));
        ...
        {
            bool result = CF_00001485A_AddAndDivide.Solution_0_Test(input);
