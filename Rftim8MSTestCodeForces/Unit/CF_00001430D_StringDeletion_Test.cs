...
{
    [TestClass]
    public sealed class CF_00001430D_StringDeletion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001430D_StringDeletion));
        ...
        {
            bool result = CF_00001430D_StringDeletion.Solution_0_Test(input);
