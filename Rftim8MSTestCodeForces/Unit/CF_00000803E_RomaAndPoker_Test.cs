...
{
    [TestClass]
    public sealed class CF_00000803E_RomaAndPoker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000803E_RomaAndPoker));
        ...
        {
            bool result = CF_00000803E_RomaAndPoker.Solution_0_Test(input);
