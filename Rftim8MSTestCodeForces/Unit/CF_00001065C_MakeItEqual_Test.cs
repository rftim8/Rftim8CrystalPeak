...
{
    [TestClass]
    public sealed class CF_00001065C_MakeItEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001065C_MakeItEqual));
        ...
        {
            bool result = CF_00001065C_MakeItEqual.Solution_0_Test(input);
