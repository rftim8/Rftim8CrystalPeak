...
{
    [TestClass]
    public sealed class CF_00000193A_CuttingFigure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000193A_CuttingFigure));
        ...
        {
            bool result = CF_00000193A_CuttingFigure.Solution_0_Test(input);
