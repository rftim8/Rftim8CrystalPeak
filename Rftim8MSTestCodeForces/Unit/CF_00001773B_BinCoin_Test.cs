...
{
    [TestClass]
    public sealed class CF_00001773B_BinCoin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001773B_BinCoin));
        ...
        {
            bool result = CF_00001773B_BinCoin.Solution_0_Test(input);
