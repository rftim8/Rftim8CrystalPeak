...
{
    [TestClass]
    public sealed class CF_00000804E_TheSamePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000804E_TheSamePermutation));
        ...
        {
            bool result = CF_00000804E_TheSamePermutation.Solution_0_Test(input);
