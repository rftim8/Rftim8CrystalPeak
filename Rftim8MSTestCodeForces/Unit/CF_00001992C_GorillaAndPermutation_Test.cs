...
{
    [TestClass]
    public sealed class CF_00001992C_GorillaAndPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001992C_GorillaAndPermutation));
        ...
        {
            bool result = CF_00001992C_GorillaAndPermutation.Solution_0_Test(input);
