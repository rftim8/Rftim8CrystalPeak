...
{
    [TestClass]
    public sealed class CF_00000311D_IntervalCubing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000311D_IntervalCubing));
        ...
        {
            bool result = CF_00000311D_IntervalCubing.Solution_0_Test(input);
