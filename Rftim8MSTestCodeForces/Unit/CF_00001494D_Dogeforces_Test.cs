...
{
    [TestClass]
    public sealed class CF_00001494D_Dogeforces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001494D_Dogeforces));
        ...
        {
            bool result = CF_00001494D_Dogeforces.Solution_0_Test(input);
