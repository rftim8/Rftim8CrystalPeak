...
{
    [TestClass]
    public sealed class CF_00001028G_GuessTheNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001028G_GuessTheNumber));
        ...
        {
            bool result = CF_00001028G_GuessTheNumber.Solution_0_Test(input);
