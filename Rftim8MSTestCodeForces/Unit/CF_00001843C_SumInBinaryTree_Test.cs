...
{
    [TestClass]
    public sealed class CF_00001843C_SumInBinaryTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001843C_SumInBinaryTree));
        ...
        {
            bool result = CF_00001843C_SumInBinaryTree.Solution_0_Test(input);
