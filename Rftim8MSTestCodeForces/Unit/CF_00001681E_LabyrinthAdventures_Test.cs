...
{
    [TestClass]
    public sealed class CF_00001681E_LabyrinthAdventures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001681E_LabyrinthAdventures));
        ...
        {
            bool result = CF_00001681E_LabyrinthAdventures.Solution_0_Test(input);
