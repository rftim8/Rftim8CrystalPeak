...
{
    [TestClass]
    public sealed class CF_00000121B_LuckyTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000121B_LuckyTransformation));
        ...
        {
            bool result = CF_00000121B_LuckyTransformation.Solution_0_Test(input);
