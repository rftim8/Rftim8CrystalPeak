...
{
    [TestClass]
    public sealed class CF_00001952H_Palindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001952H_Palindrome));
        ...
        {
            bool result = CF_00001952H_Palindrome.Solution_0_Test(input);
