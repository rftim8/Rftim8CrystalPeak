...
{
    [TestClass]
    public sealed class CF_00001665A_GCDVsLCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001665A_GCDVsLCM));
        ...
        {
            bool result = CF_00001665A_GCDVsLCM.Solution_0_Test(input);
