...
{
    [TestClass]
    public sealed class CF_00002008H_SakurakosTest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002008H_SakurakosTest));
        ...
        {
            bool result = CF_00002008H_SakurakosTest.Solution_0_Test(input);
