...
{
    [TestClass]
    public sealed class CF_00002004E_NotANimProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002004E_NotANimProblem));
        ...
        {
            bool result = CF_00002004E_NotANimProblem.Solution_0_Test(input);
