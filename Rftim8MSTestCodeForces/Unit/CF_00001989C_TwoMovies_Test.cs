...
{
    [TestClass]
    public sealed class CF_00001989C_TwoMovies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001989C_TwoMovies));
        ...
        {
            bool result = CF_00001989C_TwoMovies.Solution_0_Test(input);
