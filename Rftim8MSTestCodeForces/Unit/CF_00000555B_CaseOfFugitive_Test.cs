...
{
    [TestClass]
    public sealed class CF_00000555B_CaseOfFugitive_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000555B_CaseOfFugitive));
        ...
        {
            bool result = CF_00000555B_CaseOfFugitive.Solution_0_Test(input);
