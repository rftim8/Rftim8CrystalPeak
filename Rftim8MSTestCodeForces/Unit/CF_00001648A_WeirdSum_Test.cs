...
{
    [TestClass]
    public sealed class CF_00001648A_WeirdSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001648A_WeirdSum));
        ...
        {
            bool result = CF_00001648A_WeirdSum.Solution_0_Test(input);
