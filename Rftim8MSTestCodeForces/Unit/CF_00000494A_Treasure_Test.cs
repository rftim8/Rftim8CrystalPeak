...
{
    [TestClass]
    public sealed class CF_00000494A_Treasure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000494A_Treasure));
        ...
        {
            bool result = CF_00000494A_Treasure.Solution_0_Test(input);
