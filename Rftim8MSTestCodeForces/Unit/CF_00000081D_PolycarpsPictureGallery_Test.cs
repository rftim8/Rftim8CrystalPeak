...
{
    [TestClass]
    public sealed class CF_00000081D_PolycarpsPictureGallery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000081D_PolycarpsPictureGallery));
        ...
        {
            bool result = CF_00000081D_PolycarpsPictureGallery.Solution_0_Test(input);
