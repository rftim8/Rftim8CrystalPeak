...
{
    [TestClass]
    public sealed class CF_00001438E_YuriiCanDoEverything_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001438E_YuriiCanDoEverything));
        ...
        {
            bool result = CF_00001438E_YuriiCanDoEverything.Solution_0_Test(input);
