...
{
    [TestClass]
    public sealed class CF_00001603E_APerfectProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001603E_APerfectProblem));
        ...
        {
            bool result = CF_00001603E_APerfectProblem.Solution_0_Test(input);
