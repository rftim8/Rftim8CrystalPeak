...
{
    [TestClass]
    public sealed class CF_00000261C_MaximAndMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000261C_MaximAndMatrix));
        ...
        {
            bool result = CF_00000261C_MaximAndMatrix.Solution_0_Test(input);
