...
{
    [TestClass]
    public sealed class CF_00001340E_NastyaAndBees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001340E_NastyaAndBees));
        ...
        {
            bool result = CF_00001340E_NastyaAndBees.Solution_0_Test(input);
