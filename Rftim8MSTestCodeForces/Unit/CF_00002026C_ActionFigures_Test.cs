...
{
    [TestClass]
    public sealed class CF_00002026C_ActionFigures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002026C_ActionFigures));
        ...
        {
            bool result = CF_00002026C_ActionFigures.Solution_0_Test(input);
