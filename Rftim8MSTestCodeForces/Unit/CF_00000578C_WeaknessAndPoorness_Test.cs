...
{
    [TestClass]
    public sealed class CF_00000578C_WeaknessAndPoorness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000578C_WeaknessAndPoorness));
        ...
        {
            bool result = CF_00000578C_WeaknessAndPoorness.Solution_0_Test(input);
