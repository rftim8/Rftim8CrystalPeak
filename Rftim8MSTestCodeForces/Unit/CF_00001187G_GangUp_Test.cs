...
{
    [TestClass]
    public sealed class CF_00001187G_GangUp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001187G_GangUp));
        ...
        {
            bool result = CF_00001187G_GangUp.Solution_0_Test(input);
