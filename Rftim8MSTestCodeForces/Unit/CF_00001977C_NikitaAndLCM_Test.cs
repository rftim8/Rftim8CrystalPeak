...
{
    [TestClass]
    public sealed class CF_00001977C_NikitaAndLCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001977C_NikitaAndLCM));
        ...
        {
            bool result = CF_00001977C_NikitaAndLCM.Solution_0_Test(input);
