...
{
    [TestClass]
    public sealed class CF_00000788A_FunctionsAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000788A_FunctionsAgain));
        ...
        {
            bool result = CF_00000788A_FunctionsAgain.Solution_0_Test(input);
