...
{
    [TestClass]
    public sealed class CF_00001927D_FindTheDifferentOnes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001927D_FindTheDifferentOnes));
        ...
        {
            bool result = CF_00001927D_FindTheDifferentOnes.Solution_0_Test(input);
