...
{
    [TestClass]
    public sealed class CF_00001784A_MonstersEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001784A_MonstersEasyVersion));
        ...
        {
            bool result = CF_00001784A_MonstersEasyVersion.Solution_0_Test(input);
