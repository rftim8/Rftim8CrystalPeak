...
{
    [TestClass]
    public sealed class CF_00000825E_MinimalLabels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000825E_MinimalLabels));
        ...
        {
            bool result = CF_00000825E_MinimalLabels.Solution_0_Test(input);
