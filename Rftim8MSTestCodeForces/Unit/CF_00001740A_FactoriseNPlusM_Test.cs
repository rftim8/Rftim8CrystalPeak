...
{
    [TestClass]
    public sealed class CF_00001740A_FactoriseNPlusM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001740A_FactoriseNPlusM));
        ...
        {
            bool result = CF_00001740A_FactoriseNPlusM.Solution_0_Test(input);
