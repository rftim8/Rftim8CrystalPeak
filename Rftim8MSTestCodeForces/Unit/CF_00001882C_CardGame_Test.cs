...
{
    [TestClass]
    public sealed class CF_00001882C_CardGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001882C_CardGame));
        ...
        {
            bool result = CF_00001882C_CardGame.Solution_0_Test(input);
