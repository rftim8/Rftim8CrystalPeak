...
{
    [TestClass]
    public sealed class CF_00000621E_WetSharkAndBlocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000621E_WetSharkAndBlocks));
        ...
        {
            bool result = CF_00000621E_WetSharkAndBlocks.Solution_0_Test(input);
