...
{
    [TestClass]
    public sealed class CF_00000626A_RobotSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000626A_RobotSequence));
        ...
        {
            bool result = CF_00000626A_RobotSequence.Solution_0_Test(input);
