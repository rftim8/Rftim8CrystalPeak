...
{
    [TestClass]
    public sealed class CF_00001056E_CheckTranscription_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001056E_CheckTranscription));
        ...
        {
            bool result = CF_00001056E_CheckTranscription.Solution_0_Test(input);
