...
{
    [TestClass]
    public sealed class CF_00001003D_CoinsAndQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001003D_CoinsAndQueries));
        ...
        {
            bool result = CF_00001003D_CoinsAndQueries.Solution_0_Test(input);
