...
{
    [TestClass]
    public sealed class CF_00000117E_TreeOrNotTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000117E_TreeOrNotTree));
        ...
        {
            bool result = CF_00000117E_TreeOrNotTree.Solution_0_Test(input);
