...
{
    [TestClass]
    public sealed class CF_00000818C_SofaThief_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000818C_SofaThief));
        ...
        {
            bool result = CF_00000818C_SofaThief.Solution_0_Test(input);
