...
{
    [TestClass]
    public sealed class CF_00001227B_Box_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001227B_Box));
        ...
        {
            bool result = CF_00001227B_Box.Solution_0_Test(input);
