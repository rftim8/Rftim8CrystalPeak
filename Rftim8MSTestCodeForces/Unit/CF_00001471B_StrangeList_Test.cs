...
{
    [TestClass]
    public sealed class CF_00001471B_StrangeList_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001471B_StrangeList));
        ...
        {
            bool result = CF_00001471B_StrangeList.Solution_0_Test(input);
