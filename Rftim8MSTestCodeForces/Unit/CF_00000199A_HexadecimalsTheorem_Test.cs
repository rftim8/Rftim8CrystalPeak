...
{
    [TestClass]
    public sealed class CF_00000199A_HexadecimalsTheorem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000199A_HexadecimalsTheorem));
        ...
        {
            bool result = CF_00000199A_HexadecimalsTheorem.Solution_0_Test(input);
