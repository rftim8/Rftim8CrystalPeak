...
{
    [TestClass]
    public sealed class CF_00000314D_SerejaAndStraightLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000314D_SerejaAndStraightLines));
        ...
        {
            bool result = CF_00000314D_SerejaAndStraightLines.Solution_0_Test(input);
