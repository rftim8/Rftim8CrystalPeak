...
{
    [TestClass]
    public sealed class CF_00001092C_PrefixesAndSuffixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001092C_PrefixesAndSuffixes));
        ...
        {
            bool result = CF_00001092C_PrefixesAndSuffixes.Solution_0_Test(input);
