...
{
    [TestClass]
    public sealed class CF_00000293D_KsushaAndSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000293D_KsushaAndSquare));
        ...
        {
            bool result = CF_00000293D_KsushaAndSquare.Solution_0_Test(input);
