...
{
    [TestClass]
    public sealed class CF_00000883L_BerlandTaxi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883L_BerlandTaxi));
        ...
        {
            bool result = CF_00000883L_BerlandTaxi.Solution_0_Test(input);
