...
{
    [TestClass]
    public sealed class CF_00000444A_DZYLovesPhysics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000444A_DZYLovesPhysics));
        ...
        {
            bool result = CF_00000444A_DZYLovesPhysics.Solution_0_Test(input);
