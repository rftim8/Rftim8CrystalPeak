...
{
    [TestClass]
    public sealed class CF_00000712E_MemoryAndCasinos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000712E_MemoryAndCasinos));
        ...
        {
            bool result = CF_00000712E_MemoryAndCasinos.Solution_0_Test(input);
