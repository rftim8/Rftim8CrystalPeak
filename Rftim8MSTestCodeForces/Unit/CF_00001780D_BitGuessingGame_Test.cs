...
{
    [TestClass]
    public sealed class CF_00001780D_BitGuessingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001780D_BitGuessingGame));
        ...
        {
            bool result = CF_00001780D_BitGuessingGame.Solution_0_Test(input);
