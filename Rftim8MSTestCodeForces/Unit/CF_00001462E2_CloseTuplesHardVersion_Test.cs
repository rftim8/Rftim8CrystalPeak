...
{
    [TestClass]
    public sealed class CF_00001462E2_CloseTuplesHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001462E2_CloseTuplesHardVersion));
        ...
        {
            bool result = CF_00001462E2_CloseTuplesHardVersion.Solution_0_Test(input);
