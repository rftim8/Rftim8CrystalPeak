...
{
    [TestClass]
    public sealed class CF_00001438D_PowerfulKsenia_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001438D_PowerfulKsenia));
        ...
        {
            bool result = CF_00001438D_PowerfulKsenia.Solution_0_Test(input);
