...
{
    [TestClass]
    public sealed class CF_00001746G_OlympiadTraining_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001746G_OlympiadTraining));
        ...
        {
            bool result = CF_00001746G_OlympiadTraining.Solution_0_Test(input);
