...
{
    [TestClass]
    public sealed class CF_00001360G_ABMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001360G_ABMatrix));
        ...
        {
            bool result = CF_00001360G_ABMatrix.Solution_0_Test(input);
