...
{
    [TestClass]
    public sealed class CF_00001725F_FieldPhotography_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725F_FieldPhotography));
        ...
        {
            bool result = CF_00001725F_FieldPhotography.Solution_0_Test(input);
