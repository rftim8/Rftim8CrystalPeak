...
{
    [TestClass]
    public sealed class CF_00000154B_Colliders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000154B_Colliders));
        ...
        {
            bool result = CF_00000154B_Colliders.Solution_0_Test(input);
