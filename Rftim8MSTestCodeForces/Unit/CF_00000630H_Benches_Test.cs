...
{
    [TestClass]
    public sealed class CF_00000630H_Benches_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630H_Benches));
        ...
        {
            bool result = CF_00000630H_Benches.Solution_0_Test(input);
