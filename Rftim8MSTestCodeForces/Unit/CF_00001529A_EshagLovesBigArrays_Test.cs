...
{
    [TestClass]
    public sealed class CF_00001529A_EshagLovesBigArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001529A_EshagLovesBigArrays));
        ...
        {
            bool result = CF_00001529A_EshagLovesBigArrays.Solution_0_Test(input);
