...
{
    [TestClass]
    public sealed class CF_00000083A_MagicalArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000083A_MagicalArray));
        ...
        {
            bool result = CF_00000083A_MagicalArray.Solution_0_Test(input);
