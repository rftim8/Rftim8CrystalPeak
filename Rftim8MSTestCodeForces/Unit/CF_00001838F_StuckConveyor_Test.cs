...
{
    [TestClass]
    public sealed class CF_00001838F_StuckConveyor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001838F_StuckConveyor));
        ...
        {
            bool result = CF_00001838F_StuckConveyor.Solution_0_Test(input);
