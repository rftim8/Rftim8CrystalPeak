...
{
    [TestClass]
    public sealed class CF_00001066F_YetAnother2DWalking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001066F_YetAnother2DWalking));
        ...
        {
            bool result = CF_00001066F_YetAnother2DWalking.Solution_0_Test(input);
