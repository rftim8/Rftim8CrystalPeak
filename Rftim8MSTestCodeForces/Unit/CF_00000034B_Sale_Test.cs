...
{
    [TestClass]
    public sealed class CF_00000034B_Sale_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000034B_Sale));
        ...
        {
            bool result = CF_00000034B_Sale.Solution_0_Test(input);
