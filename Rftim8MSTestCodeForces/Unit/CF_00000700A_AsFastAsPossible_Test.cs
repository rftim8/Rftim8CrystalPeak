...
{
    [TestClass]
    public sealed class CF_00000700A_AsFastAsPossible_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000700A_AsFastAsPossible));
        ...
        {
            bool result = CF_00000700A_AsFastAsPossible.Solution_0_Test(input);
