...
{
    [TestClass]
    public sealed class CF_00001656G_CyclePalindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001656G_CyclePalindrome));
        ...
        {
            bool result = CF_00001656G_CyclePalindrome.Solution_0_Test(input);
