...
{
    [TestClass]
    public sealed class CF_00000106B_ChoosingLaptop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000106B_ChoosingLaptop));
        ...
        {
            bool result = CF_00000106B_ChoosingLaptop.Solution_0_Test(input);
