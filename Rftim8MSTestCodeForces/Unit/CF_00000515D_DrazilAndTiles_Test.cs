...
{
    [TestClass]
    public sealed class CF_00000515D_DrazilAndTiles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000515D_DrazilAndTiles));
        ...
        {
            bool result = CF_00000515D_DrazilAndTiles.Solution_0_Test(input);
