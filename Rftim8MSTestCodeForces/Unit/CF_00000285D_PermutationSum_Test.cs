...
{
    [TestClass]
    public sealed class CF_00000285D_PermutationSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000285D_PermutationSum));
        ...
        {
            bool result = CF_00000285D_PermutationSum.Solution_0_Test(input);
