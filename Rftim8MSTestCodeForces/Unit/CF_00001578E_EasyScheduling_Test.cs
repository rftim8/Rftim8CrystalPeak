...
{
    [TestClass]
    public sealed class CF_00001578E_EasyScheduling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001578E_EasyScheduling));
        ...
        {
            bool result = CF_00001578E_EasyScheduling.Solution_0_Test(input);
