...
{
    [TestClass]
    public sealed class CF_00000022E_Scheme_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000022E_Scheme));
        ...
        {
            bool result = CF_00000022E_Scheme.Solution_0_Test(input);
