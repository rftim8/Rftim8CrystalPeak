...
{
    [TestClass]
    public sealed class CF_00000758F_GeometricalProgression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000758F_GeometricalProgression));
        ...
        {
            bool result = CF_00000758F_GeometricalProgression.Solution_0_Test(input);
