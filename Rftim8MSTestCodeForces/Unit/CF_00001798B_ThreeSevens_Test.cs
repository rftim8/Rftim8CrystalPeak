...
{
    [TestClass]
    public sealed class CF_00001798B_ThreeSevens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001798B_ThreeSevens));
        ...
        {
            bool result = CF_00001798B_ThreeSevens.Solution_0_Test(input);
