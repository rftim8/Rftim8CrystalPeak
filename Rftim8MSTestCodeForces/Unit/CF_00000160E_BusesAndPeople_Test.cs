...
{
    [TestClass]
    public sealed class CF_00000160E_BusesAndPeople_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000160E_BusesAndPeople));
        ...
        {
            bool result = CF_00000160E_BusesAndPeople.Solution_0_Test(input);
