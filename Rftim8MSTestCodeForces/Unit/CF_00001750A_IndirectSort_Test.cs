...
{
    [TestClass]
    public sealed class CF_00001750A_IndirectSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001750A_IndirectSort));
        ...
        {
            bool result = CF_00001750A_IndirectSort.Solution_0_Test(input);
