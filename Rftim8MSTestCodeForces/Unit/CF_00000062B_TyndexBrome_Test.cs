...
{
    [TestClass]
    public sealed class CF_00000062B_TyndexBrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000062B_TyndexBrome));
        ...
        {
            bool result = CF_00000062B_TyndexBrome.Solution_0_Test(input);
