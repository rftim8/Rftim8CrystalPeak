...
{
    [TestClass]
    public sealed class CF_00000032E_HideandSeek_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000032E_HideandSeek));
        ...
        {
            bool result = CF_00000032E_HideandSeek.Solution_0_Test(input);
