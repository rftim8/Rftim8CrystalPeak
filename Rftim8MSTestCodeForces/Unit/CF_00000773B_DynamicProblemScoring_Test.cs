...
{
    [TestClass]
    public sealed class CF_00000773B_DynamicProblemScoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000773B_DynamicProblemScoring));
        ...
        {
            bool result = CF_00000773B_DynamicProblemScoring.Solution_0_Test(input);
