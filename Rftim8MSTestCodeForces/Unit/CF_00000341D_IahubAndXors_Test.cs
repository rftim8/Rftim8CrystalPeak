...
{
    [TestClass]
    public sealed class CF_00000341D_IahubAndXors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000341D_IahubAndXors));
        ...
        {
            bool result = CF_00000341D_IahubAndXors.Solution_0_Test(input);
