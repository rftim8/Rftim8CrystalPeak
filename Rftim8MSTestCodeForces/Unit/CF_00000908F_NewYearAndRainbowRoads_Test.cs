...
{
    [TestClass]
    public sealed class CF_00000908F_NewYearAndRainbowRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000908F_NewYearAndRainbowRoads));
        ...
        {
            bool result = CF_00000908F_NewYearAndRainbowRoads.Solution_0_Test(input);
