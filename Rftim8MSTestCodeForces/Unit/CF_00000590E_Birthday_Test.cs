...
{
    [TestClass]
    public sealed class CF_00000590E_Birthday_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000590E_Birthday));
        ...
        {
            bool result = CF_00000590E_Birthday.Solution_0_Test(input);
