...
{
    [TestClass]
    public sealed class CF_00001345B_CardConstructions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001345B_CardConstructions));
        ...
        {
            bool result = CF_00001345B_CardConstructions.Solution_0_Test(input);
