...
{
    [TestClass]
    public sealed class CF_00000025C_RoadsInBerland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000025C_RoadsInBerland));
        ...
        {
            bool result = CF_00000025C_RoadsInBerland.Solution_0_Test(input);
