...
{
    [TestClass]
    public sealed class CF_00000675B_RestoringPainting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000675B_RestoringPainting));
        ...
        {
            bool result = CF_00000675B_RestoringPainting.Solution_0_Test(input);
