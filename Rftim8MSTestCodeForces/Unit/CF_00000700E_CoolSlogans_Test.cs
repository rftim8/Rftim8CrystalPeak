...
{
    [TestClass]
    public sealed class CF_00000700E_CoolSlogans_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000700E_CoolSlogans));
        ...
        {
            bool result = CF_00000700E_CoolSlogans.Solution_0_Test(input);
