...
{
    [TestClass]
    public sealed class CF_00000402D_UpgradingArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000402D_UpgradingArray));
        ...
        {
            bool result = CF_00000402D_UpgradingArray.Solution_0_Test(input);
