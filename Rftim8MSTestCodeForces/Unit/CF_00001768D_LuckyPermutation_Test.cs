...
{
    [TestClass]
    public sealed class CF_00001768D_LuckyPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001768D_LuckyPermutation));
        ...
        {
            bool result = CF_00001768D_LuckyPermutation.Solution_0_Test(input);
