...
{
    [TestClass]
    public sealed class CF_00000793B_IgorAndHisWayToWork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000793B_IgorAndHisWayToWork));
        ...
        {
            bool result = CF_00000793B_IgorAndHisWayToWork.Solution_0_Test(input);
