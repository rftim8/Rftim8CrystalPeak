...
{
    [TestClass]
    public sealed class CF_00001081E_MissingNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001081E_MissingNumbers));
        ...
        {
            bool result = CF_00001081E_MissingNumbers.Solution_0_Test(input);
