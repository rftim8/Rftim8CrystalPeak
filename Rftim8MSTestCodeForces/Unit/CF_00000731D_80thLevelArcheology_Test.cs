...
{
    [TestClass]
    public sealed class CF_00000731D_80thLevelArcheology_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000731D_80thLevelArcheology));
        ...
        {
            bool result = CF_00000731D_80thLevelArcheology.Solution_0_Test(input);
