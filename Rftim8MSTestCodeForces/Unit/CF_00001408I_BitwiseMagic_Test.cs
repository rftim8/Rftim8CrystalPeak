...
{
    [TestClass]
    public sealed class CF_00001408I_BitwiseMagic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001408I_BitwiseMagic));
        ...
        {
            bool result = CF_00001408I_BitwiseMagic.Solution_0_Test(input);
