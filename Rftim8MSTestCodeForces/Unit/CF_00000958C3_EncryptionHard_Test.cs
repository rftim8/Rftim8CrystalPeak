...
{
    [TestClass]
    public sealed class CF_00000958C3_EncryptionHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958C3_EncryptionHard));
        ...
        {
            bool result = CF_00000958C3_EncryptionHard.Solution_0_Test(input);
