...
{
    [TestClass]
    public sealed class CF_00000466E_InformationGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000466E_InformationGraph));
        ...
        {
            bool result = CF_00000466E_InformationGraph.Solution_0_Test(input);
