...
{
    [TestClass]
    public sealed class CF_00000441A_ValeraAndAntiqueItems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000441A_ValeraAndAntiqueItems));
        ...
        {
            bool result = CF_00000441A_ValeraAndAntiqueItems.Solution_0_Test(input);
