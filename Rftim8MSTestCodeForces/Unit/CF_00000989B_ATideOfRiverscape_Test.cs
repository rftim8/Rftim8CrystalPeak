...
{
    [TestClass]
    public sealed class CF_00000989B_ATideOfRiverscape_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000989B_ATideOfRiverscape));
        ...
        {
            bool result = CF_00000989B_ATideOfRiverscape.Solution_0_Test(input);
