...
{
    [TestClass]
    public sealed class CF_00001746E1_JokingEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001746E1_JokingEasyVersion));
        ...
        {
            bool result = CF_00001746E1_JokingEasyVersion.Solution_0_Test(input);
