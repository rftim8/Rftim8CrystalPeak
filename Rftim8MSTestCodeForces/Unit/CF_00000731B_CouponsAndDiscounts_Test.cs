...
{
    [TestClass]
    public sealed class CF_00000731B_CouponsAndDiscounts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000731B_CouponsAndDiscounts));
        ...
        {
            bool result = CF_00000731B_CouponsAndDiscounts.Solution_0_Test(input);
