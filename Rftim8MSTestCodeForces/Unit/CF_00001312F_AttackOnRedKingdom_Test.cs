...
{
    [TestClass]
    public sealed class CF_00001312F_AttackOnRedKingdom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001312F_AttackOnRedKingdom));
        ...
        {
            bool result = CF_00001312F_AttackOnRedKingdom.Solution_0_Test(input);
