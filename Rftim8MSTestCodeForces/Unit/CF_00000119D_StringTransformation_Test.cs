...
{
    [TestClass]
    public sealed class CF_00000119D_StringTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000119D_StringTransformation));
        ...
        {
            bool result = CF_00000119D_StringTransformation.Solution_0_Test(input);
