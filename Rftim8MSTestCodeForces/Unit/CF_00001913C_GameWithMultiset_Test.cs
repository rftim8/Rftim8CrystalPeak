...
{
    [TestClass]
    public sealed class CF_00001913C_GameWithMultiset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001913C_GameWithMultiset));
        ...
        {
            bool result = CF_00001913C_GameWithMultiset.Solution_0_Test(input);
