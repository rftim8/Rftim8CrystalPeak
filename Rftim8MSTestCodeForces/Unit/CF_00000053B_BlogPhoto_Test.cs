...
{
    [TestClass]
    public sealed class CF_00000053B_BlogPhoto_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000053B_BlogPhoto));
        ...
        {
            bool result = CF_00000053B_BlogPhoto.Solution_0_Test(input);
