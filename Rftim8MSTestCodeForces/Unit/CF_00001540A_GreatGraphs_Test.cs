...
{
    [TestClass]
    public sealed class CF_00001540A_GreatGraphs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001540A_GreatGraphs));
        ...
        {
            bool result = CF_00001540A_GreatGraphs.Solution_0_Test(input);
