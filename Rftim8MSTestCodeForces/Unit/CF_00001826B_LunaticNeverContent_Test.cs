...
{
    [TestClass]
    public sealed class CF_00001826B_LunaticNeverContent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001826B_LunaticNeverContent));
        ...
        {
            bool result = CF_00001826B_LunaticNeverContent.Solution_0_Test(input);
