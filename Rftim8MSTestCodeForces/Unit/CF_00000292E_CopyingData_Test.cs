...
{
    [TestClass]
    public sealed class CF_00000292E_CopyingData_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000292E_CopyingData));
        ...
        {
            bool result = CF_00000292E_CopyingData.Solution_0_Test(input);
