...
{
    [TestClass]
    public sealed class CF_00001295A_DisplayTheNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001295A_DisplayTheNumber));
        ...
        {
            bool result = CF_00001295A_DisplayTheNumber.Solution_0_Test(input);
