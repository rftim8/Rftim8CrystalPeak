...
{
    [TestClass]
    public sealed class CF_00000883G_OrientationOfEdges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883G_OrientationOfEdges));
        ...
        {
            bool result = CF_00000883G_OrientationOfEdges.Solution_0_Test(input);
