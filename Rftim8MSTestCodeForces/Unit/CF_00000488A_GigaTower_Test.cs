...
{
    [TestClass]
    public sealed class CF_00000488A_GigaTower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000488A_GigaTower));
        ...
        {
            bool result = CF_00000488A_GigaTower.Solution_0_Test(input);
