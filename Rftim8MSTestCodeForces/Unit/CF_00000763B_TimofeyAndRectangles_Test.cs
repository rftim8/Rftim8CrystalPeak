...
{
    [TestClass]
    public sealed class CF_00000763B_TimofeyAndRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000763B_TimofeyAndRectangles));
        ...
        {
            bool result = CF_00000763B_TimofeyAndRectangles.Solution_0_Test(input);
