...
{
    [TestClass]
    public sealed class CF_00000297D_ColorTheCarpet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000297D_ColorTheCarpet));
        ...
        {
            bool result = CF_00000297D_ColorTheCarpet.Solution_0_Test(input);
