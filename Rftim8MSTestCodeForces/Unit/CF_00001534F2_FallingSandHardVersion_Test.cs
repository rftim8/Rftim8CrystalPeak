...
{
    [TestClass]
    public sealed class CF_00001534F2_FallingSandHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001534F2_FallingSandHardVersion));
        ...
        {
            bool result = CF_00001534F2_FallingSandHardVersion.Solution_0_Test(input);
