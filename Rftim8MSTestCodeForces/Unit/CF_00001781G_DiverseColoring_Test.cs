...
{
    [TestClass]
    public sealed class CF_00001781G_DiverseColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001781G_DiverseColoring));
        ...
        {
            bool result = CF_00001781G_DiverseColoring.Solution_0_Test(input);
