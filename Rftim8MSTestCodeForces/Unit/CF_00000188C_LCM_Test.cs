...
{
    [TestClass]
    public sealed class CF_00000188C_LCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000188C_LCM));
        ...
        {
            bool result = CF_00000188C_LCM.Solution_0_Test(input);
