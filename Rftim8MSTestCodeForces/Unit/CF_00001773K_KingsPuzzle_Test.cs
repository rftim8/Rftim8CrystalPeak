...
{
    [TestClass]
    public sealed class CF_00001773K_KingsPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001773K_KingsPuzzle));
        ...
        {
            bool result = CF_00001773K_KingsPuzzle.Solution_0_Test(input);
