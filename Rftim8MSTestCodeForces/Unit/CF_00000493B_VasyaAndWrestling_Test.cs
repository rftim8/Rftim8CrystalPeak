...
{
    [TestClass]
    public sealed class CF_00000493B_VasyaAndWrestling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000493B_VasyaAndWrestling));
        ...
        {
            bool result = CF_00000493B_VasyaAndWrestling.Solution_0_Test(input);
