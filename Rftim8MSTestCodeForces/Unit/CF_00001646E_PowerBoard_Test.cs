...
{
    [TestClass]
    public sealed class CF_00001646E_PowerBoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001646E_PowerBoard));
        ...
        {
            bool result = CF_00001646E_PowerBoard.Solution_0_Test(input);
