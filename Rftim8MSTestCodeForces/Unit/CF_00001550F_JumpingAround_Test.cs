...
{
    [TestClass]
    public sealed class CF_00001550F_JumpingAround_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001550F_JumpingAround));
        ...
        {
            bool result = CF_00001550F_JumpingAround.Solution_0_Test(input);
