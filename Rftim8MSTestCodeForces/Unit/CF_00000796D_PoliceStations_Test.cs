...
{
    [TestClass]
    public sealed class CF_00000796D_PoliceStations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000796D_PoliceStations));
        ...
        {
            bool result = CF_00000796D_PoliceStations.Solution_0_Test(input);
