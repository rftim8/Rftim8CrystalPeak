...
{
    [TestClass]
    public sealed class CF_00000424A_Squats_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000424A_Squats));
        ...
        {
            bool result = CF_00000424A_Squats.Solution_0_Test(input);
