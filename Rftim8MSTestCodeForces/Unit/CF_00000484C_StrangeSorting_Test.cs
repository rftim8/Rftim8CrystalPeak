...
{
    [TestClass]
    public sealed class CF_00000484C_StrangeSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000484C_StrangeSorting));
        ...
        {
            bool result = CF_00000484C_StrangeSorting.Solution_0_Test(input);
