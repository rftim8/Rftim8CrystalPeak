...
{
    [TestClass]
    public sealed class CF_00000409F_000001_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000409F_000001));
        ...
        {
            bool result = CF_00000409F_000001.Solution_0_Test(input);
