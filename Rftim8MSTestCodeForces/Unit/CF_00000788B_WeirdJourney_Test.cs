...
{
    [TestClass]
    public sealed class CF_00000788B_WeirdJourney_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000788B_WeirdJourney));
        ...
        {
            bool result = CF_00000788B_WeirdJourney.Solution_0_Test(input);
