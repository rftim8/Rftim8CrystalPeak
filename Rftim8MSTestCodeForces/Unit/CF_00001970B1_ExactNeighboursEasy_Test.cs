...
{
    [TestClass]
    public sealed class CF_00001970B1_ExactNeighboursEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970B1_ExactNeighboursEasy));
        ...
        {
            bool result = CF_00001970B1_ExactNeighboursEasy.Solution_0_Test(input);
