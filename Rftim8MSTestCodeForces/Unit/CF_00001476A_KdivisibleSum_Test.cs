...
{
    [TestClass]
    public sealed class CF_00001476A_KdivisibleSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001476A_KdivisibleSum));
        ...
        {
            bool result = CF_00001476A_KdivisibleSum.Solution_0_Test(input);
