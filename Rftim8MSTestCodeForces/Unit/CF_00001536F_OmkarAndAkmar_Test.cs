...
{
    [TestClass]
    public sealed class CF_00001536F_OmkarAndAkmar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001536F_OmkarAndAkmar));
        ...
        {
            bool result = CF_00001536F_OmkarAndAkmar.Solution_0_Test(input);
