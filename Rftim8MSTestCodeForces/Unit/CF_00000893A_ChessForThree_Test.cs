...
{
    [TestClass]
    public sealed class CF_00000893A_ChessForThree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000893A_ChessForThree));
        ...
        {
            bool result = CF_00000893A_ChessForThree.Solution_0_Test(input);
