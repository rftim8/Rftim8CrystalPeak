...
{
    [TestClass]
    public sealed class CF_00000622F_TheSumOfTheKthPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000622F_TheSumOfTheKthPowers));
        ...
        {
            bool result = CF_00000622F_TheSumOfTheKthPowers.Solution_0_Test(input);
