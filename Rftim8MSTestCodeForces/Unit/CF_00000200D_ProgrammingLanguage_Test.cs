...
{
    [TestClass]
    public sealed class CF_00000200D_ProgrammingLanguage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000200D_ProgrammingLanguage));
        ...
        {
            bool result = CF_00000200D_ProgrammingLanguage.Solution_0_Test(input);
