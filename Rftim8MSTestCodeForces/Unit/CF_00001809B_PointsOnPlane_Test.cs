...
{
    [TestClass]
    public sealed class CF_00001809B_PointsOnPlane_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001809B_PointsOnPlane));
        ...
        {
            bool result = CF_00001809B_PointsOnPlane.Solution_0_Test(input);
