...
{
    [TestClass]
    public sealed class CF_00000162J_Brackets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000162J_Brackets));
        ...
        {
            bool result = CF_00000162J_Brackets.Solution_0_Test(input);
