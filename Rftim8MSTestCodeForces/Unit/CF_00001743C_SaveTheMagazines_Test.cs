...
{
    [TestClass]
    public sealed class CF_00001743C_SaveTheMagazines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001743C_SaveTheMagazines));
        ...
        {
            bool result = CF_00001743C_SaveTheMagazines.Solution_0_Test(input);
