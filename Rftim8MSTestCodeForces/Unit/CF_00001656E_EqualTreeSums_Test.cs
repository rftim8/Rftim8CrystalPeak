...
{
    [TestClass]
    public sealed class CF_00001656E_EqualTreeSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001656E_EqualTreeSums));
        ...
        {
            bool result = CF_00001656E_EqualTreeSums.Solution_0_Test(input);
