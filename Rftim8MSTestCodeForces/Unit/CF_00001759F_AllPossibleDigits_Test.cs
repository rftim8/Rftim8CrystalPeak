...
{
    [TestClass]
    public sealed class CF_00001759F_AllPossibleDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001759F_AllPossibleDigits));
        ...
        {
            bool result = CF_00001759F_AllPossibleDigits.Solution_0_Test(input);
