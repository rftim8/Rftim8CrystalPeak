...
{
    [TestClass]
    public sealed class CF_00001675C_DetectiveTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001675C_DetectiveTask));
        ...
        {
            bool result = CF_00001675C_DetectiveTask.Solution_0_Test(input);
