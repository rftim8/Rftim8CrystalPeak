...
{
    [TestClass]
    public sealed class CF_00000715C_DigitTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000715C_DigitTree));
        ...
        {
            bool result = CF_00000715C_DigitTree.Solution_0_Test(input);
