...
{
    [TestClass]
    public sealed class CF_00000218A_MountainScenery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000218A_MountainScenery));
        ...
        {
            bool result = CF_00000218A_MountainScenery.Solution_0_Test(input);
