...
{
    [TestClass]
    public sealed class CF_00001440B_SumOfMedians_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001440B_SumOfMedians));
        ...
        {
            bool result = CF_00001440B_SumOfMedians.Solution_0_Test(input);
