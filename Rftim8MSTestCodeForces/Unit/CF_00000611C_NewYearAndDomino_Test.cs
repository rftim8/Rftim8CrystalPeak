...
{
    [TestClass]
    public sealed class CF_00000611C_NewYearAndDomino_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000611C_NewYearAndDomino));
        ...
        {
            bool result = CF_00000611C_NewYearAndDomino.Solution_0_Test(input);
