...
{
    [TestClass]
    public sealed class CF_00001271B_Blocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001271B_Blocks));
        ...
        {
            bool result = CF_00001271B_Blocks.Solution_0_Test(input);
