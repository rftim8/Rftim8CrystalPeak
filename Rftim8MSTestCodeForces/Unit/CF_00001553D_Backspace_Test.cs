...
{
    [TestClass]
    public sealed class CF_00001553D_Backspace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001553D_Backspace));
        ...
        {
            bool result = CF_00001553D_Backspace.Solution_0_Test(input);
