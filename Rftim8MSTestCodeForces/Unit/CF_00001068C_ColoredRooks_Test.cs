...
{
    [TestClass]
    public sealed class CF_00001068C_ColoredRooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001068C_ColoredRooks));
        ...
        {
            bool result = CF_00001068C_ColoredRooks.Solution_0_Test(input);
