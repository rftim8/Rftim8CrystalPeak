...
{
    [TestClass]
    public sealed class CF_00000011E_ForwardMarch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000011E_ForwardMarch));
        ...
        {
            bool result = CF_00000011E_ForwardMarch.Solution_0_Test(input);
