...
{
    [TestClass]
    public sealed class CF_00000552D_VanyaAndTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000552D_VanyaAndTriangles));
        ...
        {
            bool result = CF_00000552D_VanyaAndTriangles.Solution_0_Test(input);
