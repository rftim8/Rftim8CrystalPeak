...
{
    [TestClass]
    public sealed class CF_00000611F_NewYearAndCleaning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000611F_NewYearAndCleaning));
        ...
        {
            bool result = CF_00000611F_NewYearAndCleaning.Solution_0_Test(input);
