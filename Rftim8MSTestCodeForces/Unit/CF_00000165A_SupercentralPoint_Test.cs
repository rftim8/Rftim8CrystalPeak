...
{
    [TestClass]
    public sealed class CF_00000165A_SupercentralPoint_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000165A_SupercentralPoint));
        ...
        {
            bool result = CF_00000165A_SupercentralPoint.Solution_0_Test(input);
