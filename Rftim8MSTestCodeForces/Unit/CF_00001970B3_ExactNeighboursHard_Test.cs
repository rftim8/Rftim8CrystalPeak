...
{
    [TestClass]
    public sealed class CF_00001970B3_ExactNeighboursHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970B3_ExactNeighboursHard));
        ...
        {
            bool result = CF_00001970B3_ExactNeighboursHard.Solution_0_Test(input);
