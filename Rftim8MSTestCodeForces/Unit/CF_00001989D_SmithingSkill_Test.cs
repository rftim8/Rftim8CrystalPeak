...
{
    [TestClass]
    public sealed class CF_00001989D_SmithingSkill_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001989D_SmithingSkill));
        ...
        {
            bool result = CF_00001989D_SmithingSkill.Solution_0_Test(input);
