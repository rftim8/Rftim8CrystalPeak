...
{
    [TestClass]
    public sealed class CF_00001401C_MereArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001401C_MereArray));
        ...
        {
            bool result = CF_00001401C_MereArray.Solution_0_Test(input);
