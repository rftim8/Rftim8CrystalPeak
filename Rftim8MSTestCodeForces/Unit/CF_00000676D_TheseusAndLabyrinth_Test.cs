...
{
    [TestClass]
    public sealed class CF_00000676D_TheseusAndLabyrinth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000676D_TheseusAndLabyrinth));
        ...
        {
            bool result = CF_00000676D_TheseusAndLabyrinth.Solution_0_Test(input);
