...
{
    [TestClass]
    public sealed class CF_00000276B_LittleGirlAndGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000276B_LittleGirlAndGame));
        ...
        {
            bool result = CF_00000276B_LittleGirlAndGame.Solution_0_Test(input);
