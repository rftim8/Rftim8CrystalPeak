...
{
    [TestClass]
    public sealed class CF_00001066E_BinaryNumbersANDSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001066E_BinaryNumbersANDSum));
        ...
        {
            bool result = CF_00001066E_BinaryNumbersANDSum.Solution_0_Test(input);
