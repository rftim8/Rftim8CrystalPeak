...
{
    [TestClass]
    public sealed class CF_00001990B_ArrayCraft_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001990B_ArrayCraft));
        ...
        {
            bool result = CF_00001990B_ArrayCraft.Solution_0_Test(input);
