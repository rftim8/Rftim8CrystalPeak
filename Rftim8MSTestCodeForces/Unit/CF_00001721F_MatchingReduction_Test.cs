...
{
    [TestClass]
    public sealed class CF_00001721F_MatchingReduction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001721F_MatchingReduction));
        ...
        {
            bool result = CF_00001721F_MatchingReduction.Solution_0_Test(input);
