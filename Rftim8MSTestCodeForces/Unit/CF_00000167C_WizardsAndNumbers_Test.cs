...
{
    [TestClass]
    public sealed class CF_00000167C_WizardsAndNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000167C_WizardsAndNumbers));
        ...
        {
            bool result = CF_00000167C_WizardsAndNumbers.Solution_0_Test(input);
