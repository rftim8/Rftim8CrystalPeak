...
{
    [TestClass]
    public sealed class CF_00001760B_AtillasFavoriteProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001760B_AtillasFavoriteProblem));
        ...
        {
            bool result = CF_00001760B_AtillasFavoriteProblem.Solution_0_Test(input);
