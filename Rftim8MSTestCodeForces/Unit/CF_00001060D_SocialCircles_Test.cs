...
{
    [TestClass]
    public sealed class CF_00001060D_SocialCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001060D_SocialCircles));
        ...
        {
            bool result = CF_00001060D_SocialCircles.Solution_0_Test(input);
