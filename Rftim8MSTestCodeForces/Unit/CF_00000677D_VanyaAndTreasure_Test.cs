...
{
    [TestClass]
    public sealed class CF_00000677D_VanyaAndTreasure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000677D_VanyaAndTreasure));
        ...
        {
            bool result = CF_00000677D_VanyaAndTreasure.Solution_0_Test(input);
