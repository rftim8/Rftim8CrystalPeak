...
{
    [TestClass]
    public sealed class CF_00001299C_WaterBalance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001299C_WaterBalance));
        ...
        {
            bool result = CF_00001299C_WaterBalance.Solution_0_Test(input);
