...
{
    [TestClass]
    public sealed class CF_00002027E2_BitGameHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002027E2_BitGameHardVersion));
        ...
        {
            bool result = CF_00002027E2_BitGameHardVersion.Solution_0_Test(input);
