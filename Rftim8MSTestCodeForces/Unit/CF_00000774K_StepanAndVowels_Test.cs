...
{
    [TestClass]
    public sealed class CF_00000774K_StepanAndVowels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774K_StepanAndVowels));
        ...
        {
            bool result = CF_00000774K_StepanAndVowels.Solution_0_Test(input);
