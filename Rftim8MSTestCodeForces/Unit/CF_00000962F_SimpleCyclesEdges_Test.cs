...
{
    [TestClass]
    public sealed class CF_00000962F_SimpleCyclesEdges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000962F_SimpleCyclesEdges));
        ...
        {
            bool result = CF_00000962F_SimpleCyclesEdges.Solution_0_Test(input);
