...
{
    [TestClass]
    public sealed class CF_00001731F_FunctionSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001731F_FunctionSum));
        ...
        {
            bool result = CF_00001731F_FunctionSum.Solution_0_Test(input);
