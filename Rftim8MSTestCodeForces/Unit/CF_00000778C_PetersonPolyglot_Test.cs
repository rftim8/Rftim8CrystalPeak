...
{
    [TestClass]
    public sealed class CF_00000778C_PetersonPolyglot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000778C_PetersonPolyglot));
        ...
        {
            bool result = CF_00000778C_PetersonPolyglot.Solution_0_Test(input);
