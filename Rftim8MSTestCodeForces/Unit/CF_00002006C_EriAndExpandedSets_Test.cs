...
{
    [TestClass]
    public sealed class CF_00002006C_EriAndExpandedSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002006C_EriAndExpandedSets));
        ...
        {
            bool result = CF_00002006C_EriAndExpandedSets.Solution_0_Test(input);
