...
{
    [TestClass]
    public sealed class CF_00000547E_MikeAndFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000547E_MikeAndFriends));
        ...
        {
            bool result = CF_00000547E_MikeAndFriends.Solution_0_Test(input);
