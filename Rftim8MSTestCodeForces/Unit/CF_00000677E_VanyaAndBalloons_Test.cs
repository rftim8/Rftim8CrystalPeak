...
{
    [TestClass]
    public sealed class CF_00000677E_VanyaAndBalloons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000677E_VanyaAndBalloons));
        ...
        {
            bool result = CF_00000677E_VanyaAndBalloons.Solution_0_Test(input);
