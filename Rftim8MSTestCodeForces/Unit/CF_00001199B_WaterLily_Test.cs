...
{
    [TestClass]
    public sealed class CF_00001199B_WaterLily_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001199B_WaterLily));
        ...
        {
            bool result = CF_00001199B_WaterLily.Solution_0_Test(input);
