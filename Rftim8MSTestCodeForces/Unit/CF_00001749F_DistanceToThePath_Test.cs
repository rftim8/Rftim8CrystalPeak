...
{
    [TestClass]
    public sealed class CF_00001749F_DistanceToThePath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001749F_DistanceToThePath));
        ...
        {
            bool result = CF_00001749F_DistanceToThePath.Solution_0_Test(input);
