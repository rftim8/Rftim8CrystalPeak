...
{
    [TestClass]
    public sealed class CF_00000208D_PrizesPrizesMorePrizes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000208D_PrizesPrizesMorePrizes));
        ...
        {
            bool result = CF_00000208D_PrizesPrizesMorePrizes.Solution_0_Test(input);
