...
{
    [TestClass]
    public sealed class CF_00000858B_WhichFloor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000858B_WhichFloor));
        ...
        {
            bool result = CF_00000858B_WhichFloor.Solution_0_Test(input);
