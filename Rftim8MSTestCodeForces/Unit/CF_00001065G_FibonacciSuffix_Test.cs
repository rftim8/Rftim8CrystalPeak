...
{
    [TestClass]
    public sealed class CF_00001065G_FibonacciSuffix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001065G_FibonacciSuffix));
        ...
        {
            bool result = CF_00001065G_FibonacciSuffix.Solution_0_Test(input);
