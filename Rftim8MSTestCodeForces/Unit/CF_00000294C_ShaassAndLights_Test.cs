...
{
    [TestClass]
    public sealed class CF_00000294C_ShaassAndLights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000294C_ShaassAndLights));
        ...
        {
            bool result = CF_00000294C_ShaassAndLights.Solution_0_Test(input);
