...
{
    [TestClass]
    public sealed class CF_00000033C_WonderfulRandomizedSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000033C_WonderfulRandomizedSum));
        ...
        {
            bool result = CF_00000033C_WonderfulRandomizedSum.Solution_0_Test(input);
