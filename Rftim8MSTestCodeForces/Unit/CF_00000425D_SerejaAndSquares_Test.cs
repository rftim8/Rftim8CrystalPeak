...
{
    [TestClass]
    public sealed class CF_00000425D_SerejaAndSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000425D_SerejaAndSquares));
        ...
        {
            bool result = CF_00000425D_SerejaAndSquares.Solution_0_Test(input);
