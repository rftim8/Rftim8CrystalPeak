...
{
    [TestClass]
    public sealed class CF_00000468B_TwoSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000468B_TwoSets));
        ...
        {
            bool result = CF_00000468B_TwoSets.Solution_0_Test(input);
