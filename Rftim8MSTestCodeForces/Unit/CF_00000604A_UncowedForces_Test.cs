...
{
    [TestClass]
    public sealed class CF_00000604A_UncowedForces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000604A_UncowedForces));
        ...
        {
            bool result = CF_00000604A_UncowedForces.Solution_0_Test(input);
