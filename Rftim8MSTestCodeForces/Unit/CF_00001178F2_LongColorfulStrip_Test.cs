...
{
    [TestClass]
    public sealed class CF_00001178F2_LongColorfulStrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001178F2_LongColorfulStrip));
        ...
        {
            bool result = CF_00001178F2_LongColorfulStrip.Solution_0_Test(input);
