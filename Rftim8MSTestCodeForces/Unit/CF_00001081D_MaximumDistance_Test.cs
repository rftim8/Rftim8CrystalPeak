...
{
    [TestClass]
    public sealed class CF_00001081D_MaximumDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001081D_MaximumDistance));
        ...
        {
            bool result = CF_00001081D_MaximumDistance.Solution_0_Test(input);
