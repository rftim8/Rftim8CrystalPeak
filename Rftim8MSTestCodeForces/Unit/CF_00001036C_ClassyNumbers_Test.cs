...
{
    [TestClass]
    public sealed class CF_00001036C_ClassyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001036C_ClassyNumbers));
        ...
        {
            bool result = CF_00001036C_ClassyNumbers.Solution_0_Test(input);
