...
{
    [TestClass]
    public sealed class CF_00000387E_GeorgeAndCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000387E_GeorgeAndCards));
        ...
        {
            bool result = CF_00000387E_GeorgeAndCards.Solution_0_Test(input);
