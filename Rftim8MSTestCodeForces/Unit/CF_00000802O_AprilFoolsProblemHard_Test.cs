...
{
    [TestClass]
    public sealed class CF_00000802O_AprilFoolsProblemHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802O_AprilFoolsProblemHard));
        ...
        {
            bool result = CF_00000802O_AprilFoolsProblemHard.Solution_0_Test(input);
