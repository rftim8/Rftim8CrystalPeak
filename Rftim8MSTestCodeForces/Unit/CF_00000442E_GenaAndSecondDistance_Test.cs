...
{
    [TestClass]
    public sealed class CF_00000442E_GenaAndSecondDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000442E_GenaAndSecondDistance));
        ...
        {
            bool result = CF_00000442E_GenaAndSecondDistance.Solution_0_Test(input);
