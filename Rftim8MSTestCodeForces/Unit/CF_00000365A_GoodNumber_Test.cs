...
{
    [TestClass]
    public sealed class CF_00000365A_GoodNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000365A_GoodNumber));
        ...
        {
            bool result = CF_00000365A_GoodNumber.Solution_0_Test(input);
