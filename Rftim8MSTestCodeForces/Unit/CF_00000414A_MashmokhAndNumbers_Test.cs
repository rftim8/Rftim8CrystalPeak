...
{
    [TestClass]
    public sealed class CF_00000414A_MashmokhAndNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000414A_MashmokhAndNumbers));
        ...
        {
            bool result = CF_00000414A_MashmokhAndNumbers.Solution_0_Test(input);
