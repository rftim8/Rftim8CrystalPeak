...
{
    [TestClass]
    public sealed class CF_00001181E1_AStoryOfOneCountryEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001181E1_AStoryOfOneCountryEasy));
        ...
        {
            bool result = CF_00001181E1_AStoryOfOneCountryEasy.Solution_0_Test(input);
