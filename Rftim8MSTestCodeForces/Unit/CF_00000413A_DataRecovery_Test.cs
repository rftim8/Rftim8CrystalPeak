...
{
    [TestClass]
    public sealed class CF_00000413A_DataRecovery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000413A_DataRecovery));
        ...
        {
            bool result = CF_00000413A_DataRecovery.Solution_0_Test(input);
