...
{
    [TestClass]
    public sealed class CF_00001051A_VasyaAndPassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001051A_VasyaAndPassword));
        ...
        {
            bool result = CF_00001051A_VasyaAndPassword.Solution_0_Test(input);
