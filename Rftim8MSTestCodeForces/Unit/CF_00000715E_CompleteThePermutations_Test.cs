...
{
    [TestClass]
    public sealed class CF_00000715E_CompleteThePermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000715E_CompleteThePermutations));
        ...
        {
            bool result = CF_00000715E_CompleteThePermutations.Solution_0_Test(input);
