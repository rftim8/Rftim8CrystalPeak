...
{
    [TestClass]
    public sealed class CF_00000149E_MartianStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000149E_MartianStrings));
        ...
        {
            bool result = CF_00000149E_MartianStrings.Solution_0_Test(input);
