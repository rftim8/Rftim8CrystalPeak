...
{
    [TestClass]
    public sealed class CF_00000908C_NewYearAndCurling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000908C_NewYearAndCurling));
        ...
        {
            bool result = CF_00000908C_NewYearAndCurling.Solution_0_Test(input);
