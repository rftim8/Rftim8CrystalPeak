...
{
    [TestClass]
    public sealed class CF_00001360H_BinaryMedian_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001360H_BinaryMedian));
        ...
        {
            bool result = CF_00001360H_BinaryMedian.Solution_0_Test(input);
