...
{
    [TestClass]
    public sealed class CF_00001170E_SlidingDoors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001170E_SlidingDoors));
        ...
        {
            bool result = CF_00001170E_SlidingDoors.Solution_0_Test(input);
