...
{
    [TestClass]
    public sealed class CF_00001216B_Shooting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001216B_Shooting));
        ...
        {
            bool result = CF_00001216B_Shooting.Solution_0_Test(input);
