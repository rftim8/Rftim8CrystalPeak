...
{
    [TestClass]
    public sealed class CF_00000678B_TheSameCalendar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000678B_TheSameCalendar));
        ...
        {
            bool result = CF_00000678B_TheSameCalendar.Solution_0_Test(input);
