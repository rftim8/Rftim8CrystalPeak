...
{
    [TestClass]
    public sealed class CF_00001713B_OptimalReduction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001713B_OptimalReduction));
        ...
        {
            bool result = CF_00001713B_OptimalReduction.Solution_0_Test(input);
