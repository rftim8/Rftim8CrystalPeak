...
{
    [TestClass]
    public sealed class CF_00001742C_Stripes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001742C_Stripes));
        ...
        {
            bool result = CF_00001742C_Stripes.Solution_0_Test(input);
