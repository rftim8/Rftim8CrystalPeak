...
{
    [TestClass]
    public sealed class CF_00000095A_Hockey_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000095A_Hockey));
        ...
        {
            bool result = CF_00000095A_Hockey.Solution_0_Test(input);
