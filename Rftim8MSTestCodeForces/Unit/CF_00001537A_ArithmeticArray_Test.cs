...
{
    [TestClass]
    public sealed class CF_00001537A_ArithmeticArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001537A_ArithmeticArray));
        ...
        {
            bool result = CF_00001537A_ArithmeticArray.Solution_0_Test(input);
