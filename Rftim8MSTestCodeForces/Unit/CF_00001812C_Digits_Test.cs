...
{
    [TestClass]
    public sealed class CF_00001812C_Digits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001812C_Digits));
        ...
        {
            bool result = CF_00001812C_Digits.Solution_0_Test(input);
