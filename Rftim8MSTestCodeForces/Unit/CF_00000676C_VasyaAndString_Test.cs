...
{
    [TestClass]
    public sealed class CF_00000676C_VasyaAndString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000676C_VasyaAndString));
        ...
        {
            bool result = CF_00000676C_VasyaAndString.Solution_0_Test(input);
