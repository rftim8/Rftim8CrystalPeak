...
{
    [TestClass]
    public sealed class CF_00001104A_SplittingIntoDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001104A_SplittingIntoDigits));
        ...
        {
            bool result = CF_00001104A_SplittingIntoDigits.Solution_0_Test(input);
