...
{
    [TestClass]
    public sealed class CF_00001819E_RoadsInECity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001819E_RoadsInECity));
        ...
        {
            bool result = CF_00001819E_RoadsInECity.Solution_0_Test(input);
