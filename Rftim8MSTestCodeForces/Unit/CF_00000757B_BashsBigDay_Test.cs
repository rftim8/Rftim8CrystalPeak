...
{
    [TestClass]
    public sealed class CF_00000757B_BashsBigDay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000757B_BashsBigDay));
        ...
        {
            bool result = CF_00000757B_BashsBigDay.Solution_0_Test(input);
