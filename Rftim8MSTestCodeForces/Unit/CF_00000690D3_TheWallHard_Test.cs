...
{
    [TestClass]
    public sealed class CF_00000690D3_TheWallHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690D3_TheWallHard));
        ...
        {
            bool result = CF_00000690D3_TheWallHard.Solution_0_Test(input);
