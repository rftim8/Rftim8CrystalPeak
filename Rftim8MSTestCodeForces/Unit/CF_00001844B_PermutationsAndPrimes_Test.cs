...
{
    [TestClass]
    public sealed class CF_00001844B_PermutationsAndPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001844B_PermutationsAndPrimes));
        ...
        {
            bool result = CF_00001844B_PermutationsAndPrimes.Solution_0_Test(input);
