...
{
    [TestClass]
    public sealed class CF_00001295C_ObtainTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001295C_ObtainTheString));
        ...
        {
            bool result = CF_00001295C_ObtainTheString.Solution_0_Test(input);
