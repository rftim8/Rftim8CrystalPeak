...
{
    [TestClass]
    public sealed class CF_00001430C_NumbersOnWhiteboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001430C_NumbersOnWhiteboard));
        ...
        {
            bool result = CF_00001430C_NumbersOnWhiteboard.Solution_0_Test(input);
