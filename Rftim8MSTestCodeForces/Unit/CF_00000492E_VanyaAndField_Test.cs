...
{
    [TestClass]
    public sealed class CF_00000492E_VanyaAndField_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000492E_VanyaAndField));
        ...
        {
            bool result = CF_00000492E_VanyaAndField.Solution_0_Test(input);
