...
{
    [TestClass]
    public sealed class CF_00001209G2_IntoBlocksHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001209G2_IntoBlocksHardVersion));
        ...
        {
            bool result = CF_00001209G2_IntoBlocksHardVersion.Solution_0_Test(input);
