...
{
    [TestClass]
    public sealed class CF_00001641F_CoveringCircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001641F_CoveringCircle));
        ...
        {
            bool result = CF_00001641F_CoveringCircle.Solution_0_Test(input);
