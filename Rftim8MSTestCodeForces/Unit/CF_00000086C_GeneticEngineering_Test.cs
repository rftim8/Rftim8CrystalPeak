...
{
    [TestClass]
    public sealed class CF_00000086C_GeneticEngineering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000086C_GeneticEngineering));
        ...
        {
            bool result = CF_00000086C_GeneticEngineering.Solution_0_Test(input);
