...
{
    [TestClass]
    public sealed class CF_00000385D_BearAndFloodlight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000385D_BearAndFloodlight));
        ...
        {
            bool result = CF_00000385D_BearAndFloodlight.Solution_0_Test(input);
