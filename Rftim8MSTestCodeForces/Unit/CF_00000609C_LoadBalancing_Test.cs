...
{
    [TestClass]
    public sealed class CF_00000609C_LoadBalancing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000609C_LoadBalancing));
        ...
        {
            bool result = CF_00000609C_LoadBalancing.Solution_0_Test(input);
