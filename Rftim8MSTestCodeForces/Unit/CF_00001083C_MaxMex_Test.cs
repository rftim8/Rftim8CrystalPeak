...
{
    [TestClass]
    public sealed class CF_00001083C_MaxMex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001083C_MaxMex));
        ...
        {
            bool result = CF_00001083C_MaxMex.Solution_0_Test(input);
