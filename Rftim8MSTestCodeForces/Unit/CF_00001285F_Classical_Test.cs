...
{
    [TestClass]
    public sealed class CF_00001285F_Classical_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001285F_Classical));
        ...
        {
            bool result = CF_00001285F_Classical.Solution_0_Test(input);
