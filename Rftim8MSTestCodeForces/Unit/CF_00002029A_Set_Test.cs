...
{
    [TestClass]
    public sealed class CF_00002029A_Set_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002029A_Set));
        ...
        {
            bool result = CF_00002029A_Set.Solution_0_Test(input);
