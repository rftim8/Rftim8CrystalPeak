...
{
    [TestClass]
    public sealed class CF_00000016C_Monitor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000016C_Monitor));
        ...
        {
            bool result = CF_00000016C_Monitor.Solution_0_Test(input);
