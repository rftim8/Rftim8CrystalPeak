...
{
    [TestClass]
    public sealed class CF_00001423C_DusansRailway_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001423C_DusansRailway));
        ...
        {
            bool result = CF_00001423C_DusansRailway.Solution_0_Test(input);
