...
{
    [TestClass]
    public sealed class CF_00000038G_Queue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000038G_Queue));
        ...
        {
            bool result = CF_00000038G_Queue.Solution_0_Test(input);
