...
{
    [TestClass]
    public sealed class CF_00000865E_HexDyslexia_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000865E_HexDyslexia));
        ...
        {
            bool result = CF_00000865E_HexDyslexia.Solution_0_Test(input);
