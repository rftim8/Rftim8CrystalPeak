...
{
    [TestClass]
    public sealed class CF_00000675D_TreeConstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000675D_TreeConstruction));
        ...
        {
            bool result = CF_00000675D_TreeConstruction.Solution_0_Test(input);
