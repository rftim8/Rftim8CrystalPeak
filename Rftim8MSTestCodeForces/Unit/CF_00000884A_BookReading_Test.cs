...
{
    [TestClass]
    public sealed class CF_00000884A_BookReading_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000884A_BookReading));
        ...
        {
            bool result = CF_00000884A_BookReading.Solution_0_Test(input);
