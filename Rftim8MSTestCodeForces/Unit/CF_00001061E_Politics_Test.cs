...
{
    [TestClass]
    public sealed class CF_00001061E_Politics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001061E_Politics));
        ...
        {
            bool result = CF_00001061E_Politics.Solution_0_Test(input);
