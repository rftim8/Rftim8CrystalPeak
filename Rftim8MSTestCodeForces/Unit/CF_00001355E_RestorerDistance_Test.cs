...
{
    [TestClass]
    public sealed class CF_00001355E_RestorerDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001355E_RestorerDistance));
        ...
        {
            bool result = CF_00001355E_RestorerDistance.Solution_0_Test(input);
