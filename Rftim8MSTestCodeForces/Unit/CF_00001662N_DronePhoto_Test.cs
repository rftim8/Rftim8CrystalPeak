...
{
    [TestClass]
    public sealed class CF_00001662N_DronePhoto_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662N_DronePhoto));
        ...
        {
            bool result = CF_00001662N_DronePhoto.Solution_0_Test(input);
