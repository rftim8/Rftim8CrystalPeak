...
{
    [TestClass]
    public sealed class CF_00001201E2_KnightmareHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001201E2_KnightmareHard));
        ...
        {
            bool result = CF_00001201E2_KnightmareHard.Solution_0_Test(input);
