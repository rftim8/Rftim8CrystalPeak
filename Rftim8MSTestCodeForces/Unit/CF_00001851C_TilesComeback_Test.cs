...
{
    [TestClass]
    public sealed class CF_00001851C_TilesComeback_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001851C_TilesComeback));
        ...
        {
            bool result = CF_00001851C_TilesComeback.Solution_0_Test(input);
