...
{
    [TestClass]
    public sealed class CF_00001760E_BinaryInversions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001760E_BinaryInversions));
        ...
        {
            bool result = CF_00001760E_BinaryInversions.Solution_0_Test(input);
