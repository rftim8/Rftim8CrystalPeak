...
{
    [TestClass]
    public sealed class CF_00001969A_TwoFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001969A_TwoFriends));
        ...
        {
            bool result = CF_00001969A_TwoFriends.Solution_0_Test(input);
