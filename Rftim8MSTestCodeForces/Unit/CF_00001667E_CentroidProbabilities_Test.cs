...
{
    [TestClass]
    public sealed class CF_00001667E_CentroidProbabilities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001667E_CentroidProbabilities));
        ...
        {
            bool result = CF_00001667E_CentroidProbabilities.Solution_0_Test(input);
