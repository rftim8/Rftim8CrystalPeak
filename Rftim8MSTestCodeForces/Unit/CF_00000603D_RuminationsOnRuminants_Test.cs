...
{
    [TestClass]
    public sealed class CF_00000603D_RuminationsOnRuminants_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000603D_RuminationsOnRuminants));
        ...
        {
            bool result = CF_00000603D_RuminationsOnRuminants.Solution_0_Test(input);
