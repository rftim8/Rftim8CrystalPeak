...
{
    [TestClass]
    public sealed class CF_00001082B_VovaAndTrophies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001082B_VovaAndTrophies));
        ...
        {
            bool result = CF_00001082B_VovaAndTrophies.Solution_0_Test(input);
