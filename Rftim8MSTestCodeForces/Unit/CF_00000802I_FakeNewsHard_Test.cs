...
{
    [TestClass]
    public sealed class CF_00000802I_FakeNewsHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802I_FakeNewsHard));
        ...
        {
            bool result = CF_00000802I_FakeNewsHard.Solution_0_Test(input);
