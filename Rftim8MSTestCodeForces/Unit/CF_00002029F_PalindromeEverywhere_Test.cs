...
{
    [TestClass]
    public sealed class CF_00002029F_PalindromeEverywhere_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002029F_PalindromeEverywhere));
        ...
        {
            bool result = CF_00002029F_PalindromeEverywhere.Solution_0_Test(input);
