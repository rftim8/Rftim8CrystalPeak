...
{
    [TestClass]
    public sealed class CF_00001110H_ModestSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001110H_ModestSubstrings));
        ...
        {
            bool result = CF_00001110H_ModestSubstrings.Solution_0_Test(input);
