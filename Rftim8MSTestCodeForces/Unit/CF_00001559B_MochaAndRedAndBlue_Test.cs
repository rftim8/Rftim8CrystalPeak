...
{
    [TestClass]
    public sealed class CF_00001559B_MochaAndRedAndBlue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001559B_MochaAndRedAndBlue));
        ...
        {
            bool result = CF_00001559B_MochaAndRedAndBlue.Solution_0_Test(input);
