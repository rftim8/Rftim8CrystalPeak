...
{
    [TestClass]
    public sealed class CF_00000255B_CodeParsing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000255B_CodeParsing));
        ...
        {
            bool result = CF_00000255B_CodeParsing.Solution_0_Test(input);
