...
{
    [TestClass]
    public sealed class CF_00001175B_CatchOverflow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001175B_CatchOverflow));
        ...
        {
            bool result = CF_00001175B_CatchOverflow.Solution_0_Test(input);
