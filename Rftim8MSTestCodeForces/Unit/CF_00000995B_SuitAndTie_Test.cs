...
{
    [TestClass]
    public sealed class CF_00000995B_SuitAndTie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000995B_SuitAndTie));
        ...
        {
            bool result = CF_00000995B_SuitAndTie.Solution_0_Test(input);
