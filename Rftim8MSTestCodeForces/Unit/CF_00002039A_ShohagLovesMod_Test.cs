...
{
    [TestClass]
    public sealed class CF_00002039A_ShohagLovesMod_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002039A_ShohagLovesMod));
        ...
        {
            bool result = CF_00002039A_ShohagLovesMod.Solution_0_Test(input);
