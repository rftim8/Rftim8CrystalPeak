...
{
    [TestClass]
    public sealed class CF_00000382E_KseniaAndCombinatorics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000382E_KseniaAndCombinatorics));
        ...
        {
            bool result = CF_00000382E_KseniaAndCombinatorics.Solution_0_Test(input);
