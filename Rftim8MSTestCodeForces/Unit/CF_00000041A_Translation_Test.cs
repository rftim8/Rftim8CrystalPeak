...
{
    [TestClass]
    public sealed class CF_00000041A_Translation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000041A_Translation));
        ...
        {
            bool result = CF_00000041A_Translation.Solution_0_Test(input);
