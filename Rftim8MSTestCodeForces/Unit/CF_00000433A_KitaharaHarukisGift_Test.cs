...
{
    [TestClass]
    public sealed class CF_00000433A_KitaharaHarukisGift_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000433A_KitaharaHarukisGift));
        ...
        {
            bool result = CF_00000433A_KitaharaHarukisGift.Solution_0_Test(input);
