...
{
    [TestClass]
    public sealed class CF_00000794D_LabellingCities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000794D_LabellingCities));
        ...
        {
            bool result = CF_00000794D_LabellingCities.Solution_0_Test(input);
