...
{
    [TestClass]
    public sealed class CF_00001031A_GoldenPlate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001031A_GoldenPlate));
        ...
        {
            bool result = CF_00001031A_GoldenPlate.Solution_0_Test(input);
