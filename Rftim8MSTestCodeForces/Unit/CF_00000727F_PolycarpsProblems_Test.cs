...
{
    [TestClass]
    public sealed class CF_00000727F_PolycarpsProblems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000727F_PolycarpsProblems));
        ...
        {
            bool result = CF_00000727F_PolycarpsProblems.Solution_0_Test(input);
