...
{
    [TestClass]
    public sealed class CF_00001695D1_TreeQueriesEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001695D1_TreeQueriesEasyVersion));
        ...
        {
            bool result = CF_00001695D1_TreeQueriesEasyVersion.Solution_0_Test(input);
