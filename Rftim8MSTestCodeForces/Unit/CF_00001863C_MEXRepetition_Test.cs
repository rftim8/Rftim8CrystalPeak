...
{
    [TestClass]
    public sealed class CF_00001863C_MEXRepetition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001863C_MEXRepetition));
        ...
        {
            bool result = CF_00001863C_MEXRepetition.Solution_0_Test(input);
