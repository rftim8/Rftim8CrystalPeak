...
{
    [TestClass]
    public sealed class CF_00000236B_EasyNumberChallenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000236B_EasyNumberChallenge));
        ...
        {
            bool result = CF_00000236B_EasyNumberChallenge.Solution_0_Test(input);
