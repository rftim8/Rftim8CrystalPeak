...
{
    [TestClass]
    public sealed class CF_00000272A_DimaAndFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000272A_DimaAndFriends));
        ...
        {
            bool result = CF_00000272A_DimaAndFriends.Solution_0_Test(input);
