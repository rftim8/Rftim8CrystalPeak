...
{
    [TestClass]
    public sealed class CF_00001020A_NewBuildingForSIS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001020A_NewBuildingForSIS));
        ...
        {
            bool result = CF_00001020A_NewBuildingForSIS.Solution_0_Test(input);
