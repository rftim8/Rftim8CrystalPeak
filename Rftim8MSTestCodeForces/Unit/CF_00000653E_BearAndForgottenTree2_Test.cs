...
{
    [TestClass]
    public sealed class CF_00000653E_BearAndForgottenTree2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000653E_BearAndForgottenTree2));
        ...
        {
            bool result = CF_00000653E_BearAndForgottenTree2.Solution_0_Test(input);
