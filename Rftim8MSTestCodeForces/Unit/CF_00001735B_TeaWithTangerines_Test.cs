...
{
    [TestClass]
    public sealed class CF_00001735B_TeaWithTangerines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001735B_TeaWithTangerines));
        ...
        {
            bool result = CF_00001735B_TeaWithTangerines.Solution_0_Test(input);
