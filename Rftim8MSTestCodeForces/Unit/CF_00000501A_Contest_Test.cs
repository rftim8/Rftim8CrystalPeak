...
{
    [TestClass]
    public sealed class CF_00000501A_Contest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000501A_Contest));
        ...
        {
            bool result = CF_00000501A_Contest.Solution_0_Test(input);
