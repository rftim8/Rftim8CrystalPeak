...
{
    [TestClass]
    public sealed class CF_00001364C_EhabAndPrefixMEXs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001364C_EhabAndPrefixMEXs));
        ...
        {
            bool result = CF_00001364C_EhabAndPrefixMEXs.Solution_0_Test(input);
