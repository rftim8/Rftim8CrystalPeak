...
{
    [TestClass]
    public sealed class CF_00001987E_WonderfulTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001987E_WonderfulTree));
        ...
        {
            bool result = CF_00001987E_WonderfulTree.Solution_0_Test(input);
