...
{
    [TestClass]
    public sealed class CF_00001157G_InverseOfRowsAndColumns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001157G_InverseOfRowsAndColumns));
        ...
        {
            bool result = CF_00001157G_InverseOfRowsAndColumns.Solution_0_Test(input);
