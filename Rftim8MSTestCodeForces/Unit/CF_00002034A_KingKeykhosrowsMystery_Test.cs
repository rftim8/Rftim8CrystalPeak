...
{
    [TestClass]
    public sealed class CF_00002034A_KingKeykhosrowsMystery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002034A_KingKeykhosrowsMystery));
        ...
        {
            bool result = CF_00002034A_KingKeykhosrowsMystery.Solution_0_Test(input);
