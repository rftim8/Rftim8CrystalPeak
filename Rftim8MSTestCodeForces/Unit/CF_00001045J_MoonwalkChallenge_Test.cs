...
{
    [TestClass]
    public sealed class CF_00001045J_MoonwalkChallenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001045J_MoonwalkChallenge));
        ...
        {
            bool result = CF_00001045J_MoonwalkChallenge.Solution_0_Test(input);
