...
{
    [TestClass]
    public sealed class CF_00000216B_FormingTeams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000216B_FormingTeams));
        ...
        {
            bool result = CF_00000216B_FormingTeams.Solution_0_Test(input);
