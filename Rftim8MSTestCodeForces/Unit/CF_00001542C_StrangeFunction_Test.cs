...
{
    [TestClass]
    public sealed class CF_00001542C_StrangeFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001542C_StrangeFunction));
        ...
        {
            bool result = CF_00001542C_StrangeFunction.Solution_0_Test(input);
