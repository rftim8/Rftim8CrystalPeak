...
{
    [TestClass]
    public sealed class CF_00001955H_TheMostRecklessDefense_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001955H_TheMostRecklessDefense));
        ...
        {
            bool result = CF_00001955H_TheMostRecklessDefense.Solution_0_Test(input);
