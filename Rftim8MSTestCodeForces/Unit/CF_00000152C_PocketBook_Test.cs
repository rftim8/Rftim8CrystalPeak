...
{
    [TestClass]
    public sealed class CF_00000152C_PocketBook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000152C_PocketBook));
        ...
        {
            bool result = CF_00000152C_PocketBook.Solution_0_Test(input);
