...
{
    [TestClass]
    public sealed class CF_00001368F_LampsOnACircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001368F_LampsOnACircle));
        ...
        {
            bool result = CF_00001368F_LampsOnACircle.Solution_0_Test(input);
