...
{
    [TestClass]
    public sealed class CF_00001721E_PrefixFunctionQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001721E_PrefixFunctionQueries));
        ...
        {
            bool result = CF_00001721E_PrefixFunctionQueries.Solution_0_Test(input);
