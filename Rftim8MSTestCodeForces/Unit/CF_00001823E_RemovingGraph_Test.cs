...
{
    [TestClass]
    public sealed class CF_00001823E_RemovingGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001823E_RemovingGraph));
        ...
        {
            bool result = CF_00001823E_RemovingGraph.Solution_0_Test(input);
