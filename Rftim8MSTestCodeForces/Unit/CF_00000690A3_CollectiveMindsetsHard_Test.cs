...
{
    [TestClass]
    public sealed class CF_00000690A3_CollectiveMindsetsHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690A3_CollectiveMindsetsHard));
        ...
        {
            bool result = CF_00000690A3_CollectiveMindsetsHard.Solution_0_Test(input);
