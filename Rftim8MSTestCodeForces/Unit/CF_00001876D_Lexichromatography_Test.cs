...
{
    [TestClass]
    public sealed class CF_00001876D_Lexichromatography_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001876D_Lexichromatography));
        ...
        {
            bool result = CF_00001876D_Lexichromatography.Solution_0_Test(input);
