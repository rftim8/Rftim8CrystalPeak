...
{
    [TestClass]
    public sealed class CF_00000173C_SpiralMaximum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000173C_SpiralMaximum));
        ...
        {
            bool result = CF_00000173C_SpiralMaximum.Solution_0_Test(input);
