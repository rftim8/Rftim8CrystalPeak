...
{
    [TestClass]
    public sealed class CF_00001101B_Accordion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001101B_Accordion));
        ...
        {
            bool result = CF_00001101B_Accordion.Solution_0_Test(input);
