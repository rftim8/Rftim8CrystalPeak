...
{
    [TestClass]
    public sealed class CF_00001985G_DFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001985G_DFunction));
        ...
        {
            bool result = CF_00001985G_DFunction.Solution_0_Test(input);
