...
{
    [TestClass]
    public sealed class CF_00001193C_ScissorsAndTape_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001193C_ScissorsAndTape));
        ...
        {
            bool result = CF_00001193C_ScissorsAndTape.Solution_0_Test(input);
