...
{
    [TestClass]
    public sealed class CF_00001403A_ThePotionOfGreatPower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001403A_ThePotionOfGreatPower));
        ...
        {
            bool result = CF_00001403A_ThePotionOfGreatPower.Solution_0_Test(input);
