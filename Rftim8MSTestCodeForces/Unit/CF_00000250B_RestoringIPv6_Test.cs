...
{
    [TestClass]
    public sealed class CF_00000250B_RestoringIPv6_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000250B_RestoringIPv6));
        ...
        {
            bool result = CF_00000250B_RestoringIPv6.Solution_0_Test(input);
