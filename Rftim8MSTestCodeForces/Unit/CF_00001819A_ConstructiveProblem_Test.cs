...
{
    [TestClass]
    public sealed class CF_00001819A_ConstructiveProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001819A_ConstructiveProblem));
        ...
        {
            bool result = CF_00001819A_ConstructiveProblem.Solution_0_Test(input);
