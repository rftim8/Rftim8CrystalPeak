...
{
    [TestClass]
    public sealed class CF_00000140B_NewYearCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000140B_NewYearCards));
        ...
        {
            bool result = CF_00000140B_NewYearCards.Solution_0_Test(input);
