...
{
    [TestClass]
    public sealed class CF_00001034D_IntervalsOfIntervals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001034D_IntervalsOfIntervals));
        ...
        {
            bool result = CF_00001034D_IntervalsOfIntervals.Solution_0_Test(input);
