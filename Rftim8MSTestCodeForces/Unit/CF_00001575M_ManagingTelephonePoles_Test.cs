...
{
    [TestClass]
    public sealed class CF_00001575M_ManagingTelephonePoles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575M_ManagingTelephonePoles));
        ...
        {
            bool result = CF_00001575M_ManagingTelephonePoles.Solution_0_Test(input);
