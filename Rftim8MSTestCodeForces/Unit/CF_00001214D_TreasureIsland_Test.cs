...
{
    [TestClass]
    public sealed class CF_00001214D_TreasureIsland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001214D_TreasureIsland));
        ...
        {
            bool result = CF_00001214D_TreasureIsland.Solution_0_Test(input);
