...
{
    [TestClass]
    public sealed class CF_00000397B_OnCorruptionAndNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000397B_OnCorruptionAndNumbers));
        ...
        {
            bool result = CF_00000397B_OnCorruptionAndNumbers.Solution_0_Test(input);
