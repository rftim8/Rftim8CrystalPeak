...
{
    [TestClass]
    public sealed class CF_00000064H_TableBowling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000064H_TableBowling));
        ...
        {
            bool result = CF_00000064H_TableBowling.Solution_0_Test(input);
