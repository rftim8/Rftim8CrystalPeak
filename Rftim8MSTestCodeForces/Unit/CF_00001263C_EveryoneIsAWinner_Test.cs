...
{
    [TestClass]
    public sealed class CF_00001263C_EveryoneIsAWinner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001263C_EveryoneIsAWinner));
        ...
        {
            bool result = CF_00001263C_EveryoneIsAWinner.Solution_0_Test(input);
