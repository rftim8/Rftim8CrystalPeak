...
{
    [TestClass]
    public sealed class CF_00001494B_BerlandCrossword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001494B_BerlandCrossword));
        ...
        {
            bool result = CF_00001494B_BerlandCrossword.Solution_0_Test(input);
