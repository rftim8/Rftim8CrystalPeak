...
{
    [TestClass]
    public sealed class CF_00000873C_StrangeGameOnMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000873C_StrangeGameOnMatrix));
        ...
        {
            bool result = CF_00000873C_StrangeGameOnMatrix.Solution_0_Test(input);
