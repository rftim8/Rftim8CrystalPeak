...
{
    [TestClass]
    public sealed class CF_00001396A_MultiplesOfLength_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001396A_MultiplesOfLength));
        ...
        {
            bool result = CF_00001396A_MultiplesOfLength.Solution_0_Test(input);
