...
{
    [TestClass]
    public sealed class CF_00001958G_ObservationTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001958G_ObservationTowers));
        ...
        {
            bool result = CF_00001958G_ObservationTowers.Solution_0_Test(input);
