...
{
    [TestClass]
    public sealed class CF_00001994E_WoodenGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001994E_WoodenGame));
        ...
        {
            bool result = CF_00001994E_WoodenGame.Solution_0_Test(input);
