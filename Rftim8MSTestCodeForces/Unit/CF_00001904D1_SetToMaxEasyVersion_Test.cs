...
{
    [TestClass]
    public sealed class CF_00001904D1_SetToMaxEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001904D1_SetToMaxEasyVersion));
        ...
        {
            bool result = CF_00001904D1_SetToMaxEasyVersion.Solution_0_Test(input);
