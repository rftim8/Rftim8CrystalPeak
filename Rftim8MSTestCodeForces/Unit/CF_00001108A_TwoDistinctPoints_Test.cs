...
{
    [TestClass]
    public sealed class CF_00001108A_TwoDistinctPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001108A_TwoDistinctPoints));
        ...
        {
            bool result = CF_00001108A_TwoDistinctPoints.Solution_0_Test(input);
