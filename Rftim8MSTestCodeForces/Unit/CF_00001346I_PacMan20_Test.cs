...
{
    [TestClass]
    public sealed class CF_00001346I_PacMan20_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001346I_PacMan20));
        ...
        {
            bool result = CF_00001346I_PacMan20.Solution_0_Test(input);
