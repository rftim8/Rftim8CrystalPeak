...
{
    [TestClass]
    public sealed class CF_00001583H_OmkarAndTours_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001583H_OmkarAndTours));
        ...
        {
            bool result = CF_00001583H_OmkarAndTours.Solution_0_Test(input);
