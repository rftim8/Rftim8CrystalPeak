...
{
    [TestClass]
    public sealed class CF_00000576A_VasyaAndPetyasGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000576A_VasyaAndPetyasGame));
        ...
        {
            bool result = CF_00000576A_VasyaAndPetyasGame.Solution_0_Test(input);
