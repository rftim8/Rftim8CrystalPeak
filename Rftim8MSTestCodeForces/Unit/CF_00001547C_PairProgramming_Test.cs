...
{
    [TestClass]
    public sealed class CF_00001547C_PairProgramming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001547C_PairProgramming));
        ...
        {
            bool result = CF_00001547C_PairProgramming.Solution_0_Test(input);
