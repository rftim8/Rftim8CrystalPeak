...
{
    [TestClass]
    public sealed class CF_00000041D_Pawn_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000041D_Pawn));
        ...
        {
            bool result = CF_00000041D_Pawn.Solution_0_Test(input);
