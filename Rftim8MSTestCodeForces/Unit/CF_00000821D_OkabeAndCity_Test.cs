...
{
    [TestClass]
    public sealed class CF_00000821D_OkabeAndCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000821D_OkabeAndCity));
        ...
        {
            bool result = CF_00000821D_OkabeAndCity.Solution_0_Test(input);
