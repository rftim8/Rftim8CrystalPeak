...
{
    [TestClass]
    public sealed class CF_00001844E_GreatGrids_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001844E_GreatGrids));
        ...
        {
            bool result = CF_00001844E_GreatGrids.Solution_0_Test(input);
