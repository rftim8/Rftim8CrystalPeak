...
{
    [TestClass]
    public sealed class CF_00001264E_BeautifulLeague_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001264E_BeautifulLeague));
        ...
        {
            bool result = CF_00001264E_BeautifulLeague.Solution_0_Test(input);
