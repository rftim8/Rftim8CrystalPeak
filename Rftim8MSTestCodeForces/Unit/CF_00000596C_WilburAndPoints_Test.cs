...
{
    [TestClass]
    public sealed class CF_00000596C_WilburAndPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000596C_WilburAndPoints));
        ...
        {
            bool result = CF_00000596C_WilburAndPoints.Solution_0_Test(input);
