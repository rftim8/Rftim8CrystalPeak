...
{
    [TestClass]
    public sealed class CF_00001167B_LostNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001167B_LostNumbers));
        ...
        {
            bool result = CF_00001167B_LostNumbers.Solution_0_Test(input);
