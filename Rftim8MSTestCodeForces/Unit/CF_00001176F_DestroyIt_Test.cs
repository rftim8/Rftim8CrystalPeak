...
{
    [TestClass]
    public sealed class CF_00001176F_DestroyIt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001176F_DestroyIt));
        ...
        {
            bool result = CF_00001176F_DestroyIt.Solution_0_Test(input);
