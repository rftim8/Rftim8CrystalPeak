...
{
    [TestClass]
    public sealed class CF_00000119B_BeforeExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000119B_BeforeExam));
        ...
        {
            bool result = CF_00000119B_BeforeExam.Solution_0_Test(input);
