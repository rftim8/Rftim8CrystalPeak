...
{
    [TestClass]
    public sealed class CF_00000811C_VladikAndMemorableTrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000811C_VladikAndMemorableTrip));
        ...
        {
            bool result = CF_00000811C_VladikAndMemorableTrip.Solution_0_Test(input);
