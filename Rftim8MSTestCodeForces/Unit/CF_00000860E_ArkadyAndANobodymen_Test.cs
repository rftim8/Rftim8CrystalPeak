...
{
    [TestClass]
    public sealed class CF_00000860E_ArkadyAndANobodymen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000860E_ArkadyAndANobodymen));
        ...
        {
            bool result = CF_00000860E_ArkadyAndANobodymen.Solution_0_Test(input);
