...
{
    [TestClass]
    public sealed class CF_00000858A_Krounding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000858A_Krounding));
        ...
        {
            bool result = CF_00000858A_Krounding.Solution_0_Test(input);
