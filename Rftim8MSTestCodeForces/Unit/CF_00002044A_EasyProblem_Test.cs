...
{
    [TestClass]
    public sealed class CF_00002044A_EasyProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002044A_EasyProblem));
        ...
        {
            bool result = CF_00002044A_EasyProblem.Solution_0_Test(input);
