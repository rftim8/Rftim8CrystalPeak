...
{
    [TestClass]
    public sealed class CF_00000952C_RavioliSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000952C_RavioliSort));
        ...
        {
            bool result = CF_00000952C_RavioliSort.Solution_0_Test(input);
