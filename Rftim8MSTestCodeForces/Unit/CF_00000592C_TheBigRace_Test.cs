...
{
    [TestClass]
    public sealed class CF_00000592C_TheBigRace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000592C_TheBigRace));
        ...
        {
            bool result = CF_00000592C_TheBigRace.Solution_0_Test(input);
