...
{
    [TestClass]
    public sealed class CF_00001043A_Elections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001043A_Elections));
        ...
        {
            bool result = CF_00001043A_Elections.Solution_0_Test(input);
