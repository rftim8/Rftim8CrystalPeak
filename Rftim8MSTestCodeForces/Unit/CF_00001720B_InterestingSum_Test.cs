...
{
    [TestClass]
    public sealed class CF_00001720B_InterestingSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001720B_InterestingSum));
        ...
        {
            bool result = CF_00001720B_InterestingSum.Solution_0_Test(input);
