...
{
    [TestClass]
    public sealed class CF_00001431C_BlackFriday_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001431C_BlackFriday));
        ...
        {
            bool result = CF_00001431C_BlackFriday.Solution_0_Test(input);
