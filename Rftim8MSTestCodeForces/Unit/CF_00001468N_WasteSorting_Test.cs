...
{
    [TestClass]
    public sealed class CF_00001468N_WasteSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468N_WasteSorting));
        ...
        {
            bool result = CF_00001468N_WasteSorting.Solution_0_Test(input);
