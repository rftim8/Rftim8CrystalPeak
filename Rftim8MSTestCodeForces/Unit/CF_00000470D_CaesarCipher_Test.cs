...
{
    [TestClass]
    public sealed class CF_00000470D_CaesarCipher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000470D_CaesarCipher));
        ...
        {
            bool result = CF_00000470D_CaesarCipher.Solution_0_Test(input);
