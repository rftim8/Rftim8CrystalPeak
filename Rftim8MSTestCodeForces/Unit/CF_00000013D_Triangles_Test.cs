...
{
    [TestClass]
    public sealed class CF_00000013D_Triangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000013D_Triangles));
        ...
        {
            bool result = CF_00000013D_Triangles.Solution_0_Test(input);
