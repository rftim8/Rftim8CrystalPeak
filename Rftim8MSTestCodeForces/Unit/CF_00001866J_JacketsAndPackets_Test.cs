...
{
    [TestClass]
    public sealed class CF_00001866J_JacketsAndPackets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001866J_JacketsAndPackets));
        ...
        {
            bool result = CF_00001866J_JacketsAndPackets.Solution_0_Test(input);
