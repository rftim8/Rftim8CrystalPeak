...
{
    [TestClass]
    public sealed class CF_00001950B_Upscaling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001950B_Upscaling));
        ...
        {
            bool result = CF_00001950B_Upscaling.Solution_0_Test(input);
