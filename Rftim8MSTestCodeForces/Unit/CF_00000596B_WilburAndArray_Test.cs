...
{
    [TestClass]
    public sealed class CF_00000596B_WilburAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000596B_WilburAndArray));
        ...
        {
            bool result = CF_00000596B_WilburAndArray.Solution_0_Test(input);
