...
{
    [TestClass]
    public sealed class CF_00000797D_BrokenBST_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000797D_BrokenBST));
        ...
        {
            bool result = CF_00000797D_BrokenBST.Solution_0_Test(input);
