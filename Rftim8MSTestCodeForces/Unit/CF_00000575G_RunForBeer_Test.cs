...
{
    [TestClass]
    public sealed class CF_00000575G_RunForBeer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000575G_RunForBeer));
        ...
        {
            bool result = CF_00000575G_RunForBeer.Solution_0_Test(input);
