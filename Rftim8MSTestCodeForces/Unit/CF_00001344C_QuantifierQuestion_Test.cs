...
{
    [TestClass]
    public sealed class CF_00001344C_QuantifierQuestion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001344C_QuantifierQuestion));
        ...
        {
            bool result = CF_00001344C_QuantifierQuestion.Solution_0_Test(input);
