...
{
    [TestClass]
    public sealed class CF_00001420E_BattleLemmings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001420E_BattleLemmings));
        ...
        {
            bool result = CF_00001420E_BattleLemmings.Solution_0_Test(input);
