...
{
    [TestClass]
    public sealed class CF_00001081F_TrickyInteractor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001081F_TrickyInteractor));
        ...
        {
            bool result = CF_00001081F_TrickyInteractor.Solution_0_Test(input);
