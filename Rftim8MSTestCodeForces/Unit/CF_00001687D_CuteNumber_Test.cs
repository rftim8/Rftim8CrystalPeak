...
{
    [TestClass]
    public sealed class CF_00001687D_CuteNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001687D_CuteNumber));
        ...
        {
            bool result = CF_00001687D_CuteNumber.Solution_0_Test(input);
