...
{
    [TestClass]
    public sealed class CF_00000656A_DaVinciPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000656A_DaVinciPowers));
        ...
        {
            bool result = CF_00000656A_DaVinciPowers.Solution_0_Test(input);
