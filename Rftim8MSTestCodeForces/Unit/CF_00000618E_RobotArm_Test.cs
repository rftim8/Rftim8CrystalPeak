...
{
    [TestClass]
    public sealed class CF_00000618E_RobotArm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000618E_RobotArm));
        ...
        {
            bool result = CF_00000618E_RobotArm.Solution_0_Test(input);
