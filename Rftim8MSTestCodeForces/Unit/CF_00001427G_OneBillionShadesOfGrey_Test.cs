...
{
    [TestClass]
    public sealed class CF_00001427G_OneBillionShadesOfGrey_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001427G_OneBillionShadesOfGrey));
        ...
        {
            bool result = CF_00001427G_OneBillionShadesOfGrey.Solution_0_Test(input);
