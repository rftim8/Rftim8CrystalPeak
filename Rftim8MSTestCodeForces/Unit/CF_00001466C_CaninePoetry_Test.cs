...
{
    [TestClass]
    public sealed class CF_00001466C_CaninePoetry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001466C_CaninePoetry));
        ...
        {
            bool result = CF_00001466C_CaninePoetry.Solution_0_Test(input);
