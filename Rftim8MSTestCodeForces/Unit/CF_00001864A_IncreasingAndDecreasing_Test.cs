...
{
    [TestClass]
    public sealed class CF_00001864A_IncreasingAndDecreasing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001864A_IncreasingAndDecreasing));
        ...
        {
            bool result = CF_00001864A_IncreasingAndDecreasing.Solution_0_Test(input);
