...
{
    [TestClass]
    public sealed class CF_00000520A_Pangram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000520A_Pangram));
        ...
        {
            bool result = CF_00000520A_Pangram.Solution_0_Test(input);
