...
{
    [TestClass]
    public sealed class CF_00001523D_LoveHate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001523D_LoveHate));
        ...
        {
            bool result = CF_00001523D_LoveHate.Solution_0_Test(input);
