...
{
    [TestClass]
    public sealed class CF_00001017F_TheNeutralZone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001017F_TheNeutralZone));
        ...
        {
            bool result = CF_00001017F_TheNeutralZone.Solution_0_Test(input);
