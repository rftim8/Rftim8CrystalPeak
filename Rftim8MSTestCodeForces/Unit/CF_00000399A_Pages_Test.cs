...
{
    [TestClass]
    public sealed class CF_00000399A_Pages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000399A_Pages));
        ...
        {
            bool result = CF_00000399A_Pages.Solution_0_Test(input);
