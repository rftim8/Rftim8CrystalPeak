...
{
    [TestClass]
    public sealed class CF_00000798D_MikeAndDistribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000798D_MikeAndDistribution));
        ...
        {
            bool result = CF_00000798D_MikeAndDistribution.Solution_0_Test(input);
