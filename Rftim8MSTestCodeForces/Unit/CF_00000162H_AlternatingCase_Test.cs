...
{
    [TestClass]
    public sealed class CF_00000162H_AlternatingCase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000162H_AlternatingCase));
        ...
        {
            bool result = CF_00000162H_AlternatingCase.Solution_0_Test(input);
