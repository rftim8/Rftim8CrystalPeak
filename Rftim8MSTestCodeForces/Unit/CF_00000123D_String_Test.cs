...
{
    [TestClass]
    public sealed class CF_00000123D_String_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000123D_String));
        ...
        {
            bool result = CF_00000123D_String.Solution_0_Test(input);
