...
{
    [TestClass]
    public sealed class CF_00002014A_RobinHelps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002014A_RobinHelps));
        ...
        {
            bool result = CF_00002014A_RobinHelps.Solution_0_Test(input);
