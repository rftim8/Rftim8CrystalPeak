...
{
    [TestClass]
    public sealed class CF_00000055C_PieOrDie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000055C_PieOrDie));
        ...
        {
            bool result = CF_00000055C_PieOrDie.Solution_0_Test(input);
