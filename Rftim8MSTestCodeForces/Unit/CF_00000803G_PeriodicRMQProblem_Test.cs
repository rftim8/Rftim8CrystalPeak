...
{
    [TestClass]
    public sealed class CF_00000803G_PeriodicRMQProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000803G_PeriodicRMQProblem));
        ...
        {
            bool result = CF_00000803G_PeriodicRMQProblem.Solution_0_Test(input);
