...
{
    [TestClass]
    public sealed class CF_00000161C_Abracadabra_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000161C_Abracadabra));
        ...
        {
            bool result = CF_00000161C_Abracadabra.Solution_0_Test(input);
