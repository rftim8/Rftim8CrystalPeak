...
{
    [TestClass]
    public sealed class CF_00001692C_WheresTheBishop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001692C_WheresTheBishop));
        ...
        {
            bool result = CF_00001692C_WheresTheBishop.Solution_0_Test(input);
