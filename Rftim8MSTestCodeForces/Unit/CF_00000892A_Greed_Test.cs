...
{
    [TestClass]
    public sealed class CF_00000892A_Greed_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000892A_Greed));
        ...
        {
            bool result = CF_00000892A_Greed.Solution_0_Test(input);
