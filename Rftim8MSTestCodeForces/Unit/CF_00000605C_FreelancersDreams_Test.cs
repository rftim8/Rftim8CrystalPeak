...
{
    [TestClass]
    public sealed class CF_00000605C_FreelancersDreams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000605C_FreelancersDreams));
        ...
        {
            bool result = CF_00000605C_FreelancersDreams.Solution_0_Test(input);
