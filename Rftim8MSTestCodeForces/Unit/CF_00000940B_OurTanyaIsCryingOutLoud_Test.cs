...
{
    [TestClass]
    public sealed class CF_00000940B_OurTanyaIsCryingOutLoud_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000940B_OurTanyaIsCryingOutLoud));
        ...
        {
            bool result = CF_00000940B_OurTanyaIsCryingOutLoud.Solution_0_Test(input);
