...
{
    [TestClass]
    public sealed class CF_00001974B_SymmetricEncoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001974B_SymmetricEncoding));
        ...
        {
            bool result = CF_00001974B_SymmetricEncoding.Solution_0_Test(input);
