...
{
    [TestClass]
    public sealed class CF_00000471B_MUHAndImportantThings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000471B_MUHAndImportantThings));
        ...
        {
            bool result = CF_00000471B_MUHAndImportantThings.Solution_0_Test(input);
