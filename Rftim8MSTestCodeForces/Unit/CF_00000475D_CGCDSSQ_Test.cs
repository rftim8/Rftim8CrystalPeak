...
{
    [TestClass]
    public sealed class CF_00000475D_CGCDSSQ_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000475D_CGCDSSQ));
        ...
        {
            bool result = CF_00000475D_CGCDSSQ.Solution_0_Test(input);
