...
{
    [TestClass]
    public sealed class CF_00000558C_AmrAndChemistry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000558C_AmrAndChemistry));
        ...
        {
            bool result = CF_00000558C_AmrAndChemistry.Solution_0_Test(input);
