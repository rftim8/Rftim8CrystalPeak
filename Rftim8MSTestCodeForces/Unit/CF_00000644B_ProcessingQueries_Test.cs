...
{
    [TestClass]
    public sealed class CF_00000644B_ProcessingQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000644B_ProcessingQueries));
        ...
        {
            bool result = CF_00000644B_ProcessingQueries.Solution_0_Test(input);
