...
{
    [TestClass]
    public sealed class CF_00000924E_Wardrobe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000924E_Wardrobe));
        ...
        {
            bool result = CF_00000924E_Wardrobe.Solution_0_Test(input);
