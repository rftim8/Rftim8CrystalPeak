...
{
    [TestClass]
    public sealed class CF_00000954D_FightAgainstTraffic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000954D_FightAgainstTraffic));
        ...
        {
            bool result = CF_00000954D_FightAgainstTraffic.Solution_0_Test(input);
