...
{
    [TestClass]
    public sealed class CF_00001654E_ArithmeticOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001654E_ArithmeticOperations));
        ...
        {
            bool result = CF_00001654E_ArithmeticOperations.Solution_0_Test(input);
