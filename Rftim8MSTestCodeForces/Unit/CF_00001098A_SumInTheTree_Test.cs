...
{
    [TestClass]
    public sealed class CF_00001098A_SumInTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001098A_SumInTheTree));
        ...
        {
            bool result = CF_00001098A_SumInTheTree.Solution_0_Test(input);
