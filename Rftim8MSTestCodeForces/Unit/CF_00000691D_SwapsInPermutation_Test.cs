...
{
    [TestClass]
    public sealed class CF_00000691D_SwapsInPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000691D_SwapsInPermutation));
        ...
        {
            bool result = CF_00000691D_SwapsInPermutation.Solution_0_Test(input);
