...
{
    [TestClass]
    public sealed class CF_00000370D_BrokenMonitor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000370D_BrokenMonitor));
        ...
        {
            bool result = CF_00000370D_BrokenMonitor.Solution_0_Test(input);
