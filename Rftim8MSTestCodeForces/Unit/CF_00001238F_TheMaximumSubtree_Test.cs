...
{
    [TestClass]
    public sealed class CF_00001238F_TheMaximumSubtree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001238F_TheMaximumSubtree));
        ...
        {
            bool result = CF_00001238F_TheMaximumSubtree.Solution_0_Test(input);
