...
{
    [TestClass]
    public sealed class CF_00001057A_BmailComputerNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001057A_BmailComputerNetwork));
        ...
        {
            bool result = CF_00001057A_BmailComputerNetwork.Solution_0_Test(input);
