...
{
    [TestClass]
    public sealed class CF_00001454F_ArrayPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001454F_ArrayPartition));
        ...
        {
            bool result = CF_00001454F_ArrayPartition.Solution_0_Test(input);
