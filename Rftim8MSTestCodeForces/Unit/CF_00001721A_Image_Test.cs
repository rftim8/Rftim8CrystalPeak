...
{
    [TestClass]
    public sealed class CF_00001721A_Image_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001721A_Image));
        ...
        {
            bool result = CF_00001721A_Image.Solution_0_Test(input);
