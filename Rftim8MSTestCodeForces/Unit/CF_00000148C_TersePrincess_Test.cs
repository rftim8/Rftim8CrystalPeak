...
{
    [TestClass]
    public sealed class CF_00000148C_TersePrincess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000148C_TersePrincess));
        ...
        {
            bool result = CF_00000148C_TersePrincess.Solution_0_Test(input);
