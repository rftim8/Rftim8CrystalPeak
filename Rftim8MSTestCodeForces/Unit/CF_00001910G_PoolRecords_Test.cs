...
{
    [TestClass]
    public sealed class CF_00001910G_PoolRecords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001910G_PoolRecords));
        ...
        {
            bool result = CF_00001910G_PoolRecords.Solution_0_Test(input);
