...
{
    [TestClass]
    public sealed class CF_00001368C_EvenPicture_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001368C_EvenPicture));
        ...
        {
            bool result = CF_00001368C_EvenPicture.Solution_0_Test(input);
