...
{
    [TestClass]
    public sealed class CF_00000994A_Fingerprints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000994A_Fingerprints));
        ...
        {
            bool result = CF_00000994A_Fingerprints.Solution_0_Test(input);
