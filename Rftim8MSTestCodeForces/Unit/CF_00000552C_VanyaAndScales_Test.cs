...
{
    [TestClass]
    public sealed class CF_00000552C_VanyaAndScales_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000552C_VanyaAndScales));
        ...
        {
            bool result = CF_00000552C_VanyaAndScales.Solution_0_Test(input);
