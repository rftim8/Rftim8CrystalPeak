...
{
    [TestClass]
    public sealed class CF_00001391E_PairsOfPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001391E_PairsOfPairs));
        ...
        {
            bool result = CF_00001391E_PairsOfPairs.Solution_0_Test(input);
