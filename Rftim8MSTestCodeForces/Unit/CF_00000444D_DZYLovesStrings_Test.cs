...
{
    [TestClass]
    public sealed class CF_00000444D_DZYLovesStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000444D_DZYLovesStrings));
        ...
        {
            bool result = CF_00000444D_DZYLovesStrings.Solution_0_Test(input);
