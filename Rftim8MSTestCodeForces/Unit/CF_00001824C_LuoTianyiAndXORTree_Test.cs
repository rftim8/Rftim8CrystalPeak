...
{
    [TestClass]
    public sealed class CF_00001824C_LuoTianyiAndXORTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001824C_LuoTianyiAndXORTree));
        ...
        {
            bool result = CF_00001824C_LuoTianyiAndXORTree.Solution_0_Test(input);
