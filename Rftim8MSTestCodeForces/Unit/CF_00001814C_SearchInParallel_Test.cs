...
{
    [TestClass]
    public sealed class CF_00001814C_SearchInParallel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001814C_SearchInParallel));
        ...
        {
            bool result = CF_00001814C_SearchInParallel.Solution_0_Test(input);
