...
{
    [TestClass]
    public sealed class CF_00000030A_Accounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000030A_Accounting));
        ...
        {
            bool result = CF_00000030A_Accounting.Solution_0_Test(input);
