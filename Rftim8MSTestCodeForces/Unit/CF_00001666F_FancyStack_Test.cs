...
{
    [TestClass]
    public sealed class CF_00001666F_FancyStack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001666F_FancyStack));
        ...
        {
            bool result = CF_00001666F_FancyStack.Solution_0_Test(input);
