...
{
    [TestClass]
    public sealed class CF_00001923D_Slimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001923D_Slimes));
        ...
        {
            bool result = CF_00001923D_Slimes.Solution_0_Test(input);
