...
{
    [TestClass]
    public sealed class CF_00000165E_CompatibleNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000165E_CompatibleNumbers));
        ...
        {
            bool result = CF_00000165E_CompatibleNumbers.Solution_0_Test(input);
