...
{
    [TestClass]
    public sealed class CF_00000533E_CorrectingMistakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000533E_CorrectingMistakes));
        ...
        {
            bool result = CF_00000533E_CorrectingMistakes.Solution_0_Test(input);
