...
{
    [TestClass]
    public sealed class CF_00001743G_AntifibonacciCut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001743G_AntifibonacciCut));
        ...
        {
            bool result = CF_00001743G_AntifibonacciCut.Solution_0_Test(input);
