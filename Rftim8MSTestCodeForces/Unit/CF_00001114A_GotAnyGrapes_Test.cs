...
{
    [TestClass]
    public sealed class CF_00001114A_GotAnyGrapes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001114A_GotAnyGrapes));
        ...
        {
            bool result = CF_00001114A_GotAnyGrapes.Solution_0_Test(input);
