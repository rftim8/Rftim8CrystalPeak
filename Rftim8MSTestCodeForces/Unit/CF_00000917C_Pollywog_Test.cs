...
{
    [TestClass]
    public sealed class CF_00000917C_Pollywog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000917C_Pollywog));
        ...
        {
            bool result = CF_00000917C_Pollywog.Solution_0_Test(input);
