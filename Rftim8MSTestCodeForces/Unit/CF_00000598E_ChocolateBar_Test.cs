...
{
    [TestClass]
    public sealed class CF_00000598E_ChocolateBar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000598E_ChocolateBar));
        ...
        {
            bool result = CF_00000598E_ChocolateBar.Solution_0_Test(input);
