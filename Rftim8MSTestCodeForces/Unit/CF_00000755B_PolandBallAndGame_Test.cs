...
{
    [TestClass]
    public sealed class CF_00000755B_PolandBallAndGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000755B_PolandBallAndGame));
        ...
        {
            bool result = CF_00000755B_PolandBallAndGame.Solution_0_Test(input);
