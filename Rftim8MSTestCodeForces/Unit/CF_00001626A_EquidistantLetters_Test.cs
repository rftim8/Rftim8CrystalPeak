...
{
    [TestClass]
    public sealed class CF_00001626A_EquidistantLetters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001626A_EquidistantLetters));
        ...
        {
            bool result = CF_00001626A_EquidistantLetters.Solution_0_Test(input);
