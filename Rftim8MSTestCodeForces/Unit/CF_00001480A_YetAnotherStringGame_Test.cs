...
{
    [TestClass]
    public sealed class CF_00001480A_YetAnotherStringGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001480A_YetAnotherStringGame));
        ...
        {
            bool result = CF_00001480A_YetAnotherStringGame.Solution_0_Test(input);
