...
{
    [TestClass]
    public sealed class CF_00000026C_Parquet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000026C_Parquet));
        ...
        {
            bool result = CF_00000026C_Parquet.Solution_0_Test(input);
