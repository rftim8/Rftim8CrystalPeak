...
{
    [TestClass]
    public sealed class CF_00001907B_YetnotherrokenKeoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001907B_YetnotherrokenKeoard));
        ...
        {
            bool result = CF_00001907B_YetnotherrokenKeoard.Solution_0_Test(input);
