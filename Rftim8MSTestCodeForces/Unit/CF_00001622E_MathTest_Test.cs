...
{
    [TestClass]
    public sealed class CF_00001622E_MathTest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001622E_MathTest));
        ...
        {
            bool result = CF_00001622E_MathTest.Solution_0_Test(input);
