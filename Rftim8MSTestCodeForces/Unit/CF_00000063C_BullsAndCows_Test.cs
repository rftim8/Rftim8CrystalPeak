...
{
    [TestClass]
    public sealed class CF_00000063C_BullsAndCows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000063C_BullsAndCows));
        ...
        {
            bool result = CF_00000063C_BullsAndCows.Solution_0_Test(input);
