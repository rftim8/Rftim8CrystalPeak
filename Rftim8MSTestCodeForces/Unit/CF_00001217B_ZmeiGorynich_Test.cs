...
{
    [TestClass]
    public sealed class CF_00001217B_ZmeiGorynich_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001217B_ZmeiGorynich));
        ...
        {
            bool result = CF_00001217B_ZmeiGorynich.Solution_0_Test(input);
