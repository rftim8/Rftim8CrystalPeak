...
{
    [TestClass]
    public sealed class CF_00000160C_FindPair_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000160C_FindPair));
        ...
        {
            bool result = CF_00000160C_FindPair.Solution_0_Test(input);
