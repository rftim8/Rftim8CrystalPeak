...
{
    [TestClass]
    public sealed class CF_00001575G_GCDFestival_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575G_GCDFestival));
        ...
        {
            bool result = CF_00001575G_GCDFestival.Solution_0_Test(input);
