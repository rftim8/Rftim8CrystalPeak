...
{
    [TestClass]
    public sealed class CF_00001297B_Cartoons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001297B_Cartoons));
        ...
        {
            bool result = CF_00001297B_Cartoons.Solution_0_Test(input);
