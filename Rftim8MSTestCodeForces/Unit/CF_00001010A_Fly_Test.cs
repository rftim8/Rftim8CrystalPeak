...
{
    [TestClass]
    public sealed class CF_00001010A_Fly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001010A_Fly));
        ...
        {
            bool result = CF_00001010A_Fly.Solution_0_Test(input);
