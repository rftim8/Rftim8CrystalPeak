...
{
    [TestClass]
    public sealed class CF_00001546A_AquaMoonAndTwoArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001546A_AquaMoonAndTwoArrays));
        ...
        {
            bool result = CF_00001546A_AquaMoonAndTwoArrays.Solution_0_Test(input);
