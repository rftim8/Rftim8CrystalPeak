...
{
    [TestClass]
    public sealed class CF_00001891F_AGrowingTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001891F_AGrowingTree));
        ...
        {
            bool result = CF_00001891F_AGrowingTree.Solution_0_Test(input);
