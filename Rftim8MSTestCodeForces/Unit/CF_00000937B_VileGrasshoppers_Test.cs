...
{
    [TestClass]
    public sealed class CF_00000937B_VileGrasshoppers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000937B_VileGrasshoppers));
        ...
        {
            bool result = CF_00000937B_VileGrasshoppers.Solution_0_Test(input);
