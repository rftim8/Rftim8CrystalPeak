...
{
    [TestClass]
    public sealed class CF_00001485B_ReplaceAndKeepSorted_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001485B_ReplaceAndKeepSorted));
        ...
        {
            bool result = CF_00001485B_ReplaceAndKeepSorted.Solution_0_Test(input);
