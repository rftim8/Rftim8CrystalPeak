...
{
    [TestClass]
    public sealed class CF_00000385C_BearAndPrimeNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000385C_BearAndPrimeNumbers));
        ...
        {
            bool result = CF_00000385C_BearAndPrimeNumbers.Solution_0_Test(input);
