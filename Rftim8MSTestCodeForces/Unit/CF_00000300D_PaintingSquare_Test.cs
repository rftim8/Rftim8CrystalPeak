...
{
    [TestClass]
    public sealed class CF_00000300D_PaintingSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000300D_PaintingSquare));
        ...
        {
            bool result = CF_00000300D_PaintingSquare.Solution_0_Test(input);
