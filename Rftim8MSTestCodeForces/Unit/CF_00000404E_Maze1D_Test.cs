...
{
    [TestClass]
    public sealed class CF_00000404E_Maze1D_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000404E_Maze1D));
        ...
        {
            bool result = CF_00000404E_Maze1D.Solution_0_Test(input);
