...
{
    [TestClass]
    public sealed class CF_00001550C_ManhattanSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001550C_ManhattanSubarrays));
        ...
        {
            bool result = CF_00001550C_ManhattanSubarrays.Solution_0_Test(input);
