...
{
    [TestClass]
    public sealed class CF_00000557B_PashaAndTea_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000557B_PashaAndTea));
        ...
        {
            bool result = CF_00000557B_PashaAndTea.Solution_0_Test(input);
