...
{
    [TestClass]
    public sealed class CF_00001943E2_MEXGame2HardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001943E2_MEXGame2HardVersion));
        ...
        {
            bool result = CF_00001943E2_MEXGame2HardVersion.Solution_0_Test(input);
