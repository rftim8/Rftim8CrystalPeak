...
{
    [TestClass]
    public sealed class CF_00001654C_AliceAndTheCake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001654C_AliceAndTheCake));
        ...
        {
            bool result = CF_00001654C_AliceAndTheCake.Solution_0_Test(input);
