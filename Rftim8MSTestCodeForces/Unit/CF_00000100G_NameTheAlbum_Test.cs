...
{
    [TestClass]
    public sealed class CF_00000100G_NameTheAlbum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000100G_NameTheAlbum));
        ...
        {
            bool result = CF_00000100G_NameTheAlbum.Solution_0_Test(input);
