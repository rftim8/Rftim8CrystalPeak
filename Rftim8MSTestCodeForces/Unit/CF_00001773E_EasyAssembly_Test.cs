...
{
    [TestClass]
    public sealed class CF_00001773E_EasyAssembly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001773E_EasyAssembly));
        ...
        {
            bool result = CF_00001773E_EasyAssembly.Solution_0_Test(input);
