...
{
    [TestClass]
    public sealed class CF_00000779C_DishonestSellers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000779C_DishonestSellers));
        ...
        {
            bool result = CF_00000779C_DishonestSellers.Solution_0_Test(input);
