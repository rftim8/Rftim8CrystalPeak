...
{
    [TestClass]
    public sealed class CF_00001728A_ColoredBallsRevisited_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001728A_ColoredBallsRevisited));
        ...
        {
            bool result = CF_00001728A_ColoredBallsRevisited.Solution_0_Test(input);
