...
{
    [TestClass]
    public sealed class CF_00001107B_DigitalRoot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001107B_DigitalRoot));
        ...
        {
            bool result = CF_00001107B_DigitalRoot.Solution_0_Test(input);
