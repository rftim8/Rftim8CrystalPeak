...
{
    [TestClass]
    public sealed class CF_00000285B_FindMarble_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000285B_FindMarble));
        ...
        {
            bool result = CF_00000285B_FindMarble.Solution_0_Test(input);
