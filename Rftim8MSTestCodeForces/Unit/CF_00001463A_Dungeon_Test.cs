...
{
    [TestClass]
    public sealed class CF_00001463A_Dungeon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001463A_Dungeon));
        ...
        {
            bool result = CF_00001463A_Dungeon.Solution_0_Test(input);
