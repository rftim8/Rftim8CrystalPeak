...
{
    [TestClass]
    public sealed class CF_00001009F_DominantIndices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001009F_DominantIndices));
        ...
        {
            bool result = CF_00001009F_DominantIndices.Solution_0_Test(input);
