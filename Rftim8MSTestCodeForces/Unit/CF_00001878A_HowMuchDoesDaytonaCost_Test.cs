...
{
    [TestClass]
    public sealed class CF_00001878A_HowMuchDoesDaytonaCost_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001878A_HowMuchDoesDaytonaCost));
        ...
        {
            bool result = CF_00001878A_HowMuchDoesDaytonaCost.Solution_0_Test(input);
