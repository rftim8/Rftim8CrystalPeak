...
{
    [TestClass]
    public sealed class CF_00000235C_CyclicalQuest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000235C_CyclicalQuest));
        ...
        {
            bool result = CF_00000235C_CyclicalQuest.Solution_0_Test(input);
