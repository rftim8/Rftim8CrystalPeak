...
{
    [TestClass]
    public sealed class CF_00001802A_Likes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001802A_Likes));
        ...
        {
            bool result = CF_00001802A_Likes.Solution_0_Test(input);
