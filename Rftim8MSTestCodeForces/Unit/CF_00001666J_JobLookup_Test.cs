...
{
    [TestClass]
    public sealed class CF_00001666J_JobLookup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001666J_JobLookup));
        ...
        {
            bool result = CF_00001666J_JobLookup.Solution_0_Test(input);
