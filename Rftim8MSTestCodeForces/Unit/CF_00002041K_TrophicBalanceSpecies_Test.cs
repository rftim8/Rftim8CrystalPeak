...
{
    [TestClass]
    public sealed class CF_00002041K_TrophicBalanceSpecies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002041K_TrophicBalanceSpecies));
        ...
        {
            bool result = CF_00002041K_TrophicBalanceSpecies.Solution_0_Test(input);
