...
{
    [TestClass]
    public sealed class CF_00001744C_TrafficLight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001744C_TrafficLight));
        ...
        {
            bool result = CF_00001744C_TrafficLight.Solution_0_Test(input);
