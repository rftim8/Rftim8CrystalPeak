...
{
    [TestClass]
    public sealed class CF_00001662O_CircularMaze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662O_CircularMaze));
        ...
        {
            bool result = CF_00001662O_CircularMaze.Solution_0_Test(input);
