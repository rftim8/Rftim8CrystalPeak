...
{
    [TestClass]
    public sealed class CF_00001343D_ConstantPalindromeSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001343D_ConstantPalindromeSum));
        ...
        {
            bool result = CF_00001343D_ConstantPalindromeSum.Solution_0_Test(input);
