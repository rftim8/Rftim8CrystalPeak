...
{
    [TestClass]
    public sealed class CF_00000144D_MissileSilos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000144D_MissileSilos));
        ...
        {
            bool result = CF_00000144D_MissileSilos.Solution_0_Test(input);
