...
{
    [TestClass]
    public sealed class CF_00000400E_InnaAndBinaryLogic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000400E_InnaAndBinaryLogic));
        ...
        {
            bool result = CF_00000400E_InnaAndBinaryLogic.Solution_0_Test(input);
