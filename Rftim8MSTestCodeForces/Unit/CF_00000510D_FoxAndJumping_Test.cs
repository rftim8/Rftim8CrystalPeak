...
{
    [TestClass]
    public sealed class CF_00000510D_FoxAndJumping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000510D_FoxAndJumping));
        ...
        {
            bool result = CF_00000510D_FoxAndJumping.Solution_0_Test(input);
