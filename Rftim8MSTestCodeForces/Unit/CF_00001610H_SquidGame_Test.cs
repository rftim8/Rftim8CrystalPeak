...
{
    [TestClass]
    public sealed class CF_00001610H_SquidGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001610H_SquidGame));
        ...
        {
            bool result = CF_00001610H_SquidGame.Solution_0_Test(input);
