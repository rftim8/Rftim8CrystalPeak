...
{
    [TestClass]
    public sealed class CF_00000963D_FrequencyOfString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000963D_FrequencyOfString));
        ...
        {
            bool result = CF_00000963D_FrequencyOfString.Solution_0_Test(input);
