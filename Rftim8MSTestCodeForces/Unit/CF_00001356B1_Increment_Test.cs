...
{
    [TestClass]
    public sealed class CF_00001356B1_Increment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001356B1_Increment));
        ...
        {
            bool result = CF_00001356B1_Increment.Solution_0_Test(input);
