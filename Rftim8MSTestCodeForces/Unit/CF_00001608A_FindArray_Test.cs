...
{
    [TestClass]
    public sealed class CF_00001608A_FindArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001608A_FindArray));
        ...
        {
            bool result = CF_00001608A_FindArray.Solution_0_Test(input);
