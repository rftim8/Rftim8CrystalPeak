...
{
    [TestClass]
    public sealed class CF_00000140A_NewYearTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000140A_NewYearTable));
        ...
        {
            bool result = CF_00000140A_NewYearTable.Solution_0_Test(input);
