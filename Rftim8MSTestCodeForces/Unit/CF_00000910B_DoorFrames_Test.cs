...
{
    [TestClass]
    public sealed class CF_00000910B_DoorFrames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000910B_DoorFrames));
        ...
        {
            bool result = CF_00000910B_DoorFrames.Solution_0_Test(input);
