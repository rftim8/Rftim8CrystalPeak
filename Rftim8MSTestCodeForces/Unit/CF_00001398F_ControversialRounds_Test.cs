...
{
    [TestClass]
    public sealed class CF_00001398F_ControversialRounds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001398F_ControversialRounds));
        ...
        {
            bool result = CF_00001398F_ControversialRounds.Solution_0_Test(input);
