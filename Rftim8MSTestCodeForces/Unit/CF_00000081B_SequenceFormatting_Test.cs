...
{
    [TestClass]
    public sealed class CF_00000081B_SequenceFormatting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000081B_SequenceFormatting));
        ...
        {
            bool result = CF_00000081B_SequenceFormatting.Solution_0_Test(input);
