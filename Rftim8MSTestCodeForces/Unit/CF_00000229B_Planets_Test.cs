...
{
    [TestClass]
    public sealed class CF_00000229B_Planets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000229B_Planets));
        ...
        {
            bool result = CF_00000229B_Planets.Solution_0_Test(input);
