...
{
    [TestClass]
    public sealed class CF_00000939E_Maximize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000939E_Maximize));
        ...
        {
            bool result = CF_00000939E_Maximize.Solution_0_Test(input);
