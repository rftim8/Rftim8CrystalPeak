...
{
    [TestClass]
    public sealed class CF_00001658E_GojouAndMatrixGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001658E_GojouAndMatrixGame));
        ...
        {
            bool result = CF_00001658E_GojouAndMatrixGame.Solution_0_Test(input);
