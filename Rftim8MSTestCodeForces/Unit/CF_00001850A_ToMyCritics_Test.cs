...
{
    [TestClass]
    public sealed class CF_00001850A_ToMyCritics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001850A_ToMyCritics));
        ...
        {
            bool result = CF_00001850A_ToMyCritics.Solution_0_Test(input);
