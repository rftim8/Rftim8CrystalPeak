...
{
    [TestClass]
    public sealed class CF_00000003A_ShortestPathOfTheKing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000003A_ShortestPathOfTheKing));
        ...
        {
            bool result = CF_00000003A_ShortestPathOfTheKing.Solution_0_Test(input);
