...
{
    [TestClass]
    public sealed class CF_00001158E_StrangeDevice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001158E_StrangeDevice));
        ...
        {
            bool result = CF_00001158E_StrangeDevice.Solution_0_Test(input);
