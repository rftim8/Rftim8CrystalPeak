...
{
    [TestClass]
    public sealed class CF_00000615C_RunningTrack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000615C_RunningTrack));
        ...
        {
            bool result = CF_00000615C_RunningTrack.Solution_0_Test(input);
