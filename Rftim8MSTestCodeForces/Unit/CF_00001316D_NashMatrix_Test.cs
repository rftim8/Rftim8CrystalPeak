...
{
    [TestClass]
    public sealed class CF_00001316D_NashMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001316D_NashMatrix));
        ...
        {
            bool result = CF_00001316D_NashMatrix.Solution_0_Test(input);
