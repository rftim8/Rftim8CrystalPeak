...
{
    [TestClass]
    public sealed class CF_00000075D_BigMaximumSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000075D_BigMaximumSum));
        ...
        {
            bool result = CF_00000075D_BigMaximumSum.Solution_0_Test(input);
