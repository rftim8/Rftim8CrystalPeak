...
{
    [TestClass]
    public sealed class CF_00000477E_DreamoonAndNotepad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000477E_DreamoonAndNotepad));
        ...
        {
            bool result = CF_00000477E_DreamoonAndNotepad.Solution_0_Test(input);
