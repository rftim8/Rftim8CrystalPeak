...
{
    [TestClass]
    public sealed class CF_00000371D_Vessels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000371D_Vessels));
        ...
        {
            bool result = CF_00000371D_Vessels.Solution_0_Test(input);
