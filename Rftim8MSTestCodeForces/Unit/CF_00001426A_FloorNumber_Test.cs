...
{
    [TestClass]
    public sealed class CF_00001426A_FloorNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001426A_FloorNumber));
        ...
        {
            bool result = CF_00001426A_FloorNumber.Solution_0_Test(input);
