...
{
    [TestClass]
    public sealed class CF_00000925F_ParametricCirculation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000925F_ParametricCirculation));
        ...
        {
            bool result = CF_00000925F_ParametricCirculation.Solution_0_Test(input);
