...
{
    [TestClass]
    public sealed class CF_00000460A_VasyaAndSocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000460A_VasyaAndSocks));
        ...
        {
            bool result = CF_00000460A_VasyaAndSocks.Solution_0_Test(input);
