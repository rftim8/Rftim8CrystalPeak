...
{
    [TestClass]
    public sealed class CF_00000549H_DegenerateMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000549H_DegenerateMatrix));
        ...
        {
            bool result = CF_00000549H_DegenerateMatrix.Solution_0_Test(input);
