...
{
    [TestClass]
    public sealed class CF_00000686B_LittleRobberGirlsZoo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000686B_LittleRobberGirlsZoo));
        ...
        {
            bool result = CF_00000686B_LittleRobberGirlsZoo.Solution_0_Test(input);
