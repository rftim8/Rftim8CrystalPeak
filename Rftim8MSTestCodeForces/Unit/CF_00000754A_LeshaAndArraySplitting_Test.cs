...
{
    [TestClass]
    public sealed class CF_00000754A_LeshaAndArraySplitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000754A_LeshaAndArraySplitting));
        ...
        {
            bool result = CF_00000754A_LeshaAndArraySplitting.Solution_0_Test(input);
