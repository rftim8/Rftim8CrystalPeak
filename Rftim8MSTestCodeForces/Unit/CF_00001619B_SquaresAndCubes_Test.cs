...
{
    [TestClass]
    public sealed class CF_00001619B_SquaresAndCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001619B_SquaresAndCubes));
        ...
        {
            bool result = CF_00001619B_SquaresAndCubes.Solution_0_Test(input);
