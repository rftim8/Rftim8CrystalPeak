...
{
    [TestClass]
    public sealed class CF_00001736D_EqualBinarySubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001736D_EqualBinarySubsequences));
        ...
        {
            bool result = CF_00001736D_EqualBinarySubsequences.Solution_0_Test(input);
