...
{
    [TestClass]
    public sealed class CF_00001788A_OneAndTwo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001788A_OneAndTwo));
        ...
        {
            bool result = CF_00001788A_OneAndTwo.Solution_0_Test(input);
