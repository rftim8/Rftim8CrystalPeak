...
{
    [TestClass]
    public sealed class CF_00000725F_FamilyPhotos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000725F_FamilyPhotos));
        ...
        {
            bool result = CF_00000725F_FamilyPhotos.Solution_0_Test(input);
