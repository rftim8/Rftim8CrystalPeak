...
{
    [TestClass]
    public sealed class CF_00001260F_ColoredTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001260F_ColoredTree));
        ...
        {
            bool result = CF_00001260F_ColoredTree.Solution_0_Test(input);
