...
{
    [TestClass]
    public sealed class CF_00001304A_TwoRabbits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001304A_TwoRabbits));
        ...
        {
            bool result = CF_00001304A_TwoRabbits.Solution_0_Test(input);
