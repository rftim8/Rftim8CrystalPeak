...
{
    [TestClass]
    public sealed class CF_00001665C_TreeInfection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001665C_TreeInfection));
        ...
        {
            bool result = CF_00001665C_TreeInfection.Solution_0_Test(input);
