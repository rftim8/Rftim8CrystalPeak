...
{
    [TestClass]
    public sealed class CF_00000279C_Ladder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000279C_Ladder));
        ...
        {
            bool result = CF_00000279C_Ladder.Solution_0_Test(input);
