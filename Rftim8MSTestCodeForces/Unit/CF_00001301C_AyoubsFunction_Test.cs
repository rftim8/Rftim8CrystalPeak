...
{
    [TestClass]
    public sealed class CF_00001301C_AyoubsFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001301C_AyoubsFunction));
        ...
        {
            bool result = CF_00001301C_AyoubsFunction.Solution_0_Test(input);
