...
{
    [TestClass]
    public sealed class CF_00000931C_LaboratoryWork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000931C_LaboratoryWork));
        ...
        {
            bool result = CF_00000931C_LaboratoryWork.Solution_0_Test(input);
