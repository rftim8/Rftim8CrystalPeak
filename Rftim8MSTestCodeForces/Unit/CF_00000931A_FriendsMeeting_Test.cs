...
{
    [TestClass]
    public sealed class CF_00000931A_FriendsMeeting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000931A_FriendsMeeting));
        ...
        {
            bool result = CF_00000931A_FriendsMeeting.Solution_0_Test(input);
