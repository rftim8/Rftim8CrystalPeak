...
{
    [TestClass]
    public sealed class CF_00001767C_CountBinaryStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001767C_CountBinaryStrings));
        ...
        {
            bool result = CF_00001767C_CountBinaryStrings.Solution_0_Test(input);
