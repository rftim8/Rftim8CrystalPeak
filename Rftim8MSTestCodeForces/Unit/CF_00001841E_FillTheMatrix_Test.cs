...
{
    [TestClass]
    public sealed class CF_00001841E_FillTheMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001841E_FillTheMatrix));
        ...
        {
            bool result = CF_00001841E_FillTheMatrix.Solution_0_Test(input);
