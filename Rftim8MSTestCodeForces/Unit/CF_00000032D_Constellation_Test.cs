...
{
    [TestClass]
    public sealed class CF_00000032D_Constellation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000032D_Constellation));
        ...
        {
            bool result = CF_00000032D_Constellation.Solution_0_Test(input);
