...
{
    [TestClass]
    public sealed class CF_00001303G_SumOfPrefixSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001303G_SumOfPrefixSums));
        ...
        {
            bool result = CF_00001303G_SumOfPrefixSums.Solution_0_Test(input);
