...
{
    [TestClass]
    public sealed class CF_00002029C_NewRating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002029C_NewRating));
        ...
        {
            bool result = CF_00002029C_NewRating.Solution_0_Test(input);
