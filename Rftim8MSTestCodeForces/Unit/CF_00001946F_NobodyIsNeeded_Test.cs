...
{
    [TestClass]
    public sealed class CF_00001946F_NobodyIsNeeded_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001946F_NobodyIsNeeded));
        ...
        {
            bool result = CF_00001946F_NobodyIsNeeded.Solution_0_Test(input);
