...
{
    [TestClass]
    public sealed class CF_00001526B_IHate1111_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001526B_IHate1111));
        ...
        {
            bool result = CF_00001526B_IHate1111.Solution_0_Test(input);
