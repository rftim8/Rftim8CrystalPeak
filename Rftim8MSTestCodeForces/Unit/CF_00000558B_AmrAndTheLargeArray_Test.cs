...
{
    [TestClass]
    public sealed class CF_00000558B_AmrAndTheLargeArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000558B_AmrAndTheLargeArray));
        ...
        {
            bool result = CF_00000558B_AmrAndTheLargeArray.Solution_0_Test(input);
