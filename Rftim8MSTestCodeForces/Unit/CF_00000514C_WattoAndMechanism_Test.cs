...
{
    [TestClass]
    public sealed class CF_00000514C_WattoAndMechanism_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000514C_WattoAndMechanism));
        ...
        {
            bool result = CF_00000514C_WattoAndMechanism.Solution_0_Test(input);
