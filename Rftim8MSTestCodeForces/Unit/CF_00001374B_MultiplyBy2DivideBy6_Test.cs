...
{
    [TestClass]
    public sealed class CF_00001374B_MultiplyBy2DivideBy6_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001374B_MultiplyBy2DivideBy6));
        ...
        {
            bool result = CF_00001374B_MultiplyBy2DivideBy6.Solution_0_Test(input);
