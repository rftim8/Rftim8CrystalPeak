...
{
    [TestClass]
    public sealed class CF_00000444C_DZYLovesColors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000444C_DZYLovesColors));
        ...
        {
            bool result = CF_00000444C_DZYLovesColors.Solution_0_Test(input);
