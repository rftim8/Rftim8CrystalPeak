...
{
    [TestClass]
    public sealed class CF_00000804B_MinimumNumberOfSteps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000804B_MinimumNumberOfSteps));
        ...
        {
            bool result = CF_00000804B_MinimumNumberOfSteps.Solution_0_Test(input);
