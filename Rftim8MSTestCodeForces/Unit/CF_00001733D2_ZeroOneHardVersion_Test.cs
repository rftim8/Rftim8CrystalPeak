...
{
    [TestClass]
    public sealed class CF_00001733D2_ZeroOneHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001733D2_ZeroOneHardVersion));
        ...
        {
            bool result = CF_00001733D2_ZeroOneHardVersion.Solution_0_Test(input);
