...
{
    [TestClass]
    public sealed class CF_00001610A_AntiLightsCellGuessing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001610A_AntiLightsCellGuessing));
        ...
        {
            bool result = CF_00001610A_AntiLightsCellGuessing.Solution_0_Test(input);
