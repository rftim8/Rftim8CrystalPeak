...
{
    [TestClass]
    public sealed class CF_00000958D1_HyperspaceJumpEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958D1_HyperspaceJumpEasy));
        ...
        {
            bool result = CF_00000958D1_HyperspaceJumpEasy.Solution_0_Test(input);
