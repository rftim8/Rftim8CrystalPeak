...
{
    [TestClass]
    public sealed class CF_00000810A_StraightA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000810A_StraightA));
        ...
        {
            bool result = CF_00000810A_StraightA.Solution_0_Test(input);
