...
{
    [TestClass]
    public sealed class CF_00000047C_Crossword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000047C_Crossword));
        ...
        {
            bool result = CF_00000047C_Crossword.Solution_0_Test(input);
