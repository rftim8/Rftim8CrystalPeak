...
{
    [TestClass]
    public sealed class CF_00001107F_VasyaAndEndlessCredits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001107F_VasyaAndEndlessCredits));
        ...
        {
            bool result = CF_00001107F_VasyaAndEndlessCredits.Solution_0_Test(input);
