...
{
    [TestClass]
    public sealed class CF_00000138B_DigitsPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000138B_DigitsPermutations));
        ...
        {
            bool result = CF_00000138B_DigitsPermutations.Solution_0_Test(input);
