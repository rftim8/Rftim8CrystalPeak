...
{
    [TestClass]
    public sealed class CF_00001860E_FastTravelTextEditor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001860E_FastTravelTextEditor));
        ...
        {
            bool result = CF_00001860E_FastTravelTextEditor.Solution_0_Test(input);
