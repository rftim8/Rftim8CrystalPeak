...
{
    [TestClass]
    public sealed class CF_00000835B_TheNumberOnTheBoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000835B_TheNumberOnTheBoard));
        ...
        {
            bool result = CF_00000835B_TheNumberOnTheBoard.Solution_0_Test(input);
