...
{
    [TestClass]
    public sealed class CF_00001658F_JujuAndBinaryString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001658F_JujuAndBinaryString));
        ...
        {
            bool result = CF_00001658F_JujuAndBinaryString.Solution_0_Test(input);
