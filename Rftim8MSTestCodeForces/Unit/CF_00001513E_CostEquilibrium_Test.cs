...
{
    [TestClass]
    public sealed class CF_00001513E_CostEquilibrium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001513E_CostEquilibrium));
        ...
        {
            bool result = CF_00001513E_CostEquilibrium.Solution_0_Test(input);
