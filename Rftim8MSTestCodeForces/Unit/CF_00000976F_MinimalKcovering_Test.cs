...
{
    [TestClass]
    public sealed class CF_00000976F_MinimalKcovering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000976F_MinimalKcovering));
        ...
        {
            bool result = CF_00000976F_MinimalKcovering.Solution_0_Test(input);
