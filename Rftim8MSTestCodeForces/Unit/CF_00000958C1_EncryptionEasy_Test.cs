...
{
    [TestClass]
    public sealed class CF_00000958C1_EncryptionEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958C1_EncryptionEasy));
        ...
        {
            bool result = CF_00000958C1_EncryptionEasy.Solution_0_Test(input);
