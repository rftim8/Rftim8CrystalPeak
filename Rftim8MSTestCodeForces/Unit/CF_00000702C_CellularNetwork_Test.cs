...
{
    [TestClass]
    public sealed class CF_00000702C_CellularNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000702C_CellularNetwork));
        ...
        {
            bool result = CF_00000702C_CellularNetwork.Solution_0_Test(input);
