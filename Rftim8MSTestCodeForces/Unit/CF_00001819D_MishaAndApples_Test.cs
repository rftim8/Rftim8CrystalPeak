...
{
    [TestClass]
    public sealed class CF_00001819D_MishaAndApples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001819D_MishaAndApples));
        ...
        {
            bool result = CF_00001819D_MishaAndApples.Solution_0_Test(input);
