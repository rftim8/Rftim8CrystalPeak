...
{
    [TestClass]
    public sealed class CF_00001829B_BlankSpace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001829B_BlankSpace));
        ...
        {
            bool result = CF_00001829B_BlankSpace.Solution_0_Test(input);
