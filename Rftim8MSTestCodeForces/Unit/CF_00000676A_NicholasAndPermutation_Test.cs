...
{
    [TestClass]
    public sealed class CF_00000676A_NicholasAndPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000676A_NicholasAndPermutation));
        ...
        {
            bool result = CF_00000676A_NicholasAndPermutation.Solution_0_Test(input);
