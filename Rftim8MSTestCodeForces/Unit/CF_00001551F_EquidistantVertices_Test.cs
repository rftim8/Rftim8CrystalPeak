...
{
    [TestClass]
    public sealed class CF_00001551F_EquidistantVertices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001551F_EquidistantVertices));
        ...
        {
            bool result = CF_00001551F_EquidistantVertices.Solution_0_Test(input);
