...
{
    [TestClass]
    public sealed class CF_00001974C_BeautifulTriplePairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001974C_BeautifulTriplePairs));
        ...
        {
            bool result = CF_00001974C_BeautifulTriplePairs.Solution_0_Test(input);
