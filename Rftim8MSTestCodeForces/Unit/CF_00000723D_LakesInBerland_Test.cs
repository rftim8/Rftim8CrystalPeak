...
{
    [TestClass]
    public sealed class CF_00000723D_LakesInBerland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000723D_LakesInBerland));
        ...
        {
            bool result = CF_00000723D_LakesInBerland.Solution_0_Test(input);
