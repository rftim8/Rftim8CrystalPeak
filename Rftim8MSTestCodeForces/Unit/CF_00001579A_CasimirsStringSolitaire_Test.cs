...
{
    [TestClass]
    public sealed class CF_00001579A_CasimirsStringSolitaire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001579A_CasimirsStringSolitaire));
        ...
        {
            bool result = CF_00001579A_CasimirsStringSolitaire.Solution_0_Test(input);
