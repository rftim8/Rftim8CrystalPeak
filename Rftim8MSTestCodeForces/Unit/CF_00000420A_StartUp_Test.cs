...
{
    [TestClass]
    public sealed class CF_00000420A_StartUp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000420A_StartUp));
        ...
        {
            bool result = CF_00000420A_StartUp.Solution_0_Test(input);
