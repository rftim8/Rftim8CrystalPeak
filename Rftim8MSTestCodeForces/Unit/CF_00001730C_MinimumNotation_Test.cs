...
{
    [TestClass]
    public sealed class CF_00001730C_MinimumNotation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001730C_MinimumNotation));
        ...
        {
            bool result = CF_00001730C_MinimumNotation.Solution_0_Test(input);
