...
{
    [TestClass]
    public sealed class CF_00001967B1_ReverseCardEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001967B1_ReverseCardEasyVersion));
        ...
        {
            bool result = CF_00001967B1_ReverseCardEasyVersion.Solution_0_Test(input);
