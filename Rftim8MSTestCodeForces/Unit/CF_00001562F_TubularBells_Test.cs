...
{
    [TestClass]
    public sealed class CF_00001562F_TubularBells_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001562F_TubularBells));
        ...
        {
            bool result = CF_00001562F_TubularBells.Solution_0_Test(input);
