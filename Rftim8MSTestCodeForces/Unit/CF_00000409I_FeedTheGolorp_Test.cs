...
{
    [TestClass]
    public sealed class CF_00000409I_FeedTheGolorp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000409I_FeedTheGolorp));
        ...
        {
            bool result = CF_00000409I_FeedTheGolorp.Solution_0_Test(input);
