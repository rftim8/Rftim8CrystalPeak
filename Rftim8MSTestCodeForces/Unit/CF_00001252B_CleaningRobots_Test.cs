...
{
    [TestClass]
    public sealed class CF_00001252B_CleaningRobots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001252B_CleaningRobots));
        ...
        {
            bool result = CF_00001252B_CleaningRobots.Solution_0_Test(input);
