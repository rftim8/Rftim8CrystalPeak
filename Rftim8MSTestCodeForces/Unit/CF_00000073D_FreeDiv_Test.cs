...
{
    [TestClass]
    public sealed class CF_00000073D_FreeDiv_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000073D_FreeDiv));
        ...
        {
            bool result = CF_00000073D_FreeDiv.Solution_0_Test(input);
