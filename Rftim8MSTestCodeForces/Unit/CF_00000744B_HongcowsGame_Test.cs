...
{
    [TestClass]
    public sealed class CF_00000744B_HongcowsGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000744B_HongcowsGame));
        ...
        {
            bool result = CF_00000744B_HongcowsGame.Solution_0_Test(input);
