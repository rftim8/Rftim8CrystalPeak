...
{
    [TestClass]
    public sealed class CF_00000554B_OhanaCleansUp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000554B_OhanaCleansUp));
        ...
        {
            bool result = CF_00000554B_OhanaCleansUp.Solution_0_Test(input);
