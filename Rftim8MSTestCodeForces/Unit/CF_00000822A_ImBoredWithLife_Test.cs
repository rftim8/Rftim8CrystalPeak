...
{
    [TestClass]
    public sealed class CF_00000822A_ImBoredWithLife_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000822A_ImBoredWithLife));
        ...
        {
            bool result = CF_00000822A_ImBoredWithLife.Solution_0_Test(input);
