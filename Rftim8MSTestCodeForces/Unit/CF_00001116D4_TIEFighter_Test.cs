...
{
    [TestClass]
    public sealed class CF_00001116D4_TIEFighter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001116D4_TIEFighter));
        ...
        {
            bool result = CF_00001116D4_TIEFighter.Solution_0_Test(input);
