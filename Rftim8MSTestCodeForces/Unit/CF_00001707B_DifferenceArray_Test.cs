...
{
    [TestClass]
    public sealed class CF_00001707B_DifferenceArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001707B_DifferenceArray));
        ...
        {
            bool result = CF_00001707B_DifferenceArray.Solution_0_Test(input);
