...
{
    [TestClass]
    public sealed class CF_00000236A_BoyOrGirl_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000236A_BoyOrGirl));
        ...
        {
            bool result = CF_00000236A_BoyOrGirl.Solution_0_Test(input);
