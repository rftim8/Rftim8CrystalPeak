...
{
    [TestClass]
    public sealed class CF_00000039G_InverseFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000039G_InverseFunction));
        ...
        {
            bool result = CF_00000039G_InverseFunction.Solution_0_Test(input);
