...
{
    [TestClass]
    public sealed class CF_00001799E_CityUnion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001799E_CityUnion));
        ...
        {
            bool result = CF_00001799E_CityUnion.Solution_0_Test(input);
