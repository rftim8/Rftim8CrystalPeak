...
{
    [TestClass]
    public sealed class CF_00000862A_MahmoudAndEhabAndTheMEX_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000862A_MahmoudAndEhabAndTheMEX));
        ...
        {
            bool result = CF_00000862A_MahmoudAndEhabAndTheMEX.Solution_0_Test(input);
