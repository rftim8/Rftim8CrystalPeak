...
{
    [TestClass]
    public sealed class CF_00001205C_PalindromicPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001205C_PalindromicPaths));
        ...
        {
            bool result = CF_00001205C_PalindromicPaths.Solution_0_Test(input);
