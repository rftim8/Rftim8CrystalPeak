...
{
    [TestClass]
    public sealed class CF_00000081C_AverageScore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000081C_AverageScore));
        ...
        {
            bool result = CF_00000081C_AverageScore.Solution_0_Test(input);
