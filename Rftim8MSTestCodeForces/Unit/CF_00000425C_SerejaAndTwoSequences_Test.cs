...
{
    [TestClass]
    public sealed class CF_00000425C_SerejaAndTwoSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000425C_SerejaAndTwoSequences));
        ...
        {
            bool result = CF_00000425C_SerejaAndTwoSequences.Solution_0_Test(input);
