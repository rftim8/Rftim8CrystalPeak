...
{
    [TestClass]
    public sealed class CF_00001906H_TwinFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001906H_TwinFriends));
        ...
        {
            bool result = CF_00001906H_TwinFriends.Solution_0_Test(input);
