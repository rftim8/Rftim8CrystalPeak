...
{
    [TestClass]
    public sealed class CF_00000683A_TheCheckOfThePoint_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000683A_TheCheckOfThePoint));
        ...
        {
            bool result = CF_00000683A_TheCheckOfThePoint.Solution_0_Test(input);
