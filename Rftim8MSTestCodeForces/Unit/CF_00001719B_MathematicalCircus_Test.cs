...
{
    [TestClass]
    public sealed class CF_00001719B_MathematicalCircus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001719B_MathematicalCircus));
        ...
        {
            bool result = CF_00001719B_MathematicalCircus.Solution_0_Test(input);
