...
{
    [TestClass]
    public sealed class CF_00001774A_AddPlusMinusSign_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001774A_AddPlusMinusSign));
        ...
        {
            bool result = CF_00001774A_AddPlusMinusSign.Solution_0_Test(input);
