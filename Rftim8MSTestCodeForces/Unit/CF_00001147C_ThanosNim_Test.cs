...
{
    [TestClass]
    public sealed class CF_00001147C_ThanosNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001147C_ThanosNim));
        ...
        {
            bool result = CF_00001147C_ThanosNim.Solution_0_Test(input);
