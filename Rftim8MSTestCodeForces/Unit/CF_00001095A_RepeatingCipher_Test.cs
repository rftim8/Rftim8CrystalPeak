...
{
    [TestClass]
    public sealed class CF_00001095A_RepeatingCipher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001095A_RepeatingCipher));
        ...
        {
            bool result = CF_00001095A_RepeatingCipher.Solution_0_Test(input);
