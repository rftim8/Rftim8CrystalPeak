...
{
    [TestClass]
    public sealed class CF_00000717G_Underfail_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000717G_Underfail));
        ...
        {
            bool result = CF_00000717G_Underfail.Solution_0_Test(input);
