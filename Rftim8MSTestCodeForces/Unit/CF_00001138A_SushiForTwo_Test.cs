...
{
    [TestClass]
    public sealed class CF_00001138A_SushiForTwo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001138A_SushiForTwo));
        ...
        {
            bool result = CF_00001138A_SushiForTwo.Solution_0_Test(input);
