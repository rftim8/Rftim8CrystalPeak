...
{
    [TestClass]
    public sealed class CF_00000955F_Heaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000955F_Heaps));
        ...
        {
            bool result = CF_00000955F_Heaps.Solution_0_Test(input);
