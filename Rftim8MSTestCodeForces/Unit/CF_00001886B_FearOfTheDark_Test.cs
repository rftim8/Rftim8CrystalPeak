...
{
    [TestClass]
    public sealed class CF_00001886B_FearOfTheDark_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001886B_FearOfTheDark));
        ...
        {
            bool result = CF_00001886B_FearOfTheDark.Solution_0_Test(input);
