...
{
    [TestClass]
    public sealed class CF_00000868G_ElTollCaves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000868G_ElTollCaves));
        ...
        {
            bool result = CF_00000868G_ElTollCaves.Solution_0_Test(input);
