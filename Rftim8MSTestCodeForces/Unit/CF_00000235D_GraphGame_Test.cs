...
{
    [TestClass]
    public sealed class CF_00000235D_GraphGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000235D_GraphGame));
        ...
        {
            bool result = CF_00000235D_GraphGame.Solution_0_Test(input);
