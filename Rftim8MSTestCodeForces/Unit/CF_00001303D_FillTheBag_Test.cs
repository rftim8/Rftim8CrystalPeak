...
{
    [TestClass]
    public sealed class CF_00001303D_FillTheBag_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001303D_FillTheBag));
        ...
        {
            bool result = CF_00001303D_FillTheBag.Solution_0_Test(input);
