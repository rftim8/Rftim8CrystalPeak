...
{
    [TestClass]
    public sealed class CF_00000027D_RingRoad2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000027D_RingRoad2));
        ...
        {
            bool result = CF_00000027D_RingRoad2.Solution_0_Test(input);
