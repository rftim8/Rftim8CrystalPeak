...
{
    [TestClass]
    public sealed class CF_00001328B_KthBeautifulString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001328B_KthBeautifulString));
        ...
        {
            bool result = CF_00001328B_KthBeautifulString.Solution_0_Test(input);
