...
{
    [TestClass]
    public sealed class CF_00001070A_FindANumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001070A_FindANumber));
        ...
        {
            bool result = CF_00001070A_FindANumber.Solution_0_Test(input);
