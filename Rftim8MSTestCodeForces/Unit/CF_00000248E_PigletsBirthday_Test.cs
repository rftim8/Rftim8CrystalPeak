...
{
    [TestClass]
    public sealed class CF_00000248E_PigletsBirthday_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000248E_PigletsBirthday));
        ...
        {
            bool result = CF_00000248E_PigletsBirthday.Solution_0_Test(input);
