...
{
    [TestClass]
    public sealed class CF_00001025E_ColoredCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001025E_ColoredCubes));
        ...
        {
            bool result = CF_00001025E_ColoredCubes.Solution_0_Test(input);
