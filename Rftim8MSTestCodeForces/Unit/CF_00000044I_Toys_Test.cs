...
{
    [TestClass]
    public sealed class CF_00000044I_Toys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000044I_Toys));
        ...
        {
            bool result = CF_00000044I_Toys.Solution_0_Test(input);
