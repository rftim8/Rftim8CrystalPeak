...
{
    [TestClass]
    public sealed class CF_00001968C_AssemblyViaRemainders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001968C_AssemblyViaRemainders));
        ...
        {
            bool result = CF_00001968C_AssemblyViaRemainders.Solution_0_Test(input);
