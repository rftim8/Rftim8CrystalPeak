...
{
    [TestClass]
    public sealed class CF_00000476A_DreamoonAndStairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000476A_DreamoonAndStairs));
        ...
        {
            bool result = CF_00000476A_DreamoonAndStairs.Solution_0_Test(input);
