...
{
    [TestClass]
    public sealed class CF_00001371E1_AsterismEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001371E1_AsterismEasyVersion));
        ...
        {
            bool result = CF_00001371E1_AsterismEasyVersion.Solution_0_Test(input);
