...
{
    [TestClass]
    public sealed class CF_00000234C_Weather_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000234C_Weather));
        ...
        {
            bool result = CF_00000234C_Weather.Solution_0_Test(input);
