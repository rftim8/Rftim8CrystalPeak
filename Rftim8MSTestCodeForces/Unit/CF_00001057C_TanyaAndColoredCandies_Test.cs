...
{
    [TestClass]
    public sealed class CF_00001057C_TanyaAndColoredCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001057C_TanyaAndColoredCandies));
        ...
        {
            bool result = CF_00001057C_TanyaAndColoredCandies.Solution_0_Test(input);
