...
{
    [TestClass]
    public sealed class CF_00000344A_Magnets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000344A_Magnets));
        ...
        {
            bool result = CF_00000344A_Magnets.Solution_0_Test(input);
