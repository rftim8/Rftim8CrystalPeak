...
{
    [TestClass]
    public sealed class CF_00000076B_Mice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000076B_Mice));
        ...
        {
            bool result = CF_00000076B_Mice.Solution_0_Test(input);
