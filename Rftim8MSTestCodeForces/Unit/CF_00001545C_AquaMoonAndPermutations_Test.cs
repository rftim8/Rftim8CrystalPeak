...
{
    [TestClass]
    public sealed class CF_00001545C_AquaMoonAndPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001545C_AquaMoonAndPermutations));
        ...
        {
            bool result = CF_00001545C_AquaMoonAndPermutations.Solution_0_Test(input);
