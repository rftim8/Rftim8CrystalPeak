...
{
    [TestClass]
    public sealed class CF_00000653G_MoveByPrime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000653G_MoveByPrime));
        ...
        {
            bool result = CF_00000653G_MoveByPrime.Solution_0_Test(input);
