...
{
    [TestClass]
    public sealed class CF_00000681C_HeapOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000681C_HeapOperations));
        ...
        {
            bool result = CF_00000681C_HeapOperations.Solution_0_Test(input);
