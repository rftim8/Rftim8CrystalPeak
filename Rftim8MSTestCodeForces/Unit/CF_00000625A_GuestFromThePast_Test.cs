...
{
    [TestClass]
    public sealed class CF_00000625A_GuestFromThePast_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000625A_GuestFromThePast));
        ...
        {
            bool result = CF_00000625A_GuestFromThePast.Solution_0_Test(input);
