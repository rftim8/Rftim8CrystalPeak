...
{
    [TestClass]
    public sealed class CF_00001109B_SashaAndOneMoreName_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001109B_SashaAndOneMoreName));
        ...
        {
            bool result = CF_00001109B_SashaAndOneMoreName.Solution_0_Test(input);
