...
{
    [TestClass]
    public sealed class CF_00001271C_ShawarmaTent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001271C_ShawarmaTent));
        ...
        {
            bool result = CF_00001271C_ShawarmaTent.Solution_0_Test(input);
