...
{
    [TestClass]
    public sealed class CF_00001906K_DeckBuildingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001906K_DeckBuildingGame));
        ...
        {
            bool result = CF_00001906K_DeckBuildingGame.Solution_0_Test(input);
