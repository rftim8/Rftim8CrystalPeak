...
{
    [TestClass]
    public sealed class CF_00002000D_RightLeftWrong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002000D_RightLeftWrong));
        ...
        {
            bool result = CF_00002000D_RightLeftWrong.Solution_0_Test(input);
