...
{
    [TestClass]
    public sealed class CF_00000690F1_TreeOfLifeEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690F1_TreeOfLifeEasy));
        ...
        {
            bool result = CF_00000690F1_TreeOfLifeEasy.Solution_0_Test(input);
