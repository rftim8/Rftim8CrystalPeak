...
{
    [TestClass]
    public sealed class CF_00001458F_RangeDiameterSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001458F_RangeDiameterSum));
        ...
        {
            bool result = CF_00001458F_RangeDiameterSum.Solution_0_Test(input);
