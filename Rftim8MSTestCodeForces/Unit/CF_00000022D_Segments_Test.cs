...
{
    [TestClass]
    public sealed class CF_00000022D_Segments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000022D_Segments));
        ...
        {
            bool result = CF_00000022D_Segments.Solution_0_Test(input);
