...
{
    [TestClass]
    public sealed class CF_00000550D_RegularBridge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000550D_RegularBridge));
        ...
        {
            bool result = CF_00000550D_RegularBridge.Solution_0_Test(input);
