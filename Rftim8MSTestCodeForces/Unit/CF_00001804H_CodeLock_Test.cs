...
{
    [TestClass]
    public sealed class CF_00001804H_CodeLock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001804H_CodeLock));
        ...
        {
            bool result = CF_00001804H_CodeLock.Solution_0_Test(input);
