...
{
    [TestClass]
    public sealed class CF_00000217E_AlienDNA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000217E_AlienDNA));
        ...
        {
            bool result = CF_00000217E_AlienDNA.Solution_0_Test(input);
