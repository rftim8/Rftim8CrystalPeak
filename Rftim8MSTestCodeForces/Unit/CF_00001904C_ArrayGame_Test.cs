...
{
    [TestClass]
    public sealed class CF_00001904C_ArrayGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001904C_ArrayGame));
        ...
        {
            bool result = CF_00001904C_ArrayGame.Solution_0_Test(input);
