...
{
    [TestClass]
    public sealed class CF_00000868E_PolicemanAndATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000868E_PolicemanAndATree));
        ...
        {
            bool result = CF_00000868E_PolicemanAndATree.Solution_0_Test(input);
