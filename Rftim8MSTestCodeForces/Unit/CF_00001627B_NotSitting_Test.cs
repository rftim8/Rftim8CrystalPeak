...
{
    [TestClass]
    public sealed class CF_00001627B_NotSitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001627B_NotSitting));
        ...
        {
            bool result = CF_00001627B_NotSitting.Solution_0_Test(input);
