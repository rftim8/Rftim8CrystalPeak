...
{
    [TestClass]
    public sealed class CF_00000140D_NewYearContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000140D_NewYearContest));
        ...
        {
            bool result = CF_00000140D_NewYearContest.Solution_0_Test(input);
