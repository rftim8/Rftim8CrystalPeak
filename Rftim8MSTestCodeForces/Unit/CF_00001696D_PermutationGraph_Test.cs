...
{
    [TestClass]
    public sealed class CF_00001696D_PermutationGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001696D_PermutationGraph));
        ...
        {
            bool result = CF_00001696D_PermutationGraph.Solution_0_Test(input);
