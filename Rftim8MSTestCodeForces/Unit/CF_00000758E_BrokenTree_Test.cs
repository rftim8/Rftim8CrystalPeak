...
{
    [TestClass]
    public sealed class CF_00000758E_BrokenTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000758E_BrokenTree));
        ...
        {
            bool result = CF_00000758E_BrokenTree.Solution_0_Test(input);
