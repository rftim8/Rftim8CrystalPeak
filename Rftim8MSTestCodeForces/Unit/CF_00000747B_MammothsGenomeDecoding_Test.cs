...
{
    [TestClass]
    public sealed class CF_00000747B_MammothsGenomeDecoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000747B_MammothsGenomeDecoding));
        ...
        {
            bool result = CF_00000747B_MammothsGenomeDecoding.Solution_0_Test(input);
