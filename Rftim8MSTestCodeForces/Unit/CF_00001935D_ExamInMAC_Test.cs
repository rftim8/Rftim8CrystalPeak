...
{
    [TestClass]
    public sealed class CF_00001935D_ExamInMAC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001935D_ExamInMAC));
        ...
        {
            bool result = CF_00001935D_ExamInMAC.Solution_0_Test(input);
