...
{
    [TestClass]
    public sealed class CF_00001619E_MEXAndIncrements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001619E_MEXAndIncrements));
        ...
        {
            bool result = CF_00001619E_MEXAndIncrements.Solution_0_Test(input);
