...
{
    [TestClass]
    public sealed class CF_00000456B_FedyaAndMaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000456B_FedyaAndMaths));
        ...
        {
            bool result = CF_00000456B_FedyaAndMaths.Solution_0_Test(input);
