...
{
    [TestClass]
    public sealed class CF_00000818A_DiplomasAndCertificates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000818A_DiplomasAndCertificates));
        ...
        {
            bool result = CF_00000818A_DiplomasAndCertificates.Solution_0_Test(input);
