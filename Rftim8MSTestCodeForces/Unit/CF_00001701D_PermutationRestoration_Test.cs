...
{
    [TestClass]
    public sealed class CF_00001701D_PermutationRestoration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001701D_PermutationRestoration));
        ...
        {
            bool result = CF_00001701D_PermutationRestoration.Solution_0_Test(input);
