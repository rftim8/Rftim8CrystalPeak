...
{
    [TestClass]
    public sealed class CF_00001451F_NullifyTheMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001451F_NullifyTheMatrix));
        ...
        {
            bool result = CF_00001451F_NullifyTheMatrix.Solution_0_Test(input);
