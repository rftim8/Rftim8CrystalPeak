...
{
    [TestClass]
    public sealed class CF_00001228E_AnotherFillingTheGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001228E_AnotherFillingTheGrid));
        ...
        {
            bool result = CF_00001228E_AnotherFillingTheGrid.Solution_0_Test(input);
