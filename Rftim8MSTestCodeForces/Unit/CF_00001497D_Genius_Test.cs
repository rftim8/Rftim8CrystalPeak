...
{
    [TestClass]
    public sealed class CF_00001497D_Genius_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001497D_Genius));
        ...
        {
            bool result = CF_00001497D_Genius.Solution_0_Test(input);
