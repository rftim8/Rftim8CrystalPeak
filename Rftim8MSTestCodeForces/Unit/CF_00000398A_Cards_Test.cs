...
{
    [TestClass]
    public sealed class CF_00000398A_Cards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000398A_Cards));
        ...
        {
            bool result = CF_00000398A_Cards.Solution_0_Test(input);
