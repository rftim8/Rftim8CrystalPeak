...
{
    [TestClass]
    public sealed class CF_00001729B_DecodeString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001729B_DecodeString));
        ...
        {
            bool result = CF_00001729B_DecodeString.Solution_0_Test(input);
