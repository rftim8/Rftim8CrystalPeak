...
{
    [TestClass]
    public sealed class CF_00000201A_ClearSymmetry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000201A_ClearSymmetry));
        ...
        {
            bool result = CF_00000201A_ClearSymmetry.Solution_0_Test(input);
