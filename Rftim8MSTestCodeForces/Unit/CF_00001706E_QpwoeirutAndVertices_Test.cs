...
{
    [TestClass]
    public sealed class CF_00001706E_QpwoeirutAndVertices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001706E_QpwoeirutAndVertices));
        ...
        {
            bool result = CF_00001706E_QpwoeirutAndVertices.Solution_0_Test(input);
