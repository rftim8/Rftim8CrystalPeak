...
{
    [TestClass]
    public sealed class CF_00000125C_HobbitsParty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000125C_HobbitsParty));
        ...
        {
            bool result = CF_00000125C_HobbitsParty.Solution_0_Test(input);
