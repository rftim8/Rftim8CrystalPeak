...
{
    [TestClass]
    public sealed class CF_00001467C_ThreeBags_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001467C_ThreeBags));
        ...
        {
            bool result = CF_00001467C_ThreeBags.Solution_0_Test(input);
