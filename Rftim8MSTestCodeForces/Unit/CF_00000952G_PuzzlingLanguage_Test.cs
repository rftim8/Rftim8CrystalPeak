...
{
    [TestClass]
    public sealed class CF_00000952G_PuzzlingLanguage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000952G_PuzzlingLanguage));
        ...
        {
            bool result = CF_00000952G_PuzzlingLanguage.Solution_0_Test(input);
