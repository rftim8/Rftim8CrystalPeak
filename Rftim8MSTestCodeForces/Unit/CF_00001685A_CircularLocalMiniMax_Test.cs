...
{
    [TestClass]
    public sealed class CF_00001685A_CircularLocalMiniMax_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001685A_CircularLocalMiniMax));
        ...
        {
            bool result = CF_00001685A_CircularLocalMiniMax.Solution_0_Test(input);
