...
{
    [TestClass]
    public sealed class CF_00000159E_ZebraTower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000159E_ZebraTower));
        ...
        {
            bool result = CF_00000159E_ZebraTower.Solution_0_Test(input);
