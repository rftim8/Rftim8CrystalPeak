...
{
    [TestClass]
    public sealed class CF_00001912J_JoyOfPokemonObservation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001912J_JoyOfPokemonObservation));
        ...
        {
            bool result = CF_00001912J_JoyOfPokemonObservation.Solution_0_Test(input);
