...
{
    [TestClass]
    public sealed class CF_00001843F1_OmskMetroSimpleVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001843F1_OmskMetroSimpleVersion));
        ...
        {
            bool result = CF_00001843F1_OmskMetroSimpleVersion.Solution_0_Test(input);
