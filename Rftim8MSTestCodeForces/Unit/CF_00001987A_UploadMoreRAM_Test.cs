...
{
    [TestClass]
    public sealed class CF_00001987A_UploadMoreRAM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001987A_UploadMoreRAM));
        ...
        {
            bool result = CF_00001987A_UploadMoreRAM.Solution_0_Test(input);
