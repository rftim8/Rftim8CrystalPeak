...
{
    [TestClass]
    public sealed class CF_00001601F_TwoSorts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001601F_TwoSorts));
        ...
        {
            bool result = CF_00001601F_TwoSorts.Solution_0_Test(input);
