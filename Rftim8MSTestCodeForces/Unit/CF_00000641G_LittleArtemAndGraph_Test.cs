...
{
    [TestClass]
    public sealed class CF_00000641G_LittleArtemAndGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000641G_LittleArtemAndGraph));
        ...
        {
            bool result = CF_00000641G_LittleArtemAndGraph.Solution_0_Test(input);
