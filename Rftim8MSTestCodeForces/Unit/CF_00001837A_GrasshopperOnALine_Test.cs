...
{
    [TestClass]
    public sealed class CF_00001837A_GrasshopperOnALine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001837A_GrasshopperOnALine));
        ...
        {
            bool result = CF_00001837A_GrasshopperOnALine.Solution_0_Test(input);
