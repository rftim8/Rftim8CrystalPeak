...
{
    [TestClass]
    public sealed class CF_00000078C_BeaverGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000078C_BeaverGame));
        ...
        {
            bool result = CF_00000078C_BeaverGame.Solution_0_Test(input);
