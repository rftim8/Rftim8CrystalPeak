...
{
    [TestClass]
    public sealed class CF_00000033D_Knights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000033D_Knights));
        ...
        {
            bool result = CF_00000033D_Knights.Solution_0_Test(input);
