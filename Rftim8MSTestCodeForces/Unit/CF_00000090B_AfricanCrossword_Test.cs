...
{
    [TestClass]
    public sealed class CF_00000090B_AfricanCrossword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000090B_AfricanCrossword));
        ...
        {
            bool result = CF_00000090B_AfricanCrossword.Solution_0_Test(input);
