...
{
    [TestClass]
    public sealed class CF_00001812B_WasItRated_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001812B_WasItRated));
        ...
        {
            bool result = CF_00001812B_WasItRated.Solution_0_Test(input);
