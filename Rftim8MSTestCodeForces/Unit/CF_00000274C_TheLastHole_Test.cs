...
{
    [TestClass]
    public sealed class CF_00000274C_TheLastHole_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000274C_TheLastHole));
        ...
        {
            bool result = CF_00000274C_TheLastHole.Solution_0_Test(input);
