...
{
    [TestClass]
    public sealed class CF_00001983F_Arrayvalue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001983F_Arrayvalue));
        ...
        {
            bool result = CF_00001983F_Arrayvalue.Solution_0_Test(input);
