...
{
    [TestClass]
    public sealed class CF_00000466A_CheapTravel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000466A_CheapTravel));
        ...
        {
            bool result = CF_00000466A_CheapTravel.Solution_0_Test(input);
