...
{
    [TestClass]
    public sealed class CF_00001165C_GoodString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001165C_GoodString));
        ...
        {
            bool result = CF_00001165C_GoodString.Solution_0_Test(input);
