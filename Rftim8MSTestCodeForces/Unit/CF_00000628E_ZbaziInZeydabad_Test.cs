...
{
    [TestClass]
    public sealed class CF_00000628E_ZbaziInZeydabad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000628E_ZbaziInZeydabad));
        ...
        {
            bool result = CF_00000628E_ZbaziInZeydabad.Solution_0_Test(input);
