...
{
    [TestClass]
    public sealed class CF_00000893B_BeautifulDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000893B_BeautifulDivisors));
        ...
        {
            bool result = CF_00000893B_BeautifulDivisors.Solution_0_Test(input);
