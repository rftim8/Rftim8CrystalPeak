...
{
    [TestClass]
    public sealed class CF_00001866H_HappySets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001866H_HappySets));
        ...
        {
            bool result = CF_00001866H_HappySets.Solution_0_Test(input);
