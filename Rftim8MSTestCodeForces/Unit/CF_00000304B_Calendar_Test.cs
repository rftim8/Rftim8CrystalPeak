...
{
    [TestClass]
    public sealed class CF_00000304B_Calendar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000304B_Calendar));
        ...
        {
            bool result = CF_00000304B_Calendar.Solution_0_Test(input);
