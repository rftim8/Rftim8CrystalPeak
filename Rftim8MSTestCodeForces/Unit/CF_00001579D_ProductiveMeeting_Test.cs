...
{
    [TestClass]
    public sealed class CF_00001579D_ProductiveMeeting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001579D_ProductiveMeeting));
        ...
        {
            bool result = CF_00001579D_ProductiveMeeting.Solution_0_Test(input);
