...
{
    [TestClass]
    public sealed class CF_00001285A_MezoPlayingZoma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001285A_MezoPlayingZoma));
        ...
        {
            bool result = CF_00001285A_MezoPlayingZoma.Solution_0_Test(input);
