...
{
    [TestClass]
    public sealed class CF_00001790G_TokensOnGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001790G_TokensOnGraph));
        ...
        {
            bool result = CF_00001790G_TokensOnGraph.Solution_0_Test(input);
