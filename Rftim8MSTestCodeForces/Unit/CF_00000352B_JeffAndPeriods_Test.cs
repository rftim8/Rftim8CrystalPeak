...
{
    [TestClass]
    public sealed class CF_00000352B_JeffAndPeriods_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000352B_JeffAndPeriods));
        ...
        {
            bool result = CF_00000352B_JeffAndPeriods.Solution_0_Test(input);
