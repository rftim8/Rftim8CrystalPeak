...
{
    [TestClass]
    public sealed class CF_00001826F_FadingIntoFog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001826F_FadingIntoFog));
        ...
        {
            bool result = CF_00001826F_FadingIntoFog.Solution_0_Test(input);
