...
{
    [TestClass]
    public sealed class CF_00001065F_UpAndDownTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001065F_UpAndDownTheTree));
        ...
        {
            bool result = CF_00001065F_UpAndDownTheTree.Solution_0_Test(input);
