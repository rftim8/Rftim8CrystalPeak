...
{
    [TestClass]
    public sealed class CF_00001695B_CircleGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001695B_CircleGame));
        ...
        {
            bool result = CF_00001695B_CircleGame.Solution_0_Test(input);
