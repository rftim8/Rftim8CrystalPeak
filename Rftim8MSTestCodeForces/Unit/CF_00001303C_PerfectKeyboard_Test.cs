...
{
    [TestClass]
    public sealed class CF_00001303C_PerfectKeyboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001303C_PerfectKeyboard));
        ...
        {
            bool result = CF_00001303C_PerfectKeyboard.Solution_0_Test(input);
