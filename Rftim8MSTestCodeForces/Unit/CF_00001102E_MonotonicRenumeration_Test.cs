...
{
    [TestClass]
    public sealed class CF_00001102E_MonotonicRenumeration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001102E_MonotonicRenumeration));
        ...
        {
            bool result = CF_00001102E_MonotonicRenumeration.Solution_0_Test(input);
