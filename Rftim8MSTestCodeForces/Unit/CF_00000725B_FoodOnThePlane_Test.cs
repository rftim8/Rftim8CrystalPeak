...
{
    [TestClass]
    public sealed class CF_00000725B_FoodOnThePlane_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000725B_FoodOnThePlane));
        ...
        {
            bool result = CF_00000725B_FoodOnThePlane.Solution_0_Test(input);
