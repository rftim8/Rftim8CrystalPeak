...
{
    [TestClass]
    public sealed class CF_00000545B_EquidistantString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000545B_EquidistantString));
        ...
        {
            bool result = CF_00000545B_EquidistantString.Solution_0_Test(input);
