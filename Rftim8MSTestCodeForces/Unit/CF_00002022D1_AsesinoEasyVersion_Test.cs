...
{
    [TestClass]
    public sealed class CF_00002022D1_AsesinoEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002022D1_AsesinoEasyVersion));
        ...
        {
            bool result = CF_00002022D1_AsesinoEasyVersion.Solution_0_Test(input);
