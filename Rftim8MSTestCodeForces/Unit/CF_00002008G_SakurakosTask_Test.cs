...
{
    [TestClass]
    public sealed class CF_00002008G_SakurakosTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002008G_SakurakosTask));
        ...
        {
            bool result = CF_00002008G_SakurakosTask.Solution_0_Test(input);
