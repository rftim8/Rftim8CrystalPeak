...
{
    [TestClass]
    public sealed class CF_00001620D_ExactChange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001620D_ExactChange));
        ...
        {
            bool result = CF_00001620D_ExactChange.Solution_0_Test(input);
