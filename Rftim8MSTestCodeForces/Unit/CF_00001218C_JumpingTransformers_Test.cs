...
{
    [TestClass]
    public sealed class CF_00001218C_JumpingTransformers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001218C_JumpingTransformers));
        ...
        {
            bool result = CF_00001218C_JumpingTransformers.Solution_0_Test(input);
