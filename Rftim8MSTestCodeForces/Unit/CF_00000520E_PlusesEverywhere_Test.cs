...
{
    [TestClass]
    public sealed class CF_00000520E_PlusesEverywhere_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000520E_PlusesEverywhere));
        ...
        {
            bool result = CF_00000520E_PlusesEverywhere.Solution_0_Test(input);
