...
{
    [TestClass]
    public sealed class CF_00000101E_CandiesAndStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000101E_CandiesAndStones));
        ...
        {
            bool result = CF_00000101E_CandiesAndStones.Solution_0_Test(input);
