...
{
    [TestClass]
    public sealed class CF_00000722E_ResearchRover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000722E_ResearchRover));
        ...
        {
            bool result = CF_00000722E_ResearchRover.Solution_0_Test(input);
