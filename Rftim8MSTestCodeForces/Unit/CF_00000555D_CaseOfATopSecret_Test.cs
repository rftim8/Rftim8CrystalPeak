...
{
    [TestClass]
    public sealed class CF_00000555D_CaseOfATopSecret_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000555D_CaseOfATopSecret));
        ...
        {
            bool result = CF_00000555D_CaseOfATopSecret.Solution_0_Test(input);
