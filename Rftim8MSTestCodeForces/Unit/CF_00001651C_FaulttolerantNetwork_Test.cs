...
{
    [TestClass]
    public sealed class CF_00001651C_FaulttolerantNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001651C_FaulttolerantNetwork));
        ...
        {
            bool result = CF_00001651C_FaulttolerantNetwork.Solution_0_Test(input);
