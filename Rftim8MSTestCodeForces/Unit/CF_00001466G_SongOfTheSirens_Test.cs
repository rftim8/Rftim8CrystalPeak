...
{
    [TestClass]
    public sealed class CF_00001466G_SongOfTheSirens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001466G_SongOfTheSirens));
        ...
        {
            bool result = CF_00001466G_SongOfTheSirens.Solution_0_Test(input);
