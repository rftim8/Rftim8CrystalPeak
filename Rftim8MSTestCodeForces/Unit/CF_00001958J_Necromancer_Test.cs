...
{
    [TestClass]
    public sealed class CF_00001958J_Necromancer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001958J_Necromancer));
        ...
        {
            bool result = CF_00001958J_Necromancer.Solution_0_Test(input);
