...
{
    [TestClass]
    public sealed class CF_00001848D_VikaAndBonuses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001848D_VikaAndBonuses));
        ...
        {
            bool result = CF_00001848D_VikaAndBonuses.Solution_0_Test(input);
