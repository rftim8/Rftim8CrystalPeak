...
{
    [TestClass]
    public sealed class CF_00001266E_SpaceshipSolitaire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001266E_SpaceshipSolitaire));
        ...
        {
            bool result = CF_00001266E_SpaceshipSolitaire.Solution_0_Test(input);
