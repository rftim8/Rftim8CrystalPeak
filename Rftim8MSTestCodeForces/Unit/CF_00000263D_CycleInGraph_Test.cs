...
{
    [TestClass]
    public sealed class CF_00000263D_CycleInGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000263D_CycleInGraph));
        ...
        {
            bool result = CF_00000263D_CycleInGraph.Solution_0_Test(input);
