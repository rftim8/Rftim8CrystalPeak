...
{
    [TestClass]
    public sealed class CF_00000961B_LectureSleep_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000961B_LectureSleep));
        ...
        {
            bool result = CF_00000961B_LectureSleep.Solution_0_Test(input);
