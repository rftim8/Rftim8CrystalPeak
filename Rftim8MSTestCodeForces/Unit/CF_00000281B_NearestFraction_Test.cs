...
{
    [TestClass]
    public sealed class CF_00000281B_NearestFraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000281B_NearestFraction));
        ...
        {
            bool result = CF_00000281B_NearestFraction.Solution_0_Test(input);
