...
{
    [TestClass]
    public sealed class CF_00001853A_Desorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001853A_Desorting));
        ...
        {
            bool result = CF_00001853A_Desorting.Solution_0_Test(input);
