...
{
    [TestClass]
    public sealed class CF_00000216D_SpidersWeb_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000216D_SpidersWeb));
        ...
        {
            bool result = CF_00000216D_SpidersWeb.Solution_0_Test(input);
