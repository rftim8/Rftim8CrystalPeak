...
{
    [TestClass]
    public sealed class CF_00001706C_QpwoeirutAndTheCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001706C_QpwoeirutAndTheCity));
        ...
        {
            bool result = CF_00001706C_QpwoeirutAndTheCity.Solution_0_Test(input);
