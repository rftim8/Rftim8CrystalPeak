...
{
    [TestClass]
    public sealed class CF_00000645C_EnduringExodus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000645C_EnduringExodus));
        ...
        {
            bool result = CF_00000645C_EnduringExodus.Solution_0_Test(input);
