...
{
    [TestClass]
    public sealed class CF_00001811E_LivingSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001811E_LivingSequence));
        ...
        {
            bool result = CF_00001811E_LivingSequence.Solution_0_Test(input);
