...
{
    [TestClass]
    public sealed class CF_00000340A_TheWall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000340A_TheWall));
        ...
        {
            bool result = CF_00000340A_TheWall.Solution_0_Test(input);
