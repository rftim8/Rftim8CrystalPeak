...
{
    [TestClass]
    public sealed class CF_00001077A_FrogJumping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001077A_FrogJumping));
        ...
        {
            bool result = CF_00001077A_FrogJumping.Solution_0_Test(input);
