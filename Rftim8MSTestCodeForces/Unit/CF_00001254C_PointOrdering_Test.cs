...
{
    [TestClass]
    public sealed class CF_00001254C_PointOrdering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001254C_PointOrdering));
        ...
        {
            bool result = CF_00001254C_PointOrdering.Solution_0_Test(input);
