...
{
    [TestClass]
    public sealed class CF_00001188B_CountPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001188B_CountPairs));
        ...
        {
            bool result = CF_00001188B_CountPairs.Solution_0_Test(input);
