...
{
    [TestClass]
    public sealed class CF_00001197E_CultureCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001197E_CultureCode));
        ...
        {
            bool result = CF_00001197E_CultureCode.Solution_0_Test(input);
