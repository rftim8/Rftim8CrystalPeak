...
{
    [TestClass]
    public sealed class CF_00001389D_SegmentIntersections_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001389D_SegmentIntersections));
        ...
        {
            bool result = CF_00001389D_SegmentIntersections.Solution_0_Test(input);
