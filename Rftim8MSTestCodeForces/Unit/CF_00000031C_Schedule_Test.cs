...
{
    [TestClass]
    public sealed class CF_00000031C_Schedule_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000031C_Schedule));
        ...
        {
            bool result = CF_00000031C_Schedule.Solution_0_Test(input);
