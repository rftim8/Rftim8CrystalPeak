...
{
    [TestClass]
    public sealed class CF_00001438A_SpecificTastesOfAndre_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001438A_SpecificTastesOfAndre));
        ...
        {
            bool result = CF_00001438A_SpecificTastesOfAndre.Solution_0_Test(input);
