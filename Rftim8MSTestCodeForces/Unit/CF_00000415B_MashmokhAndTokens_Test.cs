...
{
    [TestClass]
    public sealed class CF_00000415B_MashmokhAndTokens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000415B_MashmokhAndTokens));
        ...
        {
            bool result = CF_00000415B_MashmokhAndTokens.Solution_0_Test(input);
