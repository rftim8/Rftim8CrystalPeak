...
{
    [TestClass]
    public sealed class CF_00000568C_NewLanguage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000568C_NewLanguage));
        ...
        {
            bool result = CF_00000568C_NewLanguage.Solution_0_Test(input);
