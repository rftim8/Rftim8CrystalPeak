...
{
    [TestClass]
    public sealed class CF_00000724E_GoodsTransportation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000724E_GoodsTransportation));
        ...
        {
            bool result = CF_00000724E_GoodsTransportation.Solution_0_Test(input);
