...
{
    [TestClass]
    public sealed class CF_00000681B_EconomyGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000681B_EconomyGame));
        ...
        {
            bool result = CF_00000681B_EconomyGame.Solution_0_Test(input);
