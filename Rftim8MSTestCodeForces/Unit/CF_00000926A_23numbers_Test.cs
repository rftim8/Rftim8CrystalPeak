...
{
    [TestClass]
    public sealed class CF_00000926A_23numbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000926A_23numbers));
        ...
        {
            bool result = CF_00000926A_23numbers.Solution_0_Test(input);
