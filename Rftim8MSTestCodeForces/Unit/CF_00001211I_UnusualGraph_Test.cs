...
{
    [TestClass]
    public sealed class CF_00001211I_UnusualGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001211I_UnusualGraph));
        ...
        {
            bool result = CF_00001211I_UnusualGraph.Solution_0_Test(input);
