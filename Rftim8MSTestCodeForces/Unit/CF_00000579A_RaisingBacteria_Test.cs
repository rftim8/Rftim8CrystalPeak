...
{
    [TestClass]
    public sealed class CF_00000579A_RaisingBacteria_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000579A_RaisingBacteria));
        ...
        {
            bool result = CF_00000579A_RaisingBacteria.Solution_0_Test(input);
