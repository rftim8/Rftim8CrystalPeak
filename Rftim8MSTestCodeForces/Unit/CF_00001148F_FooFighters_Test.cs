...
{
    [TestClass]
    public sealed class CF_00001148F_FooFighters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001148F_FooFighters));
        ...
        {
            bool result = CF_00001148F_FooFighters.Solution_0_Test(input);
