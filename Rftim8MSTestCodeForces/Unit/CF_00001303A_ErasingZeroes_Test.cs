...
{
    [TestClass]
    public sealed class CF_00001303A_ErasingZeroes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001303A_ErasingZeroes));
        ...
        {
            bool result = CF_00001303A_ErasingZeroes.Solution_0_Test(input);
