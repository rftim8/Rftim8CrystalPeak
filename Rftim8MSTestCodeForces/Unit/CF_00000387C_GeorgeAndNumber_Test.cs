...
{
    [TestClass]
    public sealed class CF_00000387C_GeorgeAndNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000387C_GeorgeAndNumber));
        ...
        {
            bool result = CF_00000387C_GeorgeAndNumber.Solution_0_Test(input);
