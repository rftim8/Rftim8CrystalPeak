...
{
    [TestClass]
    public sealed class CF_00001089D_DistanceSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001089D_DistanceSum));
        ...
        {
            bool result = CF_00001089D_DistanceSum.Solution_0_Test(input);
