...
{
    [TestClass]
    public sealed class CF_00000995A_Tesla_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000995A_Tesla));
        ...
        {
            bool result = CF_00000995A_Tesla.Solution_0_Test(input);
