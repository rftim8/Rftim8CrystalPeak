...
{
    [TestClass]
    public sealed class CF_00001475D_CleaningThePhone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001475D_CleaningThePhone));
        ...
        {
            bool result = CF_00001475D_CleaningThePhone.Solution_0_Test(input);
