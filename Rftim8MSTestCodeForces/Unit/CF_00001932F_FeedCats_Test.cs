...
{
    [TestClass]
    public sealed class CF_00001932F_FeedCats_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001932F_FeedCats));
        ...
        {
            bool result = CF_00001932F_FeedCats.Solution_0_Test(input);
