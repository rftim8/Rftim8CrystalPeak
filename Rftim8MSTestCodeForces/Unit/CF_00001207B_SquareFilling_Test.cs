...
{
    [TestClass]
    public sealed class CF_00001207B_SquareFilling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001207B_SquareFilling));
        ...
        {
            bool result = CF_00001207B_SquareFilling.Solution_0_Test(input);
