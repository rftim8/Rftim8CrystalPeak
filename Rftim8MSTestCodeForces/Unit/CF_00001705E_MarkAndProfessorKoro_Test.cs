...
{
    [TestClass]
    public sealed class CF_00001705E_MarkAndProfessorKoro_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001705E_MarkAndProfessorKoro));
        ...
        {
            bool result = CF_00001705E_MarkAndProfessorKoro.Solution_0_Test(input);
