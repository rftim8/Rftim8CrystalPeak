...
{
    [TestClass]
    public sealed class CF_00000618D_HamiltonianSpanningTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000618D_HamiltonianSpanningTree));
        ...
        {
            bool result = CF_00000618D_HamiltonianSpanningTree.Solution_0_Test(input);
