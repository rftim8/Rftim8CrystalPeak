...
{
    [TestClass]
    public sealed class CF_00000843E_MaximumFlow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000843E_MaximumFlow));
        ...
        {
            bool result = CF_00000843E_MaximumFlow.Solution_0_Test(input);
