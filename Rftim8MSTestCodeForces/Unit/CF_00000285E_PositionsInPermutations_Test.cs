...
{
    [TestClass]
    public sealed class CF_00000285E_PositionsInPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000285E_PositionsInPermutations));
        ...
        {
            bool result = CF_00000285E_PositionsInPermutations.Solution_0_Test(input);
