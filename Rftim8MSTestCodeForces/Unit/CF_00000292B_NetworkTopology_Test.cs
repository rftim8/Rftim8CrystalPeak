...
{
    [TestClass]
    public sealed class CF_00000292B_NetworkTopology_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000292B_NetworkTopology));
        ...
        {
            bool result = CF_00000292B_NetworkTopology.Solution_0_Test(input);
