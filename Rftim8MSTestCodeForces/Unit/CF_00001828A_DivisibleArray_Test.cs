...
{
    [TestClass]
    public sealed class CF_00001828A_DivisibleArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001828A_DivisibleArray));
        ...
        {
            bool result = CF_00001828A_DivisibleArray.Solution_0_Test(input);
