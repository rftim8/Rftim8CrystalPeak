...
{
    [TestClass]
    public sealed class CF_00000847E_Packmen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847E_Packmen));
        ...
        {
            bool result = CF_00000847E_Packmen.Solution_0_Test(input);
