...
{
    [TestClass]
    public sealed class CF_00000886E_MaximumElement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000886E_MaximumElement));
        ...
        {
            bool result = CF_00000886E_MaximumElement.Solution_0_Test(input);
