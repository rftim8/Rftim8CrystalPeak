...
{
    [TestClass]
    public sealed class CF_00001042C_ArrayProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001042C_ArrayProduct));
        ...
        {
            bool result = CF_00001042C_ArrayProduct.Solution_0_Test(input);
