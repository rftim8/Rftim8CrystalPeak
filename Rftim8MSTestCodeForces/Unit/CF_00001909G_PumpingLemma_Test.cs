...
{
    [TestClass]
    public sealed class CF_00001909G_PumpingLemma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001909G_PumpingLemma));
        ...
        {
            bool result = CF_00001909G_PumpingLemma.Solution_0_Test(input);
