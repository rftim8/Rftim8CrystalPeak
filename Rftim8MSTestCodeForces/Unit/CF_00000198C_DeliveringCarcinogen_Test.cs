...
{
    [TestClass]
    public sealed class CF_00000198C_DeliveringCarcinogen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000198C_DeliveringCarcinogen));
        ...
        {
            bool result = CF_00000198C_DeliveringCarcinogen.Solution_0_Test(input);
