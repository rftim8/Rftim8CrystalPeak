...
{
    [TestClass]
    public sealed class CF_00001615G_MaximumAdjacentPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001615G_MaximumAdjacentPairs));
        ...
        {
            bool result = CF_00001615G_MaximumAdjacentPairs.Solution_0_Test(input);
