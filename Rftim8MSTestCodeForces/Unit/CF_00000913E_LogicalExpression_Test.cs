...
{
    [TestClass]
    public sealed class CF_00000913E_LogicalExpression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000913E_LogicalExpression));
        ...
        {
            bool result = CF_00000913E_LogicalExpression.Solution_0_Test(input);
