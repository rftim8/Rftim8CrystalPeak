...
{
    [TestClass]
    public sealed class CF_00001669H_MaximalAND_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001669H_MaximalAND));
        ...
        {
            bool result = CF_00001669H_MaximalAND.Solution_0_Test(input);
