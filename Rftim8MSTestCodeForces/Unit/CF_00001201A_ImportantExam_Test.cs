...
{
    [TestClass]
    public sealed class CF_00001201A_ImportantExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001201A_ImportantExam));
        ...
        {
            bool result = CF_00001201A_ImportantExam.Solution_0_Test(input);
