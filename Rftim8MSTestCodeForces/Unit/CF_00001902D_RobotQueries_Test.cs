...
{
    [TestClass]
    public sealed class CF_00001902D_RobotQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001902D_RobotQueries));
        ...
        {
            bool result = CF_00001902D_RobotQueries.Solution_0_Test(input);
