...
{
    [TestClass]
    public sealed class CF_00000052C_CircularRMQ_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000052C_CircularRMQ));
        ...
        {
            bool result = CF_00000052C_CircularRMQ.Solution_0_Test(input);
