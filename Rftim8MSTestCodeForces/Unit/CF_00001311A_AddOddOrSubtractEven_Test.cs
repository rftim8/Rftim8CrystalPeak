...
{
    [TestClass]
    public sealed class CF_00001311A_AddOddOrSubtractEven_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001311A_AddOddOrSubtractEven));
        ...
        {
            bool result = CF_00001311A_AddOddOrSubtractEven.Solution_0_Test(input);
