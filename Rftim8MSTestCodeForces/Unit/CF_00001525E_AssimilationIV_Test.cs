...
{
    [TestClass]
    public sealed class CF_00001525E_AssimilationIV_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001525E_AssimilationIV));
        ...
        {
            bool result = CF_00001525E_AssimilationIV.Solution_0_Test(input);
