...
{
    [TestClass]
    public sealed class CF_00000228C_FractalDetector_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000228C_FractalDetector));
        ...
        {
            bool result = CF_00000228C_FractalDetector.Solution_0_Test(input);
