...
{
    [TestClass]
    public sealed class CF_00000710A_KingMoves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000710A_KingMoves));
        ...
        {
            bool result = CF_00000710A_KingMoves.Solution_0_Test(input);
