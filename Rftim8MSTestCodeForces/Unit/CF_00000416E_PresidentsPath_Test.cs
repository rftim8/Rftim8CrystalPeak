...
{
    [TestClass]
    public sealed class CF_00000416E_PresidentsPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000416E_PresidentsPath));
        ...
        {
            bool result = CF_00000416E_PresidentsPath.Solution_0_Test(input);
