...
{
    [TestClass]
    public sealed class CF_00001585G_Poachers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001585G_Poachers));
        ...
        {
            bool result = CF_00001585G_Poachers.Solution_0_Test(input);
