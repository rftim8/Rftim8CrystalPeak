...
{
    [TestClass]
    public sealed class CF_00001192B_DynamicDiameter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001192B_DynamicDiameter));
        ...
        {
            bool result = CF_00001192B_DynamicDiameter.Solution_0_Test(input);
