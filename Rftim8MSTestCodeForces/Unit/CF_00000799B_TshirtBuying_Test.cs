...
{
    [TestClass]
    public sealed class CF_00000799B_TshirtBuying_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000799B_TshirtBuying));
        ...
        {
            bool result = CF_00000799B_TshirtBuying.Solution_0_Test(input);
