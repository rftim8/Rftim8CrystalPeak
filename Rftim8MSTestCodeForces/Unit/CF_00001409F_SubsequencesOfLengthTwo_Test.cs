...
{
    [TestClass]
    public sealed class CF_00001409F_SubsequencesOfLengthTwo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001409F_SubsequencesOfLengthTwo));
        ...
        {
            bool result = CF_00001409F_SubsequencesOfLengthTwo.Solution_0_Test(input);
