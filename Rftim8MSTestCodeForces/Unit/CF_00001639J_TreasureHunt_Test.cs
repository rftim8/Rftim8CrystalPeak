...
{
    [TestClass]
    public sealed class CF_00001639J_TreasureHunt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001639J_TreasureHunt));
        ...
        {
            bool result = CF_00001639J_TreasureHunt.Solution_0_Test(input);
