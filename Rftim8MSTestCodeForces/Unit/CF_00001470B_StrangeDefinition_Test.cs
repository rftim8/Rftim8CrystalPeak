...
{
    [TestClass]
    public sealed class CF_00001470B_StrangeDefinition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001470B_StrangeDefinition));
        ...
        {
            bool result = CF_00001470B_StrangeDefinition.Solution_0_Test(input);
