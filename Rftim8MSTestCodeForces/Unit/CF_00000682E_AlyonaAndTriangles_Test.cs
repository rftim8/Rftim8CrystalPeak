...
{
    [TestClass]
    public sealed class CF_00000682E_AlyonaAndTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000682E_AlyonaAndTriangles));
        ...
        {
            bool result = CF_00000682E_AlyonaAndTriangles.Solution_0_Test(input);
