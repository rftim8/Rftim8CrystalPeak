...
{
    [TestClass]
    public sealed class CF_00000407C_CuriousArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000407C_CuriousArray));
        ...
        {
            bool result = CF_00000407C_CuriousArray.Solution_0_Test(input);
