...
{
    [TestClass]
    public sealed class CF_00001315A_DeadPixel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001315A_DeadPixel));
        ...
        {
            bool result = CF_00001315A_DeadPixel.Solution_0_Test(input);
