...
{
    [TestClass]
    public sealed class CF_00000740B_AlyonaAndFlowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000740B_AlyonaAndFlowers));
        ...
        {
            bool result = CF_00000740B_AlyonaAndFlowers.Solution_0_Test(input);
