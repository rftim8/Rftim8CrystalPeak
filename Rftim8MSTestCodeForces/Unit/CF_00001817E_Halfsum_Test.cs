...
{
    [TestClass]
    public sealed class CF_00001817E_Halfsum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001817E_Halfsum));
        ...
        {
            bool result = CF_00001817E_Halfsum.Solution_0_Test(input);
