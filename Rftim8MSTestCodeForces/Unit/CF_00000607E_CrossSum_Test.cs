...
{
    [TestClass]
    public sealed class CF_00000607E_CrossSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000607E_CrossSum));
        ...
        {
            bool result = CF_00000607E_CrossSum.Solution_0_Test(input);
