...
{
    [TestClass]
    public sealed class CF_00001142B_LynyrdSkynyrd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001142B_LynyrdSkynyrd));
        ...
        {
            bool result = CF_00001142B_LynyrdSkynyrd.Solution_0_Test(input);
