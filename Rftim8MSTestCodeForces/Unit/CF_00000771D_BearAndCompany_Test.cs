...
{
    [TestClass]
    public sealed class CF_00000771D_BearAndCompany_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000771D_BearAndCompany));
        ...
        {
            bool result = CF_00000771D_BearAndCompany.Solution_0_Test(input);
