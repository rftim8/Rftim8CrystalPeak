...
{
    [TestClass]
    public sealed class CF_00001615D_XormasTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001615D_XormasTree));
        ...
        {
            bool result = CF_00001615D_XormasTree.Solution_0_Test(input);
