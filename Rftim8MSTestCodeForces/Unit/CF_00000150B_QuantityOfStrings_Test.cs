...
{
    [TestClass]
    public sealed class CF_00000150B_QuantityOfStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000150B_QuantityOfStrings));
        ...
        {
            bool result = CF_00000150B_QuantityOfStrings.Solution_0_Test(input);
