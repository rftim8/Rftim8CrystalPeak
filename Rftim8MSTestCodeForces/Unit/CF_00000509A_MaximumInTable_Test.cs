...
{
    [TestClass]
    public sealed class CF_00000509A_MaximumInTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000509A_MaximumInTable));
        ...
        {
            bool result = CF_00000509A_MaximumInTable.Solution_0_Test(input);
