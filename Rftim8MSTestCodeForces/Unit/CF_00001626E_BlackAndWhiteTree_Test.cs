...
{
    [TestClass]
    public sealed class CF_00001626E_BlackAndWhiteTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001626E_BlackAndWhiteTree));
        ...
        {
            bool result = CF_00001626E_BlackAndWhiteTree.Solution_0_Test(input);
