...
{
    [TestClass]
    public sealed class CF_00002002A_DistancedColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002002A_DistancedColoring));
        ...
        {
            bool result = CF_00002002A_DistancedColoring.Solution_0_Test(input);
