...
{
    [TestClass]
    public sealed class CF_00000557E_AnnAndHalfPalindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000557E_AnnAndHalfPalindrome));
        ...
        {
            bool result = CF_00000557E_AnnAndHalfPalindrome.Solution_0_Test(input);
