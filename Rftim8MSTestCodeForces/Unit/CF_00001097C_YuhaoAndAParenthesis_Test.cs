...
{
    [TestClass]
    public sealed class CF_00001097C_YuhaoAndAParenthesis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001097C_YuhaoAndAParenthesis));
        ...
        {
            bool result = CF_00001097C_YuhaoAndAParenthesis.Solution_0_Test(input);
