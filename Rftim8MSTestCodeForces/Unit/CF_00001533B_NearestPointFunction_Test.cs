...
{
    [TestClass]
    public sealed class CF_00001533B_NearestPointFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001533B_NearestPointFunction));
        ...
        {
            bool result = CF_00001533B_NearestPointFunction.Solution_0_Test(input);
