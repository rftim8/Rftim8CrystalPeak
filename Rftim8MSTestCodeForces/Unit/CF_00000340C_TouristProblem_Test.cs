...
{
    [TestClass]
    public sealed class CF_00000340C_TouristProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000340C_TouristProblem));
        ...
        {
            bool result = CF_00000340C_TouristProblem.Solution_0_Test(input);
