...
{
    [TestClass]
    public sealed class CF_00001047B_CoverPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001047B_CoverPoints));
        ...
        {
            bool result = CF_00001047B_CoverPoints.Solution_0_Test(input);
