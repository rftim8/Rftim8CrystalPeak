...
{
    [TestClass]
    public sealed class CF_00000219C_ColorStripe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000219C_ColorStripe));
        ...
        {
            bool result = CF_00000219C_ColorStripe.Solution_0_Test(input);
