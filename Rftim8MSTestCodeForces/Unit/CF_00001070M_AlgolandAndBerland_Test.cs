...
{
    [TestClass]
    public sealed class CF_00001070M_AlgolandAndBerland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001070M_AlgolandAndBerland));
        ...
        {
            bool result = CF_00001070M_AlgolandAndBerland.Solution_0_Test(input);
