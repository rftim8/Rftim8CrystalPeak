...
{
    [TestClass]
    public sealed class CF_00000217C_Formurosa_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000217C_Formurosa));
        ...
        {
            bool result = CF_00000217C_Formurosa.Solution_0_Test(input);
