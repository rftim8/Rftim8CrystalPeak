...
{
    [TestClass]
    public sealed class CF_00001791C_PrependAndAppend_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001791C_PrependAndAppend));
        ...
        {
            bool result = CF_00001791C_PrependAndAppend.Solution_0_Test(input);
