...
{
    [TestClass]
    public sealed class CF_00000631A_Interview_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000631A_Interview));
        ...
        {
            bool result = CF_00000631A_Interview.Solution_0_Test(input);
