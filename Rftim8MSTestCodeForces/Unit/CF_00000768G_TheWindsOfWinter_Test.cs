...
{
    [TestClass]
    public sealed class CF_00000768G_TheWindsOfWinter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000768G_TheWindsOfWinter));
        ...
        {
            bool result = CF_00000768G_TheWindsOfWinter.Solution_0_Test(input);
