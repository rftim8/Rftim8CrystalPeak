...
{
    [TestClass]
    public sealed class CF_00000140E_NewYearGarland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000140E_NewYearGarland));
        ...
        {
            bool result = CF_00000140E_NewYearGarland.Solution_0_Test(input);
