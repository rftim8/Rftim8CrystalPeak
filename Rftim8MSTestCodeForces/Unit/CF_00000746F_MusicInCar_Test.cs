...
{
    [TestClass]
    public sealed class CF_00000746F_MusicInCar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000746F_MusicInCar));
        ...
        {
            bool result = CF_00000746F_MusicInCar.Solution_0_Test(input);
