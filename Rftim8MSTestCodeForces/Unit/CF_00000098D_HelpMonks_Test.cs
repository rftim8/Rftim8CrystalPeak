...
{
    [TestClass]
    public sealed class CF_00000098D_HelpMonks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000098D_HelpMonks));
        ...
        {
            bool result = CF_00000098D_HelpMonks.Solution_0_Test(input);
