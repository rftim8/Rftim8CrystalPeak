...
{
    [TestClass]
    public sealed class CF_00001214E_PetyaAndConstructionSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001214E_PetyaAndConstructionSet));
        ...
        {
            bool result = CF_00001214E_PetyaAndConstructionSet.Solution_0_Test(input);
