...
{
    [TestClass]
    public sealed class CF_00001454E_NumberOfSimplePaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001454E_NumberOfSimplePaths));
        ...
        {
            bool result = CF_00001454E_NumberOfSimplePaths.Solution_0_Test(input);
