...
{
    [TestClass]
    public sealed class CF_00000554A_KyoyaAndPhotobooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000554A_KyoyaAndPhotobooks));
        ...
        {
            bool result = CF_00000554A_KyoyaAndPhotobooks.Solution_0_Test(input);
