...
{
    [TestClass]
    public sealed class CF_00001407B_BigVova_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001407B_BigVova));
        ...
        {
            bool result = CF_00001407B_BigVova.Solution_0_Test(input);
