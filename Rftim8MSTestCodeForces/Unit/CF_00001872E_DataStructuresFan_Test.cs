...
{
    [TestClass]
    public sealed class CF_00001872E_DataStructuresFan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001872E_DataStructuresFan));
        ...
        {
            bool result = CF_00001872E_DataStructuresFan.Solution_0_Test(input);
