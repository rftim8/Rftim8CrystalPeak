...
{
    [TestClass]
    public sealed class CF_00001329A_DreamoonLikesColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001329A_DreamoonLikesColoring));
        ...
        {
            bool result = CF_00001329A_DreamoonLikesColoring.Solution_0_Test(input);
