...
{
    [TestClass]
    public sealed class CF_00000271E_ThreeHorses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000271E_ThreeHorses));
        ...
        {
            bool result = CF_00000271E_ThreeHorses.Solution_0_Test(input);
