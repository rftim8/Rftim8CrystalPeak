...
{
    [TestClass]
    public sealed class CF_00001760C_Advantage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001760C_Advantage));
        ...
        {
            bool result = CF_00001760C_Advantage.Solution_0_Test(input);
