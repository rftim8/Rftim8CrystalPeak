...
{
    [TestClass]
    public sealed class CF_00000280A_RectanglePuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000280A_RectanglePuzzle));
        ...
        {
            bool result = CF_00000280A_RectanglePuzzle.Solution_0_Test(input);
