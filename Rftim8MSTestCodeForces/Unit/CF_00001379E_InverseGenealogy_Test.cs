...
{
    [TestClass]
    public sealed class CF_00001379E_InverseGenealogy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001379E_InverseGenealogy));
        ...
        {
            bool result = CF_00001379E_InverseGenealogy.Solution_0_Test(input);
