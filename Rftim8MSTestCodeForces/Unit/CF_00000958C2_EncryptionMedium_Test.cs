...
{
    [TestClass]
    public sealed class CF_00000958C2_EncryptionMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958C2_EncryptionMedium));
        ...
        {
            bool result = CF_00000958C2_EncryptionMedium.Solution_0_Test(input);
