...
{
    [TestClass]
    public sealed class CF_00000525E_AnyaAndCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000525E_AnyaAndCubes));
        ...
        {
            bool result = CF_00000525E_AnyaAndCubes.Solution_0_Test(input);
