...
{
    [TestClass]
    public sealed class CF_00001941A_RudolfAndTheTicket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001941A_RudolfAndTheTicket));
        ...
        {
            bool result = CF_00001941A_RudolfAndTheTicket.Solution_0_Test(input);
