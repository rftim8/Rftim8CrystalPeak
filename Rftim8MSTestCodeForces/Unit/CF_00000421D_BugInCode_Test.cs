...
{
    [TestClass]
    public sealed class CF_00000421D_BugInCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000421D_BugInCode));
        ...
        {
            bool result = CF_00000421D_BugInCode.Solution_0_Test(input);
