...
{
    [TestClass]
    public sealed class CF_00001732D1_BalanceEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001732D1_BalanceEasyVersion));
        ...
        {
            bool result = CF_00001732D1_BalanceEasyVersion.Solution_0_Test(input);
