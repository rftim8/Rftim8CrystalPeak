...
{
    [TestClass]
    public sealed class CF_00000630E_ARectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630E_ARectangle));
        ...
        {
            bool result = CF_00000630E_ARectangle.Solution_0_Test(input);
