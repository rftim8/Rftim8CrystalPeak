...
{
    [TestClass]
    public sealed class CF_00001239D_CatowiceCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001239D_CatowiceCity));
        ...
        {
            bool result = CF_00001239D_CatowiceCity.Solution_0_Test(input);
