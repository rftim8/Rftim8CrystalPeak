...
{
    [TestClass]
    public sealed class CF_00000865G_FlowersAndChocolate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000865G_FlowersAndChocolate));
        ...
        {
            bool result = CF_00000865G_FlowersAndChocolate.Solution_0_Test(input);
