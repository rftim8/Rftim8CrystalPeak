...
{
    [TestClass]
    public sealed class CF_00001992A_OnlyPluses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001992A_OnlyPluses));
        ...
        {
            bool result = CF_00001992A_OnlyPluses.Solution_0_Test(input);
