...
{
    [TestClass]
    public sealed class CF_00000639A_BearAndDisplayedFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000639A_BearAndDisplayedFriends));
        ...
        {
            bool result = CF_00000639A_BearAndDisplayedFriends.Solution_0_Test(input);
