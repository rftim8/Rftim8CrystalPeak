...
{
    [TestClass]
    public sealed class CF_00000653A_BearAndThreeBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000653A_BearAndThreeBalls));
        ...
        {
            bool result = CF_00000653A_BearAndThreeBalls.Solution_0_Test(input);
