...
{
    [TestClass]
    public sealed class CF_00000762F_TreeNesting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000762F_TreeNesting));
        ...
        {
            bool result = CF_00000762F_TreeNesting.Solution_0_Test(input);
