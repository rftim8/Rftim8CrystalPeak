...
{
    [TestClass]
    public sealed class CF_00001875A_JellyfishAndUndertale_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001875A_JellyfishAndUndertale));
        ...
        {
            bool result = CF_00001875A_JellyfishAndUndertale.Solution_0_Test(input);
