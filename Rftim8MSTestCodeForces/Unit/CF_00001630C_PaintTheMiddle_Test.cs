...
{
    [TestClass]
    public sealed class CF_00001630C_PaintTheMiddle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001630C_PaintTheMiddle));
        ...
        {
            bool result = CF_00001630C_PaintTheMiddle.Solution_0_Test(input);
