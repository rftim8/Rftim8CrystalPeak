...
{
    [TestClass]
    public sealed class CF_00001005A_TanyaAndStairways_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001005A_TanyaAndStairways));
        ...
        {
            bool result = CF_00001005A_TanyaAndStairways.Solution_0_Test(input);
