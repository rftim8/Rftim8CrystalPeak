...
{
    [TestClass]
    public sealed class CF_00000731F_VideoCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000731F_VideoCards));
        ...
        {
            bool result = CF_00000731F_VideoCards.Solution_0_Test(input);
