...
{
    [TestClass]
    public sealed class CF_00001190E_TokitsukazeAndExplosion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001190E_TokitsukazeAndExplosion));
        ...
        {
            bool result = CF_00001190E_TokitsukazeAndExplosion.Solution_0_Test(input);
