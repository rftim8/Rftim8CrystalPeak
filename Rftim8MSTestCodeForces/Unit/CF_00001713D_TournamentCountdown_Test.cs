...
{
    [TestClass]
    public sealed class CF_00001713D_TournamentCountdown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001713D_TournamentCountdown));
        ...
        {
            bool result = CF_00001713D_TournamentCountdown.Solution_0_Test(input);
