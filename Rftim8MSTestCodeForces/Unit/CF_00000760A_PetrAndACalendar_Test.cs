...
{
    [TestClass]
    public sealed class CF_00000760A_PetrAndACalendar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000760A_PetrAndACalendar));
        ...
        {
            bool result = CF_00000760A_PetrAndACalendar.Solution_0_Test(input);
