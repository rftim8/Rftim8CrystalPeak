...
{
    [TestClass]
    public sealed class CF_00001234A_EqualizePricesAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001234A_EqualizePricesAgain));
        ...
        {
            bool result = CF_00001234A_EqualizePricesAgain.Solution_0_Test(input);
