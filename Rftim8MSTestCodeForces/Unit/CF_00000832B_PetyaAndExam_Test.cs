...
{
    [TestClass]
    public sealed class CF_00000832B_PetyaAndExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000832B_PetyaAndExam));
        ...
        {
            bool result = CF_00000832B_PetyaAndExam.Solution_0_Test(input);
