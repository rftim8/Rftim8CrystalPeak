...
{
    [TestClass]
    public sealed class CF_00000372A_CountingKangaroosIsFun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000372A_CountingKangaroosIsFun));
        ...
        {
            bool result = CF_00000372A_CountingKangaroosIsFun.Solution_0_Test(input);
