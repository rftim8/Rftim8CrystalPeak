...
{
    [TestClass]
    public sealed class CF_00000044D_Hyperdrive_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000044D_Hyperdrive));
        ...
        {
            bool result = CF_00000044D_Hyperdrive.Solution_0_Test(input);
