...
{
    [TestClass]
    public sealed class CF_00001173A_NauuoAndVotes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001173A_NauuoAndVotes));
        ...
        {
            bool result = CF_00001173A_NauuoAndVotes.Solution_0_Test(input);
