...
{
    [TestClass]
    public sealed class CF_00001446F_LineDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001446F_LineDistance));
        ...
        {
            bool result = CF_00001446F_LineDistance.Solution_0_Test(input);
