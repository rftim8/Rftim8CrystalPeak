...
{
    [TestClass]
    public sealed class CF_00001585E_FrequencyQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001585E_FrequencyQueries));
        ...
        {
            bool result = CF_00001585E_FrequencyQueries.Solution_0_Test(input);
