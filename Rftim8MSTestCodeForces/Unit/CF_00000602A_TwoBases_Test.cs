...
{
    [TestClass]
    public sealed class CF_00000602A_TwoBases_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000602A_TwoBases));
        ...
        {
            bool result = CF_00000602A_TwoBases.Solution_0_Test(input);
