...
{
    [TestClass]
    public sealed class CF_00000898C_PhoneNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000898C_PhoneNumbers));
        ...
        {
            bool result = CF_00000898C_PhoneNumbers.Solution_0_Test(input);
