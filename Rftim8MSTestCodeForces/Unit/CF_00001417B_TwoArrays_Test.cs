...
{
    [TestClass]
    public sealed class CF_00001417B_TwoArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001417B_TwoArrays));
        ...
        {
            bool result = CF_00001417B_TwoArrays.Solution_0_Test(input);
