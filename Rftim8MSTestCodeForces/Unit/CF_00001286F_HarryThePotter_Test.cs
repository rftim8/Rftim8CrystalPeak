...
{
    [TestClass]
    public sealed class CF_00001286F_HarryThePotter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001286F_HarryThePotter));
        ...
        {
            bool result = CF_00001286F_HarryThePotter.Solution_0_Test(input);
