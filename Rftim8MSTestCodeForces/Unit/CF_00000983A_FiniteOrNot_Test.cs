...
{
    [TestClass]
    public sealed class CF_00000983A_FiniteOrNot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000983A_FiniteOrNot));
        ...
        {
            bool result = CF_00000983A_FiniteOrNot.Solution_0_Test(input);
