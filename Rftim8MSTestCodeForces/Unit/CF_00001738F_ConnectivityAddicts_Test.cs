...
{
    [TestClass]
    public sealed class CF_00001738F_ConnectivityAddicts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001738F_ConnectivityAddicts));
        ...
        {
            bool result = CF_00001738F_ConnectivityAddicts.Solution_0_Test(input);
