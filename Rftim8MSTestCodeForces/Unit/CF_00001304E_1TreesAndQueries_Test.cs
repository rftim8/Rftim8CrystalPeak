...
{
    [TestClass]
    public sealed class CF_00001304E_1TreesAndQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001304E_1TreesAndQueries));
        ...
        {
            bool result = CF_00001304E_1TreesAndQueries.Solution_0_Test(input);
