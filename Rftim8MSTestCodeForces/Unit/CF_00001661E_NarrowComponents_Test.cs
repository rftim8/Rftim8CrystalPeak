...
{
    [TestClass]
    public sealed class CF_00001661E_NarrowComponents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001661E_NarrowComponents));
        ...
        {
            bool result = CF_00001661E_NarrowComponents.Solution_0_Test(input);
