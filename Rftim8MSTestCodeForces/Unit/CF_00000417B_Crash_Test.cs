...
{
    [TestClass]
    public sealed class CF_00000417B_Crash_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000417B_Crash));
        ...
        {
            bool result = CF_00000417B_Crash.Solution_0_Test(input);
