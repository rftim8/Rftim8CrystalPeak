...
{
    [TestClass]
    public sealed class CF_00000915G_CoprimeArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000915G_CoprimeArrays));
        ...
        {
            bool result = CF_00000915G_CoprimeArrays.Solution_0_Test(input);
