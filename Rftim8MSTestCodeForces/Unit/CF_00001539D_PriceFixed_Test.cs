...
{
    [TestClass]
    public sealed class CF_00001539D_PriceFixed_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001539D_PriceFixed));
        ...
        {
            bool result = CF_00001539D_PriceFixed.Solution_0_Test(input);
