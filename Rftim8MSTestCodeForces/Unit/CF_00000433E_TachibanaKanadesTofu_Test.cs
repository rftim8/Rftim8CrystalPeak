...
{
    [TestClass]
    public sealed class CF_00000433E_TachibanaKanadesTofu_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000433E_TachibanaKanadesTofu));
        ...
        {
            bool result = CF_00000433E_TachibanaKanadesTofu.Solution_0_Test(input);
