...
{
    [TestClass]
    public sealed class CF_00000883B_BerlandArmy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883B_BerlandArmy));
        ...
        {
            bool result = CF_00000883B_BerlandArmy.Solution_0_Test(input);
