...
{
    [TestClass]
    public sealed class CF_00001031F_FamiliarOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001031F_FamiliarOperations));
        ...
        {
            bool result = CF_00001031F_FamiliarOperations.Solution_0_Test(input);
