...
{
    [TestClass]
    public sealed class CF_00000818G_FourMelodies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000818G_FourMelodies));
        ...
        {
            bool result = CF_00000818G_FourMelodies.Solution_0_Test(input);
