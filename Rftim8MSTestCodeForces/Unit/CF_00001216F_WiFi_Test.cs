...
{
    [TestClass]
    public sealed class CF_00001216F_WiFi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001216F_WiFi));
        ...
        {
            bool result = CF_00001216F_WiFi.Solution_0_Test(input);
