...
{
    [TestClass]
    public sealed class CF_00000567F_Mausoleum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000567F_Mausoleum));
        ...
        {
            bool result = CF_00000567F_Mausoleum.Solution_0_Test(input);
