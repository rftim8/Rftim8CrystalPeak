...
{
    [TestClass]
    public sealed class CF_00000487B_Strip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000487B_Strip));
        ...
        {
            bool result = CF_00000487B_Strip.Solution_0_Test(input);
