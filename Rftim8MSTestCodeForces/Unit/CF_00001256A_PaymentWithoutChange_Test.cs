...
{
    [TestClass]
    public sealed class CF_00001256A_PaymentWithoutChange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001256A_PaymentWithoutChange));
        ...
        {
            bool result = CF_00001256A_PaymentWithoutChange.Solution_0_Test(input);
