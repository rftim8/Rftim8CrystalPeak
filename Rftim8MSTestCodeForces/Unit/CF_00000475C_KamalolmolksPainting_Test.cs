...
{
    [TestClass]
    public sealed class CF_00000475C_KamalolmolksPainting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000475C_KamalolmolksPainting));
        ...
        {
            bool result = CF_00000475C_KamalolmolksPainting.Solution_0_Test(input);
