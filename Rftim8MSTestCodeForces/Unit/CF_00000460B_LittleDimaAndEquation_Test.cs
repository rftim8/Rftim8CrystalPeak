...
{
    [TestClass]
    public sealed class CF_00000460B_LittleDimaAndEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000460B_LittleDimaAndEquation));
        ...
        {
            bool result = CF_00000460B_LittleDimaAndEquation.Solution_0_Test(input);
