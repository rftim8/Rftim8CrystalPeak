...
{
    [TestClass]
    public sealed class CF_00001657F_WordsOnTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001657F_WordsOnTree));
        ...
        {
            bool result = CF_00001657F_WordsOnTree.Solution_0_Test(input);
