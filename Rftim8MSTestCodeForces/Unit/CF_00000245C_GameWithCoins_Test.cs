...
{
    [TestClass]
    public sealed class CF_00000245C_GameWithCoins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000245C_GameWithCoins));
        ...
        {
            bool result = CF_00000245C_GameWithCoins.Solution_0_Test(input);
