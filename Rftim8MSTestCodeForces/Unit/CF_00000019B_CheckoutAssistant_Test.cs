...
{
    [TestClass]
    public sealed class CF_00000019B_CheckoutAssistant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000019B_CheckoutAssistant));
        ...
        {
            bool result = CF_00000019B_CheckoutAssistant.Solution_0_Test(input);
