...
{
    [TestClass]
    public sealed class CF_00000887C_SolutionForCube_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000887C_SolutionForCube));
        ...
        {
            bool result = CF_00000887C_SolutionForCube.Solution_0_Test(input);
