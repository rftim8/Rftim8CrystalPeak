...
{
    [TestClass]
    public sealed class CF_00000171F_Ucyhf_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000171F_Ucyhf));
        ...
        {
            bool result = CF_00000171F_Ucyhf.Solution_0_Test(input);
