...
{
    [TestClass]
    public sealed class CF_00000031B_SysadminBob_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000031B_SysadminBob));
        ...
        {
            bool result = CF_00000031B_SysadminBob.Solution_0_Test(input);
