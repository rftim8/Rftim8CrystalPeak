...
{
    [TestClass]
    public sealed class CF_00001492D_GeniussGambit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001492D_GeniussGambit));
        ...
        {
            bool result = CF_00001492D_GeniussGambit.Solution_0_Test(input);
