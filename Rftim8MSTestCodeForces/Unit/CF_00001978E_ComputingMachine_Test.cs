...
{
    [TestClass]
    public sealed class CF_00001978E_ComputingMachine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001978E_ComputingMachine));
        ...
        {
            bool result = CF_00001978E_ComputingMachine.Solution_0_Test(input);
