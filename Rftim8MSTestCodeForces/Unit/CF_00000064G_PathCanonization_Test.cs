...
{
    [TestClass]
    public sealed class CF_00000064G_PathCanonization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000064G_PathCanonization));
        ...
        {
            bool result = CF_00000064G_PathCanonization.Solution_0_Test(input);
