...
{
    [TestClass]
    public sealed class CF_00001371C_ACookieForYou_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001371C_ACookieForYou));
        ...
        {
            bool result = CF_00001371C_ACookieForYou.Solution_0_Test(input);
