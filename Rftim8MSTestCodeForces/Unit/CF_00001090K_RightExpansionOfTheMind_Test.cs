...
{
    [TestClass]
    public sealed class CF_00001090K_RightExpansionOfTheMind_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090K_RightExpansionOfTheMind));
        ...
        {
            bool result = CF_00001090K_RightExpansionOfTheMind.Solution_0_Test(input);
