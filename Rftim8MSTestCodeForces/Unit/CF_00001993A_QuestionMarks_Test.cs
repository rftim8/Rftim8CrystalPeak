...
{
    [TestClass]
    public sealed class CF_00001993A_QuestionMarks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001993A_QuestionMarks));
        ...
        {
            bool result = CF_00001993A_QuestionMarks.Solution_0_Test(input);
