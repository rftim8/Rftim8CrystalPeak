...
{
    [TestClass]
    public sealed class CF_00000309B_ContextAdvertising_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000309B_ContextAdvertising));
        ...
        {
            bool result = CF_00000309B_ContextAdvertising.Solution_0_Test(input);
