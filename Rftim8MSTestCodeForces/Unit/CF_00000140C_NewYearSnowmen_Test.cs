...
{
    [TestClass]
    public sealed class CF_00000140C_NewYearSnowmen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000140C_NewYearSnowmen));
        ...
        {
            bool result = CF_00000140C_NewYearSnowmen.Solution_0_Test(input);
