...
{
    [TestClass]
    public sealed class CF_00001038F_WrapAround_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001038F_WrapAround));
        ...
        {
            bool result = CF_00001038F_WrapAround.Solution_0_Test(input);
