...
{
    [TestClass]
    public sealed class CF_00001030D_VasyaAndTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001030D_VasyaAndTriangle));
        ...
        {
            bool result = CF_00001030D_VasyaAndTriangle.Solution_0_Test(input);
