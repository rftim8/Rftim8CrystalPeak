...
{
    [TestClass]
    public sealed class CF_00000059A_Word_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000059A_Word));
        ...
        {
            bool result = CF_00000059A_Word.Solution_0_Test(input);
