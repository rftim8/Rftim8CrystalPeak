...
{
    [TestClass]
    public sealed class CF_00001834C_GameWithReversing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001834C_GameWithReversing));
        ...
        {
            bool result = CF_00001834C_GameWithReversing.Solution_0_Test(input);
