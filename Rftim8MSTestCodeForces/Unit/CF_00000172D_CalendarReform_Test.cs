...
{
    [TestClass]
    public sealed class CF_00000172D_CalendarReform_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000172D_CalendarReform));
        ...
        {
            bool result = CF_00000172D_CalendarReform.Solution_0_Test(input);
