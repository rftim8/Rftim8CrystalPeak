...
{
    [TestClass]
    public sealed class CF_00000035B_Warehouse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000035B_Warehouse));
        ...
        {
            bool result = CF_00000035B_Warehouse.Solution_0_Test(input);
