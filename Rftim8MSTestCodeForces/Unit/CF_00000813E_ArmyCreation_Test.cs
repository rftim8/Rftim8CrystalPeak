...
{
    [TestClass]
    public sealed class CF_00000813E_ArmyCreation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000813E_ArmyCreation));
        ...
        {
            bool result = CF_00000813E_ArmyCreation.Solution_0_Test(input);
