...
{
    [TestClass]
    public sealed class CF_00001146B_HateA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001146B_HateA));
        ...
        {
            bool result = CF_00001146B_HateA.Solution_0_Test(input);
