...
{
    [TestClass]
    public sealed class CF_00001080E_SonyaAndMatrixBeauty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001080E_SonyaAndMatrixBeauty));
        ...
        {
            bool result = CF_00001080E_SonyaAndMatrixBeauty.Solution_0_Test(input);
