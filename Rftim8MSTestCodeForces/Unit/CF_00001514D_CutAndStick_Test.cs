...
{
    [TestClass]
    public sealed class CF_00001514D_CutAndStick_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001514D_CutAndStick));
        ...
        {
            bool result = CF_00001514D_CutAndStick.Solution_0_Test(input);
