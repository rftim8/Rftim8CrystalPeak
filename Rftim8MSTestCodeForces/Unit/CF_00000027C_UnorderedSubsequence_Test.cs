...
{
    [TestClass]
    public sealed class CF_00000027C_UnorderedSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000027C_UnorderedSubsequence));
        ...
        {
            bool result = CF_00000027C_UnorderedSubsequence.Solution_0_Test(input);
