...
{
    [TestClass]
    public sealed class CF_00001111E_Tree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001111E_Tree));
        ...
        {
            bool result = CF_00001111E_Tree.Solution_0_Test(input);
