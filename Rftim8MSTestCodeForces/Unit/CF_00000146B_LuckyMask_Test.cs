...
{
    [TestClass]
    public sealed class CF_00000146B_LuckyMask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000146B_LuckyMask));
        ...
        {
            bool result = CF_00000146B_LuckyMask.Solution_0_Test(input);
