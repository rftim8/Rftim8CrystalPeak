...
{
    [TestClass]
    public sealed class CF_00000990F_FlowControl_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000990F_FlowControl));
        ...
        {
            bool result = CF_00000990F_FlowControl.Solution_0_Test(input);
