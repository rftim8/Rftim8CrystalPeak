...
{
    [TestClass]
    public sealed class CF_00001001E_DistinguishBellStates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001001E_DistinguishBellStates));
        ...
        {
            bool result = CF_00001001E_DistinguishBellStates.Solution_0_Test(input);
