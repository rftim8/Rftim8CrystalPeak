...
{
    [TestClass]
    public sealed class CF_00001027B_NumbersOnTheChessboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001027B_NumbersOnTheChessboard));
        ...
        {
            bool result = CF_00001027B_NumbersOnTheChessboard.Solution_0_Test(input);
