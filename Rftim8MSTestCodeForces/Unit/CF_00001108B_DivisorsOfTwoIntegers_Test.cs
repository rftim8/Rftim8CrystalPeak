...
{
    [TestClass]
    public sealed class CF_00001108B_DivisorsOfTwoIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001108B_DivisorsOfTwoIntegers));
        ...
        {
            bool result = CF_00001108B_DivisorsOfTwoIntegers.Solution_0_Test(input);
