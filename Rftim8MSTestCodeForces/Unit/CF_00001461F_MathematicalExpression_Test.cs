...
{
    [TestClass]
    public sealed class CF_00001461F_MathematicalExpression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001461F_MathematicalExpression));
        ...
        {
            bool result = CF_00001461F_MathematicalExpression.Solution_0_Test(input);
