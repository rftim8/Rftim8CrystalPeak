...
{
    [TestClass]
    public sealed class CF_00000268B_Buttons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000268B_Buttons));
        ...
        {
            bool result = CF_00000268B_Buttons.Solution_0_Test(input);
