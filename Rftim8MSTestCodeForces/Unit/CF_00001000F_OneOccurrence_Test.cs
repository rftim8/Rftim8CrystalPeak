...
{
    [TestClass]
    public sealed class CF_00001000F_OneOccurrence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001000F_OneOccurrence));
        ...
        {
            bool result = CF_00001000F_OneOccurrence.Solution_0_Test(input);
