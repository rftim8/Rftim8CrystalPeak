...
{
    [TestClass]
    public sealed class CF_00000896A_NephrenGivesARiddle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000896A_NephrenGivesARiddle));
        ...
        {
            bool result = CF_00000896A_NephrenGivesARiddle.Solution_0_Test(input);
