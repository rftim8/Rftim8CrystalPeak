...
{
    [TestClass]
    public sealed class CF_00000020A_BerOSFileSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000020A_BerOSFileSystem));
        ...
        {
            bool result = CF_00000020A_BerOSFileSystem.Solution_0_Test(input);
