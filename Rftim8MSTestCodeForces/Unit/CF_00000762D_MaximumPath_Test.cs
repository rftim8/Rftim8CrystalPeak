...
{
    [TestClass]
    public sealed class CF_00000762D_MaximumPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000762D_MaximumPath));
        ...
        {
            bool result = CF_00000762D_MaximumPath.Solution_0_Test(input);
