...
{
    [TestClass]
    public sealed class CF_00001580F_ProblemsForCodeforces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001580F_ProblemsForCodeforces));
        ...
        {
            bool result = CF_00001580F_ProblemsForCodeforces.Solution_0_Test(input);
