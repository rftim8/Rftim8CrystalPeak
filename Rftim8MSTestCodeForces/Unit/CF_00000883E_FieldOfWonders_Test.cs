...
{
    [TestClass]
    public sealed class CF_00000883E_FieldOfWonders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883E_FieldOfWonders));
        ...
        {
            bool result = CF_00000883E_FieldOfWonders.Solution_0_Test(input);
