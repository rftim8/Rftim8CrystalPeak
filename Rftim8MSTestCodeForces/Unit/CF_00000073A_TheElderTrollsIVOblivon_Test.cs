...
{
    [TestClass]
    public sealed class CF_00000073A_TheElderTrollsIVOblivon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000073A_TheElderTrollsIVOblivon));
        ...
        {
            bool result = CF_00000073A_TheElderTrollsIVOblivon.Solution_0_Test(input);
