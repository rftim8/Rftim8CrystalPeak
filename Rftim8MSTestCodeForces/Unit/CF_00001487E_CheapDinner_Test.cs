...
{
    [TestClass]
    public sealed class CF_00001487E_CheapDinner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001487E_CheapDinner));
        ...
        {
            bool result = CF_00001487E_CheapDinner.Solution_0_Test(input);
