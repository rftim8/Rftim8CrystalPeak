...
{
    [TestClass]
    public sealed class CF_00001290A_MindControl_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001290A_MindControl));
        ...
        {
            bool result = CF_00001290A_MindControl.Solution_0_Test(input);
