...
{
    [TestClass]
    public sealed class CF_00001625B_ElementaryParticles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001625B_ElementaryParticles));
        ...
        {
            bool result = CF_00001625B_ElementaryParticles.Solution_0_Test(input);
