...
{
    [TestClass]
    public sealed class CF_00000665C_SimpleStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000665C_SimpleStrings));
        ...
        {
            bool result = CF_00000665C_SimpleStrings.Solution_0_Test(input);
