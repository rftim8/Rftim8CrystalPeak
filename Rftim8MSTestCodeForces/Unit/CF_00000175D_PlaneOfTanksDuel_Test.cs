...
{
    [TestClass]
    public sealed class CF_00000175D_PlaneOfTanksDuel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000175D_PlaneOfTanksDuel));
        ...
        {
            bool result = CF_00000175D_PlaneOfTanksDuel.Solution_0_Test(input);
