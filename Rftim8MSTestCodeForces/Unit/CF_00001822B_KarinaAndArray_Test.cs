...
{
    [TestClass]
    public sealed class CF_00001822B_KarinaAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001822B_KarinaAndArray));
        ...
        {
            bool result = CF_00001822B_KarinaAndArray.Solution_0_Test(input);
