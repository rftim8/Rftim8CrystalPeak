...
{
    [TestClass]
    public sealed class CF_00000431A_BlackSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000431A_BlackSquare));
        ...
        {
            bool result = CF_00000431A_BlackSquare.Solution_0_Test(input);
