...
{
    [TestClass]
    public sealed class CF_00000504D_MishaAndXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000504D_MishaAndXOR));
        ...
        {
            bool result = CF_00000504D_MishaAndXOR.Solution_0_Test(input);
