...
{
    [TestClass]
    public sealed class CF_00000775A_UniversitySchedule_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000775A_UniversitySchedule));
        ...
        {
            bool result = CF_00000775A_UniversitySchedule.Solution_0_Test(input);
