...
{
    [TestClass]
    public sealed class CF_00000500G_NewYearRunning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000500G_NewYearRunning));
        ...
        {
            bool result = CF_00000500G_NewYearRunning.Solution_0_Test(input);
