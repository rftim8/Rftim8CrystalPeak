...
{
    [TestClass]
    public sealed class CF_00001267I_IntriguingSelection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001267I_IntriguingSelection));
        ...
        {
            bool result = CF_00001267I_IntriguingSelection.Solution_0_Test(input);
