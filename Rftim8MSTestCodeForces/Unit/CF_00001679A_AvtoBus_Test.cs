...
{
    [TestClass]
    public sealed class CF_00001679A_AvtoBus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001679A_AvtoBus));
        ...
        {
            bool result = CF_00001679A_AvtoBus.Solution_0_Test(input);
