...
{
    [TestClass]
    public sealed class CF_00001979A_GuessTheMaximum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001979A_GuessTheMaximum));
        ...
        {
            bool result = CF_00001979A_GuessTheMaximum.Solution_0_Test(input);
