...
{
    [TestClass]
    public sealed class CF_00001242C_SumBalance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001242C_SumBalance));
        ...
        {
            bool result = CF_00001242C_SumBalance.Solution_0_Test(input);
