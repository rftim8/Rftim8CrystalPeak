...
{
    [TestClass]
    public sealed class CF_00000467E_AlexAndComplicatedTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000467E_AlexAndComplicatedTask));
        ...
        {
            bool result = CF_00000467E_AlexAndComplicatedTask.Solution_0_Test(input);
