...
{
    [TestClass]
    public sealed class CF_00000801A_ViciousKeyboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000801A_ViciousKeyboard));
        ...
        {
            bool result = CF_00000801A_ViciousKeyboard.Solution_0_Test(input);
