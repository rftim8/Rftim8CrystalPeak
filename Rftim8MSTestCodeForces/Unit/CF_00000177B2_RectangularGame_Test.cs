...
{
    [TestClass]
    public sealed class CF_00000177B2_RectangularGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000177B2_RectangularGame));
        ...
        {
            bool result = CF_00000177B2_RectangularGame.Solution_0_Test(input);
