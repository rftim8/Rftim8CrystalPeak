...
{
    [TestClass]
    public sealed class CF_00001882B_SetsAndUnion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001882B_SetsAndUnion));
        ...
        {
            bool result = CF_00001882B_SetsAndUnion.Solution_0_Test(input);
