...
{
    [TestClass]
    public sealed class CF_00000858D_PolycarpsPhoneBook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000858D_PolycarpsPhoneBook));
        ...
        {
            bool result = CF_00000858D_PolycarpsPhoneBook.Solution_0_Test(input);
