...
{
    [TestClass]
    public sealed class CF_00001528F_AmShZFarm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001528F_AmShZFarm));
        ...
        {
            bool result = CF_00001528F_AmShZFarm.Solution_0_Test(input);
