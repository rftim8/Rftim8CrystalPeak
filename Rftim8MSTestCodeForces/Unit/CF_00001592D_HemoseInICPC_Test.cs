...
{
    [TestClass]
    public sealed class CF_00001592D_HemoseInICPC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001592D_HemoseInICPC));
        ...
        {
            bool result = CF_00001592D_HemoseInICPC.Solution_0_Test(input);
