...
{
    [TestClass]
    public sealed class CF_00000331A1_OhSweetBeaverette_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000331A1_OhSweetBeaverette));
        ...
        {
            bool result = CF_00000331A1_OhSweetBeaverette.Solution_0_Test(input);
