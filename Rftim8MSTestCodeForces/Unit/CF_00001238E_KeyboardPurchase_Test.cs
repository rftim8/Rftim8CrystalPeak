...
{
    [TestClass]
    public sealed class CF_00001238E_KeyboardPurchase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001238E_KeyboardPurchase));
        ...
        {
            bool result = CF_00001238E_KeyboardPurchase.Solution_0_Test(input);
