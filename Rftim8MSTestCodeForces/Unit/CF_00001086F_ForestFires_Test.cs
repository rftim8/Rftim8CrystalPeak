...
{
    [TestClass]
    public sealed class CF_00001086F_ForestFires_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001086F_ForestFires));
        ...
        {
            bool result = CF_00001086F_ForestFires.Solution_0_Test(input);
