...
{
    [TestClass]
    public sealed class CF_00000652F_AntsOnACircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000652F_AntsOnACircle));
        ...
        {
            bool result = CF_00000652F_AntsOnACircle.Solution_0_Test(input);
