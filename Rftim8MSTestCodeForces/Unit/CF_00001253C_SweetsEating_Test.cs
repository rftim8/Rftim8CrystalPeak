...
{
    [TestClass]
    public sealed class CF_00001253C_SweetsEating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001253C_SweetsEating));
        ...
        {
            bool result = CF_00001253C_SweetsEating.Solution_0_Test(input);
