...
{
    [TestClass]
    public sealed class CF_00001109A_SashaAndABitOfRelax_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001109A_SashaAndABitOfRelax));
        ...
        {
            bool result = CF_00001109A_SashaAndABitOfRelax.Solution_0_Test(input);
