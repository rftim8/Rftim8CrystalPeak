...
{
    [TestClass]
    public sealed class CF_00000198B_JumpingOnWalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000198B_JumpingOnWalls));
        ...
        {
            bool result = CF_00000198B_JumpingOnWalls.Solution_0_Test(input);
