...
{
    [TestClass]
    public sealed class CF_00000189B_CountingRhombi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000189B_CountingRhombi));
        ...
        {
            bool result = CF_00000189B_CountingRhombi.Solution_0_Test(input);
