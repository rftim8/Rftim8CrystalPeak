...
{
    [TestClass]
    public sealed class CF_00000317B_Ants_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000317B_Ants));
        ...
        {
            bool result = CF_00000317B_Ants.Solution_0_Test(input);
