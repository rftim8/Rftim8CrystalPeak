...
{
    [TestClass]
    public sealed class CF_00000150D_MissionImpassable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000150D_MissionImpassable));
        ...
        {
            bool result = CF_00000150D_MissionImpassable.Solution_0_Test(input);
