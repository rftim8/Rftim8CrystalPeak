...
{
    [TestClass]
    public sealed class CF_00000690C1_BrainNetworkEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690C1_BrainNetworkEasy));
        ...
        {
            bool result = CF_00000690C1_BrainNetworkEasy.Solution_0_Test(input);
