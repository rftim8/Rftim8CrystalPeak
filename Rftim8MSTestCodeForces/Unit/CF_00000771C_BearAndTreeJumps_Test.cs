...
{
    [TestClass]
    public sealed class CF_00000771C_BearAndTreeJumps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000771C_BearAndTreeJumps));
        ...
        {
            bool result = CF_00000771C_BearAndTreeJumps.Solution_0_Test(input);
