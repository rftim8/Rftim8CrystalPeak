...
{
    [TestClass]
    public sealed class CF_00001938F_FormingGroups_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001938F_FormingGroups));
        ...
        {
            bool result = CF_00001938F_FormingGroups.Solution_0_Test(input);
