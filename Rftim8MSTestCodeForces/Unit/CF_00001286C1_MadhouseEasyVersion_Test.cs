...
{
    [TestClass]
    public sealed class CF_00001286C1_MadhouseEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001286C1_MadhouseEasyVersion));
        ...
        {
            bool result = CF_00001286C1_MadhouseEasyVersion.Solution_0_Test(input);
