...
{
    [TestClass]
    public sealed class CF_00000042E_BaldmanAndTheMilitary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000042E_BaldmanAndTheMilitary));
        ...
        {
            bool result = CF_00000042E_BaldmanAndTheMilitary.Solution_0_Test(input);
