...
{
    [TestClass]
    public sealed class CF_00001747D_YetAnotherProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001747D_YetAnotherProblem));
        ...
        {
            bool result = CF_00001747D_YetAnotherProblem.Solution_0_Test(input);
