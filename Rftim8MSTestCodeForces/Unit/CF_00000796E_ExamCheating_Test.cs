...
{
    [TestClass]
    public sealed class CF_00000796E_ExamCheating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000796E_ExamCheating));
        ...
        {
            bool result = CF_00000796E_ExamCheating.Solution_0_Test(input);
