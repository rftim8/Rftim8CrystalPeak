...
{
    [TestClass]
    public sealed class CF_00000331C1_TheGreatJulyaCalendar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000331C1_TheGreatJulyaCalendar));
        ...
        {
            bool result = CF_00000331C1_TheGreatJulyaCalendar.Solution_0_Test(input);
