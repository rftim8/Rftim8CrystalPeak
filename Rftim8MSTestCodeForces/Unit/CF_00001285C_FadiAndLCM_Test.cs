...
{
    [TestClass]
    public sealed class CF_00001285C_FadiAndLCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001285C_FadiAndLCM));
        ...
        {
            bool result = CF_00001285C_FadiAndLCM.Solution_0_Test(input);
