...
{
    [TestClass]
    public sealed class CF_00001784E_InfiniteGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001784E_InfiniteGame));
        ...
        {
            bool result = CF_00001784E_InfiniteGame.Solution_0_Test(input);
