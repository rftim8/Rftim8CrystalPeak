...
{
    [TestClass]
    public sealed class CF_00000150C_SmartCheater_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000150C_SmartCheater));
        ...
        {
            bool result = CF_00000150C_SmartCheater.Solution_0_Test(input);
