...
{
    [TestClass]
    public sealed class CF_00000617E_XORAndFavoriteNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000617E_XORAndFavoriteNumber));
        ...
        {
            bool result = CF_00000617E_XORAndFavoriteNumber.Solution_0_Test(input);
