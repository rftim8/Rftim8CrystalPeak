...
{
    [TestClass]
    public sealed class CF_00001178B_WOWFactor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001178B_WOWFactor));
        ...
        {
            bool result = CF_00001178B_WOWFactor.Solution_0_Test(input);
