...
{
    [TestClass]
    public sealed class CF_00000004C_RegistrationSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000004C_RegistrationSystem));
        ...
        {
            bool result = CF_00000004C_RegistrationSystem.Solution_0_Test(input);
