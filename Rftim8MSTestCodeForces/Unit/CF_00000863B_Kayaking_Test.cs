...
{
    [TestClass]
    public sealed class CF_00000863B_Kayaking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000863B_Kayaking));
        ...
        {
            bool result = CF_00000863B_Kayaking.Solution_0_Test(input);
