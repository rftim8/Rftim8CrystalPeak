...
{
    [TestClass]
    public sealed class CF_00001227G_NotSame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001227G_NotSame));
        ...
        {
            bool result = CF_00001227G_NotSame.Solution_0_Test(input);
