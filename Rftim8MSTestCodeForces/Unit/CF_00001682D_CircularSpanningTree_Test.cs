...
{
    [TestClass]
    public sealed class CF_00001682D_CircularSpanningTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001682D_CircularSpanningTree));
        ...
        {
            bool result = CF_00001682D_CircularSpanningTree.Solution_0_Test(input);
