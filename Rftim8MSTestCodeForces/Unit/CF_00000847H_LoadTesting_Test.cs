...
{
    [TestClass]
    public sealed class CF_00000847H_LoadTesting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847H_LoadTesting));
        ...
        {
            bool result = CF_00000847H_LoadTesting.Solution_0_Test(input);
