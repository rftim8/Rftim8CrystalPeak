...
{
    [TestClass]
    public sealed class CF_00000766C_MahmoudAndAMessage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000766C_MahmoudAndAMessage));
        ...
        {
            bool result = CF_00000766C_MahmoudAndAMessage.Solution_0_Test(input);
