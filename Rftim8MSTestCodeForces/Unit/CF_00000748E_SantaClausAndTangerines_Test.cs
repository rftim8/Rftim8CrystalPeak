...
{
    [TestClass]
    public sealed class CF_00000748E_SantaClausAndTangerines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000748E_SantaClausAndTangerines));
        ...
        {
            bool result = CF_00000748E_SantaClausAndTangerines.Solution_0_Test(input);
