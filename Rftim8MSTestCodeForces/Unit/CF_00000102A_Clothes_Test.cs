...
{
    [TestClass]
    public sealed class CF_00000102A_Clothes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000102A_Clothes));
        ...
        {
            bool result = CF_00000102A_Clothes.Solution_0_Test(input);
