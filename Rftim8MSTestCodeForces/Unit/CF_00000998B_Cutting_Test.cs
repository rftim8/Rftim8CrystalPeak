...
{
    [TestClass]
    public sealed class CF_00000998B_Cutting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000998B_Cutting));
        ...
        {
            bool result = CF_00000998B_Cutting.Solution_0_Test(input);
