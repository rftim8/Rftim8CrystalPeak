...
{
    [TestClass]
    public sealed class CF_00001257A_TwoRivalStudents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001257A_TwoRivalStudents));
        ...
        {
            bool result = CF_00001257A_TwoRivalStudents.Solution_0_Test(input);
