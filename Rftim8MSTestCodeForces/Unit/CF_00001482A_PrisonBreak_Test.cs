...
{
    [TestClass]
    public sealed class CF_00001482A_PrisonBreak_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001482A_PrisonBreak));
        ...
        {
            bool result = CF_00001482A_PrisonBreak.Solution_0_Test(input);
