...
{
    [TestClass]
    public sealed class CF_00001658A_MarinAndPhotoshoot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001658A_MarinAndPhotoshoot));
        ...
        {
            bool result = CF_00001658A_MarinAndPhotoshoot.Solution_0_Test(input);
