...
{
    [TestClass]
    public sealed class CF_00001696B_NITDestroysTheUniverse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001696B_NITDestroysTheUniverse));
        ...
        {
            bool result = CF_00001696B_NITDestroysTheUniverse.Solution_0_Test(input);
