...
{
    [TestClass]
    public sealed class CF_00001567C_CarryingConundrum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001567C_CarryingConundrum));
        ...
        {
            bool result = CF_00001567C_CarryingConundrum.Solution_0_Test(input);
