...
{
    [TestClass]
    public sealed class CF_00000631C_Report_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000631C_Report));
        ...
        {
            bool result = CF_00000631C_Report.Solution_0_Test(input);
