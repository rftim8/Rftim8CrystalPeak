...
{
    [TestClass]
    public sealed class CF_00001672E_Notepadexe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001672E_Notepadexe));
        ...
        {
            bool result = CF_00001672E_Notepadexe.Solution_0_Test(input);
