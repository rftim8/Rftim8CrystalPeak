...
{
    [TestClass]
    public sealed class CF_00002041A_TheBentoBoxAdventure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002041A_TheBentoBoxAdventure));
        ...
        {
            bool result = CF_00002041A_TheBentoBoxAdventure.Solution_0_Test(input);
