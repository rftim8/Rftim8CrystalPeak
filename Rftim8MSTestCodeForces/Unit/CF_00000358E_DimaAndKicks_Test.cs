...
{
    [TestClass]
    public sealed class CF_00000358E_DimaAndKicks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000358E_DimaAndKicks));
        ...
        {
            bool result = CF_00000358E_DimaAndKicks.Solution_0_Test(input);
