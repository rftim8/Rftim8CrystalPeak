...
{
    [TestClass]
    public sealed class CF_00000683C_SymmetricDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000683C_SymmetricDifference));
        ...
        {
            bool result = CF_00000683C_SymmetricDifference.Solution_0_Test(input);
