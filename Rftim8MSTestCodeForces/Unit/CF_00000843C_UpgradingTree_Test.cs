...
{
    [TestClass]
    public sealed class CF_00000843C_UpgradingTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000843C_UpgradingTree));
        ...
        {
            bool result = CF_00000843C_UpgradingTree.Solution_0_Test(input);
