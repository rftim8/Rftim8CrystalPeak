...
{
    [TestClass]
    public sealed class CF_00001403C_ChessRush_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001403C_ChessRush));
        ...
        {
            bool result = CF_00001403C_ChessRush.Solution_0_Test(input);
