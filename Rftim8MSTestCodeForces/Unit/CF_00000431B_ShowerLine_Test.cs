...
{
    [TestClass]
    public sealed class CF_00000431B_ShowerLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000431B_ShowerLine));
        ...
        {
            bool result = CF_00000431B_ShowerLine.Solution_0_Test(input);
