...
{
    [TestClass]
    public sealed class CF_00001707A_DoremysIQ_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001707A_DoremysIQ));
        ...
        {
            bool result = CF_00001707A_DoremysIQ.Solution_0_Test(input);
