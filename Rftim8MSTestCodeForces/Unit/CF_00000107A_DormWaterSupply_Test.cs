...
{
    [TestClass]
    public sealed class CF_00000107A_DormWaterSupply_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000107A_DormWaterSupply));
        ...
        {
            bool result = CF_00000107A_DormWaterSupply.Solution_0_Test(input);
