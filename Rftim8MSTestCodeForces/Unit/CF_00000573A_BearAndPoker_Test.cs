...
{
    [TestClass]
    public sealed class CF_00000573A_BearAndPoker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000573A_BearAndPoker));
        ...
        {
            bool result = CF_00000573A_BearAndPoker.Solution_0_Test(input);
