...
{
    [TestClass]
    public sealed class CF_00000373A_CollectingBeatsIsFun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000373A_CollectingBeatsIsFun));
        ...
        {
            bool result = CF_00000373A_CollectingBeatsIsFun.Solution_0_Test(input);
