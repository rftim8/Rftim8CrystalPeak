...
{
    [TestClass]
    public sealed class CF_00000266A_StonesOnTheTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000266A_StonesOnTheTable));
        ...
        {
            bool result = CF_00000266A_StonesOnTheTable.Solution_0_Test(input);
