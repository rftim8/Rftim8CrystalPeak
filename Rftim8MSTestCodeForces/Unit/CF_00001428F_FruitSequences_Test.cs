...
{
    [TestClass]
    public sealed class CF_00001428F_FruitSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001428F_FruitSequences));
        ...
        {
            bool result = CF_00001428F_FruitSequences.Solution_0_Test(input);
