...
{
    [TestClass]
    public sealed class CF_00001320B_NavigationSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001320B_NavigationSystem));
        ...
        {
            bool result = CF_00001320B_NavigationSystem.Solution_0_Test(input);
