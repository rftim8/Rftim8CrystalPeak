...
{
    [TestClass]
    public sealed class CF_00000875F_RoyalQuestions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000875F_RoyalQuestions));
        ...
        {
            bool result = CF_00000875F_RoyalQuestions.Solution_0_Test(input);
