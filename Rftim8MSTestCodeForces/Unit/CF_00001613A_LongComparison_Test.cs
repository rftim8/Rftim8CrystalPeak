...
{
    [TestClass]
    public sealed class CF_00001613A_LongComparison_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001613A_LongComparison));
        ...
        {
            bool result = CF_00001613A_LongComparison.Solution_0_Test(input);
