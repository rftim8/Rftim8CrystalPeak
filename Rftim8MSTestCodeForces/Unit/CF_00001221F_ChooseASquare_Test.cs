...
{
    [TestClass]
    public sealed class CF_00001221F_ChooseASquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001221F_ChooseASquare));
        ...
        {
            bool result = CF_00001221F_ChooseASquare.Solution_0_Test(input);
