...
{
    [TestClass]
    public sealed class CF_00002002F1_CourtBlueEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002002F1_CourtBlueEasyVersion));
        ...
        {
            bool result = CF_00002002F1_CourtBlueEasyVersion.Solution_0_Test(input);
