...
{
    [TestClass]
    public sealed class CF_00000103E_BuyingSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000103E_BuyingSets));
        ...
        {
            bool result = CF_00000103E_BuyingSets.Solution_0_Test(input);
