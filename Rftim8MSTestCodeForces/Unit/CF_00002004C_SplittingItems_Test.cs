...
{
    [TestClass]
    public sealed class CF_00002004C_SplittingItems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002004C_SplittingItems));
        ...
        {
            bool result = CF_00002004C_SplittingItems.Solution_0_Test(input);
