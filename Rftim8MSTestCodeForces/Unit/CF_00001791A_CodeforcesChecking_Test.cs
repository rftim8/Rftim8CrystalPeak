...
{
    [TestClass]
    public sealed class CF_00001791A_CodeforcesChecking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001791A_CodeforcesChecking));
        ...
        {
            bool result = CF_00001791A_CodeforcesChecking.Solution_0_Test(input);
