...
{
    [TestClass]
    public sealed class CF_00001644C_IncreaseSubarraySums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001644C_IncreaseSubarraySums));
        ...
        {
            bool result = CF_00001644C_IncreaseSubarraySums.Solution_0_Test(input);
