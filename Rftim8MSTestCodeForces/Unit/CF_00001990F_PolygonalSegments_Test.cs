...
{
    [TestClass]
    public sealed class CF_00001990F_PolygonalSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001990F_PolygonalSegments));
        ...
        {
            bool result = CF_00001990F_PolygonalSegments.Solution_0_Test(input);
