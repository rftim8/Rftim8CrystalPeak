...
{
    [TestClass]
    public sealed class CF_00001938L_XOROperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001938L_XOROperations));
        ...
        {
            bool result = CF_00001938L_XOROperations.Solution_0_Test(input);
