...
{
    [TestClass]
    public sealed class CF_00000983B_XORpyramid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000983B_XORpyramid));
        ...
        {
            bool result = CF_00000983B_XORpyramid.Solution_0_Test(input);
