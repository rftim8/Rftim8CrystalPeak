...
{
    [TestClass]
    public sealed class CF_00000366D_DimaAndTrapGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000366D_DimaAndTrapGraph));
        ...
        {
            bool result = CF_00000366D_DimaAndTrapGraph.Solution_0_Test(input);
