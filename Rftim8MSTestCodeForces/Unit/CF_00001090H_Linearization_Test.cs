...
{
    [TestClass]
    public sealed class CF_00001090H_Linearization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090H_Linearization));
        ...
        {
            bool result = CF_00001090H_Linearization.Solution_0_Test(input);
