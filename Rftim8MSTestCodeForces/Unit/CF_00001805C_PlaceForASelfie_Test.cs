...
{
    [TestClass]
    public sealed class CF_00001805C_PlaceForASelfie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001805C_PlaceForASelfie));
        ...
        {
            bool result = CF_00001805C_PlaceForASelfie.Solution_0_Test(input);
