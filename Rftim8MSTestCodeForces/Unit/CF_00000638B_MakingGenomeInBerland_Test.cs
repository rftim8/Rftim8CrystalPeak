...
{
    [TestClass]
    public sealed class CF_00000638B_MakingGenomeInBerland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000638B_MakingGenomeInBerland));
        ...
        {
            bool result = CF_00000638B_MakingGenomeInBerland.Solution_0_Test(input);
