...
{
    [TestClass]
    public sealed class CF_00001806C_SequenceMaster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001806C_SequenceMaster));
        ...
        {
            bool result = CF_00001806C_SequenceMaster.Solution_0_Test(input);
