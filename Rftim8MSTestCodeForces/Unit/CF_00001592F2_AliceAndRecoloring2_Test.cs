...
{
    [TestClass]
    public sealed class CF_00001592F2_AliceAndRecoloring2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001592F2_AliceAndRecoloring2));
        ...
        {
            bool result = CF_00001592F2_AliceAndRecoloring2.Solution_0_Test(input);
