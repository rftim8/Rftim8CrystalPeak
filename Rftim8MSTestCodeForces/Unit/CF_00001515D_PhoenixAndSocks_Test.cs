...
{
    [TestClass]
    public sealed class CF_00001515D_PhoenixAndSocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001515D_PhoenixAndSocks));
        ...
        {
            bool result = CF_00001515D_PhoenixAndSocks.Solution_0_Test(input);
