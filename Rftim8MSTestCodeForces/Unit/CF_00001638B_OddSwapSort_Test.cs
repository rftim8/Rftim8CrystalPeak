...
{
    [TestClass]
    public sealed class CF_00001638B_OddSwapSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001638B_OddSwapSort));
        ...
        {
            bool result = CF_00001638B_OddSwapSort.Solution_0_Test(input);
