...
{
    [TestClass]
    public sealed class CF_00000949A_Zebras_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000949A_Zebras));
        ...
        {
            bool result = CF_00000949A_Zebras.Solution_0_Test(input);
