...
{
    [TestClass]
    public sealed class CF_00001517H_FlyAroundTheWorld_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001517H_FlyAroundTheWorld));
        ...
        {
            bool result = CF_00001517H_FlyAroundTheWorld.Solution_0_Test(input);
