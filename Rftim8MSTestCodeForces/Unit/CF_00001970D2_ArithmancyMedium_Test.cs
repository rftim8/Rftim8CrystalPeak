...
{
    [TestClass]
    public sealed class CF_00001970D2_ArithmancyMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970D2_ArithmancyMedium));
        ...
        {
            bool result = CF_00001970D2_ArithmancyMedium.Solution_0_Test(input);
