...
{
    [TestClass]
    public sealed class CF_00001408D_Searchlights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001408D_Searchlights));
        ...
        {
            bool result = CF_00001408D_Searchlights.Solution_0_Test(input);
