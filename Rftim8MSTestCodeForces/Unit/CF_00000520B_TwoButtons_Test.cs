...
{
    [TestClass]
    public sealed class CF_00000520B_TwoButtons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000520B_TwoButtons));
        ...
        {
            bool result = CF_00000520B_TwoButtons.Solution_0_Test(input);
