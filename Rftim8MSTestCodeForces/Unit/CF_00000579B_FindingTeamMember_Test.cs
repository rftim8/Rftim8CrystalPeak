...
{
    [TestClass]
    public sealed class CF_00000579B_FindingTeamMember_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000579B_FindingTeamMember));
        ...
        {
            bool result = CF_00000579B_FindingTeamMember.Solution_0_Test(input);
