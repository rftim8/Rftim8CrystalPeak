...
{
    [TestClass]
    public sealed class CF_00000708E_StudentsCamp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000708E_StudentsCamp));
        ...
        {
            bool result = CF_00000708E_StudentsCamp.Solution_0_Test(input);
