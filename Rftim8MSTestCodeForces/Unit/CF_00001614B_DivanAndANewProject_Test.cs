...
{
    [TestClass]
    public sealed class CF_00001614B_DivanAndANewProject_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001614B_DivanAndANewProject));
        ...
        {
            bool result = CF_00001614B_DivanAndANewProject.Solution_0_Test(input);
