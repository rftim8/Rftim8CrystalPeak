...
{
    [TestClass]
    public sealed class CF_00001769B2_CopyingFilesII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001769B2_CopyingFilesII));
        ...
        {
            bool result = CF_00001769B2_CopyingFilesII.Solution_0_Test(input);
