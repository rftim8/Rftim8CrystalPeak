...
{
    [TestClass]
    public sealed class CF_00000962G_VisibleBlackAreas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000962G_VisibleBlackAreas));
        ...
        {
            bool result = CF_00000962G_VisibleBlackAreas.Solution_0_Test(input);
