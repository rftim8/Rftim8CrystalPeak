...
{
    [TestClass]
    public sealed class CF_00000865B_OrderingPizza_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000865B_OrderingPizza));
        ...
        {
            bool result = CF_00000865B_OrderingPizza.Solution_0_Test(input);
