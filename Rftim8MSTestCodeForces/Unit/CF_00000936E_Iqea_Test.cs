...
{
    [TestClass]
    public sealed class CF_00000936E_Iqea_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000936E_Iqea));
        ...
        {
            bool result = CF_00000936E_Iqea.Solution_0_Test(input);
