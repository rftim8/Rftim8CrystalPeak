...
{
    [TestClass]
    public sealed class CF_00001082A_VasyaAndBook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001082A_VasyaAndBook));
        ...
        {
            bool result = CF_00001082A_VasyaAndBook.Solution_0_Test(input);
