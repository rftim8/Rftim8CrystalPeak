...
{
    [TestClass]
    public sealed class CF_00001625D_BinarySpiders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001625D_BinarySpiders));
        ...
        {
            bool result = CF_00001625D_BinarySpiders.Solution_0_Test(input);
