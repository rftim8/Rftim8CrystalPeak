...
{
    [TestClass]
    public sealed class CF_00000311E_Biologist_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000311E_Biologist));
        ...
        {
            bool result = CF_00000311E_Biologist.Solution_0_Test(input);
