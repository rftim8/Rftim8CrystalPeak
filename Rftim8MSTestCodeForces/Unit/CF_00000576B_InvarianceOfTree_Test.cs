...
{
    [TestClass]
    public sealed class CF_00000576B_InvarianceOfTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000576B_InvarianceOfTree));
        ...
        {
            bool result = CF_00000576B_InvarianceOfTree.Solution_0_Test(input);
