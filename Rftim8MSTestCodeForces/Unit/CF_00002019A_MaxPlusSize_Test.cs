...
{
    [TestClass]
    public sealed class CF_00002019A_MaxPlusSize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002019A_MaxPlusSize));
        ...
        {
            bool result = CF_00002019A_MaxPlusSize.Solution_0_Test(input);
