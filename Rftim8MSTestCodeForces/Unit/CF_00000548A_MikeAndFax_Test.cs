...
{
    [TestClass]
    public sealed class CF_00000548A_MikeAndFax_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000548A_MikeAndFax));
        ...
        {
            bool result = CF_00000548A_MikeAndFax.Solution_0_Test(input);
