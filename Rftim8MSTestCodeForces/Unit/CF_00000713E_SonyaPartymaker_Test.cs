...
{
    [TestClass]
    public sealed class CF_00000713E_SonyaPartymaker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000713E_SonyaPartymaker));
        ...
        {
            bool result = CF_00000713E_SonyaPartymaker.Solution_0_Test(input);
