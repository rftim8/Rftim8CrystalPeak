...
{
    [TestClass]
    public sealed class CF_00001345A_PuzzlePieces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001345A_PuzzlePieces));
        ...
        {
            bool result = CF_00001345A_PuzzlePieces.Solution_0_Test(input);
