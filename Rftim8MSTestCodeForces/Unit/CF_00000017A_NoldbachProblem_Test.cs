...
{
    [TestClass]
    public sealed class CF_00000017A_NoldbachProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000017A_NoldbachProblem));
        ...
        {
            bool result = CF_00000017A_NoldbachProblem.Solution_0_Test(input);
