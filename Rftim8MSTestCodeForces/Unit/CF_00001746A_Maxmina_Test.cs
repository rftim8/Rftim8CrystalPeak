...
{
    [TestClass]
    public sealed class CF_00001746A_Maxmina_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001746A_Maxmina));
        ...
        {
            bool result = CF_00001746A_Maxmina.Solution_0_Test(input);
