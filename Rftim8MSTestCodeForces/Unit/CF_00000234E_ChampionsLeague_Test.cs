...
{
    [TestClass]
    public sealed class CF_00000234E_ChampionsLeague_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000234E_ChampionsLeague));
        ...
        {
            bool result = CF_00000234E_ChampionsLeague.Solution_0_Test(input);
