...
{
    [TestClass]
    public sealed class CF_00001218I_TheLightSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001218I_TheLightSquare));
        ...
        {
            bool result = CF_00001218I_TheLightSquare.Solution_0_Test(input);
