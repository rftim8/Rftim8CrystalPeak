...
{
    [TestClass]
    public sealed class CF_00000107D_CrimeManagement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000107D_CrimeManagement));
        ...
        {
            bool result = CF_00000107D_CrimeManagement.Solution_0_Test(input);
