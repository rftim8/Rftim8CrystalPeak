...
{
    [TestClass]
    public sealed class CF_00001938I_SymmetricBoundary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001938I_SymmetricBoundary));
        ...
        {
            bool result = CF_00001938I_SymmetricBoundary.Solution_0_Test(input);
