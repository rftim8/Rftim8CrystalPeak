...
{
    [TestClass]
    public sealed class CF_00000981D_Bookshelves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000981D_Bookshelves));
        ...
        {
            bool result = CF_00000981D_Bookshelves.Solution_0_Test(input);
