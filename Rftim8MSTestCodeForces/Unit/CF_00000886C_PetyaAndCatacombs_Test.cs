...
{
    [TestClass]
    public sealed class CF_00000886C_PetyaAndCatacombs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000886C_PetyaAndCatacombs));
        ...
        {
            bool result = CF_00000886C_PetyaAndCatacombs.Solution_0_Test(input);
