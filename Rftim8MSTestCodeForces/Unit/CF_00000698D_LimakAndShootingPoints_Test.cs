...
{
    [TestClass]
    public sealed class CF_00000698D_LimakAndShootingPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000698D_LimakAndShootingPoints));
        ...
        {
            bool result = CF_00000698D_LimakAndShootingPoints.Solution_0_Test(input);
