...
{
    [TestClass]
    public sealed class CF_00000992C_NastyaAndAWardrobe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000992C_NastyaAndAWardrobe));
        ...
        {
            bool result = CF_00000992C_NastyaAndAWardrobe.Solution_0_Test(input);
