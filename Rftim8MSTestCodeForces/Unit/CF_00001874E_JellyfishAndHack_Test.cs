...
{
    [TestClass]
    public sealed class CF_00001874E_JellyfishAndHack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001874E_JellyfishAndHack));
        ...
        {
            bool result = CF_00001874E_JellyfishAndHack.Solution_0_Test(input);
