...
{
    [TestClass]
    public sealed class CF_00001868C_TravelPlan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001868C_TravelPlan));
        ...
        {
            bool result = CF_00001868C_TravelPlan.Solution_0_Test(input);
