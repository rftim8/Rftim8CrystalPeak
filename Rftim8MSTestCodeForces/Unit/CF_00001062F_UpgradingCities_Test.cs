...
{
    [TestClass]
    public sealed class CF_00001062F_UpgradingCities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001062F_UpgradingCities));
        ...
        {
            bool result = CF_00001062F_UpgradingCities.Solution_0_Test(input);
