...
{
    [TestClass]
    public sealed class CF_00000345D_ChainLetter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000345D_ChainLetter));
        ...
        {
            bool result = CF_00000345D_ChainLetter.Solution_0_Test(input);
