...
{
    [TestClass]
    public sealed class CF_00001350B_OracAndModels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001350B_OracAndModels));
        ...
        {
            bool result = CF_00001350B_OracAndModels.Solution_0_Test(input);
