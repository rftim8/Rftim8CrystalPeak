...
{
    [TestClass]
    public sealed class CF_00000080A_PanoramixsPrediction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000080A_PanoramixsPrediction));
        ...
        {
            bool result = CF_00000080A_PanoramixsPrediction.Solution_0_Test(input);
