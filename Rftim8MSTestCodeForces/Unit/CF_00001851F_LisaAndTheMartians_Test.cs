...
{
    [TestClass]
    public sealed class CF_00001851F_LisaAndTheMartians_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001851F_LisaAndTheMartians));
        ...
        {
            bool result = CF_00001851F_LisaAndTheMartians.Solution_0_Test(input);
