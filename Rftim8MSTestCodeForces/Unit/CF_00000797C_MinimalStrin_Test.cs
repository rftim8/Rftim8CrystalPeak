...
{
    [TestClass]
    public sealed class CF_00000797C_MinimalStrin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000797C_MinimalStrin));
        ...
        {
            bool result = CF_00000797C_MinimalStrin.Solution_0_Test(input);
