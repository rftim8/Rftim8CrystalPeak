...
{
    [TestClass]
    public sealed class CF_00000230B_Tprimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000230B_Tprimes));
        ...
        {
            bool result = CF_00000230B_Tprimes.Solution_0_Test(input);
