...
{
    [TestClass]
    public sealed class CF_00001644D_CrossColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001644D_CrossColoring));
        ...
        {
            bool result = CF_00001644D_CrossColoring.Solution_0_Test(input);
