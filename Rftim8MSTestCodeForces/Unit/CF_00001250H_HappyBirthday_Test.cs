...
{
    [TestClass]
    public sealed class CF_00001250H_HappyBirthday_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250H_HappyBirthday));
        ...
        {
            bool result = CF_00001250H_HappyBirthday.Solution_0_Test(input);
