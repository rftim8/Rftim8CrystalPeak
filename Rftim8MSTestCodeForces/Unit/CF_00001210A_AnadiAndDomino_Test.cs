...
{
    [TestClass]
    public sealed class CF_00001210A_AnadiAndDomino_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001210A_AnadiAndDomino));
        ...
        {
            bool result = CF_00001210A_AnadiAndDomino.Solution_0_Test(input);
