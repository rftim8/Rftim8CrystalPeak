...
{
    [TestClass]
    public sealed class CF_00000717D_DexterinasLab_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000717D_DexterinasLab));
        ...
        {
            bool result = CF_00000717D_DexterinasLab.Solution_0_Test(input);
