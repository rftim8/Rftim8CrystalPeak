...
{
    [TestClass]
    public sealed class CF_00001876E_BallStackable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001876E_BallStackable));
        ...
        {
            bool result = CF_00001876E_BallStackable.Solution_0_Test(input);
