...
{
    [TestClass]
    public sealed class CF_00000679D_BearAndChase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000679D_BearAndChase));
        ...
        {
            bool result = CF_00000679D_BearAndChase.Solution_0_Test(input);
