...
{
    [TestClass]
    public sealed class CF_00000584B_KolyaAndTanya_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000584B_KolyaAndTanya));
        ...
        {
            bool result = CF_00000584B_KolyaAndTanya.Solution_0_Test(input);
