...
{
    [TestClass]
    public sealed class CF_00001762B_MakeArrayGood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001762B_MakeArrayGood));
        ...
        {
            bool result = CF_00001762B_MakeArrayGood.Solution_0_Test(input);
