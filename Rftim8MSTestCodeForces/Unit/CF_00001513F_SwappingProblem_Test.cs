...
{
    [TestClass]
    public sealed class CF_00001513F_SwappingProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001513F_SwappingProblem));
        ...
        {
            bool result = CF_00001513F_SwappingProblem.Solution_0_Test(input);
