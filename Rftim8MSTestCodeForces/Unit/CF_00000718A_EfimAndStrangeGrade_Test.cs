...
{
    [TestClass]
    public sealed class CF_00000718A_EfimAndStrangeGrade_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000718A_EfimAndStrangeGrade));
        ...
        {
            bool result = CF_00000718A_EfimAndStrangeGrade.Solution_0_Test(input);
