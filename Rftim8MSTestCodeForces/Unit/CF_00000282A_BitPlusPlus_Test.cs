...
{
    [TestClass]
    public sealed class CF_00000282A_BitPlusPlus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000282A_BitPlusPlus));
        ...
        {
            bool result = CF_00000282A_BitPlusPlus.Solution_0_Test(input);
