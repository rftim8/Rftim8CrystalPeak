...
{
    [TestClass]
    public sealed class CF_00000873F_ForbiddenIndices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000873F_ForbiddenIndices));
        ...
        {
            bool result = CF_00000873F_ForbiddenIndices.Solution_0_Test(input);
