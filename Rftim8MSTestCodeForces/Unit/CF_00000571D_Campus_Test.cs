...
{
    [TestClass]
    public sealed class CF_00000571D_Campus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000571D_Campus));
        ...
        {
            bool result = CF_00000571D_Campus.Solution_0_Test(input);
