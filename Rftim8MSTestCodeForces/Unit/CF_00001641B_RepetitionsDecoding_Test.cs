...
{
    [TestClass]
    public sealed class CF_00001641B_RepetitionsDecoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001641B_RepetitionsDecoding));
        ...
        {
            bool result = CF_00001641B_RepetitionsDecoding.Solution_0_Test(input);
