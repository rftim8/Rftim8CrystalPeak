...
{
    [TestClass]
    public sealed class CF_00000060D_Savior_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000060D_Savior));
        ...
        {
            bool result = CF_00000060D_Savior.Solution_0_Test(input);
