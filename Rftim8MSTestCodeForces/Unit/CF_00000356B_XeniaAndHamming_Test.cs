...
{
    [TestClass]
    public sealed class CF_00000356B_XeniaAndHamming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000356B_XeniaAndHamming));
        ...
        {
            bool result = CF_00000356B_XeniaAndHamming.Solution_0_Test(input);
