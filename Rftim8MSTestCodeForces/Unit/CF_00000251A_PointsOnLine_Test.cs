...
{
    [TestClass]
    public sealed class CF_00000251A_PointsOnLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000251A_PointsOnLine));
        ...
        {
            bool result = CF_00000251A_PointsOnLine.Solution_0_Test(input);
