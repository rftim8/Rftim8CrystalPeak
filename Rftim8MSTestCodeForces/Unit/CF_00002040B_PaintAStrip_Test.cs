...
{
    [TestClass]
    public sealed class CF_00002040B_PaintAStrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002040B_PaintAStrip));
        ...
        {
            bool result = CF_00002040B_PaintAStrip.Solution_0_Test(input);
