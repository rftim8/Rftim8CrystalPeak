...
{
    [TestClass]
    public sealed class CF_00000438D_TheChildAndSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000438D_TheChildAndSequence));
        ...
        {
            bool result = CF_00000438D_TheChildAndSequence.Solution_0_Test(input);
