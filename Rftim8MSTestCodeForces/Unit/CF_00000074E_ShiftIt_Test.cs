...
{
    [TestClass]
    public sealed class CF_00000074E_ShiftIt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000074E_ShiftIt));
        ...
        {
            bool result = CF_00000074E_ShiftIt.Solution_0_Test(input);
