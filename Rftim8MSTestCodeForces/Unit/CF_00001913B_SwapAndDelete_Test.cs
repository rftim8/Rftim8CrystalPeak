...
{
    [TestClass]
    public sealed class CF_00001913B_SwapAndDelete_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001913B_SwapAndDelete));
        ...
        {
            bool result = CF_00001913B_SwapAndDelete.Solution_0_Test(input);
