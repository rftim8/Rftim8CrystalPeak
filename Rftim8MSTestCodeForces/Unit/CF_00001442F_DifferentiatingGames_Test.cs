...
{
    [TestClass]
    public sealed class CF_00001442F_DifferentiatingGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001442F_DifferentiatingGames));
        ...
        {
            bool result = CF_00001442F_DifferentiatingGames.Solution_0_Test(input);
