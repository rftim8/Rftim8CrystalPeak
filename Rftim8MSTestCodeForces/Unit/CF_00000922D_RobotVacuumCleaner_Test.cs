...
{
    [TestClass]
    public sealed class CF_00000922D_RobotVacuumCleaner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000922D_RobotVacuumCleaner));
        ...
        {
            bool result = CF_00000922D_RobotVacuumCleaner.Solution_0_Test(input);
