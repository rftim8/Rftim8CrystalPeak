...
{
    [TestClass]
    public sealed class CF_00000245F_LogStreamAnalysis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000245F_LogStreamAnalysis));
        ...
        {
            bool result = CF_00000245F_LogStreamAnalysis.Solution_0_Test(input);
