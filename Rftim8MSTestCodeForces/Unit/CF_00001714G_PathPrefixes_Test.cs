...
{
    [TestClass]
    public sealed class CF_00001714G_PathPrefixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001714G_PathPrefixes));
        ...
        {
            bool result = CF_00001714G_PathPrefixes.Solution_0_Test(input);
