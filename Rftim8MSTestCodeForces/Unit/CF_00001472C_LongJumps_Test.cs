...
{
    [TestClass]
    public sealed class CF_00001472C_LongJumps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001472C_LongJumps));
        ...
        {
            bool result = CF_00001472C_LongJumps.Solution_0_Test(input);
