...
{
    [TestClass]
    public sealed class CF_00000291B_CommandLineArguments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000291B_CommandLineArguments));
        ...
        {
            bool result = CF_00000291B_CommandLineArguments.Solution_0_Test(input);
