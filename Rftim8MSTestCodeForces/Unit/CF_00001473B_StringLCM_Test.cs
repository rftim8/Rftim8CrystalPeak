...
{
    [TestClass]
    public sealed class CF_00001473B_StringLCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001473B_StringLCM));
        ...
        {
            bool result = CF_00001473B_StringLCM.Solution_0_Test(input);
