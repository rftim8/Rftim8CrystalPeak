...
{
    [TestClass]
    public sealed class CF_00001654H_ThreeMinimums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001654H_ThreeMinimums));
        ...
        {
            bool result = CF_00001654H_ThreeMinimums.Solution_0_Test(input);
