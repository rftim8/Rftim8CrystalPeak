...
{
    [TestClass]
    public sealed class CF_00001582C_GrandmaCapaKnitsAScarf_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001582C_GrandmaCapaKnitsAScarf));
        ...
        {
            bool result = CF_00001582C_GrandmaCapaKnitsAScarf.Solution_0_Test(input);
