...
{
    [TestClass]
    public sealed class CF_00000703E_MishkaAndDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000703E_MishkaAndDivisors));
        ...
        {
            bool result = CF_00000703E_MishkaAndDivisors.Solution_0_Test(input);
