...
{
    [TestClass]
    public sealed class CF_00000678D_IteratedLinearFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000678D_IteratedLinearFunction));
        ...
        {
            bool result = CF_00000678D_IteratedLinearFunction.Solution_0_Test(input);
