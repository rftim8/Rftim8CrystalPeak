...
{
    [TestClass]
    public sealed class CF_00000286B_Shifting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000286B_Shifting));
        ...
        {
            bool result = CF_00000286B_Shifting.Solution_0_Test(input);
