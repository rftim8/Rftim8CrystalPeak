...
{
    [TestClass]
    public sealed class CF_00001430G_YetAnotherDAGProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001430G_YetAnotherDAGProblem));
        ...
        {
            bool result = CF_00001430G_YetAnotherDAGProblem.Solution_0_Test(input);
