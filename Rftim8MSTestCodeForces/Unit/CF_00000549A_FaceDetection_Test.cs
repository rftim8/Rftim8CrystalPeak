...
{
    [TestClass]
    public sealed class CF_00000549A_FaceDetection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000549A_FaceDetection));
        ...
        {
            bool result = CF_00000549A_FaceDetection.Solution_0_Test(input);
