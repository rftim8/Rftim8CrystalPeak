...
{
    [TestClass]
    public sealed class CF_00001557D_EzzatAndGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001557D_EzzatAndGrid));
        ...
        {
            bool result = CF_00001557D_EzzatAndGrid.Solution_0_Test(input);
