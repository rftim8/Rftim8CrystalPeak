...
{
    [TestClass]
    public sealed class CF_00000877B_NikitaAndString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000877B_NikitaAndString));
        ...
        {
            bool result = CF_00000877B_NikitaAndString.Solution_0_Test(input);
