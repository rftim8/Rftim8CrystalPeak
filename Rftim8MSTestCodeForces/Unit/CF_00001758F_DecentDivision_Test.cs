...
{
    [TestClass]
    public sealed class CF_00001758F_DecentDivision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001758F_DecentDivision));
        ...
        {
            bool result = CF_00001758F_DecentDivision.Solution_0_Test(input);
