...
{
    [TestClass]
    public sealed class CF_00001924B_SpaceHarbour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001924B_SpaceHarbour));
        ...
        {
            bool result = CF_00001924B_SpaceHarbour.Solution_0_Test(input);
