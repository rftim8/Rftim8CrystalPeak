...
{
    [TestClass]
    public sealed class CF_00001584F_StrangeLCS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001584F_StrangeLCS));
        ...
        {
            bool result = CF_00001584F_StrangeLCS.Solution_0_Test(input);
