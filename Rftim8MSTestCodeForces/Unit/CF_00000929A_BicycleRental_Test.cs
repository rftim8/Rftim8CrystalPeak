...
{
    [TestClass]
    public sealed class CF_00000929A_BicycleRental_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000929A_BicycleRental));
        ...
        {
            bool result = CF_00000929A_BicycleRental.Solution_0_Test(input);
