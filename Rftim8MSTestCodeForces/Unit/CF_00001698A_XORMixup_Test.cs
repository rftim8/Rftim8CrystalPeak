...
{
    [TestClass]
    public sealed class CF_00001698A_XORMixup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001698A_XORMixup));
        ...
        {
            bool result = CF_00001698A_XORMixup.Solution_0_Test(input);
