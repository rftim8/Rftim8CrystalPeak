...
{
    [TestClass]
    public sealed class CF_00001866F_FreakJokerProcess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001866F_FreakJokerProcess));
        ...
        {
            bool result = CF_00001866F_FreakJokerProcess.Solution_0_Test(input);
