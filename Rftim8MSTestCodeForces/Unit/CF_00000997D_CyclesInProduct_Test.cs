...
{
    [TestClass]
    public sealed class CF_00000997D_CyclesInProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000997D_CyclesInProduct));
        ...
        {
            bool result = CF_00000997D_CyclesInProduct.Solution_0_Test(input);
