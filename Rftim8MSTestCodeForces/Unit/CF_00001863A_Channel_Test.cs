...
{
    [TestClass]
    public sealed class CF_00001863A_Channel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001863A_Channel));
        ...
        {
            bool result = CF_00001863A_Channel.Solution_0_Test(input);
