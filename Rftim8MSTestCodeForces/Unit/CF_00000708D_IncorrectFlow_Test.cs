...
{
    [TestClass]
    public sealed class CF_00000708D_IncorrectFlow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000708D_IncorrectFlow));
        ...
        {
            bool result = CF_00000708D_IncorrectFlow.Solution_0_Test(input);
