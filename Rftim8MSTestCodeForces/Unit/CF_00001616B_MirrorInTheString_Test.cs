...
{
    [TestClass]
    public sealed class CF_00001616B_MirrorInTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001616B_MirrorInTheString));
        ...
        {
            bool result = CF_00001616B_MirrorInTheString.Solution_0_Test(input);
