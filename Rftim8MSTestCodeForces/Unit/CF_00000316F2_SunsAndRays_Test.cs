...
{
    [TestClass]
    public sealed class CF_00000316F2_SunsAndRays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000316F2_SunsAndRays));
        ...
        {
            bool result = CF_00000316F2_SunsAndRays.Solution_0_Test(input);
