...
{
    [TestClass]
    public sealed class CF_00000284A_CowsAndPrimitiveRoots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000284A_CowsAndPrimitiveRoots));
        ...
        {
            bool result = CF_00000284A_CowsAndPrimitiveRoots.Solution_0_Test(input);
