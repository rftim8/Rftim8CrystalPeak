...
{
    [TestClass]
    public sealed class CF_00001328D_Carousel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001328D_Carousel));
        ...
        {
            bool result = CF_00001328D_Carousel.Solution_0_Test(input);
