...
{
    [TestClass]
    public sealed class CF_00000426A_SerejaAndMugs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000426A_SerejaAndMugs));
        ...
        {
            bool result = CF_00000426A_SerejaAndMugs.Solution_0_Test(input);
