...
{
    [TestClass]
    public sealed class CF_00001844H_MultipleOfThreeCycles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001844H_MultipleOfThreeCycles));
        ...
        {
            bool result = CF_00001844H_MultipleOfThreeCycles.Solution_0_Test(input);
