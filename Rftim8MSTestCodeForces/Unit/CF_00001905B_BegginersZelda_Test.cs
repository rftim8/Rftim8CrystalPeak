...
{
    [TestClass]
    public sealed class CF_00001905B_BegginersZelda_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001905B_BegginersZelda));
        ...
        {
            bool result = CF_00001905B_BegginersZelda.Solution_0_Test(input);
