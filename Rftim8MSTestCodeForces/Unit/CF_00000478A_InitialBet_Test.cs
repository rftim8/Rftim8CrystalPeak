...
{
    [TestClass]
    public sealed class CF_00000478A_InitialBet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000478A_InitialBet));
        ...
        {
            bool result = CF_00000478A_InitialBet.Solution_0_Test(input);
