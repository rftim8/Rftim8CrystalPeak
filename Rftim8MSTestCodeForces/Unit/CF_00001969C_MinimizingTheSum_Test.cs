...
{
    [TestClass]
    public sealed class CF_00001969C_MinimizingTheSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001969C_MinimizingTheSum));
        ...
        {
            bool result = CF_00001969C_MinimizingTheSum.Solution_0_Test(input);
