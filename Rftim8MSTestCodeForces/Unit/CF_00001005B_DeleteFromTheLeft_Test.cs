...
{
    [TestClass]
    public sealed class CF_00001005B_DeleteFromTheLeft_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001005B_DeleteFromTheLeft));
        ...
        {
            bool result = CF_00001005B_DeleteFromTheLeft.Solution_0_Test(input);
