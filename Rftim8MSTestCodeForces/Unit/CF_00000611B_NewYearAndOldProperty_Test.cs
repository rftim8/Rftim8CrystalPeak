...
{
    [TestClass]
    public sealed class CF_00000611B_NewYearAndOldProperty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000611B_NewYearAndOldProperty));
        ...
        {
            bool result = CF_00000611B_NewYearAndOldProperty.Solution_0_Test(input);
