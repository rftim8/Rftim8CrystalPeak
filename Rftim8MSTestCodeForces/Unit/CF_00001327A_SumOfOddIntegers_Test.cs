...
{
    [TestClass]
    public sealed class CF_00001327A_SumOfOddIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001327A_SumOfOddIntegers));
        ...
        {
            bool result = CF_00001327A_SumOfOddIntegers.Solution_0_Test(input);
