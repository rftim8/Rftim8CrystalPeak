...
{
    [TestClass]
    public sealed class CF_00000750A_NewYearAndHurry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000750A_NewYearAndHurry));
        ...
        {
            bool result = CF_00000750A_NewYearAndHurry.Solution_0_Test(input);
