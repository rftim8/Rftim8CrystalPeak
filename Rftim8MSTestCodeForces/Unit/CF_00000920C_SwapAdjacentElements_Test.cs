...
{
    [TestClass]
    public sealed class CF_00000920C_SwapAdjacentElements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000920C_SwapAdjacentElements));
        ...
        {
            bool result = CF_00000920C_SwapAdjacentElements.Solution_0_Test(input);
