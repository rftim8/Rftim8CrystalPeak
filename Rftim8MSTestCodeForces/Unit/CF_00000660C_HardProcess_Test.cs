...
{
    [TestClass]
    public sealed class CF_00000660C_HardProcess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000660C_HardProcess));
        ...
        {
            bool result = CF_00000660C_HardProcess.Solution_0_Test(input);
