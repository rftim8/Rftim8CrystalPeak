...
{
    [TestClass]
    public sealed class CF_00000847C_SumOfNestings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847C_SumOfNestings));
        ...
        {
            bool result = CF_00000847C_SumOfNestings.Solution_0_Test(input);
