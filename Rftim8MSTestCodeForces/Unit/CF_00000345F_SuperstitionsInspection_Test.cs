...
{
    [TestClass]
    public sealed class CF_00000345F_SuperstitionsInspection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000345F_SuperstitionsInspection));
        ...
        {
            bool result = CF_00000345F_SuperstitionsInspection.Solution_0_Test(input);
