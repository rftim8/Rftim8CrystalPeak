...
{
    [TestClass]
    public sealed class CF_00000009D_HowManyTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000009D_HowManyTrees));
        ...
        {
            bool result = CF_00000009D_HowManyTrees.Solution_0_Test(input);
