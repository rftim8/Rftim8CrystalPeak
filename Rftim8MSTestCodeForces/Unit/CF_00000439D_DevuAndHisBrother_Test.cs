...
{
    [TestClass]
    public sealed class CF_00000439D_DevuAndHisBrother_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000439D_DevuAndHisBrother));
        ...
        {
            bool result = CF_00000439D_DevuAndHisBrother.Solution_0_Test(input);
