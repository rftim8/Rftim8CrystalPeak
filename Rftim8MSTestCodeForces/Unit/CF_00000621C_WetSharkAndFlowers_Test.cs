...
{
    [TestClass]
    public sealed class CF_00000621C_WetSharkAndFlowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000621C_WetSharkAndFlowers));
        ...
        {
            bool result = CF_00000621C_WetSharkAndFlowers.Solution_0_Test(input);
