...
{
    [TestClass]
    public sealed class CF_00001618C_PaintTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001618C_PaintTheArray));
        ...
        {
            bool result = CF_00001618C_PaintTheArray.Solution_0_Test(input);
