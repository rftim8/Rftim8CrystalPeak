...
{
    [TestClass]
    public sealed class CF_00000159B_Matchmaker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000159B_Matchmaker));
        ...
        {
            bool result = CF_00000159B_Matchmaker.Solution_0_Test(input);
