...
{
    [TestClass]
    public sealed class CF_00000116B_LittlePigsAndWolves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000116B_LittlePigsAndWolves));
        ...
        {
            bool result = CF_00000116B_LittlePigsAndWolves.Solution_0_Test(input);
