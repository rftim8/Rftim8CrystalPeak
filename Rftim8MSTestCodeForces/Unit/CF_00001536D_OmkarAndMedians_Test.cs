...
{
    [TestClass]
    public sealed class CF_00001536D_OmkarAndMedians_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001536D_OmkarAndMedians));
        ...
        {
            bool result = CF_00001536D_OmkarAndMedians.Solution_0_Test(input);
