...
{
    [TestClass]
    public sealed class CF_00001083B_TheFairNutAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001083B_TheFairNutAndStrings));
        ...
        {
            bool result = CF_00001083B_TheFairNutAndStrings.Solution_0_Test(input);
