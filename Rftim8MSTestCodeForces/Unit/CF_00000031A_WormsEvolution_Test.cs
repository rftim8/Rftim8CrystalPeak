...
{
    [TestClass]
    public sealed class CF_00000031A_WormsEvolution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000031A_WormsEvolution));
        ...
        {
            bool result = CF_00000031A_WormsEvolution.Solution_0_Test(input);
