...
{
    [TestClass]
    public sealed class CF_00001421C_Palindromifier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001421C_Palindromifier));
        ...
        {
            bool result = CF_00001421C_Palindromifier.Solution_0_Test(input);
