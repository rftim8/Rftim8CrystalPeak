...
{
    [TestClass]
    public sealed class CF_00001870F_LazyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001870F_LazyNumbers));
        ...
        {
            bool result = CF_00001870F_LazyNumbers.Solution_0_Test(input);
