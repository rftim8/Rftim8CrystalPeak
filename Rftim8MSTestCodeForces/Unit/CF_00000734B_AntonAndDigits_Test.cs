...
{
    [TestClass]
    public sealed class CF_00000734B_AntonAndDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000734B_AntonAndDigits));
        ...
        {
            bool result = CF_00000734B_AntonAndDigits.Solution_0_Test(input);
