...
{
    [TestClass]
    public sealed class CF_00001295E_PermutationSeparation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001295E_PermutationSeparation));
        ...
        {
            bool result = CF_00001295E_PermutationSeparation.Solution_0_Test(input);
