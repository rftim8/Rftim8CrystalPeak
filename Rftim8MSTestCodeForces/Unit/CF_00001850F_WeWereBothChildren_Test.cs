...
{
    [TestClass]
    public sealed class CF_00001850F_WeWereBothChildren_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001850F_WeWereBothChildren));
        ...
        {
            bool result = CF_00001850F_WeWereBothChildren.Solution_0_Test(input);
