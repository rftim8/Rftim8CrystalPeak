...
{
    [TestClass]
    public sealed class CF_00001037E_Trips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001037E_Trips));
        ...
        {
            bool result = CF_00001037E_Trips.Solution_0_Test(input);
