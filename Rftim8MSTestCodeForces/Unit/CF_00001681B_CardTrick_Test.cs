...
{
    [TestClass]
    public sealed class CF_00001681B_CardTrick_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001681B_CardTrick));
        ...
        {
            bool result = CF_00001681B_CardTrick.Solution_0_Test(input);
