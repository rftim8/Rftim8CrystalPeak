...
{
    [TestClass]
    public sealed class CF_00001055E_SegmentsOnTheLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001055E_SegmentsOnTheLine));
        ...
        {
            bool result = CF_00001055E_SegmentsOnTheLine.Solution_0_Test(input);
