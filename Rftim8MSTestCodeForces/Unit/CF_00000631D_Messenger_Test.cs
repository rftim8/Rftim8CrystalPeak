...
{
    [TestClass]
    public sealed class CF_00000631D_Messenger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000631D_Messenger));
        ...
        {
            bool result = CF_00000631D_Messenger.Solution_0_Test(input);
