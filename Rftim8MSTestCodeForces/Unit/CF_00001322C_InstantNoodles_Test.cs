...
{
    [TestClass]
    public sealed class CF_00001322C_InstantNoodles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001322C_InstantNoodles));
        ...
        {
            bool result = CF_00001322C_InstantNoodles.Solution_0_Test(input);
