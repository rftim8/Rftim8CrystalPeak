...
{
    [TestClass]
    public sealed class CF_00001302A_NashEquilibrium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001302A_NashEquilibrium));
        ...
        {
            bool result = CF_00001302A_NashEquilibrium.Solution_0_Test(input);
