...
{
    [TestClass]
    public sealed class CF_00000912B_NewYearsEveb_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000912B_NewYearsEveb));
        ...
        {
            bool result = CF_00000912B_NewYearsEveb.Solution_0_Test(input);
