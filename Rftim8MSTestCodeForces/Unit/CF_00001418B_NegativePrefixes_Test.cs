...
{
    [TestClass]
    public sealed class CF_00001418B_NegativePrefixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001418B_NegativePrefixes));
        ...
        {
            bool result = CF_00001418B_NegativePrefixes.Solution_0_Test(input);
