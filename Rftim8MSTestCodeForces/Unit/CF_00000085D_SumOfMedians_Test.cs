...
{
    [TestClass]
    public sealed class CF_00000085D_SumOfMedians_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000085D_SumOfMedians));
        ...
        {
            bool result = CF_00000085D_SumOfMedians.Solution_0_Test(input);
