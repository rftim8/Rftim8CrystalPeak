...
{
    [TestClass]
    public sealed class CF_00000553A_KyoyaAndColoredBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000553A_KyoyaAndColoredBalls));
        ...
        {
            bool result = CF_00000553A_KyoyaAndColoredBalls.Solution_0_Test(input);
