...
{
    [TestClass]
    public sealed class CF_00001063F_StringJourney_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001063F_StringJourney));
        ...
        {
            bool result = CF_00001063F_StringJourney.Solution_0_Test(input);
