...
{
    [TestClass]
    public sealed class CF_00001725A_AccumulationOfDominoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725A_AccumulationOfDominoes));
        ...
        {
            bool result = CF_00001725A_AccumulationOfDominoes.Solution_0_Test(input);
