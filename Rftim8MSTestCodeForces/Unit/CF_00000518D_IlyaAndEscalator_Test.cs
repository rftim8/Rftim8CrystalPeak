...
{
    [TestClass]
    public sealed class CF_00000518D_IlyaAndEscalator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000518D_IlyaAndEscalator));
        ...
        {
            bool result = CF_00000518D_IlyaAndEscalator.Solution_0_Test(input);
