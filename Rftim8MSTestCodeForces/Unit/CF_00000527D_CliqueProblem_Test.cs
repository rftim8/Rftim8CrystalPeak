...
{
    [TestClass]
    public sealed class CF_00000527D_CliqueProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000527D_CliqueProblem));
        ...
        {
            bool result = CF_00000527D_CliqueProblem.Solution_0_Test(input);
