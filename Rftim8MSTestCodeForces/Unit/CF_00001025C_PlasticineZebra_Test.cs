...
{
    [TestClass]
    public sealed class CF_00001025C_PlasticineZebra_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001025C_PlasticineZebra));
        ...
        {
            bool result = CF_00001025C_PlasticineZebra.Solution_0_Test(input);
