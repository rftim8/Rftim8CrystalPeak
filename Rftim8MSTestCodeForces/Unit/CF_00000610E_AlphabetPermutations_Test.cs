...
{
    [TestClass]
    public sealed class CF_00000610E_AlphabetPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000610E_AlphabetPermutations));
        ...
        {
            bool result = CF_00000610E_AlphabetPermutations.Solution_0_Test(input);
