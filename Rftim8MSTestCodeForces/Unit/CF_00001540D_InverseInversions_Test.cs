...
{
    [TestClass]
    public sealed class CF_00001540D_InverseInversions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001540D_InverseInversions));
        ...
        {
            bool result = CF_00001540D_InverseInversions.Solution_0_Test(input);
