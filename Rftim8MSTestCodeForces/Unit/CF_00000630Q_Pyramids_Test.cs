...
{
    [TestClass]
    public sealed class CF_00000630Q_Pyramids_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630Q_Pyramids));
        ...
        {
            bool result = CF_00000630Q_Pyramids.Solution_0_Test(input);
