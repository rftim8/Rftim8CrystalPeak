...
{
    [TestClass]
    public sealed class CF_00001555E_BoringSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001555E_BoringSegments));
        ...
        {
            bool result = CF_00001555E_BoringSegments.Solution_0_Test(input);
