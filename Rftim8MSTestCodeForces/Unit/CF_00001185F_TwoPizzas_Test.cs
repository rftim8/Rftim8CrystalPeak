...
{
    [TestClass]
    public sealed class CF_00001185F_TwoPizzas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001185F_TwoPizzas));
        ...
        {
            bool result = CF_00001185F_TwoPizzas.Solution_0_Test(input);
