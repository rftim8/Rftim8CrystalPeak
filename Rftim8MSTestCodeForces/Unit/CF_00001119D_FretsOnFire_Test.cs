...
{
    [TestClass]
    public sealed class CF_00001119D_FretsOnFire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001119D_FretsOnFire));
        ...
        {
            bool result = CF_00001119D_FretsOnFire.Solution_0_Test(input);
