...
{
    [TestClass]
    public sealed class CF_00000960G_BanditBlues_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000960G_BanditBlues));
        ...
        {
            bool result = CF_00000960G_BanditBlues.Solution_0_Test(input);
