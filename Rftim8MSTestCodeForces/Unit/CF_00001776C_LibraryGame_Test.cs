...
{
    [TestClass]
    public sealed class CF_00001776C_LibraryGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001776C_LibraryGame));
        ...
        {
            bool result = CF_00001776C_LibraryGame.Solution_0_Test(input);
