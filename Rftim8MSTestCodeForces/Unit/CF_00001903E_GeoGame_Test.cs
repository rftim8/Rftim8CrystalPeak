...
{
    [TestClass]
    public sealed class CF_00001903E_GeoGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001903E_GeoGame));
        ...
        {
            bool result = CF_00001903E_GeoGame.Solution_0_Test(input);
