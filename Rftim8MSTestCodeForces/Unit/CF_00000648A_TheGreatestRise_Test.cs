...
{
    [TestClass]
    public sealed class CF_00000648A_TheGreatestRise_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000648A_TheGreatestRise));
        ...
        {
            bool result = CF_00000648A_TheGreatestRise.Solution_0_Test(input);
