...
{
    [TestClass]
    public sealed class CF_00000391E2_ThreeTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000391E2_ThreeTrees));
        ...
        {
            bool result = CF_00000391E2_ThreeTrees.Solution_0_Test(input);
