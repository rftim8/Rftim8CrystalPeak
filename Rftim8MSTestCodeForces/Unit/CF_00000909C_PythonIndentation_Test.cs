...
{
    [TestClass]
    public sealed class CF_00000909C_PythonIndentation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000909C_PythonIndentation));
        ...
        {
            bool result = CF_00000909C_PythonIndentation.Solution_0_Test(input);
