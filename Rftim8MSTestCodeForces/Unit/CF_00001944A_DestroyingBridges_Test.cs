...
{
    [TestClass]
    public sealed class CF_00001944A_DestroyingBridges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001944A_DestroyingBridges));
        ...
        {
            bool result = CF_00001944A_DestroyingBridges.Solution_0_Test(input);
