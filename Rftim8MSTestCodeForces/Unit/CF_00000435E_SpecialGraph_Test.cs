...
{
    [TestClass]
    public sealed class CF_00000435E_SpecialGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000435E_SpecialGraph));
        ...
        {
            bool result = CF_00000435E_SpecialGraph.Solution_0_Test(input);
