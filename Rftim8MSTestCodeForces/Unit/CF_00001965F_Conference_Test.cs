...
{
    [TestClass]
    public sealed class CF_00001965F_Conference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001965F_Conference));
        ...
        {
            bool result = CF_00001965F_Conference.Solution_0_Test(input);
