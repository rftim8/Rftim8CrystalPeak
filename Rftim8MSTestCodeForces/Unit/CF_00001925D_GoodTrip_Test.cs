...
{
    [TestClass]
    public sealed class CF_00001925D_GoodTrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001925D_GoodTrip));
        ...
        {
            bool result = CF_00001925D_GoodTrip.Solution_0_Test(input);
