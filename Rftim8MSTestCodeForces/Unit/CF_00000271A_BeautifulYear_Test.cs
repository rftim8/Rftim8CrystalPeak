...
{
    [TestClass]
    public sealed class CF_00000271A_BeautifulYear_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000271A_BeautifulYear));
        ...
        {
            bool result = CF_00000271A_BeautifulYear.Solution_0_Test(input);
