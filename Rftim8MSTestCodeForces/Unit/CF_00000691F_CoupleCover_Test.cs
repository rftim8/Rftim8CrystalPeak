...
{
    [TestClass]
    public sealed class CF_00000691F_CoupleCover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000691F_CoupleCover));
        ...
        {
            bool result = CF_00000691F_CoupleCover.Solution_0_Test(input);
