...
{
    [TestClass]
    public sealed class CF_00001523A_GameOfLife_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001523A_GameOfLife));
        ...
        {
            bool result = CF_00001523A_GameOfLife.Solution_0_Test(input);
