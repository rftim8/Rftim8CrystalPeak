...
{
    [TestClass]
    public sealed class CF_00000142A_HelpFarmer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000142A_HelpFarmer));
        ...
        {
            bool result = CF_00000142A_HelpFarmer.Solution_0_Test(input);
