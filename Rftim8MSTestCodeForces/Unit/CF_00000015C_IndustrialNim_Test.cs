...
{
    [TestClass]
    public sealed class CF_00000015C_IndustrialNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000015C_IndustrialNim));
        ...
        {
            bool result = CF_00000015C_IndustrialNim.Solution_0_Test(input);
