...
{
    [TestClass]
    public sealed class CF_00001368D_ANDORAndSquareSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001368D_ANDORAndSquareSum));
        ...
        {
            bool result = CF_00001368D_ANDORAndSquareSum.Solution_0_Test(input);
