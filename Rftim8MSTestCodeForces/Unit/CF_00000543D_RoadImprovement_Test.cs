...
{
    [TestClass]
    public sealed class CF_00000543D_RoadImprovement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000543D_RoadImprovement));
        ...
        {
            bool result = CF_00000543D_RoadImprovement.Solution_0_Test(input);
