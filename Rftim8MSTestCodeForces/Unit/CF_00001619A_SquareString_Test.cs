...
{
    [TestClass]
    public sealed class CF_00001619A_SquareString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001619A_SquareString));
        ...
        {
            bool result = CF_00001619A_SquareString.Solution_0_Test(input);
