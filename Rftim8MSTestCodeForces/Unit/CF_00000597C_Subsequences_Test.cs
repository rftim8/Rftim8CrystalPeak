...
{
    [TestClass]
    public sealed class CF_00000597C_Subsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000597C_Subsequences));
        ...
        {
            bool result = CF_00000597C_Subsequences.Solution_0_Test(input);
