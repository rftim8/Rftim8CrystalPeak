...
{
    [TestClass]
    public sealed class CF_00000928D_Autocompletion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000928D_Autocompletion));
        ...
        {
            bool result = CF_00000928D_Autocompletion.Solution_0_Test(input);
