...
{
    [TestClass]
    public sealed class CF_00001342E_PlacingRooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001342E_PlacingRooks));
        ...
        {
            bool result = CF_00001342E_PlacingRooks.Solution_0_Test(input);
