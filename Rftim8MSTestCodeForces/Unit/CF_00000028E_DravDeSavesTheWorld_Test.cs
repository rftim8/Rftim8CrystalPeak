...
{
    [TestClass]
    public sealed class CF_00000028E_DravDeSavesTheWorld_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000028E_DravDeSavesTheWorld));
        ...
        {
            bool result = CF_00000028E_DravDeSavesTheWorld.Solution_0_Test(input);
