...
{
    [TestClass]
    public sealed class CF_00001936F_GrandFinaleCircles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001936F_GrandFinaleCircles));
        ...
        {
            bool result = CF_00001936F_GrandFinaleCircles.Solution_0_Test(input);
