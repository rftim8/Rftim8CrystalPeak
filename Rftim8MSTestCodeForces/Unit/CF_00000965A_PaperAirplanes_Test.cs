...
{
    [TestClass]
    public sealed class CF_00000965A_PaperAirplanes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000965A_PaperAirplanes));
        ...
        {
            bool result = CF_00000965A_PaperAirplanes.Solution_0_Test(input);
