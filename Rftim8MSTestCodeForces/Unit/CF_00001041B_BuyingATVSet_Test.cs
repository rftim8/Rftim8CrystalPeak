...
{
    [TestClass]
    public sealed class CF_00001041B_BuyingATVSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001041B_BuyingATVSet));
        ...
        {
            bool result = CF_00001041B_BuyingATVSet.Solution_0_Test(input);
