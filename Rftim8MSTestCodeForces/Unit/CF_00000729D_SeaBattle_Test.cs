...
{
    [TestClass]
    public sealed class CF_00000729D_SeaBattle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000729D_SeaBattle));
        ...
        {
            bool result = CF_00000729D_SeaBattle.Solution_0_Test(input);
