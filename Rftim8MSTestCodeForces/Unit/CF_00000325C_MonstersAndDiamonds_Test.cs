...
{
    [TestClass]
    public sealed class CF_00000325C_MonstersAndDiamonds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000325C_MonstersAndDiamonds));
        ...
        {
            bool result = CF_00000325C_MonstersAndDiamonds.Solution_0_Test(input);
