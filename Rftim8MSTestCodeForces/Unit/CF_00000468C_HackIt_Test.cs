...
{
    [TestClass]
    public sealed class CF_00000468C_HackIt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000468C_HackIt));
        ...
        {
            bool result = CF_00000468C_HackIt.Solution_0_Test(input);
