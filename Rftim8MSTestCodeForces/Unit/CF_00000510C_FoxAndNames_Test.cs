...
{
    [TestClass]
    public sealed class CF_00000510C_FoxAndNames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000510C_FoxAndNames));
        ...
        {
            bool result = CF_00000510C_FoxAndNames.Solution_0_Test(input);
