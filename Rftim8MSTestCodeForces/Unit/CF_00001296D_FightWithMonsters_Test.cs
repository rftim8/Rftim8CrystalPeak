...
{
    [TestClass]
    public sealed class CF_00001296D_FightWithMonsters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001296D_FightWithMonsters));
        ...
        {
            bool result = CF_00001296D_FightWithMonsters.Solution_0_Test(input);
