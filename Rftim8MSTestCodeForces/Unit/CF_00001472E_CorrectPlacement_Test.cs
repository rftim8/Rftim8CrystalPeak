...
{
    [TestClass]
    public sealed class CF_00001472E_CorrectPlacement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001472E_CorrectPlacement));
        ...
        {
            bool result = CF_00001472E_CorrectPlacement.Solution_0_Test(input);
