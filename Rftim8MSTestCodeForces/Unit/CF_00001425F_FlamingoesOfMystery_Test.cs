...
{
    [TestClass]
    public sealed class CF_00001425F_FlamingoesOfMystery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001425F_FlamingoesOfMystery));
        ...
        {
            bool result = CF_00001425F_FlamingoesOfMystery.Solution_0_Test(input);
