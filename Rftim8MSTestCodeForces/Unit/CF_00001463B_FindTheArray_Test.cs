...
{
    [TestClass]
    public sealed class CF_00001463B_FindTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001463B_FindTheArray));
        ...
        {
            bool result = CF_00001463B_FindTheArray.Solution_0_Test(input);
