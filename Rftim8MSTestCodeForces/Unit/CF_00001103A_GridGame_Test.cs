...
{
    [TestClass]
    public sealed class CF_00001103A_GridGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001103A_GridGame));
        ...
        {
            bool result = CF_00001103A_GridGame.Solution_0_Test(input);
