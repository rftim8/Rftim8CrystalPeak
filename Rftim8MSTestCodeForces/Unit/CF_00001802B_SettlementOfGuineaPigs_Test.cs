...
{
    [TestClass]
    public sealed class CF_00001802B_SettlementOfGuineaPigs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001802B_SettlementOfGuineaPigs));
        ...
        {
            bool result = CF_00001802B_SettlementOfGuineaPigs.Solution_0_Test(input);
