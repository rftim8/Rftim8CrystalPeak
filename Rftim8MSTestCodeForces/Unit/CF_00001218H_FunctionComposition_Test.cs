...
{
    [TestClass]
    public sealed class CF_00001218H_FunctionComposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001218H_FunctionComposition));
        ...
        {
            bool result = CF_00001218H_FunctionComposition.Solution_0_Test(input);
