...
{
    [TestClass]
    public sealed class CF_00001558F_StrangeSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001558F_StrangeSort));
        ...
        {
            bool result = CF_00001558F_StrangeSort.Solution_0_Test(input);
