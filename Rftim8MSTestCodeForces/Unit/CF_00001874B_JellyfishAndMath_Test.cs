...
{
    [TestClass]
    public sealed class CF_00001874B_JellyfishAndMath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001874B_JellyfishAndMath));
        ...
        {
            bool result = CF_00001874B_JellyfishAndMath.Solution_0_Test(input);
