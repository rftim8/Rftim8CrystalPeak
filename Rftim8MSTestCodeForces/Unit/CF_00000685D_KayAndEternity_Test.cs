...
{
    [TestClass]
    public sealed class CF_00000685D_KayAndEternity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000685D_KayAndEternity));
        ...
        {
            bool result = CF_00000685D_KayAndEternity.Solution_0_Test(input);
