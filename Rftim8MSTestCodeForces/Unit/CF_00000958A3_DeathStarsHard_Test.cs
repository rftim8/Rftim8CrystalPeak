...
{
    [TestClass]
    public sealed class CF_00000958A3_DeathStarsHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958A3_DeathStarsHard));
        ...
        {
            bool result = CF_00000958A3_DeathStarsHard.Solution_0_Test(input);
