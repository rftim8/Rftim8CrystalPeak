...
{
    [TestClass]
    public sealed class CF_00001907E_GoodTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001907E_GoodTriples));
        ...
        {
            bool result = CF_00001907E_GoodTriples.Solution_0_Test(input);
