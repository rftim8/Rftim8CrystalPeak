...
{
    [TestClass]
    public sealed class CF_00000703B_MishkaAndTrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000703B_MishkaAndTrip));
        ...
        {
            bool result = CF_00000703B_MishkaAndTrip.Solution_0_Test(input);
