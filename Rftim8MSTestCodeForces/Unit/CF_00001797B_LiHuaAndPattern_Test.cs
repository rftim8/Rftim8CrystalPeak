...
{
    [TestClass]
    public sealed class CF_00001797B_LiHuaAndPattern_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001797B_LiHuaAndPattern));
        ...
        {
            bool result = CF_00001797B_LiHuaAndPattern.Solution_0_Test(input);
