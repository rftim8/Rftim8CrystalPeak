...
{
    [TestClass]
    public sealed class CF_00001659A_RedVersusBlue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001659A_RedVersusBlue));
        ...
        {
            bool result = CF_00001659A_RedVersusBlue.Solution_0_Test(input);
