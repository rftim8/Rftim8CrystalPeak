...
{
    [TestClass]
    public sealed class CF_00001852C_InaOfTheMountain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001852C_InaOfTheMountain));
        ...
        {
            bool result = CF_00001852C_InaOfTheMountain.Solution_0_Test(input);
