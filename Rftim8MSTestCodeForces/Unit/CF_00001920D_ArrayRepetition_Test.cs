...
{
    [TestClass]
    public sealed class CF_00001920D_ArrayRepetition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001920D_ArrayRepetition));
        ...
        {
            bool result = CF_00001920D_ArrayRepetition.Solution_0_Test(input);
