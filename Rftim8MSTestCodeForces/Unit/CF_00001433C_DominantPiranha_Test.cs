...
{
    [TestClass]
    public sealed class CF_00001433C_DominantPiranha_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001433C_DominantPiranha));
        ...
        {
            bool result = CF_00001433C_DominantPiranha.Solution_0_Test(input);
