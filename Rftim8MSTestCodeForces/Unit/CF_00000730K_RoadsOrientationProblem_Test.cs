...
{
    [TestClass]
    public sealed class CF_00000730K_RoadsOrientationProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730K_RoadsOrientationProblem));
        ...
        {
            bool result = CF_00000730K_RoadsOrientationProblem.Solution_0_Test(input);
