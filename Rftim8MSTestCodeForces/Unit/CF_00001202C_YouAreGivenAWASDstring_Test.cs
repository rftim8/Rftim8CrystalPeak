...
{
    [TestClass]
    public sealed class CF_00001202C_YouAreGivenAWASDstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001202C_YouAreGivenAWASDstring));
        ...
        {
            bool result = CF_00001202C_YouAreGivenAWASDstring.Solution_0_Test(input);
