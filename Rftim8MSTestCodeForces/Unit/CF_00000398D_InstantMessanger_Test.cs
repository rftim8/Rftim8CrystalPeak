...
{
    [TestClass]
    public sealed class CF_00000398D_InstantMessanger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000398D_InstantMessanger));
        ...
        {
            bool result = CF_00000398D_InstantMessanger.Solution_0_Test(input);
