...
{
    [TestClass]
    public sealed class CF_00001211C_IceCream_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001211C_IceCream));
        ...
        {
            bool result = CF_00001211C_IceCream.Solution_0_Test(input);
