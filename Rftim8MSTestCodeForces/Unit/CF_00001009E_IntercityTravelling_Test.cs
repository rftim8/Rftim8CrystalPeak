...
{
    [TestClass]
    public sealed class CF_00001009E_IntercityTravelling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001009E_IntercityTravelling));
        ...
        {
            bool result = CF_00001009E_IntercityTravelling.Solution_0_Test(input);
