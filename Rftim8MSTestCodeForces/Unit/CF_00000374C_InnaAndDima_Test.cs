...
{
    [TestClass]
    public sealed class CF_00000374C_InnaAndDima_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000374C_InnaAndDima));
        ...
        {
            bool result = CF_00000374C_InnaAndDima.Solution_0_Test(input);
