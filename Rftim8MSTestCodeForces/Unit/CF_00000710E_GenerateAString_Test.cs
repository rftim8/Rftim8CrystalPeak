...
{
    [TestClass]
    public sealed class CF_00000710E_GenerateAString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000710E_GenerateAString));
        ...
        {
            bool result = CF_00000710E_GenerateAString.Solution_0_Test(input);
