...
{
    [TestClass]
    public sealed class CF_00000053C_LittleFrog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000053C_LittleFrog));
        ...
        {
            bool result = CF_00000053C_LittleFrog.Solution_0_Test(input);
