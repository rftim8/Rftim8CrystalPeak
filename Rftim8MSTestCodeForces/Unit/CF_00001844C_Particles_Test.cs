...
{
    [TestClass]
    public sealed class CF_00001844C_Particles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001844C_Particles));
        ...
        {
            bool result = CF_00001844C_Particles.Solution_0_Test(input);
