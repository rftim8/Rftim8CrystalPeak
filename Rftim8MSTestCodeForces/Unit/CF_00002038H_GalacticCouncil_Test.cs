...
{
    [TestClass]
    public sealed class CF_00002038H_GalacticCouncil_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002038H_GalacticCouncil));
        ...
        {
            bool result = CF_00002038H_GalacticCouncil.Solution_0_Test(input);
