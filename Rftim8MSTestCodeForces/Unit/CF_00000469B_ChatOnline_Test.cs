...
{
    [TestClass]
    public sealed class CF_00000469B_ChatOnline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000469B_ChatOnline));
        ...
        {
            bool result = CF_00000469B_ChatOnline.Solution_0_Test(input);
