...
{
    [TestClass]
    public sealed class CF_00001789A_ServalAndMochasArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001789A_ServalAndMochasArray));
        ...
        {
            bool result = CF_00001789A_ServalAndMochasArray.Solution_0_Test(input);
