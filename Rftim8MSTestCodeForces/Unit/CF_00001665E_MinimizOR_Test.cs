...
{
    [TestClass]
    public sealed class CF_00001665E_MinimizOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001665E_MinimizOR));
        ...
        {
            bool result = CF_00001665E_MinimizOR.Solution_0_Test(input);
