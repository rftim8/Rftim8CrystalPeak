...
{
    [TestClass]
    public sealed class CF_00000653B_BearAndCompressing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000653B_BearAndCompressing));
        ...
        {
            bool result = CF_00000653B_BearAndCompressing.Solution_0_Test(input);
