...
{
    [TestClass]
    public sealed class CF_00001053E_EulerTour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001053E_EulerTour));
        ...
        {
            bool result = CF_00001053E_EulerTour.Solution_0_Test(input);
