...
{
    [TestClass]
    public sealed class CF_00000235A_LCMChallenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000235A_LCMChallenge));
        ...
        {
            bool result = CF_00000235A_LCMChallenge.Solution_0_Test(input);
