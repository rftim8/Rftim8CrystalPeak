...
{
    [TestClass]
    public sealed class CF_00000907B_TicTacToe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000907B_TicTacToe));
        ...
        {
            bool result = CF_00000907B_TicTacToe.Solution_0_Test(input);
