...
{
    [TestClass]
    public sealed class CF_00001250F_DataCenter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250F_DataCenter));
        ...
        {
            bool result = CF_00001250F_DataCenter.Solution_0_Test(input);
