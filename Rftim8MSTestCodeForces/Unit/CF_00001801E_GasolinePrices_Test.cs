...
{
    [TestClass]
    public sealed class CF_00001801E_GasolinePrices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001801E_GasolinePrices));
        ...
        {
            bool result = CF_00001801E_GasolinePrices.Solution_0_Test(input);
