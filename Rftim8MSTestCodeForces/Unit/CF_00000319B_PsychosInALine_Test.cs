...
{
    [TestClass]
    public sealed class CF_00000319B_PsychosInALine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000319B_PsychosInALine));
        ...
        {
            bool result = CF_00000319B_PsychosInALine.Solution_0_Test(input);
