...
{
    [TestClass]
    public sealed class CF_00001521B_NastiaAndAGoodArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001521B_NastiaAndAGoodArray));
        ...
        {
            bool result = CF_00001521B_NastiaAndAGoodArray.Solution_0_Test(input);
