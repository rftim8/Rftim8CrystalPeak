...
{
    [TestClass]
    public sealed class CF_00001054E_ChipsPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001054E_ChipsPuzzle));
        ...
        {
            bool result = CF_00001054E_ChipsPuzzle.Solution_0_Test(input);
