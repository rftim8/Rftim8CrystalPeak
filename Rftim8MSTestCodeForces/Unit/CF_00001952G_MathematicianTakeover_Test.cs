...
{
    [TestClass]
    public sealed class CF_00001952G_MathematicianTakeover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001952G_MathematicianTakeover));
        ...
        {
            bool result = CF_00001952G_MathematicianTakeover.Solution_0_Test(input);
