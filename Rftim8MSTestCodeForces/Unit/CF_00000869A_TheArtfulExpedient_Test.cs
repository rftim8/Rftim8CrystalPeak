...
{
    [TestClass]
    public sealed class CF_00000869A_TheArtfulExpedient_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000869A_TheArtfulExpedient));
        ...
        {
            bool result = CF_00000869A_TheArtfulExpedient.Solution_0_Test(input);
