...
{
    [TestClass]
    public sealed class CF_00000055D_BeautifulNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000055D_BeautifulNumbers));
        ...
        {
            bool result = CF_00000055D_BeautifulNumbers.Solution_0_Test(input);
