...
{
    [TestClass]
    public sealed class CF_00000917D_StrangerTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000917D_StrangerTrees));
        ...
        {
            bool result = CF_00000917D_StrangerTrees.Solution_0_Test(input);
