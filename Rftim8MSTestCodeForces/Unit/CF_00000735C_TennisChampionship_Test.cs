...
{
    [TestClass]
    public sealed class CF_00000735C_TennisChampionship_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000735C_TennisChampionship));
        ...
        {
            bool result = CF_00000735C_TennisChampionship.Solution_0_Test(input);
