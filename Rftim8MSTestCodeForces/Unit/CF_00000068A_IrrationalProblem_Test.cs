...
{
    [TestClass]
    public sealed class CF_00000068A_IrrationalProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000068A_IrrationalProblem));
        ...
        {
            bool result = CF_00000068A_IrrationalProblem.Solution_0_Test(input);
