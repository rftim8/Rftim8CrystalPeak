...
{
    [TestClass]
    public sealed class CF_00000173D_Deputies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000173D_Deputies));
        ...
        {
            bool result = CF_00000173D_Deputies.Solution_0_Test(input);
