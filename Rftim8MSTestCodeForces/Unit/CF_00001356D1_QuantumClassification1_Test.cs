...
{
    [TestClass]
    public sealed class CF_00001356D1_QuantumClassification1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001356D1_QuantumClassification1));
        ...
        {
            bool result = CF_00001356D1_QuantumClassification1.Solution_0_Test(input);
