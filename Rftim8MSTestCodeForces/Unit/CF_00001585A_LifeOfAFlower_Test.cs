...
{
    [TestClass]
    public sealed class CF_00001585A_LifeOfAFlower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001585A_LifeOfAFlower));
        ...
        {
            bool result = CF_00001585A_LifeOfAFlower.Solution_0_Test(input);
