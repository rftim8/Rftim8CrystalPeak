...
{
    [TestClass]
    public sealed class CF_00000855G_HarryVsVoldemort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000855G_HarryVsVoldemort));
        ...
        {
            bool result = CF_00000855G_HarryVsVoldemort.Solution_0_Test(input);
