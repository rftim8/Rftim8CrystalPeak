...
{
    [TestClass]
    public sealed class CF_00001353E_KperiodicGarland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001353E_KperiodicGarland));
        ...
        {
            bool result = CF_00001353E_KperiodicGarland.Solution_0_Test(input);
