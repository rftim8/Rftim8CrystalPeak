...
{
    [TestClass]
    public sealed class CF_00000594E_CuttingTheLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000594E_CuttingTheLine));
        ...
        {
            bool result = CF_00000594E_CuttingTheLine.Solution_0_Test(input);
