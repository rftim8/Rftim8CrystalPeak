...
{
    [TestClass]
    public sealed class CF_00001257C_DominatedSubarray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001257C_DominatedSubarray));
        ...
        {
            bool result = CF_00001257C_DominatedSubarray.Solution_0_Test(input);
