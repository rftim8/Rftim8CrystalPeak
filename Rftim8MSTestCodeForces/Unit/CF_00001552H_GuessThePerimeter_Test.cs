...
{
    [TestClass]
    public sealed class CF_00001552H_GuessThePerimeter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001552H_GuessThePerimeter));
        ...
        {
            bool result = CF_00001552H_GuessThePerimeter.Solution_0_Test(input);
