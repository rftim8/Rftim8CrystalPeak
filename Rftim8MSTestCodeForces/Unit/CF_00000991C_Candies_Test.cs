...
{
    [TestClass]
    public sealed class CF_00000991C_Candies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000991C_Candies));
        ...
        {
            bool result = CF_00000991C_Candies.Solution_0_Test(input);
