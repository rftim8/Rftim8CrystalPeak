...
{
    [TestClass]
    public sealed class CF_00001704F_ColouringGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001704F_ColouringGame));
        ...
        {
            bool result = CF_00001704F_ColouringGame.Solution_0_Test(input);
