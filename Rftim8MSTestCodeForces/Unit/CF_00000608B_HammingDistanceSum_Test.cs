...
{
    [TestClass]
    public sealed class CF_00000608B_HammingDistanceSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000608B_HammingDistanceSum));
        ...
        {
            bool result = CF_00000608B_HammingDistanceSum.Solution_0_Test(input);
