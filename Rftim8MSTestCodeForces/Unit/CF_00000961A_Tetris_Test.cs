...
{
    [TestClass]
    public sealed class CF_00000961A_Tetris_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000961A_Tetris));
        ...
        {
            bool result = CF_00000961A_Tetris.Solution_0_Test(input);
