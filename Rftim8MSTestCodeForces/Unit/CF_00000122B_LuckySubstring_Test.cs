...
{
    [TestClass]
    public sealed class CF_00000122B_LuckySubstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000122B_LuckySubstring));
        ...
        {
            bool result = CF_00000122B_LuckySubstring.Solution_0_Test(input);
