...
{
    [TestClass]
    public sealed class CF_00000117A_Elevator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000117A_Elevator));
        ...
        {
            bool result = CF_00000117A_Elevator.Solution_0_Test(input);
