...
{
    [TestClass]
    public sealed class CF_00001163B1_CatPartyEasyEdition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001163B1_CatPartyEasyEdition));
        ...
        {
            bool result = CF_00001163B1_CatPartyEasyEdition.Solution_0_Test(input);
