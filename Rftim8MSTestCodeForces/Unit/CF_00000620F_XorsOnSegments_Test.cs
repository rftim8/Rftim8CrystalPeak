...
{
    [TestClass]
    public sealed class CF_00000620F_XorsOnSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000620F_XorsOnSegments));
        ...
        {
            bool result = CF_00000620F_XorsOnSegments.Solution_0_Test(input);
