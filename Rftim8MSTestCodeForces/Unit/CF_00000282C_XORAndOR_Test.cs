...
{
    [TestClass]
    public sealed class CF_00000282C_XORAndOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000282C_XORAndOR));
        ...
        {
            bool result = CF_00000282C_XORAndOR.Solution_0_Test(input);
