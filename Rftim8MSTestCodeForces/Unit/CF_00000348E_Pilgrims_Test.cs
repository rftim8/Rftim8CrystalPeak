...
{
    [TestClass]
    public sealed class CF_00000348E_Pilgrims_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000348E_Pilgrims));
        ...
        {
            bool result = CF_00000348E_Pilgrims.Solution_0_Test(input);
