...
{
    [TestClass]
    public sealed class CF_00000450A_JzzhuAndChildren_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000450A_JzzhuAndChildren));
        ...
        {
            bool result = CF_00000450A_JzzhuAndChildren.Solution_0_Test(input);
