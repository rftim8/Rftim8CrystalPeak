...
{
    [TestClass]
    public sealed class CF_00001155E_GuessTheRoot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001155E_GuessTheRoot));
        ...
        {
            bool result = CF_00001155E_GuessTheRoot.Solution_0_Test(input);
