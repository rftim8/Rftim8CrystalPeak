...
{
    [TestClass]
    public sealed class CF_00001250I_ShowMustGoOn_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250I_ShowMustGoOn));
        ...
        {
            bool result = CF_00001250I_ShowMustGoOn.Solution_0_Test(input);
