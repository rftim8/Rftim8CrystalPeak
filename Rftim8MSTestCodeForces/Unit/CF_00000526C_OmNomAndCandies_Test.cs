...
{
    [TestClass]
    public sealed class CF_00000526C_OmNomAndCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000526C_OmNomAndCandies));
        ...
        {
            bool result = CF_00000526C_OmNomAndCandies.Solution_0_Test(input);
