...
{
    [TestClass]
    public sealed class CF_00001098C_ConstructATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001098C_ConstructATree));
        ...
        {
            bool result = CF_00001098C_ConstructATree.Solution_0_Test(input);
