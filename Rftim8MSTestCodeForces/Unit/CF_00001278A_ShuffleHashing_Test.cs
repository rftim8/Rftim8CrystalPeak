...
{
    [TestClass]
    public sealed class CF_00001278A_ShuffleHashing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001278A_ShuffleHashing));
        ...
        {
            bool result = CF_00001278A_ShuffleHashing.Solution_0_Test(input);
