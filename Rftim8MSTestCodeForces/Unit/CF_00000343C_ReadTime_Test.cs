...
{
    [TestClass]
    public sealed class CF_00000343C_ReadTime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000343C_ReadTime));
        ...
        {
            bool result = CF_00000343C_ReadTime.Solution_0_Test(input);
