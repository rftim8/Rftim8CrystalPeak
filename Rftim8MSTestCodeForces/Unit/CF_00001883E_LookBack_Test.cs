...
{
    [TestClass]
    public sealed class CF_00001883E_LookBack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001883E_LookBack));
        ...
        {
            bool result = CF_00001883E_LookBack.Solution_0_Test(input);
