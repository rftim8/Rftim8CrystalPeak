...
{
    [TestClass]
    public sealed class CF_00001538E_FunnySubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001538E_FunnySubstrings));
        ...
        {
            bool result = CF_00001538E_FunnySubstrings.Solution_0_Test(input);
