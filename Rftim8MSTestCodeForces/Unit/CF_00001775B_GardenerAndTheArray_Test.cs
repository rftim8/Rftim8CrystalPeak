...
{
    [TestClass]
    public sealed class CF_00001775B_GardenerAndTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001775B_GardenerAndTheArray));
        ...
        {
            bool result = CF_00001775B_GardenerAndTheArray.Solution_0_Test(input);
