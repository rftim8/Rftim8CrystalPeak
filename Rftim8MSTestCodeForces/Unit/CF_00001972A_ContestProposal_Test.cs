...
{
    [TestClass]
    public sealed class CF_00001972A_ContestProposal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001972A_ContestProposal));
        ...
        {
            bool result = CF_00001972A_ContestProposal.Solution_0_Test(input);
