...
{
    [TestClass]
    public sealed class CF_00000271B_PrimeMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000271B_PrimeMatrix));
        ...
        {
            bool result = CF_00000271B_PrimeMatrix.Solution_0_Test(input);
