...
{
    [TestClass]
    public sealed class CF_00000368B_SerejaAndSuffixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000368B_SerejaAndSuffixes));
        ...
        {
            bool result = CF_00000368B_SerejaAndSuffixes.Solution_0_Test(input);
