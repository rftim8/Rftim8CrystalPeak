...
{
    [TestClass]
    public sealed class CF_00000020C_Dijkstra_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000020C_Dijkstra));
        ...
        {
            bool result = CF_00000020C_Dijkstra.Solution_0_Test(input);
