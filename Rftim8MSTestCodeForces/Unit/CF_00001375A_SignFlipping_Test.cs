...
{
    [TestClass]
    public sealed class CF_00001375A_SignFlipping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001375A_SignFlipping));
        ...
        {
            bool result = CF_00001375A_SignFlipping.Solution_0_Test(input);
