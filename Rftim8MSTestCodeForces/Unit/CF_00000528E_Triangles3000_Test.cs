...
{
    [TestClass]
    public sealed class CF_00000528E_Triangles3000_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000528E_Triangles3000));
        ...
        {
            bool result = CF_00000528E_Triangles3000.Solution_0_Test(input);
