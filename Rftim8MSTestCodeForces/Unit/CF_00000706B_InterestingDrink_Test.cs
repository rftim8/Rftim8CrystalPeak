...
{
    [TestClass]
    public sealed class CF_00000706B_InterestingDrink_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000706B_InterestingDrink));
        ...
        {
            bool result = CF_00000706B_InterestingDrink.Solution_0_Test(input);
