...
{
    [TestClass]
    public sealed class CF_00000938G_ShortestPathQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000938G_ShortestPathQueries));
        ...
        {
            bool result = CF_00000938G_ShortestPathQueries.Solution_0_Test(input);
