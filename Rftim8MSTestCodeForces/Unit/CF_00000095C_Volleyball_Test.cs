...
{
    [TestClass]
    public sealed class CF_00000095C_Volleyball_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000095C_Volleyball));
        ...
        {
            bool result = CF_00000095C_Volleyball.Solution_0_Test(input);
