...
{
    [TestClass]
    public sealed class CF_00000091D_GrocersProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000091D_GrocersProblem));
        ...
        {
            bool result = CF_00000091D_GrocersProblem.Solution_0_Test(input);
