...
{
    [TestClass]
    public sealed class CF_00001578J_JustKingdom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001578J_JustKingdom));
        ...
        {
            bool result = CF_00001578J_JustKingdom.Solution_0_Test(input);
