...
{
    [TestClass]
    public sealed class CF_00001766E_Decomposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001766E_Decomposition));
        ...
        {
            bool result = CF_00001766E_Decomposition.Solution_0_Test(input);
