...
{
    [TestClass]
    public sealed class CF_00001609C_ComplexMarketAnalysis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001609C_ComplexMarketAnalysis));
        ...
        {
            bool result = CF_00001609C_ComplexMarketAnalysis.Solution_0_Test(input);
