...
{
    [TestClass]
    public sealed class CF_00001856D_MoreWrong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001856D_MoreWrong));
        ...
        {
            bool result = CF_00001856D_MoreWrong.Solution_0_Test(input);
