...
{
    [TestClass]
    public sealed class CF_00000098C_HelpGregTheDwarf_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000098C_HelpGregTheDwarf));
        ...
        {
            bool result = CF_00000098C_HelpGregTheDwarf.Solution_0_Test(input);
