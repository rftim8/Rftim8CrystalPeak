...
{
    [TestClass]
    public sealed class CF_00000543A_WritingCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000543A_WritingCode));
        ...
        {
            bool result = CF_00000543A_WritingCode.Solution_0_Test(input);
