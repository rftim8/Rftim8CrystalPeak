...
{
    [TestClass]
    public sealed class CF_00001789E_ServalAndMusicGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001789E_ServalAndMusicGame));
        ...
        {
            bool result = CF_00001789E_ServalAndMusicGame.Solution_0_Test(input);
