...
{
    [TestClass]
    public sealed class CF_00001514E_BabyEhabsHyperApartment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001514E_BabyEhabsHyperApartment));
        ...
        {
            bool result = CF_00001514E_BabyEhabsHyperApartment.Solution_0_Test(input);
