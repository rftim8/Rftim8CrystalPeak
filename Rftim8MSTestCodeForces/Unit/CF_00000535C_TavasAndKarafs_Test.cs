...
{
    [TestClass]
    public sealed class CF_00000535C_TavasAndKarafs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000535C_TavasAndKarafs));
        ...
        {
            bool result = CF_00000535C_TavasAndKarafs.Solution_0_Test(input);
