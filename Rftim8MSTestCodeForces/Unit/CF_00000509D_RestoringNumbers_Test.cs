...
{
    [TestClass]
    public sealed class CF_00000509D_RestoringNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000509D_RestoringNumbers));
        ...
        {
            bool result = CF_00000509D_RestoringNumbers.Solution_0_Test(input);
