...
{
    [TestClass]
    public sealed class CF_00000258E_LittleElephantAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000258E_LittleElephantAndTree));
        ...
        {
            bool result = CF_00000258E_LittleElephantAndTree.Solution_0_Test(input);
