...
{
    [TestClass]
    public sealed class CF_00000237E_BuildString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000237E_BuildString));
        ...
        {
            bool result = CF_00000237E_BuildString.Solution_0_Test(input);
