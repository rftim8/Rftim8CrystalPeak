...
{
    [TestClass]
    public sealed class CF_00001118E_YetAnotherBallProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001118E_YetAnotherBallProblem));
        ...
        {
            bool result = CF_00001118E_YetAnotherBallProblem.Solution_0_Test(input);
