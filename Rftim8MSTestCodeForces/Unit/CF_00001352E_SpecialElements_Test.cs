...
{
    [TestClass]
    public sealed class CF_00001352E_SpecialElements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001352E_SpecialElements));
        ...
        {
            bool result = CF_00001352E_SpecialElements.Solution_0_Test(input);
