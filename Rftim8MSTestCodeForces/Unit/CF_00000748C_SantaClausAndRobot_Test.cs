...
{
    [TestClass]
    public sealed class CF_00000748C_SantaClausAndRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000748C_SantaClausAndRobot));
        ...
        {
            bool result = CF_00000748C_SantaClausAndRobot.Solution_0_Test(input);
