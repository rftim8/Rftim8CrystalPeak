...
{
    [TestClass]
    public sealed class CF_00001776M_ParmigianaWithSeafood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001776M_ParmigianaWithSeafood));
        ...
        {
            bool result = CF_00001776M_ParmigianaWithSeafood.Solution_0_Test(input);
