...
{
    [TestClass]
    public sealed class CF_00001175C_Electrification_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001175C_Electrification));
        ...
        {
            bool result = CF_00001175C_Electrification.Solution_0_Test(input);
