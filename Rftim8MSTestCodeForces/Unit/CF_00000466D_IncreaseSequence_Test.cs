...
{
    [TestClass]
    public sealed class CF_00000466D_IncreaseSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000466D_IncreaseSequence));
        ...
        {
            bool result = CF_00000466D_IncreaseSequence.Solution_0_Test(input);
