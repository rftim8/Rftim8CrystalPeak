...
{
    [TestClass]
    public sealed class CF_00000975D_Ghosts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000975D_Ghosts));
        ...
        {
            bool result = CF_00000975D_Ghosts.Solution_0_Test(input);
