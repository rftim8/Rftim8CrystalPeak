...
{
    [TestClass]
    public sealed class CF_00000779A_PupilsRedistribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000779A_PupilsRedistribution));
        ...
        {
            bool result = CF_00000779A_PupilsRedistribution.Solution_0_Test(input);
