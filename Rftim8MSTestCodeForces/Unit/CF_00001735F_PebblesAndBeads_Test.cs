...
{
    [TestClass]
    public sealed class CF_00001735F_PebblesAndBeads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001735F_PebblesAndBeads));
        ...
        {
            bool result = CF_00001735F_PebblesAndBeads.Solution_0_Test(input);
