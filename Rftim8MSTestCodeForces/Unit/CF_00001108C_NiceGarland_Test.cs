...
{
    [TestClass]
    public sealed class CF_00001108C_NiceGarland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001108C_NiceGarland));
        ...
        {
            bool result = CF_00001108C_NiceGarland.Solution_0_Test(input);
