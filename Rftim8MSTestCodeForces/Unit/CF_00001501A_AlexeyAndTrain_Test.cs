...
{
    [TestClass]
    public sealed class CF_00001501A_AlexeyAndTrain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001501A_AlexeyAndTrain));
        ...
        {
            bool result = CF_00001501A_AlexeyAndTrain.Solution_0_Test(input);
