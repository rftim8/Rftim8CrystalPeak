...
{
    [TestClass]
    public sealed class CF_00001493C_KbeautifulStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001493C_KbeautifulStrings));
        ...
        {
            bool result = CF_00001493C_KbeautifulStrings.Solution_0_Test(input);
