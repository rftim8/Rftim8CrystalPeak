...
{
    [TestClass]
    public sealed class CF_00001994C_HungryGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001994C_HungryGames));
        ...
        {
            bool result = CF_00001994C_HungryGames.Solution_0_Test(input);
