...
{
    [TestClass]
    public sealed class CF_00001531A_SingerColor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001531A_SingerColor));
        ...
        {
            bool result = CF_00001531A_SingerColor.Solution_0_Test(input);
