...
{
    [TestClass]
    public sealed class CF_00001616A_IntegerDiversity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001616A_IntegerDiversity));
        ...
        {
            bool result = CF_00001616A_IntegerDiversity.Solution_0_Test(input);
