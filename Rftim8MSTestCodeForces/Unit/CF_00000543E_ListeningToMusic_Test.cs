...
{
    [TestClass]
    public sealed class CF_00000543E_ListeningToMusic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000543E_ListeningToMusic));
        ...
        {
            bool result = CF_00000543E_ListeningToMusic.Solution_0_Test(input);
