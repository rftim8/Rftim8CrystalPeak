...
{
    [TestClass]
    public sealed class CF_00001533H_Submatrices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001533H_Submatrices));
        ...
        {
            bool result = CF_00001533H_Submatrices.Solution_0_Test(input);
