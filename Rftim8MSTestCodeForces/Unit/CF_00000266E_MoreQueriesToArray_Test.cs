...
{
    [TestClass]
    public sealed class CF_00000266E_MoreQueriesToArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000266E_MoreQueriesToArray));
        ...
        {
            bool result = CF_00000266E_MoreQueriesToArray.Solution_0_Test(input);
