...
{
    [TestClass]
    public sealed class CF_00001689A_LexString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001689A_LexString));
        ...
        {
            bool result = CF_00001689A_LexString.Solution_0_Test(input);
