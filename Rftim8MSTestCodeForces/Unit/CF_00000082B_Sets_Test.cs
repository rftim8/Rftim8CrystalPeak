...
{
    [TestClass]
    public sealed class CF_00000082B_Sets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000082B_Sets));
        ...
        {
            bool result = CF_00000082B_Sets.Solution_0_Test(input);
