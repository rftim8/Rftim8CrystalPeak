...
{
    [TestClass]
    public sealed class CF_00001016F_RoadProjects_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001016F_RoadProjects));
        ...
        {
            bool result = CF_00001016F_RoadProjects.Solution_0_Test(input);
