...
{
    [TestClass]
    public sealed class CF_00000020B_Equation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000020B_Equation));
        ...
        {
            bool result = CF_00000020B_Equation.Solution_0_Test(input);
