...
{
    [TestClass]
    public sealed class CF_00001013A_PilesWithStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001013A_PilesWithStones));
        ...
        {
            bool result = CF_00001013A_PilesWithStones.Solution_0_Test(input);
