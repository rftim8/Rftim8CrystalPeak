...
{
    [TestClass]
    public sealed class CF_00000711B_ChrisAndMagicSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000711B_ChrisAndMagicSquare));
        ...
        {
            bool result = CF_00000711B_ChrisAndMagicSquare.Solution_0_Test(input);
