...
{
    [TestClass]
    public sealed class CF_00002032B_Medians_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002032B_Medians));
        ...
        {
            bool result = CF_00002032B_Medians.Solution_0_Test(input);
