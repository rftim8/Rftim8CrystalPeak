...
{
    [TestClass]
    public sealed class CF_00001528E_MashtaliAndHaghTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001528E_MashtaliAndHaghTrees));
        ...
        {
            bool result = CF_00001528E_MashtaliAndHaghTrees.Solution_0_Test(input);
