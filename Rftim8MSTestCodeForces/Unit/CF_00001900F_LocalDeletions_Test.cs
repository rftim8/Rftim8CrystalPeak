...
{
    [TestClass]
    public sealed class CF_00001900F_LocalDeletions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001900F_LocalDeletions));
        ...
        {
            bool result = CF_00001900F_LocalDeletions.Solution_0_Test(input);
