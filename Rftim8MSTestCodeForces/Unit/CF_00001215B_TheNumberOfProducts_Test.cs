...
{
    [TestClass]
    public sealed class CF_00001215B_TheNumberOfProducts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001215B_TheNumberOfProducts));
        ...
        {
            bool result = CF_00001215B_TheNumberOfProducts.Solution_0_Test(input);
