...
{
    [TestClass]
    public sealed class CF_00001754B_KevinAndPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001754B_KevinAndPermutation));
        ...
        {
            bool result = CF_00001754B_KevinAndPermutation.Solution_0_Test(input);
