...
{
    [TestClass]
    public sealed class CF_00001739F_KeyboardDesign_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001739F_KeyboardDesign));
        ...
        {
            bool result = CF_00001739F_KeyboardDesign.Solution_0_Test(input);
