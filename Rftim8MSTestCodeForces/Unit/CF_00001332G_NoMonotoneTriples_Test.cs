...
{
    [TestClass]
    public sealed class CF_00001332G_NoMonotoneTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001332G_NoMonotoneTriples));
        ...
        {
            bool result = CF_00001332G_NoMonotoneTriples.Solution_0_Test(input);
