...
{
    [TestClass]
    public sealed class CF_00001896E_PermutationSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001896E_PermutationSorting));
        ...
        {
            bool result = CF_00001896E_PermutationSorting.Solution_0_Test(input);
