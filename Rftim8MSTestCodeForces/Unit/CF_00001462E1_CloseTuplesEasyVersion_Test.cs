...
{
    [TestClass]
    public sealed class CF_00001462E1_CloseTuplesEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001462E1_CloseTuplesEasyVersion));
        ...
        {
            bool result = CF_00001462E1_CloseTuplesEasyVersion.Solution_0_Test(input);
