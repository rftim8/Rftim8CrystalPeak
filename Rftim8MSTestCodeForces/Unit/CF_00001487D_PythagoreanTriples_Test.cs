...
{
    [TestClass]
    public sealed class CF_00001487D_PythagoreanTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001487D_PythagoreanTriples));
        ...
        {
            bool result = CF_00001487D_PythagoreanTriples.Solution_0_Test(input);
