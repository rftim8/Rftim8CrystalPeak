...
{
    [TestClass]
    public sealed class CF_00001012F_Passports_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001012F_Passports));
        ...
        {
            bool result = CF_00001012F_Passports.Solution_0_Test(input);
