...
{
    [TestClass]
    public sealed class CF_00001543B_CustomisingTheTrack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001543B_CustomisingTheTrack));
        ...
        {
            bool result = CF_00001543B_CustomisingTheTrack.Solution_0_Test(input);
