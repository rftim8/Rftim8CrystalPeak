...
{
    [TestClass]
    public sealed class CF_00001003F_Abbreviation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001003F_Abbreviation));
        ...
        {
            bool result = CF_00001003F_Abbreviation.Solution_0_Test(input);
