...
{
    [TestClass]
    public sealed class CF_00000279B_Books_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000279B_Books));
        ...
        {
            bool result = CF_00000279B_Books.Solution_0_Test(input);
