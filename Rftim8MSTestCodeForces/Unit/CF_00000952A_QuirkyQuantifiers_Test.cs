...
{
    [TestClass]
    public sealed class CF_00000952A_QuirkyQuantifiers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000952A_QuirkyQuantifiers));
        ...
        {
            bool result = CF_00000952A_QuirkyQuantifiers.Solution_0_Test(input);
