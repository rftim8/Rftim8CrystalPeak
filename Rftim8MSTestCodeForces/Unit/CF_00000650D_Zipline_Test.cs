...
{
    [TestClass]
    public sealed class CF_00000650D_Zipline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000650D_Zipline));
        ...
        {
            bool result = CF_00000650D_Zipline.Solution_0_Test(input);
