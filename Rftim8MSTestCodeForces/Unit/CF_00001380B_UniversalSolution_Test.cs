...
{
    [TestClass]
    public sealed class CF_00001380B_UniversalSolution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001380B_UniversalSolution));
        ...
        {
            bool result = CF_00001380B_UniversalSolution.Solution_0_Test(input);
