...
{
    [TestClass]
    public sealed class CF_00000977C_LessOrEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000977C_LessOrEqual));
        ...
        {
            bool result = CF_00000977C_LessOrEqual.Solution_0_Test(input);
