...
{
    [TestClass]
    public sealed class CF_00001312E_ArrayShrinking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001312E_ArrayShrinking));
        ...
        {
            bool result = CF_00001312E_ArrayShrinking.Solution_0_Test(input);
