...
{
    [TestClass]
    public sealed class CF_00000774A_AmusementPark_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774A_AmusementPark));
        ...
        {
            bool result = CF_00000774A_AmusementPark.Solution_0_Test(input);
