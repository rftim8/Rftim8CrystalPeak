...
{
    [TestClass]
    public sealed class CF_00000374A_InnaAndPinkPony_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000374A_InnaAndPinkPony));
        ...
        {
            bool result = CF_00000374A_InnaAndPinkPony.Solution_0_Test(input);
