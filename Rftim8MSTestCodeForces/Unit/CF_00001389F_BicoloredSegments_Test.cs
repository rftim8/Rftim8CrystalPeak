...
{
    [TestClass]
    public sealed class CF_00001389F_BicoloredSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001389F_BicoloredSegments));
        ...
        {
            bool result = CF_00001389F_BicoloredSegments.Solution_0_Test(input);
