...
{
    [TestClass]
    public sealed class CF_00000825B_FiveInaRow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000825B_FiveInaRow));
        ...
        {
            bool result = CF_00000825B_FiveInaRow.Solution_0_Test(input);
