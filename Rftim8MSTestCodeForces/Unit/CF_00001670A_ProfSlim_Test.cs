...
{
    [TestClass]
    public sealed class CF_00001670A_ProfSlim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001670A_ProfSlim));
        ...
        {
            bool result = CF_00001670A_ProfSlim.Solution_0_Test(input);
