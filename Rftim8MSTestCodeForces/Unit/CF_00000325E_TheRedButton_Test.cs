...
{
    [TestClass]
    public sealed class CF_00000325E_TheRedButton_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000325E_TheRedButton));
        ...
        {
            bool result = CF_00000325E_TheRedButton.Solution_0_Test(input);
