...
{
    [TestClass]
    public sealed class CF_00000620E_NewYearTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000620E_NewYearTree));
        ...
        {
            bool result = CF_00000620E_NewYearTree.Solution_0_Test(input);
