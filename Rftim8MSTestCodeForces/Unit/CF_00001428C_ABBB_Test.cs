...
{
    [TestClass]
    public sealed class CF_00001428C_ABBB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001428C_ABBB));
        ...
        {
            bool result = CF_00001428C_ABBB.Solution_0_Test(input);
