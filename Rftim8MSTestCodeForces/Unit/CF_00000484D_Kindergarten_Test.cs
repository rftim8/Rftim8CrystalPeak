...
{
    [TestClass]
    public sealed class CF_00000484D_Kindergarten_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000484D_Kindergarten));
        ...
        {
            bool result = CF_00000484D_Kindergarten.Solution_0_Test(input);
