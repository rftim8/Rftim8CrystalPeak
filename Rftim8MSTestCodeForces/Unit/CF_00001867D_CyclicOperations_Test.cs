...
{
    [TestClass]
    public sealed class CF_00001867D_CyclicOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001867D_CyclicOperations));
        ...
        {
            bool result = CF_00001867D_CyclicOperations.Solution_0_Test(input);
