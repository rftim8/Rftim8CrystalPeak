...
{
    [TestClass]
    public sealed class CF_00001817C_SimilarPolynomials_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001817C_SimilarPolynomials));
        ...
        {
            bool result = CF_00001817C_SimilarPolynomials.Solution_0_Test(input);
