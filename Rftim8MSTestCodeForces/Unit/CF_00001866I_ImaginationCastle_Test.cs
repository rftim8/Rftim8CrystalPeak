...
{
    [TestClass]
    public sealed class CF_00001866I_ImaginationCastle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001866I_ImaginationCastle));
        ...
        {
            bool result = CF_00001866I_ImaginationCastle.Solution_0_Test(input);
