...
{
    [TestClass]
    public sealed class CF_00000338D_GCDTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000338D_GCDTable));
        ...
        {
            bool result = CF_00000338D_GCDTable.Solution_0_Test(input);
