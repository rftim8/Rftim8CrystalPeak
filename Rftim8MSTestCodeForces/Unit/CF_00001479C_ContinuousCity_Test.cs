...
{
    [TestClass]
    public sealed class CF_00001479C_ContinuousCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001479C_ContinuousCity));
        ...
        {
            bool result = CF_00001479C_ContinuousCity.Solution_0_Test(input);
