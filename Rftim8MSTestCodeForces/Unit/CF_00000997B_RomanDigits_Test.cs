...
{
    [TestClass]
    public sealed class CF_00000997B_RomanDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000997B_RomanDigits));
        ...
        {
            bool result = CF_00000997B_RomanDigits.Solution_0_Test(input);
