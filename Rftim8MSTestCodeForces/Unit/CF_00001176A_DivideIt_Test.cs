...
{
    [TestClass]
    public sealed class CF_00001176A_DivideIt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001176A_DivideIt));
        ...
        {
            bool result = CF_00001176A_DivideIt.Solution_0_Test(input);
