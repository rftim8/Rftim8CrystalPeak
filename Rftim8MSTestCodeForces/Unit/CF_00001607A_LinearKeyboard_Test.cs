...
{
    [TestClass]
    public sealed class CF_00001607A_LinearKeyboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001607A_LinearKeyboard));
        ...
        {
            bool result = CF_00001607A_LinearKeyboard.Solution_0_Test(input);
