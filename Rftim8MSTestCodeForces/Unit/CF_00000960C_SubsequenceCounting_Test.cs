...
{
    [TestClass]
    public sealed class CF_00000960C_SubsequenceCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000960C_SubsequenceCounting));
        ...
        {
            bool result = CF_00000960C_SubsequenceCounting.Solution_0_Test(input);
