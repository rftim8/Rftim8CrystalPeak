...
{
    [TestClass]
    public sealed class CF_00001400G_Mercenaries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001400G_Mercenaries));
        ...
        {
            bool result = CF_00001400G_Mercenaries.Solution_0_Test(input);
