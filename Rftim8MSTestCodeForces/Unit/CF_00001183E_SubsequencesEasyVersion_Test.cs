...
{
    [TestClass]
    public sealed class CF_00001183E_SubsequencesEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001183E_SubsequencesEasyVersion));
        ...
        {
            bool result = CF_00001183E_SubsequencesEasyVersion.Solution_0_Test(input);
