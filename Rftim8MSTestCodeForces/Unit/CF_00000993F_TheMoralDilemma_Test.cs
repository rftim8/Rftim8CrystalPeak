...
{
    [TestClass]
    public sealed class CF_00000993F_TheMoralDilemma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000993F_TheMoralDilemma));
        ...
        {
            bool result = CF_00000993F_TheMoralDilemma.Solution_0_Test(input);
