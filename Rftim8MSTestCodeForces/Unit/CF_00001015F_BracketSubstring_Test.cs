...
{
    [TestClass]
    public sealed class CF_00001015F_BracketSubstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001015F_BracketSubstring));
        ...
        {
            bool result = CF_00001015F_BracketSubstring.Solution_0_Test(input);
