...
{
    [TestClass]
    public sealed class CF_00000103A_TestingPantsForSadness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000103A_TestingPantsForSadness));
        ...
        {
            bool result = CF_00000103A_TestingPantsForSadness.Solution_0_Test(input);
