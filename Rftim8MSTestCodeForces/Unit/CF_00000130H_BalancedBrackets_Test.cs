...
{
    [TestClass]
    public sealed class CF_00000130H_BalancedBrackets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000130H_BalancedBrackets));
        ...
        {
            bool result = CF_00000130H_BalancedBrackets.Solution_0_Test(input);
