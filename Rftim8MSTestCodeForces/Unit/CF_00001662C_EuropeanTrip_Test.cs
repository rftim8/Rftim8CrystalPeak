...
{
    [TestClass]
    public sealed class CF_00001662C_EuropeanTrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662C_EuropeanTrip));
        ...
        {
            bool result = CF_00001662C_EuropeanTrip.Solution_0_Test(input);
