...
{
    [TestClass]
    public sealed class CF_00001931G_OneDimensionalPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001931G_OneDimensionalPuzzle));
        ...
        {
            bool result = CF_00001931G_OneDimensionalPuzzle.Solution_0_Test(input);
