...
{
    [TestClass]
    public sealed class CF_00000722C_DestroyingArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000722C_DestroyingArray));
        ...
        {
            bool result = CF_00000722C_DestroyingArray.Solution_0_Test(input);
