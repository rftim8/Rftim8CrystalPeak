...
{
    [TestClass]
    public sealed class CF_00000175E_PowerDefence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000175E_PowerDefence));
        ...
        {
            bool result = CF_00000175E_PowerDefence.Solution_0_Test(input);
