...
{
    [TestClass]
    public sealed class CF_00001209H_MovingWalkways_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001209H_MovingWalkways));
        ...
        {
            bool result = CF_00001209H_MovingWalkways.Solution_0_Test(input);
