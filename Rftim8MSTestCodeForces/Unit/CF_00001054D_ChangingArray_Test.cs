...
{
    [TestClass]
    public sealed class CF_00001054D_ChangingArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001054D_ChangingArray));
        ...
        {
            bool result = CF_00001054D_ChangingArray.Solution_0_Test(input);
