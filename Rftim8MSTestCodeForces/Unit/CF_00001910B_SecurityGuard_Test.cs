...
{
    [TestClass]
    public sealed class CF_00001910B_SecurityGuard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001910B_SecurityGuard));
        ...
        {
            bool result = CF_00001910B_SecurityGuard.Solution_0_Test(input);
