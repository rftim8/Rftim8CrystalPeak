...
{
    [TestClass]
    public sealed class CF_00000895E_EyesClosed_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000895E_EyesClosed));
        ...
        {
            bool result = CF_00000895E_EyesClosed.Solution_0_Test(input);
