...
{
    [TestClass]
    public sealed class CF_00000183C_CyclicColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000183C_CyclicColoring));
        ...
        {
            bool result = CF_00000183C_CyclicColoring.Solution_0_Test(input);
