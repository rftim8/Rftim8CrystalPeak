...
{
    [TestClass]
    public sealed class CF_00002038B_MakeItEqual_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002038B_MakeItEqual));
        ...
        {
            bool result = CF_00002038B_MakeItEqual.Solution_0_Test(input);
