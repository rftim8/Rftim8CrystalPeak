...
{
    [TestClass]
    public sealed class CF_00001808B_PlayingInACasino_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001808B_PlayingInACasino));
        ...
        {
            bool result = CF_00001808B_PlayingInACasino.Solution_0_Test(input);
