...
{
    [TestClass]
    public sealed class CF_00000797E_ArrayQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000797E_ArrayQueries));
        ...
        {
            bool result = CF_00000797E_ArrayQueries.Solution_0_Test(input);
