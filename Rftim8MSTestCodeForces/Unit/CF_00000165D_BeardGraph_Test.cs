...
{
    [TestClass]
    public sealed class CF_00000165D_BeardGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000165D_BeardGraph));
        ...
        {
            bool result = CF_00000165D_BeardGraph.Solution_0_Test(input);
