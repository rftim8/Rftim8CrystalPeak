...
{
    [TestClass]
    public sealed class CF_00000571B_Minimization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000571B_Minimization));
        ...
        {
            bool result = CF_00000571B_Minimization.Solution_0_Test(input);
