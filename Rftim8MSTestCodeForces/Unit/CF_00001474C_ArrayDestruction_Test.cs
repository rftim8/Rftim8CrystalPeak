...
{
    [TestClass]
    public sealed class CF_00001474C_ArrayDestruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001474C_ArrayDestruction));
        ...
        {
            bool result = CF_00001474C_ArrayDestruction.Solution_0_Test(input);
