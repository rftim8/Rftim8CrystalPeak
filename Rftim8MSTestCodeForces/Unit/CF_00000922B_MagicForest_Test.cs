...
{
    [TestClass]
    public sealed class CF_00000922B_MagicForest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000922B_MagicForest));
        ...
        {
            bool result = CF_00000922B_MagicForest.Solution_0_Test(input);
