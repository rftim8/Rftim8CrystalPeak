...
{
    [TestClass]
    public sealed class CF_00000990G_GCDCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000990G_GCDCounting));
        ...
        {
            bool result = CF_00000990G_GCDCounting.Solution_0_Test(input);
