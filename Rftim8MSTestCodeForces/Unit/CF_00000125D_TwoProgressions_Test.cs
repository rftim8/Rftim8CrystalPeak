...
{
    [TestClass]
    public sealed class CF_00000125D_TwoProgressions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000125D_TwoProgressions));
        ...
        {
            bool result = CF_00000125D_TwoProgressions.Solution_0_Test(input);
