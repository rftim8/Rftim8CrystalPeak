...
{
    [TestClass]
    public sealed class CF_00002043C_SumsOnSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002043C_SumsOnSegments));
        ...
        {
            bool result = CF_00002043C_SumsOnSegments.Solution_0_Test(input);
