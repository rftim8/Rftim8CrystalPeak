...
{
    [TestClass]
    public sealed class CF_00000467B_FedorAndNewGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000467B_FedorAndNewGame));
        ...
        {
            bool result = CF_00000467B_FedorAndNewGame.Solution_0_Test(input);
