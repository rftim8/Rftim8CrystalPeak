...
{
    [TestClass]
    public sealed class CF_00001508B_AlmostSorted_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001508B_AlmostSorted));
        ...
        {
            bool result = CF_00001508B_AlmostSorted.Solution_0_Test(input);
