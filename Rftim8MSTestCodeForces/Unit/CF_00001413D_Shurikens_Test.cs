...
{
    [TestClass]
    public sealed class CF_00001413D_Shurikens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001413D_Shurikens));
        ...
        {
            bool result = CF_00001413D_Shurikens.Solution_0_Test(input);
