...
{
    [TestClass]
    public sealed class CF_00001093A_DiceRolling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001093A_DiceRolling));
        ...
        {
            bool result = CF_00001093A_DiceRolling.Solution_0_Test(input);
