...
{
    [TestClass]
    public sealed class CF_00001257F_MakeThemSimilar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001257F_MakeThemSimilar));
        ...
        {
            bool result = CF_00001257F_MakeThemSimilar.Solution_0_Test(input);
