...
{
    [TestClass]
    public sealed class CF_00001037H_Security_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001037H_Security));
        ...
        {
            bool result = CF_00001037H_Security.Solution_0_Test(input);
