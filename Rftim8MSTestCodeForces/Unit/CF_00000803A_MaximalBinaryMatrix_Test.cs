...
{
    [TestClass]
    public sealed class CF_00000803A_MaximalBinaryMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000803A_MaximalBinaryMatrix));
        ...
        {
            bool result = CF_00000803A_MaximalBinaryMatrix.Solution_0_Test(input);
