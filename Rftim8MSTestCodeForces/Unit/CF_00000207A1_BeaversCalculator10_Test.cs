...
{
    [TestClass]
    public sealed class CF_00000207A1_BeaversCalculator10_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000207A1_BeaversCalculator10));
        ...
        {
            bool result = CF_00000207A1_BeaversCalculator10.Solution_0_Test(input);
