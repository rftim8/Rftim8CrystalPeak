...
{
    [TestClass]
    public sealed class CF_00001476F_Lanterns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001476F_Lanterns));
        ...
        {
            bool result = CF_00001476F_Lanterns.Solution_0_Test(input);
