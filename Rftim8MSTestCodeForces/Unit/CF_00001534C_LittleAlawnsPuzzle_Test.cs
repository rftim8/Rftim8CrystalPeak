...
{
    [TestClass]
    public sealed class CF_00001534C_LittleAlawnsPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001534C_LittleAlawnsPuzzle));
        ...
        {
            bool result = CF_00001534C_LittleAlawnsPuzzle.Solution_0_Test(input);
