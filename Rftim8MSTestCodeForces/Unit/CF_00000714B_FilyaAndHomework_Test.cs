...
{
    [TestClass]
    public sealed class CF_00000714B_FilyaAndHomework_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000714B_FilyaAndHomework));
        ...
        {
            bool result = CF_00000714B_FilyaAndHomework.Solution_0_Test(input);
