...
{
    [TestClass]
    public sealed class CF_00000253C_TextEditor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000253C_TextEditor));
        ...
        {
            bool result = CF_00000253C_TextEditor.Solution_0_Test(input);
