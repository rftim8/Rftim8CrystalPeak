...
{
    [TestClass]
    public sealed class CF_00000286D_Tourists_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000286D_Tourists));
        ...
        {
            bool result = CF_00000286D_Tourists.Solution_0_Test(input);
