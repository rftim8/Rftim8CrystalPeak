...
{
    [TestClass]
    public sealed class CF_00001948E_CliquePartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001948E_CliquePartition));
        ...
        {
            bool result = CF_00001948E_CliquePartition.Solution_0_Test(input);
