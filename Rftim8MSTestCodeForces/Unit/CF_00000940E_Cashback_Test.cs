...
{
    [TestClass]
    public sealed class CF_00000940E_Cashback_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000940E_Cashback));
        ...
        {
            bool result = CF_00000940E_Cashback.Solution_0_Test(input);
