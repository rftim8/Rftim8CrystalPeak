...
{
    [TestClass]
    public sealed class CF_00001418E_ExpectedDamage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001418E_ExpectedDamage));
        ...
        {
            bool result = CF_00001418E_ExpectedDamage.Solution_0_Test(input);
