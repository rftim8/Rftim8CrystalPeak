...
{
    [TestClass]
    public sealed class CF_00000309A_MorningRun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000309A_MorningRun));
        ...
        {
            bool result = CF_00000309A_MorningRun.Solution_0_Test(input);
