...
{
    [TestClass]
    public sealed class CF_00000448B_SuffixStructures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000448B_SuffixStructures));
        ...
        {
            bool result = CF_00000448B_SuffixStructures.Solution_0_Test(input);
