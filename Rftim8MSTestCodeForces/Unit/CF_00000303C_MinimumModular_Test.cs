...
{
    [TestClass]
    public sealed class CF_00000303C_MinimumModular_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000303C_MinimumModular));
        ...
        {
            bool result = CF_00000303C_MinimumModular.Solution_0_Test(input);
