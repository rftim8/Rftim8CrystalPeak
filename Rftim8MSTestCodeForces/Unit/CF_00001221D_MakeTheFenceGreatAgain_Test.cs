...
{
    [TestClass]
    public sealed class CF_00001221D_MakeTheFenceGreatAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001221D_MakeTheFenceGreatAgain));
        ...
        {
            bool result = CF_00001221D_MakeTheFenceGreatAgain.Solution_0_Test(input);
