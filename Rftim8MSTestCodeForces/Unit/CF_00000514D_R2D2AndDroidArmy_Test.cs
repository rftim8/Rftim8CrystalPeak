...
{
    [TestClass]
    public sealed class CF_00000514D_R2D2AndDroidArmy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000514D_R2D2AndDroidArmy));
        ...
        {
            bool result = CF_00000514D_R2D2AndDroidArmy.Solution_0_Test(input);
