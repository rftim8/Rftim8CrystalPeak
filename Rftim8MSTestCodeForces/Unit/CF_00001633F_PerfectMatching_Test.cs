...
{
    [TestClass]
    public sealed class CF_00001633F_PerfectMatching_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001633F_PerfectMatching));
        ...
        {
            bool result = CF_00001633F_PerfectMatching.Solution_0_Test(input);
