...
{
    [TestClass]
    public sealed class CF_00000576E_PaintingEdges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000576E_PaintingEdges));
        ...
        {
            bool result = CF_00000576E_PaintingEdges.Solution_0_Test(input);
