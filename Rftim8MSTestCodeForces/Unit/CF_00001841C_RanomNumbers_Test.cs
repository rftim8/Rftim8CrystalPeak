...
{
    [TestClass]
    public sealed class CF_00001841C_RanomNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001841C_RanomNumbers));
        ...
        {
            bool result = CF_00001841C_RanomNumbers.Solution_0_Test(input);
