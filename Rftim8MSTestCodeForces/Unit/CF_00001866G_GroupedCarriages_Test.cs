...
{
    [TestClass]
    public sealed class CF_00001866G_GroupedCarriages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001866G_GroupedCarriages));
        ...
        {
            bool result = CF_00001866G_GroupedCarriages.Solution_0_Test(input);
