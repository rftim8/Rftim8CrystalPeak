...
{
    [TestClass]
    public sealed class CF_00001044B_IntersectingSubtrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001044B_IntersectingSubtrees));
        ...
        {
            bool result = CF_00001044B_IntersectingSubtrees.Solution_0_Test(input);
