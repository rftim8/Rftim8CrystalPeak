...
{
    [TestClass]
    public sealed class CF_00000873E_AwardsForContestants_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000873E_AwardsForContestants));
        ...
        {
            bool result = CF_00000873E_AwardsForContestants.Solution_0_Test(input);
