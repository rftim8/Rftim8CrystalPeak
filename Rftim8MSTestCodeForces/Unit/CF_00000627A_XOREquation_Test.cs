...
{
    [TestClass]
    public sealed class CF_00000627A_XOREquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000627A_XOREquation));
        ...
        {
            bool result = CF_00000627A_XOREquation.Solution_0_Test(input);
