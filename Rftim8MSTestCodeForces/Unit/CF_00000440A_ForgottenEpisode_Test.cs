...
{
    [TestClass]
    public sealed class CF_00000440A_ForgottenEpisode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000440A_ForgottenEpisode));
        ...
        {
            bool result = CF_00000440A_ForgottenEpisode.Solution_0_Test(input);
