...
{
    [TestClass]
    public sealed class CF_00001037F_MaximumReduction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001037F_MaximumReduction));
        ...
        {
            bool result = CF_00001037F_MaximumReduction.Solution_0_Test(input);
