...
{
    [TestClass]
    public sealed class CF_00001369A_FashionabLee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001369A_FashionabLee));
        ...
        {
            bool result = CF_00001369A_FashionabLee.Solution_0_Test(input);
