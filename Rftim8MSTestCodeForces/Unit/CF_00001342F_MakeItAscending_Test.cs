...
{
    [TestClass]
    public sealed class CF_00001342F_MakeItAscending_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001342F_MakeItAscending));
        ...
        {
            bool result = CF_00001342F_MakeItAscending.Solution_0_Test(input);
