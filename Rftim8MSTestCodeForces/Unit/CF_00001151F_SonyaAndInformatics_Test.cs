...
{
    [TestClass]
    public sealed class CF_00001151F_SonyaAndInformatics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001151F_SonyaAndInformatics));
        ...
        {
            bool result = CF_00001151F_SonyaAndInformatics.Solution_0_Test(input);
