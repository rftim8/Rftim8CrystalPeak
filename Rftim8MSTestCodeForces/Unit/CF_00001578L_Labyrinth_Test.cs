...
{
    [TestClass]
    public sealed class CF_00001578L_Labyrinth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001578L_Labyrinth));
        ...
        {
            bool result = CF_00001578L_Labyrinth.Solution_0_Test(input);
