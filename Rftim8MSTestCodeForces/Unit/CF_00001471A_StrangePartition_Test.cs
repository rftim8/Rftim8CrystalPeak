...
{
    [TestClass]
    public sealed class CF_00001471A_StrangePartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001471A_StrangePartition));
        ...
        {
            bool result = CF_00001471A_StrangePartition.Solution_0_Test(input);
