...
{
    [TestClass]
    public sealed class CF_00001266H_RedBlueGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001266H_RedBlueGraph));
        ...
        {
            bool result = CF_00001266H_RedBlueGraph.Solution_0_Test(input);
