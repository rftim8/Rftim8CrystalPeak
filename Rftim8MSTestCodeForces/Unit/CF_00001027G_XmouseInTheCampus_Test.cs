...
{
    [TestClass]
    public sealed class CF_00001027G_XmouseInTheCampus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001027G_XmouseInTheCampus));
        ...
        {
            bool result = CF_00001027G_XmouseInTheCampus.Solution_0_Test(input);
