...
{
    [TestClass]
    public sealed class CF_00001145A_ThanosSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001145A_ThanosSort));
        ...
        {
            bool result = CF_00001145A_ThanosSort.Solution_0_Test(input);
