...
{
    [TestClass]
    public sealed class CF_00000148E_Porcelain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000148E_Porcelain));
        ...
        {
            bool result = CF_00000148E_Porcelain.Solution_0_Test(input);
