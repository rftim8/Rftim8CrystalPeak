...
{
    [TestClass]
    public sealed class CF_00001982D_BeautyOfTheMountains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001982D_BeautyOfTheMountains));
        ...
        {
            bool result = CF_00001982D_BeautyOfTheMountains.Solution_0_Test(input);
