...
{
    [TestClass]
    public sealed class CF_00002008C_LongestGoodArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002008C_LongestGoodArray));
        ...
        {
            bool result = CF_00002008C_LongestGoodArray.Solution_0_Test(input);
