...
{
    [TestClass]
    public sealed class CF_00001822D_SuperPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001822D_SuperPermutation));
        ...
        {
            bool result = CF_00001822D_SuperPermutation.Solution_0_Test(input);
