...
{
    [TestClass]
    public sealed class CF_00001730A_Planets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001730A_Planets));
        ...
        {
            bool result = CF_00001730A_Planets.Solution_0_Test(input);
