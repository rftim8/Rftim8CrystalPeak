...
{
    [TestClass]
    public sealed class CF_00001954C_LongMultiplication_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001954C_LongMultiplication));
        ...
        {
            bool result = CF_00001954C_LongMultiplication.Solution_0_Test(input);
