...
{
    [TestClass]
    public sealed class CF_00000957A_TritonicIridescence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000957A_TritonicIridescence));
        ...
        {
            bool result = CF_00000957A_TritonicIridescence.Solution_0_Test(input);
