...
{
    [TestClass]
    public sealed class CF_00001945G_CookAndPorridge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001945G_CookAndPorridge));
        ...
        {
            bool result = CF_00001945G_CookAndPorridge.Solution_0_Test(input);
