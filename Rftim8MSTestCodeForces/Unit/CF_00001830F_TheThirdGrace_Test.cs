...
{
    [TestClass]
    public sealed class CF_00001830F_TheThirdGrace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001830F_TheThirdGrace));
        ...
        {
            bool result = CF_00001830F_TheThirdGrace.Solution_0_Test(input);
