...
{
    [TestClass]
    public sealed class CF_00001675A_FoodForAnimals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001675A_FoodForAnimals));
        ...
        {
            bool result = CF_00001675A_FoodForAnimals.Solution_0_Test(input);
