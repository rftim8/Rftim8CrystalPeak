...
{
    [TestClass]
    public sealed class CF_00001898B_MilenaAndAdmirer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001898B_MilenaAndAdmirer));
        ...
        {
            bool result = CF_00001898B_MilenaAndAdmirer.Solution_0_Test(input);
