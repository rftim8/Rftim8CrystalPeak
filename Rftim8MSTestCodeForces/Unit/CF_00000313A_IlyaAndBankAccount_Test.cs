...
{
    [TestClass]
    public sealed class CF_00000313A_IlyaAndBankAccount_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000313A_IlyaAndBankAccount));
        ...
        {
            bool result = CF_00000313A_IlyaAndBankAccount.Solution_0_Test(input);
