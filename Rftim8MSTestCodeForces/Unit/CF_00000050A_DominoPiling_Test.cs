...
{
    [TestClass]
    public sealed class CF_00000050A_DominoPiling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000050A_DominoPiling));
        ...
        {
            bool result = CF_00000050A_DominoPiling.Solution_0_Test(input);
