...
{
    [TestClass]
    public sealed class CF_00001452F_DividePowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001452F_DividePowers));
        ...
        {
            bool result = CF_00001452F_DividePowers.Solution_0_Test(input);
