...
{
    [TestClass]
    public sealed class CF_00000124A_TheNumberOfPositions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000124A_TheNumberOfPositions));
        ...
        {
            bool result = CF_00000124A_TheNumberOfPositions.Solution_0_Test(input);
