...
{
    [TestClass]
    public sealed class CF_00000958B1_MaximumControlEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958B1_MaximumControlEasy));
        ...
        {
            bool result = CF_00000958B1_MaximumControlEasy.Solution_0_Test(input);
