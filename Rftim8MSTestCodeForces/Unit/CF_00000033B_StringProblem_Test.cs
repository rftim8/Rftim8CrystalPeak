...
{
    [TestClass]
    public sealed class CF_00000033B_StringProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000033B_StringProblem));
        ...
        {
            bool result = CF_00000033B_StringProblem.Solution_0_Test(input);
