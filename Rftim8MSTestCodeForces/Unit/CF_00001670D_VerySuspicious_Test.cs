...
{
    [TestClass]
    public sealed class CF_00001670D_VerySuspicious_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001670D_VerySuspicious));
        ...
        {
            bool result = CF_00001670D_VerySuspicious.Solution_0_Test(input);
