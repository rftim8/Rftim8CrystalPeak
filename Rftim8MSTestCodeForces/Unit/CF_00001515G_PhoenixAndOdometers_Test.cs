...
{
    [TestClass]
    public sealed class CF_00001515G_PhoenixAndOdometers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001515G_PhoenixAndOdometers));
        ...
        {
            bool result = CF_00001515G_PhoenixAndOdometers.Solution_0_Test(input);
