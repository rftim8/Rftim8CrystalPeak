...
{
    [TestClass]
    public sealed class CF_00000530E_SumAndProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000530E_SumAndProduct));
        ...
        {
            bool result = CF_00000530E_SumAndProduct.Solution_0_Test(input);
