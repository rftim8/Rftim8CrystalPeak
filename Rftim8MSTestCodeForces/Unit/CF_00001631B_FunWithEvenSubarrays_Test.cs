...
{
    [TestClass]
    public sealed class CF_00001631B_FunWithEvenSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001631B_FunWithEvenSubarrays));
        ...
        {
            bool result = CF_00001631B_FunWithEvenSubarrays.Solution_0_Test(input);
