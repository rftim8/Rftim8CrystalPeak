...
{
    [TestClass]
    public sealed class CF_00001663H_CrossLanguageProgram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001663H_CrossLanguageProgram));
        ...
        {
            bool result = CF_00001663H_CrossLanguageProgram.Solution_0_Test(input);
