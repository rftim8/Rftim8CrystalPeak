...
{
    [TestClass]
    public sealed class CF_00001762C_BinaryStringsAreFun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001762C_BinaryStringsAreFun));
        ...
        {
            bool result = CF_00001762C_BinaryStringsAreFun.Solution_0_Test(input);
