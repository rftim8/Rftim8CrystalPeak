...
{
    [TestClass]
    public sealed class CF_00001857C_AssemblyViaMinimums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001857C_AssemblyViaMinimums));
        ...
        {
            bool result = CF_00001857C_AssemblyViaMinimums.Solution_0_Test(input);
