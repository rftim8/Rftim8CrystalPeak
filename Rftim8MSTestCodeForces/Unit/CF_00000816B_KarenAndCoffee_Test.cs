...
{
    [TestClass]
    public sealed class CF_00000816B_KarenAndCoffee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000816B_KarenAndCoffee));
        ...
        {
            bool result = CF_00000816B_KarenAndCoffee.Solution_0_Test(input);
