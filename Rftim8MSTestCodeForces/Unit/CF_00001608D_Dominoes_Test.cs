...
{
    [TestClass]
    public sealed class CF_00001608D_Dominoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001608D_Dominoes));
        ...
        {
            bool result = CF_00001608D_Dominoes.Solution_0_Test(input);
