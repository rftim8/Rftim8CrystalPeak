...
{
    [TestClass]
    public sealed class CF_00000690C3_BrainNetworkHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690C3_BrainNetworkHard));
        ...
        {
            bool result = CF_00000690C3_BrainNetworkHard.Solution_0_Test(input);
