...
{
    [TestClass]
    public sealed class CF_00000963A_AlternatingSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000963A_AlternatingSum));
        ...
        {
            bool result = CF_00000963A_AlternatingSum.Solution_0_Test(input);
