...
{
    [TestClass]
    public sealed class CF_00001394C_BoboniuAndString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001394C_BoboniuAndString));
        ...
        {
            bool result = CF_00001394C_BoboniuAndString.Solution_0_Test(input);
