...
{
    [TestClass]
    public sealed class CF_00001527E_PartitionGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001527E_PartitionGame));
        ...
        {
            bool result = CF_00001527E_PartitionGame.Solution_0_Test(input);
