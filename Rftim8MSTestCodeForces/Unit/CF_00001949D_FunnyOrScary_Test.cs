...
{
    [TestClass]
    public sealed class CF_00001949D_FunnyOrScary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001949D_FunnyOrScary));
        ...
        {
            bool result = CF_00001949D_FunnyOrScary.Solution_0_Test(input);
