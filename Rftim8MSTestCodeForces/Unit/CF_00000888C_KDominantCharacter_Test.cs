...
{
    [TestClass]
    public sealed class CF_00000888C_KDominantCharacter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000888C_KDominantCharacter));
        ...
        {
            bool result = CF_00000888C_KDominantCharacter.Solution_0_Test(input);
