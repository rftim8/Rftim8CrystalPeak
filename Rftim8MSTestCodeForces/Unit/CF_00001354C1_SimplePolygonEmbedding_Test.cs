...
{
    [TestClass]
    public sealed class CF_00001354C1_SimplePolygonEmbedding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001354C1_SimplePolygonEmbedding));
        ...
        {
            bool result = CF_00001354C1_SimplePolygonEmbedding.Solution_0_Test(input);
