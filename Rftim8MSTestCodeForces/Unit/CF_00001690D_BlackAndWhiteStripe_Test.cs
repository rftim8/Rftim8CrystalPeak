...
{
    [TestClass]
    public sealed class CF_00001690D_BlackAndWhiteStripe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001690D_BlackAndWhiteStripe));
        ...
        {
            bool result = CF_00001690D_BlackAndWhiteStripe.Solution_0_Test(input);
