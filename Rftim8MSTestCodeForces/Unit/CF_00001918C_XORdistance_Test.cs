...
{
    [TestClass]
    public sealed class CF_00001918C_XORdistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001918C_XORdistance));
        ...
        {
            bool result = CF_00001918C_XORdistance.Solution_0_Test(input);
