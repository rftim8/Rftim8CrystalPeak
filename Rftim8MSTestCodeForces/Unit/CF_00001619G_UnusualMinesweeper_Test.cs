...
{
    [TestClass]
    public sealed class CF_00001619G_UnusualMinesweeper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001619G_UnusualMinesweeper));
        ...
        {
            bool result = CF_00001619G_UnusualMinesweeper.Solution_0_Test(input);
