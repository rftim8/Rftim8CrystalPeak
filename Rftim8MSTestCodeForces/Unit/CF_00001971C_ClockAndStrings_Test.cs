...
{
    [TestClass]
    public sealed class CF_00001971C_ClockAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001971C_ClockAndStrings));
        ...
        {
            bool result = CF_00001971C_ClockAndStrings.Solution_0_Test(input);
