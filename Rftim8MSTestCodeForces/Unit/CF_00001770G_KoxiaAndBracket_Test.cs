...
{
    [TestClass]
    public sealed class CF_00001770G_KoxiaAndBracket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001770G_KoxiaAndBracket));
        ...
        {
            bool result = CF_00001770G_KoxiaAndBracket.Solution_0_Test(input);
