...
{
    [TestClass]
    public sealed class CF_00000350B_Resort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000350B_Resort));
        ...
        {
            bool result = CF_00000350B_Resort.Solution_0_Test(input);
