...
{
    [TestClass]
    public sealed class CF_00001310B_DoubleElimination_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001310B_DoubleElimination));
        ...
        {
            bool result = CF_00001310B_DoubleElimination.Solution_0_Test(input);
