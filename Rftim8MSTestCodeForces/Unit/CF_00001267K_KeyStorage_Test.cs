...
{
    [TestClass]
    public sealed class CF_00001267K_KeyStorage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001267K_KeyStorage));
        ...
        {
            bool result = CF_00001267K_KeyStorage.Solution_0_Test(input);
