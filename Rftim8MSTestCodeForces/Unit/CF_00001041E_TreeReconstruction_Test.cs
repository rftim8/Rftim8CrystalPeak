...
{
    [TestClass]
    public sealed class CF_00001041E_TreeReconstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001041E_TreeReconstruction));
        ...
        {
            bool result = CF_00001041E_TreeReconstruction.Solution_0_Test(input);
