...
{
    [TestClass]
    public sealed class CF_00000982C_CutEmAll_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000982C_CutEmAll));
        ...
        {
            bool result = CF_00000982C_CutEmAll.Solution_0_Test(input);
