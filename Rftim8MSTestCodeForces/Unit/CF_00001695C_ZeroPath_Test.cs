...
{
    [TestClass]
    public sealed class CF_00001695C_ZeroPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001695C_ZeroPath));
        ...
        {
            bool result = CF_00001695C_ZeroPath.Solution_0_Test(input);
