...
{
    [TestClass]
    public sealed class CF_00001705F_MarkAndTheOnlineExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001705F_MarkAndTheOnlineExam));
        ...
        {
            bool result = CF_00001705F_MarkAndTheOnlineExam.Solution_0_Test(input);
