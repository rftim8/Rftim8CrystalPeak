...
{
    [TestClass]
    public sealed class CF_00001561C_DeepDownBelow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001561C_DeepDownBelow));
        ...
        {
            bool result = CF_00001561C_DeepDownBelow.Solution_0_Test(input);
