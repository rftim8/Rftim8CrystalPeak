...
{
    [TestClass]
    public sealed class CF_00000304A_PythagoreanTheoremII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000304A_PythagoreanTheoremII));
        ...
        {
            bool result = CF_00000304A_PythagoreanTheoremII.Solution_0_Test(input);
