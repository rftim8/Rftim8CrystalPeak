...
{
    [TestClass]
    public sealed class CF_00000222B_CosmicTables_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000222B_CosmicTables));
        ...
        {
            bool result = CF_00000222B_CosmicTables.Solution_0_Test(input);
