...
{
    [TestClass]
    public sealed class CF_00001583E_MomentOfBloom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001583E_MomentOfBloom));
        ...
        {
            bool result = CF_00001583E_MomentOfBloom.Solution_0_Test(input);
