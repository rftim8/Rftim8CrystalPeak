...
{
    [TestClass]
    public sealed class CF_00001656D_Kgood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001656D_Kgood));
        ...
        {
            bool result = CF_00001656D_Kgood.Solution_0_Test(input);
