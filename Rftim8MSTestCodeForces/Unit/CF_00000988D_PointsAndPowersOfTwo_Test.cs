...
{
    [TestClass]
    public sealed class CF_00000988D_PointsAndPowersOfTwo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000988D_PointsAndPowersOfTwo));
        ...
        {
            bool result = CF_00000988D_PointsAndPowersOfTwo.Solution_0_Test(input);
