...
{
    [TestClass]
    public sealed class CF_00000385B_BearAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000385B_BearAndStrings));
        ...
        {
            bool result = CF_00000385B_BearAndStrings.Solution_0_Test(input);
