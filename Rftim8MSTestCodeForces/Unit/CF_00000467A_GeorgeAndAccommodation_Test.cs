...
{
    [TestClass]
    public sealed class CF_00000467A_GeorgeAndAccommodation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000467A_GeorgeAndAccommodation));
        ...
        {
            bool result = CF_00000467A_GeorgeAndAccommodation.Solution_0_Test(input);
