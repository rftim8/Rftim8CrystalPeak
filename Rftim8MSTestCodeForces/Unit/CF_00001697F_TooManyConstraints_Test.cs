...
{
    [TestClass]
    public sealed class CF_00001697F_TooManyConstraints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001697F_TooManyConstraints));
        ...
        {
            bool result = CF_00001697F_TooManyConstraints.Solution_0_Test(input);
