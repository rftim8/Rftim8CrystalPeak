...
{
    [TestClass]
    public sealed class CF_00000316C1_TidyingUp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000316C1_TidyingUp));
        ...
        {
            bool result = CF_00000316C1_TidyingUp.Solution_0_Test(input);
