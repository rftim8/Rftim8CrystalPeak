...
{
    [TestClass]
    public sealed class CF_00001763B_Incinerate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001763B_Incinerate));
        ...
        {
            bool result = CF_00001763B_Incinerate.Solution_0_Test(input);
