...
{
    [TestClass]
    public sealed class CF_00000295D_GregAndCaves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000295D_GregAndCaves));
        ...
        {
            bool result = CF_00000295D_GregAndCaves.Solution_0_Test(input);
