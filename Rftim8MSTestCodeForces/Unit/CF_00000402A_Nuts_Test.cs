...
{
    [TestClass]
    public sealed class CF_00000402A_Nuts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000402A_Nuts));
        ...
        {
            bool result = CF_00000402A_Nuts.Solution_0_Test(input);
