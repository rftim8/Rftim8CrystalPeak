...
{
    [TestClass]
    public sealed class CF_00001197F_ColoringGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001197F_ColoringGame));
        ...
        {
            bool result = CF_00001197F_ColoringGame.Solution_0_Test(input);
