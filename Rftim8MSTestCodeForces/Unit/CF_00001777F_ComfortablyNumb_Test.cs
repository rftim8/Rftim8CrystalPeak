...
{
    [TestClass]
    public sealed class CF_00001777F_ComfortablyNumb_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001777F_ComfortablyNumb));
        ...
        {
            bool result = CF_00001777F_ComfortablyNumb.Solution_0_Test(input);
