...
{
    [TestClass]
    public sealed class CF_00000804D_ExpectedDiameterOfATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000804D_ExpectedDiameterOfATree));
        ...
        {
            bool result = CF_00000804D_ExpectedDiameterOfATree.Solution_0_Test(input);
