...
{
    [TestClass]
    public sealed class CF_00000441B_ValeraAndFruits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000441B_ValeraAndFruits));
        ...
        {
            bool result = CF_00000441B_ValeraAndFruits.Solution_0_Test(input);
