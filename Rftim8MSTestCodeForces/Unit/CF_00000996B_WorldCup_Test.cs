...
{
    [TestClass]
    public sealed class CF_00000996B_WorldCup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000996B_WorldCup));
        ...
        {
            bool result = CF_00000996B_WorldCup.Solution_0_Test(input);
