...
{
    [TestClass]
    public sealed class CF_00000131D_Subway_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000131D_Subway));
        ...
        {
            bool result = CF_00000131D_Subway.Solution_0_Test(input);
