...
{
    [TestClass]
    public sealed class CF_00001387C_Viruses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001387C_Viruses));
        ...
        {
            bool result = CF_00001387C_Viruses.Solution_0_Test(input);
