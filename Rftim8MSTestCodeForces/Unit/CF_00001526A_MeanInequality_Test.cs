...
{
    [TestClass]
    public sealed class CF_00001526A_MeanInequality_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001526A_MeanInequality));
        ...
        {
            bool result = CF_00001526A_MeanInequality.Solution_0_Test(input);
