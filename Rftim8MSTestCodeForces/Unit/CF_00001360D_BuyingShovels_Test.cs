...
{
    [TestClass]
    public sealed class CF_00001360D_BuyingShovels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001360D_BuyingShovels));
        ...
        {
            bool result = CF_00001360D_BuyingShovels.Solution_0_Test(input);
