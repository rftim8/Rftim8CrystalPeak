...
{
    [TestClass]
    public sealed class CF_00000248B_ChillyWilly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000248B_ChillyWilly));
        ...
        {
            bool result = CF_00000248B_ChillyWilly.Solution_0_Test(input);
