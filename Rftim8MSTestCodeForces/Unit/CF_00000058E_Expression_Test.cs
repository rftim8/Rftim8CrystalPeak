...
{
    [TestClass]
    public sealed class CF_00000058E_Expression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000058E_Expression));
        ...
        {
            bool result = CF_00000058E_Expression.Solution_0_Test(input);
