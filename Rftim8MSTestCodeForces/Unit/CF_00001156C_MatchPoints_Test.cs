...
{
    [TestClass]
    public sealed class CF_00001156C_MatchPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001156C_MatchPoints));
        ...
        {
            bool result = CF_00001156C_MatchPoints.Solution_0_Test(input);
