...
{
    [TestClass]
    public sealed class CF_00001203E_Boxers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001203E_Boxers));
        ...
        {
            bool result = CF_00001203E_Boxers.Solution_0_Test(input);
