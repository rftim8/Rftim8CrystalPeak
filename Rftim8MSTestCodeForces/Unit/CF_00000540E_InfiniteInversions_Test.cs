...
{
    [TestClass]
    public sealed class CF_00000540E_InfiniteInversions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000540E_InfiniteInversions));
        ...
        {
            bool result = CF_00000540E_InfiniteInversions.Solution_0_Test(input);
