...
{
    [TestClass]
    public sealed class CF_00001238A_PrimeSubtraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001238A_PrimeSubtraction));
        ...
        {
            bool result = CF_00001238A_PrimeSubtraction.Solution_0_Test(input);
