...
{
    [TestClass]
    public sealed class CF_00001704A_Two01Sequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001704A_Two01Sequences));
        ...
        {
            bool result = CF_00001704A_Two01Sequences.Solution_0_Test(input);
