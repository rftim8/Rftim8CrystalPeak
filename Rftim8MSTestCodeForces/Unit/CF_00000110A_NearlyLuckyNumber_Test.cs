...
{
    [TestClass]
    public sealed class CF_00000110A_NearlyLuckyNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000110A_NearlyLuckyNumber));
        ...
        {
            bool result = CF_00000110A_NearlyLuckyNumber.Solution_0_Test(input);
