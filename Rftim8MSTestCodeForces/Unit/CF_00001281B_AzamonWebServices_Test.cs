...
{
    [TestClass]
    public sealed class CF_00001281B_AzamonWebServices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001281B_AzamonWebServices));
        ...
        {
            bool result = CF_00001281B_AzamonWebServices.Solution_0_Test(input);
