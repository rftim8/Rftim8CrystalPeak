...
{
    [TestClass]
    public sealed class CF_00000648C_TheWayOfWork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000648C_TheWayOfWork));
        ...
        {
            bool result = CF_00000648C_TheWayOfWork.Solution_0_Test(input);
