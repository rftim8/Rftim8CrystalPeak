...
{
    [TestClass]
    public sealed class CF_00000451A_GameWithSticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000451A_GameWithSticks));
        ...
        {
            bool result = CF_00000451A_GameWithSticks.Solution_0_Test(input);
