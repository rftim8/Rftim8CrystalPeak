...
{
    [TestClass]
    public sealed class CF_00000071E_NuclearFusion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000071E_NuclearFusion));
        ...
        {
            bool result = CF_00000071E_NuclearFusion.Solution_0_Test(input);
