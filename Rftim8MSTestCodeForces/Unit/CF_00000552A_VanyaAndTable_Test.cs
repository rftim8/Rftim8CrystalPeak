...
{
    [TestClass]
    public sealed class CF_00000552A_VanyaAndTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000552A_VanyaAndTable));
        ...
        {
            bool result = CF_00000552A_VanyaAndTable.Solution_0_Test(input);
