...
{
    [TestClass]
    public sealed class CF_00000613E_PuzzleLover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000613E_PuzzleLover));
        ...
        {
            bool result = CF_00000613E_PuzzleLover.Solution_0_Test(input);
