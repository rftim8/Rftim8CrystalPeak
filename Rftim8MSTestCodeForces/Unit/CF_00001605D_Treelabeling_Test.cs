...
{
    [TestClass]
    public sealed class CF_00001605D_Treelabeling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001605D_Treelabeling));
        ...
        {
            bool result = CF_00001605D_Treelabeling.Solution_0_Test(input);
