...
{
    [TestClass]
    public sealed class CF_00000500E_NewYearDomino_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000500E_NewYearDomino));
        ...
        {
            bool result = CF_00000500E_NewYearDomino.Solution_0_Test(input);
