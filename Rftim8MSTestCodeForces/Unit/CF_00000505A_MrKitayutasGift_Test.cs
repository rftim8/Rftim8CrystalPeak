...
{
    [TestClass]
    public sealed class CF_00000505A_MrKitayutasGift_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000505A_MrKitayutasGift));
        ...
        {
            bool result = CF_00000505A_MrKitayutasGift.Solution_0_Test(input);
