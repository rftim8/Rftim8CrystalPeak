...
{
    [TestClass]
    public sealed class CF_00001807F_BouncyBall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001807F_BouncyBall));
        ...
        {
            bool result = CF_00001807F_BouncyBall.Solution_0_Test(input);
