...
{
    [TestClass]
    public sealed class CF_00000489B_BerSUBall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000489B_BerSUBall));
        ...
        {
            bool result = CF_00000489B_BerSUBall.Solution_0_Test(input);
