...
{
    [TestClass]
    public sealed class CF_00000660D_NumberOfParallelograms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000660D_NumberOfParallelograms));
        ...
        {
            bool result = CF_00000660D_NumberOfParallelograms.Solution_0_Test(input);
