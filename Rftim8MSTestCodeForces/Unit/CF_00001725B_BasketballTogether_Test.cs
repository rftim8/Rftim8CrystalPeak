...
{
    [TestClass]
    public sealed class CF_00001725B_BasketballTogether_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725B_BasketballTogether));
        ...
        {
            bool result = CF_00001725B_BasketballTogether.Solution_0_Test(input);
