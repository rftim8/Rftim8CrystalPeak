...
{
    [TestClass]
    public sealed class CF_00001023C_BracketSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001023C_BracketSubsequence));
        ...
        {
            bool result = CF_00001023C_BracketSubsequence.Solution_0_Test(input);
