...
{
    [TestClass]
    public sealed class CF_00001351C_Skier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001351C_Skier));
        ...
        {
            bool result = CF_00001351C_Skier.Solution_0_Test(input);
