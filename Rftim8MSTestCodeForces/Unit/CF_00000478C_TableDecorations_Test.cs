...
{
    [TestClass]
    public sealed class CF_00000478C_TableDecorations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000478C_TableDecorations));
        ...
        {
            bool result = CF_00000478C_TableDecorations.Solution_0_Test(input);
