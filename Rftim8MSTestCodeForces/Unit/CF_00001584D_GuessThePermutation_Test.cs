...
{
    [TestClass]
    public sealed class CF_00001584D_GuessThePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001584D_GuessThePermutation));
        ...
        {
            bool result = CF_00001584D_GuessThePermutation.Solution_0_Test(input);
