...
{
    [TestClass]
    public sealed class CF_00000527E_DataCenterDrama_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000527E_DataCenterDrama));
        ...
        {
            bool result = CF_00000527E_DataCenterDrama.Solution_0_Test(input);
