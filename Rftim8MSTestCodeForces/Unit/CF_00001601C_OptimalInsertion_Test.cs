...
{
    [TestClass]
    public sealed class CF_00001601C_OptimalInsertion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001601C_OptimalInsertion));
        ...
        {
            bool result = CF_00001601C_OptimalInsertion.Solution_0_Test(input);
