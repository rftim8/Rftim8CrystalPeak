...
{
    [TestClass]
    public sealed class CF_00000364C_BeautifulSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000364C_BeautifulSet));
        ...
        {
            bool result = CF_00000364C_BeautifulSet.Solution_0_Test(input);
