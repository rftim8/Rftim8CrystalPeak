...
{
    [TestClass]
    public sealed class CF_00001163A_EatingSoup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001163A_EatingSoup));
        ...
        {
            bool result = CF_00001163A_EatingSoup.Solution_0_Test(input);
