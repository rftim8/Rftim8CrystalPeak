...
{
    [TestClass]
    public sealed class CF_00001776A_WalkingBoy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001776A_WalkingBoy));
        ...
        {
            bool result = CF_00001776A_WalkingBoy.Solution_0_Test(input);
