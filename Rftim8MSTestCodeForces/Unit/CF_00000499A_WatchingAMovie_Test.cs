...
{
    [TestClass]
    public sealed class CF_00000499A_WatchingAMovie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000499A_WatchingAMovie));
        ...
        {
            bool result = CF_00000499A_WatchingAMovie.Solution_0_Test(input);
