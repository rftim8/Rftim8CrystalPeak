...
{
    [TestClass]
    public sealed class CF_00000568D_SignPosts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000568D_SignPosts));
        ...
        {
            bool result = CF_00000568D_SignPosts.Solution_0_Test(input);
