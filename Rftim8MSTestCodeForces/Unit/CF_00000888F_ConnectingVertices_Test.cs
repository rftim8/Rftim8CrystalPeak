...
{
    [TestClass]
    public sealed class CF_00000888F_ConnectingVertices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000888F_ConnectingVertices));
        ...
        {
            bool result = CF_00000888F_ConnectingVertices.Solution_0_Test(input);
