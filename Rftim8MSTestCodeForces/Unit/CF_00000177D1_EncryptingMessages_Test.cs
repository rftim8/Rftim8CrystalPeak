...
{
    [TestClass]
    public sealed class CF_00000177D1_EncryptingMessages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000177D1_EncryptingMessages));
        ...
        {
            bool result = CF_00000177D1_EncryptingMessages.Solution_0_Test(input);
