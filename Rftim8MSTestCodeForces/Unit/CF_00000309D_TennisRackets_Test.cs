...
{
    [TestClass]
    public sealed class CF_00000309D_TennisRackets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000309D_TennisRackets));
        ...
        {
            bool result = CF_00000309D_TennisRackets.Solution_0_Test(input);
