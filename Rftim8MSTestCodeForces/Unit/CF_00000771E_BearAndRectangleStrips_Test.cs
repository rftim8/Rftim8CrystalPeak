...
{
    [TestClass]
    public sealed class CF_00000771E_BearAndRectangleStrips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000771E_BearAndRectangleStrips));
        ...
        {
            bool result = CF_00000771E_BearAndRectangleStrips.Solution_0_Test(input);
