...
{
    [TestClass]
    public sealed class CF_00000723E_OneWayReform_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000723E_OneWayReform));
        ...
        {
            bool result = CF_00000723E_OneWayReform.Solution_0_Test(input);
