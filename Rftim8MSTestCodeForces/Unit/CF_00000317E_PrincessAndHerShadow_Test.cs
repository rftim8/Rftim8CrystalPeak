...
{
    [TestClass]
    public sealed class CF_00000317E_PrincessAndHerShadow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000317E_PrincessAndHerShadow));
        ...
        {
            bool result = CF_00000317E_PrincessAndHerShadow.Solution_0_Test(input);
