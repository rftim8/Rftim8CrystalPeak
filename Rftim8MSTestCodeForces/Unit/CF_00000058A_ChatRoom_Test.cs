...
{
    [TestClass]
    public sealed class CF_00000058A_ChatRoom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000058A_ChatRoom));
        ...
        {
            bool result = CF_00000058A_ChatRoom.Solution_0_Test(input);
