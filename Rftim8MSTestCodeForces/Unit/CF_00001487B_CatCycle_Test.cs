...
{
    [TestClass]
    public sealed class CF_00001487B_CatCycle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001487B_CatCycle));
        ...
        {
            bool result = CF_00001487B_CatCycle.Solution_0_Test(input);
