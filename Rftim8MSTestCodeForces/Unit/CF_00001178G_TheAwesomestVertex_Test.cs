...
{
    [TestClass]
    public sealed class CF_00001178G_TheAwesomestVertex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001178G_TheAwesomestVertex));
        ...
        {
            bool result = CF_00001178G_TheAwesomestVertex.Solution_0_Test(input);
