...
{
    [TestClass]
    public sealed class CF_00000736E_ChessChampionship_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000736E_ChessChampionship));
        ...
        {
            bool result = CF_00000736E_ChessChampionship.Solution_0_Test(input);
