...
{
    [TestClass]
    public sealed class CF_00001346H_GameWithSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001346H_GameWithSegments));
        ...
        {
            bool result = CF_00001346H_GameWithSegments.Solution_0_Test(input);
