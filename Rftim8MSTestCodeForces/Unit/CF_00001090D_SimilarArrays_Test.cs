...
{
    [TestClass]
    public sealed class CF_00001090D_SimilarArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090D_SimilarArrays));
        ...
        {
            bool result = CF_00001090D_SimilarArrays.Solution_0_Test(input);
