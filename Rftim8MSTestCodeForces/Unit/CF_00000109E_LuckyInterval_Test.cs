...
{
    [TestClass]
    public sealed class CF_00000109E_LuckyInterval_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000109E_LuckyInterval));
        ...
        {
            bool result = CF_00000109E_LuckyInterval.Solution_0_Test(input);
