...
{
    [TestClass]
    public sealed class CF_00001547G_HowManyPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001547G_HowManyPaths));
        ...
        {
            bool result = CF_00001547G_HowManyPaths.Solution_0_Test(input);
