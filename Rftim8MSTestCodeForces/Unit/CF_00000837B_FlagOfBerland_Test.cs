...
{
    [TestClass]
    public sealed class CF_00000837B_FlagOfBerland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000837B_FlagOfBerland));
        ...
        {
            bool result = CF_00000837B_FlagOfBerland.Solution_0_Test(input);
