...
{
    [TestClass]
    public sealed class CF_00000491A_UpTheHill_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000491A_UpTheHill));
        ...
        {
            bool result = CF_00000491A_UpTheHill.Solution_0_Test(input);
