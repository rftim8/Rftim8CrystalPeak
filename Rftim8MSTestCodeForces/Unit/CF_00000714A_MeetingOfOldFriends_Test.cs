...
{
    [TestClass]
    public sealed class CF_00000714A_MeetingOfOldFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000714A_MeetingOfOldFriends));
        ...
        {
            bool result = CF_00000714A_MeetingOfOldFriends.Solution_0_Test(input);
