...
{
    [TestClass]
    public sealed class CF_00001288B_YetAnotherMemeProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001288B_YetAnotherMemeProblem));
        ...
        {
            bool result = CF_00001288B_YetAnotherMemeProblem.Solution_0_Test(input);
