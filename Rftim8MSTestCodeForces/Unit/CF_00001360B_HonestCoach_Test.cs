...
{
    [TestClass]
    public sealed class CF_00001360B_HonestCoach_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001360B_HonestCoach));
        ...
        {
            bool result = CF_00001360B_HonestCoach.Solution_0_Test(input);
