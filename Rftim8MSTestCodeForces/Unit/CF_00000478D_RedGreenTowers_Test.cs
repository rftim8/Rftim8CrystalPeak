...
{
    [TestClass]
    public sealed class CF_00000478D_RedGreenTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000478D_RedGreenTowers));
        ...
        {
            bool result = CF_00000478D_RedGreenTowers.Solution_0_Test(input);
