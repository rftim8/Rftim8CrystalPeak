...
{
    [TestClass]
    public sealed class CF_00001618E_SingersTour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001618E_SingersTour));
        ...
        {
            bool result = CF_00001618E_SingersTour.Solution_0_Test(input);
