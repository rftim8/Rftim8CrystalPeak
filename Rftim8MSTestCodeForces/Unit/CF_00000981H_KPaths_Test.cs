...
{
    [TestClass]
    public sealed class CF_00000981H_KPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000981H_KPaths));
        ...
        {
            bool result = CF_00000981H_KPaths.Solution_0_Test(input);
