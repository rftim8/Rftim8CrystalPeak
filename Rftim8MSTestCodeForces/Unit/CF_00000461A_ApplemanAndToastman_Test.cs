...
{
    [TestClass]
    public sealed class CF_00000461A_ApplemanAndToastman_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000461A_ApplemanAndToastman));
        ...
        {
            bool result = CF_00000461A_ApplemanAndToastman.Solution_0_Test(input);
