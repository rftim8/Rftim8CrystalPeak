...
{
    [TestClass]
    public sealed class CF_00001017D_TheWu_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001017D_TheWu));
        ...
        {
            bool result = CF_00001017D_TheWu.Solution_0_Test(input);
