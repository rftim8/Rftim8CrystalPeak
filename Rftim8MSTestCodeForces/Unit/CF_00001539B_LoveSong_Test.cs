...
{
    [TestClass]
    public sealed class CF_00001539B_LoveSong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001539B_LoveSong));
        ...
        {
            bool result = CF_00001539B_LoveSong.Solution_0_Test(input);
