...
{
    [TestClass]
    public sealed class CF_00001673F_AntiTheftRoadPlanning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001673F_AntiTheftRoadPlanning));
        ...
        {
            bool result = CF_00001673F_AntiTheftRoadPlanning.Solution_0_Test(input);
