...
{
    [TestClass]
    public sealed class CF_00000991D_Bishwock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000991D_Bishwock));
        ...
        {
            bool result = CF_00000991D_Bishwock.Solution_0_Test(input);
