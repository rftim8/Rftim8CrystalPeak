...
{
    [TestClass]
    public sealed class CF_00000794E_ChoosingCarrot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000794E_ChoosingCarrot));
        ...
        {
            bool result = CF_00000794E_ChoosingCarrot.Solution_0_Test(input);
