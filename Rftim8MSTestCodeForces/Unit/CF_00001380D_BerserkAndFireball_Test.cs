...
{
    [TestClass]
    public sealed class CF_00001380D_BerserkAndFireball_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001380D_BerserkAndFireball));
        ...
        {
            bool result = CF_00001380D_BerserkAndFireball.Solution_0_Test(input);
