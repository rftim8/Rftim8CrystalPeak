...
{
    [TestClass]
    public sealed class CF_00001931F_ChatScreenshots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001931F_ChatScreenshots));
        ...
        {
            bool result = CF_00001931F_ChatScreenshots.Solution_0_Test(input);
