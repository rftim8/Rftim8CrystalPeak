...
{
    [TestClass]
    public sealed class CF_00000379A_NewYearCandles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000379A_NewYearCandles));
        ...
        {
            bool result = CF_00000379A_NewYearCandles.Solution_0_Test(input);
