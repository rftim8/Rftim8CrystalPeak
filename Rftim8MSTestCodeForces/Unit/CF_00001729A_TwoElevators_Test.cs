...
{
    [TestClass]
    public sealed class CF_00001729A_TwoElevators_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001729A_TwoElevators));
        ...
        {
            bool result = CF_00001729A_TwoElevators.Solution_0_Test(input);
