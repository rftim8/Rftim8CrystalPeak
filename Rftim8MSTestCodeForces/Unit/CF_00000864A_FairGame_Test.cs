...
{
    [TestClass]
    public sealed class CF_00000864A_FairGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000864A_FairGame));
        ...
        {
            bool result = CF_00000864A_FairGame.Solution_0_Test(input);
