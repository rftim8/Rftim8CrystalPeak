...
{
    [TestClass]
    public sealed class CF_00000208E_BloodCousins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000208E_BloodCousins));
        ...
        {
            bool result = CF_00000208E_BloodCousins.Solution_0_Test(input);
