...
{
    [TestClass]
    public sealed class CF_00000641C_LittleArtemAndDance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000641C_LittleArtemAndDance));
        ...
        {
            bool result = CF_00000641C_LittleArtemAndDance.Solution_0_Test(input);
