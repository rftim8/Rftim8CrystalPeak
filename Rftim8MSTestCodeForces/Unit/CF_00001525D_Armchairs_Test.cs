...
{
    [TestClass]
    public sealed class CF_00001525D_Armchairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001525D_Armchairs));
        ...
        {
            bool result = CF_00001525D_Armchairs.Solution_0_Test(input);
