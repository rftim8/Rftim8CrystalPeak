...
{
    [TestClass]
    public sealed class CF_00000215B_OlympicMedal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000215B_OlympicMedal));
        ...
        {
            bool result = CF_00000215B_OlympicMedal.Solution_0_Test(input);
