...
{
    [TestClass]
    public sealed class CF_00000958B2_MaximumControlMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958B2_MaximumControlMedium));
        ...
        {
            bool result = CF_00000958B2_MaximumControlMedium.Solution_0_Test(input);
