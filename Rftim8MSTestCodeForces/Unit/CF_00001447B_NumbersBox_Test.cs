...
{
    [TestClass]
    public sealed class CF_00001447B_NumbersBox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001447B_NumbersBox));
        ...
        {
            bool result = CF_00001447B_NumbersBox.Solution_0_Test(input);
