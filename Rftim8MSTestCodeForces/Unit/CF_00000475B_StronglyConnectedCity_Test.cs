...
{
    [TestClass]
    public sealed class CF_00000475B_StronglyConnectedCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000475B_StronglyConnectedCity));
        ...
        {
            bool result = CF_00000475B_StronglyConnectedCity.Solution_0_Test(input);
