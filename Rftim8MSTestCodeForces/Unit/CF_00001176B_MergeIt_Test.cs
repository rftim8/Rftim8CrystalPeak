...
{
    [TestClass]
    public sealed class CF_00001176B_MergeIt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001176B_MergeIt));
        ...
        {
            bool result = CF_00001176B_MergeIt.Solution_0_Test(input);
