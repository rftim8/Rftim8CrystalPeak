...
{
    [TestClass]
    public sealed class CF_00001334G_SubstringSearch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001334G_SubstringSearch));
        ...
        {
            bool result = CF_00001334G_SubstringSearch.Solution_0_Test(input);
