...
{
    [TestClass]
    public sealed class CF_00001084B_KvassAndTheFairNut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001084B_KvassAndTheFairNut));
        ...
        {
            bool result = CF_00001084B_KvassAndTheFairNut.Solution_0_Test(input);
