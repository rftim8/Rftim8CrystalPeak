...
{
    [TestClass]
    public sealed class CF_00000850F_RainbowBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000850F_RainbowBalls));
        ...
        {
            bool result = CF_00000850F_RainbowBalls.Solution_0_Test(input);
