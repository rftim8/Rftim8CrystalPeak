...
{
    [TestClass]
    public sealed class CF_00001686B_OddSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001686B_OddSubarrays));
        ...
        {
            bool result = CF_00001686B_OddSubarrays.Solution_0_Test(input);
