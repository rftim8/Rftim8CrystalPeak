...
{
    [TestClass]
    public sealed class CF_00001834E_MEXOfLCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001834E_MEXOfLCM));
        ...
        {
            bool result = CF_00001834E_MEXOfLCM.Solution_0_Test(input);
