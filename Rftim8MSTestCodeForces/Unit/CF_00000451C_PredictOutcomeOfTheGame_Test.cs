...
{
    [TestClass]
    public sealed class CF_00000451C_PredictOutcomeOfTheGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000451C_PredictOutcomeOfTheGame));
        ...
        {
            bool result = CF_00000451C_PredictOutcomeOfTheGame.Solution_0_Test(input);
