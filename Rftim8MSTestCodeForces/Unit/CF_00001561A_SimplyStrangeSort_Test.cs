...
{
    [TestClass]
    public sealed class CF_00001561A_SimplyStrangeSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001561A_SimplyStrangeSort));
        ...
        {
            bool result = CF_00001561A_SimplyStrangeSort.Solution_0_Test(input);
