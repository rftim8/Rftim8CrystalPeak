...
{
    [TestClass]
    public sealed class CF_00000739E_GoshaIsHunting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000739E_GoshaIsHunting));
        ...
        {
            bool result = CF_00000739E_GoshaIsHunting.Solution_0_Test(input);
