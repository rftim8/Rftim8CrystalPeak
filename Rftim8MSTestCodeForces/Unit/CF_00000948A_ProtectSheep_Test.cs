...
{
    [TestClass]
    public sealed class CF_00000948A_ProtectSheep_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000948A_ProtectSheep));
        ...
        {
            bool result = CF_00000948A_ProtectSheep.Solution_0_Test(input);
