...
{
    [TestClass]
    public sealed class CF_00000105B_DarkAssembly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000105B_DarkAssembly));
        ...
        {
            bool result = CF_00000105B_DarkAssembly.Solution_0_Test(input);
