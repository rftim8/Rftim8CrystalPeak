...
{
    [TestClass]
    public sealed class CF_00001275E1_Checksum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001275E1_Checksum));
        ...
        {
            bool result = CF_00001275E1_Checksum.Solution_0_Test(input);
