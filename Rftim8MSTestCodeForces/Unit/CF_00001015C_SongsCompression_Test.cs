...
{
    [TestClass]
    public sealed class CF_00001015C_SongsCompression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001015C_SongsCompression));
        ...
        {
            bool result = CF_00001015C_SongsCompression.Solution_0_Test(input);
