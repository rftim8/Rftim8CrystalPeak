...
{
    [TestClass]
    public sealed class CF_00001694B_ParanoidString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001694B_ParanoidString));
        ...
        {
            bool result = CF_00001694B_ParanoidString.Solution_0_Test(input);
