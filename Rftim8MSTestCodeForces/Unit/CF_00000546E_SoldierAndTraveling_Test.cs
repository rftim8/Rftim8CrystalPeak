...
{
    [TestClass]
    public sealed class CF_00000546E_SoldierAndTraveling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000546E_SoldierAndTraveling));
        ...
        {
            bool result = CF_00000546E_SoldierAndTraveling.Solution_0_Test(input);
