...
{
    [TestClass]
    public sealed class CF_00000777C_AlyonaAndSpreadsheet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000777C_AlyonaAndSpreadsheet));
        ...
        {
            bool result = CF_00000777C_AlyonaAndSpreadsheet.Solution_0_Test(input);
