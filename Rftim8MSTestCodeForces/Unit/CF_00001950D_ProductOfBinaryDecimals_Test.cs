...
{
    [TestClass]
    public sealed class CF_00001950D_ProductOfBinaryDecimals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001950D_ProductOfBinaryDecimals));
        ...
        {
            bool result = CF_00001950D_ProductOfBinaryDecimals.Solution_0_Test(input);
