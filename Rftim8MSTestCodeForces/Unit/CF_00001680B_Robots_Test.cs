...
{
    [TestClass]
    public sealed class CF_00001680B_Robots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001680B_Robots));
        ...
        {
            bool result = CF_00001680B_Robots.Solution_0_Test(input);
