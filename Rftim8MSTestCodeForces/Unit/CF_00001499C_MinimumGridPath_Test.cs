...
{
    [TestClass]
    public sealed class CF_00001499C_MinimumGridPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001499C_MinimumGridPath));
        ...
        {
            bool result = CF_00001499C_MinimumGridPath.Solution_0_Test(input);
