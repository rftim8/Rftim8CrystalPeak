...
{
    [TestClass]
    public sealed class CF_00000837D_RoundSubset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000837D_RoundSubset));
        ...
        {
            bool result = CF_00000837D_RoundSubset.Solution_0_Test(input);
