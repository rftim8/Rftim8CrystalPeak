...
{
    [TestClass]
    public sealed class CF_00001407C_ChocolateBunny_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001407C_ChocolateBunny));
        ...
        {
            bool result = CF_00001407C_ChocolateBunny.Solution_0_Test(input);
