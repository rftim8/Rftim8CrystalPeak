...
{
    [TestClass]
    public sealed class CF_00000059C_Title_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000059C_Title));
        ...
        {
            bool result = CF_00000059C_Title.Solution_0_Test(input);
