...
{
    [TestClass]
    public sealed class CF_00000713B_SearchingRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000713B_SearchingRectangles));
        ...
        {
            bool result = CF_00000713B_SearchingRectangles.Solution_0_Test(input);
