...
{
    [TestClass]
    public sealed class CF_00000711C_ColoringTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000711C_ColoringTrees));
        ...
        {
            bool result = CF_00000711C_ColoringTrees.Solution_0_Test(input);
