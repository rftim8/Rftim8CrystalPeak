...
{
    [TestClass]
    public sealed class CF_00001703G_GoodKeyBadKey_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001703G_GoodKeyBadKey));
        ...
        {
            bool result = CF_00001703G_GoodKeyBadKey.Solution_0_Test(input);
