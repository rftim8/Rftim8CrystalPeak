...
{
    [TestClass]
    public sealed class CF_00000007C_Line_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000007C_Line));
        ...
        {
            bool result = CF_00000007C_Line.Solution_0_Test(input);
