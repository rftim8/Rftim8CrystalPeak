...
{
    [TestClass]
    public sealed class CF_00000662C_BinaryTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000662C_BinaryTable));
        ...
        {
            bool result = CF_00000662C_BinaryTable.Solution_0_Test(input);
