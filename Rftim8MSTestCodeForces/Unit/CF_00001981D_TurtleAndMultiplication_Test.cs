...
{
    [TestClass]
    public sealed class CF_00001981D_TurtleAndMultiplication_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001981D_TurtleAndMultiplication));
        ...
        {
            bool result = CF_00001981D_TurtleAndMultiplication.Solution_0_Test(input);
