...
{
    [TestClass]
    public sealed class CF_00000526D_OmNomAndNecklace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000526D_OmNomAndNecklace));
        ...
        {
            bool result = CF_00000526D_OmNomAndNecklace.Solution_0_Test(input);
