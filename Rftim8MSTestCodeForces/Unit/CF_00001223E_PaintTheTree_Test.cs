...
{
    [TestClass]
    public sealed class CF_00001223E_PaintTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001223E_PaintTheTree));
        ...
        {
            bool result = CF_00001223E_PaintTheTree.Solution_0_Test(input);
