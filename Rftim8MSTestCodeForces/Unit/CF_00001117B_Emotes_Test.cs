...
{
    [TestClass]
    public sealed class CF_00001117B_Emotes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001117B_Emotes));
        ...
        {
            bool result = CF_00001117B_Emotes.Solution_0_Test(input);
