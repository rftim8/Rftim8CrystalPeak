...
{
    [TestClass]
    public sealed class CF_00001363E_TreeShuffling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001363E_TreeShuffling));
        ...
        {
            bool result = CF_00001363E_TreeShuffling.Solution_0_Test(input);
