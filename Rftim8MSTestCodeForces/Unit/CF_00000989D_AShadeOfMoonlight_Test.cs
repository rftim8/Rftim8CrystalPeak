...
{
    [TestClass]
    public sealed class CF_00000989D_AShadeOfMoonlight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000989D_AShadeOfMoonlight));
        ...
        {
            bool result = CF_00000989D_AShadeOfMoonlight.Solution_0_Test(input);
