...
{
    [TestClass]
    public sealed class CF_00001917A_LeastProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001917A_LeastProduct));
        ...
        {
            bool result = CF_00001917A_LeastProduct.Solution_0_Test(input);
