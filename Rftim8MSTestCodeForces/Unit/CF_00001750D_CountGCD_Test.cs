...
{
    [TestClass]
    public sealed class CF_00001750D_CountGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001750D_CountGCD));
        ...
        {
            bool result = CF_00001750D_CountGCD.Solution_0_Test(input);
