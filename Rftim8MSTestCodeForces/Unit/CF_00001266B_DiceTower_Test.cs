...
{
    [TestClass]
    public sealed class CF_00001266B_DiceTower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001266B_DiceTower));
        ...
        {
            bool result = CF_00001266B_DiceTower.Solution_0_Test(input);
