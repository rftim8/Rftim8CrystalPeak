...
{
    [TestClass]
    public sealed class CF_00001061C_Multiplicity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001061C_Multiplicity));
        ...
        {
            bool result = CF_00001061C_Multiplicity.Solution_0_Test(input);
