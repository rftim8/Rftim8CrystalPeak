...
{
    [TestClass]
    public sealed class CF_00001844A_SubtractionGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001844A_SubtractionGame));
        ...
        {
            bool result = CF_00001844A_SubtractionGame.Solution_0_Test(input);
