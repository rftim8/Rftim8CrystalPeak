...
{
    [TestClass]
    public sealed class CF_00001416C_XORInverse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001416C_XORInverse));
        ...
        {
            bool result = CF_00001416C_XORInverse.Solution_0_Test(input);
