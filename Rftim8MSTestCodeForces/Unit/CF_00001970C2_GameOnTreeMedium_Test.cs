...
{
    [TestClass]
    public sealed class CF_00001970C2_GameOnTreeMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970C2_GameOnTreeMedium));
        ...
        {
            bool result = CF_00001970C2_GameOnTreeMedium.Solution_0_Test(input);
