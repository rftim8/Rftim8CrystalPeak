...
{
    [TestClass]
    public sealed class CF_00001116D1_BlockDiagonalMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001116D1_BlockDiagonalMatrix));
        ...
        {
            bool result = CF_00001116D1_BlockDiagonalMatrix.Solution_0_Test(input);
