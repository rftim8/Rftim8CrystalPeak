...
{
    [TestClass]
    public sealed class CF_00001183G_CandyBoxHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001183G_CandyBoxHardVersion));
        ...
        {
            bool result = CF_00001183G_CandyBoxHardVersion.Solution_0_Test(input);
