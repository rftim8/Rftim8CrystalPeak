...
{
    [TestClass]
    public sealed class CF_00001506E_RestoringThePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001506E_RestoringThePermutation));
        ...
        {
            bool result = CF_00001506E_RestoringThePermutation.Solution_0_Test(input);
