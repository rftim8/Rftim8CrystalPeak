...
{
    [TestClass]
    public sealed class CF_00000126D_FibonacciSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000126D_FibonacciSums));
        ...
        {
            bool result = CF_00000126D_FibonacciSums.Solution_0_Test(input);
