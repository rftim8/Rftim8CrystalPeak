...
{
    [TestClass]
    public sealed class CF_00001055G_JellyfishNightmare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001055G_JellyfishNightmare));
        ...
        {
            bool result = CF_00001055G_JellyfishNightmare.Solution_0_Test(input);
