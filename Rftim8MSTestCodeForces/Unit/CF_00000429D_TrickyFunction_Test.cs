...
{
    [TestClass]
    public sealed class CF_00000429D_TrickyFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000429D_TrickyFunction));
        ...
        {
            bool result = CF_00000429D_TrickyFunction.Solution_0_Test(input);
