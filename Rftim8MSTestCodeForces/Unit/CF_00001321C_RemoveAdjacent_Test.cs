...
{
    [TestClass]
    public sealed class CF_00001321C_RemoveAdjacent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001321C_RemoveAdjacent));
        ...
        {
            bool result = CF_00001321C_RemoveAdjacent.Solution_0_Test(input);
