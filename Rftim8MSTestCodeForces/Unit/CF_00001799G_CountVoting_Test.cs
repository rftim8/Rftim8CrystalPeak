...
{
    [TestClass]
    public sealed class CF_00001799G_CountVoting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001799G_CountVoting));
        ...
        {
            bool result = CF_00001799G_CountVoting.Solution_0_Test(input);
