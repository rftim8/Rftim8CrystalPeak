...
{
    [TestClass]
    public sealed class CF_00000799E_AquariumDecoration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000799E_AquariumDecoration));
        ...
        {
            bool result = CF_00000799E_AquariumDecoration.Solution_0_Test(input);
