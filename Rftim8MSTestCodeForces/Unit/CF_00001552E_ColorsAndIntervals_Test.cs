...
{
    [TestClass]
    public sealed class CF_00001552E_ColorsAndIntervals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001552E_ColorsAndIntervals));
        ...
        {
            bool result = CF_00001552E_ColorsAndIntervals.Solution_0_Test(input);
