...
{
    [TestClass]
    public sealed class CF_00001292E_RinAndTheUnknownFlower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001292E_RinAndTheUnknownFlower));
        ...
        {
            bool result = CF_00001292E_RinAndTheUnknownFlower.Solution_0_Test(input);
