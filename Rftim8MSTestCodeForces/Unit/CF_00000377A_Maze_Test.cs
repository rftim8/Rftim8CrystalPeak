...
{
    [TestClass]
    public sealed class CF_00000377A_Maze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000377A_Maze));
        ...
        {
            bool result = CF_00000377A_Maze.Solution_0_Test(input);
