...
{
    [TestClass]
    public sealed class CF_00000672A_SummerCamp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000672A_SummerCamp));
        ...
        {
            bool result = CF_00000672A_SummerCamp.Solution_0_Test(input);
