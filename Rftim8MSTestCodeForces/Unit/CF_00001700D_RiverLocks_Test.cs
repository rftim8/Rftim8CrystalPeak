...
{
    [TestClass]
    public sealed class CF_00001700D_RiverLocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001700D_RiverLocks));
        ...
        {
            bool result = CF_00001700D_RiverLocks.Solution_0_Test(input);
