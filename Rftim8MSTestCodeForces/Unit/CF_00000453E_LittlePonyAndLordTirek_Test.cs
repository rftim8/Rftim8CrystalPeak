...
{
    [TestClass]
    public sealed class CF_00000453E_LittlePonyAndLordTirek_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000453E_LittlePonyAndLordTirek));
        ...
        {
            bool result = CF_00000453E_LittlePonyAndLordTirek.Solution_0_Test(input);
