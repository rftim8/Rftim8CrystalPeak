...
{
    [TestClass]
    public sealed class CF_00001282E_TheCakeIsALie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001282E_TheCakeIsALie));
        ...
        {
            bool result = CF_00001282E_TheCakeIsALie.Solution_0_Test(input);
