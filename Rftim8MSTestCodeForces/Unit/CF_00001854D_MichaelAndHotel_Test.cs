...
{
    [TestClass]
    public sealed class CF_00001854D_MichaelAndHotel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001854D_MichaelAndHotel));
        ...
        {
            bool result = CF_00001854D_MichaelAndHotel.Solution_0_Test(input);
