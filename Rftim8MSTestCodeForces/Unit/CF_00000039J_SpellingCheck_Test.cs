...
{
    [TestClass]
    public sealed class CF_00000039J_SpellingCheck_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000039J_SpellingCheck));
        ...
        {
            bool result = CF_00000039J_SpellingCheck.Solution_0_Test(input);
