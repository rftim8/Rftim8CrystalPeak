...
{
    [TestClass]
    public sealed class CF_00000848C_GoodbyeSouvenir_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000848C_GoodbyeSouvenir));
        ...
        {
            bool result = CF_00000848C_GoodbyeSouvenir.Solution_0_Test(input);
