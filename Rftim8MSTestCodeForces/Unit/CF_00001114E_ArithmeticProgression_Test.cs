...
{
    [TestClass]
    public sealed class CF_00001114E_ArithmeticProgression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001114E_ArithmeticProgression));
        ...
        {
            bool result = CF_00001114E_ArithmeticProgression.Solution_0_Test(input);
