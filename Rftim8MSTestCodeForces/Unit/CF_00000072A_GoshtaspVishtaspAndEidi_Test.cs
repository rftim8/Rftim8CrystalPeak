...
{
    [TestClass]
    public sealed class CF_00000072A_GoshtaspVishtaspAndEidi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000072A_GoshtaspVishtaspAndEidi));
        ...
        {
            bool result = CF_00000072A_GoshtaspVishtaspAndEidi.Solution_0_Test(input);
