...
{
    [TestClass]
    public sealed class CF_00000316B1_EKG_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000316B1_EKG));
        ...
        {
            bool result = CF_00000316B1_EKG.Solution_0_Test(input);
