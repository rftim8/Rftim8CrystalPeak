...
{
    [TestClass]
    public sealed class CF_00001118B_TanyaAndCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001118B_TanyaAndCandies));
        ...
        {
            bool result = CF_00001118B_TanyaAndCandies.Solution_0_Test(input);
