...
{
    [TestClass]
    public sealed class CF_00001858E1_RollbacksEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001858E1_RollbacksEasyVersion));
        ...
        {
            bool result = CF_00001858E1_RollbacksEasyVersion.Solution_0_Test(input);
