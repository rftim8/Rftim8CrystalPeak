...
{
    [TestClass]
    public sealed class CF_00001703C_Cypher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001703C_Cypher));
        ...
        {
            bool result = CF_00001703C_Cypher.Solution_0_Test(input);
