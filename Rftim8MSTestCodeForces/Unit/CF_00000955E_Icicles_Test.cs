...
{
    [TestClass]
    public sealed class CF_00000955E_Icicles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000955E_Icicles));
        ...
        {
            bool result = CF_00000955E_Icicles.Solution_0_Test(input);
