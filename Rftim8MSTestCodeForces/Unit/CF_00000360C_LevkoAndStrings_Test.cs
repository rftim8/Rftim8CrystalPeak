...
{
    [TestClass]
    public sealed class CF_00000360C_LevkoAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000360C_LevkoAndStrings));
        ...
        {
            bool result = CF_00000360C_LevkoAndStrings.Solution_0_Test(input);
