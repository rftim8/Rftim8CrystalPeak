...
{
    [TestClass]
    public sealed class CF_00001433B_YetAnotherBookshelf_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001433B_YetAnotherBookshelf));
        ...
        {
            bool result = CF_00001433B_YetAnotherBookshelf.Solution_0_Test(input);
