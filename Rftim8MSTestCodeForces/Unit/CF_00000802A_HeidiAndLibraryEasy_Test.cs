...
{
    [TestClass]
    public sealed class CF_00000802A_HeidiAndLibraryEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802A_HeidiAndLibraryEasy));
        ...
        {
            bool result = CF_00000802A_HeidiAndLibraryEasy.Solution_0_Test(input);
