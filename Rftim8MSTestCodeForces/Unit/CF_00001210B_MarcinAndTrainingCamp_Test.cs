...
{
    [TestClass]
    public sealed class CF_00001210B_MarcinAndTrainingCamp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001210B_MarcinAndTrainingCamp));
        ...
        {
            bool result = CF_00001210B_MarcinAndTrainingCamp.Solution_0_Test(input);
