...
{
    [TestClass]
    public sealed class CF_00001181C_Flag_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001181C_Flag));
        ...
        {
            bool result = CF_00001181C_Flag.Solution_0_Test(input);
