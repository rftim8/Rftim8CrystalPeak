...
{
    [TestClass]
    public sealed class CF_00001392B_OmkarAndInfinityClock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001392B_OmkarAndInfinityClock));
        ...
        {
            bool result = CF_00001392B_OmkarAndInfinityClock.Solution_0_Test(input);
