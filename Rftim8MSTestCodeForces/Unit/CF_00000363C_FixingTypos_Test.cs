...
{
    [TestClass]
    public sealed class CF_00000363C_FixingTypos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000363C_FixingTypos));
        ...
        {
            bool result = CF_00000363C_FixingTypos.Solution_0_Test(input);
