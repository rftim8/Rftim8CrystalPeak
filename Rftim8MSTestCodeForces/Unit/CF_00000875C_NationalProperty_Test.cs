...
{
    [TestClass]
    public sealed class CF_00000875C_NationalProperty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000875C_NationalProperty));
        ...
        {
            bool result = CF_00000875C_NationalProperty.Solution_0_Test(input);
