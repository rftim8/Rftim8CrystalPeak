...
{
    [TestClass]
    public sealed class CF_00000718D_AndrewAndChemistry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000718D_AndrewAndChemistry));
        ...
        {
            bool result = CF_00000718D_AndrewAndChemistry.Solution_0_Test(input);
