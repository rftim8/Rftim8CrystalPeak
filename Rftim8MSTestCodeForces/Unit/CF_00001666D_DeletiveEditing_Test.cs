...
{
    [TestClass]
    public sealed class CF_00001666D_DeletiveEditing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001666D_DeletiveEditing));
        ...
        {
            bool result = CF_00001666D_DeletiveEditing.Solution_0_Test(input);
