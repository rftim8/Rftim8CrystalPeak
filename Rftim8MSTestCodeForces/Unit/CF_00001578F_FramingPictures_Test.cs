...
{
    [TestClass]
    public sealed class CF_00001578F_FramingPictures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001578F_FramingPictures));
        ...
        {
            bool result = CF_00001578F_FramingPictures.Solution_0_Test(input);
