...
{
    [TestClass]
    public sealed class CF_00001528C_TreesOfTranquillity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001528C_TreesOfTranquillity));
        ...
        {
            bool result = CF_00001528C_TreesOfTranquillity.Solution_0_Test(input);
