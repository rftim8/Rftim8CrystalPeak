...
{
    [TestClass]
    public sealed class CF_00001823A_Acharacteristic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001823A_Acharacteristic));
        ...
        {
            bool result = CF_00001823A_Acharacteristic.Solution_0_Test(input);
