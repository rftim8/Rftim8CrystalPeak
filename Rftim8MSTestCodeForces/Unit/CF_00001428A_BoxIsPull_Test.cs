...
{
    [TestClass]
    public sealed class CF_00001428A_BoxIsPull_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001428A_BoxIsPull));
        ...
        {
            bool result = CF_00001428A_BoxIsPull.Solution_0_Test(input);
