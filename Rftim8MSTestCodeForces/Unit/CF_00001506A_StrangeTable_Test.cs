...
{
    [TestClass]
    public sealed class CF_00001506A_StrangeTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001506A_StrangeTable));
        ...
        {
            bool result = CF_00001506A_StrangeTable.Solution_0_Test(input);
