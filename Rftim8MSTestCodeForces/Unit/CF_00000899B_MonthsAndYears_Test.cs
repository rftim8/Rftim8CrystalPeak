...
{
    [TestClass]
    public sealed class CF_00000899B_MonthsAndYears_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000899B_MonthsAndYears));
        ...
        {
            bool result = CF_00000899B_MonthsAndYears.Solution_0_Test(input);
