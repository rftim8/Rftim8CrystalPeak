...
{
    [TestClass]
    public sealed class CF_00001227E_ArsonInBerlandForest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001227E_ArsonInBerlandForest));
        ...
        {
            bool result = CF_00001227E_ArsonInBerlandForest.Solution_0_Test(input);
