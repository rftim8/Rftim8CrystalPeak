...
{
    [TestClass]
    public sealed class CF_00000891B_Gluttony_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000891B_Gluttony));
        ...
        {
            bool result = CF_00000891B_Gluttony.Solution_0_Test(input);
