...
{
    [TestClass]
    public sealed class CF_00000723F_StSpanningTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000723F_StSpanningTree));
        ...
        {
            bool result = CF_00000723F_StSpanningTree.Solution_0_Test(input);
