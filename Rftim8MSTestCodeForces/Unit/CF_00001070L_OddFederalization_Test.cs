...
{
    [TestClass]
    public sealed class CF_00001070L_OddFederalization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001070L_OddFederalization));
        ...
        {
            bool result = CF_00001070L_OddFederalization.Solution_0_Test(input);
