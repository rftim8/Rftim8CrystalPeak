...
{
    [TestClass]
    public sealed class CF_00001878E_IvaAndPav_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001878E_IvaAndPav));
        ...
        {
            bool result = CF_00001878E_IvaAndPav.Solution_0_Test(input);
