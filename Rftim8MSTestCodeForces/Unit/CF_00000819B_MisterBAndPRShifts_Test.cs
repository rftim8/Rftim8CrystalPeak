...
{
    [TestClass]
    public sealed class CF_00000819B_MisterBAndPRShifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000819B_MisterBAndPRShifts));
        ...
        {
            bool result = CF_00000819B_MisterBAndPRShifts.Solution_0_Test(input);
