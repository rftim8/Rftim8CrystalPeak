...
{
    [TestClass]
    public sealed class CF_00000238B_BoringPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000238B_BoringPartition));
        ...
        {
            bool result = CF_00000238B_BoringPartition.Solution_0_Test(input);
