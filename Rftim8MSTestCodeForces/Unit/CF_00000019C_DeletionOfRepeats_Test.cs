...
{
    [TestClass]
    public sealed class CF_00000019C_DeletionOfRepeats_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000019C_DeletionOfRepeats));
        ...
        {
            bool result = CF_00000019C_DeletionOfRepeats.Solution_0_Test(input);
