...
{
    [TestClass]
    public sealed class CF_00000250C_MovieCritics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000250C_MovieCritics));
        ...
        {
            bool result = CF_00000250C_MovieCritics.Solution_0_Test(input);
