...
{
    [TestClass]
    public sealed class CF_00001574A_RegularBracketSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001574A_RegularBracketSequences));
        ...
        {
            bool result = CF_00001574A_RegularBracketSequences.Solution_0_Test(input);
