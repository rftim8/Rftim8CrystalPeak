...
{
    [TestClass]
    public sealed class CF_00001783D_DifferentArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001783D_DifferentArrays));
        ...
        {
            bool result = CF_00001783D_DifferentArrays.Solution_0_Test(input);
