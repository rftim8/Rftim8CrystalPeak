...
{
    [TestClass]
    public sealed class CF_00001011B_PlanningTheExpedition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001011B_PlanningTheExpedition));
        ...
        {
            bool result = CF_00001011B_PlanningTheExpedition.Solution_0_Test(input);
