...
{
    [TestClass]
    public sealed class CF_00000371B_FoxDividingCheese_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000371B_FoxDividingCheese));
        ...
        {
            bool result = CF_00000371B_FoxDividingCheese.Solution_0_Test(input);
