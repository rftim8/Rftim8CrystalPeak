...
{
    [TestClass]
    public sealed class CF_00001090F_HowToLearnYouScore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090F_HowToLearnYouScore));
        ...
        {
            bool result = CF_00001090F_HowToLearnYouScore.Solution_0_Test(input);
