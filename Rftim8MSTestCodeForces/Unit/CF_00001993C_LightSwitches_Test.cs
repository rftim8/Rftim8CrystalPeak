...
{
    [TestClass]
    public sealed class CF_00001993C_LightSwitches_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001993C_LightSwitches));
        ...
        {
            bool result = CF_00001993C_LightSwitches.Solution_0_Test(input);
