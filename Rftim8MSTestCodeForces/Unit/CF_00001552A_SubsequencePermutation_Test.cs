...
{
    [TestClass]
    public sealed class CF_00001552A_SubsequencePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001552A_SubsequencePermutation));
        ...
        {
            bool result = CF_00001552A_SubsequencePermutation.Solution_0_Test(input);
