...
{
    [TestClass]
    public sealed class CF_00000495A_DigitalCounter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000495A_DigitalCounter));
        ...
        {
            bool result = CF_00000495A_DigitalCounter.Solution_0_Test(input);
