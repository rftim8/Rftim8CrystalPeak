...
{
    [TestClass]
    public sealed class CF_00000837A_TextVolume_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000837A_TextVolume));
        ...
        {
            bool result = CF_00000837A_TextVolume.Solution_0_Test(input);
