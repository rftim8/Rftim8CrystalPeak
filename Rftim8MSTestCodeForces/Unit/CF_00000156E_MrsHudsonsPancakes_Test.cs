...
{
    [TestClass]
    public sealed class CF_00000156E_MrsHudsonsPancakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000156E_MrsHudsonsPancakes));
        ...
        {
            bool result = CF_00000156E_MrsHudsonsPancakes.Solution_0_Test(input);
