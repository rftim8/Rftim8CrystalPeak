...
{
    [TestClass]
    public sealed class CF_00000490F_TreelandTour_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000490F_TreelandTour));
        ...
        {
            bool result = CF_00000490F_TreelandTour.Solution_0_Test(input);
