...
{
    [TestClass]
    public sealed class CF_00001357A3_DistinguishHFromX_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001357A3_DistinguishHFromX));
        ...
        {
            bool result = CF_00001357A3_DistinguishHFromX.Solution_0_Test(input);
