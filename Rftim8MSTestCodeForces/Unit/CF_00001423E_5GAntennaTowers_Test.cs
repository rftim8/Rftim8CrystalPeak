...
{
    [TestClass]
    public sealed class CF_00001423E_5GAntennaTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001423E_5GAntennaTowers));
        ...
        {
            bool result = CF_00001423E_5GAntennaTowers.Solution_0_Test(input);
