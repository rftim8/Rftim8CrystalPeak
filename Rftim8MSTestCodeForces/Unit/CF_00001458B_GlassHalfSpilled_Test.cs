...
{
    [TestClass]
    public sealed class CF_00001458B_GlassHalfSpilled_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001458B_GlassHalfSpilled));
        ...
        {
            bool result = CF_00001458B_GlassHalfSpilled.Solution_0_Test(input);
