...
{
    [TestClass]
    public sealed class CF_00001408B_ArraysSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001408B_ArraysSum));
        ...
        {
            bool result = CF_00001408B_ArraysSum.Solution_0_Test(input);
