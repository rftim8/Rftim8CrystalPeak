...
{
    [TestClass]
    public sealed class CF_00000388E_FoxAndMeteorShower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000388E_FoxAndMeteorShower));
        ...
        {
            bool result = CF_00000388E_FoxAndMeteorShower.Solution_0_Test(input);
