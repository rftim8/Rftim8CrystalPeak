...
{
    [TestClass]
    public sealed class CF_00001455E_FourPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001455E_FourPoints));
        ...
        {
            bool result = CF_00001455E_FourPoints.Solution_0_Test(input);
