...
{
    [TestClass]
    public sealed class CF_00000630L_CrackingTheCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630L_CrackingTheCode));
        ...
        {
            bool result = CF_00000630L_CrackingTheCode.Solution_0_Test(input);
