...
{
    [TestClass]
    public sealed class CF_00000771F_BearAndIsomorphicPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000771F_BearAndIsomorphicPoints));
        ...
        {
            bool result = CF_00000771F_BearAndIsomorphicPoints.Solution_0_Test(input);
