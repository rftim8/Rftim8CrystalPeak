...
{
    [TestClass]
    public sealed class CF_00001932C_LRremainders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001932C_LRremainders));
        ...
        {
            bool result = CF_00001932C_LRremainders.Solution_0_Test(input);
