...
{
    [TestClass]
    public sealed class CF_00000736D_Permutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000736D_Permutations));
        ...
        {
            bool result = CF_00000736D_Permutations.Solution_0_Test(input);
