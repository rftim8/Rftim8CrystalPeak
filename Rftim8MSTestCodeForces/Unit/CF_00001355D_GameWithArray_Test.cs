...
{
    [TestClass]
    public sealed class CF_00001355D_GameWithArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001355D_GameWithArray));
        ...
        {
            bool result = CF_00001355D_GameWithArray.Solution_0_Test(input);
