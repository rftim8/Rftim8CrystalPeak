...
{
    [TestClass]
    public sealed class CF_00001718C_TonyaAndBurenka179_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001718C_TonyaAndBurenka179));
        ...
        {
            bool result = CF_00001718C_TonyaAndBurenka179.Solution_0_Test(input);
