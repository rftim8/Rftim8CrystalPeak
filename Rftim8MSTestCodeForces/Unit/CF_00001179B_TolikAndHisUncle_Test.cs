...
{
    [TestClass]
    public sealed class CF_00001179B_TolikAndHisUncle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001179B_TolikAndHisUncle));
        ...
        {
            bool result = CF_00001179B_TolikAndHisUncle.Solution_0_Test(input);
