...
{
    [TestClass]
    public sealed class CF_00000999F_CardsAndJoy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000999F_CardsAndJoy));
        ...
        {
            bool result = CF_00000999F_CardsAndJoy.Solution_0_Test(input);
