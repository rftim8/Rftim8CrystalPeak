...
{
    [TestClass]
    public sealed class CF_00001494C_1DSokoban_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001494C_1DSokoban));
        ...
        {
            bool result = CF_00001494C_1DSokoban.Solution_0_Test(input);
