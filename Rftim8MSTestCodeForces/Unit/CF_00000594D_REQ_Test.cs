...
{
    [TestClass]
    public sealed class CF_00000594D_REQ_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000594D_REQ));
        ...
        {
            bool result = CF_00000594D_REQ.Solution_0_Test(input);
