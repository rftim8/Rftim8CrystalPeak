...
{
    [TestClass]
    public sealed class CF_00001045F_ShadyLady_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001045F_ShadyLady));
        ...
        {
            bool result = CF_00001045F_ShadyLady.Solution_0_Test(input);
