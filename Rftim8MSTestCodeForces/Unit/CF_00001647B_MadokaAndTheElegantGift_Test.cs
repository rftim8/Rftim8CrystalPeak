...
{
    [TestClass]
    public sealed class CF_00001647B_MadokaAndTheElegantGift_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001647B_MadokaAndTheElegantGift));
        ...
        {
            bool result = CF_00001647B_MadokaAndTheElegantGift.Solution_0_Test(input);
