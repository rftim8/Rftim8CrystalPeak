...
{
    [TestClass]
    public sealed class CF_00000063A_SinkingShip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000063A_SinkingShip));
        ...
        {
            bool result = CF_00000063A_SinkingShip.Solution_0_Test(input);
