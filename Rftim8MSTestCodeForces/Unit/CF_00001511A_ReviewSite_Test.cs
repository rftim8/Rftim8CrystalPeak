...
{
    [TestClass]
    public sealed class CF_00001511A_ReviewSite_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001511A_ReviewSite));
        ...
        {
            bool result = CF_00001511A_ReviewSite.Solution_0_Test(input);
