...
{
    [TestClass]
    public sealed class CF_00001030F_PuttingBoxesTogether_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001030F_PuttingBoxesTogether));
        ...
        {
            bool result = CF_00001030F_PuttingBoxesTogether.Solution_0_Test(input);
