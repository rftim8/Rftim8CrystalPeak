...
{
    [TestClass]
    public sealed class CF_00000933D_ACreativeCutout_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000933D_ACreativeCutout));
        ...
        {
            bool result = CF_00000933D_ACreativeCutout.Solution_0_Test(input);
