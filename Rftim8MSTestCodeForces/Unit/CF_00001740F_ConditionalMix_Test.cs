...
{
    [TestClass]
    public sealed class CF_00001740F_ConditionalMix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001740F_ConditionalMix));
        ...
        {
            bool result = CF_00001740F_ConditionalMix.Solution_0_Test(input);
