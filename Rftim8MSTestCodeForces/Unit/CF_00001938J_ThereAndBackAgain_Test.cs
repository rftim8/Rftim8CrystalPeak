...
{
    [TestClass]
    public sealed class CF_00001938J_ThereAndBackAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001938J_ThereAndBackAgain));
        ...
        {
            bool result = CF_00001938J_ThereAndBackAgain.Solution_0_Test(input);
