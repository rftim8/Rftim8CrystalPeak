...
{
    [TestClass]
    public sealed class CF_00000029D_AntOnTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000029D_AntOnTheTree));
        ...
        {
            bool result = CF_00000029D_AntOnTheTree.Solution_0_Test(input);
