...
{
    [TestClass]
    public sealed class CF_00000131C_TheWorldIsATheatre_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000131C_TheWorldIsATheatre));
        ...
        {
            bool result = CF_00000131C_TheWorldIsATheatre.Solution_0_Test(input);
