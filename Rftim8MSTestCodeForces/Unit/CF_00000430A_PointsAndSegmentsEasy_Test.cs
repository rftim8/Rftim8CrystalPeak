...
{
    [TestClass]
    public sealed class CF_00000430A_PointsAndSegmentsEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000430A_PointsAndSegmentsEasy));
        ...
        {
            bool result = CF_00000430A_PointsAndSegmentsEasy.Solution_0_Test(input);
