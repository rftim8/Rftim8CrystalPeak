...
{
    [TestClass]
    public sealed class CF_00001905E_OneX_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001905E_OneX));
        ...
        {
            bool result = CF_00001905E_OneX.Solution_0_Test(input);
