...
{
    [TestClass]
    public sealed class CF_00001920C_PartitioningTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001920C_PartitioningTheArray));
        ...
        {
            bool result = CF_00001920C_PartitioningTheArray.Solution_0_Test(input);
