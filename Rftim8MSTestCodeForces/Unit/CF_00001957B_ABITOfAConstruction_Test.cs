...
{
    [TestClass]
    public sealed class CF_00001957B_ABITOfAConstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001957B_ABITOfAConstruction));
        ...
        {
            bool result = CF_00001957B_ABITOfAConstruction.Solution_0_Test(input);
