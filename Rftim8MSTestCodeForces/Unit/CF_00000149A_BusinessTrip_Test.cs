...
{
    [TestClass]
    public sealed class CF_00000149A_BusinessTrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000149A_BusinessTrip));
        ...
        {
            bool result = CF_00000149A_BusinessTrip.Solution_0_Test(input);
