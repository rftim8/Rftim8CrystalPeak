...
{
    [TestClass]
    public sealed class CF_00001994B_FunGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001994B_FunGame));
        ...
        {
            bool result = CF_00001994B_FunGame.Solution_0_Test(input);
