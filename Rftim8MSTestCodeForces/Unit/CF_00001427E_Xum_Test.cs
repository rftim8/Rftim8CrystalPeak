...
{
    [TestClass]
    public sealed class CF_00001427E_Xum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001427E_Xum));
        ...
        {
            bool result = CF_00001427E_Xum.Solution_0_Test(input);
