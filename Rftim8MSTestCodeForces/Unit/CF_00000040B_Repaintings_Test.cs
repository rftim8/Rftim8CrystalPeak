...
{
    [TestClass]
    public sealed class CF_00000040B_Repaintings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000040B_Repaintings));
        ...
        {
            bool result = CF_00000040B_Repaintings.Solution_0_Test(input);
