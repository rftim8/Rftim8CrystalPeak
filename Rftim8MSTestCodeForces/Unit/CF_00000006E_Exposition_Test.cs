...
{
    [TestClass]
    public sealed class CF_00000006E_Exposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000006E_Exposition));
        ...
        {
            bool result = CF_00000006E_Exposition.Solution_0_Test(input);
