...
{
    [TestClass]
    public sealed class CF_00001346C_SpringCleaning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001346C_SpringCleaning));
        ...
        {
            bool result = CF_00001346C_SpringCleaning.Solution_0_Test(input);
