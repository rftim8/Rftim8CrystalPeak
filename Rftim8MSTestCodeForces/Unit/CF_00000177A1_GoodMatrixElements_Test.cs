...
{
    [TestClass]
    public sealed class CF_00000177A1_GoodMatrixElements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000177A1_GoodMatrixElements));
        ...
        {
            bool result = CF_00000177A1_GoodMatrixElements.Solution_0_Test(input);
