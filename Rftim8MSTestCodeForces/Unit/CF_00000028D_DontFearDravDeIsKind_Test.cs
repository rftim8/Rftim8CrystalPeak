...
{
    [TestClass]
    public sealed class CF_00000028D_DontFearDravDeIsKind_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000028D_DontFearDravDeIsKind));
        ...
        {
            bool result = CF_00000028D_DontFearDravDeIsKind.Solution_0_Test(input);
