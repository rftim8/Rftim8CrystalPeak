...
{
    [TestClass]
    public sealed class CF_00000591B_Rebranding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000591B_Rebranding));
        ...
        {
            bool result = CF_00000591B_Rebranding.Solution_0_Test(input);
