...
{
    [TestClass]
    public sealed class CF_00001295B_InfinitePrefixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001295B_InfinitePrefixes));
        ...
        {
            bool result = CF_00001295B_InfinitePrefixes.Solution_0_Test(input);
