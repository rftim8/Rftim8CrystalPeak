...
{
    [TestClass]
    public sealed class CF_00001250J_TheParade_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250J_TheParade));
        ...
        {
            bool result = CF_00001250J_TheParade.Solution_0_Test(input);
