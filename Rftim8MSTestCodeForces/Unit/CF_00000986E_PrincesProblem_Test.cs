...
{
    [TestClass]
    public sealed class CF_00000986E_PrincesProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000986E_PrincesProblem));
        ...
        {
            bool result = CF_00000986E_PrincesProblem.Solution_0_Test(input);
