...
{
    [TestClass]
    public sealed class CF_00000085E_GuardTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000085E_GuardTowers));
        ...
        {
            bool result = CF_00000085E_GuardTowers.Solution_0_Test(input);
