...
{
    [TestClass]
    public sealed class CF_00000286C_MainSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000286C_MainSequence));
        ...
        {
            bool result = CF_00000286C_MainSequence.Solution_0_Test(input);
