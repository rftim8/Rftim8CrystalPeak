...
{
    [TestClass]
    public sealed class CF_00000154C_DoubleProfiles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000154C_DoubleProfiles));
        ...
        {
            bool result = CF_00000154C_DoubleProfiles.Solution_0_Test(input);
