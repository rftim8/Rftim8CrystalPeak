...
{
    [TestClass]
    public sealed class CF_00000627F_IslandPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000627F_IslandPuzzle));
        ...
        {
            bool result = CF_00000627F_IslandPuzzle.Solution_0_Test(input);
