...
{
    [TestClass]
    public sealed class CF_00001085D_MinimumDiameterTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001085D_MinimumDiameterTree));
        ...
        {
            bool result = CF_00001085D_MinimumDiameterTree.Solution_0_Test(input);
