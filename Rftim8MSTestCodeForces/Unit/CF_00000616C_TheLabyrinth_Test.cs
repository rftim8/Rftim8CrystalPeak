...
{
    [TestClass]
    public sealed class CF_00000616C_TheLabyrinth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000616C_TheLabyrinth));
        ...
        {
            bool result = CF_00000616C_TheLabyrinth.Solution_0_Test(input);
