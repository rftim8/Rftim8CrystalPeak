...
{
    [TestClass]
    public sealed class CF_00001787F_InverseTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001787F_InverseTransformation));
        ...
        {
            bool result = CF_00001787F_InverseTransformation.Solution_0_Test(input);
