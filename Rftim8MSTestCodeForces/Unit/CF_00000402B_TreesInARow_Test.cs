...
{
    [TestClass]
    public sealed class CF_00000402B_TreesInARow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000402B_TreesInARow));
        ...
        {
            bool result = CF_00000402B_TreesInARow.Solution_0_Test(input);
