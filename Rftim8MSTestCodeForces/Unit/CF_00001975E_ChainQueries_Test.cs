...
{
    [TestClass]
    public sealed class CF_00001975E_ChainQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001975E_ChainQueries));
        ...
        {
            bool result = CF_00001975E_ChainQueries.Solution_0_Test(input);
