...
{
    [TestClass]
    public sealed class CF_00001607G_BanquetPreparations1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001607G_BanquetPreparations1));
        ...
        {
            bool result = CF_00001607G_BanquetPreparations1.Solution_0_Test(input);
