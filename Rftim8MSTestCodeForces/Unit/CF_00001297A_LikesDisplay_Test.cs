...
{
    [TestClass]
    public sealed class CF_00001297A_LikesDisplay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001297A_LikesDisplay));
        ...
        {
            bool result = CF_00001297A_LikesDisplay.Solution_0_Test(input);
