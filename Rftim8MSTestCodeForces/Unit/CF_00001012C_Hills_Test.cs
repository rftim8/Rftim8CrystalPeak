...
{
    [TestClass]
    public sealed class CF_00001012C_Hills_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001012C_Hills));
        ...
        {
            bool result = CF_00001012C_Hills.Solution_0_Test(input);
