...
{
    [TestClass]
    public sealed class CF_00001332F_IndependentSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001332F_IndependentSet));
        ...
        {
            bool result = CF_00001332F_IndependentSet.Solution_0_Test(input);
