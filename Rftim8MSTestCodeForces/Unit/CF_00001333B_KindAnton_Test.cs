...
{
    [TestClass]
    public sealed class CF_00001333B_KindAnton_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001333B_KindAnton));
        ...
        {
            bool result = CF_00001333B_KindAnton.Solution_0_Test(input);
