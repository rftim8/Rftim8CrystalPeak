...
{
    [TestClass]
    public sealed class CF_00001747E_ListGeneration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001747E_ListGeneration));
        ...
        {
            bool result = CF_00001747E_ListGeneration.Solution_0_Test(input);
