...
{
    [TestClass]
    public sealed class CF_00001788E_SumOverZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001788E_SumOverZero));
        ...
        {
            bool result = CF_00001788E_SumOverZero.Solution_0_Test(input);
