...
{
    [TestClass]
    public sealed class CF_00001741D_MashaAndABeautifulTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001741D_MashaAndABeautifulTree));
        ...
        {
            bool result = CF_00001741D_MashaAndABeautifulTree.Solution_0_Test(input);
