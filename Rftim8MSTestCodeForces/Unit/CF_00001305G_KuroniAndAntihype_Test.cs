...
{
    [TestClass]
    public sealed class CF_00001305G_KuroniAndAntihype_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001305G_KuroniAndAntihype));
        ...
        {
            bool result = CF_00001305G_KuroniAndAntihype.Solution_0_Test(input);
