...
{
    [TestClass]
    public sealed class CF_00000185B_MushroomScientists_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000185B_MushroomScientists));
        ...
        {
            bool result = CF_00000185B_MushroomScientists.Solution_0_Test(input);
