...
{
    [TestClass]
    public sealed class CF_00000607C_Marbles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000607C_Marbles));
        ...
        {
            bool result = CF_00000607C_Marbles.Solution_0_Test(input);
