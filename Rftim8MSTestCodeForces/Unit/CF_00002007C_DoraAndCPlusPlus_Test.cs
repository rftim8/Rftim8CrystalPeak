...
{
    [TestClass]
    public sealed class CF_00002007C_DoraAndCPlusPlus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002007C_DoraAndCPlusPlus));
        ...
        {
            bool result = CF_00002007C_DoraAndCPlusPlus.Solution_0_Test(input);
