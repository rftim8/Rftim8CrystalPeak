...
{
    [TestClass]
    public sealed class CF_00002003A_TurtleAndGoodStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002003A_TurtleAndGoodStrings));
        ...
        {
            bool result = CF_00002003A_TurtleAndGoodStrings.Solution_0_Test(input);
