...
{
    [TestClass]
    public sealed class CF_00000992E_NastyaAndKingShamans_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000992E_NastyaAndKingShamans));
        ...
        {
            bool result = CF_00000992E_NastyaAndKingShamans.Solution_0_Test(input);
