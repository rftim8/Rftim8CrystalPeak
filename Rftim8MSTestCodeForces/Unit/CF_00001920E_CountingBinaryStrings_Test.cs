...
{
    [TestClass]
    public sealed class CF_00001920E_CountingBinaryStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001920E_CountingBinaryStrings));
        ...
        {
            bool result = CF_00001920E_CountingBinaryStrings.Solution_0_Test(input);
