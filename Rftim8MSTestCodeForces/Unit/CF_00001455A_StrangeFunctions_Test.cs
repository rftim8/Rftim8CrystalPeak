...
{
    [TestClass]
    public sealed class CF_00001455A_StrangeFunctions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001455A_StrangeFunctions));
        ...
        {
            bool result = CF_00001455A_StrangeFunctions.Solution_0_Test(input);
