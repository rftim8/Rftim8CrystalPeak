...
{
    [TestClass]
    public sealed class CF_00001742B_Increasing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001742B_Increasing));
        ...
        {
            bool result = CF_00001742B_Increasing.Solution_0_Test(input);
