...
{
    [TestClass]
    public sealed class CF_00000895D_StringMark_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000895D_StringMark));
        ...
        {
            bool result = CF_00000895D_StringMark.Solution_0_Test(input);
