...
{
    [TestClass]
    public sealed class CF_00001375I_CubicLattice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001375I_CubicLattice));
        ...
        {
            bool result = CF_00001375I_CubicLattice.Solution_0_Test(input);
