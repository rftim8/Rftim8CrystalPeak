...
{
    [TestClass]
    public sealed class CF_00001468M_SimilarSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468M_SimilarSets));
        ...
        {
            bool result = CF_00001468M_SimilarSets.Solution_0_Test(input);
