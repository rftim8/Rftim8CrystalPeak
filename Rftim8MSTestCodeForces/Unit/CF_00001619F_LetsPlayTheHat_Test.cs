...
{
    [TestClass]
    public sealed class CF_00001619F_LetsPlayTheHat_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001619F_LetsPlayTheHat));
        ...
        {
            bool result = CF_00001619F_LetsPlayTheHat.Solution_0_Test(input);
