...
{
    [TestClass]
    public sealed class CF_00000986B_PetrAndPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000986B_PetrAndPermutations));
        ...
        {
            bool result = CF_00000986B_PetrAndPermutations.Solution_0_Test(input);
