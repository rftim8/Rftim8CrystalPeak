...
{
    [TestClass]
    public sealed class CF_00000704B_AntMan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000704B_AntMan));
        ...
        {
            bool result = CF_00000704B_AntMan.Solution_0_Test(input);
