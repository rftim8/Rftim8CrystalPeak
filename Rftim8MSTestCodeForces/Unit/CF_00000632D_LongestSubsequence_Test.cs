...
{
    [TestClass]
    public sealed class CF_00000632D_LongestSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000632D_LongestSubsequence));
        ...
        {
            bool result = CF_00000632D_LongestSubsequence.Solution_0_Test(input);
