...
{
    [TestClass]
    public sealed class CF_00001949K_MakeTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001949K_MakeTriangle));
        ...
        {
            bool result = CF_00001949K_MakeTriangle.Solution_0_Test(input);
