...
{
    [TestClass]
    public sealed class CF_00001116D5_Creeper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001116D5_Creeper));
        ...
        {
            bool result = CF_00001116D5_Creeper.Solution_0_Test(input);
