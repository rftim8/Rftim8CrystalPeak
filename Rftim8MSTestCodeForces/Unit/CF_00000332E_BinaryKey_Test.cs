...
{
    [TestClass]
    public sealed class CF_00000332E_BinaryKey_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000332E_BinaryKey));
        ...
        {
            bool result = CF_00000332E_BinaryKey.Solution_0_Test(input);
