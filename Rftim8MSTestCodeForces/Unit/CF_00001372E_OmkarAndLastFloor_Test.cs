...
{
    [TestClass]
    public sealed class CF_00001372E_OmkarAndLastFloor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001372E_OmkarAndLastFloor));
        ...
        {
            bool result = CF_00001372E_OmkarAndLastFloor.Solution_0_Test(input);
