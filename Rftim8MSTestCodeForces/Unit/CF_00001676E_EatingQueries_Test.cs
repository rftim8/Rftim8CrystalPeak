...
{
    [TestClass]
    public sealed class CF_00001676E_EatingQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001676E_EatingQueries));
        ...
        {
            bool result = CF_00001676E_EatingQueries.Solution_0_Test(input);
