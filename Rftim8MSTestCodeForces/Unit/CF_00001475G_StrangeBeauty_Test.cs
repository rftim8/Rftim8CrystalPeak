...
{
    [TestClass]
    public sealed class CF_00001475G_StrangeBeauty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001475G_StrangeBeauty));
        ...
        {
            bool result = CF_00001475G_StrangeBeauty.Solution_0_Test(input);
