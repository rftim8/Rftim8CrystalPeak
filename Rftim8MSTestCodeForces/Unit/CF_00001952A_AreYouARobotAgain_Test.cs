...
{
    [TestClass]
    public sealed class CF_00001952A_AreYouARobotAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001952A_AreYouARobotAgain));
        ...
        {
            bool result = CF_00001952A_AreYouARobotAgain.Solution_0_Test(input);
