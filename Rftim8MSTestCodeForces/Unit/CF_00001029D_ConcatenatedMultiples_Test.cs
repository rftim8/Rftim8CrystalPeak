...
{
    [TestClass]
    public sealed class CF_00001029D_ConcatenatedMultiples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001029D_ConcatenatedMultiples));
        ...
        {
            bool result = CF_00001029D_ConcatenatedMultiples.Solution_0_Test(input);
