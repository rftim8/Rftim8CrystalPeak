...
{
    [TestClass]
    public sealed class CF_00001584E_GameWithStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001584E_GameWithStones));
        ...
        {
            bool result = CF_00001584E_GameWithStones.Solution_0_Test(input);
