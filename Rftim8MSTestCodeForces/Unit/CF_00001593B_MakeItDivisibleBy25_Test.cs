...
{
    [TestClass]
    public sealed class CF_00001593B_MakeItDivisibleBy25_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001593B_MakeItDivisibleBy25));
        ...
        {
            bool result = CF_00001593B_MakeItDivisibleBy25.Solution_0_Test(input);
