...
{
    [TestClass]
    public sealed class CF_00002037G_NatlanExploring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002037G_NatlanExploring));
        ...
        {
            bool result = CF_00002037G_NatlanExploring.Solution_0_Test(input);
