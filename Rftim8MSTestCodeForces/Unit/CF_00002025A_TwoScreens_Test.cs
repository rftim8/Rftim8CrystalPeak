...
{
    [TestClass]
    public sealed class CF_00002025A_TwoScreens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002025A_TwoScreens));
        ...
        {
            bool result = CF_00002025A_TwoScreens.Solution_0_Test(input);
