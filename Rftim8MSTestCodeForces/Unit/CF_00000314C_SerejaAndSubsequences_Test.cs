...
{
    [TestClass]
    public sealed class CF_00000314C_SerejaAndSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000314C_SerejaAndSubsequences));
        ...
        {
            bool result = CF_00000314C_SerejaAndSubsequences.Solution_0_Test(input);
