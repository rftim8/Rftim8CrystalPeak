...
{
    [TestClass]
    public sealed class CF_00001462B_LastYearsSubstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001462B_LastYearsSubstring));
        ...
        {
            bool result = CF_00001462B_LastYearsSubstring.Solution_0_Test(input);
