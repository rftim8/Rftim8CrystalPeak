...
{
    [TestClass]
    public sealed class CF_00001847A_TheManWhoBecameAGod_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001847A_TheManWhoBecameAGod));
        ...
        {
            bool result = CF_00001847A_TheManWhoBecameAGod.Solution_0_Test(input);
