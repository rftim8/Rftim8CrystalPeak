...
{
    [TestClass]
    public sealed class CF_00001110F_NearestLeaf_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001110F_NearestLeaf));
        ...
        {
            bool result = CF_00001110F_NearestLeaf.Solution_0_Test(input);
