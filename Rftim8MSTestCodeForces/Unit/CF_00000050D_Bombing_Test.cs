...
{
    [TestClass]
    public sealed class CF_00000050D_Bombing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000050D_Bombing));
        ...
        {
            bool result = CF_00000050D_Bombing.Solution_0_Test(input);
