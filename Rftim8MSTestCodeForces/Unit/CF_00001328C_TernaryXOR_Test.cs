...
{
    [TestClass]
    public sealed class CF_00001328C_TernaryXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001328C_TernaryXOR));
        ...
        {
            bool result = CF_00001328C_TernaryXOR.Solution_0_Test(input);
