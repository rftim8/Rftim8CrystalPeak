...
{
    [TestClass]
    public sealed class CF_00001158A_ThePartyAndSweets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001158A_ThePartyAndSweets));
        ...
        {
            bool result = CF_00001158A_ThePartyAndSweets.Solution_0_Test(input);
