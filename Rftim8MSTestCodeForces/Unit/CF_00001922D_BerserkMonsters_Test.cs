...
{
    [TestClass]
    public sealed class CF_00001922D_BerserkMonsters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001922D_BerserkMonsters));
        ...
        {
            bool result = CF_00001922D_BerserkMonsters.Solution_0_Test(input);
