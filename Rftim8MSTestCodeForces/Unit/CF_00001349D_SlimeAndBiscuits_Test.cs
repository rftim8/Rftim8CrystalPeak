...
{
    [TestClass]
    public sealed class CF_00001349D_SlimeAndBiscuits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001349D_SlimeAndBiscuits));
        ...
        {
            bool result = CF_00001349D_SlimeAndBiscuits.Solution_0_Test(input);
