...
{
    [TestClass]
    public sealed class CF_00001918D_BlockingElements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001918D_BlockingElements));
        ...
        {
            bool result = CF_00001918D_BlockingElements.Solution_0_Test(input);
