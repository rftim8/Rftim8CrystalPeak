...
{
    [TestClass]
    public sealed class CF_00002025F_ChooseYourQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002025F_ChooseYourQueries));
        ...
        {
            bool result = CF_00002025F_ChooseYourQueries.Solution_0_Test(input);
