...
{
    [TestClass]
    public sealed class CF_00000186B_GrowingMushrooms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000186B_GrowingMushrooms));
        ...
        {
            bool result = CF_00000186B_GrowingMushrooms.Solution_0_Test(input);
