...
{
    [TestClass]
    public sealed class CF_00001398D_ColoredRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001398D_ColoredRectangles));
        ...
        {
            bool result = CF_00001398D_ColoredRectangles.Solution_0_Test(input);
