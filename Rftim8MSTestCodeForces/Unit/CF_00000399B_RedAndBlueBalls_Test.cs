...
{
    [TestClass]
    public sealed class CF_00000399B_RedAndBlueBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000399B_RedAndBlueBalls));
        ...
        {
            bool result = CF_00000399B_RedAndBlueBalls.Solution_0_Test(input);
