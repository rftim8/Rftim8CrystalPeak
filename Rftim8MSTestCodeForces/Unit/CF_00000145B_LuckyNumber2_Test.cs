...
{
    [TestClass]
    public sealed class CF_00000145B_LuckyNumber2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000145B_LuckyNumber2));
        ...
        {
            bool result = CF_00000145B_LuckyNumber2.Solution_0_Test(input);
