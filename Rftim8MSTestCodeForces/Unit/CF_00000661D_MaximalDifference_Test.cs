...
{
    [TestClass]
    public sealed class CF_00000661D_MaximalDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000661D_MaximalDifference));
        ...
        {
            bool result = CF_00000661D_MaximalDifference.Solution_0_Test(input);
