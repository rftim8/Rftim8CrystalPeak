...
{
    [TestClass]
    public sealed class CF_00001887F_MinimumSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001887F_MinimumSegments));
        ...
        {
            bool result = CF_00001887F_MinimumSegments.Solution_0_Test(input);
