...
{
    [TestClass]
    public sealed class CF_00001632D_NewYearConcert_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001632D_NewYearConcert));
        ...
        {
            bool result = CF_00001632D_NewYearConcert.Solution_0_Test(input);
