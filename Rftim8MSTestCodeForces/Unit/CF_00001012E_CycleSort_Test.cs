...
{
    [TestClass]
    public sealed class CF_00001012E_CycleSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001012E_CycleSort));
        ...
        {
            bool result = CF_00001012E_CycleSort.Solution_0_Test(input);
