...
{
    [TestClass]
    public sealed class CF_00000856A_SetTheory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000856A_SetTheory));
        ...
        {
            bool result = CF_00000856A_SetTheory.Solution_0_Test(input);
