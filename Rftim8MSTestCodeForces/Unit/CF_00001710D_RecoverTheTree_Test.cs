...
{
    [TestClass]
    public sealed class CF_00001710D_RecoverTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001710D_RecoverTheTree));
        ...
        {
            bool result = CF_00001710D_RecoverTheTree.Solution_0_Test(input);
