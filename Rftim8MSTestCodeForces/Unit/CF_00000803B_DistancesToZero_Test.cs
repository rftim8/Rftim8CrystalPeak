...
{
    [TestClass]
    public sealed class CF_00000803B_DistancesToZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000803B_DistancesToZero));
        ...
        {
            bool result = CF_00000803B_DistancesToZero.Solution_0_Test(input);
