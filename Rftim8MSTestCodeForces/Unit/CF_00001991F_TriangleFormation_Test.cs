...
{
    [TestClass]
    public sealed class CF_00001991F_TriangleFormation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001991F_TriangleFormation));
        ...
        {
            bool result = CF_00001991F_TriangleFormation.Solution_0_Test(input);
