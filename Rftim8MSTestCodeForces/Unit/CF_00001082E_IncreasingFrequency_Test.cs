...
{
    [TestClass]
    public sealed class CF_00001082E_IncreasingFrequency_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001082E_IncreasingFrequency));
        ...
        {
            bool result = CF_00001082E_IncreasingFrequency.Solution_0_Test(input);
