...
{
    [TestClass]
    public sealed class CF_00000309E_Sheep_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000309E_Sheep));
        ...
        {
            bool result = CF_00000309E_Sheep.Solution_0_Test(input);
