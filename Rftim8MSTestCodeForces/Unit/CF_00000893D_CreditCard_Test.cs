...
{
    [TestClass]
    public sealed class CF_00000893D_CreditCard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000893D_CreditCard));
        ...
        {
            bool result = CF_00000893D_CreditCard.Solution_0_Test(input);
