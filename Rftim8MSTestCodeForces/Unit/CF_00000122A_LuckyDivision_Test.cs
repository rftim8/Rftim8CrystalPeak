...
{
    [TestClass]
    public sealed class CF_00000122A_LuckyDivision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000122A_LuckyDivision));
        ...
        {
            bool result = CF_00000122A_LuckyDivision.Solution_0_Test(input);
