...
{
    [TestClass]
    public sealed class CF_00000965B_Battleship_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000965B_Battleship));
        ...
        {
            bool result = CF_00000965B_Battleship.Solution_0_Test(input);
