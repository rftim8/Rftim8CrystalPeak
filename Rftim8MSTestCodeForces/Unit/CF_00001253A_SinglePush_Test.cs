...
{
    [TestClass]
    public sealed class CF_00001253A_SinglePush_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001253A_SinglePush));
        ...
        {
            bool result = CF_00001253A_SinglePush.Solution_0_Test(input);
