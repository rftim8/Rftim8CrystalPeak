...
{
    [TestClass]
    public sealed class CF_00001213A_ChipsMoving_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001213A_ChipsMoving));
        ...
        {
            bool result = CF_00001213A_ChipsMoving.Solution_0_Test(input);
