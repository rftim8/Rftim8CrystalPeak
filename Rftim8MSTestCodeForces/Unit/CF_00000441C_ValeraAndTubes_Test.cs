...
{
    [TestClass]
    public sealed class CF_00000441C_ValeraAndTubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000441C_ValeraAndTubes));
        ...
        {
            bool result = CF_00000441C_ValeraAndTubes.Solution_0_Test(input);
