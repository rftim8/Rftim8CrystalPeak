...
{
    [TestClass]
    public sealed class CF_00001592A_GamerHemose_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001592A_GamerHemose));
        ...
        {
            bool result = CF_00001592A_GamerHemose.Solution_0_Test(input);
