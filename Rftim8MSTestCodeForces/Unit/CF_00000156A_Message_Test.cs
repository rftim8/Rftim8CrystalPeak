...
{
    [TestClass]
    public sealed class CF_00000156A_Message_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000156A_Message));
        ...
        {
            bool result = CF_00000156A_Message.Solution_0_Test(input);
