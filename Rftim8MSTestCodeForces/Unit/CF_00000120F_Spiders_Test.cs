...
{
    [TestClass]
    public sealed class CF_00000120F_Spiders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000120F_Spiders));
        ...
        {
            bool result = CF_00000120F_Spiders.Solution_0_Test(input);
