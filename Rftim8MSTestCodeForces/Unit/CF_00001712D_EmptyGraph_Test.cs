...
{
    [TestClass]
    public sealed class CF_00001712D_EmptyGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001712D_EmptyGraph));
        ...
        {
            bool result = CF_00001712D_EmptyGraph.Solution_0_Test(input);
