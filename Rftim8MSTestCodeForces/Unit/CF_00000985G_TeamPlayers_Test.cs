...
{
    [TestClass]
    public sealed class CF_00000985G_TeamPlayers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000985G_TeamPlayers));
        ...
        {
            bool result = CF_00000985G_TeamPlayers.Solution_0_Test(input);
