...
{
    [TestClass]
    public sealed class CF_00001490C_SumOfCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001490C_SumOfCubes));
        ...
        {
            bool result = CF_00001490C_SumOfCubes.Solution_0_Test(input);
