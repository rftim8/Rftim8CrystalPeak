...
{
    [TestClass]
    public sealed class CF_00001059A_Cashier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001059A_Cashier));
        ...
        {
            bool result = CF_00001059A_Cashier.Solution_0_Test(input);
