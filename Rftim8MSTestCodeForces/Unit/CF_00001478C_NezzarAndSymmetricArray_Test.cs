...
{
    [TestClass]
    public sealed class CF_00001478C_NezzarAndSymmetricArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001478C_NezzarAndSymmetricArray));
        ...
        {
            bool result = CF_00001478C_NezzarAndSymmetricArray.Solution_0_Test(input);
