...
{
    [TestClass]
    public sealed class CF_00000063E_SweetsGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000063E_SweetsGame));
        ...
        {
            bool result = CF_00000063E_SweetsGame.Solution_0_Test(input);
