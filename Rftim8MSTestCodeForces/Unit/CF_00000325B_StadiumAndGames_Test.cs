...
{
    [TestClass]
    public sealed class CF_00000325B_StadiumAndGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000325B_StadiumAndGames));
        ...
        {
            bool result = CF_00000325B_StadiumAndGames.Solution_0_Test(input);
