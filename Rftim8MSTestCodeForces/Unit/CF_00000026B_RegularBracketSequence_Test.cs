...
{
    [TestClass]
    public sealed class CF_00000026B_RegularBracketSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000026B_RegularBracketSequence));
        ...
        {
            bool result = CF_00000026B_RegularBracketSequence.Solution_0_Test(input);
