...
{
    [TestClass]
    public sealed class CF_00000536D_TavasInKansas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000536D_TavasInKansas));
        ...
        {
            bool result = CF_00000536D_TavasInKansas.Solution_0_Test(input);
