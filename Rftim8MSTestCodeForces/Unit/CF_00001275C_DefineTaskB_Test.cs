...
{
    [TestClass]
    public sealed class CF_00001275C_DefineTaskB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001275C_DefineTaskB));
        ...
        {
            bool result = CF_00001275C_DefineTaskB.Solution_0_Test(input);
