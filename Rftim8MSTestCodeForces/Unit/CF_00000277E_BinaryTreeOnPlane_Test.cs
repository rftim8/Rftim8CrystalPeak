...
{
    [TestClass]
    public sealed class CF_00000277E_BinaryTreeOnPlane_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000277E_BinaryTreeOnPlane));
        ...
        {
            bool result = CF_00000277E_BinaryTreeOnPlane.Solution_0_Test(input);
