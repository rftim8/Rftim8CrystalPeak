...
{
    [TestClass]
    public sealed class CF_00001659D_ReverseSortSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001659D_ReverseSortSum));
        ...
        {
            bool result = CF_00001659D_ReverseSortSum.Solution_0_Test(input);
