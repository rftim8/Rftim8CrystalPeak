...
{
    [TestClass]
    public sealed class CF_00000015A_CottageVillage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000015A_CottageVillage));
        ...
        {
            bool result = CF_00000015A_CottageVillage.Solution_0_Test(input);
