...
{
    [TestClass]
    public sealed class CF_00000653F_PaperTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000653F_PaperTask));
        ...
        {
            bool result = CF_00000653F_PaperTask.Solution_0_Test(input);
