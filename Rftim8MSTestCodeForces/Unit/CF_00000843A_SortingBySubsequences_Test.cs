...
{
    [TestClass]
    public sealed class CF_00000843A_SortingBySubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000843A_SortingBySubsequences));
        ...
        {
            bool result = CF_00000843A_SortingBySubsequences.Solution_0_Test(input);
