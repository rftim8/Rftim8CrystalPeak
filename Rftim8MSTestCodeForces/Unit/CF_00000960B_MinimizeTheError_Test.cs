...
{
    [TestClass]
    public sealed class CF_00000960B_MinimizeTheError_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000960B_MinimizeTheError));
        ...
        {
            bool result = CF_00000960B_MinimizeTheError.Solution_0_Test(input);
