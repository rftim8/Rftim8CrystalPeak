...
{
    [TestClass]
    public sealed class CF_00000997C_SkyFullOfStars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000997C_SkyFullOfStars));
        ...
        {
            bool result = CF_00000997C_SkyFullOfStars.Solution_0_Test(input);
