...
{
    [TestClass]
    public sealed class CF_00001822A_TubeTubeFeed_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001822A_TubeTubeFeed));
        ...
        {
            bool result = CF_00001822A_TubeTubeFeed.Solution_0_Test(input);
