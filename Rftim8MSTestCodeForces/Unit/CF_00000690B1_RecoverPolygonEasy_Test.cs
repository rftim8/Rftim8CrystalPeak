...
{
    [TestClass]
    public sealed class CF_00000690B1_RecoverPolygonEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690B1_RecoverPolygonEasy));
        ...
        {
            bool result = CF_00000690B1_RecoverPolygonEasy.Solution_0_Test(input);
