...
{
    [TestClass]
    public sealed class CF_00000868A_BarkToUnlock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000868A_BarkToUnlock));
        ...
        {
            bool result = CF_00000868A_BarkToUnlock.Solution_0_Test(input);
