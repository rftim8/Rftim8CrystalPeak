...
{
    [TestClass]
    public sealed class CF_00000391D2_Supercollider_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000391D2_Supercollider));
        ...
        {
            bool result = CF_00000391D2_Supercollider.Solution_0_Test(input);
