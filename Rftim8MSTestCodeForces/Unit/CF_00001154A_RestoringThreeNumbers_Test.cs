...
{
    [TestClass]
    public sealed class CF_00001154A_RestoringThreeNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001154A_RestoringThreeNumbers));
        ...
        {
            bool result = CF_00001154A_RestoringThreeNumbers.Solution_0_Test(input);
