...
{
    [TestClass]
    public sealed class CF_00001070B_Berkomnadzor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001070B_Berkomnadzor));
        ...
        {
            bool result = CF_00001070B_Berkomnadzor.Solution_0_Test(input);
