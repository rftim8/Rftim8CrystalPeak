...
{
    [TestClass]
    public sealed class CF_00000274E_MirrorRoom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000274E_MirrorRoom));
        ...
        {
            bool result = CF_00000274E_MirrorRoom.Solution_0_Test(input);
