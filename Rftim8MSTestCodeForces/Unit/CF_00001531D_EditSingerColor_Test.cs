...
{
    [TestClass]
    public sealed class CF_00001531D_EditSingerColor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001531D_EditSingerColor));
        ...
        {
            bool result = CF_00001531D_EditSingerColor.Solution_0_Test(input);
