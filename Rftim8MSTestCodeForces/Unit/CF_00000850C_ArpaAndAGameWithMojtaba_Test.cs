...
{
    [TestClass]
    public sealed class CF_00000850C_ArpaAndAGameWithMojtaba_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000850C_ArpaAndAGameWithMojtaba));
        ...
        {
            bool result = CF_00000850C_ArpaAndAGameWithMojtaba.Solution_0_Test(input);
