...
{
    [TestClass]
    public sealed class CF_00000509F_ProgressMonitoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000509F_ProgressMonitoring));
        ...
        {
            bool result = CF_00000509F_ProgressMonitoring.Solution_0_Test(input);
