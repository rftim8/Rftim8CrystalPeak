...
{
    [TestClass]
    public sealed class CF_00000996A_HitTheLottery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000996A_HitTheLottery));
        ...
        {
            bool result = CF_00000996A_HitTheLottery.Solution_0_Test(input);
