...
{
    [TestClass]
    public sealed class CF_00001334E_DivisorPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001334E_DivisorPaths));
        ...
        {
            bool result = CF_00001334E_DivisorPaths.Solution_0_Test(input);
