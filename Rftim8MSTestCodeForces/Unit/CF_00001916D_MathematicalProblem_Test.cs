...
{
    [TestClass]
    public sealed class CF_00001916D_MathematicalProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001916D_MathematicalProblem));
        ...
        {
            bool result = CF_00001916D_MathematicalProblem.Solution_0_Test(input);
