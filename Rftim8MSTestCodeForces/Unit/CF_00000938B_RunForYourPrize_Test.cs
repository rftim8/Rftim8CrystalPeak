...
{
    [TestClass]
    public sealed class CF_00000938B_RunForYourPrize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000938B_RunForYourPrize));
        ...
        {
            bool result = CF_00000938B_RunForYourPrize.Solution_0_Test(input);
