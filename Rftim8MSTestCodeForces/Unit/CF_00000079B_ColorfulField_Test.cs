...
{
    [TestClass]
    public sealed class CF_00000079B_ColorfulField_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000079B_ColorfulField));
        ...
        {
            bool result = CF_00000079B_ColorfulField.Solution_0_Test(input);
