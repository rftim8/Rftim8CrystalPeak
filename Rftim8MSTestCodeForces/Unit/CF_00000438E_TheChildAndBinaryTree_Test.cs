...
{
    [TestClass]
    public sealed class CF_00000438E_TheChildAndBinaryTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000438E_TheChildAndBinaryTree));
        ...
        {
            bool result = CF_00000438E_TheChildAndBinaryTree.Solution_0_Test(input);
