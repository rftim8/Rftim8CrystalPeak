...
{
    [TestClass]
    public sealed class CF_00000638A_HomeNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000638A_HomeNumbers));
        ...
        {
            bool result = CF_00000638A_HomeNumbers.Solution_0_Test(input);
