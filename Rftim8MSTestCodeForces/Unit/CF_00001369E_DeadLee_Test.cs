...
{
    [TestClass]
    public sealed class CF_00001369E_DeadLee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001369E_DeadLee));
        ...
        {
            bool result = CF_00001369E_DeadLee.Solution_0_Test(input);
