...
{
    [TestClass]
    public sealed class CF_00001774C_IceAndFire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001774C_IceAndFire));
        ...
        {
            bool result = CF_00001774C_IceAndFire.Solution_0_Test(input);
