...
{
    [TestClass]
    public sealed class CF_00000044J_Triminoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000044J_Triminoes));
        ...
        {
            bool result = CF_00000044J_Triminoes.Solution_0_Test(input);
