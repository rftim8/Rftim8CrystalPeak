...
{
    [TestClass]
    public sealed class CF_00000530I_DifferentVariables_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000530I_DifferentVariables));
        ...
        {
            bool result = CF_00000530I_DifferentVariables.Solution_0_Test(input);
