...
{
    [TestClass]
    public sealed class CF_00000093E_Lostborn_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000093E_Lostborn));
        ...
        {
            bool result = CF_00000093E_Lostborn.Solution_0_Test(input);
