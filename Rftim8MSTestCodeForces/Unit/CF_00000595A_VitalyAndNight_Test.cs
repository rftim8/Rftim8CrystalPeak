...
{
    [TestClass]
    public sealed class CF_00000595A_VitalyAndNight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000595A_VitalyAndNight));
        ...
        {
            bool result = CF_00000595A_VitalyAndNight.Solution_0_Test(input);
