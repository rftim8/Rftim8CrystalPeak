...
{
    [TestClass]
    public sealed class CF_00000036B_Fractal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000036B_Fractal));
        ...
        {
            bool result = CF_00000036B_Fractal.Solution_0_Test(input);
