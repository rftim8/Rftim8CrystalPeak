...
{
    [TestClass]
    public sealed class CF_00001145B_KanbanNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001145B_KanbanNumbers));
        ...
        {
            bool result = CF_00001145B_KanbanNumbers.Solution_0_Test(input);
