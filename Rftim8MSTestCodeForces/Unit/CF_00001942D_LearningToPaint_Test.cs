...
{
    [TestClass]
    public sealed class CF_00001942D_LearningToPaint_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001942D_LearningToPaint));
        ...
        {
            bool result = CF_00001942D_LearningToPaint.Solution_0_Test(input);
