...
{
    [TestClass]
    public sealed class CF_00000928A_LoginVerification_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000928A_LoginVerification));
        ...
        {
            bool result = CF_00000928A_LoginVerification.Solution_0_Test(input);
