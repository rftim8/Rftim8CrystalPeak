...
{
    [TestClass]
    public sealed class CF_00000475F_Metauniverse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000475F_Metauniverse));
        ...
        {
            bool result = CF_00000475F_Metauniverse.Solution_0_Test(input);
