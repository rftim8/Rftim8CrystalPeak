...
{
    [TestClass]
    public sealed class CF_00000812A_SagheerAndCrossroads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000812A_SagheerAndCrossroads));
        ...
        {
            bool result = CF_00000812A_SagheerAndCrossroads.Solution_0_Test(input);
