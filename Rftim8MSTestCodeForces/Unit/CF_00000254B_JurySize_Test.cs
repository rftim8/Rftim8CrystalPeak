...
{
    [TestClass]
    public sealed class CF_00000254B_JurySize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000254B_JurySize));
        ...
        {
            bool result = CF_00000254B_JurySize.Solution_0_Test(input);
