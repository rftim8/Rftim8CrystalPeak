...
{
    [TestClass]
    public sealed class CF_00000082E_Corridor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000082E_Corridor));
        ...
        {
            bool result = CF_00000082E_Corridor.Solution_0_Test(input);
