...
{
    [TestClass]
    public sealed class CF_00000796F_SequenceRecovery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000796F_SequenceRecovery));
        ...
        {
            bool result = CF_00000796F_SequenceRecovery.Solution_0_Test(input);
