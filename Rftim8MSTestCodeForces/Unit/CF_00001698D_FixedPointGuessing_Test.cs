...
{
    [TestClass]
    public sealed class CF_00001698D_FixedPointGuessing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001698D_FixedPointGuessing));
        ...
        {
            bool result = CF_00001698D_FixedPointGuessing.Solution_0_Test(input);
