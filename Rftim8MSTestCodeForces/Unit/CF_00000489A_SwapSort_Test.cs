...
{
    [TestClass]
    public sealed class CF_00000489A_SwapSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000489A_SwapSort));
        ...
        {
            bool result = CF_00000489A_SwapSort.Solution_0_Test(input);
