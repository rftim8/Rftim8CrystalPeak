...
{
    [TestClass]
    public sealed class CF_00001922C_ClosestCities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001922C_ClosestCities));
        ...
        {
            bool result = CF_00001922C_ClosestCities.Solution_0_Test(input);
