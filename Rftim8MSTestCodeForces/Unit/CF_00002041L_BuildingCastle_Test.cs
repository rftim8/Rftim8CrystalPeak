...
{
    [TestClass]
    public sealed class CF_00002041L_BuildingCastle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002041L_BuildingCastle));
        ...
        {
            bool result = CF_00002041L_BuildingCastle.Solution_0_Test(input);
