...
{
    [TestClass]
    public sealed class CF_00000632A_GrandmaLauraAndApples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000632A_GrandmaLauraAndApples));
        ...
        {
            bool result = CF_00000632A_GrandmaLauraAndApples.Solution_0_Test(input);
