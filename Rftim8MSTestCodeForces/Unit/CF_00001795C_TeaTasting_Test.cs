...
{
    [TestClass]
    public sealed class CF_00001795C_TeaTasting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001795C_TeaTasting));
        ...
        {
            bool result = CF_00001795C_TeaTasting.Solution_0_Test(input);
