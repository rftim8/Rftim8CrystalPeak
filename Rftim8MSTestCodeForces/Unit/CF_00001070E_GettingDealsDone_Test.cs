...
{
    [TestClass]
    public sealed class CF_00001070E_GettingDealsDone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001070E_GettingDealsDone));
        ...
        {
            bool result = CF_00001070E_GettingDealsDone.Solution_0_Test(input);
