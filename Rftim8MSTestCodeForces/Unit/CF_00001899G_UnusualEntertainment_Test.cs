...
{
    [TestClass]
    public sealed class CF_00001899G_UnusualEntertainment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001899G_UnusualEntertainment));
        ...
        {
            bool result = CF_00001899G_UnusualEntertainment.Solution_0_Test(input);
