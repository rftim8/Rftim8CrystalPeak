...
{
    [TestClass]
    public sealed class CF_00001402B_Roads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001402B_Roads));
        ...
        {
            bool result = CF_00001402B_Roads.Solution_0_Test(input);
