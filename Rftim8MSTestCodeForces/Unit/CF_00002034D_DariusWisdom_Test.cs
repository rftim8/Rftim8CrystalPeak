...
{
    [TestClass]
    public sealed class CF_00002034D_DariusWisdom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002034D_DariusWisdom));
        ...
        {
            bool result = CF_00002034D_DariusWisdom.Solution_0_Test(input);
