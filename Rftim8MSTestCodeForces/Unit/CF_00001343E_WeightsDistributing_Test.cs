...
{
    [TestClass]
    public sealed class CF_00001343E_WeightsDistributing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001343E_WeightsDistributing));
        ...
        {
            bool result = CF_00001343E_WeightsDistributing.Solution_0_Test(input);
