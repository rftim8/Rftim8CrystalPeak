...
{
    [TestClass]
    public sealed class CF_00000711E_ZSAndTheBirthdayParadox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000711E_ZSAndTheBirthdayParadox));
        ...
        {
            bool result = CF_00000711E_ZSAndTheBirthdayParadox.Solution_0_Test(input);
