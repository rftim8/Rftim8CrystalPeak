...
{
    [TestClass]
    public sealed class CF_00000567A_LinelandMail_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000567A_LinelandMail));
        ...
        {
            bool result = CF_00000567A_LinelandMail.Solution_0_Test(input);
