...
{
    [TestClass]
    public sealed class CF_00000417E_SquareTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000417E_SquareTable));
        ...
        {
            bool result = CF_00000417E_SquareTable.Solution_0_Test(input);
