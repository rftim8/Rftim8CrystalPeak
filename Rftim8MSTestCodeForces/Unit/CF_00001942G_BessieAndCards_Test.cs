...
{
    [TestClass]
    public sealed class CF_00001942G_BessieAndCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001942G_BessieAndCards));
        ...
        {
            bool result = CF_00001942G_BessieAndCards.Solution_0_Test(input);
