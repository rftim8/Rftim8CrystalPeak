...
{
    [TestClass]
    public sealed class CF_00001143C_Queen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001143C_Queen));
        ...
        {
            bool result = CF_00001143C_Queen.Solution_0_Test(input);
