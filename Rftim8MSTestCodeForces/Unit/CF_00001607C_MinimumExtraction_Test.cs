...
{
    [TestClass]
    public sealed class CF_00001607C_MinimumExtraction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001607C_MinimumExtraction));
        ...
        {
            bool result = CF_00001607C_MinimumExtraction.Solution_0_Test(input);
