...
{
    [TestClass]
    public sealed class CF_00000830C_BambooPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000830C_BambooPartition));
        ...
        {
            bool result = CF_00000830C_BambooPartition.Solution_0_Test(input);
