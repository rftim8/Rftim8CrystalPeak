...
{
    [TestClass]
    public sealed class CF_00001770F_KoxiaAndSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001770F_KoxiaAndSequence));
        ...
        {
            bool result = CF_00001770F_KoxiaAndSequence.Solution_0_Test(input);
