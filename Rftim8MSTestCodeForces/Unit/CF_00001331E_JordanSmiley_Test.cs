...
{
    [TestClass]
    public sealed class CF_00001331E_JordanSmiley_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001331E_JordanSmiley));
        ...
        {
            bool result = CF_00001331E_JordanSmiley.Solution_0_Test(input);
