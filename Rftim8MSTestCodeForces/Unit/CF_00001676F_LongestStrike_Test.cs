...
{
    [TestClass]
    public sealed class CF_00001676F_LongestStrike_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001676F_LongestStrike));
        ...
        {
            bool result = CF_00001676F_LongestStrike.Solution_0_Test(input);
