...
{
    [TestClass]
    public sealed class CF_00001550A_FindTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001550A_FindTheArray));
        ...
        {
            bool result = CF_00001550A_FindTheArray.Solution_0_Test(input);
