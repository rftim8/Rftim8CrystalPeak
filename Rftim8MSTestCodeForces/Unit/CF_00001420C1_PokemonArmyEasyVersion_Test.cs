...
{
    [TestClass]
    public sealed class CF_00001420C1_PokemonArmyEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001420C1_PokemonArmyEasyVersion));
        ...
        {
            bool result = CF_00001420C1_PokemonArmyEasyVersion.Solution_0_Test(input);
