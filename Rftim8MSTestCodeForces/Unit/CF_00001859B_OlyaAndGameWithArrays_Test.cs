...
{
    [TestClass]
    public sealed class CF_00001859B_OlyaAndGameWithArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001859B_OlyaAndGameWithArrays));
        ...
        {
            bool result = CF_00001859B_OlyaAndGameWithArrays.Solution_0_Test(input);
