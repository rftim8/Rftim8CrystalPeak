...
{
    [TestClass]
    public sealed class CF_00000364B_FreeMarket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000364B_FreeMarket));
        ...
        {
            bool result = CF_00000364B_FreeMarket.Solution_0_Test(input);
