...
{
    [TestClass]
    public sealed class CF_00001834A_UnitArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001834A_UnitArray));
        ...
        {
            bool result = CF_00001834A_UnitArray.Solution_0_Test(input);
