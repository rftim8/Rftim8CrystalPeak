...
{
    [TestClass]
    public sealed class CF_00000037A_Towers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000037A_Towers));
        ...
        {
            bool result = CF_00000037A_Towers.Solution_0_Test(input);
