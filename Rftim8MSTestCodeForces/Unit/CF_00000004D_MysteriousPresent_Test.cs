...
{
    [TestClass]
    public sealed class CF_00000004D_MysteriousPresent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000004D_MysteriousPresent));
        ...
        {
            bool result = CF_00000004D_MysteriousPresent.Solution_0_Test(input);
