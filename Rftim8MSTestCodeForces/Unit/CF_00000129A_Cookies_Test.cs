...
{
    [TestClass]
    public sealed class CF_00000129A_Cookies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000129A_Cookies));
        ...
        {
            bool result = CF_00000129A_Cookies.Solution_0_Test(input);
