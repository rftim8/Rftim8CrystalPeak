...
{
    [TestClass]
    public sealed class CF_00000165B_BurningMidnightOil_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000165B_BurningMidnightOil));
        ...
        {
            bool result = CF_00000165B_BurningMidnightOil.Solution_0_Test(input);
