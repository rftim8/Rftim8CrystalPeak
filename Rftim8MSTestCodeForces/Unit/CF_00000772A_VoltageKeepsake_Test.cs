...
{
    [TestClass]
    public sealed class CF_00000772A_VoltageKeepsake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000772A_VoltageKeepsake));
        ...
        {
            bool result = CF_00000772A_VoltageKeepsake.Solution_0_Test(input);
