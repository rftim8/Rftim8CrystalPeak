...
{
    [TestClass]
    public sealed class CF_00000401A_VanyaAndCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000401A_VanyaAndCards));
        ...
        {
            bool result = CF_00000401A_VanyaAndCards.Solution_0_Test(input);
