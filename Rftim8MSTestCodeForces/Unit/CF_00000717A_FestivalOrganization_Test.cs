...
{
    [TestClass]
    public sealed class CF_00000717A_FestivalOrganization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000717A_FestivalOrganization));
        ...
        {
            bool result = CF_00000717A_FestivalOrganization.Solution_0_Test(input);
