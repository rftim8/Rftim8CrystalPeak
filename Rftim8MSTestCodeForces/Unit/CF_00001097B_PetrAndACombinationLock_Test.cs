...
{
    [TestClass]
    public sealed class CF_00001097B_PetrAndACombinationLock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001097B_PetrAndACombinationLock));
        ...
        {
            bool result = CF_00001097B_PetrAndACombinationLock.Solution_0_Test(input);
