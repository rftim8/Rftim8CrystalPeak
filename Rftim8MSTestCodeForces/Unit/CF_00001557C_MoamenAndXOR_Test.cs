...
{
    [TestClass]
    public sealed class CF_00001557C_MoamenAndXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001557C_MoamenAndXOR));
        ...
        {
            bool result = CF_00001557C_MoamenAndXOR.Solution_0_Test(input);
