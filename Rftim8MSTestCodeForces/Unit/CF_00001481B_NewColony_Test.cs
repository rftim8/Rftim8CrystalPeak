...
{
    [TestClass]
    public sealed class CF_00001481B_NewColony_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001481B_NewColony));
        ...
        {
            bool result = CF_00001481B_NewColony.Solution_0_Test(input);
