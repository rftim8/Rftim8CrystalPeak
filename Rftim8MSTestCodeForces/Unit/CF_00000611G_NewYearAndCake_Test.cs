...
{
    [TestClass]
    public sealed class CF_00000611G_NewYearAndCake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000611G_NewYearAndCake));
        ...
        {
            bool result = CF_00000611G_NewYearAndCake.Solution_0_Test(input);
