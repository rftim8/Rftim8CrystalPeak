...
{
    [TestClass]
    public sealed class CF_00001342A_RoadToZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001342A_RoadToZero));
        ...
        {
            bool result = CF_00001342A_RoadToZero.Solution_0_Test(input);
