...
{
    [TestClass]
    public sealed class CF_00000360A_LevkoAndArrayRecovery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000360A_LevkoAndArrayRecovery));
        ...
        {
            bool result = CF_00000360A_LevkoAndArrayRecovery.Solution_0_Test(input);
