...
{
    [TestClass]
    public sealed class CF_00001267B_BallsOfBuma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001267B_BallsOfBuma));
        ...
        {
            bool result = CF_00001267B_BallsOfBuma.Solution_0_Test(input);
