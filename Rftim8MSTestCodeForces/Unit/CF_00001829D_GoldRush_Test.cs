...
{
    [TestClass]
    public sealed class CF_00001829D_GoldRush_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001829D_GoldRush));
        ...
        {
            bool result = CF_00001829D_GoldRush.Solution_0_Test(input);
