...
{
    [TestClass]
    public sealed class CF_00000093D_Flags_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000093D_Flags));
        ...
        {
            bool result = CF_00000093D_Flags.Solution_0_Test(input);
