...
{
    [TestClass]
    public sealed class CF_00001931D_DivisiblePairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001931D_DivisiblePairs));
        ...
        {
            bool result = CF_00001931D_DivisiblePairs.Solution_0_Test(input);
