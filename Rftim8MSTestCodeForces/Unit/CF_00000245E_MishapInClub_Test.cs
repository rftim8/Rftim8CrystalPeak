...
{
    [TestClass]
    public sealed class CF_00000245E_MishapInClub_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000245E_MishapInClub));
        ...
        {
            bool result = CF_00000245E_MishapInClub.Solution_0_Test(input);
