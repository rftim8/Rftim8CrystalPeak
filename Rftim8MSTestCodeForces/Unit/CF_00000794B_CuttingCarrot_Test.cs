...
{
    [TestClass]
    public sealed class CF_00000794B_CuttingCarrot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000794B_CuttingCarrot));
        ...
        {
            bool result = CF_00000794B_CuttingCarrot.Solution_0_Test(input);
