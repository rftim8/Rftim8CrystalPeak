...
{
    [TestClass]
    public sealed class CF_00001641A_GreatSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001641A_GreatSequence));
        ...
        {
            bool result = CF_00001641A_GreatSequence.Solution_0_Test(input);
