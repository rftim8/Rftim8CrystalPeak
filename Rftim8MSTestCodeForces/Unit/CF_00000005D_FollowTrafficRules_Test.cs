...
{
    [TestClass]
    public sealed class CF_00000005D_FollowTrafficRules_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000005D_FollowTrafficRules));
        ...
        {
            bool result = CF_00000005D_FollowTrafficRules.Solution_0_Test(input);
