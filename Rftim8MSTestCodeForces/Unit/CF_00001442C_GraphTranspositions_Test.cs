...
{
    [TestClass]
    public sealed class CF_00001442C_GraphTranspositions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001442C_GraphTranspositions));
        ...
        {
            bool result = CF_00001442C_GraphTranspositions.Solution_0_Test(input);
