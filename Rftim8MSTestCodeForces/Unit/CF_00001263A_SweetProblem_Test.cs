...
{
    [TestClass]
    public sealed class CF_00001263A_SweetProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001263A_SweetProblem));
        ...
        {
            bool result = CF_00001263A_SweetProblem.Solution_0_Test(input);
