...
{
    [TestClass]
    public sealed class CF_00001391B_FixYou_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001391B_FixYou));
        ...
        {
            bool result = CF_00001391B_FixYou.Solution_0_Test(input);
