...
{
    [TestClass]
    public sealed class CF_00000382B_NumberBusters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000382B_NumberBusters));
        ...
        {
            bool result = CF_00000382B_NumberBusters.Solution_0_Test(input);
