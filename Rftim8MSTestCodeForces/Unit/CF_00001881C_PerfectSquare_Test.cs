...
{
    [TestClass]
    public sealed class CF_00001881C_PerfectSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001881C_PerfectSquare));
        ...
        {
            bool result = CF_00001881C_PerfectSquare.Solution_0_Test(input);
