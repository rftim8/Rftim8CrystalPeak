...
{
    [TestClass]
    public sealed class CF_00000167D_WizardsAndRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000167D_WizardsAndRoads));
        ...
        {
            bool result = CF_00000167D_WizardsAndRoads.Solution_0_Test(input);
