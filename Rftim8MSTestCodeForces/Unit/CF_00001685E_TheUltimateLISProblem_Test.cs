...
{
    [TestClass]
    public sealed class CF_00001685E_TheUltimateLISProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001685E_TheUltimateLISProblem));
        ...
        {
            bool result = CF_00001685E_TheUltimateLISProblem.Solution_0_Test(input);
