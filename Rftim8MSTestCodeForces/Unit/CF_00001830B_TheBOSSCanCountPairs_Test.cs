...
{
    [TestClass]
    public sealed class CF_00001830B_TheBOSSCanCountPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001830B_TheBOSSCanCountPairs));
        ...
        {
            bool result = CF_00001830B_TheBOSSCanCountPairs.Solution_0_Test(input);
