...
{
    [TestClass]
    public sealed class CF_00001781E_RectangleShrinking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001781E_RectangleShrinking));
        ...
        {
            bool result = CF_00001781E_RectangleShrinking.Solution_0_Test(input);
