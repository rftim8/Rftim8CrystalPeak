...
{
    [TestClass]
    public sealed class CF_00001914A_ProblemsolvingLog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001914A_ProblemsolvingLog));
        ...
        {
            bool result = CF_00001914A_ProblemsolvingLog.Solution_0_Test(input);
