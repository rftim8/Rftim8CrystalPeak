...
{
    [TestClass]
    public sealed class CF_00000623B_ArrayGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000623B_ArrayGCD));
        ...
        {
            bool result = CF_00000623B_ArrayGCD.Solution_0_Test(input);
