...
{
    [TestClass]
    public sealed class CF_00001776D_Teamwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001776D_Teamwork));
        ...
        {
            bool result = CF_00001776D_Teamwork.Solution_0_Test(input);
