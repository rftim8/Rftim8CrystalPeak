...
{
    [TestClass]
    public sealed class CF_00001878B_AleksaAndStack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001878B_AleksaAndStack));
        ...
        {
            bool result = CF_00001878B_AleksaAndStack.Solution_0_Test(input);
