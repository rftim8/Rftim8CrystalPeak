...
{
    [TestClass]
    public sealed class CF_00001692H_Gambling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001692H_Gambling));
        ...
        {
            bool result = CF_00001692H_Gambling.Solution_0_Test(input);
