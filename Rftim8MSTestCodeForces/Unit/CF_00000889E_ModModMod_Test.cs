...
{
    [TestClass]
    public sealed class CF_00000889E_ModModMod_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000889E_ModModMod));
        ...
        {
            bool result = CF_00000889E_ModModMod.Solution_0_Test(input);
