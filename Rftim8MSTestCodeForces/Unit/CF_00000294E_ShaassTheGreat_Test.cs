...
{
    [TestClass]
    public sealed class CF_00000294E_ShaassTheGreat_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000294E_ShaassTheGreat));
        ...
        {
            bool result = CF_00000294E_ShaassTheGreat.Solution_0_Test(input);
