...
{
    [TestClass]
    public sealed class CF_00000518C_AnyaAndSmartphone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000518C_AnyaAndSmartphone));
        ...
        {
            bool result = CF_00000518C_AnyaAndSmartphone.Solution_0_Test(input);
