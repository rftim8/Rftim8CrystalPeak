...
{
    [TestClass]
    public sealed class CF_00000113A_GrammarLessons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000113A_GrammarLessons));
        ...
        {
            bool result = CF_00000113A_GrammarLessons.Solution_0_Test(input);
