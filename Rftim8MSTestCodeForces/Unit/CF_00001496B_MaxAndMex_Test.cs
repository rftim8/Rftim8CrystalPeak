...
{
    [TestClass]
    public sealed class CF_00001496B_MaxAndMex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001496B_MaxAndMex));
        ...
        {
            bool result = CF_00001496B_MaxAndMex.Solution_0_Test(input);
