...
{
    [TestClass]
    public sealed class CF_00001690E_PriceMaximization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001690E_PriceMaximization));
        ...
        {
            bool result = CF_00001690E_PriceMaximization.Solution_0_Test(input);
