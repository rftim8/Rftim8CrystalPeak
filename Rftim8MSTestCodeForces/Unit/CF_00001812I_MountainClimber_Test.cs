...
{
    [TestClass]
    public sealed class CF_00001812I_MountainClimber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001812I_MountainClimber));
        ...
        {
            bool result = CF_00001812I_MountainClimber.Solution_0_Test(input);
