...
{
    [TestClass]
    public sealed class CF_00001773L_LisasSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001773L_LisasSequences));
        ...
        {
            bool result = CF_00001773L_LisasSequences.Solution_0_Test(input);
