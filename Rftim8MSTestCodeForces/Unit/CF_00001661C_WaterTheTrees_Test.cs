...
{
    [TestClass]
    public sealed class CF_00001661C_WaterTheTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001661C_WaterTheTrees));
        ...
        {
            bool result = CF_00001661C_WaterTheTrees.Solution_0_Test(input);
