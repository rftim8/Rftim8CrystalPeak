...
{
    [TestClass]
    public sealed class CF_00001605C_DominantCharacter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001605C_DominantCharacter));
        ...
        {
            bool result = CF_00001605C_DominantCharacter.Solution_0_Test(input);
