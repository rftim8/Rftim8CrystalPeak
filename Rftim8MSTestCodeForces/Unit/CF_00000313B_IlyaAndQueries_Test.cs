...
{
    [TestClass]
    public sealed class CF_00000313B_IlyaAndQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000313B_IlyaAndQueries));
        ...
        {
            bool result = CF_00000313B_IlyaAndQueries.Solution_0_Test(input);
