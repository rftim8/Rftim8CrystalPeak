...
{
    [TestClass]
    public sealed class CF_00001823D_UniquePalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001823D_UniquePalindromes));
        ...
        {
            bool result = CF_00001823D_UniquePalindromes.Solution_0_Test(input);
