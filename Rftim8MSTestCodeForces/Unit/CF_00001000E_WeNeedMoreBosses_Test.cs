...
{
    [TestClass]
    public sealed class CF_00001000E_WeNeedMoreBosses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001000E_WeNeedMoreBosses));
        ...
        {
            bool result = CF_00001000E_WeNeedMoreBosses.Solution_0_Test(input);
