...
{
    [TestClass]
    public sealed class CF_00000041E_3cycles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000041E_3cycles));
        ...
        {
            bool result = CF_00000041E_3cycles.Solution_0_Test(input);
