...
{
    [TestClass]
    public sealed class CF_00001092D2_GreatVovaWallVersion2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001092D2_GreatVovaWallVersion2));
        ...
        {
            bool result = CF_00001092D2_GreatVovaWallVersion2.Solution_0_Test(input);
