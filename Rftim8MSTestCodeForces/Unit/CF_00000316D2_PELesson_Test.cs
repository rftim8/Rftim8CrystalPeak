...
{
    [TestClass]
    public sealed class CF_00000316D2_PELesson_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000316D2_PELesson));
        ...
        {
            bool result = CF_00000316D2_PELesson.Solution_0_Test(input);
