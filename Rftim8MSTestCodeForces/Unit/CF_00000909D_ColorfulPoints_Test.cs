...
{
    [TestClass]
    public sealed class CF_00000909D_ColorfulPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000909D_ColorfulPoints));
        ...
        {
            bool result = CF_00000909D_ColorfulPoints.Solution_0_Test(input);
