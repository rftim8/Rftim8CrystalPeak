...
{
    [TestClass]
    public sealed class CF_00001732C1_SheikhEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001732C1_SheikhEasyVersion));
        ...
        {
            bool result = CF_00001732C1_SheikhEasyVersion.Solution_0_Test(input);
