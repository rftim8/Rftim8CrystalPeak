...
{
    [TestClass]
    public sealed class CF_00000402E_StrictlyPositiveMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000402E_StrictlyPositiveMatrix));
        ...
        {
            bool result = CF_00000402E_StrictlyPositiveMatrix.Solution_0_Test(input);
