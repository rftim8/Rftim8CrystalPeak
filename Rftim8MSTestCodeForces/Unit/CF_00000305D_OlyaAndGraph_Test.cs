...
{
    [TestClass]
    public sealed class CF_00000305D_OlyaAndGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000305D_OlyaAndGraph));
        ...
        {
            bool result = CF_00000305D_OlyaAndGraph.Solution_0_Test(input);
