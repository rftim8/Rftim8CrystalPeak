...
{
    [TestClass]
    public sealed class CF_00001884E_HardDesign_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001884E_HardDesign));
        ...
        {
            bool result = CF_00001884E_HardDesign.Solution_0_Test(input);
