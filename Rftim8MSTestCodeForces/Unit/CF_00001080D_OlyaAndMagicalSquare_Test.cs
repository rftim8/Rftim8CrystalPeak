...
{
    [TestClass]
    public sealed class CF_00001080D_OlyaAndMagicalSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001080D_OlyaAndMagicalSquare));
        ...
        {
            bool result = CF_00001080D_OlyaAndMagicalSquare.Solution_0_Test(input);
