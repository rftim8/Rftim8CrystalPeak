...
{
    [TestClass]
    public sealed class CF_00001671C_DolceVita_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001671C_DolceVita));
        ...
        {
            bool result = CF_00001671C_DolceVita.Solution_0_Test(input);
