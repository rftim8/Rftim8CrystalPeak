...
{
    [TestClass]
    public sealed class CF_00000462A_ApplemanAndEasyTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000462A_ApplemanAndEasyTask));
        ...
        {
            bool result = CF_00000462A_ApplemanAndEasyTask.Solution_0_Test(input);
