...
{
    [TestClass]
    public sealed class CF_00001903A_HalloumiBoxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001903A_HalloumiBoxes));
        ...
        {
            bool result = CF_00001903A_HalloumiBoxes.Solution_0_Test(input);
