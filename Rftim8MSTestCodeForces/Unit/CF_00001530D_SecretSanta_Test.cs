...
{
    [TestClass]
    public sealed class CF_00001530D_SecretSanta_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001530D_SecretSanta));
        ...
        {
            bool result = CF_00001530D_SecretSanta.Solution_0_Test(input);
