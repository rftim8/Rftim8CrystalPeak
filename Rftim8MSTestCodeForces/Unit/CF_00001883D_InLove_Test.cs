...
{
    [TestClass]
    public sealed class CF_00001883D_InLove_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001883D_InLove));
        ...
        {
            bool result = CF_00001883D_InLove.Solution_0_Test(input);
