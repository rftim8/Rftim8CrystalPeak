...
{
    [TestClass]
    public sealed class CF_00000320B_PingPongEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000320B_PingPongEasyVersion));
        ...
        {
            bool result = CF_00000320B_PingPongEasyVersion.Solution_0_Test(input);
