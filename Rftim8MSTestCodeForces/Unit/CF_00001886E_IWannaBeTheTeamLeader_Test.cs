...
{
    [TestClass]
    public sealed class CF_00001886E_IWannaBeTheTeamLeader_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001886E_IWannaBeTheTeamLeader));
        ...
        {
            bool result = CF_00001886E_IWannaBeTheTeamLeader.Solution_0_Test(input);
