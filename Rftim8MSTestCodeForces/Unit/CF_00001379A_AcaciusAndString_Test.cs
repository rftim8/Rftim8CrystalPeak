...
{
    [TestClass]
    public sealed class CF_00001379A_AcaciusAndString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001379A_AcaciusAndString));
        ...
        {
            bool result = CF_00001379A_AcaciusAndString.Solution_0_Test(input);
