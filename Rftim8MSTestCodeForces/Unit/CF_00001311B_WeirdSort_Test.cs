...
{
    [TestClass]
    public sealed class CF_00001311B_WeirdSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001311B_WeirdSort));
        ...
        {
            bool result = CF_00001311B_WeirdSort.Solution_0_Test(input);
