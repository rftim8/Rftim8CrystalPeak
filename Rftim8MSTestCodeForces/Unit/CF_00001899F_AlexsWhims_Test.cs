...
{
    [TestClass]
    public sealed class CF_00001899F_AlexsWhims_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001899F_AlexsWhims));
        ...
        {
            bool result = CF_00001899F_AlexsWhims.Solution_0_Test(input);
