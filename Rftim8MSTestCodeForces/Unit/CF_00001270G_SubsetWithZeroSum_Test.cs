...
{
    [TestClass]
    public sealed class CF_00001270G_SubsetWithZeroSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001270G_SubsetWithZeroSum));
        ...
        {
            bool result = CF_00001270G_SubsetWithZeroSum.Solution_0_Test(input);
