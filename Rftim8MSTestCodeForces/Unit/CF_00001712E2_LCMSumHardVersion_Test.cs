...
{
    [TestClass]
    public sealed class CF_00001712E2_LCMSumHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001712E2_LCMSumHardVersion));
        ...
        {
            bool result = CF_00001712E2_LCMSumHardVersion.Solution_0_Test(input);
