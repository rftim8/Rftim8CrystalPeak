...
{
    [TestClass]
    public sealed class CF_00000958E1_GuardDutyEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958E1_GuardDutyEasy));
        ...
        {
            bool result = CF_00000958E1_GuardDutyEasy.Solution_0_Test(input);
