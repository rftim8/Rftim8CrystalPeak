...
{
    [TestClass]
    public sealed class CF_00001493F_EnchantedMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001493F_EnchantedMatrix));
        ...
        {
            bool result = CF_00001493F_EnchantedMatrix.Solution_0_Test(input);
