...
{
    [TestClass]
    public sealed class CF_00001615E_PurpleCrayon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001615E_PurpleCrayon));
        ...
        {
            bool result = CF_00001615E_PurpleCrayon.Solution_0_Test(input);
