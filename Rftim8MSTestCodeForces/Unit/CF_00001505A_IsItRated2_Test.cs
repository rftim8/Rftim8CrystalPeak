...
{
    [TestClass]
    public sealed class CF_00001505A_IsItRated2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001505A_IsItRated2));
        ...
        {
            bool result = CF_00001505A_IsItRated2.Solution_0_Test(input);
