...
{
    [TestClass]
    public sealed class CF_00001385G_ColumnsSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001385G_ColumnsSwaps));
        ...
        {
            bool result = CF_00001385G_ColumnsSwaps.Solution_0_Test(input);
