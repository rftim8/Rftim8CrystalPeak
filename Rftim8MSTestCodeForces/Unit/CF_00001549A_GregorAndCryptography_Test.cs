...
{
    [TestClass]
    public sealed class CF_00001549A_GregorAndCryptography_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001549A_GregorAndCryptography));
        ...
        {
            bool result = CF_00001549A_GregorAndCryptography.Solution_0_Test(input);
