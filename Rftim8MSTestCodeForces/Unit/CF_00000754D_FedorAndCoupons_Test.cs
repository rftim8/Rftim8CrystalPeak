...
{
    [TestClass]
    public sealed class CF_00000754D_FedorAndCoupons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000754D_FedorAndCoupons));
        ...
        {
            bool result = CF_00000754D_FedorAndCoupons.Solution_0_Test(input);
