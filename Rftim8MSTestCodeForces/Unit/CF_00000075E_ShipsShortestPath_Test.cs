...
{
    [TestClass]
    public sealed class CF_00000075E_ShipsShortestPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000075E_ShipsShortestPath));
        ...
        {
            bool result = CF_00000075E_ShipsShortestPath.Solution_0_Test(input);
