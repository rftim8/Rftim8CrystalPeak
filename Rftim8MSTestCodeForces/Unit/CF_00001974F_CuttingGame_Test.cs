...
{
    [TestClass]
    public sealed class CF_00001974F_CuttingGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001974F_CuttingGame));
        ...
        {
            bool result = CF_00001974F_CuttingGame.Solution_0_Test(input);
