...
{
    [TestClass]
    public sealed class CF_00000430B_BallsGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000430B_BallsGame));
        ...
        {
            bool result = CF_00000430B_BallsGame.Solution_0_Test(input);
