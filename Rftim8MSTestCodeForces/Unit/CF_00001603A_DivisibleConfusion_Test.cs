...
{
    [TestClass]
    public sealed class CF_00001603A_DivisibleConfusion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001603A_DivisibleConfusion));
        ...
        {
            bool result = CF_00001603A_DivisibleConfusion.Solution_0_Test(input);
