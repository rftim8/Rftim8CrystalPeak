...
{
    [TestClass]
    public sealed class CF_00000915B_Browser_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000915B_Browser));
        ...
        {
            bool result = CF_00000915B_Browser.Solution_0_Test(input);
