...
{
    [TestClass]
    public sealed class CF_00000504E_MishaAndLCPOnTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000504E_MishaAndLCPOnTree));
        ...
        {
            bool result = CF_00000504E_MishaAndLCPOnTree.Solution_0_Test(input);
