...
{
    [TestClass]
    public sealed class CF_00000985E_PencilsAndBoxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000985E_PencilsAndBoxes));
        ...
        {
            bool result = CF_00000985E_PencilsAndBoxes.Solution_0_Test(input);
