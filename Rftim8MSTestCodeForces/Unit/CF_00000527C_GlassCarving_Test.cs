...
{
    [TestClass]
    public sealed class CF_00000527C_GlassCarving_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000527C_GlassCarving));
        ...
        {
            bool result = CF_00000527C_GlassCarving.Solution_0_Test(input);
