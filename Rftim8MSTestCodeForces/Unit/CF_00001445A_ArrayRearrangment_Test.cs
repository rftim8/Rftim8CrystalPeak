...
{
    [TestClass]
    public sealed class CF_00001445A_ArrayRearrangment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001445A_ArrayRearrangment));
        ...
        {
            bool result = CF_00001445A_ArrayRearrangment.Solution_0_Test(input);
