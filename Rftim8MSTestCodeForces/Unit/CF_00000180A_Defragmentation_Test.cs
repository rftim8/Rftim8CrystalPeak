...
{
    [TestClass]
    public sealed class CF_00000180A_Defragmentation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000180A_Defragmentation));
        ...
        {
            bool result = CF_00000180A_Defragmentation.Solution_0_Test(input);
