...
{
    [TestClass]
    public sealed class CF_00001736B_PlayingWithGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001736B_PlayingWithGCD));
        ...
        {
            bool result = CF_00001736B_PlayingWithGCD.Solution_0_Test(input);
