...
{
    [TestClass]
    public sealed class CF_00001032D_BarcelonianDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001032D_BarcelonianDistance));
        ...
        {
            bool result = CF_00001032D_BarcelonianDistance.Solution_0_Test(input);
