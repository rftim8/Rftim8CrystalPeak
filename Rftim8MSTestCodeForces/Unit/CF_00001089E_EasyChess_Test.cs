...
{
    [TestClass]
    public sealed class CF_00001089E_EasyChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001089E_EasyChess));
        ...
        {
            bool result = CF_00001089E_EasyChess.Solution_0_Test(input);
