...
{
    [TestClass]
    public sealed class CF_00001531C_SymmetricalAmphitheatre_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001531C_SymmetricalAmphitheatre));
        ...
        {
            bool result = CF_00001531C_SymmetricalAmphitheatre.Solution_0_Test(input);
