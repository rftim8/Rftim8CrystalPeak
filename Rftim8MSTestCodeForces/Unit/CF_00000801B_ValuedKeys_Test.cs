...
{
    [TestClass]
    public sealed class CF_00000801B_ValuedKeys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000801B_ValuedKeys));
        ...
        {
            bool result = CF_00000801B_ValuedKeys.Solution_0_Test(input);
