...
{
    [TestClass]
    public sealed class CF_00000019E_Fairy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000019E_Fairy));
        ...
        {
            bool result = CF_00000019E_Fairy.Solution_0_Test(input);
