...
{
    [TestClass]
    public sealed class CF_00001970C1_GameOnTreeEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970C1_GameOnTreeEasy));
        ...
        {
            bool result = CF_00001970C1_GameOnTreeEasy.Solution_0_Test(input);
