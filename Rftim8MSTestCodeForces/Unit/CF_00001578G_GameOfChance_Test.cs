...
{
    [TestClass]
    public sealed class CF_00001578G_GameOfChance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001578G_GameOfChance));
        ...
        {
            bool result = CF_00001578G_GameOfChance.Solution_0_Test(input);
