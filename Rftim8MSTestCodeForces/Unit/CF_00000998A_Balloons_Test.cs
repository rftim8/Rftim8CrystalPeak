...
{
    [TestClass]
    public sealed class CF_00000998A_Balloons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000998A_Balloons));
        ...
        {
            bool result = CF_00000998A_Balloons.Solution_0_Test(input);
