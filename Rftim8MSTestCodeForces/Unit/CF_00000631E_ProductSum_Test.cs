...
{
    [TestClass]
    public sealed class CF_00000631E_ProductSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000631E_ProductSum));
        ...
        {
            bool result = CF_00000631E_ProductSum.Solution_0_Test(input);
