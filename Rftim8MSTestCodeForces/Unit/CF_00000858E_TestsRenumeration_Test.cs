...
{
    [TestClass]
    public sealed class CF_00000858E_TestsRenumeration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000858E_TestsRenumeration));
        ...
        {
            bool result = CF_00000858E_TestsRenumeration.Solution_0_Test(input);
