...
{
    [TestClass]
    public sealed class CF_00001433G_ReducingDeliveryCost_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001433G_ReducingDeliveryCost));
        ...
        {
            bool result = CF_00001433G_ReducingDeliveryCost.Solution_0_Test(input);
