...
{
    [TestClass]
    public sealed class CF_00000932C_PermutationCycle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000932C_PermutationCycle));
        ...
        {
            bool result = CF_00000932C_PermutationCycle.Solution_0_Test(input);
