...
{
    [TestClass]
    public sealed class CF_00001153A_ServalAndBus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001153A_ServalAndBus));
        ...
        {
            bool result = CF_00001153A_ServalAndBus.Solution_0_Test(input);
