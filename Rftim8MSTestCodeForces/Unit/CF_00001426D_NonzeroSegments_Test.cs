...
{
    [TestClass]
    public sealed class CF_00001426D_NonzeroSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001426D_NonzeroSegments));
        ...
        {
            bool result = CF_00001426D_NonzeroSegments.Solution_0_Test(input);
