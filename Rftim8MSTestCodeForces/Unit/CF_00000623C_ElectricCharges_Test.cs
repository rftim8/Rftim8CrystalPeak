...
{
    [TestClass]
    public sealed class CF_00000623C_ElectricCharges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000623C_ElectricCharges));
        ...
        {
            bool result = CF_00000623C_ElectricCharges.Solution_0_Test(input);
