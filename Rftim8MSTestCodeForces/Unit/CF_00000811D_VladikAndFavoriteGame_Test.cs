...
{
    [TestClass]
    public sealed class CF_00000811D_VladikAndFavoriteGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000811D_VladikAndFavoriteGame));
        ...
        {
            bool result = CF_00000811D_VladikAndFavoriteGame.Solution_0_Test(input);
