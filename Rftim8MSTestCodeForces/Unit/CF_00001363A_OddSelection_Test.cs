...
{
    [TestClass]
    public sealed class CF_00001363A_OddSelection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001363A_OddSelection));
        ...
        {
            bool result = CF_00001363A_OddSelection.Solution_0_Test(input);
