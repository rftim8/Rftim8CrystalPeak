...
{
    [TestClass]
    public sealed class CF_00002020E_ExpectedPower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002020E_ExpectedPower));
        ...
        {
            bool result = CF_00002020E_ExpectedPower.Solution_0_Test(input);
