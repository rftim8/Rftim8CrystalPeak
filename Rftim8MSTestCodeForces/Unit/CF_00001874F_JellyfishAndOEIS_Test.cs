...
{
    [TestClass]
    public sealed class CF_00001874F_JellyfishAndOEIS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001874F_JellyfishAndOEIS));
        ...
        {
            bool result = CF_00001874F_JellyfishAndOEIS.Solution_0_Test(input);
