...
{
    [TestClass]
    public sealed class CF_00001137B_CampSchedule_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001137B_CampSchedule));
        ...
        {
            bool result = CF_00001137B_CampSchedule.Solution_0_Test(input);
