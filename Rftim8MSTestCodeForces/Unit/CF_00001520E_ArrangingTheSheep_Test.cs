...
{
    [TestClass]
    public sealed class CF_00001520E_ArrangingTheSheep_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001520E_ArrangingTheSheep));
        ...
        {
            bool result = CF_00001520E_ArrangingTheSheep.Solution_0_Test(input);
