...
{
    [TestClass]
    public sealed class CF_00000490B_Queue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000490B_Queue));
        ...
        {
            bool result = CF_00000490B_Queue.Solution_0_Test(input);
