...
{
    [TestClass]
    public sealed class CF_00001946B_MaximumSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001946B_MaximumSum));
        ...
        {
            bool result = CF_00001946B_MaximumSum.Solution_0_Test(input);
