...
{
    [TestClass]
    public sealed class CF_00001814B_LongLegs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001814B_LongLegs));
        ...
        {
            bool result = CF_00001814B_LongLegs.Solution_0_Test(input);
