...
{
    [TestClass]
    public sealed class CF_00000033E_Helper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000033E_Helper));
        ...
        {
            bool result = CF_00000033E_Helper.Solution_0_Test(input);
