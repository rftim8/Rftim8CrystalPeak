...
{
    [TestClass]
    public sealed class CF_00001036F_RelativelyPrimePowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001036F_RelativelyPrimePowers));
        ...
        {
            bool result = CF_00001036F_RelativelyPrimePowers.Solution_0_Test(input);
