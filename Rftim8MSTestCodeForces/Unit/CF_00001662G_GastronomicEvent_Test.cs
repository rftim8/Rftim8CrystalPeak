...
{
    [TestClass]
    public sealed class CF_00001662G_GastronomicEvent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662G_GastronomicEvent));
        ...
        {
            bool result = CF_00001662G_GastronomicEvent.Solution_0_Test(input);
