...
{
    [TestClass]
    public sealed class CF_00001895E_InfiniteCardGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001895E_InfiniteCardGame));
        ...
        {
            bool result = CF_00001895E_InfiniteCardGame.Solution_0_Test(input);
