...
{
    [TestClass]
    public sealed class CF_00000362E_PetyaAndPipes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000362E_PetyaAndPipes));
        ...
        {
            bool result = CF_00000362E_PetyaAndPipes.Solution_0_Test(input);
