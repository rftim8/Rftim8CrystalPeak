...
{
    [TestClass]
    public sealed class CF_00001295D_SameGCDs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001295D_SameGCDs));
        ...
        {
            bool result = CF_00001295D_SameGCDs.Solution_0_Test(input);
