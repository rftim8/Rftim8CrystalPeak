...
{
    [TestClass]
    public sealed class CF_00000901C_BipartiteSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000901C_BipartiteSegments));
        ...
        {
            bool result = CF_00000901C_BipartiteSegments.Solution_0_Test(input);
