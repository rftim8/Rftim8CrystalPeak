...
{
    [TestClass]
    public sealed class CF_00001288A_Deadline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001288A_Deadline));
        ...
        {
            bool result = CF_00001288A_Deadline.Solution_0_Test(input);
