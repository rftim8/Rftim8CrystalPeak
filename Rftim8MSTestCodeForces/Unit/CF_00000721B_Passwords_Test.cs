...
{
    [TestClass]
    public sealed class CF_00000721B_Passwords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000721B_Passwords));
        ...
        {
            bool result = CF_00000721B_Passwords.Solution_0_Test(input);
