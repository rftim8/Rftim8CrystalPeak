...
{
    [TestClass]
    public sealed class CF_00001336B_XeniaAndColorfulGems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001336B_XeniaAndColorfulGems));
        ...
        {
            bool result = CF_00001336B_XeniaAndColorfulGems.Solution_0_Test(input);
