...
{
    [TestClass]
    public sealed class CF_00001455C_Pingpong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001455C_Pingpong));
        ...
        {
            bool result = CF_00001455C_Pingpong.Solution_0_Test(input);
