...
{
    [TestClass]
    public sealed class CF_00001818B_Indivisible_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001818B_Indivisible));
        ...
        {
            bool result = CF_00001818B_Indivisible.Solution_0_Test(input);
