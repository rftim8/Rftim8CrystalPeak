...
{
    [TestClass]
    public sealed class CF_00000601B_LipshitzSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000601B_LipshitzSequence));
        ...
        {
            bool result = CF_00000601B_LipshitzSequence.Solution_0_Test(input);
