...
{
    [TestClass]
    public sealed class CF_00001152A_NekoFindsGrapes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001152A_NekoFindsGrapes));
        ...
        {
            bool result = CF_00001152A_NekoFindsGrapes.Solution_0_Test(input);
