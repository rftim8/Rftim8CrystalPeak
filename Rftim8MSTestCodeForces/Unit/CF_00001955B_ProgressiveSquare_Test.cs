...
{
    [TestClass]
    public sealed class CF_00001955B_ProgressiveSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001955B_ProgressiveSquare));
        ...
        {
            bool result = CF_00001955B_ProgressiveSquare.Solution_0_Test(input);
