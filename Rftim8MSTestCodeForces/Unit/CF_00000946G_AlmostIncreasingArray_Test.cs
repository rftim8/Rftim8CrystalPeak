...
{
    [TestClass]
    public sealed class CF_00000946G_AlmostIncreasingArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000946G_AlmostIncreasingArray));
        ...
        {
            bool result = CF_00000946G_AlmostIncreasingArray.Solution_0_Test(input);
