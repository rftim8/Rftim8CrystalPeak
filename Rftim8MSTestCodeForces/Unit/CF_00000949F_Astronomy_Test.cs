...
{
    [TestClass]
    public sealed class CF_00000949F_Astronomy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000949F_Astronomy));
        ...
        {
            bool result = CF_00000949F_Astronomy.Solution_0_Test(input);
