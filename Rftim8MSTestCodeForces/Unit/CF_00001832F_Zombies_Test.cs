...
{
    [TestClass]
    public sealed class CF_00001832F_Zombies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001832F_Zombies));
        ...
        {
            bool result = CF_00001832F_Zombies.Solution_0_Test(input);
