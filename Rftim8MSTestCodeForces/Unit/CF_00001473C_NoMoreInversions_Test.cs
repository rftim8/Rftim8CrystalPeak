...
{
    [TestClass]
    public sealed class CF_00001473C_NoMoreInversions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001473C_NoMoreInversions));
        ...
        {
            bool result = CF_00001473C_NoMoreInversions.Solution_0_Test(input);
