...
{
    [TestClass]
    public sealed class CF_00000764B_TimofeyAndCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000764B_TimofeyAndCubes));
        ...
        {
            bool result = CF_00000764B_TimofeyAndCubes.Solution_0_Test(input);
