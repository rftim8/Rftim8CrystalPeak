...
{
    [TestClass]
    public sealed class CF_00001736E_SwapAndTake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001736E_SwapAndTake));
        ...
        {
            bool result = CF_00001736E_SwapAndTake.Solution_0_Test(input);
