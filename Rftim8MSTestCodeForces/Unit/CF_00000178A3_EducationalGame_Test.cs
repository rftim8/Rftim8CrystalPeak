...
{
    [TestClass]
    public sealed class CF_00000178A3_EducationalGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000178A3_EducationalGame));
        ...
        {
            bool result = CF_00000178A3_EducationalGame.Solution_0_Test(input);
