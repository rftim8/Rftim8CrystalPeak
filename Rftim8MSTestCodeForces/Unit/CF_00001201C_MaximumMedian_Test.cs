...
{
    [TestClass]
    public sealed class CF_00001201C_MaximumMedian_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001201C_MaximumMedian));
        ...
        {
            bool result = CF_00001201C_MaximumMedian.Solution_0_Test(input);
