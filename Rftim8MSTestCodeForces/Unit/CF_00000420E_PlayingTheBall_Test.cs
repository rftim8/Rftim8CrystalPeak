...
{
    [TestClass]
    public sealed class CF_00000420E_PlayingTheBall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000420E_PlayingTheBall));
        ...
        {
            bool result = CF_00000420E_PlayingTheBall.Solution_0_Test(input);
