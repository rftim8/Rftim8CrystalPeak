...
{
    [TestClass]
    public sealed class CF_00000886B_VladAndCafes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000886B_VladAndCafes));
        ...
        {
            bool result = CF_00000886B_VladAndCafes.Solution_0_Test(input);
