...
{
    [TestClass]
    public sealed class CF_00000106C_Buns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000106C_Buns));
        ...
        {
            bool result = CF_00000106C_Buns.Solution_0_Test(input);
