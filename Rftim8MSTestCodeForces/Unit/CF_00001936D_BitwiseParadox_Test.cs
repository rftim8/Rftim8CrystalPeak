...
{
    [TestClass]
    public sealed class CF_00001936D_BitwiseParadox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001936D_BitwiseParadox));
        ...
        {
            bool result = CF_00001936D_BitwiseParadox.Solution_0_Test(input);
