...
{
    [TestClass]
    public sealed class CF_00000802D_MarmotsEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802D_MarmotsEasy));
        ...
        {
            bool result = CF_00000802D_MarmotsEasy.Solution_0_Test(input);
