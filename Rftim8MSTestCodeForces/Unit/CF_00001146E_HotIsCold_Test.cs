...
{
    [TestClass]
    public sealed class CF_00001146E_HotIsCold_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001146E_HotIsCold));
        ...
        {
            bool result = CF_00001146E_HotIsCold.Solution_0_Test(input);
