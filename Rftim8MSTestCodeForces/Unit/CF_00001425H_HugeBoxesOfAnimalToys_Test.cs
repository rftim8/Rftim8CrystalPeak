...
{
    [TestClass]
    public sealed class CF_00001425H_HugeBoxesOfAnimalToys_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001425H_HugeBoxesOfAnimalToys));
        ...
        {
            bool result = CF_00001425H_HugeBoxesOfAnimalToys.Solution_0_Test(input);
