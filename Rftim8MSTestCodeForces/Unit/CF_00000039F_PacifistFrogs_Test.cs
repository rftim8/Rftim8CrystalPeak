...
{
    [TestClass]
    public sealed class CF_00000039F_PacifistFrogs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000039F_PacifistFrogs));
        ...
        {
            bool result = CF_00000039F_PacifistFrogs.Solution_0_Test(input);
