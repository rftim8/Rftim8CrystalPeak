...
{
    [TestClass]
    public sealed class CF_00001628C_GridXor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001628C_GridXor));
        ...
        {
            bool result = CF_00001628C_GridXor.Solution_0_Test(input);
