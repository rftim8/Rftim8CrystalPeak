...
{
    [TestClass]
    public sealed class CF_00001444B_DivideAndSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001444B_DivideAndSum));
        ...
        {
            bool result = CF_00001444B_DivideAndSum.Solution_0_Test(input);
