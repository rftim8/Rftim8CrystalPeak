...
{
    [TestClass]
    public sealed class CF_00001631A_MinMaxSwap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001631A_MinMaxSwap));
        ...
        {
            bool result = CF_00001631A_MinMaxSwap.Solution_0_Test(input);
