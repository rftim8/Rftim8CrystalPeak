...
{
    [TestClass]
    public sealed class CF_00000900A_FindExtraOne_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000900A_FindExtraOne));
        ...
        {
            bool result = CF_00000900A_FindExtraOne.Solution_0_Test(input);
