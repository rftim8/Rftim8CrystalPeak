...
{
    [TestClass]
    public sealed class CF_00001211A_ThreeProblems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001211A_ThreeProblems));
        ...
        {
            bool result = CF_00001211A_ThreeProblems.Solution_0_Test(input);
