...
{
    [TestClass]
    public sealed class CF_00001181A_ChungaChanga_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001181A_ChungaChanga));
        ...
        {
            bool result = CF_00001181A_ChungaChanga.Solution_0_Test(input);
