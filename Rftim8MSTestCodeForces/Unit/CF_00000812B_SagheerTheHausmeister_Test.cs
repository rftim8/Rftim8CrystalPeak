...
{
    [TestClass]
    public sealed class CF_00000812B_SagheerTheHausmeister_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000812B_SagheerTheHausmeister));
        ...
        {
            bool result = CF_00000812B_SagheerTheHausmeister.Solution_0_Test(input);
