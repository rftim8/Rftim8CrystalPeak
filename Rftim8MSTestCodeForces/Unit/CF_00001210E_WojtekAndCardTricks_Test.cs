...
{
    [TestClass]
    public sealed class CF_00001210E_WojtekAndCardTricks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001210E_WojtekAndCardTricks));
        ...
        {
            bool result = CF_00001210E_WojtekAndCardTricks.Solution_0_Test(input);
