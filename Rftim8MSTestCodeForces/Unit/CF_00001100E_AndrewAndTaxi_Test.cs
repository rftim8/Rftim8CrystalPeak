...
{
    [TestClass]
    public sealed class CF_00001100E_AndrewAndTaxi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001100E_AndrewAndTaxi));
        ...
        {
            bool result = CF_00001100E_AndrewAndTaxi.Solution_0_Test(input);
