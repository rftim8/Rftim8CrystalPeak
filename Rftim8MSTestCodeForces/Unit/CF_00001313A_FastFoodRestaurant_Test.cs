...
{
    [TestClass]
    public sealed class CF_00001313A_FastFoodRestaurant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001313A_FastFoodRestaurant));
        ...
        {
            bool result = CF_00001313A_FastFoodRestaurant.Solution_0_Test(input);
