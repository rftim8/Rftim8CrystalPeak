...
{
    [TestClass]
    public sealed class CF_00001974A_PhoneDesktop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001974A_PhoneDesktop));
        ...
        {
            bool result = CF_00001974A_PhoneDesktop.Solution_0_Test(input);
