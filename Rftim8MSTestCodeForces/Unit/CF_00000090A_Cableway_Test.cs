...
{
    [TestClass]
    public sealed class CF_00000090A_Cableway_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000090A_Cableway));
        ...
        {
            bool result = CF_00000090A_Cableway.Solution_0_Test(input);
