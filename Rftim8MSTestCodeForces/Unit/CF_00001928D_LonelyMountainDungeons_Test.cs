...
{
    [TestClass]
    public sealed class CF_00001928D_LonelyMountainDungeons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001928D_LonelyMountainDungeons));
        ...
        {
            bool result = CF_00001928D_LonelyMountainDungeons.Solution_0_Test(input);
