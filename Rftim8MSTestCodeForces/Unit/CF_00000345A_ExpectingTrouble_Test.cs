...
{
    [TestClass]
    public sealed class CF_00000345A_ExpectingTrouble_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000345A_ExpectingTrouble));
        ...
        {
            bool result = CF_00000345A_ExpectingTrouble.Solution_0_Test(input);
