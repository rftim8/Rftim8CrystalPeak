...
{
    [TestClass]
    public sealed class CF_00001553C_Penalty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001553C_Penalty));
        ...
        {
            bool result = CF_00001553C_Penalty.Solution_0_Test(input);
