...
{
    [TestClass]
    public sealed class CF_00001906F_MaximizeTheValue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001906F_MaximizeTheValue));
        ...
        {
            bool result = CF_00001906F_MaximizeTheValue.Solution_0_Test(input);
