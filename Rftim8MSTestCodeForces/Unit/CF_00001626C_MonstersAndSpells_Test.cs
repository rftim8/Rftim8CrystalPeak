...
{
    [TestClass]
    public sealed class CF_00001626C_MonstersAndSpells_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001626C_MonstersAndSpells));
        ...
        {
            bool result = CF_00001626C_MonstersAndSpells.Solution_0_Test(input);
