...
{
    [TestClass]
    public sealed class CF_00001873A_ShortSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001873A_ShortSort));
        ...
        {
            bool result = CF_00001873A_ShortSort.Solution_0_Test(input);
