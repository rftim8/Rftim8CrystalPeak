...
{
    [TestClass]
    public sealed class CF_00001553G_CommonDivisorGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001553G_CommonDivisorGraph));
        ...
        {
            bool result = CF_00001553G_CommonDivisorGraph.Solution_0_Test(input);
