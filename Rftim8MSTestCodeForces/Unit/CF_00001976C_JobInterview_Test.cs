...
{
    [TestClass]
    public sealed class CF_00001976C_JobInterview_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001976C_JobInterview));
        ...
        {
            bool result = CF_00001976C_JobInterview.Solution_0_Test(input);
