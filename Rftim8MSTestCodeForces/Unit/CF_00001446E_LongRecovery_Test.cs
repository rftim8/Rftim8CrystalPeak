...
{
    [TestClass]
    public sealed class CF_00001446E_LongRecovery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001446E_LongRecovery));
        ...
        {
            bool result = CF_00001446E_LongRecovery.Solution_0_Test(input);
