...
{
    [TestClass]
    public sealed class CF_00001253D_HarmoniousGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001253D_HarmoniousGraph));
        ...
        {
            bool result = CF_00001253D_HarmoniousGraph.Solution_0_Test(input);
