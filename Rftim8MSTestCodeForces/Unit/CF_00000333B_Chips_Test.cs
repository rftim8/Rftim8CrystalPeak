...
{
    [TestClass]
    public sealed class CF_00000333B_Chips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000333B_Chips));
        ...
        {
            bool result = CF_00000333B_Chips.Solution_0_Test(input);
