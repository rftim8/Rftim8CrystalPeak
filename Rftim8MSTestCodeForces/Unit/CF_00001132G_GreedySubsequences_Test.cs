...
{
    [TestClass]
    public sealed class CF_00001132G_GreedySubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001132G_GreedySubsequences));
        ...
        {
            bool result = CF_00001132G_GreedySubsequences.Solution_0_Test(input);
