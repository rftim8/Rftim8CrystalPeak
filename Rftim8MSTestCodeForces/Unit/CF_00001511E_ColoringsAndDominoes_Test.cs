...
{
    [TestClass]
    public sealed class CF_00001511E_ColoringsAndDominoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001511E_ColoringsAndDominoes));
        ...
        {
            bool result = CF_00001511E_ColoringsAndDominoes.Solution_0_Test(input);
