...
{
    [TestClass]
    public sealed class CF_00002041D_DrunkenMaze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002041D_DrunkenMaze));
        ...
        {
            bool result = CF_00002041D_DrunkenMaze.Solution_0_Test(input);
