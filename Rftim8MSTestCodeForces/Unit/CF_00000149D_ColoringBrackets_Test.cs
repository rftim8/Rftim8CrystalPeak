...
{
    [TestClass]
    public sealed class CF_00000149D_ColoringBrackets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000149D_ColoringBrackets));
        ...
        {
            bool result = CF_00000149D_ColoringBrackets.Solution_0_Test(input);
