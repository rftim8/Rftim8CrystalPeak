...
{
    [TestClass]
    public sealed class CF_00001418A_BuyingTorches_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001418A_BuyingTorches));
        ...
        {
            bool result = CF_00001418A_BuyingTorches.Solution_0_Test(input);
