...
{
    [TestClass]
    public sealed class CF_00001659C_LineEmpire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001659C_LineEmpire));
        ...
        {
            bool result = CF_00001659C_LineEmpire.Solution_0_Test(input);
