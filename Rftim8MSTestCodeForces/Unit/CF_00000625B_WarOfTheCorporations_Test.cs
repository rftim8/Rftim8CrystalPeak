...
{
    [TestClass]
    public sealed class CF_00000625B_WarOfTheCorporations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000625B_WarOfTheCorporations));
        ...
        {
            bool result = CF_00000625B_WarOfTheCorporations.Solution_0_Test(input);
