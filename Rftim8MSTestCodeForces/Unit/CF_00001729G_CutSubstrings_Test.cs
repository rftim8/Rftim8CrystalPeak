...
{
    [TestClass]
    public sealed class CF_00001729G_CutSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001729G_CutSubstrings));
        ...
        {
            bool result = CF_00001729G_CutSubstrings.Solution_0_Test(input);
