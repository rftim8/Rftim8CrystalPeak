...
{
    [TestClass]
    public sealed class CF_00001385F_RemovingLeaves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001385F_RemovingLeaves));
        ...
        {
            bool result = CF_00001385F_RemovingLeaves.Solution_0_Test(input);
