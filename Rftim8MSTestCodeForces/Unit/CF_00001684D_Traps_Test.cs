...
{
    [TestClass]
    public sealed class CF_00001684D_Traps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001684D_Traps));
        ...
        {
            bool result = CF_00001684D_Traps.Solution_0_Test(input);
