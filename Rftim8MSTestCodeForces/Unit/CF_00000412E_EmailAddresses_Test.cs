...
{
    [TestClass]
    public sealed class CF_00000412E_EmailAddresses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000412E_EmailAddresses));
        ...
        {
            bool result = CF_00000412E_EmailAddresses.Solution_0_Test(input);
