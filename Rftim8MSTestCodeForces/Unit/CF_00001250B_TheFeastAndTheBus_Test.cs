...
{
    [TestClass]
    public sealed class CF_00001250B_TheFeastAndTheBus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250B_TheFeastAndTheBus));
        ...
        {
            bool result = CF_00001250B_TheFeastAndTheBus.Solution_0_Test(input);
