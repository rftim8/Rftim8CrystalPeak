...
{
    [TestClass]
    public sealed class CF_00001715A_Crossmarket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001715A_Crossmarket));
        ...
        {
            bool result = CF_00001715A_Crossmarket.Solution_0_Test(input);
