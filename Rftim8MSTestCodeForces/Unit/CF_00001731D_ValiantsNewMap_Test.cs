...
{
    [TestClass]
    public sealed class CF_00001731D_ValiantsNewMap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001731D_ValiantsNewMap));
        ...
        {
            bool result = CF_00001731D_ValiantsNewMap.Solution_0_Test(input);
