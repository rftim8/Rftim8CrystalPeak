...
{
    [TestClass]
    public sealed class CF_00001952D_AreYouAProcrastinator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001952D_AreYouAProcrastinator));
        ...
        {
            bool result = CF_00001952D_AreYouAProcrastinator.Solution_0_Test(input);
