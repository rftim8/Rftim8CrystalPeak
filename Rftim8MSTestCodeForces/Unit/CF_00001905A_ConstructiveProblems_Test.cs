...
{
    [TestClass]
    public sealed class CF_00001905A_ConstructiveProblems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001905A_ConstructiveProblems));
        ...
        {
            bool result = CF_00001905A_ConstructiveProblems.Solution_0_Test(input);
