...
{
    [TestClass]
    public sealed class CF_00001463C_BusyRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001463C_BusyRobot));
        ...
        {
            bool result = CF_00001463C_BusyRobot.Solution_0_Test(input);
