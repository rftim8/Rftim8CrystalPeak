...
{
    [TestClass]
    public sealed class CF_00000398C_TreeAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000398C_TreeAndArray));
        ...
        {
            bool result = CF_00000398C_TreeAndArray.Solution_0_Test(input);
