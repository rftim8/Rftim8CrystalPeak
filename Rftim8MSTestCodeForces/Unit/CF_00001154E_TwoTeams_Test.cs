...
{
    [TestClass]
    public sealed class CF_00001154E_TwoTeams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001154E_TwoTeams));
        ...
        {
            bool result = CF_00001154E_TwoTeams.Solution_0_Test(input);
