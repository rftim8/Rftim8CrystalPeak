...
{
    [TestClass]
    public sealed class CF_00001426F_NumberOfSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001426F_NumberOfSubsequences));
        ...
        {
            bool result = CF_00001426F_NumberOfSubsequences.Solution_0_Test(input);
