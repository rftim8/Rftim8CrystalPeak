...
{
    [TestClass]
    public sealed class CF_00001090B_LaTeXExpert_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090B_LaTeXExpert));
        ...
        {
            bool result = CF_00001090B_LaTeXExpert.Solution_0_Test(input);
