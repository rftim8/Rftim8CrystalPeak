...
{
    [TestClass]
    public sealed class CF_00001984B_LargeAddition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001984B_LargeAddition));
        ...
        {
            bool result = CF_00001984B_LargeAddition.Solution_0_Test(input);
