...
{
    [TestClass]
    public sealed class CF_00000615E_Hexagons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000615E_Hexagons));
        ...
        {
            bool result = CF_00000615E_Hexagons.Solution_0_Test(input);
