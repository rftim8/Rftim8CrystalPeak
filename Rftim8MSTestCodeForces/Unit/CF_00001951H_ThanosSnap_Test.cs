...
{
    [TestClass]
    public sealed class CF_00001951H_ThanosSnap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001951H_ThanosSnap));
        ...
        {
            bool result = CF_00001951H_ThanosSnap.Solution_0_Test(input);
