...
{
    [TestClass]
    public sealed class CF_00001144G_TwoMergedSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001144G_TwoMergedSequences));
        ...
        {
            bool result = CF_00001144G_TwoMergedSequences.Solution_0_Test(input);
