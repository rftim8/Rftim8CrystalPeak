...
{
    [TestClass]
    public sealed class CF_00001618B_MissingBigram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001618B_MissingBigram));
        ...
        {
            bool result = CF_00001618B_MissingBigram.Solution_0_Test(input);
