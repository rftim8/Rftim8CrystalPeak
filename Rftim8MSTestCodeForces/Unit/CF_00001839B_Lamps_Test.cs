...
{
    [TestClass]
    public sealed class CF_00001839B_Lamps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001839B_Lamps));
        ...
        {
            bool result = CF_00001839B_Lamps.Solution_0_Test(input);
