...
{
    [TestClass]
    public sealed class CF_00000794A_BankRobbery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000794A_BankRobbery));
        ...
        {
            bool result = CF_00000794A_BankRobbery.Solution_0_Test(input);
