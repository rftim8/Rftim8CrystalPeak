...
{
    [TestClass]
    public sealed class CF_00001725E_ElectricalEfficiency_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725E_ElectricalEfficiency));
        ...
        {
            bool result = CF_00001725E_ElectricalEfficiency.Solution_0_Test(input);
