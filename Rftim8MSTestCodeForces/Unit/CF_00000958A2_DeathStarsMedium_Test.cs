...
{
    [TestClass]
    public sealed class CF_00000958A2_DeathStarsMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000958A2_DeathStarsMedium));
        ...
        {
            bool result = CF_00000958A2_DeathStarsMedium.Solution_0_Test(input);
