...
{
    [TestClass]
    public sealed class CF_00000391B_WordFolding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000391B_WordFolding));
        ...
        {
            bool result = CF_00000391B_WordFolding.Solution_0_Test(input);
