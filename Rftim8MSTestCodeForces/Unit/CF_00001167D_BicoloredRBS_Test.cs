...
{
    [TestClass]
    public sealed class CF_00001167D_BicoloredRBS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001167D_BicoloredRBS));
        ...
        {
            bool result = CF_00001167D_BicoloredRBS.Solution_0_Test(input);
