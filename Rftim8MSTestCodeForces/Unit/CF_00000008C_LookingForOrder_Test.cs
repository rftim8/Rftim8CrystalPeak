...
{
    [TestClass]
    public sealed class CF_00000008C_LookingForOrder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000008C_LookingForOrder));
        ...
        {
            bool result = CF_00000008C_LookingForOrder.Solution_0_Test(input);
