...
{
    [TestClass]
    public sealed class CF_00000323B_Tournamentgraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000323B_Tournamentgraph));
        ...
        {
            bool result = CF_00000323B_Tournamentgraph.Solution_0_Test(input);
