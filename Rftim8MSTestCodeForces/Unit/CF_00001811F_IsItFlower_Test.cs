...
{
    [TestClass]
    public sealed class CF_00001811F_IsItFlower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001811F_IsItFlower));
        ...
        {
            bool result = CF_00001811F_IsItFlower.Solution_0_Test(input);
