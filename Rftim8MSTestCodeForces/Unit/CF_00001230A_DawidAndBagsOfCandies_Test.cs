...
{
    [TestClass]
    public sealed class CF_00001230A_DawidAndBagsOfCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001230A_DawidAndBagsOfCandies));
        ...
        {
            bool result = CF_00001230A_DawidAndBagsOfCandies.Solution_0_Test(input);
