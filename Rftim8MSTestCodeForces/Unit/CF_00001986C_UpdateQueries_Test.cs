...
{
    [TestClass]
    public sealed class CF_00001986C_UpdateQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001986C_UpdateQueries));
        ...
        {
            bool result = CF_00001986C_UpdateQueries.Solution_0_Test(input);
