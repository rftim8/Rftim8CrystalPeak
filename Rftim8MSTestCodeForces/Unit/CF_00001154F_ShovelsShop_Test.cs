...
{
    [TestClass]
    public sealed class CF_00001154F_ShovelsShop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001154F_ShovelsShop));
        ...
        {
            bool result = CF_00001154F_ShovelsShop.Solution_0_Test(input);
