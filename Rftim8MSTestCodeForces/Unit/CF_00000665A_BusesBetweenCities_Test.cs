...
{
    [TestClass]
    public sealed class CF_00000665A_BusesBetweenCities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000665A_BusesBetweenCities));
        ...
        {
            bool result = CF_00000665A_BusesBetweenCities.Solution_0_Test(input);
