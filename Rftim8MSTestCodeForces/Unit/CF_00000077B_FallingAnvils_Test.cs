...
{
    [TestClass]
    public sealed class CF_00000077B_FallingAnvils_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000077B_FallingAnvils));
        ...
        {
            bool result = CF_00000077B_FallingAnvils.Solution_0_Test(input);
