...
{
    [TestClass]
    public sealed class CF_00000182E_WoodenFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000182E_WoodenFence));
        ...
        {
            bool result = CF_00000182E_WoodenFence.Solution_0_Test(input);
