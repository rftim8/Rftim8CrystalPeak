...
{
    [TestClass]
    public sealed class CF_00000965D_SingleuseStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000965D_SingleuseStones));
        ...
        {
            bool result = CF_00000965D_SingleuseStones.Solution_0_Test(input);
