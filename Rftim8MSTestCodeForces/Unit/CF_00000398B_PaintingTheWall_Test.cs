...
{
    [TestClass]
    public sealed class CF_00000398B_PaintingTheWall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000398B_PaintingTheWall));
        ...
        {
            bool result = CF_00000398B_PaintingTheWall.Solution_0_Test(input);
