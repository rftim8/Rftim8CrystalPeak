...
{
    [TestClass]
    public sealed class CF_00000578E_Walking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000578E_Walking));
        ...
        {
            bool result = CF_00000578E_Walking.Solution_0_Test(input);
