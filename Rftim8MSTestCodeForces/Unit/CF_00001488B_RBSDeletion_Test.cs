...
{
    [TestClass]
    public sealed class CF_00001488B_RBSDeletion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001488B_RBSDeletion));
        ...
        {
            bool result = CF_00001488B_RBSDeletion.Solution_0_Test(input);
