...
{
    [TestClass]
    public sealed class CF_00002038M_RoyalFlush_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002038M_RoyalFlush));
        ...
        {
            bool result = CF_00002038M_RoyalFlush.Solution_0_Test(input);
