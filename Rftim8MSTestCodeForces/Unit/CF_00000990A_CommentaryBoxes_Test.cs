...
{
    [TestClass]
    public sealed class CF_00000990A_CommentaryBoxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000990A_CommentaryBoxes));
        ...
        {
            bool result = CF_00000990A_CommentaryBoxes.Solution_0_Test(input);
