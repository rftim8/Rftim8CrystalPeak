...
{
    [TestClass]
    public sealed class CF_00001919F1_WineFactoryEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001919F1_WineFactoryEasyVersion));
        ...
        {
            bool result = CF_00001919F1_WineFactoryEasyVersion.Solution_0_Test(input);
