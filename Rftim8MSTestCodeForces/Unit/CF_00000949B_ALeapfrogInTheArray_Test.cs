...
{
    [TestClass]
    public sealed class CF_00000949B_ALeapfrogInTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000949B_ALeapfrogInTheArray));
        ...
        {
            bool result = CF_00000949B_ALeapfrogInTheArray.Solution_0_Test(input);
