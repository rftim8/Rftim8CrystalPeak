...
{
    [TestClass]
    public sealed class CF_00001783B_MatrixOfDifferences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001783B_MatrixOfDifferences));
        ...
        {
            bool result = CF_00001783B_MatrixOfDifferences.Solution_0_Test(input);
