...
{
    [TestClass]
    public sealed class CF_00001926E_VladAndAnOddOrdering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001926E_VladAndAnOddOrdering));
        ...
        {
            bool result = CF_00001926E_VladAndAnOddOrdering.Solution_0_Test(input);
