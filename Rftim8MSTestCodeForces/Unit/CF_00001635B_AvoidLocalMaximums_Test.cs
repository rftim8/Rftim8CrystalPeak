...
{
    [TestClass]
    public sealed class CF_00001635B_AvoidLocalMaximums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001635B_AvoidLocalMaximums));
        ...
        {
            bool result = CF_00001635B_AvoidLocalMaximums.Solution_0_Test(input);
