...
{
    [TestClass]
    public sealed class CF_00001732C2_SheikhHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001732C2_SheikhHardVersion));
        ...
        {
            bool result = CF_00001732C2_SheikhHardVersion.Solution_0_Test(input);
