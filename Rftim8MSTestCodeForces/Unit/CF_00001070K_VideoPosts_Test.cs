...
{
    [TestClass]
    public sealed class CF_00001070K_VideoPosts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001070K_VideoPosts));
        ...
        {
            bool result = CF_00001070K_VideoPosts.Solution_0_Test(input);
