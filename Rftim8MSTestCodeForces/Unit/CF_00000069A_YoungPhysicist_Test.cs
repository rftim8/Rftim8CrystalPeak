...
{
    [TestClass]
    public sealed class CF_00000069A_YoungPhysicist_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000069A_YoungPhysicist));
        ...
        {
            bool result = CF_00000069A_YoungPhysicist.Solution_0_Test(input);
