...
{
    [TestClass]
    public sealed class CF_00000490C_HackingCypher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000490C_HackingCypher));
        ...
        {
            bool result = CF_00000490C_HackingCypher.Solution_0_Test(input);
