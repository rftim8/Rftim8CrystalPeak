...
{
    [TestClass]
    public sealed class CF_00001672C_UnequalArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001672C_UnequalArray));
        ...
        {
            bool result = CF_00001672C_UnequalArray.Solution_0_Test(input);
