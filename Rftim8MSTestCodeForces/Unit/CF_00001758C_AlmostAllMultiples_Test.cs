...
{
    [TestClass]
    public sealed class CF_00001758C_AlmostAllMultiples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001758C_AlmostAllMultiples));
        ...
        {
            bool result = CF_00001758C_AlmostAllMultiples.Solution_0_Test(input);
