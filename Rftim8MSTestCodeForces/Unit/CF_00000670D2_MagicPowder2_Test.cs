...
{
    [TestClass]
    public sealed class CF_00000670D2_MagicPowder2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000670D2_MagicPowder2));
        ...
        {
            bool result = CF_00000670D2_MagicPowder2.Solution_0_Test(input);
