...
{
    [TestClass]
    public sealed class CF_00001628E_GroceriesInMeteorTown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001628E_GroceriesInMeteorTown));
        ...
        {
            bool result = CF_00001628E_GroceriesInMeteorTown.Solution_0_Test(input);
