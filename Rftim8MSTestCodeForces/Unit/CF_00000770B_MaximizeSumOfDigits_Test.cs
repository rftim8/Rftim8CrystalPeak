...
{
    [TestClass]
    public sealed class CF_00000770B_MaximizeSumOfDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000770B_MaximizeSumOfDigits));
        ...
        {
            bool result = CF_00000770B_MaximizeSumOfDigits.Solution_0_Test(input);
