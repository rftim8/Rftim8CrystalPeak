...
{
    [TestClass]
    public sealed class CF_00002022B_KarSalesman_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002022B_KarSalesman));
        ...
        {
            bool result = CF_00002022B_KarSalesman.Solution_0_Test(input);
