...
{
    [TestClass]
    public sealed class CF_00000060C_MushroomStrife_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000060C_MushroomStrife));
        ...
        {
            bool result = CF_00000060C_MushroomStrife.Solution_0_Test(input);
