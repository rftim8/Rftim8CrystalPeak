...
{
    [TestClass]
    public sealed class CF_00000652D_NestedSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000652D_NestedSegments));
        ...
        {
            bool result = CF_00000652D_NestedSegments.Solution_0_Test(input);
