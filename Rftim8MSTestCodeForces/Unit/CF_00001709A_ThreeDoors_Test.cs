...
{
    [TestClass]
    public sealed class CF_00001709A_ThreeDoors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001709A_ThreeDoors));
        ...
        {
            bool result = CF_00001709A_ThreeDoors.Solution_0_Test(input);
