...
{
    [TestClass]
    public sealed class CF_00001325C_EhabAndPatheticMEXs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001325C_EhabAndPatheticMEXs));
        ...
        {
            bool result = CF_00001325C_EhabAndPatheticMEXs.Solution_0_Test(input);
