...
{
    [TestClass]
    public sealed class CF_00001921E_EatTheChip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001921E_EatTheChip));
        ...
        {
            bool result = CF_00001921E_EatTheChip.Solution_0_Test(input);
