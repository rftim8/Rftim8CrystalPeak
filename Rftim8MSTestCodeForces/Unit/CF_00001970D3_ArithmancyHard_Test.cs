...
{
    [TestClass]
    public sealed class CF_00001970D3_ArithmancyHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970D3_ArithmancyHard));
        ...
        {
            bool result = CF_00001970D3_ArithmancyHard.Solution_0_Test(input);
