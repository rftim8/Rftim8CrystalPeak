...
{
    [TestClass]
    public sealed class CF_00001810G_TheMaximumPrefix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001810G_TheMaximumPrefix));
        ...
        {
            bool result = CF_00001810G_TheMaximumPrefix.Solution_0_Test(input);
