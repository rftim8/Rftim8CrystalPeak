...
{
    [TestClass]
    public sealed class CF_00000241G_ChallengingBalloons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000241G_ChallengingBalloons));
        ...
        {
            bool result = CF_00000241G_ChallengingBalloons.Solution_0_Test(input);
