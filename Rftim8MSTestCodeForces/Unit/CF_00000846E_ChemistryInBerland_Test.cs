...
{
    [TestClass]
    public sealed class CF_00000846E_ChemistryInBerland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000846E_ChemistryInBerland));
        ...
        {
            bool result = CF_00000846E_ChemistryInBerland.Solution_0_Test(input);
