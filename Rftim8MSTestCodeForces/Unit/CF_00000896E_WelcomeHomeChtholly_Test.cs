...
{
    [TestClass]
    public sealed class CF_00000896E_WelcomeHomeChtholly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000896E_WelcomeHomeChtholly));
        ...
        {
            bool result = CF_00000896E_WelcomeHomeChtholly.Solution_0_Test(input);
