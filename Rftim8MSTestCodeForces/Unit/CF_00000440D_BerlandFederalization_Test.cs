...
{
    [TestClass]
    public sealed class CF_00000440D_BerlandFederalization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000440D_BerlandFederalization));
        ...
        {
            bool result = CF_00000440D_BerlandFederalization.Solution_0_Test(input);
