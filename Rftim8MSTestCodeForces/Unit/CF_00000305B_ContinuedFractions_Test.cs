...
{
    [TestClass]
    public sealed class CF_00000305B_ContinuedFractions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000305B_ContinuedFractions));
        ...
        {
            bool result = CF_00000305B_ContinuedFractions.Solution_0_Test(input);
