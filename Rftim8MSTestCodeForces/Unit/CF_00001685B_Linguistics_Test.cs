...
{
    [TestClass]
    public sealed class CF_00001685B_Linguistics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001685B_Linguistics));
        ...
        {
            bool result = CF_00001685B_Linguistics.Solution_0_Test(input);
