...
{
    [TestClass]
    public sealed class CF_00000162D_RemoveDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000162D_RemoveDigits));
        ...
        {
            bool result = CF_00000162D_RemoveDigits.Solution_0_Test(input);
