...
{
    [TestClass]
    public sealed class CF_00000089B_WidgetLibrary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000089B_WidgetLibrary));
        ...
        {
            bool result = CF_00000089B_WidgetLibrary.Solution_0_Test(input);
