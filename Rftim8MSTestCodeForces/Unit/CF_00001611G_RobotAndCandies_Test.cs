...
{
    [TestClass]
    public sealed class CF_00001611G_RobotAndCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001611G_RobotAndCandies));
        ...
        {
            bool result = CF_00001611G_RobotAndCandies.Solution_0_Test(input);
