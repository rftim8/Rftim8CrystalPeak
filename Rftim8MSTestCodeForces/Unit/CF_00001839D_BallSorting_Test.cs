...
{
    [TestClass]
    public sealed class CF_00001839D_BallSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001839D_BallSorting));
        ...
        {
            bool result = CF_00001839D_BallSorting.Solution_0_Test(input);
