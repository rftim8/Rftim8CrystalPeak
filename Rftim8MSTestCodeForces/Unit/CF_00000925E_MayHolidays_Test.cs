...
{
    [TestClass]
    public sealed class CF_00000925E_MayHolidays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000925E_MayHolidays));
        ...
        {
            bool result = CF_00000925E_MayHolidays.Solution_0_Test(input);
