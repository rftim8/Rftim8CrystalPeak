...
{
    [TestClass]
    public sealed class CF_00000167A_WizardsAndTrolleybuses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000167A_WizardsAndTrolleybuses));
        ...
        {
            bool result = CF_00000167A_WizardsAndTrolleybuses.Solution_0_Test(input);
