...
{
    [TestClass]
    public sealed class CF_00001760A_MediumNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001760A_MediumNumber));
        ...
        {
            bool result = CF_00001760A_MediumNumber.Solution_0_Test(input);
