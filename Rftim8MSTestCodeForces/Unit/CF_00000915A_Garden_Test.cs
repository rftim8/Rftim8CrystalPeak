...
{
    [TestClass]
    public sealed class CF_00000915A_Garden_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000915A_Garden));
        ...
        {
            bool result = CF_00000915A_Garden.Solution_0_Test(input);
