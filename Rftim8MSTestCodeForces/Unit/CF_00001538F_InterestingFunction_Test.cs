...
{
    [TestClass]
    public sealed class CF_00001538F_InterestingFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001538F_InterestingFunction));
        ...
        {
            bool result = CF_00001538F_InterestingFunction.Solution_0_Test(input);
