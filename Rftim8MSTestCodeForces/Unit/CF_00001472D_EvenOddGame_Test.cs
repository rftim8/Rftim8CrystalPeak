...
{
    [TestClass]
    public sealed class CF_00001472D_EvenOddGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001472D_EvenOddGame));
        ...
        {
            bool result = CF_00001472D_EvenOddGame.Solution_0_Test(input);
