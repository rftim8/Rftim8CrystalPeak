...
{
    [TestClass]
    public sealed class CF_00000649B_Floors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000649B_Floors));
        ...
        {
            bool result = CF_00000649B_Floors.Solution_0_Test(input);
