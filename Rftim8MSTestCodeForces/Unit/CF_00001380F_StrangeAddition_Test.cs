...
{
    [TestClass]
    public sealed class CF_00001380F_StrangeAddition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001380F_StrangeAddition));
        ...
        {
            bool result = CF_00001380F_StrangeAddition.Solution_0_Test(input);
