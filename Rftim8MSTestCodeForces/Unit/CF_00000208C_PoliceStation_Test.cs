...
{
    [TestClass]
    public sealed class CF_00000208C_PoliceStation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000208C_PoliceStation));
        ...
        {
            bool result = CF_00000208C_PoliceStation.Solution_0_Test(input);
