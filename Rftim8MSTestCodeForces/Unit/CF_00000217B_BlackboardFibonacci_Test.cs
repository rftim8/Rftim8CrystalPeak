...
{
    [TestClass]
    public sealed class CF_00000217B_BlackboardFibonacci_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000217B_BlackboardFibonacci));
        ...
        {
            bool result = CF_00000217B_BlackboardFibonacci.Solution_0_Test(input);
