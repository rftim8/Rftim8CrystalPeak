...
{
    [TestClass]
    public sealed class CF_00000902A_VisitingAFriend_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000902A_VisitingAFriend));
        ...
        {
            bool result = CF_00000902A_VisitingAFriend.Solution_0_Test(input);
