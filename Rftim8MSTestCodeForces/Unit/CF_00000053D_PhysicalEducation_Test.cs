...
{
    [TestClass]
    public sealed class CF_00000053D_PhysicalEducation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000053D_PhysicalEducation));
        ...
        {
            bool result = CF_00000053D_PhysicalEducation.Solution_0_Test(input);
