...
{
    [TestClass]
    public sealed class CF_00000039B_CompanyIncomeGrowth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000039B_CompanyIncomeGrowth));
        ...
        {
            bool result = CF_00000039B_CompanyIncomeGrowth.Solution_0_Test(input);
