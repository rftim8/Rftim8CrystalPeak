...
{
    [TestClass]
    public sealed class CF_00000570B_SimpleGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000570B_SimpleGame));
        ...
        {
            bool result = CF_00000570B_SimpleGame.Solution_0_Test(input);
