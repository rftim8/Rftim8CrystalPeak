...
{
    [TestClass]
    public sealed class CF_00000758C_UnfairPoll_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000758C_UnfairPoll));
        ...
        {
            bool result = CF_00000758C_UnfairPoll.Solution_0_Test(input);
