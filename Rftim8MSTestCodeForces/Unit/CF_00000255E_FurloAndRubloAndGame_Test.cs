...
{
    [TestClass]
    public sealed class CF_00000255E_FurloAndRubloAndGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000255E_FurloAndRubloAndGame));
        ...
        {
            bool result = CF_00000255E_FurloAndRubloAndGame.Solution_0_Test(input);
