...
{
    [TestClass]
    public sealed class CF_00000799D_FieldExpansion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000799D_FieldExpansion));
        ...
        {
            bool result = CF_00000799D_FieldExpansion.Solution_0_Test(input);
