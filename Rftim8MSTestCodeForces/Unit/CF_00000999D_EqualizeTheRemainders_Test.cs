...
{
    [TestClass]
    public sealed class CF_00000999D_EqualizeTheRemainders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000999D_EqualizeTheRemainders));
        ...
        {
            bool result = CF_00000999D_EqualizeTheRemainders.Solution_0_Test(input);
