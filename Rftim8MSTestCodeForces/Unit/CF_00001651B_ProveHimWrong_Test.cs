...
{
    [TestClass]
    public sealed class CF_00001651B_ProveHimWrong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001651B_ProveHimWrong));
        ...
        {
            bool result = CF_00001651B_ProveHimWrong.Solution_0_Test(input);
