...
{
    [TestClass]
    public sealed class CF_00000021D_TravelingGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000021D_TravelingGraph));
        ...
        {
            bool result = CF_00000021D_TravelingGraph.Solution_0_Test(input);
