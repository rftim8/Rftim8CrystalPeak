...
{
    [TestClass]
    public sealed class CF_00000641B_LittleArtemAndMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000641B_LittleArtemAndMatrix));
        ...
        {
            bool result = CF_00000641B_LittleArtemAndMatrix.Solution_0_Test(input);
