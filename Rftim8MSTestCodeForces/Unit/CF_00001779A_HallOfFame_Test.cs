...
{
    [TestClass]
    public sealed class CF_00001779A_HallOfFame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001779A_HallOfFame));
        ...
        {
            bool result = CF_00001779A_HallOfFame.Solution_0_Test(input);
