...
{
    [TestClass]
    public sealed class CF_00001296B_FoodBuying_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001296B_FoodBuying));
        ...
        {
            bool result = CF_00001296B_FoodBuying.Solution_0_Test(input);
