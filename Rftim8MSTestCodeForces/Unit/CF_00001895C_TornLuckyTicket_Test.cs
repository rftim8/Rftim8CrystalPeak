...
{
    [TestClass]
    public sealed class CF_00001895C_TornLuckyTicket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001895C_TornLuckyTicket));
        ...
        {
            bool result = CF_00001895C_TornLuckyTicket.Solution_0_Test(input);
