...
{
    [TestClass]
    public sealed class CF_00001905C_LargestSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001905C_LargestSubsequence));
        ...
        {
            bool result = CF_00001905C_LargestSubsequence.Solution_0_Test(input);
