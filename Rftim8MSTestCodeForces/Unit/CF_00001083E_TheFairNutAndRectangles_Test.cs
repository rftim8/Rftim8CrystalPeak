...
{
    [TestClass]
    public sealed class CF_00001083E_TheFairNutAndRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001083E_TheFairNutAndRectangles));
        ...
        {
            bool result = CF_00001083E_TheFairNutAndRectangles.Solution_0_Test(input);
