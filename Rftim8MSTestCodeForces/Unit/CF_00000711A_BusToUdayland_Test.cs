...
{
    [TestClass]
    public sealed class CF_00000711A_BusToUdayland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000711A_BusToUdayland));
        ...
        {
            bool result = CF_00000711A_BusToUdayland.Solution_0_Test(input);
