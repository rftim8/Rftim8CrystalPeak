...
{
    [TestClass]
    public sealed class CF_00000893E_CountingArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000893E_CountingArrays));
        ...
        {
            bool result = CF_00000893E_CountingArrays.Solution_0_Test(input);
