...
{
    [TestClass]
    public sealed class CF_00001674B_Dictionary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001674B_Dictionary));
        ...
        {
            bool result = CF_00001674B_Dictionary.Solution_0_Test(input);
