...
{
    [TestClass]
    public sealed class CF_00001250M_SmartGarden_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250M_SmartGarden));
        ...
        {
            bool result = CF_00001250M_SmartGarden.Solution_0_Test(input);
