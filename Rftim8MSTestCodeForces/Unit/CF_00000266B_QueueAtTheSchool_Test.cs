...
{
    [TestClass]
    public sealed class CF_00000266B_QueueAtTheSchool_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000266B_QueueAtTheSchool));
        ...
        {
            bool result = CF_00000266B_QueueAtTheSchool.Solution_0_Test(input);
