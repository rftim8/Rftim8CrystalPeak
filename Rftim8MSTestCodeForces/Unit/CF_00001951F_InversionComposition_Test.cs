...
{
    [TestClass]
    public sealed class CF_00001951F_InversionComposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001951F_InversionComposition));
        ...
        {
            bool result = CF_00001951F_InversionComposition.Solution_0_Test(input);
