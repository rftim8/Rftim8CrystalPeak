...
{
    [TestClass]
    public sealed class CF_00000109B_LuckyProbability_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000109B_LuckyProbability));
        ...
        {
            bool result = CF_00000109B_LuckyProbability.Solution_0_Test(input);
