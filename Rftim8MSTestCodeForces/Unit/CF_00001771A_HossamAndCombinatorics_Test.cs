...
{
    [TestClass]
    public sealed class CF_00001771A_HossamAndCombinatorics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001771A_HossamAndCombinatorics));
        ...
        {
            bool result = CF_00001771A_HossamAndCombinatorics.Solution_0_Test(input);
