...
{
    [TestClass]
    public sealed class CF_00000535E_TavasAndPashmaks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000535E_TavasAndPashmaks));
        ...
        {
            bool result = CF_00000535E_TavasAndPashmaks.Solution_0_Test(input);
