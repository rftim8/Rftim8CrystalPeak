...
{
    [TestClass]
    public sealed class CF_00000173A_RockPaperScissors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000173A_RockPaperScissors));
        ...
        {
            bool result = CF_00000173A_RockPaperScissors.Solution_0_Test(input);
