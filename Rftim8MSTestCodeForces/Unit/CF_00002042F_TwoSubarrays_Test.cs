...
{
    [TestClass]
    public sealed class CF_00002042F_TwoSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002042F_TwoSubarrays));
        ...
        {
            bool result = CF_00002042F_TwoSubarrays.Solution_0_Test(input);
