...
{
    [TestClass]
    public sealed class CF_00001379D_NewPassengerTrams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001379D_NewPassengerTrams));
        ...
        {
            bool result = CF_00001379D_NewPassengerTrams.Solution_0_Test(input);
