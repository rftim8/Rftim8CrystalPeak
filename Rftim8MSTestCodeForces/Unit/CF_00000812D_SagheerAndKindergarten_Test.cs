...
{
    [TestClass]
    public sealed class CF_00000812D_SagheerAndKindergarten_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000812D_SagheerAndKindergarten));
        ...
        {
            bool result = CF_00000812D_SagheerAndKindergarten.Solution_0_Test(input);
