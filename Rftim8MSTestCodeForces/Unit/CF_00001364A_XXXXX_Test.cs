...
{
    [TestClass]
    public sealed class CF_00001364A_XXXXX_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001364A_XXXXX));
        ...
        {
            bool result = CF_00001364A_XXXXX.Solution_0_Test(input);
