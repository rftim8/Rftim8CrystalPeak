...
{
    [TestClass]
    public sealed class CF_00000257B_PlayingCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000257B_PlayingCubes));
        ...
        {
            bool result = CF_00000257B_PlayingCubes.Solution_0_Test(input);
