...
{
    [TestClass]
    public sealed class CF_00000437A_TheChildAndHomework_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000437A_TheChildAndHomework));
        ...
        {
            bool result = CF_00000437A_TheChildAndHomework.Solution_0_Test(input);
