...
{
    [TestClass]
    public sealed class CF_00001656I_NeighbourOrdering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001656I_NeighbourOrdering));
        ...
        {
            bool result = CF_00001656I_NeighbourOrdering.Solution_0_Test(input);
