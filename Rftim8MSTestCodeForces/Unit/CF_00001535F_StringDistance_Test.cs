...
{
    [TestClass]
    public sealed class CF_00001535F_StringDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001535F_StringDistance));
        ...
        {
            bool result = CF_00001535F_StringDistance.Solution_0_Test(input);
