...
{
    [TestClass]
    public sealed class CF_00001649B_GameOfBallPassing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001649B_GameOfBallPassing));
        ...
        {
            bool result = CF_00001649B_GameOfBallPassing.Solution_0_Test(input);
