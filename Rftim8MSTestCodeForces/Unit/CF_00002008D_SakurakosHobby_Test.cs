...
{
    [TestClass]
    public sealed class CF_00002008D_SakurakosHobby_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002008D_SakurakosHobby));
        ...
        {
            bool result = CF_00002008D_SakurakosHobby.Solution_0_Test(input);
