...
{
    [TestClass]
    public sealed class CF_00001930E_234WonderfulWonderful_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001930E_234WonderfulWonderful));
        ...
        {
            bool result = CF_00001930E_234WonderfulWonderful.Solution_0_Test(input);
