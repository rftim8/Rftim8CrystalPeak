...
{
    [TestClass]
    public sealed class CF_00000582E_BooleanFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000582E_BooleanFunction));
        ...
        {
            bool result = CF_00000582E_BooleanFunction.Solution_0_Test(input);
