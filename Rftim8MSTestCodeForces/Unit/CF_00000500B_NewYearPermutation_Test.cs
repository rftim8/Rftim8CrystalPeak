...
{
    [TestClass]
    public sealed class CF_00000500B_NewYearPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000500B_NewYearPermutation));
        ...
        {
            bool result = CF_00000500B_NewYearPermutation.Solution_0_Test(input);
