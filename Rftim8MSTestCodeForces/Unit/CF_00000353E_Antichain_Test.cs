...
{
    [TestClass]
    public sealed class CF_00000353E_Antichain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000353E_Antichain));
        ...
        {
            bool result = CF_00000353E_Antichain.Solution_0_Test(input);
