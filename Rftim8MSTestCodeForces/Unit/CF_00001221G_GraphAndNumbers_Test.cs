...
{
    [TestClass]
    public sealed class CF_00001221G_GraphAndNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001221G_GraphAndNumbers));
        ...
        {
            bool result = CF_00001221G_GraphAndNumbers.Solution_0_Test(input);
