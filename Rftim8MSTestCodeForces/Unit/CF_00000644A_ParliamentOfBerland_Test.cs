...
{
    [TestClass]
    public sealed class CF_00000644A_ParliamentOfBerland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000644A_ParliamentOfBerland));
        ...
        {
            bool result = CF_00000644A_ParliamentOfBerland.Solution_0_Test(input);
