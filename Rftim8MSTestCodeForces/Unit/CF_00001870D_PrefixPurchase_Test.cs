...
{
    [TestClass]
    public sealed class CF_00001870D_PrefixPurchase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001870D_PrefixPurchase));
        ...
        {
            bool result = CF_00001870D_PrefixPurchase.Solution_0_Test(input);
