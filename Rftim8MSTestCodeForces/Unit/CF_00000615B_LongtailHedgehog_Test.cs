...
{
    [TestClass]
    public sealed class CF_00000615B_LongtailHedgehog_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000615B_LongtailHedgehog));
        ...
        {
            bool result = CF_00000615B_LongtailHedgehog.Solution_0_Test(input);
