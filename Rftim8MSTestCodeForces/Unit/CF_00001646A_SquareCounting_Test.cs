...
{
    [TestClass]
    public sealed class CF_00001646A_SquareCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001646A_SquareCounting));
        ...
        {
            bool result = CF_00001646A_SquareCounting.Solution_0_Test(input);
