...
{
    [TestClass]
    public sealed class CF_00001606D_RedBlueMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001606D_RedBlueMatrix));
        ...
        {
            bool result = CF_00001606D_RedBlueMatrix.Solution_0_Test(input);
