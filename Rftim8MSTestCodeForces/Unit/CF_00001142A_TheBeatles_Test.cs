...
{
    [TestClass]
    public sealed class CF_00001142A_TheBeatles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001142A_TheBeatles));
        ...
        {
            bool result = CF_00001142A_TheBeatles.Solution_0_Test(input);
