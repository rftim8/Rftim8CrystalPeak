...
{
    [TestClass]
    public sealed class CF_00000255A_GregsWorkout_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000255A_GregsWorkout));
        ...
        {
            bool result = CF_00000255A_GregsWorkout.Solution_0_Test(input);
