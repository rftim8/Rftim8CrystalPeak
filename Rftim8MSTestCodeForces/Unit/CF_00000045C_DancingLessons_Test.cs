...
{
    [TestClass]
    public sealed class CF_00000045C_DancingLessons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000045C_DancingLessons));
        ...
        {
            bool result = CF_00000045C_DancingLessons.Solution_0_Test(input);
