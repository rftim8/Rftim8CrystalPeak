...
{
    [TestClass]
    public sealed class CF_00002013C_PasswordCracking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002013C_PasswordCracking));
        ...
        {
            bool result = CF_00002013C_PasswordCracking.Solution_0_Test(input);
