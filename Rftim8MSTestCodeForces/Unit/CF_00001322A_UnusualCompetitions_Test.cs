...
{
    [TestClass]
    public sealed class CF_00001322A_UnusualCompetitions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001322A_UnusualCompetitions));
        ...
        {
            bool result = CF_00001322A_UnusualCompetitions.Solution_0_Test(input);
