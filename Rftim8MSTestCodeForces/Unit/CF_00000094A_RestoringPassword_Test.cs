...
{
    [TestClass]
    public sealed class CF_00000094A_RestoringPassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000094A_RestoringPassword));
        ...
        {
            bool result = CF_00000094A_RestoringPassword.Solution_0_Test(input);
