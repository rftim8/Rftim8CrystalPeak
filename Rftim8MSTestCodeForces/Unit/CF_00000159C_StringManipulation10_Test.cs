...
{
    [TestClass]
    public sealed class CF_00000159C_StringManipulation10_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000159C_StringManipulation10));
        ...
        {
            bool result = CF_00000159C_StringManipulation10.Solution_0_Test(input);
