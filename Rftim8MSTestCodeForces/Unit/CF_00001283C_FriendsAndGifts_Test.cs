...
{
    [TestClass]
    public sealed class CF_00001283C_FriendsAndGifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001283C_FriendsAndGifts));
        ...
        {
            bool result = CF_00001283C_FriendsAndGifts.Solution_0_Test(input);
