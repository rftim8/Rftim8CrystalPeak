...
{
    [TestClass]
    public sealed class CF_00001970E1_TrailsEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970E1_TrailsEasy));
        ...
        {
            bool result = CF_00001970E1_TrailsEasy.Solution_0_Test(input);
