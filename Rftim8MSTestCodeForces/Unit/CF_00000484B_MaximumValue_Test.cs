...
{
    [TestClass]
    public sealed class CF_00000484B_MaximumValue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000484B_MaximumValue));
        ...
        {
            bool result = CF_00000484B_MaximumValue.Solution_0_Test(input);
