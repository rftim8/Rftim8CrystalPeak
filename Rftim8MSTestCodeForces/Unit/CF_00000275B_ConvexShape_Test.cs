...
{
    [TestClass]
    public sealed class CF_00000275B_ConvexShape_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000275B_ConvexShape));
        ...
        {
            bool result = CF_00000275B_ConvexShape.Solution_0_Test(input);
