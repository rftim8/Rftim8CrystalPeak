...
{
    [TestClass]
    public sealed class CF_00001190C_TokitsukazeAndDuel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001190C_TokitsukazeAndDuel));
        ...
        {
            bool result = CF_00001190C_TokitsukazeAndDuel.Solution_0_Test(input);
