...
{
    [TestClass]
    public sealed class CF_00001329E_DreamoonLovesAA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001329E_DreamoonLovesAA));
        ...
        {
            bool result = CF_00001329E_DreamoonLovesAA.Solution_0_Test(input);
