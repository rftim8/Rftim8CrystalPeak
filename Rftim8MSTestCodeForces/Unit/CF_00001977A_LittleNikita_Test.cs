...
{
    [TestClass]
    public sealed class CF_00001977A_LittleNikita_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001977A_LittleNikita));
        ...
        {
            bool result = CF_00001977A_LittleNikita.Solution_0_Test(input);
