...
{
    [TestClass]
    public sealed class CF_00000935D_FafaAndAncientAlphabet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000935D_FafaAndAncientAlphabet));
        ...
        {
            bool result = CF_00000935D_FafaAndAncientAlphabet.Solution_0_Test(input);
