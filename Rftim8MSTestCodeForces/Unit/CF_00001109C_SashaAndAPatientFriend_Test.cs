...
{
    [TestClass]
    public sealed class CF_00001109C_SashaAndAPatientFriend_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001109C_SashaAndAPatientFriend));
        ...
        {
            bool result = CF_00001109C_SashaAndAPatientFriend.Solution_0_Test(input);
