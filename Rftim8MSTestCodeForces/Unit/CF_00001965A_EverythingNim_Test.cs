...
{
    [TestClass]
    public sealed class CF_00001965A_EverythingNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001965A_EverythingNim));
        ...
        {
            bool result = CF_00001965A_EverythingNim.Solution_0_Test(input);
