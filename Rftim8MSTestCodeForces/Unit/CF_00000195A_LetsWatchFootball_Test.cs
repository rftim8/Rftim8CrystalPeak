...
{
    [TestClass]
    public sealed class CF_00000195A_LetsWatchFootball_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000195A_LetsWatchFootball));
        ...
        {
            bool result = CF_00000195A_LetsWatchFootball.Solution_0_Test(input);
