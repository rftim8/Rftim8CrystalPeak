...
{
    [TestClass]
    public sealed class CF_00000342C_CupboardAndBalloons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000342C_CupboardAndBalloons));
        ...
        {
            bool result = CF_00000342C_CupboardAndBalloons.Solution_0_Test(input);
