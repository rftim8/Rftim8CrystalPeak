...
{
    [TestClass]
    public sealed class CF_00000747D_WinterIsComing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000747D_WinterIsComing));
        ...
        {
            bool result = CF_00000747D_WinterIsComing.Solution_0_Test(input);
