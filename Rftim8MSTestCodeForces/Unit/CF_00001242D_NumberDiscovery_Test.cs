...
{
    [TestClass]
    public sealed class CF_00001242D_NumberDiscovery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001242D_NumberDiscovery));
        ...
        {
            bool result = CF_00001242D_NumberDiscovery.Solution_0_Test(input);
