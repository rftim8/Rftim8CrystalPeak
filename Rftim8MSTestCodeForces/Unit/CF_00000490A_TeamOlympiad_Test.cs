...
{
    [TestClass]
    public sealed class CF_00000490A_TeamOlympiad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000490A_TeamOlympiad));
        ...
        {
            bool result = CF_00000490A_TeamOlympiad.Solution_0_Test(input);
