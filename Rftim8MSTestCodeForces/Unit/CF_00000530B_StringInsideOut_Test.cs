...
{
    [TestClass]
    public sealed class CF_00000530B_StringInsideOut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000530B_StringInsideOut));
        ...
        {
            bool result = CF_00000530B_StringInsideOut.Solution_0_Test(input);
