...
{
    [TestClass]
    public sealed class CF_00000559D_Randomizer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000559D_Randomizer));
        ...
        {
            bool result = CF_00000559D_Randomizer.Solution_0_Test(input);
