...
{
    [TestClass]
    public sealed class CF_00001082C_MultiSubjectCompetition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001082C_MultiSubjectCompetition));
        ...
        {
            bool result = CF_00001082C_MultiSubjectCompetition.Solution_0_Test(input);
