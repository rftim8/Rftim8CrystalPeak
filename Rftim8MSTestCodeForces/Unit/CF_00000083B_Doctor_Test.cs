...
{
    [TestClass]
    public sealed class CF_00000083B_Doctor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000083B_Doctor));
        ...
        {
            bool result = CF_00000083B_Doctor.Solution_0_Test(input);
