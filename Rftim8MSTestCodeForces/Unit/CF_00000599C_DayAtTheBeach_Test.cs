...
{
    [TestClass]
    public sealed class CF_00000599C_DayAtTheBeach_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000599C_DayAtTheBeach));
        ...
        {
            bool result = CF_00000599C_DayAtTheBeach.Solution_0_Test(input);
