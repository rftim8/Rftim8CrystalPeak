...
{
    [TestClass]
    public sealed class CF_00000643A_BearAndColors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000643A_BearAndColors));
        ...
        {
            bool result = CF_00000643A_BearAndColors.Solution_0_Test(input);
