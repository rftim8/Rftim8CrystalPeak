...
{
    [TestClass]
    public sealed class CF_00001388D_CaptainFlintAndTreasure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001388D_CaptainFlintAndTreasure));
        ...
        {
            bool result = CF_00001388D_CaptainFlintAndTreasure.Solution_0_Test(input);
