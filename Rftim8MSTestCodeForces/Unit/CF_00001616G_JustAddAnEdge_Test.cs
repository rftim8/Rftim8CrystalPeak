...
{
    [TestClass]
    public sealed class CF_00001616G_JustAddAnEdge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001616G_JustAddAnEdge));
        ...
        {
            bool result = CF_00001616G_JustAddAnEdge.Solution_0_Test(input);
