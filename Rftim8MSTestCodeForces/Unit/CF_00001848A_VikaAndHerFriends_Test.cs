...
{
    [TestClass]
    public sealed class CF_00001848A_VikaAndHerFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001848A_VikaAndHerFriends));
        ...
        {
            bool result = CF_00001848A_VikaAndHerFriends.Solution_0_Test(input);
