...
{
    [TestClass]
    public sealed class CF_00000175F_GnomesOfMightAndMagic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000175F_GnomesOfMightAndMagic));
        ...
        {
            bool result = CF_00000175F_GnomesOfMightAndMagic.Solution_0_Test(input);
