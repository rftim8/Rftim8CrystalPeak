...
{
    [TestClass]
    public sealed class CF_00001763A_AbsoluteMaximization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001763A_AbsoluteMaximization));
        ...
        {
            bool result = CF_00001763A_AbsoluteMaximization.Solution_0_Test(input);
