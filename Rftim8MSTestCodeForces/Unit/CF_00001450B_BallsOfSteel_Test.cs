...
{
    [TestClass]
    public sealed class CF_00001450B_BallsOfSteel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001450B_BallsOfSteel));
        ...
        {
            bool result = CF_00001450B_BallsOfSteel.Solution_0_Test(input);
