...
{
    [TestClass]
    public sealed class CF_00001666G_GlobalWarming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001666G_GlobalWarming));
        ...
        {
            bool result = CF_00001666G_GlobalWarming.Solution_0_Test(input);
