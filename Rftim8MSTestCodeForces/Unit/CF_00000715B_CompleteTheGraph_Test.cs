...
{
    [TestClass]
    public sealed class CF_00000715B_CompleteTheGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000715B_CompleteTheGraph));
        ...
        {
            bool result = CF_00000715B_CompleteTheGraph.Solution_0_Test(input);
