...
{
    [TestClass]
    public sealed class CF_00001477E_NezzarAndTournaments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001477E_NezzarAndTournaments));
        ...
        {
            bool result = CF_00001477E_NezzarAndTournaments.Solution_0_Test(input);
