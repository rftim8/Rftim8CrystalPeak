...
{
    [TestClass]
    public sealed class CF_00001399C_BoatsCompetition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001399C_BoatsCompetition));
        ...
        {
            bool result = CF_00001399C_BoatsCompetition.Solution_0_Test(input);
