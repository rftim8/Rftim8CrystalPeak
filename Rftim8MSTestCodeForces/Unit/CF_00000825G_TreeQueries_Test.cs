...
{
    [TestClass]
    public sealed class CF_00000825G_TreeQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000825G_TreeQueries));
        ...
        {
            bool result = CF_00000825G_TreeQueries.Solution_0_Test(input);
