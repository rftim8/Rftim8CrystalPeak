...
{
    [TestClass]
    public sealed class CF_00000093A_Frames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000093A_Frames));
        ...
        {
            bool result = CF_00000093A_Frames.Solution_0_Test(input);
