...
{
    [TestClass]
    public sealed class CF_00001608E_TheCellsOnThePaper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001608E_TheCellsOnThePaper));
        ...
        {
            bool result = CF_00001608E_TheCellsOnThePaper.Solution_0_Test(input);
