...
{
    [TestClass]
    public sealed class CF_00001845D_RatingSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001845D_RatingSystem));
        ...
        {
            bool result = CF_00001845D_RatingSystem.Solution_0_Test(input);
