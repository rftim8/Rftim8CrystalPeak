...
{
    [TestClass]
    public sealed class CF_00001251A_BrokenKeyboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001251A_BrokenKeyboard));
        ...
        {
            bool result = CF_00001251A_BrokenKeyboard.Solution_0_Test(input);
