...
{
    [TestClass]
    public sealed class CF_00000567E_PresidentAndRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000567E_PresidentAndRoads));
        ...
        {
            bool result = CF_00000567E_PresidentAndRoads.Solution_0_Test(input);
