...
{
    [TestClass]
    public sealed class CF_00000555E_CaseOfComputerNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000555E_CaseOfComputerNetwork));
        ...
        {
            bool result = CF_00000555E_CaseOfComputerNetwork.Solution_0_Test(input);
