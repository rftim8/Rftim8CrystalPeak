...
{
    [TestClass]
    public sealed class CF_00000629C_FamilDoorAndBrackets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000629C_FamilDoorAndBrackets));
        ...
        {
            bool result = CF_00000629C_FamilDoorAndBrackets.Solution_0_Test(input);
