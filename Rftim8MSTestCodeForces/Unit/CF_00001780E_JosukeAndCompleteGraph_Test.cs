...
{
    [TestClass]
    public sealed class CF_00001780E_JosukeAndCompleteGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001780E_JosukeAndCompleteGraph));
        ...
        {
            bool result = CF_00001780E_JosukeAndCompleteGraph.Solution_0_Test(input);
