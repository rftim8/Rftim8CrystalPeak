...
{
    [TestClass]
    public sealed class CF_00001910E_MaximumSumSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001910E_MaximumSumSubarrays));
        ...
        {
            bool result = CF_00001910E_MaximumSumSubarrays.Solution_0_Test(input);
