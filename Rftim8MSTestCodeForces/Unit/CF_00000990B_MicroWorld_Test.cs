...
{
    [TestClass]
    public sealed class CF_00000990B_MicroWorld_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000990B_MicroWorld));
        ...
        {
            bool result = CF_00000990B_MicroWorld.Solution_0_Test(input);
