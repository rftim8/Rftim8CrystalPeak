...
{
    [TestClass]
    public sealed class CF_00000633G_YashAndTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000633G_YashAndTrees));
        ...
        {
            bool result = CF_00000633G_YashAndTrees.Solution_0_Test(input);
