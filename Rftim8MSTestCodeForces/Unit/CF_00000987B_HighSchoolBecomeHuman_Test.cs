...
{
    [TestClass]
    public sealed class CF_00000987B_HighSchoolBecomeHuman_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000987B_HighSchoolBecomeHuman));
        ...
        {
            bool result = CF_00000987B_HighSchoolBecomeHuman.Solution_0_Test(input);
