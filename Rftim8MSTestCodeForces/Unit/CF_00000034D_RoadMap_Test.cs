...
{
    [TestClass]
    public sealed class CF_00000034D_RoadMap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000034D_RoadMap));
        ...
        {
            bool result = CF_00000034D_RoadMap.Solution_0_Test(input);
