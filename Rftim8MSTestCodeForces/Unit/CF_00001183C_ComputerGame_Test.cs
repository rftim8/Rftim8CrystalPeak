...
{
    [TestClass]
    public sealed class CF_00001183C_ComputerGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001183C_ComputerGame));
        ...
        {
            bool result = CF_00001183C_ComputerGame.Solution_0_Test(input);
