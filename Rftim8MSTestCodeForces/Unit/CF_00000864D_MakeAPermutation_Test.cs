...
{
    [TestClass]
    public sealed class CF_00000864D_MakeAPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000864D_MakeAPermutation));
        ...
        {
            bool result = CF_00000864D_MakeAPermutation.Solution_0_Test(input);
