...
{
    [TestClass]
    public sealed class CF_00002033C_SakurakosFieldTrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002033C_SakurakosFieldTrip));
        ...
        {
            bool result = CF_00002033C_SakurakosFieldTrip.Solution_0_Test(input);
