...
{
    [TestClass]
    public sealed class CF_00000168B_WizardsAndMinimalSpell_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000168B_WizardsAndMinimalSpell));
        ...
        {
            bool result = CF_00000168B_WizardsAndMinimalSpell.Solution_0_Test(input);
