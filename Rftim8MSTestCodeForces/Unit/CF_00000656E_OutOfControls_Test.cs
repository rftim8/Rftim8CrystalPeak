...
{
    [TestClass]
    public sealed class CF_00000656E_OutOfControls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000656E_OutOfControls));
        ...
        {
            bool result = CF_00000656E_OutOfControls.Solution_0_Test(input);
