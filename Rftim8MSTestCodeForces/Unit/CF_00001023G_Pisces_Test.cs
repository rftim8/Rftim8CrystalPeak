...
{
    [TestClass]
    public sealed class CF_00001023G_Pisces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001023G_Pisces));
        ...
        {
            bool result = CF_00001023G_Pisces.Solution_0_Test(input);
