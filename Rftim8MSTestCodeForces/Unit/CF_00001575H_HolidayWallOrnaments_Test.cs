...
{
    [TestClass]
    public sealed class CF_00001575H_HolidayWallOrnaments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575H_HolidayWallOrnaments));
        ...
        {
            bool result = CF_00001575H_HolidayWallOrnaments.Solution_0_Test(input);
