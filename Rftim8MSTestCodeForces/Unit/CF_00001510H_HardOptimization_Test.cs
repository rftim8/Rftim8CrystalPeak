...
{
    [TestClass]
    public sealed class CF_00001510H_HardOptimization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001510H_HardOptimization));
        ...
        {
            bool result = CF_00001510H_HardOptimization.Solution_0_Test(input);
