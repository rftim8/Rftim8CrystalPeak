...
{
    [TestClass]
    public sealed class CF_00001910H_SumOfDigitsOfSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001910H_SumOfDigitsOfSums));
        ...
        {
            bool result = CF_00001910H_SumOfDigitsOfSums.Solution_0_Test(input);
