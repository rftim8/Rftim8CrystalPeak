...
{
    [TestClass]
    public sealed class CF_00000118C_FancyNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000118C_FancyNumber));
        ...
        {
            bool result = CF_00000118C_FancyNumber.Solution_0_Test(input);
