...
{
    [TestClass]
    public sealed class CF_00001334B_MiddleClass_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001334B_MiddleClass));
        ...
        {
            bool result = CF_00001334B_MiddleClass.Solution_0_Test(input);
