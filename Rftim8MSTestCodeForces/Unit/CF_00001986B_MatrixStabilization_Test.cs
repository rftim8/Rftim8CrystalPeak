...
{
    [TestClass]
    public sealed class CF_00001986B_MatrixStabilization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001986B_MatrixStabilization));
        ...
        {
            bool result = CF_00001986B_MatrixStabilization.Solution_0_Test(input);
