...
{
    [TestClass]
    public sealed class CF_00000220C_LittleElephantAndShifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000220C_LittleElephantAndShifts));
        ...
        {
            bool result = CF_00000220C_LittleElephantAndShifts.Solution_0_Test(input);
