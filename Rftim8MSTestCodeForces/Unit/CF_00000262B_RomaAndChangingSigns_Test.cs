...
{
    [TestClass]
    public sealed class CF_00000262B_RomaAndChangingSigns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000262B_RomaAndChangingSigns));
        ...
        {
            bool result = CF_00000262B_RomaAndChangingSigns.Solution_0_Test(input);
