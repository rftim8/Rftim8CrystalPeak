...
{
    [TestClass]
    public sealed class CF_00000415A_MashmokhAndLights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000415A_MashmokhAndLights));
        ...
        {
            bool result = CF_00000415A_MashmokhAndLights.Solution_0_Test(input);
