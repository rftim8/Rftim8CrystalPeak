...
{
    [TestClass]
    public sealed class CF_00000534A_Exam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000534A_Exam));
        ...
        {
            bool result = CF_00000534A_Exam.Solution_0_Test(input);
