...
{
    [TestClass]
    public sealed class CF_00000630G_ChallengePennants_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630G_ChallengePennants));
        ...
        {
            bool result = CF_00000630G_ChallengePennants.Solution_0_Test(input);
