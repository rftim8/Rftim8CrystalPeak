...
{
    [TestClass]
    public sealed class CF_00000126B_Password_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000126B_Password));
        ...
        {
            bool result = CF_00000126B_Password.Solution_0_Test(input);
