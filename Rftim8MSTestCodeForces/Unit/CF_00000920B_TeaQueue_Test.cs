...
{
    [TestClass]
    public sealed class CF_00000920B_TeaQueue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000920B_TeaQueue));
        ...
        {
            bool result = CF_00000920B_TeaQueue.Solution_0_Test(input);
