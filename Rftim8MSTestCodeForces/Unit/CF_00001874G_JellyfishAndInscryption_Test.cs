...
{
    [TestClass]
    public sealed class CF_00001874G_JellyfishAndInscryption_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001874G_JellyfishAndInscryption));
        ...
        {
            bool result = CF_00001874G_JellyfishAndInscryption.Solution_0_Test(input);
