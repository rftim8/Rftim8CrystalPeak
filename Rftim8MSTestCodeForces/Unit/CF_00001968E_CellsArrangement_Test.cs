...
{
    [TestClass]
    public sealed class CF_00001968E_CellsArrangement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001968E_CellsArrangement));
        ...
        {
            bool result = CF_00001968E_CellsArrangement.Solution_0_Test(input);
