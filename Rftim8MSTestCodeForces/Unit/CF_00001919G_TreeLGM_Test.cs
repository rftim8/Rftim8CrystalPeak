...
{
    [TestClass]
    public sealed class CF_00001919G_TreeLGM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001919G_TreeLGM));
        ...
        {
            bool result = CF_00001919G_TreeLGM.Solution_0_Test(input);
