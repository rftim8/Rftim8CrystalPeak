...
{
    [TestClass]
    public sealed class CF_00001348F_PhoenixAndMemory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001348F_PhoenixAndMemory));
        ...
        {
            bool result = CF_00001348F_PhoenixAndMemory.Solution_0_Test(input);
