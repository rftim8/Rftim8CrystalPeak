...
{
    [TestClass]
    public sealed class CF_00000887A_Div64_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000887A_Div64));
        ...
        {
            bool result = CF_00000887A_Div64.Solution_0_Test(input);
