...
{
    [TestClass]
    public sealed class CF_00001149A_PrefixSumPrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001149A_PrefixSumPrimes));
        ...
        {
            bool result = CF_00001149A_PrefixSumPrimes.Solution_0_Test(input);
