...
{
    [TestClass]
    public sealed class CF_00001062E_Company_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001062E_Company));
        ...
        {
            bool result = CF_00001062E_Company.Solution_0_Test(input);
