...
{
    [TestClass]
    public sealed class CF_00000758A_HolidayOfEquality_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000758A_HolidayOfEquality));
        ...
        {
            bool result = CF_00000758A_HolidayOfEquality.Solution_0_Test(input);
