...
{
    [TestClass]
    public sealed class CF_00000322A_CielAndDancing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000322A_CielAndDancing));
        ...
        {
            bool result = CF_00000322A_CielAndDancing.Solution_0_Test(input);
