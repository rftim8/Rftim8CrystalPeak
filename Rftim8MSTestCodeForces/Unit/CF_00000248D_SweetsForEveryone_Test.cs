...
{
    [TestClass]
    public sealed class CF_00000248D_SweetsForEveryone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000248D_SweetsForEveryone));
        ...
        {
            bool result = CF_00000248D_SweetsForEveryone.Solution_0_Test(input);
