...
{
    [TestClass]
    public sealed class CF_00000241E_Flights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000241E_Flights));
        ...
        {
            bool result = CF_00000241E_Flights.Solution_0_Test(input);
