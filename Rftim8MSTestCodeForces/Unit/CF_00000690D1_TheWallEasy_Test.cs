...
{
    [TestClass]
    public sealed class CF_00000690D1_TheWallEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690D1_TheWallEasy));
        ...
        {
            bool result = CF_00000690D1_TheWallEasy.Solution_0_Test(input);
