...
{
    [TestClass]
    public sealed class CF_00000022B_BargainingTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000022B_BargainingTable));
        ...
        {
            bool result = CF_00000022B_BargainingTable.Solution_0_Test(input);
