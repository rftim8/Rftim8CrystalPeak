...
{
    [TestClass]
    public sealed class CF_00001609D_SocialNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001609D_SocialNetwork));
        ...
        {
            bool result = CF_00001609D_SocialNetwork.Solution_0_Test(input);
