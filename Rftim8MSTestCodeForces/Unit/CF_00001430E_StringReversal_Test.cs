...
{
    [TestClass]
    public sealed class CF_00001430E_StringReversal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001430E_StringReversal));
        ...
        {
            bool result = CF_00001430E_StringReversal.Solution_0_Test(input);
