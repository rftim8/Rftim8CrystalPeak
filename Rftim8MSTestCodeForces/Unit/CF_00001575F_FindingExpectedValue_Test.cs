...
{
    [TestClass]
    public sealed class CF_00001575F_FindingExpectedValue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575F_FindingExpectedValue));
        ...
        {
            bool result = CF_00001575F_FindingExpectedValue.Solution_0_Test(input);
