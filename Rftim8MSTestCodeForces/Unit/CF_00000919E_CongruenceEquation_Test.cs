...
{
    [TestClass]
    public sealed class CF_00000919E_CongruenceEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000919E_CongruenceEquation));
        ...
        {
            bool result = CF_00000919E_CongruenceEquation.Solution_0_Test(input);
