...
{
    [TestClass]
    public sealed class CF_00001107A_DigitsSequenceDividing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001107A_DigitsSequenceDividing));
        ...
        {
            bool result = CF_00001107A_DigitsSequenceDividing.Solution_0_Test(input);
