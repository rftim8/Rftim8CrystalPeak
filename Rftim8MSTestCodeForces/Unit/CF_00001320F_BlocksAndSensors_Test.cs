...
{
    [TestClass]
    public sealed class CF_00001320F_BlocksAndSensors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001320F_BlocksAndSensors));
        ...
        {
            bool result = CF_00001320F_BlocksAndSensors.Solution_0_Test(input);
