...
{
    [TestClass]
    public sealed class CF_00001152E_NekoAndFlashback_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001152E_NekoAndFlashback));
        ...
        {
            bool result = CF_00001152E_NekoAndFlashback.Solution_0_Test(input);
