...
{
    [TestClass]
    public sealed class CF_00002023E_TreeOfLife_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002023E_TreeOfLife));
        ...
        {
            bool result = CF_00002023E_TreeOfLife.Solution_0_Test(input);
