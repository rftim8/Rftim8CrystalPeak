...
{
    [TestClass]
    public sealed class CF_00000435D_SpecialGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000435D_SpecialGrid));
        ...
        {
            bool result = CF_00000435D_SpecialGrid.Solution_0_Test(input);
