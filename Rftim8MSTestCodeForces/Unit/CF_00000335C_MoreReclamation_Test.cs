...
{
    [TestClass]
    public sealed class CF_00000335C_MoreReclamation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000335C_MoreReclamation));
        ...
        {
            bool result = CF_00000335C_MoreReclamation.Solution_0_Test(input);
