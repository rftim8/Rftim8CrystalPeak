...
{
    [TestClass]
    public sealed class CF_00001393B_ApplejackAndStorages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001393B_ApplejackAndStorages));
        ...
        {
            bool result = CF_00001393B_ApplejackAndStorages.Solution_0_Test(input);
