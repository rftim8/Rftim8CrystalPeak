...
{
    [TestClass]
    public sealed class CF_00000988F_RainAndUmbrellas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000988F_RainAndUmbrellas));
        ...
        {
            bool result = CF_00000988F_RainAndUmbrellas.Solution_0_Test(input);
