...
{
    [TestClass]
    public sealed class CF_00000366C_DimaAndSalad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000366C_DimaAndSalad));
        ...
        {
            bool result = CF_00000366C_DimaAndSalad.Solution_0_Test(input);
