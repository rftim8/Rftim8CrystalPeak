...
{
    [TestClass]
    public sealed class CF_00001630A_AndMatching_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001630A_AndMatching));
        ...
        {
            bool result = CF_00001630A_AndMatching.Solution_0_Test(input);
