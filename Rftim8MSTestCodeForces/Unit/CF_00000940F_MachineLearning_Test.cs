...
{
    [TestClass]
    public sealed class CF_00000940F_MachineLearning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000940F_MachineLearning));
        ...
        {
            bool result = CF_00000940F_MachineLearning.Solution_0_Test(input);
