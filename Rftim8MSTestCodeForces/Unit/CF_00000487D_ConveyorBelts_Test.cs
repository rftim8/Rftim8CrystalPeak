...
{
    [TestClass]
    public sealed class CF_00000487D_ConveyorBelts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000487D_ConveyorBelts));
        ...
        {
            bool result = CF_00000487D_ConveyorBelts.Solution_0_Test(input);
