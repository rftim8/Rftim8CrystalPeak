...
{
    [TestClass]
    public sealed class CF_00001951D_BuyingJewels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001951D_BuyingJewels));
        ...
        {
            bool result = CF_00001951D_BuyingJewels.Solution_0_Test(input);
