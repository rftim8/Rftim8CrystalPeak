...
{
    [TestClass]
    public sealed class CF_00000205A_LittleElephantAndRozdil_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000205A_LittleElephantAndRozdil));
        ...
        {
            bool result = CF_00000205A_LittleElephantAndRozdil.Solution_0_Test(input);
