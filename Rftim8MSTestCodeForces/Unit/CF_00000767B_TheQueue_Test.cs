...
{
    [TestClass]
    public sealed class CF_00000767B_TheQueue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000767B_TheQueue));
        ...
        {
            bool result = CF_00000767B_TheQueue.Solution_0_Test(input);
