...
{
    [TestClass]
    public sealed class CF_00000495B_ModularEquations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000495B_ModularEquations));
        ...
        {
            bool result = CF_00000495B_ModularEquations.Solution_0_Test(input);
