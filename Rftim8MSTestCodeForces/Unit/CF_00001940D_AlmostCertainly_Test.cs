...
{
    [TestClass]
    public sealed class CF_00001940D_AlmostCertainly_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001940D_AlmostCertainly));
        ...
        {
            bool result = CF_00001940D_AlmostCertainly.Solution_0_Test(input);
