...
{
    [TestClass]
    public sealed class CF_00001209C_PaintTheDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001209C_PaintTheDigits));
        ...
        {
            bool result = CF_00001209C_PaintTheDigits.Solution_0_Test(input);
