...
{
    [TestClass]
    public sealed class CF_00000455B_ALotOfGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000455B_ALotOfGames));
        ...
        {
            bool result = CF_00000455B_ALotOfGames.Solution_0_Test(input);
