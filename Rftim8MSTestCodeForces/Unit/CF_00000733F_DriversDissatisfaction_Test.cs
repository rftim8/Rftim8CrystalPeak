...
{
    [TestClass]
    public sealed class CF_00000733F_DriversDissatisfaction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000733F_DriversDissatisfaction));
        ...
        {
            bool result = CF_00000733F_DriversDissatisfaction.Solution_0_Test(input);
