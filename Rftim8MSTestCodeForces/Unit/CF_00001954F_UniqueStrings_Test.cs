...
{
    [TestClass]
    public sealed class CF_00001954F_UniqueStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001954F_UniqueStrings));
        ...
        {
            bool result = CF_00001954F_UniqueStrings.Solution_0_Test(input);
