...
{
    [TestClass]
    public sealed class CF_00000372D_ChoosingSubtreeIsFun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000372D_ChoosingSubtreeIsFun));
        ...
        {
            bool result = CF_00000372D_ChoosingSubtreeIsFun.Solution_0_Test(input);
