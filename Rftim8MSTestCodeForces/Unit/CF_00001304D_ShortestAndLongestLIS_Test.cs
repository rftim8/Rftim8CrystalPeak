...
{
    [TestClass]
    public sealed class CF_00001304D_ShortestAndLongestLIS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001304D_ShortestAndLongestLIS));
        ...
        {
            bool result = CF_00001304D_ShortestAndLongestLIS.Solution_0_Test(input);
