...
{
    [TestClass]
    public sealed class CF_00001996D_Fun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001996D_Fun));
        ...
        {
            bool result = CF_00001996D_Fun.Solution_0_Test(input);
