...
{
    [TestClass]
    public sealed class CF_00000683F_ReformatTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000683F_ReformatTheString));
        ...
        {
            bool result = CF_00000683F_ReformatTheString.Solution_0_Test(input);
