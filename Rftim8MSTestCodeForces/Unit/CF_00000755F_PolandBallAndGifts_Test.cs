...
{
    [TestClass]
    public sealed class CF_00000755F_PolandBallAndGifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000755F_PolandBallAndGifts));
        ...
        {
            bool result = CF_00000755F_PolandBallAndGifts.Solution_0_Test(input);
