...
{
    [TestClass]
    public sealed class CF_00000057A_SquareEarth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000057A_SquareEarth));
        ...
        {
            bool result = CF_00000057A_SquareEarth.Solution_0_Test(input);
