...
{
    [TestClass]
    public sealed class CF_00000650B_ImagePreview_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000650B_ImagePreview));
        ...
        {
            bool result = CF_00000650B_ImagePreview.Solution_0_Test(input);
