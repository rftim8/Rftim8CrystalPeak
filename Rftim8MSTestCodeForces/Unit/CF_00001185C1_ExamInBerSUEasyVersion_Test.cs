...
{
    [TestClass]
    public sealed class CF_00001185C1_ExamInBerSUEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001185C1_ExamInBerSUEasyVersion));
        ...
        {
            bool result = CF_00001185C1_ExamInBerSUEasyVersion.Solution_0_Test(input);
