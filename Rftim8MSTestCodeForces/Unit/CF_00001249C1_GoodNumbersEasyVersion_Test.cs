...
{
    [TestClass]
    public sealed class CF_00001249C1_GoodNumbersEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001249C1_GoodNumbersEasyVersion));
        ...
        {
            bool result = CF_00001249C1_GoodNumbersEasyVersion.Solution_0_Test(input);
