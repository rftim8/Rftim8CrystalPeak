...
{
    [TestClass]
    public sealed class CF_00001184E1_DaleksInvasionEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001184E1_DaleksInvasionEasy));
        ...
        {
            bool result = CF_00001184E1_DaleksInvasionEasy.Solution_0_Test(input);
