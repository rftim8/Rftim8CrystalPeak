...
{
    [TestClass]
    public sealed class CF_00001662K_PandemicRestrictions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662K_PandemicRestrictions));
        ...
        {
            bool result = CF_00001662K_PandemicRestrictions.Solution_0_Test(input);
