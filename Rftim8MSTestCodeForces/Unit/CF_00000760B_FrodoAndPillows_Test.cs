...
{
    [TestClass]
    public sealed class CF_00000760B_FrodoAndPillows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000760B_FrodoAndPillows));
        ...
        {
            bool result = CF_00000760B_FrodoAndPillows.Solution_0_Test(input);
