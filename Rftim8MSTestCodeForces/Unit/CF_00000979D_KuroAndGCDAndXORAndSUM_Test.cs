...
{
    [TestClass]
    public sealed class CF_00000979D_KuroAndGCDAndXORAndSUM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000979D_KuroAndGCDAndXORAndSUM));
        ...
        {
            bool result = CF_00000979D_KuroAndGCDAndXORAndSUM.Solution_0_Test(input);
