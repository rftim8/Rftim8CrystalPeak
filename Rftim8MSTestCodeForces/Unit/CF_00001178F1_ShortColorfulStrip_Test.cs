...
{
    [TestClass]
    public sealed class CF_00001178F1_ShortColorfulStrip_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001178F1_ShortColorfulStrip));
        ...
        {
            bool result = CF_00001178F1_ShortColorfulStrip.Solution_0_Test(input);
