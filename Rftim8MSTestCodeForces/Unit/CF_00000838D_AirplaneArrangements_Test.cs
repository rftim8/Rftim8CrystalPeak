...
{
    [TestClass]
    public sealed class CF_00000838D_AirplaneArrangements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000838D_AirplaneArrangements));
        ...
        {
            bool result = CF_00000838D_AirplaneArrangements.Solution_0_Test(input);
