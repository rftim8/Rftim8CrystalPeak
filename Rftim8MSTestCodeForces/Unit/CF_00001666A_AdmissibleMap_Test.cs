...
{
    [TestClass]
    public sealed class CF_00001666A_AdmissibleMap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001666A_AdmissibleMap));
        ...
        {
            bool result = CF_00001666A_AdmissibleMap.Solution_0_Test(input);
