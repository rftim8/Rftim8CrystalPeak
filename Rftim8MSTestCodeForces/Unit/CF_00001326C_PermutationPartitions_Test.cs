...
{
    [TestClass]
    public sealed class CF_00001326C_PermutationPartitions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001326C_PermutationPartitions));
        ...
        {
            bool result = CF_00001326C_PermutationPartitions.Solution_0_Test(input);
