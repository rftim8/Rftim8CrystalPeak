...
{
    [TestClass]
    public sealed class CF_00000190B_Surrounded_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000190B_Surrounded));
        ...
        {
            bool result = CF_00000190B_Surrounded.Solution_0_Test(input);
