...
{
    [TestClass]
    public sealed class CF_00001045E_AncientCivilizations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001045E_AncientCivilizations));
        ...
        {
            bool result = CF_00001045E_AncientCivilizations.Solution_0_Test(input);
