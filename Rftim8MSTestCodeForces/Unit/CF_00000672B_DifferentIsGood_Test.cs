...
{
    [TestClass]
    public sealed class CF_00000672B_DifferentIsGood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000672B_DifferentIsGood));
        ...
        {
            bool result = CF_00000672B_DifferentIsGood.Solution_0_Test(input);
