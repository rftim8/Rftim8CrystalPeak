...
{
    [TestClass]
    public sealed class CF_00000626F_GroupProjects_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000626F_GroupProjects));
        ...
        {
            bool result = CF_00000626F_GroupProjects.Solution_0_Test(input);
