...
{
    [TestClass]
    public sealed class CF_00001677F_TokitsukazeAndGems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001677F_TokitsukazeAndGems));
        ...
        {
            bool result = CF_00001677F_TokitsukazeAndGems.Solution_0_Test(input);
