...
{
    [TestClass]
    public sealed class CF_00000939C_ConvenientForEverybody_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000939C_ConvenientForEverybody));
        ...
        {
            bool result = CF_00000939C_ConvenientForEverybody.Solution_0_Test(input);
