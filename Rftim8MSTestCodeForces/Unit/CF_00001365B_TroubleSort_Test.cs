...
{
    [TestClass]
    public sealed class CF_00001365B_TroubleSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001365B_TroubleSort));
        ...
        {
            bool result = CF_00001365B_TroubleSort.Solution_0_Test(input);
