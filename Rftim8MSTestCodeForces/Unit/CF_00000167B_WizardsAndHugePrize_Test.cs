...
{
    [TestClass]
    public sealed class CF_00000167B_WizardsAndHugePrize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000167B_WizardsAndHugePrize));
        ...
        {
            bool result = CF_00000167B_WizardsAndHugePrize.Solution_0_Test(input);
