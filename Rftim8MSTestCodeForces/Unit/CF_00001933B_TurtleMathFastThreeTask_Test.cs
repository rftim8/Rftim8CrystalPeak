...
{
    [TestClass]
    public sealed class CF_00001933B_TurtleMathFastThreeTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001933B_TurtleMathFastThreeTask));
        ...
        {
            bool result = CF_00001933B_TurtleMathFastThreeTask.Solution_0_Test(input);
