...
{
    [TestClass]
    public sealed class CF_00000159A_FriendsOrNot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000159A_FriendsOrNot));
        ...
        {
            bool result = CF_00000159A_FriendsOrNot.Solution_0_Test(input);
