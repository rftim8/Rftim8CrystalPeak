...
{
    [TestClass]
    public sealed class CF_00000393A_Nineteen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000393A_Nineteen));
        ...
        {
            bool result = CF_00000393A_Nineteen.Solution_0_Test(input);
