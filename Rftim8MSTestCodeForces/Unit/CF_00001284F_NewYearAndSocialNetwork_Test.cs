...
{
    [TestClass]
    public sealed class CF_00001284F_NewYearAndSocialNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001284F_NewYearAndSocialNetwork));
        ...
        {
            bool result = CF_00001284F_NewYearAndSocialNetwork.Solution_0_Test(input);
