...
{
    [TestClass]
    public sealed class CF_00001423I_LookupTables_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001423I_LookupTables));
        ...
        {
            bool result = CF_00001423I_LookupTables.Solution_0_Test(input);
