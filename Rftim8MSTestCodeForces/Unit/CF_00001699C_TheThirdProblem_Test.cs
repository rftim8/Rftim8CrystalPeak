...
{
    [TestClass]
    public sealed class CF_00001699C_TheThirdProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001699C_TheThirdProblem));
        ...
        {
            bool result = CF_00001699C_TheThirdProblem.Solution_0_Test(input);
