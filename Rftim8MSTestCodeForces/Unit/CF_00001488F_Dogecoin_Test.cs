...
{
    [TestClass]
    public sealed class CF_00001488F_Dogecoin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001488F_Dogecoin));
        ...
        {
            bool result = CF_00001488F_Dogecoin.Solution_0_Test(input);
