...
{
    [TestClass]
    public sealed class CF_00001510B_ButtonLock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001510B_ButtonLock));
        ...
        {
            bool result = CF_00001510B_ButtonLock.Solution_0_Test(input);
