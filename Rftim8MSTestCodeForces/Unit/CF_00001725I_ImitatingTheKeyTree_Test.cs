...
{
    [TestClass]
    public sealed class CF_00001725I_ImitatingTheKeyTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725I_ImitatingTheKeyTree));
        ...
        {
            bool result = CF_00001725I_ImitatingTheKeyTree.Solution_0_Test(input);
