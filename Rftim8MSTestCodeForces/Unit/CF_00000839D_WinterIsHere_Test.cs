...
{
    [TestClass]
    public sealed class CF_00000839D_WinterIsHere_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000839D_WinterIsHere));
        ...
        {
            bool result = CF_00000839D_WinterIsHere.Solution_0_Test(input);
