...
{
    [TestClass]
    public sealed class CF_00000474D_Flowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000474D_Flowers));
        ...
        {
            bool result = CF_00000474D_Flowers.Solution_0_Test(input);
