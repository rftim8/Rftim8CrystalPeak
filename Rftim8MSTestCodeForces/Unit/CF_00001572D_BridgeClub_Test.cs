...
{
    [TestClass]
    public sealed class CF_00001572D_BridgeClub_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001572D_BridgeClub));
        ...
        {
            bool result = CF_00001572D_BridgeClub.Solution_0_Test(input);
