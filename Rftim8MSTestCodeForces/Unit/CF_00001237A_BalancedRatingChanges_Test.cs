...
{
    [TestClass]
    public sealed class CF_00001237A_BalancedRatingChanges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001237A_BalancedRatingChanges));
        ...
        {
            bool result = CF_00001237A_BalancedRatingChanges.Solution_0_Test(input);
