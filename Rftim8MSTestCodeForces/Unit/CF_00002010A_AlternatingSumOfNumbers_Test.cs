...
{
    [TestClass]
    public sealed class CF_00002010A_AlternatingSumOfNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002010A_AlternatingSumOfNumbers));
        ...
        {
            bool result = CF_00002010A_AlternatingSumOfNumbers.Solution_0_Test(input);
