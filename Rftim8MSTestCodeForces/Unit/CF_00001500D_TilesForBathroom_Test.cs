...
{
    [TestClass]
    public sealed class CF_00001500D_TilesForBathroom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001500D_TilesForBathroom));
        ...
        {
            bool result = CF_00001500D_TilesForBathroom.Solution_0_Test(input);
