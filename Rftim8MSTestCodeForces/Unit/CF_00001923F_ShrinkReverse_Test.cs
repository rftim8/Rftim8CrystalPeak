...
{
    [TestClass]
    public sealed class CF_00001923F_ShrinkReverse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001923F_ShrinkReverse));
        ...
        {
            bool result = CF_00001923F_ShrinkReverse.Solution_0_Test(input);
