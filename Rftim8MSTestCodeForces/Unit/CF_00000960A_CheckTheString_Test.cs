...
{
    [TestClass]
    public sealed class CF_00000960A_CheckTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000960A_CheckTheString));
        ...
        {
            bool result = CF_00000960A_CheckTheString.Solution_0_Test(input);
