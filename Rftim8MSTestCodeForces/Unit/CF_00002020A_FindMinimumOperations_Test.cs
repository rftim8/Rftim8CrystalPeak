...
{
    [TestClass]
    public sealed class CF_00002020A_FindMinimumOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002020A_FindMinimumOperations));
        ...
        {
            bool result = CF_00002020A_FindMinimumOperations.Solution_0_Test(input);
