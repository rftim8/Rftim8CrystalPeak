...
{
    [TestClass]
    public sealed class CF_00001514B_AND0SumBig_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001514B_AND0SumBig));
        ...
        {
            bool result = CF_00001514B_AND0SumBig.Solution_0_Test(input);
