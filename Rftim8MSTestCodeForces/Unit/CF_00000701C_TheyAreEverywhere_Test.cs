...
{
    [TestClass]
    public sealed class CF_00000701C_TheyAreEverywhere_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000701C_TheyAreEverywhere));
        ...
        {
            bool result = CF_00000701C_TheyAreEverywhere.Solution_0_Test(input);
