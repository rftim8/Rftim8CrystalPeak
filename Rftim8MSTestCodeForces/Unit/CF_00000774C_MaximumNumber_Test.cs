...
{
    [TestClass]
    public sealed class CF_00000774C_MaximumNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774C_MaximumNumber));
        ...
        {
            bool result = CF_00000774C_MaximumNumber.Solution_0_Test(input);
