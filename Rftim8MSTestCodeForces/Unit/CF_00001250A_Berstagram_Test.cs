...
{
    [TestClass]
    public sealed class CF_00001250A_Berstagram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250A_Berstagram));
        ...
        {
            bool result = CF_00001250A_Berstagram.Solution_0_Test(input);
