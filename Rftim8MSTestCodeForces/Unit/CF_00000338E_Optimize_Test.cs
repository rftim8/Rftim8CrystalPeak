...
{
    [TestClass]
    public sealed class CF_00000338E_Optimize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000338E_Optimize));
        ...
        {
            bool result = CF_00000338E_Optimize.Solution_0_Test(input);
