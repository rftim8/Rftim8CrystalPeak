...
{
    [TestClass]
    public sealed class CF_00001418D_TrashProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001418D_TrashProblem));
        ...
        {
            bool result = CF_00001418D_TrashProblem.Solution_0_Test(input);
