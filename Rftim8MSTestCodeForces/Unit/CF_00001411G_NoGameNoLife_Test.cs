...
{
    [TestClass]
    public sealed class CF_00001411G_NoGameNoLife_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001411G_NoGameNoLife));
        ...
        {
            bool result = CF_00001411G_NoGameNoLife.Solution_0_Test(input);
