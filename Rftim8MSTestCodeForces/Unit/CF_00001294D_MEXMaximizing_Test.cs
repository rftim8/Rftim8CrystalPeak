...
{
    [TestClass]
    public sealed class CF_00001294D_MEXMaximizing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001294D_MEXMaximizing));
        ...
        {
            bool result = CF_00001294D_MEXMaximizing.Solution_0_Test(input);
