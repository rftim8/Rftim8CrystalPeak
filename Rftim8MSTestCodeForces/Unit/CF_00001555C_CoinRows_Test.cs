...
{
    [TestClass]
    public sealed class CF_00001555C_CoinRows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001555C_CoinRows));
        ...
        {
            bool result = CF_00001555C_CoinRows.Solution_0_Test(input);
