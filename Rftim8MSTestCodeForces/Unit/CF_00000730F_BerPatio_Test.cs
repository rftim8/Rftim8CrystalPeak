...
{
    [TestClass]
    public sealed class CF_00000730F_BerPatio_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730F_BerPatio));
        ...
        {
            bool result = CF_00000730F_BerPatio.Solution_0_Test(input);
