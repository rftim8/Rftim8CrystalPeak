...
{
    [TestClass]
    public sealed class CF_00001934D1_XORBreakSoloVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001934D1_XORBreakSoloVersion));
        ...
        {
            bool result = CF_00001934D1_XORBreakSoloVersion.Solution_0_Test(input);
