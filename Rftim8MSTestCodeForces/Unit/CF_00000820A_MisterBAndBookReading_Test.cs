...
{
    [TestClass]
    public sealed class CF_00000820A_MisterBAndBookReading_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000820A_MisterBAndBookReading));
        ...
        {
            bool result = CF_00000820A_MisterBAndBookReading.Solution_0_Test(input);
