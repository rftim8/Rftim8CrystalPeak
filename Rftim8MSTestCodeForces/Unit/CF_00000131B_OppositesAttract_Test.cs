...
{
    [TestClass]
    public sealed class CF_00000131B_OppositesAttract_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000131B_OppositesAttract));
        ...
        {
            bool result = CF_00000131B_OppositesAttract.Solution_0_Test(input);
