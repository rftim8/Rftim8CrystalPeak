...
{
    [TestClass]
    public sealed class CF_00001320D_ReachableStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001320D_ReachableStrings));
        ...
        {
            bool result = CF_00001320D_ReachableStrings.Solution_0_Test(input);
