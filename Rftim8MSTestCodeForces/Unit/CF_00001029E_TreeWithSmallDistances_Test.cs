...
{
    [TestClass]
    public sealed class CF_00001029E_TreeWithSmallDistances_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001029E_TreeWithSmallDistances));
        ...
        {
            bool result = CF_00001029E_TreeWithSmallDistances.Solution_0_Test(input);
