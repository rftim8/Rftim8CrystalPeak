...
{
    [TestClass]
    public sealed class CF_00001851G_VladAndTheMountains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001851G_VladAndTheMountains));
        ...
        {
            bool result = CF_00001851G_VladAndTheMountains.Solution_0_Test(input);
