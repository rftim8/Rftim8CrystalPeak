...
{
    [TestClass]
    public sealed class CF_00001772C_DifferentDifferences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001772C_DifferentDifferences));
        ...
        {
            bool result = CF_00001772C_DifferentDifferences.Solution_0_Test(input);
