...
{
    [TestClass]
    public sealed class CF_00000249D_DonkeyAndStars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000249D_DonkeyAndStars));
        ...
        {
            bool result = CF_00000249D_DonkeyAndStars.Solution_0_Test(input);
