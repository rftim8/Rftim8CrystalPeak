...
{
    [TestClass]
    public sealed class CF_00002022A_BusToPenjamo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002022A_BusToPenjamo));
        ...
        {
            bool result = CF_00002022A_BusToPenjamo.Solution_0_Test(input);
