...
{
    [TestClass]
    public sealed class CF_00001856E2_PermuTreeHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001856E2_PermuTreeHardVersion));
        ...
        {
            bool result = CF_00001856E2_PermuTreeHardVersion.Solution_0_Test(input);
