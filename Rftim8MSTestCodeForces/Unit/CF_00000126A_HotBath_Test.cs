...
{
    [TestClass]
    public sealed class CF_00000126A_HotBath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000126A_HotBath));
        ...
        {
            bool result = CF_00000126A_HotBath.Solution_0_Test(input);
