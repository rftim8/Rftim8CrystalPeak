...
{
    [TestClass]
    public sealed class CF_00000103C_RussianRoulette_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000103C_RussianRoulette));
        ...
        {
            bool result = CF_00000103C_RussianRoulette.Solution_0_Test(input);
