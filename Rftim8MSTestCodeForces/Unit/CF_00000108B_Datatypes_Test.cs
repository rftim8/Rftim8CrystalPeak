...
{
    [TestClass]
    public sealed class CF_00000108B_Datatypes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000108B_Datatypes));
        ...
        {
            bool result = CF_00000108B_Datatypes.Solution_0_Test(input);
