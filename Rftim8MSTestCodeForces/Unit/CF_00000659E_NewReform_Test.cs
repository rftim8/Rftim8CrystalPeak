...
{
    [TestClass]
    public sealed class CF_00000659E_NewReform_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000659E_NewReform));
        ...
        {
            bool result = CF_00000659E_NewReform.Solution_0_Test(input);
