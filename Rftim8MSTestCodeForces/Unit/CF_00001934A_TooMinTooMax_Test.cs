...
{
    [TestClass]
    public sealed class CF_00001934A_TooMinTooMax_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001934A_TooMinTooMax));
        ...
        {
            bool result = CF_00001934A_TooMinTooMax.Solution_0_Test(input);
