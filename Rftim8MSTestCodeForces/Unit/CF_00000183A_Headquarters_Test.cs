...
{
    [TestClass]
    public sealed class CF_00000183A_Headquarters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000183A_Headquarters));
        ...
        {
            bool result = CF_00000183A_Headquarters.Solution_0_Test(input);
