...
{
    [TestClass]
    public sealed class CF_00001979E_ManhattanTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001979E_ManhattanTriangle));
        ...
        {
            bool result = CF_00001979E_ManhattanTriangle.Solution_0_Test(input);
