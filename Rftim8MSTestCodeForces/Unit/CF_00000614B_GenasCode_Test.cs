...
{
    [TestClass]
    public sealed class CF_00000614B_GenasCode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000614B_GenasCode));
        ...
        {
            bool result = CF_00000614B_GenasCode.Solution_0_Test(input);
