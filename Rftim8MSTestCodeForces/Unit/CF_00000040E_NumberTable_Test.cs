...
{
    [TestClass]
    public sealed class CF_00000040E_NumberTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000040E_NumberTable));
        ...
        {
            bool result = CF_00000040E_NumberTable.Solution_0_Test(input);
