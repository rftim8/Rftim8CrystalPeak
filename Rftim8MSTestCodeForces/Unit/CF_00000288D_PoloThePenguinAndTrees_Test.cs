...
{
    [TestClass]
    public sealed class CF_00000288D_PoloThePenguinAndTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000288D_PoloThePenguinAndTrees));
        ...
        {
            bool result = CF_00000288D_PoloThePenguinAndTrees.Solution_0_Test(input);
