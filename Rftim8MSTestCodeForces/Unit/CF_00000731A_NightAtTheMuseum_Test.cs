...
{
    [TestClass]
    public sealed class CF_00000731A_NightAtTheMuseum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000731A_NightAtTheMuseum));
        ...
        {
            bool result = CF_00000731A_NightAtTheMuseum.Solution_0_Test(input);
