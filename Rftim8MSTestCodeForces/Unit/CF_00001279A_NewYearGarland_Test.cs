...
{
    [TestClass]
    public sealed class CF_00001279A_NewYearGarland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001279A_NewYearGarland));
        ...
        {
            bool result = CF_00001279A_NewYearGarland.Solution_0_Test(input);
