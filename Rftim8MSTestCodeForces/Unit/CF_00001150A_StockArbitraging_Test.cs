...
{
    [TestClass]
    public sealed class CF_00001150A_StockArbitraging_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001150A_StockArbitraging));
        ...
        {
            bool result = CF_00001150A_StockArbitraging.Solution_0_Test(input);
