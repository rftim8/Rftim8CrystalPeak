...
{
    [TestClass]
    public sealed class CF_00001499A_DominoOnWindowsill_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001499A_DominoOnWindowsill));
        ...
        {
            bool result = CF_00001499A_DominoOnWindowsill.Solution_0_Test(input);
