...
{
    [TestClass]
    public sealed class CF_00001288E_MessengerSimulator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001288E_MessengerSimulator));
        ...
        {
            bool result = CF_00001288E_MessengerSimulator.Solution_0_Test(input);
