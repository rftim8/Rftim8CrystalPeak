...
{
    [TestClass]
    public sealed class CF_00000029B_TrafficLights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000029B_TrafficLights));
        ...
        {
            bool result = CF_00000029B_TrafficLights.Solution_0_Test(input);
