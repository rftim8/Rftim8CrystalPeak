...
{
    [TestClass]
    public sealed class CF_00001585C_MinimizeDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001585C_MinimizeDistance));
        ...
        {
            bool result = CF_00001585C_MinimizeDistance.Solution_0_Test(input);
