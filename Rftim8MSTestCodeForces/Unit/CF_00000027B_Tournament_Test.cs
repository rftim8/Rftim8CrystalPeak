...
{
    [TestClass]
    public sealed class CF_00000027B_Tournament_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000027B_Tournament));
        ...
        {
            bool result = CF_00000027B_Tournament.Solution_0_Test(input);
