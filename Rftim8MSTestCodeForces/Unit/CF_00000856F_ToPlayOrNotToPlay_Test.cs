...
{
    [TestClass]
    public sealed class CF_00000856F_ToPlayOrNotToPlay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000856F_ToPlayOrNotToPlay));
        ...
        {
            bool result = CF_00000856F_ToPlayOrNotToPlay.Solution_0_Test(input);
