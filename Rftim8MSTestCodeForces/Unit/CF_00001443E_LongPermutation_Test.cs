...
{
    [TestClass]
    public sealed class CF_00001443E_LongPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001443E_LongPermutation));
        ...
        {
            bool result = CF_00001443E_LongPermutation.Solution_0_Test(input);
