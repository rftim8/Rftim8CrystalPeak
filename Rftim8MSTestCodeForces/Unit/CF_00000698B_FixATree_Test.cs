...
{
    [TestClass]
    public sealed class CF_00000698B_FixATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000698B_FixATree));
        ...
        {
            bool result = CF_00000698B_FixATree.Solution_0_Test(input);
