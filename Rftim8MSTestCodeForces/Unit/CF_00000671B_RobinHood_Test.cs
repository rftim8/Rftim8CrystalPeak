...
{
    [TestClass]
    public sealed class CF_00000671B_RobinHood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000671B_RobinHood));
        ...
        {
            bool result = CF_00000671B_RobinHood.Solution_0_Test(input);
