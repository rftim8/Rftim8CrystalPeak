...
{
    [TestClass]
    public sealed class CF_00001864F_ExoticQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001864F_ExoticQueries));
        ...
        {
            bool result = CF_00001864F_ExoticQueries.Solution_0_Test(input);
