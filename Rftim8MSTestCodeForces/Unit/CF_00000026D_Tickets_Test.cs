...
{
    [TestClass]
    public sealed class CF_00000026D_Tickets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000026D_Tickets));
        ...
        {
            bool result = CF_00000026D_Tickets.Solution_0_Test(input);
