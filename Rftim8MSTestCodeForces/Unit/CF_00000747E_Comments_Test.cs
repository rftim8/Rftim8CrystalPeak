...
{
    [TestClass]
    public sealed class CF_00000747E_Comments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000747E_Comments));
        ...
        {
            bool result = CF_00000747E_Comments.Solution_0_Test(input);
