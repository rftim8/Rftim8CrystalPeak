...
{
    [TestClass]
    public sealed class CF_00001919E_CountingPrefixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001919E_CountingPrefixes));
        ...
        {
            bool result = CF_00001919E_CountingPrefixes.Solution_0_Test(input);
