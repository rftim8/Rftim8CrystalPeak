...
{
    [TestClass]
    public sealed class CF_00000924C_RiversideCurio_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000924C_RiversideCurio));
        ...
        {
            bool result = CF_00000924C_RiversideCurio.Solution_0_Test(input);
