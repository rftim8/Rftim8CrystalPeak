...
{
    [TestClass]
    public sealed class CF_00000960D_FullBinaryTreeQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000960D_FullBinaryTreeQueries));
        ...
        {
            bool result = CF_00000960D_FullBinaryTreeQueries.Solution_0_Test(input);
