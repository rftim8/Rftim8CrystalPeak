...
{
    [TestClass]
    public sealed class CF_00001065E_SideTransmutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001065E_SideTransmutations));
        ...
        {
            bool result = CF_00001065E_SideTransmutations.Solution_0_Test(input);
