...
{
    [TestClass]
    public sealed class CF_00000878D_MagicBreeding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000878D_MagicBreeding));
        ...
        {
            bool result = CF_00000878D_MagicBreeding.Solution_0_Test(input);
