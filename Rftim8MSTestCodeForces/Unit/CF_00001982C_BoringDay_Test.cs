...
{
    [TestClass]
    public sealed class CF_00001982C_BoringDay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001982C_BoringDay));
        ...
        {
            bool result = CF_00001982C_BoringDay.Solution_0_Test(input);
