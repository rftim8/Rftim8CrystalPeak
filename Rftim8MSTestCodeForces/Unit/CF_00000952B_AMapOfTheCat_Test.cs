...
{
    [TestClass]
    public sealed class CF_00000952B_AMapOfTheCat_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000952B_AMapOfTheCat));
        ...
        {
            bool result = CF_00000952B_AMapOfTheCat.Solution_0_Test(input);
