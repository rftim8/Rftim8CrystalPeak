...
{
    [TestClass]
    public sealed class CF_00001044D_DeductionQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001044D_DeductionQueries));
        ...
        {
            bool result = CF_00001044D_DeductionQueries.Solution_0_Test(input);
