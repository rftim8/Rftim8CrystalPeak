...
{
    [TestClass]
    public sealed class CF_00000949C_DataCenterMaintenance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000949C_DataCenterMaintenance));
        ...
        {
            bool result = CF_00000949C_DataCenterMaintenance.Solution_0_Test(input);
