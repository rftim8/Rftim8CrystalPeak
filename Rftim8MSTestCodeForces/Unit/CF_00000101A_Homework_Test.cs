...
{
    [TestClass]
    public sealed class CF_00000101A_Homework_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000101A_Homework));
        ...
        {
            bool result = CF_00000101A_Homework.Solution_0_Test(input);
