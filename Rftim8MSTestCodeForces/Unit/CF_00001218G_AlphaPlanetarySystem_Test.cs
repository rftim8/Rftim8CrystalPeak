...
{
    [TestClass]
    public sealed class CF_00001218G_AlphaPlanetarySystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001218G_AlphaPlanetarySystem));
        ...
        {
            bool result = CF_00001218G_AlphaPlanetarySystem.Solution_0_Test(input);
