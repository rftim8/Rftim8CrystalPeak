...
{
    [TestClass]
    public sealed class CF_00000643G_ChoosingAds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000643G_ChoosingAds));
        ...
        {
            bool result = CF_00000643G_ChoosingAds.Solution_0_Test(input);
