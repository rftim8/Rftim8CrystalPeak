...
{
    [TestClass]
    public sealed class CF_00000639F_BearAndChemistry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000639F_BearAndChemistry));
        ...
        {
            bool result = CF_00000639F_BearAndChemistry.Solution_0_Test(input);
