...
{
    [TestClass]
    public sealed class CF_00001090I_MinimalProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001090I_MinimalProduct));
        ...
        {
            bool result = CF_00001090I_MinimalProduct.Solution_0_Test(input);
