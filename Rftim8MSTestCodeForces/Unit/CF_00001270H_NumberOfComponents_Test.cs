...
{
    [TestClass]
    public sealed class CF_00001270H_NumberOfComponents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001270H_NumberOfComponents));
        ...
        {
            bool result = CF_00001270H_NumberOfComponents.Solution_0_Test(input);
