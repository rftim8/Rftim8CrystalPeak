...
{
    [TestClass]
    public sealed class CF_00000007E_DefiningMacros_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000007E_DefiningMacros));
        ...
        {
            bool result = CF_00000007E_DefiningMacros.Solution_0_Test(input);
