...
{
    [TestClass]
    public sealed class CF_00000749E_InversionsAfterShuffle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000749E_InversionsAfterShuffle));
        ...
        {
            bool result = CF_00000749E_InversionsAfterShuffle.Solution_0_Test(input);
