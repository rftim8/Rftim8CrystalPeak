...
{
    [TestClass]
    public sealed class CF_00000278B_NewProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000278B_NewProblem));
        ...
        {
            bool result = CF_00000278B_NewProblem.Solution_0_Test(input);
