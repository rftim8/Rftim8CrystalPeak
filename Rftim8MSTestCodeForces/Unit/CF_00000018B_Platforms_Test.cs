...
{
    [TestClass]
    public sealed class CF_00000018B_Platforms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000018B_Platforms));
        ...
        {
            bool result = CF_00000018B_Platforms.Solution_0_Test(input);
