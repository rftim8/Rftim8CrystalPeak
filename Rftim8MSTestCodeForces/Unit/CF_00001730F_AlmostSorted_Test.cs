...
{
    [TestClass]
    public sealed class CF_00001730F_AlmostSorted_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001730F_AlmostSorted));
        ...
        {
            bool result = CF_00001730F_AlmostSorted.Solution_0_Test(input);
