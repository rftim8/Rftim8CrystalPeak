...
{
    [TestClass]
    public sealed class CF_00000600A_ExtractNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000600A_ExtractNumbers));
        ...
        {
            bool result = CF_00000600A_ExtractNumbers.Solution_0_Test(input);
