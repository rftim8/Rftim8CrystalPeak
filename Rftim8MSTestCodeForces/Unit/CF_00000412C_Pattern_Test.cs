...
{
    [TestClass]
    public sealed class CF_00000412C_Pattern_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000412C_Pattern));
        ...
        {
            bool result = CF_00000412C_Pattern.Solution_0_Test(input);
