...
{
    [TestClass]
    public sealed class CF_00000447A_DZYLovesHash_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000447A_DZYLovesHash));
        ...
        {
            bool result = CF_00000447A_DZYLovesHash.Solution_0_Test(input);
