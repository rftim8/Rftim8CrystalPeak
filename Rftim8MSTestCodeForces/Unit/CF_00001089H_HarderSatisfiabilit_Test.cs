...
{
    [TestClass]
    public sealed class CF_00001089H_HarderSatisfiabilit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001089H_HarderSatisfiabilit));
        ...
        {
            bool result = CF_00001089H_HarderSatisfiabilit.Solution_0_Test(input);
