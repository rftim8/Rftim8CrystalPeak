...
{
    [TestClass]
    public sealed class CF_00001159A_APileOfStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001159A_APileOfStones));
        ...
        {
            bool result = CF_00001159A_APileOfStones.Solution_0_Test(input);
