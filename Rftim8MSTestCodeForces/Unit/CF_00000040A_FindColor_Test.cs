...
{
    [TestClass]
    public sealed class CF_00000040A_FindColor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000040A_FindColor));
        ...
        {
            bool result = CF_00000040A_FindColor.Solution_0_Test(input);
