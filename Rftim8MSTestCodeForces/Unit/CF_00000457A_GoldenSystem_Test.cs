...
{
    [TestClass]
    public sealed class CF_00000457A_GoldenSystem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000457A_GoldenSystem));
        ...
        {
            bool result = CF_00000457A_GoldenSystem.Solution_0_Test(input);
