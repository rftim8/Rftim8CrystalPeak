...
{
    [TestClass]
    public sealed class CF_00001475B_NewYearsNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001475B_NewYearsNumber));
        ...
        {
            bool result = CF_00001475B_NewYearsNumber.Solution_0_Test(input);
