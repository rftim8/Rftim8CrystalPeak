...
{
    [TestClass]
    public sealed class CF_00001056D_DecorateAppleTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001056D_DecorateAppleTree));
        ...
        {
            bool result = CF_00001056D_DecorateAppleTree.Solution_0_Test(input);
