...
{
    [TestClass]
    public sealed class CF_00000316G2_GoodSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000316G2_GoodSubstrings));
        ...
        {
            bool result = CF_00000316G2_GoodSubstrings.Solution_0_Test(input);
