...
{
    [TestClass]
    public sealed class CF_00001776J_ItalianDataCenters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001776J_ItalianDataCenters));
        ...
        {
            bool result = CF_00001776J_ItalianDataCenters.Solution_0_Test(input);
