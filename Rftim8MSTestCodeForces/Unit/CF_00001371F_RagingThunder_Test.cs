...
{
    [TestClass]
    public sealed class CF_00001371F_RagingThunder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001371F_RagingThunder));
        ...
        {
            bool result = CF_00001371F_RagingThunder.Solution_0_Test(input);
