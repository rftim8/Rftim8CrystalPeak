...
{
    [TestClass]
    public sealed class CF_00000962C_MakeASquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000962C_MakeASquare));
        ...
        {
            bool result = CF_00000962C_MakeASquare.Solution_0_Test(input);
