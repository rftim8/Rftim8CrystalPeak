...
{
    [TestClass]
    public sealed class CF_00001389A_LCMProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001389A_LCMProblem));
        ...
        {
            bool result = CF_00001389A_LCMProblem.Solution_0_Test(input);
