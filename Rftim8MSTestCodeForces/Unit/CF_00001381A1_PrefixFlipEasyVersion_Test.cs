...
{
    [TestClass]
    public sealed class CF_00001381A1_PrefixFlipEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001381A1_PrefixFlipEasyVersion));
        ...
        {
            bool result = CF_00001381A1_PrefixFlipEasyVersion.Solution_0_Test(input);
