...
{
    [TestClass]
    public sealed class CF_00001257B_MagicStick_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001257B_MagicStick));
        ...
        {
            bool result = CF_00001257B_MagicStick.Solution_0_Test(input);
