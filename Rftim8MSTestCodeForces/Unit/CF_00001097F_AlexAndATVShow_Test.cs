...
{
    [TestClass]
    public sealed class CF_00001097F_AlexAndATVShow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001097F_AlexAndATVShow));
        ...
        {
            bool result = CF_00001097F_AlexAndATVShow.Solution_0_Test(input);
