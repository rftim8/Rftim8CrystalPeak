...
{
    [TestClass]
    public sealed class CF_00000819D_MisterBAndAstronomers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000819D_MisterBAndAstronomers));
        ...
        {
            bool result = CF_00000819D_MisterBAndAstronomers.Solution_0_Test(input);
