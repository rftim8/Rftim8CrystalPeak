...
{
    [TestClass]
    public sealed class CF_00001851D_PrefixPermutationSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001851D_PrefixPermutationSums));
        ...
        {
            bool result = CF_00001851D_PrefixPermutationSums.Solution_0_Test(input);
