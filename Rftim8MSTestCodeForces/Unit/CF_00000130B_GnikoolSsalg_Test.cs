...
{
    [TestClass]
    public sealed class CF_00000130B_GnikoolSsalg_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000130B_GnikoolSsalg));
        ...
        {
            bool result = CF_00000130B_GnikoolSsalg.Solution_0_Test(input);
