...
{
    [TestClass]
    public sealed class CF_00001557A_EzzatAndTwoSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001557A_EzzatAndTwoSubsequences));
        ...
        {
            bool result = CF_00001557A_EzzatAndTwoSubsequences.Solution_0_Test(input);
