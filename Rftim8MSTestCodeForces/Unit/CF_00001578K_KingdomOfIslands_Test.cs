...
{
    [TestClass]
    public sealed class CF_00001578K_KingdomOfIslands_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001578K_KingdomOfIslands));
        ...
        {
            bool result = CF_00001578K_KingdomOfIslands.Solution_0_Test(input);
