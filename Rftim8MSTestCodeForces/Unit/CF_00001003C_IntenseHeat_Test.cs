...
{
    [TestClass]
    public sealed class CF_00001003C_IntenseHeat_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001003C_IntenseHeat));
        ...
        {
            bool result = CF_00001003C_IntenseHeat.Solution_0_Test(input);
