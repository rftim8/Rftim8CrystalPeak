...
{
    [TestClass]
    public sealed class CF_00001562B_ScenesFromAMemory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001562B_ScenesFromAMemory));
        ...
        {
            bool result = CF_00001562B_ScenesFromAMemory.Solution_0_Test(input);
