...
{
    [TestClass]
    public sealed class CF_00001244A_PensAndPencils_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001244A_PensAndPencils));
        ...
        {
            bool result = CF_00001244A_PensAndPencils.Solution_0_Test(input);
