...
{
    [TestClass]
    public sealed class CF_00001422D_ReturningHome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001422D_ReturningHome));
        ...
        {
            bool result = CF_00001422D_ReturningHome.Solution_0_Test(input);
