...
{
    [TestClass]
    public sealed class CF_00001182A_FillingShapes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001182A_FillingShapes));
        ...
        {
            bool result = CF_00001182A_FillingShapes.Solution_0_Test(input);
