...
{
    [TestClass]
    public sealed class CF_00002023A_ConcatenationOfArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002023A_ConcatenationOfArrays));
        ...
        {
            bool result = CF_00002023A_ConcatenationOfArrays.Solution_0_Test(input);
