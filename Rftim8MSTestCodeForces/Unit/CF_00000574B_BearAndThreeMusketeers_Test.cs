...
{
    [TestClass]
    public sealed class CF_00000574B_BearAndThreeMusketeers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000574B_BearAndThreeMusketeers));
        ...
        {
            bool result = CF_00000574B_BearAndThreeMusketeers.Solution_0_Test(input);
