...
{
    [TestClass]
    public sealed class CF_00001187B_LettersShop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001187B_LettersShop));
        ...
        {
            bool result = CF_00001187B_LettersShop.Solution_0_Test(input);
