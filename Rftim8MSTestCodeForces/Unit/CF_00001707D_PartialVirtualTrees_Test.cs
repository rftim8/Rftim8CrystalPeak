...
{
    [TestClass]
    public sealed class CF_00001707D_PartialVirtualTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001707D_PartialVirtualTrees));
        ...
        {
            bool result = CF_00001707D_PartialVirtualTrees.Solution_0_Test(input);
