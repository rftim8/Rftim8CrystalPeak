...
{
    [TestClass]
    public sealed class CF_00001227A_MathProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001227A_MathProblem));
        ...
        {
            bool result = CF_00001227A_MathProblem.Solution_0_Test(input);
