...
{
    [TestClass]
    public sealed class CF_00000321D_CielAndFlipboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000321D_CielAndFlipboard));
        ...
        {
            bool result = CF_00000321D_CielAndFlipboard.Solution_0_Test(input);
