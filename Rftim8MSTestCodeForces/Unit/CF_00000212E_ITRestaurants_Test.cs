...
{
    [TestClass]
    public sealed class CF_00000212E_ITRestaurants_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000212E_ITRestaurants));
        ...
        {
            bool result = CF_00000212E_ITRestaurants.Solution_0_Test(input);
