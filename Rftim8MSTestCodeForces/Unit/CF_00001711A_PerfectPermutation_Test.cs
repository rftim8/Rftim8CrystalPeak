...
{
    [TestClass]
    public sealed class CF_00001711A_PerfectPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001711A_PerfectPermutation));
        ...
        {
            bool result = CF_00001711A_PerfectPermutation.Solution_0_Test(input);
