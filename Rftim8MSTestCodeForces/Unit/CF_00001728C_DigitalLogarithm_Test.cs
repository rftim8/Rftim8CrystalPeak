...
{
    [TestClass]
    public sealed class CF_00001728C_DigitalLogarithm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001728C_DigitalLogarithm));
        ...
        {
            bool result = CF_00001728C_DigitalLogarithm.Solution_0_Test(input);
