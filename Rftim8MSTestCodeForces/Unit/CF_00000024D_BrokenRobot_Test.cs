...
{
    [TestClass]
    public sealed class CF_00000024D_BrokenRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000024D_BrokenRobot));
        ...
        {
            bool result = CF_00000024D_BrokenRobot.Solution_0_Test(input);
