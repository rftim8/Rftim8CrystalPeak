...
{
    [TestClass]
    public sealed class CF_00000605A_SortingRailwayCars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000605A_SortingRailwayCars));
        ...
        {
            bool result = CF_00000605A_SortingRailwayCars.Solution_0_Test(input);
