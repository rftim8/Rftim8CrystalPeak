...
{
    [TestClass]
    public sealed class CF_00000822E_Liar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000822E_Liar));
        ...
        {
            bool result = CF_00000822E_Liar.Solution_0_Test(input);
