...
{
    [TestClass]
    public sealed class CF_00001223B_StringsEqualization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001223B_StringsEqualization));
        ...
        {
            bool result = CF_00001223B_StringsEqualization.Solution_0_Test(input);
