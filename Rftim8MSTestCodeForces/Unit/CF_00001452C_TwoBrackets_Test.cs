...
{
    [TestClass]
    public sealed class CF_00001452C_TwoBrackets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001452C_TwoBrackets));
        ...
        {
            bool result = CF_00001452C_TwoBrackets.Solution_0_Test(input);
