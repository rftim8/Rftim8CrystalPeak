...
{
    [TestClass]
    public sealed class CF_00001709B_AlsoTryMinecraft_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001709B_AlsoTryMinecraft));
        ...
        {
            bool result = CF_00001709B_AlsoTryMinecraft.Solution_0_Test(input);
