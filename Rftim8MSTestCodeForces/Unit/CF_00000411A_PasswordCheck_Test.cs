...
{
    [TestClass]
    public sealed class CF_00000411A_PasswordCheck_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000411A_PasswordCheck));
        ...
        {
            bool result = CF_00000411A_PasswordCheck.Solution_0_Test(input);
