...
{
    [TestClass]
    public sealed class CF_00001236A_Stones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001236A_Stones));
        ...
        {
            bool result = CF_00001236A_Stones.Solution_0_Test(input);
