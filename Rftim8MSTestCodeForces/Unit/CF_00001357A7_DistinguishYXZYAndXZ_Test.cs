...
{
    [TestClass]
    public sealed class CF_00001357A7_DistinguishYXZYAndXZ_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001357A7_DistinguishYXZYAndXZ));
        ...
        {
            bool result = CF_00001357A7_DistinguishYXZYAndXZ.Solution_0_Test(input);
