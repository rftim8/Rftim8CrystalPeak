...
{
    [TestClass]
    public sealed class CF_00001916E_HappyLifeInUniversity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001916E_HappyLifeInUniversity));
        ...
        {
            bool result = CF_00001916E_HappyLifeInUniversity.Solution_0_Test(input);
