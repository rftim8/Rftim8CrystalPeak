...
{
    [TestClass]
    public sealed class CF_00000735D_Taxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000735D_Taxes));
        ...
        {
            bool result = CF_00000735D_Taxes.Solution_0_Test(input);
