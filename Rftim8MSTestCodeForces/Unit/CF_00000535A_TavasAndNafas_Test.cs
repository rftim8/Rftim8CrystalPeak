...
{
    [TestClass]
    public sealed class CF_00000535A_TavasAndNafas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000535A_TavasAndNafas));
        ...
        {
            bool result = CF_00000535A_TavasAndNafas.Solution_0_Test(input);
