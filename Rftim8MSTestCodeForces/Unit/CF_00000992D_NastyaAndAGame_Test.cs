...
{
    [TestClass]
    public sealed class CF_00000992D_NastyaAndAGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000992D_NastyaAndAGame));
        ...
        {
            bool result = CF_00000992D_NastyaAndAGame.Solution_0_Test(input);
