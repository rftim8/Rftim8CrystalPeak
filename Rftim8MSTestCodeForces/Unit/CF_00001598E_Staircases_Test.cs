...
{
    [TestClass]
    public sealed class CF_00001598E_Staircases_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001598E_Staircases));
        ...
        {
            bool result = CF_00001598E_Staircases.Solution_0_Test(input);
