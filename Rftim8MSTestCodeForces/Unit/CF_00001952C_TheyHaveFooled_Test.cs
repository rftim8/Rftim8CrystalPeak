...
{
    [TestClass]
    public sealed class CF_00001952C_TheyHaveFooled_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001952C_TheyHaveFooled));
        ...
        {
            bool result = CF_00001952C_TheyHaveFooled.Solution_0_Test(input);
