...
{
    [TestClass]
    public sealed class CF_00001174F_EhabAndTheBigFinale_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001174F_EhabAndTheBigFinale));
        ...
        {
            bool result = CF_00001174F_EhabAndTheBigFinale.Solution_0_Test(input);
