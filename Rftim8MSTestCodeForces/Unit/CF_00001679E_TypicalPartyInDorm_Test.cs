...
{
    [TestClass]
    public sealed class CF_00001679E_TypicalPartyInDorm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001679E_TypicalPartyInDorm));
        ...
        {
            bool result = CF_00001679E_TypicalPartyInDorm.Solution_0_Test(input);
