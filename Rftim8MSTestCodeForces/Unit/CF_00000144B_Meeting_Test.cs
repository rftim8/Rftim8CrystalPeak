...
{
    [TestClass]
    public sealed class CF_00000144B_Meeting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000144B_Meeting));
        ...
        {
            bool result = CF_00000144B_Meeting.Solution_0_Test(input);
