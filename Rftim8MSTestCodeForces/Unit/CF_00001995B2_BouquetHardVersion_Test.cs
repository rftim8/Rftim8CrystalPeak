...
{
    [TestClass]
    public sealed class CF_00001995B2_BouquetHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001995B2_BouquetHardVersion));
        ...
        {
            bool result = CF_00001995B2_BouquetHardVersion.Solution_0_Test(input);
