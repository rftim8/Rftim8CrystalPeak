...
{
    [TestClass]
    public sealed class CF_00000177E2_SpaceVoyage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000177E2_SpaceVoyage));
        ...
        {
            bool result = CF_00000177E2_SpaceVoyage.Solution_0_Test(input);
