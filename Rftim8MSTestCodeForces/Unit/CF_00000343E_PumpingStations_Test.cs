...
{
    [TestClass]
    public sealed class CF_00000343E_PumpingStations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000343E_PumpingStations));
        ...
        {
            bool result = CF_00000343E_PumpingStations.Solution_0_Test(input);
