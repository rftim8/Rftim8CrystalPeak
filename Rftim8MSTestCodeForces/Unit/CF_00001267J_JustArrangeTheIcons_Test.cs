...
{
    [TestClass]
    public sealed class CF_00001267J_JustArrangeTheIcons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001267J_JustArrangeTheIcons));
        ...
        {
            bool result = CF_00001267J_JustArrangeTheIcons.Solution_0_Test(input);
