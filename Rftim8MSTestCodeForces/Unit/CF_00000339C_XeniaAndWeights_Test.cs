...
{
    [TestClass]
    public sealed class CF_00000339C_XeniaAndWeights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000339C_XeniaAndWeights));
        ...
        {
            bool result = CF_00000339C_XeniaAndWeights.Solution_0_Test(input);
