...
{
    [TestClass]
    public sealed class CF_00001329D_DreamoonLikesStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001329D_DreamoonLikesStrings));
        ...
        {
            bool result = CF_00001329D_DreamoonLikesStrings.Solution_0_Test(input);
