...
{
    [TestClass]
    public sealed class CF_00001693C_KeshiInSearchOfAmShZ_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001693C_KeshiInSearchOfAmShZ));
        ...
        {
            bool result = CF_00001693C_KeshiInSearchOfAmShZ.Solution_0_Test(input);
