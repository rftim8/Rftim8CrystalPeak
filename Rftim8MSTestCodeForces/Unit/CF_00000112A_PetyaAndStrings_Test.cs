...
{
    [TestClass]
    public sealed class CF_00000112A_PetyaAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000112A_PetyaAndStrings));
        ...
        {
            bool result = CF_00000112A_PetyaAndStrings.Solution_0_Test(input);
