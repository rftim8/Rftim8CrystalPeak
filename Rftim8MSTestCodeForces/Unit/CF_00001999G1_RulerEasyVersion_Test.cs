...
{
    [TestClass]
    public sealed class CF_00001999G1_RulerEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001999G1_RulerEasyVersion));
        ...
        {
            bool result = CF_00001999G1_RulerEasyVersion.Solution_0_Test(input);
