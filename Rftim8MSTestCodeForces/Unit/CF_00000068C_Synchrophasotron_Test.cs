...
{
    [TestClass]
    public sealed class CF_00000068C_Synchrophasotron_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000068C_Synchrophasotron));
        ...
        {
            bool result = CF_00000068C_Synchrophasotron.Solution_0_Test(input);
