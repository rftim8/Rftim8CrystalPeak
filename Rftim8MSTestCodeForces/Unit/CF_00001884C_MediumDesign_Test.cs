...
{
    [TestClass]
    public sealed class CF_00001884C_MediumDesign_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001884C_MediumDesign));
        ...
        {
            bool result = CF_00001884C_MediumDesign.Solution_0_Test(input);
