...
{
    [TestClass]
    public sealed class CF_00001698G_LongBinaryString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001698G_LongBinaryString));
        ...
        {
            bool result = CF_00001698G_LongBinaryString.Solution_0_Test(input);
