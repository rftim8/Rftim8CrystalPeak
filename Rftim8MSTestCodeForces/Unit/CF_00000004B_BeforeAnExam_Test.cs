...
{
    [TestClass]
    public sealed class CF_00000004B_BeforeAnExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000004B_BeforeAnExam));
        ...
        {
            bool result = CF_00000004B_BeforeAnExam.Solution_0_Test(input);
