...
{
    [TestClass]
    public sealed class CF_00000855E_SalazarSlytherinsLocket_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000855E_SalazarSlytherinsLocket));
        ...
        {
            bool result = CF_00000855E_SalazarSlytherinsLocket.Solution_0_Test(input);
