...
{
    [TestClass]
    public sealed class CF_00001431G_NumberDeletionGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001431G_NumberDeletionGame));
        ...
        {
            bool result = CF_00001431G_NumberDeletionGame.Solution_0_Test(input);
