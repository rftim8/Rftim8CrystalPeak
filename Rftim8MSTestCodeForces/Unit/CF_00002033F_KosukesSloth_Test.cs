...
{
    [TestClass]
    public sealed class CF_00002033F_KosukesSloth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002033F_KosukesSloth));
        ...
        {
            bool result = CF_00002033F_KosukesSloth.Solution_0_Test(input);
