...
{
    [TestClass]
    public sealed class CF_00000774D_LieOrTruth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774D_LieOrTruth));
        ...
        {
            bool result = CF_00000774D_LieOrTruth.Solution_0_Test(input);
