...
{
    [TestClass]
    public sealed class CF_00001571E_FixTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001571E_FixTheString));
        ...
        {
            bool result = CF_00001571E_FixTheString.Solution_0_Test(input);
