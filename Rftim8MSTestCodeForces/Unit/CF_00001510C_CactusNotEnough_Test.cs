...
{
    [TestClass]
    public sealed class CF_00001510C_CactusNotEnough_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001510C_CactusNotEnough));
        ...
        {
            bool result = CF_00001510C_CactusNotEnough.Solution_0_Test(input);
