...
{
    [TestClass]
    public sealed class CF_00001811A_InsertDigit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001811A_InsertDigit));
        ...
        {
            bool result = CF_00001811A_InsertDigit.Solution_0_Test(input);
