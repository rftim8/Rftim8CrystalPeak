...
{
    [TestClass]
    public sealed class CF_00000091E_IglooSkyscraper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000091E_IglooSkyscraper));
        ...
        {
            bool result = CF_00000091E_IglooSkyscraper.Solution_0_Test(input);
