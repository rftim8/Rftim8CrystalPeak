...
{
    [TestClass]
    public sealed class CF_00001995C_Squaring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001995C_Squaring));
        ...
        {
            bool result = CF_00001995C_Squaring.Solution_0_Test(input);
