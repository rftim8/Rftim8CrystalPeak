...
{
    [TestClass]
    public sealed class CF_00000231D_MagicBox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000231D_MagicBox));
        ...
        {
            bool result = CF_00000231D_MagicBox.Solution_0_Test(input);
