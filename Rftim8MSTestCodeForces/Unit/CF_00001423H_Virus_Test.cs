...
{
    [TestClass]
    public sealed class CF_00001423H_Virus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001423H_Virus));
        ...
        {
            bool result = CF_00001423H_Virus.Solution_0_Test(input);
