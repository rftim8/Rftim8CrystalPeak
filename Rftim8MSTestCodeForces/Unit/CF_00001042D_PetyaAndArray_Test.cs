...
{
    [TestClass]
    public sealed class CF_00001042D_PetyaAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001042D_PetyaAndArray));
        ...
        {
            bool result = CF_00001042D_PetyaAndArray.Solution_0_Test(input);
