...
{
    [TestClass]
    public sealed class CF_00001784F_MinimumsOrMedians_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001784F_MinimumsOrMedians));
        ...
        {
            bool result = CF_00001784F_MinimumsOrMedians.Solution_0_Test(input);
