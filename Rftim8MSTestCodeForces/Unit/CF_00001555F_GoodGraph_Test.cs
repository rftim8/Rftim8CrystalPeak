...
{
    [TestClass]
    public sealed class CF_00001555F_GoodGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001555F_GoodGraph));
        ...
        {
            bool result = CF_00001555F_GoodGraph.Solution_0_Test(input);
