...
{
    [TestClass]
    public sealed class CF_00001862C_FlowerCityFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001862C_FlowerCityFence));
        ...
        {
            bool result = CF_00001862C_FlowerCityFence.Solution_0_Test(input);
