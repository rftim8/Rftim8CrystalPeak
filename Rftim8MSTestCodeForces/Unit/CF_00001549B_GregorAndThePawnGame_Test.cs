...
{
    [TestClass]
    public sealed class CF_00001549B_GregorAndThePawnGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001549B_GregorAndThePawnGame));
        ...
        {
            bool result = CF_00001549B_GregorAndThePawnGame.Solution_0_Test(input);
