...
{
    [TestClass]
    public sealed class CF_00001121C_SystemTesting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001121C_SystemTesting));
        ...
        {
            bool result = CF_00001121C_SystemTesting.Solution_0_Test(input);
