...
{
    [TestClass]
    public sealed class CF_00001795A_TwoTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001795A_TwoTowers));
        ...
        {
            bool result = CF_00001795A_TwoTowers.Solution_0_Test(input);
