...
{
    [TestClass]
    public sealed class CF_00001879D_SumOfXORFunctions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001879D_SumOfXORFunctions));
        ...
        {
            bool result = CF_00001879D_SumOfXORFunctions.Solution_0_Test(input);
