...
{
    [TestClass]
    public sealed class CF_00001439A1_BinaryTableEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001439A1_BinaryTableEasyVersion));
        ...
        {
            bool result = CF_00001439A1_BinaryTableEasyVersion.Solution_0_Test(input);
