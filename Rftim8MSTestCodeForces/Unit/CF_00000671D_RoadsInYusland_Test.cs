...
{
    [TestClass]
    public sealed class CF_00000671D_RoadsInYusland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000671D_RoadsInYusland));
        ...
        {
            bool result = CF_00000671D_RoadsInYusland.Solution_0_Test(input);
