...
{
    [TestClass]
    public sealed class CF_00001733E_Conveyor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001733E_Conveyor));
        ...
        {
            bool result = CF_00001733E_Conveyor.Solution_0_Test(input);
