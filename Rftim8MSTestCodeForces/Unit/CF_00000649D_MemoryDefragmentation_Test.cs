...
{
    [TestClass]
    public sealed class CF_00000649D_MemoryDefragmentation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000649D_MemoryDefragmentation));
        ...
        {
            bool result = CF_00000649D_MemoryDefragmentation.Solution_0_Test(input);
