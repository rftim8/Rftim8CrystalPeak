...
{
    [TestClass]
    public sealed class CF_00001810E_Monsters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001810E_Monsters));
        ...
        {
            bool result = CF_00001810E_Monsters.Solution_0_Test(input);
