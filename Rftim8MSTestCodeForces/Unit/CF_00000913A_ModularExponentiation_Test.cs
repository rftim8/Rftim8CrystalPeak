...
{
    [TestClass]
    public sealed class CF_00000913A_ModularExponentiation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000913A_ModularExponentiation));
        ...
        {
            bool result = CF_00000913A_ModularExponentiation.Solution_0_Test(input);
