...
{
    [TestClass]
    public sealed class CF_00000435C_Cardiogram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000435C_Cardiogram));
        ...
        {
            bool result = CF_00000435C_Cardiogram.Solution_0_Test(input);
