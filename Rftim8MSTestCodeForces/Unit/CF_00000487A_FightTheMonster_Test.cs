...
{
    [TestClass]
    public sealed class CF_00000487A_FightTheMonster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000487A_FightTheMonster));
        ...
        {
            bool result = CF_00000487A_FightTheMonster.Solution_0_Test(input);
