...
{
    [TestClass]
    public sealed class CF_00001508C_CompleteTheMST_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001508C_CompleteTheMST));
        ...
        {
            bool result = CF_00001508C_CompleteTheMST.Solution_0_Test(input);
