...
{
    [TestClass]
    public sealed class CF_00000961F_Ksubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000961F_Ksubstrings));
        ...
        {
            bool result = CF_00000961F_Ksubstrings.Solution_0_Test(input);
