...
{
    [TestClass]
    public sealed class CF_00000715D_CreateAMaze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000715D_CreateAMaze));
        ...
        {
            bool result = CF_00000715D_CreateAMaze.Solution_0_Test(input);
