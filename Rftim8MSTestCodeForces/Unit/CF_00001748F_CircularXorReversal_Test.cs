...
{
    [TestClass]
    public sealed class CF_00001748F_CircularXorReversal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001748F_CircularXorReversal));
        ...
        {
            bool result = CF_00001748F_CircularXorReversal.Solution_0_Test(input);
