...
{
    [TestClass]
    public sealed class CF_00002021A_MeaningMean_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002021A_MeaningMean));
        ...
        {
            bool result = CF_00002021A_MeaningMean.Solution_0_Test(input);
