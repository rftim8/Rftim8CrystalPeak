...
{
    [TestClass]
    public sealed class CF_00000327C_MagicFive_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000327C_MagicFive));
        ...
        {
            bool result = CF_00000327C_MagicFive.Solution_0_Test(input);
