...
{
    [TestClass]
    public sealed class CF_00000853A_Planning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000853A_Planning));
        ...
        {
            bool result = CF_00000853A_Planning.Solution_0_Test(input);
