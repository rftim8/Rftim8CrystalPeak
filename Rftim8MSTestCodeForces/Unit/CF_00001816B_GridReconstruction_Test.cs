...
{
    [TestClass]
    public sealed class CF_00001816B_GridReconstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001816B_GridReconstruction));
        ...
        {
            bool result = CF_00001816B_GridReconstruction.Solution_0_Test(input);
