...
{
    [TestClass]
    public sealed class CF_00000864F_CitiesExcursions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000864F_CitiesExcursions));
        ...
        {
            bool result = CF_00000864F_CitiesExcursions.Solution_0_Test(input);
