...
{
    [TestClass]
    public sealed class CF_00000583B_RobotsTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000583B_RobotsTask));
        ...
        {
            bool result = CF_00000583B_RobotsTask.Solution_0_Test(input);
