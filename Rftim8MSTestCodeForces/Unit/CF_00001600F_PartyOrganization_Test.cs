...
{
    [TestClass]
    public sealed class CF_00001600F_PartyOrganization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001600F_PartyOrganization));
        ...
        {
            bool result = CF_00001600F_PartyOrganization.Solution_0_Test(input);
