...
{
    [TestClass]
    public sealed class CF_00000496E_DistributingParts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000496E_DistributingParts));
        ...
        {
            bool result = CF_00000496E_DistributingParts.Solution_0_Test(input);
