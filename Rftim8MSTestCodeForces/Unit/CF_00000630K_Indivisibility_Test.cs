...
{
    [TestClass]
    public sealed class CF_00000630K_Indivisibility_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630K_Indivisibility));
        ...
        {
            bool result = CF_00000630K_Indivisibility.Solution_0_Test(input);
