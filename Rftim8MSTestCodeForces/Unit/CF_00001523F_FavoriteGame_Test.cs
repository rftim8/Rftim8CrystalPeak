...
{
    [TestClass]
    public sealed class CF_00001523F_FavoriteGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001523F_FavoriteGame));
        ...
        {
            bool result = CF_00001523F_FavoriteGame.Solution_0_Test(input);
