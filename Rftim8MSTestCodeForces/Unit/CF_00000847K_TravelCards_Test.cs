...
{
    [TestClass]
    public sealed class CF_00000847K_TravelCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847K_TravelCards));
        ...
        {
            bool result = CF_00000847K_TravelCards.Solution_0_Test(input);
