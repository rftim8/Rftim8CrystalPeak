...
{
    [TestClass]
    public sealed class CF_00000306C_WhiteBlackAndWhiteAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000306C_WhiteBlackAndWhiteAgain));
        ...
        {
            bool result = CF_00000306C_WhiteBlackAndWhiteAgain.Solution_0_Test(input);
