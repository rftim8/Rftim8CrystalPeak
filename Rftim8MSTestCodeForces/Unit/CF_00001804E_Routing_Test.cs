...
{
    [TestClass]
    public sealed class CF_00001804E_Routing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001804E_Routing));
        ...
        {
            bool result = CF_00001804E_Routing.Solution_0_Test(input);
