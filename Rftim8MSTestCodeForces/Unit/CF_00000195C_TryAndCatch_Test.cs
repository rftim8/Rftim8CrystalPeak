...
{
    [TestClass]
    public sealed class CF_00000195C_TryAndCatch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000195C_TryAndCatch));
        ...
        {
            bool result = CF_00000195C_TryAndCatch.Solution_0_Test(input);
