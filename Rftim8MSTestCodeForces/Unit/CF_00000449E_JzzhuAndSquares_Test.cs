...
{
    [TestClass]
    public sealed class CF_00000449E_JzzhuAndSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000449E_JzzhuAndSquares));
        ...
        {
            bool result = CF_00000449E_JzzhuAndSquares.Solution_0_Test(input);
