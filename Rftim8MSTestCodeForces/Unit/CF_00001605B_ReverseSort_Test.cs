...
{
    [TestClass]
    public sealed class CF_00001605B_ReverseSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001605B_ReverseSort));
        ...
        {
            bool result = CF_00001605B_ReverseSort.Solution_0_Test(input);
