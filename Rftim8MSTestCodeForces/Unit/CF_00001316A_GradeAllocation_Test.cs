...
{
    [TestClass]
    public sealed class CF_00001316A_GradeAllocation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001316A_GradeAllocation));
        ...
        {
            bool result = CF_00001316A_GradeAllocation.Solution_0_Test(input);
