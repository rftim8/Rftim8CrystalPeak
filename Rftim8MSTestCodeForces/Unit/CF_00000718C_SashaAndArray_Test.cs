...
{
    [TestClass]
    public sealed class CF_00000718C_SashaAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000718C_SashaAndArray));
        ...
        {
            bool result = CF_00000718C_SashaAndArray.Solution_0_Test(input);
