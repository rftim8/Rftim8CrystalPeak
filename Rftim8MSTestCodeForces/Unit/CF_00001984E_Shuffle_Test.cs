...
{
    [TestClass]
    public sealed class CF_00001984E_Shuffle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001984E_Shuffle));
        ...
        {
            bool result = CF_00001984E_Shuffle.Solution_0_Test(input);
