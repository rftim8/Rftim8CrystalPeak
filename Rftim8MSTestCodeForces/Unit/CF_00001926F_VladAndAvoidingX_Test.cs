...
{
    [TestClass]
    public sealed class CF_00001926F_VladAndAvoidingX_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001926F_VladAndAvoidingX));
        ...
        {
            bool result = CF_00001926F_VladAndAvoidingX.Solution_0_Test(input);
