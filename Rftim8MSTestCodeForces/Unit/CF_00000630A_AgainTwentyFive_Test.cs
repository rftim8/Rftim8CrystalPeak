...
{
    [TestClass]
    public sealed class CF_00000630A_AgainTwentyFive_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630A_AgainTwentyFive));
        ...
        {
            bool result = CF_00000630A_AgainTwentyFive.Solution_0_Test(input);
