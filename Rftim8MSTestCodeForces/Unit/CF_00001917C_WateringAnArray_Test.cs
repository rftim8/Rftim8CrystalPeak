...
{
    [TestClass]
    public sealed class CF_00001917C_WateringAnArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001917C_WateringAnArray));
        ...
        {
            bool result = CF_00001917C_WateringAnArray.Solution_0_Test(input);
