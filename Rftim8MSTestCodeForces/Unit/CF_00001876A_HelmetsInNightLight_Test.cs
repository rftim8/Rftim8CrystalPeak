...
{
    [TestClass]
    public sealed class CF_00001876A_HelmetsInNightLight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001876A_HelmetsInNightLight));
        ...
        {
            bool result = CF_00001876A_HelmetsInNightLight.Solution_0_Test(input);
