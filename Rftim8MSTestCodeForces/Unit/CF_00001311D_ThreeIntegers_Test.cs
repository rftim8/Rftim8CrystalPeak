...
{
    [TestClass]
    public sealed class CF_00001311D_ThreeIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001311D_ThreeIntegers));
        ...
        {
            bool result = CF_00001311D_ThreeIntegers.Solution_0_Test(input);
