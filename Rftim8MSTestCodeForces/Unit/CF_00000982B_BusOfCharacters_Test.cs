...
{
    [TestClass]
    public sealed class CF_00000982B_BusOfCharacters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000982B_BusOfCharacters));
        ...
        {
            bool result = CF_00000982B_BusOfCharacters.Solution_0_Test(input);
