...
{
    [TestClass]
    public sealed class CF_00000140F_NewYearSnowflake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000140F_NewYearSnowflake));
        ...
        {
            bool result = CF_00000140F_NewYearSnowflake.Solution_0_Test(input);
