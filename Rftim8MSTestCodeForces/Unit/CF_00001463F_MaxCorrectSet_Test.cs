...
{
    [TestClass]
    public sealed class CF_00001463F_MaxCorrectSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001463F_MaxCorrectSet));
        ...
        {
            bool result = CF_00001463F_MaxCorrectSet.Solution_0_Test(input);
