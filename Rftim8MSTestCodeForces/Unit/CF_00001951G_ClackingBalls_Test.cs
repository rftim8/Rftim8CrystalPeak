...
{
    [TestClass]
    public sealed class CF_00001951G_ClackingBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001951G_ClackingBalls));
        ...
        {
            bool result = CF_00001951G_ClackingBalls.Solution_0_Test(input);
