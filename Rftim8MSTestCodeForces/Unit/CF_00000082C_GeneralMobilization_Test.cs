...
{
    [TestClass]
    public sealed class CF_00000082C_GeneralMobilization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000082C_GeneralMobilization));
        ...
        {
            bool result = CF_00000082C_GeneralMobilization.Solution_0_Test(input);
