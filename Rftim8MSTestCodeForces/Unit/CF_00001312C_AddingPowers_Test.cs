...
{
    [TestClass]
    public sealed class CF_00001312C_AddingPowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001312C_AddingPowers));
        ...
        {
            bool result = CF_00001312C_AddingPowers.Solution_0_Test(input);
