...
{
    [TestClass]
    public sealed class CF_00000586B_LaurentyAndShop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000586B_LaurentyAndShop));
        ...
        {
            bool result = CF_00000586B_LaurentyAndShop.Solution_0_Test(input);
