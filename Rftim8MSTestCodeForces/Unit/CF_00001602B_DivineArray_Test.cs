...
{
    [TestClass]
    public sealed class CF_00001602B_DivineArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001602B_DivineArray));
        ...
        {
            bool result = CF_00001602B_DivineArray.Solution_0_Test(input);
