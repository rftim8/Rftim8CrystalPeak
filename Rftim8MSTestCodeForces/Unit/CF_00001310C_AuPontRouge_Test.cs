...
{
    [TestClass]
    public sealed class CF_00001310C_AuPontRouge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001310C_AuPontRouge));
        ...
        {
            bool result = CF_00001310C_AuPontRouge.Solution_0_Test(input);
