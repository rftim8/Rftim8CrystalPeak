...
{
    [TestClass]
    public sealed class CF_00000134A_AverageNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000134A_AverageNumbers));
        ...
        {
            bool result = CF_00000134A_AverageNumbers.Solution_0_Test(input);
