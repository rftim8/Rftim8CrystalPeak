...
{
    [TestClass]
    public sealed class CF_00001654G_SnowyMountain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001654G_SnowyMountain));
        ...
        {
            bool result = CF_00001654G_SnowyMountain.Solution_0_Test(input);
