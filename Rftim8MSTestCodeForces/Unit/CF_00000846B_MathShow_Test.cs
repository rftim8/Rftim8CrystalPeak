...
{
    [TestClass]
    public sealed class CF_00000846B_MathShow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000846B_MathShow));
        ...
        {
            bool result = CF_00000846B_MathShow.Solution_0_Test(input);
