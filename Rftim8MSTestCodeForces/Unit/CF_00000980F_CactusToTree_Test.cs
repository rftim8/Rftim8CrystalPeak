...
{
    [TestClass]
    public sealed class CF_00000980F_CactusToTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000980F_CactusToTree));
        ...
        {
            bool result = CF_00000980F_CactusToTree.Solution_0_Test(input);
