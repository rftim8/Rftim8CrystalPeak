...
{
    [TestClass]
    public sealed class CF_00000528D_FuzzySearch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000528D_FuzzySearch));
        ...
        {
            bool result = CF_00000528D_FuzzySearch.Solution_0_Test(input);
