...
{
    [TestClass]
    public sealed class CF_00001955G_GCDOnAGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001955G_GCDOnAGrid));
        ...
        {
            bool result = CF_00001955G_GCDOnAGrid.Solution_0_Test(input);
