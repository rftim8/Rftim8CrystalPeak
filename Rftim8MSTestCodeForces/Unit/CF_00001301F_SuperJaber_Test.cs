...
{
    [TestClass]
    public sealed class CF_00001301F_SuperJaber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001301F_SuperJaber));
        ...
        {
            bool result = CF_00001301F_SuperJaber.Solution_0_Test(input);
