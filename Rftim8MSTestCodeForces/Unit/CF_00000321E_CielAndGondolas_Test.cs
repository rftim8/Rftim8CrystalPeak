...
{
    [TestClass]
    public sealed class CF_00000321E_CielAndGondolas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000321E_CielAndGondolas));
        ...
        {
            bool result = CF_00000321E_CielAndGondolas.Solution_0_Test(input);
