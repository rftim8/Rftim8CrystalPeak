...
{
    [TestClass]
    public sealed class CF_00000408A_LineToCashier_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000408A_LineToCashier));
        ...
        {
            bool result = CF_00000408A_LineToCashier.Solution_0_Test(input);
