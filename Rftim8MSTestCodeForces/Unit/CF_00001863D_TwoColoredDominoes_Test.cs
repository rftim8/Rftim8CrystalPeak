...
{
    [TestClass]
    public sealed class CF_00001863D_TwoColoredDominoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001863D_TwoColoredDominoes));
        ...
        {
            bool result = CF_00001863D_TwoColoredDominoes.Solution_0_Test(input);
