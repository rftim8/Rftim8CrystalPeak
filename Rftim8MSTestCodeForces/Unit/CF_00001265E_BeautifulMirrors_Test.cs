...
{
    [TestClass]
    public sealed class CF_00001265E_BeautifulMirrors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001265E_BeautifulMirrors));
        ...
        {
            bool result = CF_00001265E_BeautifulMirrors.Solution_0_Test(input);
