...
{
    [TestClass]
    public sealed class CF_00000224A_Parallelepiped_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000224A_Parallelepiped));
        ...
        {
            bool result = CF_00000224A_Parallelepiped.Solution_0_Test(input);
