...
{
    [TestClass]
    public sealed class CF_00001833D_Flipper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001833D_Flipper));
        ...
        {
            bool result = CF_00001833D_Flipper.Solution_0_Test(input);
