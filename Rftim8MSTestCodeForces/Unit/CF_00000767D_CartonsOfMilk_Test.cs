...
{
    [TestClass]
    public sealed class CF_00000767D_CartonsOfMilk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000767D_CartonsOfMilk));
        ...
        {
            bool result = CF_00000767D_CartonsOfMilk.Solution_0_Test(input);
