...
{
    [TestClass]
    public sealed class CF_00000049A_Sleuth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000049A_Sleuth));
        ...
        {
            bool result = CF_00000049A_Sleuth.Solution_0_Test(input);
