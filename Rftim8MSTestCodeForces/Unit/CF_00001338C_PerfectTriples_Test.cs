...
{
    [TestClass]
    public sealed class CF_00001338C_PerfectTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001338C_PerfectTriples));
        ...
        {
            bool result = CF_00001338C_PerfectTriples.Solution_0_Test(input);
