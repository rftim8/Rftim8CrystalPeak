...
{
    [TestClass]
    public sealed class CF_00000073B_NeedForBrake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000073B_NeedForBrake));
        ...
        {
            bool result = CF_00000073B_NeedForBrake.Solution_0_Test(input);
