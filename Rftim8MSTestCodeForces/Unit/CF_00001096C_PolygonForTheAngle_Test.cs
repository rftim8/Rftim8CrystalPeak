...
{
    [TestClass]
    public sealed class CF_00001096C_PolygonForTheAngle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001096C_PolygonForTheAngle));
        ...
        {
            bool result = CF_00001096C_PolygonForTheAngle.Solution_0_Test(input);
