...
{
    [TestClass]
    public sealed class CF_00001442B_IdentifyTheOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001442B_IdentifyTheOperations));
        ...
        {
            bool result = CF_00001442B_IdentifyTheOperations.Solution_0_Test(input);
