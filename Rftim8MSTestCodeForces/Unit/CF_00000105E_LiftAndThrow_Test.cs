...
{
    [TestClass]
    public sealed class CF_00000105E_LiftAndThrow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000105E_LiftAndThrow));
        ...
        {
            bool result = CF_00000105E_LiftAndThrow.Solution_0_Test(input);
