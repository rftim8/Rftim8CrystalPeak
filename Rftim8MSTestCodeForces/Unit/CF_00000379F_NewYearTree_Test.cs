...
{
    [TestClass]
    public sealed class CF_00000379F_NewYearTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000379F_NewYearTree));
        ...
        {
            bool result = CF_00000379F_NewYearTree.Solution_0_Test(input);
