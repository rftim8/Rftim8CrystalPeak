...
{
    [TestClass]
    public sealed class CF_00001335D_AntiSudoku_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001335D_AntiSudoku));
        ...
        {
            bool result = CF_00001335D_AntiSudoku.Solution_0_Test(input);
