...
{
    [TestClass]
    public sealed class CF_00000863E_TurnOffTheTV_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000863E_TurnOffTheTV));
        ...
        {
            bool result = CF_00000863E_TurnOffTheTV.Solution_0_Test(input);
