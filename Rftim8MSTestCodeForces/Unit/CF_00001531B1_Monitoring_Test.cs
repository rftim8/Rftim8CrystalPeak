...
{
    [TestClass]
    public sealed class CF_00001531B1_Monitoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001531B1_Monitoring));
        ...
        {
            bool result = CF_00001531B1_Monitoring.Solution_0_Test(input);
