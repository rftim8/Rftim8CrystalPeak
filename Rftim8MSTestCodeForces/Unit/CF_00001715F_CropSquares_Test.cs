...
{
    [TestClass]
    public sealed class CF_00001715F_CropSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001715F_CropSquares));
        ...
        {
            bool result = CF_00001715F_CropSquares.Solution_0_Test(input);
