...
{
    [TestClass]
    public sealed class CF_00001193B_MagicTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001193B_MagicTree));
        ...
        {
            bool result = CF_00001193B_MagicTree.Solution_0_Test(input);
