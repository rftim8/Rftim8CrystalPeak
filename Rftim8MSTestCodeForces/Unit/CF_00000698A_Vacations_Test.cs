...
{
    [TestClass]
    public sealed class CF_00000698A_Vacations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000698A_Vacations));
        ...
        {
            bool result = CF_00000698A_Vacations.Solution_0_Test(input);
