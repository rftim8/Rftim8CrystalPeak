...
{
    [TestClass]
    public sealed class CF_00001827E_BusRoutes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001827E_BusRoutes));
        ...
        {
            bool result = CF_00001827E_BusRoutes.Solution_0_Test(input);
