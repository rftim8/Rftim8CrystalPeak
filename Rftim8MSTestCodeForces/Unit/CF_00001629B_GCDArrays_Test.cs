...
{
    [TestClass]
    public sealed class CF_00001629B_GCDArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001629B_GCDArrays));
        ...
        {
            bool result = CF_00001629B_GCDArrays.Solution_0_Test(input);
