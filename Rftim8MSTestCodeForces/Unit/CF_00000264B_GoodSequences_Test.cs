...
{
    [TestClass]
    public sealed class CF_00000264B_GoodSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000264B_GoodSequences));
        ...
        {
            bool result = CF_00000264B_GoodSequences.Solution_0_Test(input);
