...
{
    [TestClass]
    public sealed class CF_00000771B_BearAndDifferentNames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000771B_BearAndDifferentNames));
        ...
        {
            bool result = CF_00000771B_BearAndDifferentNames.Solution_0_Test(input);
