...
{
    [TestClass]
    public sealed class CF_00001422E_Minlexes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001422E_Minlexes));
        ...
        {
            bool result = CF_00001422E_Minlexes.Solution_0_Test(input);
