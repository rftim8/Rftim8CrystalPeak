...
{
    [TestClass]
    public sealed class CF_00000914H_EmberAndStormsTreeGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000914H_EmberAndStormsTreeGame));
        ...
        {
            bool result = CF_00000914H_EmberAndStormsTreeGame.Solution_0_Test(input);
