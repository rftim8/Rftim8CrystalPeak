...
{
    [TestClass]
    public sealed class CF_00001373G_Pawns_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001373G_Pawns));
        ...
        {
            bool result = CF_00001373G_Pawns.Solution_0_Test(input);
