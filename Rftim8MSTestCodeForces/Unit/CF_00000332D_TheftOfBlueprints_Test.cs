...
{
    [TestClass]
    public sealed class CF_00000332D_TheftOfBlueprints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000332D_TheftOfBlueprints));
        ...
        {
            bool result = CF_00000332D_TheftOfBlueprints.Solution_0_Test(input);
