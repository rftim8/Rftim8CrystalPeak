...
{
    [TestClass]
    public sealed class CF_00000215C_Crosses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000215C_Crosses));
        ...
        {
            bool result = CF_00000215C_Crosses.Solution_0_Test(input);
