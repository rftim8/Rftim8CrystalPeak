...
{
    [TestClass]
    public sealed class CF_00000075B_FacetookPriorityWall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000075B_FacetookPriorityWall));
        ...
        {
            bool result = CF_00000075B_FacetookPriorityWall.Solution_0_Test(input);
