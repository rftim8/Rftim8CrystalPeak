...
{
    [TestClass]
    public sealed class CF_00000277A_LearningLanguages_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000277A_LearningLanguages));
        ...
        {
            bool result = CF_00000277A_LearningLanguages.Solution_0_Test(input);
