...
{
    [TestClass]
    public sealed class CF_00001055D_Refactoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001055D_Refactoring));
        ...
        {
            bool result = CF_00001055D_Refactoring.Solution_0_Test(input);
