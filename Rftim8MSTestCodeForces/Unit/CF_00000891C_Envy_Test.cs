...
{
    [TestClass]
    public sealed class CF_00000891C_Envy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000891C_Envy));
        ...
        {
            bool result = CF_00000891C_Envy.Solution_0_Test(input);
