...
{
    [TestClass]
    public sealed class CF_00001754A_TechnicalSupport_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001754A_TechnicalSupport));
        ...
        {
            bool result = CF_00001754A_TechnicalSupport.Solution_0_Test(input);
