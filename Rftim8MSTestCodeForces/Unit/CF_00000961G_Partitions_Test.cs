...
{
    [TestClass]
    public sealed class CF_00000961G_Partitions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000961G_Partitions));
        ...
        {
            bool result = CF_00000961G_Partitions.Solution_0_Test(input);
