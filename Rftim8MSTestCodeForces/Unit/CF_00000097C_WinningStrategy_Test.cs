...
{
    [TestClass]
    public sealed class CF_00000097C_WinningStrategy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000097C_WinningStrategy));
        ...
        {
            bool result = CF_00000097C_WinningStrategy.Solution_0_Test(input);
