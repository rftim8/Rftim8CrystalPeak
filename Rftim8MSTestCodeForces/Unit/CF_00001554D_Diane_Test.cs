...
{
    [TestClass]
    public sealed class CF_00001554D_Diane_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001554D_Diane));
        ...
        {
            bool result = CF_00001554D_Diane.Solution_0_Test(input);
