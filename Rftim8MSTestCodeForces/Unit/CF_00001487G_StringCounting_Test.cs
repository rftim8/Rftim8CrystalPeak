...
{
    [TestClass]
    public sealed class CF_00001487G_StringCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001487G_StringCounting));
        ...
        {
            bool result = CF_00001487G_StringCounting.Solution_0_Test(input);
