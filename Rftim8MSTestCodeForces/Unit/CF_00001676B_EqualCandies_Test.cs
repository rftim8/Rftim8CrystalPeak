...
{
    [TestClass]
    public sealed class CF_00001676B_EqualCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001676B_EqualCandies));
        ...
        {
            bool result = CF_00001676B_EqualCandies.Solution_0_Test(input);
