...
{
    [TestClass]
    public sealed class CF_00001147D_PalindromeXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001147D_PalindromeXOR));
        ...
        {
            bool result = CF_00001147D_PalindromeXOR.Solution_0_Test(input);
