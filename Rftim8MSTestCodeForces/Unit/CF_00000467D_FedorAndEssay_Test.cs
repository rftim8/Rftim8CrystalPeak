...
{
    [TestClass]
    public sealed class CF_00000467D_FedorAndEssay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000467D_FedorAndEssay));
        ...
        {
            bool result = CF_00000467D_FedorAndEssay.Solution_0_Test(input);
