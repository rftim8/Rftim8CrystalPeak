...
{
    [TestClass]
    public sealed class CF_00001551B1_WonderfulColoring1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001551B1_WonderfulColoring1));
        ...
        {
            bool result = CF_00001551B1_WonderfulColoring1.Solution_0_Test(input);
