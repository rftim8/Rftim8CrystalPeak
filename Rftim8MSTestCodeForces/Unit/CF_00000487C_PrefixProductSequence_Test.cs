...
{
    [TestClass]
    public sealed class CF_00000487C_PrefixProductSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000487C_PrefixProductSequence));
        ...
        {
            bool result = CF_00000487C_PrefixProductSequence.Solution_0_Test(input);
