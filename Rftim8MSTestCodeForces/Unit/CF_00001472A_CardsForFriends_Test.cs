...
{
    [TestClass]
    public sealed class CF_00001472A_CardsForFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001472A_CardsForFriends));
        ...
        {
            bool result = CF_00001472A_CardsForFriends.Solution_0_Test(input);
