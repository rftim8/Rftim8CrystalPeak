...
{
    [TestClass]
    public sealed class CF_00000471A_MUHAndSticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000471A_MUHAndSticks));
        ...
        {
            bool result = CF_00000471A_MUHAndSticks.Solution_0_Test(input);
