...
{
    [TestClass]
    public sealed class CF_00001662M_BottleArrangements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662M_BottleArrangements));
        ...
        {
            bool result = CF_00001662M_BottleArrangements.Solution_0_Test(input);
