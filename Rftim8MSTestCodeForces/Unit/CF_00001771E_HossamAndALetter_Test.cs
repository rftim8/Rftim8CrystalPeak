...
{
    [TestClass]
    public sealed class CF_00001771E_HossamAndALetter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001771E_HossamAndALetter));
        ...
        {
            bool result = CF_00001771E_HossamAndALetter.Solution_0_Test(input);
