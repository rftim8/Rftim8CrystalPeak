...
{
    [TestClass]
    public sealed class CF_00001622F_QuadraticSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001622F_QuadraticSet));
        ...
        {
            bool result = CF_00001622F_QuadraticSet.Solution_0_Test(input);
