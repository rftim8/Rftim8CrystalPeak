...
{
    [TestClass]
    public sealed class CF_00000476B_DreamoonAndWiFi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000476B_DreamoonAndWiFi));
        ...
        {
            bool result = CF_00000476B_DreamoonAndWiFi.Solution_0_Test(input);
