...
{
    [TestClass]
    public sealed class CF_00001178A_PrimeMinister_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001178A_PrimeMinister));
        ...
        {
            bool result = CF_00001178A_PrimeMinister.Solution_0_Test(input);
