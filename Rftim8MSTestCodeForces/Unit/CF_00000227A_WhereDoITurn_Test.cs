...
{
    [TestClass]
    public sealed class CF_00000227A_WhereDoITurn_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000227A_WhereDoITurn));
        ...
        {
            bool result = CF_00000227A_WhereDoITurn.Solution_0_Test(input);
