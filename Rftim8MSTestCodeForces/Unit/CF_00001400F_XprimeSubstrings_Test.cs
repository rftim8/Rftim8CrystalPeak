...
{
    [TestClass]
    public sealed class CF_00001400F_XprimeSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001400F_XprimeSubstrings));
        ...
        {
            bool result = CF_00001400F_XprimeSubstrings.Solution_0_Test(input);
