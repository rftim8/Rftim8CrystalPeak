...
{
    [TestClass]
    public sealed class CF_00001402C_StarTrek_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001402C_StarTrek));
        ...
        {
            bool result = CF_00001402C_StarTrek.Solution_0_Test(input);
