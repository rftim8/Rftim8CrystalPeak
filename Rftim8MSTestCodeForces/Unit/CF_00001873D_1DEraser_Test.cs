...
{
    [TestClass]
    public sealed class CF_00001873D_1DEraser_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001873D_1DEraser));
        ...
        {
            bool result = CF_00001873D_1DEraser.Solution_0_Test(input);
