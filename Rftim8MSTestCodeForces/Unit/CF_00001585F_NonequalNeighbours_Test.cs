...
{
    [TestClass]
    public sealed class CF_00001585F_NonequalNeighbours_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001585F_NonequalNeighbours));
        ...
        {
            bool result = CF_00001585F_NonequalNeighbours.Solution_0_Test(input);
