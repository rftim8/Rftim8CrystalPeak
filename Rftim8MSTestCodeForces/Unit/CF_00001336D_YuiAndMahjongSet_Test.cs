...
{
    [TestClass]
    public sealed class CF_00001336D_YuiAndMahjongSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001336D_YuiAndMahjongSet));
        ...
        {
            bool result = CF_00001336D_YuiAndMahjongSet.Solution_0_Test(input);
