...
{
    [TestClass]
    public sealed class CF_00001038D_Slime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001038D_Slime));
        ...
        {
            bool result = CF_00001038D_Slime.Solution_0_Test(input);
