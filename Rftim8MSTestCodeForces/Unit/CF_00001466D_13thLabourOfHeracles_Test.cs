...
{
    [TestClass]
    public sealed class CF_00001466D_13thLabourOfHeracles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001466D_13thLabourOfHeracles));
        ...
        {
            bool result = CF_00001466D_13thLabourOfHeracles.Solution_0_Test(input);
