...
{
    [TestClass]
    public sealed class CF_00001268D_InvertationInTournament_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001268D_InvertationInTournament));
        ...
        {
            bool result = CF_00001268D_InvertationInTournament.Solution_0_Test(input);
