...
{
    [TestClass]
    public sealed class CF_00001354B_TernaryString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001354B_TernaryString));
        ...
        {
            bool result = CF_00001354B_TernaryString.Solution_0_Test(input);
