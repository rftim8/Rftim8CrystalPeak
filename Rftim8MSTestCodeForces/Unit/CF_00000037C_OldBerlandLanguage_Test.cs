...
{
    [TestClass]
    public sealed class CF_00000037C_OldBerlandLanguage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000037C_OldBerlandLanguage));
        ...
        {
            bool result = CF_00000037C_OldBerlandLanguage.Solution_0_Test(input);
