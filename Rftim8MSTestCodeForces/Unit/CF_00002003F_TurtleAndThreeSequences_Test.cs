...
{
    [TestClass]
    public sealed class CF_00002003F_TurtleAndThreeSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002003F_TurtleAndThreeSequences));
        ...
        {
            bool result = CF_00002003F_TurtleAndThreeSequences.Solution_0_Test(input);
