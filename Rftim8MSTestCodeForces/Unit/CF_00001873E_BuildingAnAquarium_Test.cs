...
{
    [TestClass]
    public sealed class CF_00001873E_BuildingAnAquarium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001873E_BuildingAnAquarium));
        ...
        {
            bool result = CF_00001873E_BuildingAnAquarium.Solution_0_Test(input);
