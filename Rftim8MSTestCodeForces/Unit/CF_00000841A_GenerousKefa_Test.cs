...
{
    [TestClass]
    public sealed class CF_00000841A_GenerousKefa_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000841A_GenerousKefa));
        ...
        {
            bool result = CF_00000841A_GenerousKefa.Solution_0_Test(input);
