...
{
    [TestClass]
    public sealed class CF_00000784E_TwistedCircuit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000784E_TwistedCircuit));
        ...
        {
            bool result = CF_00000784E_TwistedCircuit.Solution_0_Test(input);
