...
{
    [TestClass]
    public sealed class CF_00001776N_CountPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001776N_CountPermutations));
        ...
        {
            bool result = CF_00001776N_CountPermutations.Solution_0_Test(input);
