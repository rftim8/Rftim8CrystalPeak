...
{
    [TestClass]
    public sealed class CF_00001919A_WalletExchange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001919A_WalletExchange));
        ...
        {
            bool result = CF_00001919A_WalletExchange.Solution_0_Test(input);
