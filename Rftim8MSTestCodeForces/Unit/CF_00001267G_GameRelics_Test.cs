...
{
    [TestClass]
    public sealed class CF_00001267G_GameRelics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001267G_GameRelics));
        ...
        {
            bool result = CF_00001267G_GameRelics.Solution_0_Test(input);
