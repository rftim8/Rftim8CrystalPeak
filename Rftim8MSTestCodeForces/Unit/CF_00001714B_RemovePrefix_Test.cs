...
{
    [TestClass]
    public sealed class CF_00001714B_RemovePrefix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001714B_RemovePrefix));
        ...
        {
            bool result = CF_00001714B_RemovePrefix.Solution_0_Test(input);
