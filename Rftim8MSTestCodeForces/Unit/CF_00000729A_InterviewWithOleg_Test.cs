...
{
    [TestClass]
    public sealed class CF_00000729A_InterviewWithOleg_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000729A_InterviewWithOleg));
        ...
        {
            bool result = CF_00000729A_InterviewWithOleg.Solution_0_Test(input);
