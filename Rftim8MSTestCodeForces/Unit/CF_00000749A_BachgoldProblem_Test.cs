...
{
    [TestClass]
    public sealed class CF_00000749A_BachgoldProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000749A_BachgoldProblem));
        ...
        {
            bool result = CF_00000749A_BachgoldProblem.Solution_0_Test(input);
