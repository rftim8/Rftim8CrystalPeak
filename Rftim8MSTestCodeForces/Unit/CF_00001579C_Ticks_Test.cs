...
{
    [TestClass]
    public sealed class CF_00001579C_Ticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001579C_Ticks));
        ...
        {
            bool result = CF_00001579C_Ticks.Solution_0_Test(input);
