...
{
    [TestClass]
    public sealed class CF_00000192A_FunkyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000192A_FunkyNumbers));
        ...
        {
            bool result = CF_00000192A_FunkyNumbers.Solution_0_Test(input);
