...
{
    [TestClass]
    public sealed class CF_00000047E_Cannon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000047E_Cannon));
        ...
        {
            bool result = CF_00000047E_Cannon.Solution_0_Test(input);
