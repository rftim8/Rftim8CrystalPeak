...
{
    [TestClass]
    public sealed class CF_00000465B_Inbox100500_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000465B_Inbox100500));
        ...
        {
            bool result = CF_00000465B_Inbox100500.Solution_0_Test(input);
