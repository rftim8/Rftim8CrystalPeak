...
{
    [TestClass]
    public sealed class CF_00001705B_MarkTheDustSweeper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001705B_MarkTheDustSweeper));
        ...
        {
            bool result = CF_00001705B_MarkTheDustSweeper.Solution_0_Test(input);
