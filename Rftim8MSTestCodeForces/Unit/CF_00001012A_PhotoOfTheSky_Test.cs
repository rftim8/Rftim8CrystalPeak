...
{
    [TestClass]
    public sealed class CF_00001012A_PhotoOfTheSky_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001012A_PhotoOfTheSky));
        ...
        {
            bool result = CF_00001012A_PhotoOfTheSky.Solution_0_Test(input);
