...
{
    [TestClass]
    public sealed class CF_00001748C_ZeroSumPrefixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001748C_ZeroSumPrefixes));
        ...
        {
            bool result = CF_00001748C_ZeroSumPrefixes.Solution_0_Test(input);
