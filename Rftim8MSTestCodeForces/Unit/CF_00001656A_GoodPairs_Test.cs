...
{
    [TestClass]
    public sealed class CF_00001656A_GoodPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001656A_GoodPairs));
        ...
        {
            bool result = CF_00001656A_GoodPairs.Solution_0_Test(input);
