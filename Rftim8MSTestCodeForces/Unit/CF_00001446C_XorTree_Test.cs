...
{
    [TestClass]
    public sealed class CF_00001446C_XorTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001446C_XorTree));
        ...
        {
            bool result = CF_00001446C_XorTree.Solution_0_Test(input);
