...
{
    [TestClass]
    public sealed class CF_00001836B_Astrophysicists_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001836B_Astrophysicists));
        ...
        {
            bool result = CF_00001836B_Astrophysicists.Solution_0_Test(input);
