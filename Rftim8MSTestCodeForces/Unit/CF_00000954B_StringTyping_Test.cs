...
{
    [TestClass]
    public sealed class CF_00000954B_StringTyping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000954B_StringTyping));
        ...
        {
            bool result = CF_00000954B_StringTyping.Solution_0_Test(input);
