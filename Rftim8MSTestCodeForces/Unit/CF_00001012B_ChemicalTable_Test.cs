...
{
    [TestClass]
    public sealed class CF_00001012B_ChemicalTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001012B_ChemicalTable));
        ...
        {
            bool result = CF_00001012B_ChemicalTable.Solution_0_Test(input);
