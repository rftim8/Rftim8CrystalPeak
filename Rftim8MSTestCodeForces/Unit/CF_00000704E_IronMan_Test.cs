...
{
    [TestClass]
    public sealed class CF_00000704E_IronMan_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000704E_IronMan));
        ...
        {
            bool result = CF_00000704E_IronMan.Solution_0_Test(input);
