...
{
    [TestClass]
    public sealed class CF_00001722D_Line_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001722D_Line));
        ...
        {
            bool result = CF_00001722D_Line.Solution_0_Test(input);
