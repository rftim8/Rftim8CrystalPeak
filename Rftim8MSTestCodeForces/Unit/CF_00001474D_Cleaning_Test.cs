...
{
    [TestClass]
    public sealed class CF_00001474D_Cleaning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001474D_Cleaning));
        ...
        {
            bool result = CF_00001474D_Cleaning.Solution_0_Test(input);
