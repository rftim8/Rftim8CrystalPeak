...
{
    [TestClass]
    public sealed class CF_00001795B_IdealPoint_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001795B_IdealPoint));
        ...
        {
            bool result = CF_00001795B_IdealPoint.Solution_0_Test(input);
