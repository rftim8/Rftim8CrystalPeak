...
{
    [TestClass]
    public sealed class CF_00000930D_GameWithTokens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000930D_GameWithTokens));
        ...
        {
            bool result = CF_00000930D_GameWithTokens.Solution_0_Test(input);
