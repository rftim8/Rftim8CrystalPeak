...
{
    [TestClass]
    public sealed class CF_00001868B1_CandyPartyEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001868B1_CandyPartyEasyVersion));
        ...
        {
            bool result = CF_00001868B1_CandyPartyEasyVersion.Solution_0_Test(input);
