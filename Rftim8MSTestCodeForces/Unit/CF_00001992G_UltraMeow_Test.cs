...
{
    [TestClass]
    public sealed class CF_00001992G_UltraMeow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001992G_UltraMeow));
        ...
        {
            bool result = CF_00001992G_UltraMeow.Solution_0_Test(input);
