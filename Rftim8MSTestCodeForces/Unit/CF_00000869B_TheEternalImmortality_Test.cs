...
{
    [TestClass]
    public sealed class CF_00000869B_TheEternalImmortality_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000869B_TheEternalImmortality));
        ...
        {
            bool result = CF_00000869B_TheEternalImmortality.Solution_0_Test(input);
