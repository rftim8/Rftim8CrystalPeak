...
{
    [TestClass]
    public sealed class CF_00001682B_ANDSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001682B_ANDSorting));
        ...
        {
            bool result = CF_00001682B_ANDSorting.Solution_0_Test(input);
