...
{
    [TestClass]
    public sealed class CF_00001148D_DirtyDeedsDoneDirtCheap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001148D_DirtyDeedsDoneDirtCheap));
        ...
        {
            bool result = CF_00001148D_DirtyDeedsDoneDirtCheap.Solution_0_Test(input);
