...
{
    [TestClass]
    public sealed class CF_00001914G1_LightBulbsEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001914G1_LightBulbsEasyVersion));
        ...
        {
            bool result = CF_00001914G1_LightBulbsEasyVersion.Solution_0_Test(input);
