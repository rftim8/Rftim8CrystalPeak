...
{
    [TestClass]
    public sealed class CF_00000739A_AlyonaAndMex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000739A_AlyonaAndMex));
        ...
        {
            bool result = CF_00000739A_AlyonaAndMex.Solution_0_Test(input);
