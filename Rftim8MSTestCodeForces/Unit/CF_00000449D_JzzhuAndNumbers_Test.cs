...
{
    [TestClass]
    public sealed class CF_00000449D_JzzhuAndNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000449D_JzzhuAndNumbers));
        ...
        {
            bool result = CF_00000449D_JzzhuAndNumbers.Solution_0_Test(input);
