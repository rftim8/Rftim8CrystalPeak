...
{
    [TestClass]
    public sealed class CF_00000596A_WilburAndSwimmingPool_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000596A_WilburAndSwimmingPool));
        ...
        {
            bool result = CF_00000596A_WilburAndSwimmingPool.Solution_0_Test(input);
