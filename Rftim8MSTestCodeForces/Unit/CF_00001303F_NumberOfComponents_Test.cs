...
{
    [TestClass]
    public sealed class CF_00001303F_NumberOfComponents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001303F_NumberOfComponents));
        ...
        {
            bool result = CF_00001303F_NumberOfComponents.Solution_0_Test(input);
