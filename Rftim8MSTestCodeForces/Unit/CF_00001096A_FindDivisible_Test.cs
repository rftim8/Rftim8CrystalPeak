...
{
    [TestClass]
    public sealed class CF_00001096A_FindDivisible_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001096A_FindDivisible));
        ...
        {
            bool result = CF_00001096A_FindDivisible.Solution_0_Test(input);
