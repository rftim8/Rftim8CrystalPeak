...
{
    [TestClass]
    public sealed class CF_00001443B_SavingTheCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001443B_SavingTheCity));
        ...
        {
            bool result = CF_00001443B_SavingTheCity.Solution_0_Test(input);
