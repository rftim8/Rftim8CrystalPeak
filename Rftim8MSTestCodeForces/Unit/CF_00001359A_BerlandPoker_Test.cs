...
{
    [TestClass]
    public sealed class CF_00001359A_BerlandPoker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001359A_BerlandPoker));
        ...
        {
            bool result = CF_00001359A_BerlandPoker.Solution_0_Test(input);
