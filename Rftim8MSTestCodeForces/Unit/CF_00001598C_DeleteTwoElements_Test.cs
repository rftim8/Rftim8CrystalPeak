...
{
    [TestClass]
    public sealed class CF_00001598C_DeleteTwoElements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001598C_DeleteTwoElements));
        ...
        {
            bool result = CF_00001598C_DeleteTwoElements.Solution_0_Test(input);
