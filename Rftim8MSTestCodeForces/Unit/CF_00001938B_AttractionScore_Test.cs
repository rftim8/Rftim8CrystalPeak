...
{
    [TestClass]
    public sealed class CF_00001938B_AttractionScore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001938B_AttractionScore));
        ...
        {
            bool result = CF_00001938B_AttractionScore.Solution_0_Test(input);
