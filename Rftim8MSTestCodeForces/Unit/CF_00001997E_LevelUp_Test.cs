...
{
    [TestClass]
    public sealed class CF_00001997E_LevelUp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001997E_LevelUp));
        ...
        {
            bool result = CF_00001997E_LevelUp.Solution_0_Test(input);
