...
{
    [TestClass]
    public sealed class CF_00001422F_BoringQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001422F_BoringQueries));
        ...
        {
            bool result = CF_00001422F_BoringQueries.Solution_0_Test(input);
