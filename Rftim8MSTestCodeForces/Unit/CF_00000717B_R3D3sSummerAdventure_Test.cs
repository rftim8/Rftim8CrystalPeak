...
{
    [TestClass]
    public sealed class CF_00000717B_R3D3sSummerAdventure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000717B_R3D3sSummerAdventure));
        ...
        {
            bool result = CF_00000717B_R3D3sSummerAdventure.Solution_0_Test(input);
