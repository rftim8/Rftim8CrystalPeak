...
{
    [TestClass]
    public sealed class CF_00000050C_HappyFarm5_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000050C_HappyFarm5));
        ...
        {
            bool result = CF_00000050C_HappyFarm5.Solution_0_Test(input);
