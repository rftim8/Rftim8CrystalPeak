...
{
    [TestClass]
    public sealed class CF_00001511F_Chainword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001511F_Chainword));
        ...
        {
            bool result = CF_00001511F_Chainword.Solution_0_Test(input);
