...
{
    [TestClass]
    public sealed class CF_00001520B_OrdinaryNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001520B_OrdinaryNumbers));
        ...
        {
            bool result = CF_00001520B_OrdinaryNumbers.Solution_0_Test(input);
