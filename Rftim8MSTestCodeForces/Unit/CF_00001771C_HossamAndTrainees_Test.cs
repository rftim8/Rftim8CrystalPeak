...
{
    [TestClass]
    public sealed class CF_00001771C_HossamAndTrainees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001771C_HossamAndTrainees));
        ...
        {
            bool result = CF_00001771C_HossamAndTrainees.Solution_0_Test(input);
