...
{
    [TestClass]
    public sealed class CF_00000323A_BlackandWhiteCube_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000323A_BlackandWhiteCube));
        ...
        {
            bool result = CF_00000323A_BlackandWhiteCube.Solution_0_Test(input);
