...
{
    [TestClass]
    public sealed class CF_00000071B_ProgressBar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000071B_ProgressBar));
        ...
        {
            bool result = CF_00000071B_ProgressBar.Solution_0_Test(input);
