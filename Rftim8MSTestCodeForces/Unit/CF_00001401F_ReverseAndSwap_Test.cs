...
{
    [TestClass]
    public sealed class CF_00001401F_ReverseAndSwap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001401F_ReverseAndSwap));
        ...
        {
            bool result = CF_00001401F_ReverseAndSwap.Solution_0_Test(input);
