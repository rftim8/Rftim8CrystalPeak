...
{
    [TestClass]
    public sealed class CF_00000488B_CandyBoxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000488B_CandyBoxes));
        ...
        {
            bool result = CF_00000488B_CandyBoxes.Solution_0_Test(input);
