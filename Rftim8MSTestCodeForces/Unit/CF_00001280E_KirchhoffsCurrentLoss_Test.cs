...
{
    [TestClass]
    public sealed class CF_00001280E_KirchhoffsCurrentLoss_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001280E_KirchhoffsCurrentLoss));
        ...
        {
            bool result = CF_00001280E_KirchhoffsCurrentLoss.Solution_0_Test(input);
