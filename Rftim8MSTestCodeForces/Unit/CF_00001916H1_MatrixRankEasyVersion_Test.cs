...
{
    [TestClass]
    public sealed class CF_00001916H1_MatrixRankEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001916H1_MatrixRankEasyVersion));
        ...
        {
            bool result = CF_00001916H1_MatrixRankEasyVersion.Solution_0_Test(input);
