...
{
    [TestClass]
    public sealed class CF_00000023C_OrangesAndApples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000023C_OrangesAndApples));
        ...
        {
            bool result = CF_00000023C_OrangesAndApples.Solution_0_Test(input);
