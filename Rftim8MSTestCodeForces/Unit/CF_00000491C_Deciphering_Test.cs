...
{
    [TestClass]
    public sealed class CF_00000491C_Deciphering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000491C_Deciphering));
        ...
        {
            bool result = CF_00000491C_Deciphering.Solution_0_Test(input);
