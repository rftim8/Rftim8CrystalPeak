...
{
    [TestClass]
    public sealed class CF_00001089F_Fractions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001089F_Fractions));
        ...
        {
            bool result = CF_00001089F_Fractions.Solution_0_Test(input);
