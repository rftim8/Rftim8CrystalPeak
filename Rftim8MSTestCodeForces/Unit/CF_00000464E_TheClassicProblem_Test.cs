...
{
    [TestClass]
    public sealed class CF_00000464E_TheClassicProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000464E_TheClassicProblem));
        ...
        {
            bool result = CF_00000464E_TheClassicProblem.Solution_0_Test(input);
