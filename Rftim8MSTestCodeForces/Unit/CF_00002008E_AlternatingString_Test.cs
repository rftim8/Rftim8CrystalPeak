...
{
    [TestClass]
    public sealed class CF_00002008E_AlternatingString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002008E_AlternatingString));
        ...
        {
            bool result = CF_00002008E_AlternatingString.Solution_0_Test(input);
