...
{
    [TestClass]
    public sealed class CF_00002020C_BitwiseBalancing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002020C_BitwiseBalancing));
        ...
        {
            bool result = CF_00002020C_BitwiseBalancing.Solution_0_Test(input);
