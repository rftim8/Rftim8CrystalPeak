...
{
    [TestClass]
    public sealed class CF_00000328B_SheldonAndIcePieces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000328B_SheldonAndIcePieces));
        ...
        {
            bool result = CF_00000328B_SheldonAndIcePieces.Solution_0_Test(input);
