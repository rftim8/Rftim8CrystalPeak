...
{
    [TestClass]
    public sealed class CF_00000774B_SignificantCups_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774B_SignificantCups));
        ...
        {
            bool result = CF_00000774B_SignificantCups.Solution_0_Test(input);
