...
{
    [TestClass]
    public sealed class CF_00002027A_RectangleArrangement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002027A_RectangleArrangement));
        ...
        {
            bool result = CF_00002027A_RectangleArrangement.Solution_0_Test(input);
