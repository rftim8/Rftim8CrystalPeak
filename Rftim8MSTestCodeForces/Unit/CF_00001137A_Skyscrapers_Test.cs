...
{
    [TestClass]
    public sealed class CF_00001137A_Skyscrapers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001137A_Skyscrapers));
        ...
        {
            bool result = CF_00001137A_Skyscrapers.Solution_0_Test(input);
