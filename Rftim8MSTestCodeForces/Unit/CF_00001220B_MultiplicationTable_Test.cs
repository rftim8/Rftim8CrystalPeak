...
{
    [TestClass]
    public sealed class CF_00001220B_MultiplicationTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001220B_MultiplicationTable));
        ...
        {
            bool result = CF_00001220B_MultiplicationTable.Solution_0_Test(input);
