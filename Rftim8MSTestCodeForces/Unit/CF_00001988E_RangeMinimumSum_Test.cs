...
{
    [TestClass]
    public sealed class CF_00001988E_RangeMinimumSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001988E_RangeMinimumSum));
        ...
        {
            bool result = CF_00001988E_RangeMinimumSum.Solution_0_Test(input);
