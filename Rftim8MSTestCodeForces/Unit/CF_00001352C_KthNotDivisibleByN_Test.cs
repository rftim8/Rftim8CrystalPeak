...
{
    [TestClass]
    public sealed class CF_00001352C_KthNotDivisibleByN_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001352C_KthNotDivisibleByN));
        ...
        {
            bool result = CF_00001352C_KthNotDivisibleByN.Solution_0_Test(input);
