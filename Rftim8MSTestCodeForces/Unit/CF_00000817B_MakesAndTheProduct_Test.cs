...
{
    [TestClass]
    public sealed class CF_00000817B_MakesAndTheProduct_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000817B_MakesAndTheProduct));
        ...
        {
            bool result = CF_00000817B_MakesAndTheProduct.Solution_0_Test(input);
