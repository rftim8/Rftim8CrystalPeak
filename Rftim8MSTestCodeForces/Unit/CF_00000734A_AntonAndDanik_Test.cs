...
{
    [TestClass]
    public sealed class CF_00000734A_AntonAndDanik_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000734A_AntonAndDanik));
        ...
        {
            bool result = CF_00000734A_AntonAndDanik.Solution_0_Test(input);
