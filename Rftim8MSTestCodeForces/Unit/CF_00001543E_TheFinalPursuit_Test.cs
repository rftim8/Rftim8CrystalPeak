...
{
    [TestClass]
    public sealed class CF_00001543E_TheFinalPursuit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001543E_TheFinalPursuit));
        ...
        {
            bool result = CF_00001543E_TheFinalPursuit.Solution_0_Test(input);
