...
{
    [TestClass]
    public sealed class CF_00001633B_Minority_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001633B_Minority));
        ...
        {
            bool result = CF_00001633B_Minority.Solution_0_Test(input);
