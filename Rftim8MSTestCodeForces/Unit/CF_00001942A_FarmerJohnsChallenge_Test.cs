...
{
    [TestClass]
    public sealed class CF_00001942A_FarmerJohnsChallenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001942A_FarmerJohnsChallenge));
        ...
        {
            bool result = CF_00001942A_FarmerJohnsChallenge.Solution_0_Test(input);
