...
{
    [TestClass]
    public sealed class CF_00002011E_RockPaperScissorsBot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002011E_RockPaperScissorsBot));
        ...
        {
            bool result = CF_00002011E_RockPaperScissorsBot.Solution_0_Test(input);
