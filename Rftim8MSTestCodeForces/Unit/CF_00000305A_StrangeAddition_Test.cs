...
{
    [TestClass]
    public sealed class CF_00000305A_StrangeAddition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000305A_StrangeAddition));
        ...
        {
            bool result = CF_00000305A_StrangeAddition.Solution_0_Test(input);
