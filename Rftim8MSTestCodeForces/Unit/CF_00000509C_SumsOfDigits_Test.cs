...
{
    [TestClass]
    public sealed class CF_00000509C_SumsOfDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000509C_SumsOfDigits));
        ...
        {
            bool result = CF_00000509C_SumsOfDigits.Solution_0_Test(input);
