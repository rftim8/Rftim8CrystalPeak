...
{
    [TestClass]
    public sealed class CF_00001658D2_388535HardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001658D2_388535HardVersion));
        ...
        {
            bool result = CF_00001658D2_388535HardVersion.Solution_0_Test(input);
