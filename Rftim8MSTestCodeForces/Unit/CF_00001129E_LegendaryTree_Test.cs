...
{
    [TestClass]
    public sealed class CF_00001129E_LegendaryTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001129E_LegendaryTree));
        ...
        {
            bool result = CF_00001129E_LegendaryTree.Solution_0_Test(input);
