...
{
    [TestClass]
    public sealed class CF_00001431A_SellingHamburgers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001431A_SellingHamburgers));
        ...
        {
            bool result = CF_00001431A_SellingHamburgers.Solution_0_Test(input);
