...
{
    [TestClass]
    public sealed class CF_00000995D_Game_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000995D_Game));
        ...
        {
            bool result = CF_00000995D_Game.Solution_0_Test(input);
