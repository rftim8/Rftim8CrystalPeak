...
{
    [TestClass]
    public sealed class CF_00001846B_RudolphAndTicTacToe_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001846B_RudolphAndTicTacToe));
        ...
        {
            bool result = CF_00001846B_RudolphAndTicTacToe.Solution_0_Test(input);
