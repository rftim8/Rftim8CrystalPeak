...
{
    [TestClass]
    public sealed class CF_00001807B_GrabTheCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001807B_GrabTheCandies));
        ...
        {
            bool result = CF_00001807B_GrabTheCandies.Solution_0_Test(input);
