...
{
    [TestClass]
    public sealed class CF_00002014D_RobertHoodAndMrsHood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002014D_RobertHoodAndMrsHood));
        ...
        {
            bool result = CF_00002014D_RobertHoodAndMrsHood.Solution_0_Test(input);
