...
{
    [TestClass]
    public sealed class CF_00000768E_GameOfStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000768E_GameOfStones));
        ...
        {
            bool result = CF_00000768E_GameOfStones.Solution_0_Test(input);
