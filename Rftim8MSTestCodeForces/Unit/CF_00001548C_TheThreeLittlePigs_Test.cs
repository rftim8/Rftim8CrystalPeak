...
{
    [TestClass]
    public sealed class CF_00001548C_TheThreeLittlePigs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001548C_TheThreeLittlePigs));
        ...
        {
            bool result = CF_00001548C_TheThreeLittlePigs.Solution_0_Test(input);
