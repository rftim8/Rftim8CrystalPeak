...
{
    [TestClass]
    public sealed class CF_00001066B_Heaters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001066B_Heaters));
        ...
        {
            bool result = CF_00001066B_Heaters.Solution_0_Test(input);
