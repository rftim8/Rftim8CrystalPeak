...
{
    [TestClass]
    public sealed class CF_00000156D_Clues_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000156D_Clues));
        ...
        {
            bool result = CF_00000156D_Clues.Solution_0_Test(input);
