...
{
    [TestClass]
    public sealed class CF_00001574F_Occurrences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001574F_Occurrences));
        ...
        {
            bool result = CF_00001574F_Occurrences.Solution_0_Test(input);
