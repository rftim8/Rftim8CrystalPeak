...
{
    [TestClass]
    public sealed class CF_00000980E_TheNumberGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000980E_TheNumberGames));
        ...
        {
            bool result = CF_00000980E_TheNumberGames.Solution_0_Test(input);
