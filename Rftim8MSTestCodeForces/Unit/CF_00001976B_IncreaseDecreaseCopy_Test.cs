...
{
    [TestClass]
    public sealed class CF_00001976B_IncreaseDecreaseCopy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001976B_IncreaseDecreaseCopy));
        ...
        {
            bool result = CF_00001976B_IncreaseDecreaseCopy.Solution_0_Test(input);
