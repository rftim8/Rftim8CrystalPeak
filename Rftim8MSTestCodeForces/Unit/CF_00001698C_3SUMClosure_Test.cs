...
{
    [TestClass]
    public sealed class CF_00001698C_3SUMClosure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001698C_3SUMClosure));
        ...
        {
            bool result = CF_00001698C_3SUMClosure.Solution_0_Test(input);
