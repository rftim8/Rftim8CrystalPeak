...
{
    [TestClass]
    public sealed class CF_00000721E_RoadToHome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000721E_RoadToHome));
        ...
        {
            bool result = CF_00000721E_RoadToHome.Solution_0_Test(input);
