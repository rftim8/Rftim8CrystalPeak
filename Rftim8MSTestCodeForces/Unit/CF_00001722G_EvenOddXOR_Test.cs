...
{
    [TestClass]
    public sealed class CF_00001722G_EvenOddXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001722G_EvenOddXOR));
        ...
        {
            bool result = CF_00001722G_EvenOddXOR.Solution_0_Test(input);
