...
{
    [TestClass]
    public sealed class CF_00001699B_AlmostTernaryMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001699B_AlmostTernaryMatrix));
        ...
        {
            bool result = CF_00001699B_AlmostTernaryMatrix.Solution_0_Test(input);
