...
{
    [TestClass]
    public sealed class CF_00001725C_CircularMirror_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725C_CircularMirror));
        ...
        {
            bool result = CF_00001725C_CircularMirror.Solution_0_Test(input);
