...
{
    [TestClass]
    public sealed class CF_00001485C_FloorAndMod_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001485C_FloorAndMod));
        ...
        {
            bool result = CF_00001485C_FloorAndMod.Solution_0_Test(input);
