...
{
    [TestClass]
    public sealed class CF_00001868B2_CandyPartyHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001868B2_CandyPartyHardVersion));
        ...
        {
            bool result = CF_00001868B2_CandyPartyHardVersion.Solution_0_Test(input);
