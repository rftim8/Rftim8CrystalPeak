...
{
    [TestClass]
    public sealed class CF_00000533B_WorkGroup_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000533B_WorkGroup));
        ...
        {
            bool result = CF_00000533B_WorkGroup.Solution_0_Test(input);
