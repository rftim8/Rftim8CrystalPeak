...
{
    [TestClass]
    public sealed class CF_00002023B_Skipping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002023B_Skipping));
        ...
        {
            bool result = CF_00002023B_Skipping.Solution_0_Test(input);
