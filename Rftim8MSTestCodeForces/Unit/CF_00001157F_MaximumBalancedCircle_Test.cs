...
{
    [TestClass]
    public sealed class CF_00001157F_MaximumBalancedCircle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001157F_MaximumBalancedCircle));
        ...
        {
            bool result = CF_00001157F_MaximumBalancedCircle.Solution_0_Test(input);
