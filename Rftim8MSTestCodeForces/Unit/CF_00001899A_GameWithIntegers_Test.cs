...
{
    [TestClass]
    public sealed class CF_00001899A_GameWithIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001899A_GameWithIntegers));
        ...
        {
            bool result = CF_00001899A_GameWithIntegers.Solution_0_Test(input);
