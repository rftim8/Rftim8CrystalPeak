...
{
    [TestClass]
    public sealed class CF_00002018B_Speedbreaker_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002018B_Speedbreaker));
        ...
        {
            bool result = CF_00002018B_Speedbreaker.Solution_0_Test(input);
