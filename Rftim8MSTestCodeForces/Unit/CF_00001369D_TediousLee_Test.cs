...
{
    [TestClass]
    public sealed class CF_00001369D_TediousLee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001369D_TediousLee));
        ...
        {
            bool result = CF_00001369D_TediousLee.Solution_0_Test(input);
