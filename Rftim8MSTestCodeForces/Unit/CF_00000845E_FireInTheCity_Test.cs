...
{
    [TestClass]
    public sealed class CF_00000845E_FireInTheCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000845E_FireInTheCity));
        ...
        {
            bool result = CF_00000845E_FireInTheCity.Solution_0_Test(input);
