...
{
    [TestClass]
    public sealed class CF_00001901B_ChipAndRibbon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001901B_ChipAndRibbon));
        ...
        {
            bool result = CF_00001901B_ChipAndRibbon.Solution_0_Test(input);
