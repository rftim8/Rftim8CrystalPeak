...
{
    [TestClass]
    public sealed class CF_00000339E_ThreeSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000339E_ThreeSwaps));
        ...
        {
            bool result = CF_00000339E_ThreeSwaps.Solution_0_Test(input);
