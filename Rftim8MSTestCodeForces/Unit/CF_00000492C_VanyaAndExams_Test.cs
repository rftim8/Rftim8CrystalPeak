...
{
    [TestClass]
    public sealed class CF_00000492C_VanyaAndExams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000492C_VanyaAndExams));
        ...
        {
            bool result = CF_00000492C_VanyaAndExams.Solution_0_Test(input);
