...
{
    [TestClass]
    public sealed class CF_00000750B_NewYearAndNorthPole_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000750B_NewYearAndNorthPole));
        ...
        {
            bool result = CF_00000750B_NewYearAndNorthPole.Solution_0_Test(input);
