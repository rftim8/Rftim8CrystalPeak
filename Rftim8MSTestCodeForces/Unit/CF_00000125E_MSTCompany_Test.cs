...
{
    [TestClass]
    public sealed class CF_00000125E_MSTCompany_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000125E_MSTCompany));
        ...
        {
            bool result = CF_00000125E_MSTCompany.Solution_0_Test(input);
