...
{
    [TestClass]
    public sealed class CF_00001992F_ValuableCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001992F_ValuableCards));
        ...
        {
            bool result = CF_00001992F_ValuableCards.Solution_0_Test(input);
