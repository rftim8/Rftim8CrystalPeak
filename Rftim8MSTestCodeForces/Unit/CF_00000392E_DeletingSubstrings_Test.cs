...
{
    [TestClass]
    public sealed class CF_00000392E_DeletingSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000392E_DeletingSubstrings));
        ...
        {
            bool result = CF_00000392E_DeletingSubstrings.Solution_0_Test(input);
