...
{
    [TestClass]
    public sealed class CF_00000805B_3palindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000805B_3palindrome));
        ...
        {
            bool result = CF_00000805B_3palindrome.Solution_0_Test(input);
