...
{
    [TestClass]
    public sealed class CF_00001554C_Mikasa_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001554C_Mikasa));
        ...
        {
            bool result = CF_00001554C_Mikasa.Solution_0_Test(input);
