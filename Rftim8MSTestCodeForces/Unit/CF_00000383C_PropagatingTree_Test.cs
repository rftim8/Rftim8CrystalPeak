...
{
    [TestClass]
    public sealed class CF_00000383C_PropagatingTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000383C_PropagatingTree));
        ...
        {
            bool result = CF_00000383C_PropagatingTree.Solution_0_Test(input);
