...
{
    [TestClass]
    public sealed class CF_00000119C_EducationReform_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000119C_EducationReform));
        ...
        {
            bool result = CF_00000119C_EducationReform.Solution_0_Test(input);
