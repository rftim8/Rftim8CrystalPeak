...
{
    [TestClass]
    public sealed class CF_00001255B_FridgeLockers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001255B_FridgeLockers));
        ...
        {
            bool result = CF_00001255B_FridgeLockers.Solution_0_Test(input);
