...
{
    [TestClass]
    public sealed class CF_00000887B_CubesForMasha_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000887B_CubesForMasha));
        ...
        {
            bool result = CF_00000887B_CubesForMasha.Solution_0_Test(input);
