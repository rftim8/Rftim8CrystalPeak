...
{
    [TestClass]
    public sealed class CF_00000926E_MergeEqualElements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000926E_MergeEqualElements));
        ...
        {
            bool result = CF_00000926E_MergeEqualElements.Solution_0_Test(input);
