...
{
    [TestClass]
    public sealed class CF_00000725E_TooMuchMoney_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000725E_TooMuchMoney));
        ...
        {
            bool result = CF_00000725E_TooMuchMoney.Solution_0_Test(input);
