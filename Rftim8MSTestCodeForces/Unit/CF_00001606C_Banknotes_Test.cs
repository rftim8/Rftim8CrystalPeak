...
{
    [TestClass]
    public sealed class CF_00001606C_Banknotes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001606C_Banknotes));
        ...
        {
            bool result = CF_00001606C_Banknotes.Solution_0_Test(input);
