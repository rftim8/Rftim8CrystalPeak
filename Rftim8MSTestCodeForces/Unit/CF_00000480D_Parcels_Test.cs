...
{
    [TestClass]
    public sealed class CF_00000480D_Parcels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000480D_Parcels));
        ...
        {
            bool result = CF_00000480D_Parcels.Solution_0_Test(input);
