...
{
    [TestClass]
    public sealed class CF_00000575C_Party_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000575C_Party));
        ...
        {
            bool result = CF_00000575C_Party.Solution_0_Test(input);
