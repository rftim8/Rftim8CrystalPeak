...
{
    [TestClass]
    public sealed class CF_00001606F_TreeQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001606F_TreeQueries));
        ...
        {
            bool result = CF_00001606F_TreeQueries.Solution_0_Test(input);
