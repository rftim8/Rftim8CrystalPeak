...
{
    [TestClass]
    public sealed class CF_00001883G1_DancesEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001883G1_DancesEasyVersion));
        ...
        {
            bool result = CF_00001883G1_DancesEasyVersion.Solution_0_Test(input);
