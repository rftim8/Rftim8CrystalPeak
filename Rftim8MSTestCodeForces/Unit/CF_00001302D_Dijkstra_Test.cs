...
{
    [TestClass]
    public sealed class CF_00001302D_Dijkstra_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001302D_Dijkstra));
        ...
        {
            bool result = CF_00001302D_Dijkstra.Solution_0_Test(input);
