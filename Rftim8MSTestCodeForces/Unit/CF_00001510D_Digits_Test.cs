...
{
    [TestClass]
    public sealed class CF_00001510D_Digits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001510D_Digits));
        ...
        {
            bool result = CF_00001510D_Digits.Solution_0_Test(input);
