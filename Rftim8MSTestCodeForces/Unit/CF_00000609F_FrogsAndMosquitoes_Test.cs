...
{
    [TestClass]
    public sealed class CF_00000609F_FrogsAndMosquitoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000609F_FrogsAndMosquitoes));
        ...
        {
            bool result = CF_00000609F_FrogsAndMosquitoes.Solution_0_Test(input);
