...
{
    [TestClass]
    public sealed class CF_00001056H_DetectRobots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001056H_DetectRobots));
        ...
        {
            bool result = CF_00001056H_DetectRobots.Solution_0_Test(input);
