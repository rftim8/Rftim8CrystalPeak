...
{
    [TestClass]
    public sealed class CF_00000339B_XeniaAndRingroad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000339B_XeniaAndRingroad));
        ...
        {
            bool result = CF_00000339B_XeniaAndRingroad.Solution_0_Test(input);
