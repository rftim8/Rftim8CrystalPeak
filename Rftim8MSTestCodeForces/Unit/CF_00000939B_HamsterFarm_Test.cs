...
{
    [TestClass]
    public sealed class CF_00000939B_HamsterFarm_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000939B_HamsterFarm));
        ...
        {
            bool result = CF_00000939B_HamsterFarm.Solution_0_Test(input);
