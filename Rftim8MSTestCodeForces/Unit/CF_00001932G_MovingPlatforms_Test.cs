...
{
    [TestClass]
    public sealed class CF_00001932G_MovingPlatforms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001932G_MovingPlatforms));
        ...
        {
            bool result = CF_00001932G_MovingPlatforms.Solution_0_Test(input);
