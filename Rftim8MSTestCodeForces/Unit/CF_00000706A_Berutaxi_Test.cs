...
{
    [TestClass]
    public sealed class CF_00000706A_Berutaxi_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000706A_Berutaxi));
        ...
        {
            bool result = CF_00000706A_Berutaxi.Solution_0_Test(input);
