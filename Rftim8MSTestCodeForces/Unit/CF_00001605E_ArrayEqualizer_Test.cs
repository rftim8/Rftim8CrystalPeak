...
{
    [TestClass]
    public sealed class CF_00001605E_ArrayEqualizer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001605E_ArrayEqualizer));
        ...
        {
            bool result = CF_00001605E_ArrayEqualizer.Solution_0_Test(input);
