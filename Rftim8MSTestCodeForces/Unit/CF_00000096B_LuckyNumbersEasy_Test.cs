...
{
    [TestClass]
    public sealed class CF_00000096B_LuckyNumbersEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000096B_LuckyNumbersEasy));
        ...
        {
            bool result = CF_00000096B_LuckyNumbersEasy.Solution_0_Test(input);
