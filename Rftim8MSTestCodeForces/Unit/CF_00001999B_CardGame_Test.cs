...
{
    [TestClass]
    public sealed class CF_00001999B_CardGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001999B_CardGame));
        ...
        {
            bool result = CF_00001999B_CardGame.Solution_0_Test(input);
