...
{
    [TestClass]
    public sealed class CF_00000055A_FleaTravel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000055A_FleaTravel));
        ...
        {
            bool result = CF_00000055A_FleaTravel.Solution_0_Test(input);
