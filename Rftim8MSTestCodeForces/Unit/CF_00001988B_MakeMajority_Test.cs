...
{
    [TestClass]
    public sealed class CF_00001988B_MakeMajority_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001988B_MakeMajority));
        ...
        {
            bool result = CF_00001988B_MakeMajority.Solution_0_Test(input);
