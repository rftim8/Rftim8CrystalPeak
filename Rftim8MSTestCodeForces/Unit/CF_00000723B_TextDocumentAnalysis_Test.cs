...
{
    [TestClass]
    public sealed class CF_00000723B_TextDocumentAnalysis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000723B_TextDocumentAnalysis));
        ...
        {
            bool result = CF_00000723B_TextDocumentAnalysis.Solution_0_Test(input);
