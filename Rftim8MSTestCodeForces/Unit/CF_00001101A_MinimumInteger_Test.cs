...
{
    [TestClass]
    public sealed class CF_00001101A_MinimumInteger_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001101A_MinimumInteger));
        ...
        {
            bool result = CF_00001101A_MinimumInteger.Solution_0_Test(input);
