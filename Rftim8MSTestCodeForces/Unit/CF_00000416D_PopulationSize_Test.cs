...
{
    [TestClass]
    public sealed class CF_00000416D_PopulationSize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000416D_PopulationSize));
        ...
        {
            bool result = CF_00000416D_PopulationSize.Solution_0_Test(input);
