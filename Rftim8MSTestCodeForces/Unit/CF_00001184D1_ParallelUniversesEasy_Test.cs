...
{
    [TestClass]
    public sealed class CF_00001184D1_ParallelUniversesEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001184D1_ParallelUniversesEasy));
        ...
        {
            bool result = CF_00001184D1_ParallelUniversesEasy.Solution_0_Test(input);
