...
{
    [TestClass]
    public sealed class CF_00001758E_TickTock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001758E_TickTock));
        ...
        {
            bool result = CF_00001758E_TickTock.Solution_0_Test(input);
