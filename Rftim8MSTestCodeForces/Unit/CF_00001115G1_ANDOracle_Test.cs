...
{
    [TestClass]
    public sealed class CF_00001115G1_ANDOracle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001115G1_ANDOracle));
        ...
        {
            bool result = CF_00001115G1_ANDOracle.Solution_0_Test(input);
