...
{
    [TestClass]
    public sealed class CF_00001397A_JugglingLetters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001397A_JugglingLetters));
        ...
        {
            bool result = CF_00001397A_JugglingLetters.Solution_0_Test(input);
