...
{
    [TestClass]
    public sealed class CF_00001110A_Parity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001110A_Parity));
        ...
        {
            bool result = CF_00001110A_Parity.Solution_0_Test(input);
