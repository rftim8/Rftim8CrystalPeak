...
{
    [TestClass]
    public sealed class CF_00001593F_RedBlackNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001593F_RedBlackNumber));
        ...
        {
            bool result = CF_00001593F_RedBlackNumber.Solution_0_Test(input);
