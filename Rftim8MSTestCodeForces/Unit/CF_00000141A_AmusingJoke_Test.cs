...
{
    [TestClass]
    public sealed class CF_00000141A_AmusingJoke_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000141A_AmusingJoke));
        ...
        {
            bool result = CF_00000141A_AmusingJoke.Solution_0_Test(input);
