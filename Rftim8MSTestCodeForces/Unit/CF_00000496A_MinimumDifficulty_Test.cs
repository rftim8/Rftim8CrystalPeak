...
{
    [TestClass]
    public sealed class CF_00000496A_MinimumDifficulty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000496A_MinimumDifficulty));
        ...
        {
            bool result = CF_00000496A_MinimumDifficulty.Solution_0_Test(input);
