...
{
    [TestClass]
    public sealed class CF_00000802N_AprilFoolsProblemMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802N_AprilFoolsProblemMedium));
        ...
        {
            bool result = CF_00000802N_AprilFoolsProblemMedium.Solution_0_Test(input);
