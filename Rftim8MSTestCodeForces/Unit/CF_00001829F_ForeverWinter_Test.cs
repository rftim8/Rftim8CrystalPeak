...
{
    [TestClass]
    public sealed class CF_00001829F_ForeverWinter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001829F_ForeverWinter));
        ...
        {
            bool result = CF_00001829F_ForeverWinter.Solution_0_Test(input);
