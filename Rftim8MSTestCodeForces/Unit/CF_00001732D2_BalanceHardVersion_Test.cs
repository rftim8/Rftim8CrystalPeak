...
{
    [TestClass]
    public sealed class CF_00001732D2_BalanceHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001732D2_BalanceHardVersion));
        ...
        {
            bool result = CF_00001732D2_BalanceHardVersion.Solution_0_Test(input);
