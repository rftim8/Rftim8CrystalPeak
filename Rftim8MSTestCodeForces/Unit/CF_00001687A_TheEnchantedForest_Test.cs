...
{
    [TestClass]
    public sealed class CF_00001687A_TheEnchantedForest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001687A_TheEnchantedForest));
        ...
        {
            bool result = CF_00001687A_TheEnchantedForest.Solution_0_Test(input);
