...
{
    [TestClass]
    public sealed class CF_00001548A_WebOfLies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001548A_WebOfLies));
        ...
        {
            bool result = CF_00001548A_WebOfLies.Solution_0_Test(input);
