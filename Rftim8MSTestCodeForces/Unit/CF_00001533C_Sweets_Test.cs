...
{
    [TestClass]
    public sealed class CF_00001533C_Sweets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001533C_Sweets));
        ...
        {
            bool result = CF_00001533C_Sweets.Solution_0_Test(input);
