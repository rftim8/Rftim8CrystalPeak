...
{
    [TestClass]
    public sealed class CF_00000418E_TrickyPassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000418E_TrickyPassword));
        ...
        {
            bool result = CF_00000418E_TrickyPassword.Solution_0_Test(input);
