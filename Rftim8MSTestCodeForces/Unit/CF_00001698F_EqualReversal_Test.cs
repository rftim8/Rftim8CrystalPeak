...
{
    [TestClass]
    public sealed class CF_00001698F_EqualReversal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001698F_EqualReversal));
        ...
        {
            bool result = CF_00001698F_EqualReversal.Solution_0_Test(input);
