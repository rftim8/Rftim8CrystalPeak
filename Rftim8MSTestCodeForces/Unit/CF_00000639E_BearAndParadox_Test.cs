...
{
    [TestClass]
    public sealed class CF_00000639E_BearAndParadox_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000639E_BearAndParadox));
        ...
        {
            bool result = CF_00000639E_BearAndParadox.Solution_0_Test(input);
