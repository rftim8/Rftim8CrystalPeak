...
{
    [TestClass]
    public sealed class CF_00001854A2_DualHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001854A2_DualHardVersion));
        ...
        {
            bool result = CF_00001854A2_DualHardVersion.Solution_0_Test(input);
