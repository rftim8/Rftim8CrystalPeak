...
{
    [TestClass]
    public sealed class CF_00001326G_SpiderwebTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001326G_SpiderwebTrees));
        ...
        {
            bool result = CF_00001326G_SpiderwebTrees.Solution_0_Test(input);
