...
{
    [TestClass]
    public sealed class CF_00001107D_Compression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001107D_Compression));
        ...
        {
            bool result = CF_00001107D_Compression.Solution_0_Test(input);
