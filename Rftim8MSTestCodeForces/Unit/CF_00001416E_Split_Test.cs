...
{
    [TestClass]
    public sealed class CF_00001416E_Split_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001416E_Split));
        ...
        {
            bool result = CF_00001416E_Split.Solution_0_Test(input);
