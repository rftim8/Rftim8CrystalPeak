...
{
    [TestClass]
    public sealed class CF_00001662A_OrganizingSWERC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662A_OrganizingSWERC));
        ...
        {
            bool result = CF_00001662A_OrganizingSWERC.Solution_0_Test(input);
