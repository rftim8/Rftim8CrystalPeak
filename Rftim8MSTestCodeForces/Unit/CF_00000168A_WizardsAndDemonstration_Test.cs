...
{
    [TestClass]
    public sealed class CF_00000168A_WizardsAndDemonstration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000168A_WizardsAndDemonstration));
        ...
        {
            bool result = CF_00000168A_WizardsAndDemonstration.Solution_0_Test(input);
