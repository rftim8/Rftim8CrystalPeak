...
{
    [TestClass]
    public sealed class CF_00000723C_PolycarpAtTheRadio_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000723C_PolycarpAtTheRadio));
        ...
        {
            bool result = CF_00000723C_PolycarpAtTheRadio.Solution_0_Test(input);
