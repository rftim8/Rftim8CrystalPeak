...
{
    [TestClass]
    public sealed class CF_00000661A_LazyCatererSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000661A_LazyCatererSequence));
        ...
        {
            bool result = CF_00000661A_LazyCatererSequence.Solution_0_Test(input);
