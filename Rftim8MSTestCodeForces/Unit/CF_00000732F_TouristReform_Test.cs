...
{
    [TestClass]
    public sealed class CF_00000732F_TouristReform_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000732F_TouristReform));
        ...
        {
            bool result = CF_00000732F_TouristReform.Solution_0_Test(input);
