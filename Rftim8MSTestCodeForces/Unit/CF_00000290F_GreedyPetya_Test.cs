...
{
    [TestClass]
    public sealed class CF_00000290F_GreedyPetya_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000290F_GreedyPetya));
        ...
        {
            bool result = CF_00000290F_GreedyPetya.Solution_0_Test(input);
