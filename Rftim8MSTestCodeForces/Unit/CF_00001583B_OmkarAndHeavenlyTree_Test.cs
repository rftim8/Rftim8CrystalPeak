...
{
    [TestClass]
    public sealed class CF_00001583B_OmkarAndHeavenlyTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001583B_OmkarAndHeavenlyTree));
        ...
        {
            bool result = CF_00001583B_OmkarAndHeavenlyTree.Solution_0_Test(input);
