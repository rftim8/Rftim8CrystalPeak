...
{
    [TestClass]
    public sealed class CF_00001843D_AppleTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001843D_AppleTree));
        ...
        {
            bool result = CF_00001843D_AppleTree.Solution_0_Test(input);
