...
{
    [TestClass]
    public sealed class CF_00002013D_MinimizeTheDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002013D_MinimizeTheDifference));
        ...
        {
            bool result = CF_00002013D_MinimizeTheDifference.Solution_0_Test(input);
