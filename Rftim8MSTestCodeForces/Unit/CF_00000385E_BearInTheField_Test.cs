...
{
    [TestClass]
    public sealed class CF_00000385E_BearInTheField_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000385E_BearInTheField));
        ...
        {
            bool result = CF_00000385E_BearInTheField.Solution_0_Test(input);
