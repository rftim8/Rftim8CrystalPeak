...
{
    [TestClass]
    public sealed class CF_00000145C_LuckySubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000145C_LuckySubsequence));
        ...
        {
            bool result = CF_00000145C_LuckySubsequence.Solution_0_Test(input);
