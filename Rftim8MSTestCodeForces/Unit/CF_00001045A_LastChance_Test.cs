...
{
    [TestClass]
    public sealed class CF_00001045A_LastChance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001045A_LastChance));
        ...
        {
            bool result = CF_00001045A_LastChance.Solution_0_Test(input);
