...
{
    [TestClass]
    public sealed class CF_00000898F_RestoringTheExpression_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000898F_RestoringTheExpression));
        ...
        {
            bool result = CF_00000898F_RestoringTheExpression.Solution_0_Test(input);
