...
{
    [TestClass]
    public sealed class CF_00001288D_MinimaxProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001288D_MinimaxProblem));
        ...
        {
            bool result = CF_00001288D_MinimaxProblem.Solution_0_Test(input);
