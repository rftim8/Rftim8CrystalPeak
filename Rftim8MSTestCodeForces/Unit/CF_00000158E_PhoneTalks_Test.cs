...
{
    [TestClass]
    public sealed class CF_00000158E_PhoneTalks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000158E_PhoneTalks));
        ...
        {
            bool result = CF_00000158E_PhoneTalks.Solution_0_Test(input);
