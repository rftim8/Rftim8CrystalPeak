...
{
    [TestClass]
    public sealed class CF_00001452A_RobotProgram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001452A_RobotProgram));
        ...
        {
            bool result = CF_00001452A_RobotProgram.Solution_0_Test(input);
