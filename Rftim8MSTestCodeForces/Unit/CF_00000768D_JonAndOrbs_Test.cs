...
{
    [TestClass]
    public sealed class CF_00000768D_JonAndOrbs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000768D_JonAndOrbs));
        ...
        {
            bool result = CF_00000768D_JonAndOrbs.Solution_0_Test(input);
