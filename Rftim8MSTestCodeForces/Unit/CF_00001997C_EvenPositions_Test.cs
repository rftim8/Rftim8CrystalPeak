...
{
    [TestClass]
    public sealed class CF_00001997C_EvenPositions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001997C_EvenPositions));
        ...
        {
            bool result = CF_00001997C_EvenPositions.Solution_0_Test(input);
