...
{
    [TestClass]
    public sealed class CF_00001365G_SecurePassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001365G_SecurePassword));
        ...
        {
            bool result = CF_00001365G_SecurePassword.Solution_0_Test(input);
