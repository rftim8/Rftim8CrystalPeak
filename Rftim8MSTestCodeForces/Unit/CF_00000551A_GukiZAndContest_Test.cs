...
{
    [TestClass]
    public sealed class CF_00000551A_GukiZAndContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000551A_GukiZAndContest));
        ...
        {
            bool result = CF_00000551A_GukiZAndContest.Solution_0_Test(input);
