...
{
    [TestClass]
    public sealed class CF_00000112B_PetyaAndSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000112B_PetyaAndSquare));
        ...
        {
            bool result = CF_00000112B_PetyaAndSquare.Solution_0_Test(input);
