...
{
    [TestClass]
    public sealed class CF_00000794G_ReplaceAll_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000794G_ReplaceAll));
        ...
        {
            bool result = CF_00000794G_ReplaceAll.Solution_0_Test(input);
