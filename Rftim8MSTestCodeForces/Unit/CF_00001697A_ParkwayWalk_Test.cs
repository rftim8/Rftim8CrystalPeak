...
{
    [TestClass]
    public sealed class CF_00001697A_ParkwayWalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001697A_ParkwayWalk));
        ...
        {
            bool result = CF_00001697A_ParkwayWalk.Solution_0_Test(input);
