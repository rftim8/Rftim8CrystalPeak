...
{
    [TestClass]
    public sealed class CF_00001617C_PaprikaAndPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001617C_PaprikaAndPermutation));
        ...
        {
            bool result = CF_00001617C_PaprikaAndPermutation.Solution_0_Test(input);
