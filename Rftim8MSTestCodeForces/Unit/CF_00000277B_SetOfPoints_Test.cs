...
{
    [TestClass]
    public sealed class CF_00000277B_SetOfPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000277B_SetOfPoints));
        ...
        {
            bool result = CF_00000277B_SetOfPoints.Solution_0_Test(input);
