...
{
    [TestClass]
    public sealed class CF_00000999C_AlphabeticRemovals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000999C_AlphabeticRemovals));
        ...
        {
            bool result = CF_00000999C_AlphabeticRemovals.Solution_0_Test(input);
