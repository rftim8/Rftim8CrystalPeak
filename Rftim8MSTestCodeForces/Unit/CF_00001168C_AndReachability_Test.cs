...
{
    [TestClass]
    public sealed class CF_00001168C_AndReachability_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001168C_AndReachability));
        ...
        {
            bool result = CF_00001168C_AndReachability.Solution_0_Test(input);
