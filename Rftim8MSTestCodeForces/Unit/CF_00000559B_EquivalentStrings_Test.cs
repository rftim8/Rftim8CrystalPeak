...
{
    [TestClass]
    public sealed class CF_00000559B_EquivalentStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000559B_EquivalentStrings));
        ...
        {
            bool result = CF_00000559B_EquivalentStrings.Solution_0_Test(input);
