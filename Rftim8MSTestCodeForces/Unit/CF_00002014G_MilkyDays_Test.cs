...
{
    [TestClass]
    public sealed class CF_00002014G_MilkyDays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002014G_MilkyDays));
        ...
        {
            bool result = CF_00002014G_MilkyDays.Solution_0_Test(input);
