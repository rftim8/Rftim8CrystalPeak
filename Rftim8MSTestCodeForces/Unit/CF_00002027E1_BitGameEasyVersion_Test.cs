...
{
    [TestClass]
    public sealed class CF_00002027E1_BitGameEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002027E1_BitGameEasyVersion));
        ...
        {
            bool result = CF_00002027E1_BitGameEasyVersion.Solution_0_Test(input);
