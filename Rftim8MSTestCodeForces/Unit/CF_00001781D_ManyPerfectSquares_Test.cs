...
{
    [TestClass]
    public sealed class CF_00001781D_ManyPerfectSquares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001781D_ManyPerfectSquares));
        ...
        {
            bool result = CF_00001781D_ManyPerfectSquares.Solution_0_Test(input);
