...
{
    [TestClass]
    public sealed class CF_00001903C_TheofanisNightmare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001903C_TheofanisNightmare));
        ...
        {
            bool result = CF_00001903C_TheofanisNightmare.Solution_0_Test(input);
