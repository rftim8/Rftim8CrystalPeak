...
{
    [TestClass]
    public sealed class CF_00001838D_BracketWalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001838D_BracketWalk));
        ...
        {
            bool result = CF_00001838D_BracketWalk.Solution_0_Test(input);
