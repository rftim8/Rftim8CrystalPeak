...
{
    [TestClass]
    public sealed class CF_00000038B_Chess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000038B_Chess));
        ...
        {
            bool result = CF_00000038B_Chess.Solution_0_Test(input);
