...
{
    [TestClass]
    public sealed class CF_00001365C_RotationMatching_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001365C_RotationMatching));
        ...
        {
            bool result = CF_00001365C_RotationMatching.Solution_0_Test(input);
