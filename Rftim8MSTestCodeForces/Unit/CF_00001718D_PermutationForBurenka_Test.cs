...
{
    [TestClass]
    public sealed class CF_00001718D_PermutationForBurenka_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001718D_PermutationForBurenka));
        ...
        {
            bool result = CF_00001718D_PermutationForBurenka.Solution_0_Test(input);
