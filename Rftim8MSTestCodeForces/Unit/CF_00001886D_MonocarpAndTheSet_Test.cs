...
{
    [TestClass]
    public sealed class CF_00001886D_MonocarpAndTheSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001886D_MonocarpAndTheSet));
        ...
        {
            bool result = CF_00001886D_MonocarpAndTheSet.Solution_0_Test(input);
