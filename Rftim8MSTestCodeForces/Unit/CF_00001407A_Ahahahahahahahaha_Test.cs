...
{
    [TestClass]
    public sealed class CF_00001407A_Ahahahahahahahaha_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001407A_Ahahahahahahahaha));
        ...
        {
            bool result = CF_00001407A_Ahahahahahahahaha.Solution_0_Test(input);
