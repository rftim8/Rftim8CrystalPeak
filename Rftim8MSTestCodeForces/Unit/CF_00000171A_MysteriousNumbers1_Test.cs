...
{
    [TestClass]
    public sealed class CF_00000171A_MysteriousNumbers1_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000171A_MysteriousNumbers1));
        ...
        {
            bool result = CF_00000171A_MysteriousNumbers1.Solution_0_Test(input);
