...
{
    [TestClass]
    public sealed class CF_00000620C_PearlsInARow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000620C_PearlsInARow));
        ...
        {
            bool result = CF_00000620C_PearlsInARow.Solution_0_Test(input);
