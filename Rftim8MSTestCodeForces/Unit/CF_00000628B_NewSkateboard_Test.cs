...
{
    [TestClass]
    public sealed class CF_00000628B_NewSkateboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000628B_NewSkateboard));
        ...
        {
            bool result = CF_00000628B_NewSkateboard.Solution_0_Test(input);
