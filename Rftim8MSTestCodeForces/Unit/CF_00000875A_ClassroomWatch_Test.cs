...
{
    [TestClass]
    public sealed class CF_00000875A_ClassroomWatch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000875A_ClassroomWatch));
        ...
        {
            bool result = CF_00000875A_ClassroomWatch.Solution_0_Test(input);
