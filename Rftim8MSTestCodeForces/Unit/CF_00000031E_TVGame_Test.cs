...
{
    [TestClass]
    public sealed class CF_00000031E_TVGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000031E_TVGame));
        ...
        {
            bool result = CF_00000031E_TVGame.Solution_0_Test(input);
