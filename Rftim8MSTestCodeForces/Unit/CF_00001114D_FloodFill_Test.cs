...
{
    [TestClass]
    public sealed class CF_00001114D_FloodFill_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001114D_FloodFill));
        ...
        {
            bool result = CF_00001114D_FloodFill.Solution_0_Test(input);
