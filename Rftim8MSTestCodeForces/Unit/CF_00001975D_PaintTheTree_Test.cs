...
{
    [TestClass]
    public sealed class CF_00001975D_PaintTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001975D_PaintTheTree));
        ...
        {
            bool result = CF_00001975D_PaintTheTree.Solution_0_Test(input);
