...
{
    [TestClass]
    public sealed class CF_00000182B_VasyasCalendar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000182B_VasyasCalendar));
        ...
        {
            bool result = CF_00000182B_VasyasCalendar.Solution_0_Test(input);
