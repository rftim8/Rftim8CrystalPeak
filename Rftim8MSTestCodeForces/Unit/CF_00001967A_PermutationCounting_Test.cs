...
{
    [TestClass]
    public sealed class CF_00001967A_PermutationCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001967A_PermutationCounting));
        ...
        {
            bool result = CF_00001967A_PermutationCounting.Solution_0_Test(input);
