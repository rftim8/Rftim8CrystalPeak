...
{
    [TestClass]
    public sealed class CF_00000405D_ToySum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000405D_ToySum));
        ...
        {
            bool result = CF_00000405D_ToySum.Solution_0_Test(input);
