...
{
    [TestClass]
    public sealed class CF_00000633C_SpySyndrome2_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000633C_SpySyndrome2));
        ...
        {
            bool result = CF_00000633C_SpySyndrome2.Solution_0_Test(input);
