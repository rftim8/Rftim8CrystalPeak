...
{
    [TestClass]
    public sealed class CF_00000789A_AnastasiaAndPebbles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000789A_AnastasiaAndPebbles));
        ...
        {
            bool result = CF_00000789A_AnastasiaAndPebbles.Solution_0_Test(input);
