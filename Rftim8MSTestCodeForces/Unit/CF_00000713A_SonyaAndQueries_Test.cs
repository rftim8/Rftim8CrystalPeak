...
{
    [TestClass]
    public sealed class CF_00000713A_SonyaAndQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000713A_SonyaAndQueries));
        ...
        {
            bool result = CF_00000713A_SonyaAndQueries.Solution_0_Test(input);
