...
{
    [TestClass]
    public sealed class CF_00001045I_PalindromePairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001045I_PalindromePairs));
        ...
        {
            bool result = CF_00001045I_PalindromePairs.Solution_0_Test(input);
