...
{
    [TestClass]
    public sealed class CF_00000982A_Row_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000982A_Row));
        ...
        {
            bool result = CF_00000982A_Row.Solution_0_Test(input);
