...
{
    [TestClass]
    public sealed class CF_00001726E_AlmostPerfect_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001726E_AlmostPerfect));
        ...
        {
            bool result = CF_00001726E_AlmostPerfect.Solution_0_Test(input);
