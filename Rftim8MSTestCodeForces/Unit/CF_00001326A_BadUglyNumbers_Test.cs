...
{
    [TestClass]
    public sealed class CF_00001326A_BadUglyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001326A_BadUglyNumbers));
        ...
        {
            bool result = CF_00001326A_BadUglyNumbers.Solution_0_Test(input);
