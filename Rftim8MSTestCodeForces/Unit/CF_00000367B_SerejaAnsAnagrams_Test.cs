...
{
    [TestClass]
    public sealed class CF_00000367B_SerejaAnsAnagrams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000367B_SerejaAnsAnagrams));
        ...
        {
            bool result = CF_00000367B_SerejaAnsAnagrams.Solution_0_Test(input);
