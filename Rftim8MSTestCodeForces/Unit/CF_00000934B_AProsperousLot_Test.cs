...
{
    [TestClass]
    public sealed class CF_00000934B_AProsperousLot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000934B_AProsperousLot));
        ...
        {
            bool result = CF_00000934B_AProsperousLot.Solution_0_Test(input);
