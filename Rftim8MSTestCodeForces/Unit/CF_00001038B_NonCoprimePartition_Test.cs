...
{
    [TestClass]
    public sealed class CF_00001038B_NonCoprimePartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001038B_NonCoprimePartition));
        ...
        {
            bool result = CF_00001038B_NonCoprimePartition.Solution_0_Test(input);
