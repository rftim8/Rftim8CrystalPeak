...
{
    [TestClass]
    public sealed class CF_00000492A_VanyaAndCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000492A_VanyaAndCubes));
        ...
        {
            bool result = CF_00000492A_VanyaAndCubes.Solution_0_Test(input);
