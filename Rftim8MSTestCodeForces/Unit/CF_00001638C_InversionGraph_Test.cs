...
{
    [TestClass]
    public sealed class CF_00001638C_InversionGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001638C_InversionGraph));
        ...
        {
            bool result = CF_00001638C_InversionGraph.Solution_0_Test(input);
