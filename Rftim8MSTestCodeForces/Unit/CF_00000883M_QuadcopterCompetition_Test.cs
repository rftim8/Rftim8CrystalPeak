...
{
    [TestClass]
    public sealed class CF_00000883M_QuadcopterCompetition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883M_QuadcopterCompetition));
        ...
        {
            bool result = CF_00000883M_QuadcopterCompetition.Solution_0_Test(input);
