...
{
    [TestClass]
    public sealed class CF_00001857A_ArrayColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001857A_ArrayColoring));
        ...
        {
            bool result = CF_00001857A_ArrayColoring.Solution_0_Test(input);
