...
{
    [TestClass]
    public sealed class CF_00001505B_DMCA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001505B_DMCA));
        ...
        {
            bool result = CF_00001505B_DMCA.Solution_0_Test(input);
