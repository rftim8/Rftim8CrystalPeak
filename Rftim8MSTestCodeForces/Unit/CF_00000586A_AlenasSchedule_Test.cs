...
{
    [TestClass]
    public sealed class CF_00000586A_AlenasSchedule_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000586A_AlenasSchedule));
        ...
        {
            bool result = CF_00000586A_AlenasSchedule.Solution_0_Test(input);
