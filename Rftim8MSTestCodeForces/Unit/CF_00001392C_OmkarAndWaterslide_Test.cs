...
{
    [TestClass]
    public sealed class CF_00001392C_OmkarAndWaterslide_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001392C_OmkarAndWaterslide));
        ...
        {
            bool result = CF_00001392C_OmkarAndWaterslide.Solution_0_Test(input);
