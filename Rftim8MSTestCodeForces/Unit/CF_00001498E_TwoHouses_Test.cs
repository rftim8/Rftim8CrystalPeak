...
{
    [TestClass]
    public sealed class CF_00001498E_TwoHouses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001498E_TwoHouses));
        ...
        {
            bool result = CF_00001498E_TwoHouses.Solution_0_Test(input);
