...
{
    [TestClass]
    public sealed class CF_00001323B_CountSubrectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001323B_CountSubrectangles));
        ...
        {
            bool result = CF_00001323B_CountSubrectangles.Solution_0_Test(input);
