...
{
    [TestClass]
    public sealed class CF_00001321A_ContestForRobots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001321A_ContestForRobots));
        ...
        {
            bool result = CF_00001321A_ContestForRobots.Solution_0_Test(input);
