...
{
    [TestClass]
    public sealed class CF_00000237B_YoungTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000237B_YoungTable));
        ...
        {
            bool result = CF_00000237B_YoungTable.Solution_0_Test(input);
