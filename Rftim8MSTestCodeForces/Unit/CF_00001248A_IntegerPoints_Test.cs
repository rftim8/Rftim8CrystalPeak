...
{
    [TestClass]
    public sealed class CF_00001248A_IntegerPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001248A_IntegerPoints));
        ...
        {
            bool result = CF_00001248A_IntegerPoints.Solution_0_Test(input);
