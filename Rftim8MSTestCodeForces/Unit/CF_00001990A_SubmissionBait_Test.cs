...
{
    [TestClass]
    public sealed class CF_00001990A_SubmissionBait_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001990A_SubmissionBait));
        ...
        {
            bool result = CF_00001990A_SubmissionBait.Solution_0_Test(input);
