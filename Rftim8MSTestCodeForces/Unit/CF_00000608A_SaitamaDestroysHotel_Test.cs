...
{
    [TestClass]
    public sealed class CF_00000608A_SaitamaDestroysHotel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000608A_SaitamaDestroysHotel));
        ...
        {
            bool result = CF_00000608A_SaitamaDestroysHotel.Solution_0_Test(input);
