...
{
    [TestClass]
    public sealed class CF_00000063B_SettlersTraining_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000063B_SettlersTraining));
        ...
        {
            bool result = CF_00000063B_SettlersTraining.Solution_0_Test(input);
