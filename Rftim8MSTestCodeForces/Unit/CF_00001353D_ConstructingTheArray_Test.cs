...
{
    [TestClass]
    public sealed class CF_00001353D_ConstructingTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001353D_ConstructingTheArray));
        ...
        {
            bool result = CF_00001353D_ConstructingTheArray.Solution_0_Test(input);
