...
{
    [TestClass]
    public sealed class CF_00000606B_TestingRobots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000606B_TestingRobots));
        ...
        {
            bool result = CF_00000606B_TestingRobots.Solution_0_Test(input);
