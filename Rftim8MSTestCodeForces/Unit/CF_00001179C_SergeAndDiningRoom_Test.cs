...
{
    [TestClass]
    public sealed class CF_00001179C_SergeAndDiningRoom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001179C_SergeAndDiningRoom));
        ...
        {
            bool result = CF_00001179C_SergeAndDiningRoom.Solution_0_Test(input);
