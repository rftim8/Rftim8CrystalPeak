...
{
    [TestClass]
    public sealed class CF_00000100B_FriendlyNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000100B_FriendlyNumbers));
        ...
        {
            bool result = CF_00000100B_FriendlyNumbers.Solution_0_Test(input);
