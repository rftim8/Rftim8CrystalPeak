...
{
    [TestClass]
    public sealed class CF_00001523E_CryptoLights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001523E_CryptoLights));
        ...
        {
            bool result = CF_00001523E_CryptoLights.Solution_0_Test(input);
