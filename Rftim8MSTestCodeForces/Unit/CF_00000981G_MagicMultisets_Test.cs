...
{
    [TestClass]
    public sealed class CF_00000981G_MagicMultisets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000981G_MagicMultisets));
        ...
        {
            bool result = CF_00000981G_MagicMultisets.Solution_0_Test(input);
