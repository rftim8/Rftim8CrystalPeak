...
{
    [TestClass]
    public sealed class CF_00001887B_TimeTravel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001887B_TimeTravel));
        ...
        {
            bool result = CF_00001887B_TimeTravel.Solution_0_Test(input);
