...
{
    [TestClass]
    public sealed class CF_00001613E_CrazyRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001613E_CrazyRobot));
        ...
        {
            bool result = CF_00001613E_CrazyRobot.Solution_0_Test(input);
