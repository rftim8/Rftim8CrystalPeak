...
{
    [TestClass]
    public sealed class CF_00001974E_MoneyBuysHappiness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001974E_MoneyBuysHappiness));
        ...
        {
            bool result = CF_00001974E_MoneyBuysHappiness.Solution_0_Test(input);
