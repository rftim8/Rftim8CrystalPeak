...
{
    [TestClass]
    public sealed class CF_00001269A_Equation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001269A_Equation));
        ...
        {
            bool result = CF_00001269A_Equation.Solution_0_Test(input);
