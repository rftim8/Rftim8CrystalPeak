...
{
    [TestClass]
    public sealed class CF_00001662D_EvolutionOfWeasels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662D_EvolutionOfWeasels));
        ...
        {
            bool result = CF_00001662D_EvolutionOfWeasels.Solution_0_Test(input);
