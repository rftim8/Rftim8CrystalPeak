...
{
    [TestClass]
    public sealed class CF_00000388A_FoxAndBoxAccumulation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000388A_FoxAndBoxAccumulation));
        ...
        {
            bool result = CF_00000388A_FoxAndBoxAccumulation.Solution_0_Test(input);
