...
{
    [TestClass]
    public sealed class CF_00000778A_StringGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000778A_StringGame));
        ...
        {
            bool result = CF_00000778A_StringGame.Solution_0_Test(input);
