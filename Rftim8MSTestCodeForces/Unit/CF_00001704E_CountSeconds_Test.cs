...
{
    [TestClass]
    public sealed class CF_00001704E_CountSeconds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001704E_CountSeconds));
        ...
        {
            bool result = CF_00001704E_CountSeconds.Solution_0_Test(input);
