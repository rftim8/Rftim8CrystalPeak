...
{
    [TestClass]
    public sealed class CF_00000066A_PetyaAndJava_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000066A_PetyaAndJava));
        ...
        {
            bool result = CF_00000066A_PetyaAndJava.Solution_0_Test(input);
