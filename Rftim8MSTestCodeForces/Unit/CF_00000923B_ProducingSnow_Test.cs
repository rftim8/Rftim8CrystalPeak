...
{
    [TestClass]
    public sealed class CF_00000923B_ProducingSnow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000923B_ProducingSnow));
        ...
        {
            bool result = CF_00000923B_ProducingSnow.Solution_0_Test(input);
