...
{
    [TestClass]
    public sealed class CF_00001406D_ThreeSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001406D_ThreeSequences));
        ...
        {
            bool result = CF_00001406D_ThreeSequences.Solution_0_Test(input);
