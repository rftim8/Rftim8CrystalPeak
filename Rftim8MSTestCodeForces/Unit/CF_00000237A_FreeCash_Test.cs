...
{
    [TestClass]
    public sealed class CF_00000237A_FreeCash_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000237A_FreeCash));
        ...
        {
            bool result = CF_00000237A_FreeCash.Solution_0_Test(input);
