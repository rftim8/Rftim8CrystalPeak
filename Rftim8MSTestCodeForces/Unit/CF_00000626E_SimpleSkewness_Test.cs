...
{
    [TestClass]
    public sealed class CF_00000626E_SimpleSkewness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000626E_SimpleSkewness));
        ...
        {
            bool result = CF_00000626E_SimpleSkewness.Solution_0_Test(input);
