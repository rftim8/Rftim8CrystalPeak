...
{
    [TestClass]
    public sealed class CF_00001423B_ValuablePaper_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001423B_ValuablePaper));
        ...
        {
            bool result = CF_00001423B_ValuablePaper.Solution_0_Test(input);
