...
{
    [TestClass]
    public sealed class CF_00001915G_Bicycles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001915G_Bicycles));
        ...
        {
            bool result = CF_00001915G_Bicycles.Solution_0_Test(input);
