...
{
    [TestClass]
    public sealed class CF_00001385C_MakeItGood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001385C_MakeItGood));
        ...
        {
            bool result = CF_00001385C_MakeItGood.Solution_0_Test(input);
