...
{
    [TestClass]
    public sealed class CF_00001541A_PrettyPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001541A_PrettyPermutations));
        ...
        {
            bool result = CF_00001541A_PrettyPermutations.Solution_0_Test(input);
