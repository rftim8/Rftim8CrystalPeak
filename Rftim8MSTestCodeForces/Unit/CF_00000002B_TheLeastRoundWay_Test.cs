...
{
    [TestClass]
    public sealed class CF_00000002B_TheLeastRoundWay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000002B_TheLeastRoundWay));
        ...
        {
            bool result = CF_00000002B_TheLeastRoundWay.Solution_0_Test(input);
