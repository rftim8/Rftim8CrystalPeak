...
{
    [TestClass]
    public sealed class CF_00001349B_OracAndMedians_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001349B_OracAndMedians));
        ...
        {
            bool result = CF_00001349B_OracAndMedians.Solution_0_Test(input);
