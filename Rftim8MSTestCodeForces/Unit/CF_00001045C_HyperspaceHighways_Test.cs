...
{
    [TestClass]
    public sealed class CF_00001045C_HyperspaceHighways_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001045C_HyperspaceHighways));
        ...
        {
            bool result = CF_00001045C_HyperspaceHighways.Solution_0_Test(input);
