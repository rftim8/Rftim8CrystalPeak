...
{
    [TestClass]
    public sealed class CF_00001738E_BalanceAddicts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001738E_BalanceAddicts));
        ...
        {
            bool result = CF_00001738E_BalanceAddicts.Solution_0_Test(input);
