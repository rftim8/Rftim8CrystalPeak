...
{
    [TestClass]
    public sealed class CF_00001078E_NegativeTimeSummation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001078E_NegativeTimeSummation));
        ...
        {
            bool result = CF_00001078E_NegativeTimeSummation.Solution_0_Test(input);
