...
{
    [TestClass]
    public sealed class CF_00001437A_MarketingScheme_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001437A_MarketingScheme));
        ...
        {
            bool result = CF_00001437A_MarketingScheme.Solution_0_Test(input);
