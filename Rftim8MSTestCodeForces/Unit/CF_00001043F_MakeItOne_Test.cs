...
{
    [TestClass]
    public sealed class CF_00001043F_MakeItOne_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001043F_MakeItOne));
        ...
        {
            bool result = CF_00001043F_MakeItOne.Solution_0_Test(input);
