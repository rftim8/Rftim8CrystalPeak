...
{
    [TestClass]
    public sealed class CF_00000213D_Stars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000213D_Stars));
        ...
        {
            bool result = CF_00000213D_Stars.Solution_0_Test(input);
