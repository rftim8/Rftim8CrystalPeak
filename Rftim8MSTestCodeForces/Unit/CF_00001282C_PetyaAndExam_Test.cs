...
{
    [TestClass]
    public sealed class CF_00001282C_PetyaAndExam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001282C_PetyaAndExam));
        ...
        {
            bool result = CF_00001282C_PetyaAndExam.Solution_0_Test(input);
