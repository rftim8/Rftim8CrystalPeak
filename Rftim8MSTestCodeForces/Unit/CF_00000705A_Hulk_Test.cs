...
{
    [TestClass]
    public sealed class CF_00000705A_Hulk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000705A_Hulk));
        ...
        {
            bool result = CF_00000705A_Hulk.Solution_0_Test(input);
