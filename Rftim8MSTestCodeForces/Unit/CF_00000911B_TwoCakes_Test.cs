...
{
    [TestClass]
    public sealed class CF_00000911B_TwoCakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000911B_TwoCakes));
        ...
        {
            bool result = CF_00000911B_TwoCakes.Solution_0_Test(input);
