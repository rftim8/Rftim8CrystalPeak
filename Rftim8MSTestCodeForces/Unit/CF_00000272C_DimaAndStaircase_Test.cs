...
{
    [TestClass]
    public sealed class CF_00000272C_DimaAndStaircase_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000272C_DimaAndStaircase));
        ...
        {
            bool result = CF_00000272C_DimaAndStaircase.Solution_0_Test(input);
