...
{
    [TestClass]
    public sealed class CF_00001553B_ReverseString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001553B_ReverseString));
        ...
        {
            bool result = CF_00001553B_ReverseString.Solution_0_Test(input);
