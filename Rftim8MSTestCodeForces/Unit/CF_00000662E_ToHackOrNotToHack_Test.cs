...
{
    [TestClass]
    public sealed class CF_00000662E_ToHackOrNotToHack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000662E_ToHackOrNotToHack));
        ...
        {
            bool result = CF_00000662E_ToHackOrNotToHack.Solution_0_Test(input);
