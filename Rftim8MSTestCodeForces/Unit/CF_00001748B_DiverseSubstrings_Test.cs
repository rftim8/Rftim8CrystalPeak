...
{
    [TestClass]
    public sealed class CF_00001748B_DiverseSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001748B_DiverseSubstrings));
        ...
        {
            bool result = CF_00001748B_DiverseSubstrings.Solution_0_Test(input);
