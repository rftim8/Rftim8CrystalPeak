...
{
    [TestClass]
    public sealed class CF_00000384B_Multitasking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000384B_Multitasking));
        ...
        {
            bool result = CF_00000384B_Multitasking.Solution_0_Test(input);
