...
{
    [TestClass]
    public sealed class CF_00001150B_TilingChallenge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001150B_TilingChallenge));
        ...
        {
            bool result = CF_00001150B_TilingChallenge.Solution_0_Test(input);
