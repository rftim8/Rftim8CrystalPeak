...
{
    [TestClass]
    public sealed class CF_00000757F_TeamRocketRisesAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000757F_TeamRocketRisesAgain));
        ...
        {
            bool result = CF_00000757F_TeamRocketRisesAgain.Solution_0_Test(input);
