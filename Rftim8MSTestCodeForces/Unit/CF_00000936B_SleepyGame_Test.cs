...
{
    [TestClass]
    public sealed class CF_00000936B_SleepyGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000936B_SleepyGame));
        ...
        {
            bool result = CF_00000936B_SleepyGame.Solution_0_Test(input);
