...
{
    [TestClass]
    public sealed class CF_00000605E_IntergalaxyTrips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000605E_IntergalaxyTrips));
        ...
        {
            bool result = CF_00000605E_IntergalaxyTrips.Solution_0_Test(input);
