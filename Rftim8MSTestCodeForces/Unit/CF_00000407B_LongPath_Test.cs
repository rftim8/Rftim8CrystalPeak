...
{
    [TestClass]
    public sealed class CF_00000407B_LongPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000407B_LongPath));
        ...
        {
            bool result = CF_00000407B_LongPath.Solution_0_Test(input);
