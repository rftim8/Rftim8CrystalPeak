...
{
    [TestClass]
    public sealed class CF_00000009A_DieRoll_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000009A_DieRoll));
        ...
        {
            bool result = CF_00000009A_DieRoll.Solution_0_Test(input);
