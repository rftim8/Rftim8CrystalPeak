...
{
    [TestClass]
    public sealed class CF_00001117E_DecypherTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001117E_DecypherTheString));
        ...
        {
            bool result = CF_00001117E_DecypherTheString.Solution_0_Test(input);
