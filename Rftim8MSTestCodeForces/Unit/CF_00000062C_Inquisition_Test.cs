...
{
    [TestClass]
    public sealed class CF_00000062C_Inquisition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000062C_Inquisition));
        ...
        {
            bool result = CF_00000062C_Inquisition.Solution_0_Test(input);
