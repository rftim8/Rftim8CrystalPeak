...
{
    [TestClass]
    public sealed class CF_00000707E_Garlands_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000707E_Garlands));
        ...
        {
            bool result = CF_00000707E_Garlands.Solution_0_Test(input);
