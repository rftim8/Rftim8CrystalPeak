...
{
    [TestClass]
    public sealed class CF_00001031B_CuriosityHasNoLimits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001031B_CuriosityHasNoLimits));
        ...
        {
            bool result = CF_00001031B_CuriosityHasNoLimits.Solution_0_Test(input);
