...
{
    [TestClass]
    public sealed class CF_00000189A_CutRibbon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000189A_CutRibbon));
        ...
        {
            bool result = CF_00000189A_CutRibbon.Solution_0_Test(input);
