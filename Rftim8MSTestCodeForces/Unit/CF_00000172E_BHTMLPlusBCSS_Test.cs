...
{
    [TestClass]
    public sealed class CF_00000172E_BHTMLPlusBCSS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000172E_BHTMLPlusBCSS));
        ...
        {
            bool result = CF_00000172E_BHTMLPlusBCSS.Solution_0_Test(input);
