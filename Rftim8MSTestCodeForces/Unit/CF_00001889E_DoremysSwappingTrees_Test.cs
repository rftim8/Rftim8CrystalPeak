...
{
    [TestClass]
    public sealed class CF_00001889E_DoremysSwappingTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001889E_DoremysSwappingTrees));
        ...
        {
            bool result = CF_00001889E_DoremysSwappingTrees.Solution_0_Test(input);
