...
{
    [TestClass]
    public sealed class CF_00001383D_Rearrange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001383D_Rearrange));
        ...
        {
            bool result = CF_00001383D_Rearrange.Solution_0_Test(input);
