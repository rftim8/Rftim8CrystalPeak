...
{
    [TestClass]
    public sealed class CF_00001672B_ILoveAAAB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001672B_ILoveAAAB));
        ...
        {
            bool result = CF_00001672B_ILoveAAAB.Solution_0_Test(input);
