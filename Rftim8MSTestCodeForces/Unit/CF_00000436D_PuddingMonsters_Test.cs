...
{
    [TestClass]
    public sealed class CF_00000436D_PuddingMonsters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000436D_PuddingMonsters));
        ...
        {
            bool result = CF_00000436D_PuddingMonsters.Solution_0_Test(input);
