...
{
    [TestClass]
    public sealed class CF_00000755C_PolandBallAndForest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000755C_PolandBallAndForest));
        ...
        {
            bool result = CF_00000755C_PolandBallAndForest.Solution_0_Test(input);
