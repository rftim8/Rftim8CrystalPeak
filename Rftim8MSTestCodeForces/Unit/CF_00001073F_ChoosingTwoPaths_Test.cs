...
{
    [TestClass]
    public sealed class CF_00001073F_ChoosingTwoPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001073F_ChoosingTwoPaths));
        ...
        {
            bool result = CF_00001073F_ChoosingTwoPaths.Solution_0_Test(input);
