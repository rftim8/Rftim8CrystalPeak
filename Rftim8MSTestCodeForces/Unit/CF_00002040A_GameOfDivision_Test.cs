...
{
    [TestClass]
    public sealed class CF_00002040A_GameOfDivision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002040A_GameOfDivision));
        ...
        {
            bool result = CF_00002040A_GameOfDivision.Solution_0_Test(input);
