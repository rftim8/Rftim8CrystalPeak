...
{
    [TestClass]
    public sealed class CF_00000656G_YoureAProfessional_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000656G_YoureAProfessional));
        ...
        {
            bool result = CF_00000656G_YoureAProfessional.Solution_0_Test(input);
