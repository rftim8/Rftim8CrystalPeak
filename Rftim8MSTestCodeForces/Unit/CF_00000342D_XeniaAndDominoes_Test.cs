...
{
    [TestClass]
    public sealed class CF_00000342D_XeniaAndDominoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000342D_XeniaAndDominoes));
        ...
        {
            bool result = CF_00000342D_XeniaAndDominoes.Solution_0_Test(input);
