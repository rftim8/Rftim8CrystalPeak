...
{
    [TestClass]
    public sealed class CF_00001152D_NekoAndAkisPrank_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001152D_NekoAndAkisPrank));
        ...
        {
            bool result = CF_00001152D_NekoAndAkisPrank.Solution_0_Test(input);
