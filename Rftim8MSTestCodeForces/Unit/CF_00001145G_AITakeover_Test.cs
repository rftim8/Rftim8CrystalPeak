...
{
    [TestClass]
    public sealed class CF_00001145G_AITakeover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001145G_AITakeover));
        ...
        {
            bool result = CF_00001145G_AITakeover.Solution_0_Test(input);
