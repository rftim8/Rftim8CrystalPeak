...
{
    [TestClass]
    public sealed class CF_00001342B_BinaryPeriod_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001342B_BinaryPeriod));
        ...
        {
            bool result = CF_00001342B_BinaryPeriod.Solution_0_Test(input);
