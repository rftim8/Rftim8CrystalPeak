...
{
    [TestClass]
    public sealed class CF_00001420C2_PokemonArmyHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001420C2_PokemonArmyHardVersion));
        ...
        {
            bool result = CF_00001420C2_PokemonArmyHardVersion.Solution_0_Test(input);
