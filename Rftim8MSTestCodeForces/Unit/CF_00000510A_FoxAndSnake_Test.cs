...
{
    [TestClass]
    public sealed class CF_00000510A_FoxAndSnake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000510A_FoxAndSnake));
        ...
        {
            bool result = CF_00000510A_FoxAndSnake.Solution_0_Test(input);
