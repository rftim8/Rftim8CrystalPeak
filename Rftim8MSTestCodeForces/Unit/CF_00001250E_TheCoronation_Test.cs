...
{
    [TestClass]
    public sealed class CF_00001250E_TheCoronation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001250E_TheCoronation));
        ...
        {
            bool result = CF_00001250E_TheCoronation.Solution_0_Test(input);
