...
{
    [TestClass]
    public sealed class CF_00001370D_OddEvenSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001370D_OddEvenSubsequence));
        ...
        {
            bool result = CF_00001370D_OddEvenSubsequence.Solution_0_Test(input);
