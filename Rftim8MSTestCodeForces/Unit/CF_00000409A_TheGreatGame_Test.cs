...
{
    [TestClass]
    public sealed class CF_00000409A_TheGreatGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000409A_TheGreatGame));
        ...
        {
            bool result = CF_00000409A_TheGreatGame.Solution_0_Test(input);
