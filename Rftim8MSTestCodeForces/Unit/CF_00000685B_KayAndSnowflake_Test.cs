...
{
    [TestClass]
    public sealed class CF_00000685B_KayAndSnowflake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000685B_KayAndSnowflake));
        ...
        {
            bool result = CF_00000685B_KayAndSnowflake.Solution_0_Test(input);
