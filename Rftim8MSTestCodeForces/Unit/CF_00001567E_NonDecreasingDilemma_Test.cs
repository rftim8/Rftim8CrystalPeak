...
{
    [TestClass]
    public sealed class CF_00001567E_NonDecreasingDilemma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001567E_NonDecreasingDilemma));
        ...
        {
            bool result = CF_00001567E_NonDecreasingDilemma.Solution_0_Test(input);
