...
{
    [TestClass]
    public sealed class CF_00000598D_IgorInTheMuseum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000598D_IgorInTheMuseum));
        ...
        {
            bool result = CF_00000598D_IgorInTheMuseum.Solution_0_Test(input);
