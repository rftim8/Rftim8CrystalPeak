...
{
    [TestClass]
    public sealed class CF_00000380B_SerejaAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000380B_SerejaAndTree));
        ...
        {
            bool result = CF_00000380B_SerejaAndTree.Solution_0_Test(input);
