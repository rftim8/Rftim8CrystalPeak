...
{
    [TestClass]
    public sealed class CF_00000626G_Raffles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000626G_Raffles));
        ...
        {
            bool result = CF_00000626G_Raffles.Solution_0_Test(input);
