...
{
    [TestClass]
    public sealed class CF_00001970B2_ExactNeighboursMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970B2_ExactNeighboursMedium));
        ...
        {
            bool result = CF_00001970B2_ExactNeighboursMedium.Solution_0_Test(input);
