...
{
    [TestClass]
    public sealed class CF_00001879B_ChipsOnTheBoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001879B_ChipsOnTheBoard));
        ...
        {
            bool result = CF_00001879B_ChipsOnTheBoard.Solution_0_Test(input);
