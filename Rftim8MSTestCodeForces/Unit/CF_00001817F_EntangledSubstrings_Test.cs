...
{
    [TestClass]
    public sealed class CF_00001817F_EntangledSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001817F_EntangledSubstrings));
        ...
        {
            bool result = CF_00001817F_EntangledSubstrings.Solution_0_Test(input);
