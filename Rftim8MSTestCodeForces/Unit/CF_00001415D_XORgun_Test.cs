...
{
    [TestClass]
    public sealed class CF_00001415D_XORgun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001415D_XORgun));
        ...
        {
            bool result = CF_00001415D_XORgun.Solution_0_Test(input);
