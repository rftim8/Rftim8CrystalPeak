...
{
    [TestClass]
    public sealed class CF_00001930F_MaximizeTheDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001930F_MaximizeTheDifference));
        ...
        {
            bool result = CF_00001930F_MaximizeTheDifference.Solution_0_Test(input);
