...
{
    [TestClass]
    public sealed class CF_00001019E_RainingSeason_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001019E_RainingSeason));
        ...
        {
            bool result = CF_00001019E_RainingSeason.Solution_0_Test(input);
