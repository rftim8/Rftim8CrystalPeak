...
{
    [TestClass]
    public sealed class CF_00001173B_NauuoAndChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001173B_NauuoAndChess));
        ...
        {
            bool result = CF_00001173B_NauuoAndChess.Solution_0_Test(input);
