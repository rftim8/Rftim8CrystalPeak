...
{
    [TestClass]
    public sealed class CF_00001875C_JellyfishAndGreenApple_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001875C_JellyfishAndGreenApple));
        ...
        {
            bool result = CF_00001875C_JellyfishAndGreenApple.Solution_0_Test(input);
