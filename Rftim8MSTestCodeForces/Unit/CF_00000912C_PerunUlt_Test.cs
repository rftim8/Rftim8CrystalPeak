...
{
    [TestClass]
    public sealed class CF_00000912C_PerunUlt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000912C_PerunUlt));
        ...
        {
            bool result = CF_00000912C_PerunUlt.Solution_0_Test(input);
