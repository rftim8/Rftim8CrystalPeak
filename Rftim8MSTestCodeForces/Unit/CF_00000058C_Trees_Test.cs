...
{
    [TestClass]
    public sealed class CF_00000058C_Trees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000058C_Trees));
        ...
        {
            bool result = CF_00000058C_Trees.Solution_0_Test(input);
