...
{
    [TestClass]
    public sealed class CF_00001789C_ServalAndToxelsArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001789C_ServalAndToxelsArrays));
        ...
        {
            bool result = CF_00001789C_ServalAndToxelsArrays.Solution_0_Test(input);
