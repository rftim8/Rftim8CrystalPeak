...
{
    [TestClass]
    public sealed class CF_00001284D_NewYearAndConference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001284D_NewYearAndConference));
        ...
        {
            bool result = CF_00001284D_NewYearAndConference.Solution_0_Test(input);
