...
{
    [TestClass]
    public sealed class CF_00000087B_VasyaAndTypes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000087B_VasyaAndTypes));
        ...
        {
            bool result = CF_00000087B_VasyaAndTypes.Solution_0_Test(input);
