...
{
    [TestClass]
    public sealed class CF_00001473A_ReplacingElements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001473A_ReplacingElements));
        ...
        {
            bool result = CF_00001473A_ReplacingElements.Solution_0_Test(input);
