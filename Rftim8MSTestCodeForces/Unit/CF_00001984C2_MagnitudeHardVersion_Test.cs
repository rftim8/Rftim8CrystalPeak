...
{
    [TestClass]
    public sealed class CF_00001984C2_MagnitudeHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001984C2_MagnitudeHardVersion));
        ...
        {
            bool result = CF_00001984C2_MagnitudeHardVersion.Solution_0_Test(input);
