...
{
    [TestClass]
    public sealed class CF_00001302C_SegmentTreeOrFenwick_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001302C_SegmentTreeOrFenwick));
        ...
        {
            bool result = CF_00001302C_SegmentTreeOrFenwick.Solution_0_Test(input);
