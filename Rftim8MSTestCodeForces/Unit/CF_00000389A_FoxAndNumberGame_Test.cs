...
{
    [TestClass]
    public sealed class CF_00000389A_FoxAndNumberGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000389A_FoxAndNumberGame));
        ...
        {
            bool result = CF_00000389A_FoxAndNumberGame.Solution_0_Test(input);
