...
{
    [TestClass]
    public sealed class CF_00001557E_AssiutChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001557E_AssiutChess));
        ...
        {
            bool result = CF_00001557E_AssiutChess.Solution_0_Test(input);
