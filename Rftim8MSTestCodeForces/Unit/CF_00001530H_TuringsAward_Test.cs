...
{
    [TestClass]
    public sealed class CF_00001530H_TuringsAward_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001530H_TuringsAward));
        ...
        {
            bool result = CF_00001530H_TuringsAward.Solution_0_Test(input);
