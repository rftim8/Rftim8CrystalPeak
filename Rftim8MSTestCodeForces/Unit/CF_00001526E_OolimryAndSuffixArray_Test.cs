...
{
    [TestClass]
    public sealed class CF_00001526E_OolimryAndSuffixArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001526E_OolimryAndSuffixArray));
        ...
        {
            bool result = CF_00001526E_OolimryAndSuffixArray.Solution_0_Test(input);
