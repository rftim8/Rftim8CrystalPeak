...
{
    [TestClass]
    public sealed class CF_00001654A_MaximumCakeTastiness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001654A_MaximumCakeTastiness));
        ...
        {
            bool result = CF_00001654A_MaximumCakeTastiness.Solution_0_Test(input);
