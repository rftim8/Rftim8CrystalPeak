...
{
    [TestClass]
    public sealed class CF_00000242B_BigSegment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000242B_BigSegment));
        ...
        {
            bool result = CF_00000242B_BigSegment.Solution_0_Test(input);
