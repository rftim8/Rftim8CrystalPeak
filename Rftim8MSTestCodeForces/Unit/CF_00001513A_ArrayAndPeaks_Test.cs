...
{
    [TestClass]
    public sealed class CF_00001513A_ArrayAndPeaks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001513A_ArrayAndPeaks));
        ...
        {
            bool result = CF_00001513A_ArrayAndPeaks.Solution_0_Test(input);
