...
{
    [TestClass]
    public sealed class CF_00001045H_Selfexploration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001045H_Selfexploration));
        ...
        {
            bool result = CF_00001045H_Selfexploration.Solution_0_Test(input);
