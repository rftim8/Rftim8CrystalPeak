...
{
    [TestClass]
    public sealed class CF_00001882D_TreeXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001882D_TreeXOR));
        ...
        {
            bool result = CF_00001882D_TreeXOR.Solution_0_Test(input);
