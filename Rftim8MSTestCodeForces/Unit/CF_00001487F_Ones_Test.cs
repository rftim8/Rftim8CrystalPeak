...
{
    [TestClass]
    public sealed class CF_00001487F_Ones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001487F_Ones));
        ...
        {
            bool result = CF_00001487F_Ones.Solution_0_Test(input);
