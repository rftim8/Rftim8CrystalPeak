...
{
    [TestClass]
    public sealed class CF_00001780A_HayatoAndSchool_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001780A_HayatoAndSchool));
        ...
        {
            bool result = CF_00001780A_HayatoAndSchool.Solution_0_Test(input);
