...
{
    [TestClass]
    public sealed class CF_00001923C_FindB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001923C_FindB));
        ...
        {
            bool result = CF_00001923C_FindB.Solution_0_Test(input);
