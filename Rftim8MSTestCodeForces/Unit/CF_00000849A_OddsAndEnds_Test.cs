...
{
    [TestClass]
    public sealed class CF_00000849A_OddsAndEnds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000849A_OddsAndEnds));
        ...
        {
            bool result = CF_00000849A_OddsAndEnds.Solution_0_Test(input);
