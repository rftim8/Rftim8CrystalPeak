...
{
    [TestClass]
    public sealed class CF_00000848B_RootersSong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000848B_RootersSong));
        ...
        {
            bool result = CF_00000848B_RootersSong.Solution_0_Test(input);
