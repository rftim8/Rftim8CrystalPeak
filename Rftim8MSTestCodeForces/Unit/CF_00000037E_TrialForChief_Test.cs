...
{
    [TestClass]
    public sealed class CF_00000037E_TrialForChief_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000037E_TrialForChief));
        ...
        {
            bool result = CF_00000037E_TrialForChief.Solution_0_Test(input);
