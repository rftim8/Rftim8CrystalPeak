...
{
    [TestClass]
    public sealed class CF_00001939B_EvidenceBoard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001939B_EvidenceBoard));
        ...
        {
            bool result = CF_00001939B_EvidenceBoard.Solution_0_Test(input);
