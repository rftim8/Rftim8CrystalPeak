...
{
    [TestClass]
    public sealed class CF_00000277D_GoogleCodeJam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000277D_GoogleCodeJam));
        ...
        {
            bool result = CF_00000277D_GoogleCodeJam.Solution_0_Test(input);
