...
{
    [TestClass]
    public sealed class CF_00001977E_Tensor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001977E_Tensor));
        ...
        {
            bool result = CF_00001977E_Tensor.Solution_0_Test(input);
