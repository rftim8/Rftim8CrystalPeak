...
{
    [TestClass]
    public sealed class CF_00001991D_PrimeXORColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001991D_PrimeXORColoring));
        ...
        {
            bool result = CF_00001991D_PrimeXORColoring.Solution_0_Test(input);
