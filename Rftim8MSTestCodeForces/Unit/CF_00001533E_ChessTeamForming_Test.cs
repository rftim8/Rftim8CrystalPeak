...
{
    [TestClass]
    public sealed class CF_00001533E_ChessTeamForming_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001533E_ChessTeamForming));
        ...
        {
            bool result = CF_00001533E_ChessTeamForming.Solution_0_Test(input);
