...
{
    [TestClass]
    public sealed class CF_00000220B_LittleElephantAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000220B_LittleElephantAndArray));
        ...
        {
            bool result = CF_00000220B_LittleElephantAndArray.Solution_0_Test(input);
