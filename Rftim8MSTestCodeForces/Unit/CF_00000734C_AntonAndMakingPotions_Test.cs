...
{
    [TestClass]
    public sealed class CF_00000734C_AntonAndMakingPotions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000734C_AntonAndMakingPotions));
        ...
        {
            bool result = CF_00000734C_AntonAndMakingPotions.Solution_0_Test(input);
