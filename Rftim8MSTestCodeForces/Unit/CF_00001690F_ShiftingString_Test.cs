...
{
    [TestClass]
    public sealed class CF_00001690F_ShiftingString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001690F_ShiftingString));
        ...
        {
            bool result = CF_00001690F_ShiftingString.Solution_0_Test(input);
