...
{
    [TestClass]
    public sealed class CF_00001136A_NastyaIsReadingABook_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001136A_NastyaIsReadingABook));
        ...
        {
            bool result = CF_00001136A_NastyaIsReadingABook.Solution_0_Test(input);
