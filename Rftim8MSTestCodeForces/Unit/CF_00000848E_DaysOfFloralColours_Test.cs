...
{
    [TestClass]
    public sealed class CF_00000848E_DaysOfFloralColours_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000848E_DaysOfFloralColours));
        ...
        {
            bool result = CF_00000848E_DaysOfFloralColours.Solution_0_Test(input);
