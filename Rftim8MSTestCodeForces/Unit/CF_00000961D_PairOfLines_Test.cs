...
{
    [TestClass]
    public sealed class CF_00000961D_PairOfLines_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000961D_PairOfLines));
        ...
        {
            bool result = CF_00000961D_PairOfLines.Solution_0_Test(input);
