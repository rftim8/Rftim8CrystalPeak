...
{
    [TestClass]
    public sealed class CF_00000774L_Bars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774L_Bars));
        ...
        {
            bool result = CF_00000774L_Bars.Solution_0_Test(input);
