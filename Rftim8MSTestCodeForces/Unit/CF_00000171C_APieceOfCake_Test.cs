...
{
    [TestClass]
    public sealed class CF_00000171C_APieceOfCake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000171C_APieceOfCake));
        ...
        {
            bool result = CF_00000171C_APieceOfCake.Solution_0_Test(input);
