...
{
    [TestClass]
    public sealed class CF_00001034E_LittleCLoves3III_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001034E_LittleCLoves3III));
        ...
        {
            bool result = CF_00001034E_LittleCLoves3III.Solution_0_Test(input);
