...
{
    [TestClass]
    public sealed class CF_00001133C_BalancedTeam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001133C_BalancedTeam));
        ...
        {
            bool result = CF_00001133C_BalancedTeam.Solution_0_Test(input);
