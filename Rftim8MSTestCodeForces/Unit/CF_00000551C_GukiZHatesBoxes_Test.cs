...
{
    [TestClass]
    public sealed class CF_00000551C_GukiZHatesBoxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000551C_GukiZHatesBoxes));
        ...
        {
            bool result = CF_00000551C_GukiZHatesBoxes.Solution_0_Test(input);
