...
{
    [TestClass]
    public sealed class CF_00000955D_Scissors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000955D_Scissors));
        ...
        {
            bool result = CF_00000955D_Scissors.Solution_0_Test(input);
