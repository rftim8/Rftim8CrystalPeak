...
{
    [TestClass]
    public sealed class CF_00000632E_ThiefInAShop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000632E_ThiefInAShop));
        ...
        {
            bool result = CF_00000632E_ThiefInAShop.Solution_0_Test(input);
