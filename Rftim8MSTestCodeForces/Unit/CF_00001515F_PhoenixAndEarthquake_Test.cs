...
{
    [TestClass]
    public sealed class CF_00001515F_PhoenixAndEarthquake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001515F_PhoenixAndEarthquake));
        ...
        {
            bool result = CF_00001515F_PhoenixAndEarthquake.Solution_0_Test(input);
