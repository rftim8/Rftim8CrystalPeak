...
{
    [TestClass]
    public sealed class CF_00000689A_MikeAndCellphone_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000689A_MikeAndCellphone));
        ...
        {
            bool result = CF_00000689A_MikeAndCellphone.Solution_0_Test(input);
