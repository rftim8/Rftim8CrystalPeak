...
{
    [TestClass]
    public sealed class CF_00000036E_TwoPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000036E_TwoPaths));
        ...
        {
            bool result = CF_00000036E_TwoPaths.Solution_0_Test(input);
