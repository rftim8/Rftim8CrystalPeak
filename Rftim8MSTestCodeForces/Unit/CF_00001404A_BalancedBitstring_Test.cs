...
{
    [TestClass]
    public sealed class CF_00001404A_BalancedBitstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001404A_BalancedBitstring));
        ...
        {
            bool result = CF_00001404A_BalancedBitstring.Solution_0_Test(input);
