...
{
    [TestClass]
    public sealed class CF_00000349B_ColorTheFence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000349B_ColorTheFence));
        ...
        {
            bool result = CF_00000349B_ColorTheFence.Solution_0_Test(input);
