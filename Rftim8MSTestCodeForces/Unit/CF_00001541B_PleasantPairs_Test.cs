...
{
    [TestClass]
    public sealed class CF_00001541B_PleasantPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001541B_PleasantPairs));
        ...
        {
            bool result = CF_00001541B_PleasantPairs.Solution_0_Test(input);
