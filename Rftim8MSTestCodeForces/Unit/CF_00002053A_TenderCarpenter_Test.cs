...
{
    [TestClass]
    public sealed class CF_00002053A_TenderCarpenter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002053A_TenderCarpenter));
        ...
        {
            bool result = CF_00002053A_TenderCarpenter.Solution_0_Test(input);
