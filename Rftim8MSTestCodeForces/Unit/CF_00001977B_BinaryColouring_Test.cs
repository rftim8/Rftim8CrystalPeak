...
{
    [TestClass]
    public sealed class CF_00001977B_BinaryColouring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001977B_BinaryColouring));
        ...
        {
            bool result = CF_00001977B_BinaryColouring.Solution_0_Test(input);
