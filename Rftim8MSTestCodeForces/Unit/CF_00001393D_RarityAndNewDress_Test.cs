...
{
    [TestClass]
    public sealed class CF_00001393D_RarityAndNewDress_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001393D_RarityAndNewDress));
        ...
        {
            bool result = CF_00001393D_RarityAndNewDress.Solution_0_Test(input);
