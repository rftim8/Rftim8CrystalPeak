...
{
    [TestClass]
    public sealed class CF_00001985C_GoodPrefixes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001985C_GoodPrefixes));
        ...
        {
            bool result = CF_00001985C_GoodPrefixes.Solution_0_Test(input);
