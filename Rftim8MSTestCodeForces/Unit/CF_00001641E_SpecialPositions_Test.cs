...
{
    [TestClass]
    public sealed class CF_00001641E_SpecialPositions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001641E_SpecialPositions));
        ...
        {
            bool result = CF_00001641E_SpecialPositions.Solution_0_Test(input);
