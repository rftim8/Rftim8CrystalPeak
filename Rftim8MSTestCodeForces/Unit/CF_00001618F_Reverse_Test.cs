...
{
    [TestClass]
    public sealed class CF_00001618F_Reverse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001618F_Reverse));
        ...
        {
            bool result = CF_00001618F_Reverse.Solution_0_Test(input);
