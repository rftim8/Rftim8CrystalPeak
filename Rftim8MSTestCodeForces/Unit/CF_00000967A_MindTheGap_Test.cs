...
{
    [TestClass]
    public sealed class CF_00000967A_MindTheGap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000967A_MindTheGap));
        ...
        {
            bool result = CF_00000967A_MindTheGap.Solution_0_Test(input);
