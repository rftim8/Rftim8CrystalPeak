...
{
    [TestClass]
    public sealed class CF_00001365D_SolveTheMaze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001365D_SolveTheMaze));
        ...
        {
            bool result = CF_00001365D_SolveTheMaze.Solution_0_Test(input);
