...
{
    [TestClass]
    public sealed class CF_00000698F_CoprimePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000698F_CoprimePermutation));
        ...
        {
            bool result = CF_00000698F_CoprimePermutation.Solution_0_Test(input);
