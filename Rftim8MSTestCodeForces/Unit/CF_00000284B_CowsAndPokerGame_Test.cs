...
{
    [TestClass]
    public sealed class CF_00000284B_CowsAndPokerGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000284B_CowsAndPokerGame));
        ...
        {
            bool result = CF_00000284B_CowsAndPokerGame.Solution_0_Test(input);
