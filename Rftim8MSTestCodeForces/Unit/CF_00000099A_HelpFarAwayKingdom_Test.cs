...
{
    [TestClass]
    public sealed class CF_00000099A_HelpFarAwayKingdom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000099A_HelpFarAwayKingdom));
        ...
        {
            bool result = CF_00000099A_HelpFarAwayKingdom.Solution_0_Test(input);
