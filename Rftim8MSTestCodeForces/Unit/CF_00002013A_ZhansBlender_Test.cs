...
{
    [TestClass]
    public sealed class CF_00002013A_ZhansBlender_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002013A_ZhansBlender));
        ...
        {
            bool result = CF_00002013A_ZhansBlender.Solution_0_Test(input);
