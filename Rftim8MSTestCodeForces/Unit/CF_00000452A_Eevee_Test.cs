...
{
    [TestClass]
    public sealed class CF_00000452A_Eevee_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000452A_Eevee));
        ...
        {
            bool result = CF_00000452A_Eevee.Solution_0_Test(input);
