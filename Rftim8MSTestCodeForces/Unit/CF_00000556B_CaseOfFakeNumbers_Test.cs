...
{
    [TestClass]
    public sealed class CF_00000556B_CaseOfFakeNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000556B_CaseOfFakeNumbers));
        ...
        {
            bool result = CF_00000556B_CaseOfFakeNumbers.Solution_0_Test(input);
