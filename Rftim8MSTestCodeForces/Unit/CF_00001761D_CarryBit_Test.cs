...
{
    [TestClass]
    public sealed class CF_00001761D_CarryBit_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001761D_CarryBit));
        ...
        {
            bool result = CF_00001761D_CarryBit.Solution_0_Test(input);
