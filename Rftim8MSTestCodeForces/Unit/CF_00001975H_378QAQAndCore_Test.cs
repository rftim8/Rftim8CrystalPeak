...
{
    [TestClass]
    public sealed class CF_00001975H_378QAQAndCore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001975H_378QAQAndCore));
        ...
        {
            bool result = CF_00001975H_378QAQAndCore.Solution_0_Test(input);
