...
{
    [TestClass]
    public sealed class CF_00001622B_BerlandMusic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001622B_BerlandMusic));
        ...
        {
            bool result = CF_00001622B_BerlandMusic.Solution_0_Test(input);
