...
{
    [TestClass]
    public sealed class CF_00001533A_TravelToBertown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001533A_TravelToBertown));
        ...
        {
            bool result = CF_00001533A_TravelToBertown.Solution_0_Test(input);
