...
{
    [TestClass]
    public sealed class CF_00000048A_Rockpaperscissors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000048A_Rockpaperscissors));
        ...
        {
            bool result = CF_00000048A_Rockpaperscissors.Solution_0_Test(input);
