...
{
    [TestClass]
    public sealed class CF_00001792B_StandupComedian_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001792B_StandupComedian));
        ...
        {
            bool result = CF_00001792B_StandupComedian.Solution_0_Test(input);
