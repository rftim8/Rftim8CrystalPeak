...
{
    [TestClass]
    public sealed class CF_00000773A_SuccessRate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000773A_SuccessRate));
        ...
        {
            bool result = CF_00000773A_SuccessRate.Solution_0_Test(input);
