...
{
    [TestClass]
    public sealed class CF_00001895F_FancyArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001895F_FancyArrays));
        ...
        {
            bool result = CF_00001895F_FancyArrays.Solution_0_Test(input);
