...
{
    [TestClass]
    public sealed class CF_00001307D_CowAndFields_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001307D_CowAndFields));
        ...
        {
            bool result = CF_00001307D_CowAndFields.Solution_0_Test(input);
