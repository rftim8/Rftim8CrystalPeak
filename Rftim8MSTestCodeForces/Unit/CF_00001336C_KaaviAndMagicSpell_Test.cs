...
{
    [TestClass]
    public sealed class CF_00001336C_KaaviAndMagicSpell_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001336C_KaaviAndMagicSpell));
        ...
        {
            bool result = CF_00001336C_KaaviAndMagicSpell.Solution_0_Test(input);
