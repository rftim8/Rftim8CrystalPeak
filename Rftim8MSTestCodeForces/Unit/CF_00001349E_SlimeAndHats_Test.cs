...
{
    [TestClass]
    public sealed class CF_00001349E_SlimeAndHats_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001349E_SlimeAndHats));
        ...
        {
            bool result = CF_00001349E_SlimeAndHats.Solution_0_Test(input);
