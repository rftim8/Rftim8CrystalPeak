...
{
    [TestClass]
    public sealed class CF_00000772D_VaryingKibibits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000772D_VaryingKibibits));
        ...
        {
            bool result = CF_00000772D_VaryingKibibits.Solution_0_Test(input);
