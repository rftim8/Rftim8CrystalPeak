...
{
    [TestClass]
    public sealed class CF_00000626C_BlockTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000626C_BlockTowers));
        ...
        {
            bool result = CF_00000626C_BlockTowers.Solution_0_Test(input);
