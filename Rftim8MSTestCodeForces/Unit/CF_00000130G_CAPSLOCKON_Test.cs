...
{
    [TestClass]
    public sealed class CF_00000130G_CAPSLOCKON_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000130G_CAPSLOCKON));
        ...
        {
            bool result = CF_00000130G_CAPSLOCKON.Solution_0_Test(input);
