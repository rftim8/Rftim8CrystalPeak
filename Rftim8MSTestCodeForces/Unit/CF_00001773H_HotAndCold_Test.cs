...
{
    [TestClass]
    public sealed class CF_00001773H_HotAndCold_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001773H_HotAndCold));
        ...
        {
            bool result = CF_00001773H_HotAndCold.Solution_0_Test(input);
