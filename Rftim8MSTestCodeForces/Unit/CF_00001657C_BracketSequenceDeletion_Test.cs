...
{
    [TestClass]
    public sealed class CF_00001657C_BracketSequenceDeletion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001657C_BracketSequenceDeletion));
        ...
        {
            bool result = CF_00001657C_BracketSequenceDeletion.Solution_0_Test(input);
