...
{
    [TestClass]
    public sealed class CF_00001283D_ChristmasTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001283D_ChristmasTrees));
        ...
        {
            bool result = CF_00001283D_ChristmasTrees.Solution_0_Test(input);
