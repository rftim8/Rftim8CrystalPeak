...
{
    [TestClass]
    public sealed class CF_00000844B_Rectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000844B_Rectangles));
        ...
        {
            bool result = CF_00000844B_Rectangles.Solution_0_Test(input);
