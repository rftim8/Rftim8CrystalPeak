...
{
    [TestClass]
    public sealed class CF_00001838A_BlackboardList_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001838A_BlackboardList));
        ...
        {
            bool result = CF_00001838A_BlackboardList.Solution_0_Test(input);
