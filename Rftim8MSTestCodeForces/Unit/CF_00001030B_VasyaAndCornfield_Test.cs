...
{
    [TestClass]
    public sealed class CF_00001030B_VasyaAndCornfield_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001030B_VasyaAndCornfield));
        ...
        {
            bool result = CF_00001030B_VasyaAndCornfield.Solution_0_Test(input);
