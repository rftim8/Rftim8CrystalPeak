...
{
    [TestClass]
    public sealed class CF_00000570D_TreeRequests_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000570D_TreeRequests));
        ...
        {
            bool result = CF_00000570D_TreeRequests.Solution_0_Test(input);
