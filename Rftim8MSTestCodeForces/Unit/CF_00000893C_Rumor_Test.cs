...
{
    [TestClass]
    public sealed class CF_00000893C_Rumor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000893C_Rumor));
        ...
        {
            bool result = CF_00000893C_Rumor.Solution_0_Test(input);
