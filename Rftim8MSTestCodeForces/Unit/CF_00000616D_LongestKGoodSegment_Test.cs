...
{
    [TestClass]
    public sealed class CF_00000616D_LongestKGoodSegment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000616D_LongestKGoodSegment));
        ...
        {
            bool result = CF_00000616D_LongestKGoodSegment.Solution_0_Test(input);
