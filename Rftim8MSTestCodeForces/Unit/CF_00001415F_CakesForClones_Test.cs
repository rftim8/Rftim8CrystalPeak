...
{
    [TestClass]
    public sealed class CF_00001415F_CakesForClones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001415F_CakesForClones));
        ...
        {
            bool result = CF_00001415F_CakesForClones.Solution_0_Test(input);
