...
{
    [TestClass]
    public sealed class CF_00000191B_Demonstration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000191B_Demonstration));
        ...
        {
            bool result = CF_00000191B_Demonstration.Solution_0_Test(input);
