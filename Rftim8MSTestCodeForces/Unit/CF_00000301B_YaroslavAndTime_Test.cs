...
{
    [TestClass]
    public sealed class CF_00000301B_YaroslavAndTime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000301B_YaroslavAndTime));
        ...
        {
            bool result = CF_00000301B_YaroslavAndTime.Solution_0_Test(input);
