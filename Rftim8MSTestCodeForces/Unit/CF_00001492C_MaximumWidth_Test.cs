...
{
    [TestClass]
    public sealed class CF_00001492C_MaximumWidth_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001492C_MaximumWidth));
        ...
        {
            bool result = CF_00001492C_MaximumWidth.Solution_0_Test(input);
