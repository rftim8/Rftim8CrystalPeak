...
{
    [TestClass]
    public sealed class CF_00001984F_Reconstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001984F_Reconstruction));
        ...
        {
            bool result = CF_00001984F_Reconstruction.Solution_0_Test(input);
