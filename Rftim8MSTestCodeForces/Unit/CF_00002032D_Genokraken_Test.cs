...
{
    [TestClass]
    public sealed class CF_00002032D_Genokraken_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002032D_Genokraken));
        ...
        {
            bool result = CF_00002032D_Genokraken.Solution_0_Test(input);
