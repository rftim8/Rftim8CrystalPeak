...
{
    [TestClass]
    public sealed class CF_00001693F_IMightBeWrong_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001693F_IMightBeWrong));
        ...
        {
            bool result = CF_00001693F_IMightBeWrong.Solution_0_Test(input);
