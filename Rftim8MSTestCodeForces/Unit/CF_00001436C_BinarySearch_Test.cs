...
{
    [TestClass]
    public sealed class CF_00001436C_BinarySearch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001436C_BinarySearch));
        ...
        {
            bool result = CF_00001436C_BinarySearch.Solution_0_Test(input);
