...
{
    [TestClass]
    public sealed class CF_00000624A_SaveLuke_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000624A_SaveLuke));
        ...
        {
            bool result = CF_00000624A_SaveLuke.Solution_0_Test(input);
