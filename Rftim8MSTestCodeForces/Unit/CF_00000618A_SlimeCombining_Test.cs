...
{
    [TestClass]
    public sealed class CF_00000618A_SlimeCombining_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000618A_SlimeCombining));
        ...
        {
            bool result = CF_00000618A_SlimeCombining.Solution_0_Test(input);
