...
{
    [TestClass]
    public sealed class CF_00000141D_TakeoffRamps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000141D_TakeoffRamps));
        ...
        {
            bool result = CF_00000141D_TakeoffRamps.Solution_0_Test(input);
