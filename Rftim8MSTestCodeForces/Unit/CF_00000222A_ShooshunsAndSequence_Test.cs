...
{
    [TestClass]
    public sealed class CF_00000222A_ShooshunsAndSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000222A_ShooshunsAndSequence));
        ...
        {
            bool result = CF_00000222A_ShooshunsAndSequence.Solution_0_Test(input);
