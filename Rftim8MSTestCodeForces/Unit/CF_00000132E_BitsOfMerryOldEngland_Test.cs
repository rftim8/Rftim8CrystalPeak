...
{
    [TestClass]
    public sealed class CF_00000132E_BitsOfMerryOldEngland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000132E_BitsOfMerryOldEngland));
        ...
        {
            bool result = CF_00000132E_BitsOfMerryOldEngland.Solution_0_Test(input);
