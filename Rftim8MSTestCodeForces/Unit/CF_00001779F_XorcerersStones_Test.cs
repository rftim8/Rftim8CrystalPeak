...
{
    [TestClass]
    public sealed class CF_00001779F_XorcerersStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001779F_XorcerersStones));
        ...
        {
            bool result = CF_00001779F_XorcerersStones.Solution_0_Test(input);
