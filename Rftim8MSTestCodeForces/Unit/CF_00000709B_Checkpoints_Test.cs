...
{
    [TestClass]
    public sealed class CF_00000709B_Checkpoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000709B_Checkpoints));
        ...
        {
            bool result = CF_00000709B_Checkpoints.Solution_0_Test(input);
