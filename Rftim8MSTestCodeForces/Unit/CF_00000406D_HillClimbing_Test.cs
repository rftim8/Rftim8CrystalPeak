...
{
    [TestClass]
    public sealed class CF_00000406D_HillClimbing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000406D_HillClimbing));
        ...
        {
            bool result = CF_00000406D_HillClimbing.Solution_0_Test(input);
