...
{
    [TestClass]
    public sealed class CF_00001051E_VasyaAndBigIntegers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001051E_VasyaAndBigIntegers));
        ...
        {
            bool result = CF_00001051E_VasyaAndBigIntegers.Solution_0_Test(input);
