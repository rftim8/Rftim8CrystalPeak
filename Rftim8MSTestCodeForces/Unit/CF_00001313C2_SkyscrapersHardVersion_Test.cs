...
{
    [TestClass]
    public sealed class CF_00001313C2_SkyscrapersHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001313C2_SkyscrapersHardVersion));
        ...
        {
            bool result = CF_00001313C2_SkyscrapersHardVersion.Solution_0_Test(input);
