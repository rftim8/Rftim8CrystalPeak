...
{
    [TestClass]
    public sealed class CF_00000188E_HQ9Plus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000188E_HQ9Plus));
        ...
        {
            bool result = CF_00000188E_HQ9Plus.Solution_0_Test(input);
