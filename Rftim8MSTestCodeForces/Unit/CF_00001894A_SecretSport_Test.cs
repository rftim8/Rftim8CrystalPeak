...
{
    [TestClass]
    public sealed class CF_00001894A_SecretSport_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001894A_SecretSport));
        ...
        {
            bool result = CF_00001894A_SecretSport.Solution_0_Test(input);
