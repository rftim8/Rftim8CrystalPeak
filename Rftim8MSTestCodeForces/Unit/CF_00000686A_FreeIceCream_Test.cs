...
{
    [TestClass]
    public sealed class CF_00000686A_FreeIceCream_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000686A_FreeIceCream));
        ...
        {
            bool result = CF_00000686A_FreeIceCream.Solution_0_Test(input);
