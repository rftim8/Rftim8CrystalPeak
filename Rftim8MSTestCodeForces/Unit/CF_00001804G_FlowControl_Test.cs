...
{
    [TestClass]
    public sealed class CF_00001804G_FlowControl_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001804G_FlowControl));
        ...
        {
            bool result = CF_00001804G_FlowControl.Solution_0_Test(input);
