...
{
    [TestClass]
    public sealed class CF_00000926D_ChoosePlace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000926D_ChoosePlace));
        ...
        {
            bool result = CF_00000926D_ChoosePlace.Solution_0_Test(input);
