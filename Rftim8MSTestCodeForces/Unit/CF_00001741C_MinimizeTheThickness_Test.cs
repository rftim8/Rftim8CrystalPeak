...
{
    [TestClass]
    public sealed class CF_00001741C_MinimizeTheThickness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001741C_MinimizeTheThickness));
        ...
        {
            bool result = CF_00001741C_MinimizeTheThickness.Solution_0_Test(input);
