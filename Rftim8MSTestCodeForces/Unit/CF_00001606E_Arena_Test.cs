...
{
    [TestClass]
    public sealed class CF_00001606E_Arena_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001606E_Arena));
        ...
        {
            bool result = CF_00001606E_Arena.Solution_0_Test(input);
