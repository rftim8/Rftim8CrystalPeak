...
{
    [TestClass]
    public sealed class CF_00000648E_CollectTheNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000648E_CollectTheNumber));
        ...
        {
            bool result = CF_00000648E_CollectTheNumber.Solution_0_Test(input);
