...
{
    [TestClass]
    public sealed class CF_00001604A_Era_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001604A_Era));
        ...
        {
            bool result = CF_00001604A_Era.Solution_0_Test(input);
