...
{
    [TestClass]
    public sealed class CF_00001033G_ChipGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001033G_ChipGame));
        ...
        {
            bool result = CF_00001033G_ChipGame.Solution_0_Test(input);
