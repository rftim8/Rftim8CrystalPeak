...
{
    [TestClass]
    public sealed class CF_00000774J_StepansSeries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774J_StepansSeries));
        ...
        {
            bool result = CF_00000774J_StepansSeries.Solution_0_Test(input);
