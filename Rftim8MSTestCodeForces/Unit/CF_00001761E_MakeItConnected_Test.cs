...
{
    [TestClass]
    public sealed class CF_00001761E_MakeItConnected_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001761E_MakeItConnected));
        ...
        {
            bool result = CF_00001761E_MakeItConnected.Solution_0_Test(input);
