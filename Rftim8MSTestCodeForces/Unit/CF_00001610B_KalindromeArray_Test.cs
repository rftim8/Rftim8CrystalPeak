...
{
    [TestClass]
    public sealed class CF_00001610B_KalindromeArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001610B_KalindromeArray));
        ...
        {
            bool result = CF_00001610B_KalindromeArray.Solution_0_Test(input);
