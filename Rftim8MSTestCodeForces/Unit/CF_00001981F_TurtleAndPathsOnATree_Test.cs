...
{
    [TestClass]
    public sealed class CF_00001981F_TurtleAndPathsOnATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001981F_TurtleAndPathsOnATree));
        ...
        {
            bool result = CF_00001981F_TurtleAndPathsOnATree.Solution_0_Test(input);
