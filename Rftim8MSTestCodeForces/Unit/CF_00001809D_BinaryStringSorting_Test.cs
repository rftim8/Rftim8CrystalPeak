...
{
    [TestClass]
    public sealed class CF_00001809D_BinaryStringSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001809D_BinaryStringSorting));
        ...
        {
            bool result = CF_00001809D_BinaryStringSorting.Solution_0_Test(input);
