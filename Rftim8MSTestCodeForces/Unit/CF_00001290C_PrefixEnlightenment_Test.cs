...
{
    [TestClass]
    public sealed class CF_00001290C_PrefixEnlightenment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001290C_PrefixEnlightenment));
        ...
        {
            bool result = CF_00001290C_PrefixEnlightenment.Solution_0_Test(input);
