...
{
    [TestClass]
    public sealed class CF_00001468D_Firecrackers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468D_Firecrackers));
        ...
        {
            bool result = CF_00001468D_Firecrackers.Solution_0_Test(input);
