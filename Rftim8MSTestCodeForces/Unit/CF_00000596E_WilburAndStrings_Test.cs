...
{
    [TestClass]
    public sealed class CF_00000596E_WilburAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000596E_WilburAndStrings));
        ...
        {
            bool result = CF_00000596E_WilburAndStrings.Solution_0_Test(input);
