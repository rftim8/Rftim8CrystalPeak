...
{
    [TestClass]
    public sealed class CF_00000097E_Leaders_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000097E_Leaders));
        ...
        {
            bool result = CF_00000097E_Leaders.Solution_0_Test(input);
