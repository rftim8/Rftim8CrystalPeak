...
{
    [TestClass]
    public sealed class CF_00000380C_SerejaAndBrackets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000380C_SerejaAndBrackets));
        ...
        {
            bool result = CF_00000380C_SerejaAndBrackets.Solution_0_Test(input);
