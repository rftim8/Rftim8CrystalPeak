...
{
    [TestClass]
    public sealed class CF_00001453E_DogSnacks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001453E_DogSnacks));
        ...
        {
            bool result = CF_00001453E_DogSnacks.Solution_0_Test(input);
