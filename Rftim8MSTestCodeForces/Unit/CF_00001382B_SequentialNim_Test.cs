...
{
    [TestClass]
    public sealed class CF_00001382B_SequentialNim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001382B_SequentialNim));
        ...
        {
            bool result = CF_00001382B_SequentialNim.Solution_0_Test(input);
