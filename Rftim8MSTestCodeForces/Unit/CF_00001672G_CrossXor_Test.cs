...
{
    [TestClass]
    public sealed class CF_00001672G_CrossXor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001672G_CrossXor));
        ...
        {
            bool result = CF_00001672G_CrossXor.Solution_0_Test(input);
