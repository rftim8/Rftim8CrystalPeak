...
{
    [TestClass]
    public sealed class CF_00001623A_RobotCleaner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001623A_RobotCleaner));
        ...
        {
            bool result = CF_00001623A_RobotCleaner.Solution_0_Test(input);
