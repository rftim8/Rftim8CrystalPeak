...
{
    [TestClass]
    public sealed class CF_00000191D_MetroScheme_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000191D_MetroScheme));
        ...
        {
            bool result = CF_00000191D_MetroScheme.Solution_0_Test(input);
