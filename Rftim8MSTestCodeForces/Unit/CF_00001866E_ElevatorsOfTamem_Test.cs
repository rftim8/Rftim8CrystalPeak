...
{
    [TestClass]
    public sealed class CF_00001866E_ElevatorsOfTamem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001866E_ElevatorsOfTamem));
        ...
        {
            bool result = CF_00001866E_ElevatorsOfTamem.Solution_0_Test(input);
