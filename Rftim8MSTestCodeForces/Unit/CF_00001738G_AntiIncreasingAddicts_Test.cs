...
{
    [TestClass]
    public sealed class CF_00001738G_AntiIncreasingAddicts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001738G_AntiIncreasingAddicts));
        ...
        {
            bool result = CF_00001738G_AntiIncreasingAddicts.Solution_0_Test(input);
