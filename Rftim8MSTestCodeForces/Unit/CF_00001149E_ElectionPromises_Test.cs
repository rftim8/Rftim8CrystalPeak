...
{
    [TestClass]
    public sealed class CF_00001149E_ElectionPromises_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001149E_ElectionPromises));
        ...
        {
            bool result = CF_00001149E_ElectionPromises.Solution_0_Test(input);
