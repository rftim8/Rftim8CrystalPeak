...
{
    [TestClass]
    public sealed class CF_00000932G_PalindromePartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000932G_PalindromePartition));
        ...
        {
            bool result = CF_00000932G_PalindromePartition.Solution_0_Test(input);
