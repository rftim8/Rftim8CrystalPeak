...
{
    [TestClass]
    public sealed class CF_00000929D_BorderGate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000929D_BorderGate));
        ...
        {
            bool result = CF_00000929D_BorderGate.Solution_0_Test(input);
