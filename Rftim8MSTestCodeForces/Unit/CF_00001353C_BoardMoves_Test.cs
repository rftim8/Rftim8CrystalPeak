...
{
    [TestClass]
    public sealed class CF_00001353C_BoardMoves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001353C_BoardMoves));
        ...
        {
            bool result = CF_00001353C_BoardMoves.Solution_0_Test(input);
