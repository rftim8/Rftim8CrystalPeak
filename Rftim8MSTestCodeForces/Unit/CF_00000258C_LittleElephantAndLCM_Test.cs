...
{
    [TestClass]
    public sealed class CF_00000258C_LittleElephantAndLCM_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000258C_LittleElephantAndLCM));
        ...
        {
            bool result = CF_00000258C_LittleElephantAndLCM.Solution_0_Test(input);
