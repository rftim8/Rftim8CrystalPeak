...
{
    [TestClass]
    public sealed class CF_00000138A_LiteratureLesson_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000138A_LiteratureLesson));
        ...
        {
            bool result = CF_00000138A_LiteratureLesson.Solution_0_Test(input);
