...
{
    [TestClass]
    public sealed class CF_00001970G2_MinFundPrisonMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970G2_MinFundPrisonMedium));
        ...
        {
            bool result = CF_00001970G2_MinFundPrisonMedium.Solution_0_Test(input);
