...
{
    [TestClass]
    public sealed class CF_00000702A_MaximumIncrease_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000702A_MaximumIncrease));
        ...
        {
            bool result = CF_00000702A_MaximumIncrease.Solution_0_Test(input);
