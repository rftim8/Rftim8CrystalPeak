...
{
    [TestClass]
    public sealed class CF_00000627D_PreorderTest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000627D_PreorderTest));
        ...
        {
            bool result = CF_00000627D_PreorderTest.Solution_0_Test(input);
