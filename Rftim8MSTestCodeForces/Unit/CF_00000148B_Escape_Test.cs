...
{
    [TestClass]
    public sealed class CF_00000148B_Escape_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000148B_Escape));
        ...
        {
            bool result = CF_00000148B_Escape.Solution_0_Test(input);
