...
{
    [TestClass]
    public sealed class CF_00000510E_FoxAndDinner_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000510E_FoxAndDinner));
        ...
        {
            bool result = CF_00000510E_FoxAndDinner.Solution_0_Test(input);
