...
{
    [TestClass]
    public sealed class CF_00001777B_Emordnilap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001777B_Emordnilap));
        ...
        {
            bool result = CF_00001777B_Emordnilap.Solution_0_Test(input);
