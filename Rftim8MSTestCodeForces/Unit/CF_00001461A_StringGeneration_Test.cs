...
{
    [TestClass]
    public sealed class CF_00001461A_StringGeneration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001461A_StringGeneration));
        ...
        {
            bool result = CF_00001461A_StringGeneration.Solution_0_Test(input);
