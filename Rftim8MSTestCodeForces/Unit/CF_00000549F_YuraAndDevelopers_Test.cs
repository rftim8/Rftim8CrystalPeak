...
{
    [TestClass]
    public sealed class CF_00000549F_YuraAndDevelopers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000549F_YuraAndDevelopers));
        ...
        {
            bool result = CF_00000549F_YuraAndDevelopers.Solution_0_Test(input);
