...
{
    [TestClass]
    public sealed class CF_00001530B_PuttingPlates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001530B_PuttingPlates));
        ...
        {
            bool result = CF_00001530B_PuttingPlates.Solution_0_Test(input);
