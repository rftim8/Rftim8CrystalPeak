...
{
    [TestClass]
    public sealed class CF_00000643F_BearsAndJuice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000643F_BearsAndJuice));
        ...
        {
            bool result = CF_00000643F_BearsAndJuice.Solution_0_Test(input);
