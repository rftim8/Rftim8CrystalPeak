...
{
    [TestClass]
    public sealed class CF_00000425A_SerejaAndSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000425A_SerejaAndSwaps));
        ...
        {
            bool result = CF_00000425A_SerejaAndSwaps.Solution_0_Test(input);
