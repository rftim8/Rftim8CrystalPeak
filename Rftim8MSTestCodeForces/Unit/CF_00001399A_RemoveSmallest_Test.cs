...
{
    [TestClass]
    public sealed class CF_00001399A_RemoveSmallest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001399A_RemoveSmallest));
        ...
        {
            bool result = CF_00001399A_RemoveSmallest.Solution_0_Test(input);
