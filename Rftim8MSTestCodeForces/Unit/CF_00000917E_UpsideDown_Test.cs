...
{
    [TestClass]
    public sealed class CF_00000917E_UpsideDown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000917E_UpsideDown));
        ...
        {
            bool result = CF_00000917E_UpsideDown.Solution_0_Test(input);
