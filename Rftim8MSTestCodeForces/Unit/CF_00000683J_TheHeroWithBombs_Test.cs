...
{
    [TestClass]
    public sealed class CF_00000683J_TheHeroWithBombs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000683J_TheHeroWithBombs));
        ...
        {
            bool result = CF_00000683J_TheHeroWithBombs.Solution_0_Test(input);
