...
{
    [TestClass]
    public sealed class CF_00000078E_Evacuation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000078E_Evacuation));
        ...
        {
            bool result = CF_00000078E_Evacuation.Solution_0_Test(input);
