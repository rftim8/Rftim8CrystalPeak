...
{
    [TestClass]
    public sealed class CF_00001842E_TenzingAndTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001842E_TenzingAndTriangle));
        ...
        {
            bool result = CF_00001842E_TenzingAndTriangle.Solution_0_Test(input);
