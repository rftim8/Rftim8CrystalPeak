...
{
    [TestClass]
    public sealed class CF_00001932E_FinalCountdown_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001932E_FinalCountdown));
        ...
        {
            bool result = CF_00001932E_FinalCountdown.Solution_0_Test(input);
