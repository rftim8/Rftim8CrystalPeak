...
{
    [TestClass]
    public sealed class CF_00000188G_ArraySorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000188G_ArraySorting));
        ...
        {
            bool result = CF_00000188G_ArraySorting.Solution_0_Test(input);
