...
{
    [TestClass]
    public sealed class CF_00001753D_TheBeach_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001753D_TheBeach));
        ...
        {
            bool result = CF_00001753D_TheBeach.Solution_0_Test(input);
