...
{
    [TestClass]
    public sealed class CF_00001503A_BalanceTheBits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001503A_BalanceTheBits));
        ...
        {
            bool result = CF_00001503A_BalanceTheBits.Solution_0_Test(input);
