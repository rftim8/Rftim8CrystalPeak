...
{
    [TestClass]
    public sealed class CF_00001313B_DifferentRules_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001313B_DifferentRules));
        ...
        {
            bool result = CF_00001313B_DifferentRules.Solution_0_Test(input);
