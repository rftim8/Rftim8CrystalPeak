...
{
    [TestClass]
    public sealed class CF_00000243D_Cubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000243D_Cubes));
        ...
        {
            bool result = CF_00000243D_Cubes.Solution_0_Test(input);
