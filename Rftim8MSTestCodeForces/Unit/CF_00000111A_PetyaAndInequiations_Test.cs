...
{
    [TestClass]
    public sealed class CF_00000111A_PetyaAndInequiations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000111A_PetyaAndInequiations));
        ...
        {
            bool result = CF_00000111A_PetyaAndInequiations.Solution_0_Test(input);
