...
{
    [TestClass]
    public sealed class CF_00001312B_Bogosort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001312B_Bogosort));
        ...
        {
            bool result = CF_00001312B_Bogosort.Solution_0_Test(input);
