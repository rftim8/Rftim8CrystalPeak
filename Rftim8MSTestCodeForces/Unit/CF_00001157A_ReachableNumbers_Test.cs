...
{
    [TestClass]
    public sealed class CF_00001157A_ReachableNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001157A_ReachableNumbers));
        ...
        {
            bool result = CF_00001157A_ReachableNumbers.Solution_0_Test(input);
