...
{
    [TestClass]
    public sealed class CF_00000750C_NewYearAndRating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000750C_NewYearAndRating));
        ...
        {
            bool result = CF_00000750C_NewYearAndRating.Solution_0_Test(input);
