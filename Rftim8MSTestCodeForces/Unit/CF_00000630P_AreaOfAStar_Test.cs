...
{
    [TestClass]
    public sealed class CF_00000630P_AreaOfAStar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000630P_AreaOfAStar));
        ...
        {
            bool result = CF_00000630P_AreaOfAStar.Solution_0_Test(input);
