...
{
    [TestClass]
    public sealed class CF_00001206B_MakeProductEqualOne_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001206B_MakeProductEqualOne));
        ...
        {
            bool result = CF_00001206B_MakeProductEqualOne.Solution_0_Test(input);
