...
{
    [TestClass]
    public sealed class CF_00001814D_BalancingWeapons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001814D_BalancingWeapons));
        ...
        {
            bool result = CF_00001814D_BalancingWeapons.Solution_0_Test(input);
