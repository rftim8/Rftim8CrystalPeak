...
{
    [TestClass]
    public sealed class CF_00001936B_Pinball_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001936B_Pinball));
        ...
        {
            bool result = CF_00001936B_Pinball.Solution_0_Test(input);
