...
{
    [TestClass]
    public sealed class CF_00001948D_TandemRepeats_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001948D_TandemRepeats));
        ...
        {
            bool result = CF_00001948D_TandemRepeats.Solution_0_Test(input);
