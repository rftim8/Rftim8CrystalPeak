...
{
    [TestClass]
    public sealed class CF_00000154A_Hometask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000154A_Hometask));
        ...
        {
            bool result = CF_00000154A_Hometask.Solution_0_Test(input);
