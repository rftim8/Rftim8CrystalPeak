...
{
    [TestClass]
    public sealed class CF_00001815F_OHNO1234_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001815F_OHNO1234));
        ...
        {
            bool result = CF_00001815F_OHNO1234.Solution_0_Test(input);
