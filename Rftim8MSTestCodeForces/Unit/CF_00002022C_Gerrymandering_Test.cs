...
{
    [TestClass]
    public sealed class CF_00002022C_Gerrymandering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002022C_Gerrymandering));
        ...
        {
            bool result = CF_00002022C_Gerrymandering.Solution_0_Test(input);
