...
{
    [TestClass]
    public sealed class CF_00001276E_FourStones_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001276E_FourStones));
        ...
        {
            bool result = CF_00001276E_FourStones.Solution_0_Test(input);
