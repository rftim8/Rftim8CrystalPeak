...
{
    [TestClass]
    public sealed class CF_00000637A_VotingForPhotos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000637A_VotingForPhotos));
        ...
        {
            bool result = CF_00000637A_VotingForPhotos.Solution_0_Test(input);
