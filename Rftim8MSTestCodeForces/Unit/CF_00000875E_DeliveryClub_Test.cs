...
{
    [TestClass]
    public sealed class CF_00000875E_DeliveryClub_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000875E_DeliveryClub));
        ...
        {
            bool result = CF_00000875E_DeliveryClub.Solution_0_Test(input);
