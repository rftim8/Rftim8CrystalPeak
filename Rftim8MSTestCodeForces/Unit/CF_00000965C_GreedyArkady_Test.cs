...
{
    [TestClass]
    public sealed class CF_00000965C_GreedyArkady_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000965C_GreedyArkady));
        ...
        {
            bool result = CF_00000965C_GreedyArkady.Solution_0_Test(input);
