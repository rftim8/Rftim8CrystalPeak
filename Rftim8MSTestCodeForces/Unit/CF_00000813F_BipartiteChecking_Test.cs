...
{
    [TestClass]
    public sealed class CF_00000813F_BipartiteChecking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000813F_BipartiteChecking));
        ...
        {
            bool result = CF_00000813F_BipartiteChecking.Solution_0_Test(input);
