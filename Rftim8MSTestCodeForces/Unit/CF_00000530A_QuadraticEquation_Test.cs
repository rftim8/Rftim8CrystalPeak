...
{
    [TestClass]
    public sealed class CF_00000530A_QuadraticEquation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000530A_QuadraticEquation));
        ...
        {
            bool result = CF_00000530A_QuadraticEquation.Solution_0_Test(input);
