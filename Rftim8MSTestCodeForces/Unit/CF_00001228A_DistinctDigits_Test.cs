...
{
    [TestClass]
    public sealed class CF_00001228A_DistinctDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001228A_DistinctDigits));
        ...
        {
            bool result = CF_00001228A_DistinctDigits.Solution_0_Test(input);
