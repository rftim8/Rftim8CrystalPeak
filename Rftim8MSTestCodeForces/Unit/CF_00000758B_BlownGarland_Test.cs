...
{
    [TestClass]
    public sealed class CF_00000758B_BlownGarland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000758B_BlownGarland));
        ...
        {
            bool result = CF_00000758B_BlownGarland.Solution_0_Test(input);
