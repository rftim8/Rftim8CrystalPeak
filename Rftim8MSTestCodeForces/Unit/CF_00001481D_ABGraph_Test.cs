...
{
    [TestClass]
    public sealed class CF_00001481D_ABGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001481D_ABGraph));
        ...
        {
            bool result = CF_00001481D_ABGraph.Solution_0_Test(input);
