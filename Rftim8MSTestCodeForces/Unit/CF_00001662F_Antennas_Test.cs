...
{
    [TestClass]
    public sealed class CF_00001662F_Antennas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662F_Antennas));
        ...
        {
            bool result = CF_00001662F_Antennas.Solution_0_Test(input);
