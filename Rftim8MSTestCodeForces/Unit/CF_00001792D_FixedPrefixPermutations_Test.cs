...
{
    [TestClass]
    public sealed class CF_00001792D_FixedPrefixPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001792D_FixedPrefixPermutations));
        ...
        {
            bool result = CF_00001792D_FixedPrefixPermutations.Solution_0_Test(input);
