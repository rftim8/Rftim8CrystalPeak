...
{
    [TestClass]
    public sealed class CF_00000542C_IdempotentFunctions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000542C_IdempotentFunctions));
        ...
        {
            bool result = CF_00000542C_IdempotentFunctions.Solution_0_Test(input);
