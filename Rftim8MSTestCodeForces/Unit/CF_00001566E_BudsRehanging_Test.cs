...
{
    [TestClass]
    public sealed class CF_00001566E_BudsRehanging_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001566E_BudsRehanging));
        ...
        {
            bool result = CF_00001566E_BudsRehanging.Solution_0_Test(input);
