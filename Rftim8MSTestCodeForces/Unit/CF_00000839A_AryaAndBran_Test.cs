...
{
    [TestClass]
    public sealed class CF_00000839A_AryaAndBran_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000839A_AryaAndBran));
        ...
        {
            bool result = CF_00000839A_AryaAndBran.Solution_0_Test(input);
