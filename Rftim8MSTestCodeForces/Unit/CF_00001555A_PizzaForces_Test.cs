...
{
    [TestClass]
    public sealed class CF_00001555A_PizzaForces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001555A_PizzaForces));
        ...
        {
            bool result = CF_00001555A_PizzaForces.Solution_0_Test(input);
