...
{
    [TestClass]
    public sealed class CF_00000925D_AztecCatacombs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000925D_AztecCatacombs));
        ...
        {
            bool result = CF_00000925D_AztecCatacombs.Solution_0_Test(input);
