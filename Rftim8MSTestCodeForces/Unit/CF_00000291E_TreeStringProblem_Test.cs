...
{
    [TestClass]
    public sealed class CF_00000291E_TreeStringProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000291E_TreeStringProblem));
        ...
        {
            bool result = CF_00000291E_TreeStringProblem.Solution_0_Test(input);
