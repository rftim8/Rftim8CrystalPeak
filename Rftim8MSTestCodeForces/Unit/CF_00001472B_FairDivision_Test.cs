...
{
    [TestClass]
    public sealed class CF_00001472B_FairDivision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001472B_FairDivision));
        ...
        {
            bool result = CF_00001472B_FairDivision.Solution_0_Test(input);
