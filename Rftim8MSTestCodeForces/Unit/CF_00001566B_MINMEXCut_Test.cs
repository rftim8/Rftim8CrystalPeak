...
{
    [TestClass]
    public sealed class CF_00001566B_MINMEXCut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001566B_MINMEXCut));
        ...
        {
            bool result = CF_00001566B_MINMEXCut.Solution_0_Test(input);
