...
{
    [TestClass]
    public sealed class CF_00000013B_LetterA_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000013B_LetterA));
        ...
        {
            bool result = CF_00000013B_LetterA.Solution_0_Test(input);
