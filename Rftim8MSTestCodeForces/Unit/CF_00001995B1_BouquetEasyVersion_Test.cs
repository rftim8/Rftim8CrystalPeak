...
{
    [TestClass]
    public sealed class CF_00001995B1_BouquetEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001995B1_BouquetEasyVersion));
        ...
        {
            bool result = CF_00001995B1_BouquetEasyVersion.Solution_0_Test(input);
