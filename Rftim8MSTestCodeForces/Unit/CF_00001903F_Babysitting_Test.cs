...
{
    [TestClass]
    public sealed class CF_00001903F_Babysitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001903F_Babysitting));
        ...
        {
            bool result = CF_00001903F_Babysitting.Solution_0_Test(input);
