...
{
    [TestClass]
    public sealed class CF_00000976B_LaraCroftAndTheNewGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000976B_LaraCroftAndTheNewGame));
        ...
        {
            bool result = CF_00000976B_LaraCroftAndTheNewGame.Solution_0_Test(input);
