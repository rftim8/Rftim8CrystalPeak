...
{
    [TestClass]
    public sealed class CF_00000194B_Square_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000194B_Square));
        ...
        {
            bool result = CF_00000194B_Square.Solution_0_Test(input);
