...
{
    [TestClass]
    public sealed class CF_00000772E_VerifyingKingdom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000772E_VerifyingKingdom));
        ...
        {
            bool result = CF_00000772E_VerifyingKingdom.Solution_0_Test(input);
