...
{
    [TestClass]
    public sealed class CF_00002024A_ProfitableInterestRate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002024A_ProfitableInterestRate));
        ...
        {
            bool result = CF_00002024A_ProfitableInterestRate.Solution_0_Test(input);
