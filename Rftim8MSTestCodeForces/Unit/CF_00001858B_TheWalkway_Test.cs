...
{
    [TestClass]
    public sealed class CF_00001858B_TheWalkway_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001858B_TheWalkway));
        ...
        {
            bool result = CF_00001858B_TheWalkway.Solution_0_Test(input);
