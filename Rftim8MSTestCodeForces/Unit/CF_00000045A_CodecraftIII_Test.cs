...
{
    [TestClass]
    public sealed class CF_00000045A_CodecraftIII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000045A_CodecraftIII));
        ...
        {
            bool result = CF_00000045A_CodecraftIII.Solution_0_Test(input);
