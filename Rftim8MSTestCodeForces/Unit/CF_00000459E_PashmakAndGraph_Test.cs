...
{
    [TestClass]
    public sealed class CF_00000459E_PashmakAndGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000459E_PashmakAndGraph));
        ...
        {
            bool result = CF_00000459E_PashmakAndGraph.Solution_0_Test(input);
