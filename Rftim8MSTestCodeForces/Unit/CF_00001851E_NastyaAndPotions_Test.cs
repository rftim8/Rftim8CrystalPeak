...
{
    [TestClass]
    public sealed class CF_00001851E_NastyaAndPotions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001851E_NastyaAndPotions));
        ...
        {
            bool result = CF_00001851E_NastyaAndPotions.Solution_0_Test(input);
