...
{
    [TestClass]
    public sealed class CF_00000690C2_BrainNetworkMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690C2_BrainNetworkMedium));
        ...
        {
            bool result = CF_00000690C2_BrainNetworkMedium.Solution_0_Test(input);
