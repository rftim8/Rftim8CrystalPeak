...
{
    [TestClass]
    public sealed class CF_00001469D_CeilDivisions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001469D_CeilDivisions));
        ...
        {
            bool result = CF_00001469D_CeilDivisions.Solution_0_Test(input);
