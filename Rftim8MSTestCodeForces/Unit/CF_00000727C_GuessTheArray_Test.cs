...
{
    [TestClass]
    public sealed class CF_00000727C_GuessTheArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000727C_GuessTheArray));
        ...
        {
            bool result = CF_00000727C_GuessTheArray.Solution_0_Test(input);
