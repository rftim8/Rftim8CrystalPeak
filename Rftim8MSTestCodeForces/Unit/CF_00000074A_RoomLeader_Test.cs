...
{
    [TestClass]
    public sealed class CF_00000074A_RoomLeader_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000074A_RoomLeader));
        ...
        {
            bool result = CF_00000074A_RoomLeader.Solution_0_Test(input);
