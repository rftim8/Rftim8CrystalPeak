...
{
    [TestClass]
    public sealed class CF_00000552B_VanyaAndBooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000552B_VanyaAndBooks));
        ...
        {
            bool result = CF_00000552B_VanyaAndBooks.Solution_0_Test(input);
