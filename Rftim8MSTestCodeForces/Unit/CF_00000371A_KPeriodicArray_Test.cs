...
{
    [TestClass]
    public sealed class CF_00000371A_KPeriodicArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000371A_KPeriodicArray));
        ...
        {
            bool result = CF_00000371A_KPeriodicArray.Solution_0_Test(input);
