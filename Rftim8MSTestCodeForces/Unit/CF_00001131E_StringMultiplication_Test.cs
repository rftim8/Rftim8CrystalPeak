...
{
    [TestClass]
    public sealed class CF_00001131E_StringMultiplication_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001131E_StringMultiplication));
        ...
        {
            bool result = CF_00001131E_StringMultiplication.Solution_0_Test(input);
