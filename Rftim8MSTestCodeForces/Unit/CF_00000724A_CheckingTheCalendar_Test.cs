...
{
    [TestClass]
    public sealed class CF_00000724A_CheckingTheCalendar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000724A_CheckingTheCalendar));
        ...
        {
            bool result = CF_00000724A_CheckingTheCalendar.Solution_0_Test(input);
