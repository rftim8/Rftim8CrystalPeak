...
{
    [TestClass]
    public sealed class CF_00001837C_BestBinaryString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001837C_BestBinaryString));
        ...
        {
            bool result = CF_00001837C_BestBinaryString.Solution_0_Test(input);
