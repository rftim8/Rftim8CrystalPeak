...
{
    [TestClass]
    public sealed class CF_00000825D_SuitableReplacement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000825D_SuitableReplacement));
        ...
        {
            bool result = CF_00000825D_SuitableReplacement.Solution_0_Test(input);
