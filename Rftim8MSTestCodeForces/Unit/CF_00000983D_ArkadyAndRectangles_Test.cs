...
{
    [TestClass]
    public sealed class CF_00000983D_ArkadyAndRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000983D_ArkadyAndRectangles));
        ...
        {
            bool result = CF_00000983D_ArkadyAndRectangles.Solution_0_Test(input);
