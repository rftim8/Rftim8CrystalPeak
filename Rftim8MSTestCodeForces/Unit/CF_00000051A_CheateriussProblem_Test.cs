...
{
    [TestClass]
    public sealed class CF_00000051A_CheateriussProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000051A_CheateriussProblem));
        ...
        {
            bool result = CF_00000051A_CheateriussProblem.Solution_0_Test(input);
