...
{
    [TestClass]
    public sealed class CF_00001339A_FillingDiamonds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001339A_FillingDiamonds));
        ...
        {
            bool result = CF_00001339A_FillingDiamonds.Solution_0_Test(input);
