...
{
    [TestClass]
    public sealed class CF_00001003A_PolycarpsPockets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001003A_PolycarpsPockets));
        ...
        {
            bool result = CF_00001003A_PolycarpsPockets.Solution_0_Test(input);
