...
{
    [TestClass]
    public sealed class CF_00002036C_AnyaAnd1100_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002036C_AnyaAnd1100));
        ...
        {
            bool result = CF_00002036C_AnyaAnd1100.Solution_0_Test(input);
