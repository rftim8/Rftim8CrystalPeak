...
{
    [TestClass]
    public sealed class CF_00001615F_LEGOndaryGrandmaster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001615F_LEGOndaryGrandmaster));
        ...
        {
            bool result = CF_00001615F_LEGOndaryGrandmaster.Solution_0_Test(input);
