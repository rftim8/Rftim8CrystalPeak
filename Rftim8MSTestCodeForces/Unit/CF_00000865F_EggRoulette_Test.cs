...
{
    [TestClass]
    public sealed class CF_00000865F_EggRoulette_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000865F_EggRoulette));
        ...
        {
            bool result = CF_00000865F_EggRoulette.Solution_0_Test(input);
