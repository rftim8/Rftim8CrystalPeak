...
{
    [TestClass]
    public sealed class CF_00000352A_JeffAndDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000352A_JeffAndDigits));
        ...
        {
            bool result = CF_00000352A_JeffAndDigits.Solution_0_Test(input);
