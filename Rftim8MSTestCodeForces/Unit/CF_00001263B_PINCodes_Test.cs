...
{
    [TestClass]
    public sealed class CF_00001263B_PINCodes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001263B_PINCodes));
        ...
        {
            bool result = CF_00001263B_PINCodes.Solution_0_Test(input);
