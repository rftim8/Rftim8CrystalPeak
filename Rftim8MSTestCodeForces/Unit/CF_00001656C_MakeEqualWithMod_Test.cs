...
{
    [TestClass]
    public sealed class CF_00001656C_MakeEqualWithMod_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001656C_MakeEqualWithMod));
        ...
        {
            bool result = CF_00001656C_MakeEqualWithMod.Solution_0_Test(input);
