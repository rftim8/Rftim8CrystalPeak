...
{
    [TestClass]
    public sealed class CF_00000566G_MaxAndMin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000566G_MaxAndMin));
        ...
        {
            bool result = CF_00000566G_MaxAndMin.Solution_0_Test(input);
