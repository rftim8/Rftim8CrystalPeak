...
{
    [TestClass]
    public sealed class CF_00001701E_TextEditor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001701E_TextEditor));
        ...
        {
            bool result = CF_00001701E_TextEditor.Solution_0_Test(input);
