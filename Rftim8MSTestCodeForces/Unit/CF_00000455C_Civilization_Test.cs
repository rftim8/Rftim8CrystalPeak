...
{
    [TestClass]
    public sealed class CF_00000455C_Civilization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000455C_Civilization));
        ...
        {
            bool result = CF_00000455C_Civilization.Solution_0_Test(input);
