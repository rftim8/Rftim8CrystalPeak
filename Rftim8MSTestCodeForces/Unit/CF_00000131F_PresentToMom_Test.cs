...
{
    [TestClass]
    public sealed class CF_00000131F_PresentToMom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000131F_PresentToMom));
        ...
        {
            bool result = CF_00000131F_PresentToMom.Solution_0_Test(input);
