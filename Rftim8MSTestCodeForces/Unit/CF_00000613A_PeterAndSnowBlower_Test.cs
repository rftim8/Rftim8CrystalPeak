...
{
    [TestClass]
    public sealed class CF_00000613A_PeterAndSnowBlower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000613A_PeterAndSnowBlower));
        ...
        {
            bool result = CF_00000613A_PeterAndSnowBlower.Solution_0_Test(input);
