...
{
    [TestClass]
    public sealed class CF_00000078B_EasterEggs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000078B_EasterEggs));
        ...
        {
            bool result = CF_00000078B_EasterEggs.Solution_0_Test(input);
