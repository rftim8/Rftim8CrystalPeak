...
{
    [TestClass]
    public sealed class CF_00000079C_Beaver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000079C_Beaver));
        ...
        {
            bool result = CF_00000079C_Beaver.Solution_0_Test(input);
