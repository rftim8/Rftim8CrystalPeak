...
{
    [TestClass]
    public sealed class CF_00000677B_VanyaAndFoodProcessor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000677B_VanyaAndFoodProcessor));
        ...
        {
            bool result = CF_00000677B_VanyaAndFoodProcessor.Solution_0_Test(input);
