...
{
    [TestClass]
    public sealed class CF_00000103B_Cthulhu_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000103B_Cthulhu));
        ...
        {
            bool result = CF_00000103B_Cthulhu.Solution_0_Test(input);
