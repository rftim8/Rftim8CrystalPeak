...
{
    [TestClass]
    public sealed class CF_00001556E_Equilibrium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001556E_Equilibrium));
        ...
        {
            bool result = CF_00001556E_Equilibrium.Solution_0_Test(input);
