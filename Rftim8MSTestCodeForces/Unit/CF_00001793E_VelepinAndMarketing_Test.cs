...
{
    [TestClass]
    public sealed class CF_00001793E_VelepinAndMarketing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001793E_VelepinAndMarketing));
        ...
        {
            bool result = CF_00001793E_VelepinAndMarketing.Solution_0_Test(input);
