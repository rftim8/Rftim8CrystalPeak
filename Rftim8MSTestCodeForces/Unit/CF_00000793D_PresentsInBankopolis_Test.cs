...
{
    [TestClass]
    public sealed class CF_00000793D_PresentsInBankopolis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000793D_PresentsInBankopolis));
        ...
        {
            bool result = CF_00000793D_PresentsInBankopolis.Solution_0_Test(input);
