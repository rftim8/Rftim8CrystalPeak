...
{
    [TestClass]
    public sealed class CF_00001178E_Archaeology_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001178E_Archaeology));
        ...
        {
            bool result = CF_00001178E_Archaeology.Solution_0_Test(input);
