...
{
    [TestClass]
    public sealed class CF_00001217A_CreatingACharacter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001217A_CreatingACharacter));
        ...
        {
            bool result = CF_00001217A_CreatingACharacter.Solution_0_Test(input);
