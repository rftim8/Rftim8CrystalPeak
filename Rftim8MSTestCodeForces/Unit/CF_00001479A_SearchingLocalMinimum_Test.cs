...
{
    [TestClass]
    public sealed class CF_00001479A_SearchingLocalMinimum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001479A_SearchingLocalMinimum));
        ...
        {
            bool result = CF_00001479A_SearchingLocalMinimum.Solution_0_Test(input);
