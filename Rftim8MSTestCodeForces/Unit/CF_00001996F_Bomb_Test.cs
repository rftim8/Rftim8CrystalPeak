...
{
    [TestClass]
    public sealed class CF_00001996F_Bomb_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001996F_Bomb));
        ...
        {
            bool result = CF_00001996F_Bomb.Solution_0_Test(input);
