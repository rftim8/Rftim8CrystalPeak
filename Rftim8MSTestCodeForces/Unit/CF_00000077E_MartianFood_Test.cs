...
{
    [TestClass]
    public sealed class CF_00000077E_MartianFood_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000077E_MartianFood));
        ...
        {
            bool result = CF_00000077E_MartianFood.Solution_0_Test(input);
