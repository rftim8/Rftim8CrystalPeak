...
{
    [TestClass]
    public sealed class CF_00000584A_OlesyaAndRodion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000584A_OlesyaAndRodion));
        ...
        {
            bool result = CF_00000584A_OlesyaAndRodion.Solution_0_Test(input);
