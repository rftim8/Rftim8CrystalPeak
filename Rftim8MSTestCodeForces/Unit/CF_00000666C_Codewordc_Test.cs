...
{
    [TestClass]
    public sealed class CF_00000666C_Codewordc_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000666C_Codewordc));
        ...
        {
            bool result = CF_00000666C_Codewordc.Solution_0_Test(input);
