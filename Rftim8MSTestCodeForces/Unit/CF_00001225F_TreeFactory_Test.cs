...
{
    [TestClass]
    public sealed class CF_00001225F_TreeFactory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001225F_TreeFactory));
        ...
        {
            bool result = CF_00001225F_TreeFactory.Solution_0_Test(input);
