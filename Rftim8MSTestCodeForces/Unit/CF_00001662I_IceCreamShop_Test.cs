...
{
    [TestClass]
    public sealed class CF_00001662I_IceCreamShop_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662I_IceCreamShop));
        ...
        {
            bool result = CF_00001662I_IceCreamShop.Solution_0_Test(input);
