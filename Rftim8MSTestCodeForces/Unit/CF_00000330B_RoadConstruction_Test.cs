...
{
    [TestClass]
    public sealed class CF_00000330B_RoadConstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000330B_RoadConstruction));
        ...
        {
            bool result = CF_00000330B_RoadConstruction.Solution_0_Test(input);
