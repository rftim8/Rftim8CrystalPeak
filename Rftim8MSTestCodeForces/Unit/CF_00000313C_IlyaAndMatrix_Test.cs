...
{
    [TestClass]
    public sealed class CF_00000313C_IlyaAndMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000313C_IlyaAndMatrix));
        ...
        {
            bool result = CF_00000313C_IlyaAndMatrix.Solution_0_Test(input);
