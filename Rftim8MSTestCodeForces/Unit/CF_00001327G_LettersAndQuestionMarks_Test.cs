...
{
    [TestClass]
    public sealed class CF_00001327G_LettersAndQuestionMarks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001327G_LettersAndQuestionMarks));
        ...
        {
            bool result = CF_00001327G_LettersAndQuestionMarks.Solution_0_Test(input);
