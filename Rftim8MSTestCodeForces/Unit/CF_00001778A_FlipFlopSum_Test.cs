...
{
    [TestClass]
    public sealed class CF_00001778A_FlipFlopSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001778A_FlipFlopSum));
        ...
        {
            bool result = CF_00001778A_FlipFlopSum.Solution_0_Test(input);
