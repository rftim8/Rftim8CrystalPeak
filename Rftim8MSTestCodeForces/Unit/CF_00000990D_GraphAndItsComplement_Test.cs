...
{
    [TestClass]
    public sealed class CF_00000990D_GraphAndItsComplement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000990D_GraphAndItsComplement));
        ...
        {
            bool result = CF_00000990D_GraphAndItsComplement.Solution_0_Test(input);
