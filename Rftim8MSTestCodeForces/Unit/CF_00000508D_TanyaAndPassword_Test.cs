...
{
    [TestClass]
    public sealed class CF_00000508D_TanyaAndPassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000508D_TanyaAndPassword));
        ...
        {
            bool result = CF_00000508D_TanyaAndPassword.Solution_0_Test(input);
