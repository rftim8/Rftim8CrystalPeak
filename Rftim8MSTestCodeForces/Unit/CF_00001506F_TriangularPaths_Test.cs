...
{
    [TestClass]
    public sealed class CF_00001506F_TriangularPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001506F_TriangularPaths));
        ...
        {
            bool result = CF_00001506F_TriangularPaths.Solution_0_Test(input);
