...
{
    [TestClass]
    public sealed class CF_00001967F_NextAndPrev_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001967F_NextAndPrev));
        ...
        {
            bool result = CF_00001967F_NextAndPrev.Solution_0_Test(input);
