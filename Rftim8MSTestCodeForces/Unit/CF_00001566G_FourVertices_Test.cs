...
{
    [TestClass]
    public sealed class CF_00001566G_FourVertices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001566G_FourVertices));
        ...
        {
            bool result = CF_00001566G_FourVertices.Solution_0_Test(input);
