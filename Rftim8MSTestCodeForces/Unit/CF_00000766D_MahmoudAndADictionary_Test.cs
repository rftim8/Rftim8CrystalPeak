...
{
    [TestClass]
    public sealed class CF_00000766D_MahmoudAndADictionary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000766D_MahmoudAndADictionary));
        ...
        {
            bool result = CF_00000766D_MahmoudAndADictionary.Solution_0_Test(input);
