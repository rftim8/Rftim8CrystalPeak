...
{
    [TestClass]
    public sealed class CF_00000445B_DZYLovesChemistry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000445B_DZYLovesChemistry));
        ...
        {
            bool result = CF_00000445B_DZYLovesChemistry.Solution_0_Test(input);
