...
{
    [TestClass]
    public sealed class CF_00001872F_SellingAMenagerie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001872F_SellingAMenagerie));
        ...
        {
            bool result = CF_00001872F_SellingAMenagerie.Solution_0_Test(input);
