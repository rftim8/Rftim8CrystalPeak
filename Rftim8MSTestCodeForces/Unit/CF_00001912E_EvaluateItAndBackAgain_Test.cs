...
{
    [TestClass]
    public sealed class CF_00001912E_EvaluateItAndBackAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001912E_EvaluateItAndBackAgain));
        ...
        {
            bool result = CF_00001912E_EvaluateItAndBackAgain.Solution_0_Test(input);
