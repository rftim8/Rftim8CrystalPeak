...
{
    [TestClass]
    public sealed class CF_00001373C_PlusesAndMinuses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001373C_PlusesAndMinuses));
        ...
        {
            bool result = CF_00001373C_PlusesAndMinuses.Solution_0_Test(input);
