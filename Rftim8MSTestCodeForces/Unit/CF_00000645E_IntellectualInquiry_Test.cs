...
{
    [TestClass]
    public sealed class CF_00000645E_IntellectualInquiry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000645E_IntellectualInquiry));
        ...
        {
            bool result = CF_00000645E_IntellectualInquiry.Solution_0_Test(input);
