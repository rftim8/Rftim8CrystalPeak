...
{
    [TestClass]
    public sealed class CF_00001610E_AmShZAndGOAT_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001610E_AmShZAndGOAT));
        ...
        {
            bool result = CF_00001610E_AmShZAndGOAT.Solution_0_Test(input);
