...
{
    [TestClass]
    public sealed class CF_00001707C_DFSTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001707C_DFSTrees));
        ...
        {
            bool result = CF_00001707C_DFSTrees.Solution_0_Test(input);
