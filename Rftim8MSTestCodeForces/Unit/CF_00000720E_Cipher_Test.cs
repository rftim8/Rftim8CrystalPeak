...
{
    [TestClass]
    public sealed class CF_00000720E_Cipher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000720E_Cipher));
        ...
        {
            bool result = CF_00000720E_Cipher.Solution_0_Test(input);
