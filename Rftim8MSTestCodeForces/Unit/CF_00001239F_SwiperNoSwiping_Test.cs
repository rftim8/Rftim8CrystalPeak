...
{
    [TestClass]
    public sealed class CF_00001239F_SwiperNoSwiping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001239F_SwiperNoSwiping));
        ...
        {
            bool result = CF_00001239F_SwiperNoSwiping.Solution_0_Test(input);
