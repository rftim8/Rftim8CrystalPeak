...
{
    [TestClass]
    public sealed class CF_00002036F_XORificator3000_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002036F_XORificator3000));
        ...
        {
            bool result = CF_00002036F_XORificator3000.Solution_0_Test(input);
