...
{
    [TestClass]
    public sealed class CF_00000557D_VitalyAndCycle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000557D_VitalyAndCycle));
        ...
        {
            bool result = CF_00000557D_VitalyAndCycle.Solution_0_Test(input);
