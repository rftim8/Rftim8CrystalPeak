...
{
    [TestClass]
    public sealed class CF_00001467E_DistinctiveRootsInATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001467E_DistinctiveRootsInATree));
        ...
        {
            bool result = CF_00001467E_DistinctiveRootsInATree.Solution_0_Test(input);
