...
{
    [TestClass]
    public sealed class CF_00000076E_Points_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000076E_Points));
        ...
        {
            bool result = CF_00000076E_Points.Solution_0_Test(input);
