...
{
    [TestClass]
    public sealed class CF_00001405A_PermutationForgery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001405A_PermutationForgery));
        ...
        {
            bool result = CF_00001405A_PermutationForgery.Solution_0_Test(input);
