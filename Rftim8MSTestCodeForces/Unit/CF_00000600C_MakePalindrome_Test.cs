...
{
    [TestClass]
    public sealed class CF_00000600C_MakePalindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000600C_MakePalindrome));
        ...
        {
            bool result = CF_00000600C_MakePalindrome.Solution_0_Test(input);
