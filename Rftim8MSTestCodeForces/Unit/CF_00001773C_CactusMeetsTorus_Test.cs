...
{
    [TestClass]
    public sealed class CF_00001773C_CactusMeetsTorus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001773C_CactusMeetsTorus));
        ...
        {
            bool result = CF_00001773C_CactusMeetsTorus.Solution_0_Test(input);
