...
{
    [TestClass]
    public sealed class CF_00000978G_PetyasExams_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000978G_PetyasExams));
        ...
        {
            bool result = CF_00000978G_PetyasExams.Solution_0_Test(input);
