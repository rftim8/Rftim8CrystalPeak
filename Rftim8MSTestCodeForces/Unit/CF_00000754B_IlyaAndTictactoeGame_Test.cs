...
{
    [TestClass]
    public sealed class CF_00000754B_IlyaAndTictactoeGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000754B_IlyaAndTictactoeGame));
        ...
        {
            bool result = CF_00000754B_IlyaAndTictactoeGame.Solution_0_Test(input);
