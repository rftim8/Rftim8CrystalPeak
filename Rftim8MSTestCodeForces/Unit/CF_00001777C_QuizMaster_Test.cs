...
{
    [TestClass]
    public sealed class CF_00001777C_QuizMaster_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001777C_QuizMaster));
        ...
        {
            bool result = CF_00001777C_QuizMaster.Solution_0_Test(input);
