...
{
    [TestClass]
    public sealed class CF_00000505E_MrKitayutaVsBamboos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000505E_MrKitayutaVsBamboos));
        ...
        {
            bool result = CF_00000505E_MrKitayutaVsBamboos.Solution_0_Test(input);
