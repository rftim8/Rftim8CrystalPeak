...
{
    [TestClass]
    public sealed class CF_00001734A_SelectThreeSticks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001734A_SelectThreeSticks));
        ...
        {
            bool result = CF_00001734A_SelectThreeSticks.Solution_0_Test(input);
