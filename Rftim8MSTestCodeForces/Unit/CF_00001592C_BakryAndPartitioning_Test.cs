...
{
    [TestClass]
    public sealed class CF_00001592C_BakryAndPartitioning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001592C_BakryAndPartitioning));
        ...
        {
            bool result = CF_00001592C_BakryAndPartitioning.Solution_0_Test(input);
