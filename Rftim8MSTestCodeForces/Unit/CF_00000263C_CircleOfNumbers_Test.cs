...
{
    [TestClass]
    public sealed class CF_00000263C_CircleOfNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000263C_CircleOfNumbers));
        ...
        {
            bool result = CF_00000263C_CircleOfNumbers.Solution_0_Test(input);
