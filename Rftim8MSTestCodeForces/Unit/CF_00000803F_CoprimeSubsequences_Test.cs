...
{
    [TestClass]
    public sealed class CF_00000803F_CoprimeSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000803F_CoprimeSubsequences));
        ...
        {
            bool result = CF_00000803F_CoprimeSubsequences.Solution_0_Test(input);
