...
{
    [TestClass]
    public sealed class CF_00000368A_SerejaAndCoatRack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000368A_SerejaAndCoatRack));
        ...
        {
            bool result = CF_00000368A_SerejaAndCoatRack.Solution_0_Test(input);
