...
{
    [TestClass]
    public sealed class CF_00001466A_BovineDilemma_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001466A_BovineDilemma));
        ...
        {
            bool result = CF_00001466A_BovineDilemma.Solution_0_Test(input);
