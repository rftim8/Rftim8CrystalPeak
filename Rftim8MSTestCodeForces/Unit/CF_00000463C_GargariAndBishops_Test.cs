...
{
    [TestClass]
    public sealed class CF_00000463C_GargariAndBishops_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000463C_GargariAndBishops));
        ...
        {
            bool result = CF_00000463C_GargariAndBishops.Solution_0_Test(input);
