...
{
    [TestClass]
    public sealed class CF_00001980D_GCDsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001980D_GCDsequence));
        ...
        {
            bool result = CF_00001980D_GCDsequence.Solution_0_Test(input);
