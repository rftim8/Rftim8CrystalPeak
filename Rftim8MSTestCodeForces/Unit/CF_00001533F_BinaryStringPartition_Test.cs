...
{
    [TestClass]
    public sealed class CF_00001533F_BinaryStringPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001533F_BinaryStringPartition));
        ...
        {
            bool result = CF_00001533F_BinaryStringPartition.Solution_0_Test(input);
