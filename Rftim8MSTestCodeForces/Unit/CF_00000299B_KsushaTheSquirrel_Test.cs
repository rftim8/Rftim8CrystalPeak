...
{
    [TestClass]
    public sealed class CF_00000299B_KsushaTheSquirrel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000299B_KsushaTheSquirrel));
        ...
        {
            bool result = CF_00000299B_KsushaTheSquirrel.Solution_0_Test(input);
