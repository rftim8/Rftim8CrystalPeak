...
{
    [TestClass]
    public sealed class CF_00001423N_BubbleSquareTokens_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001423N_BubbleSquareTokens));
        ...
        {
            bool result = CF_00001423N_BubbleSquareTokens.Solution_0_Test(input);
