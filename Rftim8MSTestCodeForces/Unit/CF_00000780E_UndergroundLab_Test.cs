...
{
    [TestClass]
    public sealed class CF_00000780E_UndergroundLab_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000780E_UndergroundLab));
        ...
        {
            bool result = CF_00000780E_UndergroundLab.Solution_0_Test(input);
