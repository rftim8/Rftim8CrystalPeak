...
{
    [TestClass]
    public sealed class CF_00001458A_RowGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001458A_RowGCD));
        ...
        {
            bool result = CF_00001458A_RowGCD.Solution_0_Test(input);
