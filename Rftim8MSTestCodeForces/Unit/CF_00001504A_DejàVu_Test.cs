...
{
    [TestClass]
    public sealed class CF_00001504A_DejàVu_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001504A_DejàVu));
        ...
        {
            bool result = CF_00001504A_DejàVu.Solution_0_Test(input);
