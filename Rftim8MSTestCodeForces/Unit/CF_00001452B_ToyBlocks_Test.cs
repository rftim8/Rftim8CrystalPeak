...
{
    [TestClass]
    public sealed class CF_00001452B_ToyBlocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001452B_ToyBlocks));
        ...
        {
            bool result = CF_00001452B_ToyBlocks.Solution_0_Test(input);
