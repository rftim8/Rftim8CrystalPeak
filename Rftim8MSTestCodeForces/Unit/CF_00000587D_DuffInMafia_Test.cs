...
{
    [TestClass]
    public sealed class CF_00000587D_DuffInMafia_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000587D_DuffInMafia));
        ...
        {
            bool result = CF_00000587D_DuffInMafia.Solution_0_Test(input);
