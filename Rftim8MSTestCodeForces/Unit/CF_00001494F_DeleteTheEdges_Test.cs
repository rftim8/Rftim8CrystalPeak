...
{
    [TestClass]
    public sealed class CF_00001494F_DeleteTheEdges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001494F_DeleteTheEdges));
        ...
        {
            bool result = CF_00001494F_DeleteTheEdges.Solution_0_Test(input);
