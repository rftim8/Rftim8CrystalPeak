...
{
    [TestClass]
    public sealed class CF_00001772G_GainingRating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001772G_GainingRating));
        ...
        {
            bool result = CF_00001772G_GainingRating.Solution_0_Test(input);
