...
{
    [TestClass]
    public sealed class CF_00001872A_TwoVessels_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001872A_TwoVessels));
        ...
        {
            bool result = CF_00001872A_TwoVessels.Solution_0_Test(input);
