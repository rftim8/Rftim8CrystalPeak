...
{
    [TestClass]
    public sealed class CF_00001738B_PrefixSumAddicts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001738B_PrefixSumAddicts));
        ...
        {
            bool result = CF_00001738B_PrefixSumAddicts.Solution_0_Test(input);
