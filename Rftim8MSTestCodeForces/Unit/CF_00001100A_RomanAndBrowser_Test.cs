...
{
    [TestClass]
    public sealed class CF_00001100A_RomanAndBrowser_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001100A_RomanAndBrowser));
        ...
        {
            bool result = CF_00001100A_RomanAndBrowser.Solution_0_Test(input);
