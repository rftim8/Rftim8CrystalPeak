...
{
    [TestClass]
    public sealed class CF_00002030C_ATRUEBattle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002030C_ATRUEBattle));
        ...
        {
            bool result = CF_00002030C_ATRUEBattle.Solution_0_Test(input);
