...
{
    [TestClass]
    public sealed class CF_00001216D_Swords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001216D_Swords));
        ...
        {
            bool result = CF_00001216D_Swords.Solution_0_Test(input);
