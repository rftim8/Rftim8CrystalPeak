...
{
    [TestClass]
    public sealed class CF_00001660B_VladAndCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001660B_VladAndCandies));
        ...
        {
            bool result = CF_00001660B_VladAndCandies.Solution_0_Test(input);
