...
{
    [TestClass]
    public sealed class CF_00001096D_EasyProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001096D_EasyProblem));
        ...
        {
            bool result = CF_00001096D_EasyProblem.Solution_0_Test(input);
