...
{
    [TestClass]
    public sealed class CF_00001505E_Cakewalk_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001505E_Cakewalk));
        ...
        {
            bool result = CF_00001505E_Cakewalk.Solution_0_Test(input);
