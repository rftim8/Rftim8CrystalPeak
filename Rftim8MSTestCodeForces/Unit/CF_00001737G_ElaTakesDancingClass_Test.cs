...
{
    [TestClass]
    public sealed class CF_00001737G_ElaTakesDancingClass_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001737G_ElaTakesDancingClass));
        ...
        {
            bool result = CF_00001737G_ElaTakesDancingClass.Solution_0_Test(input);
