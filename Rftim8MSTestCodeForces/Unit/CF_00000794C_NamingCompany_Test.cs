...
{
    [TestClass]
    public sealed class CF_00000794C_NamingCompany_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000794C_NamingCompany));
        ...
        {
            bool result = CF_00000794C_NamingCompany.Solution_0_Test(input);
