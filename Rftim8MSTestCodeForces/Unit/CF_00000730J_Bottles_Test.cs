...
{
    [TestClass]
    public sealed class CF_00000730J_Bottles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000730J_Bottles));
        ...
        {
            bool result = CF_00000730J_Bottles.Solution_0_Test(input);
