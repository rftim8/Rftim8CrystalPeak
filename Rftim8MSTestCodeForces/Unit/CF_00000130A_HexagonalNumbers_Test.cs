...
{
    [TestClass]
    public sealed class CF_00000130A_HexagonalNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000130A_HexagonalNumbers));
        ...
        {
            bool result = CF_00000130A_HexagonalNumbers.Solution_0_Test(input);
