...
{
    [TestClass]
    public sealed class CF_00001156B_UglyPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001156B_UglyPairs));
        ...
        {
            bool result = CF_00001156B_UglyPairs.Solution_0_Test(input);
