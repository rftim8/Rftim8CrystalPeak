...
{
    [TestClass]
    public sealed class CF_00001470D_StrangeHousing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001470D_StrangeHousing));
        ...
        {
            bool result = CF_00001470D_StrangeHousing.Solution_0_Test(input);
