...
{
    [TestClass]
    public sealed class CF_00001196F_KthPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001196F_KthPath));
        ...
        {
            bool result = CF_00001196F_KthPath.Solution_0_Test(input);
