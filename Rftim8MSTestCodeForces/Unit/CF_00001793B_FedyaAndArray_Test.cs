...
{
    [TestClass]
    public sealed class CF_00001793B_FedyaAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001793B_FedyaAndArray));
        ...
        {
            bool result = CF_00001793B_FedyaAndArray.Solution_0_Test(input);
