...
{
    [TestClass]
    public sealed class CF_00000060E_MushroomGnomes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000060E_MushroomGnomes));
        ...
        {
            bool result = CF_00000060E_MushroomGnomes.Solution_0_Test(input);
