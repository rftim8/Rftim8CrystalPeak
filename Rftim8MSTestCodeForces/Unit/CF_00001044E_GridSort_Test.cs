...
{
    [TestClass]
    public sealed class CF_00001044E_GridSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001044E_GridSort));
        ...
        {
            bool result = CF_00001044E_GridSort.Solution_0_Test(input);
