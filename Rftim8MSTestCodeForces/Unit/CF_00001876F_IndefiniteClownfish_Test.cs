...
{
    [TestClass]
    public sealed class CF_00001876F_IndefiniteClownfish_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001876F_IndefiniteClownfish));
        ...
        {
            bool result = CF_00001876F_IndefiniteClownfish.Solution_0_Test(input);
