...
{
    [TestClass]
    public sealed class CF_00001575B_BuildingAnAmusementPark_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575B_BuildingAnAmusementPark));
        ...
        {
            bool result = CF_00001575B_BuildingAnAmusementPark.Solution_0_Test(input);
