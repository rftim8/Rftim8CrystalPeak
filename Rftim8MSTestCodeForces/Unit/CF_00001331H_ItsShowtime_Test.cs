...
{
    [TestClass]
    public sealed class CF_00001331H_ItsShowtime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001331H_ItsShowtime));
        ...
        {
            bool result = CF_00001331H_ItsShowtime.Solution_0_Test(input);
