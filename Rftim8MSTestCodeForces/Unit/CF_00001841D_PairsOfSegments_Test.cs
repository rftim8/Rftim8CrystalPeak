...
{
    [TestClass]
    public sealed class CF_00001841D_PairsOfSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001841D_PairsOfSegments));
        ...
        {
            bool result = CF_00001841D_PairsOfSegments.Solution_0_Test(input);
