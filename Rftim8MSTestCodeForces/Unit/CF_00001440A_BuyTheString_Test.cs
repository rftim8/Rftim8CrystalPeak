...
{
    [TestClass]
    public sealed class CF_00001440A_BuyTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001440A_BuyTheString));
        ...
        {
            bool result = CF_00001440A_BuyTheString.Solution_0_Test(input);
