...
{
    [TestClass]
    public sealed class CF_00001602A_TwoSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001602A_TwoSubsequences));
        ...
        {
            bool result = CF_00001602A_TwoSubsequences.Solution_0_Test(input);
