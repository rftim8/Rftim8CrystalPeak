...
{
    [TestClass]
    public sealed class CF_00001790E_VladAndAPairOfNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001790E_VladAndAPairOfNumbers));
        ...
        {
            bool result = CF_00001790E_VladAndAPairOfNumbers.Solution_0_Test(input);
