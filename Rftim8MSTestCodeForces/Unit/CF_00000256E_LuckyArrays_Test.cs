...
{
    [TestClass]
    public sealed class CF_00000256E_LuckyArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000256E_LuckyArrays));
        ...
        {
            bool result = CF_00000256E_LuckyArrays.Solution_0_Test(input);
