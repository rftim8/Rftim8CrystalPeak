...
{
    [TestClass]
    public sealed class CF_00001437D_MinimalHeightTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001437D_MinimalHeightTree));
        ...
        {
            bool result = CF_00001437D_MinimalHeightTree.Solution_0_Test(input);
