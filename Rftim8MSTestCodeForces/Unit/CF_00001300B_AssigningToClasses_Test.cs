...
{
    [TestClass]
    public sealed class CF_00001300B_AssigningToClasses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001300B_AssigningToClasses));
        ...
        {
            bool result = CF_00001300B_AssigningToClasses.Solution_0_Test(input);
