...
{
    [TestClass]
    public sealed class CF_00000390A_InnaAndAlarmClock_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000390A_InnaAndAlarmClock));
        ...
        {
            bool result = CF_00000390A_InnaAndAlarmClock.Solution_0_Test(input);
