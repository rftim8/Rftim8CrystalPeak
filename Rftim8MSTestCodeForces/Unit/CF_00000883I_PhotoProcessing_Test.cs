...
{
    [TestClass]
    public sealed class CF_00000883I_PhotoProcessing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883I_PhotoProcessing));
        ...
        {
            bool result = CF_00000883I_PhotoProcessing.Solution_0_Test(input);
