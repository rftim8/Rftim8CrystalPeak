...
{
    [TestClass]
    public sealed class CF_00000884D_BoxesAndBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000884D_BoxesAndBalls));
        ...
        {
            bool result = CF_00000884D_BoxesAndBalls.Solution_0_Test(input);
