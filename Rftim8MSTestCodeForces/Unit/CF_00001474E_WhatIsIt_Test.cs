...
{
    [TestClass]
    public sealed class CF_00001474E_WhatIsIt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001474E_WhatIsIt));
        ...
        {
            bool result = CF_00001474E_WhatIsIt.Solution_0_Test(input);
