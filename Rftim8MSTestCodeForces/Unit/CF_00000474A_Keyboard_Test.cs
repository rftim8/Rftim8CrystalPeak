...
{
    [TestClass]
    public sealed class CF_00000474A_Keyboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000474A_Keyboard));
        ...
        {
            bool result = CF_00000474A_Keyboard.Solution_0_Test(input);
