...
{
    [TestClass]
    public sealed class CF_00001977D_XORificator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001977D_XORificator));
        ...
        {
            bool result = CF_00001977D_XORificator.Solution_0_Test(input);
