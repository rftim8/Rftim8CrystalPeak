...
{
    [TestClass]
    public sealed class CF_00001628D1_GameOnSumEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001628D1_GameOnSumEasyVersion));
        ...
        {
            bool result = CF_00001628D1_GameOnSumEasyVersion.Solution_0_Test(input);
