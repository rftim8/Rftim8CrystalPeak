...
{
    [TestClass]
    public sealed class CF_00001898E_SofiaAndStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001898E_SofiaAndStrings));
        ...
        {
            bool result = CF_00001898E_SofiaAndStrings.Solution_0_Test(input);
