...
{
    [TestClass]
    public sealed class CF_00001397B_PowerSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001397B_PowerSequence));
        ...
        {
            bool result = CF_00001397B_PowerSequence.Solution_0_Test(input);
