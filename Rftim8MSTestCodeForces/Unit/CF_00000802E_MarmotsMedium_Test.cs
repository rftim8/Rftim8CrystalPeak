...
{
    [TestClass]
    public sealed class CF_00000802E_MarmotsMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802E_MarmotsMedium));
        ...
        {
            bool result = CF_00000802E_MarmotsMedium.Solution_0_Test(input);
