...
{
    [TestClass]
    public sealed class CF_00001186F_VusTheCossackAndAGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001186F_VusTheCossackAndAGraph));
        ...
        {
            bool result = CF_00001186F_VusTheCossackAndAGraph.Solution_0_Test(input);
