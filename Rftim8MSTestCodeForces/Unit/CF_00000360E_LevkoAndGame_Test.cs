...
{
    [TestClass]
    public sealed class CF_00000360E_LevkoAndGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000360E_LevkoAndGame));
        ...
        {
            bool result = CF_00000360E_LevkoAndGame.Solution_0_Test(input);
