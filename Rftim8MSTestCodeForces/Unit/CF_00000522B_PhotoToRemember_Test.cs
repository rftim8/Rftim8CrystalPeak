...
{
    [TestClass]
    public sealed class CF_00000522B_PhotoToRemember_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000522B_PhotoToRemember));
        ...
        {
            bool result = CF_00000522B_PhotoToRemember.Solution_0_Test(input);
