...
{
    [TestClass]
    public sealed class CF_00001517A_SumOf2050_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001517A_SumOf2050));
        ...
        {
            bool result = CF_00001517A_SumOf2050.Solution_0_Test(input);
