...
{
    [TestClass]
    public sealed class CF_00001738C_EvenNumberAddicts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001738C_EvenNumberAddicts));
        ...
        {
            bool result = CF_00001738C_EvenNumberAddicts.Solution_0_Test(input);
