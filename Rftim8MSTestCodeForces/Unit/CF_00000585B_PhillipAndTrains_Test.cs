...
{
    [TestClass]
    public sealed class CF_00000585B_PhillipAndTrains_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000585B_PhillipAndTrains));
        ...
        {
            bool result = CF_00000585B_PhillipAndTrains.Solution_0_Test(input);
