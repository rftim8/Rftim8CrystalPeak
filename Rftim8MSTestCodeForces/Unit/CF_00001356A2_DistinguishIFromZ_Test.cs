...
{
    [TestClass]
    public sealed class CF_00001356A2_DistinguishIFromZ_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001356A2_DistinguishIFromZ));
        ...
        {
            bool result = CF_00001356A2_DistinguishIFromZ.Solution_0_Test(input);
