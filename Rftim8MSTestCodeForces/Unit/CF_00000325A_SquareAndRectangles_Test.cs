...
{
    [TestClass]
    public sealed class CF_00000325A_SquareAndRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000325A_SquareAndRectangles));
        ...
        {
            bool result = CF_00000325A_SquareAndRectangles.Solution_0_Test(input);
