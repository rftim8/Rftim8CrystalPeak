...
{
    [TestClass]
    public sealed class CF_00001413C_PerformEasily_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001413C_PerformEasily));
        ...
        {
            bool result = CF_00001413C_PerformEasily.Solution_0_Test(input);
