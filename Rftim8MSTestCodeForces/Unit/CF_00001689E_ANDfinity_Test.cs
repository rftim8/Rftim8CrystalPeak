...
{
    [TestClass]
    public sealed class CF_00001689E_ANDfinity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001689E_ANDfinity));
        ...
        {
            bool result = CF_00001689E_ANDfinity.Solution_0_Test(input);
