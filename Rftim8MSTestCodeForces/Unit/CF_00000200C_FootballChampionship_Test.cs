...
{
    [TestClass]
    public sealed class CF_00000200C_FootballChampionship_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000200C_FootballChampionship));
        ...
        {
            bool result = CF_00000200C_FootballChampionship.Solution_0_Test(input);
