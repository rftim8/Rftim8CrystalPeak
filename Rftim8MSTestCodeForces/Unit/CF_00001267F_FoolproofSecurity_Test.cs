...
{
    [TestClass]
    public sealed class CF_00001267F_FoolproofSecurity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001267F_FoolproofSecurity));
        ...
        {
            bool result = CF_00001267F_FoolproofSecurity.Solution_0_Test(input);
