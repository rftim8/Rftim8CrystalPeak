...
{
    [TestClass]
    public sealed class CF_00000464A_NoToPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000464A_NoToPalindromes));
        ...
        {
            bool result = CF_00000464A_NoToPalindromes.Solution_0_Test(input);
