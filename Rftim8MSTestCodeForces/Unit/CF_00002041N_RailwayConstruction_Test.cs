...
{
    [TestClass]
    public sealed class CF_00002041N_RailwayConstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002041N_RailwayConstruction));
        ...
        {
            bool result = CF_00002041N_RailwayConstruction.Solution_0_Test(input);
