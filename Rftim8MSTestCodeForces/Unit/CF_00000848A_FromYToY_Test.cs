...
{
    [TestClass]
    public sealed class CF_00000848A_FromYToY_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000848A_FromYToY));
        ...
        {
            bool result = CF_00000848A_FromYToY.Solution_0_Test(input);
