...
{
    [TestClass]
    public sealed class CF_00001979B_XORSequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001979B_XORSequences));
        ...
        {
            bool result = CF_00001979B_XORSequences.Solution_0_Test(input);
