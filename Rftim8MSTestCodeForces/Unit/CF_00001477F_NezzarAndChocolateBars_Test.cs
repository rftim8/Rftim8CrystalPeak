...
{
    [TestClass]
    public sealed class CF_00001477F_NezzarAndChocolateBars_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001477F_NezzarAndChocolateBars));
        ...
        {
            bool result = CF_00001477F_NezzarAndChocolateBars.Solution_0_Test(input);
