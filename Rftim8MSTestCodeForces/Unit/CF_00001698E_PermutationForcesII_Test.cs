...
{
    [TestClass]
    public sealed class CF_00001698E_PermutationForcesII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001698E_PermutationForcesII));
        ...
        {
            bool result = CF_00001698E_PermutationForcesII.Solution_0_Test(input);
