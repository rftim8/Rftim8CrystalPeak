...
{
    [TestClass]
    public sealed class CF_00000501B_MishaAndChangingHandles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000501B_MishaAndChangingHandles));
        ...
        {
            bool result = CF_00000501B_MishaAndChangingHandles.Solution_0_Test(input);
