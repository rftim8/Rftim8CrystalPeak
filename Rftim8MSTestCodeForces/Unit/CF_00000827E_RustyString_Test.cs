...
{
    [TestClass]
    public sealed class CF_00000827E_RustyString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000827E_RustyString));
        ...
        {
            bool result = CF_00000827E_RustyString.Solution_0_Test(input);
