...
{
    [TestClass]
    public sealed class CF_00000850B_ArpaAndAListOfNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000850B_ArpaAndAListOfNumbers));
        ...
        {
            bool result = CF_00000850B_ArpaAndAListOfNumbers.Solution_0_Test(input);
