...
{
    [TestClass]
    public sealed class CF_00001025A_DoggoRecoloring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001025A_DoggoRecoloring));
        ...
        {
            bool result = CF_00001025A_DoggoRecoloring.Solution_0_Test(input);
