...
{
    [TestClass]
    public sealed class CF_00000804F_FakeBullions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000804F_FakeBullions));
        ...
        {
            bool result = CF_00000804F_FakeBullions.Solution_0_Test(input);
