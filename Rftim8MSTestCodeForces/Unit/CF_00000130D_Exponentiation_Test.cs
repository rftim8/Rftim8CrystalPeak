...
{
    [TestClass]
    public sealed class CF_00000130D_Exponentiation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000130D_Exponentiation));
        ...
        {
            bool result = CF_00000130D_Exponentiation.Solution_0_Test(input);
