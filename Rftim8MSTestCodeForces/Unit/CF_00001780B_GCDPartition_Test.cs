...
{
    [TestClass]
    public sealed class CF_00001780B_GCDPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001780B_GCDPartition));
        ...
        {
            bool result = CF_00001780B_GCDPartition.Solution_0_Test(input);
