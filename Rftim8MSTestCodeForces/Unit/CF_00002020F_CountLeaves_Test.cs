...
{
    [TestClass]
    public sealed class CF_00002020F_CountLeaves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002020F_CountLeaves));
        ...
        {
            bool result = CF_00002020F_CountLeaves.Solution_0_Test(input);
