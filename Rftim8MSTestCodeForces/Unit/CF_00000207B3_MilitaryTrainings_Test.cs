...
{
    [TestClass]
    public sealed class CF_00000207B3_MilitaryTrainings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000207B3_MilitaryTrainings));
        ...
        {
            bool result = CF_00000207B3_MilitaryTrainings.Solution_0_Test(input);
