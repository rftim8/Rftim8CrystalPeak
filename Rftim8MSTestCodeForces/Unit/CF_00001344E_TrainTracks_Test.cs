...
{
    [TestClass]
    public sealed class CF_00001344E_TrainTracks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001344E_TrainTracks));
        ...
        {
            bool result = CF_00001344E_TrainTracks.Solution_0_Test(input);
