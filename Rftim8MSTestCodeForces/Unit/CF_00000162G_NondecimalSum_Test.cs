...
{
    [TestClass]
    public sealed class CF_00000162G_NondecimalSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000162G_NondecimalSum));
        ...
        {
            bool result = CF_00000162G_NondecimalSum.Solution_0_Test(input);
