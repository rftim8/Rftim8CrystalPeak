...
{
    [TestClass]
    public sealed class CF_00001603F_October182017_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001603F_October182017));
        ...
        {
            bool result = CF_00001603F_October182017.Solution_0_Test(input);
