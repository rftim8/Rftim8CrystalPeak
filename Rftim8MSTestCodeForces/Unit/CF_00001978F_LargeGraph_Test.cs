...
{
    [TestClass]
    public sealed class CF_00001978F_LargeGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001978F_LargeGraph));
        ...
        {
            bool result = CF_00001978F_LargeGraph.Solution_0_Test(input);
