...
{
    [TestClass]
    public sealed class CF_00000590D_TopSecretTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000590D_TopSecretTask));
        ...
        {
            bool result = CF_00000590D_TopSecretTask.Solution_0_Test(input);
