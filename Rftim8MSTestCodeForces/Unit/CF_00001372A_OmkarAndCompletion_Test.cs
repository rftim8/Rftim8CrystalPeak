...
{
    [TestClass]
    public sealed class CF_00001372A_OmkarAndCompletion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001372A_OmkarAndCompletion));
        ...
        {
            bool result = CF_00001372A_OmkarAndCompletion.Solution_0_Test(input);
