...
{
    [TestClass]
    public sealed class CF_00001496A_SplitIt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001496A_SplitIt));
        ...
        {
            bool result = CF_00001496A_SplitIt.Solution_0_Test(input);
