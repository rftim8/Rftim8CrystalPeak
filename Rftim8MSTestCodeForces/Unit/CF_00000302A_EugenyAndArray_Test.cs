...
{
    [TestClass]
    public sealed class CF_00000302A_EugenyAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000302A_EugenyAndArray));
        ...
        {
            bool result = CF_00000302A_EugenyAndArray.Solution_0_Test(input);
