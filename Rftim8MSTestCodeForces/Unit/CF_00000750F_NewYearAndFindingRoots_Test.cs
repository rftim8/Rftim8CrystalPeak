...
{
    [TestClass]
    public sealed class CF_00000750F_NewYearAndFindingRoots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000750F_NewYearAndFindingRoots));
        ...
        {
            bool result = CF_00000750F_NewYearAndFindingRoots.Solution_0_Test(input);
