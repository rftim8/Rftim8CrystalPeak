...
{
    [TestClass]
    public sealed class CF_00001439E_CheatAndWin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001439E_CheatAndWin));
        ...
        {
            bool result = CF_00001439E_CheatAndWin.Solution_0_Test(input);
