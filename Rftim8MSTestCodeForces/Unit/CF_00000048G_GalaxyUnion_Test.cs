...
{
    [TestClass]
    public sealed class CF_00000048G_GalaxyUnion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000048G_GalaxyUnion));
        ...
        {
            bool result = CF_00000048G_GalaxyUnion.Solution_0_Test(input);
