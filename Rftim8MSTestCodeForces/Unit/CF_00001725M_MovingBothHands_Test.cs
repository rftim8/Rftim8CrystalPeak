...
{
    [TestClass]
    public sealed class CF_00001725M_MovingBothHands_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725M_MovingBothHands));
        ...
        {
            bool result = CF_00001725M_MovingBothHands.Solution_0_Test(input);
