...
{
    [TestClass]
    public sealed class CF_00000005E_BindianSignalizing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000005E_BindianSignalizing));
        ...
        {
            bool result = CF_00000005E_BindianSignalizing.Solution_0_Test(input);
