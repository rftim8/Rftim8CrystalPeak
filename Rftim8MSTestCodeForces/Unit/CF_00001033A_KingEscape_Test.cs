...
{
    [TestClass]
    public sealed class CF_00001033A_KingEscape_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001033A_KingEscape));
        ...
        {
            bool result = CF_00001033A_KingEscape.Solution_0_Test(input);
