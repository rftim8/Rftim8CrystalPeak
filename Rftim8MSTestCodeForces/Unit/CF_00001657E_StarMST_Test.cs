...
{
    [TestClass]
    public sealed class CF_00001657E_StarMST_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001657E_StarMST));
        ...
        {
            bool result = CF_00001657E_StarMST.Solution_0_Test(input);
