...
{
    [TestClass]
    public sealed class CF_00000935F_FafaAndArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000935F_FafaAndArray));
        ...
        {
            bool result = CF_00000935F_FafaAndArray.Solution_0_Test(input);
