...
{
    [TestClass]
    public sealed class CF_00001244E_MinimizingDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001244E_MinimizingDifference));
        ...
        {
            bool result = CF_00001244E_MinimizingDifference.Solution_0_Test(input);
