...
{
    [TestClass]
    public sealed class CF_00000441D_ValeraAndSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000441D_ValeraAndSwaps));
        ...
        {
            bool result = CF_00000441D_ValeraAndSwaps.Solution_0_Test(input);
