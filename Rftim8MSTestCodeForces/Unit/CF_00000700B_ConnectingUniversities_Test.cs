...
{
    [TestClass]
    public sealed class CF_00000700B_ConnectingUniversities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000700B_ConnectingUniversities));
        ...
        {
            bool result = CF_00000700B_ConnectingUniversities.Solution_0_Test(input);
