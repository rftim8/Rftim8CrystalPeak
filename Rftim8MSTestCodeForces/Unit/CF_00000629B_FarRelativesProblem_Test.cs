...
{
    [TestClass]
    public sealed class CF_00000629B_FarRelativesProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000629B_FarRelativesProblem));
        ...
        {
            bool result = CF_00000629B_FarRelativesProblem.Solution_0_Test(input);
