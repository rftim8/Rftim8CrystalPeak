...
{
    [TestClass]
    public sealed class CF_00000049C_Disposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000049C_Disposition));
        ...
        {
            bool result = CF_00000049C_Disposition.Solution_0_Test(input);
