...
{
    [TestClass]
    public sealed class CF_00001469B_RedAndBlue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001469B_RedAndBlue));
        ...
        {
            bool result = CF_00001469B_RedAndBlue.Solution_0_Test(input);
