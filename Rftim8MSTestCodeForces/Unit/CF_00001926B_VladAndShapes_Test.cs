...
{
    [TestClass]
    public sealed class CF_00001926B_VladAndShapes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001926B_VladAndShapes));
        ...
        {
            bool result = CF_00001926B_VladAndShapes.Solution_0_Test(input);
