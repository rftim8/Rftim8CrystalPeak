...
{
    [TestClass]
    public sealed class CF_00001020B_Badge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001020B_Badge));
        ...
        {
            bool result = CF_00001020B_Badge.Solution_0_Test(input);
