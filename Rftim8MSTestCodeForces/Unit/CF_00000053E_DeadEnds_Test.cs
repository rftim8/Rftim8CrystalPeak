...
{
    [TestClass]
    public sealed class CF_00000053E_DeadEnds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000053E_DeadEnds));
        ...
        {
            bool result = CF_00000053E_DeadEnds.Solution_0_Test(input);
