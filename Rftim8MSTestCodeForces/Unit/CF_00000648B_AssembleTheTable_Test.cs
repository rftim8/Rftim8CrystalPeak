...
{
    [TestClass]
    public sealed class CF_00000648B_AssembleTheTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000648B_AssembleTheTable));
        ...
        {
            bool result = CF_00000648B_AssembleTheTable.Solution_0_Test(input);
