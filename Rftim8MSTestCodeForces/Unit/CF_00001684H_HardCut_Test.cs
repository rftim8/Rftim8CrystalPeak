...
{
    [TestClass]
    public sealed class CF_00001684H_HardCut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001684H_HardCut));
        ...
        {
            bool result = CF_00001684H_HardCut.Solution_0_Test(input);
