...
{
    [TestClass]
    public sealed class CF_00001930G_PrefixMaxSetCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001930G_PrefixMaxSetCounting));
        ...
        {
            bool result = CF_00001930G_PrefixMaxSetCounting.Solution_0_Test(input);
