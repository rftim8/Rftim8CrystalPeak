...
{
    [TestClass]
    public sealed class CF_00000707B_Bakery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000707B_Bakery));
        ...
        {
            bool result = CF_00000707B_Bakery.Solution_0_Test(input);
