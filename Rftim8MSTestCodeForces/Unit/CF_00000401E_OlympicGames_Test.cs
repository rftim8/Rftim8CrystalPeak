...
{
    [TestClass]
    public sealed class CF_00000401E_OlympicGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000401E_OlympicGames));
        ...
        {
            bool result = CF_00000401E_OlympicGames.Solution_0_Test(input);
