...
{
    [TestClass]
    public sealed class CF_00000592A_PawnChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000592A_PawnChess));
        ...
        {
            bool result = CF_00000592A_PawnChess.Solution_0_Test(input);
