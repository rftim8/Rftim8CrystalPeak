...
{
    [TestClass]
    public sealed class CF_00000232C_DoeGraphs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000232C_DoeGraphs));
        ...
        {
            bool result = CF_00000232C_DoeGraphs.Solution_0_Test(input);
