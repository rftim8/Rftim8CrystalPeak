...
{
    [TestClass]
    public sealed class CF_00001439B_GraphSubsetProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001439B_GraphSubsetProblem));
        ...
        {
            bool result = CF_00001439B_GraphSubsetProblem.Solution_0_Test(input);
