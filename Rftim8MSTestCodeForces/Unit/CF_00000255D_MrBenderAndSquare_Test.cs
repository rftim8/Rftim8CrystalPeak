...
{
    [TestClass]
    public sealed class CF_00000255D_MrBenderAndSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000255D_MrBenderAndSquare));
        ...
        {
            bool result = CF_00000255D_MrBenderAndSquare.Solution_0_Test(input);
