...
{
    [TestClass]
    public sealed class CF_00001510A_ASCIIAutomataArt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001510A_ASCIIAutomataArt));
        ...
        {
            bool result = CF_00001510A_ASCIIAutomataArt.Solution_0_Test(input);
