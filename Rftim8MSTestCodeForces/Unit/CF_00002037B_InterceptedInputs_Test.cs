...
{
    [TestClass]
    public sealed class CF_00002037B_InterceptedInputs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002037B_InterceptedInputs));
        ...
        {
            bool result = CF_00002037B_InterceptedInputs.Solution_0_Test(input);
