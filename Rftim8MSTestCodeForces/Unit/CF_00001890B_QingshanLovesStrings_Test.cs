...
{
    [TestClass]
    public sealed class CF_00001890B_QingshanLovesStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001890B_QingshanLovesStrings));
        ...
        {
            bool result = CF_00001890B_QingshanLovesStrings.Solution_0_Test(input);
