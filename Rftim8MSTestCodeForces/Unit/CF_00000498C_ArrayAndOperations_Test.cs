...
{
    [TestClass]
    public sealed class CF_00000498C_ArrayAndOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000498C_ArrayAndOperations));
        ...
        {
            bool result = CF_00000498C_ArrayAndOperations.Solution_0_Test(input);
