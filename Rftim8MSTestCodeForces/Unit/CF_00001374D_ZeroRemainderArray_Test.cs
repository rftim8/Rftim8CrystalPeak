...
{
    [TestClass]
    public sealed class CF_00001374D_ZeroRemainderArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001374D_ZeroRemainderArray));
        ...
        {
            bool result = CF_00001374D_ZeroRemainderArray.Solution_0_Test(input);
