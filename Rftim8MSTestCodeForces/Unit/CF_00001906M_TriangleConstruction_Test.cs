...
{
    [TestClass]
    public sealed class CF_00001906M_TriangleConstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001906M_TriangleConstruction));
        ...
        {
            bool result = CF_00001906M_TriangleConstruction.Solution_0_Test(input);
