...
{
    [TestClass]
    public sealed class CF_00001956D_NeneAndTheMexOperator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001956D_NeneAndTheMexOperator));
        ...
        {
            bool result = CF_00001956D_NeneAndTheMexOperator.Solution_0_Test(input);
