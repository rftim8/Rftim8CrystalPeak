...
{
    [TestClass]
    public sealed class CF_00001027D_MouseHunt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001027D_MouseHunt));
        ...
        {
            bool result = CF_00001027D_MouseHunt.Solution_0_Test(input);
