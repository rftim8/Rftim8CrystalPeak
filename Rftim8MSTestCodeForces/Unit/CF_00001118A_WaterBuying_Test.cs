...
{
    [TestClass]
    public sealed class CF_00001118A_WaterBuying_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001118A_WaterBuying));
        ...
        {
            bool result = CF_00001118A_WaterBuying.Solution_0_Test(input);
