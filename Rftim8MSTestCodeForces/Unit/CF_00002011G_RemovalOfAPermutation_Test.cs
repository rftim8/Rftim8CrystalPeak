...
{
    [TestClass]
    public sealed class CF_00002011G_RemovalOfAPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002011G_RemovalOfAPermutation));
        ...
        {
            bool result = CF_00002011G_RemovalOfAPermutation.Solution_0_Test(input);
