...
{
    [TestClass]
    public sealed class CF_00000778B_BitwiseFormula_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000778B_BitwiseFormula));
        ...
        {
            bool result = CF_00000778B_BitwiseFormula.Solution_0_Test(input);
