...
{
    [TestClass]
    public sealed class CF_00001101C_DivisionAndUnion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001101C_DivisionAndUnion));
        ...
        {
            bool result = CF_00001101C_DivisionAndUnion.Solution_0_Test(input);
