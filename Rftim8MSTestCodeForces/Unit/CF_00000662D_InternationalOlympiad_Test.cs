...
{
    [TestClass]
    public sealed class CF_00000662D_InternationalOlympiad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000662D_InternationalOlympiad));
        ...
        {
            bool result = CF_00000662D_InternationalOlympiad.Solution_0_Test(input);
