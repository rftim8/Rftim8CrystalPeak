...
{
    [TestClass]
    public sealed class CF_00001404E_Bricks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001404E_Bricks));
        ...
        {
            bool result = CF_00001404E_Bricks.Solution_0_Test(input);
