...
{
    [TestClass]
    public sealed class CF_00001674F_DesktopRearrangement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001674F_DesktopRearrangement));
        ...
        {
            bool result = CF_00001674F_DesktopRearrangement.Solution_0_Test(input);
