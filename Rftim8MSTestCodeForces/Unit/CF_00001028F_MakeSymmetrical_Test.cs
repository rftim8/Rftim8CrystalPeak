...
{
    [TestClass]
    public sealed class CF_00001028F_MakeSymmetrical_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001028F_MakeSymmetrical));
        ...
        {
            bool result = CF_00001028F_MakeSymmetrical.Solution_0_Test(input);
