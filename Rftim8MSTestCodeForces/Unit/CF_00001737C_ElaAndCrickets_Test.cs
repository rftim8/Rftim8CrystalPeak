...
{
    [TestClass]
    public sealed class CF_00001737C_ElaAndCrickets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001737C_ElaAndCrickets));
        ...
        {
            bool result = CF_00001737C_ElaAndCrickets.Solution_0_Test(input);
