...
{
    [TestClass]
    public sealed class CF_00001534B_HistogramUgliness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001534B_HistogramUgliness));
        ...
        {
            bool result = CF_00001534B_HistogramUgliness.Solution_0_Test(input);
