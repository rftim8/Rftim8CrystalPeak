...
{
    [TestClass]
    public sealed class CF_00000154D_FlatlandFencin_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000154D_FlatlandFencin));
        ...
        {
            bool result = CF_00000154D_FlatlandFencin.Solution_0_Test(input);
