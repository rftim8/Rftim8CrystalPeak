...
{
    [TestClass]
    public sealed class CF_00001423G_GrowingFlowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001423G_GrowingFlowers));
        ...
        {
            bool result = CF_00001423G_GrowingFlowers.Solution_0_Test(input);
