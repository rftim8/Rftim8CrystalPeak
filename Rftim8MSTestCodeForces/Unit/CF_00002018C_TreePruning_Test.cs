...
{
    [TestClass]
    public sealed class CF_00002018C_TreePruning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002018C_TreePruning));
        ...
        {
            bool result = CF_00002018C_TreePruning.Solution_0_Test(input);
