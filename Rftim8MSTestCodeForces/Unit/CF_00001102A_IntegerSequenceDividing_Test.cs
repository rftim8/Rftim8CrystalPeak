...
{
    [TestClass]
    public sealed class CF_00001102A_IntegerSequenceDividing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001102A_IntegerSequenceDividing));
        ...
        {
            bool result = CF_00001102A_IntegerSequenceDividing.Solution_0_Test(input);
