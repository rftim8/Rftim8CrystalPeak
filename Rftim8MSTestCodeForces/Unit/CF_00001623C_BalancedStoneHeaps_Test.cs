...
{
    [TestClass]
    public sealed class CF_00001623C_BalancedStoneHeaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001623C_BalancedStoneHeaps));
        ...
        {
            bool result = CF_00001623C_BalancedStoneHeaps.Solution_0_Test(input);
