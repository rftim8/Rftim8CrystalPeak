...
{
    [TestClass]
    public sealed class CF_00001004C_SonyaAndRobots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001004C_SonyaAndRobots));
        ...
        {
            bool result = CF_00001004C_SonyaAndRobots.Solution_0_Test(input);
