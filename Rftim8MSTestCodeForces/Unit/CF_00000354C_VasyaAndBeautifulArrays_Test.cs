...
{
    [TestClass]
    public sealed class CF_00000354C_VasyaAndBeautifulArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000354C_VasyaAndBeautifulArrays));
        ...
        {
            bool result = CF_00000354C_VasyaAndBeautifulArrays.Solution_0_Test(input);
