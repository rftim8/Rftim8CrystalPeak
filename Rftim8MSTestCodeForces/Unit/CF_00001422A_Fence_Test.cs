...
{
    [TestClass]
    public sealed class CF_00001422A_Fence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001422A_Fence));
        ...
        {
            bool result = CF_00001422A_Fence.Solution_0_Test(input);
