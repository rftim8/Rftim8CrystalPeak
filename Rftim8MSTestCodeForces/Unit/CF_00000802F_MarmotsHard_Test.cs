...
{
    [TestClass]
    public sealed class CF_00000802F_MarmotsHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802F_MarmotsHard));
        ...
        {
            bool result = CF_00000802F_MarmotsHard.Solution_0_Test(input);
