...
{
    [TestClass]
    public sealed class CF_00000459C_PashmakAndBuses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000459C_PashmakAndBuses));
        ...
        {
            bool result = CF_00000459C_PashmakAndBuses.Solution_0_Test(input);
