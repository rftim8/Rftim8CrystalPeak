...
{
    [TestClass]
    public sealed class CF_00000400D_DimaAndBacteria_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000400D_DimaAndBacteria));
        ...
        {
            bool result = CF_00000400D_DimaAndBacteria.Solution_0_Test(input);
