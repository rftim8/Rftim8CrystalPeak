...
{
    [TestClass]
    public sealed class CF_00001381A2_PrefixFlipHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001381A2_PrefixFlipHardVersion));
        ...
        {
            bool result = CF_00001381A2_PrefixFlipHardVersion.Solution_0_Test(input);
