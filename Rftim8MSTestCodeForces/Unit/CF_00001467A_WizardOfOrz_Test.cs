...
{
    [TestClass]
    public sealed class CF_00001467A_WizardOfOrz_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001467A_WizardOfOrz));
        ...
        {
            bool result = CF_00001467A_WizardOfOrz.Solution_0_Test(input);
