...
{
    [TestClass]
    public sealed class CF_00000500D_NewYearSantaNetwork_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000500D_NewYearSantaNetwork));
        ...
        {
            bool result = CF_00000500D_NewYearSantaNetwork.Solution_0_Test(input);
