...
{
    [TestClass]
    public sealed class CF_00000452D_WasherDryerFolder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000452D_WasherDryerFolder));
        ...
        {
            bool result = CF_00000452D_WasherDryerFolder.Solution_0_Test(input);
