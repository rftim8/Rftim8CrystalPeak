...
{
    [TestClass]
    public sealed class CF_00001661D_ProgressionsCovering_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001661D_ProgressionsCovering));
        ...
        {
            bool result = CF_00001661D_ProgressionsCovering.Solution_0_Test(input);
