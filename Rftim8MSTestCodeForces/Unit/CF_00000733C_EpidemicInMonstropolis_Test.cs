...
{
    [TestClass]
    public sealed class CF_00000733C_EpidemicInMonstropolis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000733C_EpidemicInMonstropolis));
        ...
        {
            bool result = CF_00000733C_EpidemicInMonstropolis.Solution_0_Test(input);
