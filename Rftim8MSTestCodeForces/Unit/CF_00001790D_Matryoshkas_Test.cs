...
{
    [TestClass]
    public sealed class CF_00001790D_Matryoshkas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001790D_Matryoshkas));
        ...
        {
            bool result = CF_00001790D_Matryoshkas.Solution_0_Test(input);
