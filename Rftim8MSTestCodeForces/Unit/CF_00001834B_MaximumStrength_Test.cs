...
{
    [TestClass]
    public sealed class CF_00001834B_MaximumStrength_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001834B_MaximumStrength));
        ...
        {
            bool result = CF_00001834B_MaximumStrength.Solution_0_Test(input);
