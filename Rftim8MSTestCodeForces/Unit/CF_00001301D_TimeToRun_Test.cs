...
{
    [TestClass]
    public sealed class CF_00001301D_TimeToRun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001301D_TimeToRun));
        ...
        {
            bool result = CF_00001301D_TimeToRun.Solution_0_Test(input);
