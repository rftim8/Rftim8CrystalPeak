...
{
    [TestClass]
    public sealed class CF_00001348C_PhoenixAndDistribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001348C_PhoenixAndDistribution));
        ...
        {
            bool result = CF_00001348C_PhoenixAndDistribution.Solution_0_Test(input);
