...
{
    [TestClass]
    public sealed class CF_00000922E_Birds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000922E_Birds));
        ...
        {
            bool result = CF_00000922E_Birds.Solution_0_Test(input);
