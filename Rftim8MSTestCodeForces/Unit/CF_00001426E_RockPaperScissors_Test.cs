...
{
    [TestClass]
    public sealed class CF_00001426E_RockPaperScissors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001426E_RockPaperScissors));
        ...
        {
            bool result = CF_00001426E_RockPaperScissors.Solution_0_Test(input);
