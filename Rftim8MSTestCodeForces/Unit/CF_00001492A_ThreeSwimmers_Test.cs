...
{
    [TestClass]
    public sealed class CF_00001492A_ThreeSwimmers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001492A_ThreeSwimmers));
        ...
        {
            bool result = CF_00001492A_ThreeSwimmers.Solution_0_Test(input);
