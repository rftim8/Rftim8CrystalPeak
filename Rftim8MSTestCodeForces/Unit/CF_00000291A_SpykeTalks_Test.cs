...
{
    [TestClass]
    public sealed class CF_00000291A_SpykeTalks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000291A_SpykeTalks));
        ...
        {
            bool result = CF_00000291A_SpykeTalks.Solution_0_Test(input);
