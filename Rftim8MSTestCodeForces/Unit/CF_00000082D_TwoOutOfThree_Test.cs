...
{
    [TestClass]
    public sealed class CF_00000082D_TwoOutOfThree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000082D_TwoOutOfThree));
        ...
        {
            bool result = CF_00000082D_TwoOutOfThree.Solution_0_Test(input);
