...
{
    [TestClass]
    public sealed class CF_00000077D_DominoCarpet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000077D_DominoCarpet));
        ...
        {
            bool result = CF_00000077D_DominoCarpet.Solution_0_Test(input);
