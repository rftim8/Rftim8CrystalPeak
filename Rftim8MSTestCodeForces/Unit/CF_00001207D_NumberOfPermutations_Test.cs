...
{
    [TestClass]
    public sealed class CF_00001207D_NumberOfPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001207D_NumberOfPermutations));
        ...
        {
            bool result = CF_00001207D_NumberOfPermutations.Solution_0_Test(input);
