...
{
    [TestClass]
    public sealed class CF_00000073C_LionAgeII_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000073C_LionAgeII));
        ...
        {
            bool result = CF_00000073C_LionAgeII.Solution_0_Test(input);
