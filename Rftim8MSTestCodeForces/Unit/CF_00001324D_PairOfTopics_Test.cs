...
{
    [TestClass]
    public sealed class CF_00001324D_PairOfTopics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001324D_PairOfTopics));
        ...
        {
            bool result = CF_00001324D_PairOfTopics.Solution_0_Test(input);
