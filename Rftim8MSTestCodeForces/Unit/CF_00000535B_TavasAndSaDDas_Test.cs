...
{
    [TestClass]
    public sealed class CF_00000535B_TavasAndSaDDas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000535B_TavasAndSaDDas));
        ...
        {
            bool result = CF_00000535B_TavasAndSaDDas.Solution_0_Test(input);
