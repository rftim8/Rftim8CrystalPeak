...
{
    [TestClass]
    public sealed class CF_00001208C_MagicGrid_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001208C_MagicGrid));
        ...
        {
            bool result = CF_00001208C_MagicGrid.Solution_0_Test(input);
