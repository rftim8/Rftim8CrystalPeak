...
{
    [TestClass]
    public sealed class CF_00001887C_MinimumArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001887C_MinimumArray));
        ...
        {
            bool result = CF_00001887C_MinimumArray.Solution_0_Test(input);
