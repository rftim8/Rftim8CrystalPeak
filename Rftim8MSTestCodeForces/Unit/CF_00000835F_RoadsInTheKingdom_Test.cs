...
{
    [TestClass]
    public sealed class CF_00000835F_RoadsInTheKingdom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000835F_RoadsInTheKingdom));
        ...
        {
            bool result = CF_00000835F_RoadsInTheKingdom.Solution_0_Test(input);
