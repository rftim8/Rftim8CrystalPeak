...
{
    [TestClass]
    public sealed class CF_00001714A_EveryoneLovesToSleep_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001714A_EveryoneLovesToSleep));
        ...
        {
            bool result = CF_00001714A_EveryoneLovesToSleep.Solution_0_Test(input);
