...
{
    [TestClass]
    public sealed class CF_00000612B_HDDIsOutdatedTechnology_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000612B_HDDIsOutdatedTechnology));
        ...
        {
            bool result = CF_00000612B_HDDIsOutdatedTechnology.Solution_0_Test(input);
