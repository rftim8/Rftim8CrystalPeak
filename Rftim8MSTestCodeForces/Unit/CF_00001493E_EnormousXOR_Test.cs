...
{
    [TestClass]
    public sealed class CF_00001493E_EnormousXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001493E_EnormousXOR));
        ...
        {
            bool result = CF_00001493E_EnormousXOR.Solution_0_Test(input);
