...
{
    [TestClass]
    public sealed class CF_00000884C_BertownSubway_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000884C_BertownSubway));
        ...
        {
            bool result = CF_00000884C_BertownSubway.Solution_0_Test(input);
