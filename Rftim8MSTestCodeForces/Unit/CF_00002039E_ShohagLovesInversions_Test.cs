...
{
    [TestClass]
    public sealed class CF_00002039E_ShohagLovesInversions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002039E_ShohagLovesInversions));
        ...
        {
            bool result = CF_00002039E_ShohagLovesInversions.Solution_0_Test(input);
