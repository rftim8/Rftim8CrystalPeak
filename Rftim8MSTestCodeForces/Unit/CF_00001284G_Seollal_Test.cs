...
{
    [TestClass]
    public sealed class CF_00001284G_Seollal_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001284G_Seollal));
        ...
        {
            bool result = CF_00001284G_Seollal.Solution_0_Test(input);
