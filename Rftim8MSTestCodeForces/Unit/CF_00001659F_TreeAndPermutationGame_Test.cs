...
{
    [TestClass]
    public sealed class CF_00001659F_TreeAndPermutationGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001659F_TreeAndPermutationGame));
        ...
        {
            bool result = CF_00001659F_TreeAndPermutationGame.Solution_0_Test(input);
