...
{
    [TestClass]
    public sealed class CF_00000269D_MaximumWaterfall_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000269D_MaximumWaterfall));
        ...
        {
            bool result = CF_00000269D_MaximumWaterfall.Solution_0_Test(input);
