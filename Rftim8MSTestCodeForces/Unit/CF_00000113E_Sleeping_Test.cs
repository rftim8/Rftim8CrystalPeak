...
{
    [TestClass]
    public sealed class CF_00000113E_Sleeping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000113E_Sleeping));
        ...
        {
            bool result = CF_00000113E_Sleeping.Solution_0_Test(input);
