...
{
    [TestClass]
    public sealed class CF_00001466B_LastMinuteEnhancements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001466B_LastMinuteEnhancements));
        ...
        {
            bool result = CF_00001466B_LastMinuteEnhancements.Solution_0_Test(input);
