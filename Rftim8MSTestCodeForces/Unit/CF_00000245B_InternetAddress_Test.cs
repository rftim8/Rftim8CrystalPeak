...
{
    [TestClass]
    public sealed class CF_00000245B_InternetAddress_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000245B_InternetAddress));
        ...
        {
            bool result = CF_00000245B_InternetAddress.Solution_0_Test(input);
