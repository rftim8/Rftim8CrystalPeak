...
{
    [TestClass]
    public sealed class CF_00001244B_RoomsAndStaircases_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001244B_RoomsAndStaircases));
        ...
        {
            bool result = CF_00001244B_RoomsAndStaircases.Solution_0_Test(input);
