...
{
    [TestClass]
    public sealed class CF_00001916F_GroupDivision_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001916F_GroupDivision));
        ...
        {
            bool result = CF_00001916F_GroupDivision.Solution_0_Test(input);
