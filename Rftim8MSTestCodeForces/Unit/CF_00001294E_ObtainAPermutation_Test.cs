...
{
    [TestClass]
    public sealed class CF_00001294E_ObtainAPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001294E_ObtainAPermutation));
        ...
        {
            bool result = CF_00001294E_ObtainAPermutation.Solution_0_Test(input);
