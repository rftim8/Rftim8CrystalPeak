...
{
    [TestClass]
    public sealed class CF_00000679B_BearAndTowerOfCubes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000679B_BearAndTowerOfCubes));
        ...
        {
            bool result = CF_00000679B_BearAndTowerOfCubes.Solution_0_Test(input);
