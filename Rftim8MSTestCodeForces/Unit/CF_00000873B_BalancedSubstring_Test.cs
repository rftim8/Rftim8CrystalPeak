...
{
    [TestClass]
    public sealed class CF_00000873B_BalancedSubstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000873B_BalancedSubstring));
        ...
        {
            bool result = CF_00000873B_BalancedSubstring.Solution_0_Test(input);
