...
{
    [TestClass]
    public sealed class CF_00000269A_MagicalBoxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000269A_MagicalBoxes));
        ...
        {
            bool result = CF_00000269A_MagicalBoxes.Solution_0_Test(input);
