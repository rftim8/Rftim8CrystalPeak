...
{
    [TestClass]
    public sealed class CF_00000627C_PackageDelivery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000627C_PackageDelivery));
        ...
        {
            bool result = CF_00000627C_PackageDelivery.Solution_0_Test(input);
