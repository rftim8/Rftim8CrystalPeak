...
{
    [TestClass]
    public sealed class CF_00001029C_MaximalIntersection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001029C_MaximalIntersection));
        ...
        {
            bool result = CF_00001029C_MaximalIntersection.Solution_0_Test(input);
