...
{
    [TestClass]
    public sealed class CF_00001951I_GrowingTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001951I_GrowingTrees));
        ...
        {
            bool result = CF_00001951I_GrowingTrees.Solution_0_Test(input);
