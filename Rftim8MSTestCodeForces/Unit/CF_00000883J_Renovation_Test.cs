...
{
    [TestClass]
    public sealed class CF_00000883J_Renovation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883J_Renovation));
        ...
        {
            bool result = CF_00000883J_Renovation.Solution_0_Test(input);
