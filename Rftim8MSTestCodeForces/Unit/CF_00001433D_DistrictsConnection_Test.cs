...
{
    [TestClass]
    public sealed class CF_00001433D_DistrictsConnection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001433D_DistrictsConnection));
        ...
        {
            bool result = CF_00001433D_DistrictsConnection.Solution_0_Test(input);
