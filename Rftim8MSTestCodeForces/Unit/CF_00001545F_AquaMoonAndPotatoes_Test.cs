...
{
    [TestClass]
    public sealed class CF_00001545F_AquaMoonAndPotatoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001545F_AquaMoonAndPotatoes));
        ...
        {
            bool result = CF_00001545F_AquaMoonAndPotatoes.Solution_0_Test(input);
