...
{
    [TestClass]
    public sealed class CF_00000840A_LehaAndFunction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000840A_LehaAndFunction));
        ...
        {
            bool result = CF_00000840A_LehaAndFunction.Solution_0_Test(input);
