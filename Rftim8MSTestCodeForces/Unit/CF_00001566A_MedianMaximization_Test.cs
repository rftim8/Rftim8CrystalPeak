...
{
    [TestClass]
    public sealed class CF_00001566A_MedianMaximization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001566A_MedianMaximization));
        ...
        {
            bool result = CF_00001566A_MedianMaximization.Solution_0_Test(input);
