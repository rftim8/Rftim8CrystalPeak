...
{
    [TestClass]
    public sealed class CF_00000784D_TouchyFeelyPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000784D_TouchyFeelyPalindromes));
        ...
        {
            bool result = CF_00000784D_TouchyFeelyPalindromes.Solution_0_Test(input);
