...
{
    [TestClass]
    public sealed class CF_00000785B_AntonAndClasses_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000785B_AntonAndClasses));
        ...
        {
            bool result = CF_00000785B_AntonAndClasses.Solution_0_Test(input);
