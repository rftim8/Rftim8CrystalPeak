...
{
    [TestClass]
    public sealed class CF_00000776D_TheDoorProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000776D_TheDoorProblem));
        ...
        {
            bool result = CF_00000776D_TheDoorProblem.Solution_0_Test(input);
