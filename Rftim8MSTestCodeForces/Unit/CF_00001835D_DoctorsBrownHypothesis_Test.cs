...
{
    [TestClass]
    public sealed class CF_00001835D_DoctorsBrownHypothesis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001835D_DoctorsBrownHypothesis));
        ...
        {
            bool result = CF_00001835D_DoctorsBrownHypothesis.Solution_0_Test(input);
