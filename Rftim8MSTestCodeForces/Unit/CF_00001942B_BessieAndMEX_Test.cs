...
{
    [TestClass]
    public sealed class CF_00001942B_BessieAndMEX_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001942B_BessieAndMEX));
        ...
        {
            bool result = CF_00001942B_BessieAndMEX.Solution_0_Test(input);
