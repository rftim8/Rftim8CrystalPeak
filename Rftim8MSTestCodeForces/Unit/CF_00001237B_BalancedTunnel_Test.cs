...
{
    [TestClass]
    public sealed class CF_00001237B_BalancedTunnel_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001237B_BalancedTunnel));
        ...
        {
            bool result = CF_00001237B_BalancedTunnel.Solution_0_Test(input);
