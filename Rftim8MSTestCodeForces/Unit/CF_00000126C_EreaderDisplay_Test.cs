...
{
    [TestClass]
    public sealed class CF_00000126C_EreaderDisplay_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000126C_EreaderDisplay));
        ...
        {
            bool result = CF_00000126C_EreaderDisplay.Solution_0_Test(input);
