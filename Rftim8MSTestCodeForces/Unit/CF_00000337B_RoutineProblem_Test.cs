...
{
    [TestClass]
    public sealed class CF_00000337B_RoutineProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000337B_RoutineProblem));
        ...
        {
            bool result = CF_00000337B_RoutineProblem.Solution_0_Test(input);
