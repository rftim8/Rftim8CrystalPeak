...
{
    [TestClass]
    public sealed class CF_00001982A_Soccer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001982A_Soccer));
        ...
        {
            bool result = CF_00001982A_Soccer.Solution_0_Test(input);
