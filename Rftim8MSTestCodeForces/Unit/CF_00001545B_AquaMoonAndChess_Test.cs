...
{
    [TestClass]
    public sealed class CF_00001545B_AquaMoonAndChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001545B_AquaMoonAndChess));
        ...
        {
            bool result = CF_00001545B_AquaMoonAndChess.Solution_0_Test(input);
