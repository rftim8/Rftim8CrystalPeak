...
{
    [TestClass]
    public sealed class CF_00001510I_IsItRated_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001510I_IsItRated));
        ...
        {
            bool result = CF_00001510I_IsItRated.Solution_0_Test(input);
