...
{
    [TestClass]
    public sealed class CF_00002011A_ProblemSolving_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002011A_ProblemSolving));
        ...
        {
            bool result = CF_00002011A_ProblemSolving.Solution_0_Test(input);
