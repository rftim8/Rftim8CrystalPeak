...
{
    [TestClass]
    public sealed class CF_00001404C_FixedPointRemoval_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001404C_FixedPointRemoval));
        ...
        {
            bool result = CF_00001404C_FixedPointRemoval.Solution_0_Test(input);
