...
{
    [TestClass]
    public sealed class CF_00001077B_DisturbedPeople_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001077B_DisturbedPeople));
        ...
        {
            bool result = CF_00001077B_DisturbedPeople.Solution_0_Test(input);
