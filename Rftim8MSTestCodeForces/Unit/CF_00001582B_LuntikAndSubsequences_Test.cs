...
{
    [TestClass]
    public sealed class CF_00001582B_LuntikAndSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001582B_LuntikAndSubsequences));
        ...
        {
            bool result = CF_00001582B_LuntikAndSubsequences.Solution_0_Test(input);
