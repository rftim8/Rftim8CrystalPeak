...
{
    [TestClass]
    public sealed class CF_00000696A_LorenzoVonMatterhorn_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000696A_LorenzoVonMatterhorn));
        ...
        {
            bool result = CF_00000696A_LorenzoVonMatterhorn.Solution_0_Test(input);
