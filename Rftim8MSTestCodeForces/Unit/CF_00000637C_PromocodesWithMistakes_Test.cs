...
{
    [TestClass]
    public sealed class CF_00000637C_PromocodesWithMistakes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000637C_PromocodesWithMistakes));
        ...
        {
            bool result = CF_00000637C_PromocodesWithMistakes.Solution_0_Test(input);
