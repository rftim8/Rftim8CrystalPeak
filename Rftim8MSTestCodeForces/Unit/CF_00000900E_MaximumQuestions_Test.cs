...
{
    [TestClass]
    public sealed class CF_00000900E_MaximumQuestions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000900E_MaximumQuestions));
        ...
        {
            bool result = CF_00000900E_MaximumQuestions.Solution_0_Test(input);
