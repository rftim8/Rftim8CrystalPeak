...
{
    [TestClass]
    public sealed class CF_00001316B_StringModification_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001316B_StringModification));
        ...
        {
            bool result = CF_00001316B_StringModification.Solution_0_Test(input);
