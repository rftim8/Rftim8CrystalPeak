...
{
    [TestClass]
    public sealed class CF_00000147A_Punctuation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000147A_Punctuation));
        ...
        {
            bool result = CF_00000147A_Punctuation.Solution_0_Test(input);
