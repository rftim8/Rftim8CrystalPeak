...
{
    [TestClass]
    public sealed class CF_00000043E_Race_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000043E_Race));
        ...
        {
            bool result = CF_00000043E_Race.Solution_0_Test(input);
