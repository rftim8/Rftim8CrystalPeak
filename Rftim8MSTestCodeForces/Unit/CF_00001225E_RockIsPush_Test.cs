...
{
    [TestClass]
    public sealed class CF_00001225E_RockIsPush_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001225E_RockIsPush));
        ...
        {
            bool result = CF_00001225E_RockIsPush.Solution_0_Test(input);
