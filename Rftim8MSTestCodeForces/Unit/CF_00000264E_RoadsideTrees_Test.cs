...
{
    [TestClass]
    public sealed class CF_00000264E_RoadsideTrees_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000264E_RoadsideTrees));
        ...
        {
            bool result = CF_00000264E_RoadsideTrees.Solution_0_Test(input);
