...
{
    [TestClass]
    public sealed class CF_00000822B_CrosswordSolving_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000822B_CrosswordSolving));
        ...
        {
            bool result = CF_00000822B_CrosswordSolving.Solution_0_Test(input);
