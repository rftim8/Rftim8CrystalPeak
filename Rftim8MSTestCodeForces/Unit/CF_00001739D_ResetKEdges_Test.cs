...
{
    [TestClass]
    public sealed class CF_00001739D_ResetKEdges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001739D_ResetKEdges));
        ...
        {
            bool result = CF_00001739D_ResetKEdges.Solution_0_Test(input);
