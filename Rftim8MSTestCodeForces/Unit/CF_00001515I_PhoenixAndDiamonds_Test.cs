...
{
    [TestClass]
    public sealed class CF_00001515I_PhoenixAndDiamonds_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001515I_PhoenixAndDiamonds));
        ...
        {
            bool result = CF_00001515I_PhoenixAndDiamonds.Solution_0_Test(input);
