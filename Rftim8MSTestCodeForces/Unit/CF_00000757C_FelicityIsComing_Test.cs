...
{
    [TestClass]
    public sealed class CF_00000757C_FelicityIsComing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000757C_FelicityIsComing));
        ...
        {
            bool result = CF_00000757C_FelicityIsComing.Solution_0_Test(input);
