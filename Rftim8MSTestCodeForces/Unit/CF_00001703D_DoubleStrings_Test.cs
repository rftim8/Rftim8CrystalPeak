...
{
    [TestClass]
    public sealed class CF_00001703D_DoubleStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001703D_DoubleStrings));
        ...
        {
            bool result = CF_00001703D_DoubleStrings.Solution_0_Test(input);
