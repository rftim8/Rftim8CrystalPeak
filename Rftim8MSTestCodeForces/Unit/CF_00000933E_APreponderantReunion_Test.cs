...
{
    [TestClass]
    public sealed class CF_00000933E_APreponderantReunion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000933E_APreponderantReunion));
        ...
        {
            bool result = CF_00000933E_APreponderantReunion.Solution_0_Test(input);
