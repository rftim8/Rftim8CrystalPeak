...
{
    [TestClass]
    public sealed class CF_00000353B_TwoHeaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000353B_TwoHeaps));
        ...
        {
            bool result = CF_00000353B_TwoHeaps.Solution_0_Test(input);
