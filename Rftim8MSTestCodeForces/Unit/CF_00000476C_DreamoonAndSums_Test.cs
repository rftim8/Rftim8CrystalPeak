...
{
    [TestClass]
    public sealed class CF_00000476C_DreamoonAndSums_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000476C_DreamoonAndSums));
        ...
        {
            bool result = CF_00000476C_DreamoonAndSums.Solution_0_Test(input);
