...
{
    [TestClass]
    public sealed class CF_00001749A_CowardlyRooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001749A_CowardlyRooks));
        ...
        {
            bool result = CF_00001749A_CowardlyRooks.Solution_0_Test(input);
