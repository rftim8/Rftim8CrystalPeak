...
{
    [TestClass]
    public sealed class CF_00000512E_FoxAndPolygon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000512E_FoxAndPolygon));
        ...
        {
            bool result = CF_00000512E_FoxAndPolygon.Solution_0_Test(input);
