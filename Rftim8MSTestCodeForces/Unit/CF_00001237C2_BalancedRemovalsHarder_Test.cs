...
{
    [TestClass]
    public sealed class CF_00001237C2_BalancedRemovalsHarder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001237C2_BalancedRemovalsHarder));
        ...
        {
            bool result = CF_00001237C2_BalancedRemovalsHarder.Solution_0_Test(input);
