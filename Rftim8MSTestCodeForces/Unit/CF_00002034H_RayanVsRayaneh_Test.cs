...
{
    [TestClass]
    public sealed class CF_00002034H_RayanVsRayaneh_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002034H_RayanVsRayaneh));
        ...
        {
            bool result = CF_00002034H_RayanVsRayaneh.Solution_0_Test(input);
