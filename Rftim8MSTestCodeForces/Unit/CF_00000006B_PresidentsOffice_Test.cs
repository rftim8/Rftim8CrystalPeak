...
{
    [TestClass]
    public sealed class CF_00000006B_PresidentsOffice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000006B_PresidentsOffice));
        ...
        {
            bool result = CF_00000006B_PresidentsOffice.Solution_0_Test(input);
