...
{
    [TestClass]
    public sealed class CF_00000578B_OrGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000578B_OrGame));
        ...
        {
            bool result = CF_00000578B_OrGame.Solution_0_Test(input);
