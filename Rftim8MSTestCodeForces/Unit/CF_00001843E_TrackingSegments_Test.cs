...
{
    [TestClass]
    public sealed class CF_00001843E_TrackingSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001843E_TrackingSegments));
        ...
        {
            bool result = CF_00001843E_TrackingSegments.Solution_0_Test(input);
