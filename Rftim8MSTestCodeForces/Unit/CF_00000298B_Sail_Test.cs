...
{
    [TestClass]
    public sealed class CF_00000298B_Sail_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000298B_Sail));
        ...
        {
            bool result = CF_00000298B_Sail.Solution_0_Test(input);
