...
{
    [TestClass]
    public sealed class CF_00001703B_ICPCBalloons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001703B_ICPCBalloons));
        ...
        {
            bool result = CF_00001703B_ICPCBalloons.Solution_0_Test(input);
