...
{
    [TestClass]
    public sealed class CF_00000722B_VersePattern_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000722B_VersePattern));
        ...
        {
            bool result = CF_00000722B_VersePattern.Solution_0_Test(input);
