...
{
    [TestClass]
    public sealed class CF_00001675B_MakeItIncreasing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001675B_MakeItIncreasing));
        ...
        {
            bool result = CF_00001675B_MakeItIncreasing.Solution_0_Test(input);
