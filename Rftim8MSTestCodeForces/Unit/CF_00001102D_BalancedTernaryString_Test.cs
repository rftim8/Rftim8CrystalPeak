...
{
    [TestClass]
    public sealed class CF_00001102D_BalancedTernaryString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001102D_BalancedTernaryString));
        ...
        {
            bool result = CF_00001102D_BalancedTernaryString.Solution_0_Test(input);
