...
{
    [TestClass]
    public sealed class CF_00000173E_CampingGroups_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000173E_CampingGroups));
        ...
        {
            bool result = CF_00000173E_CampingGroups.Solution_0_Test(input);
