...
{
    [TestClass]
    public sealed class CF_00001228C_PrimesAndMultiplication_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001228C_PrimesAndMultiplication));
        ...
        {
            bool result = CF_00001228C_PrimesAndMultiplication.Solution_0_Test(input);
