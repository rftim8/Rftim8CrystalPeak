...
{
    [TestClass]
    public sealed class CF_00000853C_Boredom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000853C_Boredom));
        ...
        {
            bool result = CF_00000853C_Boredom.Solution_0_Test(input);
