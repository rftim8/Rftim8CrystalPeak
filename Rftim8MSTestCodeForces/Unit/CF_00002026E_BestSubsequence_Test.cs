...
{
    [TestClass]
    public sealed class CF_00002026E_BestSubsequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002026E_BestSubsequence));
        ...
        {
            bool result = CF_00002026E_BestSubsequence.Solution_0_Test(input);
