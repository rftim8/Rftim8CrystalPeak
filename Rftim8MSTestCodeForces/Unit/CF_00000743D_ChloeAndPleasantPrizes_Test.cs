...
{
    [TestClass]
    public sealed class CF_00000743D_ChloeAndPleasantPrizes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000743D_ChloeAndPleasantPrizes));
        ...
        {
            bool result = CF_00000743D_ChloeAndPleasantPrizes.Solution_0_Test(input);
