...
{
    [TestClass]
    public sealed class CF_00000962D_MergeEquals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000962D_MergeEquals));
        ...
        {
            bool result = CF_00000962D_MergeEquals.Solution_0_Test(input);
