...
{
    [TestClass]
    public sealed class CF_00000879B_TableTennis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000879B_TableTennis));
        ...
        {
            bool result = CF_00000879B_TableTennis.Solution_0_Test(input);
