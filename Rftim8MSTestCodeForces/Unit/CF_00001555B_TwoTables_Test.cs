...
{
    [TestClass]
    public sealed class CF_00001555B_TwoTables_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001555B_TwoTables));
        ...
        {
            bool result = CF_00001555B_TwoTables.Solution_0_Test(input);
