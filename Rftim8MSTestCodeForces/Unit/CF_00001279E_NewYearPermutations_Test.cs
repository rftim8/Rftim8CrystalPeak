...
{
    [TestClass]
    public sealed class CF_00001279E_NewYearPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001279E_NewYearPermutations));
        ...
        {
            bool result = CF_00001279E_NewYearPermutations.Solution_0_Test(input);
