...
{
    [TestClass]
    public sealed class CF_00000067A_PartialTeacher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000067A_PartialTeacher));
        ...
        {
            bool result = CF_00000067A_PartialTeacher.Solution_0_Test(input);
