...
{
    [TestClass]
    public sealed class CF_00000877E_DanilAndAParttimeJob_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000877E_DanilAndAParttimeJob));
        ...
        {
            bool result = CF_00000877E_DanilAndAParttimeJob.Solution_0_Test(input);
