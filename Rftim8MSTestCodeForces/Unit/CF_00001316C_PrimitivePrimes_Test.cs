...
{
    [TestClass]
    public sealed class CF_00001316C_PrimitivePrimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001316C_PrimitivePrimes));
        ...
        {
            bool result = CF_00001316C_PrimitivePrimes.Solution_0_Test(input);
