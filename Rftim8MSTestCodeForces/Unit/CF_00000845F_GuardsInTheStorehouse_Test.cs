...
{
    [TestClass]
    public sealed class CF_00000845F_GuardsInTheStorehouse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000845F_GuardsInTheStorehouse));
        ...
        {
            bool result = CF_00000845F_GuardsInTheStorehouse.Solution_0_Test(input);
