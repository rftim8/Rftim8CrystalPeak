...
{
    [TestClass]
    public sealed class CF_00000765F_Souvenirs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000765F_Souvenirs));
        ...
        {
            bool result = CF_00000765F_Souvenirs.Solution_0_Test(input);
