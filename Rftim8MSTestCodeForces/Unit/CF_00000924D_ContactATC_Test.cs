...
{
    [TestClass]
    public sealed class CF_00000924D_ContactATC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000924D_ContactATC));
        ...
        {
            bool result = CF_00000924D_ContactATC.Solution_0_Test(input);
