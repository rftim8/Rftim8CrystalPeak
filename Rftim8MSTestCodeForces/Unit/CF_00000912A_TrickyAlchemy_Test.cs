...
{
    [TestClass]
    public sealed class CF_00000912A_TrickyAlchemy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000912A_TrickyAlchemy));
        ...
        {
            bool result = CF_00000912A_TrickyAlchemy.Solution_0_Test(input);
