...
{
    [TestClass]
    public sealed class CF_00001099A_Snowball_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001099A_Snowball));
        ...
        {
            bool result = CF_00001099A_Snowball.Solution_0_Test(input);
