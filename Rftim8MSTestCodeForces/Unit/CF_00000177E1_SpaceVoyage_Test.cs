...
{
    [TestClass]
    public sealed class CF_00000177E1_SpaceVoyage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000177E1_SpaceVoyage));
        ...
        {
            bool result = CF_00000177E1_SpaceVoyage.Solution_0_Test(input);
