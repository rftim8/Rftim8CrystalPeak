...
{
    [TestClass]
    public sealed class CF_00001812D_TrivialConjecture_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001812D_TrivialConjecture));
        ...
        {
            bool result = CF_00001812D_TrivialConjecture.Solution_0_Test(input);
