...
{
    [TestClass]
    public sealed class CF_00000706D_VasiliysMultiset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000706D_VasiliysMultiset));
        ...
        {
            bool result = CF_00000706D_VasiliysMultiset.Solution_0_Test(input);
