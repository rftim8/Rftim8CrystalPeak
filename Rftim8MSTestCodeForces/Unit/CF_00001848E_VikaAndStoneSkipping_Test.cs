...
{
    [TestClass]
    public sealed class CF_00001848E_VikaAndStoneSkipping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001848E_VikaAndStoneSkipping));
        ...
        {
            bool result = CF_00001848E_VikaAndStoneSkipping.Solution_0_Test(input);
