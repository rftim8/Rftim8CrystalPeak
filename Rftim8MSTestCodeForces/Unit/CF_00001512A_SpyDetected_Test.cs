...
{
    [TestClass]
    public sealed class CF_00001512A_SpyDetected_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001512A_SpyDetected));
        ...
        {
            bool result = CF_00001512A_SpyDetected.Solution_0_Test(input);
