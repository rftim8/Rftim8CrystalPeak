...
{
    [TestClass]
    public sealed class CF_00000896D_NephrenRunsACinema_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000896D_NephrenRunsACinema));
        ...
        {
            bool result = CF_00000896D_NephrenRunsACinema.Solution_0_Test(input);
