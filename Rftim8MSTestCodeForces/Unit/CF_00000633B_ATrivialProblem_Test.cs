...
{
    [TestClass]
    public sealed class CF_00000633B_ATrivialProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000633B_ATrivialProblem));
        ...
        {
            bool result = CF_00000633B_ATrivialProblem.Solution_0_Test(input);
