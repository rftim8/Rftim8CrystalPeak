...
{
    [TestClass]
    public sealed class CF_00001034A_EnlargeGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001034A_EnlargeGCD));
        ...
        {
            bool result = CF_00001034A_EnlargeGCD.Solution_0_Test(input);
