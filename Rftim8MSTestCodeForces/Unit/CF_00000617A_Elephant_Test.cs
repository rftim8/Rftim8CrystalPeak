...
{
    [TestClass]
    public sealed class CF_00000617A_Elephant_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000617A_Elephant));
        ...
        {
            bool result = CF_00000617A_Elephant.Solution_0_Test(input);
