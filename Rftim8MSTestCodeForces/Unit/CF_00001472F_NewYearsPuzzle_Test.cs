...
{
    [TestClass]
    public sealed class CF_00001472F_NewYearsPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001472F_NewYearsPuzzle));
        ...
        {
            bool result = CF_00001472F_NewYearsPuzzle.Solution_0_Test(input);
