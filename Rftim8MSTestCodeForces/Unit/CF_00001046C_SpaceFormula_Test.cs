...
{
    [TestClass]
    public sealed class CF_00001046C_SpaceFormula_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001046C_SpaceFormula));
        ...
        {
            bool result = CF_00001046C_SpaceFormula.Solution_0_Test(input);
