...
{
    [TestClass]
    public sealed class CF_00001270I_XorOnFigures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001270I_XorOnFigures));
        ...
        {
            bool result = CF_00001270I_XorOnFigures.Solution_0_Test(input);
