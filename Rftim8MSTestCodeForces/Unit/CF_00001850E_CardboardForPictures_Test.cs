...
{
    [TestClass]
    public sealed class CF_00001850E_CardboardForPictures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001850E_CardboardForPictures));
        ...
        {
            bool result = CF_00001850E_CardboardForPictures.Solution_0_Test(input);
