...
{
    [TestClass]
    public sealed class CF_00002029D_CoolGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002029D_CoolGraph));
        ...
        {
            bool result = CF_00002029D_CoolGraph.Solution_0_Test(input);
