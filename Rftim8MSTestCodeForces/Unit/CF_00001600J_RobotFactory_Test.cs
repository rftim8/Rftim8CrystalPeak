...
{
    [TestClass]
    public sealed class CF_00001600J_RobotFactory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001600J_RobotFactory));
        ...
        {
            bool result = CF_00001600J_RobotFactory.Solution_0_Test(input);
