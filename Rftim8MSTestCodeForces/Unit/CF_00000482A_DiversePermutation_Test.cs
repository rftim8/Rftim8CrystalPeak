...
{
    [TestClass]
    public sealed class CF_00000482A_DiversePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000482A_DiversePermutation));
        ...
        {
            bool result = CF_00000482A_DiversePermutation.Solution_0_Test(input);
