...
{
    [TestClass]
    public sealed class CF_00001930B_PermutationPrinting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001930B_PermutationPrinting));
        ...
        {
            bool result = CF_00001930B_PermutationPrinting.Solution_0_Test(input);
