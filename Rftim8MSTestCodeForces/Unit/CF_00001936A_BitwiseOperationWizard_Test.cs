...
{
    [TestClass]
    public sealed class CF_00001936A_BitwiseOperationWizard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001936A_BitwiseOperationWizard));
        ...
        {
            bool result = CF_00001936A_BitwiseOperationWizard.Solution_0_Test(input);
