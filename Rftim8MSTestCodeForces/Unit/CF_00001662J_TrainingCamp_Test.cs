...
{
    [TestClass]
    public sealed class CF_00001662J_TrainingCamp_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662J_TrainingCamp));
        ...
        {
            bool result = CF_00001662J_TrainingCamp.Solution_0_Test(input);
