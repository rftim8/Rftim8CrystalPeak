...
{
    [TestClass]
    public sealed class CF_00000830D_SingerHouse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000830D_SingerHouse));
        ...
        {
            bool result = CF_00000830D_SingerHouse.Solution_0_Test(input);
