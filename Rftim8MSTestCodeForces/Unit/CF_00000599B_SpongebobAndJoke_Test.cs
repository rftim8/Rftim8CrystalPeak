...
{
    [TestClass]
    public sealed class CF_00000599B_SpongebobAndJoke_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000599B_SpongebobAndJoke));
        ...
        {
            bool result = CF_00000599B_SpongebobAndJoke.Solution_0_Test(input);
