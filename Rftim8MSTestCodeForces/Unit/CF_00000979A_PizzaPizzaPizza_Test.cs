...
{
    [TestClass]
    public sealed class CF_00000979A_PizzaPizzaPizza_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000979A_PizzaPizzaPizza));
        ...
        {
            bool result = CF_00000979A_PizzaPizzaPizza.Solution_0_Test(input);
