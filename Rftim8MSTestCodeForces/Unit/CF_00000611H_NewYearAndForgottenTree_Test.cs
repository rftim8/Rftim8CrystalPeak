...
{
    [TestClass]
    public sealed class CF_00000611H_NewYearAndForgottenTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000611H_NewYearAndForgottenTree));
        ...
        {
            bool result = CF_00000611H_NewYearAndForgottenTree.Solution_0_Test(input);
