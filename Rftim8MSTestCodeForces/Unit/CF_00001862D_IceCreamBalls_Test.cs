...
{
    [TestClass]
    public sealed class CF_00001862D_IceCreamBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001862D_IceCreamBalls));
        ...
        {
            bool result = CF_00001862D_IceCreamBalls.Solution_0_Test(input);
