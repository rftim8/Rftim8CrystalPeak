...
{
    [TestClass]
    public sealed class CF_00000584E_AntonAndIra_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000584E_AntonAndIra));
        ...
        {
            bool result = CF_00000584E_AntonAndIra.Solution_0_Test(input);
