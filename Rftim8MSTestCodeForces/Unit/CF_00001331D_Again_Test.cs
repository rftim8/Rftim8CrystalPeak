...
{
    [TestClass]
    public sealed class CF_00001331D_Again_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001331D_Again));
        ...
        {
            bool result = CF_00001331D_Again.Solution_0_Test(input);
