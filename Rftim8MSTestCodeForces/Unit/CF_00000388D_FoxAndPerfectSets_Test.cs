...
{
    [TestClass]
    public sealed class CF_00000388D_FoxAndPerfectSets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000388D_FoxAndPerfectSets));
        ...
        {
            bool result = CF_00000388D_FoxAndPerfectSets.Solution_0_Test(input);
