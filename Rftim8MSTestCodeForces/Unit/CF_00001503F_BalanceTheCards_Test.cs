...
{
    [TestClass]
    public sealed class CF_00001503F_BalanceTheCards_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001503F_BalanceTheCards));
        ...
        {
            bool result = CF_00001503F_BalanceTheCards.Solution_0_Test(input);
