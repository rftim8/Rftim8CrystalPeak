...
{
    [TestClass]
    public sealed class CF_00000061D_EternalVictory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000061D_EternalVictory));
        ...
        {
            bool result = CF_00000061D_EternalVictory.Solution_0_Test(input);
