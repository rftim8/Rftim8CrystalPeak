...
{
    [TestClass]
    public sealed class CF_00001937A_ShuffleParty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001937A_ShuffleParty));
        ...
        {
            bool result = CF_00001937A_ShuffleParty.Solution_0_Test(input);
