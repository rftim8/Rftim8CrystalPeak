...
{
    [TestClass]
    public sealed class CF_00001118F1_TreeCuttingEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001118F1_TreeCuttingEasyVersion));
        ...
        {
            bool result = CF_00001118F1_TreeCuttingEasyVersion.Solution_0_Test(input);
