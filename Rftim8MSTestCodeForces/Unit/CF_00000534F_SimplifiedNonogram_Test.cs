...
{
    [TestClass]
    public sealed class CF_00000534F_SimplifiedNonogram_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000534F_SimplifiedNonogram));
        ...
        {
            bool result = CF_00000534F_SimplifiedNonogram.Solution_0_Test(input);
