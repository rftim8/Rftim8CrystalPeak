...
{
    [TestClass]
    public sealed class CF_00000983E_NNCountry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000983E_NNCountry));
        ...
        {
            bool result = CF_00000983E_NNCountry.Solution_0_Test(input);
