...
{
    [TestClass]
    public sealed class CF_00000101C_Vectors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000101C_Vectors));
        ...
        {
            bool result = CF_00000101C_Vectors.Solution_0_Test(input);
