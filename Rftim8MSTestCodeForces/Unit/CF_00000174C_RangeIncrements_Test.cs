...
{
    [TestClass]
    public sealed class CF_00000174C_RangeIncrements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000174C_RangeIncrements));
        ...
        {
            bool result = CF_00000174C_RangeIncrements.Solution_0_Test(input);
