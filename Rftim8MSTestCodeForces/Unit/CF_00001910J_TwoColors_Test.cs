...
{
    [TestClass]
    public sealed class CF_00001910J_TwoColors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001910J_TwoColors));
        ...
        {
            bool result = CF_00001910J_TwoColors.Solution_0_Test(input);
