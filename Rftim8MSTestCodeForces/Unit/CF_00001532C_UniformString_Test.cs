...
{
    [TestClass]
    public sealed class CF_00001532C_UniformString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001532C_UniformString));
        ...
        {
            bool result = CF_00001532C_UniformString.Solution_0_Test(input);
