...
{
    [TestClass]
    public sealed class CF_00000451D_CountGoodSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000451D_CountGoodSubstrings));
        ...
        {
            bool result = CF_00000451D_CountGoodSubstrings.Solution_0_Test(input);
