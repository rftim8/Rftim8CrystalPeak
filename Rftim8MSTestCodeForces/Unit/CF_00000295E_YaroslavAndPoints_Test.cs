...
{
    [TestClass]
    public sealed class CF_00000295E_YaroslavAndPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000295E_YaroslavAndPoints));
        ...
        {
            bool result = CF_00000295E_YaroslavAndPoints.Solution_0_Test(input);
