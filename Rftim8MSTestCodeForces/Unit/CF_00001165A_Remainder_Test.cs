...
{
    [TestClass]
    public sealed class CF_00001165A_Remainder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001165A_Remainder));
        ...
        {
            bool result = CF_00001165A_Remainder.Solution_0_Test(input);
