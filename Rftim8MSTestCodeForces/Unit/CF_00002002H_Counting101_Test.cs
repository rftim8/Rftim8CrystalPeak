...
{
    [TestClass]
    public sealed class CF_00002002H_Counting101_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002002H_Counting101));
        ...
        {
            bool result = CF_00002002H_Counting101.Solution_0_Test(input);
