...
{
    [TestClass]
    public sealed class CF_00001360C_SimilarPairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001360C_SimilarPairs));
        ...
        {
            bool result = CF_00001360C_SimilarPairs.Solution_0_Test(input);
