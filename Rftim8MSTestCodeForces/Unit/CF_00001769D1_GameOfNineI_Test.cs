...
{
    [TestClass]
    public sealed class CF_00001769D1_GameOfNineI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001769D1_GameOfNineI));
        ...
        {
            bool result = CF_00001769D1_GameOfNineI.Solution_0_Test(input);
