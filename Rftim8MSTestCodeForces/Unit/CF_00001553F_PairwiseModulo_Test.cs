...
{
    [TestClass]
    public sealed class CF_00001553F_PairwiseModulo_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001553F_PairwiseModulo));
        ...
        {
            bool result = CF_00001553F_PairwiseModulo.Solution_0_Test(input);
