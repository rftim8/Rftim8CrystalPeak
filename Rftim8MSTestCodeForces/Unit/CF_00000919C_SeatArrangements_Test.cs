...
{
    [TestClass]
    public sealed class CF_00000919C_SeatArrangements_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000919C_SeatArrangements));
        ...
        {
            bool result = CF_00000919C_SeatArrangements.Solution_0_Test(input);
