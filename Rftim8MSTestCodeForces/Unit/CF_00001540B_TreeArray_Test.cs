...
{
    [TestClass]
    public sealed class CF_00001540B_TreeArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001540B_TreeArray));
        ...
        {
            bool result = CF_00001540B_TreeArray.Solution_0_Test(input);
