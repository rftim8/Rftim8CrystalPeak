...
{
    [TestClass]
    public sealed class CF_00000329C_GraphReconstruction_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000329C_GraphReconstruction));
        ...
        {
            bool result = CF_00000329C_GraphReconstruction.Solution_0_Test(input);
