...
{
    [TestClass]
    public sealed class CF_00001398C_GoodSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001398C_GoodSubarrays));
        ...
        {
            bool result = CF_00001398C_GoodSubarrays.Solution_0_Test(input);
