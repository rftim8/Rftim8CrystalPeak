...
{
    [TestClass]
    public sealed class CF_00000665B_Shopping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000665B_Shopping));
        ...
        {
            bool result = CF_00000665B_Shopping.Solution_0_Test(input);
