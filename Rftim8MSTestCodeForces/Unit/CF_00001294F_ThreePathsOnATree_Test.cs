...
{
    [TestClass]
    public sealed class CF_00001294F_ThreePathsOnATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001294F_ThreePathsOnATree));
        ...
        {
            bool result = CF_00001294F_ThreePathsOnATree.Solution_0_Test(input);
