...
{
    [TestClass]
    public sealed class CF_00000066B_PetyaAndCountryside_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000066B_PetyaAndCountryside));
        ...
        {
            bool result = CF_00000066B_PetyaAndCountryside.Solution_0_Test(input);
