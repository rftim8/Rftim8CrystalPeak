...
{
    [TestClass]
    public sealed class CF_00001029A_ManyEqualSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001029A_ManyEqualSubstrings));
        ...
        {
            bool result = CF_00001029A_ManyEqualSubstrings.Solution_0_Test(input);
