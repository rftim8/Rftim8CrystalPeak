...
{
    [TestClass]
    public sealed class CF_00000276D_LittleGirlAndMaximumXOR_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000276D_LittleGirlAndMaximumXOR));
        ...
        {
            bool result = CF_00000276D_LittleGirlAndMaximumXOR.Solution_0_Test(input);
