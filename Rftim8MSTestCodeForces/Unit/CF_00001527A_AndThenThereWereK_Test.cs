...
{
    [TestClass]
    public sealed class CF_00001527A_AndThenThereWereK_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001527A_AndThenThereWereK));
        ...
        {
            bool result = CF_00001527A_AndThenThereWereK.Solution_0_Test(input);
