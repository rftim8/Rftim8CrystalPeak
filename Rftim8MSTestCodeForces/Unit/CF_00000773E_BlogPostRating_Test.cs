...
{
    [TestClass]
    public sealed class CF_00000773E_BlogPostRating_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000773E_BlogPostRating));
        ...
        {
            bool result = CF_00000773E_BlogPostRating.Solution_0_Test(input);
