...
{
    [TestClass]
    public sealed class CF_00001143B_Nirvana_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001143B_Nirvana));
        ...
        {
            bool result = CF_00001143B_Nirvana.Solution_0_Test(input);
