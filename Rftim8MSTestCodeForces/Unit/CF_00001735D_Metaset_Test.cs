...
{
    [TestClass]
    public sealed class CF_00001735D_Metaset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001735D_Metaset));
        ...
        {
            bool result = CF_00001735D_Metaset.Solution_0_Test(input);
