...
{
    [TestClass]
    public sealed class CF_00001151A_MaximAndBiology_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001151A_MaximAndBiology));
        ...
        {
            bool result = CF_00001151A_MaximAndBiology.Solution_0_Test(input);
