...
{
    [TestClass]
    public sealed class CF_00000064D_Presents_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000064D_Presents));
        ...
        {
            bool result = CF_00000064D_Presents.Solution_0_Test(input);
