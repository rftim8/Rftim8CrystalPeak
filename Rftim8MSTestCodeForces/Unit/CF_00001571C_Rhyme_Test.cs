...
{
    [TestClass]
    public sealed class CF_00001571C_Rhyme_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001571C_Rhyme));
        ...
        {
            bool result = CF_00001571C_Rhyme.Solution_0_Test(input);
