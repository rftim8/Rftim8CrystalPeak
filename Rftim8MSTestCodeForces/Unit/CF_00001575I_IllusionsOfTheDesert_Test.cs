...
{
    [TestClass]
    public sealed class CF_00001575I_IllusionsOfTheDesert_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001575I_IllusionsOfTheDesert));
        ...
        {
            bool result = CF_00001575I_IllusionsOfTheDesert.Solution_0_Test(input);
