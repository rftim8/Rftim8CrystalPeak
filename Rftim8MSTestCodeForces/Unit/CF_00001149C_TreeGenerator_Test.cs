...
{
    [TestClass]
    public sealed class CF_00001149C_TreeGenerator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001149C_TreeGenerator));
        ...
        {
            bool result = CF_00001149C_TreeGenerator.Solution_0_Test(input);
