...
{
    [TestClass]
    public sealed class CF_00000201B_GuessThatCar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000201B_GuessThatCar));
        ...
        {
            bool result = CF_00000201B_GuessThatCar.Solution_0_Test(input);
