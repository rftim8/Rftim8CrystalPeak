...
{
    [TestClass]
    public sealed class CF_00001884D_CountingRhyme_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001884D_CountingRhyme));
        ...
        {
            bool result = CF_00001884D_CountingRhyme.Solution_0_Test(input);
