...
{
    [TestClass]
    public sealed class CF_00001692E_BinaryDeque_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001692E_BinaryDeque));
        ...
        {
            bool result = CF_00001692E_BinaryDeque.Solution_0_Test(input);
