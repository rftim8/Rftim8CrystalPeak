...
{
    [TestClass]
    public sealed class CF_00001245F_DanielAndSpringCleaning_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001245F_DanielAndSpringCleaning));
        ...
        {
            bool result = CF_00001245F_DanielAndSpringCleaning.Solution_0_Test(input);
