...
{
    [TestClass]
    public sealed class CF_00000219A_KString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000219A_KString));
        ...
        {
            bool result = CF_00000219A_KString.Solution_0_Test(input);
