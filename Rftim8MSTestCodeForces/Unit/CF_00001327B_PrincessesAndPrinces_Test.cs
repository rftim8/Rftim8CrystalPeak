...
{
    [TestClass]
    public sealed class CF_00001327B_PrincessesAndPrinces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001327B_PrincessesAndPrinces));
        ...
        {
            bool result = CF_00001327B_PrincessesAndPrinces.Solution_0_Test(input);
