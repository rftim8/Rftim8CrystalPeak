...
{
    [TestClass]
    public sealed class CF_00001119E_PavelAndTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001119E_PavelAndTriangles));
        ...
        {
            bool result = CF_00001119E_PavelAndTriangles.Solution_0_Test(input);
