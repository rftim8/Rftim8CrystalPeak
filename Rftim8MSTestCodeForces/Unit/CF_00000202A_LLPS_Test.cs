...
{
    [TestClass]
    public sealed class CF_00000202A_LLPS_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000202A_LLPS));
        ...
        {
            bool result = CF_00000202A_LLPS.Solution_0_Test(input);
