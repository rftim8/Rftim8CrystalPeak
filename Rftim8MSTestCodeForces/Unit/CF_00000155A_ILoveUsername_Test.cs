...
{
    [TestClass]
    public sealed class CF_00000155A_ILoveUsername_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000155A_ILoveUsername));
        ...
        {
            bool result = CF_00000155A_ILoveUsername.Solution_0_Test(input);
