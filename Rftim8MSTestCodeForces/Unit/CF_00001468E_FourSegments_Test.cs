...
{
    [TestClass]
    public sealed class CF_00001468E_FourSegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468E_FourSegments));
        ...
        {
            bool result = CF_00001468E_FourSegments.Solution_0_Test(input);
