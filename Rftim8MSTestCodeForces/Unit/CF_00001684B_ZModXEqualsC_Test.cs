...
{
    [TestClass]
    public sealed class CF_00001684B_ZModXEqualsC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001684B_ZModXEqualsC));
        ...
        {
            bool result = CF_00001684B_ZModXEqualsC.Solution_0_Test(input);
