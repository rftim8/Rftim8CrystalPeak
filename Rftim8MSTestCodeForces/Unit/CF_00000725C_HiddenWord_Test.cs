...
{
    [TestClass]
    public sealed class CF_00000725C_HiddenWord_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000725C_HiddenWord));
        ...
        {
            bool result = CF_00000725C_HiddenWord.Solution_0_Test(input);
