...
{
    [TestClass]
    public sealed class CF_00001005D_PolycarpAndDiv3_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001005D_PolycarpAndDiv3));
        ...
        {
            bool result = CF_00001005D_PolycarpAndDiv3.Solution_0_Test(input);
