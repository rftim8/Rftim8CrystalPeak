...
{
    [TestClass]
    public sealed class CF_00000192B_WalkingInTheRain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000192B_WalkingInTheRain));
        ...
        {
            bool result = CF_00000192B_WalkingInTheRain.Solution_0_Test(input);
