...
{
    [TestClass]
    public sealed class CF_00000838C_FutureFailure_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000838C_FutureFailure));
        ...
        {
            bool result = CF_00000838C_FutureFailure.Solution_0_Test(input);
