...
{
    [TestClass]
    public sealed class CF_00001501B_NapoleonCake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001501B_NapoleonCake));
        ...
        {
            bool result = CF_00001501B_NapoleonCake.Solution_0_Test(input);
