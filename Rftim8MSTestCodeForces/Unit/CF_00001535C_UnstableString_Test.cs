...
{
    [TestClass]
    public sealed class CF_00001535C_UnstableString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001535C_UnstableString));
        ...
        {
            bool result = CF_00001535C_UnstableString.Solution_0_Test(input);
