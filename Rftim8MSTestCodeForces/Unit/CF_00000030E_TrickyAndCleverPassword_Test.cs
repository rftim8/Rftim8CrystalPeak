...
{
    [TestClass]
    public sealed class CF_00000030E_TrickyAndCleverPassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000030E_TrickyAndCleverPassword));
        ...
        {
            bool result = CF_00000030E_TrickyAndCleverPassword.Solution_0_Test(input);
