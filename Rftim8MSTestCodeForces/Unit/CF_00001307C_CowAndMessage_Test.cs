...
{
    [TestClass]
    public sealed class CF_00001307C_CowAndMessage_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001307C_CowAndMessage));
        ...
        {
            bool result = CF_00001307C_CowAndMessage.Solution_0_Test(input);
