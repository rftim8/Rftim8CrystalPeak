...
{
    [TestClass]
    public sealed class CF_00001910D_RemoveAndAdd_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001910D_RemoveAndAdd));
        ...
        {
            bool result = CF_00001910D_RemoveAndAdd.Solution_0_Test(input);
