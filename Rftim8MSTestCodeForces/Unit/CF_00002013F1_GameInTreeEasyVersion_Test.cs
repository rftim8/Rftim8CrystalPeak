...
{
    [TestClass]
    public sealed class CF_00002013F1_GameInTreeEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002013F1_GameInTreeEasyVersion));
        ...
        {
            bool result = CF_00002013F1_GameInTreeEasyVersion.Solution_0_Test(input);
