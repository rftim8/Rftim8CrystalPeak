...
{
    [TestClass]
    public sealed class CF_00001100F_IvanAndBurgers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001100F_IvanAndBurgers));
        ...
        {
            bool result = CF_00001100F_IvanAndBurgers.Solution_0_Test(input);
