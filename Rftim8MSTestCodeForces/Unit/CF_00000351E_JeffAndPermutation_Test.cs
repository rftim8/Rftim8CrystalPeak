...
{
    [TestClass]
    public sealed class CF_00000351E_JeffAndPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000351E_JeffAndPermutation));
        ...
        {
            bool result = CF_00000351E_JeffAndPermutation.Solution_0_Test(input);
