...
{
    [TestClass]
    public sealed class CF_00001670B_DormsWar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001670B_DormsWar));
        ...
        {
            bool result = CF_00001670B_DormsWar.Solution_0_Test(input);
