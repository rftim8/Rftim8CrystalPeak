...
{
    [TestClass]
    public sealed class CF_00000313D_IlyaAndRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000313D_IlyaAndRoads));
        ...
        {
            bool result = CF_00000313D_IlyaAndRoads.Solution_0_Test(input);
