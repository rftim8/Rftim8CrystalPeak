...
{
    [TestClass]
    public sealed class CF_00000986D_PerfectEncoding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000986D_PerfectEncoding));
        ...
        {
            bool result = CF_00000986D_PerfectEncoding.Solution_0_Test(input);
