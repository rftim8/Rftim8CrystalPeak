...
{
    [TestClass]
    public sealed class CF_00000559E_GeraldAndPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000559E_GeraldAndPath));
        ...
        {
            bool result = CF_00000559E_GeraldAndPath.Solution_0_Test(input);
