...
{
    [TestClass]
    public sealed class CF_00000500C_NewYearBookReading_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000500C_NewYearBookReading));
        ...
        {
            bool result = CF_00000500C_NewYearBookReading.Solution_0_Test(input);
