...
{
    [TestClass]
    public sealed class CF_00001313C1_SkyscrapersEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001313C1_SkyscrapersEasyVersion));
        ...
        {
            bool result = CF_00001313C1_SkyscrapersEasyVersion.Solution_0_Test(input);
