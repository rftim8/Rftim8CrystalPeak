...
{
    [TestClass]
    public sealed class CF_00001913E_MatrixProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001913E_MatrixProblem));
        ...
        {
            bool result = CF_00001913E_MatrixProblem.Solution_0_Test(input);
