...
{
    [TestClass]
    public sealed class CF_00000333C_LuckyTickets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000333C_LuckyTickets));
        ...
        {
            bool result = CF_00000333C_LuckyTickets.Solution_0_Test(input);
