...
{
    [TestClass]
    public sealed class CF_00000707A_BrainsPhotos_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000707A_BrainsPhotos));
        ...
        {
            bool result = CF_00000707A_BrainsPhotos.Solution_0_Test(input);
