...
{
    [TestClass]
    public sealed class CF_00001842I_TenzingAndNecklace_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001842I_TenzingAndNecklace));
        ...
        {
            bool result = CF_00001842I_TenzingAndNecklace.Solution_0_Test(input);
