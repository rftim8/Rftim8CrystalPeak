...
{
    [TestClass]
    public sealed class CF_00001303E_EraseSubsequences_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001303E_EraseSubsequences));
        ...
        {
            bool result = CF_00001303E_EraseSubsequences.Solution_0_Test(input);
