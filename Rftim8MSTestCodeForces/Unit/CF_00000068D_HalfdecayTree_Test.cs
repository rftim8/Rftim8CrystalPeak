...
{
    [TestClass]
    public sealed class CF_00000068D_HalfdecayTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000068D_HalfdecayTree));
        ...
        {
            bool result = CF_00000068D_HalfdecayTree.Solution_0_Test(input);
