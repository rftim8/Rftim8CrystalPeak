...
{
    [TestClass]
    public sealed class CF_00001996A_Legs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001996A_Legs));
        ...
        {
            bool result = CF_00001996A_Legs.Solution_0_Test(input);
