...
{
    [TestClass]
    public sealed class CF_00001938A_AntiparticleAntiphysics_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001938A_AntiparticleAntiphysics));
        ...
        {
            bool result = CF_00001938A_AntiparticleAntiphysics.Solution_0_Test(input);
