...
{
    [TestClass]
    public sealed class CF_00001438F_OlhaAndIgor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001438F_OlhaAndIgor));
        ...
        {
            bool result = CF_00001438F_OlhaAndIgor.Solution_0_Test(input);
