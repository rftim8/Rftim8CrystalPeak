...
{
    [TestClass]
    public sealed class CF_00002014F_SheriffsDefense_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002014F_SheriffsDefense));
        ...
        {
            bool result = CF_00002014F_SheriffsDefense.Solution_0_Test(input);
