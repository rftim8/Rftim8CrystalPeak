...
{
    [TestClass]
    public sealed class CF_00001153E_ServalAndSnake_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001153E_ServalAndSnake));
        ...
        {
            bool result = CF_00001153E_ServalAndSnake.Solution_0_Test(input);
