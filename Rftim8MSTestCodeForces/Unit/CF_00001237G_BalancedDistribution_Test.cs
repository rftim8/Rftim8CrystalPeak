...
{
    [TestClass]
    public sealed class CF_00001237G_BalancedDistribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001237G_BalancedDistribution));
        ...
        {
            bool result = CF_00001237G_BalancedDistribution.Solution_0_Test(input);
