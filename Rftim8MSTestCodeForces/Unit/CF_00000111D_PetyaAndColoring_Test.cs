...
{
    [TestClass]
    public sealed class CF_00000111D_PetyaAndColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000111D_PetyaAndColoring));
        ...
        {
            bool result = CF_00000111D_PetyaAndColoring.Solution_0_Test(input);
