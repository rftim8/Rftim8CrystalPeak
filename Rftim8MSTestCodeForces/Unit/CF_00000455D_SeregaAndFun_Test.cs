...
{
    [TestClass]
    public sealed class CF_00000455D_SeregaAndFun_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000455D_SeregaAndFun));
        ...
        {
            bool result = CF_00000455D_SeregaAndFun.Solution_0_Test(input);
