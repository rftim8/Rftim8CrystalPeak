...
{
    [TestClass]
    public sealed class CF_00000524E_RooksAndRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000524E_RooksAndRectangles));
        ...
        {
            bool result = CF_00000524E_RooksAndRectangles.Solution_0_Test(input);
