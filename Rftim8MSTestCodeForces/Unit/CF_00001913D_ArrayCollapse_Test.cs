...
{
    [TestClass]
    public sealed class CF_00001913D_ArrayCollapse_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001913D_ArrayCollapse));
        ...
        {
            bool result = CF_00001913D_ArrayCollapse.Solution_0_Test(input);
