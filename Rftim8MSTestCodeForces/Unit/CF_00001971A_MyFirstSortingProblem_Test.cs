...
{
    [TestClass]
    public sealed class CF_00001971A_MyFirstSortingProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001971A_MyFirstSortingProblem));
        ...
        {
            bool result = CF_00001971A_MyFirstSortingProblem.Solution_0_Test(input);
