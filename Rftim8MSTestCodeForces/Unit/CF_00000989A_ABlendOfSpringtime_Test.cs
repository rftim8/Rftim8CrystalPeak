...
{
    [TestClass]
    public sealed class CF_00000989A_ABlendOfSpringtime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000989A_ABlendOfSpringtime));
        ...
        {
            bool result = CF_00000989A_ABlendOfSpringtime.Solution_0_Test(input);
