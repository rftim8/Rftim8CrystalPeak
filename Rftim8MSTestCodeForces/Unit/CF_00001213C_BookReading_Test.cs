...
{
    [TestClass]
    public sealed class CF_00001213C_BookReading_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001213C_BookReading));
        ...
        {
            bool result = CF_00001213C_BookReading.Solution_0_Test(input);
