...
{
    [TestClass]
    public sealed class CF_00001873H_MadCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001873H_MadCity));
        ...
        {
            bool result = CF_00001873H_MadCity.Solution_0_Test(input);
