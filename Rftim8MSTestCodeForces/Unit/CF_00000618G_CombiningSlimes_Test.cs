...
{
    [TestClass]
    public sealed class CF_00000618G_CombiningSlimes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000618G_CombiningSlimes));
        ...
        {
            bool result = CF_00000618G_CombiningSlimes.Solution_0_Test(input);
