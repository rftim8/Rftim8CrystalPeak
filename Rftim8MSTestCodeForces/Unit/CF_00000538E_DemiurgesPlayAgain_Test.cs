...
{
    [TestClass]
    public sealed class CF_00000538E_DemiurgesPlayAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000538E_DemiurgesPlayAgain));
        ...
        {
            bool result = CF_00000538E_DemiurgesPlayAgain.Solution_0_Test(input);
