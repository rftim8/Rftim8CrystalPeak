...
{
    [TestClass]
    public sealed class CF_00001215E_Marbles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001215E_Marbles));
        ...
        {
            bool result = CF_00001215E_Marbles.Solution_0_Test(input);
