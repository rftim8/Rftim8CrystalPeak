...
{
    [TestClass]
    public sealed class CF_00001671A_StringBuilding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001671A_StringBuilding));
        ...
        {
            bool result = CF_00001671A_StringBuilding.Solution_0_Test(input);
