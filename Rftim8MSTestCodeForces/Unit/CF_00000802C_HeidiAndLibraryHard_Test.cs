...
{
    [TestClass]
    public sealed class CF_00000802C_HeidiAndLibraryHard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000802C_HeidiAndLibraryHard));
        ...
        {
            bool result = CF_00000802C_HeidiAndLibraryHard.Solution_0_Test(input);
