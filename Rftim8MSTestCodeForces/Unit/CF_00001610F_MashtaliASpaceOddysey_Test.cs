...
{
    [TestClass]
    public sealed class CF_00001610F_MashtaliASpaceOddysey_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001610F_MashtaliASpaceOddysey));
        ...
        {
            bool result = CF_00001610F_MashtaliASpaceOddysey.Solution_0_Test(input);
