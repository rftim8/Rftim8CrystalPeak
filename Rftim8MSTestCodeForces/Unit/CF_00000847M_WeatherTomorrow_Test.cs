...
{
    [TestClass]
    public sealed class CF_00000847M_WeatherTomorrow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847M_WeatherTomorrow));
        ...
        {
            bool result = CF_00000847M_WeatherTomorrow.Solution_0_Test(input);
