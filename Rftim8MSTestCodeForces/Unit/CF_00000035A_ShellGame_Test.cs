...
{
    [TestClass]
    public sealed class CF_00000035A_ShellGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000035A_ShellGame));
        ...
        {
            bool result = CF_00000035A_ShellGame.Solution_0_Test(input);
