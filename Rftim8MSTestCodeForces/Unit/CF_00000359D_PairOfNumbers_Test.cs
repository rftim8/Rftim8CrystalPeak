...
{
    [TestClass]
    public sealed class CF_00000359D_PairOfNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000359D_PairOfNumbers));
        ...
        {
            bool result = CF_00000359D_PairOfNumbers.Solution_0_Test(input);
