...
{
    [TestClass]
    public sealed class CF_00000062E_WorldEvil_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000062E_WorldEvil));
        ...
        {
            bool result = CF_00000062E_WorldEvil.Solution_0_Test(input);
