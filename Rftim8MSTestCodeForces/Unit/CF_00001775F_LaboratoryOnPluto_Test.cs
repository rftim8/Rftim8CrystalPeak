...
{
    [TestClass]
    public sealed class CF_00001775F_LaboratoryOnPluto_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001775F_LaboratoryOnPluto));
        ...
        {
            bool result = CF_00001775F_LaboratoryOnPluto.Solution_0_Test(input);
