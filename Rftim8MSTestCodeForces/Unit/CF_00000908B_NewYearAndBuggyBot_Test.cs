...
{
    [TestClass]
    public sealed class CF_00000908B_NewYearAndBuggyBot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000908B_NewYearAndBuggyBot));
        ...
        {
            bool result = CF_00000908B_NewYearAndBuggyBot.Solution_0_Test(input);
