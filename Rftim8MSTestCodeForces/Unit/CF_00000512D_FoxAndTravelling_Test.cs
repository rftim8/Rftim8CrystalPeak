...
{
    [TestClass]
    public sealed class CF_00000512D_FoxAndTravelling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000512D_FoxAndTravelling));
        ...
        {
            bool result = CF_00000512D_FoxAndTravelling.Solution_0_Test(input);
