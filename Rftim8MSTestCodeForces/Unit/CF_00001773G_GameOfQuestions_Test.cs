...
{
    [TestClass]
    public sealed class CF_00001773G_GameOfQuestions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001773G_GameOfQuestions));
        ...
        {
            bool result = CF_00001773G_GameOfQuestions.Solution_0_Test(input);
