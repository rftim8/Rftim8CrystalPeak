...
{
    [TestClass]
    public sealed class CF_00001516D_Cut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001516D_Cut));
        ...
        {
            bool result = CF_00001516D_Cut.Solution_0_Test(input);
