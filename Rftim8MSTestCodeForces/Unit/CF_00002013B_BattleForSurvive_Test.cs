...
{
    [TestClass]
    public sealed class CF_00002013B_BattleForSurvive_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002013B_BattleForSurvive));
        ...
        {
            bool result = CF_00002013B_BattleForSurvive.Solution_0_Test(input);
