...
{
    [TestClass]
    public sealed class CF_00000810B_SummerSelloff_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000810B_SummerSelloff));
        ...
        {
            bool result = CF_00000810B_SummerSelloff.Solution_0_Test(input);
