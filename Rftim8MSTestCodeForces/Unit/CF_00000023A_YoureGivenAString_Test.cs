...
{
    [TestClass]
    public sealed class CF_00000023A_YoureGivenAString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000023A_YoureGivenAString));
        ...
        {
            bool result = CF_00000023A_YoureGivenAString.Solution_0_Test(input);
