...
{
    [TestClass]
    public sealed class CF_00002034E_PermutationsHarmony_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002034E_PermutationsHarmony));
        ...
        {
            bool result = CF_00002034E_PermutationsHarmony.Solution_0_Test(input);
