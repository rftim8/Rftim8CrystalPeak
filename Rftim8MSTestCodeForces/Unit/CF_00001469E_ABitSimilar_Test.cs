...
{
    [TestClass]
    public sealed class CF_00001469E_ABitSimilar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001469E_ABitSimilar));
        ...
        {
            bool result = CF_00001469E_ABitSimilar.Solution_0_Test(input);
