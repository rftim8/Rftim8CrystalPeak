...
{
    [TestClass]
    public sealed class CF_00001593D1_AllAreSame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001593D1_AllAreSame));
        ...
        {
            bool result = CF_00001593D1_AllAreSame.Solution_0_Test(input);
