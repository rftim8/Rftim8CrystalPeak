...
{
    [TestClass]
    public sealed class CF_00001578B_BuildingForestTrails_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001578B_BuildingForestTrails));
        ...
        {
            bool result = CF_00001578B_BuildingForestTrails.Solution_0_Test(input);
