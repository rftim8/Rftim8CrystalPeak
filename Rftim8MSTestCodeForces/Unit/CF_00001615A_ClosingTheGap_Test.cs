...
{
    [TestClass]
    public sealed class CF_00001615A_ClosingTheGap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001615A_ClosingTheGap));
        ...
        {
            bool result = CF_00001615A_ClosingTheGap.Solution_0_Test(input);
