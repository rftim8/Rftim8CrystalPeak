...
{
    [TestClass]
    public sealed class CF_00001806F1_GCDMasterEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001806F1_GCDMasterEasyVersion));
        ...
        {
            bool result = CF_00001806F1_GCDMasterEasyVersion.Solution_0_Test(input);
