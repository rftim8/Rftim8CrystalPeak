...
{
    [TestClass]
    public sealed class CF_00000300E_EmpireStrikesBack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000300E_EmpireStrikesBack));
        ...
        {
            bool result = CF_00000300E_EmpireStrikesBack.Solution_0_Test(input);
