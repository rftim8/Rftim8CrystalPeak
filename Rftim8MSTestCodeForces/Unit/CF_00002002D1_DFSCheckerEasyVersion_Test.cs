...
{
    [TestClass]
    public sealed class CF_00002002D1_DFSCheckerEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002002D1_DFSCheckerEasyVersion));
        ...
        {
            bool result = CF_00002002D1_DFSCheckerEasyVersion.Solution_0_Test(input);
