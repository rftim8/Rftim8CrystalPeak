...
{
    [TestClass]
    public sealed class CF_00001979D_FixingABinaryString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001979D_FixingABinaryString));
        ...
        {
            bool result = CF_00001979D_FixingABinaryString.Solution_0_Test(input);
