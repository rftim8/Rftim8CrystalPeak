...
{
    [TestClass]
    public sealed class CF_00001902A_BinaryImbalance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001902A_BinaryImbalance));
        ...
        {
            bool result = CF_00001902A_BinaryImbalance.Solution_0_Test(input);
