...
{
    [TestClass]
    public sealed class CF_00000392A_BlockedPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000392A_BlockedPoints));
        ...
        {
            bool result = CF_00000392A_BlockedPoints.Solution_0_Test(input);
