...
{
    [TestClass]
    public sealed class CF_00000773C_PrairiePartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000773C_PrairiePartition));
        ...
        {
            bool result = CF_00000773C_PrairiePartition.Solution_0_Test(input);
