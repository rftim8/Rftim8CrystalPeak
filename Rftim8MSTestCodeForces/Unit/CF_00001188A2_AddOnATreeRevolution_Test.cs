...
{
    [TestClass]
    public sealed class CF_00001188A2_AddOnATreeRevolution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001188A2_AddOnATreeRevolution));
        ...
        {
            bool result = CF_00001188A2_AddOnATreeRevolution.Solution_0_Test(input);
