...
{
    [TestClass]
    public sealed class CF_00001663C_SonOfVerdon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001663C_SonOfVerdon));
        ...
        {
            bool result = CF_00001663C_SonOfVerdon.Solution_0_Test(input);
