...
{
    [TestClass]
    public sealed class CF_00001015B_ObtainingTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001015B_ObtainingTheString));
        ...
        {
            bool result = CF_00001015B_ObtainingTheString.Solution_0_Test(input);
