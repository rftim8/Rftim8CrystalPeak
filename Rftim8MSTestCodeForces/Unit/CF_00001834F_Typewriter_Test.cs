...
{
    [TestClass]
    public sealed class CF_00001834F_Typewriter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001834F_Typewriter));
        ...
        {
            bool result = CF_00001834F_Typewriter.Solution_0_Test(input);
