...
{
    [TestClass]
    public sealed class CF_00000683E_HammerThrowing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000683E_HammerThrowing));
        ...
        {
            bool result = CF_00000683E_HammerThrowing.Solution_0_Test(input);
