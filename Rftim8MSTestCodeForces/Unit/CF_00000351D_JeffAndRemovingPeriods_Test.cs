...
{
    [TestClass]
    public sealed class CF_00000351D_JeffAndRemovingPeriods_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000351D_JeffAndRemovingPeriods));
        ...
        {
            bool result = CF_00000351D_JeffAndRemovingPeriods.Solution_0_Test(input);
