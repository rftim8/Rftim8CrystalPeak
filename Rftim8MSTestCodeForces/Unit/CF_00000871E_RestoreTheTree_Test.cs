...
{
    [TestClass]
    public sealed class CF_00000871E_RestoreTheTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000871E_RestoreTheTree));
        ...
        {
            bool result = CF_00000871E_RestoreTheTree.Solution_0_Test(input);
