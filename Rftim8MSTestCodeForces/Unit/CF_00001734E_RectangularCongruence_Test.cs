...
{
    [TestClass]
    public sealed class CF_00001734E_RectangularCongruence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001734E_RectangularCongruence));
        ...
        {
            bool result = CF_00001734E_RectangularCongruence.Solution_0_Test(input);
