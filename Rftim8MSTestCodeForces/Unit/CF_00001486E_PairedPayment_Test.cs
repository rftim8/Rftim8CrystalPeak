...
{
    [TestClass]
    public sealed class CF_00001486E_PairedPayment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001486E_PairedPayment));
        ...
        {
            bool result = CF_00001486E_PairedPayment.Solution_0_Test(input);
