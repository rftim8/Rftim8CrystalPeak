...
{
    [TestClass]
    public sealed class CF_00000831B_KeyboardLayouts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000831B_KeyboardLayouts));
        ...
        {
            bool result = CF_00000831B_KeyboardLayouts.Solution_0_Test(input);
