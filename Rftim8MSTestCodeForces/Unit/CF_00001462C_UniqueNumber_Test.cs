...
{
    [TestClass]
    public sealed class CF_00001462C_UniqueNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001462C_UniqueNumber));
        ...
        {
            bool result = CF_00001462C_UniqueNumber.Solution_0_Test(input);
