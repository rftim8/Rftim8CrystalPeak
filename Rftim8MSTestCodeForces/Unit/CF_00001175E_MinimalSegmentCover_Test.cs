...
{
    [TestClass]
    public sealed class CF_00001175E_MinimalSegmentCover_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001175E_MinimalSegmentCover));
        ...
        {
            bool result = CF_00001175E_MinimalSegmentCover.Solution_0_Test(input);
