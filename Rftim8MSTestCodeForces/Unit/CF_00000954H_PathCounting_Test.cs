...
{
    [TestClass]
    public sealed class CF_00000954H_PathCounting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000954H_PathCounting));
        ...
        {
            bool result = CF_00000954H_PathCounting.Solution_0_Test(input);
