...
{
    [TestClass]
    public sealed class CF_00001624D_PalindromesColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001624D_PalindromesColoring));
        ...
        {
            bool result = CF_00001624D_PalindromesColoring.Solution_0_Test(input);
