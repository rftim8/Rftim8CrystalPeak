...
{
    [TestClass]
    public sealed class CF_00000704A_Thor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000704A_Thor));
        ...
        {
            bool result = CF_00000704A_Thor.Solution_0_Test(input);
