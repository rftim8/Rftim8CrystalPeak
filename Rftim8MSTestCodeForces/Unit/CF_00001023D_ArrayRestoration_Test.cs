...
{
    [TestClass]
    public sealed class CF_00001023D_ArrayRestoration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001023D_ArrayRestoration));
        ...
        {
            bool result = CF_00001023D_ArrayRestoration.Solution_0_Test(input);
