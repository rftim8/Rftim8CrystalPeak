...
{
    [TestClass]
    public sealed class CF_00000283E_CowTennisTournament_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000283E_CowTennisTournament));
        ...
        {
            bool result = CF_00000283E_CowTennisTournament.Solution_0_Test(input);
