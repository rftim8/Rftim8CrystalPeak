...
{
    [TestClass]
    public sealed class CF_00001089G_GuestStudent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001089G_GuestStudent));
        ...
        {
            bool result = CF_00001089G_GuestStudent.Solution_0_Test(input);
