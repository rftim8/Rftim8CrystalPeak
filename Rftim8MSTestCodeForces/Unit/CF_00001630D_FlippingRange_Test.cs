...
{
    [TestClass]
    public sealed class CF_00001630D_FlippingRange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001630D_FlippingRange));
        ...
        {
            bool result = CF_00001630D_FlippingRange.Solution_0_Test(input);
