...
{
    [TestClass]
    public sealed class CF_00000003B_Lorry_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000003B_Lorry));
        ...
        {
            bool result = CF_00000003B_Lorry.Solution_0_Test(input);
