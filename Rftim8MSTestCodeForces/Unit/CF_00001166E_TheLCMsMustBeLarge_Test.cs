...
{
    [TestClass]
    public sealed class CF_00001166E_TheLCMsMustBeLarge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001166E_TheLCMsMustBeLarge));
        ...
        {
            bool result = CF_00001166E_TheLCMsMustBeLarge.Solution_0_Test(input);
