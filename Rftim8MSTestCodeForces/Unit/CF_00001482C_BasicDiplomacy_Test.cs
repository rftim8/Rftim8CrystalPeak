...
{
    [TestClass]
    public sealed class CF_00001482C_BasicDiplomacy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001482C_BasicDiplomacy));
        ...
        {
            bool result = CF_00001482C_BasicDiplomacy.Solution_0_Test(input);
