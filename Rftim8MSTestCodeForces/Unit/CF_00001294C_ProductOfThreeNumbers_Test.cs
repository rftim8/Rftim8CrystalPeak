...
{
    [TestClass]
    public sealed class CF_00001294C_ProductOfThreeNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001294C_ProductOfThreeNumbers));
        ...
        {
            bool result = CF_00001294C_ProductOfThreeNumbers.Solution_0_Test(input);
