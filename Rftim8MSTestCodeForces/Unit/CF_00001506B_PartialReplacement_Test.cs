...
{
    [TestClass]
    public sealed class CF_00001506B_PartialReplacement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001506B_PartialReplacement));
        ...
        {
            bool result = CF_00001506B_PartialReplacement.Solution_0_Test(input);
