...
{
    [TestClass]
    public sealed class CF_00001780G_DeliciousDessert_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001780G_DeliciousDessert));
        ...
        {
            bool result = CF_00001780G_DeliciousDessert.Solution_0_Test(input);
