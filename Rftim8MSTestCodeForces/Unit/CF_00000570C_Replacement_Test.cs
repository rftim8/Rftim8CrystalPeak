...
{
    [TestClass]
    public sealed class CF_00000570C_Replacement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000570C_Replacement));
        ...
        {
            bool result = CF_00000570C_Replacement.Solution_0_Test(input);
