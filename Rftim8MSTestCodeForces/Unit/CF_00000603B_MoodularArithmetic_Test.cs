...
{
    [TestClass]
    public sealed class CF_00000603B_MoodularArithmetic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000603B_MoodularArithmetic));
        ...
        {
            bool result = CF_00000603B_MoodularArithmetic.Solution_0_Test(input);
