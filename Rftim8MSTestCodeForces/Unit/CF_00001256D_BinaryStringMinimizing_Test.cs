...
{
    [TestClass]
    public sealed class CF_00001256D_BinaryStringMinimizing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001256D_BinaryStringMinimizing));
        ...
        {
            bool result = CF_00001256D_BinaryStringMinimizing.Solution_0_Test(input);
