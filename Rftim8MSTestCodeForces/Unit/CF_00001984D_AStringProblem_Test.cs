...
{
    [TestClass]
    public sealed class CF_00001984D_AStringProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001984D_AStringProblem));
        ...
        {
            bool result = CF_00001984D_AStringProblem.Solution_0_Test(input);
