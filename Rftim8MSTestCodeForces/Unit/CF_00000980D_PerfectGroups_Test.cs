...
{
    [TestClass]
    public sealed class CF_00000980D_PerfectGroups_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000980D_PerfectGroups));
        ...
        {
            bool result = CF_00000980D_PerfectGroups.Solution_0_Test(input);
