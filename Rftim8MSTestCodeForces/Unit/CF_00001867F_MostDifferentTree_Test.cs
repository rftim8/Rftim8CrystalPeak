...
{
    [TestClass]
    public sealed class CF_00001867F_MostDifferentTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001867F_MostDifferentTree));
        ...
        {
            bool result = CF_00001867F_MostDifferentTree.Solution_0_Test(input);
