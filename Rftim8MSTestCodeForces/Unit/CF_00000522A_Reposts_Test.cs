...
{
    [TestClass]
    public sealed class CF_00000522A_Reposts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000522A_Reposts));
        ...
        {
            bool result = CF_00000522A_Reposts.Solution_0_Test(input);
