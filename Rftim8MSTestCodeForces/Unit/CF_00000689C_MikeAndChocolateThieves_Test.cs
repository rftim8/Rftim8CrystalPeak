...
{
    [TestClass]
    public sealed class CF_00000689C_MikeAndChocolateThieves_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000689C_MikeAndChocolateThieves));
        ...
        {
            bool result = CF_00000689C_MikeAndChocolateThieves.Solution_0_Test(input);
