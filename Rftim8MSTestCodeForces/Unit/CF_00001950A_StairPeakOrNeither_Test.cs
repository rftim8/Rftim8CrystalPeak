...
{
    [TestClass]
    public sealed class CF_00001950A_StairPeakOrNeither_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001950A_StairPeakOrNeither));
        ...
        {
            bool result = CF_00001950A_StairPeakOrNeither.Solution_0_Test(input);
