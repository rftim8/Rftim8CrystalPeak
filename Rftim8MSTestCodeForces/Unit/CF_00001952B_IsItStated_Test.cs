...
{
    [TestClass]
    public sealed class CF_00001952B_IsItStated_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001952B_IsItStated));
        ...
        {
            bool result = CF_00001952B_IsItStated.Solution_0_Test(input);
