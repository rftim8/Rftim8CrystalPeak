...
{
    [TestClass]
    public sealed class CF_00000645B_MischievousMessMakers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000645B_MischievousMessMakers));
        ...
        {
            bool result = CF_00000645B_MischievousMessMakers.Solution_0_Test(input);
