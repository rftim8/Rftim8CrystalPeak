...
{
    [TestClass]
    public sealed class CF_00001141A_Game23_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001141A_Game23));
        ...
        {
            bool result = CF_00001141A_Game23.Solution_0_Test(input);
