...
{
    [TestClass]
    public sealed class CF_00000200B_Drinks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000200B_Drinks));
        ...
        {
            bool result = CF_00000200B_Drinks.Solution_0_Test(input);
