...
{
    [TestClass]
    public sealed class CF_00001701A_GrassField_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001701A_GrassField));
        ...
        {
            bool result = CF_00001701A_GrassField.Solution_0_Test(input);
