...
{
    [TestClass]
    public sealed class CF_00000152B_Steps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000152B_Steps));
        ...
        {
            bool result = CF_00000152B_Steps.Solution_0_Test(input);
