...
{
    [TestClass]
    public sealed class CF_00001720E_MishaAndPaintings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001720E_MishaAndPaintings));
        ...
        {
            bool result = CF_00001720E_MishaAndPaintings.Solution_0_Test(input);
