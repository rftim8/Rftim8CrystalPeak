...
{
    [TestClass]
    public sealed class CF_00001648D_SeriousBusiness_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001648D_SeriousBusiness));
        ...
        {
            bool result = CF_00001648D_SeriousBusiness.Solution_0_Test(input);
