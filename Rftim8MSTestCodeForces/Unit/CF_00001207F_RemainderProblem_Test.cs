...
{
    [TestClass]
    public sealed class CF_00001207F_RemainderProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001207F_RemainderProblem));
        ...
        {
            bool result = CF_00001207F_RemainderProblem.Solution_0_Test(input);
