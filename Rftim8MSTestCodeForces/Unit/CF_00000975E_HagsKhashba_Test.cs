...
{
    [TestClass]
    public sealed class CF_00000975E_HagsKhashba_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000975E_HagsKhashba));
        ...
        {
            bool result = CF_00000975E_HagsKhashba.Solution_0_Test(input);
