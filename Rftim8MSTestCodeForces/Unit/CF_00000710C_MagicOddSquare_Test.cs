...
{
    [TestClass]
    public sealed class CF_00000710C_MagicOddSquare_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000710C_MagicOddSquare));
        ...
        {
            bool result = CF_00000710C_MagicOddSquare.Solution_0_Test(input);
