...
{
    [TestClass]
    public sealed class CF_00001560C_InfinityTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001560C_InfinityTable));
        ...
        {
            bool result = CF_00001560C_InfinityTable.Solution_0_Test(input);
