...
{
    [TestClass]
    public sealed class CF_00000034E_Collisions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000034E_Collisions));
        ...
        {
            bool result = CF_00000034E_Collisions.Solution_0_Test(input);
