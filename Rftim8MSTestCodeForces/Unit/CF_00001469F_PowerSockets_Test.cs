...
{
    [TestClass]
    public sealed class CF_00001469F_PowerSockets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001469F_PowerSockets));
        ...
        {
            bool result = CF_00001469F_PowerSockets.Solution_0_Test(input);
