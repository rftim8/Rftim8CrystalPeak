...
{
    [TestClass]
    public sealed class CF_00001438C_EngineerArtem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001438C_EngineerArtem));
        ...
        {
            bool result = CF_00001438C_EngineerArtem.Solution_0_Test(input);
