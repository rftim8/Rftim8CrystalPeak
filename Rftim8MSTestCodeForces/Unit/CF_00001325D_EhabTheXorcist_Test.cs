...
{
    [TestClass]
    public sealed class CF_00001325D_EhabTheXorcist_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001325D_EhabTheXorcist));
        ...
        {
            bool result = CF_00001325D_EhabTheXorcist.Solution_0_Test(input);
