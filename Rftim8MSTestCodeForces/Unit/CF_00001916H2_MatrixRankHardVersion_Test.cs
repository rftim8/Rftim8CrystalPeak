...
{
    [TestClass]
    public sealed class CF_00001916H2_MatrixRankHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001916H2_MatrixRankHardVersion));
        ...
        {
            bool result = CF_00001916H2_MatrixRankHardVersion.Solution_0_Test(input);
