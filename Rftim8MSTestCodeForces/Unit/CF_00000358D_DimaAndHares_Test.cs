...
{
    [TestClass]
    public sealed class CF_00000358D_DimaAndHares_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000358D_DimaAndHares));
        ...
        {
            bool result = CF_00000358D_DimaAndHares.Solution_0_Test(input);
