...
{
    [TestClass]
    public sealed class CF_00001869A_MakeItZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001869A_MakeItZero));
        ...
        {
            bool result = CF_00001869A_MakeItZero.Solution_0_Test(input);
