...
{
    [TestClass]
    public sealed class CF_00000578A_AProblemAboutPolyline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000578A_AProblemAboutPolyline));
        ...
        {
            bool result = CF_00000578A_AProblemAboutPolyline.Solution_0_Test(input);
