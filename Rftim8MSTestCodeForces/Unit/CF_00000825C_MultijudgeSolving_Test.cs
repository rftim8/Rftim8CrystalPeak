...
{
    [TestClass]
    public sealed class CF_00000825C_MultijudgeSolving_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000825C_MultijudgeSolving));
        ...
        {
            bool result = CF_00000825C_MultijudgeSolving.Solution_0_Test(input);
