...
{
    [TestClass]
    public sealed class CF_00000835A_KeyRaces_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000835A_KeyRaces));
        ...
        {
            bool result = CF_00000835A_KeyRaces.Solution_0_Test(input);
