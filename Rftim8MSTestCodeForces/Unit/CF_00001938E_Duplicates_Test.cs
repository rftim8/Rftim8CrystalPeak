...
{
    [TestClass]
    public sealed class CF_00001938E_Duplicates_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001938E_Duplicates));
        ...
        {
            bool result = CF_00001938E_Duplicates.Solution_0_Test(input);
