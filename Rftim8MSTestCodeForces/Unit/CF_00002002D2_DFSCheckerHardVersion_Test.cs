...
{
    [TestClass]
    public sealed class CF_00002002D2_DFSCheckerHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002002D2_DFSCheckerHardVersion));
        ...
        {
            bool result = CF_00002002D2_DFSCheckerHardVersion.Solution_0_Test(input);
