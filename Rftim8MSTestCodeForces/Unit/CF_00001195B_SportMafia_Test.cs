...
{
    [TestClass]
    public sealed class CF_00001195B_SportMafia_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001195B_SportMafia));
        ...
        {
            bool result = CF_00001195B_SportMafia.Solution_0_Test(input);
