...
{
    [TestClass]
    public sealed class CF_00001743E_FTL_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001743E_FTL));
        ...
        {
            bool result = CF_00001743E_FTL.Solution_0_Test(input);
