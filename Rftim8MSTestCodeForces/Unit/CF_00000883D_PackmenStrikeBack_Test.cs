...
{
    [TestClass]
    public sealed class CF_00000883D_PackmenStrikeBack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883D_PackmenStrikeBack));
        ...
        {
            bool result = CF_00000883D_PackmenStrikeBack.Solution_0_Test(input);
