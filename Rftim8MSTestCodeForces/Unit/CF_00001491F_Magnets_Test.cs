...
{
    [TestClass]
    public sealed class CF_00001491F_Magnets_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001491F_Magnets));
        ...
        {
            bool result = CF_00001491F_Magnets.Solution_0_Test(input);
