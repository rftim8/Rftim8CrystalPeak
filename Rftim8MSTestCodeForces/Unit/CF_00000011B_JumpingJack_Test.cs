...
{
    [TestClass]
    public sealed class CF_00000011B_JumpingJack_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000011B_JumpingJack));
        ...
        {
            bool result = CF_00000011B_JumpingJack.Solution_0_Test(input);
