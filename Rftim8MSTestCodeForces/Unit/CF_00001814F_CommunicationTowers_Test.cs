...
{
    [TestClass]
    public sealed class CF_00001814F_CommunicationTowers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001814F_CommunicationTowers));
        ...
        {
            bool result = CF_00001814F_CommunicationTowers.Solution_0_Test(input);
