...
{
    [TestClass]
    public sealed class CF_00001807D_OddQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001807D_OddQueries));
        ...
        {
            bool result = CF_00001807D_OddQueries.Solution_0_Test(input);
