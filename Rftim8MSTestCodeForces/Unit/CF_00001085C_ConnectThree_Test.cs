...
{
    [TestClass]
    public sealed class CF_00001085C_ConnectThree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001085C_ConnectThree));
        ...
        {
            bool result = CF_00001085C_ConnectThree.Solution_0_Test(input);
