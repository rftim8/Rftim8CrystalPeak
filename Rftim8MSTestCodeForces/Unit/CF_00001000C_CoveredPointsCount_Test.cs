...
{
    [TestClass]
    public sealed class CF_00001000C_CoveredPointsCount_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001000C_CoveredPointsCount));
        ...
        {
            bool result = CF_00001000C_CoveredPointsCount.Solution_0_Test(input);
