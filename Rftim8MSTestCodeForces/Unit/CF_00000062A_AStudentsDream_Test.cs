...
{
    [TestClass]
    public sealed class CF_00000062A_AStudentsDream_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000062A_AStudentsDream));
        ...
        {
            bool result = CF_00000062A_AStudentsDream.Solution_0_Test(input);
