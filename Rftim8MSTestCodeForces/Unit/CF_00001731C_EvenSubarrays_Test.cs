...
{
    [TestClass]
    public sealed class CF_00001731C_EvenSubarrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001731C_EvenSubarrays));
        ...
        {
            bool result = CF_00001731C_EvenSubarrays.Solution_0_Test(input);
