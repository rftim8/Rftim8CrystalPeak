...
{
    [TestClass]
    public sealed class CF_00001170G_GraphDecomposition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001170G_GraphDecomposition));
        ...
        {
            bool result = CF_00001170G_GraphDecomposition.Solution_0_Test(input);
