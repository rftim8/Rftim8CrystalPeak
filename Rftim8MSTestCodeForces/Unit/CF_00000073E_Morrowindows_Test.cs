...
{
    [TestClass]
    public sealed class CF_00000073E_Morrowindows_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000073E_Morrowindows));
        ...
        {
            bool result = CF_00000073E_Morrowindows.Solution_0_Test(input);
