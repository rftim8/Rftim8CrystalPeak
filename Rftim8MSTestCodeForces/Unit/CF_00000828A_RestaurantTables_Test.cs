...
{
    [TestClass]
    public sealed class CF_00000828A_RestaurantTables_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000828A_RestaurantTables));
        ...
        {
            bool result = CF_00000828A_RestaurantTables.Solution_0_Test(input);
