...
{
    [TestClass]
    public sealed class CF_00000269B_GreenhouseEffect_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000269B_GreenhouseEffect));
        ...
        {
            bool result = CF_00000269B_GreenhouseEffect.Solution_0_Test(input);
