...
{
    [TestClass]
    public sealed class CF_00001868D_FlowerlikePseudotree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001868D_FlowerlikePseudotree));
        ...
        {
            bool result = CF_00001868D_FlowerlikePseudotree.Solution_0_Test(input);
