...
{
    [TestClass]
    public sealed class CF_00000936C_LockPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000936C_LockPuzzle));
        ...
        {
            bool result = CF_00000936C_LockPuzzle.Solution_0_Test(input);
