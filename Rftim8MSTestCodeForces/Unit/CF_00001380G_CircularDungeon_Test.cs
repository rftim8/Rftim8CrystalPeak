...
{
    [TestClass]
    public sealed class CF_00001380G_CircularDungeon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001380G_CircularDungeon));
        ...
        {
            bool result = CF_00001380G_CircularDungeon.Solution_0_Test(input);
