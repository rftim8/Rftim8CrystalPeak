...
{
    [TestClass]
    public sealed class CF_00001385E_DirectingEdges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001385E_DirectingEdges));
        ...
        {
            bool result = CF_00001385E_DirectingEdges.Solution_0_Test(input);
