...
{
    [TestClass]
    public sealed class CF_00001569C_JuryMeeting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001569C_JuryMeeting));
        ...
        {
            bool result = CF_00001569C_JuryMeeting.Solution_0_Test(input);
