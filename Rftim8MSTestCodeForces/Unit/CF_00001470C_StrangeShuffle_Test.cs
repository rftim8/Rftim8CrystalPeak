...
{
    [TestClass]
    public sealed class CF_00001470C_StrangeShuffle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001470C_StrangeShuffle));
        ...
        {
            bool result = CF_00001470C_StrangeShuffle.Solution_0_Test(input);
