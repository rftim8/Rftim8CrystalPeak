...
{
    [TestClass]
    public sealed class CF_00001387A_Graph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001387A_Graph));
        ...
        {
            bool result = CF_00001387A_Graph.Solution_0_Test(input);
