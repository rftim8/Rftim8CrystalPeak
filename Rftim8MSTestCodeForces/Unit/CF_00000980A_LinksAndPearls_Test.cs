...
{
    [TestClass]
    public sealed class CF_00000980A_LinksAndPearls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000980A_LinksAndPearls));
        ...
        {
            bool result = CF_00000980A_LinksAndPearls.Solution_0_Test(input);
