...
{
    [TestClass]
    public sealed class CF_00001093D_BeautifulGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001093D_BeautifulGraph));
        ...
        {
            bool result = CF_00001093D_BeautifulGraph.Solution_0_Test(input);
