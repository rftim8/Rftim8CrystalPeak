...
{
    [TestClass]
    public sealed class CF_00001036A_FunctionHeight_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001036A_FunctionHeight));
        ...
        {
            bool result = CF_00001036A_FunctionHeight.Solution_0_Test(input);
