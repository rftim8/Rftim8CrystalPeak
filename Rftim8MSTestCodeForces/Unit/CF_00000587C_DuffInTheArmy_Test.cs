...
{
    [TestClass]
    public sealed class CF_00000587C_DuffInTheArmy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000587C_DuffInTheArmy));
        ...
        {
            bool result = CF_00000587C_DuffInTheArmy.Solution_0_Test(input);
