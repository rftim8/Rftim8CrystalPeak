...
{
    [TestClass]
    public sealed class CF_00000793E_ProblemOfOffices_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000793E_ProblemOfOffices));
        ...
        {
            bool result = CF_00000793E_ProblemOfOffices.Solution_0_Test(input);
