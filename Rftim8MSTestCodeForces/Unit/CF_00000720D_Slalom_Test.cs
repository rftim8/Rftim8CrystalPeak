...
{
    [TestClass]
    public sealed class CF_00000720D_Slalom_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000720D_Slalom));
        ...
        {
            bool result = CF_00000720D_Slalom.Solution_0_Test(input);
