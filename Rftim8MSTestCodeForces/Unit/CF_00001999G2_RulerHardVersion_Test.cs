...
{
    [TestClass]
    public sealed class CF_00001999G2_RulerHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001999G2_RulerHardVersion));
        ...
        {
            bool result = CF_00001999G2_RulerHardVersion.Solution_0_Test(input);
