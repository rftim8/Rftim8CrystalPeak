...
{
    [TestClass]
    public sealed class CF_00000696E_WaitForIt_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000696E_WaitForIt));
        ...
        {
            bool result = CF_00000696E_WaitForIt.Solution_0_Test(input);
