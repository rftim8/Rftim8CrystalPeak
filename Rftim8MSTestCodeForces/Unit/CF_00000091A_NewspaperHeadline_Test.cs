...
{
    [TestClass]
    public sealed class CF_00000091A_NewspaperHeadline_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000091A_NewspaperHeadline));
        ...
        {
            bool result = CF_00000091A_NewspaperHeadline.Solution_0_Test(input);
