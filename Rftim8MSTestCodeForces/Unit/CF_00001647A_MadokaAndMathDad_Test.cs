...
{
    [TestClass]
    public sealed class CF_00001647A_MadokaAndMathDad_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001647A_MadokaAndMathDad));
        ...
        {
            bool result = CF_00001647A_MadokaAndMathDad.Solution_0_Test(input);
