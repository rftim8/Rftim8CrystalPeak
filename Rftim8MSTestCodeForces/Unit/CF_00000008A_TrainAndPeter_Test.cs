...
{
    [TestClass]
    public sealed class CF_00000008A_TrainAndPeter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000008A_TrainAndPeter));
        ...
        {
            bool result = CF_00000008A_TrainAndPeter.Solution_0_Test(input);
