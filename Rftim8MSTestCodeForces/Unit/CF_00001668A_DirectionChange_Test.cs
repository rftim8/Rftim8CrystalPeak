...
{
    [TestClass]
    public sealed class CF_00001668A_DirectionChange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001668A_DirectionChange));
        ...
        {
            bool result = CF_00001668A_DirectionChange.Solution_0_Test(input);
