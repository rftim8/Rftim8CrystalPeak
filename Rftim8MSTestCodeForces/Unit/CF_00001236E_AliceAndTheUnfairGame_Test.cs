...
{
    [TestClass]
    public sealed class CF_00001236E_AliceAndTheUnfairGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001236E_AliceAndTheUnfairGame));
        ...
        {
            bool result = CF_00001236E_AliceAndTheUnfairGame.Solution_0_Test(input);
