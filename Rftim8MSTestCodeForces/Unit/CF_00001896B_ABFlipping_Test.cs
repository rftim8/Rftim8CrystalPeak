...
{
    [TestClass]
    public sealed class CF_00001896B_ABFlipping_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001896B_ABFlipping));
        ...
        {
            bool result = CF_00001896B_ABFlipping.Solution_0_Test(input);
