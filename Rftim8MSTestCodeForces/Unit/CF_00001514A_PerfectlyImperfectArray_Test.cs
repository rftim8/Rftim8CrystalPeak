...
{
    [TestClass]
    public sealed class CF_00001514A_PerfectlyImperfectArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001514A_PerfectlyImperfectArray));
        ...
        {
            bool result = CF_00001514A_PerfectlyImperfectArray.Solution_0_Test(input);
