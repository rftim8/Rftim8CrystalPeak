...
{
    [TestClass]
    public sealed class CF_00001733D1_ZeroOneEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001733D1_ZeroOneEasyVersion));
        ...
        {
            bool result = CF_00001733D1_ZeroOneEasyVersion.Solution_0_Test(input);
