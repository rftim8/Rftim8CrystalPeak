...
{
    [TestClass]
    public sealed class CF_00001201B_ZeroArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001201B_ZeroArray));
        ...
        {
            bool result = CF_00001201B_ZeroArray.Solution_0_Test(input);
