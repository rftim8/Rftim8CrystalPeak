...
{
    [TestClass]
    public sealed class CF_00001266A_CompetitiveProgrammer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001266A_CompetitiveProgrammer));
        ...
        {
            bool result = CF_00001266A_CompetitiveProgrammer.Solution_0_Test(input);
