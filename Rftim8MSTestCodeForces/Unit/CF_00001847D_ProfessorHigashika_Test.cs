...
{
    [TestClass]
    public sealed class CF_00001847D_ProfessorHigashika_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001847D_ProfessorHigashika));
        ...
        {
            bool result = CF_00001847D_ProfessorHigashika.Solution_0_Test(input);
