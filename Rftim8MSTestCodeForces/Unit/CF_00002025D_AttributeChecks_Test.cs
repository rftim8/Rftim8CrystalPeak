...
{
    [TestClass]
    public sealed class CF_00002025D_AttributeChecks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002025D_AttributeChecks));
        ...
        {
            bool result = CF_00002025D_AttributeChecks.Solution_0_Test(input);
