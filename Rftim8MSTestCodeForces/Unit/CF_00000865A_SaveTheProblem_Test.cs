...
{
    [TestClass]
    public sealed class CF_00000865A_SaveTheProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000865A_SaveTheProblem));
        ...
        {
            bool result = CF_00000865A_SaveTheProblem.Solution_0_Test(input);
