...
{
    [TestClass]
    public sealed class CF_00001872D_PlusMinusPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001872D_PlusMinusPermutation));
        ...
        {
            bool result = CF_00001872D_PlusMinusPermutation.Solution_0_Test(input);
