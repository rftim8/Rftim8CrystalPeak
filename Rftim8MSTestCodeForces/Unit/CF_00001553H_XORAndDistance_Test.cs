...
{
    [TestClass]
    public sealed class CF_00001553H_XORAndDistance_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001553H_XORAndDistance));
        ...
        {
            bool result = CF_00001553H_XORAndDistance.Solution_0_Test(input);
