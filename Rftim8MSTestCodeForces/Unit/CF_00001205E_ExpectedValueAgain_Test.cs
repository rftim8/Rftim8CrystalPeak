...
{
    [TestClass]
    public sealed class CF_00001205E_ExpectedValueAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001205E_ExpectedValueAgain));
        ...
        {
            bool result = CF_00001205E_ExpectedValueAgain.Solution_0_Test(input);
