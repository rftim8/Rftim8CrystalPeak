...
{
    [TestClass]
    public sealed class CF_00001348B_PhoenixAndBeauty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001348B_PhoenixAndBeauty));
        ...
        {
            bool result = CF_00001348B_PhoenixAndBeauty.Solution_0_Test(input);
