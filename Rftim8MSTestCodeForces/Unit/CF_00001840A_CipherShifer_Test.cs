...
{
    [TestClass]
    public sealed class CF_00001840A_CipherShifer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001840A_CipherShifer));
        ...
        {
            bool result = CF_00001840A_CipherShifer.Solution_0_Test(input);
