...
{
    [TestClass]
    public sealed class CF_00001594D_TheNumberOfImposters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001594D_TheNumberOfImposters));
        ...
        {
            bool result = CF_00001594D_TheNumberOfImposters.Solution_0_Test(input);
