...
{
    [TestClass]
    public sealed class CF_00000364E_EmptyRectangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000364E_EmptyRectangles));
        ...
        {
            bool result = CF_00000364E_EmptyRectangles.Solution_0_Test(input);
