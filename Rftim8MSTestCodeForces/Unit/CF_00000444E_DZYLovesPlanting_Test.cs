...
{
    [TestClass]
    public sealed class CF_00000444E_DZYLovesPlanting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000444E_DZYLovesPlanting));
        ...
        {
            bool result = CF_00000444E_DZYLovesPlanting.Solution_0_Test(input);
