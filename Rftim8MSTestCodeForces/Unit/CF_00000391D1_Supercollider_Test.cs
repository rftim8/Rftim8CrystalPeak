...
{
    [TestClass]
    public sealed class CF_00000391D1_Supercollider_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000391D1_Supercollider));
        ...
        {
            bool result = CF_00000391D1_Supercollider.Solution_0_Test(input);
