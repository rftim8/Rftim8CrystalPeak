...
{
    [TestClass]
    public sealed class CF_00001512E_PermutationBySum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001512E_PermutationBySum));
        ...
        {
            bool result = CF_00001512E_PermutationBySum.Solution_0_Test(input);
