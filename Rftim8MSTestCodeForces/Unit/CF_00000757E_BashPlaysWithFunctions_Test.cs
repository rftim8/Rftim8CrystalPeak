...
{
    [TestClass]
    public sealed class CF_00000757E_BashPlaysWithFunctions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000757E_BashPlaysWithFunctions));
        ...
        {
            bool result = CF_00000757E_BashPlaysWithFunctions.Solution_0_Test(input);
