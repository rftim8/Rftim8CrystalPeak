...
{
    [TestClass]
    public sealed class CF_00001436E_ComplicatedComputations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001436E_ComplicatedComputations));
        ...
        {
            bool result = CF_00001436E_ComplicatedComputations.Solution_0_Test(input);
