...
{
    [TestClass]
    public sealed class CF_00001238D_ABstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001238D_ABstring));
        ...
        {
            bool result = CF_00001238D_ABstring.Solution_0_Test(input);
