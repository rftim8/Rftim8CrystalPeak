...
{
    [TestClass]
    public sealed class CF_00000374E_InnaAndBabies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000374E_InnaAndBabies));
        ...
        {
            bool result = CF_00000374E_InnaAndBabies.Solution_0_Test(input);
