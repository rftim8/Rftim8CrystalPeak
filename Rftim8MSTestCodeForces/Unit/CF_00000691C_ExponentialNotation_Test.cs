...
{
    [TestClass]
    public sealed class CF_00000691C_ExponentialNotation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000691C_ExponentialNotation));
        ...
        {
            bool result = CF_00000691C_ExponentialNotation.Solution_0_Test(input);
