...
{
    [TestClass]
    public sealed class CF_00000150A_WinOrFreeze_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000150A_WinOrFreeze));
        ...
        {
            bool result = CF_00000150A_WinOrFreeze.Solution_0_Test(input);
