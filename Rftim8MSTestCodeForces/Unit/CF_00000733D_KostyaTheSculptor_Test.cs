...
{
    [TestClass]
    public sealed class CF_00000733D_KostyaTheSculptor_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000733D_KostyaTheSculptor));
        ...
        {
            bool result = CF_00000733D_KostyaTheSculptor.Solution_0_Test(input);
