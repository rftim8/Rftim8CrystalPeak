...
{
    [TestClass]
    public sealed class CF_00001167F_ScalarQueries_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001167F_ScalarQueries));
        ...
        {
            bool result = CF_00001167F_ScalarQueries.Solution_0_Test(input);
