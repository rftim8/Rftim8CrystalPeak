...
{
    [TestClass]
    public sealed class CF_00001163B2_CatPartyHardEdition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001163B2_CatPartyHardEdition));
        ...
        {
            bool result = CF_00001163B2_CatPartyHardEdition.Solution_0_Test(input);
