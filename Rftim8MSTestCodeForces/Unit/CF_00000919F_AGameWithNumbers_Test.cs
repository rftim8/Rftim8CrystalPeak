...
{
    [TestClass]
    public sealed class CF_00000919F_AGameWithNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000919F_AGameWithNumbers));
        ...
        {
            bool result = CF_00000919F_AGameWithNumbers.Solution_0_Test(input);
