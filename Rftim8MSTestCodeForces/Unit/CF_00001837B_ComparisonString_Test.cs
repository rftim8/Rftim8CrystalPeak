...
{
    [TestClass]
    public sealed class CF_00001837B_ComparisonString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001837B_ComparisonString));
        ...
        {
            bool result = CF_00001837B_ComparisonString.Solution_0_Test(input);
