...
{
    [TestClass]
    public sealed class CF_00001599H_HiddenFortress_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001599H_HiddenFortress));
        ...
        {
            bool result = CF_00001599H_HiddenFortress.Solution_0_Test(input);
