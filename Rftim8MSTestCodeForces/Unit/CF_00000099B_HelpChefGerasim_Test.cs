...
{
    [TestClass]
    public sealed class CF_00000099B_HelpChefGerasim_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000099B_HelpChefGerasim));
        ...
        {
            bool result = CF_00000099B_HelpChefGerasim.Solution_0_Test(input);
