...
{
    [TestClass]
    public sealed class CF_00001915F_Greetings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001915F_Greetings));
        ...
        {
            bool result = CF_00001915F_Greetings.Solution_0_Test(input);
