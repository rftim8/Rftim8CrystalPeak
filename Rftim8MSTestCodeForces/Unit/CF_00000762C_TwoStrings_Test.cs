...
{
    [TestClass]
    public sealed class CF_00000762C_TwoStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000762C_TwoStrings));
        ...
        {
            bool result = CF_00000762C_TwoStrings.Solution_0_Test(input);
