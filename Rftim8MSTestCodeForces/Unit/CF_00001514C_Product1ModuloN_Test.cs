...
{
    [TestClass]
    public sealed class CF_00001514C_Product1ModuloN_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001514C_Product1ModuloN));
        ...
        {
            bool result = CF_00001514C_Product1ModuloN.Solution_0_Test(input);
