...
{
    [TestClass]
    public sealed class CF_00001468J_RoadReform_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001468J_RoadReform));
        ...
        {
            bool result = CF_00001468J_RoadReform.Solution_0_Test(input);
