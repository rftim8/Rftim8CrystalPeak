...
{
    [TestClass]
    public sealed class CF_00001279F_NewYearAndHandleChange_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001279F_NewYearAndHandleChange));
        ...
        {
            bool result = CF_00001279F_NewYearAndHandleChange.Solution_0_Test(input);
