...
{
    [TestClass]
    public sealed class CF_00000202B_BrandNewEasyProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000202B_BrandNewEasyProblem));
        ...
        {
            bool result = CF_00000202B_BrandNewEasyProblem.Solution_0_Test(input);
