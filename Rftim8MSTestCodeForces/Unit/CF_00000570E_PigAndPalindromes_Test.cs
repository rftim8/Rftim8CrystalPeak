...
{
    [TestClass]
    public sealed class CF_00000570E_PigAndPalindromes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000570E_PigAndPalindromes));
        ...
        {
            bool result = CF_00000570E_PigAndPalindromes.Solution_0_Test(input);
