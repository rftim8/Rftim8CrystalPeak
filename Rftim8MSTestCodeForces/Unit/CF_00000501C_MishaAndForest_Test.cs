...
{
    [TestClass]
    public sealed class CF_00000501C_MishaAndForest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000501C_MishaAndForest));
        ...
        {
            bool result = CF_00000501C_MishaAndForest.Solution_0_Test(input);
