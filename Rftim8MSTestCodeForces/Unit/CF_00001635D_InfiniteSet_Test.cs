...
{
    [TestClass]
    public sealed class CF_00001635D_InfiniteSet_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001635D_InfiniteSet));
        ...
        {
            bool result = CF_00001635D_InfiniteSet.Solution_0_Test(input);
