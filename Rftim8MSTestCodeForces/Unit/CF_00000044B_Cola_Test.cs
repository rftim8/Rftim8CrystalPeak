...
{
    [TestClass]
    public sealed class CF_00000044B_Cola_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000044B_Cola));
        ...
        {
            bool result = CF_00000044B_Cola.Solution_0_Test(input);
