...
{
    [TestClass]
    public sealed class CF_00000069D_DotdpGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000069D_DotdpGames));
        ...
        {
            bool result = CF_00000069D_DotdpGames.Solution_0_Test(input);
