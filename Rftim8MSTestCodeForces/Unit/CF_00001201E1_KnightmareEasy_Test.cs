...
{
    [TestClass]
    public sealed class CF_00001201E1_KnightmareEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001201E1_KnightmareEasy));
        ...
        {
            bool result = CF_00001201E1_KnightmareEasy.Solution_0_Test(input);
