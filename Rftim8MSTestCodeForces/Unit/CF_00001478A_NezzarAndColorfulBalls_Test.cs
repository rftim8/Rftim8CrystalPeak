...
{
    [TestClass]
    public sealed class CF_00001478A_NezzarAndColorfulBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001478A_NezzarAndColorfulBalls));
        ...
        {
            bool result = CF_00001478A_NezzarAndColorfulBalls.Solution_0_Test(input);
