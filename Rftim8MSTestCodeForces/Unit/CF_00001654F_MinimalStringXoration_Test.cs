...
{
    [TestClass]
    public sealed class CF_00001654F_MinimalStringXoration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001654F_MinimalStringXoration));
        ...
        {
            bool result = CF_00001654F_MinimalStringXoration.Solution_0_Test(input);
