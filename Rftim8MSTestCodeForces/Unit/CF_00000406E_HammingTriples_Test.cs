...
{
    [TestClass]
    public sealed class CF_00000406E_HammingTriples_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000406E_HammingTriples));
        ...
        {
            bool result = CF_00000406E_HammingTriples.Solution_0_Test(input);
