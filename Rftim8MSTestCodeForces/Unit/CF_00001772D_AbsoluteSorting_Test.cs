...
{
    [TestClass]
    public sealed class CF_00001772D_AbsoluteSorting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001772D_AbsoluteSorting));
        ...
        {
            bool result = CF_00001772D_AbsoluteSorting.Solution_0_Test(input);
