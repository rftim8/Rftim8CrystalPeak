...
{
    [TestClass]
    public sealed class CF_00000581E_KojiroAndFurrari_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000581E_KojiroAndFurrari));
        ...
        {
            bool result = CF_00000581E_KojiroAndFurrari.Solution_0_Test(input);
