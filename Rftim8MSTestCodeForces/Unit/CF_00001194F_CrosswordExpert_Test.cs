...
{
    [TestClass]
    public sealed class CF_00001194F_CrosswordExpert_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001194F_CrosswordExpert));
        ...
        {
            bool result = CF_00001194F_CrosswordExpert.Solution_0_Test(input);
