...
{
    [TestClass]
    public sealed class CF_00000774E_BigNumberAndRemainder_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000774E_BigNumberAndRemainder));
        ...
        {
            bool result = CF_00000774E_BigNumberAndRemainder.Solution_0_Test(input);
