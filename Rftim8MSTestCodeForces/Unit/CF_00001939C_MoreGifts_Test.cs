...
{
    [TestClass]
    public sealed class CF_00001939C_MoreGifts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001939C_MoreGifts));
        ...
        {
            bool result = CF_00001939C_MoreGifts.Solution_0_Test(input);
