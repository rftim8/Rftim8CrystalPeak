...
{
    [TestClass]
    public sealed class CF_00001807E_Interview_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001807E_Interview));
        ...
        {
            bool result = CF_00001807E_Interview.Solution_0_Test(input);
