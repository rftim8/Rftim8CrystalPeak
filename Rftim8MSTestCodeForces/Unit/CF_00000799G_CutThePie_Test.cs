...
{
    [TestClass]
    public sealed class CF_00000799G_CutThePie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000799G_CutThePie));
        ...
        {
            bool result = CF_00000799G_CutThePie.Solution_0_Test(input);
