...
{
    [TestClass]
    public sealed class CF_00001856B_GoodArrays_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001856B_GoodArrays));
        ...
        {
            bool result = CF_00001856B_GoodArrays.Solution_0_Test(input);
