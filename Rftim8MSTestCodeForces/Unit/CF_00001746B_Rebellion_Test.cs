...
{
    [TestClass]
    public sealed class CF_00001746B_Rebellion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001746B_Rebellion));
        ...
        {
            bool result = CF_00001746B_Rebellion.Solution_0_Test(input);
