...
{
    [TestClass]
    public sealed class CF_00000377C_CaptainsMode_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000377C_CaptainsMode));
        ...
        {
            bool result = CF_00000377C_CaptainsMode.Solution_0_Test(input);
