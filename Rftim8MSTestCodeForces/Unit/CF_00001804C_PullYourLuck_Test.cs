...
{
    [TestClass]
    public sealed class CF_00001804C_PullYourLuck_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001804C_PullYourLuck));
        ...
        {
            bool result = CF_00001804C_PullYourLuck.Solution_0_Test(input);
