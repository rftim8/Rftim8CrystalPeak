...
{
    [TestClass]
    public sealed class CF_00001184E2_DaleksInvasionMedium_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001184E2_DaleksInvasionMedium));
        ...
        {
            bool result = CF_00001184E2_DaleksInvasionMedium.Solution_0_Test(input);
