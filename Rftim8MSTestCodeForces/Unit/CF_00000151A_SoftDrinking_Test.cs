...
{
    [TestClass]
    public sealed class CF_00000151A_SoftDrinking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000151A_SoftDrinking));
        ...
        {
            bool result = CF_00000151A_SoftDrinking.Solution_0_Test(input);
