...
{
    [TestClass]
    public sealed class CF_00000301A_YaroslavAndSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000301A_YaroslavAndSequence));
        ...
        {
            bool result = CF_00000301A_YaroslavAndSequence.Solution_0_Test(input);
