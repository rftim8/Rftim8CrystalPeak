...
{
    [TestClass]
    public sealed class CF_00000535D_TavasAndMalekas_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000535D_TavasAndMalekas));
        ...
        {
            bool result = CF_00000535D_TavasAndMalekas.Solution_0_Test(input);
