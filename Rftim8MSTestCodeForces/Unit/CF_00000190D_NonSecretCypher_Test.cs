...
{
    [TestClass]
    public sealed class CF_00000190D_NonSecretCypher_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000190D_NonSecretCypher));
        ...
        {
            bool result = CF_00000190D_NonSecretCypher.Solution_0_Test(input);
