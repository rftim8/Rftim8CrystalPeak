...
{
    [TestClass]
    public sealed class CF_00000038H_TheGreatMarathon_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000038H_TheGreatMarathon));
        ...
        {
            bool result = CF_00000038H_TheGreatMarathon.Solution_0_Test(input);
