...
{
    [TestClass]
    public sealed class CF_00000600E_LomsatGelral_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000600E_LomsatGelral));
        ...
        {
            bool result = CF_00000600E_LomsatGelral.Solution_0_Test(input);
