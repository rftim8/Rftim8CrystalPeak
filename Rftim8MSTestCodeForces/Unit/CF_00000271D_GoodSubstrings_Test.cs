...
{
    [TestClass]
    public sealed class CF_00000271D_GoodSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000271D_GoodSubstrings));
        ...
        {
            bool result = CF_00000271D_GoodSubstrings.Solution_0_Test(input);
