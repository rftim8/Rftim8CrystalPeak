...
{
    [TestClass]
    public sealed class CF_00001352A_SumOfRoundNumbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001352A_SumOfRoundNumbers));
        ...
        {
            bool result = CF_00001352A_SumOfRoundNumbers.Solution_0_Test(input);
