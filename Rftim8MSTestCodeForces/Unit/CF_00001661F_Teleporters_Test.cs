...
{
    [TestClass]
    public sealed class CF_00001661F_Teleporters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001661F_Teleporters));
        ...
        {
            bool result = CF_00001661F_Teleporters.Solution_0_Test(input);
