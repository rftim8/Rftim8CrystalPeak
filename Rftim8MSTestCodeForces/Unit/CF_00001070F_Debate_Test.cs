...
{
    [TestClass]
    public sealed class CF_00001070F_Debate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001070F_Debate));
        ...
        {
            bool result = CF_00001070F_Debate.Solution_0_Test(input);
