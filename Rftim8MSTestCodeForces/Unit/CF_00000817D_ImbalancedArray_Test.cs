...
{
    [TestClass]
    public sealed class CF_00000817D_ImbalancedArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000817D_ImbalancedArray));
        ...
        {
            bool result = CF_00000817D_ImbalancedArray.Solution_0_Test(input);
