...
{
    [TestClass]
    public sealed class CF_00001095B_ArrayStabilization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001095B_ArrayStabilization));
        ...
        {
            bool result = CF_00001095B_ArrayStabilization.Solution_0_Test(input);
