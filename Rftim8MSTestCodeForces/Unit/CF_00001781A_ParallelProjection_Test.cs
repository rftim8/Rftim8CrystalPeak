...
{
    [TestClass]
    public sealed class CF_00001781A_ParallelProjection_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001781A_ParallelProjection));
        ...
        {
            bool result = CF_00001781A_ParallelProjection.Solution_0_Test(input);
