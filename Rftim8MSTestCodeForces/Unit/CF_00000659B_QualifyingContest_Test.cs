...
{
    [TestClass]
    public sealed class CF_00000659B_QualifyingContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000659B_QualifyingContest));
        ...
        {
            bool result = CF_00000659B_QualifyingContest.Solution_0_Test(input);
