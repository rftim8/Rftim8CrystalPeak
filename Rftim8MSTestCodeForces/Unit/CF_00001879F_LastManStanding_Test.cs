...
{
    [TestClass]
    public sealed class CF_00001879F_LastManStanding_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001879F_LastManStanding));
        ...
        {
            bool result = CF_00001879F_LastManStanding.Solution_0_Test(input);
