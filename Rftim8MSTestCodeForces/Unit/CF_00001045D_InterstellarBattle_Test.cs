...
{
    [TestClass]
    public sealed class CF_00001045D_InterstellarBattle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001045D_InterstellarBattle));
        ...
        {
            bool result = CF_00001045D_InterstellarBattle.Solution_0_Test(input);
