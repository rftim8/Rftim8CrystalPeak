...
{
    [TestClass]
    public sealed class CF_00000603C_LiegesOfLegendre_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000603C_LiegesOfLegendre));
        ...
        {
            bool result = CF_00000603C_LiegesOfLegendre.Solution_0_Test(input);
