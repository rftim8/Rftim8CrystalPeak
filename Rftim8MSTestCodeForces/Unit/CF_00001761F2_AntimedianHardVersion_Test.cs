...
{
    [TestClass]
    public sealed class CF_00001761F2_AntimedianHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001761F2_AntimedianHardVersion));
        ...
        {
            bool result = CF_00001761F2_AntimedianHardVersion.Solution_0_Test(input);
