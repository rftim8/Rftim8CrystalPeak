...
{
    [TestClass]
    public sealed class CF_00001185D_ExtraElement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001185D_ExtraElement));
        ...
        {
            bool result = CF_00001185D_ExtraElement.Solution_0_Test(input);
