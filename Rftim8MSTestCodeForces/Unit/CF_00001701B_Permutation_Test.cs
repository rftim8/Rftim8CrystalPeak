...
{
    [TestClass]
    public sealed class CF_00001701B_Permutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001701B_Permutation));
        ...
        {
            bool result = CF_00001701B_Permutation.Solution_0_Test(input);
