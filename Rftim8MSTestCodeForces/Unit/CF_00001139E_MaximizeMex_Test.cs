...
{
    [TestClass]
    public sealed class CF_00001139E_MaximizeMex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001139E_MaximizeMex));
        ...
        {
            bool result = CF_00001139E_MaximizeMex.Solution_0_Test(input);
