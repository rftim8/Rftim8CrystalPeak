...
{
    [TestClass]
    public sealed class CF_00001165B_PolycarpTraining_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001165B_PolycarpTraining));
        ...
        {
            bool result = CF_00001165B_PolycarpTraining.Solution_0_Test(input);
