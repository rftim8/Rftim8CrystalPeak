...
{
    [TestClass]
    public sealed class CF_00000659G_FenceDivercity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000659G_FenceDivercity));
        ...
        {
            bool result = CF_00000659G_FenceDivercity.Solution_0_Test(input);
