...
{
    [TestClass]
    public sealed class CF_00001937B_BinaryPath_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001937B_BinaryPath));
        ...
        {
            bool result = CF_00001937B_BinaryPath.Solution_0_Test(input);
