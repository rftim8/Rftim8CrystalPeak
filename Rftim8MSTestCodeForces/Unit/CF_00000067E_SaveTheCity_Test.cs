...
{
    [TestClass]
    public sealed class CF_00000067E_SaveTheCity_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000067E_SaveTheCity));
        ...
        {
            bool result = CF_00000067E_SaveTheCity.Solution_0_Test(input);
