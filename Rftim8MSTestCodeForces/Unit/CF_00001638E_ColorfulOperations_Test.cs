...
{
    [TestClass]
    public sealed class CF_00001638E_ColorfulOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001638E_ColorfulOperations));
        ...
        {
            bool result = CF_00001638E_ColorfulOperations.Solution_0_Test(input);
