...
{
    [TestClass]
    public sealed class CF_00001398B_SubstringRemovalGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001398B_SubstringRemovalGame));
        ...
        {
            bool result = CF_00001398B_SubstringRemovalGame.Solution_0_Test(input);
