...
{
    [TestClass]
    public sealed class CF_00001433A_BoringApartments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001433A_BoringApartments));
        ...
        {
            bool result = CF_00001433A_BoringApartments.Solution_0_Test(input);
