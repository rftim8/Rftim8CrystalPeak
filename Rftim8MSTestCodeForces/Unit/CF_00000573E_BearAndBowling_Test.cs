...
{
    [TestClass]
    public sealed class CF_00000573E_BearAndBowling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000573E_BearAndBowling));
        ...
        {
            bool result = CF_00000573E_BearAndBowling.Solution_0_Test(input);
