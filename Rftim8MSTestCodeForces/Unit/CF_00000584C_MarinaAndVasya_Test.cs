...
{
    [TestClass]
    public sealed class CF_00000584C_MarinaAndVasya_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000584C_MarinaAndVasya));
        ...
        {
            bool result = CF_00000584C_MarinaAndVasya.Solution_0_Test(input);
