...
{
    [TestClass]
    public sealed class CF_00001479B1_PaintingTheArrayI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001479B1_PaintingTheArrayI));
        ...
        {
            bool result = CF_00001479B1_PaintingTheArrayI.Solution_0_Test(input);
