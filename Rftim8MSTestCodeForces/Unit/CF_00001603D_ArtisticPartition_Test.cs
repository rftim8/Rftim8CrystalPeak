...
{
    [TestClass]
    public sealed class CF_00001603D_ArtisticPartition_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001603D_ArtisticPartition));
        ...
        {
            bool result = CF_00001603D_ArtisticPartition.Solution_0_Test(input);
