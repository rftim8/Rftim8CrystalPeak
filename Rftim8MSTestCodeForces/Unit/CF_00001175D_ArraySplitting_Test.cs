...
{
    [TestClass]
    public sealed class CF_00001175D_ArraySplitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001175D_ArraySplitting));
        ...
        {
            bool result = CF_00001175D_ArraySplitting.Solution_0_Test(input);
