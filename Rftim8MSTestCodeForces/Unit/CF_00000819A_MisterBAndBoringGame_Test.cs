...
{
    [TestClass]
    public sealed class CF_00000819A_MisterBAndBoringGame_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000819A_MisterBAndBoringGame));
        ...
        {
            bool result = CF_00000819A_MisterBAndBoringGame.Solution_0_Test(input);
