...
{
    [TestClass]
    public sealed class CF_00001675D_VerticalPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001675D_VerticalPaths));
        ...
        {
            bool result = CF_00001675D_VerticalPaths.Solution_0_Test(input);
