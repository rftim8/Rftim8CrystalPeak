...
{
    [TestClass]
    public sealed class CF_00001776E_CrossingTheRailways_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001776E_CrossingTheRailways));
        ...
        {
            bool result = CF_00001776E_CrossingTheRailways.Solution_0_Test(input);
