...
{
    [TestClass]
    public sealed class CF_00001266C_DiverseMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001266C_DiverseMatrix));
        ...
        {
            bool result = CF_00001266C_DiverseMatrix.Solution_0_Test(input);
