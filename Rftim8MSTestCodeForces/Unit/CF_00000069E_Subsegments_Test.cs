...
{
    [TestClass]
    public sealed class CF_00000069E_Subsegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000069E_Subsegments));
        ...
        {
            bool result = CF_00000069E_Subsegments.Solution_0_Test(input);
