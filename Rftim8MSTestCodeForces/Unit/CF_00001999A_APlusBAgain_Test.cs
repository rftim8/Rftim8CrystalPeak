...
{
    [TestClass]
    public sealed class CF_00001999A_APlusBAgain_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001999A_APlusBAgain));
        ...
        {
            bool result = CF_00001999A_APlusBAgain.Solution_0_Test(input);
