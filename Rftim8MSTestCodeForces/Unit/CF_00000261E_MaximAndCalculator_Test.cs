...
{
    [TestClass]
    public sealed class CF_00000261E_MaximAndCalculator_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000261E_MaximAndCalculator));
        ...
        {
            bool result = CF_00000261E_MaximAndCalculator.Solution_0_Test(input);
