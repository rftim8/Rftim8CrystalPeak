...
{
    [TestClass]
    public sealed class CF_00000914D_BashAndAToughMathPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000914D_BashAndAToughMathPuzzle));
        ...
        {
            bool result = CF_00000914D_BashAndAToughMathPuzzle.Solution_0_Test(input);
