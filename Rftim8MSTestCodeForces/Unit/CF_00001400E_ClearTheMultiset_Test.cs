...
{
    [TestClass]
    public sealed class CF_00001400E_ClearTheMultiset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001400E_ClearTheMultiset));
        ...
        {
            bool result = CF_00001400E_ClearTheMultiset.Solution_0_Test(input);
