...
{
    [TestClass]
    public sealed class CF_00001983A_ArrayDivisibility_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001983A_ArrayDivisibility));
        ...
        {
            bool result = CF_00001983A_ArrayDivisibility.Solution_0_Test(input);
