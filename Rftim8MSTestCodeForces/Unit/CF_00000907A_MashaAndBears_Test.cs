...
{
    [TestClass]
    public sealed class CF_00000907A_MashaAndBears_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000907A_MashaAndBears));
        ...
        {
            bool result = CF_00000907A_MashaAndBears.Solution_0_Test(input);
