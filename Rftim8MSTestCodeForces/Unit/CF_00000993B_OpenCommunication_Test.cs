...
{
    [TestClass]
    public sealed class CF_00000993B_OpenCommunication_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000993B_OpenCommunication));
        ...
        {
            bool result = CF_00000993B_OpenCommunication.Solution_0_Test(input);
