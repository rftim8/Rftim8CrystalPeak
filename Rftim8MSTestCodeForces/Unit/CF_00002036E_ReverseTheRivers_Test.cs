...
{
    [TestClass]
    public sealed class CF_00002036E_ReverseTheRivers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002036E_ReverseTheRivers));
        ...
        {
            bool result = CF_00002036E_ReverseTheRivers.Solution_0_Test(input);
