...
{
    [TestClass]
    public sealed class CF_00001445B_Elimination_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001445B_Elimination));
        ...
        {
            bool result = CF_00001445B_Elimination.Solution_0_Test(input);
