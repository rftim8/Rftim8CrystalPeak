...
{
    [TestClass]
    public sealed class CF_00000493C_VasyaAndBasketball_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000493C_VasyaAndBasketball));
        ...
        {
            bool result = CF_00000493C_VasyaAndBasketball.Solution_0_Test(input);
