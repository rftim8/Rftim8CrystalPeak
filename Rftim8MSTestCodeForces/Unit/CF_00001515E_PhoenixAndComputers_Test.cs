...
{
    [TestClass]
    public sealed class CF_00001515E_PhoenixAndComputers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001515E_PhoenixAndComputers));
        ...
        {
            bool result = CF_00001515E_PhoenixAndComputers.Solution_0_Test(input);
