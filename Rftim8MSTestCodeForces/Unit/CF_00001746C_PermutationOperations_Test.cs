...
{
    [TestClass]
    public sealed class CF_00001746C_PermutationOperations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001746C_PermutationOperations));
        ...
        {
            bool result = CF_00001746C_PermutationOperations.Solution_0_Test(input);
