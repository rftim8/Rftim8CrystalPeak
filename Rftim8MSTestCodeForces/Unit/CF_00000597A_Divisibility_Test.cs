...
{
    [TestClass]
    public sealed class CF_00000597A_Divisibility_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000597A_Divisibility));
        ...
        {
            bool result = CF_00000597A_Divisibility.Solution_0_Test(input);
