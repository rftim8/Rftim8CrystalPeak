...
{
    [TestClass]
    public sealed class CF_00001276B_TwoFairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001276B_TwoFairs));
        ...
        {
            bool result = CF_00001276B_TwoFairs.Solution_0_Test(input);
