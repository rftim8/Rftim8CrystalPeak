...
{
    [TestClass]
    public sealed class CF_00000264C_ChoosingBalls_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000264C_ChoosingBalls));
        ...
        {
            bool result = CF_00000264C_ChoosingBalls.Solution_0_Test(input);
