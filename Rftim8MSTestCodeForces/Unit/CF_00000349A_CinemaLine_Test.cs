...
{
    [TestClass]
    public sealed class CF_00000349A_CinemaLine_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000349A_CinemaLine));
        ...
        {
            bool result = CF_00000349A_CinemaLine.Solution_0_Test(input);
