...
{
    [TestClass]
    public sealed class CF_00001725H_HotBlackHotWhite_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001725H_HotBlackHotWhite));
        ...
        {
            bool result = CF_00001725H_HotBlackHotWhite.Solution_0_Test(input);
