...
{
    [TestClass]
    public sealed class CF_00001662H_Boundary_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001662H_Boundary));
        ...
        {
            bool result = CF_00001662H_Boundary.Solution_0_Test(input);
