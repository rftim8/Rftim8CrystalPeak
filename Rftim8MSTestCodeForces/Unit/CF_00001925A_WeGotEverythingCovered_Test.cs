...
{
    [TestClass]
    public sealed class CF_00001925A_WeGotEverythingCovered_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001925A_WeGotEverythingCovered));
        ...
        {
            bool result = CF_00001925A_WeGotEverythingCovered.Solution_0_Test(input);
