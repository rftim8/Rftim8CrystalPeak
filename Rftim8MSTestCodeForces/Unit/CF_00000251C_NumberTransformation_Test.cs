...
{
    [TestClass]
    public sealed class CF_00000251C_NumberTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000251C_NumberTransformation));
        ...
        {
            bool result = CF_00000251C_NumberTransformation.Solution_0_Test(input);
