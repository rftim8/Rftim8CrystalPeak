...
{
    [TestClass]
    public sealed class CF_00002040C_OrderedPermutations_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002040C_OrderedPermutations));
        ...
        {
            bool result = CF_00002040C_OrderedPermutations.Solution_0_Test(input);
