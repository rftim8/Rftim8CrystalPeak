...
{
    [TestClass]
    public sealed class CF_00001788D_MovingDots_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001788D_MovingDots));
        ...
        {
            bool result = CF_00001788D_MovingDots.Solution_0_Test(input);
