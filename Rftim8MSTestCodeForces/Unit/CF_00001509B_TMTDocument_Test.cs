...
{
    [TestClass]
    public sealed class CF_00001509B_TMTDocument_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001509B_TMTDocument));
        ...
        {
            bool result = CF_00001509B_TMTDocument.Solution_0_Test(input);
