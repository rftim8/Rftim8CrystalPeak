...
{
    [TestClass]
    public sealed class CF_00001103C_JohnnySolving_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001103C_JohnnySolving));
        ...
        {
            bool result = CF_00001103C_JohnnySolving.Solution_0_Test(input);
