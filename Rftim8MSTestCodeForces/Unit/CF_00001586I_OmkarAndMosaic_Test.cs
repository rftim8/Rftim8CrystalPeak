...
{
    [TestClass]
    public sealed class CF_00001586I_OmkarAndMosaic_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001586I_OmkarAndMosaic));
        ...
        {
            bool result = CF_00001586I_OmkarAndMosaic.Solution_0_Test(input);
