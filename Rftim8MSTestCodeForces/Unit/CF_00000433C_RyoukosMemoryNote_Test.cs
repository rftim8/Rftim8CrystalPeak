...
{
    [TestClass]
    public sealed class CF_00000433C_RyoukosMemoryNote_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000433C_RyoukosMemoryNote));
        ...
        {
            bool result = CF_00000433C_RyoukosMemoryNote.Solution_0_Test(input);
