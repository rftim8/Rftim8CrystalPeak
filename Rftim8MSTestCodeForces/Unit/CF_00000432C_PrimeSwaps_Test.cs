...
{
    [TestClass]
    public sealed class CF_00000432C_PrimeSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000432C_PrimeSwaps));
        ...
        {
            bool result = CF_00000432C_PrimeSwaps.Solution_0_Test(input);
