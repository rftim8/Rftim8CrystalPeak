...
{
    [TestClass]
    public sealed class CF_00001528B_KaviOnPairingDuty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001528B_KaviOnPairingDuty));
        ...
        {
            bool result = CF_00001528B_KaviOnPairingDuty.Solution_0_Test(input);
