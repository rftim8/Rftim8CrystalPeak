...
{
    [TestClass]
    public sealed class CF_00000216C_HiringStaff_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000216C_HiringStaff));
        ...
        {
            bool result = CF_00000216C_HiringStaff.Solution_0_Test(input);
