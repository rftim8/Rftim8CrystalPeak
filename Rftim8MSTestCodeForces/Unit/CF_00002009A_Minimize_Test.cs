...
{
    [TestClass]
    public sealed class CF_00002009A_Minimize_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002009A_Minimize));
        ...
        {
            bool result = CF_00002009A_Minimize.Solution_0_Test(input);
