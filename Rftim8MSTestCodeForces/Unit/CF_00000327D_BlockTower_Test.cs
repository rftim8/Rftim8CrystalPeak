...
{
    [TestClass]
    public sealed class CF_00000327D_BlockTower_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000327D_BlockTower));
        ...
        {
            bool result = CF_00000327D_BlockTower.Solution_0_Test(input);
