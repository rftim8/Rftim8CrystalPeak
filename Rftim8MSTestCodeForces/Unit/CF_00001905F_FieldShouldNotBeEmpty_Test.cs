...
{
    [TestClass]
    public sealed class CF_00001905F_FieldShouldNotBeEmpty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001905F_FieldShouldNotBeEmpty));
        ...
        {
            bool result = CF_00001905F_FieldShouldNotBeEmpty.Solution_0_Test(input);
