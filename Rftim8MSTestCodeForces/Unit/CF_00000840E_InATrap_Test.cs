...
{
    [TestClass]
    public sealed class CF_00000840E_InATrap_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000840E_InATrap));
        ...
        {
            bool result = CF_00000840E_InATrap.Solution_0_Test(input);
