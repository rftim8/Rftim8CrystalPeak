...
{
    [TestClass]
    public sealed class CF_00000734E_AntonAndTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000734E_AntonAndTree));
        ...
        {
            bool result = CF_00000734E_AntonAndTree.Solution_0_Test(input);
