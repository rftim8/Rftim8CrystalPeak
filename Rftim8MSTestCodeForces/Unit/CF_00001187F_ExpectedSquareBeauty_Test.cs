...
{
    [TestClass]
    public sealed class CF_00001187F_ExpectedSquareBeauty_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001187F_ExpectedSquareBeauty));
        ...
        {
            bool result = CF_00001187F_ExpectedSquareBeauty.Solution_0_Test(input);
