...
{
    [TestClass]
    public sealed class CF_00000175B_PlaneOfTanksPro_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000175B_PlaneOfTanksPro));
        ...
        {
            bool result = CF_00000175B_PlaneOfTanksPro.Solution_0_Test(input);
