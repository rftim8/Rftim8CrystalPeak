...
{
    [TestClass]
    public sealed class CF_00001367F2_FlyingSortHardVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001367F2_FlyingSortHardVersion));
        ...
        {
            bool result = CF_00001367F2_FlyingSortHardVersion.Solution_0_Test(input);
