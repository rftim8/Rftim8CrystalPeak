...
{
    [TestClass]
    public sealed class CF_00000727E_GamesOnACD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000727E_GamesOnACD));
        ...
        {
            bool result = CF_00000727E_GamesOnACD.Solution_0_Test(input);
