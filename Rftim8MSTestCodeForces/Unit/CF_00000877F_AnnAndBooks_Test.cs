...
{
    [TestClass]
    public sealed class CF_00000877F_AnnAndBooks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000877F_AnnAndBooks));
        ...
        {
            bool result = CF_00000877F_AnnAndBooks.Solution_0_Test(input);
