...
{
    [TestClass]
    public sealed class CF_00000938F_ErasingSubstrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000938F_ErasingSubstrings));
        ...
        {
            bool result = CF_00000938F_ErasingSubstrings.Solution_0_Test(input);
