...
{
    [TestClass]
    public sealed class CF_00001558D_TopNotchInsertions_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001558D_TopNotchInsertions));
        ...
        {
            bool result = CF_00001558D_TopNotchInsertions.Solution_0_Test(input);
