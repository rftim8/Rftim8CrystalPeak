...
{
    [TestClass]
    public sealed class CF_00001092F_TreeWithMaximumCost_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001092F_TreeWithMaximumCost));
        ...
        {
            bool result = CF_00001092F_TreeWithMaximumCost.Solution_0_Test(input);
