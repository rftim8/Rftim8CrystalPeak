...
{
    [TestClass]
    public sealed class CF_00000076A_Gift_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000076A_Gift));
        ...
        {
            bool result = CF_00000076A_Gift.Solution_0_Test(input);
