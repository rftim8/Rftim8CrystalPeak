...
{
    [TestClass]
    public sealed class CF_00001608B_BuildThePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001608B_BuildThePermutation));
        ...
        {
            bool result = CF_00001608B_BuildThePermutation.Solution_0_Test(input);
