...
{
    [TestClass]
    public sealed class CF_00001276C_BeautifulRectangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001276C_BeautifulRectangle));
        ...
        {
            bool result = CF_00001276C_BeautifulRectangle.Solution_0_Test(input);
