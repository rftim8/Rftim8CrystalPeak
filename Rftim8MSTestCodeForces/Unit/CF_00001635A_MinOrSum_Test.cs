...
{
    [TestClass]
    public sealed class CF_00001635A_MinOrSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001635A_MinOrSum));
        ...
        {
            bool result = CF_00001635A_MinOrSum.Solution_0_Test(input);
