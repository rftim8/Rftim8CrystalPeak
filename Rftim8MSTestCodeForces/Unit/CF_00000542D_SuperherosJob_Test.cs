...
{
    [TestClass]
    public sealed class CF_00000542D_SuperherosJob_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000542D_SuperherosJob));
        ...
        {
            bool result = CF_00000542D_SuperherosJob.Solution_0_Test(input);
