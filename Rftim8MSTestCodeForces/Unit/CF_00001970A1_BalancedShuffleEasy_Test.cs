...
{
    [TestClass]
    public sealed class CF_00001970A1_BalancedShuffleEasy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001970A1_BalancedShuffleEasy));
        ...
        {
            bool result = CF_00001970A1_BalancedShuffleEasy.Solution_0_Test(input);
