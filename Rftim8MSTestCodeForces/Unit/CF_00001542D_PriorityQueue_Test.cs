...
{
    [TestClass]
    public sealed class CF_00001542D_PriorityQueue_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001542D_PriorityQueue));
        ...
        {
            bool result = CF_00001542D_PriorityQueue.Solution_0_Test(input);
