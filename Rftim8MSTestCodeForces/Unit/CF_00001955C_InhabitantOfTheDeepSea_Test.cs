...
{
    [TestClass]
    public sealed class CF_00001955C_InhabitantOfTheDeepSea_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001955C_InhabitantOfTheDeepSea));
        ...
        {
            bool result = CF_00001955C_InhabitantOfTheDeepSea.Solution_0_Test(input);
