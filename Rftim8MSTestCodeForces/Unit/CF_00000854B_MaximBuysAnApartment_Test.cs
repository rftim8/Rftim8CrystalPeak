...
{
    [TestClass]
    public sealed class CF_00000854B_MaximBuysAnApartment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000854B_MaximBuysAnApartment));
        ...
        {
            bool result = CF_00000854B_MaximBuysAnApartment.Solution_0_Test(input);
