...
{
    [TestClass]
    public sealed class CF_00001398A_BadTriangle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001398A_BadTriangle));
        ...
        {
            bool result = CF_00001398A_BadTriangle.Solution_0_Test(input);
