...
{
    [TestClass]
    public sealed class CF_00001031E_TripleFlips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001031E_TripleFlips));
        ...
        {
            bool result = CF_00001031E_TripleFlips.Solution_0_Test(input);
