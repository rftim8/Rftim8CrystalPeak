...
{
    [TestClass]
    public sealed class CF_00000331B2_ShaveBeaver_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000331B2_ShaveBeaver));
        ...
        {
            bool result = CF_00000331B2_ShaveBeaver.Solution_0_Test(input);
