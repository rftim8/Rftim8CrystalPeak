...
{
    [TestClass]
    public sealed class CF_00000260B_AncientProphesy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000260B_AncientProphesy));
        ...
        {
            bool result = CF_00000260B_AncientProphesy.Solution_0_Test(input);
