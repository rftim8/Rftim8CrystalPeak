...
{
    [TestClass]
    public sealed class CF_00000293C_CubeProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000293C_CubeProblem));
        ...
        {
            bool result = CF_00000293C_CubeProblem.Solution_0_Test(input);
