...
{
    [TestClass]
    public sealed class CF_00000496B_SecretCombination_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000496B_SecretCombination));
        ...
        {
            bool result = CF_00000496B_SecretCombination.Solution_0_Test(input);
