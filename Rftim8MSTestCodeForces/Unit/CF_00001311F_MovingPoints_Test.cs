...
{
    [TestClass]
    public sealed class CF_00001311F_MovingPoints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001311F_MovingPoints));
        ...
        {
            bool result = CF_00001311F_MovingPoints.Solution_0_Test(input);
