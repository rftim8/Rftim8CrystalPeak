...
{
    [TestClass]
    public sealed class CF_00001672D_CyclicRotation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001672D_CyclicRotation));
        ...
        {
            bool result = CF_00001672D_CyclicRotation.Solution_0_Test(input);
