...
{
    [TestClass]
    public sealed class CF_00000159D_PalindromePairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000159D_PalindromePairs));
        ...
        {
            bool result = CF_00000159D_PalindromePairs.Solution_0_Test(input);
