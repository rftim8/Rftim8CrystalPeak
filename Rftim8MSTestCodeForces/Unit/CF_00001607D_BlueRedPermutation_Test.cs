...
{
    [TestClass]
    public sealed class CF_00001607D_BlueRedPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001607D_BlueRedPermutation));
        ...
        {
            bool result = CF_00001607D_BlueRedPermutation.Solution_0_Test(input);
