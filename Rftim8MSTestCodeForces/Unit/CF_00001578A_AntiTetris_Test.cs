...
{
    [TestClass]
    public sealed class CF_00001578A_AntiTetris_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001578A_AntiTetris));
        ...
        {
            bool result = CF_00001578A_AntiTetris.Solution_0_Test(input);
