...
{
    [TestClass]
    public sealed class CF_00001798D_ShockingArrangement_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001798D_ShockingArrangement));
        ...
        {
            bool result = CF_00001798D_ShockingArrangement.Solution_0_Test(input);
