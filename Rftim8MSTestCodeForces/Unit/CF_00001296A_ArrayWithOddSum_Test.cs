...
{
    [TestClass]
    public sealed class CF_00001296A_ArrayWithOddSum_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001296A_ArrayWithOddSum));
        ...
        {
            bool result = CF_00001296A_ArrayWithOddSum.Solution_0_Test(input);
