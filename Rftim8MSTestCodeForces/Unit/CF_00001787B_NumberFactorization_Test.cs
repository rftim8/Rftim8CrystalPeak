...
{
    [TestClass]
    public sealed class CF_00001787B_NumberFactorization_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001787B_NumberFactorization));
        ...
        {
            bool result = CF_00001787B_NumberFactorization.Solution_0_Test(input);
