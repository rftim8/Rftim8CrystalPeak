...
{
    [TestClass]
    public sealed class CF_00000260C_BallsAndBoxes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000260C_BallsAndBoxes));
        ...
        {
            bool result = CF_00000260C_BallsAndBoxes.Solution_0_Test(input);
