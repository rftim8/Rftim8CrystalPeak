...
{
    [TestClass]
    public sealed class CF_00000463B_CaisaAndPylons_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000463B_CaisaAndPylons));
        ...
        {
            bool result = CF_00000463B_CaisaAndPylons.Solution_0_Test(input);
