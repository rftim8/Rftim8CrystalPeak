...
{
    [TestClass]
    public sealed class CF_00001179A_ValeriyAndDeque_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001179A_ValeriyAndDeque));
        ...
        {
            bool result = CF_00001179A_ValeriyAndDeque.Solution_0_Test(input);
