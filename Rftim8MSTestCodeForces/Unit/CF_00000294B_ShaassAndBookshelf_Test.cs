...
{
    [TestClass]
    public sealed class CF_00000294B_ShaassAndBookshelf_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000294B_ShaassAndBookshelf));
        ...
        {
            bool result = CF_00000294B_ShaassAndBookshelf.Solution_0_Test(input);
