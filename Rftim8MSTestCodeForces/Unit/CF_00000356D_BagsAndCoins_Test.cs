...
{
    [TestClass]
    public sealed class CF_00000356D_BagsAndCoins_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000356D_BagsAndCoins));
        ...
        {
            bool result = CF_00000356D_BagsAndCoins.Solution_0_Test(input);
