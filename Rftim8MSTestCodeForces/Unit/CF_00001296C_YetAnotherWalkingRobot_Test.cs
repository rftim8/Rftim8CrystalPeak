...
{
    [TestClass]
    public sealed class CF_00001296C_YetAnotherWalkingRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001296C_YetAnotherWalkingRobot));
        ...
        {
            bool result = CF_00001296C_YetAnotherWalkingRobot.Solution_0_Test(input);
