...
{
    [TestClass]
    public sealed class CF_00001845C_StrongPassword_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001845C_StrongPassword));
        ...
        {
            bool result = CF_00001845C_StrongPassword.Solution_0_Test(input);
