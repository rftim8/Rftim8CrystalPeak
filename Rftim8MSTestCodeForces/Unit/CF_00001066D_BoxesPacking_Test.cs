...
{
    [TestClass]
    public sealed class CF_00001066D_BoxesPacking_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001066D_BoxesPacking));
        ...
        {
            bool result = CF_00001066D_BoxesPacking.Solution_0_Test(input);
