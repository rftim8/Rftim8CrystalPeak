...
{
    [TestClass]
    public sealed class CF_00000240E_RoadRepairs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000240E_RoadRepairs));
        ...
        {
            bool result = CF_00000240E_RoadRepairs.Solution_0_Test(input);
