...
{
    [TestClass]
    public sealed class CF_00000629E_FamilDoorAndRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000629E_FamilDoorAndRoads));
        ...
        {
            bool result = CF_00000629E_FamilDoorAndRoads.Solution_0_Test(input);
