...
{
    [TestClass]
    public sealed class CF_00001835E_OldMobile_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001835E_OldMobile));
        ...
        {
            bool result = CF_00001835E_OldMobile.Solution_0_Test(input);
