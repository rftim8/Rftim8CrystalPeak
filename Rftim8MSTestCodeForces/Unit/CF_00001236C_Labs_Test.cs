...
{
    [TestClass]
    public sealed class CF_00001236C_Labs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001236C_Labs));
        ...
        {
            bool result = CF_00001236C_Labs.Solution_0_Test(input);
