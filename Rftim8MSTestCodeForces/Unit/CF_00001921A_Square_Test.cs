...
{
    [TestClass]
    public sealed class CF_00001921A_Square_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001921A_Square));
        ...
        {
            bool result = CF_00001921A_Square.Solution_0_Test(input);
