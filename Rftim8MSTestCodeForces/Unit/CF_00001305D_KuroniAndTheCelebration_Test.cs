...
{
    [TestClass]
    public sealed class CF_00001305D_KuroniAndTheCelebration_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001305D_KuroniAndTheCelebration));
        ...
        {
            bool result = CF_00001305D_KuroniAndTheCelebration.Solution_0_Test(input);
