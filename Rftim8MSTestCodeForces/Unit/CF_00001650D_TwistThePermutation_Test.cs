...
{
    [TestClass]
    public sealed class CF_00001650D_TwistThePermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001650D_TwistThePermutation));
        ...
        {
            bool result = CF_00001650D_TwistThePermutation.Solution_0_Test(input);
