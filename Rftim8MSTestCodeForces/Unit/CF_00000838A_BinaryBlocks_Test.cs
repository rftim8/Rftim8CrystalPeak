...
{
    [TestClass]
    public sealed class CF_00000838A_BinaryBlocks_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000838A_BinaryBlocks));
        ...
        {
            bool result = CF_00000838A_BinaryBlocks.Solution_0_Test(input);
