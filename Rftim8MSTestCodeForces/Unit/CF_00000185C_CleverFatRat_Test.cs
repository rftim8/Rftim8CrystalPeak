...
{
    [TestClass]
    public sealed class CF_00000185C_CleverFatRat_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000185C_CleverFatRat));
        ...
        {
            bool result = CF_00000185C_CleverFatRat.Solution_0_Test(input);
