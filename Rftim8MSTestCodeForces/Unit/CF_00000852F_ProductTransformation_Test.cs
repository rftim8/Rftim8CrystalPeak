...
{
    [TestClass]
    public sealed class CF_00000852F_ProductTransformation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000852F_ProductTransformation));
        ...
        {
            bool result = CF_00000852F_ProductTransformation.Solution_0_Test(input);
