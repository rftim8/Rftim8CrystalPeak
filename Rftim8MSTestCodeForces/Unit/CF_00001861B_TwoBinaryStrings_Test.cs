...
{
    [TestClass]
    public sealed class CF_00001861B_TwoBinaryStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001861B_TwoBinaryStrings));
        ...
        {
            bool result = CF_00001861B_TwoBinaryStrings.Solution_0_Test(input);
