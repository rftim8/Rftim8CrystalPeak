...
{
    [TestClass]
    public sealed class CF_00000603E_PastoralOddities_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000603E_PastoralOddities));
        ...
        {
            bool result = CF_00000603E_PastoralOddities.Solution_0_Test(input);
