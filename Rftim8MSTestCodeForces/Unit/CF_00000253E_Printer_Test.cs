...
{
    [TestClass]
    public sealed class CF_00000253E_Printer_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000253E_Printer));
        ...
        {
            bool result = CF_00000253E_Printer.Solution_0_Test(input);
