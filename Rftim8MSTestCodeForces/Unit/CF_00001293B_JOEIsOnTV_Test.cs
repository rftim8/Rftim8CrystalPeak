...
{
    [TestClass]
    public sealed class CF_00001293B_JOEIsOnTV_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001293B_JOEIsOnTV));
        ...
        {
            bool result = CF_00001293B_JOEIsOnTV.Solution_0_Test(input);
