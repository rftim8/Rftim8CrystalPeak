...
{
    [TestClass]
    public sealed class CF_00001051G_Distinctification_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001051G_Distinctification));
        ...
        {
            bool result = CF_00001051G_Distinctification.Solution_0_Test(input);
