...
{
    [TestClass]
    public sealed class CF_00001056C_PickHeroes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001056C_PickHeroes));
        ...
        {
            bool result = CF_00001056C_PickHeroes.Solution_0_Test(input);
