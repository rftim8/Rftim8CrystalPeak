...
{
    [TestClass]
    public sealed class CF_00000809A_DoYouWantADate_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000809A_DoYouWantADate));
        ...
        {
            bool result = CF_00000809A_DoYouWantADate.Solution_0_Test(input);
