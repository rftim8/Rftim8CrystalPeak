...
{
    [TestClass]
    public sealed class CF_00000160D_EdgesInMST_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000160D_EdgesInMST));
        ...
        {
            bool result = CF_00000160D_EdgesInMST.Solution_0_Test(input);
