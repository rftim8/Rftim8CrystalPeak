...
{
    [TestClass]
    public sealed class CF_00000413B_SpykeChatting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000413B_SpykeChatting));
        ...
        {
            bool result = CF_00000413B_SpykeChatting.Solution_0_Test(input);
