...
{
    [TestClass]
    public sealed class CF_00000805A_FakeNP_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000805A_FakeNP));
        ...
        {
            bool result = CF_00000805A_FakeNP.Solution_0_Test(input);
