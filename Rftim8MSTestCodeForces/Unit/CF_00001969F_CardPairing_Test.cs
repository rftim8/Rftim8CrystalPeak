...
{
    [TestClass]
    public sealed class CF_00001969F_CardPairing_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001969F_CardPairing));
        ...
        {
            bool result = CF_00001969F_CardPairing.Solution_0_Test(input);
