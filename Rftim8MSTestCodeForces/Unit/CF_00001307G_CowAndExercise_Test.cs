...
{
    [TestClass]
    public sealed class CF_00001307G_CowAndExercise_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001307G_CowAndExercise));
        ...
        {
            bool result = CF_00001307G_CowAndExercise.Solution_0_Test(input);
