...
{
    [TestClass]
    public sealed class CF_00001381E_Origami_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001381E_Origami));
        ...
        {
            bool result = CF_00001381E_Origami.Solution_0_Test(input);
