...
{
    [TestClass]
    public sealed class CF_00001545A_AquaMoonAndStrangeSort_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001545A_AquaMoonAndStrangeSort));
        ...
        {
            bool result = CF_00001545A_AquaMoonAndStrangeSort.Solution_0_Test(input);
