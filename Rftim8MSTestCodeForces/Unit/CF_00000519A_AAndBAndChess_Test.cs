...
{
    [TestClass]
    public sealed class CF_00000519A_AAndBAndChess_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000519A_AAndBAndChess));
        ...
        {
            bool result = CF_00000519A_AAndBAndChess.Solution_0_Test(input);
