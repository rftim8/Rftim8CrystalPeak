...
{
    [TestClass]
    public sealed class CF_00000625E_FrogFights_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000625E_FrogFights));
        ...
        {
            bool result = CF_00000625E_FrogFights.Solution_0_Test(input);
