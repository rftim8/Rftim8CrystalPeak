...
{
    [TestClass]
    public sealed class CF_00001425E_ExcitationOfAtoms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001425E_ExcitationOfAtoms));
        ...
        {
            bool result = CF_00001425E_ExcitationOfAtoms.Solution_0_Test(input);
