...
{
    [TestClass]
    public sealed class CF_00000431C_KTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000431C_KTree));
        ...
        {
            bool result = CF_00000431C_KTree.Solution_0_Test(input);
