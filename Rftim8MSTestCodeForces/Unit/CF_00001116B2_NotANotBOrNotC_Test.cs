...
{
    [TestClass]
    public sealed class CF_00001116B2_NotANotBOrNotC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001116B2_NotANotBOrNotC));
        ...
        {
            bool result = CF_00001116B2_NotANotBOrNotC.Solution_0_Test(input);
