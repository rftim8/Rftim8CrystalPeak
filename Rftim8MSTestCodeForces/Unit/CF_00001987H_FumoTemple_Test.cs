...
{
    [TestClass]
    public sealed class CF_00001987H_FumoTemple_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001987H_FumoTemple));
        ...
        {
            bool result = CF_00001987H_FumoTemple.Solution_0_Test(input);
