...
{
    [TestClass]
    public sealed class CF_00000879A_BoryasDiagnosis_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000879A_BoryasDiagnosis));
        ...
        {
            bool result = CF_00000879A_BoryasDiagnosis.Solution_0_Test(input);
