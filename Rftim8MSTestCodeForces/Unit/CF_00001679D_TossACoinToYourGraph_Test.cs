...
{
    [TestClass]
    public sealed class CF_00001679D_TossACoinToYourGraph_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001679D_TossACoinToYourGraph));
        ...
        {
            bool result = CF_00001679D_TossACoinToYourGraph.Solution_0_Test(input);
