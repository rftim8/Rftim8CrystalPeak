...
{
    [TestClass]
    public sealed class CF_00000468E_Permanent_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000468E_Permanent));
        ...
        {
            bool result = CF_00000468E_Permanent.Solution_0_Test(input);
