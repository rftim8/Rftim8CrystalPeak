...
{
    [TestClass]
    public sealed class CF_00000219E_ParkingLot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000219E_ParkingLot));
        ...
        {
            bool result = CF_00000219E_ParkingLot.Solution_0_Test(input);
