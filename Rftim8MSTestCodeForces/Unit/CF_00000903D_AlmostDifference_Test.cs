...
{
    [TestClass]
    public sealed class CF_00000903D_AlmostDifference_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000903D_AlmostDifference));
        ...
        {
            bool result = CF_00000903D_AlmostDifference.Solution_0_Test(input);
