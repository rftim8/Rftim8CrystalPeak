...
{
    [TestClass]
    public sealed class CF_00000915C_PermuteDigits_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000915C_PermuteDigits));
        ...
        {
            bool result = CF_00000915C_PermuteDigits.Solution_0_Test(input);
