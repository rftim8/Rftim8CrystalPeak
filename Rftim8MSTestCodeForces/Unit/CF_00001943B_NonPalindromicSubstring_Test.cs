...
{
    [TestClass]
    public sealed class CF_00001943B_NonPalindromicSubstring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001943B_NonPalindromicSubstring));
        ...
        {
            bool result = CF_00001943B_NonPalindromicSubstring.Solution_0_Test(input);
