...
{
    [TestClass]
    public sealed class CF_00001990D_GridPuzzle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001990D_GridPuzzle));
        ...
        {
            bool result = CF_00001990D_GridPuzzle.Solution_0_Test(input);
