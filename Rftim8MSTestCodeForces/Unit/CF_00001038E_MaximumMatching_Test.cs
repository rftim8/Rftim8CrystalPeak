...
{
    [TestClass]
    public sealed class CF_00001038E_MaximumMatching_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001038E_MaximumMatching));
        ...
        {
            bool result = CF_00001038E_MaximumMatching.Solution_0_Test(input);
