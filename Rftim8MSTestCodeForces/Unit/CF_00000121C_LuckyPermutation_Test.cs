...
{
    [TestClass]
    public sealed class CF_00000121C_LuckyPermutation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000121C_LuckyPermutation));
        ...
        {
            bool result = CF_00000121C_LuckyPermutation.Solution_0_Test(input);
