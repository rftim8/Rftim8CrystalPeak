...
{
    [TestClass]
    public sealed class CF_00000922F_Divisibility_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000922F_Divisibility));
        ...
        {
            bool result = CF_00000922F_Divisibility.Solution_0_Test(input);
