...
{
    [TestClass]
    public sealed class CF_00001166C_ATaleOfTwoLands_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001166C_ATaleOfTwoLands));
        ...
        {
            bool result = CF_00001166C_ATaleOfTwoLands.Solution_0_Test(input);
