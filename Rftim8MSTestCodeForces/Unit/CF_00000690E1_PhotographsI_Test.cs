...
{
    [TestClass]
    public sealed class CF_00000690E1_PhotographsI_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000690E1_PhotographsI));
        ...
        {
            bool result = CF_00000690E1_PhotographsI.Solution_0_Test(input);
