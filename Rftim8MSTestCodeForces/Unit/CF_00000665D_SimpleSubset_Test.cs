...
{
    [TestClass]
    public sealed class CF_00000665D_SimpleSubset_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000665D_SimpleSubset));
        ...
        {
            bool result = CF_00000665D_SimpleSubset.Solution_0_Test(input);
