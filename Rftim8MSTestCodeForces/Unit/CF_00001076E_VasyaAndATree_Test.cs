...
{
    [TestClass]
    public sealed class CF_00001076E_VasyaAndATree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001076E_VasyaAndATree));
        ...
        {
            bool result = CF_00001076E_VasyaAndATree.Solution_0_Test(input);
