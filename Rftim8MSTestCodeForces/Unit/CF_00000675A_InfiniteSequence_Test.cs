...
{
    [TestClass]
    public sealed class CF_00000675A_InfiniteSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000675A_InfiniteSequence));
        ...
        {
            bool result = CF_00000675A_InfiniteSequence.Solution_0_Test(input);
