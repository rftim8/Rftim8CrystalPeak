...
{
    [TestClass]
    public sealed class CF_00001093B_LettersRearranging_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001093B_LettersRearranging));
        ...
        {
            bool result = CF_00001093B_LettersRearranging.Solution_0_Test(input);
