...
{
    [TestClass]
    public sealed class CF_00001680E_MovingChips_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001680E_MovingChips));
        ...
        {
            bool result = CF_00001680E_MovingChips.Solution_0_Test(input);
