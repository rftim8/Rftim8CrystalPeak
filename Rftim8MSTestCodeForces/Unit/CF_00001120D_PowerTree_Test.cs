...
{
    [TestClass]
    public sealed class CF_00001120D_PowerTree_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001120D_PowerTree));
        ...
        {
            bool result = CF_00001120D_PowerTree.Solution_0_Test(input);
