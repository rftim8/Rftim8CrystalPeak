...
{
    [TestClass]
    public sealed class CF_00001938G_PersonalityTest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001938G_PersonalityTest));
        ...
        {
            bool result = CF_00001938G_PersonalityTest.Solution_0_Test(input);
