...
{
    [TestClass]
    public sealed class CF_00001973B_CatFoxAndTheLonelyArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001973B_CatFoxAndTheLonelyArray));
        ...
        {
            bool result = CF_00001973B_CatFoxAndTheLonelyArray.Solution_0_Test(input);
