...
{
    [TestClass]
    public sealed class CF_00001873G_ABBCOrBACB_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001873G_ABBCOrBACB));
        ...
        {
            bool result = CF_00001873G_ABBCOrBACB.Solution_0_Test(input);
