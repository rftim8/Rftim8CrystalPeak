...
{
    [TestClass]
    public sealed class CF_00001257E_TheContest_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001257E_TheContest));
        ...
        {
            bool result = CF_00001257E_TheContest.Solution_0_Test(input);
