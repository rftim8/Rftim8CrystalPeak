...
{
    [TestClass]
    public sealed class CF_00000719A_VityaInTheCountryside_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000719A_VityaInTheCountryside));
        ...
        {
            bool result = CF_00000719A_VityaInTheCountryside.Solution_0_Test(input);
