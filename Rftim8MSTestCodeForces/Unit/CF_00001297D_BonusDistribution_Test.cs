...
{
    [TestClass]
    public sealed class CF_00001297D_BonusDistribution_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001297D_BonusDistribution));
        ...
        {
            bool result = CF_00001297D_BonusDistribution.Solution_0_Test(input);
