...
{
    [TestClass]
    public sealed class CF_00001277D_LetsPlayTheWords_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001277D_LetsPlayTheWords));
        ...
        {
            bool result = CF_00001277D_LetsPlayTheWords.Solution_0_Test(input);
