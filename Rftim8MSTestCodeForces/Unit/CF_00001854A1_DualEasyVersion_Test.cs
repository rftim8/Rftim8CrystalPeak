...
{
    [TestClass]
    public sealed class CF_00001854A1_DualEasyVersion_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001854A1_DualEasyVersion));
        ...
        {
            bool result = CF_00001854A1_DualEasyVersion.Solution_0_Test(input);
