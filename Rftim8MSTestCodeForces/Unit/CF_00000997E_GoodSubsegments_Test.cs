...
{
    [TestClass]
    public sealed class CF_00000997E_GoodSubsegments_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000997E_GoodSubsegments));
        ...
        {
            bool result = CF_00000997E_GoodSubsegments.Solution_0_Test(input);
