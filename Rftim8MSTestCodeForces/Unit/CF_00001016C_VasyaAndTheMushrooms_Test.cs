...
{
    [TestClass]
    public sealed class CF_00001016C_VasyaAndTheMushrooms_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001016C_VasyaAndTheMushrooms));
        ...
        {
            bool result = CF_00001016C_VasyaAndTheMushrooms.Solution_0_Test(input);
