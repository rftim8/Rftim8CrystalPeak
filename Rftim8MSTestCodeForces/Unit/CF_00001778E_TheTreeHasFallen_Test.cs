...
{
    [TestClass]
    public sealed class CF_00001778E_TheTreeHasFallen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001778E_TheTreeHasFallen));
        ...
        {
            bool result = CF_00001778E_TheTreeHasFallen.Solution_0_Test(input);
