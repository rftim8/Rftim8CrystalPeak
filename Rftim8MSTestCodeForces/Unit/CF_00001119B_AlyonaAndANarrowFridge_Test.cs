...
{
    [TestClass]
    public sealed class CF_00001119B_AlyonaAndANarrowFridge_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001119B_AlyonaAndANarrowFridge));
        ...
        {
            bool result = CF_00001119B_AlyonaAndANarrowFridge.Solution_0_Test(input);
