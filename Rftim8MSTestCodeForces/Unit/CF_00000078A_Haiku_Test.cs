...
{
    [TestClass]
    public sealed class CF_00000078A_Haiku_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000078A_Haiku));
        ...
        {
            bool result = CF_00000078A_Haiku.Solution_0_Test(input);
