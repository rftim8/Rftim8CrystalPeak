...
{
    [TestClass]
    public sealed class CF_00000770C_OnlineCoursesInBSU_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000770C_OnlineCoursesInBSU));
        ...
        {
            bool result = CF_00000770C_OnlineCoursesInBSU.Solution_0_Test(input);
