...
{
    [TestClass]
    public sealed class CF_00000831A_UnimodalArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000831A_UnimodalArray));
        ...
        {
            bool result = CF_00000831A_UnimodalArray.Solution_0_Test(input);
