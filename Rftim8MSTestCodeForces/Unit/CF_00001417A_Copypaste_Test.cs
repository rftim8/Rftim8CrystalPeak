...
{
    [TestClass]
    public sealed class CF_00001417A_Copypaste_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001417A_Copypaste));
        ...
        {
            bool result = CF_00001417A_Copypaste.Solution_0_Test(input);
