...
{
    [TestClass]
    public sealed class CF_00001532A_APlusBTrialProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001532A_APlusBTrialProblem));
        ...
        {
            bool result = CF_00001532A_APlusBTrialProblem.Solution_0_Test(input);
