...
{
    [TestClass]
    public sealed class CF_00001562E_RescueNiwen_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001562E_RescueNiwen));
        ...
        {
            bool result = CF_00001562E_RescueNiwen.Solution_0_Test(input);
