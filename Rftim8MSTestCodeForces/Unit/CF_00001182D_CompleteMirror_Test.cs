...
{
    [TestClass]
    public sealed class CF_00001182D_CompleteMirror_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001182D_CompleteMirror));
        ...
        {
            bool result = CF_00001182D_CompleteMirror.Solution_0_Test(input);
