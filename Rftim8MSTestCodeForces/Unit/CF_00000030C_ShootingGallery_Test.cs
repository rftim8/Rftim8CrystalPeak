...
{
    [TestClass]
    public sealed class CF_00000030C_ShootingGallery_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000030C_ShootingGallery));
        ...
        {
            bool result = CF_00000030C_ShootingGallery.Solution_0_Test(input);
