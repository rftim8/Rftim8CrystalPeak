...
{
    [TestClass]
    public sealed class CF_00000708B_RecoverTheString_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000708B_RecoverTheString));
        ...
        {
            bool result = CF_00000708B_RecoverTheString.Solution_0_Test(input);
