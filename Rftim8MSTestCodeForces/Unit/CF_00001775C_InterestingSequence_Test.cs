...
{
    [TestClass]
    public sealed class CF_00001775C_InterestingSequence_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001775C_InterestingSequence));
        ...
        {
            bool result = CF_00001775C_InterestingSequence.Solution_0_Test(input);
