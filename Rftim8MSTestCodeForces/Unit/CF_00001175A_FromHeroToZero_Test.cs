...
{
    [TestClass]
    public sealed class CF_00001175A_FromHeroToZero_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001175A_FromHeroToZero));
        ...
        {
            bool result = CF_00001175A_FromHeroToZero.Solution_0_Test(input);
