...
{
    [TestClass]
    public sealed class CF_00001383F_SpecialEdges_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001383F_SpecialEdges));
        ...
        {
            bool result = CF_00001383F_SpecialEdges.Solution_0_Test(input);
