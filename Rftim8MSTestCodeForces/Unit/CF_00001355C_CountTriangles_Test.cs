...
{
    [TestClass]
    public sealed class CF_00001355C_CountTriangles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001355C_CountTriangles));
        ...
        {
            bool result = CF_00001355C_CountTriangles.Solution_0_Test(input);
