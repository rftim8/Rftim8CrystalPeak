...
{
    [TestClass]
    public sealed class CF_00001141E_SuperheroBattle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001141E_SuperheroBattle));
        ...
        {
            bool result = CF_00001141E_SuperheroBattle.Solution_0_Test(input);
