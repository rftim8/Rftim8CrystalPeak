...
{
    [TestClass]
    public sealed class CF_00000856D_MashaAndCactus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000856D_MashaAndCactus));
        ...
        {
            bool result = CF_00000856D_MashaAndCactus.Solution_0_Test(input);
