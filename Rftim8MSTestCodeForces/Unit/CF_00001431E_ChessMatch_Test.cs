...
{
    [TestClass]
    public sealed class CF_00001431E_ChessMatch_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001431E_ChessMatch));
        ...
        {
            bool result = CF_00001431E_ChessMatch.Solution_0_Test(input);
