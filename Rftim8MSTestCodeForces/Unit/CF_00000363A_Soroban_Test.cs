...
{
    [TestClass]
    public sealed class CF_00000363A_Soroban_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000363A_Soroban));
        ...
        {
            bool result = CF_00000363A_Soroban.Solution_0_Test(input);
