...
{
    [TestClass]
    public sealed class CF_00001698B_RisingSand_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001698B_RisingSand));
        ...
        {
            bool result = CF_00001698B_RisingSand.Solution_0_Test(input);
