...
{
    [TestClass]
    public sealed class CF_00001537D_DeletingDivisors_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001537D_DeletingDivisors));
        ...
        {
            bool result = CF_00001537D_DeletingDivisors.Solution_0_Test(input);
