...
{
    [TestClass]
    public sealed class CF_00000153B_BinaryNotation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000153B_BinaryNotation));
        ...
        {
            bool result = CF_00000153B_BinaryNotation.Solution_0_Test(input);
