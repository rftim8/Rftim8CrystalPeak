...
{
    [TestClass]
    public sealed class CF_00001006B_PolycarpsPractice_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001006B_PolycarpsPractice));
        ...
        {
            bool result = CF_00001006B_PolycarpsPractice.Solution_0_Test(input);
