...
{
    [TestClass]
    public sealed class CF_00000086B_TetrisRevisited_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000086B_TetrisRevisited));
        ...
        {
            bool result = CF_00000086B_TetrisRevisited.Solution_0_Test(input);
