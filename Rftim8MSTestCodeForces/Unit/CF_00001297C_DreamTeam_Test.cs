...
{
    [TestClass]
    public sealed class CF_00001297C_DreamTeam_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001297C_DreamTeam));
        ...
        {
            bool result = CF_00001297C_DreamTeam.Solution_0_Test(input);
