...
{
    [TestClass]
    public sealed class CF_00001656B_SubtractOperation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001656B_SubtractOperation));
        ...
        {
            bool result = CF_00001656B_SubtractOperation.Solution_0_Test(input);
