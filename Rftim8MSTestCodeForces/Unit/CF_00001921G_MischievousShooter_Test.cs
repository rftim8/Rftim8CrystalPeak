...
{
    [TestClass]
    public sealed class CF_00001921G_MischievousShooter_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001921G_MischievousShooter));
        ...
        {
            bool result = CF_00001921G_MischievousShooter.Solution_0_Test(input);
