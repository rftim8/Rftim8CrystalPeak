...
{
    [TestClass]
    public sealed class CF_00001854F_MarkAndSpaceship_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001854F_MarkAndSpaceship));
        ...
        {
            bool result = CF_00001854F_MarkAndSpaceship.Solution_0_Test(input);
