...
{
    [TestClass]
    public sealed class CF_00000660B_SeatingOnBus_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000660B_SeatingOnBus));
        ...
        {
            bool result = CF_00000660B_SeatingOnBus.Solution_0_Test(input);
