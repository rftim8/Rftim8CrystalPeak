...
{
    [TestClass]
    public sealed class CF_00000936A_SaveEnergy_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000936A_SaveEnergy));
        ...
        {
            bool result = CF_00000936A_SaveEnergy.Solution_0_Test(input);
