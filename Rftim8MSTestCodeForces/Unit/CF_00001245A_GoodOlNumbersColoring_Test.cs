...
{
    [TestClass]
    public sealed class CF_00001245A_GoodOlNumbersColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001245A_GoodOlNumbersColoring));
        ...
        {
            bool result = CF_00001245A_GoodOlNumbersColoring.Solution_0_Test(input);
