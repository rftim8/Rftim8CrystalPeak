...
{
    [TestClass]
    public sealed class CF_00001328A_DivisibilityProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001328A_DivisibilityProblem));
        ...
        {
            bool result = CF_00001328A_DivisibilityProblem.Solution_0_Test(input);
