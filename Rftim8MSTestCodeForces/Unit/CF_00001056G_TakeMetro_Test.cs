...
{
    [TestClass]
    public sealed class CF_00001056G_TakeMetro_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001056G_TakeMetro));
        ...
        {
            bool result = CF_00001056G_TakeMetro.Solution_0_Test(input);
