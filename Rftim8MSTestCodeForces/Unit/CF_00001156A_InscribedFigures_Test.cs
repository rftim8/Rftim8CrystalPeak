...
{
    [TestClass]
    public sealed class CF_00001156A_InscribedFigures_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001156A_InscribedFigures));
        ...
        {
            bool result = CF_00001156A_InscribedFigures.Solution_0_Test(input);
