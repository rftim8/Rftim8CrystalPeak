...
{
    [TestClass]
    public sealed class CF_00000913D_TooEasyProblems_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000913D_TooEasyProblems));
        ...
        {
            bool result = CF_00000913D_TooEasyProblems.Solution_0_Test(input);
