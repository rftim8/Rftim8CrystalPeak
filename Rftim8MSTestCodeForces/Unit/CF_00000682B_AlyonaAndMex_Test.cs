...
{
    [TestClass]
    public sealed class CF_00000682B_AlyonaAndMex_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000682B_AlyonaAndMex));
        ...
        {
            bool result = CF_00000682B_AlyonaAndMex.Solution_0_Test(input);
