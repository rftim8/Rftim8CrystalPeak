...
{
    [TestClass]
    public sealed class CF_00000913C_PartyLemonade_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000913C_PartyLemonade));
        ...
        {
            bool result = CF_00000913C_PartyLemonade.Solution_0_Test(input);
