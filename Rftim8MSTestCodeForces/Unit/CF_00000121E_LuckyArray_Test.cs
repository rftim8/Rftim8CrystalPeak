...
{
    [TestClass]
    public sealed class CF_00000121E_LuckyArray_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000121E_LuckyArray));
        ...
        {
            bool result = CF_00000121E_LuckyArray.Solution_0_Test(input);
