...
{
    [TestClass]
    public sealed class CF_00000859F_OrderingTShirts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000859F_OrderingTShirts));
        ...
        {
            bool result = CF_00000859F_OrderingTShirts.Solution_0_Test(input);
