...
{
    [TestClass]
    public sealed class CF_00000107E_Darts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000107E_Darts));
        ...
        {
            bool result = CF_00000107E_Darts.Solution_0_Test(input);
