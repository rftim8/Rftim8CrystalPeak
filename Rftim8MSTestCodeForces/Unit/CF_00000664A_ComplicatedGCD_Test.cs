...
{
    [TestClass]
    public sealed class CF_00000664A_ComplicatedGCD_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000664A_ComplicatedGCD));
        ...
        {
            bool result = CF_00000664A_ComplicatedGCD.Solution_0_Test(input);
