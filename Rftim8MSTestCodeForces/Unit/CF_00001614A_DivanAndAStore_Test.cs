...
{
    [TestClass]
    public sealed class CF_00001614A_DivanAndAStore_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001614A_DivanAndAStore));
        ...
        {
            bool result = CF_00001614A_DivanAndAStore.Solution_0_Test(input);
