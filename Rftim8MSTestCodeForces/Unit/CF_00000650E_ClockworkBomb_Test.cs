...
{
    [TestClass]
    public sealed class CF_00000650E_ClockworkBomb_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000650E_ClockworkBomb));
        ...
        {
            bool result = CF_00000650E_ClockworkBomb.Solution_0_Test(input);
