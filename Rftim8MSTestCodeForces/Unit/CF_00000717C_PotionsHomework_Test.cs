...
{
    [TestClass]
    public sealed class CF_00000717C_PotionsHomework_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000717C_PotionsHomework));
        ...
        {
            bool result = CF_00000717C_PotionsHomework.Solution_0_Test(input);
