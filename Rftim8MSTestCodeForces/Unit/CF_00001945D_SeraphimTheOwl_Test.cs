...
{
    [TestClass]
    public sealed class CF_00001945D_SeraphimTheOwl_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001945D_SeraphimTheOwl));
        ...
        {
            bool result = CF_00001945D_SeraphimTheOwl.Solution_0_Test(input);
