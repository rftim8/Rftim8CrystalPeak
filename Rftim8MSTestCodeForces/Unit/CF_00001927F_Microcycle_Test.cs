...
{
    [TestClass]
    public sealed class CF_00001927F_Microcycle_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001927F_Microcycle));
        ...
        {
            bool result = CF_00001927F_Microcycle.Solution_0_Test(input);
