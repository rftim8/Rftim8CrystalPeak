...
{
    [TestClass]
    public sealed class CF_00001899B_250ThousandTonsOfTNT_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001899B_250ThousandTonsOfTNT));
        ...
        {
            bool result = CF_00001899B_250ThousandTonsOfTNT.Solution_0_Test(input);
