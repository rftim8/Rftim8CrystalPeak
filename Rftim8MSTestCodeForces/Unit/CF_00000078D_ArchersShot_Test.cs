...
{
    [TestClass]
    public sealed class CF_00000078D_ArchersShot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000078D_ArchersShot));
        ...
        {
            bool result = CF_00000078D_ArchersShot.Solution_0_Test(input);
