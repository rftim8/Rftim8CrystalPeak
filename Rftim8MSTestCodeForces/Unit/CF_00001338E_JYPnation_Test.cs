...
{
    [TestClass]
    public sealed class CF_00001338E_JYPnation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001338E_JYPnation));
        ...
        {
            bool result = CF_00001338E_JYPnation.Solution_0_Test(input);
