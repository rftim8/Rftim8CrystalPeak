...
{
    [TestClass]
    public sealed class CF_00000063D_DividingIsland_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000063D_DividingIsland));
        ...
        {
            bool result = CF_00000063D_DividingIsland.Solution_0_Test(input);
