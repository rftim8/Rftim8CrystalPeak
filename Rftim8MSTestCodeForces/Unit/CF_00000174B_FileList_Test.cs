...
{
    [TestClass]
    public sealed class CF_00000174B_FileList_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000174B_FileList));
        ...
        {
            bool result = CF_00000174B_FileList.Solution_0_Test(input);
