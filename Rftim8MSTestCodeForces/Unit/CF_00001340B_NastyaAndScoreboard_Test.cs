...
{
    [TestClass]
    public sealed class CF_00001340B_NastyaAndScoreboard_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001340B_NastyaAndScoreboard));
        ...
        {
            bool result = CF_00001340B_NastyaAndScoreboard.Solution_0_Test(input);
