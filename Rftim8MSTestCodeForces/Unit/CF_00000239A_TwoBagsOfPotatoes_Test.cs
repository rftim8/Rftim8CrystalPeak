...
{
    [TestClass]
    public sealed class CF_00000239A_TwoBagsOfPotatoes_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000239A_TwoBagsOfPotatoes));
        ...
        {
            bool result = CF_00000239A_TwoBagsOfPotatoes.Solution_0_Test(input);
