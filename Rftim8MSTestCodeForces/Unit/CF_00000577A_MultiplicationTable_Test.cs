...
{
    [TestClass]
    public sealed class CF_00000577A_MultiplicationTable_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000577A_MultiplicationTable));
        ...
        {
            bool result = CF_00000577A_MultiplicationTable.Solution_0_Test(input);
