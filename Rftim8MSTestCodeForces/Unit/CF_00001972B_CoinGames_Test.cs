...
{
    [TestClass]
    public sealed class CF_00001972B_CoinGames_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001972B_CoinGames));
        ...
        {
            bool result = CF_00001972B_CoinGames.Solution_0_Test(input);
