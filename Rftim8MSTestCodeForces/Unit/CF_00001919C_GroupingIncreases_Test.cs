...
{
    [TestClass]
    public sealed class CF_00001919C_GroupingIncreases_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001919C_GroupingIncreases));
        ...
        {
            bool result = CF_00001919C_GroupingIncreases.Solution_0_Test(input);
