...
{
    [TestClass]
    public sealed class CF_00001408A_CircleColoring_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001408A_CircleColoring));
        ...
        {
            bool result = CF_00001408A_CircleColoring.Solution_0_Test(input);
