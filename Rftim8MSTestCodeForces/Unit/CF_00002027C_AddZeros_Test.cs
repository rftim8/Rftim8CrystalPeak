...
{
    [TestClass]
    public sealed class CF_00002027C_AddZeros_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00002027C_AddZeros));
        ...
        {
            bool result = CF_00002027C_AddZeros.Solution_0_Test(input);
