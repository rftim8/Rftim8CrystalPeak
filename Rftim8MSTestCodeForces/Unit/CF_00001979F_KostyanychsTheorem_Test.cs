...
{
    [TestClass]
    public sealed class CF_00001979F_KostyanychsTheorem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001979F_KostyanychsTheorem));
        ...
        {
            bool result = CF_00001979F_KostyanychsTheorem.Solution_0_Test(input);
