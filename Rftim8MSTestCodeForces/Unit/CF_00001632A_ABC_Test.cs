...
{
    [TestClass]
    public sealed class CF_00001632A_ABC_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001632A_ABC));
        ...
        {
            bool result = CF_00001632A_ABC.Solution_0_Test(input);
