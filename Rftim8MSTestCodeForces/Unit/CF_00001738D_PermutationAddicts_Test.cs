...
{
    [TestClass]
    public sealed class CF_00001738D_PermutationAddicts_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001738D_PermutationAddicts));
        ...
        {
            bool result = CF_00001738D_PermutationAddicts.Solution_0_Test(input);
