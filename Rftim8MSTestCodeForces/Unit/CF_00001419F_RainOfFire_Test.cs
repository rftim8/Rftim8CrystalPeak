...
{
    [TestClass]
    public sealed class CF_00001419F_RainOfFire_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001419F_RainOfFire));
        ...
        {
            bool result = CF_00001419F_RainOfFire.Solution_0_Test(input);
