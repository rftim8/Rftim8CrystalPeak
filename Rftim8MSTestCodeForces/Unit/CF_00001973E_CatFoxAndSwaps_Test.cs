...
{
    [TestClass]
    public sealed class CF_00001973E_CatFoxAndSwaps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001973E_CatFoxAndSwaps));
        ...
        {
            bool result = CF_00001973E_CatFoxAndSwaps.Solution_0_Test(input);
