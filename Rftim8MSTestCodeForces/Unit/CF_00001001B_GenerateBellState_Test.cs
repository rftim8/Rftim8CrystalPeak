...
{
    [TestClass]
    public sealed class CF_00001001B_GenerateBellState_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001001B_GenerateBellState));
        ...
        {
            bool result = CF_00001001B_GenerateBellState.Solution_0_Test(input);
