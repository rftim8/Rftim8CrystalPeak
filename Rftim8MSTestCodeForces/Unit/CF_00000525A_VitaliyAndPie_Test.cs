...
{
    [TestClass]
    public sealed class CF_00000525A_VitaliyAndPie_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000525A_VitaliyAndPie));
        ...
        {
            bool result = CF_00000525A_VitaliyAndPie.Solution_0_Test(input);
