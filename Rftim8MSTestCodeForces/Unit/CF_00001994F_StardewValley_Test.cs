...
{
    [TestClass]
    public sealed class CF_00001994F_StardewValley_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001994F_StardewValley));
        ...
        {
            bool result = CF_00001994F_StardewValley.Solution_0_Test(input);
