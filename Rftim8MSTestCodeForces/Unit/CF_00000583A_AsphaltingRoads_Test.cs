...
{
    [TestClass]
    public sealed class CF_00000583A_AsphaltingRoads_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000583A_AsphaltingRoads));
        ...
        {
            bool result = CF_00000583A_AsphaltingRoads.Solution_0_Test(input);
