...
{
    [TestClass]
    public sealed class CF_00000763C_TimofeyAndRemoduling_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000763C_TimofeyAndRemoduling));
        ...
        {
            bool result = CF_00000763C_TimofeyAndRemoduling.Solution_0_Test(input);
