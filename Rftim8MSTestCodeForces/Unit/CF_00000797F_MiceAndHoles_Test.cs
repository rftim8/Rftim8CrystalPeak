...
{
    [TestClass]
    public sealed class CF_00000797F_MiceAndHoles_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000797F_MiceAndHoles));
        ...
        {
            bool result = CF_00000797F_MiceAndHoles.Solution_0_Test(input);
