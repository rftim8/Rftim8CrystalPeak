...
{
    [TestClass]
    public sealed class CF_00000680B_BearAndFindingCriminals_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000680B_BearAndFindingCriminals));
        ...
        {
            bool result = CF_00000680B_BearAndFindingCriminals.Solution_0_Test(input);
