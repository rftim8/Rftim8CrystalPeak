...
{
    [TestClass]
    public sealed class CF_00001355B_YoungExplorers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001355B_YoungExplorers));
        ...
        {
            bool result = CF_00001355B_YoungExplorers.Solution_0_Test(input);
