...
{
    [TestClass]
    public sealed class CF_00001929C_SashaAndTheCasino_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001929C_SashaAndTheCasino));
        ...
        {
            bool result = CF_00001929C_SashaAndTheCasino.Solution_0_Test(input);
