...
{
    [TestClass]
    public sealed class CF_00000847D_DogShow_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000847D_DogShow));
        ...
        {
            bool result = CF_00000847D_DogShow.Solution_0_Test(input);
