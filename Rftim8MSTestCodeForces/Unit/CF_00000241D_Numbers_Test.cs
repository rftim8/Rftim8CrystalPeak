...
{
    [TestClass]
    public sealed class CF_00000241D_Numbers_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000241D_Numbers));
        ...
        {
            bool result = CF_00000241D_Numbers.Solution_0_Test(input);
