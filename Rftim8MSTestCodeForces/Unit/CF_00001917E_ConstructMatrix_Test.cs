...
{
    [TestClass]
    public sealed class CF_00001917E_ConstructMatrix_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001917E_ConstructMatrix));
        ...
        {
            bool result = CF_00001917E_ConstructMatrix.Solution_0_Test(input);
