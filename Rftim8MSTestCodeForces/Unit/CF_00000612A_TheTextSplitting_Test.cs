...
{
    [TestClass]
    public sealed class CF_00000612A_TheTextSplitting_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000612A_TheTextSplitting));
        ...
        {
            bool result = CF_00000612A_TheTextSplitting.Solution_0_Test(input);
