...
{
    [TestClass]
    public sealed class CF_00000520C_DNAAlignment_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000520C_DNAAlignment));
        ...
        {
            bool result = CF_00000520C_DNAAlignment.Solution_0_Test(input);
