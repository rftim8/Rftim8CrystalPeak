...
{
    [TestClass]
    public sealed class CF_00001891C_SmiloAndMonsters_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001891C_SmiloAndMonsters));
        ...
        {
            bool result = CF_00001891C_SmiloAndMonsters.Solution_0_Test(input);
