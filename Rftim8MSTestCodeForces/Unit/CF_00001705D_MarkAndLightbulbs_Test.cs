...
{
    [TestClass]
    public sealed class CF_00001705D_MarkAndLightbulbs_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001705D_MarkAndLightbulbs));
        ...
        {
            bool result = CF_00001705D_MarkAndLightbulbs.Solution_0_Test(input);
