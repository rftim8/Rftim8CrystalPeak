...
{
    [TestClass]
    public sealed class CF_00000809B_GladToSeeYou_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000809B_GladToSeeYou));
        ...
        {
            bool result = CF_00000809B_GladToSeeYou.Solution_0_Test(input);
