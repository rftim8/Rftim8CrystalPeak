...
{
    [TestClass]
    public sealed class CF_00001006F_XorPaths_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001006F_XorPaths));
        ...
        {
            bool result = CF_00001006F_XorPaths.Solution_0_Test(input);
