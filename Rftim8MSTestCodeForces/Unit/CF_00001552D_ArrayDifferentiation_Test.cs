...
{
    [TestClass]
    public sealed class CF_00001552D_ArrayDifferentiation_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001552D_ArrayDifferentiation));
        ...
        {
            bool result = CF_00001552D_ArrayDifferentiation.Solution_0_Test(input);
