...
{
    [TestClass]
    public sealed class CF_00000321A_CielAndRobot_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000321A_CielAndRobot));
        ...
        {
            bool result = CF_00000321A_CielAndRobot.Solution_0_Test(input);
