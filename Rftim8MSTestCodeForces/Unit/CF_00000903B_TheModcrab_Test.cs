...
{
    [TestClass]
    public sealed class CF_00000903B_TheModcrab_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000903B_TheModcrab));
        ...
        {
            bool result = CF_00000903B_TheModcrab.Solution_0_Test(input);
