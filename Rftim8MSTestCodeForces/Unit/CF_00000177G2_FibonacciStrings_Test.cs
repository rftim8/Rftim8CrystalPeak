...
{
    [TestClass]
    public sealed class CF_00000177G2_FibonacciStrings_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000177G2_FibonacciStrings));
        ...
        {
            bool result = CF_00000177G2_FibonacciStrings.Solution_0_Test(input);
