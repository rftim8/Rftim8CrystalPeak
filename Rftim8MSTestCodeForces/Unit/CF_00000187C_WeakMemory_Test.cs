...
{
    [TestClass]
    public sealed class CF_00000187C_WeakMemory_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000187C_WeakMemory));
        ...
        {
            bool result = CF_00000187C_WeakMemory.Solution_0_Test(input);
