...
{
    [TestClass]
    public sealed class CF_00000991E_BusNumber_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000991E_BusNumber));
        ...
        {
            bool result = CF_00000991E_BusNumber.Solution_0_Test(input);
