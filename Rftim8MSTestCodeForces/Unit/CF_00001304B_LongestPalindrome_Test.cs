...
{
    [TestClass]
    public sealed class CF_00001304B_LongestPalindrome_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001304B_LongestPalindrome));
        ...
        {
            bool result = CF_00001304B_LongestPalindrome.Solution_0_Test(input);
