...
{
    [TestClass]
    public sealed class CF_00000558E_ASimpleTask_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000558E_ASimpleTask));
        ...
        {
            bool result = CF_00000558E_ASimpleTask.Solution_0_Test(input);
