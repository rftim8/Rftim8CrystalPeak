...
{
    [TestClass]
    public sealed class CF_00001764B_DoremysPerfectMathClass_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001764B_DoremysPerfectMathClass));
        ...
        {
            bool result = CF_00001764B_DoremysPerfectMathClass.Solution_0_Test(input);
