...
{
    [TestClass]
    public sealed class CF_00001548B_IntegersHaveFriends_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001548B_IntegersHaveFriends));
        ...
        {
            bool result = CF_00001548B_IntegersHaveFriends.Solution_0_Test(input);
