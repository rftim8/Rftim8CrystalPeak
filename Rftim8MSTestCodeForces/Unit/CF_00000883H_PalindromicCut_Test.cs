...
{
    [TestClass]
    public sealed class CF_00000883H_PalindromicCut_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000883H_PalindromicCut));
        ...
        {
            bool result = CF_00000883H_PalindromicCut.Solution_0_Test(input);
