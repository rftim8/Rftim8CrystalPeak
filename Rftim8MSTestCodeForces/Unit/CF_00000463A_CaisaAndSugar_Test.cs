...
{
    [TestClass]
    public sealed class CF_00000463A_CaisaAndSugar_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000463A_CaisaAndSugar));
        ...
        {
            bool result = CF_00000463A_CaisaAndSugar.Solution_0_Test(input);
