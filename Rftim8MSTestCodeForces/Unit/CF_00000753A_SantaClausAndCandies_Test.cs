...
{
    [TestClass]
    public sealed class CF_00000753A_SantaClausAndCandies_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000753A_SantaClausAndCandies));
        ...
        {
            bool result = CF_00000753A_SantaClausAndCandies.Solution_0_Test(input);
