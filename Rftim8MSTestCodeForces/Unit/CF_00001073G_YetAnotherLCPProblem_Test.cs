...
{
    [TestClass]
    public sealed class CF_00001073G_YetAnotherLCPProblem_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001073G_YetAnotherLCPProblem));
        ...
        {
            bool result = CF_00001073G_YetAnotherLCPProblem.Solution_0_Test(input);
