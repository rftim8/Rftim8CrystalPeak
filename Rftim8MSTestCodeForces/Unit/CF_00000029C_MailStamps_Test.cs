...
{
    [TestClass]
    public sealed class CF_00000029C_MailStamps_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00000029C_MailStamps));
        ...
        {
            bool result = CF_00000029C_MailStamps.Solution_0_Test(input);
