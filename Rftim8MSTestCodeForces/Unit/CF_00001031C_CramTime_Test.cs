...
{
    [TestClass]
    public sealed class CF_00001031C_CramTime_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001031C_CramTime));
        ...
        {
            bool result = CF_00001031C_CramTime.Solution_0_Test(input);
