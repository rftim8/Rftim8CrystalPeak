...
{
    [TestClass]
    public sealed class CF_00001821D_BlackCells_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001821D_BlackCells));
        ...
        {
            bool result = CF_00001821D_BlackCells.Solution_0_Test(input);
