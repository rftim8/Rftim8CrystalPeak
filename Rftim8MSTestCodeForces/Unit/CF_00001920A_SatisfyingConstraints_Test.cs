...
{
    [TestClass]
    public sealed class CF_00001920A_SatisfyingConstraints_Test
    {
        public TestContext TestContext { get; set; } = null!;

        private static readonly List<string>? Input = RftCodeForcesStaticData.Input_Test(testType: true, problemName: nameof(CF_00001920A_SatisfyingConstraints));
        ...
        {
            bool result = CF_00001920A_SatisfyingConstraints.Solution_0_Test(input);
